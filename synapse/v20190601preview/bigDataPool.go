...
func NewBigDataPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20190601preview:BigDataPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigDataPool(ctx *pulumi.Context,
	...
	var resource BigDataPool
	err := ctx.ReadResource("azure-native:synapse/v20190601preview:BigDataPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
