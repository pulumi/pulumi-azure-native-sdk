...
func NewIpFirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20190601preview:IpFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpFirewallRule(ctx *pulumi.Context,
	...
	var resource IpFirewallRule
	err := ctx.ReadResource("azure-native:synapse/v20190601preview:IpFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
