...
//
// Deprecated: azure-native:synapse/v20210501:IntegrationRuntime is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:IntegrationRuntime to guarantee forwards compatibility.
...
func NewIntegrationRuntime(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210501:IntegrationRuntime", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationRuntime(ctx *pulumi.Context,
	...
	var resource IntegrationRuntime
	err := ctx.ReadResource("azure-native:synapse/v20210501:IntegrationRuntime", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
