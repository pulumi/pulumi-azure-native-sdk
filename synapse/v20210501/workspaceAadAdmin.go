...
//
// Deprecated: azure-native:synapse/v20210501:WorkspaceAadAdmin is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:WorkspaceAadAdmin to guarantee forwards compatibility.
...
func NewWorkspaceAadAdmin(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210501:WorkspaceAadAdmin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceAadAdmin(ctx *pulumi.Context,
	...
	var resource WorkspaceAadAdmin
	err := ctx.ReadResource("azure-native:synapse/v20210501:WorkspaceAadAdmin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
