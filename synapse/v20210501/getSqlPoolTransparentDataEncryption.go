...
//
// Deprecated: azure-native:synapse/v20210501:SqlPoolTransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolTransparentDataEncryption to guarantee forwards compatibility.
func LookupSqlPoolTransparentDataEncryption(ctx *pulumi.Context, args *LookupSqlPoolTransparentDataEncryptionArgs, opts ...pulumi.InvokeOption) (*LookupSqlPoolTransparentDataEncryptionResult, error) {
	...
	err := ctx.Invoke("azure-native:synapse/v20210501:getSqlPoolTransparentDataEncryption", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
