...
func NewWorkspaceAadAdmin(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601:WorkspaceAadAdmin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceAadAdmin(ctx *pulumi.Context,
	...
	var resource WorkspaceAadAdmin
	err := ctx.ReadResource("azure-native:synapse/v20210601:WorkspaceAadAdmin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
