...
func LookupIntegrationRuntime(ctx *pulumi.Context, args *LookupIntegrationRuntimeArgs, opts ...pulumi.InvokeOption) (*LookupIntegrationRuntimeResult, error) {
	...
	err := ctx.Invoke("azure-native:synapse/v20210601:getIntegrationRuntime", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupIntegrationRuntimeOutput(ctx *pulumi.Context, args LookupIntegrationRuntimeOutputArgs, opts ...pulumi.InvokeOption) LookupIntegrationRuntimeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIntegrationRuntimeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:synapse/v20210601:getIntegrationRuntime", args, LookupIntegrationRuntimeResultOutput{}, options).(LookupIntegrationRuntimeResultOutput), nil
