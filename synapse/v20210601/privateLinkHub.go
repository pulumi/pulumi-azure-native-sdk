...
func NewPrivateLinkHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601:PrivateLinkHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkHub(ctx *pulumi.Context,
	...
	var resource PrivateLinkHub
	err := ctx.ReadResource("azure-native:synapse/v20210601:PrivateLinkHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
