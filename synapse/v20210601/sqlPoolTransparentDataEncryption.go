...
func NewSqlPoolTransparentDataEncryption(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601:SqlPoolTransparentDataEncryption", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPoolTransparentDataEncryption(ctx *pulumi.Context,
	...
	var resource SqlPoolTransparentDataEncryption
	err := ctx.ReadResource("azure-native:synapse/v20210601:SqlPoolTransparentDataEncryption", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
