...
// TransparentDataEncryptionStatusInput is an input type that accepts values of the TransparentDataEncryptionStatus enum
// A concrete instance of `TransparentDataEncryptionStatusInput` can be one of the following:
//
