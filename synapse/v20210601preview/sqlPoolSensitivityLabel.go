...
func NewSqlPoolSensitivityLabel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPoolSensitivityLabel(ctx *pulumi.Context,
	...
	var resource SqlPoolSensitivityLabel
	err := ctx.ReadResource("azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
