...
func NewSqlPoolWorkloadClassifier(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601preview:SqlPoolWorkloadClassifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPoolWorkloadClassifier(ctx *pulumi.Context,
	...
	var resource SqlPoolWorkloadClassifier
	err := ctx.ReadResource("azure-native:synapse/v20210601preview:SqlPoolWorkloadClassifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
