...
func NewSqlPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601preview:SqlPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlPool(ctx *pulumi.Context,
	...
	var resource SqlPool
	err := ctx.ReadResource("azure-native:synapse/v20210601preview:SqlPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
