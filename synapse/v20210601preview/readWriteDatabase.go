...
func NewReadWriteDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210601preview:ReadWriteDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadWriteDatabase(ctx *pulumi.Context,
	...
	var resource ReadWriteDatabase
	err := ctx.ReadResource("azure-native:synapse/v20210601preview:ReadWriteDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
