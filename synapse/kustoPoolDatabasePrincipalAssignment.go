...
func NewKustoPoolDatabasePrincipalAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse:KustoPoolDatabasePrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoPoolDatabasePrincipalAssignment(ctx *pulumi.Context,
	...
	var resource KustoPoolDatabasePrincipalAssignment
	err := ctx.ReadResource("azure-native:synapse:KustoPoolDatabasePrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
