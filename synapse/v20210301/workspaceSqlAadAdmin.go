...
func NewWorkspaceSqlAadAdmin(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210301:WorkspaceSqlAadAdmin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceSqlAadAdmin(ctx *pulumi.Context,
	...
	var resource WorkspaceSqlAadAdmin
	err := ctx.ReadResource("azure-native:synapse/v20210301:WorkspaceSqlAadAdmin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
