...
// A privateLinkHub
//
// Deprecated: azure-native:synapse/v20210301:PrivateLinkHub is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.
...
func NewPrivateLinkHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210301:PrivateLinkHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkHub(ctx *pulumi.Context,
	...
	var resource PrivateLinkHub
	err := ctx.ReadResource("azure-native:synapse/v20210301:PrivateLinkHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
