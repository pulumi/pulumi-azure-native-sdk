...
func (SkuSize) ElementType() reflect.Type {
	return reflect.TypeOf((*SkuSize)(nil)).Elem()
}

func (e SkuSize) ToSkuSizeOutput() SkuSizeOutput {
	return pulumi.ToOutput(e).(SkuSizeOutput)
}

func (e SkuSize) ToSkuSizeOutputWithContext(ctx context.Context) SkuSizeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(SkuSizeOutput)
}

func (e SkuSize) ToSkuSizePtrOutput() SkuSizePtrOutput {
	return e.ToSkuSizePtrOutputWithContext(context.Background())
}

func (e SkuSize) ToSkuSizePtrOutputWithContext(ctx context.Context) SkuSizePtrOutput {
	return SkuSize(e).ToSkuSizeOutputWithContext(ctx).ToSkuSizePtrOutputWithContext(ctx)
}
...
func (o SkuSizeOutput) ToSkuSizePtrOutput() SkuSizePtrOutput {
	return o.ToSkuSizePtrOutputWithContext(context.Background())
}

func (o SkuSizeOutput) ToSkuSizePtrOutputWithContext(ctx context.Context) SkuSizePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SkuSize) *SkuSize {
		return &v
	}).(SkuSizePtrOutput)
}
...
func (o SkuSizeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e SkuSize) string {
		return string(e)
	}).(pulumi.StringOutput)
}
...
func (o SkuSizePtrOutput) Elem() SkuSizeOutput {
	return o.ApplyT(func(v *SkuSize) SkuSize {
		if v != nil {
			return *v
		}
		var ret SkuSize
...
// SkuSizeInput is an input type that accepts values of the SkuSize enum
// A concrete instance of `SkuSizeInput` can be one of the following:
//
//	SkuSize_Extra_small
//	SkuSizeSmall
//	SkuSizeMedium
...
var skuSizePtrType = reflect.TypeOf((**SkuSize)(nil)).Elem()
...
type skuSizePtr string

func SkuSizePtr(v string) SkuSizePtrInput {
	return (*skuSizePtr)(&v)
}

func (*skuSizePtr) ElementType() reflect.Type {
	return skuSizePtrType
}

func (in *skuSizePtr) ToSkuSizePtrOutput() SkuSizePtrOutput {
	return pulumi.ToOutput(in).(SkuSizePtrOutput)
}

func (in *skuSizePtr) ToSkuSizePtrOutputWithContext(ctx context.Context) SkuSizePtrOutput {
...
func init() {
	...
	pulumi.RegisterOutputType(SkuSizeOutput{})
	pulumi.RegisterOutputType(SkuSizePtrOutput{})
