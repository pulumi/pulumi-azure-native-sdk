...
func NewIntegrationRuntime(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210401preview:IntegrationRuntime", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationRuntime(ctx *pulumi.Context,
	...
	var resource IntegrationRuntime
	err := ctx.ReadResource("azure-native:synapse/v20210401preview:IntegrationRuntime", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
