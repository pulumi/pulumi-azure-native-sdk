...
//
// Deprecated: azure-native:synapse/v20210401preview:WorkspaceSqlAadAdmin is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:WorkspaceSqlAadAdmin to guarantee forwards compatibility.
...
func NewWorkspaceSqlAadAdmin(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:synapse/v20210401preview:WorkspaceSqlAadAdmin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceSqlAadAdmin(ctx *pulumi.Context,
	...
	var resource WorkspaceSqlAadAdmin
	err := ctx.ReadResource("azure-native:synapse/v20210401preview:WorkspaceSqlAadAdmin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
