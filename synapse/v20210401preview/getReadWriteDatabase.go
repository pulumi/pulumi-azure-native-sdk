...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o GetReadWriteDatabaseResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v GetReadWriteDatabaseResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
