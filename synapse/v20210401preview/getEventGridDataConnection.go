...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o GetEventGridDataConnectionResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v GetEventGridDataConnectionResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
