...
func NewLinker(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicelinker/v20240401:Linker"),
		},
		{
			Type: pulumi.String("azure-native:servicelinker/v20240701preview:Linker"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Linker
	err := ctx.RegisterResource("azure-native:servicelinker:Linker", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinker(ctx *pulumi.Context,
	...
	var resource Linker
	err := ctx.ReadResource("azure-native:servicelinker:Linker", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o LinkerOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Linker) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LinkerOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *Linker) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
