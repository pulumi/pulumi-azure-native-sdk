...
func NewLinkerDryrun(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicelinker/v20230401preview:LinkerDryrun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkerDryrun(ctx *pulumi.Context,
	...
	var resource LinkerDryrun
	err := ctx.ReadResource("azure-native:servicelinker/v20230401preview:LinkerDryrun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
