...
func LookupLinker(ctx *pulumi.Context, args *LookupLinkerArgs, opts ...pulumi.InvokeOption) (*LookupLinkerResult, error) {
	...
	err := ctx.Invoke("azure-native:servicelinker/v20240401:getLinker", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupLinkerOutput(ctx *pulumi.Context, args LookupLinkerOutputArgs, opts ...pulumi.InvokeOption) LookupLinkerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLinkerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicelinker/v20240401:getLinker", args, LookupLinkerResultOutput{}, options).(LookupLinkerResultOutput), nil
