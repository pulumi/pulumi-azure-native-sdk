...
func NewConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicelinker/v20240401:Connector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnector(ctx *pulumi.Context,
	...
	var resource Connector
	err := ctx.ReadResource("azure-native:servicelinker/v20240401:Connector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
