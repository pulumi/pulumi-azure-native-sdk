...
func NewConnectorDryrun(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicelinker/v20240401:ConnectorDryrun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectorDryrun(ctx *pulumi.Context,
	...
	var resource ConnectorDryrun
	err := ctx.ReadResource("azure-native:servicelinker/v20240401:ConnectorDryrun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
