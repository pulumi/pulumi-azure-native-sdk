...
func LookupConnectorDryrun(ctx *pulumi.Context, args *LookupConnectorDryrunArgs, opts ...pulumi.InvokeOption) (*LookupConnectorDryrunResult, error) {
	...
	err := ctx.Invoke("azure-native:servicelinker/v20240701preview:getConnectorDryrun", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConnectorDryrunOutput(ctx *pulumi.Context, args LookupConnectorDryrunOutputArgs, opts ...pulumi.InvokeOption) LookupConnectorDryrunResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConnectorDryrunResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicelinker/v20240701preview:getConnectorDryrun", args, LookupConnectorDryrunResultOutput{}, options).(LookupConnectorDryrunResultOutput), nil
