...
func NewLinker(ctx *pulumi.Context,
	...
	var resource Linker
	err := ctx.RegisterResource("azure-native:servicelinker/v20211101preview:Linker", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinker(ctx *pulumi.Context,
	...
	var resource Linker
	err := ctx.ReadResource("azure-native:servicelinker/v20211101preview:Linker", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
