...
func ListAccountSas(ctx *pulumi.Context, args *ListAccountSasArgs, opts ...pulumi.InvokeOption) (*ListAccountSasResult, error) {
	...
	err := ctx.Invoke("azure-native:maps/v20240101preview:listAccountSas", args.Defaults(), &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAccountSasOutput(ctx *pulumi.Context, args ListAccountSasOutputArgs, opts ...pulumi.InvokeOption) ListAccountSasResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAccountSasResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:maps/v20240101preview:listAccountSas", args.Defaults(), ListAccountSasResultOutput{}, options).(ListAccountSasResultOutput), nil
