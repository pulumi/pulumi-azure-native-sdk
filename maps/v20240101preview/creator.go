...
func NewCreator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maps/v20240101preview:Creator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCreator(ctx *pulumi.Context,
	...
	var resource Creator
	err := ctx.ReadResource("azure-native:maps/v20240101preview:Creator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
