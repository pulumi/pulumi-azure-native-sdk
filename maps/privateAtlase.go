...
// The Azure API version of the resource.
func (o PrivateAtlaseOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PrivateAtlase) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
