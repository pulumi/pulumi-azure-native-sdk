...
func LookupCreator(ctx *pulumi.Context, args *LookupCreatorArgs, opts ...pulumi.InvokeOption) (*LookupCreatorResult, error) {
	...
	err := ctx.Invoke("azure-native:maps/v20230801preview:getCreator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCreatorOutput(ctx *pulumi.Context, args LookupCreatorOutputArgs, opts ...pulumi.InvokeOption) LookupCreatorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCreatorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:maps/v20230801preview:getCreator", args, LookupCreatorResultOutput{}, options).(LookupCreatorResultOutput), nil
