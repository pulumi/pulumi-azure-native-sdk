...
const (
	...
	AuthenticationMode_Pass_Through = AuthenticationMode("Pass-through")
)
...
func (PrivateLinkDelegation) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateLinkDelegation)(nil)).Elem()
}

func (e PrivateLinkDelegation) ToPrivateLinkDelegationOutput() PrivateLinkDelegationOutput {
	return pulumi.ToOutput(e).(PrivateLinkDelegationOutput)
}

func (e PrivateLinkDelegation) ToPrivateLinkDelegationOutputWithContext(ctx context.Context) PrivateLinkDelegationOutput {
	return pulumi.ToOutputWithContext(ctx, e).(PrivateLinkDelegationOutput)
}

func (e PrivateLinkDelegation) ToPrivateLinkDelegationPtrOutput() PrivateLinkDelegationPtrOutput {
	return e.ToPrivateLinkDelegationPtrOutputWithContext(context.Background())
}

func (e PrivateLinkDelegation) ToPrivateLinkDelegationPtrOutputWithContext(ctx context.Context) PrivateLinkDelegationPtrOutput {
	return PrivateLinkDelegation(e).ToPrivateLinkDelegationOutputWithContext(ctx).ToPrivateLinkDelegationPtrOutputWithContext(ctx)
}

func (e PrivateLinkDelegation) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e PrivateLinkDelegation) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e PrivateLinkDelegation) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e PrivateLinkDelegation) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type PrivateLinkDelegationOutput struct{ *pulumi.OutputState }

func (PrivateLinkDelegationOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateLinkDelegation)(nil)).Elem()
}

func (o PrivateLinkDelegationOutput) ToPrivateLinkDelegationOutput() PrivateLinkDelegationOutput {
	return o
}

func (o PrivateLinkDelegationOutput) ToPrivateLinkDelegationOutputWithContext(ctx context.Context) PrivateLinkDelegationOutput {
	return o
}

func (o PrivateLinkDelegationOutput) ToPrivateLinkDelegationPtrOutput() PrivateLinkDelegationPtrOutput {
	return o.ToPrivateLinkDelegationPtrOutputWithContext(context.Background())
}

func (o PrivateLinkDelegationOutput) ToPrivateLinkDelegationPtrOutputWithContext(ctx context.Context) PrivateLinkDelegationPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v PrivateLinkDelegation) *PrivateLinkDelegation {
		return &v
	}).(PrivateLinkDelegationPtrOutput)
}

func (o PrivateLinkDelegationOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o PrivateLinkDelegationOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PrivateLinkDelegation) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o PrivateLinkDelegationOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o PrivateLinkDelegationOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PrivateLinkDelegation) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type PrivateLinkDelegationPtrOutput struct{ *pulumi.OutputState }

func (PrivateLinkDelegationPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PrivateLinkDelegation)(nil)).Elem()
}

func (o PrivateLinkDelegationPtrOutput) ToPrivateLinkDelegationPtrOutput() PrivateLinkDelegationPtrOutput {
	return o
}

func (o PrivateLinkDelegationPtrOutput) ToPrivateLinkDelegationPtrOutputWithContext(ctx context.Context) PrivateLinkDelegationPtrOutput {
	return o
}

func (o PrivateLinkDelegationPtrOutput) Elem() PrivateLinkDelegationOutput {
	return o.ApplyT(func(v *PrivateLinkDelegation) PrivateLinkDelegation {
		if v != nil {
			return *v
		}
		var ret PrivateLinkDelegation
		return ret
	}).(PrivateLinkDelegationOutput)
}

func (o PrivateLinkDelegationPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o PrivateLinkDelegationPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *PrivateLinkDelegation) *string {
		if e == nil {
			return nil
		}
...
// PrivateLinkDelegationInput is an input type that accepts values of the PrivateLinkDelegation enum
// A concrete instance of `PrivateLinkDelegationInput` can be one of the following:
//
//	PrivateLinkDelegationEnabled
//	PrivateLinkDelegationDisabled
type PrivateLinkDelegationInput interface {
	pulumi.Input

	ToPrivateLinkDelegationOutput() PrivateLinkDelegationOutput
	ToPrivateLinkDelegationOutputWithContext(context.Context) PrivateLinkDelegationOutput
}

var privateLinkDelegationPtrType = reflect.TypeOf((**PrivateLinkDelegation)(nil)).Elem()

type PrivateLinkDelegationPtrInput interface {
	pulumi.Input

	ToPrivateLinkDelegationPtrOutput() PrivateLinkDelegationPtrOutput
	ToPrivateLinkDelegationPtrOutputWithContext(context.Context) PrivateLinkDelegationPtrOutput
}

type privateLinkDelegationPtr string

func PrivateLinkDelegationPtr(v string) PrivateLinkDelegationPtrInput {
	return (*privateLinkDelegationPtr)(&v)
}

func (*privateLinkDelegationPtr) ElementType() reflect.Type {
	return privateLinkDelegationPtrType
}

func (in *privateLinkDelegationPtr) ToPrivateLinkDelegationPtrOutput() PrivateLinkDelegationPtrOutput {
	return pulumi.ToOutput(in).(PrivateLinkDelegationPtrOutput)
}

func (in *privateLinkDelegationPtr) ToPrivateLinkDelegationPtrOutputWithContext(ctx context.Context) PrivateLinkDelegationPtrOutput {
...
func init() {
	...
	pulumi.RegisterOutputType(PrivateLinkDelegationOutput{})
	pulumi.RegisterOutputType(PrivateLinkDelegationPtrOutput{})
