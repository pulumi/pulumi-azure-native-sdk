...
func LookupConfigurationStore(ctx *pulumi.Context, args *LookupConfigurationStoreArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationStoreResult, error) {
	...
	err := ctx.Invoke("azure-native:appconfiguration/v20230901preview:getConfigurationStore", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupConfigurationStoreResult struct {
	...
	Experimentation *ExperimentationPropertiesResponse `pulumi:"experimentation"`
	...
	Telemetry *TelemetryPropertiesResponse `pulumi:"telemetry"`
...
func LookupConfigurationStoreOutput(ctx *pulumi.Context, args LookupConfigurationStoreOutputArgs, opts ...pulumi.InvokeOption) LookupConfigurationStoreResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConfigurationStoreResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appconfiguration/v20230901preview:getConfigurationStore", args, LookupConfigurationStoreResultOutput{}, options).(LookupConfigurationStoreResultOutput), nil
...
// Property specifying the configuration of experimentation for this configuration store
func (o LookupConfigurationStoreResultOutput) Experimentation() ExperimentationPropertiesResponsePtrOutput {
	return o.ApplyT(func(v LookupConfigurationStoreResult) *ExperimentationPropertiesResponse { return v.Experimentation }).(ExperimentationPropertiesResponsePtrOutput)
}
...
// Property specifying the configuration of telemetry for this configuration store
func (o LookupConfigurationStoreResultOutput) Telemetry() TelemetryPropertiesResponsePtrOutput {
	return o.ApplyT(func(v LookupConfigurationStoreResult) *TelemetryPropertiesResponse { return v.Telemetry }).(TelemetryPropertiesResponsePtrOutput)
}
