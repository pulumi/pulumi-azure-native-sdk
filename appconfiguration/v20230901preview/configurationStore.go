...
type ConfigurationStore struct {
	...
	Experimentation ExperimentationPropertiesResponsePtrOutput `pulumi:"experimentation"`
	...
	Telemetry TelemetryPropertiesResponsePtrOutput `pulumi:"telemetry"`
...
func NewConfigurationStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appconfiguration/v20230901preview:ConfigurationStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationStore(ctx *pulumi.Context,
	...
	var resource ConfigurationStore
	err := ctx.ReadResource("azure-native:appconfiguration/v20230901preview:ConfigurationStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type configurationStoreArgs struct {
	...
	// Property specifying the configuration of experimentation for this configuration store
	Experimentation *ExperimentationProperties `pulumi:"experimentation"`
	// The managed identity information, if configured.
	...
	// Property specifying the configuration of telemetry for this configuration store
	Telemetry *TelemetryProperties `pulumi:"telemetry"`
}
...
type ConfigurationStoreArgs struct {
	...
	// Property specifying the configuration of experimentation for this configuration store
	Experimentation ExperimentationPropertiesPtrInput
	// The managed identity information, if configured.
	...
	// Property specifying the configuration of telemetry for this configuration store
	Telemetry TelemetryPropertiesPtrInput
}
...
// Property specifying the configuration of experimentation for this configuration store
func (o ConfigurationStoreOutput) Experimentation() ExperimentationPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *ConfigurationStore) ExperimentationPropertiesResponsePtrOutput { return v.Experimentation }).(ExperimentationPropertiesResponsePtrOutput)
}
...
// Property specifying the configuration of telemetry for this configuration store
func (o ConfigurationStoreOutput) Telemetry() TelemetryPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *ConfigurationStore) TelemetryPropertiesResponsePtrOutput { return v.Telemetry }).(TelemetryPropertiesResponsePtrOutput)
}
