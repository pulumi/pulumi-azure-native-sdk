...
func NewConfigurationStore(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appconfiguration/v20240601:ConfigurationStore"),
		},
		{
			Type: pulumi.String("azure-native:appconfiguration/v20240615preview:ConfigurationStore"),
		},
		{
			Type: pulumi.String("azure-native:appconfiguration/v20250201preview:ConfigurationStore"),
		},
		{
			Type: pulumi.String("azure-native:appconfiguration/v20250601preview:ConfigurationStore"),
		},
		{
			Type: pulumi.String("azure-native:appconfiguration/v20250801preview:ConfigurationStore"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ConfigurationStore
	err := ctx.RegisterResource("azure-native:appconfiguration:ConfigurationStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationStore(ctx *pulumi.Context,
	...
	var resource ConfigurationStore
	err := ctx.ReadResource("azure-native:appconfiguration:ConfigurationStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
