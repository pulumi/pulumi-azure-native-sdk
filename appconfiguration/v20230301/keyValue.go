...
func NewKeyValue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appconfiguration/v20230301:KeyValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyValue(ctx *pulumi.Context,
	...
	var resource KeyValue
	err := ctx.ReadResource("azure-native:appconfiguration/v20230301:KeyValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
