...
func NewReplica(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appconfiguration/v20230301:Replica", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplica(ctx *pulumi.Context,
	...
	var resource Replica
	err := ctx.ReadResource("azure-native:appconfiguration/v20230301:Replica", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
