...
//
// Deprecated: azure-native:appconfiguration/v20220501:ConfigurationStore is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:ConfigurationStore to guarantee forwards compatibility.
...
func NewConfigurationStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appconfiguration/v20220501:ConfigurationStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationStore(ctx *pulumi.Context,
	...
	var resource ConfigurationStore
	err := ctx.ReadResource("azure-native:appconfiguration/v20220501:ConfigurationStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
