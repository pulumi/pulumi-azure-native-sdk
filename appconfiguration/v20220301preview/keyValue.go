...
//
// Deprecated: azure-native:appconfiguration/v20220301preview:KeyValue is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.
...
func NewKeyValue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appconfiguration/v20220301preview:KeyValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyValue(ctx *pulumi.Context,
	...
	var resource KeyValue
	err := ctx.ReadResource("azure-native:appconfiguration/v20220301preview:KeyValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
