...
func NewConfigurationStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appconfiguration/v20200701preview:ConfigurationStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationStore(ctx *pulumi.Context,
	...
	var resource ConfigurationStore
	err := ctx.ReadResource("azure-native:appconfiguration/v20200701preview:ConfigurationStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
