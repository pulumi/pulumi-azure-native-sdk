...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupBillingRoleAssignmentByEnrollmentAccountResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupBillingRoleAssignmentByEnrollmentAccountResult) commontypesv5.SystemDataResponse {
		return v.SystemData
