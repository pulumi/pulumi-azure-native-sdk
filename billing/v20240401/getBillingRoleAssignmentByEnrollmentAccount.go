...
func LookupBillingRoleAssignmentByEnrollmentAccount(ctx *pulumi.Context, args *LookupBillingRoleAssignmentByEnrollmentAccountArgs, opts ...pulumi.InvokeOption) (*LookupBillingRoleAssignmentByEnrollmentAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:billing/v20240401:getBillingRoleAssignmentByEnrollmentAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBillingRoleAssignmentByEnrollmentAccountOutput(ctx *pulumi.Context, args LookupBillingRoleAssignmentByEnrollmentAccountOutputArgs, opts ...pulumi.InvokeOption) LookupBillingRoleAssignmentByEnrollmentAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBillingRoleAssignmentByEnrollmentAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:billing/v20240401:getBillingRoleAssignmentByEnrollmentAccount", args, LookupBillingRoleAssignmentByEnrollmentAccountResultOutput{}, options).(LookupBillingRoleAssignmentByEnrollmentAccountResultOutput), nil
