...
func NewBillingRoleAssignmentByEnrollmentAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:billing/v20240401:BillingRoleAssignmentByEnrollmentAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingRoleAssignmentByEnrollmentAccount(ctx *pulumi.Context,
	...
	var resource BillingRoleAssignmentByEnrollmentAccount
	err := ctx.ReadResource("azure-native:billing/v20240401:BillingRoleAssignmentByEnrollmentAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
