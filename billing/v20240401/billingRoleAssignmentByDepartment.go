...
func NewBillingRoleAssignmentByDepartment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:billing/v20240401:BillingRoleAssignmentByDepartment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingRoleAssignmentByDepartment(ctx *pulumi.Context,
	...
	var resource BillingRoleAssignmentByDepartment
	err := ctx.ReadResource("azure-native:billing/v20240401:BillingRoleAssignmentByDepartment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
