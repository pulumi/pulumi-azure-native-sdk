...
func ListBillingAccountInvoiceSectionsByCreateSubscriptionPermission(ctx *pulumi.Context, args *ListBillingAccountInvoiceSectionsByCreateSubscriptionPermissionArgs, opts ...pulumi.InvokeOption) (*ListBillingAccountInvoiceSectionsByCreateSubscriptionPermissionResult, error) {
	...
	err := ctx.Invoke("azure-native:billing/v20240401:listBillingAccountInvoiceSectionsByCreateSubscriptionPermission", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListBillingAccountInvoiceSectionsByCreateSubscriptionPermissionOutput(ctx *pulumi.Context, args ListBillingAccountInvoiceSectionsByCreateSubscriptionPermissionOutputArgs, opts ...pulumi.InvokeOption) ListBillingAccountInvoiceSectionsByCreateSubscriptionPermissionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListBillingAccountInvoiceSectionsByCreateSubscriptionPermissionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:billing/v20240401:listBillingAccountInvoiceSectionsByCreateSubscriptionPermission", args, ListBillingAccountInvoiceSectionsByCreateSubscriptionPermissionResultOutput{}, options).(ListBillingAccountInvoiceSectionsByCreateSubscriptionPermissionResultOutput), nil
