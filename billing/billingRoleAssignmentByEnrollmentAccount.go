...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o BillingRoleAssignmentByEnrollmentAccountOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *BillingRoleAssignmentByEnrollmentAccount) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
