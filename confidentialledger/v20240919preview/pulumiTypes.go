...
type LedgerProperties struct {
	...
	MaxBodySizeInMb *int `pulumi:"maxBodySizeInMb"`
...
type LedgerPropertiesArgs struct {
	...
	// Enclave platform of the Confidential Ledger.
	EnclavePlatform pulumi.StringPtrInput `pulumi:"enclavePlatform"`
	// CCF Property for the logging level for the untrusted host: Trace, Debug, Info, Fail, Fatal.
	HostLevel pulumi.StringPtrInput `pulumi:"hostLevel"`
	// SKU associated with the ledger
	LedgerSku pulumi.StringPtrInput `pulumi:"ledgerSku"`
	// Type of Confidential Ledger
	LedgerType pulumi.StringPtrInput `pulumi:"ledgerType"`
	// CCF Property for the maximum size of the http request body: 1MB, 5MB, 10MB.
	MaxBodySizeInMb pulumi.IntPtrInput `pulumi:"maxBodySizeInMb"`
	// Number of CCF nodes in the ACC Ledger.
...
// Application type of the Confidential Ledger.
func (o LedgerPropertiesOutput) ApplicationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LedgerProperties) *string { return v.ApplicationType }).(pulumi.StringPtrOutput)
}
...
// Enclave platform of the Confidential Ledger.
func (o LedgerPropertiesOutput) EnclavePlatform() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LedgerProperties) *string { return v.EnclavePlatform }).(pulumi.StringPtrOutput)
}

// CCF Property for the logging level for the untrusted host: Trace, Debug, Info, Fail, Fatal.
func (o LedgerPropertiesOutput) HostLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LedgerProperties) *string { return v.HostLevel }).(pulumi.StringPtrOutput)
}
...
// CCF Property for the maximum size of the http request body: 1MB, 5MB, 10MB.
func (o LedgerPropertiesOutput) MaxBodySizeInMb() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LedgerProperties) *int { return v.MaxBodySizeInMb }).(pulumi.IntPtrOutput)
}

// Number of CCF nodes in the ACC Ledger.
func (o LedgerPropertiesOutput) NodeCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LedgerProperties) *int { return v.NodeCount }).(pulumi.IntPtrOutput)
}
...
// CCF Property for the subject name to include in the node certificate. Default: CN=CCF Node.
func (o LedgerPropertiesOutput) SubjectName() pulumi.StringPtrOutput {
...
// Application type of the Confidential Ledger.
func (o LedgerPropertiesPtrOutput) ApplicationType() pulumi.StringPtrOutput {
...
// Enclave platform of the Confidential Ledger.
func (o LedgerPropertiesPtrOutput) EnclavePlatform() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LedgerProperties) *string {
		if v == nil {
			return nil
		}
		return v.EnclavePlatform
	}).(pulumi.StringPtrOutput)
}

// CCF Property for the logging level for the untrusted host: Trace, Debug, Info, Fail, Fatal.
func (o LedgerPropertiesPtrOutput) HostLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LedgerProperties) *string {
		if v == nil {
			return nil
		}
...
// CCF Property for the maximum size of the http request body: 1MB, 5MB, 10MB.
func (o LedgerPropertiesPtrOutput) MaxBodySizeInMb() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *LedgerProperties) *int {
		if v == nil {
			return nil
		}
		return v.MaxBodySizeInMb
	}).(pulumi.IntPtrOutput)
}

// Number of CCF nodes in the ACC Ledger.
func (o LedgerPropertiesPtrOutput) NodeCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *LedgerProperties) *int {
		if v == nil {
			return nil
		}
...
// CCF Property for the subject name to include in the node certificate. Default: CN=CCF Node.
func (o LedgerPropertiesPtrOutput) SubjectName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LedgerProperties) *string {
		if v == nil {
			return nil
		}
...
// Application type of the Confidential Ledger.
func (o LedgerPropertiesResponseOutput) ApplicationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LedgerPropertiesResponse) *string { return v.ApplicationType }).(pulumi.StringPtrOutput)
}
...
// Enclave platform of the Confidential Ledger.
func (o LedgerPropertiesResponseOutput) EnclavePlatform() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LedgerPropertiesResponse) *string { return v.EnclavePlatform }).(pulumi.StringPtrOutput)
}

// CCF Property for the logging level for the untrusted host: Trace, Debug, Info, Fail, Fatal.
func (o LedgerPropertiesResponseOutput) HostLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LedgerPropertiesResponse) *string { return v.HostLevel }).(pulumi.StringPtrOutput)
}
...
// CCF Property for the maximum size of the http request body: 1MB, 5MB, 10MB.
func (o LedgerPropertiesResponseOutput) MaxBodySizeInMb() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LedgerPropertiesResponse) *int { return v.MaxBodySizeInMb }).(pulumi.IntPtrOutput)
}

// Number of CCF nodes in the ACC Ledger.
func (o LedgerPropertiesResponseOutput) NodeCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LedgerPropertiesResponse) *int { return v.NodeCount }).(pulumi.IntPtrOutput)
}
...
// Enclave platform of Managed CCF.
func (o ManagedCCFPropertiesOutput) EnclavePlatform() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ManagedCCFProperties) *string { return v.EnclavePlatform }).(pulumi.StringPtrOutput)
}
...
// Enclave platform of Managed CCF.
func (o ManagedCCFPropertiesPtrOutput) EnclavePlatform() pulumi.StringPtrOutput {
...
// Enclave platform of Managed CCF.
func (o ManagedCCFPropertiesResponseOutput) EnclavePlatform() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ManagedCCFPropertiesResponse) *string { return v.EnclavePlatform }).(pulumi.StringPtrOutput)
}
