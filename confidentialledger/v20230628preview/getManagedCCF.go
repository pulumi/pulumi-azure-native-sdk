...
func LookupManagedCCF(ctx *pulumi.Context, args *LookupManagedCCFArgs, opts ...pulumi.InvokeOption) (*LookupManagedCCFResult, error) {
	...
	err := ctx.Invoke("azure-native:confidentialledger/v20230628preview:getManagedCCF", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedCCFOutput(ctx *pulumi.Context, args LookupManagedCCFOutputArgs, opts ...pulumi.InvokeOption) LookupManagedCCFResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedCCFResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:confidentialledger/v20230628preview:getManagedCCF", args, LookupManagedCCFResultOutput{}, options).(LookupManagedCCFResultOutput), nil
