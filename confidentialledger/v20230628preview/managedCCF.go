...
func NewManagedCCF(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:confidentialledger/v20230628preview:ManagedCCF", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedCCF(ctx *pulumi.Context,
	...
	var resource ManagedCCF
	err := ctx.ReadResource("azure-native:confidentialledger/v20230628preview:ManagedCCF", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
