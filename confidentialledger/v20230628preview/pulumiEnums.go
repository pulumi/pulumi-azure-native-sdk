...
func (in *ledgerSkuPtr) ToOutput(ctx context.Context) pulumix.Output[*LedgerSku] {
	return pulumix.Output[*LedgerSku]{
		OutputState: in.ToLedgerSkuPtrOutputWithContext(ctx).OutputState,
	}
}
