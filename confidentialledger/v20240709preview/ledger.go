...
func NewLedger(ctx *pulumi.Context,
	...
	var resource Ledger
	err := ctx.RegisterResource("azure-native:confidentialledger/v20240709preview:Ledger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLedger(ctx *pulumi.Context,
	...
	var resource Ledger
	err := ctx.ReadResource("azure-native:confidentialledger/v20240709preview:Ledger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
