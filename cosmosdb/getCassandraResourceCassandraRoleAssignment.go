...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupCassandraResourceCassandraRoleAssignmentResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupCassandraResourceCassandraRoleAssignmentResult) commontypesv5.SystemDataResponse {
		return v.SystemData
