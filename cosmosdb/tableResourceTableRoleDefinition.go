...
func NewTableResourceTableRoleDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cosmosdb/v20241201preview:TableResourceTableRoleDefinition"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:TableResourceTableRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:TableResourceTableRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20241201preview:TableResourceTableRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb:TableResourceTableRoleDefinition"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TableResourceTableRoleDefinition
	err := ctx.RegisterResource("azure-native:cosmosdb:TableResourceTableRoleDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableResourceTableRoleDefinition(ctx *pulumi.Context,
	...
	var resource TableResourceTableRoleDefinition
	err := ctx.ReadResource("azure-native:cosmosdb:TableResourceTableRoleDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o TableResourceTableRoleDefinitionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TableResourceTableRoleDefinition) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
