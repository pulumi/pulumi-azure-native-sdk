...
func NewThroughputPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:ThroughputPool"),
		},
		{
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ThroughputPoolOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ThroughputPool) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
