...
// The configuration of the partition key to be used for partitioning data into multiple partitions
type ContainerPartitionKeyResponseV1 struct {
	// Indicates the kind of algorithm used for partitioning. For MultiHash, multiple partition keys (upto three maximum) are supported for container create
	Kind *string `pulumi:"kind"`
	// List of paths using which data within the container can be partitioned
	Paths []string `pulumi:"paths"`
...
// Defaults sets the appropriate defaults for ContainerPartitionKeyResponseV1
func (val *ContainerPartitionKeyResponseV1) Defaults() *ContainerPartitionKeyResponseV1 {
	if val == nil {
		return nil
	}
	tmp := *val
...
// The configuration of the partition key to be used for partitioning data into multiple partitions
type ContainerPartitionKeyResponseV1Output struct{ *pulumi.OutputState }

func (ContainerPartitionKeyResponseV1Output) ElementType() reflect.Type {
	return reflect.TypeOf((*ContainerPartitionKeyResponseV1)(nil)).Elem()
}

func (o ContainerPartitionKeyResponseV1Output) ToContainerPartitionKeyResponseV1Output() ContainerPartitionKeyResponseV1Output {
	return o
}

func (o ContainerPartitionKeyResponseV1Output) ToContainerPartitionKeyResponseV1OutputWithContext(ctx context.Context) ContainerPartitionKeyResponseV1Output {
	return o
}

// Indicates the kind of algorithm used for partitioning. For MultiHash, multiple partition keys (upto three maximum) are supported for container create
func (o ContainerPartitionKeyResponseV1Output) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContainerPartitionKeyResponseV1) *string { return v.Kind }).(pulumi.StringPtrOutput)
}

// List of paths using which data within the container can be partitioned
func (o ContainerPartitionKeyResponseV1Output) Paths() pulumi.StringArrayOutput {
	return o.ApplyT(func(v ContainerPartitionKeyResponseV1) []string { return v.Paths }).(pulumi.StringArrayOutput)
}

// Indicates if the container is using a system generated partition key
func (o ContainerPartitionKeyResponseV1Output) SystemKey() pulumi.BoolOutput {
	return o.ApplyT(func(v ContainerPartitionKeyResponseV1) bool { return v.SystemKey }).(pulumi.BoolOutput)
}

// Indicates the version of the partition key definition
func (o ContainerPartitionKeyResponseV1Output) Version() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ContainerPartitionKeyResponseV1) *int { return v.Version }).(pulumi.IntPtrOutput)
}

type ContainerPartitionKeyResponseV1PtrOutput struct{ *pulumi.OutputState }

func (ContainerPartitionKeyResponseV1PtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ContainerPartitionKeyResponseV1)(nil)).Elem()
}

func (o ContainerPartitionKeyResponseV1PtrOutput) ToContainerPartitionKeyResponseV1PtrOutput() ContainerPartitionKeyResponseV1PtrOutput {
	return o
}

func (o ContainerPartitionKeyResponseV1PtrOutput) ToContainerPartitionKeyResponseV1PtrOutputWithContext(ctx context.Context) ContainerPartitionKeyResponseV1PtrOutput {
	return o
}

func (o ContainerPartitionKeyResponseV1PtrOutput) Elem() ContainerPartitionKeyResponseV1Output {
	return o.ApplyT(func(v *ContainerPartitionKeyResponseV1) ContainerPartitionKeyResponseV1 {
		if v != nil {
			return *v
		}
		var ret ContainerPartitionKeyResponseV1
		return ret
	}).(ContainerPartitionKeyResponseV1Output)
}

// Indicates the kind of algorithm used for partitioning. For MultiHash, multiple partition keys (upto three maximum) are supported for container create
func (o ContainerPartitionKeyResponseV1PtrOutput) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContainerPartitionKeyResponseV1) *string {
		if v == nil {
			return nil
		}
		return v.Kind
...
// List of paths using which data within the container can be partitioned
func (o ContainerPartitionKeyResponseV1PtrOutput) Paths() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *ContainerPartitionKeyResponseV1) []string {
		if v == nil {
			return nil
		}
...
// Indicates if the container is using a system generated partition key
func (o ContainerPartitionKeyResponseV1PtrOutput) SystemKey() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *ContainerPartitionKeyResponseV1) *bool {
		if v == nil {
			return nil
		}
		return &v.SystemKey
...
// Indicates the version of the partition key definition
func (o ContainerPartitionKeyResponseV1PtrOutput) Version() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *ContainerPartitionKeyResponseV1) *int {
		if v == nil {
			return nil
		}
		return v.Version
...
// FullTextPathInput is an input type that accepts FullTextPathArgs and FullTextPathOutput values.
// You can construct a concrete instance of `FullTextPathInput` via:
//
//	FullTextPathArgs{...}
type FullTextPathInput interface {
	pulumi.Input

	ToFullTextPathOutput() FullTextPathOutput
	ToFullTextPathOutputWithContext(context.Context) FullTextPathOutput
}

// Represents the full text path specification.
type FullTextPathArgs struct {
	// The language of the full text field in the document.
...
func (FullTextPathArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*FullTextPath)(nil)).Elem()
}

func (i FullTextPathArgs) ToFullTextPathOutput() FullTextPathOutput {
	return i.ToFullTextPathOutputWithContext(context.Background())
}

func (i FullTextPathArgs) ToFullTextPathOutputWithContext(ctx context.Context) FullTextPathOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FullTextPathOutput)
}

// FullTextPathArrayInput is an input type that accepts FullTextPathArray and FullTextPathArrayOutput values.
// You can construct a concrete instance of `FullTextPathArrayInput` via:
//
//	FullTextPathArray{ FullTextPathArgs{...} }
type FullTextPathArrayInput interface {
	pulumi.Input

	ToFullTextPathArrayOutput() FullTextPathArrayOutput
	ToFullTextPathArrayOutputWithContext(context.Context) FullTextPathArrayOutput
}

type FullTextPathArray []FullTextPathInput

func (FullTextPathArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]FullTextPath)(nil)).Elem()
}

func (i FullTextPathArray) ToFullTextPathArrayOutput() FullTextPathArrayOutput {
	return i.ToFullTextPathArrayOutputWithContext(context.Background())
}

func (i FullTextPathArray) ToFullTextPathArrayOutputWithContext(ctx context.Context) FullTextPathArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FullTextPathArrayOutput)
}

// Represents the full text path specification.
type FullTextPathOutput struct{ *pulumi.OutputState }

func (FullTextPathOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FullTextPath)(nil)).Elem()
}

func (o FullTextPathOutput) ToFullTextPathOutput() FullTextPathOutput {
	return o
}

func (o FullTextPathOutput) ToFullTextPathOutputWithContext(ctx context.Context) FullTextPathOutput {
	return o
}

// The language of the full text field in the document.
func (o FullTextPathOutput) Language() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FullTextPath) *string { return v.Language }).(pulumi.StringPtrOutput)
}

// The path to the full text field in the document.
func (o FullTextPathOutput) Path() pulumi.StringOutput {
	return o.ApplyT(func(v FullTextPath) string { return v.Path }).(pulumi.StringOutput)
}

type FullTextPathArrayOutput struct{ *pulumi.OutputState }

func (FullTextPathArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]FullTextPath)(nil)).Elem()
}

func (o FullTextPathArrayOutput) ToFullTextPathArrayOutput() FullTextPathArrayOutput {
	return o
}

func (o FullTextPathArrayOutput) ToFullTextPathArrayOutputWithContext(ctx context.Context) FullTextPathArrayOutput {
	return o
}

func (o FullTextPathArrayOutput) Index(i pulumi.IntInput) FullTextPathOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) FullTextPath {
		return vs[0].([]FullTextPath)[vs[1].(int)]
	}).(FullTextPathOutput)
}

// Represents the full text path specification.
type FullTextPathResponse struct {
	// The language of the full text field in the document.
	Language *string `pulumi:"language"`
	// The path to the full text field in the document.
	Path string `pulumi:"path"`
...
// Represents the full text path specification.
type FullTextPathResponseOutput struct{ *pulumi.OutputState }

func (FullTextPathResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FullTextPathResponse)(nil)).Elem()
}

func (o FullTextPathResponseOutput) ToFullTextPathResponseOutput() FullTextPathResponseOutput {
	return o
}

func (o FullTextPathResponseOutput) ToFullTextPathResponseOutputWithContext(ctx context.Context) FullTextPathResponseOutput {
	return o
}

// The language of the full text field in the document.
func (o FullTextPathResponseOutput) Language() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FullTextPathResponse) *string { return v.Language }).(pulumi.StringPtrOutput)
}

// The path to the full text field in the document.
func (o FullTextPathResponseOutput) Path() pulumi.StringOutput {
	return o.ApplyT(func(v FullTextPathResponse) string { return v.Path }).(pulumi.StringOutput)
}

type FullTextPathResponseArrayOutput struct{ *pulumi.OutputState }

func (FullTextPathResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]FullTextPathResponse)(nil)).Elem()
}

func (o FullTextPathResponseArrayOutput) ToFullTextPathResponseArrayOutput() FullTextPathResponseArrayOutput {
	return o
}

func (o FullTextPathResponseArrayOutput) ToFullTextPathResponseArrayOutputWithContext(ctx context.Context) FullTextPathResponseArrayOutput {
	return o
}

func (o FullTextPathResponseArrayOutput) Index(i pulumi.IntInput) FullTextPathResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) FullTextPathResponse {
		return vs[0].([]FullTextPathResponse)[vs[1].(int)]
	}).(FullTextPathResponseOutput)
}
...
type FullTextPolicy struct {
	...
	FullTextPaths []FullTextPath `pulumi:"fullTextPaths"`
}

// FullTextPolicyInput is an input type that accepts FullTextPolicyArgs and FullTextPolicyOutput values.
// You can construct a concrete instance of `FullTextPolicyInput` via:
//
//	FullTextPolicyArgs{...}
type FullTextPolicyInput interface {
	pulumi.Input

	ToFullTextPolicyOutput() FullTextPolicyOutput
	ToFullTextPolicyOutputWithContext(context.Context) FullTextPolicyOutput
}

// Cosmos DB FullText Policy
type FullTextPolicyArgs struct {
	// The default language for a full text paths.
	DefaultLanguage pulumi.StringPtrInput `pulumi:"defaultLanguage"`
	// List of FullText Paths
	FullTextPaths FullTextPathArrayInput `pulumi:"fullTextPaths"`
}

func (FullTextPolicyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*FullTextPolicy)(nil)).Elem()
}

func (i FullTextPolicyArgs) ToFullTextPolicyOutput() FullTextPolicyOutput {
	return i.ToFullTextPolicyOutputWithContext(context.Background())
}

func (i FullTextPolicyArgs) ToFullTextPolicyOutputWithContext(ctx context.Context) FullTextPolicyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FullTextPolicyOutput)
}

func (i FullTextPolicyArgs) ToFullTextPolicyPtrOutput() FullTextPolicyPtrOutput {
	return i.ToFullTextPolicyPtrOutputWithContext(context.Background())
}

func (i FullTextPolicyArgs) ToFullTextPolicyPtrOutputWithContext(ctx context.Context) FullTextPolicyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FullTextPolicyOutput).ToFullTextPolicyPtrOutputWithContext(ctx)
}

// FullTextPolicyPtrInput is an input type that accepts FullTextPolicyArgs, FullTextPolicyPtr and FullTextPolicyPtrOutput values.
// You can construct a concrete instance of `FullTextPolicyPtrInput` via:
//
//	        FullTextPolicyArgs{...}
//
//	or:
//
//	        nil
type FullTextPolicyPtrInput interface {
	pulumi.Input

	ToFullTextPolicyPtrOutput() FullTextPolicyPtrOutput
	ToFullTextPolicyPtrOutputWithContext(context.Context) FullTextPolicyPtrOutput
}

type fullTextPolicyPtrType FullTextPolicyArgs

func FullTextPolicyPtr(v *FullTextPolicyArgs) FullTextPolicyPtrInput {
	return (*fullTextPolicyPtrType)(v)
}

func (*fullTextPolicyPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**FullTextPolicy)(nil)).Elem()
}

func (i *fullTextPolicyPtrType) ToFullTextPolicyPtrOutput() FullTextPolicyPtrOutput {
	return i.ToFullTextPolicyPtrOutputWithContext(context.Background())
}

func (i *fullTextPolicyPtrType) ToFullTextPolicyPtrOutputWithContext(ctx context.Context) FullTextPolicyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FullTextPolicyPtrOutput)
}

// Cosmos DB FullText Policy
type FullTextPolicyOutput struct{ *pulumi.OutputState }

func (FullTextPolicyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FullTextPolicy)(nil)).Elem()
}

func (o FullTextPolicyOutput) ToFullTextPolicyOutput() FullTextPolicyOutput {
	return o
}

func (o FullTextPolicyOutput) ToFullTextPolicyOutputWithContext(ctx context.Context) FullTextPolicyOutput {
	return o
}

func (o FullTextPolicyOutput) ToFullTextPolicyPtrOutput() FullTextPolicyPtrOutput {
	return o.ToFullTextPolicyPtrOutputWithContext(context.Background())
}

func (o FullTextPolicyOutput) ToFullTextPolicyPtrOutputWithContext(ctx context.Context) FullTextPolicyPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v FullTextPolicy) *FullTextPolicy {
		return &v
	}).(FullTextPolicyPtrOutput)
}

// The default language for a full text paths.
func (o FullTextPolicyOutput) DefaultLanguage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FullTextPolicy) *string { return v.DefaultLanguage }).(pulumi.StringPtrOutput)
}

// List of FullText Paths
func (o FullTextPolicyOutput) FullTextPaths() FullTextPathArrayOutput {
	return o.ApplyT(func(v FullTextPolicy) []FullTextPath { return v.FullTextPaths }).(FullTextPathArrayOutput)
}

type FullTextPolicyPtrOutput struct{ *pulumi.OutputState }

func (FullTextPolicyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**FullTextPolicy)(nil)).Elem()
}

func (o FullTextPolicyPtrOutput) ToFullTextPolicyPtrOutput() FullTextPolicyPtrOutput {
	return o
}

func (o FullTextPolicyPtrOutput) ToFullTextPolicyPtrOutputWithContext(ctx context.Context) FullTextPolicyPtrOutput {
	return o
}

func (o FullTextPolicyPtrOutput) Elem() FullTextPolicyOutput {
	return o.ApplyT(func(v *FullTextPolicy) FullTextPolicy {
		if v != nil {
			return *v
		}
		var ret FullTextPolicy
		return ret
	}).(FullTextPolicyOutput)
}

// The default language for a full text paths.
func (o FullTextPolicyPtrOutput) DefaultLanguage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FullTextPolicy) *string {
		if v == nil {
			return nil
		}
...
// List of FullText Paths
func (o FullTextPolicyPtrOutput) FullTextPaths() FullTextPathArrayOutput {
	return o.ApplyT(func(v *FullTextPolicy) []FullTextPath {
		if v == nil {
			return nil
		}
		return v.FullTextPaths
	}).(FullTextPathArrayOutput)
}

// Cosmos DB FullText Policy
type FullTextPolicyResponse struct {
	// The default language for a full text paths.
	DefaultLanguage *string `pulumi:"defaultLanguage"`
	// List of FullText Paths
	FullTextPaths []FullTextPathResponse `pulumi:"fullTextPaths"`
}

// Cosmos DB FullText Policy
type FullTextPolicyResponseOutput struct{ *pulumi.OutputState }

func (FullTextPolicyResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FullTextPolicyResponse)(nil)).Elem()
}

func (o FullTextPolicyResponseOutput) ToFullTextPolicyResponseOutput() FullTextPolicyResponseOutput {
	return o
}

func (o FullTextPolicyResponseOutput) ToFullTextPolicyResponseOutputWithContext(ctx context.Context) FullTextPolicyResponseOutput {
	return o
}

// The default language for a full text paths.
func (o FullTextPolicyResponseOutput) DefaultLanguage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FullTextPolicyResponse) *string { return v.DefaultLanguage }).(pulumi.StringPtrOutput)
}

// List of FullText Paths
func (o FullTextPolicyResponseOutput) FullTextPaths() FullTextPathResponseArrayOutput {
	return o.ApplyT(func(v FullTextPolicyResponse) []FullTextPathResponse { return v.FullTextPaths }).(FullTextPathResponseArrayOutput)
}

type FullTextPolicyResponsePtrOutput struct{ *pulumi.OutputState }

func (FullTextPolicyResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**FullTextPolicyResponse)(nil)).Elem()
}

func (o FullTextPolicyResponsePtrOutput) ToFullTextPolicyResponsePtrOutput() FullTextPolicyResponsePtrOutput {
	return o
}

func (o FullTextPolicyResponsePtrOutput) ToFullTextPolicyResponsePtrOutputWithContext(ctx context.Context) FullTextPolicyResponsePtrOutput {
	return o
}

func (o FullTextPolicyResponsePtrOutput) Elem() FullTextPolicyResponseOutput {
	return o.ApplyT(func(v *FullTextPolicyResponse) FullTextPolicyResponse {
		if v != nil {
			return *v
		}
		var ret FullTextPolicyResponse
		return ret
	}).(FullTextPolicyResponseOutput)
}

// The default language for a full text paths.
func (o FullTextPolicyResponsePtrOutput) DefaultLanguage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FullTextPolicyResponse) *string {
		if v == nil {
			return nil
		}
		return v.DefaultLanguage
...
// List of FullText Paths
func (o FullTextPolicyResponsePtrOutput) FullTextPaths() FullTextPathResponseArrayOutput {
	return o.ApplyT(func(v *FullTextPolicyResponse) []FullTextPathResponse {
		if v == nil {
			return nil
		}
		return v.FullTextPaths
...
type GarnetClusterResourcePropertiesEndPointsItemResponse struct {
...
// Endpoint for clients to connect to the cluster.
type GarnetClusterResourcePropertiesEndPointsItemResponseOutput struct{ *pulumi.OutputState }

func (GarnetClusterResourcePropertiesEndPointsItemResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GarnetClusterResourcePropertiesEndPointsItemResponse)(nil)).Elem()
}

func (o GarnetClusterResourcePropertiesEndPointsItemResponseOutput) ToGarnetClusterResourcePropertiesEndPointsItemResponseOutput() GarnetClusterResourcePropertiesEndPointsItemResponseOutput {
	return o
}

func (o GarnetClusterResourcePropertiesEndPointsItemResponseOutput) ToGarnetClusterResourcePropertiesEndPointsItemResponseOutputWithContext(ctx context.Context) GarnetClusterResourcePropertiesEndPointsItemResponseOutput {
	return o
}

// Ipv4 address of the endpoint.
func (o GarnetClusterResourcePropertiesEndPointsItemResponseOutput) IpAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesEndPointsItemResponse) *string { return v.IpAddress }).(pulumi.StringPtrOutput)
}

// Port number.
func (o GarnetClusterResourcePropertiesEndPointsItemResponseOutput) Port() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesEndPointsItemResponse) *int { return v.Port }).(pulumi.IntPtrOutput)
}

type GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput struct{ *pulumi.OutputState }

func (GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GarnetClusterResourcePropertiesEndPointsItemResponse)(nil)).Elem()
}

func (o GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput) ToGarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput() GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput {
	return o
}

func (o GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput) ToGarnetClusterResourcePropertiesEndPointsItemResponseArrayOutputWithContext(ctx context.Context) GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput {
	return o
}

func (o GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput) Index(i pulumi.IntInput) GarnetClusterResourcePropertiesEndPointsItemResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GarnetClusterResourcePropertiesEndPointsItemResponse {
		return vs[0].([]GarnetClusterResourcePropertiesEndPointsItemResponse)[vs[1].(int)]
	}).(GarnetClusterResourcePropertiesEndPointsItemResponseOutput)
}

// Properties of a Garnet cache cluster.
type GarnetClusterResourcePropertiesResponse struct {
	// Allocation state of the cluster and data center resources. Active implies the virtual machines of the cluster are allocated, deallocated implies virtual machines and resources are deallocated.
	AllocationState *string `pulumi:"allocationState"`
	// If the data center has Availability Zone support, apply it to the Virtual Machine ScaleSet that host the garnet cluster virtual machines.
	AvailabilityZone *bool `pulumi:"availabilityZone"`
	...
	EndPoints []GarnetClusterResourcePropertiesEndPointsItemResponse `pulumi:"endPoints"`
	// Extensions to be added or updated on cluster.
	Extensions []string `pulumi:"extensions"`
	// Number of nodes.
	NodeCount *int `pulumi:"nodeCount"`
...
// Properties of a Garnet cache cluster.
type GarnetClusterResourcePropertiesResponseOutput struct{ *pulumi.OutputState }

func (GarnetClusterResourcePropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GarnetClusterResourcePropertiesResponse)(nil)).Elem()
}

func (o GarnetClusterResourcePropertiesResponseOutput) ToGarnetClusterResourcePropertiesResponseOutput() GarnetClusterResourcePropertiesResponseOutput {
	return o
}

func (o GarnetClusterResourcePropertiesResponseOutput) ToGarnetClusterResourcePropertiesResponseOutputWithContext(ctx context.Context) GarnetClusterResourcePropertiesResponseOutput {
	return o
}

// Allocation state of the cluster and data center resources. Active implies the virtual machines of the cluster are allocated, deallocated implies virtual machines and resources are deallocated.
func (o GarnetClusterResourcePropertiesResponseOutput) AllocationState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) *string { return v.AllocationState }).(pulumi.StringPtrOutput)
}

// If the data center has Availability Zone support, apply it to the Virtual Machine ScaleSet that host the garnet cluster virtual machines.
func (o GarnetClusterResourcePropertiesResponseOutput) AvailabilityZone() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) *bool { return v.AvailabilityZone }).(pulumi.BoolPtrOutput)
}

// Type of the cluster. If set to Production, some operations might not be permitted on cluster.
func (o GarnetClusterResourcePropertiesResponseOutput) ClusterType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) *string { return v.ClusterType }).(pulumi.StringPtrOutput)
}

// Endpoints for clients to connect to the cluster.
func (o GarnetClusterResourcePropertiesResponseOutput) EndPoints() GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) []GarnetClusterResourcePropertiesEndPointsItemResponse {
		return v.EndPoints
	}).(GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput)
}

// Extensions to be added or updated on cluster.
func (o GarnetClusterResourcePropertiesResponseOutput) Extensions() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) []string { return v.Extensions }).(pulumi.StringArrayOutput)
}

// Number of nodes.
func (o GarnetClusterResourcePropertiesResponseOutput) NodeCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) *int { return v.NodeCount }).(pulumi.IntPtrOutput)
}

// Virtual Machine SKU used for clusters. Default value is Standard_DS14_v2.
func (o GarnetClusterResourcePropertiesResponseOutput) NodeSku() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) *string { return v.NodeSku }).(pulumi.StringPtrOutput)
}

// Error related to resource provisioning.
func (o GarnetClusterResourcePropertiesResponseOutput) ProvisionError() ErrorDetailResponsePtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) *ErrorDetailResponse { return v.ProvisionError }).(ErrorDetailResponsePtrOutput)
}

// The provisioning state of the resource.
func (o GarnetClusterResourcePropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

// Number of copies of data maintained by the cluster.
func (o GarnetClusterResourcePropertiesResponseOutput) ReplicationFactor() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) *int { return v.ReplicationFactor }).(pulumi.IntPtrOutput)
}

// Resource id of a subnet that this cluster's management service should have its network interface attached to. The subnet must be routable to all subnets that will be delegated to data centers. The resource id must be of the form '/subscriptions/<subscription id>/resourceGroups/<resource group>/providers/Microsoft.Network/virtualNetworks/<virtual network>/subnets/<subnet>'
func (o GarnetClusterResourcePropertiesResponseOutput) SubnetId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GarnetClusterResourcePropertiesResponse) *string { return v.SubnetId }).(pulumi.StringPtrOutput)
}
...
// The configuration of the indexing policy. By default, the indexing is automatic for all document paths within the graph
func (o GremlinGraphGetPropertiesResponseResourceOutput) IndexingPolicy() IndexingPolicyResponseV1PtrOutput {
	return o.ApplyT(func(v GremlinGraphGetPropertiesResponseResource) *IndexingPolicyResponseV1 { return v.IndexingPolicy }).(IndexingPolicyResponseV1PtrOutput)
}

// The configuration of the partition key to be used for partitioning data into multiple partitions
func (o GremlinGraphGetPropertiesResponseResourceOutput) PartitionKey() ContainerPartitionKeyResponseV1PtrOutput {
	return o.ApplyT(func(v GremlinGraphGetPropertiesResponseResource) *ContainerPartitionKeyResponseV1 {
...
// The configuration of the indexing policy. By default, the indexing is automatic for all document paths within the graph
func (o GremlinGraphGetPropertiesResponseResourcePtrOutput) IndexingPolicy() IndexingPolicyResponseV1PtrOutput {
	return o.ApplyT(func(v *GremlinGraphGetPropertiesResponseResource) *IndexingPolicyResponseV1 {
		if v == nil {
			return nil
		}
...
// The configuration of the partition key to be used for partitioning data into multiple partitions
func (o GremlinGraphGetPropertiesResponseResourcePtrOutput) PartitionKey() ContainerPartitionKeyResponseV1PtrOutput {
	return o.ApplyT(func(v *GremlinGraphGetPropertiesResponseResource) *ContainerPartitionKeyResponseV1 {
		if v == nil {
			return nil
		}
...
type IndexingPolicy struct {
	...
	VectorIndexes []VectorIndex `pulumi:"vectorIndexes"`
}
...
type IndexingPolicyArgs struct {
	...
	// List of paths to include in the vector indexing
	VectorIndexes VectorIndexArrayInput `pulumi:"vectorIndexes"`
}
...
// List of paths to include in the vector indexing
func (o IndexingPolicyOutput) VectorIndexes() VectorIndexArrayOutput {
	return o.ApplyT(func(v IndexingPolicy) []VectorIndex { return v.VectorIndexes }).(VectorIndexArrayOutput)
}
...
// List of paths to include in the vector indexing
func (o IndexingPolicyPtrOutput) VectorIndexes() VectorIndexArrayOutput {
	return o.ApplyT(func(v *IndexingPolicy) []VectorIndex {
		if v == nil {
			return nil
		}
		return v.VectorIndexes
	}).(VectorIndexArrayOutput)
}
...
// Cosmos DB indexing policy
type IndexingPolicyResponseV1 struct {
	// Indicates if the indexing policy is automatic
	Automatic *bool `pulumi:"automatic"`
	// List of composite path list
...
// Defaults sets the appropriate defaults for IndexingPolicyResponseV1
func (val *IndexingPolicyResponseV1) Defaults() *IndexingPolicyResponseV1 {
	if val == nil {
		return nil
	}
	tmp := *val
...
// Cosmos DB indexing policy
type IndexingPolicyResponseV1Output struct{ *pulumi.OutputState }

func (IndexingPolicyResponseV1Output) ElementType() reflect.Type {
	return reflect.TypeOf((*IndexingPolicyResponseV1)(nil)).Elem()
}

func (o IndexingPolicyResponseV1Output) ToIndexingPolicyResponseV1Output() IndexingPolicyResponseV1Output {
	return o
}

func (o IndexingPolicyResponseV1Output) ToIndexingPolicyResponseV1OutputWithContext(ctx context.Context) IndexingPolicyResponseV1Output {
	return o
}

// Indicates if the indexing policy is automatic
func (o IndexingPolicyResponseV1Output) Automatic() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v IndexingPolicyResponseV1) *bool { return v.Automatic }).(pulumi.BoolPtrOutput)
}

// List of composite path list
func (o IndexingPolicyResponseV1Output) CompositeIndexes() CompositePathResponseArrayArrayOutput {
	return o.ApplyT(func(v IndexingPolicyResponseV1) [][]CompositePathResponse { return v.CompositeIndexes }).(CompositePathResponseArrayArrayOutput)
}

// List of paths to exclude from indexing
func (o IndexingPolicyResponseV1Output) ExcludedPaths() ExcludedPathResponseArrayOutput {
	return o.ApplyT(func(v IndexingPolicyResponseV1) []ExcludedPathResponse { return v.ExcludedPaths }).(ExcludedPathResponseArrayOutput)
}

// List of paths to include in the full text indexing
func (o IndexingPolicyResponseV1Output) FullTextIndexes() FullTextIndexPathResponseArrayOutput {
	return o.ApplyT(func(v IndexingPolicyResponseV1) []FullTextIndexPathResponse { return v.FullTextIndexes }).(FullTextIndexPathResponseArrayOutput)
}

// List of paths to include in the indexing
func (o IndexingPolicyResponseV1Output) IncludedPaths() IncludedPathResponseArrayOutput {
	return o.ApplyT(func(v IndexingPolicyResponseV1) []IncludedPathResponse { return v.IncludedPaths }).(IncludedPathResponseArrayOutput)
}

// Indicates the indexing mode.
func (o IndexingPolicyResponseV1Output) IndexingMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IndexingPolicyResponseV1) *string { return v.IndexingMode }).(pulumi.StringPtrOutput)
}

// List of spatial specifics
func (o IndexingPolicyResponseV1Output) SpatialIndexes() SpatialSpecResponseArrayOutput {
	return o.ApplyT(func(v IndexingPolicyResponseV1) []SpatialSpecResponse { return v.SpatialIndexes }).(SpatialSpecResponseArrayOutput)
}

// List of paths to include in the vector indexing
func (o IndexingPolicyResponseV1Output) VectorIndexes() VectorIndexResponseArrayOutput {
	return o.ApplyT(func(v IndexingPolicyResponseV1) []VectorIndexResponse { return v.VectorIndexes }).(VectorIndexResponseArrayOutput)
}

type IndexingPolicyResponseV1PtrOutput struct{ *pulumi.OutputState }

func (IndexingPolicyResponseV1PtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**IndexingPolicyResponseV1)(nil)).Elem()
}

func (o IndexingPolicyResponseV1PtrOutput) ToIndexingPolicyResponseV1PtrOutput() IndexingPolicyResponseV1PtrOutput {
	return o
}

func (o IndexingPolicyResponseV1PtrOutput) ToIndexingPolicyResponseV1PtrOutputWithContext(ctx context.Context) IndexingPolicyResponseV1PtrOutput {
	return o
}

func (o IndexingPolicyResponseV1PtrOutput) Elem() IndexingPolicyResponseV1Output {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) IndexingPolicyResponseV1 {
		if v != nil {
			return *v
		}
		var ret IndexingPolicyResponseV1
		return ret
	}).(IndexingPolicyResponseV1Output)
}

// Indicates if the indexing policy is automatic
func (o IndexingPolicyResponseV1PtrOutput) Automatic() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) *bool {
		if v == nil {
			return nil
		}
		return v.Automatic
...
// List of composite path list
func (o IndexingPolicyResponseV1PtrOutput) CompositeIndexes() CompositePathResponseArrayArrayOutput {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) [][]CompositePathResponse {
		if v == nil {
			return nil
		}
		return v.CompositeIndexes
...
// List of paths to exclude from indexing
func (o IndexingPolicyResponseV1PtrOutput) ExcludedPaths() ExcludedPathResponseArrayOutput {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) []ExcludedPathResponse {
		if v == nil {
			return nil
		}
		return v.ExcludedPaths
...
// List of paths to include in the full text indexing
func (o IndexingPolicyResponseV1PtrOutput) FullTextIndexes() FullTextIndexPathResponseArrayOutput {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) []FullTextIndexPathResponse {
		if v == nil {
			return nil
		}
		return v.FullTextIndexes
...
// List of paths to include in the indexing
func (o IndexingPolicyResponseV1PtrOutput) IncludedPaths() IncludedPathResponseArrayOutput {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) []IncludedPathResponse {
		if v == nil {
			return nil
		}
		return v.IncludedPaths
...
// Indicates the indexing mode.
func (o IndexingPolicyResponseV1PtrOutput) IndexingMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) *string {
		if v == nil {
			return nil
		}
		return v.IndexingMode
...
// List of spatial specifics
func (o IndexingPolicyResponseV1PtrOutput) SpatialIndexes() SpatialSpecResponseArrayOutput {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) []SpatialSpecResponse {
		if v == nil {
			return nil
		}
		return v.SpatialIndexes
...
// List of paths to include in the vector indexing
func (o IndexingPolicyResponseV1PtrOutput) VectorIndexes() VectorIndexResponseArrayOutput {
	return o.ApplyT(func(v *IndexingPolicyResponseV1) []VectorIndexResponse {
		if v == nil {
			return nil
		}
		return v.VectorIndexes
...
// The set of data plane operations permitted through this Role Definition.
type PermissionResponseV1 struct {
	// An array of data actions that are allowed.
	DataActions []string `pulumi:"dataActions"`
	// An array of data actions that are denied.
	NotDataActions []string `pulumi:"notDataActions"`
...
// The set of data plane operations permitted through this Role Definition.
type PermissionResponseV1Output struct{ *pulumi.OutputState }

func (PermissionResponseV1Output) ElementType() reflect.Type {
	return reflect.TypeOf((*PermissionResponseV1)(nil)).Elem()
}

func (o PermissionResponseV1Output) ToPermissionResponseV1Output() PermissionResponseV1Output {
	return o
}

func (o PermissionResponseV1Output) ToPermissionResponseV1OutputWithContext(ctx context.Context) PermissionResponseV1Output {
	return o
}

// An array of data actions that are allowed.
func (o PermissionResponseV1Output) DataActions() pulumi.StringArrayOutput {
	return o.ApplyT(func(v PermissionResponseV1) []string { return v.DataActions }).(pulumi.StringArrayOutput)
}

// An array of data actions that are denied.
func (o PermissionResponseV1Output) NotDataActions() pulumi.StringArrayOutput {
	return o.ApplyT(func(v PermissionResponseV1) []string { return v.NotDataActions }).(pulumi.StringArrayOutput)
}

type PermissionResponseV1ArrayOutput struct{ *pulumi.OutputState }

func (PermissionResponseV1ArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]PermissionResponseV1)(nil)).Elem()
}

func (o PermissionResponseV1ArrayOutput) ToPermissionResponseV1ArrayOutput() PermissionResponseV1ArrayOutput {
	return o
}

func (o PermissionResponseV1ArrayOutput) ToPermissionResponseV1ArrayOutputWithContext(ctx context.Context) PermissionResponseV1ArrayOutput {
	return o
}

func (o PermissionResponseV1ArrayOutput) Index(i pulumi.IntInput) PermissionResponseV1Output {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) PermissionResponseV1 {
		return vs[0].([]PermissionResponseV1)[vs[1].(int)]
	}).(PermissionResponseV1Output)
}
...
type SqlContainerGetPropertiesResponseResource struct {
	...
	FullTextPolicy *FullTextPolicyResponse `pulumi:"fullTextPolicy"`
	...
	VectorEmbeddingPolicy *VectorEmbeddingPolicyResponse `pulumi:"vectorEmbeddingPolicy"`
}
...
// The FullText policy for the container.
func (o SqlContainerGetPropertiesResponseResourceOutput) FullTextPolicy() FullTextPolicyResponsePtrOutput {
	return o.ApplyT(func(v SqlContainerGetPropertiesResponseResource) *FullTextPolicyResponse { return v.FullTextPolicy }).(FullTextPolicyResponsePtrOutput)
}
...
// The vector embedding policy for the container.
func (o SqlContainerGetPropertiesResponseResourceOutput) VectorEmbeddingPolicy() VectorEmbeddingPolicyResponsePtrOutput {
	return o.ApplyT(func(v SqlContainerGetPropertiesResponseResource) *VectorEmbeddingPolicyResponse {
		return v.VectorEmbeddingPolicy
	}).(VectorEmbeddingPolicyResponsePtrOutput)
}
...
// The FullText policy for the container.
func (o SqlContainerGetPropertiesResponseResourcePtrOutput) FullTextPolicy() FullTextPolicyResponsePtrOutput {
	return o.ApplyT(func(v *SqlContainerGetPropertiesResponseResource) *FullTextPolicyResponse {
		if v == nil {
			return nil
		}
		return v.FullTextPolicy
	}).(FullTextPolicyResponsePtrOutput)
}
...
// The vector embedding policy for the container.
func (o SqlContainerGetPropertiesResponseResourcePtrOutput) VectorEmbeddingPolicy() VectorEmbeddingPolicyResponsePtrOutput {
	return o.ApplyT(func(v *SqlContainerGetPropertiesResponseResource) *VectorEmbeddingPolicyResponse {
		if v == nil {
			return nil
		}
...
type SqlContainerResource struct {
	...
	DefaultTtl *int `pulumi:"defaultTtl"`
	// The FullText policy for the container.
	FullTextPolicy *FullTextPolicy `pulumi:"fullTextPolicy"`
	// Name of the Cosmos DB SQL container
	Id string `pulumi:"id"`
	// The configuration of the indexing policy. By default, the indexing is automatic for all document paths within the container
	IndexingPolicy *IndexingPolicy `pulumi:"indexingPolicy"`
	...
	UniqueKeyPolicy *UniqueKeyPolicy `pulumi:"uniqueKeyPolicy"`
	// The vector embedding policy for the container.
	VectorEmbeddingPolicy *VectorEmbeddingPolicy `pulumi:"vectorEmbeddingPolicy"`
}
...
type SqlContainerResourceArgs struct {
	...
	DefaultTtl pulumi.IntPtrInput `pulumi:"defaultTtl"`
	// The FullText policy for the container.
	FullTextPolicy FullTextPolicyPtrInput `pulumi:"fullTextPolicy"`
	// Name of the Cosmos DB SQL container
	Id pulumi.StringInput `pulumi:"id"`
	// The configuration of the indexing policy. By default, the indexing is automatic for all document paths within the container
	IndexingPolicy IndexingPolicyPtrInput `pulumi:"indexingPolicy"`
	...
	UniqueKeyPolicy UniqueKeyPolicyPtrInput `pulumi:"uniqueKeyPolicy"`
	// The vector embedding policy for the container.
	VectorEmbeddingPolicy VectorEmbeddingPolicyPtrInput `pulumi:"vectorEmbeddingPolicy"`
}
...
// The FullText policy for the container.
func (o SqlContainerResourceOutput) FullTextPolicy() FullTextPolicyPtrOutput {
	return o.ApplyT(func(v SqlContainerResource) *FullTextPolicy { return v.FullTextPolicy }).(FullTextPolicyPtrOutput)
}
...
// The vector embedding policy for the container.
func (o SqlContainerResourceOutput) VectorEmbeddingPolicy() VectorEmbeddingPolicyPtrOutput {
	return o.ApplyT(func(v SqlContainerResource) *VectorEmbeddingPolicy { return v.VectorEmbeddingPolicy }).(VectorEmbeddingPolicyPtrOutput)
}
...
type VectorEmbedding struct {
	...
	DistanceFunction string `pulumi:"distanceFunction"`
	// The path to the vector field in the document.
	Path string `pulumi:"path"`
}

// VectorEmbeddingInput is an input type that accepts VectorEmbeddingArgs and VectorEmbeddingOutput values.
// You can construct a concrete instance of `VectorEmbeddingInput` via:
//
//	VectorEmbeddingArgs{...}
type VectorEmbeddingInput interface {
	pulumi.Input

	ToVectorEmbeddingOutput() VectorEmbeddingOutput
	ToVectorEmbeddingOutputWithContext(context.Context) VectorEmbeddingOutput
}

// Represents a vector embedding. A vector embedding is used to define a vector field in the documents.
type VectorEmbeddingArgs struct {
	// Indicates the data type of vector.
	DataType pulumi.StringInput `pulumi:"dataType"`
	// The number of dimensions in the vector.
	Dimensions pulumi.IntInput `pulumi:"dimensions"`
	// The distance function to use for distance calculation in between vectors.
	DistanceFunction pulumi.StringInput `pulumi:"distanceFunction"`
	// The path to the vector field in the document.
	Path pulumi.StringInput `pulumi:"path"`
}

func (VectorEmbeddingArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*VectorEmbedding)(nil)).Elem()
}

func (i VectorEmbeddingArgs) ToVectorEmbeddingOutput() VectorEmbeddingOutput {
	return i.ToVectorEmbeddingOutputWithContext(context.Background())
}

func (i VectorEmbeddingArgs) ToVectorEmbeddingOutputWithContext(ctx context.Context) VectorEmbeddingOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VectorEmbeddingOutput)
}

// VectorEmbeddingArrayInput is an input type that accepts VectorEmbeddingArray and VectorEmbeddingArrayOutput values.
// You can construct a concrete instance of `VectorEmbeddingArrayInput` via:
//
//	VectorEmbeddingArray{ VectorEmbeddingArgs{...} }
type VectorEmbeddingArrayInput interface {
	pulumi.Input

	ToVectorEmbeddingArrayOutput() VectorEmbeddingArrayOutput
	ToVectorEmbeddingArrayOutputWithContext(context.Context) VectorEmbeddingArrayOutput
}

type VectorEmbeddingArray []VectorEmbeddingInput

func (VectorEmbeddingArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]VectorEmbedding)(nil)).Elem()
}

func (i VectorEmbeddingArray) ToVectorEmbeddingArrayOutput() VectorEmbeddingArrayOutput {
	return i.ToVectorEmbeddingArrayOutputWithContext(context.Background())
}

func (i VectorEmbeddingArray) ToVectorEmbeddingArrayOutputWithContext(ctx context.Context) VectorEmbeddingArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VectorEmbeddingArrayOutput)
}

// Represents a vector embedding. A vector embedding is used to define a vector field in the documents.
type VectorEmbeddingOutput struct{ *pulumi.OutputState }

func (VectorEmbeddingOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VectorEmbedding)(nil)).Elem()
}

func (o VectorEmbeddingOutput) ToVectorEmbeddingOutput() VectorEmbeddingOutput {
	return o
}

func (o VectorEmbeddingOutput) ToVectorEmbeddingOutputWithContext(ctx context.Context) VectorEmbeddingOutput {
	return o
}

// Indicates the data type of vector.
func (o VectorEmbeddingOutput) DataType() pulumi.StringOutput {
	return o.ApplyT(func(v VectorEmbedding) string { return v.DataType }).(pulumi.StringOutput)
}

// The number of dimensions in the vector.
func (o VectorEmbeddingOutput) Dimensions() pulumi.IntOutput {
	return o.ApplyT(func(v VectorEmbedding) int { return v.Dimensions }).(pulumi.IntOutput)
}

// The distance function to use for distance calculation in between vectors.
func (o VectorEmbeddingOutput) DistanceFunction() pulumi.StringOutput {
	return o.ApplyT(func(v VectorEmbedding) string { return v.DistanceFunction }).(pulumi.StringOutput)
}

// The path to the vector field in the document.
func (o VectorEmbeddingOutput) Path() pulumi.StringOutput {
	return o.ApplyT(func(v VectorEmbedding) string { return v.Path }).(pulumi.StringOutput)
}

type VectorEmbeddingArrayOutput struct{ *pulumi.OutputState }

func (VectorEmbeddingArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]VectorEmbedding)(nil)).Elem()
}

func (o VectorEmbeddingArrayOutput) ToVectorEmbeddingArrayOutput() VectorEmbeddingArrayOutput {
	return o
}

func (o VectorEmbeddingArrayOutput) ToVectorEmbeddingArrayOutputWithContext(ctx context.Context) VectorEmbeddingArrayOutput {
	return o
}

func (o VectorEmbeddingArrayOutput) Index(i pulumi.IntInput) VectorEmbeddingOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) VectorEmbedding {
		return vs[0].([]VectorEmbedding)[vs[1].(int)]
...
type VectorEmbeddingPolicy struct {
	...
	VectorEmbeddings []VectorEmbedding `pulumi:"vectorEmbeddings"`
}

// VectorEmbeddingPolicyInput is an input type that accepts VectorEmbeddingPolicyArgs and VectorEmbeddingPolicyOutput values.
// You can construct a concrete instance of `VectorEmbeddingPolicyInput` via:
//
//	VectorEmbeddingPolicyArgs{...}
type VectorEmbeddingPolicyInput interface {
	pulumi.Input

	ToVectorEmbeddingPolicyOutput() VectorEmbeddingPolicyOutput
	ToVectorEmbeddingPolicyOutputWithContext(context.Context) VectorEmbeddingPolicyOutput
}

// Cosmos DB Vector Embedding Policy
type VectorEmbeddingPolicyArgs struct {
	// List of vector embeddings
	VectorEmbeddings VectorEmbeddingArrayInput `pulumi:"vectorEmbeddings"`
}

func (VectorEmbeddingPolicyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*VectorEmbeddingPolicy)(nil)).Elem()
}

func (i VectorEmbeddingPolicyArgs) ToVectorEmbeddingPolicyOutput() VectorEmbeddingPolicyOutput {
	return i.ToVectorEmbeddingPolicyOutputWithContext(context.Background())
}

func (i VectorEmbeddingPolicyArgs) ToVectorEmbeddingPolicyOutputWithContext(ctx context.Context) VectorEmbeddingPolicyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VectorEmbeddingPolicyOutput)
}

func (i VectorEmbeddingPolicyArgs) ToVectorEmbeddingPolicyPtrOutput() VectorEmbeddingPolicyPtrOutput {
	return i.ToVectorEmbeddingPolicyPtrOutputWithContext(context.Background())
}

func (i VectorEmbeddingPolicyArgs) ToVectorEmbeddingPolicyPtrOutputWithContext(ctx context.Context) VectorEmbeddingPolicyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VectorEmbeddingPolicyOutput).ToVectorEmbeddingPolicyPtrOutputWithContext(ctx)
}

// VectorEmbeddingPolicyPtrInput is an input type that accepts VectorEmbeddingPolicyArgs, VectorEmbeddingPolicyPtr and VectorEmbeddingPolicyPtrOutput values.
// You can construct a concrete instance of `VectorEmbeddingPolicyPtrInput` via:
//
//	        VectorEmbeddingPolicyArgs{...}
//
//	or:
//
//	        nil
type VectorEmbeddingPolicyPtrInput interface {
	pulumi.Input

	ToVectorEmbeddingPolicyPtrOutput() VectorEmbeddingPolicyPtrOutput
	ToVectorEmbeddingPolicyPtrOutputWithContext(context.Context) VectorEmbeddingPolicyPtrOutput
}

type vectorEmbeddingPolicyPtrType VectorEmbeddingPolicyArgs

func VectorEmbeddingPolicyPtr(v *VectorEmbeddingPolicyArgs) VectorEmbeddingPolicyPtrInput {
	return (*vectorEmbeddingPolicyPtrType)(v)
}

func (*vectorEmbeddingPolicyPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VectorEmbeddingPolicy)(nil)).Elem()
}

func (i *vectorEmbeddingPolicyPtrType) ToVectorEmbeddingPolicyPtrOutput() VectorEmbeddingPolicyPtrOutput {
	return i.ToVectorEmbeddingPolicyPtrOutputWithContext(context.Background())
}

func (i *vectorEmbeddingPolicyPtrType) ToVectorEmbeddingPolicyPtrOutputWithContext(ctx context.Context) VectorEmbeddingPolicyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VectorEmbeddingPolicyPtrOutput)
}

// Cosmos DB Vector Embedding Policy
type VectorEmbeddingPolicyOutput struct{ *pulumi.OutputState }

func (VectorEmbeddingPolicyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VectorEmbeddingPolicy)(nil)).Elem()
}

func (o VectorEmbeddingPolicyOutput) ToVectorEmbeddingPolicyOutput() VectorEmbeddingPolicyOutput {
	return o
}

func (o VectorEmbeddingPolicyOutput) ToVectorEmbeddingPolicyOutputWithContext(ctx context.Context) VectorEmbeddingPolicyOutput {
	return o
}

func (o VectorEmbeddingPolicyOutput) ToVectorEmbeddingPolicyPtrOutput() VectorEmbeddingPolicyPtrOutput {
	return o.ToVectorEmbeddingPolicyPtrOutputWithContext(context.Background())
}

func (o VectorEmbeddingPolicyOutput) ToVectorEmbeddingPolicyPtrOutputWithContext(ctx context.Context) VectorEmbeddingPolicyPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v VectorEmbeddingPolicy) *VectorEmbeddingPolicy {
		return &v
	}).(VectorEmbeddingPolicyPtrOutput)
}

// List of vector embeddings
func (o VectorEmbeddingPolicyOutput) VectorEmbeddings() VectorEmbeddingArrayOutput {
	return o.ApplyT(func(v VectorEmbeddingPolicy) []VectorEmbedding { return v.VectorEmbeddings }).(VectorEmbeddingArrayOutput)
}

type VectorEmbeddingPolicyPtrOutput struct{ *pulumi.OutputState }

func (VectorEmbeddingPolicyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VectorEmbeddingPolicy)(nil)).Elem()
}

func (o VectorEmbeddingPolicyPtrOutput) ToVectorEmbeddingPolicyPtrOutput() VectorEmbeddingPolicyPtrOutput {
	return o
}

func (o VectorEmbeddingPolicyPtrOutput) ToVectorEmbeddingPolicyPtrOutputWithContext(ctx context.Context) VectorEmbeddingPolicyPtrOutput {
	return o
}

func (o VectorEmbeddingPolicyPtrOutput) Elem() VectorEmbeddingPolicyOutput {
	return o.ApplyT(func(v *VectorEmbeddingPolicy) VectorEmbeddingPolicy {
		if v != nil {
			return *v
		}
		var ret VectorEmbeddingPolicy
		return ret
	}).(VectorEmbeddingPolicyOutput)
}

// List of vector embeddings
func (o VectorEmbeddingPolicyPtrOutput) VectorEmbeddings() VectorEmbeddingArrayOutput {
	return o.ApplyT(func(v *VectorEmbeddingPolicy) []VectorEmbedding {
		if v == nil {
			return nil
		}
		return v.VectorEmbeddings
	}).(VectorEmbeddingArrayOutput)
}

// Cosmos DB Vector Embedding Policy
type VectorEmbeddingPolicyResponse struct {
	// List of vector embeddings
	VectorEmbeddings []VectorEmbeddingResponse `pulumi:"vectorEmbeddings"`
}

// Cosmos DB Vector Embedding Policy
type VectorEmbeddingPolicyResponseOutput struct{ *pulumi.OutputState }

func (VectorEmbeddingPolicyResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VectorEmbeddingPolicyResponse)(nil)).Elem()
}

func (o VectorEmbeddingPolicyResponseOutput) ToVectorEmbeddingPolicyResponseOutput() VectorEmbeddingPolicyResponseOutput {
	return o
}

func (o VectorEmbeddingPolicyResponseOutput) ToVectorEmbeddingPolicyResponseOutputWithContext(ctx context.Context) VectorEmbeddingPolicyResponseOutput {
	return o
}

// List of vector embeddings
func (o VectorEmbeddingPolicyResponseOutput) VectorEmbeddings() VectorEmbeddingResponseArrayOutput {
	return o.ApplyT(func(v VectorEmbeddingPolicyResponse) []VectorEmbeddingResponse { return v.VectorEmbeddings }).(VectorEmbeddingResponseArrayOutput)
}

type VectorEmbeddingPolicyResponsePtrOutput struct{ *pulumi.OutputState }

func (VectorEmbeddingPolicyResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VectorEmbeddingPolicyResponse)(nil)).Elem()
}

func (o VectorEmbeddingPolicyResponsePtrOutput) ToVectorEmbeddingPolicyResponsePtrOutput() VectorEmbeddingPolicyResponsePtrOutput {
	return o
}

func (o VectorEmbeddingPolicyResponsePtrOutput) ToVectorEmbeddingPolicyResponsePtrOutputWithContext(ctx context.Context) VectorEmbeddingPolicyResponsePtrOutput {
	return o
}

func (o VectorEmbeddingPolicyResponsePtrOutput) Elem() VectorEmbeddingPolicyResponseOutput {
	return o.ApplyT(func(v *VectorEmbeddingPolicyResponse) VectorEmbeddingPolicyResponse {
		if v != nil {
			return *v
		}
		var ret VectorEmbeddingPolicyResponse
		return ret
	}).(VectorEmbeddingPolicyResponseOutput)
}

// List of vector embeddings
func (o VectorEmbeddingPolicyResponsePtrOutput) VectorEmbeddings() VectorEmbeddingResponseArrayOutput {
	return o.ApplyT(func(v *VectorEmbeddingPolicyResponse) []VectorEmbeddingResponse {
		if v == nil {
			return nil
		}
		return v.VectorEmbeddings
	}).(VectorEmbeddingResponseArrayOutput)
}

// Represents a vector embedding. A vector embedding is used to define a vector field in the documents.
type VectorEmbeddingResponse struct {
	// Indicates the data type of vector.
	DataType string `pulumi:"dataType"`
	// The number of dimensions in the vector.
	Dimensions int `pulumi:"dimensions"`
...
// Represents a vector embedding. A vector embedding is used to define a vector field in the documents.
type VectorEmbeddingResponseOutput struct{ *pulumi.OutputState }

func (VectorEmbeddingResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VectorEmbeddingResponse)(nil)).Elem()
}

func (o VectorEmbeddingResponseOutput) ToVectorEmbeddingResponseOutput() VectorEmbeddingResponseOutput {
	return o
}

func (o VectorEmbeddingResponseOutput) ToVectorEmbeddingResponseOutputWithContext(ctx context.Context) VectorEmbeddingResponseOutput {
	return o
}

// Indicates the data type of vector.
func (o VectorEmbeddingResponseOutput) DataType() pulumi.StringOutput {
	return o.ApplyT(func(v VectorEmbeddingResponse) string { return v.DataType }).(pulumi.StringOutput)
}

// The number of dimensions in the vector.
func (o VectorEmbeddingResponseOutput) Dimensions() pulumi.IntOutput {
	return o.ApplyT(func(v VectorEmbeddingResponse) int { return v.Dimensions }).(pulumi.IntOutput)
}

// The distance function to use for distance calculation in between vectors.
func (o VectorEmbeddingResponseOutput) DistanceFunction() pulumi.StringOutput {
	return o.ApplyT(func(v VectorEmbeddingResponse) string { return v.DistanceFunction }).(pulumi.StringOutput)
}

// The path to the vector field in the document.
func (o VectorEmbeddingResponseOutput) Path() pulumi.StringOutput {
	return o.ApplyT(func(v VectorEmbeddingResponse) string { return v.Path }).(pulumi.StringOutput)
}

type VectorEmbeddingResponseArrayOutput struct{ *pulumi.OutputState }

func (VectorEmbeddingResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]VectorEmbeddingResponse)(nil)).Elem()
}

func (o VectorEmbeddingResponseArrayOutput) ToVectorEmbeddingResponseArrayOutput() VectorEmbeddingResponseArrayOutput {
	return o
}

func (o VectorEmbeddingResponseArrayOutput) ToVectorEmbeddingResponseArrayOutputWithContext(ctx context.Context) VectorEmbeddingResponseArrayOutput {
	return o
}

func (o VectorEmbeddingResponseArrayOutput) Index(i pulumi.IntInput) VectorEmbeddingResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) VectorEmbeddingResponse {
		return vs[0].([]VectorEmbeddingResponse)[vs[1].(int)]
	}).(VectorEmbeddingResponseOutput)
}
...
// You can construct a concrete instance of `VectorIndexInput` via:
//
//	VectorIndexArgs{...}
type VectorIndexInput interface {
	...
	ToVectorIndexOutputWithContext(context.Context) VectorIndexOutput
}
...
func (i VectorIndexArgs) ToVectorIndexOutput() VectorIndexOutput {
	return i.ToVectorIndexOutputWithContext(context.Background())
}

func (i VectorIndexArgs) ToVectorIndexOutputWithContext(ctx context.Context) VectorIndexOutput {
...
func (VectorIndexResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VectorIndexResponse)(nil)).Elem()
}

func (o VectorIndexResponseOutput) ToVectorIndexResponseOutput() VectorIndexResponseOutput {
	return o
}

func (o VectorIndexResponseOutput) ToVectorIndexResponseOutputWithContext(ctx context.Context) VectorIndexResponseOutput {
	return o
}
...
func (VectorIndexResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]VectorIndexResponse)(nil)).Elem()
}

func (o VectorIndexResponseArrayOutput) ToVectorIndexResponseArrayOutput() VectorIndexResponseArrayOutput {
	return o
}

func (o VectorIndexResponseArrayOutput) ToVectorIndexResponseArrayOutputWithContext(ctx context.Context) VectorIndexResponseArrayOutput {
	return o
}

func (o VectorIndexResponseArrayOutput) Index(i pulumi.IntInput) VectorIndexResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) VectorIndexResponse {
		return vs[0].([]VectorIndexResponse)[vs[1].(int)]
...
func init() {
	...
	pulumi.RegisterOutputType(FullTextPathResponseArrayOutput{})
	pulumi.RegisterOutputType(FullTextPolicyOutput{})
	...
	pulumi.RegisterOutputType(GarnetClusterResourcePropertiesEndPointsItemResponseOutput{})
	pulumi.RegisterOutputType(GarnetClusterResourcePropertiesEndPointsItemResponseArrayOutput{})
	pulumi.RegisterOutputType(GarnetClusterResourcePropertiesResponseOutput{})
	...
	pulumi.RegisterOutputType(PermissionResponseV1Output{})
	pulumi.RegisterOutputType(PermissionResponseV1ArrayOutput{})
	...
	pulumi.RegisterOutputType(VectorEmbeddingOutput{})
	pulumi.RegisterOutputType(VectorEmbeddingArrayOutput{})
	pulumi.RegisterOutputType(VectorEmbeddingPolicyOutput{})
	pulumi.RegisterOutputType(VectorEmbeddingPolicyPtrOutput{})
	pulumi.RegisterOutputType(VectorEmbeddingPolicyResponseOutput{})
	pulumi.RegisterOutputType(VectorEmbeddingPolicyResponsePtrOutput{})
	pulumi.RegisterOutputType(VectorEmbeddingResponseOutput{})
	pulumi.RegisterOutputType(VectorEmbeddingResponseArrayOutput{})
	pulumi.RegisterOutputType(VectorIndexOutput{})
	pulumi.RegisterOutputType(VectorIndexArrayOutput{})
	pulumi.RegisterOutputType(VectorIndexResponseOutput{})
	pulumi.RegisterOutputType(VectorIndexResponseArrayOutput{})
