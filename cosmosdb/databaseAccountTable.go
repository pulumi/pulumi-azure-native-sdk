...
func NewDatabaseAccountTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:DatabaseAccountTable"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:DatabaseAccountTable"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:DatabaseAccountTable"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:DatabaseAccountTable"),
		},
		{
