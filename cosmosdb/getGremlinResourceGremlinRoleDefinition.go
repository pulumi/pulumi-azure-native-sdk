...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupGremlinResourceGremlinRoleDefinitionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupGremlinResourceGremlinRoleDefinitionResult) commontypesv5.SystemDataResponse {
		return v.SystemData
