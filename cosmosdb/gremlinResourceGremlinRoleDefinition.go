...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o GremlinResourceGremlinRoleDefinitionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *GremlinResourceGremlinRoleDefinition) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
