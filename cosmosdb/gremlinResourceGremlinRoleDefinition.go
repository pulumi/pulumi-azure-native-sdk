...
func NewGremlinResourceGremlinRoleDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:GremlinResourceGremlinRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:GremlinResourceGremlinRoleDefinition"),
		},
	})
