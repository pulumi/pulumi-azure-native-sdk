...
func NewCassandraResourceCassandraView(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cosmosdb/v20210701preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20211015preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20211115preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20220215preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20220515preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20220815preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20221115preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230301preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230315preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230915preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20231115preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20240215preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20240515preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20240901preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20241201preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20250501preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:CassandraResourceCassandraView"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cosmosdb:CassandraResourceCassandraView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraResourceCassandraView(ctx *pulumi.Context,
	...
	var resource CassandraResourceCassandraView
	err := ctx.ReadResource("azure-native:cosmosdb:CassandraResourceCassandraView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o CassandraResourceCassandraViewOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CassandraResourceCassandraView) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
