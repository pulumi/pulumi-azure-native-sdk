...
func NewGremlinResourceGremlinDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:GremlinResourceGremlinDatabase"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:GremlinResourceGremlinDatabase"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:GremlinResourceGremlinDatabase"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:GremlinResourceGremlinDatabase"),
		},
		{
