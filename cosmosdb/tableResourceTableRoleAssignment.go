...
func NewTableResourceTableRoleAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20250501preview:TableResourceTableRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:TableResourceTableRoleAssignment"),
		},
		{
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o TableResourceTableRoleAssignmentOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *TableResourceTableRoleAssignment) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
