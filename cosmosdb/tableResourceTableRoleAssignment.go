...
func NewTableResourceTableRoleAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:TableResourceTableRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:TableResourceTableRoleAssignment"),
		},
		{
