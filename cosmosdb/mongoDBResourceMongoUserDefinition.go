...
func NewMongoDBResourceMongoUserDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:MongoDBResourceMongoUserDefinition"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:MongoDBResourceMongoUserDefinition"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:MongoDBResourceMongoUserDefinition"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:MongoDBResourceMongoUserDefinition"),
		},
		{
