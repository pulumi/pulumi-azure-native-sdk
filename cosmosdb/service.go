...
func NewService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:Service"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:Service"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:Service"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:Service"),
		},
		{
