...
func LookupSqlResourceSqlDatabase(ctx *pulumi.Context, args *LookupSqlResourceSqlDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupSqlResourceSqlDatabaseResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getSqlResourceSqlDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSqlResourceSqlDatabaseOutput(ctx *pulumi.Context, args LookupSqlResourceSqlDatabaseOutputArgs, opts ...pulumi.InvokeOption) LookupSqlResourceSqlDatabaseResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSqlResourceSqlDatabaseResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cosmosdb:getSqlResourceSqlDatabase", args, LookupSqlResourceSqlDatabaseResultOutput{}, options).(LookupSqlResourceSqlDatabaseResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSqlResourceSqlDatabaseResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSqlResourceSqlDatabaseResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
