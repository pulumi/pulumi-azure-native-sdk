...
func LookupThroughputPoolAccount(ctx *pulumi.Context, args *LookupThroughputPoolAccountArgs, opts ...pulumi.InvokeOption) (*LookupThroughputPoolAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getThroughputPoolAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupThroughputPoolAccountOutput(ctx *pulumi.Context, args LookupThroughputPoolAccountOutputArgs, opts ...pulumi.InvokeOption) LookupThroughputPoolAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupThroughputPoolAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cosmosdb:getThroughputPoolAccount", args, LookupThroughputPoolAccountResultOutput{}, options).(LookupThroughputPoolAccountResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupThroughputPoolAccountResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupThroughputPoolAccountResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupThroughputPoolAccountResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupThroughputPoolAccountResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
