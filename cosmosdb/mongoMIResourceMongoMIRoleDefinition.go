...
func NewMongoMIResourceMongoMIRoleDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:MongoMIResourceMongoMIRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:MongoMIResourceMongoMIRoleDefinition"),
		},
	})
