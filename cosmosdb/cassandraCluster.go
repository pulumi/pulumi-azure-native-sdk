...
func NewCassandraCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:CassandraCluster"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:CassandraCluster"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:CassandraCluster"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:CassandraCluster"),
		},
		{
