...
func NewFleetspaceAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:FleetspaceAccount"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:FleetspaceAccount"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o FleetspaceAccountOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *FleetspaceAccount) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
