...
func LookupGremlinResourceGremlinGraph(ctx *pulumi.Context, args *LookupGremlinResourceGremlinGraphArgs, opts ...pulumi.InvokeOption) (*LookupGremlinResourceGremlinGraphResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getGremlinResourceGremlinGraph", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupGremlinResourceGremlinGraphOutput(ctx *pulumi.Context, args LookupGremlinResourceGremlinGraphOutputArgs, opts ...pulumi.InvokeOption) LookupGremlinResourceGremlinGraphResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGremlinResourceGremlinGraphResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cosmosdb:getGremlinResourceGremlinGraph", args, LookupGremlinResourceGremlinGraphResultOutput{}, options).(LookupGremlinResourceGremlinGraphResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupGremlinResourceGremlinGraphResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupGremlinResourceGremlinGraphResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
