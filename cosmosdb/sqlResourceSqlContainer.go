...
func NewSqlResourceSqlContainer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:SqlResourceSqlContainer"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:SqlResourceSqlContainer"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:SqlResourceSqlContainer"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:SqlResourceSqlContainer"),
		},
		{
