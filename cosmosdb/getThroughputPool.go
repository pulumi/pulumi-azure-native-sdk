...
func LookupThroughputPool(ctx *pulumi.Context, args *LookupThroughputPoolArgs, opts ...pulumi.InvokeOption) (*LookupThroughputPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getThroughputPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupThroughputPoolOutput(ctx *pulumi.Context, args LookupThroughputPoolOutputArgs, opts ...pulumi.InvokeOption) LookupThroughputPoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupThroughputPoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cosmosdb:getThroughputPool", args, LookupThroughputPoolResultOutput{}, options).(LookupThroughputPoolResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupThroughputPoolResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupThroughputPoolResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupThroughputPoolResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupThroughputPoolResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
