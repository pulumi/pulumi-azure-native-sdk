...
func NewDatabaseAccountCassandraTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:DatabaseAccountCassandraTable"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:DatabaseAccountCassandraTable"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:DatabaseAccountCassandraTable"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:DatabaseAccountCassandraTable"),
		},
		{
