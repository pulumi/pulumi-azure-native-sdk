...
func LookupDatabaseAccountSqlDatabase(ctx *pulumi.Context, args *LookupDatabaseAccountSqlDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAccountSqlDatabaseResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getDatabaseAccountSqlDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDatabaseAccountSqlDatabaseOutput(ctx *pulumi.Context, args LookupDatabaseAccountSqlDatabaseOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseAccountSqlDatabaseResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseAccountSqlDatabaseResultOutput, error) {
			args := v.(LookupDatabaseAccountSqlDatabaseArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:cosmosdb:getDatabaseAccountSqlDatabase", args, LookupDatabaseAccountSqlDatabaseResultOutput{}, options).(LookupDatabaseAccountSqlDatabaseResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDatabaseAccountSqlDatabaseResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDatabaseAccountSqlDatabaseResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
