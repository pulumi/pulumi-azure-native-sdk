...
func NewThroughputPoolAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cosmosdb/v20231115preview:ThroughputPoolAccount"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20240215preview:ThroughputPoolAccount"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20240515preview:ThroughputPoolAccount"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20240901preview:ThroughputPoolAccount"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20241201preview:ThroughputPoolAccount"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20250501preview:ThroughputPoolAccount"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:ThroughputPoolAccount"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cosmosdb:ThroughputPoolAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThroughputPoolAccount(ctx *pulumi.Context,
	...
	var resource ThroughputPoolAccount
	err := ctx.ReadResource("azure-native:cosmosdb:ThroughputPoolAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ThroughputPoolAccountOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ThroughputPoolAccount) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ThroughputPoolAccountOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ThroughputPoolAccount) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
