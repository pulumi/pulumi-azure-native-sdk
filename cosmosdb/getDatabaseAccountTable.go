...
func LookupDatabaseAccountTable(ctx *pulumi.Context, args *LookupDatabaseAccountTableArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAccountTableResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getDatabaseAccountTable", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDatabaseAccountTableOutput(ctx *pulumi.Context, args LookupDatabaseAccountTableOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseAccountTableResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseAccountTableResultOutput, error) {
			args := v.(LookupDatabaseAccountTableArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:cosmosdb:getDatabaseAccountTable", args, LookupDatabaseAccountTableResultOutput{}, options).(LookupDatabaseAccountTableResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDatabaseAccountTableResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDatabaseAccountTableResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
