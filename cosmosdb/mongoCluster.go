...
func NewMongoCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230301preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230315preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230915preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20231115preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20240215preview:MongoCluster"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cosmosdb:MongoCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoCluster(ctx *pulumi.Context,
	...
	var resource MongoCluster
	err := ctx.ReadResource("azure-native:cosmosdb:MongoCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
