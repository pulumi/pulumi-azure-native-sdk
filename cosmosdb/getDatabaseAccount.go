...
func LookupDatabaseAccount(ctx *pulumi.Context, args *LookupDatabaseAccountArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getDatabaseAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupDatabaseAccountResult struct {
	...
	KeyVaultKeyUriVersion string `pulumi:"keyVaultKeyUriVersion"`
...
func LookupDatabaseAccountOutput(ctx *pulumi.Context, args LookupDatabaseAccountOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cosmosdb:getDatabaseAccount", args, LookupDatabaseAccountResultOutput{}, options).(LookupDatabaseAccountResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDatabaseAccountResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The version of the Customer Managed Key currently being used by the account
func (o LookupDatabaseAccountResultOutput) KeyVaultKeyUriVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) string { return v.KeyVaultKeyUriVersion }).(pulumi.StringOutput)
}
...
// The system meta data relating to this resource.
func (o LookupDatabaseAccountResultOutput) SystemData() commontypesv1.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) commontypesv1.SystemDataResponse { return v.SystemData }).(commontypesv1.SystemDataResponseOutput)
}
