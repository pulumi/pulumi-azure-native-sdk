...
func NewMongoClusterFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230301preview:MongoClusterFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230315preview:MongoClusterFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20230915preview:MongoClusterFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20231115preview:MongoClusterFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20240215preview:MongoClusterFirewallRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cosmosdb:MongoClusterFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoClusterFirewallRule(ctx *pulumi.Context,
	...
	var resource MongoClusterFirewallRule
	err := ctx.ReadResource("azure-native:cosmosdb:MongoClusterFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o MongoClusterFirewallRuleOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *MongoClusterFirewallRule) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
