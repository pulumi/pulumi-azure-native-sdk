...
func LookupGraphResourceGraph(ctx *pulumi.Context, args *LookupGraphResourceGraphArgs, opts ...pulumi.InvokeOption) (*LookupGraphResourceGraphResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getGraphResourceGraph", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGraphResourceGraphOutput(ctx *pulumi.Context, args LookupGraphResourceGraphOutputArgs, opts ...pulumi.InvokeOption) LookupGraphResourceGraphResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGraphResourceGraphResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cosmosdb:getGraphResourceGraph", args, LookupGraphResourceGraphResultOutput{}, options).(LookupGraphResourceGraphResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupGraphResourceGraphResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupGraphResourceGraphResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
