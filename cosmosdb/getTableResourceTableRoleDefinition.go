...
func LookupTableResourceTableRoleDefinition(ctx *pulumi.Context, args *LookupTableResourceTableRoleDefinitionArgs, opts ...pulumi.InvokeOption) (*LookupTableResourceTableRoleDefinitionResult, error) {
	...
	err := ctx.Invoke("azure-native:cosmosdb:getTableResourceTableRoleDefinition", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTableResourceTableRoleDefinitionOutput(ctx *pulumi.Context, args LookupTableResourceTableRoleDefinitionOutputArgs, opts ...pulumi.InvokeOption) LookupTableResourceTableRoleDefinitionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTableResourceTableRoleDefinitionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cosmosdb:getTableResourceTableRoleDefinition", args, LookupTableResourceTableRoleDefinitionResultOutput{}, options).(LookupTableResourceTableRoleDefinitionResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupTableResourceTableRoleDefinitionResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupTableResourceTableRoleDefinitionResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupTableResourceTableRoleDefinitionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupTableResourceTableRoleDefinitionResult) commontypesv5.SystemDataResponse {
		return v.SystemData
