...
func NewMongoDBResourceMongoDBDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251015:MongoDBResourceMongoDBDatabase"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20251101preview:MongoDBResourceMongoDBDatabase"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260315:MongoDBResourceMongoDBDatabase"),
		},
		{
			Type: pulumi.String("azure-native:cosmosdb/v20260401preview:MongoDBResourceMongoDBDatabase"),
		},
		{
