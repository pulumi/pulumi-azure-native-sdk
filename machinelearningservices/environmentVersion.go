...
func NewEnvironmentVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:EnvironmentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:EnvironmentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:EnvironmentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:EnvironmentVersion"),
		},
		{
