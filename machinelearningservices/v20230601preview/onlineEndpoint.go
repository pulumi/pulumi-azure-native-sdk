...
func NewOnlineEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20230801preview:OnlineEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20231001:OnlineEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240101preview:OnlineEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240401:OnlineEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240401preview:OnlineEndpoint"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230601preview:OnlineEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOnlineEndpoint(ctx *pulumi.Context,
	...
	var resource OnlineEndpoint
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230601preview:OnlineEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
