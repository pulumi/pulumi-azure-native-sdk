...
func NewRegistryModelVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230601preview:RegistryModelVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryModelVersion(ctx *pulumi.Context,
	...
	var resource RegistryModelVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230601preview:RegistryModelVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
