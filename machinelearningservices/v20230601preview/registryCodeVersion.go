...
func NewRegistryCodeVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240101preview:RegistryCodeVersion"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240701preview:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001preview:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250101preview:RegistryCodeVersion"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230601preview:RegistryCodeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryCodeVersion(ctx *pulumi.Context,
	...
	var resource RegistryCodeVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230601preview:RegistryCodeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
