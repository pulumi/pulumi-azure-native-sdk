...
func NewWorkspaceConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20230801preview:WorkspaceConnection"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20231001:WorkspaceConnection"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240101preview:WorkspaceConnection"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240401:WorkspaceConnection"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240401preview:WorkspaceConnection"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240701preview:WorkspaceConnection"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001:WorkspaceConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230601preview:WorkspaceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceConnection(ctx *pulumi.Context,
	...
	var resource WorkspaceConnection
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230601preview:WorkspaceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
