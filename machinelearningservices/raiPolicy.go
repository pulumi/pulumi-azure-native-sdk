...
func NewRaiPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:RaiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:RaiPolicy"),
		},
	})
