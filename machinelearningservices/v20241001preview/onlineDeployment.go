...
func NewOnlineDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20241001preview:OnlineDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOnlineDeployment(ctx *pulumi.Context,
	...
	var resource OnlineDeployment
	err := ctx.ReadResource("azure-native:machinelearningservices/v20241001preview:OnlineDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
