...
func NewWorkspaceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20241001preview:WorkspaceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceConnection(ctx *pulumi.Context,
	...
	var resource WorkspaceConnection
	err := ctx.ReadResource("azure-native:machinelearningservices/v20241001preview:WorkspaceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
