...
func NewFeaturesetContainerEntity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20241001preview:FeaturesetContainerEntity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeaturesetContainerEntity(ctx *pulumi.Context,
	...
	var resource FeaturesetContainerEntity
	err := ctx.ReadResource("azure-native:machinelearningservices/v20241001preview:FeaturesetContainerEntity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
