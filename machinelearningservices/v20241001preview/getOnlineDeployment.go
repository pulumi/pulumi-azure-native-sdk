...
func LookupOnlineDeployment(ctx *pulumi.Context, args *LookupOnlineDeploymentArgs, opts ...pulumi.InvokeOption) (*LookupOnlineDeploymentResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20241001preview:getOnlineDeployment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupOnlineDeploymentOutput(ctx *pulumi.Context, args LookupOnlineDeploymentOutputArgs, opts ...pulumi.InvokeOption) LookupOnlineDeploymentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOnlineDeploymentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20241001preview:getOnlineDeployment", args, LookupOnlineDeploymentResultOutput{}, options).(LookupOnlineDeploymentResultOutput), nil
