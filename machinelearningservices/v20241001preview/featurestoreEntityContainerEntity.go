...
func NewFeaturestoreEntityContainerEntity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20241001preview:FeaturestoreEntityContainerEntity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeaturestoreEntityContainerEntity(ctx *pulumi.Context,
	...
	var resource FeaturestoreEntityContainerEntity
	err := ctx.ReadResource("azure-native:machinelearningservices/v20241001preview:FeaturestoreEntityContainerEntity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
