...
func NewInferenceGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240401preview:InferenceGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource InferenceGroup
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20241001preview:InferenceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInferenceGroup(ctx *pulumi.Context,
	...
	var resource InferenceGroup
	err := ctx.ReadResource("azure-native:machinelearningservices/v20241001preview:InferenceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
