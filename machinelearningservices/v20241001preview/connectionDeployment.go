...
func NewConnectionDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20241001preview:ConnectionDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionDeployment(ctx *pulumi.Context,
	...
	var resource ConnectionDeployment
	err := ctx.ReadResource("azure-native:machinelearningservices/v20241001preview:ConnectionDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
