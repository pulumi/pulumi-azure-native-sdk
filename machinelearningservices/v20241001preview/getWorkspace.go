...
func LookupWorkspace(ctx *pulumi.Context, args *LookupWorkspaceArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20241001preview:getWorkspace", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupWorkspaceResult struct {
	...
	AgentsEndpointUri string `pulumi:"agentsEndpointUri"`
...
func LookupWorkspaceOutput(ctx *pulumi.Context, args LookupWorkspaceOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20241001preview:getWorkspace", args, LookupWorkspaceResultOutput{}, options).(LookupWorkspaceResultOutput), nil
...
// The URI of agents endpoint associated with this workspace.
func (o LookupWorkspaceResultOutput) AgentsEndpointUri() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) string { return v.AgentsEndpointUri }).(pulumi.StringOutput)
}
...
// The flag to indicate whether we will do role assignment for the workspace MSI on resource group level.
func (o LookupWorkspaceResultOutput) AllowRoleAssignmentOnRG() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *bool { return v.AllowRoleAssignmentOnRG }).(pulumi.BoolPtrOutput)
}
...
func (o LookupWorkspaceResultOutput) EnableServiceSideCMKEncryption() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *bool { return v.EnableServiceSideCMKEncryption }).(pulumi.BoolPtrOutput)
}

// Flag to tell if simplified CMK should be enabled for this workspace.
func (o LookupWorkspaceResultOutput) EnableSimplifiedCmk() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *bool { return v.EnableSimplifiedCmk }).(pulumi.BoolPtrOutput)
}

// Flag to tell if SoftwareBillOfMaterials should be enabled for this workspace.
func (o LookupWorkspaceResultOutput) EnableSoftwareBillOfMaterials() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *bool { return v.EnableSoftwareBillOfMaterials }).(pulumi.BoolPtrOutput)
}
...
// The list of IPv4  addresses that are allowed to access the workspace.
func (o LookupWorkspaceResultOutput) IpAllowlist() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) []string { return v.IpAllowlist }).(pulumi.StringArrayOutput)
}
...
// A set of rules governing the network accessibility of the workspace.
func (o LookupWorkspaceResultOutput) NetworkAcls() NetworkAclsResponsePtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *NetworkAclsResponse { return v.NetworkAcls }).(NetworkAclsResponsePtrOutput)
}
...
// Set to trigger the provisioning of the managed VNet with the default Options when creating a Workspace with the managed VNet enabled, or else it does nothing.
func (o LookupWorkspaceResultOutput) ProvisionNetworkNow() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *bool { return v.ProvisionNetworkNow }).(pulumi.BoolPtrOutput)
}
