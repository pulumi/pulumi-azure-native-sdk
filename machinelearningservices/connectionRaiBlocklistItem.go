...
func NewConnectionRaiBlocklistItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251001preview:ConnectionRaiBlocklistItem"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:ConnectionRaiBlocklistItem"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:ConnectionRaiBlocklistItem"),
		},
		{
