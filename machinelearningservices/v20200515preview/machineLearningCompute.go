...
//
// Deprecated: azure-native:machinelearningservices/v20200515preview:MachineLearningCompute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:MachineLearningCompute to guarantee forwards compatibility.
...
func NewMachineLearningCompute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20221201preview:MachineLearningCompute"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20230401preview:MachineLearningCompute"),
		},
	})
	opts = append(opts, aliases)
	var resource MachineLearningCompute
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20200515preview:MachineLearningCompute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineLearningCompute(ctx *pulumi.Context,
	...
	var resource MachineLearningCompute
	err := ctx.ReadResource("azure-native:machinelearningservices/v20200515preview:MachineLearningCompute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
