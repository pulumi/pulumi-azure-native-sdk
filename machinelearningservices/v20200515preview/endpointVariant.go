...
//
// Deprecated: azure-native:machinelearningservices/v20200515preview:EndpointVariant is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility.
...
func NewEndpointVariant(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20200515preview:EndpointVariant", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpointVariant(ctx *pulumi.Context,
	...
	var resource EndpointVariant
	err := ctx.ReadResource("azure-native:machinelearningservices/v20200515preview:EndpointVariant", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
