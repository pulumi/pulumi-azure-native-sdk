...
type LookupEnvironmentVersionResult struct {
	...
	Properties EnvironmentVersionPropertiesResponse `pulumi:"properties"`
...
// [Required] Additional attributes of the entity.
func (o LookupEnvironmentVersionResultOutput) Properties() EnvironmentVersionPropertiesResponseOutput {
	return o.ApplyT(func(v LookupEnvironmentVersionResult) EnvironmentVersionPropertiesResponse { return v.Properties }).(EnvironmentVersionPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupEnvironmentVersionResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupEnvironmentVersionResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
