...
func LookupFeaturestoreEntityContainerEntity(ctx *pulumi.Context, args *LookupFeaturestoreEntityContainerEntityArgs, opts ...pulumi.InvokeOption) (*LookupFeaturestoreEntityContainerEntityResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20241001:getFeaturestoreEntityContainerEntity", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupFeaturestoreEntityContainerEntityOutput(ctx *pulumi.Context, args LookupFeaturestoreEntityContainerEntityOutputArgs, opts ...pulumi.InvokeOption) LookupFeaturestoreEntityContainerEntityResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFeaturestoreEntityContainerEntityResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20241001:getFeaturestoreEntityContainerEntity", args, LookupFeaturestoreEntityContainerEntityResultOutput{}, options).(LookupFeaturestoreEntityContainerEntityResultOutput), nil
