...
func ListWorkspaceStorageAccountKeys(ctx *pulumi.Context, args *ListWorkspaceStorageAccountKeysArgs, opts ...pulumi.InvokeOption) (*ListWorkspaceStorageAccountKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20241001:listWorkspaceStorageAccountKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWorkspaceStorageAccountKeysOutput(ctx *pulumi.Context, args ListWorkspaceStorageAccountKeysOutputArgs, opts ...pulumi.InvokeOption) ListWorkspaceStorageAccountKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkspaceStorageAccountKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20241001:listWorkspaceStorageAccountKeys", args, ListWorkspaceStorageAccountKeysResultOutput{}, options).(ListWorkspaceStorageAccountKeysResultOutput), nil
