...
func NewCodeVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20241001:CodeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodeVersion(ctx *pulumi.Context,
	...
	var resource CodeVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20241001:CodeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
