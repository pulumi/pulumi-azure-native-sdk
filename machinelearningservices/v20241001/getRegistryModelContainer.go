...
func LookupRegistryModelContainer(ctx *pulumi.Context, args *LookupRegistryModelContainerArgs, opts ...pulumi.InvokeOption) (*LookupRegistryModelContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20241001:getRegistryModelContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupRegistryModelContainerOutput(ctx *pulumi.Context, args LookupRegistryModelContainerOutputArgs, opts ...pulumi.InvokeOption) LookupRegistryModelContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistryModelContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20241001:getRegistryModelContainer", args, LookupRegistryModelContainerResultOutput{}, options).(LookupRegistryModelContainerResultOutput), nil
