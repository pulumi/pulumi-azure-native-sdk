...
func NewInferenceGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401preview:InferenceGroup"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250701preview:InferenceGroup"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251001preview:InferenceGroup"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:InferenceGroup"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:InferenceGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource InferenceGroup
	err := ctx.RegisterResource("azure-native:machinelearningservices:InferenceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInferenceGroup(ctx *pulumi.Context,
	...
	var resource InferenceGroup
	err := ctx.ReadResource("azure-native:machinelearningservices:InferenceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
