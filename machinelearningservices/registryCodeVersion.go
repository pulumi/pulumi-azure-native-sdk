...
type RegistryCodeVersion struct {
	...
	Properties CodeVersionPropertiesResponseOutput `pulumi:"properties"`
...
func NewRegistryCodeVersion(ctx *pulumi.Context,
	...
	args.Properties = args.Properties.ToCodeVersionPropertiesOutput().ApplyT(func(v CodeVersionProperties) CodeVersionProperties { return *v.Defaults() }).(CodeVersionPropertiesOutput)
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401preview:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250601:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250701preview:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250901:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251001preview:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251201:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:RegistryCodeVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:RegistryCodeVersion"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource RegistryCodeVersion
	err := ctx.RegisterResource("azure-native:machinelearningservices:RegistryCodeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryCodeVersion(ctx *pulumi.Context,
	...
	var resource RegistryCodeVersion
	err := ctx.ReadResource("azure-native:machinelearningservices:RegistryCodeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type registryCodeVersionArgs struct {
	...
	// [Required] Additional attributes of the entity.
	Properties CodeVersionProperties `pulumi:"properties"`
...
type RegistryCodeVersionArgs struct {
	...
	// [Required] Additional attributes of the entity.
	Properties CodeVersionPropertiesInput
	// Name of Azure Machine Learning registry. This is case-insensitive
...
// The Azure API version of the resource.
func (o RegistryCodeVersionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *RegistryCodeVersion) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// [Required] Additional attributes of the entity.
func (o RegistryCodeVersionOutput) Properties() CodeVersionPropertiesResponseOutput {
	return o.ApplyT(func(v *RegistryCodeVersion) CodeVersionPropertiesResponseOutput { return v.Properties }).(CodeVersionPropertiesResponseOutput)
}
