...
//
// Deprecated: azure-native:machinelearningservices/v20221001:ModelVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:ModelVersion to guarantee forwards compatibility.
...
func NewModelVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221001:ModelVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModelVersion(ctx *pulumi.Context,
	...
	var resource ModelVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221001:ModelVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
