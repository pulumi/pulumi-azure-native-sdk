...
// Deprecated: azure-native:machinelearningservices/v20221001:BatchEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:BatchEndpoint to guarantee forwards compatibility.
func LookupBatchEndpoint(ctx *pulumi.Context, args *LookupBatchEndpointArgs, opts ...pulumi.InvokeOption) (*LookupBatchEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20221001:getBatchEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
