...
func NewBatchEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221001:BatchEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBatchEndpoint(ctx *pulumi.Context,
	...
	var resource BatchEndpoint
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221001:BatchEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
