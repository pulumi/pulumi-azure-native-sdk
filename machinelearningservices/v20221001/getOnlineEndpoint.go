...
// Deprecated: azure-native:machinelearningservices/v20221001:OnlineEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:OnlineEndpoint to guarantee forwards compatibility.
func LookupOnlineEndpoint(ctx *pulumi.Context, args *LookupOnlineEndpointArgs, opts ...pulumi.InvokeOption) (*LookupOnlineEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20221001:getOnlineEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
