...
func NewModelVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:ModelVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:ModelVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:ModelVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:ModelVersion"),
		},
	})
