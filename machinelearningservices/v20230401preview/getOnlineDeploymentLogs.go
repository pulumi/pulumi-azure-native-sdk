...
func GetOnlineDeploymentLogs(ctx *pulumi.Context, args *GetOnlineDeploymentLogsArgs, opts ...pulumi.InvokeOption) (*GetOnlineDeploymentLogsResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20230401preview:getOnlineDeploymentLogs", args.Defaults(), &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetOnlineDeploymentLogsOutput(ctx *pulumi.Context, args GetOnlineDeploymentLogsOutputArgs, opts ...pulumi.InvokeOption) GetOnlineDeploymentLogsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetOnlineDeploymentLogsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20230401preview:getOnlineDeploymentLogs", args.Defaults(), GetOnlineDeploymentLogsResultOutput{}, options).(GetOnlineDeploymentLogsResultOutput), nil
