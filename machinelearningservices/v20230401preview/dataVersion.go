...
func NewDataVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230401preview:DataVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataVersion(ctx *pulumi.Context,
	...
	var resource DataVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230401preview:DataVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
