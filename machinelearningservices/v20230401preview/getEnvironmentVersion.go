...
func LookupEnvironmentVersion(ctx *pulumi.Context, args *LookupEnvironmentVersionArgs, opts ...pulumi.InvokeOption) (*LookupEnvironmentVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20230401preview:getEnvironmentVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupEnvironmentVersionOutput(ctx *pulumi.Context, args LookupEnvironmentVersionOutputArgs, opts ...pulumi.InvokeOption) LookupEnvironmentVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEnvironmentVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20230401preview:getEnvironmentVersion", args, LookupEnvironmentVersionResultOutput{}, options).(LookupEnvironmentVersionResultOutput), nil
