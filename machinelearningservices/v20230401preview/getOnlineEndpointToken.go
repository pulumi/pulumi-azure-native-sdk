...
func GetOnlineEndpointToken(ctx *pulumi.Context, args *GetOnlineEndpointTokenArgs, opts ...pulumi.InvokeOption) (*GetOnlineEndpointTokenResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20230401preview:getOnlineEndpointToken", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func GetOnlineEndpointTokenOutput(ctx *pulumi.Context, args GetOnlineEndpointTokenOutputArgs, opts ...pulumi.InvokeOption) GetOnlineEndpointTokenResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetOnlineEndpointTokenResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20230401preview:getOnlineEndpointToken", args, GetOnlineEndpointTokenResultOutput{}, options).(GetOnlineEndpointTokenResultOutput), nil
