...
const (
	...
	ClassificationModelPerformanceMetricF1Score = ClassificationModelPerformanceMetric("F1Score")
)
...
//	ClassificationModelPerformanceMetricF1Score
...
const (
	...
	ConnectionCategoryAzureDataLakeGen2     = ConnectionCategory("AzureDataLakeGen2")
...
func (MonitoringInputDataContext) ElementType() reflect.Type {
	return reflect.TypeOf((*MonitoringInputDataContext)(nil)).Elem()
}

func (e MonitoringInputDataContext) ToMonitoringInputDataContextOutput() MonitoringInputDataContextOutput {
	return pulumi.ToOutput(e).(MonitoringInputDataContextOutput)
}

func (e MonitoringInputDataContext) ToMonitoringInputDataContextOutputWithContext(ctx context.Context) MonitoringInputDataContextOutput {
	return pulumi.ToOutputWithContext(ctx, e).(MonitoringInputDataContextOutput)
}

func (e MonitoringInputDataContext) ToMonitoringInputDataContextPtrOutput() MonitoringInputDataContextPtrOutput {
	return e.ToMonitoringInputDataContextPtrOutputWithContext(context.Background())
}

func (e MonitoringInputDataContext) ToMonitoringInputDataContextPtrOutputWithContext(ctx context.Context) MonitoringInputDataContextPtrOutput {
	return MonitoringInputDataContext(e).ToMonitoringInputDataContextOutputWithContext(ctx).ToMonitoringInputDataContextPtrOutputWithContext(ctx)
}

func (e MonitoringInputDataContext) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e MonitoringInputDataContext) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e MonitoringInputDataContext) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e MonitoringInputDataContext) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type MonitoringInputDataContextOutput struct{ *pulumi.OutputState }

func (MonitoringInputDataContextOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*MonitoringInputDataContext)(nil)).Elem()
}

func (o MonitoringInputDataContextOutput) ToMonitoringInputDataContextOutput() MonitoringInputDataContextOutput {
	return o
}

func (o MonitoringInputDataContextOutput) ToMonitoringInputDataContextOutputWithContext(ctx context.Context) MonitoringInputDataContextOutput {
	return o
}

func (o MonitoringInputDataContextOutput) ToMonitoringInputDataContextPtrOutput() MonitoringInputDataContextPtrOutput {
	return o.ToMonitoringInputDataContextPtrOutputWithContext(context.Background())
}

func (o MonitoringInputDataContextOutput) ToMonitoringInputDataContextPtrOutputWithContext(ctx context.Context) MonitoringInputDataContextPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v MonitoringInputDataContext) *MonitoringInputDataContext {
		return &v
	}).(MonitoringInputDataContextPtrOutput)
}

func (o MonitoringInputDataContextOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o MonitoringInputDataContextOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e MonitoringInputDataContext) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o MonitoringInputDataContextOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o MonitoringInputDataContextOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e MonitoringInputDataContext) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type MonitoringInputDataContextPtrOutput struct{ *pulumi.OutputState }

func (MonitoringInputDataContextPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**MonitoringInputDataContext)(nil)).Elem()
}

func (o MonitoringInputDataContextPtrOutput) ToMonitoringInputDataContextPtrOutput() MonitoringInputDataContextPtrOutput {
	return o
}

func (o MonitoringInputDataContextPtrOutput) ToMonitoringInputDataContextPtrOutputWithContext(ctx context.Context) MonitoringInputDataContextPtrOutput {
	return o
}

func (o MonitoringInputDataContextPtrOutput) Elem() MonitoringInputDataContextOutput {
	return o.ApplyT(func(v *MonitoringInputDataContext) MonitoringInputDataContext {
		if v != nil {
			return *v
		}
		var ret MonitoringInputDataContext
		return ret
	}).(MonitoringInputDataContextOutput)
}

func (o MonitoringInputDataContextPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o MonitoringInputDataContextPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *MonitoringInputDataContext) *string {
		if e == nil {
			return nil
		}
...
// MonitoringInputDataContextInput is an input type that accepts values of the MonitoringInputDataContext enum
// A concrete instance of `MonitoringInputDataContextInput` can be one of the following:
//
//	MonitoringInputDataContextModelInputs
//	MonitoringInputDataContextModelOutputs
//	MonitoringInputDataContextTraining
//	MonitoringInputDataContextTest
//	MonitoringInputDataContextValidation
//	MonitoringInputDataContextGroundTruth
type MonitoringInputDataContextInput interface {
	pulumi.Input

	ToMonitoringInputDataContextOutput() MonitoringInputDataContextOutput
	ToMonitoringInputDataContextOutputWithContext(context.Context) MonitoringInputDataContextOutput
}

var monitoringInputDataContextPtrType = reflect.TypeOf((**MonitoringInputDataContext)(nil)).Elem()

type MonitoringInputDataContextPtrInput interface {
	pulumi.Input

	ToMonitoringInputDataContextPtrOutput() MonitoringInputDataContextPtrOutput
	ToMonitoringInputDataContextPtrOutputWithContext(context.Context) MonitoringInputDataContextPtrOutput
}

type monitoringInputDataContextPtr string

func MonitoringInputDataContextPtr(v string) MonitoringInputDataContextPtrInput {
	return (*monitoringInputDataContextPtr)(&v)
}

func (*monitoringInputDataContextPtr) ElementType() reflect.Type {
	return monitoringInputDataContextPtrType
}

func (in *monitoringInputDataContextPtr) ToMonitoringInputDataContextPtrOutput() MonitoringInputDataContextPtrOutput {
	return pulumi.ToOutput(in).(MonitoringInputDataContextPtrOutput)
}

func (in *monitoringInputDataContextPtr) ToMonitoringInputDataContextPtrOutputWithContext(ctx context.Context) MonitoringInputDataContextPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(MonitoringInputDataContextPtrOutput)
}

func (in *monitoringInputDataContextPtr) ToOutput(ctx context.Context) pulumix.Output[*MonitoringInputDataContext] {
	return pulumix.Output[*MonitoringInputDataContext]{
		OutputState: in.ToMonitoringInputDataContextPtrOutputWithContext(ctx).OutputState,
	}
}
...
func init() {
	...
	pulumi.RegisterOutputType(MonitoringInputDataContextOutput{})
	pulumi.RegisterOutputType(MonitoringInputDataContextPtrOutput{})
