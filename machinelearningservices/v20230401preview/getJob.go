...
func LookupJob(ctx *pulumi.Context, args *LookupJobArgs, opts ...pulumi.InvokeOption) (*LookupJobResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20230401preview:getJob", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupJobOutput(ctx *pulumi.Context, args LookupJobOutputArgs, opts ...pulumi.InvokeOption) LookupJobResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupJobResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20230401preview:getJob", args, LookupJobResultOutput{}, options).(LookupJobResultOutput), nil
