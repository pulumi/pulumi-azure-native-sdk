...
func (o LookupRegistryEnvironmentVersionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRegistryEnvironmentVersionResult] {
	return pulumix.Output[LookupRegistryEnvironmentVersionResult]{
