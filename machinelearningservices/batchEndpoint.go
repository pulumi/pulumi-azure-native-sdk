...
func NewBatchEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:BatchEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:BatchEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:BatchEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:BatchEndpoint"),
		},
	})
