...
type LookupRegistryCodeContainerResult struct {
	...
	Properties CodeContainerPropertiesResponse `pulumi:"properties"`
...
func LookupRegistryCodeContainerOutput(ctx *pulumi.Context, args LookupRegistryCodeContainerOutputArgs, opts ...pulumi.InvokeOption) LookupRegistryCodeContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistryCodeContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices:getRegistryCodeContainer", args, LookupRegistryCodeContainerResultOutput{}, options).(LookupRegistryCodeContainerResultOutput), nil
...
// [Required] Additional attributes of the entity.
func (o LookupRegistryCodeContainerResultOutput) Properties() CodeContainerPropertiesResponseOutput {
	return o.ApplyT(func(v LookupRegistryCodeContainerResult) CodeContainerPropertiesResponse { return v.Properties }).(CodeContainerPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupRegistryCodeContainerResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupRegistryCodeContainerResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
