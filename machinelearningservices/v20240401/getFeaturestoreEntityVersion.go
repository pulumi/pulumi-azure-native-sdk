...
func LookupFeaturestoreEntityVersion(ctx *pulumi.Context, args *LookupFeaturestoreEntityVersionArgs, opts ...pulumi.InvokeOption) (*LookupFeaturestoreEntityVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240401:getFeaturestoreEntityVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupFeaturestoreEntityVersionOutput(ctx *pulumi.Context, args LookupFeaturestoreEntityVersionOutputArgs, opts ...pulumi.InvokeOption) LookupFeaturestoreEntityVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFeaturestoreEntityVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240401:getFeaturestoreEntityVersion", args, LookupFeaturestoreEntityVersionResultOutput{}, options).(LookupFeaturestoreEntityVersionResultOutput), nil
