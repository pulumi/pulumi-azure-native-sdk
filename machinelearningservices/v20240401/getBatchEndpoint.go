...
func LookupBatchEndpoint(ctx *pulumi.Context, args *LookupBatchEndpointArgs, opts ...pulumi.InvokeOption) (*LookupBatchEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240401:getBatchEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBatchEndpointOutput(ctx *pulumi.Context, args LookupBatchEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupBatchEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBatchEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240401:getBatchEndpoint", args, LookupBatchEndpointResultOutput{}, options).(LookupBatchEndpointResultOutput), nil
