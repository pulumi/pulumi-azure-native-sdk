...
func LookupManagedNetworkSettingsRule(ctx *pulumi.Context, args *LookupManagedNetworkSettingsRuleArgs, opts ...pulumi.InvokeOption) (*LookupManagedNetworkSettingsRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240401:getManagedNetworkSettingsRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedNetworkSettingsRuleOutput(ctx *pulumi.Context, args LookupManagedNetworkSettingsRuleOutputArgs, opts ...pulumi.InvokeOption) LookupManagedNetworkSettingsRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedNetworkSettingsRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240401:getManagedNetworkSettingsRule", args, LookupManagedNetworkSettingsRuleResultOutput{}, options).(LookupManagedNetworkSettingsRuleResultOutput), nil
