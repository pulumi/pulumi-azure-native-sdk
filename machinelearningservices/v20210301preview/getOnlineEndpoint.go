...
func (o LookupOnlineEndpointResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOnlineEndpointResult] {
	return pulumix.Output[LookupOnlineEndpointResult]{
