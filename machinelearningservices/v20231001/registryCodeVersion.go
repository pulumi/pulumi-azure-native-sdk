...
func NewRegistryCodeVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20231001:RegistryCodeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryCodeVersion(ctx *pulumi.Context,
	...
	var resource RegistryCodeVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20231001:RegistryCodeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
