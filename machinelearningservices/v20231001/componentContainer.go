...
func NewComponentContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20231001:ComponentContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponentContainer(ctx *pulumi.Context,
	...
	var resource ComponentContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20231001:ComponentContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
