...
func NewRegistryCodeContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20231001:RegistryCodeContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryCodeContainer(ctx *pulumi.Context,
	...
	var resource RegistryCodeContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20231001:RegistryCodeContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
