...
func NewConnectionRaiBlocklistItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20250101preview:ConnectionRaiBlocklistItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionRaiBlocklistItem(ctx *pulumi.Context,
	...
	var resource ConnectionRaiBlocklistItem
	err := ctx.ReadResource("azure-native:machinelearningservices/v20250101preview:ConnectionRaiBlocklistItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
