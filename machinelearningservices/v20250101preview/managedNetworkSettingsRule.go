...
func NewManagedNetworkSettingsRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20250101preview:ManagedNetworkSettingsRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedNetworkSettingsRule(ctx *pulumi.Context,
	...
	var resource ManagedNetworkSettingsRule
	err := ctx.ReadResource("azure-native:machinelearningservices/v20250101preview:ManagedNetworkSettingsRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
