...
func ListOnlineEndpointKeys(ctx *pulumi.Context, args *ListOnlineEndpointKeysArgs, opts ...pulumi.InvokeOption) (*ListOnlineEndpointKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20250101preview:listOnlineEndpointKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListOnlineEndpointKeysOutput(ctx *pulumi.Context, args ListOnlineEndpointKeysOutputArgs, opts ...pulumi.InvokeOption) ListOnlineEndpointKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListOnlineEndpointKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20250101preview:listOnlineEndpointKeys", args, ListOnlineEndpointKeysResultOutput{}, options).(ListOnlineEndpointKeysResultOutput), nil
