...
func NewConnectionDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20250101preview:ConnectionDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionDeployment(ctx *pulumi.Context,
	...
	var resource ConnectionDeployment
	err := ctx.ReadResource("azure-native:machinelearningservices/v20250101preview:ConnectionDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
