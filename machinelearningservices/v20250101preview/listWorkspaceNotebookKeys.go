...
func ListWorkspaceNotebookKeys(ctx *pulumi.Context, args *ListWorkspaceNotebookKeysArgs, opts ...pulumi.InvokeOption) (*ListWorkspaceNotebookKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20250101preview:listWorkspaceNotebookKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWorkspaceNotebookKeysOutput(ctx *pulumi.Context, args ListWorkspaceNotebookKeysOutputArgs, opts ...pulumi.InvokeOption) ListWorkspaceNotebookKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkspaceNotebookKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20250101preview:listWorkspaceNotebookKeys", args, ListWorkspaceNotebookKeysResultOutput{}, options).(ListWorkspaceNotebookKeysResultOutput), nil
