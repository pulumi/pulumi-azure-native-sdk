...
func ListWorkspaceConnectionSecrets(ctx *pulumi.Context, args *ListWorkspaceConnectionSecretsArgs, opts ...pulumi.InvokeOption) (*ListWorkspaceConnectionSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20250101preview:listWorkspaceConnectionSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWorkspaceConnectionSecretsOutput(ctx *pulumi.Context, args ListWorkspaceConnectionSecretsOutputArgs, opts ...pulumi.InvokeOption) ListWorkspaceConnectionSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkspaceConnectionSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20250101preview:listWorkspaceConnectionSecrets", args, ListWorkspaceConnectionSecretsResultOutput{}, options).(ListWorkspaceConnectionSecretsResultOutput), nil
