...
// Deprecated: azure-native:machinelearningservices/v20221201preview:BatchEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:BatchEndpoint to guarantee forwards compatibility.
...
func NewBatchEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221201preview:BatchEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBatchEndpoint(ctx *pulumi.Context,
	...
	var resource BatchEndpoint
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221201preview:BatchEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
