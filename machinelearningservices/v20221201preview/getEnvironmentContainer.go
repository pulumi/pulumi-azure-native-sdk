...
//
// Deprecated: azure-native:machinelearningservices/v20221201preview:EnvironmentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:EnvironmentContainer to guarantee forwards compatibility.
func LookupEnvironmentContainer(ctx *pulumi.Context, args *LookupEnvironmentContainerArgs, opts ...pulumi.InvokeOption) (*LookupEnvironmentContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20221201preview:getEnvironmentContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
