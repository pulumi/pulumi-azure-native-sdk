...
func NewModelVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221201preview:ModelVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModelVersion(ctx *pulumi.Context,
	...
	var resource ModelVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221201preview:ModelVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
