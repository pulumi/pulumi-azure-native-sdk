...
//
// Deprecated: azure-native:machinelearningservices/v20221201preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Job to guarantee forwards compatibility.
func LookupJob(ctx *pulumi.Context, args *LookupJobArgs, opts ...pulumi.InvokeOption) (*LookupJobResult, error) {
	var rv LookupJobResult
	err := ctx.Invoke("azure-native:machinelearningservices/v20221201preview:getJob", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
