...
//
// Deprecated: azure-native:machinelearningservices/v20221201preview:RegistryComponentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:RegistryComponentVersion to guarantee forwards compatibility.
func LookupRegistryComponentVersion(ctx *pulumi.Context, args *LookupRegistryComponentVersionArgs, opts ...pulumi.InvokeOption) (*LookupRegistryComponentVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20221201preview:getRegistryComponentVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
