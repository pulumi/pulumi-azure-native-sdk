...
//
// Deprecated: azure-native:machinelearningservices/v20221201preview:Compute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Compute to guarantee forwards compatibility.
type Compute struct {
...
func NewCompute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221201preview:Compute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCompute(ctx *pulumi.Context,
	...
	var resource Compute
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221201preview:Compute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
