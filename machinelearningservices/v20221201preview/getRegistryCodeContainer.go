...
//
// Deprecated: azure-native:machinelearningservices/v20221201preview:RegistryCodeContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:RegistryCodeContainer to guarantee forwards compatibility.
func LookupRegistryCodeContainer(ctx *pulumi.Context, args *LookupRegistryCodeContainerArgs, opts ...pulumi.InvokeOption) (*LookupRegistryCodeContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20221201preview:getRegistryCodeContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
