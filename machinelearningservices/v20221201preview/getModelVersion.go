...
//
// Deprecated: azure-native:machinelearningservices/v20221201preview:ModelVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:ModelVersion to guarantee forwards compatibility.
func LookupModelVersion(ctx *pulumi.Context, args *LookupModelVersionArgs, opts ...pulumi.InvokeOption) (*LookupModelVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20221201preview:getModelVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
