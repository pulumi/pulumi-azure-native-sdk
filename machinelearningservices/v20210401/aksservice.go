...
func NewAKSService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20210401:AKSService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAKSService(ctx *pulumi.Context,
	...
	var resource AKSService
	err := ctx.ReadResource("azure-native:machinelearningservices/v20210401:AKSService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *AKSService) ToOutput(ctx context.Context) pulumix.Output[*AKSService] {
	return pulumix.Output[*AKSService]{
		OutputState: i.ToAKSServiceOutputWithContext(ctx).OutputState,
	}
}
...
func (o AKSServiceOutput) ToOutput(ctx context.Context) pulumix.Output[*AKSService] {
	return pulumix.Output[*AKSService]{
