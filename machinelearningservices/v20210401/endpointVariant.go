...
func NewEndpointVariant(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20210401:EndpointVariant", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpointVariant(ctx *pulumi.Context,
	...
	var resource EndpointVariant
	err := ctx.ReadResource("azure-native:machinelearningservices/v20210401:EndpointVariant", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
