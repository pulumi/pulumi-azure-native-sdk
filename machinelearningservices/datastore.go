...
func NewDatastore(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:Datastore"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:Datastore"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:Datastore"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:Datastore"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices:Datastore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatastore(ctx *pulumi.Context,
	...
	var resource Datastore
	err := ctx.ReadResource("azure-native:machinelearningservices:Datastore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
