...
func NewRegistryDataContainer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251001preview:RegistryDataContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251201:RegistryDataContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:RegistryDataContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:RegistryDataContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:RegistryDataContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:RegistryDataContainer"),
		},
	})
...
// [Required] Additional attributes of the entity.
func (o RegistryDataContainerOutput) Properties() DataContainerPropertiesResponseOutput {
	return o.ApplyT(func(v *RegistryDataContainer) DataContainerPropertiesResponseOutput { return v.Properties }).(DataContainerPropertiesResponseOutput)
}
