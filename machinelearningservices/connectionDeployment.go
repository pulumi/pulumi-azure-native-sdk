...
func NewConnectionDeployment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:ConnectionDeployment"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:ConnectionDeployment"),
		},
	})
