...
func NewRegistryEnvironmentVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:RegistryEnvironmentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:RegistryEnvironmentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:RegistryEnvironmentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:RegistryEnvironmentVersion"),
		},
	})
