...
func NewRegistryModelVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:RegistryModelVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:RegistryModelVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:RegistryModelVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:RegistryModelVersion"),
		},
	})
