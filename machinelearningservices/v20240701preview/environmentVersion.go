...
func NewEnvironmentVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240701preview:EnvironmentVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentVersion(ctx *pulumi.Context,
	...
	var resource EnvironmentVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240701preview:EnvironmentVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
