...
func LookupDataContainer(ctx *pulumi.Context, args *LookupDataContainerArgs, opts ...pulumi.InvokeOption) (*LookupDataContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240701preview:getDataContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDataContainerOutput(ctx *pulumi.Context, args LookupDataContainerOutputArgs, opts ...pulumi.InvokeOption) LookupDataContainerResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupDataContainerResultOutput, error) {
			...
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv LookupDataContainerResult
			secret, err := ctx.InvokePackageRaw("azure-native:machinelearningservices/v20240701preview:getDataContainer", args, &rv, "", opts...)
			if err != nil {
				return LookupDataContainerResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupDataContainerResultOutput)
			if secret {
				return pulumi.ToSecret(output).(LookupDataContainerResultOutput), nil
			}
			return output, nil
