...
func LookupComponentContainer(ctx *pulumi.Context, args *LookupComponentContainerArgs, opts ...pulumi.InvokeOption) (*LookupComponentContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240701preview:getComponentContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupComponentContainerOutput(ctx *pulumi.Context, args LookupComponentContainerOutputArgs, opts ...pulumi.InvokeOption) LookupComponentContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupComponentContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240701preview:getComponentContainer", args, LookupComponentContainerResultOutput{}, options).(LookupComponentContainerResultOutput), nil
