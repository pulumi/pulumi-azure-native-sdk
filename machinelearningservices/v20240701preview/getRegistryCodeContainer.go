...
func LookupRegistryCodeContainer(ctx *pulumi.Context, args *LookupRegistryCodeContainerArgs, opts ...pulumi.InvokeOption) (*LookupRegistryCodeContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240701preview:getRegistryCodeContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupRegistryCodeContainerOutput(ctx *pulumi.Context, args LookupRegistryCodeContainerOutputArgs, opts ...pulumi.InvokeOption) LookupRegistryCodeContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistryCodeContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240701preview:getRegistryCodeContainer", args, LookupRegistryCodeContainerResultOutput{}, options).(LookupRegistryCodeContainerResultOutput), nil
