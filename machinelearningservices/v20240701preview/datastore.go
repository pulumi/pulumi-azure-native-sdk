...
func NewDatastore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240701preview:Datastore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatastore(ctx *pulumi.Context,
	...
	var resource Datastore
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240701preview:Datastore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
