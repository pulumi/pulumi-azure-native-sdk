...
func LookupCodeContainer(ctx *pulumi.Context, args *LookupCodeContainerArgs, opts ...pulumi.InvokeOption) (*LookupCodeContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240701preview:getCodeContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupCodeContainerOutput(ctx *pulumi.Context, args LookupCodeContainerOutputArgs, opts ...pulumi.InvokeOption) LookupCodeContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCodeContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240701preview:getCodeContainer", args, LookupCodeContainerResultOutput{}, options).(LookupCodeContainerResultOutput), nil
