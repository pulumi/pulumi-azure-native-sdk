...
func NewEnvironmentContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240701preview:EnvironmentContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentContainer(ctx *pulumi.Context,
	...
	var resource EnvironmentContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240701preview:EnvironmentContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
