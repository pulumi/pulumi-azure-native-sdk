...
func LookupRegistryEnvironmentVersion(ctx *pulumi.Context, args *LookupRegistryEnvironmentVersionArgs, opts ...pulumi.InvokeOption) (*LookupRegistryEnvironmentVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices:getRegistryEnvironmentVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupRegistryEnvironmentVersionOutput(ctx *pulumi.Context, args LookupRegistryEnvironmentVersionOutputArgs, opts ...pulumi.InvokeOption) LookupRegistryEnvironmentVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistryEnvironmentVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices:getRegistryEnvironmentVersion", args, LookupRegistryEnvironmentVersionResultOutput{}, options).(LookupRegistryEnvironmentVersionResultOutput), nil
...
// [Required] Additional attributes of the entity.
func (o LookupRegistryEnvironmentVersionResultOutput) Properties() EnvironmentVersionPropertiesResponseOutput {
	return o.ApplyT(func(v LookupRegistryEnvironmentVersionResult) EnvironmentVersionPropertiesResponse {
		return v.Properties
	}).(EnvironmentVersionPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupRegistryEnvironmentVersionResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupRegistryEnvironmentVersionResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
