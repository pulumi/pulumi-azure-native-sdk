...
func NewRegistry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:Registry"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:Registry"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:Registry"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:Registry"),
		},
	})
