...
//
// Deprecated: azure-native:machinelearningservices/v20220501:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Workspace to guarantee forwards compatibility.
func LookupWorkspace(ctx *pulumi.Context, args *LookupWorkspaceArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceResult, error) {
	var rv LookupWorkspaceResult
	err := ctx.Invoke("azure-native:machinelearningservices/v20220501:getWorkspace", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
