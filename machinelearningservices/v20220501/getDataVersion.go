...
//
// Deprecated: azure-native:machinelearningservices/v20220501:DataVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:DataVersion to guarantee forwards compatibility.
func LookupDataVersion(ctx *pulumi.Context, args *LookupDataVersionArgs, opts ...pulumi.InvokeOption) (*LookupDataVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220501:getDataVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
