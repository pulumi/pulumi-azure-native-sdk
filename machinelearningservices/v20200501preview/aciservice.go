...
func NewACIService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20200501preview:ACIService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetACIService(ctx *pulumi.Context,
	...
	var resource ACIService
	err := ctx.ReadResource("azure-native:machinelearningservices/v20200501preview:ACIService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
