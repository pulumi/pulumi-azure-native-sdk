...
func NewCompute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:Compute"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:Compute"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:Compute"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:Compute"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Compute
	err := ctx.RegisterResource("azure-native:machinelearningservices:Compute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCompute(ctx *pulumi.Context,
	...
	var resource Compute
	err := ctx.ReadResource("azure-native:machinelearningservices:Compute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
