...
type BatchEndpoint struct {
	...
	BatchEndpointDetails BatchEndpointResponseOutput `pulumi:"batchEndpointDetails"`
...
func NewBatchEndpoint(ctx *pulumi.Context,
	...
	if args.BatchEndpointDetails == nil {
		return nil, errors.New("invalid value for required argument 'BatchEndpointDetails'")
	}
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20231001:BatchEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240101preview:BatchEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240401:BatchEndpoint"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001:BatchEndpoint"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20220201preview:BatchEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBatchEndpoint(ctx *pulumi.Context,
	...
	var resource BatchEndpoint
	err := ctx.ReadResource("azure-native:machinelearningservices/v20220201preview:BatchEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type batchEndpointArgs struct {
	// [Required] Additional attributes of the entity.
	BatchEndpointDetails BatchEndpointType `pulumi:"batchEndpointDetails"`
...
type BatchEndpointArgs struct {
	// [Required] Additional attributes of the entity.
	BatchEndpointDetails BatchEndpointTypeInput
	// Name for the Batch inference endpoint.
...
// [Required] Additional attributes of the entity.
func (o BatchEndpointOutput) BatchEndpointDetails() BatchEndpointResponseOutput {
	return o.ApplyT(func(v *BatchEndpoint) BatchEndpointResponseOutput { return v.BatchEndpointDetails }).(BatchEndpointResponseOutput)
}
