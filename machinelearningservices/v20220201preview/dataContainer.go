...
type DataContainer struct {
	...
	DataContainerDetails DataContainerResponseOutput `pulumi:"dataContainerDetails"`
...
func NewDataContainer(ctx *pulumi.Context,
	...
	if args.DataContainerDetails == nil {
		return nil, errors.New("invalid value for required argument 'DataContainerDetails'")
	}
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240701preview:DataContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001:DataContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001preview:DataContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250101preview:DataContainer"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20220201preview:DataContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataContainer(ctx *pulumi.Context,
	...
	var resource DataContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20220201preview:DataContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type dataContainerArgs struct {
	// [Required] Additional attributes of the entity.
	DataContainerDetails DataContainerType `pulumi:"dataContainerDetails"`
	// Container name.
...
type DataContainerArgs struct {
	// [Required] Additional attributes of the entity.
	DataContainerDetails DataContainerTypeInput
	// Container name.
...
// [Required] Additional attributes of the entity.
func (o DataContainerOutput) DataContainerDetails() DataContainerResponseOutput {
	return o.ApplyT(func(v *DataContainer) DataContainerResponseOutput { return v.DataContainerDetails }).(DataContainerResponseOutput)
}
