...
func LookupOnlineDeploymentOutput(ctx *pulumi.Context, args LookupOnlineDeploymentOutputArgs, opts ...pulumi.InvokeOption) LookupOnlineDeploymentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOnlineDeploymentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20220201preview:getOnlineDeployment", args, LookupOnlineDeploymentResultOutput{}, options).(LookupOnlineDeploymentResultOutput), nil
...
// [Required] Additional attributes of the entity.
func (o LookupOnlineDeploymentResultOutput) OnlineDeploymentDetails() pulumi.AnyOutput {
	return o.ApplyT(func(v LookupOnlineDeploymentResult) interface{} { return v.OnlineDeploymentDetails }).(pulumi.AnyOutput)
}
