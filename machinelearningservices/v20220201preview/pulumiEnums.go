...
func (in *modelTypePtr) ToOutput(ctx context.Context) pulumix.Output[*ModelType] {
	return pulumix.Output[*ModelType]{
		OutputState: in.ToModelTypePtrOutputWithContext(ctx).OutputState,
	}
}
