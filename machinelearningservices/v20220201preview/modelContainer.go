...
type ModelContainer struct {
	...
	ModelContainerDetails ModelContainerResponseOutput `pulumi:"modelContainerDetails"`
...
func NewModelContainer(ctx *pulumi.Context,
	...
	if args.ModelContainerDetails == nil {
		return nil, errors.New("invalid value for required argument 'ModelContainerDetails'")
	}
	...
	args.ModelContainerDetails = args.ModelContainerDetails.ToModelContainerTypeOutput().ApplyT(func(v ModelContainerType) ModelContainerType { return *v.Defaults() }).(ModelContainerTypeOutput)
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240101preview:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240401:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240401preview:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240701preview:ModelContainer"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20220201preview:ModelContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModelContainer(ctx *pulumi.Context,
	...
	var resource ModelContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20220201preview:ModelContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type modelContainerArgs struct {
	// [Required] Additional attributes of the entity.
	ModelContainerDetails ModelContainerType `pulumi:"modelContainerDetails"`
...
type ModelContainerArgs struct {
	// [Required] Additional attributes of the entity.
	ModelContainerDetails ModelContainerTypeInput
	// Container name. This is case-sensitive.
...
// [Required] Additional attributes of the entity.
func (o ModelContainerOutput) ModelContainerDetails() ModelContainerResponseOutput {
	return o.ApplyT(func(v *ModelContainer) ModelContainerResponseOutput { return v.ModelContainerDetails }).(ModelContainerResponseOutput)
}
