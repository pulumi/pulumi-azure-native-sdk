...
func LookupCodeVersion(ctx *pulumi.Context, args *LookupCodeVersionArgs, opts ...pulumi.InvokeOption) (*LookupCodeVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220201preview:getCodeVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupCodeVersionResult struct {
	...
	CodeVersionDetails CodeVersionResponse `pulumi:"codeVersionDetails"`
...
func (val *LookupCodeVersionResult) Defaults() *LookupCodeVersionResult {
	...
	tmp := *val
	tmp.CodeVersionDetails = *tmp.CodeVersionDetails.Defaults()
...
func LookupCodeVersionOutput(ctx *pulumi.Context, args LookupCodeVersionOutputArgs, opts ...pulumi.InvokeOption) LookupCodeVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCodeVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20220201preview:getCodeVersion", args, LookupCodeVersionResultOutput{}, options).(LookupCodeVersionResultOutput), nil
...
// [Required] Additional attributes of the entity.
func (o LookupCodeVersionResultOutput) CodeVersionDetails() CodeVersionResponseOutput {
	return o.ApplyT(func(v LookupCodeVersionResult) CodeVersionResponse { return v.CodeVersionDetails }).(CodeVersionResponseOutput)
}
