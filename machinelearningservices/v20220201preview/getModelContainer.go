...
func LookupModelContainer(ctx *pulumi.Context, args *LookupModelContainerArgs, opts ...pulumi.InvokeOption) (*LookupModelContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220201preview:getModelContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupModelContainerResult struct {
	...
	ModelContainerDetails ModelContainerResponse `pulumi:"modelContainerDetails"`
...
func (val *LookupModelContainerResult) Defaults() *LookupModelContainerResult {
	...
	tmp := *val
	tmp.ModelContainerDetails = *tmp.ModelContainerDetails.Defaults()
...
func LookupModelContainerOutput(ctx *pulumi.Context, args LookupModelContainerOutputArgs, opts ...pulumi.InvokeOption) LookupModelContainerResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupModelContainerResultOutput, error) {
			args := v.(LookupModelContainerArgs)
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv LookupModelContainerResult
			secret, err := ctx.InvokePackageRaw("azure-native:machinelearningservices/v20220201preview:getModelContainer", args, &rv, "", opts...)
			if err != nil {
				return LookupModelContainerResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupModelContainerResultOutput)
			if secret {
				return pulumi.ToSecret(output).(LookupModelContainerResultOutput), nil
			}
			return output, nil
...
// [Required] Additional attributes of the entity.
func (o LookupModelContainerResultOutput) ModelContainerDetails() ModelContainerResponseOutput {
	return o.ApplyT(func(v LookupModelContainerResult) ModelContainerResponse { return v.ModelContainerDetails }).(ModelContainerResponseOutput)
}
