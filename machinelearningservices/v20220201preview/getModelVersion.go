...
func LookupModelVersion(ctx *pulumi.Context, args *LookupModelVersionArgs, opts ...pulumi.InvokeOption) (*LookupModelVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220201preview:getModelVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupModelVersionResult struct {
	...
	ModelVersionDetails ModelVersionResponse `pulumi:"modelVersionDetails"`
...
func (val *LookupModelVersionResult) Defaults() *LookupModelVersionResult {
	...
	tmp := *val
	tmp.ModelVersionDetails = *tmp.ModelVersionDetails.Defaults()
...
func LookupModelVersionOutput(ctx *pulumi.Context, args LookupModelVersionOutputArgs, opts ...pulumi.InvokeOption) LookupModelVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupModelVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20220201preview:getModelVersion", args, LookupModelVersionResultOutput{}, options).(LookupModelVersionResultOutput), nil
...
// [Required] Additional attributes of the entity.
func (o LookupModelVersionResultOutput) ModelVersionDetails() ModelVersionResponseOutput {
	return o.ApplyT(func(v LookupModelVersionResult) ModelVersionResponse { return v.ModelVersionDetails }).(ModelVersionResponseOutput)
}
