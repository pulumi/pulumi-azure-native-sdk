...
type EnvironmentContainer struct {
	...
	EnvironmentContainerDetails EnvironmentContainerResponseOutput `pulumi:"environmentContainerDetails"`
...
func NewEnvironmentContainer(ctx *pulumi.Context,
	...
	if args.EnvironmentContainerDetails == nil {
		return nil, errors.New("invalid value for required argument 'EnvironmentContainerDetails'")
	}
	...
	args.EnvironmentContainerDetails = args.EnvironmentContainerDetails.ToEnvironmentContainerTypeOutput().ApplyT(func(v EnvironmentContainerType) EnvironmentContainerType { return *v.Defaults() }).(EnvironmentContainerTypeOutput)
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20220201preview:EnvironmentContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentContainer(ctx *pulumi.Context,
	...
	var resource EnvironmentContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20220201preview:EnvironmentContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type environmentContainerArgs struct {
	// [Required] Additional attributes of the entity.
	EnvironmentContainerDetails EnvironmentContainerType `pulumi:"environmentContainerDetails"`
...
type EnvironmentContainerArgs struct {
	// [Required] Additional attributes of the entity.
	EnvironmentContainerDetails EnvironmentContainerTypeInput
	// Container name. This is case-sensitive.
...
// [Required] Additional attributes of the entity.
func (o EnvironmentContainerOutput) EnvironmentContainerDetails() EnvironmentContainerResponseOutput {
	return o.ApplyT(func(v *EnvironmentContainer) EnvironmentContainerResponseOutput { return v.EnvironmentContainerDetails }).(EnvironmentContainerResponseOutput)
}
