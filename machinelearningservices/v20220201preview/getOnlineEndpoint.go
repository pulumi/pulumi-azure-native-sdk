...
func LookupOnlineEndpoint(ctx *pulumi.Context, args *LookupOnlineEndpointArgs, opts ...pulumi.InvokeOption) (*LookupOnlineEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20220201preview:getOnlineEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupOnlineEndpointResult struct {
	...
	OnlineEndpointDetails OnlineEndpointResponse `pulumi:"onlineEndpointDetails"`
...
func (val *LookupOnlineEndpointResult) Defaults() *LookupOnlineEndpointResult {
	...
	tmp := *val
	tmp.OnlineEndpointDetails = *tmp.OnlineEndpointDetails.Defaults()
...
func LookupOnlineEndpointOutput(ctx *pulumi.Context, args LookupOnlineEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupOnlineEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOnlineEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20220201preview:getOnlineEndpoint", args, LookupOnlineEndpointResultOutput{}, options).(LookupOnlineEndpointResultOutput), nil
...
// [Required] Additional attributes of the entity.
func (o LookupOnlineEndpointResultOutput) OnlineEndpointDetails() OnlineEndpointResponseOutput {
	return o.ApplyT(func(v LookupOnlineEndpointResult) OnlineEndpointResponse { return v.OnlineEndpointDetails }).(OnlineEndpointResponseOutput)
}
