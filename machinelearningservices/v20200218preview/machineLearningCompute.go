...
func NewMachineLearningCompute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20200218preview:MachineLearningCompute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineLearningCompute(ctx *pulumi.Context,
	...
	var resource MachineLearningCompute
	err := ctx.ReadResource("azure-native:machinelearningservices/v20200218preview:MachineLearningCompute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
