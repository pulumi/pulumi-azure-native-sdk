...
func NewWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250101preview:Workspace"),
		},
		{
...
// Allow a soft deleted workspace to be recovered
func (o WorkspaceOutput) AllowRecoverSoftDeletedWorkspace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Workspace) pulumi.StringPtrOutput { return v.AllowRecoverSoftDeletedWorkspace }).(pulumi.StringPtrOutput)
}
...
// create a workspace with soft delete capability
func (o WorkspaceOutput) SoftDeleteEnabled() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Workspace) pulumi.StringPtrOutput { return v.SoftDeleteEnabled }).(pulumi.StringPtrOutput)
}
