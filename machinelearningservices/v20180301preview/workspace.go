...
func NewWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20180301preview:Workspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspace(ctx *pulumi.Context,
	...
	var resource Workspace
	err := ctx.ReadResource("azure-native:machinelearningservices/v20180301preview:Workspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// ARM id of the Batch AI workspace associated with this workspace. This cannot be changed once the workspace has been created
func (o WorkspaceOutput) BatchaiWorkspace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Workspace) pulumi.StringPtrOutput { return v.BatchaiWorkspace }).(pulumi.StringPtrOutput)
}
