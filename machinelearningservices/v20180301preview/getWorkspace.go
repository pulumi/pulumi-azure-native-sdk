...
// ARM id of the Batch AI workspace associated with this workspace. This cannot be changed once the workspace has been created
func (o LookupWorkspaceResultOutput) BatchaiWorkspace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *string { return v.BatchaiWorkspace }).(pulumi.StringPtrOutput)
}
