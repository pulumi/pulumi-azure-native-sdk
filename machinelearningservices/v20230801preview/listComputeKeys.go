...
func ListComputeKeys(ctx *pulumi.Context, args *ListComputeKeysArgs, opts ...pulumi.InvokeOption) (*ListComputeKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20230801preview:listComputeKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListComputeKeysOutput(ctx *pulumi.Context, args ListComputeKeysOutputArgs, opts ...pulumi.InvokeOption) ListComputeKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListComputeKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20230801preview:listComputeKeys", args, ListComputeKeysResultOutput{}, options).(ListComputeKeysResultOutput), nil
