...
func NewLabelingJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230801preview:LabelingJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLabelingJob(ctx *pulumi.Context,
	...
	var resource LabelingJob
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230801preview:LabelingJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
