...
func NewCompute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240101preview:Compute"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20240701preview:Compute"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001:Compute"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001preview:Compute"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230801preview:Compute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCompute(ctx *pulumi.Context,
	...
	var resource Compute
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230801preview:Compute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
