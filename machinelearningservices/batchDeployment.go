...
func NewBatchDeployment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:BatchDeployment"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:BatchDeployment"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:BatchDeployment"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:BatchDeployment"),
		},
	})
