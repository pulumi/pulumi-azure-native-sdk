...
//
// Deprecated: azure-native:machinelearningservices/v20210101:ACIService is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:ACIService to guarantee forwards compatibility.
...
func NewACIService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20210101:ACIService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetACIService(ctx *pulumi.Context,
	...
	var resource ACIService
	err := ctx.ReadResource("azure-native:machinelearningservices/v20210101:ACIService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
