...
func NewServerlessEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:ServerlessEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:ServerlessEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:ServerlessEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:ServerlessEndpoint"),
		},
	})
