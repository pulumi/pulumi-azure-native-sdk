...
func NewFeaturestoreEntityVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:FeaturestoreEntityVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:FeaturestoreEntityVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:FeaturestoreEntityVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:FeaturestoreEntityVersion"),
		},
	})
