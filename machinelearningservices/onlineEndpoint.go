...
func NewOnlineEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:OnlineEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:OnlineEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:OnlineEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:OnlineEndpoint"),
		},
	})
