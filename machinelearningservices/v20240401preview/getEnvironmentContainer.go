...
func LookupEnvironmentContainer(ctx *pulumi.Context, args *LookupEnvironmentContainerArgs, opts ...pulumi.InvokeOption) (*LookupEnvironmentContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240401preview:getEnvironmentContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupEnvironmentContainerOutput(ctx *pulumi.Context, args LookupEnvironmentContainerOutputArgs, opts ...pulumi.InvokeOption) LookupEnvironmentContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEnvironmentContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240401preview:getEnvironmentContainer", args, LookupEnvironmentContainerResultOutput{}, options).(LookupEnvironmentContainerResultOutput), nil
