...
func NewRaiPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240401preview:RaiPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRaiPolicy(ctx *pulumi.Context,
	...
	var resource RaiPolicy
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240401preview:RaiPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
