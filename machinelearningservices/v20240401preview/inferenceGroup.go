...
func NewInferenceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240401preview:InferenceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInferenceGroup(ctx *pulumi.Context,
	...
	var resource InferenceGroup
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240401preview:InferenceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
