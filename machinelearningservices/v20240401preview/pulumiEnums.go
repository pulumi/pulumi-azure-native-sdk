...
// [Required] Gets or sets the feature attribution metric to calculate.
type GenerationTokenUsageMetric string

const (
	GenerationTokenUsageMetricTotalTokenCount         = GenerationTokenUsageMetric("TotalTokenCount")
	GenerationTokenUsageMetricTotalTokenCountPerGroup = GenerationTokenUsageMetric("TotalTokenCountPerGroup")
)

func (GenerationTokenUsageMetric) ElementType() reflect.Type {
	return reflect.TypeOf((*GenerationTokenUsageMetric)(nil)).Elem()
}

func (e GenerationTokenUsageMetric) ToGenerationTokenUsageMetricOutput() GenerationTokenUsageMetricOutput {
	return pulumi.ToOutput(e).(GenerationTokenUsageMetricOutput)
}

func (e GenerationTokenUsageMetric) ToGenerationTokenUsageMetricOutputWithContext(ctx context.Context) GenerationTokenUsageMetricOutput {
	return pulumi.ToOutputWithContext(ctx, e).(GenerationTokenUsageMetricOutput)
}

func (e GenerationTokenUsageMetric) ToGenerationTokenUsageMetricPtrOutput() GenerationTokenUsageMetricPtrOutput {
	return e.ToGenerationTokenUsageMetricPtrOutputWithContext(context.Background())
}

func (e GenerationTokenUsageMetric) ToGenerationTokenUsageMetricPtrOutputWithContext(ctx context.Context) GenerationTokenUsageMetricPtrOutput {
	return GenerationTokenUsageMetric(e).ToGenerationTokenUsageMetricOutputWithContext(ctx).ToGenerationTokenUsageMetricPtrOutputWithContext(ctx)
}

func (e GenerationTokenUsageMetric) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e GenerationTokenUsageMetric) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e GenerationTokenUsageMetric) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e GenerationTokenUsageMetric) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type GenerationTokenUsageMetricOutput struct{ *pulumi.OutputState }

func (GenerationTokenUsageMetricOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GenerationTokenUsageMetric)(nil)).Elem()
}

func (o GenerationTokenUsageMetricOutput) ToGenerationTokenUsageMetricOutput() GenerationTokenUsageMetricOutput {
	return o
}

func (o GenerationTokenUsageMetricOutput) ToGenerationTokenUsageMetricOutputWithContext(ctx context.Context) GenerationTokenUsageMetricOutput {
	return o
}

func (o GenerationTokenUsageMetricOutput) ToGenerationTokenUsageMetricPtrOutput() GenerationTokenUsageMetricPtrOutput {
	return o.ToGenerationTokenUsageMetricPtrOutputWithContext(context.Background())
}

func (o GenerationTokenUsageMetricOutput) ToGenerationTokenUsageMetricPtrOutputWithContext(ctx context.Context) GenerationTokenUsageMetricPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v GenerationTokenUsageMetric) *GenerationTokenUsageMetric {
		return &v
	}).(GenerationTokenUsageMetricPtrOutput)
}

func (o GenerationTokenUsageMetricOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o GenerationTokenUsageMetricOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e GenerationTokenUsageMetric) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o GenerationTokenUsageMetricOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o GenerationTokenUsageMetricOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e GenerationTokenUsageMetric) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type GenerationTokenUsageMetricPtrOutput struct{ *pulumi.OutputState }

func (GenerationTokenUsageMetricPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**GenerationTokenUsageMetric)(nil)).Elem()
}

func (o GenerationTokenUsageMetricPtrOutput) ToGenerationTokenUsageMetricPtrOutput() GenerationTokenUsageMetricPtrOutput {
	return o
}

func (o GenerationTokenUsageMetricPtrOutput) ToGenerationTokenUsageMetricPtrOutputWithContext(ctx context.Context) GenerationTokenUsageMetricPtrOutput {
	return o
}

func (o GenerationTokenUsageMetricPtrOutput) Elem() GenerationTokenUsageMetricOutput {
	return o.ApplyT(func(v *GenerationTokenUsageMetric) GenerationTokenUsageMetric {
		if v != nil {
			return *v
		}
		var ret GenerationTokenUsageMetric
		return ret
	}).(GenerationTokenUsageMetricOutput)
}

func (o GenerationTokenUsageMetricPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o GenerationTokenUsageMetricPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *GenerationTokenUsageMetric) *string {
		if e == nil {
			return nil
		}
...
// GenerationTokenUsageMetricInput is an input type that accepts values of the GenerationTokenUsageMetric enum
// A concrete instance of `GenerationTokenUsageMetricInput` can be one of the following:
//
//	GenerationTokenUsageMetricTotalTokenCount
//	GenerationTokenUsageMetricTotalTokenCountPerGroup
type GenerationTokenUsageMetricInput interface {
	pulumi.Input

	ToGenerationTokenUsageMetricOutput() GenerationTokenUsageMetricOutput
	ToGenerationTokenUsageMetricOutputWithContext(context.Context) GenerationTokenUsageMetricOutput
}

var generationTokenUsageMetricPtrType = reflect.TypeOf((**GenerationTokenUsageMetric)(nil)).Elem()

type GenerationTokenUsageMetricPtrInput interface {
	pulumi.Input

	ToGenerationTokenUsageMetricPtrOutput() GenerationTokenUsageMetricPtrOutput
	ToGenerationTokenUsageMetricPtrOutputWithContext(context.Context) GenerationTokenUsageMetricPtrOutput
}

type generationTokenUsageMetricPtr string

func GenerationTokenUsageMetricPtr(v string) GenerationTokenUsageMetricPtrInput {
	return (*generationTokenUsageMetricPtr)(&v)
}

func (*generationTokenUsageMetricPtr) ElementType() reflect.Type {
	return generationTokenUsageMetricPtrType
}

func (in *generationTokenUsageMetricPtr) ToGenerationTokenUsageMetricPtrOutput() GenerationTokenUsageMetricPtrOutput {
	return pulumi.ToOutput(in).(GenerationTokenUsageMetricPtrOutput)
}

func (in *generationTokenUsageMetricPtr) ToGenerationTokenUsageMetricPtrOutputWithContext(ctx context.Context) GenerationTokenUsageMetricPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(GenerationTokenUsageMetricPtrOutput)
}
...
const (
	...
	MonitoringNotificationTypeAzureMonitor = MonitoringNotificationType("AzureMonitor")
)
...
func init() {
	...
	pulumi.RegisterOutputType(GenerationTokenUsageMetricOutput{})
	pulumi.RegisterOutputType(GenerationTokenUsageMetricPtrOutput{})
