...
// Managed service identity (system assigned and/or user assigned identities)
func (o OnlineDeploymentOutput) Identity() commontypesv3.ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v *OnlineDeployment) commontypesv3.ManagedServiceIdentityResponsePtrOutput { return v.Identity }).(commontypesv3.ManagedServiceIdentityResponsePtrOutput)
}
...
// Sku details required for ARM contract for Autoscaling.
func (o OnlineDeploymentOutput) Sku() commontypesv3.SkuResponsePtrOutput {
	return o.ApplyT(func(v *OnlineDeployment) commontypesv3.SkuResponsePtrOutput { return v.Sku }).(commontypesv3.SkuResponsePtrOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o OnlineDeploymentOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *OnlineDeployment) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
