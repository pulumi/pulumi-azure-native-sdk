...
func NewOnlineDeployment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:OnlineDeployment"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:OnlineDeployment"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:OnlineDeployment"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:OnlineDeployment"),
		},
	})
