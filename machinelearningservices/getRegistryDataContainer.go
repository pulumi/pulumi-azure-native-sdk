...
//
// Other available API versions: 2023-02-01-preview, 2023-04-01, 2023-04-01-preview, 2023-06-01-preview, 2023-08-01-preview, 2023-10-01, 2024-01-01-preview, 2024-04-01, 2024-07-01-preview, 2024-10-01, 2024-10-01-preview, 2025-01-01-preview, 2025-04-01, 2025-04-01-preview, 2025-06-01, 2025-07-01-preview, 2025-09-01, 2025-10-01-preview, 2026-01-15-preview, 2026-03-01, 2026-03-15-preview, 2026-05-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native machinelearningservices [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
func LookupRegistryDataContainer(ctx *pulumi.Context, args *LookupRegistryDataContainerArgs, opts ...pulumi.InvokeOption) (*LookupRegistryDataContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices:getRegistryDataContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupRegistryDataContainerResult struct {
	...
	Properties DataContainerPropertiesResponse `pulumi:"properties"`
...
func LookupRegistryDataContainerOutput(ctx *pulumi.Context, args LookupRegistryDataContainerOutputArgs, opts ...pulumi.InvokeOption) LookupRegistryDataContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistryDataContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices:getRegistryDataContainer", args, LookupRegistryDataContainerResultOutput{}, options).(LookupRegistryDataContainerResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupRegistryDataContainerResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegistryDataContainerResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// [Required] Additional attributes of the entity.
func (o LookupRegistryDataContainerResultOutput) Properties() DataContainerPropertiesResponseOutput {
	return o.ApplyT(func(v LookupRegistryDataContainerResult) DataContainerPropertiesResponse { return v.Properties }).(DataContainerPropertiesResponseOutput)
}
