...
func NewOutboundRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20241001preview:OutboundRule"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:OutboundRule"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:OutboundRule"),
		},
	})
