...
func LookupRegistryComponentContainer(ctx *pulumi.Context, args *LookupRegistryComponentContainerArgs, opts ...pulumi.InvokeOption) (*LookupRegistryComponentContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices:getRegistryComponentContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupRegistryComponentContainerOutput(ctx *pulumi.Context, args LookupRegistryComponentContainerOutputArgs, opts ...pulumi.InvokeOption) LookupRegistryComponentContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistryComponentContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices:getRegistryComponentContainer", args, LookupRegistryComponentContainerResultOutput{}, options).(LookupRegistryComponentContainerResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupRegistryComponentContainerResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegistryComponentContainerResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// [Required] Additional attributes of the entity.
func (o LookupRegistryComponentContainerResultOutput) Properties() ComponentContainerPropertiesResponseOutput {
	return o.ApplyT(func(v LookupRegistryComponentContainerResult) ComponentContainerPropertiesResponse {
		return v.Properties
	}).(ComponentContainerPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupRegistryComponentContainerResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupRegistryComponentContainerResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
