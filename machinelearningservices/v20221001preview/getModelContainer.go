...
//
// Deprecated: azure-native:machinelearningservices/v20221001preview:ModelContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:ModelContainer to guarantee forwards compatibility.
func LookupModelContainer(ctx *pulumi.Context, args *LookupModelContainerArgs, opts ...pulumi.InvokeOption) (*LookupModelContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20221001preview:getModelContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
