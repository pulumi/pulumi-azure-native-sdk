...
func NewOnlineEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221001preview:OnlineEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOnlineEndpoint(ctx *pulumi.Context,
	...
	var resource OnlineEndpoint
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221001preview:OnlineEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
