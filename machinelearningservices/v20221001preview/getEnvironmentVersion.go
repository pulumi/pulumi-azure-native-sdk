...
//
// Deprecated: azure-native:machinelearningservices/v20221001preview:EnvironmentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:EnvironmentVersion to guarantee forwards compatibility.
func LookupEnvironmentVersion(ctx *pulumi.Context, args *LookupEnvironmentVersionArgs, opts ...pulumi.InvokeOption) (*LookupEnvironmentVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20221001preview:getEnvironmentVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
