...
//
// Deprecated: azure-native:machinelearningservices/v20221001preview:ComponentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:ComponentContainer to guarantee forwards compatibility.
...
func NewComponentContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221001preview:ComponentContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponentContainer(ctx *pulumi.Context,
	...
	var resource ComponentContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221001preview:ComponentContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
