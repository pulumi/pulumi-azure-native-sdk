...
func NewComponentVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20221001preview:ComponentVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponentVersion(ctx *pulumi.Context,
	...
	var resource ComponentVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20221001preview:ComponentVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
