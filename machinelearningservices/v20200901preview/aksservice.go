...
//
// Deprecated: azure-native:machinelearningservices/v20200901preview:AKSService is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:AKSService to guarantee forwards compatibility.
...
func NewAKSService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20200901preview:AKSService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAKSService(ctx *pulumi.Context,
	...
	var resource AKSService
	err := ctx.ReadResource("azure-native:machinelearningservices/v20200901preview:AKSService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
