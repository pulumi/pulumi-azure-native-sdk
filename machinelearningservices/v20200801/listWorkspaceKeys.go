...
func ListWorkspaceKeysOutput(ctx *pulumi.Context, args ListWorkspaceKeysOutputArgs, opts ...pulumi.InvokeOption) ListWorkspaceKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkspaceKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20200801:listWorkspaceKeys", args, ListWorkspaceKeysResultOutput{}, options).(ListWorkspaceKeysResultOutput), nil
...
func (o ListWorkspaceKeysResultOutput) NotebookAccessKeys() NotebookListCredentialsResultResponsePtrOutput {
	return o.ApplyT(func(v ListWorkspaceKeysResult) *NotebookListCredentialsResultResponse { return v.NotebookAccessKeys }).(NotebookListCredentialsResultResponsePtrOutput)
}
