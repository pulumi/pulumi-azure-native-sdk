...
func NewDataContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230401:DataContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataContainer(ctx *pulumi.Context,
	...
	var resource DataContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230401:DataContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
