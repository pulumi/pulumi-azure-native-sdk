...
func NewCompute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230401:Compute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCompute(ctx *pulumi.Context,
	...
	var resource Compute
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230401:Compute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
