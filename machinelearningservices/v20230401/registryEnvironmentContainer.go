...
func NewRegistryEnvironmentContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230401:RegistryEnvironmentContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryEnvironmentContainer(ctx *pulumi.Context,
	...
	var resource RegistryEnvironmentContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230401:RegistryEnvironmentContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
