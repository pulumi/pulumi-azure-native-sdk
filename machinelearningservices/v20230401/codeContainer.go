...
func NewCodeContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230401:CodeContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodeContainer(ctx *pulumi.Context,
	...
	var resource CodeContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230401:CodeContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
