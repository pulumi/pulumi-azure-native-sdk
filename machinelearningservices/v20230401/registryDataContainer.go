...
func NewRegistryDataContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230401:RegistryDataContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryDataContainer(ctx *pulumi.Context,
	...
	var resource RegistryDataContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230401:RegistryDataContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *RegistryDataContainer) ToOutput(ctx context.Context) pulumix.Output[*RegistryDataContainer] {
	return pulumix.Output[*RegistryDataContainer]{
		OutputState: i.ToRegistryDataContainerOutputWithContext(ctx).OutputState,
	}
}
...
func (o RegistryDataContainerOutput) ToOutput(ctx context.Context) pulumix.Output[*RegistryDataContainer] {
	return pulumix.Output[*RegistryDataContainer]{
