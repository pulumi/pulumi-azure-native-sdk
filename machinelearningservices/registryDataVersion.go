...
func NewRegistryDataVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251001preview:RegistryDataVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251201:RegistryDataVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:RegistryDataVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:RegistryDataVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:RegistryDataVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:RegistryDataVersion"),
		},
	})
...
// [Required] Additional attributes of the entity.
func (o RegistryDataVersionOutput) Properties() pulumi.AnyOutput {
	return o.ApplyT(func(v *RegistryDataVersion) pulumi.AnyOutput { return v.Properties }).(pulumi.AnyOutput)
}
