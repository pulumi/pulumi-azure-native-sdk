...
func NewComponentVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401preview:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250601:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250701preview:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250901:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251001preview:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251201:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:ComponentVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:ComponentVersion"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ComponentVersion
	err := ctx.RegisterResource("azure-native:machinelearningservices:ComponentVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponentVersion(ctx *pulumi.Context,
	...
	var resource ComponentVersion
	err := ctx.ReadResource("azure-native:machinelearningservices:ComponentVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ComponentVersionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ComponentVersion) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// [Required] Additional attributes of the entity.
func (o ComponentVersionOutput) Properties() ComponentVersionPropertiesResponseOutput {
	return o.ApplyT(func(v *ComponentVersion) ComponentVersionPropertiesResponseOutput { return v.Properties }).(ComponentVersionPropertiesResponseOutput)
}
