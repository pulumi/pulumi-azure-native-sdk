...
func LookupManagedNetworkSettingsRule(ctx *pulumi.Context, args *LookupManagedNetworkSettingsRuleArgs, opts ...pulumi.InvokeOption) (*LookupManagedNetworkSettingsRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices:getManagedNetworkSettingsRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedNetworkSettingsRuleOutput(ctx *pulumi.Context, args LookupManagedNetworkSettingsRuleOutputArgs, opts ...pulumi.InvokeOption) LookupManagedNetworkSettingsRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedNetworkSettingsRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices:getManagedNetworkSettingsRule", args, LookupManagedNetworkSettingsRuleResultOutput{}, options).(LookupManagedNetworkSettingsRuleResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupManagedNetworkSettingsRuleResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupManagedNetworkSettingsRuleResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupManagedNetworkSettingsRuleResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupManagedNetworkSettingsRuleResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
