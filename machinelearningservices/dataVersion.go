...
func NewDataVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:DataVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:DataVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:DataVersion"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:DataVersion"),
		},
	})
