...
func ListServerlessEndpointKeys(ctx *pulumi.Context, args *ListServerlessEndpointKeysArgs, opts ...pulumi.InvokeOption) (*ListServerlessEndpointKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240101preview:listServerlessEndpointKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListServerlessEndpointKeysOutput(ctx *pulumi.Context, args ListServerlessEndpointKeysOutputArgs, opts ...pulumi.InvokeOption) ListServerlessEndpointKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListServerlessEndpointKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240101preview:listServerlessEndpointKeys", args, ListServerlessEndpointKeysResultOutput{}, options).(ListServerlessEndpointKeysResultOutput), nil
