...
func LookupServerlessEndpoint(ctx *pulumi.Context, args *LookupServerlessEndpointArgs, opts ...pulumi.InvokeOption) (*LookupServerlessEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240101preview:getServerlessEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerlessEndpointOutput(ctx *pulumi.Context, args LookupServerlessEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupServerlessEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerlessEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240101preview:getServerlessEndpoint", args, LookupServerlessEndpointResultOutput{}, options).(LookupServerlessEndpointResultOutput), nil
