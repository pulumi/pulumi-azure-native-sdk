...
func GetComputeAllowedResizeSizes(ctx *pulumi.Context, args *GetComputeAllowedResizeSizesArgs, opts ...pulumi.InvokeOption) (*GetComputeAllowedResizeSizesResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240101preview:getComputeAllowedResizeSizes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetComputeAllowedResizeSizesOutput(ctx *pulumi.Context, args GetComputeAllowedResizeSizesOutputArgs, opts ...pulumi.InvokeOption) GetComputeAllowedResizeSizesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetComputeAllowedResizeSizesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240101preview:getComputeAllowedResizeSizes", args, GetComputeAllowedResizeSizesResultOutput{}, options).(GetComputeAllowedResizeSizesResultOutput), nil
