...
func LookupRegistryEnvironmentContainer(ctx *pulumi.Context, args *LookupRegistryEnvironmentContainerArgs, opts ...pulumi.InvokeOption) (*LookupRegistryEnvironmentContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240101preview:getRegistryEnvironmentContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupRegistryEnvironmentContainerOutput(ctx *pulumi.Context, args LookupRegistryEnvironmentContainerOutputArgs, opts ...pulumi.InvokeOption) LookupRegistryEnvironmentContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistryEnvironmentContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240101preview:getRegistryEnvironmentContainer", args, LookupRegistryEnvironmentContainerResultOutput{}, options).(LookupRegistryEnvironmentContainerResultOutput), nil
