...
func LookupMarketplaceSubscription(ctx *pulumi.Context, args *LookupMarketplaceSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupMarketplaceSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240101preview:getMarketplaceSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMarketplaceSubscriptionOutput(ctx *pulumi.Context, args LookupMarketplaceSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupMarketplaceSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMarketplaceSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240101preview:getMarketplaceSubscription", args, LookupMarketplaceSubscriptionResultOutput{}, options).(LookupMarketplaceSubscriptionResultOutput), nil
