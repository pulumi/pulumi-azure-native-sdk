...
func NewRegistryDataContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240101preview:RegistryDataContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryDataContainer(ctx *pulumi.Context,
	...
	var resource RegistryDataContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240101preview:RegistryDataContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
