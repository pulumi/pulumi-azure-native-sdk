...
func NewRegistryModelContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240101preview:RegistryModelContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryModelContainer(ctx *pulumi.Context,
	...
	var resource RegistryModelContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240101preview:RegistryModelContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
