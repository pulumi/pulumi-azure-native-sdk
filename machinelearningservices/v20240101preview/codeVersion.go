...
func NewCodeVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240101preview:CodeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodeVersion(ctx *pulumi.Context,
	...
	var resource CodeVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240101preview:CodeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
