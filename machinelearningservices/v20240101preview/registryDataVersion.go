...
func NewRegistryDataVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240101preview:RegistryDataVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryDataVersion(ctx *pulumi.Context,
	...
	var resource RegistryDataVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240101preview:RegistryDataVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
