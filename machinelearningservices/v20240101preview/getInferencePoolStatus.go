...
func GetInferencePoolStatus(ctx *pulumi.Context, args *GetInferencePoolStatusArgs, opts ...pulumi.InvokeOption) (*GetInferencePoolStatusResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240101preview:getInferencePoolStatus", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func GetInferencePoolStatusOutput(ctx *pulumi.Context, args GetInferencePoolStatusOutputArgs, opts ...pulumi.InvokeOption) GetInferencePoolStatusResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetInferencePoolStatusResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240101preview:getInferencePoolStatus", args, GetInferencePoolStatusResultOutput{}, options).(GetInferencePoolStatusResultOutput), nil
