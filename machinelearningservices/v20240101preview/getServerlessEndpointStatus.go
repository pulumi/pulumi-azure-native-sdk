...
func GetServerlessEndpointStatus(ctx *pulumi.Context, args *GetServerlessEndpointStatusArgs, opts ...pulumi.InvokeOption) (*GetServerlessEndpointStatusResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20240101preview:getServerlessEndpointStatus", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetServerlessEndpointStatusOutput(ctx *pulumi.Context, args GetServerlessEndpointStatusOutputArgs, opts ...pulumi.InvokeOption) GetServerlessEndpointStatusResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetServerlessEndpointStatusResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearningservices/v20240101preview:getServerlessEndpointStatus", args, GetServerlessEndpointStatusResultOutput{}, options).(GetServerlessEndpointStatusResultOutput), nil
