...
func NewServerlessEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240101preview:ServerlessEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerlessEndpoint(ctx *pulumi.Context,
	...
	var resource ServerlessEndpoint
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240101preview:ServerlessEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
