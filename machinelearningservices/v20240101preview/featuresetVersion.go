...
func NewFeaturesetVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240101preview:FeaturesetVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeaturesetVersion(ctx *pulumi.Context,
	...
	var resource FeaturesetVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240101preview:FeaturesetVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
