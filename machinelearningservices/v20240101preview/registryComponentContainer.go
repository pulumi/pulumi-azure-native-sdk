...
func NewRegistryComponentContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20240101preview:RegistryComponentContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryComponentContainer(ctx *pulumi.Context,
	...
	var resource RegistryComponentContainer
	err := ctx.ReadResource("azure-native:machinelearningservices/v20240101preview:RegistryComponentContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
