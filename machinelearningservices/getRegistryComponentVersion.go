...
// [Required] Additional attributes of the entity.
func (o LookupRegistryComponentVersionResultOutput) Properties() ComponentVersionPropertiesResponseOutput {
	return o.ApplyT(func(v LookupRegistryComponentVersionResult) ComponentVersionPropertiesResponse { return v.Properties }).(ComponentVersionPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupRegistryComponentVersionResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupRegistryComponentVersionResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
