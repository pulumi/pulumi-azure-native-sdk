...
func NewWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401preview:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250601:Workspace"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:Workspace"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Workspace
	err := ctx.RegisterResource("azure-native:machinelearningservices:Workspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspace(ctx *pulumi.Context,
	...
	var resource Workspace
	err := ctx.ReadResource("azure-native:machinelearningservices:Workspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
