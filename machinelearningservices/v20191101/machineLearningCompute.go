...
// azure-native:machinelearningservices/v20191101:MachineLearningCompute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:MachineLearningCompute to guarantee forwards compatibility.
...
func NewMachineLearningCompute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20191101:MachineLearningCompute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineLearningCompute(ctx *pulumi.Context,
	...
	var resource MachineLearningCompute
	err := ctx.ReadResource("azure-native:machinelearningservices/v20191101:MachineLearningCompute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
