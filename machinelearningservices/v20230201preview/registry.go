...
func NewRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230201preview:Registry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistry(ctx *pulumi.Context,
	...
	var resource Registry
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230201preview:Registry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
