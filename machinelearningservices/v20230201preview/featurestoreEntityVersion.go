...
func NewFeaturestoreEntityVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230201preview:FeaturestoreEntityVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeaturestoreEntityVersion(ctx *pulumi.Context,
	...
	var resource FeaturestoreEntityVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230201preview:FeaturestoreEntityVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
