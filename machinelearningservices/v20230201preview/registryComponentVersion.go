...
func NewRegistryComponentVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20230201preview:RegistryComponentVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryComponentVersion(ctx *pulumi.Context,
	...
	var resource RegistryComponentVersion
	err := ctx.ReadResource("azure-native:machinelearningservices/v20230201preview:RegistryComponentVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
