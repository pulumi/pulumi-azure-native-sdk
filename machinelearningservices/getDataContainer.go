...
// [Required] Additional attributes of the entity.
func (o LookupDataContainerResultOutput) Properties() DataContainerPropertiesResponseOutput {
	return o.ApplyT(func(v LookupDataContainerResult) DataContainerPropertiesResponse { return v.Properties }).(DataContainerPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDataContainerResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDataContainerResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
