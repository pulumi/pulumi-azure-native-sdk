...
func NewModelContainer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250401preview:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250601:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250701preview:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20250901:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251001preview:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20251201:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260115preview:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260301:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260315preview:ModelContainer"),
		},
		{
			Type: pulumi.String("azure-native:machinelearningservices/v20260501:ModelContainer"),
		},
	})
...
// The Azure API version of the resource.
func (o ModelContainerOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ModelContainer) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// [Required] Additional attributes of the entity.
func (o ModelContainerOutput) Properties() ModelContainerPropertiesResponseOutput {
	return o.ApplyT(func(v *ModelContainer) ModelContainerPropertiesResponseOutput { return v.Properties }).(ModelContainerPropertiesResponseOutput)
}
