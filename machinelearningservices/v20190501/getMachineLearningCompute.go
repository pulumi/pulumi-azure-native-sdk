...
// azure-native:machinelearningservices/v20190501:MachineLearningCompute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:MachineLearningCompute to guarantee forwards compatibility.
func LookupMachineLearningCompute(ctx *pulumi.Context, args *LookupMachineLearningComputeArgs, opts ...pulumi.InvokeOption) (*LookupMachineLearningComputeResult, error) {
	...
	err := ctx.Invoke("azure-native:machinelearningservices/v20190501:getMachineLearningCompute", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
