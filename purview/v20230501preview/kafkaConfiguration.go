...
func NewKafkaConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:purview/v20230501preview:KafkaConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaConfiguration(ctx *pulumi.Context,
	...
	var resource KafkaConfiguration
	err := ctx.ReadResource("azure-native:purview/v20230501preview:KafkaConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
