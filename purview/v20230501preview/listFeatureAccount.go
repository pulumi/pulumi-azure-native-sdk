...
func ListFeatureAccount(ctx *pulumi.Context, args *ListFeatureAccountArgs, opts ...pulumi.InvokeOption) (*ListFeatureAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:purview/v20230501preview:listFeatureAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListFeatureAccountOutput(ctx *pulumi.Context, args ListFeatureAccountOutputArgs, opts ...pulumi.InvokeOption) ListFeatureAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListFeatureAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:purview/v20230501preview:listFeatureAccount", args, ListFeatureAccountResultOutput{}, options).(ListFeatureAccountResultOutput), nil
