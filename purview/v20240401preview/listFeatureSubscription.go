...
func ListFeatureSubscription(ctx *pulumi.Context, args *ListFeatureSubscriptionArgs, opts ...pulumi.InvokeOption) (*ListFeatureSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:purview/v20240401preview:listFeatureSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListFeatureSubscriptionOutput(ctx *pulumi.Context, args ListFeatureSubscriptionOutputArgs, opts ...pulumi.InvokeOption) ListFeatureSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListFeatureSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:purview/v20240401preview:listFeatureSubscription", args, ListFeatureSubscriptionResultOutput{}, options).(ListFeatureSubscriptionResultOutput), nil
