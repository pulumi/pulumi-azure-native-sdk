...
// azure-native:mixedreality/v20200406preview:RemoteRenderingAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:mixedreality/v20210301preview:RemoteRenderingAccount to guarantee forwards compatibility.
...
func NewRemoteRenderingAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mixedreality/v20200406preview:RemoteRenderingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemoteRenderingAccount(ctx *pulumi.Context,
	...
	var resource RemoteRenderingAccount
	err := ctx.ReadResource("azure-native:mixedreality/v20200406preview:RemoteRenderingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
