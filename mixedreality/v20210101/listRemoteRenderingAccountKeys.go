...
func ListRemoteRenderingAccountKeys(ctx *pulumi.Context, args *ListRemoteRenderingAccountKeysArgs, opts ...pulumi.InvokeOption) (*ListRemoteRenderingAccountKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:mixedreality/v20210101:listRemoteRenderingAccountKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListRemoteRenderingAccountKeysOutput(ctx *pulumi.Context, args ListRemoteRenderingAccountKeysOutputArgs, opts ...pulumi.InvokeOption) ListRemoteRenderingAccountKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListRemoteRenderingAccountKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:mixedreality/v20210101:listRemoteRenderingAccountKeys", args, ListRemoteRenderingAccountKeysResultOutput{}, options).(ListRemoteRenderingAccountKeysResultOutput), nil
