...
func NewRemoteRenderingAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mixedreality/v20250101:RemoteRenderingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemoteRenderingAccount(ctx *pulumi.Context,
	...
	var resource RemoteRenderingAccount
	err := ctx.ReadResource("azure-native:mixedreality/v20250101:RemoteRenderingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
