...
func LookupRemoteRenderingAccount(ctx *pulumi.Context, args *LookupRemoteRenderingAccountArgs, opts ...pulumi.InvokeOption) (*LookupRemoteRenderingAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:mixedreality/v20250101:getRemoteRenderingAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRemoteRenderingAccountOutput(ctx *pulumi.Context, args LookupRemoteRenderingAccountOutputArgs, opts ...pulumi.InvokeOption) LookupRemoteRenderingAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRemoteRenderingAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:mixedreality/v20250101:getRemoteRenderingAccount", args, LookupRemoteRenderingAccountResultOutput{}, options).(LookupRemoteRenderingAccountResultOutput), nil
