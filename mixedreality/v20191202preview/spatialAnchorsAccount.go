...
// azure-native:mixedreality/v20191202preview:SpatialAnchorsAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:mixedreality/v20210301preview:SpatialAnchorsAccount to guarantee forwards compatibility.
...
func NewSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mixedreality/v20191202preview:SpatialAnchorsAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpatialAnchorsAccount(ctx *pulumi.Context,
	...
	var resource SpatialAnchorsAccount
	err := ctx.ReadResource("azure-native:mixedreality/v20191202preview:SpatialAnchorsAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
