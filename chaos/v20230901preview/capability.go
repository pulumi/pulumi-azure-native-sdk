...
func NewCapability(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:chaos/v20230901preview:Capability", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapability(ctx *pulumi.Context,
	...
	var resource Capability
	err := ctx.ReadResource("azure-native:chaos/v20230901preview:Capability", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
