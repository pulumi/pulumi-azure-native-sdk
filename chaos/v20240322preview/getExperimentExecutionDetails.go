...
func GetExperimentExecutionDetails(ctx *pulumi.Context, args *GetExperimentExecutionDetailsArgs, opts ...pulumi.InvokeOption) (*GetExperimentExecutionDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:chaos/v20240322preview:getExperimentExecutionDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetExperimentExecutionDetailsOutput(ctx *pulumi.Context, args GetExperimentExecutionDetailsOutputArgs, opts ...pulumi.InvokeOption) GetExperimentExecutionDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetExperimentExecutionDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:chaos/v20240322preview:getExperimentExecutionDetails", args, GetExperimentExecutionDetailsResultOutput{}, options).(GetExperimentExecutionDetailsResultOutput), nil
