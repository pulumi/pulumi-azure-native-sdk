...
func NewPrivateAccess(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:chaos/v20241101preview:PrivateAccess"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateAccess
	err := ctx.RegisterResource("azure-native:chaos/v20240322preview:PrivateAccess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateAccess(ctx *pulumi.Context,
	...
	var resource PrivateAccess
	err := ctx.ReadResource("azure-native:chaos/v20240322preview:PrivateAccess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
