...
func NewExperiment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:chaos/v20230401preview:Experiment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExperiment(ctx *pulumi.Context,
	...
	var resource Experiment
	err := ctx.ReadResource("azure-native:chaos/v20230401preview:Experiment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
