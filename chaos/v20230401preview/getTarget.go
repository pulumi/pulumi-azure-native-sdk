...
//
// Deprecated: azure-native:chaos/v20230401preview:Target is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Target to guarantee forwards compatibility.
func LookupTarget(ctx *pulumi.Context, args *LookupTargetArgs, opts ...pulumi.InvokeOption) (*LookupTargetResult, error) {
	...
	err := ctx.Invoke("azure-native:chaos/v20230401preview:getTarget", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
