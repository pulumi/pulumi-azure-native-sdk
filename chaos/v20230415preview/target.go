...
func NewTarget(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:chaos/v20240101:Target"),
		},
		{
	...
	var resource Target
	err := ctx.RegisterResource("azure-native:chaos/v20230415preview:Target", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTarget(ctx *pulumi.Context,
	...
	var resource Target
	err := ctx.ReadResource("azure-native:chaos/v20230415preview:Target", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
