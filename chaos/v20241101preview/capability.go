...
type Capability struct {
	...
	ParametersSchema pulumi.StringOutput `pulumi:"parametersSchema"`
...
func NewCapability(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:chaos/v20241101preview:Capability", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapability(ctx *pulumi.Context,
	...
	var resource Capability
	err := ctx.ReadResource("azure-native:chaos/v20241101preview:Capability", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o CapabilityOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *Capability) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
...
// URL to retrieve JSON schema of the Capability parameters.
func (o CapabilityOutput) ParametersSchema() pulumi.StringOutput {
	return o.ApplyT(func(v *Capability) pulumi.StringOutput { return v.ParametersSchema }).(pulumi.StringOutput)
}

// Resource provisioning state. Not currently in use because resource is created synchronously.
func (o CapabilityOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v *Capability) pulumi.StringOutput { return v.ProvisioningState }).(pulumi.StringOutput)
}

// String of the Publisher that this Capability extends.
func (o CapabilityOutput) Publisher() pulumi.StringOutput {
	return o.ApplyT(func(v *Capability) pulumi.StringOutput { return v.Publisher }).(pulumi.StringOutput)
}
...
// String of the Target Type that this Capability extends.
func (o CapabilityOutput) TargetType() pulumi.StringOutput {
	return o.ApplyT(func(v *Capability) pulumi.StringOutput { return v.TargetType }).(pulumi.StringOutput)
}
