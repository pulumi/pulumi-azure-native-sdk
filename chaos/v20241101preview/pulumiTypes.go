...
// Resource provisioning state. Not currently in use for executions.
func (o ExperimentExecutionDetailsPropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v ExperimentExecutionDetailsPropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}
