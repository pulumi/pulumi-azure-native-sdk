...
func NewConfigurationAssignmentsForSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationAssignmentsForSubscription(ctx *pulumi.Context,
	...
	var resource ConfigurationAssignmentsForSubscription
	err := ctx.ReadResource("azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
