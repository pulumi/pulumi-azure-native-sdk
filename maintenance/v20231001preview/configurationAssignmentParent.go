...
func NewConfigurationAssignmentParent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maintenance/v20231001preview:ConfigurationAssignmentParent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationAssignmentParent(ctx *pulumi.Context,
	...
	var resource ConfigurationAssignmentParent
	err := ctx.ReadResource("azure-native:maintenance/v20231001preview:ConfigurationAssignmentParent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
