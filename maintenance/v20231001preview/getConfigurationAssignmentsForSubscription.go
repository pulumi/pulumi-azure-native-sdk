...
func LookupConfigurationAssignmentsForSubscription(ctx *pulumi.Context, args *LookupConfigurationAssignmentsForSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationAssignmentsForSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:maintenance/v20231001preview:getConfigurationAssignmentsForSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConfigurationAssignmentsForSubscriptionOutput(ctx *pulumi.Context, args LookupConfigurationAssignmentsForSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupConfigurationAssignmentsForSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConfigurationAssignmentsForSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:maintenance/v20231001preview:getConfigurationAssignmentsForSubscription", args, LookupConfigurationAssignmentsForSubscriptionResultOutput{}, options).(LookupConfigurationAssignmentsForSubscriptionResultOutput), nil
