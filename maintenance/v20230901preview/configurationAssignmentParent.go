...
func NewConfigurationAssignmentParent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maintenance/v20230901preview:ConfigurationAssignmentParent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationAssignmentParent(ctx *pulumi.Context,
	...
	var resource ConfigurationAssignmentParent
	err := ctx.ReadResource("azure-native:maintenance/v20230901preview:ConfigurationAssignmentParent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ConfigurationAssignmentParent) ToOutput(ctx context.Context) pulumix.Output[*ConfigurationAssignmentParent] {
	return pulumix.Output[*ConfigurationAssignmentParent]{
		OutputState: i.ToConfigurationAssignmentParentOutputWithContext(ctx).OutputState,
	}
}
...
func (o ConfigurationAssignmentParentOutput) ToOutput(ctx context.Context) pulumix.Output[*ConfigurationAssignmentParent] {
	return pulumix.Output[*ConfigurationAssignmentParent]{
