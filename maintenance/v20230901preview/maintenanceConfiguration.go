...
func NewMaintenanceConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:maintenance/v20231001preview:MaintenanceConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MaintenanceConfiguration
	err := ctx.RegisterResource("azure-native:maintenance/v20230901preview:MaintenanceConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMaintenanceConfiguration(ctx *pulumi.Context,
	...
	var resource MaintenanceConfiguration
	err := ctx.ReadResource("azure-native:maintenance/v20230901preview:MaintenanceConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
