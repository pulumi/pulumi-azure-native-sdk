...
func NewConfigurationAssignmentsForResourceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationAssignmentsForResourceGroup(ctx *pulumi.Context,
	...
	var resource ConfigurationAssignmentsForResourceGroup
	err := ctx.ReadResource("azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
