...
func NewConfigurationAssignmentsForSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationAssignmentsForSubscription(ctx *pulumi.Context,
	...
	var resource ConfigurationAssignmentsForSubscription
	err := ctx.ReadResource("azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ConfigurationAssignmentsForSubscription) ToOutput(ctx context.Context) pulumix.Output[*ConfigurationAssignmentsForSubscription] {
	return pulumix.Output[*ConfigurationAssignmentsForSubscription]{
		OutputState: i.ToConfigurationAssignmentsForSubscriptionOutputWithContext(ctx).OutputState,
	}
}
...
func (o ConfigurationAssignmentsForSubscriptionOutput) ToOutput(ctx context.Context) pulumix.Output[*ConfigurationAssignmentsForSubscription] {
	return pulumix.Output[*ConfigurationAssignmentsForSubscription]{
