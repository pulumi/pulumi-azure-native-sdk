...
func NewConfigurationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maintenance/v20230901preview:ConfigurationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationAssignment(ctx *pulumi.Context,
	...
	var resource ConfigurationAssignment
	err := ctx.ReadResource("azure-native:maintenance/v20230901preview:ConfigurationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
