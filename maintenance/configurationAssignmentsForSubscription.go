...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ConfigurationAssignmentsForSubscriptionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ConfigurationAssignmentsForSubscription) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
