...
func LookupConfigurationAssignment(ctx *pulumi.Context, args *LookupConfigurationAssignmentArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationAssignmentResult, error) {
	...
	err := ctx.Invoke("azure-native:maintenance/v20230401:getConfigurationAssignment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConfigurationAssignmentOutput(ctx *pulumi.Context, args LookupConfigurationAssignmentOutputArgs, opts ...pulumi.InvokeOption) LookupConfigurationAssignmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConfigurationAssignmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:maintenance/v20230401:getConfigurationAssignment", args, LookupConfigurationAssignmentResultOutput{}, options).(LookupConfigurationAssignmentResultOutput), nil
