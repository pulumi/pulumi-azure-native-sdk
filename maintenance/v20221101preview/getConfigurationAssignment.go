...
func (o LookupConfigurationAssignmentResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupConfigurationAssignmentResult] {
	return pulumix.Output[LookupConfigurationAssignmentResult]{
