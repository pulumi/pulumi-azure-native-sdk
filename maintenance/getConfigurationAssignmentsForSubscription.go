...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupConfigurationAssignmentsForSubscriptionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupConfigurationAssignmentsForSubscriptionResult) commontypesv5.SystemDataResponse {
		return v.SystemData
