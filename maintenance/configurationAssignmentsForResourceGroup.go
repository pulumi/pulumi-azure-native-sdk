...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ConfigurationAssignmentsForResourceGroupOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ConfigurationAssignmentsForResourceGroup) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
