...
func LookupConfigurationAssignmentsForResourceGroup(ctx *pulumi.Context, args *LookupConfigurationAssignmentsForResourceGroupArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationAssignmentsForResourceGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:maintenance:getConfigurationAssignmentsForResourceGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConfigurationAssignmentsForResourceGroupOutput(ctx *pulumi.Context, args LookupConfigurationAssignmentsForResourceGroupOutputArgs, opts ...pulumi.InvokeOption) LookupConfigurationAssignmentsForResourceGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConfigurationAssignmentsForResourceGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:maintenance:getConfigurationAssignmentsForResourceGroup", args, LookupConfigurationAssignmentsForResourceGroupResultOutput{}, options).(LookupConfigurationAssignmentsForResourceGroupResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupConfigurationAssignmentsForResourceGroupResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupConfigurationAssignmentsForResourceGroupResult) commontypesv5.SystemDataResponse {
		return v.SystemData
