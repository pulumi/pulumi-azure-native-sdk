...
func NewConfigurationAssignmentParent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:maintenance/v20231001preview:ConfigurationAssignmentParent"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ConfigurationAssignmentParentOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ConfigurationAssignmentParent) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
