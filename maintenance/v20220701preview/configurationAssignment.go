...
//
// Deprecated: azure-native:maintenance/v20220701preview:ConfigurationAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:maintenance/v20221101preview:ConfigurationAssignment to guarantee forwards compatibility.
...
func NewConfigurationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maintenance/v20220701preview:ConfigurationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationAssignment(ctx *pulumi.Context,
	...
	var resource ConfigurationAssignment
	err := ctx.ReadResource("azure-native:maintenance/v20220701preview:ConfigurationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
