...
//
// Deprecated: azure-native:maintenance/v20220701preview:ConfigurationAssignmentParent is being removed in the next major version of this provider. Upgrade to at least azure-native:maintenance/v20221101preview:ConfigurationAssignmentParent to guarantee forwards compatibility.
...
func NewConfigurationAssignmentParent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:maintenance/v20220701preview:ConfigurationAssignmentParent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationAssignmentParent(ctx *pulumi.Context,
	...
	var resource ConfigurationAssignmentParent
	err := ctx.ReadResource("azure-native:maintenance/v20220701preview:ConfigurationAssignmentParent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
