...
//
// Other available API versions: 2019-06-01-preview, 2020-02-02-preview, 2020-08-01-preview, 2020-11-01-preview, 2021-02-01-preview, 2021-05-01-preview, 2021-08-01-preview, 2021-11-01, 2021-11-01-preview, 2022-02-01-preview, 2022-05-01-preview, 2022-08-01-preview, 2022-11-01-preview, 2023-02-01-preview, 2023-05-01-preview, 2023-08-01-preview, 2024-05-01-preview, 2024-11-01-preview, 2025-01-01, 2025-02-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native sql [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
...
func NewWorkloadGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:WorkloadGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:WorkloadGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:WorkloadGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:WorkloadGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:WorkloadGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:WorkloadGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:WorkloadGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:WorkloadGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkloadGroup
	err := ctx.RegisterResource("azure-native:sql:WorkloadGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadGroup(ctx *pulumi.Context,
	...
	var resource WorkloadGroup
	err := ctx.ReadResource("azure-native:sql:WorkloadGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WorkloadGroupOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkloadGroup) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
