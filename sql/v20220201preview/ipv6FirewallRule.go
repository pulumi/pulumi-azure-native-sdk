...
//
// Deprecated: azure-native:sql/v20220201preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:IPv6FirewallRule to guarantee forwards compatibility.
...
func NewIPv6FirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220201preview:IPv6FirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIPv6FirewallRule(ctx *pulumi.Context,
	...
	var resource IPv6FirewallRule
	err := ctx.ReadResource("azure-native:sql/v20220201preview:IPv6FirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
