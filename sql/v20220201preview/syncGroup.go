...
//
// Deprecated: azure-native:sql/v20220201preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.
...
func NewSyncGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220201preview:SyncGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncGroup(ctx *pulumi.Context,
	...
	var resource SyncGroup
	err := ctx.ReadResource("azure-native:sql/v20220201preview:SyncGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
