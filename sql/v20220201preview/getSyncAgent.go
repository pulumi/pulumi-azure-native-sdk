...
// Gets a sync agent.
//
// Deprecated: azure-native:sql/v20220201preview:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncAgent to guarantee forwards compatibility.
func LookupSyncAgent(ctx *pulumi.Context, args *LookupSyncAgentArgs, opts ...pulumi.InvokeOption) (*LookupSyncAgentResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20220201preview:getSyncAgent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
