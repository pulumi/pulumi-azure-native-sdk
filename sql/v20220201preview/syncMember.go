...
//
// Deprecated: azure-native:sql/v20220201preview:SyncMember is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncMember to guarantee forwards compatibility.
...
func NewSyncMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220201preview:SyncMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncMember(ctx *pulumi.Context,
	...
	var resource SyncMember
	err := ctx.ReadResource("azure-native:sql/v20220201preview:SyncMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
