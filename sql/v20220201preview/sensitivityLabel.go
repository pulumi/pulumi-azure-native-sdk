...
func NewSensitivityLabel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220201preview:SensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSensitivityLabel(ctx *pulumi.Context,
	...
	var resource SensitivityLabel
	err := ctx.ReadResource("azure-native:sql/v20220201preview:SensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
