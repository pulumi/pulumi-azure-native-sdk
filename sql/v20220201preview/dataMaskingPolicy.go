...
func NewDataMaskingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220201preview:DataMaskingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataMaskingPolicy(ctx *pulumi.Context,
	...
	var resource DataMaskingPolicy
	err := ctx.ReadResource("azure-native:sql/v20220201preview:DataMaskingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
