...
func NewEncryptionProtector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:EncryptionProtector"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:EncryptionProtector"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:EncryptionProtector"),
		},
	})
