...
func NewGeoBackupPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:GeoBackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:GeoBackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:GeoBackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:GeoBackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:GeoBackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:GeoBackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:GeoBackupPolicy"),
		},
	})
