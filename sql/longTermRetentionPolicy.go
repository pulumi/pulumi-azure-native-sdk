...
func NewLongTermRetentionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:LongTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:LongTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:LongTermRetentionPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql:LongTermRetentionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLongTermRetentionPolicy(ctx *pulumi.Context,
	...
	var resource LongTermRetentionPolicy
	err := ctx.ReadResource("azure-native:sql:LongTermRetentionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
