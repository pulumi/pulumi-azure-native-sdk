...
// A database resource.
//
// Deprecated: azure-native:sql/v20171001preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20190601preview:Database to guarantee forwards compatibility.
...
func NewDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20171001preview:Database", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabase(ctx *pulumi.Context,
	...
	var resource Database
	err := ctx.ReadResource("azure-native:sql/v20171001preview:Database", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
