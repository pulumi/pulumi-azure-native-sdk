...
//
// Deprecated: azure-native:sql/v20190601preview:WorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:WorkloadClassifier to guarantee forwards compatibility.
...
func NewWorkloadClassifier(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20190601preview:WorkloadClassifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadClassifier(ctx *pulumi.Context,
	...
	var resource WorkloadClassifier
	err := ctx.ReadResource("azure-native:sql/v20190601preview:WorkloadClassifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
