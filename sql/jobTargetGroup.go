...
func NewJobTargetGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:JobTargetGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:JobTargetGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:JobTargetGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:JobTargetGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:JobTargetGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:JobTargetGroup"),
		},
	})
...
// The Azure API version of the resource.
func (o JobTargetGroupOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *JobTargetGroup) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
