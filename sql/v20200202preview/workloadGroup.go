...
//
// Deprecated: azure-native:sql/v20200202preview:WorkloadGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:WorkloadGroup to guarantee forwards compatibility.
