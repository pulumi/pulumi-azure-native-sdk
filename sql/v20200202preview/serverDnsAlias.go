...
// A server DNS alias.
//
// Deprecated: azure-native:sql/v20200202preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerDnsAlias to guarantee forwards compatibility.
...
func NewServerDnsAlias(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20200202preview:ServerDnsAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDnsAlias(ctx *pulumi.Context,
	...
	var resource ServerDnsAlias
	err := ctx.ReadResource("azure-native:sql/v20200202preview:ServerDnsAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
