...
//
// Deprecated: azure-native:sql/v20200202preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Server to guarantee forwards compatibility.
type Server struct {
