...
func NewJobTargetGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20200202preview:JobTargetGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobTargetGroup(ctx *pulumi.Context,
	...
	var resource JobTargetGroup
	err := ctx.ReadResource("azure-native:sql/v20200202preview:JobTargetGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
