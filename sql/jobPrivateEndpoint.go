...
func NewJobPrivateEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:JobPrivateEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:JobPrivateEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:JobPrivateEndpoint"),
		},
	})
