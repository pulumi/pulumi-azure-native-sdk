...
func NewServerAzureADAdministrator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ServerAzureADAdministrator"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ServerAzureADAdministrator"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ServerAzureADAdministrator"),
		},
	})
