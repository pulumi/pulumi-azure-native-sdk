...
func NewManagedInstancePrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ManagedInstancePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ManagedInstancePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ManagedInstancePrivateEndpointConnection"),
		},
	})
...
// The Azure API version of the resource.
func (o ManagedInstancePrivateEndpointConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagedInstancePrivateEndpointConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
