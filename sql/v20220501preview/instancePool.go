...
func NewInstancePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220501preview:InstancePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstancePool(ctx *pulumi.Context,
	...
	var resource InstancePool
	err := ctx.ReadResource("azure-native:sql/v20220501preview:InstancePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
