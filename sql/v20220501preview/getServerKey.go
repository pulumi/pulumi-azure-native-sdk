...
// Gets a server key.
//
// Deprecated: azure-native:sql/v20220501preview:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerKey to guarantee forwards compatibility.
func LookupServerKey(ctx *pulumi.Context, args *LookupServerKeyArgs, opts ...pulumi.InvokeOption) (*LookupServerKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20220501preview:getServerKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
