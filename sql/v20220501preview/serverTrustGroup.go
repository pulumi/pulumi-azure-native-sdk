...
//
// Deprecated: azure-native:sql/v20220501preview:ServerTrustGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.
...
func NewServerTrustGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220501preview:ServerTrustGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerTrustGroup(ctx *pulumi.Context,
	...
	var resource ServerTrustGroup
	err := ctx.ReadResource("azure-native:sql/v20220501preview:ServerTrustGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
