...
//
// Deprecated: azure-native:sql/v20220501preview:ManagedServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedServerDnsAlias to guarantee forwards compatibility.
