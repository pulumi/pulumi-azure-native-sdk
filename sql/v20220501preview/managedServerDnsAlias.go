...
//
// Deprecated: azure-native:sql/v20220501preview:ManagedServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedServerDnsAlias to guarantee forwards compatibility.
