...
// Gets a sync group.
//
// Deprecated: azure-native:sql/v20220501preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncGroup to guarantee forwards compatibility.
func LookupSyncGroup(ctx *pulumi.Context, args *LookupSyncGroupArgs, opts ...pulumi.InvokeOption) (*LookupSyncGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20220501preview:getSyncGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
