...
// Gets a sync group.
//
// Deprecated: azure-native:sql/v20220501preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.
