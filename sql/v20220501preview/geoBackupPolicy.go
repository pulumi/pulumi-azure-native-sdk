...
// A Geo backup policy.
//
// Deprecated: azure-native:sql/v20220501preview:GeoBackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:GeoBackupPolicy to guarantee forwards compatibility.
...
func NewGeoBackupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220501preview:GeoBackupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGeoBackupPolicy(ctx *pulumi.Context,
	...
	var resource GeoBackupPolicy
	err := ctx.ReadResource("azure-native:sql/v20220501preview:GeoBackupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
