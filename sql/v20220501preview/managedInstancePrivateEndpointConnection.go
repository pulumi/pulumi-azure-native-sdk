...
//
// Deprecated: azure-native:sql/v20220501preview:ManagedInstancePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstancePrivateEndpointConnection to guarantee forwards compatibility.
...
func NewManagedInstancePrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220501preview:ManagedInstancePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstancePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource ManagedInstancePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:sql/v20220501preview:ManagedInstancePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
