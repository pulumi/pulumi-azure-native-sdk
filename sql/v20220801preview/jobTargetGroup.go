...
//
// Deprecated: azure-native:sql/v20220801preview:JobTargetGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobTargetGroup to guarantee forwards compatibility.
...
func NewJobTargetGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220801preview:JobTargetGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobTargetGroup(ctx *pulumi.Context,
	...
	var resource JobTargetGroup
	err := ctx.ReadResource("azure-native:sql/v20220801preview:JobTargetGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
