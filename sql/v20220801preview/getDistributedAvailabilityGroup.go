...
//
// Deprecated: azure-native:sql/v20220801preview:DistributedAvailabilityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DistributedAvailabilityGroup to guarantee forwards compatibility.
func LookupDistributedAvailabilityGroup(ctx *pulumi.Context, args *LookupDistributedAvailabilityGroupArgs, opts ...pulumi.InvokeOption) (*LookupDistributedAvailabilityGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20220801preview:getDistributedAvailabilityGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
