...
//
// Deprecated: azure-native:sql/v20220801preview:ExtendedServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ExtendedServerBlobAuditingPolicy to guarantee forwards compatibility.
...
func NewExtendedServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220801preview:ExtendedServerBlobAuditingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExtendedServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	var resource ExtendedServerBlobAuditingPolicy
	err := ctx.ReadResource("azure-native:sql/v20220801preview:ExtendedServerBlobAuditingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
