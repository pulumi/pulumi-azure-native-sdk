...
func NewManagedInstancePrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstancePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource ManagedInstancePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
