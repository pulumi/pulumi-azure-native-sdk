...
// Gets a sync member.
//
// Deprecated: azure-native:sql/v20220801preview:SyncMember is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncMember to guarantee forwards compatibility.
func LookupSyncMember(ctx *pulumi.Context, args *LookupSyncMemberArgs, opts ...pulumi.InvokeOption) (*LookupSyncMemberResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20220801preview:getSyncMember", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
