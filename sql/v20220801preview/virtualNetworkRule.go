...
func NewVirtualNetworkRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220801preview:VirtualNetworkRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkRule(ctx *pulumi.Context,
	...
	var resource VirtualNetworkRule
	err := ctx.ReadResource("azure-native:sql/v20220801preview:VirtualNetworkRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
