...
// A sensitivity label.
//
// Deprecated: azure-native:sql/v20220801preview:ManagedDatabaseSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedDatabaseSensitivityLabel to guarantee forwards compatibility.
...
func NewManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220801preview:ManagedDatabaseSensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	var resource ManagedDatabaseSensitivityLabel
	err := ctx.ReadResource("azure-native:sql/v20220801preview:ManagedDatabaseSensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
