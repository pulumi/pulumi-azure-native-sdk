...
func NewManagedServerDnsAlias(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220801preview:ManagedServerDnsAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedServerDnsAlias(ctx *pulumi.Context,
	...
	var resource ManagedServerDnsAlias
	err := ctx.ReadResource("azure-native:sql/v20220801preview:ManagedServerDnsAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
