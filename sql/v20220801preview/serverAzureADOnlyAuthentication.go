...
func NewServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220801preview:ServerAzureADOnlyAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	var resource ServerAzureADOnlyAuthentication
	err := ctx.ReadResource("azure-native:sql/v20220801preview:ServerAzureADOnlyAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
