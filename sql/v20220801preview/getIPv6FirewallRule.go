...
//
// Deprecated: azure-native:sql/v20220801preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:IPv6FirewallRule to guarantee forwards compatibility.
func LookupIPv6FirewallRule(ctx *pulumi.Context, args *LookupIPv6FirewallRuleArgs, opts ...pulumi.InvokeOption) (*LookupIPv6FirewallRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20220801preview:getIPv6FirewallRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
