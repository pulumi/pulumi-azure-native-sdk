...
//
// Deprecated: azure-native:sql/v20220801preview:ServerTrustCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerTrustCertificate to guarantee forwards compatibility.
...
func NewServerTrustCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20220801preview:ServerTrustCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerTrustCertificate(ctx *pulumi.Context,
	...
	var resource ServerTrustCertificate
	err := ctx.ReadResource("azure-native:sql/v20220801preview:ServerTrustCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
