...
func NewBackupLongTermRetentionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20250101:BackupLongTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:BackupLongTermRetentionPolicy"),
		},
		{
