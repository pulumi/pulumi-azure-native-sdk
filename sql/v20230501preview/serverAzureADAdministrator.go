...
func NewServerAzureADAdministrator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230501preview:ServerAzureADAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAzureADAdministrator(ctx *pulumi.Context,
	...
	var resource ServerAzureADAdministrator
	err := ctx.ReadResource("azure-native:sql/v20230501preview:ServerAzureADAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
