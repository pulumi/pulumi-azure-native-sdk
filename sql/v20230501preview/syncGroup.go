...
func NewSyncGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:SyncGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:SyncGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:SyncGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SyncGroup
	err := ctx.RegisterResource("azure-native:sql/v20230501preview:SyncGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncGroup(ctx *pulumi.Context,
	...
	var resource SyncGroup
	err := ctx.ReadResource("azure-native:sql/v20230501preview:SyncGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
