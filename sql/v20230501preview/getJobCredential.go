...
func LookupJobCredential(ctx *pulumi.Context, args *LookupJobCredentialArgs, opts ...pulumi.InvokeOption) (*LookupJobCredentialResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230501preview:getJobCredential", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupJobCredentialOutput(ctx *pulumi.Context, args LookupJobCredentialOutputArgs, opts ...pulumi.InvokeOption) LookupJobCredentialResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupJobCredentialResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230501preview:getJobCredential", args, LookupJobCredentialResultOutput{}, options).(LookupJobCredentialResultOutput), nil
