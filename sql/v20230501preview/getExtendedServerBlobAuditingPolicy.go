...
func LookupExtendedServerBlobAuditingPolicy(ctx *pulumi.Context, args *LookupExtendedServerBlobAuditingPolicyArgs, opts ...pulumi.InvokeOption) (*LookupExtendedServerBlobAuditingPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230501preview:getExtendedServerBlobAuditingPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupExtendedServerBlobAuditingPolicyOutput(ctx *pulumi.Context, args LookupExtendedServerBlobAuditingPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupExtendedServerBlobAuditingPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupExtendedServerBlobAuditingPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230501preview:getExtendedServerBlobAuditingPolicy", args, LookupExtendedServerBlobAuditingPolicyResultOutput{}, options).(LookupExtendedServerBlobAuditingPolicyResultOutput), nil
