...
func LookupServerAzureADAdministrator(ctx *pulumi.Context, args *LookupServerAzureADAdministratorArgs, opts ...pulumi.InvokeOption) (*LookupServerAzureADAdministratorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230501preview:getServerAzureADAdministrator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupServerAzureADAdministratorResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupServerAzureADAdministratorResult] {
	return pulumix.Output[LookupServerAzureADAdministratorResult]{
