...
func NewReplicationLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230501preview:ReplicationLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationLink(ctx *pulumi.Context,
	...
	var resource ReplicationLink
	err := ctx.ReadResource("azure-native:sql/v20230501preview:ReplicationLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
