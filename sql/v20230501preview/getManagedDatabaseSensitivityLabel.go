...
func LookupManagedDatabaseSensitivityLabel(ctx *pulumi.Context, args *LookupManagedDatabaseSensitivityLabelArgs, opts ...pulumi.InvokeOption) (*LookupManagedDatabaseSensitivityLabelResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230501preview:getManagedDatabaseSensitivityLabel", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedDatabaseSensitivityLabelOutput(ctx *pulumi.Context, args LookupManagedDatabaseSensitivityLabelOutputArgs, opts ...pulumi.InvokeOption) LookupManagedDatabaseSensitivityLabelResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedDatabaseSensitivityLabelResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230501preview:getManagedDatabaseSensitivityLabel", args, LookupManagedDatabaseSensitivityLabelResultOutput{}, options).(LookupManagedDatabaseSensitivityLabelResultOutput), nil
