...
func LookupLongTermRetentionPolicy(ctx *pulumi.Context, args *LookupLongTermRetentionPolicyArgs, opts ...pulumi.InvokeOption) (*LookupLongTermRetentionPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230501preview:getLongTermRetentionPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupLongTermRetentionPolicyOutput(ctx *pulumi.Context, args LookupLongTermRetentionPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupLongTermRetentionPolicyResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupLongTermRetentionPolicyResultOutput, error) {
			...
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv LookupLongTermRetentionPolicyResult
			secret, err := ctx.InvokePackageRaw("azure-native:sql/v20230501preview:getLongTermRetentionPolicy", args, &rv, "", opts...)
			if err != nil {
				return LookupLongTermRetentionPolicyResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupLongTermRetentionPolicyResultOutput)
			if secret {
				return pulumi.ToSecret(output).(LookupLongTermRetentionPolicyResultOutput), nil
			}
			return output, nil
...
// The BackupStorageAccessTier for the LTR backups
func (o LookupLongTermRetentionPolicyResultOutput) BackupStorageAccessTier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupLongTermRetentionPolicyResult) *string { return v.BackupStorageAccessTier }).(pulumi.StringPtrOutput)
}
...
// The setting whether to make LTR backups immutable
func (o LookupLongTermRetentionPolicyResultOutput) MakeBackupsImmutable() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupLongTermRetentionPolicyResult) *bool { return v.MakeBackupsImmutable }).(pulumi.BoolPtrOutput)
}
