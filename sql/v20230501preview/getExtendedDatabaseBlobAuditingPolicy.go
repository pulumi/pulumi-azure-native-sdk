...
func LookupExtendedDatabaseBlobAuditingPolicy(ctx *pulumi.Context, args *LookupExtendedDatabaseBlobAuditingPolicyArgs, opts ...pulumi.InvokeOption) (*LookupExtendedDatabaseBlobAuditingPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230501preview:getExtendedDatabaseBlobAuditingPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupExtendedDatabaseBlobAuditingPolicyOutput(ctx *pulumi.Context, args LookupExtendedDatabaseBlobAuditingPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupExtendedDatabaseBlobAuditingPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupExtendedDatabaseBlobAuditingPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230501preview:getExtendedDatabaseBlobAuditingPolicy", args, LookupExtendedDatabaseBlobAuditingPolicyResultOutput{}, options).(LookupExtendedDatabaseBlobAuditingPolicyResultOutput), nil
