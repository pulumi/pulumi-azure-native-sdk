...
func LookupServerAzureADOnlyAuthentication(ctx *pulumi.Context, args *LookupServerAzureADOnlyAuthenticationArgs, opts ...pulumi.InvokeOption) (*LookupServerAzureADOnlyAuthenticationResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230501preview:getServerAzureADOnlyAuthentication", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupServerAzureADOnlyAuthenticationResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupServerAzureADOnlyAuthenticationResult] {
	return pulumix.Output[LookupServerAzureADOnlyAuthenticationResult]{
