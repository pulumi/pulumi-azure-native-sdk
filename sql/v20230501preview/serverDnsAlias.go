...
func NewServerDnsAlias(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:ServerDnsAlias"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:ServerDnsAlias"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:ServerDnsAlias"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20230501preview:ServerDnsAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDnsAlias(ctx *pulumi.Context,
	...
	var resource ServerDnsAlias
	err := ctx.ReadResource("azure-native:sql/v20230501preview:ServerDnsAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
