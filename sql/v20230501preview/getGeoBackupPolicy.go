...
func LookupGeoBackupPolicy(ctx *pulumi.Context, args *LookupGeoBackupPolicyArgs, opts ...pulumi.InvokeOption) (*LookupGeoBackupPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230501preview:getGeoBackupPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGeoBackupPolicyOutput(ctx *pulumi.Context, args LookupGeoBackupPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupGeoBackupPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGeoBackupPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230501preview:getGeoBackupPolicy", args, LookupGeoBackupPolicyResultOutput{}, options).(LookupGeoBackupPolicyResultOutput), nil
