...
func NewBackupShortTermRetentionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:BackupShortTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:BackupShortTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:BackupShortTermRetentionPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20230501preview:BackupShortTermRetentionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupShortTermRetentionPolicy(ctx *pulumi.Context,
	...
	var resource BackupShortTermRetentionPolicy
	err := ctx.ReadResource("azure-native:sql/v20230501preview:BackupShortTermRetentionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
