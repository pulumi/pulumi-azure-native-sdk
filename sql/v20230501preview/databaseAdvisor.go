...
func NewDatabaseAdvisor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230501preview:DatabaseAdvisor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAdvisor(ctx *pulumi.Context,
	...
	var resource DatabaseAdvisor
	err := ctx.ReadResource("azure-native:sql/v20230501preview:DatabaseAdvisor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
