...
func NewJob(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:Job"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:Job"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:Job"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:Job"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:Job"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:Job"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:Job"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:Job"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Job
	err := ctx.RegisterResource("azure-native:sql:Job", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.ReadResource("azure-native:sql:Job", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
