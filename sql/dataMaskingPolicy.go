...
func NewDataMaskingPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:DataMaskingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:DataMaskingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:DataMaskingPolicy"),
		},
	})
