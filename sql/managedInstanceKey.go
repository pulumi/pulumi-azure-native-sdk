...
func NewManagedInstanceKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ManagedInstanceKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ManagedInstanceKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ManagedInstanceKey"),
		},
	})
