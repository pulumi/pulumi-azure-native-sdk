...
func LookupBackupLongTermRetentionPolicy(ctx *pulumi.Context, args *LookupBackupLongTermRetentionPolicyArgs, opts ...pulumi.InvokeOption) (*LookupBackupLongTermRetentionPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql:getBackupLongTermRetentionPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupBackupLongTermRetentionPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupBackupLongTermRetentionPolicyResult] {
	return pulumix.Output[LookupBackupLongTermRetentionPolicyResult]{
