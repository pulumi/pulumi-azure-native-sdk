...
func NewWorkloadClassifier(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20250101:WorkloadClassifier"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:WorkloadClassifier"),
		},
	})
...
func GetWorkloadClassifier(ctx *pulumi.Context,
	...
	var resource WorkloadClassifier
	err := ctx.ReadResource("azure-native:sql:WorkloadClassifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
