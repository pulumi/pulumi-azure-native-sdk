...
//
// Deprecated: azure-native:sql/v20211101preview:DatabaseSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseSecurityAlertPolicy to guarantee forwards compatibility.
...
func NewDatabaseSecurityAlertPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101preview:DatabaseSecurityAlertPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseSecurityAlertPolicy(ctx *pulumi.Context,
	...
	var resource DatabaseSecurityAlertPolicy
	err := ctx.ReadResource("azure-native:sql/v20211101preview:DatabaseSecurityAlertPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
