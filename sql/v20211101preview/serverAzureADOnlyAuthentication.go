...
//
// Deprecated: azure-native:sql/v20211101preview:ServerAzureADOnlyAuthentication is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAzureADOnlyAuthentication to guarantee forwards compatibility.
...
func NewServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101preview:ServerAzureADOnlyAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	var resource ServerAzureADOnlyAuthentication
	err := ctx.ReadResource("azure-native:sql/v20211101preview:ServerAzureADOnlyAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
