...
//
// Deprecated: azure-native:sql/v20211101preview:ManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstance to guarantee forwards compatibility.
