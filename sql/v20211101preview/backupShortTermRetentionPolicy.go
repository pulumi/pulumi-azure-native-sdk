...
//
// Deprecated: azure-native:sql/v20211101preview:BackupShortTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:BackupShortTermRetentionPolicy to guarantee forwards compatibility.
...
func NewBackupShortTermRetentionPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101preview:BackupShortTermRetentionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupShortTermRetentionPolicy(ctx *pulumi.Context,
	...
	var resource BackupShortTermRetentionPolicy
	err := ctx.ReadResource("azure-native:sql/v20211101preview:BackupShortTermRetentionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
