...
//
// Deprecated: azure-native:sql/v20211101preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:IPv6FirewallRule to guarantee forwards compatibility.
