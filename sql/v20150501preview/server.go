...
//
// Deprecated: azure-native:sql/v20150501preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.
type Server struct {
