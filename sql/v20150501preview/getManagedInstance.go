...
//
// Deprecated: azure-native:sql/v20150501preview:ManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20210201preview:ManagedInstance to guarantee forwards compatibility.
