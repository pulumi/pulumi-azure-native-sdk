...
//
// Deprecated: azure-native:sql/v20201101preview:ManagedInstanceKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceKey to guarantee forwards compatibility.
