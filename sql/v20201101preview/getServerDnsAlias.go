...
//
// Deprecated: azure-native:sql/v20201101preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerDnsAlias to guarantee forwards compatibility.
func LookupServerDnsAlias(ctx *pulumi.Context, args *LookupServerDnsAliasArgs, opts ...pulumi.InvokeOption) (*LookupServerDnsAliasResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20201101preview:getServerDnsAlias", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
