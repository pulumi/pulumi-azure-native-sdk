...
//
// Deprecated: azure-native:sql/v20201101preview:DatabaseAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseAdvisor to guarantee forwards compatibility.
...
func NewDatabaseAdvisor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20201101preview:DatabaseAdvisor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAdvisor(ctx *pulumi.Context,
	...
	var resource DatabaseAdvisor
	err := ctx.ReadResource("azure-native:sql/v20201101preview:DatabaseAdvisor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
