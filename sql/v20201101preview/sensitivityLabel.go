...
// A sensitivity label.
//
// Deprecated: azure-native:sql/v20201101preview:SensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SensitivityLabel to guarantee forwards compatibility.
...
func NewSensitivityLabel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20201101preview:SensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSensitivityLabel(ctx *pulumi.Context,
	...
	var resource SensitivityLabel
	err := ctx.ReadResource("azure-native:sql/v20201101preview:SensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
