...
// Gets additional details specific to this recommended action.
func (o RecommendedActionResponseOutput) Details() pulumi.AnyOutput {
	return o.ApplyT(func(v RecommendedActionResponse) interface{} { return v.Details }).(pulumi.AnyOutput)
}
