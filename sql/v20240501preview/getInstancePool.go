...
func LookupInstancePool(ctx *pulumi.Context, args *LookupInstancePoolArgs, opts ...pulumi.InvokeOption) (*LookupInstancePoolResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20240501preview:getInstancePool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupInstancePoolOutput(ctx *pulumi.Context, args LookupInstancePoolOutputArgs, opts ...pulumi.InvokeOption) LookupInstancePoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupInstancePoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20240501preview:getInstancePool", args, LookupInstancePoolResultOutput{}, options).(LookupInstancePoolResultOutput), nil
