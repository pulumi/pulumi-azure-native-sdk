...
func LookupDatabaseBlobAuditingPolicy(ctx *pulumi.Context, args *LookupDatabaseBlobAuditingPolicyArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseBlobAuditingPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20240501preview:getDatabaseBlobAuditingPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDatabaseBlobAuditingPolicyOutput(ctx *pulumi.Context, args LookupDatabaseBlobAuditingPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseBlobAuditingPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseBlobAuditingPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20240501preview:getDatabaseBlobAuditingPolicy", args, LookupDatabaseBlobAuditingPolicyResultOutput{}, options).(LookupDatabaseBlobAuditingPolicyResultOutput), nil
