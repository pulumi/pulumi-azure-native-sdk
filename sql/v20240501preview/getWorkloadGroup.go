...
func LookupWorkloadGroup(ctx *pulumi.Context, args *LookupWorkloadGroupArgs, opts ...pulumi.InvokeOption) (*LookupWorkloadGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20240501preview:getWorkloadGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkloadGroupOutput(ctx *pulumi.Context, args LookupWorkloadGroupOutputArgs, opts ...pulumi.InvokeOption) LookupWorkloadGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkloadGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20240501preview:getWorkloadGroup", args, LookupWorkloadGroupResultOutput{}, options).(LookupWorkloadGroupResultOutput), nil
