...
func LookupManagedInstance(ctx *pulumi.Context, args *LookupManagedInstanceArgs, opts ...pulumi.InvokeOption) (*LookupManagedInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20240501preview:getManagedInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedInstanceOutput(ctx *pulumi.Context, args LookupManagedInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupManagedInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20240501preview:getManagedInstance", args, LookupManagedInstanceResultOutput{}, options).(LookupManagedInstanceResultOutput), nil
...
// Total memory in MB. Minimum value: 7168. Maximum value: 891328. Increments of 1 MB allowed only. Maximum value depends on the selected hardware family and number of vCores.
func (o LookupManagedInstanceResultOutput) TotalMemoryMB() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupManagedInstanceResult) *int { return v.TotalMemoryMB }).(pulumi.IntPtrOutput)
}
