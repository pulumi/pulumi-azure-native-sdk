...
func NewServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:ServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:ServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:ServerBlobAuditingPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20240501preview:ServerBlobAuditingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	var resource ServerBlobAuditingPolicy
	err := ctx.ReadResource("azure-native:sql/v20240501preview:ServerBlobAuditingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
