...
func NewSyncGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20240501preview:SyncGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncGroup(ctx *pulumi.Context,
	...
	var resource SyncGroup
	err := ctx.ReadResource("azure-native:sql/v20240501preview:SyncGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
