...
func LookupJobStep(ctx *pulumi.Context, args *LookupJobStepArgs, opts ...pulumi.InvokeOption) (*LookupJobStepResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20240501preview:getJobStep", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupJobStepOutput(ctx *pulumi.Context, args LookupJobStepOutputArgs, opts ...pulumi.InvokeOption) LookupJobStepResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupJobStepResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20240501preview:getJobStep", args, LookupJobStepResultOutput{}, options).(LookupJobStepResultOutput), nil
