...
func NewJobPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20240501preview:JobPrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource JobPrivateEndpoint
	err := ctx.ReadResource("azure-native:sql/v20240501preview:JobPrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
