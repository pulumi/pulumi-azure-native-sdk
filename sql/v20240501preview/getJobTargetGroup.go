...
func LookupJobTargetGroup(ctx *pulumi.Context, args *LookupJobTargetGroupArgs, opts ...pulumi.InvokeOption) (*LookupJobTargetGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20240501preview:getJobTargetGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupJobTargetGroupOutput(ctx *pulumi.Context, args LookupJobTargetGroupOutputArgs, opts ...pulumi.InvokeOption) LookupJobTargetGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupJobTargetGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20240501preview:getJobTargetGroup", args, LookupJobTargetGroupResultOutput{}, options).(LookupJobTargetGroupResultOutput), nil
