...
func LookupManagedInstanceAzureADOnlyAuthentication(ctx *pulumi.Context, args *LookupManagedInstanceAzureADOnlyAuthenticationArgs, opts ...pulumi.InvokeOption) (*LookupManagedInstanceAzureADOnlyAuthenticationResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20240501preview:getManagedInstanceAzureADOnlyAuthentication", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedInstanceAzureADOnlyAuthenticationOutput(ctx *pulumi.Context, args LookupManagedInstanceAzureADOnlyAuthenticationOutputArgs, opts ...pulumi.InvokeOption) LookupManagedInstanceAzureADOnlyAuthenticationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedInstanceAzureADOnlyAuthenticationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20240501preview:getManagedInstanceAzureADOnlyAuthentication", args, LookupManagedInstanceAzureADOnlyAuthenticationResultOutput{}, options).(LookupManagedInstanceAzureADOnlyAuthenticationResultOutput), nil
