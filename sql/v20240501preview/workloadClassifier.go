...
func NewWorkloadClassifier(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20240501preview:WorkloadClassifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadClassifier(ctx *pulumi.Context,
	...
	var resource WorkloadClassifier
	err := ctx.ReadResource("azure-native:sql/v20240501preview:WorkloadClassifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
