...
func LookupEncryptionProtector(ctx *pulumi.Context, args *LookupEncryptionProtectorArgs, opts ...pulumi.InvokeOption) (*LookupEncryptionProtectorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20240501preview:getEncryptionProtector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEncryptionProtectorOutput(ctx *pulumi.Context, args LookupEncryptionProtectorOutputArgs, opts ...pulumi.InvokeOption) LookupEncryptionProtectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEncryptionProtectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20240501preview:getEncryptionProtector", args, LookupEncryptionProtectorResultOutput{}, options).(LookupEncryptionProtectorResultOutput), nil
