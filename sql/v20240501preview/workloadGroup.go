...
func NewWorkloadGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20240501preview:WorkloadGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadGroup(ctx *pulumi.Context,
	...
	var resource WorkloadGroup
	err := ctx.ReadResource("azure-native:sql/v20240501preview:WorkloadGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
