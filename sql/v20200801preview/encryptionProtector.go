...
func NewEncryptionProtector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20200801preview:EncryptionProtector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEncryptionProtector(ctx *pulumi.Context,
	...
	var resource EncryptionProtector
	err := ctx.ReadResource("azure-native:sql/v20200801preview:EncryptionProtector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
