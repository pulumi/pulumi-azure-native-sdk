...
// A job step.
//
// Deprecated: azure-native:sql/v20200801preview:JobStep is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobStep to guarantee forwards compatibility.
type JobStep struct {
