...
// The Azure API version of the resource.
func (o LookupServerDnsAliasResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupServerDnsAliasResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
