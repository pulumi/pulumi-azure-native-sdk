...
func NewReplicationLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801:ReplicationLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationLink(ctx *pulumi.Context,
	...
	var resource ReplicationLink
	err := ctx.ReadResource("azure-native:sql/v20230801:ReplicationLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
