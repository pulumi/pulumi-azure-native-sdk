...
func NewStartStopManagedInstanceSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801:StartStopManagedInstanceSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStartStopManagedInstanceSchedule(ctx *pulumi.Context,
	...
	var resource StartStopManagedInstanceSchedule
	err := ctx.ReadResource("azure-native:sql/v20230801:StartStopManagedInstanceSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
