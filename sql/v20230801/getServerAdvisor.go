...
func LookupServerAdvisor(ctx *pulumi.Context, args *LookupServerAdvisorArgs, opts ...pulumi.InvokeOption) (*LookupServerAdvisorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801:getServerAdvisor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerAdvisorOutput(ctx *pulumi.Context, args LookupServerAdvisorOutputArgs, opts ...pulumi.InvokeOption) LookupServerAdvisorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerAdvisorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801:getServerAdvisor", args, LookupServerAdvisorResultOutput{}, options).(LookupServerAdvisorResultOutput), nil
