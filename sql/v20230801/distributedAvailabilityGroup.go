...
func NewDistributedAvailabilityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801:DistributedAvailabilityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDistributedAvailabilityGroup(ctx *pulumi.Context,
	...
	var resource DistributedAvailabilityGroup
	err := ctx.ReadResource("azure-native:sql/v20230801:DistributedAvailabilityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
