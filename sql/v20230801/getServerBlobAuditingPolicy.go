...
func LookupServerBlobAuditingPolicy(ctx *pulumi.Context, args *LookupServerBlobAuditingPolicyArgs, opts ...pulumi.InvokeOption) (*LookupServerBlobAuditingPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801:getServerBlobAuditingPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerBlobAuditingPolicyOutput(ctx *pulumi.Context, args LookupServerBlobAuditingPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupServerBlobAuditingPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerBlobAuditingPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801:getServerBlobAuditingPolicy", args, LookupServerBlobAuditingPolicyResultOutput{}, options).(LookupServerBlobAuditingPolicyResultOutput), nil
