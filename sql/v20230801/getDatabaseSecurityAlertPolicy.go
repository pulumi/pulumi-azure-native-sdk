...
func LookupDatabaseSecurityAlertPolicy(ctx *pulumi.Context, args *LookupDatabaseSecurityAlertPolicyArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseSecurityAlertPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801:getDatabaseSecurityAlertPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDatabaseSecurityAlertPolicyOutput(ctx *pulumi.Context, args LookupDatabaseSecurityAlertPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseSecurityAlertPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseSecurityAlertPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801:getDatabaseSecurityAlertPolicy", args, LookupDatabaseSecurityAlertPolicyResultOutput{}, options).(LookupDatabaseSecurityAlertPolicyResultOutput), nil
