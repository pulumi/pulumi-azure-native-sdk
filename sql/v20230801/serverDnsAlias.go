...
func NewServerDnsAlias(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801:ServerDnsAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDnsAlias(ctx *pulumi.Context,
	...
	var resource ServerDnsAlias
	err := ctx.ReadResource("azure-native:sql/v20230801:ServerDnsAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
