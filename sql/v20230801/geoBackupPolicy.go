...
func NewGeoBackupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801:GeoBackupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGeoBackupPolicy(ctx *pulumi.Context,
	...
	var resource GeoBackupPolicy
	err := ctx.ReadResource("azure-native:sql/v20230801:GeoBackupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
