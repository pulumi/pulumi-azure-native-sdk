...
func NewManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801:ManagedInstanceAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	var resource ManagedInstanceAdministrator
	err := ctx.ReadResource("azure-native:sql/v20230801:ManagedInstanceAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
