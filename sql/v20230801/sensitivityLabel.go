...
func NewSensitivityLabel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801:SensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSensitivityLabel(ctx *pulumi.Context,
	...
	var resource SensitivityLabel
	err := ctx.ReadResource("azure-native:sql/v20230801:SensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
