...
func NewJobAgent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801:JobAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobAgent(ctx *pulumi.Context,
	...
	var resource JobAgent
	err := ctx.ReadResource("azure-native:sql/v20230801:JobAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
