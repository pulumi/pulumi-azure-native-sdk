...
func LookupServerTrustCertificate(ctx *pulumi.Context, args *LookupServerTrustCertificateArgs, opts ...pulumi.InvokeOption) (*LookupServerTrustCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801:getServerTrustCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerTrustCertificateOutput(ctx *pulumi.Context, args LookupServerTrustCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupServerTrustCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerTrustCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801:getServerTrustCertificate", args, LookupServerTrustCertificateResultOutput{}, options).(LookupServerTrustCertificateResultOutput), nil
