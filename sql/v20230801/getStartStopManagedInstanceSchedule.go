...
func LookupStartStopManagedInstanceSchedule(ctx *pulumi.Context, args *LookupStartStopManagedInstanceScheduleArgs, opts ...pulumi.InvokeOption) (*LookupStartStopManagedInstanceScheduleResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801:getStartStopManagedInstanceSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupStartStopManagedInstanceScheduleOutput(ctx *pulumi.Context, args LookupStartStopManagedInstanceScheduleOutputArgs, opts ...pulumi.InvokeOption) LookupStartStopManagedInstanceScheduleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStartStopManagedInstanceScheduleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801:getStartStopManagedInstanceSchedule", args, LookupStartStopManagedInstanceScheduleResultOutput{}, options).(LookupStartStopManagedInstanceScheduleResultOutput), nil
