...
//
// Deprecated: azure-native:sql/v20211101:DataMaskingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DataMaskingPolicy to guarantee forwards compatibility.
...
func NewDataMaskingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101:DataMaskingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataMaskingPolicy(ctx *pulumi.Context,
	...
	var resource DataMaskingPolicy
	err := ctx.ReadResource("azure-native:sql/v20211101:DataMaskingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
