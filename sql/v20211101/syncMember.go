...
func NewSyncMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101:SyncMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncMember(ctx *pulumi.Context,
	...
	var resource SyncMember
	err := ctx.ReadResource("azure-native:sql/v20211101:SyncMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
