...
func NewOutboundFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:OutboundFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:OutboundFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:OutboundFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:OutboundFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:OutboundFirewallRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101:OutboundFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOutboundFirewallRule(ctx *pulumi.Context,
	...
	var resource OutboundFirewallRule
	err := ctx.ReadResource("azure-native:sql/v20211101:OutboundFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
