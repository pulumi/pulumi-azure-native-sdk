...
func NewLongTermRetentionPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101:LongTermRetentionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLongTermRetentionPolicy(ctx *pulumi.Context,
	...
	var resource LongTermRetentionPolicy
	err := ctx.ReadResource("azure-native:sql/v20211101:LongTermRetentionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
