...
func LookupSyncAgent(ctx *pulumi.Context, args *LookupSyncAgentArgs, opts ...pulumi.InvokeOption) (*LookupSyncAgentResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20211101:getSyncAgent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSyncAgentOutput(ctx *pulumi.Context, args LookupSyncAgentOutputArgs, opts ...pulumi.InvokeOption) LookupSyncAgentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSyncAgentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20211101:getSyncAgent", args, LookupSyncAgentResultOutput{}, options).(LookupSyncAgentResultOutput), nil
