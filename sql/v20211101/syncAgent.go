...
//
// Deprecated: azure-native:sql/v20211101:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncAgent to guarantee forwards compatibility.
...
func NewSyncAgent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20211101:SyncAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncAgent(ctx *pulumi.Context,
	...
	var resource SyncAgent
	err := ctx.ReadResource("azure-native:sql/v20211101:SyncAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
