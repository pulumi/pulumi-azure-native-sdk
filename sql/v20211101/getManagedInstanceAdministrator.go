...
func LookupManagedInstanceAdministrator(ctx *pulumi.Context, args *LookupManagedInstanceAdministratorArgs, opts ...pulumi.InvokeOption) (*LookupManagedInstanceAdministratorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20211101:getManagedInstanceAdministrator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedInstanceAdministratorOutput(ctx *pulumi.Context, args LookupManagedInstanceAdministratorOutputArgs, opts ...pulumi.InvokeOption) LookupManagedInstanceAdministratorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedInstanceAdministratorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20211101:getManagedInstanceAdministrator", args, LookupManagedInstanceAdministratorResultOutput{}, options).(LookupManagedInstanceAdministratorResultOutput), nil
