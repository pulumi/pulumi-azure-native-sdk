...
//
// Deprecated: azure-native:sql/v20211101:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstancePool to guarantee forwards compatibility.
func LookupInstancePool(ctx *pulumi.Context, args *LookupInstancePoolArgs, opts ...pulumi.InvokeOption) (*LookupInstancePoolResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20211101:getInstancePool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
