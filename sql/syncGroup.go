...
func NewSyncGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:SyncGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:SyncGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:SyncGroup"),
		},
	})
