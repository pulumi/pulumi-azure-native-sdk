...
func NewManagedInstanceAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ManagedInstanceAzureADOnlyAuthentication"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ManagedInstanceAzureADOnlyAuthentication"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ManagedInstanceAzureADOnlyAuthentication"),
		},
	})
