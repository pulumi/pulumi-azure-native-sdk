...
func NewVirtualNetworkRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:VirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:VirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:VirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:VirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:VirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:VirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:VirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:VirtualNetworkRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualNetworkRule
	err := ctx.RegisterResource("azure-native:sql:VirtualNetworkRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkRule(ctx *pulumi.Context,
	...
	var resource VirtualNetworkRule
	err := ctx.ReadResource("azure-native:sql:VirtualNetworkRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
