...
//
// Deprecated: azure-native:sql/v20170301preview:ExtendedDatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ExtendedDatabaseBlobAuditingPolicy to guarantee forwards compatibility.
...
func NewExtendedDatabaseBlobAuditingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20170301preview:ExtendedDatabaseBlobAuditingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExtendedDatabaseBlobAuditingPolicy(ctx *pulumi.Context,
	...
	var resource ExtendedDatabaseBlobAuditingPolicy
	err := ctx.ReadResource("azure-native:sql/v20170301preview:ExtendedDatabaseBlobAuditingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
