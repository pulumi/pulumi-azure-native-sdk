...
// A database resource.
//
// Deprecated: azure-native:sql/v20170301preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20190601preview:Database to guarantee forwards compatibility.
