...
//
// Deprecated: azure-native:sql/v20170301preview:ManagedDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedDatabase to guarantee forwards compatibility.
...
func NewManagedDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20170301preview:ManagedDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedDatabase(ctx *pulumi.Context,
	...
	var resource ManagedDatabase
	err := ctx.ReadResource("azure-native:sql/v20170301preview:ManagedDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
