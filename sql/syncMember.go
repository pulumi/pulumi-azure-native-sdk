...
func NewSyncMember(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:SyncMember"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:SyncMember"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:SyncMember"),
		},
	})
