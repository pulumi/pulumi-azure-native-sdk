...
func NewServerDnsAlias(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ServerDnsAlias"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ServerDnsAlias"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ServerDnsAlias"),
		},
	})
