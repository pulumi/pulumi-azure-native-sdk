...
func NewBackupShortTermRetentionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:BackupShortTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:BackupShortTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:BackupShortTermRetentionPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BackupShortTermRetentionPolicy
	err := ctx.RegisterResource("azure-native:sql:BackupShortTermRetentionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupShortTermRetentionPolicy(ctx *pulumi.Context,
	...
	var resource BackupShortTermRetentionPolicy
	err := ctx.ReadResource("azure-native:sql:BackupShortTermRetentionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
