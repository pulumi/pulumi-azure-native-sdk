...
func LookupDataMaskingPolicy(ctx *pulumi.Context, args *LookupDataMaskingPolicyArgs, opts ...pulumi.InvokeOption) (*LookupDataMaskingPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801preview:getDataMaskingPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDataMaskingPolicyOutput(ctx *pulumi.Context, args LookupDataMaskingPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupDataMaskingPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDataMaskingPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801preview:getDataMaskingPolicy", args, LookupDataMaskingPolicyResultOutput{}, options).(LookupDataMaskingPolicyResultOutput), nil
