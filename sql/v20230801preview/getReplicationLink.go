...
func LookupReplicationLink(ctx *pulumi.Context, args *LookupReplicationLinkArgs, opts ...pulumi.InvokeOption) (*LookupReplicationLinkResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801preview:getReplicationLink", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationLinkOutput(ctx *pulumi.Context, args LookupReplicationLinkOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationLinkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationLinkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801preview:getReplicationLink", args, LookupReplicationLinkResultOutput{}, options).(LookupReplicationLinkResultOutput), nil
