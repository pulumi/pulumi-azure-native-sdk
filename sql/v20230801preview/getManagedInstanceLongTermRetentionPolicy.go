...
func LookupManagedInstanceLongTermRetentionPolicy(ctx *pulumi.Context, args *LookupManagedInstanceLongTermRetentionPolicyArgs, opts ...pulumi.InvokeOption) (*LookupManagedInstanceLongTermRetentionPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801preview:getManagedInstanceLongTermRetentionPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedInstanceLongTermRetentionPolicyOutput(ctx *pulumi.Context, args LookupManagedInstanceLongTermRetentionPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupManagedInstanceLongTermRetentionPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedInstanceLongTermRetentionPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801preview:getManagedInstanceLongTermRetentionPolicy", args, LookupManagedInstanceLongTermRetentionPolicyResultOutput{}, options).(LookupManagedInstanceLongTermRetentionPolicyResultOutput), nil
