...
type ManagedInstance struct {
	...
	TotalMemoryMB pulumi.IntPtrOutput `pulumi:"totalMemoryMB"`
	// Resource type.
...
func NewManagedInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:ManagedInstance"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:ManagedInstance"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801preview:ManagedInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstance(ctx *pulumi.Context,
	...
	var resource ManagedInstance
	err := ctx.ReadResource("azure-native:sql/v20230801preview:ManagedInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type managedInstanceArgs struct {
	...
	// Total memory in MB. Minimum value: 7168. Maximum value: 891328. Increments of 1 MB allowed only. Maximum value depends on the selected hardware family and number of vCores.
	TotalMemoryMB *int `pulumi:"totalMemoryMB"`
	// The number of vCores. Allowed values: 8, 16, 24, 32, 40, 64, 80.
...
type ManagedInstanceArgs struct {
	...
	// Total memory in MB. Minimum value: 7168. Maximum value: 891328. Increments of 1 MB allowed only. Maximum value depends on the selected hardware family and number of vCores.
	TotalMemoryMB pulumi.IntPtrInput
	// The number of vCores. Allowed values: 8, 16, 24, 32, 40, 64, 80.
...
// Total memory in MB. Minimum value: 7168. Maximum value: 891328. Increments of 1 MB allowed only. Maximum value depends on the selected hardware family and number of vCores.
func (o ManagedInstanceOutput) TotalMemoryMB() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *ManagedInstance) pulumi.IntPtrOutput { return v.TotalMemoryMB }).(pulumi.IntPtrOutput)
}
