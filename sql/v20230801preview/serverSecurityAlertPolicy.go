...
func NewServerSecurityAlertPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:ServerSecurityAlertPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:ServerSecurityAlertPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:ServerSecurityAlertPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801preview:ServerSecurityAlertPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerSecurityAlertPolicy(ctx *pulumi.Context,
	...
	var resource ServerSecurityAlertPolicy
	err := ctx.ReadResource("azure-native:sql/v20230801preview:ServerSecurityAlertPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
