...
func LookupSensitivityLabel(ctx *pulumi.Context, args *LookupSensitivityLabelArgs, opts ...pulumi.InvokeOption) (*LookupSensitivityLabelResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801preview:getSensitivityLabel", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSensitivityLabelOutput(ctx *pulumi.Context, args LookupSensitivityLabelOutputArgs, opts ...pulumi.InvokeOption) LookupSensitivityLabelResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSensitivityLabelResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801preview:getSensitivityLabel", args, LookupSensitivityLabelResultOutput{}, options).(LookupSensitivityLabelResultOutput), nil
