...
func NewManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:ManagedDatabaseSensitivityLabel"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:ManagedDatabaseSensitivityLabel"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801preview:ManagedDatabaseSensitivityLabel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	var resource ManagedDatabaseSensitivityLabel
	err := ctx.ReadResource("azure-native:sql/v20230801preview:ManagedDatabaseSensitivityLabel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
