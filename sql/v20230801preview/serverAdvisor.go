...
func NewServerAdvisor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801preview:ServerAdvisor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAdvisor(ctx *pulumi.Context,
	...
	var resource ServerAdvisor
	err := ctx.ReadResource("azure-native:sql/v20230801preview:ServerAdvisor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
