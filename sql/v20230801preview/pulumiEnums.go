...
func (FreemiumType) ElementType() reflect.Type {
	return reflect.TypeOf((*FreemiumType)(nil)).Elem()
}

func (e FreemiumType) ToFreemiumTypeOutput() FreemiumTypeOutput {
	return pulumi.ToOutput(e).(FreemiumTypeOutput)
}

func (e FreemiumType) ToFreemiumTypeOutputWithContext(ctx context.Context) FreemiumTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(FreemiumTypeOutput)
}

func (e FreemiumType) ToFreemiumTypePtrOutput() FreemiumTypePtrOutput {
	return e.ToFreemiumTypePtrOutputWithContext(context.Background())
}

func (e FreemiumType) ToFreemiumTypePtrOutputWithContext(ctx context.Context) FreemiumTypePtrOutput {
	return FreemiumType(e).ToFreemiumTypeOutputWithContext(ctx).ToFreemiumTypePtrOutputWithContext(ctx)
}

func (e FreemiumType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e FreemiumType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e FreemiumType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e FreemiumType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type FreemiumTypeOutput struct{ *pulumi.OutputState }

func (FreemiumTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FreemiumType)(nil)).Elem()
}

func (o FreemiumTypeOutput) ToFreemiumTypeOutput() FreemiumTypeOutput {
	return o
}

func (o FreemiumTypeOutput) ToFreemiumTypeOutputWithContext(ctx context.Context) FreemiumTypeOutput {
	return o
}

func (o FreemiumTypeOutput) ToFreemiumTypePtrOutput() FreemiumTypePtrOutput {
	return o.ToFreemiumTypePtrOutputWithContext(context.Background())
}

func (o FreemiumTypeOutput) ToFreemiumTypePtrOutputWithContext(ctx context.Context) FreemiumTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v FreemiumType) *FreemiumType {
		return &v
	}).(FreemiumTypePtrOutput)
}

func (o FreemiumTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o FreemiumTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e FreemiumType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o FreemiumTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o FreemiumTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e FreemiumType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type FreemiumTypePtrOutput struct{ *pulumi.OutputState }

func (FreemiumTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**FreemiumType)(nil)).Elem()
}

func (o FreemiumTypePtrOutput) ToFreemiumTypePtrOutput() FreemiumTypePtrOutput {
	return o
}

func (o FreemiumTypePtrOutput) ToFreemiumTypePtrOutputWithContext(ctx context.Context) FreemiumTypePtrOutput {
	return o
}

func (o FreemiumTypePtrOutput) Elem() FreemiumTypeOutput {
	return o.ApplyT(func(v *FreemiumType) FreemiumType {
		if v != nil {
			return *v
		}
		var ret FreemiumType
		return ret
	}).(FreemiumTypeOutput)
}

func (o FreemiumTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o FreemiumTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *FreemiumType) *string {
		if e == nil {
			return nil
		}
...
// FreemiumTypeInput is an input type that accepts values of the FreemiumType enum
// A concrete instance of `FreemiumTypeInput` can be one of the following:
//
//	FreemiumTypeRegular
//	FreemiumTypeFreemium
type FreemiumTypeInput interface {
	pulumi.Input

	ToFreemiumTypeOutput() FreemiumTypeOutput
	ToFreemiumTypeOutputWithContext(context.Context) FreemiumTypeOutput
}

var freemiumTypePtrType = reflect.TypeOf((**FreemiumType)(nil)).Elem()

type FreemiumTypePtrInput interface {
	pulumi.Input

	ToFreemiumTypePtrOutput() FreemiumTypePtrOutput
	ToFreemiumTypePtrOutputWithContext(context.Context) FreemiumTypePtrOutput
}

type freemiumTypePtr string

func FreemiumTypePtr(v string) FreemiumTypePtrInput {
	return (*freemiumTypePtr)(&v)
}

func (*freemiumTypePtr) ElementType() reflect.Type {
	return freemiumTypePtrType
}

func (in *freemiumTypePtr) ToFreemiumTypePtrOutput() FreemiumTypePtrOutput {
	return pulumi.ToOutput(in).(FreemiumTypePtrOutput)
}

func (in *freemiumTypePtr) ToFreemiumTypePtrOutputWithContext(ctx context.Context) FreemiumTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(FreemiumTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(FreemiumTypeOutput{})
	pulumi.RegisterOutputType(FreemiumTypePtrOutput{})
