...
func NewManagedInstanceKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230801preview:ManagedInstanceKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstanceKey(ctx *pulumi.Context,
	...
	var resource ManagedInstanceKey
	err := ctx.ReadResource("azure-native:sql/v20230801preview:ManagedInstanceKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
