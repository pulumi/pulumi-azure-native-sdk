...
func LookupServerAzureADAdministrator(ctx *pulumi.Context, args *LookupServerAzureADAdministratorArgs, opts ...pulumi.InvokeOption) (*LookupServerAzureADAdministratorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801preview:getServerAzureADAdministrator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerAzureADAdministratorOutput(ctx *pulumi.Context, args LookupServerAzureADAdministratorOutputArgs, opts ...pulumi.InvokeOption) LookupServerAzureADAdministratorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerAzureADAdministratorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801preview:getServerAzureADAdministrator", args, LookupServerAzureADAdministratorResultOutput{}, options).(LookupServerAzureADAdministratorResultOutput), nil
