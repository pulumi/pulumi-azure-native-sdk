...
func LookupManagedInstanceKey(ctx *pulumi.Context, args *LookupManagedInstanceKeyArgs, opts ...pulumi.InvokeOption) (*LookupManagedInstanceKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801preview:getManagedInstanceKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedInstanceKeyOutput(ctx *pulumi.Context, args LookupManagedInstanceKeyOutputArgs, opts ...pulumi.InvokeOption) LookupManagedInstanceKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedInstanceKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801preview:getManagedInstanceKey", args, LookupManagedInstanceKeyResultOutput{}, options).(LookupManagedInstanceKeyResultOutput), nil
