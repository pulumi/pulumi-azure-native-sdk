...
func LookupManagedInstancePrivateEndpointConnection(ctx *pulumi.Context, args *LookupManagedInstancePrivateEndpointConnectionArgs, opts ...pulumi.InvokeOption) (*LookupManagedInstancePrivateEndpointConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230801preview:getManagedInstancePrivateEndpointConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedInstancePrivateEndpointConnectionOutput(ctx *pulumi.Context, args LookupManagedInstancePrivateEndpointConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupManagedInstancePrivateEndpointConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedInstancePrivateEndpointConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230801preview:getManagedInstancePrivateEndpointConnection", args, LookupManagedInstancePrivateEndpointConnectionResultOutput{}, options).(LookupManagedInstancePrivateEndpointConnectionResultOutput), nil
