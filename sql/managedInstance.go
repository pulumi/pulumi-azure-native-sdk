...
func NewManagedInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20250101:ManagedInstance"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ManagedInstance"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ManagedInstance
	err := ctx.RegisterResource("azure-native:sql:ManagedInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstance(ctx *pulumi.Context,
	...
	var resource ManagedInstance
	err := ctx.ReadResource("azure-native:sql:ManagedInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
