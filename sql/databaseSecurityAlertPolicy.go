...
func NewDatabaseSecurityAlertPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:DatabaseSecurityAlertPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:DatabaseSecurityAlertPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:DatabaseSecurityAlertPolicy"),
		},
		{
