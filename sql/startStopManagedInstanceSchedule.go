...
func NewStartStopManagedInstanceSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:StartStopManagedInstanceSchedule"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:StartStopManagedInstanceSchedule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:StartStopManagedInstanceSchedule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:StartStopManagedInstanceSchedule"),
		},
	})
