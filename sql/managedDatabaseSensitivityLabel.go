...
func NewManagedDatabaseSensitivityLabel(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20250101:ManagedDatabaseSensitivityLabel"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ManagedDatabaseSensitivityLabel"),
		},
	})
