...
func NewTransparentDataEncryption(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:TransparentDataEncryption"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:TransparentDataEncryption"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:TransparentDataEncryption"),
		},
	})
