...
func NewJobCredential(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:JobCredential"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:JobCredential"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:JobCredential"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource JobCredential
	err := ctx.RegisterResource("azure-native:sql:JobCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobCredential(ctx *pulumi.Context,
	...
	var resource JobCredential
	err := ctx.ReadResource("azure-native:sql:JobCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o JobCredentialOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *JobCredential) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
