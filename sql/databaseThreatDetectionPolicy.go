...
func NewDatabaseThreatDetectionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:DatabaseThreatDetectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:DatabaseThreatDetectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:DatabaseThreatDetectionPolicy"),
		},
		{
