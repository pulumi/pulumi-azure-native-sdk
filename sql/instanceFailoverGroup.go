...
func NewInstanceFailoverGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:InstanceFailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:InstanceFailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:InstanceFailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:InstanceFailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:InstanceFailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:InstanceFailoverGroup"),
		},
	})
