...
func NewServerTrustCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ServerTrustCertificate"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ServerTrustCertificate"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ServerTrustCertificate"),
		},
	})
