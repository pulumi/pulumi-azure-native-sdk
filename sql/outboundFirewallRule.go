...
func NewOutboundFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:OutboundFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:OutboundFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:OutboundFirewallRule"),
		},
	})
...
// The Azure API version of the resource.
func (o OutboundFirewallRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *OutboundFirewallRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
