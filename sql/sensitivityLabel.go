...
func NewSensitivityLabel(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:SensitivityLabel"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:SensitivityLabel"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:SensitivityLabel"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:SensitivityLabel"),
		},
	})
...
// The Azure API version of the resource.
func (o SensitivityLabelOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SensitivityLabel) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}

func (o SensitivityLabelOutput) ClientClassificationSource() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SensitivityLabel) pulumi.StringPtrOutput { return v.ClientClassificationSource }).(pulumi.StringPtrOutput)
}
