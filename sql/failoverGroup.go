...
func NewFailoverGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:FailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:FailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:FailoverGroup"),
		},
	})
