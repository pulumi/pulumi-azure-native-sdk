...
func NewManagedServerDnsAlias(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ManagedServerDnsAlias"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ManagedServerDnsAlias"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ManagedServerDnsAlias"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ManagedServerDnsAlias
	err := ctx.RegisterResource("azure-native:sql:ManagedServerDnsAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedServerDnsAlias(ctx *pulumi.Context,
	...
	var resource ManagedServerDnsAlias
	err := ctx.ReadResource("azure-native:sql:ManagedServerDnsAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ManagedServerDnsAliasOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagedServerDnsAlias) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
