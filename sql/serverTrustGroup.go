...
func NewServerTrustGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:ServerTrustGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:ServerTrustGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:ServerTrustGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:ServerTrustGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ServerTrustGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ServerTrustGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ServerTrustGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ServerTrustGroup
	err := ctx.RegisterResource("azure-native:sql:ServerTrustGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerTrustGroup(ctx *pulumi.Context,
	...
	var resource ServerTrustGroup
	err := ctx.ReadResource("azure-native:sql:ServerTrustGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ServerTrustGroupOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ServerTrustGroup) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
