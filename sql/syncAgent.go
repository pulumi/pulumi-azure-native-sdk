...
func NewSyncAgent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:SyncAgent"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:SyncAgent"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:SyncAgent"),
		},
	})
