...
func NewManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ManagedInstanceAdministrator"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ManagedInstanceAdministrator"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ManagedInstanceAdministrator"),
		},
	})
...
// The Azure API version of the resource.
func (o ManagedInstanceAdministratorOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagedInstanceAdministrator) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
