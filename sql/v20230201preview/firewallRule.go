...
func NewFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:FirewallRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:FirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallRule(ctx *pulumi.Context,
	...
	var resource FirewallRule
	err := ctx.ReadResource("azure-native:sql/v20230201preview:FirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
