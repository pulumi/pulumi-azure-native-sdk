...
func NewExtendedServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:ExtendedServerBlobAuditingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExtendedServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	var resource ExtendedServerBlobAuditingPolicy
	err := ctx.ReadResource("azure-native:sql/v20230201preview:ExtendedServerBlobAuditingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ExtendedServerBlobAuditingPolicy) ToOutput(ctx context.Context) pulumix.Output[*ExtendedServerBlobAuditingPolicy] {
	return pulumix.Output[*ExtendedServerBlobAuditingPolicy]{
		OutputState: i.ToExtendedServerBlobAuditingPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o ExtendedServerBlobAuditingPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*ExtendedServerBlobAuditingPolicy] {
	return pulumix.Output[*ExtendedServerBlobAuditingPolicy]{
