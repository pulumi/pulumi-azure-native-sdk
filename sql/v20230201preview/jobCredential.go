...
func NewJobCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:JobCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobCredential(ctx *pulumi.Context,
	...
	var resource JobCredential
	err := ctx.ReadResource("azure-native:sql/v20230201preview:JobCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
