...
func LookupManagedServerDnsAlias(ctx *pulumi.Context, args *LookupManagedServerDnsAliasArgs, opts ...pulumi.InvokeOption) (*LookupManagedServerDnsAliasResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230201preview:getManagedServerDnsAlias", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedServerDnsAliasOutput(ctx *pulumi.Context, args LookupManagedServerDnsAliasOutputArgs, opts ...pulumi.InvokeOption) LookupManagedServerDnsAliasResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedServerDnsAliasResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230201preview:getManagedServerDnsAlias", args, LookupManagedServerDnsAliasResultOutput{}, options).(LookupManagedServerDnsAliasResultOutput), nil
