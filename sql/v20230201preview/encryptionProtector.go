...
func NewEncryptionProtector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:EncryptionProtector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEncryptionProtector(ctx *pulumi.Context,
	...
	var resource EncryptionProtector
	err := ctx.ReadResource("azure-native:sql/v20230201preview:EncryptionProtector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *EncryptionProtector) ToOutput(ctx context.Context) pulumix.Output[*EncryptionProtector] {
	return pulumix.Output[*EncryptionProtector]{
		OutputState: i.ToEncryptionProtectorOutputWithContext(ctx).OutputState,
	}
}
...
func (o EncryptionProtectorOutput) ToOutput(ctx context.Context) pulumix.Output[*EncryptionProtector] {
	return pulumix.Output[*EncryptionProtector]{
