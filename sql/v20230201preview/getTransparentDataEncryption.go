...
func LookupTransparentDataEncryption(ctx *pulumi.Context, args *LookupTransparentDataEncryptionArgs, opts ...pulumi.InvokeOption) (*LookupTransparentDataEncryptionResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230201preview:getTransparentDataEncryption", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupTransparentDataEncryptionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTransparentDataEncryptionResult] {
	return pulumix.Output[LookupTransparentDataEncryptionResult]{
