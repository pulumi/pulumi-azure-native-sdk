...
func NewIPv6FirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:IPv6FirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIPv6FirewallRule(ctx *pulumi.Context,
	...
	var resource IPv6FirewallRule
	err := ctx.ReadResource("azure-native:sql/v20230201preview:IPv6FirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
