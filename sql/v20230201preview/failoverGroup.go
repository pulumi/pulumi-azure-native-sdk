...
func NewFailoverGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:FailoverGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFailoverGroup(ctx *pulumi.Context,
	...
	var resource FailoverGroup
	err := ctx.ReadResource("azure-native:sql/v20230201preview:FailoverGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
