...
func NewBackupShortTermRetentionPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:BackupShortTermRetentionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupShortTermRetentionPolicy(ctx *pulumi.Context,
	...
	var resource BackupShortTermRetentionPolicy
	err := ctx.ReadResource("azure-native:sql/v20230201preview:BackupShortTermRetentionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
