...
func LookupServerKey(ctx *pulumi.Context, args *LookupServerKeyArgs, opts ...pulumi.InvokeOption) (*LookupServerKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230201preview:getServerKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerKeyOutput(ctx *pulumi.Context, args LookupServerKeyOutputArgs, opts ...pulumi.InvokeOption) LookupServerKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230201preview:getServerKey", args, LookupServerKeyResultOutput{}, options).(LookupServerKeyResultOutput), nil
