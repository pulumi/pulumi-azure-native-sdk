...
func LookupServerTrustGroup(ctx *pulumi.Context, args *LookupServerTrustGroupArgs, opts ...pulumi.InvokeOption) (*LookupServerTrustGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20230201preview:getServerTrustGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerTrustGroupOutput(ctx *pulumi.Context, args LookupServerTrustGroupOutputArgs, opts ...pulumi.InvokeOption) LookupServerTrustGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerTrustGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20230201preview:getServerTrustGroup", args, LookupServerTrustGroupResultOutput{}, options).(LookupServerTrustGroupResultOutput), nil
