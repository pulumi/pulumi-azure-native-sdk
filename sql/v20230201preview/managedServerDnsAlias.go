...
func NewManagedServerDnsAlias(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:ManagedServerDnsAlias"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:ManagedServerDnsAlias"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:ManagedServerDnsAlias"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:ManagedServerDnsAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedServerDnsAlias(ctx *pulumi.Context,
	...
	var resource ManagedServerDnsAlias
	err := ctx.ReadResource("azure-native:sql/v20230201preview:ManagedServerDnsAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
