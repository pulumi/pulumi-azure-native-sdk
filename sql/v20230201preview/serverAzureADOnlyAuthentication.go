...
func NewServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:ServerAzureADOnlyAuthentication"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:ServerAzureADOnlyAuthentication"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:ServerAzureADOnlyAuthentication"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:ServerAzureADOnlyAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	var resource ServerAzureADOnlyAuthentication
	err := ctx.ReadResource("azure-native:sql/v20230201preview:ServerAzureADOnlyAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
