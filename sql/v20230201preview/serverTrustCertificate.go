...
func NewServerTrustCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:ServerTrustCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerTrustCertificate(ctx *pulumi.Context,
	...
	var resource ServerTrustCertificate
	err := ctx.ReadResource("azure-native:sql/v20230201preview:ServerTrustCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
