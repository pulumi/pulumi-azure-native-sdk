...
func NewElasticPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20230201preview:ElasticPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticPool(ctx *pulumi.Context,
	...
	var resource ElasticPool
	err := ctx.ReadResource("azure-native:sql/v20230201preview:ElasticPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
