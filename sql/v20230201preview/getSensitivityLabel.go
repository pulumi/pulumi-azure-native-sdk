...
func (o LookupSensitivityLabelResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSensitivityLabelResult] {
	return pulumix.Output[LookupSensitivityLabelResult]{
