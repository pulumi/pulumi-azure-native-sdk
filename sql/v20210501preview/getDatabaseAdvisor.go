...
//
// Deprecated: azure-native:sql/v20210501preview:DatabaseAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseAdvisor to guarantee forwards compatibility.
func LookupDatabaseAdvisor(ctx *pulumi.Context, args *LookupDatabaseAdvisorArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAdvisorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20210501preview:getDatabaseAdvisor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
