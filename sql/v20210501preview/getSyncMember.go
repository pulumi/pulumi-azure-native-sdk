...
// Gets a sync member.
//
// Deprecated: azure-native:sql/v20210501preview:SyncMember is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncMember to guarantee forwards compatibility.
