...
func NewTransparentDataEncryption(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210501preview:TransparentDataEncryption", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransparentDataEncryption(ctx *pulumi.Context,
	...
	var resource TransparentDataEncryption
	err := ctx.ReadResource("azure-native:sql/v20210501preview:TransparentDataEncryption", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
