...
//
// Deprecated: azure-native:sql/v20210501preview:JobStep is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobStep to guarantee forwards compatibility.
func LookupJobStep(ctx *pulumi.Context, args *LookupJobStepArgs, opts ...pulumi.InvokeOption) (*LookupJobStepResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20210501preview:getJobStep", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
