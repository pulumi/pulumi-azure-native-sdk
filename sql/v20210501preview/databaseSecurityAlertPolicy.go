...
func NewDatabaseSecurityAlertPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210501preview:DatabaseSecurityAlertPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseSecurityAlertPolicy(ctx *pulumi.Context,
	...
	var resource DatabaseSecurityAlertPolicy
	err := ctx.ReadResource("azure-native:sql/v20210501preview:DatabaseSecurityAlertPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
