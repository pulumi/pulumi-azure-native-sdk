...
// A job.
//
// Deprecated: azure-native:sql/v20210501preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Job to guarantee forwards compatibility.
type Job struct {
...
func NewJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.RegisterResource("azure-native:sql/v20210501preview:Job", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.ReadResource("azure-native:sql/v20210501preview:Job", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
