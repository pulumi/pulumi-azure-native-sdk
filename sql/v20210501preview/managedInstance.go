...
//
// Deprecated: azure-native:sql/v20210501preview:ManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstance to guarantee forwards compatibility.
...
func NewManagedInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210501preview:ManagedInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstance(ctx *pulumi.Context,
	...
	var resource ManagedInstance
	err := ctx.ReadResource("azure-native:sql/v20210501preview:ManagedInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
