...
func NewJobStep(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210501preview:JobStep", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobStep(ctx *pulumi.Context,
	...
	var resource JobStep
	err := ctx.ReadResource("azure-native:sql/v20210501preview:JobStep", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
