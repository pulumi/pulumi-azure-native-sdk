...
func NewExtendedDatabaseBlobAuditingPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ExtendedDatabaseBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ExtendedDatabaseBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ExtendedDatabaseBlobAuditingPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ExtendedDatabaseBlobAuditingPolicy
	err := ctx.RegisterResource("azure-native:sql:ExtendedDatabaseBlobAuditingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExtendedDatabaseBlobAuditingPolicy(ctx *pulumi.Context,
	...
	var resource ExtendedDatabaseBlobAuditingPolicy
	err := ctx.ReadResource("azure-native:sql:ExtendedDatabaseBlobAuditingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ExtendedDatabaseBlobAuditingPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ExtendedDatabaseBlobAuditingPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
