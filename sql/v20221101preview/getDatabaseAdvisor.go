...
func LookupDatabaseAdvisor(ctx *pulumi.Context, args *LookupDatabaseAdvisorArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAdvisorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20221101preview:getDatabaseAdvisor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDatabaseAdvisorOutput(ctx *pulumi.Context, args LookupDatabaseAdvisorOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseAdvisorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseAdvisorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20221101preview:getDatabaseAdvisor", args, LookupDatabaseAdvisorResultOutput{}, options).(LookupDatabaseAdvisorResultOutput), nil
