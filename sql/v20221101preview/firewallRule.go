...
func NewFirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20221101preview:FirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallRule(ctx *pulumi.Context,
	...
	var resource FirewallRule
	err := ctx.ReadResource("azure-native:sql/v20221101preview:FirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
