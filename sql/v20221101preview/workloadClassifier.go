...
func NewWorkloadClassifier(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:WorkloadClassifier"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:WorkloadClassifier"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:WorkloadClassifier"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:WorkloadClassifier"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20221101preview:WorkloadClassifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadClassifier(ctx *pulumi.Context,
	...
	var resource WorkloadClassifier
	err := ctx.ReadResource("azure-native:sql/v20221101preview:WorkloadClassifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
