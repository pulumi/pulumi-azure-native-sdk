...
func LookupDistributedAvailabilityGroup(ctx *pulumi.Context, args *LookupDistributedAvailabilityGroupArgs, opts ...pulumi.InvokeOption) (*LookupDistributedAvailabilityGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20221101preview:getDistributedAvailabilityGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDistributedAvailabilityGroupOutput(ctx *pulumi.Context, args LookupDistributedAvailabilityGroupOutputArgs, opts ...pulumi.InvokeOption) LookupDistributedAvailabilityGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDistributedAvailabilityGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20221101preview:getDistributedAvailabilityGroup", args, LookupDistributedAvailabilityGroupResultOutput{}, options).(LookupDistributedAvailabilityGroupResultOutput), nil
