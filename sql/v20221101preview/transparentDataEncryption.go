...
func NewTransparentDataEncryption(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:TransparentDataEncryption"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:TransparentDataEncryption"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20221101preview:TransparentDataEncryption", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransparentDataEncryption(ctx *pulumi.Context,
	...
	var resource TransparentDataEncryption
	err := ctx.ReadResource("azure-native:sql/v20221101preview:TransparentDataEncryption", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
