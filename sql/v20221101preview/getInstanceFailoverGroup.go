...
func LookupInstanceFailoverGroup(ctx *pulumi.Context, args *LookupInstanceFailoverGroupArgs, opts ...pulumi.InvokeOption) (*LookupInstanceFailoverGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20221101preview:getInstanceFailoverGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupInstanceFailoverGroupOutput(ctx *pulumi.Context, args LookupInstanceFailoverGroupOutputArgs, opts ...pulumi.InvokeOption) LookupInstanceFailoverGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupInstanceFailoverGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sql/v20221101preview:getInstanceFailoverGroup", args, LookupInstanceFailoverGroupResultOutput{}, options).(LookupInstanceFailoverGroupResultOutput), nil
