...
func NewServerSecurityAlertPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20221101preview:ServerSecurityAlertPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerSecurityAlertPolicy(ctx *pulumi.Context,
	...
	var resource ServerSecurityAlertPolicy
	err := ctx.ReadResource("azure-native:sql/v20221101preview:ServerSecurityAlertPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
