...
func NewFailoverGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:FailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:FailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:FailoverGroup"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:FailoverGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:sql/v20221101preview:FailoverGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFailoverGroup(ctx *pulumi.Context,
	...
	var resource FailoverGroup
	err := ctx.ReadResource("azure-native:sql/v20221101preview:FailoverGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
