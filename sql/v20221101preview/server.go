...
func NewServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230801:Server"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:Server"),
		},
		{
	...
	var resource Server
	err := ctx.RegisterResource("azure-native:sql/v20221101preview:Server", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.ReadResource("azure-native:sql/v20221101preview:Server", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
