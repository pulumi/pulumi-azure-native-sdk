...
func NewServerKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:ServerKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:ServerKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:ServerKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:ServerKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:ServerKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ServerKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ServerKey"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ServerKey"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ServerKey
	err := ctx.RegisterResource("azure-native:sql:ServerKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerKey(ctx *pulumi.Context,
	...
	var resource ServerKey
	err := ctx.ReadResource("azure-native:sql:ServerKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
