...
// An elastic pool.
//
// Deprecated: azure-native:sql/v20210201preview:ElasticPool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ElasticPool to guarantee forwards compatibility.
...
func NewElasticPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210201preview:ElasticPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticPool(ctx *pulumi.Context,
	...
	var resource ElasticPool
	err := ctx.ReadResource("azure-native:sql/v20210201preview:ElasticPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
