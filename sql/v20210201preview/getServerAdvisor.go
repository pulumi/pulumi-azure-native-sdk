...
//
// Deprecated: azure-native:sql/v20210201preview:ServerAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerAdvisor to guarantee forwards compatibility.
func LookupServerAdvisor(ctx *pulumi.Context, args *LookupServerAdvisorArgs, opts ...pulumi.InvokeOption) (*LookupServerAdvisorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20210201preview:getServerAdvisor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
