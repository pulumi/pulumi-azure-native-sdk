...
//
// Deprecated: azure-native:sql/v20210201preview:EncryptionProtector is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:EncryptionProtector to guarantee forwards compatibility.
