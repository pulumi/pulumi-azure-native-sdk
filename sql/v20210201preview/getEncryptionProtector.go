...
//
// Deprecated: azure-native:sql/v20210201preview:EncryptionProtector is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:EncryptionProtector to guarantee forwards compatibility.
func LookupEncryptionProtector(ctx *pulumi.Context, args *LookupEncryptionProtectorArgs, opts ...pulumi.InvokeOption) (*LookupEncryptionProtectorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20210201preview:getEncryptionProtector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
