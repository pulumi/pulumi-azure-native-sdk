...
//
// Deprecated: azure-native:sql/v20210201preview:FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:FirewallRule to guarantee forwards compatibility.
