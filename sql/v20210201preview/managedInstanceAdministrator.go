...
//
// Deprecated: azure-native:sql/v20210201preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.
...
func NewManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210201preview:ManagedInstanceAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstanceAdministrator(ctx *pulumi.Context,
	...
	var resource ManagedInstanceAdministrator
	err := ctx.ReadResource("azure-native:sql/v20210201preview:ManagedInstanceAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
