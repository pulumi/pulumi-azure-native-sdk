...
func NewSyncAgent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210201preview:SyncAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncAgent(ctx *pulumi.Context,
	...
	var resource SyncAgent
	err := ctx.ReadResource("azure-native:sql/v20210201preview:SyncAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
