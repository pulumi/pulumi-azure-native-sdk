...
// Gets a job agent.
//
// Deprecated: azure-native:sql/v20210201preview:JobAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobAgent to guarantee forwards compatibility.
