...
//
// Deprecated: azure-native:sql/v20210201preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerAzureADAdministrator to guarantee forwards compatibility.
func LookupServerAzureADAdministrator(ctx *pulumi.Context, args *LookupServerAzureADAdministratorArgs, opts ...pulumi.InvokeOption) (*LookupServerAzureADAdministratorResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20210201preview:getServerAzureADAdministrator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
