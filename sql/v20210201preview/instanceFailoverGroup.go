...
//
// Deprecated: azure-native:sql/v20210201preview:InstanceFailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstanceFailoverGroup to guarantee forwards compatibility.
...
func NewInstanceFailoverGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210201preview:InstanceFailoverGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceFailoverGroup(ctx *pulumi.Context,
	...
	var resource InstanceFailoverGroup
	err := ctx.ReadResource("azure-native:sql/v20210201preview:InstanceFailoverGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
