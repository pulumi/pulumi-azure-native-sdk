...
// Gets a server key.
//
// Deprecated: azure-native:sql/v20210201preview:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerKey to guarantee forwards compatibility.
