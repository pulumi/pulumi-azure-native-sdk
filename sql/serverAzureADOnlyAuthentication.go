...
func NewServerAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ServerAzureADOnlyAuthentication"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ServerAzureADOnlyAuthentication"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ServerAzureADOnlyAuthentication"),
		},
	})
...
// The Azure API version of the resource.
func (o ServerAzureADOnlyAuthenticationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ServerAzureADOnlyAuthentication) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
