...
func NewManagedInstanceLongTermRetentionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ManagedInstanceLongTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ManagedInstanceLongTermRetentionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ManagedInstanceLongTermRetentionPolicy"),
		},
	})
