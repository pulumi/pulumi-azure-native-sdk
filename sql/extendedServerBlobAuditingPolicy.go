...
func NewExtendedServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20220801preview:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20221101preview:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230201preview:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230501preview:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20230801preview:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20240501preview:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ExtendedServerBlobAuditingPolicy"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ExtendedServerBlobAuditingPolicy"),
		},
	})
...
func GetExtendedServerBlobAuditingPolicy(ctx *pulumi.Context,
	...
	var resource ExtendedServerBlobAuditingPolicy
	err := ctx.ReadResource("azure-native:sql:ExtendedServerBlobAuditingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ExtendedServerBlobAuditingPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ExtendedServerBlobAuditingPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
