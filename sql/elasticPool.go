...
func NewElasticPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:sql/v20241101preview:ElasticPool"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250101:ElasticPool"),
		},
		{
			Type: pulumi.String("azure-native:sql/v20250201preview:ElasticPool"),
		},
	})
