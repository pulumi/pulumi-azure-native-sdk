...
func NewManagedInstanceAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210801preview:ManagedInstanceAzureADOnlyAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstanceAzureADOnlyAuthentication(ctx *pulumi.Context,
	...
	var resource ManagedInstanceAzureADOnlyAuthentication
	err := ctx.ReadResource("azure-native:sql/v20210801preview:ManagedInstanceAzureADOnlyAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
