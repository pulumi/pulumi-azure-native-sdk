...
//
// Deprecated: azure-native:sql/v20210801preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.
...
func NewServerSecurityAlertPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210801preview:ServerSecurityAlertPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerSecurityAlertPolicy(ctx *pulumi.Context,
	...
	var resource ServerSecurityAlertPolicy
	err := ctx.ReadResource("azure-native:sql/v20210801preview:ServerSecurityAlertPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
