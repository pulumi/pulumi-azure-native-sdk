...
func NewOutboundFirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210801preview:OutboundFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOutboundFirewallRule(ctx *pulumi.Context,
	...
	var resource OutboundFirewallRule
	err := ctx.ReadResource("azure-native:sql/v20210801preview:OutboundFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
