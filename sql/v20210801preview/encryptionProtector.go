...
//
// Deprecated: azure-native:sql/v20210801preview:EncryptionProtector is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:EncryptionProtector to guarantee forwards compatibility.
...
func NewEncryptionProtector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210801preview:EncryptionProtector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEncryptionProtector(ctx *pulumi.Context,
	...
	var resource EncryptionProtector
	err := ctx.ReadResource("azure-native:sql/v20210801preview:EncryptionProtector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
