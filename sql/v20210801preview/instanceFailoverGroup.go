...
func NewInstanceFailoverGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210801preview:InstanceFailoverGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceFailoverGroup(ctx *pulumi.Context,
	...
	var resource InstanceFailoverGroup
	err := ctx.ReadResource("azure-native:sql/v20210801preview:InstanceFailoverGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
