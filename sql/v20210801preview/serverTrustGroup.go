...
func NewServerTrustGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210801preview:ServerTrustGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerTrustGroup(ctx *pulumi.Context,
	...
	var resource ServerTrustGroup
	err := ctx.ReadResource("azure-native:sql/v20210801preview:ServerTrustGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
