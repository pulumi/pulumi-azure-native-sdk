...
// A job.
//
// Deprecated: azure-native:sql/v20210801preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Job to guarantee forwards compatibility.
type Job struct {
