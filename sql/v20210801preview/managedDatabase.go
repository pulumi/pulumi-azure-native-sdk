...
func NewManagedDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210801preview:ManagedDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedDatabase(ctx *pulumi.Context,
	...
	var resource ManagedDatabase
	err := ctx.ReadResource("azure-native:sql/v20210801preview:ManagedDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
