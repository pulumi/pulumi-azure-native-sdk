...
//
// Deprecated: azure-native:sql/v20210801preview:ServerTrustGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerTrustGroup to guarantee forwards compatibility.
func LookupServerTrustGroup(ctx *pulumi.Context, args *LookupServerTrustGroupArgs, opts ...pulumi.InvokeOption) (*LookupServerTrustGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sql/v20210801preview:getServerTrustGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
