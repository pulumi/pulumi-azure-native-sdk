...
//
// Deprecated: azure-native:sql/v20210801preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncGroup to guarantee forwards compatibility.
