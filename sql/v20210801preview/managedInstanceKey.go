...
//
// Deprecated: azure-native:sql/v20210801preview:ManagedInstanceKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceKey to guarantee forwards compatibility.
...
func NewManagedInstanceKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sql/v20210801preview:ManagedInstanceKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedInstanceKey(ctx *pulumi.Context,
	...
	var resource ManagedInstanceKey
	err := ctx.ReadResource("azure-native:sql/v20210801preview:ManagedInstanceKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
