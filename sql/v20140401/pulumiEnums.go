...
// DatabaseEditionInput is an input type that accepts values of the DatabaseEdition enum
// A concrete instance of `DatabaseEditionInput` can be one of the following:
//
//	DatabaseEditionWeb
//	DatabaseEditionBusiness
//	DatabaseEditionBasic
//	DatabaseEditionStandard
//	DatabaseEditionPremium
//	DatabaseEditionPremiumRS
//	DatabaseEditionFree
//	DatabaseEditionStretch
//	DatabaseEditionDataWarehouse
//	DatabaseEditionSystem
//	DatabaseEditionSystem2
//	DatabaseEditionGeneralPurpose
//	DatabaseEditionBusinessCritical
//	DatabaseEditionHyperscale
...
// ElasticPoolEditionInput is an input type that accepts values of the ElasticPoolEdition enum
// A concrete instance of `ElasticPoolEditionInput` can be one of the following:
//
...
// ReadScaleInput is an input type that accepts values of the ReadScale enum
// A concrete instance of `ReadScaleInput` can be one of the following:
//
//	ReadScaleEnabled
//	ReadScaleDisabled
...
// ServiceObjectiveNameInput is an input type that accepts values of the ServiceObjectiveName enum
// A concrete instance of `ServiceObjectiveNameInput` can be one of the following:
//
