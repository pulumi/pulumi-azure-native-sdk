...
// StorageSkuNameInput is an input type that accepts values of the StorageSkuName enum
// A concrete instance of `StorageSkuNameInput` can be one of the following:
//
