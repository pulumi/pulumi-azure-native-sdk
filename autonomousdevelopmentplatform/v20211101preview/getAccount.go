...
func LookupAccount(ctx *pulumi.Context, args *LookupAccountArgs, opts ...pulumi.InvokeOption) (*LookupAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:autonomousdevelopmentplatform/v20211101preview:getAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAccountOutput(ctx *pulumi.Context, args LookupAccountOutputArgs, opts ...pulumi.InvokeOption) LookupAccountResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupAccountResultOutput, error) {
			...
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv LookupAccountResult
			secret, err := ctx.InvokePackageRaw("azure-native:autonomousdevelopmentplatform/v20211101preview:getAccount", args, &rv, "", opts...)
			if err != nil {
