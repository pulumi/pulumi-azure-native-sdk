...
// Get a msixpackage.
//
// Deprecated: azure-native:desktopvirtualization/v20210712:MSIXPackage is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:MSIXPackage to guarantee forwards compatibility.
func LookupMSIXPackage(ctx *pulumi.Context, args *LookupMSIXPackageArgs, opts ...pulumi.InvokeOption) (*LookupMSIXPackageResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20210712:getMSIXPackage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
