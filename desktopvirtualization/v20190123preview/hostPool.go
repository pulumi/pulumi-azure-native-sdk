...
// azure-native:desktopvirtualization/v20190123preview:HostPool is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20201102preview:HostPool to guarantee forwards compatibility.
...
func NewHostPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20190123preview:HostPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHostPool(ctx *pulumi.Context,
	...
	var resource HostPool
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20190123preview:HostPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
