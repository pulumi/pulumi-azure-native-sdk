...
func NewApplication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240306preview:Application"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240403:Application"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240408preview:Application"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:Application"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:Application"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:Application"),
		},
	})
