...
func NewScalingPlanPersonalSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20231101preview:ScalingPlanPersonalSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingPlanPersonalSchedule(ctx *pulumi.Context,
	...
	var resource ScalingPlanPersonalSchedule
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20231101preview:ScalingPlanPersonalSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
