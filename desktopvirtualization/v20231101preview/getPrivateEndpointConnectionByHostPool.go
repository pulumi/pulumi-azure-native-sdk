...
func LookupPrivateEndpointConnectionByHostPool(ctx *pulumi.Context, args *LookupPrivateEndpointConnectionByHostPoolArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointConnectionByHostPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20231101preview:getPrivateEndpointConnectionByHostPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateEndpointConnectionByHostPoolOutput(ctx *pulumi.Context, args LookupPrivateEndpointConnectionByHostPoolOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateEndpointConnectionByHostPoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateEndpointConnectionByHostPoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:desktopvirtualization/v20231101preview:getPrivateEndpointConnectionByHostPool", args, LookupPrivateEndpointConnectionByHostPoolResultOutput{}, options).(LookupPrivateEndpointConnectionByHostPoolResultOutput), nil
