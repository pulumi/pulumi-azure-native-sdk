...
func LookupPrivateEndpointConnectionByWorkspace(ctx *pulumi.Context, args *LookupPrivateEndpointConnectionByWorkspaceArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointConnectionByWorkspaceResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20231004preview:getPrivateEndpointConnectionByWorkspace", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateEndpointConnectionByWorkspaceOutput(ctx *pulumi.Context, args LookupPrivateEndpointConnectionByWorkspaceOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateEndpointConnectionByWorkspaceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateEndpointConnectionByWorkspaceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:desktopvirtualization/v20231004preview:getPrivateEndpointConnectionByWorkspace", args, LookupPrivateEndpointConnectionByWorkspaceResultOutput{}, options).(LookupPrivateEndpointConnectionByWorkspaceResultOutput), nil
