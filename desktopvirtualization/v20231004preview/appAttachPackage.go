...
func (i *AppAttachPackage) ToOutput(ctx context.Context) pulumix.Output[*AppAttachPackage] {
	return pulumix.Output[*AppAttachPackage]{
		OutputState: i.ToAppAttachPackageOutputWithContext(ctx).OutputState,
	}
}
...
func (o AppAttachPackageOutput) ToOutput(ctx context.Context) pulumix.Output[*AppAttachPackage] {
	return pulumix.Output[*AppAttachPackage]{
