...
func NewPrivateEndpointConnectionByHostPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20231004preview:PrivateEndpointConnectionByHostPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionByHostPool(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionByHostPool
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20231004preview:PrivateEndpointConnectionByHostPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
