...
func NewMSIXPackage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250301preview:MSIXPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250401preview:MSIXPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250801preview:MSIXPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250901preview:MSIXPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:MSIXPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251101preview:MSIXPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260101preview:MSIXPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:MSIXPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:MSIXPackage"),
		},
	})
