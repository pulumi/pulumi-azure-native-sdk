...
func LookupScalingPlan(ctx *pulumi.Context, args *LookupScalingPlanArgs, opts ...pulumi.InvokeOption) (*LookupScalingPlanResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20230905:getScalingPlan", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupScalingPlanOutput(ctx *pulumi.Context, args LookupScalingPlanOutputArgs, opts ...pulumi.InvokeOption) LookupScalingPlanResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScalingPlanResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:desktopvirtualization/v20230905:getScalingPlan", args, LookupScalingPlanResultOutput{}, options).(LookupScalingPlanResultOutput), nil
