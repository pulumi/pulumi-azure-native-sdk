...
type ScalingPlanPooledSchedule struct {
	...
	CreateDelete CreateDeletePropertiesResponsePtrOutput `pulumi:"createDelete"`
	...
	ScalingMethod pulumi.StringPtrOutput `pulumi:"scalingMethod"`
...
func NewScalingPlanPooledSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20241101preview:ScalingPlanPooledSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingPlanPooledSchedule(ctx *pulumi.Context,
	...
	var resource ScalingPlanPooledSchedule
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20241101preview:ScalingPlanPooledSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ScalingPlanPooledScheduleArgs struct {
	// The properties that control how Scaling will manage the size of the hostpool by creating and deleting hosts.
	CreateDelete CreateDeletePropertiesPtrInput
	// Set of days of the week on which this schedule is active.
	...
	// The desired scaling method to be used to scale the hosts in the assigned host pool.
	ScalingMethod pulumi.StringPtrInput
	// The name of the scaling plan.
...
// The properties that control how Scaling will manage the size of the hostpool by creating and deleting hosts.
func (o ScalingPlanPooledScheduleOutput) CreateDelete() CreateDeletePropertiesResponsePtrOutput {
	return o.ApplyT(func(v *ScalingPlanPooledSchedule) CreateDeletePropertiesResponsePtrOutput { return v.CreateDelete }).(CreateDeletePropertiesResponsePtrOutput)
}
...
// The desired scaling method to be used to scale the hosts in the assigned host pool.
func (o ScalingPlanPooledScheduleOutput) ScalingMethod() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ScalingPlanPooledSchedule) pulumi.StringPtrOutput { return v.ScalingMethod }).(pulumi.StringPtrOutput)
}
