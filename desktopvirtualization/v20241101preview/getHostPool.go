...
func LookupHostPool(ctx *pulumi.Context, args *LookupHostPoolArgs, opts ...pulumi.InvokeOption) (*LookupHostPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20241101preview:getHostPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHostPoolOutput(ctx *pulumi.Context, args LookupHostPoolOutputArgs, opts ...pulumi.InvokeOption) LookupHostPoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHostPoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:desktopvirtualization/v20241101preview:getHostPool", args, LookupHostPoolResultOutput{}, options).(LookupHostPoolResultOutput), nil
...
// Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
func (o LookupHostPoolResultOutput) DirectUDP() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupHostPoolResult) *string { return v.DirectUDP }).(pulumi.StringPtrOutput)
}
...
// Managed service identity (system assigned and/or user assigned identities)
func (o LookupHostPoolResultOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupHostPoolResult) *ManagedServiceIdentityResponse { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}
...
// Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
func (o LookupHostPoolResultOutput) ManagedPrivateUDP() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupHostPoolResult) *string { return v.ManagedPrivateUDP }).(pulumi.StringPtrOutput)
}

// The type of management for this hostpool, Automated or Standard. The default value is Automated.
func (o LookupHostPoolResultOutput) ManagementType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupHostPoolResult) *string { return v.ManagementType }).(pulumi.StringPtrOutput)
}
...
// Plan for the resource.
func (o LookupHostPoolResultOutput) Plan() PlanResponsePtrOutput {
	return o.ApplyT(func(v LookupHostPoolResult) *PlanResponse { return v.Plan }).(PlanResponsePtrOutput)
}
...
// Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
func (o LookupHostPoolResultOutput) PublicUDP() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupHostPoolResult) *string { return v.PublicUDP }).(pulumi.StringPtrOutput)
}
...
// Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
func (o LookupHostPoolResultOutput) RelayUDP() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupHostPoolResult) *string { return v.RelayUDP }).(pulumi.StringPtrOutput)
}
...
// The resource model definition representing SKU
func (o LookupHostPoolResultOutput) Sku() SkuResponsePtrOutput {
	return o.ApplyT(func(v LookupHostPoolResult) *SkuResponse { return v.Sku }).(SkuResponsePtrOutput)
}
