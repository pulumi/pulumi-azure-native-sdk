...
func (ScalingMethod) ElementType() reflect.Type {
	return reflect.TypeOf((*ScalingMethod)(nil)).Elem()
}

func (e ScalingMethod) ToScalingMethodOutput() ScalingMethodOutput {
	return pulumi.ToOutput(e).(ScalingMethodOutput)
}

func (e ScalingMethod) ToScalingMethodOutputWithContext(ctx context.Context) ScalingMethodOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ScalingMethodOutput)
}

func (e ScalingMethod) ToScalingMethodPtrOutput() ScalingMethodPtrOutput {
	return e.ToScalingMethodPtrOutputWithContext(context.Background())
}

func (e ScalingMethod) ToScalingMethodPtrOutputWithContext(ctx context.Context) ScalingMethodPtrOutput {
	return ScalingMethod(e).ToScalingMethodOutputWithContext(ctx).ToScalingMethodPtrOutputWithContext(ctx)
}

func (e ScalingMethod) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ScalingMethod) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ScalingMethod) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ScalingMethod) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type ScalingMethodOutput struct{ *pulumi.OutputState }

func (ScalingMethodOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ScalingMethod)(nil)).Elem()
}

func (o ScalingMethodOutput) ToScalingMethodOutput() ScalingMethodOutput {
	return o
}

func (o ScalingMethodOutput) ToScalingMethodOutputWithContext(ctx context.Context) ScalingMethodOutput {
	return o
}

func (o ScalingMethodOutput) ToScalingMethodPtrOutput() ScalingMethodPtrOutput {
	return o.ToScalingMethodPtrOutputWithContext(context.Background())
}

func (o ScalingMethodOutput) ToScalingMethodPtrOutputWithContext(ctx context.Context) ScalingMethodPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ScalingMethod) *ScalingMethod {
		return &v
	}).(ScalingMethodPtrOutput)
}

func (o ScalingMethodOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ScalingMethodOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ScalingMethod) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ScalingMethodOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ScalingMethodOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ScalingMethod) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type ScalingMethodPtrOutput struct{ *pulumi.OutputState }

func (ScalingMethodPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ScalingMethod)(nil)).Elem()
}

func (o ScalingMethodPtrOutput) ToScalingMethodPtrOutput() ScalingMethodPtrOutput {
	return o
}

func (o ScalingMethodPtrOutput) ToScalingMethodPtrOutputWithContext(ctx context.Context) ScalingMethodPtrOutput {
	return o
}

func (o ScalingMethodPtrOutput) Elem() ScalingMethodOutput {
	return o.ApplyT(func(v *ScalingMethod) ScalingMethod {
		if v != nil {
			return *v
		}
		var ret ScalingMethod
		return ret
	}).(ScalingMethodOutput)
}

func (o ScalingMethodPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ScalingMethodPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ScalingMethod) *string {
		if e == nil {
			return nil
		}
...
// ScalingMethodInput is an input type that accepts values of the ScalingMethod enum
// A concrete instance of `ScalingMethodInput` can be one of the following:
//
//	ScalingMethodPowerManage
//	ScalingMethodCreateDeletePowerManage
type ScalingMethodInput interface {
	pulumi.Input

	ToScalingMethodOutput() ScalingMethodOutput
	ToScalingMethodOutputWithContext(context.Context) ScalingMethodOutput
}

var scalingMethodPtrType = reflect.TypeOf((**ScalingMethod)(nil)).Elem()

type ScalingMethodPtrInput interface {
	pulumi.Input

	ToScalingMethodPtrOutput() ScalingMethodPtrOutput
	ToScalingMethodPtrOutputWithContext(context.Context) ScalingMethodPtrOutput
}

type scalingMethodPtr string

func ScalingMethodPtr(v string) ScalingMethodPtrInput {
	return (*scalingMethodPtr)(&v)
}

func (*scalingMethodPtr) ElementType() reflect.Type {
	return scalingMethodPtrType
}

func (in *scalingMethodPtr) ToScalingMethodPtrOutput() ScalingMethodPtrOutput {
	return pulumi.ToOutput(in).(ScalingMethodPtrOutput)
}

func (in *scalingMethodPtr) ToScalingMethodPtrOutputWithContext(ctx context.Context) ScalingMethodPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ScalingMethodPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ScalingMethodOutput{})
	pulumi.RegisterOutputType(ScalingMethodPtrOutput{})
