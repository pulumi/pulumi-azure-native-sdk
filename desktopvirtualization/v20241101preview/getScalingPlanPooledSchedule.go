...
func LookupScalingPlanPooledSchedule(ctx *pulumi.Context, args *LookupScalingPlanPooledScheduleArgs, opts ...pulumi.InvokeOption) (*LookupScalingPlanPooledScheduleResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20241101preview:getScalingPlanPooledSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupScalingPlanPooledScheduleOutput(ctx *pulumi.Context, args LookupScalingPlanPooledScheduleOutputArgs, opts ...pulumi.InvokeOption) LookupScalingPlanPooledScheduleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScalingPlanPooledScheduleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:desktopvirtualization/v20241101preview:getScalingPlanPooledSchedule", args, LookupScalingPlanPooledScheduleResultOutput{}, options).(LookupScalingPlanPooledScheduleResultOutput), nil
...
// The properties that control how Scaling will manage the size of the hostpool by creating and deleting hosts.
func (o LookupScalingPlanPooledScheduleResultOutput) CreateDelete() CreateDeletePropertiesResponsePtrOutput {
	return o.ApplyT(func(v LookupScalingPlanPooledScheduleResult) *CreateDeletePropertiesResponse { return v.CreateDelete }).(CreateDeletePropertiesResponsePtrOutput)
}
...
// Starting time for off-peak period.
func (o LookupScalingPlanPooledScheduleResultOutput) OffPeakStartTime() TimeResponseOutput {
	return o.ApplyT(func(v LookupScalingPlanPooledScheduleResult) TimeResponse { return v.OffPeakStartTime }).(TimeResponseOutput)
}
...
// Starting time for peak period.
func (o LookupScalingPlanPooledScheduleResultOutput) PeakStartTime() TimeResponseOutput {
	return o.ApplyT(func(v LookupScalingPlanPooledScheduleResult) TimeResponse { return v.PeakStartTime }).(TimeResponseOutput)
}

// Capacity threshold for ramp down period.
func (o LookupScalingPlanPooledScheduleResultOutput) RampDownCapacityThresholdPct() pulumi.IntOutput {
	return o.ApplyT(func(v LookupScalingPlanPooledScheduleResult) int { return v.RampDownCapacityThresholdPct }).(pulumi.IntOutput)
}
...
// Starting time for ramp down period.
func (o LookupScalingPlanPooledScheduleResultOutput) RampDownStartTime() TimeResponseOutput {
	return o.ApplyT(func(v LookupScalingPlanPooledScheduleResult) TimeResponse { return v.RampDownStartTime }).(TimeResponseOutput)
}
...
// Capacity threshold for ramp up period.
func (o LookupScalingPlanPooledScheduleResultOutput) RampUpCapacityThresholdPct() pulumi.IntOutput {
	return o.ApplyT(func(v LookupScalingPlanPooledScheduleResult) int { return v.RampUpCapacityThresholdPct }).(pulumi.IntOutput)
}
...
// Starting time for ramp up period.
func (o LookupScalingPlanPooledScheduleResultOutput) RampUpStartTime() TimeResponseOutput {
	return o.ApplyT(func(v LookupScalingPlanPooledScheduleResult) TimeResponse { return v.RampUpStartTime }).(TimeResponseOutput)
}

// The desired scaling method to be used to scale the hosts in the assigned host pool.
func (o LookupScalingPlanPooledScheduleResultOutput) ScalingMethod() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupScalingPlanPooledScheduleResult) *string { return v.ScalingMethod }).(pulumi.StringPtrOutput)
}
