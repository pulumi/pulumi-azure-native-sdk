...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AppAttachPackageOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *AppAttachPackage) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
