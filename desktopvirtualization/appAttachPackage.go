...
func NewAppAttachPackage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250301preview:AppAttachPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250401preview:AppAttachPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250801preview:AppAttachPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250901preview:AppAttachPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:AppAttachPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251101preview:AppAttachPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260101preview:AppAttachPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:AppAttachPackage"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:AppAttachPackage"),
		},
	})
...
// The Azure API version of the resource.
func (o AppAttachPackageOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AppAttachPackage) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
