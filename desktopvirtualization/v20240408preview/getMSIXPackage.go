...
func LookupMSIXPackage(ctx *pulumi.Context, args *LookupMSIXPackageArgs, opts ...pulumi.InvokeOption) (*LookupMSIXPackageResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20240408preview:getMSIXPackage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMSIXPackageOutput(ctx *pulumi.Context, args LookupMSIXPackageOutputArgs, opts ...pulumi.InvokeOption) LookupMSIXPackageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMSIXPackageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:desktopvirtualization/v20240408preview:getMSIXPackage", args, LookupMSIXPackageResultOutput{}, options).(LookupMSIXPackageResultOutput), nil
