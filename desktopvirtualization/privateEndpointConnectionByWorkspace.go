...
//
// Other available API versions: 2022-10-14-preview, 2023-09-05, 2023-10-04-preview, 2023-11-01-preview, 2024-01-16-preview, 2024-03-06-preview, 2024-04-08-preview, 2024-08-08-preview, 2024-11-01-preview, 2025-03-01-preview, 2025-04-01-preview, 2025-08-01-preview, 2025-09-01-preview, 2025-11-01-preview, 2026-01-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native desktopvirtualization [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
...
func NewPrivateEndpointConnectionByWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250801preview:PrivateEndpointConnectionByWorkspace"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250901preview:PrivateEndpointConnectionByWorkspace"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251101preview:PrivateEndpointConnectionByWorkspace"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260101preview:PrivateEndpointConnectionByWorkspace"),
		},
	})
...
// The private endpoint resource.
func (o PrivateEndpointConnectionByWorkspaceOutput) PrivateEndpoint() commontypesv5.PrivateEndpointResponsePtrOutput {
	return o.ApplyT(func(v *PrivateEndpointConnectionByWorkspace) commontypesv5.PrivateEndpointResponsePtrOutput {
		return v.PrivateEndpoint
	}).(commontypesv5.PrivateEndpointResponsePtrOutput)
}

// A collection of information about the state of the connection between service consumer and provider.
func (o PrivateEndpointConnectionByWorkspaceOutput) PrivateLinkServiceConnectionState() commontypesv5.PrivateLinkServiceConnectionStateResponseOutput {
	return o.ApplyT(func(v *PrivateEndpointConnectionByWorkspace) commontypesv5.PrivateLinkServiceConnectionStateResponseOutput {
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PrivateEndpointConnectionByWorkspaceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PrivateEndpointConnectionByWorkspace) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
