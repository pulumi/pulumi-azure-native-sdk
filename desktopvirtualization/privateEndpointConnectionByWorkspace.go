...
func NewPrivateEndpointConnectionByWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:PrivateEndpointConnectionByWorkspace"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:PrivateEndpointConnectionByWorkspace"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:PrivateEndpointConnectionByWorkspace"),
		},
	})
