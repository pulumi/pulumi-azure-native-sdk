...
func NewScalingPlanPooledSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250301preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250401preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250801preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250901preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251101preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260101preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:ScalingPlanPooledSchedule"),
		},
	})
