...
func NewHostPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20240403:HostPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHostPool(ctx *pulumi.Context,
	...
	var resource HostPool
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20240403:HostPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
