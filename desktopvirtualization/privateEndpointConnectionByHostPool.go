...
func NewPrivateEndpointConnectionByHostPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:PrivateEndpointConnectionByHostPool"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:PrivateEndpointConnectionByHostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:PrivateEndpointConnectionByHostPool"),
		},
	})
