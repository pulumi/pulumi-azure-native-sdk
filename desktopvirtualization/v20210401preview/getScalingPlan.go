...
// Get a scaling plan.
//
// Deprecated: azure-native:desktopvirtualization/v20210401preview:ScalingPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20220210preview:ScalingPlan to guarantee forwards compatibility.
func LookupScalingPlan(ctx *pulumi.Context, args *LookupScalingPlanArgs, opts ...pulumi.InvokeOption) (*LookupScalingPlanResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20210401preview:getScalingPlan", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
