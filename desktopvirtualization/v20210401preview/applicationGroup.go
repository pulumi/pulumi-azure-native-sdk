...
//
// Deprecated: azure-native:desktopvirtualization/v20210401preview:ApplicationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20220401preview:ApplicationGroup to guarantee forwards compatibility.
...
func NewApplicationGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20210401preview:ApplicationGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGroup(ctx *pulumi.Context,
	...
	var resource ApplicationGroup
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20210401preview:ApplicationGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
