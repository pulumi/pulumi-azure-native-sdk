...
func NewScalingPlanPersonalSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250301preview:ScalingPlanPersonalSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250401preview:ScalingPlanPersonalSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250801preview:ScalingPlanPersonalSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250901preview:ScalingPlanPersonalSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:ScalingPlanPersonalSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251101preview:ScalingPlanPersonalSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260101preview:ScalingPlanPersonalSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:ScalingPlanPersonalSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:ScalingPlanPersonalSchedule"),
		},
	})
