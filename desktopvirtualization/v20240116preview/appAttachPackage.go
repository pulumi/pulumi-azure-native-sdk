...
func NewAppAttachPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20240116preview:AppAttachPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppAttachPackage(ctx *pulumi.Context,
	...
	var resource AppAttachPackage
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20240116preview:AppAttachPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
