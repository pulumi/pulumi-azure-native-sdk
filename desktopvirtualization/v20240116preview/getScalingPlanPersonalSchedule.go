...
func LookupScalingPlanPersonalSchedule(ctx *pulumi.Context, args *LookupScalingPlanPersonalScheduleArgs, opts ...pulumi.InvokeOption) (*LookupScalingPlanPersonalScheduleResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20240116preview:getScalingPlanPersonalSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupScalingPlanPersonalScheduleOutput(ctx *pulumi.Context, args LookupScalingPlanPersonalScheduleOutputArgs, opts ...pulumi.InvokeOption) LookupScalingPlanPersonalScheduleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScalingPlanPersonalScheduleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:desktopvirtualization/v20240116preview:getScalingPlanPersonalSchedule", args, LookupScalingPlanPersonalScheduleResultOutput{}, options).(LookupScalingPlanPersonalScheduleResultOutput), nil
