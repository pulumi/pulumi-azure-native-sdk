...
func NewMSIXPackage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240403:MSIXPackage"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MSIXPackage
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20240116preview:MSIXPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMSIXPackage(ctx *pulumi.Context,
	...
	var resource MSIXPackage
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20240116preview:MSIXPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
