...
func NewHostPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:HostPool"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:HostPool"),
		},
	})
