...
type HostPool struct {
	...
	AppAttachPackageReferences pulumi.StringArrayOutput `pulumi:"appAttachPackageReferences"`
...
func NewHostPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20231004preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20231101preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240116preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240306preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240403:HostPool"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250301preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250401preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250801preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20250901preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251101preview:HostPool"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260101preview:HostPool"),
		},
	})
...
// List of App Attach Package links.
func (o HostPoolOutput) AppAttachPackageReferences() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *HostPool) pulumi.StringArrayOutput { return v.AppAttachPackageReferences }).(pulumi.StringArrayOutput)
}
...
// The Azure API version of the resource.
func (o HostPoolOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *HostPool) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
func (o HostPoolOutput) Identity() commontypesv5.ResourceModelWithAllowedPropertySetResponseIdentityPtrOutput {
	return o.ApplyT(func(v *HostPool) commontypesv5.ResourceModelWithAllowedPropertySetResponseIdentityPtrOutput {
		return v.Identity
...
func (o HostPoolOutput) Plan() commontypesv5.ResourceModelWithAllowedPropertySetResponsePlanPtrOutput {
	return o.ApplyT(func(v *HostPool) commontypesv5.ResourceModelWithAllowedPropertySetResponsePlanPtrOutput {
		return v.Plan
...
// List of private endpoint connection associated with the specified resource
func (o HostPoolOutput) PrivateEndpointConnections() commontypesv5.PrivateEndpointConnectionResponseArrayOutput {
	return o.ApplyT(func(v *HostPool) commontypesv5.PrivateEndpointConnectionResponseArrayOutput {
...
func (o HostPoolOutput) Sku() commontypesv5.ResourceModelWithAllowedPropertySetResponseSkuPtrOutput {
	return o.ApplyT(func(v *HostPool) commontypesv5.ResourceModelWithAllowedPropertySetResponseSkuPtrOutput { return v.Sku }).(commontypesv5.ResourceModelWithAllowedPropertySetResponseSkuPtrOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o HostPoolOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *HostPool) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
