...
//
// Deprecated: azure-native:desktopvirtualization/v20210309preview:MSIXPackage is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:MSIXPackage to guarantee forwards compatibility.
...
func NewMSIXPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20210309preview:MSIXPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMSIXPackage(ctx *pulumi.Context,
	...
	var resource MSIXPackage
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20210309preview:MSIXPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
