...
func NewWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20231101preview:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240116preview:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240306preview:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240403:Workspace"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20251010:Workspace"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260301preview:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20260401preview:Workspace"),
		},
	})
