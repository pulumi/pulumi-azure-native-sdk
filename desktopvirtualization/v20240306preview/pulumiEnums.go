...
func (DirectUDP) ElementType() reflect.Type {
	return reflect.TypeOf((*DirectUDP)(nil)).Elem()
}

func (e DirectUDP) ToDirectUDPOutput() DirectUDPOutput {
	return pulumi.ToOutput(e).(DirectUDPOutput)
}

func (e DirectUDP) ToDirectUDPOutputWithContext(ctx context.Context) DirectUDPOutput {
	return pulumi.ToOutputWithContext(ctx, e).(DirectUDPOutput)
}

func (e DirectUDP) ToDirectUDPPtrOutput() DirectUDPPtrOutput {
	return e.ToDirectUDPPtrOutputWithContext(context.Background())
}

func (e DirectUDP) ToDirectUDPPtrOutputWithContext(ctx context.Context) DirectUDPPtrOutput {
	return DirectUDP(e).ToDirectUDPOutputWithContext(ctx).ToDirectUDPPtrOutputWithContext(ctx)
}

func (e DirectUDP) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e DirectUDP) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e DirectUDP) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e DirectUDP) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type DirectUDPOutput struct{ *pulumi.OutputState }

func (DirectUDPOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DirectUDP)(nil)).Elem()
}

func (o DirectUDPOutput) ToDirectUDPOutput() DirectUDPOutput {
	return o
}

func (o DirectUDPOutput) ToDirectUDPOutputWithContext(ctx context.Context) DirectUDPOutput {
	return o
}

func (o DirectUDPOutput) ToDirectUDPPtrOutput() DirectUDPPtrOutput {
	return o.ToDirectUDPPtrOutputWithContext(context.Background())
}

func (o DirectUDPOutput) ToDirectUDPPtrOutputWithContext(ctx context.Context) DirectUDPPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v DirectUDP) *DirectUDP {
		return &v
	}).(DirectUDPPtrOutput)
}

func (o DirectUDPOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o DirectUDPOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DirectUDP) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o DirectUDPOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DirectUDPOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DirectUDP) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type DirectUDPPtrOutput struct{ *pulumi.OutputState }

func (DirectUDPPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DirectUDP)(nil)).Elem()
}

func (o DirectUDPPtrOutput) ToDirectUDPPtrOutput() DirectUDPPtrOutput {
	return o
}

func (o DirectUDPPtrOutput) ToDirectUDPPtrOutputWithContext(ctx context.Context) DirectUDPPtrOutput {
	return o
}

func (o DirectUDPPtrOutput) Elem() DirectUDPOutput {
	return o.ApplyT(func(v *DirectUDP) DirectUDP {
		if v != nil {
			return *v
		}
		var ret DirectUDP
...
func (o DirectUDPPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DirectUDPPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *DirectUDP) *string {
		if e == nil {
			return nil
		}
...
// DirectUDPInput is an input type that accepts values of the DirectUDP enum
// A concrete instance of `DirectUDPInput` can be one of the following:
//
//	DirectUDPDefault
//	DirectUDPEnabled
//	DirectUDPDisabled
type DirectUDPInput interface {
	pulumi.Input

	ToDirectUDPOutput() DirectUDPOutput
	ToDirectUDPOutputWithContext(context.Context) DirectUDPOutput
}

var directUDPPtrType = reflect.TypeOf((**DirectUDP)(nil)).Elem()

type DirectUDPPtrInput interface {
	pulumi.Input

	ToDirectUDPPtrOutput() DirectUDPPtrOutput
	ToDirectUDPPtrOutputWithContext(context.Context) DirectUDPPtrOutput
}

type directUDPPtr string

func DirectUDPPtr(v string) DirectUDPPtrInput {
	return (*directUDPPtr)(&v)
}

func (*directUDPPtr) ElementType() reflect.Type {
	return directUDPPtrType
}

func (in *directUDPPtr) ToDirectUDPPtrOutput() DirectUDPPtrOutput {
	return pulumi.ToOutput(in).(DirectUDPPtrOutput)
}

func (in *directUDPPtr) ToDirectUDPPtrOutputWithContext(ctx context.Context) DirectUDPPtrOutput {
...
func (ManagedPrivateUDP) ElementType() reflect.Type {
	return reflect.TypeOf((*ManagedPrivateUDP)(nil)).Elem()
}

func (e ManagedPrivateUDP) ToManagedPrivateUDPOutput() ManagedPrivateUDPOutput {
	return pulumi.ToOutput(e).(ManagedPrivateUDPOutput)
}

func (e ManagedPrivateUDP) ToManagedPrivateUDPOutputWithContext(ctx context.Context) ManagedPrivateUDPOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ManagedPrivateUDPOutput)
}

func (e ManagedPrivateUDP) ToManagedPrivateUDPPtrOutput() ManagedPrivateUDPPtrOutput {
	return e.ToManagedPrivateUDPPtrOutputWithContext(context.Background())
}

func (e ManagedPrivateUDP) ToManagedPrivateUDPPtrOutputWithContext(ctx context.Context) ManagedPrivateUDPPtrOutput {
	return ManagedPrivateUDP(e).ToManagedPrivateUDPOutputWithContext(ctx).ToManagedPrivateUDPPtrOutputWithContext(ctx)
}

func (e ManagedPrivateUDP) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ManagedPrivateUDP) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ManagedPrivateUDP) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ManagedPrivateUDP) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type ManagedPrivateUDPOutput struct{ *pulumi.OutputState }

func (ManagedPrivateUDPOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ManagedPrivateUDP)(nil)).Elem()
}

func (o ManagedPrivateUDPOutput) ToManagedPrivateUDPOutput() ManagedPrivateUDPOutput {
	return o
}

func (o ManagedPrivateUDPOutput) ToManagedPrivateUDPOutputWithContext(ctx context.Context) ManagedPrivateUDPOutput {
	return o
}

func (o ManagedPrivateUDPOutput) ToManagedPrivateUDPPtrOutput() ManagedPrivateUDPPtrOutput {
	return o.ToManagedPrivateUDPPtrOutputWithContext(context.Background())
}

func (o ManagedPrivateUDPOutput) ToManagedPrivateUDPPtrOutputWithContext(ctx context.Context) ManagedPrivateUDPPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ManagedPrivateUDP) *ManagedPrivateUDP {
		return &v
	}).(ManagedPrivateUDPPtrOutput)
}

func (o ManagedPrivateUDPOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ManagedPrivateUDPOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ManagedPrivateUDP) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ManagedPrivateUDPOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ManagedPrivateUDPOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ManagedPrivateUDP) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type ManagedPrivateUDPPtrOutput struct{ *pulumi.OutputState }

func (ManagedPrivateUDPPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ManagedPrivateUDP)(nil)).Elem()
}

func (o ManagedPrivateUDPPtrOutput) ToManagedPrivateUDPPtrOutput() ManagedPrivateUDPPtrOutput {
	return o
}

func (o ManagedPrivateUDPPtrOutput) ToManagedPrivateUDPPtrOutputWithContext(ctx context.Context) ManagedPrivateUDPPtrOutput {
	return o
}

func (o ManagedPrivateUDPPtrOutput) Elem() ManagedPrivateUDPOutput {
	return o.ApplyT(func(v *ManagedPrivateUDP) ManagedPrivateUDP {
		if v != nil {
			return *v
		}
		var ret ManagedPrivateUDP
		return ret
	}).(ManagedPrivateUDPOutput)
}

func (o ManagedPrivateUDPPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ManagedPrivateUDPPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ManagedPrivateUDP) *string {
		if e == nil {
			return nil
		}
...
// ManagedPrivateUDPInput is an input type that accepts values of the ManagedPrivateUDP enum
// A concrete instance of `ManagedPrivateUDPInput` can be one of the following:
//
//	ManagedPrivateUDPDefault
//	ManagedPrivateUDPEnabled
//	ManagedPrivateUDPDisabled
type ManagedPrivateUDPInput interface {
	pulumi.Input

	ToManagedPrivateUDPOutput() ManagedPrivateUDPOutput
	ToManagedPrivateUDPOutputWithContext(context.Context) ManagedPrivateUDPOutput
}

var managedPrivateUDPPtrType = reflect.TypeOf((**ManagedPrivateUDP)(nil)).Elem()

type ManagedPrivateUDPPtrInput interface {
	pulumi.Input

	ToManagedPrivateUDPPtrOutput() ManagedPrivateUDPPtrOutput
	ToManagedPrivateUDPPtrOutputWithContext(context.Context) ManagedPrivateUDPPtrOutput
}

type managedPrivateUDPPtr string

func ManagedPrivateUDPPtr(v string) ManagedPrivateUDPPtrInput {
	return (*managedPrivateUDPPtr)(&v)
}

func (*managedPrivateUDPPtr) ElementType() reflect.Type {
	return managedPrivateUDPPtrType
}

func (in *managedPrivateUDPPtr) ToManagedPrivateUDPPtrOutput() ManagedPrivateUDPPtrOutput {
	return pulumi.ToOutput(in).(ManagedPrivateUDPPtrOutput)
}

func (in *managedPrivateUDPPtr) ToManagedPrivateUDPPtrOutputWithContext(ctx context.Context) ManagedPrivateUDPPtrOutput {
...
func (PublicUDP) ElementType() reflect.Type {
	return reflect.TypeOf((*PublicUDP)(nil)).Elem()
}

func (e PublicUDP) ToPublicUDPOutput() PublicUDPOutput {
	return pulumi.ToOutput(e).(PublicUDPOutput)
}

func (e PublicUDP) ToPublicUDPOutputWithContext(ctx context.Context) PublicUDPOutput {
	return pulumi.ToOutputWithContext(ctx, e).(PublicUDPOutput)
}

func (e PublicUDP) ToPublicUDPPtrOutput() PublicUDPPtrOutput {
	return e.ToPublicUDPPtrOutputWithContext(context.Background())
}

func (e PublicUDP) ToPublicUDPPtrOutputWithContext(ctx context.Context) PublicUDPPtrOutput {
	return PublicUDP(e).ToPublicUDPOutputWithContext(ctx).ToPublicUDPPtrOutputWithContext(ctx)
}

func (e PublicUDP) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e PublicUDP) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e PublicUDP) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e PublicUDP) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type PublicUDPOutput struct{ *pulumi.OutputState }

func (PublicUDPOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PublicUDP)(nil)).Elem()
}

func (o PublicUDPOutput) ToPublicUDPOutput() PublicUDPOutput {
	return o
}

func (o PublicUDPOutput) ToPublicUDPOutputWithContext(ctx context.Context) PublicUDPOutput {
	return o
}

func (o PublicUDPOutput) ToPublicUDPPtrOutput() PublicUDPPtrOutput {
	return o.ToPublicUDPPtrOutputWithContext(context.Background())
}

func (o PublicUDPOutput) ToPublicUDPPtrOutputWithContext(ctx context.Context) PublicUDPPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v PublicUDP) *PublicUDP {
		return &v
	}).(PublicUDPPtrOutput)
}

func (o PublicUDPOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o PublicUDPOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PublicUDP) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o PublicUDPOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o PublicUDPOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PublicUDP) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type PublicUDPPtrOutput struct{ *pulumi.OutputState }

func (PublicUDPPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PublicUDP)(nil)).Elem()
}

func (o PublicUDPPtrOutput) ToPublicUDPPtrOutput() PublicUDPPtrOutput {
	return o
}

func (o PublicUDPPtrOutput) ToPublicUDPPtrOutputWithContext(ctx context.Context) PublicUDPPtrOutput {
	return o
}

func (o PublicUDPPtrOutput) Elem() PublicUDPOutput {
	return o.ApplyT(func(v *PublicUDP) PublicUDP {
		if v != nil {
			return *v
		}
		var ret PublicUDP
...
func (o PublicUDPPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o PublicUDPPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *PublicUDP) *string {
		if e == nil {
			return nil
		}
...
// PublicUDPInput is an input type that accepts values of the PublicUDP enum
// A concrete instance of `PublicUDPInput` can be one of the following:
//
//	PublicUDPDefault
//	PublicUDPEnabled
//	PublicUDPDisabled
type PublicUDPInput interface {
	pulumi.Input

	ToPublicUDPOutput() PublicUDPOutput
	ToPublicUDPOutputWithContext(context.Context) PublicUDPOutput
}

var publicUDPPtrType = reflect.TypeOf((**PublicUDP)(nil)).Elem()

type PublicUDPPtrInput interface {
	pulumi.Input

	ToPublicUDPPtrOutput() PublicUDPPtrOutput
	ToPublicUDPPtrOutputWithContext(context.Context) PublicUDPPtrOutput
}

type publicUDPPtr string

func PublicUDPPtr(v string) PublicUDPPtrInput {
	return (*publicUDPPtr)(&v)
}

func (*publicUDPPtr) ElementType() reflect.Type {
	return publicUDPPtrType
}

func (in *publicUDPPtr) ToPublicUDPPtrOutput() PublicUDPPtrOutput {
	return pulumi.ToOutput(in).(PublicUDPPtrOutput)
}

func (in *publicUDPPtr) ToPublicUDPPtrOutputWithContext(ctx context.Context) PublicUDPPtrOutput {
...
func (RelayUDP) ElementType() reflect.Type {
	return reflect.TypeOf((*RelayUDP)(nil)).Elem()
}

func (e RelayUDP) ToRelayUDPOutput() RelayUDPOutput {
	return pulumi.ToOutput(e).(RelayUDPOutput)
}

func (e RelayUDP) ToRelayUDPOutputWithContext(ctx context.Context) RelayUDPOutput {
	return pulumi.ToOutputWithContext(ctx, e).(RelayUDPOutput)
}

func (e RelayUDP) ToRelayUDPPtrOutput() RelayUDPPtrOutput {
	return e.ToRelayUDPPtrOutputWithContext(context.Background())
}

func (e RelayUDP) ToRelayUDPPtrOutputWithContext(ctx context.Context) RelayUDPPtrOutput {
	return RelayUDP(e).ToRelayUDPOutputWithContext(ctx).ToRelayUDPPtrOutputWithContext(ctx)
}

func (e RelayUDP) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e RelayUDP) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e RelayUDP) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e RelayUDP) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type RelayUDPOutput struct{ *pulumi.OutputState }

func (RelayUDPOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RelayUDP)(nil)).Elem()
}

func (o RelayUDPOutput) ToRelayUDPOutput() RelayUDPOutput {
	return o
}

func (o RelayUDPOutput) ToRelayUDPOutputWithContext(ctx context.Context) RelayUDPOutput {
	return o
}

func (o RelayUDPOutput) ToRelayUDPPtrOutput() RelayUDPPtrOutput {
	return o.ToRelayUDPPtrOutputWithContext(context.Background())
}

func (o RelayUDPOutput) ToRelayUDPPtrOutputWithContext(ctx context.Context) RelayUDPPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v RelayUDP) *RelayUDP {
		return &v
	}).(RelayUDPPtrOutput)
}

func (o RelayUDPOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o RelayUDPOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e RelayUDP) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o RelayUDPOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o RelayUDPOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e RelayUDP) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type RelayUDPPtrOutput struct{ *pulumi.OutputState }

func (RelayUDPPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**RelayUDP)(nil)).Elem()
}

func (o RelayUDPPtrOutput) ToRelayUDPPtrOutput() RelayUDPPtrOutput {
	return o
}

func (o RelayUDPPtrOutput) ToRelayUDPPtrOutputWithContext(ctx context.Context) RelayUDPPtrOutput {
	return o
}

func (o RelayUDPPtrOutput) Elem() RelayUDPOutput {
	return o.ApplyT(func(v *RelayUDP) RelayUDP {
		if v != nil {
			return *v
		}
		var ret RelayUDP
...
func (o RelayUDPPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o RelayUDPPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *RelayUDP) *string {
		if e == nil {
			return nil
		}
...
// RelayUDPInput is an input type that accepts values of the RelayUDP enum
// A concrete instance of `RelayUDPInput` can be one of the following:
//
//	RelayUDPDefault
//	RelayUDPEnabled
//	RelayUDPDisabled
type RelayUDPInput interface {
	pulumi.Input

	ToRelayUDPOutput() RelayUDPOutput
	ToRelayUDPOutputWithContext(context.Context) RelayUDPOutput
}

var relayUDPPtrType = reflect.TypeOf((**RelayUDP)(nil)).Elem()

type RelayUDPPtrInput interface {
	pulumi.Input

	ToRelayUDPPtrOutput() RelayUDPPtrOutput
	ToRelayUDPPtrOutputWithContext(context.Context) RelayUDPPtrOutput
}

type relayUDPPtr string

func RelayUDPPtr(v string) RelayUDPPtrInput {
	return (*relayUDPPtr)(&v)
}

func (*relayUDPPtr) ElementType() reflect.Type {
	return relayUDPPtrType
}

func (in *relayUDPPtr) ToRelayUDPPtrOutput() RelayUDPPtrOutput {
	return pulumi.ToOutput(in).(RelayUDPPtrOutput)
}

func (in *relayUDPPtr) ToRelayUDPPtrOutputWithContext(ctx context.Context) RelayUDPPtrOutput {
...
func init() {
	...
	pulumi.RegisterOutputType(ManagedPrivateUDPOutput{})
	pulumi.RegisterOutputType(ManagedPrivateUDPPtrOutput{})
	...
	pulumi.RegisterOutputType(PublicUDPOutput{})
	pulumi.RegisterOutputType(PublicUDPPtrOutput{})
	pulumi.RegisterOutputType(RegistrationTokenOperationOutput{})
	pulumi.RegisterOutputType(RegistrationTokenOperationPtrOutput{})
	pulumi.RegisterOutputType(RelayUDPOutput{})
	pulumi.RegisterOutputType(RelayUDPPtrOutput{})
