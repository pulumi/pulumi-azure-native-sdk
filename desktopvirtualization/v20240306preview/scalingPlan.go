...
func NewScalingPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20240306preview:ScalingPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingPlan(ctx *pulumi.Context,
	...
	var resource ScalingPlan
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20240306preview:ScalingPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
