...
type ScalingPlanPooledSchedule struct {
	...
	OffPeakStartTime TimeResponseOutput `pulumi:"offPeakStartTime"`
	// Load balancing algorithm for peak period.
	PeakLoadBalancingAlgorithm pulumi.StringPtrOutput `pulumi:"peakLoadBalancingAlgorithm"`
	// Starting time for peak period.
	PeakStartTime TimeResponseOutput `pulumi:"peakStartTime"`
	// Capacity threshold for ramp down period.
	RampDownCapacityThresholdPct pulumi.IntOutput `pulumi:"rampDownCapacityThresholdPct"`
	...
	RampDownStartTime TimeResponseOutput `pulumi:"rampDownStartTime"`
	...
	RampUpCapacityThresholdPct pulumi.IntOutput `pulumi:"rampUpCapacityThresholdPct"`
	...
	RampUpStartTime TimeResponseOutput `pulumi:"rampUpStartTime"`
...
func NewScalingPlanPooledSchedule(ctx *pulumi.Context,
	...
	if args.DaysOfWeek == nil {
		return nil, errors.New("invalid value for required argument 'DaysOfWeek'")
	}
	if args.OffPeakStartTime == nil {
		return nil, errors.New("invalid value for required argument 'OffPeakStartTime'")
	}
	if args.PeakStartTime == nil {
		return nil, errors.New("invalid value for required argument 'PeakStartTime'")
	}
	if args.RampDownCapacityThresholdPct == nil {
		return nil, errors.New("invalid value for required argument 'RampDownCapacityThresholdPct'")
	}
	if args.RampDownStartTime == nil {
		return nil, errors.New("invalid value for required argument 'RampDownStartTime'")
	}
	if args.RampUpCapacityThresholdPct == nil {
		return nil, errors.New("invalid value for required argument 'RampUpCapacityThresholdPct'")
	}
	if args.RampUpStartTime == nil {
		return nil, errors.New("invalid value for required argument 'RampUpStartTime'")
	}
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240116preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240306preview:ScalingPlanPooledSchedule"),
		},
		{
			Type: pulumi.String("azure-native:desktopvirtualization/v20240403:ScalingPlanPooledSchedule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:desktopvirtualization/v20240808preview:ScalingPlanPooledSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingPlanPooledSchedule(ctx *pulumi.Context,
	...
	var resource ScalingPlanPooledSchedule
	err := ctx.ReadResource("azure-native:desktopvirtualization/v20240808preview:ScalingPlanPooledSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ScalingPlanPooledScheduleArgs struct {
	...
	// Starting time for off-peak period.
	OffPeakStartTime TimeInput
	// Load balancing algorithm for peak period.
	PeakLoadBalancingAlgorithm pulumi.StringPtrInput
	// Starting time for peak period.
	PeakStartTime TimeInput
	// Capacity threshold for ramp down period.
	RampDownCapacityThresholdPct pulumi.IntInput
	// Should users be logged off forcefully from hosts.
...
// Starting time for off-peak period.
func (o ScalingPlanPooledScheduleOutput) OffPeakStartTime() TimeResponseOutput {
	return o.ApplyT(func(v *ScalingPlanPooledSchedule) TimeResponseOutput { return v.OffPeakStartTime }).(TimeResponseOutput)
}
...
// Starting time for peak period.
func (o ScalingPlanPooledScheduleOutput) PeakStartTime() TimeResponseOutput {
	return o.ApplyT(func(v *ScalingPlanPooledSchedule) TimeResponseOutput { return v.PeakStartTime }).(TimeResponseOutput)
}

// Capacity threshold for ramp down period.
func (o ScalingPlanPooledScheduleOutput) RampDownCapacityThresholdPct() pulumi.IntOutput {
	return o.ApplyT(func(v *ScalingPlanPooledSchedule) pulumi.IntOutput { return v.RampDownCapacityThresholdPct }).(pulumi.IntOutput)
}
...
// Starting time for ramp down period.
func (o ScalingPlanPooledScheduleOutput) RampDownStartTime() TimeResponseOutput {
	return o.ApplyT(func(v *ScalingPlanPooledSchedule) TimeResponseOutput { return v.RampDownStartTime }).(TimeResponseOutput)
}
...
// Capacity threshold for ramp up period.
func (o ScalingPlanPooledScheduleOutput) RampUpCapacityThresholdPct() pulumi.IntOutput {
	return o.ApplyT(func(v *ScalingPlanPooledSchedule) pulumi.IntOutput { return v.RampUpCapacityThresholdPct }).(pulumi.IntOutput)
}
...
// Starting time for ramp up period.
func (o ScalingPlanPooledScheduleOutput) RampUpStartTime() TimeResponseOutput {
	return o.ApplyT(func(v *ScalingPlanPooledSchedule) TimeResponseOutput { return v.RampUpStartTime }).(TimeResponseOutput)
}
