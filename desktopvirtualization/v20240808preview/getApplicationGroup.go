...
func LookupApplicationGroup(ctx *pulumi.Context, args *LookupApplicationGroupArgs, opts ...pulumi.InvokeOption) (*LookupApplicationGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:desktopvirtualization/v20240808preview:getApplicationGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApplicationGroupOutput(ctx *pulumi.Context, args LookupApplicationGroupOutputArgs, opts ...pulumi.InvokeOption) LookupApplicationGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApplicationGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:desktopvirtualization/v20240808preview:getApplicationGroup", args, LookupApplicationGroupResultOutput{}, options).(LookupApplicationGroupResultOutput), nil
...
// The managed service identities assigned to this resource.
func (o LookupApplicationGroupResultOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupApplicationGroupResult) *ManagedServiceIdentityResponse { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}
...
// Details of the resource plan.
func (o LookupApplicationGroupResultOutput) Plan() PlanResponsePtrOutput {
	return o.ApplyT(func(v LookupApplicationGroupResult) *PlanResponse { return v.Plan }).(PlanResponsePtrOutput)
}
...
// The SKU (Stock Keeping Unit) assigned to this resource.
func (o LookupApplicationGroupResultOutput) Sku() SkuResponsePtrOutput {
	return o.ApplyT(func(v LookupApplicationGroupResult) *SkuResponse { return v.Sku }).(SkuResponsePtrOutput)
}
