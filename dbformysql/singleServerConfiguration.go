...
func NewSingleServerConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20171201:SingleServerConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20171201preview:SingleServerConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20180601privatepreview:SingleServerConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SingleServerConfiguration
	err := ctx.RegisterResource("azure-native:dbformysql:SingleServerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSingleServerConfiguration(ctx *pulumi.Context,
	...
	var resource SingleServerConfiguration
	err := ctx.ReadResource("azure-native:dbformysql:SingleServerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
