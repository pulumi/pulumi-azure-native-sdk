...
func NewDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20241201preview:Database"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20241230:Database"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20250601preview:Database"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DatabaseOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Database) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
