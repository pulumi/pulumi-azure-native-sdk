...
func (PatchStrategy) ElementType() reflect.Type {
	return reflect.TypeOf((*PatchStrategy)(nil)).Elem()
}

func (e PatchStrategy) ToPatchStrategyOutput() PatchStrategyOutput {
	return pulumi.ToOutput(e).(PatchStrategyOutput)
}

func (e PatchStrategy) ToPatchStrategyOutputWithContext(ctx context.Context) PatchStrategyOutput {
	return pulumi.ToOutputWithContext(ctx, e).(PatchStrategyOutput)
}

func (e PatchStrategy) ToPatchStrategyPtrOutput() PatchStrategyPtrOutput {
	return e.ToPatchStrategyPtrOutputWithContext(context.Background())
}

func (e PatchStrategy) ToPatchStrategyPtrOutputWithContext(ctx context.Context) PatchStrategyPtrOutput {
	return PatchStrategy(e).ToPatchStrategyOutputWithContext(ctx).ToPatchStrategyPtrOutputWithContext(ctx)
}

func (e PatchStrategy) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e PatchStrategy) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e PatchStrategy) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e PatchStrategy) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type PatchStrategyOutput struct{ *pulumi.OutputState }

func (PatchStrategyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PatchStrategy)(nil)).Elem()
}

func (o PatchStrategyOutput) ToPatchStrategyOutput() PatchStrategyOutput {
	return o
}

func (o PatchStrategyOutput) ToPatchStrategyOutputWithContext(ctx context.Context) PatchStrategyOutput {
	return o
}

func (o PatchStrategyOutput) ToPatchStrategyPtrOutput() PatchStrategyPtrOutput {
	return o.ToPatchStrategyPtrOutputWithContext(context.Background())
}

func (o PatchStrategyOutput) ToPatchStrategyPtrOutputWithContext(ctx context.Context) PatchStrategyPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v PatchStrategy) *PatchStrategy {
		return &v
	}).(PatchStrategyPtrOutput)
}

func (o PatchStrategyOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o PatchStrategyOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PatchStrategy) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o PatchStrategyOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o PatchStrategyOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PatchStrategy) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type PatchStrategyPtrOutput struct{ *pulumi.OutputState }

func (PatchStrategyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PatchStrategy)(nil)).Elem()
}

func (o PatchStrategyPtrOutput) ToPatchStrategyPtrOutput() PatchStrategyPtrOutput {
	return o
}

func (o PatchStrategyPtrOutput) ToPatchStrategyPtrOutputWithContext(ctx context.Context) PatchStrategyPtrOutput {
	return o
}

func (o PatchStrategyPtrOutput) Elem() PatchStrategyOutput {
	return o.ApplyT(func(v *PatchStrategy) PatchStrategy {
		if v != nil {
			return *v
		}
		var ret PatchStrategy
		return ret
	}).(PatchStrategyOutput)
}

func (o PatchStrategyPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o PatchStrategyPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *PatchStrategy) *string {
		if e == nil {
			return nil
		}
...
// PatchStrategyInput is an input type that accepts values of the PatchStrategy enum
// A concrete instance of `PatchStrategyInput` can be one of the following:
//
//	PatchStrategyRegular
//	PatchStrategyVirtualCanary
type PatchStrategyInput interface {
	pulumi.Input

	ToPatchStrategyOutput() PatchStrategyOutput
	ToPatchStrategyOutputWithContext(context.Context) PatchStrategyOutput
}

var patchStrategyPtrType = reflect.TypeOf((**PatchStrategy)(nil)).Elem()

type PatchStrategyPtrInput interface {
	pulumi.Input

	ToPatchStrategyPtrOutput() PatchStrategyPtrOutput
	ToPatchStrategyPtrOutputWithContext(context.Context) PatchStrategyPtrOutput
}

type patchStrategyPtr string

func PatchStrategyPtr(v string) PatchStrategyPtrInput {
	return (*patchStrategyPtr)(&v)
}

func (*patchStrategyPtr) ElementType() reflect.Type {
	return patchStrategyPtrType
}

func (in *patchStrategyPtr) ToPatchStrategyPtrOutput() PatchStrategyPtrOutput {
	return pulumi.ToOutput(in).(PatchStrategyPtrOutput)
}

func (in *patchStrategyPtr) ToPatchStrategyPtrOutputWithContext(ctx context.Context) PatchStrategyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(PatchStrategyPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(PatchStrategyOutput{})
	pulumi.RegisterOutputType(PatchStrategyPtrOutput{})
