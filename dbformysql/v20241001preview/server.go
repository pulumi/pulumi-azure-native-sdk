...
type Server struct {
	...
	FullVersion pulumi.StringPtrOutput `pulumi:"fullVersion"`
...
func NewServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.RegisterResource("azure-native:dbformysql/v20241001preview:Server", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.ReadResource("azure-native:dbformysql/v20241001preview:Server", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Major version and actual engine version
func (o ServerOutput) FullVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Server) pulumi.StringPtrOutput { return v.FullVersion }).(pulumi.StringPtrOutput)
}
