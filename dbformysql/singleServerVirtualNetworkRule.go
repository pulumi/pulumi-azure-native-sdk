...
func NewSingleServerVirtualNetworkRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dbformysql/v20171201:SingleServerVirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20171201:VirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20171201preview:SingleServerVirtualNetworkRule"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20180601privatepreview:SingleServerVirtualNetworkRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dbformysql:SingleServerVirtualNetworkRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSingleServerVirtualNetworkRule(ctx *pulumi.Context,
	...
	var resource SingleServerVirtualNetworkRule
	err := ctx.ReadResource("azure-native:dbformysql:SingleServerVirtualNetworkRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
