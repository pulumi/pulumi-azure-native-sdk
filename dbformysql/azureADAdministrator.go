...
func NewAzureADAdministrator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20251201preview:AzureADAdministrator"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AzureADAdministrator
	err := ctx.RegisterResource("azure-native:dbformysql:AzureADAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureADAdministrator(ctx *pulumi.Context,
	...
	var resource AzureADAdministrator
	err := ctx.ReadResource("azure-native:dbformysql:AzureADAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
