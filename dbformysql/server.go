...
func NewServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20241201preview:Server"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20241230:Server"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20250601preview:Server"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20251201preview:Server"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Server
	err := ctx.RegisterResource("azure-native:dbformysql:Server", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.ReadResource("azure-native:dbformysql:Server", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
