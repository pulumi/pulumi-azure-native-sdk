...
func NewSingleServerDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20171201:SingleServerDatabase"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20171201preview:SingleServerDatabase"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20180601privatepreview:SingleServerDatabase"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SingleServerDatabase
	err := ctx.RegisterResource("azure-native:dbformysql:SingleServerDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSingleServerDatabase(ctx *pulumi.Context,
	...
	var resource SingleServerDatabase
	err := ctx.ReadResource("azure-native:dbformysql:SingleServerDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
