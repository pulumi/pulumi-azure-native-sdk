...
func LookupServerAdministrator(ctx *pulumi.Context, args *LookupServerAdministratorArgs, opts ...pulumi.InvokeOption) (*LookupServerAdministratorResult, error) {
	...
	err := ctx.Invoke("azure-native:dbformysql/v20171201:getServerAdministrator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerAdministratorOutput(ctx *pulumi.Context, args LookupServerAdministratorOutputArgs, opts ...pulumi.InvokeOption) LookupServerAdministratorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerAdministratorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbformysql/v20171201:getServerAdministrator", args, LookupServerAdministratorResultOutput{}, options).(LookupServerAdministratorResultOutput), nil
