...
func NewFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20241201preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20241230:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20250601preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20251201preview:FirewallRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource FirewallRule
	err := ctx.RegisterResource("azure-native:dbformysql:FirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallRule(ctx *pulumi.Context,
	...
	var resource FirewallRule
	err := ctx.ReadResource("azure-native:dbformysql:FirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
