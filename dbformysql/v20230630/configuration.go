...
func NewConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbformysql/v20230630:Configuration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfiguration(ctx *pulumi.Context,
	...
	var resource Configuration
	err := ctx.ReadResource("azure-native:dbformysql/v20230630:Configuration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
