...
func LookupVirtualNetworkRule(ctx *pulumi.Context, args *LookupVirtualNetworkRuleArgs, opts ...pulumi.InvokeOption) (*LookupVirtualNetworkRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:dbformysql/v20180601privatepreview:getVirtualNetworkRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVirtualNetworkRuleOutput(ctx *pulumi.Context, args LookupVirtualNetworkRuleOutputArgs, opts ...pulumi.InvokeOption) LookupVirtualNetworkRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVirtualNetworkRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbformysql/v20180601privatepreview:getVirtualNetworkRule", args, LookupVirtualNetworkRuleResultOutput{}, options).(LookupVirtualNetworkRuleResultOutput), nil
