...
func NewServerAdministrator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbformysql/v20180601privatepreview:ServerAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAdministrator(ctx *pulumi.Context,
	...
	var resource ServerAdministrator
	err := ctx.ReadResource("azure-native:dbformysql/v20180601privatepreview:ServerAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
