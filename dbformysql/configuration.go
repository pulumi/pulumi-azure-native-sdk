...
func NewConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20241201preview:Configuration"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20241230:Configuration"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20250601preview:Configuration"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20251201preview:Configuration"),
		},
	})
