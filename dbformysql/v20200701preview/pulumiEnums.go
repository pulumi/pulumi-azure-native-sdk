...
// InfrastructureEncryptionEnumInput is an input type that accepts values of the InfrastructureEncryptionEnum enum
// A concrete instance of `InfrastructureEncryptionEnumInput` can be one of the following:
//
