...
func LookupAzureADAdministrator(ctx *pulumi.Context, args *LookupAzureADAdministratorArgs, opts ...pulumi.InvokeOption) (*LookupAzureADAdministratorResult, error) {
	...
	err := ctx.Invoke("azure-native:dbformysql/v20220101:getAzureADAdministrator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAzureADAdministratorOutput(ctx *pulumi.Context, args LookupAzureADAdministratorOutputArgs, opts ...pulumi.InvokeOption) LookupAzureADAdministratorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAzureADAdministratorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbformysql/v20220101:getAzureADAdministrator", args, LookupAzureADAdministratorResultOutput{}, options).(LookupAzureADAdministratorResultOutput), nil
