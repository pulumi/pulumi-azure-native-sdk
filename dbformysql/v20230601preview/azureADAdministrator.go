...
func NewAzureADAdministrator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbformysql/v20230601preview:AzureADAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureADAdministrator(ctx *pulumi.Context,
	...
	var resource AzureADAdministrator
	err := ctx.ReadResource("azure-native:dbformysql/v20230601preview:AzureADAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
