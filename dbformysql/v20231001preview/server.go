...
func NewServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20231201preview:Server"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20231230:Server"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20240201preview:Server"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20240601preview:Server"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20241001preview:Server"),
		},
		{
	...
	var resource Server
	err := ctx.RegisterResource("azure-native:dbformysql/v20231001preview:Server", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.ReadResource("azure-native:dbformysql/v20231001preview:Server", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
