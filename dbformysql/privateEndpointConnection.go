...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbformysql/v20250601preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:dbformysql/v20251201preview:PrivateEndpointConnection"),
		},
	})
