...
type Server struct {
	...
	DatabasePort pulumi.IntPtrOutput `pulumi:"databasePort"`
	...
	MaintenancePolicy MaintenancePolicyResponsePtrOutput `pulumi:"maintenancePolicy"`
...
func NewServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.RegisterResource("azure-native:dbformysql/v20240601preview:Server", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.ReadResource("azure-native:dbformysql/v20240601preview:Server", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ServerArgs struct {
	...
	// The server database port. Can only be specified when the server is being created.
	DatabasePort pulumi.IntPtrInput
	// High availability related properties of a server.
...
// The server database port. Can only be specified when the server is being created.
func (o ServerOutput) DatabasePort() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Server) pulumi.IntPtrOutput { return v.DatabasePort }).(pulumi.IntPtrOutput)
}
...
// Maintenance policy of a server.
func (o ServerOutput) MaintenancePolicy() MaintenancePolicyResponsePtrOutput {
	return o.ApplyT(func(v *Server) MaintenancePolicyResponsePtrOutput { return v.MaintenancePolicy }).(MaintenancePolicyResponsePtrOutput)
}
