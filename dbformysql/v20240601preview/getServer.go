...
func LookupServer(ctx *pulumi.Context, args *LookupServerArgs, opts ...pulumi.InvokeOption) (*LookupServerResult, error) {
	...
	err := ctx.Invoke("azure-native:dbformysql/v20240601preview:getServer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupServerOutput(ctx *pulumi.Context, args LookupServerOutputArgs, opts ...pulumi.InvokeOption) LookupServerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbformysql/v20240601preview:getServer", args, LookupServerResultOutput{}, options).(LookupServerResultOutput), nil
...
// The server database port. Can only be specified when the server is being created.
func (o LookupServerResultOutput) DatabasePort() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupServerResult) *int { return v.DatabasePort }).(pulumi.IntPtrOutput)
}
...
// Maintenance policy of a server.
func (o LookupServerResultOutput) MaintenancePolicy() MaintenancePolicyResponsePtrOutput {
	return o.ApplyT(func(v LookupServerResult) *MaintenancePolicyResponse { return v.MaintenancePolicy }).(MaintenancePolicyResponsePtrOutput)
}
