...
func LookupAlias(ctx *pulumi.Context, args *LookupAliasArgs, opts ...pulumi.InvokeOption) (*LookupAliasResult, error) {
	...
	err := ctx.Invoke("azure-native:subscription/v20240801preview:getAlias", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAliasOutput(ctx *pulumi.Context, args LookupAliasOutputArgs, opts ...pulumi.InvokeOption) LookupAliasResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAliasResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:subscription/v20240801preview:getAlias", args, LookupAliasResultOutput{}, options).(LookupAliasResultOutput), nil
