...
func NewAlias(ctx *pulumi.Context,
	...
	var resource Alias
	err := ctx.RegisterResource("azure-native:subscription/v20240801preview:Alias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlias(ctx *pulumi.Context,
	...
	var resource Alias
	err := ctx.ReadResource("azure-native:subscription/v20240801preview:Alias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
