...
func NewSubscriptionTarDirectory(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:subscription:SubscriptionTarDirectory"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SubscriptionTarDirectory
	err := ctx.RegisterResource("azure-native:subscription/v20240801preview:SubscriptionTarDirectory", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionTarDirectory(ctx *pulumi.Context,
	...
	var resource SubscriptionTarDirectory
	err := ctx.ReadResource("azure-native:subscription/v20240801preview:SubscriptionTarDirectory", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
