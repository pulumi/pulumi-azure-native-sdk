...
func NewPipeline(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsdataprocessor/v20231004preview:Pipeline"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Pipeline
	err := ctx.RegisterResource("azure-native:iotoperationsdataprocessor:Pipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipeline(ctx *pulumi.Context,
	...
	var resource Pipeline
	err := ctx.ReadResource("azure-native:iotoperationsdataprocessor:Pipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
