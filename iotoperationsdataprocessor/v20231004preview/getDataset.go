...
func LookupDataset(ctx *pulumi.Context, args *LookupDatasetArgs, opts ...pulumi.InvokeOption) (*LookupDatasetResult, error) {
	...
	err := ctx.Invoke("azure-native:iotoperationsdataprocessor/v20231004preview:getDataset", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDatasetOutput(ctx *pulumi.Context, args LookupDatasetOutputArgs, opts ...pulumi.InvokeOption) LookupDatasetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatasetResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:iotoperationsdataprocessor/v20231004preview:getDataset", args, LookupDatasetResultOutput{}, options).(LookupDatasetResultOutput), nil
