...
func NewJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.RegisterResource("azure-native:importexport/v20161101:Job", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.ReadResource("azure-native:importexport/v20161101:Job", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
