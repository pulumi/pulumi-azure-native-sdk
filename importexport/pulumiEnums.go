...
// DriveStateInput is an input type that accepts values of the DriveState enum
// A concrete instance of `DriveStateInput` can be one of the following:
//
//	DriveStateSpecified
//	DriveStateReceived
...
// EncryptionKekTypeInput is an input type that accepts values of the EncryptionKekType enum
// A concrete instance of `EncryptionKekTypeInput` can be one of the following:
//
