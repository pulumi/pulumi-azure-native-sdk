...
// BlockchainProtocolInput is an input type that accepts values of the BlockchainProtocol enum
// A concrete instance of `BlockchainProtocolInput` can be one of the following:
//
