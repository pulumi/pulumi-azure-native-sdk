...
func LookupWorkspacePrivateEndpointConnection(ctx *pulumi.Context, args *LookupWorkspacePrivateEndpointConnectionArgs, opts ...pulumi.InvokeOption) (*LookupWorkspacePrivateEndpointConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:discovery:getWorkspacePrivateEndpointConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspacePrivateEndpointConnectionOutput(ctx *pulumi.Context, args LookupWorkspacePrivateEndpointConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspacePrivateEndpointConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspacePrivateEndpointConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:discovery:getWorkspacePrivateEndpointConnection", args, LookupWorkspacePrivateEndpointConnectionResultOutput{}, options).(LookupWorkspacePrivateEndpointConnectionResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupWorkspacePrivateEndpointConnectionResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWorkspacePrivateEndpointConnectionResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The resource-specific properties for this resource.
func (o LookupWorkspacePrivateEndpointConnectionResultOutput) Properties() commontypesv5.PrivateEndpointConnectionPropertiesResponseOutput {
	return o.ApplyT(func(v LookupWorkspacePrivateEndpointConnectionResult) commontypesv5.PrivateEndpointConnectionPropertiesResponse {
		return v.Properties
	}).(commontypesv5.PrivateEndpointConnectionPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupWorkspacePrivateEndpointConnectionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupWorkspacePrivateEndpointConnectionResult) commontypesv5.SystemDataResponse {
		return v.SystemData
