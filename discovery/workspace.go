...
func NewWorkspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:discovery/v20260201preview:Workspace"),
		},
		{
			Type: pulumi.String("azure-native:discovery/v20260601:Workspace"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Workspace
	err := ctx.RegisterResource("azure-native:discovery:Workspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspace(ctx *pulumi.Context,
	...
	var resource Workspace
	err := ctx.ReadResource("azure-native:discovery:Workspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The resource-specific properties for this resource.
func (o WorkspaceOutput) Properties() WorkspacePropertiesResponseOutput {
	return o.ApplyT(func(v *Workspace) WorkspacePropertiesResponseOutput { return v.Properties }).(WorkspacePropertiesResponseOutput)
}
