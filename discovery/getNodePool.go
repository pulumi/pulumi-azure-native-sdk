...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupNodePoolResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupNodePoolResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
