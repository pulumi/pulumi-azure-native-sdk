...
func LookupEntity(ctx *pulumi.Context, args *LookupEntityArgs, opts ...pulumi.InvokeOption) (*LookupEntityResult, error) {
	...
	err := ctx.Invoke("azure-native:cloudhealth:getEntity", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupEntityOutput(ctx *pulumi.Context, args LookupEntityOutputArgs, opts ...pulumi.InvokeOption) LookupEntityResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEntityResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cloudhealth:getEntity", args, LookupEntityResultOutput{}, options).(LookupEntityResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupEntityResultOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupEntityResult) commontypesv6.SystemDataResponse { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
