...
func NewAuthenticationSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudhealth/v20260101preview:AuthenticationSetting"),
		},
		{
			Type: pulumi.String("azure-native:cloudhealth/v20260501preview:AuthenticationSetting"),
		},
	})
