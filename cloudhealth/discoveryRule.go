...
type DiscoveryRule struct {
	...
	Properties DiscoveryRulePropertiesResponseOutput `pulumi:"properties"`
...
func NewDiscoveryRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudhealth:DiscoveryRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveryRule(ctx *pulumi.Context,
	...
	var resource DiscoveryRule
	err := ctx.ReadResource("azure-native:cloudhealth:DiscoveryRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type discoveryRuleArgs struct {
	...
	// The resource-specific properties for this resource.
	Properties *DiscoveryRuleProperties `pulumi:"properties"`
...
type DiscoveryRuleArgs struct {
	...
	// The resource-specific properties for this resource.
	Properties DiscoveryRulePropertiesPtrInput
	// The name of the resource group. The name is case insensitive.
...
// The resource-specific properties for this resource.
func (o DiscoveryRuleOutput) Properties() DiscoveryRulePropertiesResponseOutput {
	return o.ApplyT(func(v *DiscoveryRule) DiscoveryRulePropertiesResponseOutput { return v.Properties }).(DiscoveryRulePropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DiscoveryRuleOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *DiscoveryRule) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
