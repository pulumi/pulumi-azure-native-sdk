...
func NewEntity(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cloudhealth/v20250501preview:Entity"),
		},
		{
			Type: pulumi.String("azure-native:cloudhealth/v20260101preview:Entity"),
		},
		{
			Type: pulumi.String("azure-native:cloudhealth/v20260501preview:Entity"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Entity
	err := ctx.RegisterResource("azure-native:cloudhealth:Entity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntity(ctx *pulumi.Context,
	...
	var resource Entity
	err := ctx.ReadResource("azure-native:cloudhealth:Entity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
