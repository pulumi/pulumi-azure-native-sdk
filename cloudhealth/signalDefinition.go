...
func NewSignalDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cloudhealth/v20250501preview:SignalDefinition"),
		},
		{
			Type: pulumi.String("azure-native:cloudhealth/v20260101preview:SignalDefinition"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SignalDefinition
	err := ctx.RegisterResource("azure-native:cloudhealth:SignalDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalDefinition(ctx *pulumi.Context,
	...
	var resource SignalDefinition
	err := ctx.ReadResource("azure-native:cloudhealth:SignalDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SignalDefinitionOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *SignalDefinition) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
