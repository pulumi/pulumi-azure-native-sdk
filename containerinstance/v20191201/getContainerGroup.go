...
// azure-native:containerinstance/v20191201:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20210301:ContainerGroup to guarantee forwards compatibility.
func LookupContainerGroup(ctx *pulumi.Context, args *LookupContainerGroupArgs, opts ...pulumi.InvokeOption) (*LookupContainerGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:containerinstance/v20191201:getContainerGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
