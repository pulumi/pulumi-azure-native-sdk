...
// The properties of the Azure File volume. Azure File shares are mounted as volumes.
type AzureFileVolumeResponseV1 struct {
	// The flag indicating whether the Azure File shared mounted as a volume is read-only.
	ReadOnly *bool `pulumi:"readOnly"`
	// The name of the Azure File share to be mounted as a volume.
	ShareName string `pulumi:"shareName"`
...
// The properties of the Azure File volume. Azure File shares are mounted as volumes.
type AzureFileVolumeResponseV1Output struct{ *pulumi.OutputState }

func (AzureFileVolumeResponseV1Output) ElementType() reflect.Type {
	return reflect.TypeOf((*AzureFileVolumeResponseV1)(nil)).Elem()
}

func (o AzureFileVolumeResponseV1Output) ToAzureFileVolumeResponseV1Output() AzureFileVolumeResponseV1Output {
	return o
}

func (o AzureFileVolumeResponseV1Output) ToAzureFileVolumeResponseV1OutputWithContext(ctx context.Context) AzureFileVolumeResponseV1Output {
	return o
}

// The flag indicating whether the Azure File shared mounted as a volume is read-only.
func (o AzureFileVolumeResponseV1Output) ReadOnly() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AzureFileVolumeResponseV1) *bool { return v.ReadOnly }).(pulumi.BoolPtrOutput)
}

// The name of the Azure File share to be mounted as a volume.
func (o AzureFileVolumeResponseV1Output) ShareName() pulumi.StringOutput {
	return o.ApplyT(func(v AzureFileVolumeResponseV1) string { return v.ShareName }).(pulumi.StringOutput)
}

// The storage account access key used to access the Azure File share.
func (o AzureFileVolumeResponseV1Output) StorageAccountKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AzureFileVolumeResponseV1) *string { return v.StorageAccountKey }).(pulumi.StringPtrOutput)
}

// The name of the storage account that contains the Azure File share.
func (o AzureFileVolumeResponseV1Output) StorageAccountName() pulumi.StringOutput {
	return o.ApplyT(func(v AzureFileVolumeResponseV1) string { return v.StorageAccountName }).(pulumi.StringOutput)
}

type AzureFileVolumeResponseV1PtrOutput struct{ *pulumi.OutputState }

func (AzureFileVolumeResponseV1PtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AzureFileVolumeResponseV1)(nil)).Elem()
}

func (o AzureFileVolumeResponseV1PtrOutput) ToAzureFileVolumeResponseV1PtrOutput() AzureFileVolumeResponseV1PtrOutput {
	return o
}

func (o AzureFileVolumeResponseV1PtrOutput) ToAzureFileVolumeResponseV1PtrOutputWithContext(ctx context.Context) AzureFileVolumeResponseV1PtrOutput {
	return o
}

func (o AzureFileVolumeResponseV1PtrOutput) Elem() AzureFileVolumeResponseV1Output {
	return o.ApplyT(func(v *AzureFileVolumeResponseV1) AzureFileVolumeResponseV1 {
		if v != nil {
			return *v
		}
		var ret AzureFileVolumeResponseV1
		return ret
	}).(AzureFileVolumeResponseV1Output)
}

// The flag indicating whether the Azure File shared mounted as a volume is read-only.
func (o AzureFileVolumeResponseV1PtrOutput) ReadOnly() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AzureFileVolumeResponseV1) *bool {
		if v == nil {
			return nil
		}
		return v.ReadOnly
...
// The name of the Azure File share to be mounted as a volume.
func (o AzureFileVolumeResponseV1PtrOutput) ShareName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AzureFileVolumeResponseV1) *string {
		if v == nil {
			return nil
		}
		return &v.ShareName
...
// The storage account access key used to access the Azure File share.
func (o AzureFileVolumeResponseV1PtrOutput) StorageAccountKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AzureFileVolumeResponseV1) *string {
		if v == nil {
			return nil
		}
...
// The name of the storage account that contains the Azure File share.
func (o AzureFileVolumeResponseV1PtrOutput) StorageAccountName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AzureFileVolumeResponseV1) *string {
		if v == nil {
			return nil
		}
...
// A container instance.
type ContainerResponseV1 struct {
	// The commands to execute within the container instance in exec form.
	Command []string `pulumi:"command"`
	// The config map.
	ConfigMap *ConfigMapResponse `pulumi:"configMap"`
	// The environment variables to set in the container instance.
	EnvironmentVariables []EnvironmentVariableResponseV1 `pulumi:"environmentVariables"`
	// The name of the image used to create the container instance.
	Image *string `pulumi:"image"`
	// The instance view of the container instance. Only valid in response.
	InstanceView ContainerPropertiesResponseInstanceView `pulumi:"instanceView"`
...
// A container instance.
type ContainerResponseV1Output struct{ *pulumi.OutputState }

func (ContainerResponseV1Output) ElementType() reflect.Type {
	return reflect.TypeOf((*ContainerResponseV1)(nil)).Elem()
}

func (o ContainerResponseV1Output) ToContainerResponseV1Output() ContainerResponseV1Output {
	return o
}

func (o ContainerResponseV1Output) ToContainerResponseV1OutputWithContext(ctx context.Context) ContainerResponseV1Output {
	return o
}

// The commands to execute within the container instance in exec form.
func (o ContainerResponseV1Output) Command() pulumi.StringArrayOutput {
	return o.ApplyT(func(v ContainerResponseV1) []string { return v.Command }).(pulumi.StringArrayOutput)
}

// The config map.
func (o ContainerResponseV1Output) ConfigMap() ConfigMapResponsePtrOutput {
	return o.ApplyT(func(v ContainerResponseV1) *ConfigMapResponse { return v.ConfigMap }).(ConfigMapResponsePtrOutput)
}

// The environment variables to set in the container instance.
func (o ContainerResponseV1Output) EnvironmentVariables() EnvironmentVariableResponseV1ArrayOutput {
	return o.ApplyT(func(v ContainerResponseV1) []EnvironmentVariableResponseV1 { return v.EnvironmentVariables }).(EnvironmentVariableResponseV1ArrayOutput)
}

// The name of the image used to create the container instance.
func (o ContainerResponseV1Output) Image() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContainerResponseV1) *string { return v.Image }).(pulumi.StringPtrOutput)
}

// The instance view of the container instance. Only valid in response.
func (o ContainerResponseV1Output) InstanceView() ContainerPropertiesResponseInstanceViewOutput {
	return o.ApplyT(func(v ContainerResponseV1) ContainerPropertiesResponseInstanceView { return v.InstanceView }).(ContainerPropertiesResponseInstanceViewOutput)
}

// The liveness probe.
func (o ContainerResponseV1Output) LivenessProbe() ContainerProbeResponsePtrOutput {
	return o.ApplyT(func(v ContainerResponseV1) *ContainerProbeResponse { return v.LivenessProbe }).(ContainerProbeResponsePtrOutput)
}

// The user-provided name of the container instance.
func (o ContainerResponseV1Output) Name() pulumi.StringOutput {
	return o.ApplyT(func(v ContainerResponseV1) string { return v.Name }).(pulumi.StringOutput)
}

// The exposed ports on the container instance.
func (o ContainerResponseV1Output) Ports() ContainerPortResponseArrayOutput {
	return o.ApplyT(func(v ContainerResponseV1) []ContainerPortResponse { return v.Ports }).(ContainerPortResponseArrayOutput)
}

// The readiness probe.
func (o ContainerResponseV1Output) ReadinessProbe() ContainerProbeResponsePtrOutput {
	return o.ApplyT(func(v ContainerResponseV1) *ContainerProbeResponse { return v.ReadinessProbe }).(ContainerProbeResponsePtrOutput)
}

// The resource requirements of the container instance.
func (o ContainerResponseV1Output) Resources() ResourceRequirementsResponsePtrOutput {
	return o.ApplyT(func(v ContainerResponseV1) *ResourceRequirementsResponse { return v.Resources }).(ResourceRequirementsResponsePtrOutput)
}

// The container security properties.
func (o ContainerResponseV1Output) SecurityContext() SecurityContextDefinitionResponsePtrOutput {
	return o.ApplyT(func(v ContainerResponseV1) *SecurityContextDefinitionResponse { return v.SecurityContext }).(SecurityContextDefinitionResponsePtrOutput)
}

// The volume mounts available to the container instance.
func (o ContainerResponseV1Output) VolumeMounts() VolumeMountResponseArrayOutput {
	return o.ApplyT(func(v ContainerResponseV1) []VolumeMountResponse { return v.VolumeMounts }).(VolumeMountResponseArrayOutput)
}

type ContainerResponseV1ArrayOutput struct{ *pulumi.OutputState }

func (ContainerResponseV1ArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ContainerResponseV1)(nil)).Elem()
}

func (o ContainerResponseV1ArrayOutput) ToContainerResponseV1ArrayOutput() ContainerResponseV1ArrayOutput {
	return o
}

func (o ContainerResponseV1ArrayOutput) ToContainerResponseV1ArrayOutputWithContext(ctx context.Context) ContainerResponseV1ArrayOutput {
	return o
}

func (o ContainerResponseV1ArrayOutput) Index(i pulumi.IntInput) ContainerResponseV1Output {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ContainerResponseV1 {
		return vs[0].([]ContainerResponseV1)[vs[1].(int)]
...
type ElasticProfileContainerGroupNamingPolicy struct {
	GuidNamingPolicy *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy `pulumi:"guidNamingPolicy"`
}
...
type ElasticProfileContainerGroupNamingPolicyArgs struct {
	GuidNamingPolicy ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrInput `pulumi:"guidNamingPolicy"`
}
...
func (o ElasticProfileContainerGroupNamingPolicyOutput) GuidNamingPolicy() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return o.ApplyT(func(v ElasticProfileContainerGroupNamingPolicy) *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy {
		return v.GuidNamingPolicy
	}).(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput)
}
...
func (o ElasticProfileContainerGroupNamingPolicyPtrOutput) GuidNamingPolicy() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return o.ApplyT(func(v *ElasticProfileContainerGroupNamingPolicy) *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy {
		if v == nil {
			return nil
		}
...
// ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyInput is an input type that accepts ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs and ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput values.
// You can construct a concrete instance of `ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyInput` via:
//
//	ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs{...}
type ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyInput interface {
	pulumi.Input

	ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput
	ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutputWithContext(context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput
}

type ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs struct {
	// The prefix can be used when there are tooling limitations (e.g. on the Azure portal where CGs from multiple NGroups exist in the same RG). The prefix with the suffixed resource name must still follow Azure resource naming guidelines.
	Prefix pulumi.StringPtrInput `pulumi:"prefix"`
}

func (ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy)(nil)).Elem()
}

func (i ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput {
	return i.ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutputWithContext(context.Background())
}

func (i ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput)
}

func (i ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return i.ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(context.Background())
}

func (i ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput).ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(ctx)
}

// ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrInput is an input type that accepts ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs, ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtr and ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput values.
// You can construct a concrete instance of `ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrInput` via:
//
//	        ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs{...}
//
//	or:
//
//	        nil
type ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrInput interface {
	pulumi.Input

	ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput
	ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput
}

type elasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrType ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs

func ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtr(v *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyArgs) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrInput {
	return (*elasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrType)(v)
}

func (*elasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy)(nil)).Elem()
}

func (i *elasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrType) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return i.ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(context.Background())
}

func (i *elasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrType) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput)
}

type ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput struct{ *pulumi.OutputState }

func (ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy)(nil)).Elem()
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return o.ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(context.Background())
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy) *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy {
		return &v
	}).(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput)
}

// The prefix can be used when there are tooling limitations (e.g. on the Azure portal where CGs from multiple NGroups exist in the same RG). The prefix with the suffixed resource name must still follow Azure resource naming guidelines.
func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput) Prefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy) *string { return v.Prefix }).(pulumi.StringPtrOutput)
}

type ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput struct{ *pulumi.OutputState }

func (ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy)(nil)).Elem()
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput) Elem() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput {
	return o.ApplyT(func(v *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy {
		if v != nil {
			return *v
		}
		var ret ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy
		return ret
	}).(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput)
}

// The prefix can be used when there are tooling limitations (e.g. on the Azure portal where CGs from multiple NGroups exist in the same RG). The prefix with the suffixed resource name must still follow Azure resource naming guidelines.
func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput) Prefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicy) *string {
		if v == nil {
			return nil
		}
		return v.Prefix
...
type ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse struct {
	// The prefix can be used when there are tooling limitations (e.g. on the Azure portal where CGs from multiple NGroups exist in the same RG). The prefix with the suffixed resource name must still follow Azure resource naming guidelines.
	Prefix *string `pulumi:"prefix"`
}

type ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput struct{ *pulumi.OutputState }

func (ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse)(nil)).Elem()
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput {
	return o
}

// The prefix can be used when there are tooling limitations (e.g. on the Azure portal where CGs from multiple NGroups exist in the same RG). The prefix with the suffixed resource name must still follow Azure resource naming guidelines.
func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput) Prefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse) *string { return v.Prefix }).(pulumi.StringPtrOutput)
}

type ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput struct{ *pulumi.OutputState }

func (ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse)(nil)).Elem()
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput) ToElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput) Elem() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput {
	return o.ApplyT(func(v *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse) ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse {
		if v != nil {
			return *v
		}
		var ret ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse
		return ret
	}).(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput)
}

// The prefix can be used when there are tooling limitations (e.g. on the Azure portal where CGs from multiple NGroups exist in the same RG). The prefix with the suffixed resource name must still follow Azure resource naming guidelines.
func (o ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput) Prefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse) *string {
		if v == nil {
			return nil
		}
		return v.Prefix
...
// Container Groups are named on a generic guid based naming scheme/policy. Customer can modify naming policy to add prefix to CG names during scale out operation.
type ElasticProfileContainerGroupNamingPolicyResponse struct {
	GuidNamingPolicy *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse `pulumi:"guidNamingPolicy"`
}

// Container Groups are named on a generic guid based naming scheme/policy. Customer can modify naming policy to add prefix to CG names during scale out operation.
type ElasticProfileContainerGroupNamingPolicyResponseOutput struct{ *pulumi.OutputState }

func (ElasticProfileContainerGroupNamingPolicyResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ElasticProfileContainerGroupNamingPolicyResponse)(nil)).Elem()
}

func (o ElasticProfileContainerGroupNamingPolicyResponseOutput) ToElasticProfileContainerGroupNamingPolicyResponseOutput() ElasticProfileContainerGroupNamingPolicyResponseOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyResponseOutput) ToElasticProfileContainerGroupNamingPolicyResponseOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyResponseOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyResponseOutput) GuidNamingPolicy() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput {
	return o.ApplyT(func(v ElasticProfileContainerGroupNamingPolicyResponse) *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse {
		return v.GuidNamingPolicy
	}).(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput)
}

type ElasticProfileContainerGroupNamingPolicyResponsePtrOutput struct{ *pulumi.OutputState }

func (ElasticProfileContainerGroupNamingPolicyResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ElasticProfileContainerGroupNamingPolicyResponse)(nil)).Elem()
}

func (o ElasticProfileContainerGroupNamingPolicyResponsePtrOutput) ToElasticProfileContainerGroupNamingPolicyResponsePtrOutput() ElasticProfileContainerGroupNamingPolicyResponsePtrOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyResponsePtrOutput) ToElasticProfileContainerGroupNamingPolicyResponsePtrOutputWithContext(ctx context.Context) ElasticProfileContainerGroupNamingPolicyResponsePtrOutput {
	return o
}

func (o ElasticProfileContainerGroupNamingPolicyResponsePtrOutput) Elem() ElasticProfileContainerGroupNamingPolicyResponseOutput {
	return o.ApplyT(func(v *ElasticProfileContainerGroupNamingPolicyResponse) ElasticProfileContainerGroupNamingPolicyResponse {
		if v != nil {
			return *v
		}
		var ret ElasticProfileContainerGroupNamingPolicyResponse
		return ret
	}).(ElasticProfileContainerGroupNamingPolicyResponseOutput)
}

func (o ElasticProfileContainerGroupNamingPolicyResponsePtrOutput) GuidNamingPolicy() ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput {
	return o.ApplyT(func(v *ElasticProfileContainerGroupNamingPolicyResponse) *ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse {
		if v == nil {
			return nil
		}
...
type ElasticProfileResponse struct {
	// Container Groups are named on a generic guid based naming scheme/policy. Customer can modify naming policy to add prefix to CG names during scale out operation.
	ContainerGroupNamingPolicy *ElasticProfileContainerGroupNamingPolicyResponse `pulumi:"containerGroupNamingPolicy"`
	DesiredCount               *int                                              `pulumi:"desiredCount"`
	// Flag that indicates whether desiredCount should be maintained when customer deletes SPECIFIC container groups (CGs) from the NGroups. In this case, new CGs will be created by NGroup to compensate for the specific deleted ones.
	MaintainDesiredCount *bool `pulumi:"maintainDesiredCount"`
}
...
// Container Groups are named on a generic guid based naming scheme/policy. Customer can modify naming policy to add prefix to CG names during scale out operation.
func (o ElasticProfileResponseOutput) ContainerGroupNamingPolicy() ElasticProfileContainerGroupNamingPolicyResponsePtrOutput {
	return o.ApplyT(func(v ElasticProfileResponse) *ElasticProfileContainerGroupNamingPolicyResponse {
		return v.ContainerGroupNamingPolicy
	}).(ElasticProfileContainerGroupNamingPolicyResponsePtrOutput)
}
...
// Container Groups are named on a generic guid based naming scheme/policy. Customer can modify naming policy to add prefix to CG names during scale out operation.
func (o ElasticProfileResponsePtrOutput) ContainerGroupNamingPolicy() ElasticProfileContainerGroupNamingPolicyResponsePtrOutput {
	return o.ApplyT(func(v *ElasticProfileResponse) *ElasticProfileContainerGroupNamingPolicyResponse {
		if v == nil {
			return nil
		}
...
// The environment variable to set within the container instance.
type EnvironmentVariableResponseV1 struct {
	// The name of the environment variable.
	Name string `pulumi:"name"`
	// The value of the secure environment variable.
	SecureValue *string `pulumi:"secureValue"`
...
// The environment variable to set within the container instance.
type EnvironmentVariableResponseV1Output struct{ *pulumi.OutputState }

func (EnvironmentVariableResponseV1Output) ElementType() reflect.Type {
	return reflect.TypeOf((*EnvironmentVariableResponseV1)(nil)).Elem()
}

func (o EnvironmentVariableResponseV1Output) ToEnvironmentVariableResponseV1Output() EnvironmentVariableResponseV1Output {
	return o
}

func (o EnvironmentVariableResponseV1Output) ToEnvironmentVariableResponseV1OutputWithContext(ctx context.Context) EnvironmentVariableResponseV1Output {
	return o
}

// The name of the environment variable.
func (o EnvironmentVariableResponseV1Output) Name() pulumi.StringOutput {
	return o.ApplyT(func(v EnvironmentVariableResponseV1) string { return v.Name }).(pulumi.StringOutput)
}

// The value of the secure environment variable.
func (o EnvironmentVariableResponseV1Output) SecureValue() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EnvironmentVariableResponseV1) *string { return v.SecureValue }).(pulumi.StringPtrOutput)
}

// The value of the environment variable.
func (o EnvironmentVariableResponseV1Output) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EnvironmentVariableResponseV1) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type EnvironmentVariableResponseV1ArrayOutput struct{ *pulumi.OutputState }

func (EnvironmentVariableResponseV1ArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]EnvironmentVariableResponseV1)(nil)).Elem()
}

func (o EnvironmentVariableResponseV1ArrayOutput) ToEnvironmentVariableResponseV1ArrayOutput() EnvironmentVariableResponseV1ArrayOutput {
	return o
}

func (o EnvironmentVariableResponseV1ArrayOutput) ToEnvironmentVariableResponseV1ArrayOutputWithContext(ctx context.Context) EnvironmentVariableResponseV1ArrayOutput {
	return o
}

func (o EnvironmentVariableResponseV1ArrayOutput) Index(i pulumi.IntInput) EnvironmentVariableResponseV1Output {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) EnvironmentVariableResponseV1 {
		return vs[0].([]EnvironmentVariableResponseV1)[vs[1].(int)]
...
// Defaults sets the appropriate defaults for FileSharePropertiesResponse
func (val *FileSharePropertiesResponse) Defaults() *FileSharePropertiesResponse {
	if val == nil {
		return nil
	}
	tmp := *val
...
// Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium. Learn more at: https://learn.microsoft.com/en-us/rest/api/storagerp/file-shares/create?tabs=HTTP#shareaccesstier
func (o FileSharePropertiesResponseOutput) ShareAccessTier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FileSharePropertiesResponse) *string { return v.ShareAccessTier }).(pulumi.StringPtrOutput)
}

// Specifies how Container Groups can access the Azure file share i.e. all CG will share same Azure file share or going to have exclusive file share.
func (o FileSharePropertiesResponseOutput) ShareAccessType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FileSharePropertiesResponse) *string { return v.ShareAccessType }).(pulumi.StringPtrOutput)
}
...
func (o FileSharePropertiesResponsePtrOutput) Elem() FileSharePropertiesResponseOutput {
	return o.ApplyT(func(v *FileSharePropertiesResponse) FileSharePropertiesResponse {
		...
		var ret FileSharePropertiesResponse
		return ret
	}).(FileSharePropertiesResponseOutput)
}

// Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium. Learn more at: https://learn.microsoft.com/en-us/rest/api/storagerp/file-shares/create?tabs=HTTP#shareaccesstier
func (o FileSharePropertiesResponsePtrOutput) ShareAccessTier() pulumi.StringPtrOutput {
...
// Specifies how Container Groups can access the Azure file share i.e. all CG will share same Azure file share or going to have exclusive file share.
func (o FileSharePropertiesResponsePtrOutput) ShareAccessType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FileSharePropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
func (o FileShareResponseOutput) Properties() FileSharePropertiesResponsePtrOutput {
	return o.ApplyT(func(v FileShareResponse) *FileSharePropertiesResponse { return v.Properties }).(FileSharePropertiesResponsePtrOutput)
}
...
// Image registry credential.
type ImageRegistryCredentialResponseV1 struct {
	// The identity for the private registry.
	Identity *string `pulumi:"identity"`
	// The identity URL for the private registry.
	IdentityUrl *string `pulumi:"identityUrl"`
...
// Image registry credential.
type ImageRegistryCredentialResponseV1Output struct{ *pulumi.OutputState }

func (ImageRegistryCredentialResponseV1Output) ElementType() reflect.Type {
	return reflect.TypeOf((*ImageRegistryCredentialResponseV1)(nil)).Elem()
}

func (o ImageRegistryCredentialResponseV1Output) ToImageRegistryCredentialResponseV1Output() ImageRegistryCredentialResponseV1Output {
	return o
}

func (o ImageRegistryCredentialResponseV1Output) ToImageRegistryCredentialResponseV1OutputWithContext(ctx context.Context) ImageRegistryCredentialResponseV1Output {
	return o
}

// The identity for the private registry.
func (o ImageRegistryCredentialResponseV1Output) Identity() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ImageRegistryCredentialResponseV1) *string { return v.Identity }).(pulumi.StringPtrOutput)
}

// The identity URL for the private registry.
func (o ImageRegistryCredentialResponseV1Output) IdentityUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ImageRegistryCredentialResponseV1) *string { return v.IdentityUrl }).(pulumi.StringPtrOutput)
}

// The password for the private registry.
func (o ImageRegistryCredentialResponseV1Output) Password() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ImageRegistryCredentialResponseV1) *string { return v.Password }).(pulumi.StringPtrOutput)
}

// The Docker image registry server without a protocol such as "http" and "https".
func (o ImageRegistryCredentialResponseV1Output) Server() pulumi.StringOutput {
	return o.ApplyT(func(v ImageRegistryCredentialResponseV1) string { return v.Server }).(pulumi.StringOutput)
}

// The username for the private registry.
func (o ImageRegistryCredentialResponseV1Output) Username() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ImageRegistryCredentialResponseV1) *string { return v.Username }).(pulumi.StringPtrOutput)
}

type ImageRegistryCredentialResponseV1ArrayOutput struct{ *pulumi.OutputState }

func (ImageRegistryCredentialResponseV1ArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ImageRegistryCredentialResponseV1)(nil)).Elem()
}

func (o ImageRegistryCredentialResponseV1ArrayOutput) ToImageRegistryCredentialResponseV1ArrayOutput() ImageRegistryCredentialResponseV1ArrayOutput {
	return o
}

func (o ImageRegistryCredentialResponseV1ArrayOutput) ToImageRegistryCredentialResponseV1ArrayOutputWithContext(ctx context.Context) ImageRegistryCredentialResponseV1ArrayOutput {
	return o
}

func (o ImageRegistryCredentialResponseV1ArrayOutput) Index(i pulumi.IntInput) ImageRegistryCredentialResponseV1Output {
...
// container properties
type NGroupCGPropertyContainerPropertiesResponse struct {
	VolumeMounts []VolumeMountResponse `pulumi:"volumeMounts"`
}

// container properties
type NGroupCGPropertyContainerPropertiesResponseOutput struct{ *pulumi.OutputState }

func (NGroupCGPropertyContainerPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*NGroupCGPropertyContainerPropertiesResponse)(nil)).Elem()
}

func (o NGroupCGPropertyContainerPropertiesResponseOutput) ToNGroupCGPropertyContainerPropertiesResponseOutput() NGroupCGPropertyContainerPropertiesResponseOutput {
	return o
}

func (o NGroupCGPropertyContainerPropertiesResponseOutput) ToNGroupCGPropertyContainerPropertiesResponseOutputWithContext(ctx context.Context) NGroupCGPropertyContainerPropertiesResponseOutput {
	return o
}

func (o NGroupCGPropertyContainerPropertiesResponseOutput) VolumeMounts() VolumeMountResponseArrayOutput {
	return o.ApplyT(func(v NGroupCGPropertyContainerPropertiesResponse) []VolumeMountResponse { return v.VolumeMounts }).(VolumeMountResponseArrayOutput)
}

type NGroupCGPropertyContainerPropertiesResponsePtrOutput struct{ *pulumi.OutputState }

func (NGroupCGPropertyContainerPropertiesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**NGroupCGPropertyContainerPropertiesResponse)(nil)).Elem()
}

func (o NGroupCGPropertyContainerPropertiesResponsePtrOutput) ToNGroupCGPropertyContainerPropertiesResponsePtrOutput() NGroupCGPropertyContainerPropertiesResponsePtrOutput {
	return o
}

func (o NGroupCGPropertyContainerPropertiesResponsePtrOutput) ToNGroupCGPropertyContainerPropertiesResponsePtrOutputWithContext(ctx context.Context) NGroupCGPropertyContainerPropertiesResponsePtrOutput {
	return o
}

func (o NGroupCGPropertyContainerPropertiesResponsePtrOutput) Elem() NGroupCGPropertyContainerPropertiesResponseOutput {
	return o.ApplyT(func(v *NGroupCGPropertyContainerPropertiesResponse) NGroupCGPropertyContainerPropertiesResponse {
		if v != nil {
			return *v
		}
		var ret NGroupCGPropertyContainerPropertiesResponse
		return ret
	}).(NGroupCGPropertyContainerPropertiesResponseOutput)
}

func (o NGroupCGPropertyContainerPropertiesResponsePtrOutput) VolumeMounts() VolumeMountResponseArrayOutput {
	return o.ApplyT(func(v *NGroupCGPropertyContainerPropertiesResponse) []VolumeMountResponse {
		if v == nil {
			return nil
		}
		return v.VolumeMounts
...
type NGroupCGPropertyContainerResponse struct {
	...
	Name *string `pulumi:"name"`
	// container properties
	Properties *NGroupCGPropertyContainerPropertiesResponse `pulumi:"properties"`
}
...
// container properties
func (o NGroupCGPropertyContainerResponseOutput) Properties() NGroupCGPropertyContainerPropertiesResponsePtrOutput {
	return o.ApplyT(func(v NGroupCGPropertyContainerResponse) *NGroupCGPropertyContainerPropertiesResponse {
		return v.Properties
	}).(NGroupCGPropertyContainerPropertiesResponsePtrOutput)
}
...
type UpdateProfileResponse struct {
	// This profile allows the customers to customize the rolling update.
	RollingUpdateProfile *UpdateProfileRollingUpdateProfileResponse `pulumi:"rollingUpdateProfile"`
	UpdateMode           *string                                    `pulumi:"updateMode"`
}
...
// This profile allows the customers to customize the rolling update.
func (o UpdateProfileResponseOutput) RollingUpdateProfile() UpdateProfileRollingUpdateProfileResponsePtrOutput {
	return o.ApplyT(func(v UpdateProfileResponse) *UpdateProfileRollingUpdateProfileResponse {
		return v.RollingUpdateProfile
	}).(UpdateProfileRollingUpdateProfileResponsePtrOutput)
}
...
// This profile allows the customers to customize the rolling update.
func (o UpdateProfileResponsePtrOutput) RollingUpdateProfile() UpdateProfileRollingUpdateProfileResponsePtrOutput {
	return o.ApplyT(func(v *UpdateProfileResponse) *UpdateProfileRollingUpdateProfileResponse {
		if v == nil {
			return nil
		}
...
// This profile allows the customers to customize the rolling update.
type UpdateProfileRollingUpdateProfileResponse struct {
	// Default is false. If set to true, the CGs will be updated in-place instead of creating new CG and deleting old ones.
	InPlaceUpdate *bool `pulumi:"inPlaceUpdate"`
	// Maximum percentage of total Container Groups which can be updated simultaneously by rolling update in one batch.
	MaxBatchPercent *int `pulumi:"maxBatchPercent"`
...
// This profile allows the customers to customize the rolling update.
type UpdateProfileRollingUpdateProfileResponseOutput struct{ *pulumi.OutputState }

func (UpdateProfileRollingUpdateProfileResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*UpdateProfileRollingUpdateProfileResponse)(nil)).Elem()
}

func (o UpdateProfileRollingUpdateProfileResponseOutput) ToUpdateProfileRollingUpdateProfileResponseOutput() UpdateProfileRollingUpdateProfileResponseOutput {
	return o
}

func (o UpdateProfileRollingUpdateProfileResponseOutput) ToUpdateProfileRollingUpdateProfileResponseOutputWithContext(ctx context.Context) UpdateProfileRollingUpdateProfileResponseOutput {
	return o
}

// Default is false. If set to true, the CGs will be updated in-place instead of creating new CG and deleting old ones.
func (o UpdateProfileRollingUpdateProfileResponseOutput) InPlaceUpdate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v UpdateProfileRollingUpdateProfileResponse) *bool { return v.InPlaceUpdate }).(pulumi.BoolPtrOutput)
}

// Maximum percentage of total Container Groups which can be updated simultaneously by rolling update in one batch.
func (o UpdateProfileRollingUpdateProfileResponseOutput) MaxBatchPercent() pulumi.IntPtrOutput {
	return o.ApplyT(func(v UpdateProfileRollingUpdateProfileResponse) *int { return v.MaxBatchPercent }).(pulumi.IntPtrOutput)
}

// Maximum percentage of the updated Container Groups which can be in unhealthy state after each batch is updated.
func (o UpdateProfileRollingUpdateProfileResponseOutput) MaxUnhealthyPercent() pulumi.IntPtrOutput {
	return o.ApplyT(func(v UpdateProfileRollingUpdateProfileResponse) *int { return v.MaxUnhealthyPercent }).(pulumi.IntPtrOutput)
}

// The wait time between batches after completing the one batch of the rolling update and starting the next batch. The time duration should be specified in ISO 8601 format for duration.
func (o UpdateProfileRollingUpdateProfileResponseOutput) PauseTimeBetweenBatches() pulumi.StringPtrOutput {
	return o.ApplyT(func(v UpdateProfileRollingUpdateProfileResponse) *string { return v.PauseTimeBetweenBatches }).(pulumi.StringPtrOutput)
}

type UpdateProfileRollingUpdateProfileResponsePtrOutput struct{ *pulumi.OutputState }

func (UpdateProfileRollingUpdateProfileResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**UpdateProfileRollingUpdateProfileResponse)(nil)).Elem()
}

func (o UpdateProfileRollingUpdateProfileResponsePtrOutput) ToUpdateProfileRollingUpdateProfileResponsePtrOutput() UpdateProfileRollingUpdateProfileResponsePtrOutput {
	return o
}

func (o UpdateProfileRollingUpdateProfileResponsePtrOutput) ToUpdateProfileRollingUpdateProfileResponsePtrOutputWithContext(ctx context.Context) UpdateProfileRollingUpdateProfileResponsePtrOutput {
	return o
}

func (o UpdateProfileRollingUpdateProfileResponsePtrOutput) Elem() UpdateProfileRollingUpdateProfileResponseOutput {
	return o.ApplyT(func(v *UpdateProfileRollingUpdateProfileResponse) UpdateProfileRollingUpdateProfileResponse {
		if v != nil {
			return *v
		}
		var ret UpdateProfileRollingUpdateProfileResponse
		return ret
	}).(UpdateProfileRollingUpdateProfileResponseOutput)
}

// Default is false. If set to true, the CGs will be updated in-place instead of creating new CG and deleting old ones.
func (o UpdateProfileRollingUpdateProfileResponsePtrOutput) InPlaceUpdate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *UpdateProfileRollingUpdateProfileResponse) *bool {
		if v == nil {
			return nil
		}
		return v.InPlaceUpdate
...
// Maximum percentage of total Container Groups which can be updated simultaneously by rolling update in one batch.
func (o UpdateProfileRollingUpdateProfileResponsePtrOutput) MaxBatchPercent() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *UpdateProfileRollingUpdateProfileResponse) *int {
		if v == nil {
			return nil
		}
		return v.MaxBatchPercent
...
// Maximum percentage of the updated Container Groups which can be in unhealthy state after each batch is updated.
func (o UpdateProfileRollingUpdateProfileResponsePtrOutput) MaxUnhealthyPercent() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *UpdateProfileRollingUpdateProfileResponse) *int {
		if v == nil {
			return nil
		}
...
// The wait time between batches after completing the one batch of the rolling update and starting the next batch. The time duration should be specified in ISO 8601 format for duration.
func (o UpdateProfileRollingUpdateProfileResponsePtrOutput) PauseTimeBetweenBatches() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *UpdateProfileRollingUpdateProfileResponse) *string {
		if v == nil {
			return nil
		}
		return v.PauseTimeBetweenBatches
...
// The properties of the volume.
type VolumeResponseV1 struct {
	// The Azure File volume.
	AzureFile *AzureFileVolumeResponseV1 `pulumi:"azureFile"`
	// The empty directory volume.
	EmptyDir interface{} `pulumi:"emptyDir"`
	// The git repo volume.
	GitRepo *GitRepoVolumeResponse `pulumi:"gitRepo"`
...
// The properties of the volume.
type VolumeResponseV1Output struct{ *pulumi.OutputState }

func (VolumeResponseV1Output) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeResponseV1)(nil)).Elem()
}

func (o VolumeResponseV1Output) ToVolumeResponseV1Output() VolumeResponseV1Output {
	return o
}

func (o VolumeResponseV1Output) ToVolumeResponseV1OutputWithContext(ctx context.Context) VolumeResponseV1Output {
	return o
}

// The Azure File volume.
func (o VolumeResponseV1Output) AzureFile() AzureFileVolumeResponseV1PtrOutput {
	return o.ApplyT(func(v VolumeResponseV1) *AzureFileVolumeResponseV1 { return v.AzureFile }).(AzureFileVolumeResponseV1PtrOutput)
}

// The empty directory volume.
func (o VolumeResponseV1Output) EmptyDir() pulumi.AnyOutput {
	return o.ApplyT(func(v VolumeResponseV1) interface{} { return v.EmptyDir }).(pulumi.AnyOutput)
}

// The git repo volume.
func (o VolumeResponseV1Output) GitRepo() GitRepoVolumeResponsePtrOutput {
	return o.ApplyT(func(v VolumeResponseV1) *GitRepoVolumeResponse { return v.GitRepo }).(GitRepoVolumeResponsePtrOutput)
}

// The name of the volume.
func (o VolumeResponseV1Output) Name() pulumi.StringOutput {
	return o.ApplyT(func(v VolumeResponseV1) string { return v.Name }).(pulumi.StringOutput)
}

// The secret volume.
func (o VolumeResponseV1Output) Secret() pulumi.StringMapOutput {
	return o.ApplyT(func(v VolumeResponseV1) map[string]string { return v.Secret }).(pulumi.StringMapOutput)
}

type VolumeResponseV1ArrayOutput struct{ *pulumi.OutputState }

func (VolumeResponseV1ArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]VolumeResponseV1)(nil)).Elem()
}

func (o VolumeResponseV1ArrayOutput) ToVolumeResponseV1ArrayOutput() VolumeResponseV1ArrayOutput {
	return o
}

func (o VolumeResponseV1ArrayOutput) ToVolumeResponseV1ArrayOutputWithContext(ctx context.Context) VolumeResponseV1ArrayOutput {
	return o
}

func (o VolumeResponseV1ArrayOutput) Index(i pulumi.IntInput) VolumeResponseV1Output {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) VolumeResponseV1 {
		return vs[0].([]VolumeResponseV1)[vs[1].(int)]
...
func init() {
	...
	pulumi.RegisterOutputType(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyOutput{})
	pulumi.RegisterOutputType(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyPtrOutput{})
	pulumi.RegisterOutputType(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponseOutput{})
	pulumi.RegisterOutputType(ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponsePtrOutput{})
	pulumi.RegisterOutputType(ElasticProfileContainerGroupNamingPolicyResponseOutput{})
	pulumi.RegisterOutputType(ElasticProfileContainerGroupNamingPolicyResponsePtrOutput{})
	...
	pulumi.RegisterOutputType(NGroupCGPropertyContainerPropertiesResponseOutput{})
	pulumi.RegisterOutputType(NGroupCGPropertyContainerPropertiesResponsePtrOutput{})
	...
	pulumi.RegisterOutputType(UpdateProfileRollingUpdateProfileResponseOutput{})
	pulumi.RegisterOutputType(UpdateProfileRollingUpdateProfileResponsePtrOutput{})
