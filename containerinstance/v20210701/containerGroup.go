...
func NewContainerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerinstance/v20210701:ContainerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerGroup(ctx *pulumi.Context,
	...
	var resource ContainerGroup
	err := ctx.ReadResource("azure-native:containerinstance/v20210701:ContainerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
