...
func (IdentityAccessLevel) ElementType() reflect.Type {
	return reflect.TypeOf((*IdentityAccessLevel)(nil)).Elem()
}

func (e IdentityAccessLevel) ToIdentityAccessLevelOutput() IdentityAccessLevelOutput {
	return pulumi.ToOutput(e).(IdentityAccessLevelOutput)
}

func (e IdentityAccessLevel) ToIdentityAccessLevelOutputWithContext(ctx context.Context) IdentityAccessLevelOutput {
	return pulumi.ToOutputWithContext(ctx, e).(IdentityAccessLevelOutput)
}

func (e IdentityAccessLevel) ToIdentityAccessLevelPtrOutput() IdentityAccessLevelPtrOutput {
	return e.ToIdentityAccessLevelPtrOutputWithContext(context.Background())
}

func (e IdentityAccessLevel) ToIdentityAccessLevelPtrOutputWithContext(ctx context.Context) IdentityAccessLevelPtrOutput {
	return IdentityAccessLevel(e).ToIdentityAccessLevelOutputWithContext(ctx).ToIdentityAccessLevelPtrOutputWithContext(ctx)
}

func (e IdentityAccessLevel) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e IdentityAccessLevel) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e IdentityAccessLevel) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e IdentityAccessLevel) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type IdentityAccessLevelOutput struct{ *pulumi.OutputState }

func (IdentityAccessLevelOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*IdentityAccessLevel)(nil)).Elem()
}

func (o IdentityAccessLevelOutput) ToIdentityAccessLevelOutput() IdentityAccessLevelOutput {
	return o
}

func (o IdentityAccessLevelOutput) ToIdentityAccessLevelOutputWithContext(ctx context.Context) IdentityAccessLevelOutput {
	return o
}

func (o IdentityAccessLevelOutput) ToIdentityAccessLevelPtrOutput() IdentityAccessLevelPtrOutput {
	return o.ToIdentityAccessLevelPtrOutputWithContext(context.Background())
}

func (o IdentityAccessLevelOutput) ToIdentityAccessLevelPtrOutputWithContext(ctx context.Context) IdentityAccessLevelPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v IdentityAccessLevel) *IdentityAccessLevel {
		return &v
	}).(IdentityAccessLevelPtrOutput)
}

func (o IdentityAccessLevelOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o IdentityAccessLevelOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e IdentityAccessLevel) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o IdentityAccessLevelOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o IdentityAccessLevelOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e IdentityAccessLevel) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type IdentityAccessLevelPtrOutput struct{ *pulumi.OutputState }

func (IdentityAccessLevelPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**IdentityAccessLevel)(nil)).Elem()
}

func (o IdentityAccessLevelPtrOutput) ToIdentityAccessLevelPtrOutput() IdentityAccessLevelPtrOutput {
	return o
}

func (o IdentityAccessLevelPtrOutput) ToIdentityAccessLevelPtrOutputWithContext(ctx context.Context) IdentityAccessLevelPtrOutput {
	return o
}

func (o IdentityAccessLevelPtrOutput) Elem() IdentityAccessLevelOutput {
	return o.ApplyT(func(v *IdentityAccessLevel) IdentityAccessLevel {
		if v != nil {
			return *v
		}
		var ret IdentityAccessLevel
		return ret
	}).(IdentityAccessLevelOutput)
}

func (o IdentityAccessLevelPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o IdentityAccessLevelPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *IdentityAccessLevel) *string {
		if e == nil {
			return nil
		}
...
// IdentityAccessLevelInput is an input type that accepts values of the IdentityAccessLevel enum
// A concrete instance of `IdentityAccessLevelInput` can be one of the following:
//
//	IdentityAccessLevelAll
//	IdentityAccessLevelSystem
//	IdentityAccessLevelUser
type IdentityAccessLevelInput interface {
	pulumi.Input

	ToIdentityAccessLevelOutput() IdentityAccessLevelOutput
	ToIdentityAccessLevelOutputWithContext(context.Context) IdentityAccessLevelOutput
}

var identityAccessLevelPtrType = reflect.TypeOf((**IdentityAccessLevel)(nil)).Elem()

type IdentityAccessLevelPtrInput interface {
	pulumi.Input

	ToIdentityAccessLevelPtrOutput() IdentityAccessLevelPtrOutput
	ToIdentityAccessLevelPtrOutputWithContext(context.Context) IdentityAccessLevelPtrOutput
}

type identityAccessLevelPtr string

func IdentityAccessLevelPtr(v string) IdentityAccessLevelPtrInput {
	return (*identityAccessLevelPtr)(&v)
}

func (*identityAccessLevelPtr) ElementType() reflect.Type {
	return identityAccessLevelPtrType
}

func (in *identityAccessLevelPtr) ToIdentityAccessLevelPtrOutput() IdentityAccessLevelPtrOutput {
	return pulumi.ToOutput(in).(IdentityAccessLevelPtrOutput)
}

func (in *identityAccessLevelPtr) ToIdentityAccessLevelPtrOutputWithContext(ctx context.Context) IdentityAccessLevelPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(IdentityAccessLevelPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(IdentityAccessLevelOutput{})
	pulumi.RegisterOutputType(IdentityAccessLevelPtrOutput{})
