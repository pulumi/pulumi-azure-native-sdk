...
type ContainerGroup struct {
	...
	IdentityAcls IdentityAclsResponsePtrOutput `pulumi:"identityAcls"`
	...
	SecretReferences SecretReferenceResponseArrayOutput `pulumi:"secretReferences"`
...
func NewContainerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerinstance/v20241101preview:ContainerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerGroup(ctx *pulumi.Context,
	...
	var resource ContainerGroup
	err := ctx.ReadResource("azure-native:containerinstance/v20241101preview:ContainerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type containerGroupArgs struct {
	...
	// The access control levels of the identities.
	IdentityAcls *IdentityAcls `pulumi:"identityAcls"`
	// The image registry credentials by which the container group is created from.
	...
	// The secret references that will be referenced within the container group.
	SecretReferences []SecretReference `pulumi:"secretReferences"`
	// The SKU for a container group.
...
type ContainerGroupArgs struct {
	...
	// The access control levels of the identities.
	IdentityAcls IdentityAclsPtrInput
	// The image registry credentials by which the container group is created from.
	...
	// The secret references that will be referenced within the container group.
	SecretReferences SecretReferenceArrayInput
	// The SKU for a container group.
...
// The access control levels of the identities.
func (o ContainerGroupOutput) IdentityAcls() IdentityAclsResponsePtrOutput {
	return o.ApplyT(func(v *ContainerGroup) IdentityAclsResponsePtrOutput { return v.IdentityAcls }).(IdentityAclsResponsePtrOutput)
}
...
// The secret references that will be referenced within the container group.
func (o ContainerGroupOutput) SecretReferences() SecretReferenceResponseArrayOutput {
	return o.ApplyT(func(v *ContainerGroup) SecretReferenceResponseArrayOutput { return v.SecretReferences }).(SecretReferenceResponseArrayOutput)
}
