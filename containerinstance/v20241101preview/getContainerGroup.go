...
func LookupContainerGroup(ctx *pulumi.Context, args *LookupContainerGroupArgs, opts ...pulumi.InvokeOption) (*LookupContainerGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:containerinstance/v20241101preview:getContainerGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupContainerGroupResult struct {
	...
	IdentityAcls *IdentityAclsResponse `pulumi:"identityAcls"`
	...
	SecretReferences []SecretReferenceResponse `pulumi:"secretReferences"`
...
func LookupContainerGroupOutput(ctx *pulumi.Context, args LookupContainerGroupOutputArgs, opts ...pulumi.InvokeOption) LookupContainerGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContainerGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerinstance/v20241101preview:getContainerGroup", args, LookupContainerGroupResultOutput{}, options).(LookupContainerGroupResultOutput), nil
...
// The access control levels of the identities.
func (o LookupContainerGroupResultOutput) IdentityAcls() IdentityAclsResponsePtrOutput {
	return o.ApplyT(func(v LookupContainerGroupResult) *IdentityAclsResponse { return v.IdentityAcls }).(IdentityAclsResponsePtrOutput)
}
...
// The secret references that will be referenced within the container group.
func (o LookupContainerGroupResultOutput) SecretReferences() SecretReferenceResponseArrayOutput {
	return o.ApplyT(func(v LookupContainerGroupResult) []SecretReferenceResponse { return v.SecretReferences }).(SecretReferenceResponseArrayOutput)
}
