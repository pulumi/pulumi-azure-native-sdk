...
func NewContainerGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerinstance/v20250901:ContainerGroup"),
		},
		{
			Type: pulumi.String("azure-native:containerinstance/v20260601preview:ContainerGroup"),
		},
	})
