...
func NewNGroup(ctx *pulumi.Context,
	...
	var resource NGroup
	err := ctx.RegisterResource("azure-native:containerinstance:NGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNGroup(ctx *pulumi.Context,
	...
	var resource NGroup
	err := ctx.ReadResource("azure-native:containerinstance:NGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Metadata pertaining to creation and last modification of the resource.
func (o NGroupOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NGroup) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
