...
func LookupContainerGroup(ctx *pulumi.Context, args *LookupContainerGroupArgs, opts ...pulumi.InvokeOption) (*LookupContainerGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:containerinstance/v20230201preview:getContainerGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupContainerGroupResult struct {
	...
	IsCustomProvisioningTimeout string `pulumi:"isCustomProvisioningTimeout"`
	...
	ProvisioningTimeoutInSeconds *int `pulumi:"provisioningTimeoutInSeconds"`
...
func LookupContainerGroupOutput(ctx *pulumi.Context, args LookupContainerGroupOutputArgs, opts ...pulumi.InvokeOption) LookupContainerGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContainerGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerinstance/v20230201preview:getContainerGroup", args, LookupContainerGroupResultOutput{}, options).(LookupContainerGroupResultOutput), nil
...
// Flag indicating whether a custom value was provided for the provisioningTimeoutInSeconds property
func (o LookupContainerGroupResultOutput) IsCustomProvisioningTimeout() pulumi.StringOutput {
	return o.ApplyT(func(v LookupContainerGroupResult) string { return v.IsCustomProvisioningTimeout }).(pulumi.StringOutput)
}
...
// Time in seconds in which a container group deployment would timeout and fail. The allowed maximum value is 1800 seconds. If value is not provided, property is given maximum value by default.
func (o LookupContainerGroupResultOutput) ProvisioningTimeoutInSeconds() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupContainerGroupResult) *int { return v.ProvisioningTimeoutInSeconds }).(pulumi.IntPtrOutput)
}
