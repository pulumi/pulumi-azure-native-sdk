...
type ContainerGroup struct {
	...
	IsCustomProvisioningTimeout pulumi.StringOutput `pulumi:"isCustomProvisioningTimeout"`
	...
	ProvisioningTimeoutInSeconds pulumi.IntPtrOutput `pulumi:"provisioningTimeoutInSeconds"`
...
func NewContainerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerinstance/v20230201preview:ContainerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerGroup(ctx *pulumi.Context,
	...
	var resource ContainerGroup
	err := ctx.ReadResource("azure-native:containerinstance/v20230201preview:ContainerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ContainerGroupArgs struct {
	...
	// Time in seconds in which a container group deployment would timeout and fail. The allowed maximum value is 1800 seconds. If value is not provided, property is given maximum value by default.
	ProvisioningTimeoutInSeconds pulumi.IntPtrInput
	// The name of the resource group.
...
// Flag indicating whether a custom value was provided for the provisioningTimeoutInSeconds property
func (o ContainerGroupOutput) IsCustomProvisioningTimeout() pulumi.StringOutput {
	return o.ApplyT(func(v *ContainerGroup) pulumi.StringOutput { return v.IsCustomProvisioningTimeout }).(pulumi.StringOutput)
}
...
// Time in seconds in which a container group deployment would timeout and fail. The allowed maximum value is 1800 seconds. If value is not provided, property is given maximum value by default.
func (o ContainerGroupOutput) ProvisioningTimeoutInSeconds() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *ContainerGroup) pulumi.IntPtrOutput { return v.ProvisioningTimeoutInSeconds }).(pulumi.IntPtrOutput)
}
