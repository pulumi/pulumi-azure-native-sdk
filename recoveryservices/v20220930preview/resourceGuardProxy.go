...
func NewResourceGuardProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220930preview:ResourceGuardProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceGuardProxy(ctx *pulumi.Context,
	...
	var resource ResourceGuardProxy
	err := ctx.ReadResource("azure-native:recoveryservices/v20220930preview:ResourceGuardProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
