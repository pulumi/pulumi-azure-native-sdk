...
//
// Deprecated: azure-native:recoveryservices/v20220930preview:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:Vault to guarantee forwards compatibility.
type Vault struct {
