...
func NewReplicationMigrationItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationMigrationItem"),
		},
	})
...
// The Azure API version of the resource.
func (o ReplicationMigrationItemOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ReplicationMigrationItem) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
