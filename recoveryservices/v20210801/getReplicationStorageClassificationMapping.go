...
//
// Deprecated: azure-native:recoveryservices/v20210801:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping to guarantee forwards compatibility.
func LookupReplicationStorageClassificationMapping(ctx *pulumi.Context, args *LookupReplicationStorageClassificationMappingArgs, opts ...pulumi.InvokeOption) (*LookupReplicationStorageClassificationMappingResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20210801:getReplicationStorageClassificationMapping", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
