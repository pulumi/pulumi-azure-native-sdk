...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20220930preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20221001:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230101:PrivateEndpointConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240430preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240730preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:PrivateEndpointConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20241101preview:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:recoveryservices/v20241101preview:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
