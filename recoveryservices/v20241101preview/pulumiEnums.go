...
func (VMWorkloadPolicyType) ElementType() reflect.Type {
	return reflect.TypeOf((*VMWorkloadPolicyType)(nil)).Elem()
}

func (e VMWorkloadPolicyType) ToVMWorkloadPolicyTypeOutput() VMWorkloadPolicyTypeOutput {
	return pulumi.ToOutput(e).(VMWorkloadPolicyTypeOutput)
}

func (e VMWorkloadPolicyType) ToVMWorkloadPolicyTypeOutputWithContext(ctx context.Context) VMWorkloadPolicyTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(VMWorkloadPolicyTypeOutput)
}

func (e VMWorkloadPolicyType) ToVMWorkloadPolicyTypePtrOutput() VMWorkloadPolicyTypePtrOutput {
	return e.ToVMWorkloadPolicyTypePtrOutputWithContext(context.Background())
}

func (e VMWorkloadPolicyType) ToVMWorkloadPolicyTypePtrOutputWithContext(ctx context.Context) VMWorkloadPolicyTypePtrOutput {
	return VMWorkloadPolicyType(e).ToVMWorkloadPolicyTypeOutputWithContext(ctx).ToVMWorkloadPolicyTypePtrOutputWithContext(ctx)
}

func (e VMWorkloadPolicyType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e VMWorkloadPolicyType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e VMWorkloadPolicyType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e VMWorkloadPolicyType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type VMWorkloadPolicyTypeOutput struct{ *pulumi.OutputState }

func (VMWorkloadPolicyTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VMWorkloadPolicyType)(nil)).Elem()
}

func (o VMWorkloadPolicyTypeOutput) ToVMWorkloadPolicyTypeOutput() VMWorkloadPolicyTypeOutput {
	return o
}

func (o VMWorkloadPolicyTypeOutput) ToVMWorkloadPolicyTypeOutputWithContext(ctx context.Context) VMWorkloadPolicyTypeOutput {
	return o
}

func (o VMWorkloadPolicyTypeOutput) ToVMWorkloadPolicyTypePtrOutput() VMWorkloadPolicyTypePtrOutput {
	return o.ToVMWorkloadPolicyTypePtrOutputWithContext(context.Background())
}

func (o VMWorkloadPolicyTypeOutput) ToVMWorkloadPolicyTypePtrOutputWithContext(ctx context.Context) VMWorkloadPolicyTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v VMWorkloadPolicyType) *VMWorkloadPolicyType {
		return &v
	}).(VMWorkloadPolicyTypePtrOutput)
}

func (o VMWorkloadPolicyTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o VMWorkloadPolicyTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e VMWorkloadPolicyType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o VMWorkloadPolicyTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o VMWorkloadPolicyTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e VMWorkloadPolicyType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type VMWorkloadPolicyTypePtrOutput struct{ *pulumi.OutputState }

func (VMWorkloadPolicyTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VMWorkloadPolicyType)(nil)).Elem()
}

func (o VMWorkloadPolicyTypePtrOutput) ToVMWorkloadPolicyTypePtrOutput() VMWorkloadPolicyTypePtrOutput {
	return o
}

func (o VMWorkloadPolicyTypePtrOutput) ToVMWorkloadPolicyTypePtrOutputWithContext(ctx context.Context) VMWorkloadPolicyTypePtrOutput {
	return o
}

func (o VMWorkloadPolicyTypePtrOutput) Elem() VMWorkloadPolicyTypeOutput {
	return o.ApplyT(func(v *VMWorkloadPolicyType) VMWorkloadPolicyType {
		if v != nil {
			return *v
		}
		var ret VMWorkloadPolicyType
		return ret
	}).(VMWorkloadPolicyTypeOutput)
}

func (o VMWorkloadPolicyTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o VMWorkloadPolicyTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *VMWorkloadPolicyType) *string {
		if e == nil {
			return nil
		}
...
// VMWorkloadPolicyTypeInput is an input type that accepts values of the VMWorkloadPolicyType enum
// A concrete instance of `VMWorkloadPolicyTypeInput` can be one of the following:
//
//	VMWorkloadPolicyTypeInvalid
//	VMWorkloadPolicyTypeSnapshotV1
//	VMWorkloadPolicyTypeSnapshotV2
//	VMWorkloadPolicyTypeStreaming
type VMWorkloadPolicyTypeInput interface {
	pulumi.Input

	ToVMWorkloadPolicyTypeOutput() VMWorkloadPolicyTypeOutput
	ToVMWorkloadPolicyTypeOutputWithContext(context.Context) VMWorkloadPolicyTypeOutput
}

var vmworkloadPolicyTypePtrType = reflect.TypeOf((**VMWorkloadPolicyType)(nil)).Elem()

type VMWorkloadPolicyTypePtrInput interface {
	pulumi.Input

	ToVMWorkloadPolicyTypePtrOutput() VMWorkloadPolicyTypePtrOutput
	ToVMWorkloadPolicyTypePtrOutputWithContext(context.Context) VMWorkloadPolicyTypePtrOutput
}

type vmworkloadPolicyTypePtr string

func VMWorkloadPolicyTypePtr(v string) VMWorkloadPolicyTypePtrInput {
	return (*vmworkloadPolicyTypePtr)(&v)
}

func (*vmworkloadPolicyTypePtr) ElementType() reflect.Type {
	return vmworkloadPolicyTypePtrType
}

func (in *vmworkloadPolicyTypePtr) ToVMWorkloadPolicyTypePtrOutput() VMWorkloadPolicyTypePtrOutput {
	return pulumi.ToOutput(in).(VMWorkloadPolicyTypePtrOutput)
}

func (in *vmworkloadPolicyTypePtr) ToVMWorkloadPolicyTypePtrOutputWithContext(ctx context.Context) VMWorkloadPolicyTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(VMWorkloadPolicyTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(VMWorkloadPolicyTypeOutput{})
	pulumi.RegisterOutputType(VMWorkloadPolicyTypePtrOutput{})
