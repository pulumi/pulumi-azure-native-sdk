...
func NewProtectionIntent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240430preview:ProtectionIntent"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20241101preview:ProtectionIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionIntent(ctx *pulumi.Context,
	...
	var resource ProtectionIntent
	err := ctx.ReadResource("azure-native:recoveryservices/v20241101preview:ProtectionIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
