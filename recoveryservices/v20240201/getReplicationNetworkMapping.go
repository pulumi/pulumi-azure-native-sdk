...
func LookupReplicationNetworkMapping(ctx *pulumi.Context, args *LookupReplicationNetworkMappingArgs, opts ...pulumi.InvokeOption) (*LookupReplicationNetworkMappingResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20240201:getReplicationNetworkMapping", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationNetworkMappingOutput(ctx *pulumi.Context, args LookupReplicationNetworkMappingOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationNetworkMappingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationNetworkMappingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20240201:getReplicationNetworkMapping", args, LookupReplicationNetworkMappingResultOutput{}, options).(LookupReplicationNetworkMappingResultOutput), nil
