...
func LookupReplicationFabric(ctx *pulumi.Context, args *LookupReplicationFabricArgs, opts ...pulumi.InvokeOption) (*LookupReplicationFabricResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20240201:getReplicationFabric", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationFabricOutput(ctx *pulumi.Context, args LookupReplicationFabricOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationFabricResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationFabricResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20240201:getReplicationFabric", args, LookupReplicationFabricResultOutput{}, options).(LookupReplicationFabricResultOutput), nil
