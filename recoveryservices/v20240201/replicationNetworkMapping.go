...
func NewReplicationNetworkMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20240201:ReplicationNetworkMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationNetworkMapping(ctx *pulumi.Context,
	...
	var resource ReplicationNetworkMapping
	err := ctx.ReadResource("azure-native:recoveryservices/v20240201:ReplicationNetworkMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
