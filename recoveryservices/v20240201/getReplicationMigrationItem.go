...
func LookupReplicationMigrationItem(ctx *pulumi.Context, args *LookupReplicationMigrationItemArgs, opts ...pulumi.InvokeOption) (*LookupReplicationMigrationItemResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20240201:getReplicationMigrationItem", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationMigrationItemOutput(ctx *pulumi.Context, args LookupReplicationMigrationItemOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationMigrationItemResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationMigrationItemResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20240201:getReplicationMigrationItem", args, LookupReplicationMigrationItemResultOutput{}, options).(LookupReplicationMigrationItemResultOutput), nil
