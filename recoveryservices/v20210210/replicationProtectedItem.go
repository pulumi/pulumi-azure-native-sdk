...
//
// Deprecated: azure-native:recoveryservices/v20210210:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationProtectedItem to guarantee forwards compatibility.
...
func NewReplicationProtectedItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20210210:ReplicationProtectedItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationProtectedItem(ctx *pulumi.Context,
	...
	var resource ReplicationProtectedItem
	err := ctx.ReadResource("azure-native:recoveryservices/v20210210:ReplicationProtectedItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
