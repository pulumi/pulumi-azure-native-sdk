...
//
// Deprecated: azure-native:recoveryservices/v20210210:ProtectionContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionContainer to guarantee forwards compatibility.
...
func NewProtectionContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20210210:ProtectionContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionContainer(ctx *pulumi.Context,
	...
	var resource ProtectionContainer
	err := ctx.ReadResource("azure-native:recoveryservices/v20210210:ProtectionContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
