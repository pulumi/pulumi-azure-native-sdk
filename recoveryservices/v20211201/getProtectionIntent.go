...
//
// Deprecated: azure-native:recoveryservices/v20211201:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionIntent to guarantee forwards compatibility.
func LookupProtectionIntent(ctx *pulumi.Context, args *LookupProtectionIntentArgs, opts ...pulumi.InvokeOption) (*LookupProtectionIntentResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20211201:getProtectionIntent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
