...
// vCenter definition.
//
// Deprecated: azure-native:recoveryservices/v20211201:ReplicationvCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationvCenter to guarantee forwards compatibility.
...
func NewReplicationvCenter(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20220910:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20221001:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230101:ReplicationvCenter"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20211201:ReplicationvCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationvCenter(ctx *pulumi.Context,
	...
	var resource ReplicationvCenter
	err := ctx.ReadResource("azure-native:recoveryservices/v20211201:ReplicationvCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
