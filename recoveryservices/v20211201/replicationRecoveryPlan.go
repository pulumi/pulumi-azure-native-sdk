...
//
// Deprecated: azure-native:recoveryservices/v20211201:ReplicationRecoveryPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.
...
func NewReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20211201:ReplicationRecoveryPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	var resource ReplicationRecoveryPlan
	err := ctx.ReadResource("azure-native:recoveryservices/v20211201:ReplicationRecoveryPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
