...
func NewVault(ctx *pulumi.Context,
	...
	var resource Vault
	err := ctx.RegisterResource("azure-native:recoveryservices/v20160601:Vault", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVault(ctx *pulumi.Context,
	...
	var resource Vault
	err := ctx.ReadResource("azure-native:recoveryservices/v20160601:Vault", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
