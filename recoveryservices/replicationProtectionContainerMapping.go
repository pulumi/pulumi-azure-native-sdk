...
func NewReplicationProtectionContainerMapping(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationProtectionContainerMapping"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReplicationProtectionContainerMapping
	err := ctx.RegisterResource("azure-native:recoveryservices:ReplicationProtectionContainerMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationProtectionContainerMapping(ctx *pulumi.Context,
	...
	var resource ReplicationProtectionContainerMapping
	err := ctx.ReadResource("azure-native:recoveryservices:ReplicationProtectionContainerMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
