...
func NewProtectionIntent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250228preview:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260131preview:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ProtectionIntent"),
		},
	})
