...
func NewProtectionContainer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260131preview:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ProtectionContainer"),
		},
	})
