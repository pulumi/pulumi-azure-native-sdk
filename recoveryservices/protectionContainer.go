...
//
// Other available API versions: 2023-02-01, 2023-04-01, 2023-06-01, 2023-08-01, 2024-01-01, 2024-02-01, 2024-04-01, 2024-04-30-preview, 2024-07-30-preview, 2024-11-01-preview, 2025-01-01, 2025-02-01, 2025-02-28-preview, 2025-08-01, 2026-01-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native recoveryservices [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
...
func NewProtectionContainer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20220930preview:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20221001:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230101:ProtectionContainer"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240430preview:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240730preview:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241101preview:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250228preview:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ProtectionContainer"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101preview:ProtectionContainer"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ProtectionContainer
	err := ctx.RegisterResource("azure-native:recoveryservices:ProtectionContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionContainer(ctx *pulumi.Context,
	...
	var resource ProtectionContainer
	err := ctx.ReadResource("azure-native:recoveryservices:ProtectionContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ProtectionContainerOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ProtectionContainer) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
