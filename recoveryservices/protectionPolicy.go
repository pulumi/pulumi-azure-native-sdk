...
func NewProtectionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ProtectionPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250228preview:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260131preview:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ProtectionPolicy"),
		},
	})
...
// The Azure API version of the resource.
func (o ProtectionPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ProtectionPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
