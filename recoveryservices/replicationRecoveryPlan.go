...
func NewReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationRecoveryPlan"),
		},
	})
...
// The Azure API version of the resource.
func (o ReplicationRecoveryPlanOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ReplicationRecoveryPlan) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
