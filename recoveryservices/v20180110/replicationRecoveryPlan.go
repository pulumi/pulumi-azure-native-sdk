...
func NewReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20180110:ReplicationRecoveryPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	var resource ReplicationRecoveryPlan
	err := ctx.ReadResource("azure-native:recoveryservices/v20180110:ReplicationRecoveryPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
