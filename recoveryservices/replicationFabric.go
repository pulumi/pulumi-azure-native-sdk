...
func NewReplicationFabric(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationFabric"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationFabric"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationFabric"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationFabric"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationFabric"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationFabric"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationFabric"),
		},
	})
...
// The Azure API version of the resource.
func (o ReplicationFabricOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ReplicationFabric) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
