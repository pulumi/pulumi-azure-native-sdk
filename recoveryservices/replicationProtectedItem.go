...
func NewReplicationProtectedItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ReplicationProtectedItem"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ReplicationProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationProtectedItem"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReplicationProtectedItem
	err := ctx.RegisterResource("azure-native:recoveryservices:ReplicationProtectedItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationProtectedItem(ctx *pulumi.Context,
	...
	var resource ReplicationProtectedItem
	err := ctx.ReadResource("azure-native:recoveryservices:ReplicationProtectedItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ReplicationProtectedItemOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ReplicationProtectedItem) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
