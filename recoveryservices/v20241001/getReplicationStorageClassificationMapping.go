...
func LookupReplicationStorageClassificationMapping(ctx *pulumi.Context, args *LookupReplicationStorageClassificationMappingArgs, opts ...pulumi.InvokeOption) (*LookupReplicationStorageClassificationMappingResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20241001:getReplicationStorageClassificationMapping", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationStorageClassificationMappingOutput(ctx *pulumi.Context, args LookupReplicationStorageClassificationMappingOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationStorageClassificationMappingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationStorageClassificationMappingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20241001:getReplicationStorageClassificationMapping", args, LookupReplicationStorageClassificationMappingResultOutput{}, options).(LookupReplicationStorageClassificationMappingResultOutput), nil
