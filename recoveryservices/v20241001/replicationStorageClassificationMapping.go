...
func NewReplicationStorageClassificationMapping(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230101:ReplicationStorageClassificationMapping"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ReplicationStorageClassificationMapping"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReplicationStorageClassificationMapping
	err := ctx.RegisterResource("azure-native:recoveryservices/v20241001:ReplicationStorageClassificationMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationStorageClassificationMapping(ctx *pulumi.Context,
	...
	var resource ReplicationStorageClassificationMapping
	err := ctx.ReadResource("azure-native:recoveryservices/v20241001:ReplicationStorageClassificationMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
