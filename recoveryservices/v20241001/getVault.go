...
func LookupVault(ctx *pulumi.Context, args *LookupVaultArgs, opts ...pulumi.InvokeOption) (*LookupVaultResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20241001:getVault", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVaultOutput(ctx *pulumi.Context, args LookupVaultOutputArgs, opts ...pulumi.InvokeOption) LookupVaultResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVaultResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20241001:getVault", args, LookupVaultResultOutput{}, options).(LookupVaultResultOutput), nil
