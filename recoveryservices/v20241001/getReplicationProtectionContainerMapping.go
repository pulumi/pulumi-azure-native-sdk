...
func LookupReplicationProtectionContainerMapping(ctx *pulumi.Context, args *LookupReplicationProtectionContainerMappingArgs, opts ...pulumi.InvokeOption) (*LookupReplicationProtectionContainerMappingResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20241001:getReplicationProtectionContainerMapping", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationProtectionContainerMappingOutput(ctx *pulumi.Context, args LookupReplicationProtectionContainerMappingOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationProtectionContainerMappingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationProtectionContainerMappingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20241001:getReplicationProtectionContainerMapping", args, LookupReplicationProtectionContainerMappingResultOutput{}, options).(LookupReplicationProtectionContainerMappingResultOutput), nil
