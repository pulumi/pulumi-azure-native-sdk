...
func NewReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationRecoveryServicesProvider"),
		},
	})
