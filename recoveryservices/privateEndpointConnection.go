...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250228preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260131preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:PrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateEndpointConnection
	err := ctx.RegisterResource("azure-native:recoveryservices:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:recoveryservices:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
