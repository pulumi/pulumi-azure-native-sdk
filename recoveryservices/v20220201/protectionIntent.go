...
//
// Deprecated: azure-native:recoveryservices/v20220201:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionIntent to guarantee forwards compatibility.
...
func NewProtectionIntent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220201:ProtectionIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionIntent(ctx *pulumi.Context,
	...
	var resource ProtectionIntent
	err := ctx.ReadResource("azure-native:recoveryservices/v20220201:ProtectionIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
