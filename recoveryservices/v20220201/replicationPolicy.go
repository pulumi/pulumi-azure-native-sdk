...
//
// Deprecated: azure-native:recoveryservices/v20220201:ReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationPolicy to guarantee forwards compatibility.
...
func NewReplicationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220201:ReplicationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationPolicy(ctx *pulumi.Context,
	...
	var resource ReplicationPolicy
	err := ctx.ReadResource("azure-native:recoveryservices/v20220201:ReplicationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
