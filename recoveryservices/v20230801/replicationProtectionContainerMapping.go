...
func NewReplicationProtectionContainerMapping(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230101:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230201:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230401:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ReplicationProtectionContainerMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ReplicationProtectionContainerMapping"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230801:ReplicationProtectionContainerMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationProtectionContainerMapping(ctx *pulumi.Context,
	...
	var resource ReplicationProtectionContainerMapping
	err := ctx.ReadResource("azure-native:recoveryservices/v20230801:ReplicationProtectionContainerMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
