...
func NewReplicationMigrationItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ReplicationMigrationItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ReplicationMigrationItem"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230801:ReplicationMigrationItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationMigrationItem(ctx *pulumi.Context,
	...
	var resource ReplicationMigrationItem
	err := ctx.ReadResource("azure-native:recoveryservices/v20230801:ReplicationMigrationItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
