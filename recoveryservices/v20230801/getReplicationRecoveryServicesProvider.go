...
func LookupReplicationRecoveryServicesProvider(ctx *pulumi.Context, args *LookupReplicationRecoveryServicesProviderArgs, opts ...pulumi.InvokeOption) (*LookupReplicationRecoveryServicesProviderResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20230801:getReplicationRecoveryServicesProvider", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationRecoveryServicesProviderOutput(ctx *pulumi.Context, args LookupReplicationRecoveryServicesProviderOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationRecoveryServicesProviderResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationRecoveryServicesProviderResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20230801:getReplicationRecoveryServicesProvider", args, LookupReplicationRecoveryServicesProviderResultOutput{}, options).(LookupReplicationRecoveryServicesProviderResultOutput), nil
