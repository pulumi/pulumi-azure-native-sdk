...
func NewReplicationFabric(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ReplicationFabric"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReplicationFabric
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230601:ReplicationFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationFabric(ctx *pulumi.Context,
	...
	var resource ReplicationFabric
	err := ctx.ReadResource("azure-native:recoveryservices/v20230601:ReplicationFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
