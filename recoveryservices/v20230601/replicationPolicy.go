...
func NewReplicationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230601:ReplicationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationPolicy(ctx *pulumi.Context,
	...
	var resource ReplicationPolicy
	err := ctx.ReadResource("azure-native:recoveryservices/v20230601:ReplicationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
