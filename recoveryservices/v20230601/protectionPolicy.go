...
func NewProtectionPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20220401:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20220601preview:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20220901preview:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20220930preview:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20221001:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230101:ProtectionPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ProtectionPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240430preview:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240730preview:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ProtectionPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241101preview:ProtectionPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230601:ProtectionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionPolicy(ctx *pulumi.Context,
	...
	var resource ProtectionPolicy
	err := ctx.ReadResource("azure-native:recoveryservices/v20230601:ProtectionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
