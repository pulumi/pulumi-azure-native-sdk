...
func NewProtectionIntent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20210601:ProtectionIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionIntent(ctx *pulumi.Context,
	...
	var resource ProtectionIntent
	err := ctx.ReadResource("azure-native:recoveryservices/v20210601:ProtectionIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
