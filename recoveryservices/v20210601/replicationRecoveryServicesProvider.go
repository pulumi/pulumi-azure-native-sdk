...
// Provider details.
//
// Deprecated: azure-native:recoveryservices/v20210601:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.
...
func NewReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20210601:ReplicationRecoveryServicesProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	var resource ReplicationRecoveryServicesProvider
	err := ctx.ReadResource("azure-native:recoveryservices/v20210601:ReplicationRecoveryServicesProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
