...
func NewReplicationStorageClassificationMapping(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationStorageClassificationMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationStorageClassificationMapping"),
		},
	})
...
// The Azure API version of the resource.
func (o ReplicationStorageClassificationMappingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ReplicationStorageClassificationMapping) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
