...
func NewProtectionIntent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230401:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240730preview:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ProtectionIntent"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241101preview:ProtectionIntent"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20240430preview:ProtectionIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionIntent(ctx *pulumi.Context,
	...
	var resource ProtectionIntent
	err := ctx.ReadResource("azure-native:recoveryservices/v20240430preview:ProtectionIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
