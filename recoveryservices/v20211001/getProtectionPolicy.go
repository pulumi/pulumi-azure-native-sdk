...
//
// Deprecated: azure-native:recoveryservices/v20211001:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionPolicy to guarantee forwards compatibility.
func LookupProtectionPolicy(ctx *pulumi.Context, args *LookupProtectionPolicyArgs, opts ...pulumi.InvokeOption) (*LookupProtectionPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20211001:getProtectionPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
