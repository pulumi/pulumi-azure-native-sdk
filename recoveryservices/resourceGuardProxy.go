...
func NewResourceGuardProxy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230401:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ResourceGuardProxy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240730preview:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241101preview:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250228preview:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101preview:ResourceGuardProxy"),
		},
	})
...
// The Azure API version of the resource.
func (o ResourceGuardProxyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ResourceGuardProxy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
