...
func NewResourceGuardProxy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260131preview:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ResourceGuardProxy"),
		},
	})
