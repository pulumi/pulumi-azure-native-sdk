...
func NewReplicationPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationPolicy"),
		},
	})
...
// The Azure API version of the resource.
func (o ReplicationPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ReplicationPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
