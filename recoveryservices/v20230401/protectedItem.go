...
func NewProtectedItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230401:ProtectedItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectedItem(ctx *pulumi.Context,
	...
	var resource ProtectedItem
	err := ctx.ReadResource("azure-native:recoveryservices/v20230401:ProtectedItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
