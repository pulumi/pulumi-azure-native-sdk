...
func NewReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230101:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230201:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ReplicationRecoveryServicesProvider"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ReplicationRecoveryServicesProvider"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReplicationRecoveryServicesProvider
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230401:ReplicationRecoveryServicesProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	var resource ReplicationRecoveryServicesProvider
	err := ctx.ReadResource("azure-native:recoveryservices/v20230401:ReplicationRecoveryServicesProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
