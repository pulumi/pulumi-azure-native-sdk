...
func NewReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ReplicationRecoveryPlan"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ReplicationRecoveryPlan"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReplicationRecoveryPlan
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230401:ReplicationRecoveryPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationRecoveryPlan(ctx *pulumi.Context,
	...
	var resource ReplicationRecoveryPlan
	err := ctx.ReadResource("azure-native:recoveryservices/v20230401:ReplicationRecoveryPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
