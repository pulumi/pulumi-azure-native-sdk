...
func NewReplicationMigrationItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20230401:ReplicationMigrationItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationMigrationItem(ctx *pulumi.Context,
	...
	var resource ReplicationMigrationItem
	err := ctx.ReadResource("azure-native:recoveryservices/v20230401:ReplicationMigrationItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
