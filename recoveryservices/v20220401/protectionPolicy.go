...
//
// Deprecated: azure-native:recoveryservices/v20220401:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionPolicy to guarantee forwards compatibility.
...
func NewProtectionPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220401:ProtectionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionPolicy(ctx *pulumi.Context,
	...
	var resource ProtectionPolicy
	err := ctx.ReadResource("azure-native:recoveryservices/v20220401:ProtectionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
