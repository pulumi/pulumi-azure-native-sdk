...
func NewReplicationProtectedItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220401:ReplicationProtectedItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationProtectedItem(ctx *pulumi.Context,
	...
	var resource ReplicationProtectedItem
	err := ctx.ReadResource("azure-native:recoveryservices/v20220401:ReplicationProtectedItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
