...
// Fabric definition.
//
// Deprecated: azure-native:recoveryservices/v20220401:ReplicationFabric is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.
...
func NewReplicationFabric(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220401:ReplicationFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationFabric(ctx *pulumi.Context,
	...
	var resource ReplicationFabric
	err := ctx.ReadResource("azure-native:recoveryservices/v20220401:ReplicationFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
