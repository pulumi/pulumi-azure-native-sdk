...
func NewReplicationNetworkMapping(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationNetworkMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationNetworkMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationNetworkMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationNetworkMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationNetworkMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationNetworkMapping"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationNetworkMapping"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReplicationNetworkMapping
	err := ctx.RegisterResource("azure-native:recoveryservices:ReplicationNetworkMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationNetworkMapping(ctx *pulumi.Context,
	...
	var resource ReplicationNetworkMapping
	err := ctx.ReadResource("azure-native:recoveryservices:ReplicationNetworkMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ReplicationNetworkMappingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ReplicationNetworkMapping) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
