...
func NewProtectionPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20210101:ProtectionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionPolicy(ctx *pulumi.Context,
	...
	var resource ProtectionPolicy
	err := ctx.ReadResource("azure-native:recoveryservices/v20210101:ProtectionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
