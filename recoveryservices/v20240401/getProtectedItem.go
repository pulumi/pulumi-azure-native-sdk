...
func LookupProtectedItem(ctx *pulumi.Context, args *LookupProtectedItemArgs, opts ...pulumi.InvokeOption) (*LookupProtectedItemResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20240401:getProtectedItem", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupProtectedItemOutput(ctx *pulumi.Context, args LookupProtectedItemOutputArgs, opts ...pulumi.InvokeOption) LookupProtectedItemResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupProtectedItemResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20240401:getProtectedItem", args, LookupProtectedItemResultOutput{}, options).(LookupProtectedItemResultOutput), nil
