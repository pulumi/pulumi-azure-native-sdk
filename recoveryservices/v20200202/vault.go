...
func NewVault(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:Vault"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:Vault"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:Vault"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240430preview:Vault"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240930preview:Vault"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:Vault"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Vault
	err := ctx.RegisterResource("azure-native:recoveryservices/v20200202:Vault", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVault(ctx *pulumi.Context,
	...
	var resource Vault
	err := ctx.ReadResource("azure-native:recoveryservices/v20200202:Vault", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
