...
func LookupReplicationvCenter(ctx *pulumi.Context, args *LookupReplicationvCenterArgs, opts ...pulumi.InvokeOption) (*LookupReplicationvCenterResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20240101:getReplicationvCenter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationvCenterOutput(ctx *pulumi.Context, args LookupReplicationvCenterOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationvCenterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationvCenterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20240101:getReplicationvCenter", args, LookupReplicationvCenterResultOutput{}, options).(LookupReplicationvCenterResultOutput), nil
