...
func LookupProtectionPolicy(ctx *pulumi.Context, args *LookupProtectionPolicyArgs, opts ...pulumi.InvokeOption) (*LookupProtectionPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20240101:getProtectionPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupProtectionPolicyOutput(ctx *pulumi.Context, args LookupProtectionPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupProtectionPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupProtectionPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20240101:getProtectionPolicy", args, LookupProtectionPolicyResultOutput{}, options).(LookupProtectionPolicyResultOutput), nil
