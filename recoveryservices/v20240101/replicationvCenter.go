...
func NewReplicationvCenter(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ReplicationvCenter"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20240101:ReplicationvCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationvCenter(ctx *pulumi.Context,
	...
	var resource ReplicationvCenter
	err := ctx.ReadResource("azure-native:recoveryservices/v20240101:ReplicationvCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
