...
//
// Deprecated: azure-native:recoveryservices/v20220131preview:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:Vault to guarantee forwards compatibility.
