...
func NewProtectedItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20220930preview:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20221001:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230101:ProtectedItem"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230601:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20230801:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240101:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240201:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240401:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20240430preview:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20241001:ProtectedItem"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ProtectedItem
	err := ctx.RegisterResource("azure-native:recoveryservices/v20240730preview:ProtectedItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectedItem(ctx *pulumi.Context,
	...
	var resource ProtectedItem
	err := ctx.ReadResource("azure-native:recoveryservices/v20240730preview:ProtectedItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
