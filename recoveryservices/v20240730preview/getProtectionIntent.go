...
func LookupProtectionIntent(ctx *pulumi.Context, args *LookupProtectionIntentArgs, opts ...pulumi.InvokeOption) (*LookupProtectionIntentResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20240730preview:getProtectionIntent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupProtectionIntentOutput(ctx *pulumi.Context, args LookupProtectionIntentOutputArgs, opts ...pulumi.InvokeOption) LookupProtectionIntentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupProtectionIntentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:recoveryservices/v20240730preview:getProtectionIntent", args, LookupProtectionIntentResultOutput{}, options).(LookupProtectionIntentResultOutput), nil
