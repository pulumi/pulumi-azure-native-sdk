...
//
// Deprecated: azure-native:recoveryservices/v20221001:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.
func LookupReplicationRecoveryServicesProvider(ctx *pulumi.Context, args *LookupReplicationRecoveryServicesProviderArgs, opts ...pulumi.InvokeOption) (*LookupReplicationRecoveryServicesProviderResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20221001:getReplicationRecoveryServicesProvider", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
