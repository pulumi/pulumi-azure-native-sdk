...
func NewReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20221001:ReplicationRecoveryServicesProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationRecoveryServicesProvider(ctx *pulumi.Context,
	...
	var resource ReplicationRecoveryServicesProvider
	err := ctx.ReadResource("azure-native:recoveryservices/v20221001:ReplicationRecoveryServicesProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
