...
func NewReplicationvCenter(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ReplicationvCenter"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ReplicationvCenter"),
		},
	})
