...
//
// Deprecated: azure-native:recoveryservices/v20230101:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:Vault to guarantee forwards compatibility.
func LookupVault(ctx *pulumi.Context, args *LookupVaultArgs, opts ...pulumi.InvokeOption) (*LookupVaultResult, error) {
	var rv LookupVaultResult
	err := ctx.Invoke("azure-native:recoveryservices/v20230101:getVault", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
