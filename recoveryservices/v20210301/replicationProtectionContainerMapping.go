...
func NewReplicationProtectionContainerMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20210301:ReplicationProtectionContainerMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationProtectionContainerMapping(ctx *pulumi.Context,
	...
	var resource ReplicationProtectionContainerMapping
	err := ctx.ReadResource("azure-native:recoveryservices/v20210301:ReplicationProtectionContainerMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
