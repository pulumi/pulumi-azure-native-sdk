...
//
// Deprecated: azure-native:recoveryservices/v20210301:ReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationPolicy to guarantee forwards compatibility.
func LookupReplicationPolicy(ctx *pulumi.Context, args *LookupReplicationPolicyArgs, opts ...pulumi.InvokeOption) (*LookupReplicationPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20210301:getReplicationPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
