...
func NewReplicationvCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220301:ReplicationvCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationvCenter(ctx *pulumi.Context,
	...
	var resource ReplicationvCenter
	err := ctx.ReadResource("azure-native:recoveryservices/v20220301:ReplicationvCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
