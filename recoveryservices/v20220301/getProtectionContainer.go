...
//
// Deprecated: azure-native:recoveryservices/v20220301:ProtectionContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionContainer to guarantee forwards compatibility.
func LookupProtectionContainer(ctx *pulumi.Context, args *LookupProtectionContainerArgs, opts ...pulumi.InvokeOption) (*LookupProtectionContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20220301:getProtectionContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
