...
func NewProtectedItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250101:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250201:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250228preview:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20250801:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260101:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260131preview:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260201:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260331preview:ProtectedItem"),
		},
		{
			Type: pulumi.String("azure-native:recoveryservices/v20260501:ProtectedItem"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ProtectedItem
	err := ctx.RegisterResource("azure-native:recoveryservices:ProtectedItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectedItem(ctx *pulumi.Context,
	...
	var resource ProtectedItem
	err := ctx.ReadResource("azure-native:recoveryservices:ProtectedItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
