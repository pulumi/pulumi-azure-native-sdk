...
//
// Deprecated: azure-native:recoveryservices/v20220801:ReplicationvCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationvCenter to guarantee forwards compatibility.
func LookupReplicationvCenter(ctx *pulumi.Context, args *LookupReplicationvCenterArgs, opts ...pulumi.InvokeOption) (*LookupReplicationvCenterResult, error) {
	...
	err := ctx.Invoke("azure-native:recoveryservices/v20220801:getReplicationvCenter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
