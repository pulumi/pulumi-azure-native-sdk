...
func NewReplicationStorageClassificationMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20220801:ReplicationStorageClassificationMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationStorageClassificationMapping(ctx *pulumi.Context,
	...
	var resource ReplicationStorageClassificationMapping
	err := ctx.ReadResource("azure-native:recoveryservices/v20220801:ReplicationStorageClassificationMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
