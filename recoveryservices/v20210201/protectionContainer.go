...
func NewProtectionContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recoveryservices/v20210201:ProtectionContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionContainer(ctx *pulumi.Context,
	...
	var resource ProtectionContainer
	err := ctx.ReadResource("azure-native:recoveryservices/v20210201:ProtectionContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
