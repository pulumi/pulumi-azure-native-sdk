...
func NewVolume(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20240601preview:Volume"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20240701:Volume"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20241001preview:Volume"),
		},
		{
	...
	var resource Volume
	err := ctx.RegisterResource("azure-native:networkcloud/v20250201:Volume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.ReadResource("azure-native:networkcloud/v20250201:Volume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
