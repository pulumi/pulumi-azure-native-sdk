...
func LookupL3Network(ctx *pulumi.Context, args *LookupL3NetworkArgs, opts ...pulumi.InvokeOption) (*LookupL3NetworkResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20250201:getL3Network", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupL3NetworkOutput(ctx *pulumi.Context, args LookupL3NetworkOutputArgs, opts ...pulumi.InvokeOption) LookupL3NetworkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupL3NetworkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20250201:getL3Network", args, LookupL3NetworkResultOutput{}, options).(LookupL3NetworkResultOutput), nil
...
// Resource ETag.
func (o LookupL3NetworkResultOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v LookupL3NetworkResult) string { return v.Etag }).(pulumi.StringOutput)
}
