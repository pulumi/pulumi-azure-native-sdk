...
func NewRack(ctx *pulumi.Context,
	...
	var resource Rack
	err := ctx.RegisterResource("azure-native:networkcloud/v20250201:Rack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRack(ctx *pulumi.Context,
	...
	var resource Rack
	err := ctx.ReadResource("azure-native:networkcloud/v20250201:Rack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
