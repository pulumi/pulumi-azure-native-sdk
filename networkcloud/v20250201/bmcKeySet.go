...
func NewBmcKeySet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20250201:BmcKeySet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBmcKeySet(ctx *pulumi.Context,
	...
	var resource BmcKeySet
	err := ctx.ReadResource("azure-native:networkcloud/v20250201:BmcKeySet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
