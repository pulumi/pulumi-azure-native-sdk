...
func LookupConsoleOutput(ctx *pulumi.Context, args LookupConsoleOutputArgs, opts ...pulumi.InvokeOption) LookupConsoleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConsoleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud:getConsole", args, LookupConsoleResultOutput{}, options).(LookupConsoleResultOutput), nil
...
// Resource ETag.
func (o LookupConsoleResultOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v LookupConsoleResult) string { return v.Etag }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupConsoleResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupConsoleResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
