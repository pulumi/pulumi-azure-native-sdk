...
func NewClusterManager(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20221212preview:ClusterManager"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20230501preview:ClusterManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterManager(ctx *pulumi.Context,
	...
	var resource ClusterManager
	err := ctx.ReadResource("azure-native:networkcloud/v20230501preview:ClusterManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
