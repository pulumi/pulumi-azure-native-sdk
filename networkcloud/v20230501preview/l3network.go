...
func NewL3Network(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20230501preview:L3Network", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetL3Network(ctx *pulumi.Context,
	...
	var resource L3Network
	err := ctx.ReadResource("azure-native:networkcloud/v20230501preview:L3Network", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
