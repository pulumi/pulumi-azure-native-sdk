...
func NewKubernetesCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20240701:KubernetesCluster"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20250701preview:KubernetesCluster"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20250901:KubernetesCluster"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260101preview:KubernetesCluster"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o KubernetesClusterOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *KubernetesCluster) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
