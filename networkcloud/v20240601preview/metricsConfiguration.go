...
func NewMetricsConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20250201:MetricsConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20240601preview:MetricsConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetricsConfiguration(ctx *pulumi.Context,
	...
	var resource MetricsConfiguration
	err := ctx.ReadResource("azure-native:networkcloud/v20240601preview:MetricsConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
