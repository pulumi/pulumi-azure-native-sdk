...
func NewBareMetalMachine(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20250901:BareMetalMachine"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260101preview:BareMetalMachine"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260501preview:BareMetalMachine"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260701:BareMetalMachine"),
		},
	})
