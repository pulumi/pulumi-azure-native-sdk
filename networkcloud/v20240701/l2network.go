...
func NewL2Network(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20240701:L2Network", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetL2Network(ctx *pulumi.Context,
	...
	var resource L2Network
	err := ctx.ReadResource("azure-native:networkcloud/v20240701:L2Network", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
