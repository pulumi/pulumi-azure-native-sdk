...
func LookupBmcKeySet(ctx *pulumi.Context, args *LookupBmcKeySetArgs, opts ...pulumi.InvokeOption) (*LookupBmcKeySetResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20240701:getBmcKeySet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBmcKeySetOutput(ctx *pulumi.Context, args LookupBmcKeySetOutputArgs, opts ...pulumi.InvokeOption) LookupBmcKeySetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBmcKeySetResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20240701:getBmcKeySet", args, LookupBmcKeySetResultOutput{}, options).(LookupBmcKeySetResultOutput), nil
