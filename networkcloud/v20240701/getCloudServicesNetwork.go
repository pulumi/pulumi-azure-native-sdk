...
func LookupCloudServicesNetwork(ctx *pulumi.Context, args *LookupCloudServicesNetworkArgs, opts ...pulumi.InvokeOption) (*LookupCloudServicesNetworkResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20240701:getCloudServicesNetwork", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupCloudServicesNetworkOutput(ctx *pulumi.Context, args LookupCloudServicesNetworkOutputArgs, opts ...pulumi.InvokeOption) LookupCloudServicesNetworkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCloudServicesNetworkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20240701:getCloudServicesNetwork", args, LookupCloudServicesNetworkResultOutput{}, options).(LookupCloudServicesNetworkResultOutput), nil
