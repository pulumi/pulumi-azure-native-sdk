...
func NewCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20240701:Cluster"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20241001preview:Cluster"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20250201:Cluster"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20250901:Cluster"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260101preview:Cluster"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260501preview:Cluster"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260701:Cluster"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Cluster
	err := ctx.RegisterResource("azure-native:networkcloud:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azure-native:networkcloud:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
