...
func LookupRack(ctx *pulumi.Context, args *LookupRackArgs, opts ...pulumi.InvokeOption) (*LookupRackResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20241001preview:getRack", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRackOutput(ctx *pulumi.Context, args LookupRackOutputArgs, opts ...pulumi.InvokeOption) LookupRackResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRackResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20241001preview:getRack", args, LookupRackResultOutput{}, options).(LookupRackResultOutput), nil
