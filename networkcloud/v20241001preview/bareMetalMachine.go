...
type BareMetalMachine struct {
	...
	MachineRoles pulumi.StringArrayOutput `pulumi:"machineRoles"`
...
func NewBareMetalMachine(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20240601preview:BareMetalMachine"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20240701:BareMetalMachine"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20250201:BareMetalMachine"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20241001preview:BareMetalMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBareMetalMachine(ctx *pulumi.Context,
	...
	var resource BareMetalMachine
	err := ctx.ReadResource("azure-native:networkcloud/v20241001preview:BareMetalMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The list of roles that are assigned to the cluster node running on this machine.
func (o BareMetalMachineOutput) MachineRoles() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *BareMetalMachine) pulumi.StringArrayOutput { return v.MachineRoles }).(pulumi.StringArrayOutput)
}
