...
func NewConsole(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20240701:Console"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20241001preview:Console", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsole(ctx *pulumi.Context,
	...
	var resource Console
	err := ctx.ReadResource("azure-native:networkcloud/v20241001preview:Console", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
