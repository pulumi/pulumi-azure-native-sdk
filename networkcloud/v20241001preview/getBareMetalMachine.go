...
func LookupBareMetalMachine(ctx *pulumi.Context, args *LookupBareMetalMachineArgs, opts ...pulumi.InvokeOption) (*LookupBareMetalMachineResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20241001preview:getBareMetalMachine", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBareMetalMachineOutput(ctx *pulumi.Context, args LookupBareMetalMachineOutputArgs, opts ...pulumi.InvokeOption) LookupBareMetalMachineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBareMetalMachineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20241001preview:getBareMetalMachine", args, LookupBareMetalMachineResultOutput{}, options).(LookupBareMetalMachineResultOutput), nil
