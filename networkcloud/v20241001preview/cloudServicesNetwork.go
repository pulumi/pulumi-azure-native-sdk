...
func NewCloudServicesNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20241001preview:CloudServicesNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudServicesNetwork(ctx *pulumi.Context,
	...
	var resource CloudServicesNetwork
	err := ctx.ReadResource("azure-native:networkcloud/v20241001preview:CloudServicesNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
