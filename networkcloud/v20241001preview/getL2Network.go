...
func LookupL2Network(ctx *pulumi.Context, args *LookupL2NetworkArgs, opts ...pulumi.InvokeOption) (*LookupL2NetworkResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20241001preview:getL2Network", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupL2NetworkOutput(ctx *pulumi.Context, args LookupL2NetworkOutputArgs, opts ...pulumi.InvokeOption) LookupL2NetworkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupL2NetworkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20241001preview:getL2Network", args, LookupL2NetworkResultOutput{}, options).(LookupL2NetworkResultOutput), nil
