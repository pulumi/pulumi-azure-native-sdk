...
func LookupVolume(ctx *pulumi.Context, args *LookupVolumeArgs, opts ...pulumi.InvokeOption) (*LookupVolumeResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20241001preview:getVolume", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVolumeOutput(ctx *pulumi.Context, args LookupVolumeOutputArgs, opts ...pulumi.InvokeOption) LookupVolumeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVolumeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20241001preview:getVolume", args, LookupVolumeResultOutput{}, options).(LookupVolumeResultOutput), nil
