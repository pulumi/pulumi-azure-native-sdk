...
func NewKubernetesClusterFeature(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20241001preview:KubernetesClusterFeature", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubernetesClusterFeature(ctx *pulumi.Context,
	...
	var resource KubernetesClusterFeature
	err := ctx.ReadResource("azure-native:networkcloud/v20241001preview:KubernetesClusterFeature", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
