...
func NewKubernetesCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20241001preview:KubernetesCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubernetesCluster(ctx *pulumi.Context,
	...
	var resource KubernetesCluster
	err := ctx.ReadResource("azure-native:networkcloud/v20241001preview:KubernetesCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
