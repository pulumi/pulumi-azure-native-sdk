...
func NewTrunkedNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20241001preview:TrunkedNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrunkedNetwork(ctx *pulumi.Context,
	...
	var resource TrunkedNetwork
	err := ctx.ReadResource("azure-native:networkcloud/v20241001preview:TrunkedNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
