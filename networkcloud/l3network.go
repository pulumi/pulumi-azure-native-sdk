...
func NewL3Network(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20240701:L3Network"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20250701preview:L3Network"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20250901:L3Network"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260101preview:L3Network"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource L3Network
	err := ctx.RegisterResource("azure-native:networkcloud:L3Network", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetL3Network(ctx *pulumi.Context,
	...
	var resource L3Network
	err := ctx.ReadResource("azure-native:networkcloud:L3Network", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o L3NetworkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *L3Network) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Resource ETag.
func (o L3NetworkOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v *L3Network) pulumi.StringOutput { return v.Etag }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o L3NetworkOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *L3Network) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
