...
func NewTrunkedNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20240601preview:TrunkedNetwork"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20240701:TrunkedNetwork"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20260501preview:TrunkedNetwork"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260701:TrunkedNetwork"),
		},
	})
