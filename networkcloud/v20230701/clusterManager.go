...
func NewClusterManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20230701:ClusterManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterManager(ctx *pulumi.Context,
	...
	var resource ClusterManager
	err := ctx.ReadResource("azure-native:networkcloud/v20230701:ClusterManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
