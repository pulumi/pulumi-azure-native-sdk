...
func NewBareMetalMachineKeySet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:networkcloud:BareMetalMachineKeySet"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20230701:BareMetalMachineKeySet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBareMetalMachineKeySet(ctx *pulumi.Context,
	...
	var resource BareMetalMachineKeySet
	err := ctx.ReadResource("azure-native:networkcloud/v20230701:BareMetalMachineKeySet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
