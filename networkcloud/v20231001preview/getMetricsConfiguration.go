...
func LookupMetricsConfiguration(ctx *pulumi.Context, args *LookupMetricsConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupMetricsConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20231001preview:getMetricsConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMetricsConfigurationOutput(ctx *pulumi.Context, args LookupMetricsConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupMetricsConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMetricsConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20231001preview:getMetricsConfiguration", args, LookupMetricsConfigurationResultOutput{}, options).(LookupMetricsConfigurationResultOutput), nil
