...
func NewVirtualMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20231001preview:VirtualMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachine(ctx *pulumi.Context,
	...
	var resource VirtualMachine
	err := ctx.ReadResource("azure-native:networkcloud/v20231001preview:VirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
