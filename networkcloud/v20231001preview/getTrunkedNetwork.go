...
func LookupTrunkedNetwork(ctx *pulumi.Context, args *LookupTrunkedNetworkArgs, opts ...pulumi.InvokeOption) (*LookupTrunkedNetworkResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20231001preview:getTrunkedNetwork", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupTrunkedNetworkOutput(ctx *pulumi.Context, args LookupTrunkedNetworkOutputArgs, opts ...pulumi.InvokeOption) LookupTrunkedNetworkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTrunkedNetworkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20231001preview:getTrunkedNetwork", args, LookupTrunkedNetworkResultOutput{}, options).(LookupTrunkedNetworkResultOutput), nil
