...
func LookupVirtualMachine(ctx *pulumi.Context, args *LookupVirtualMachineArgs, opts ...pulumi.InvokeOption) (*LookupVirtualMachineResult, error) {
	...
	err := ctx.Invoke("azure-native:networkcloud/v20231001preview:getVirtualMachine", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupVirtualMachineOutput(ctx *pulumi.Context, args LookupVirtualMachineOutputArgs, opts ...pulumi.InvokeOption) LookupVirtualMachineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVirtualMachineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:networkcloud/v20231001preview:getVirtualMachine", args, LookupVirtualMachineResultOutput{}, options).(LookupVirtualMachineResultOutput), nil
