...
func NewBareMetalMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20231001preview:BareMetalMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBareMetalMachine(ctx *pulumi.Context,
	...
	var resource BareMetalMachine
	err := ctx.ReadResource("azure-native:networkcloud/v20231001preview:BareMetalMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
