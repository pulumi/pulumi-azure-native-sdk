...
func NewMetricsConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20231001preview:MetricsConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetricsConfiguration(ctx *pulumi.Context,
	...
	var resource MetricsConfiguration
	err := ctx.ReadResource("azure-native:networkcloud/v20231001preview:MetricsConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
