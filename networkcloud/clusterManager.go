...
func NewClusterManager(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20250901:ClusterManager"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260101preview:ClusterManager"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260501preview:ClusterManager"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260701:ClusterManager"),
		},
	})
