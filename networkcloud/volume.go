...
func NewVolume(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20250201:Volume"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20250701preview:Volume"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20250901:Volume"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260101preview:Volume"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Volume
	err := ctx.RegisterResource("azure-native:networkcloud:Volume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.ReadResource("azure-native:networkcloud:Volume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o VolumeOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Volume) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
