...
func NewDefaultCniNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:networkcloud:DefaultCniNetwork"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DefaultCniNetwork
	err := ctx.RegisterResource("azure-native:networkcloud/v20221212preview:DefaultCniNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultCniNetwork(ctx *pulumi.Context,
	...
	var resource DefaultCniNetwork
	err := ctx.ReadResource("azure-native:networkcloud/v20221212preview:DefaultCniNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
