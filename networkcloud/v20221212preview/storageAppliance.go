...
func NewStorageAppliance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20221212preview:StorageAppliance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAppliance(ctx *pulumi.Context,
	...
	var resource StorageAppliance
	err := ctx.ReadResource("azure-native:networkcloud/v20221212preview:StorageAppliance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
