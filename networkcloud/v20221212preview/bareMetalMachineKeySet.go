...
func NewBareMetalMachineKeySet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBareMetalMachineKeySet(ctx *pulumi.Context,
	...
	var resource BareMetalMachineKeySet
	err := ctx.ReadResource("azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
