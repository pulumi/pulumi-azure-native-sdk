...
func NewCloudServicesNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20250701preview:CloudServicesNetwork"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20250901:CloudServicesNetwork"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260101preview:CloudServicesNetwork"),
		},
	})
...
// The Azure API version of the resource.
func (o CloudServicesNetworkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CloudServicesNetwork) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CloudServicesNetworkOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *CloudServicesNetwork) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
