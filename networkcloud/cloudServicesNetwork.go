...
func NewCloudServicesNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:networkcloud/v20260501preview:CloudServicesNetwork"),
		},
		{
			Type: pulumi.String("azure-native:networkcloud/v20260701:CloudServicesNetwork"),
		},
	})
