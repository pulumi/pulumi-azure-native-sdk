...
func (ResourceOrigin) ElementType() reflect.Type {
	return reflect.TypeOf((*ResourceOrigin)(nil)).Elem()
}

func (e ResourceOrigin) ToResourceOriginOutput() ResourceOriginOutput {
	return pulumi.ToOutput(e).(ResourceOriginOutput)
}

func (e ResourceOrigin) ToResourceOriginOutputWithContext(ctx context.Context) ResourceOriginOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ResourceOriginOutput)
}

func (e ResourceOrigin) ToResourceOriginPtrOutput() ResourceOriginPtrOutput {
	return e.ToResourceOriginPtrOutputWithContext(context.Background())
}

func (e ResourceOrigin) ToResourceOriginPtrOutputWithContext(ctx context.Context) ResourceOriginPtrOutput {
	return ResourceOrigin(e).ToResourceOriginOutputWithContext(ctx).ToResourceOriginPtrOutputWithContext(ctx)
}

func (e ResourceOrigin) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ResourceOrigin) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ResourceOrigin) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ResourceOrigin) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type ResourceOriginOutput struct{ *pulumi.OutputState }

func (ResourceOriginOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ResourceOrigin)(nil)).Elem()
}

func (o ResourceOriginOutput) ToResourceOriginOutput() ResourceOriginOutput {
	return o
}

func (o ResourceOriginOutput) ToResourceOriginOutputWithContext(ctx context.Context) ResourceOriginOutput {
	return o
}

func (o ResourceOriginOutput) ToResourceOriginPtrOutput() ResourceOriginPtrOutput {
	return o.ToResourceOriginPtrOutputWithContext(context.Background())
}

func (o ResourceOriginOutput) ToResourceOriginPtrOutputWithContext(ctx context.Context) ResourceOriginPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ResourceOrigin) *ResourceOrigin {
		return &v
	}).(ResourceOriginPtrOutput)
}

func (o ResourceOriginOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ResourceOriginOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ResourceOrigin) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ResourceOriginOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ResourceOriginOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ResourceOrigin) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type ResourceOriginPtrOutput struct{ *pulumi.OutputState }

func (ResourceOriginPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ResourceOrigin)(nil)).Elem()
}

func (o ResourceOriginPtrOutput) ToResourceOriginPtrOutput() ResourceOriginPtrOutput {
	return o
}

func (o ResourceOriginPtrOutput) ToResourceOriginPtrOutputWithContext(ctx context.Context) ResourceOriginPtrOutput {
	return o
}

func (o ResourceOriginPtrOutput) Elem() ResourceOriginOutput {
	return o.ApplyT(func(v *ResourceOrigin) ResourceOrigin {
		if v != nil {
			return *v
		}
		var ret ResourceOrigin
		return ret
	}).(ResourceOriginOutput)
}

func (o ResourceOriginPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ResourceOriginPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ResourceOrigin) *string {
		if e == nil {
			return nil
		}
...
// ResourceOriginInput is an input type that accepts values of the ResourceOrigin enum
// A concrete instance of `ResourceOriginInput` can be one of the following:
//
//	ResourceOriginAzure
//	ResourceOriginAWS
//	ResourceOriginGCP
type ResourceOriginInput interface {
	pulumi.Input

	ToResourceOriginOutput() ResourceOriginOutput
	ToResourceOriginOutputWithContext(context.Context) ResourceOriginOutput
}

var resourceOriginPtrType = reflect.TypeOf((**ResourceOrigin)(nil)).Elem()

type ResourceOriginPtrInput interface {
	pulumi.Input

	ToResourceOriginPtrOutput() ResourceOriginPtrOutput
	ToResourceOriginPtrOutputWithContext(context.Context) ResourceOriginPtrOutput
}

type resourceOriginPtr string

func ResourceOriginPtr(v string) ResourceOriginPtrInput {
	return (*resourceOriginPtr)(&v)
}

func (*resourceOriginPtr) ElementType() reflect.Type {
	return resourceOriginPtrType
}

func (in *resourceOriginPtr) ToResourceOriginPtrOutput() ResourceOriginPtrOutput {
	return pulumi.ToOutput(in).(ResourceOriginPtrOutput)
}

func (in *resourceOriginPtr) ToResourceOriginPtrOutputWithContext(ctx context.Context) ResourceOriginPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ResourceOriginPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ResourceOriginOutput{})
	pulumi.RegisterOutputType(ResourceOriginPtrOutput{})
