...
func NewEvidence(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:appcomplianceautomation:Evidence"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Evidence
	err := ctx.RegisterResource("azure-native:appcomplianceautomation/v20240627:Evidence", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEvidence(ctx *pulumi.Context,
	...
	var resource Evidence
	err := ctx.ReadResource("azure-native:appcomplianceautomation/v20240627:Evidence", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
