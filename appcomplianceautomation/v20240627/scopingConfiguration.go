...
func NewScopingConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:appcomplianceautomation:ScopingConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ScopingConfiguration
	err := ctx.RegisterResource("azure-native:appcomplianceautomation/v20240627:ScopingConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopingConfiguration(ctx *pulumi.Context,
	...
	var resource ScopingConfiguration
	err := ctx.ReadResource("azure-native:appcomplianceautomation/v20240627:ScopingConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
