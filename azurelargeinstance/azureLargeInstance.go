...
func NewAzureLargeInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:azurelargeinstance/v20240801preview:AzureLargeInstance"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AzureLargeInstance
	err := ctx.RegisterResource("azure-native:azurelargeinstance:AzureLargeInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureLargeInstance(ctx *pulumi.Context,
	...
	var resource AzureLargeInstance
	err := ctx.ReadResource("azure-native:azurelargeinstance:AzureLargeInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
