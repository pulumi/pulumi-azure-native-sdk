...
func NewAzureLargeStorageInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:azurelargeinstance:AzureLargeStorageInstance"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AzureLargeStorageInstance
	err := ctx.RegisterResource("azure-native:azurelargeinstance/v20240801preview:AzureLargeStorageInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureLargeStorageInstance(ctx *pulumi.Context,
	...
	var resource AzureLargeStorageInstance
	err := ctx.ReadResource("azure-native:azurelargeinstance/v20240801preview:AzureLargeStorageInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
