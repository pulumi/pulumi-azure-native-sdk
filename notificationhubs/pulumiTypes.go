...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PrivateEndpointConnectionResourceResponseOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v PrivateEndpointConnectionResourceResponse) commontypesv5.SystemDataResponse {
		return v.SystemData
