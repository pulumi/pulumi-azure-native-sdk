...
func GetNotificationHubPnsCredentials(ctx *pulumi.Context, args *GetNotificationHubPnsCredentialsArgs, opts ...pulumi.InvokeOption) (*GetNotificationHubPnsCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:notificationhubs/v20230101preview:getNotificationHubPnsCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetNotificationHubPnsCredentialsOutput(ctx *pulumi.Context, args GetNotificationHubPnsCredentialsOutputArgs, opts ...pulumi.InvokeOption) GetNotificationHubPnsCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetNotificationHubPnsCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:notificationhubs/v20230101preview:getNotificationHubPnsCredentials", args, GetNotificationHubPnsCredentialsResultOutput{}, options).(GetNotificationHubPnsCredentialsResultOutput), nil
