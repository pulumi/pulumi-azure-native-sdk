...
func NewNotificationHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:notificationhubs/v20231001preview:NotificationHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationHub(ctx *pulumi.Context,
	...
	var resource NotificationHub
	err := ctx.ReadResource("azure-native:notificationhubs/v20231001preview:NotificationHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
