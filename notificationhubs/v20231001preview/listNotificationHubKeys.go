...
func ListNotificationHubKeys(ctx *pulumi.Context, args *ListNotificationHubKeysArgs, opts ...pulumi.InvokeOption) (*ListNotificationHubKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:notificationhubs/v20231001preview:listNotificationHubKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListNotificationHubKeysOutput(ctx *pulumi.Context, args ListNotificationHubKeysOutputArgs, opts ...pulumi.InvokeOption) ListNotificationHubKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListNotificationHubKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:notificationhubs/v20231001preview:listNotificationHubKeys", args, ListNotificationHubKeysResultOutput{}, options).(ListNotificationHubKeysResultOutput), nil
