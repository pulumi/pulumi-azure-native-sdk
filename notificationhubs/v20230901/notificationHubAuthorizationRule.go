...
func NewNotificationHubAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:notificationhubs/v20230901:NotificationHubAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationHubAuthorizationRule(ctx *pulumi.Context,
	...
	var resource NotificationHubAuthorizationRule
	err := ctx.ReadResource("azure-native:notificationhubs/v20230901:NotificationHubAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
