...
func LookupNotificationHubAuthorizationRuleOutput(ctx *pulumi.Context, args LookupNotificationHubAuthorizationRuleOutputArgs, opts ...pulumi.InvokeOption) LookupNotificationHubAuthorizationRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNotificationHubAuthorizationRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:notificationhubs:getNotificationHubAuthorizationRule", args, LookupNotificationHubAuthorizationRuleResultOutput{}, options).(LookupNotificationHubAuthorizationRuleResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupNotificationHubAuthorizationRuleResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNotificationHubAuthorizationRuleResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Gets a base64-encoded 256-bit primary key for signing and
// validating the SAS token.
func (o LookupNotificationHubAuthorizationRuleResultOutput) PrimaryKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupNotificationHubAuthorizationRuleResult) *string { return v.PrimaryKey }).(pulumi.StringPtrOutput)
}
...
// Gets a base64-encoded 256-bit primary key for signing and
// validating the SAS token.
func (o LookupNotificationHubAuthorizationRuleResultOutput) SecondaryKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupNotificationHubAuthorizationRuleResult) *string { return v.SecondaryKey }).(pulumi.StringPtrOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupNotificationHubAuthorizationRuleResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupNotificationHubAuthorizationRuleResult) commontypesv5.SystemDataResponse {
		return v.SystemData
