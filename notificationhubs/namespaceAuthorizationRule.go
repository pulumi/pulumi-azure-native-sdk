...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NamespaceAuthorizationRuleOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NamespaceAuthorizationRule) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
