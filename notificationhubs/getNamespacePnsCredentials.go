...
func GetNamespacePnsCredentials(ctx *pulumi.Context, args *GetNamespacePnsCredentialsArgs, opts ...pulumi.InvokeOption) (*GetNamespacePnsCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:notificationhubs:getNamespacePnsCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetNamespacePnsCredentialsOutput(ctx *pulumi.Context, args GetNamespacePnsCredentialsOutputArgs, opts ...pulumi.InvokeOption) GetNamespacePnsCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetNamespacePnsCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:notificationhubs:getNamespacePnsCredentials", args, GetNamespacePnsCredentialsResultOutput{}, options).(GetNamespacePnsCredentialsResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o GetNamespacePnsCredentialsResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v GetNamespacePnsCredentialsResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
