...
func NewSkusNestedResourceTypeFirst(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:providerhub/v20240901:SkusNestedResourceTypeFirst"),
		},
	})
...
func (o SkusNestedResourceTypeFirstOutput) Properties() SkuResourcePropertiesResponseOutput {
	return o.ApplyT(func(v *SkusNestedResourceTypeFirst) SkuResourcePropertiesResponseOutput { return v.Properties }).(SkuResourcePropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SkusNestedResourceTypeFirstOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *SkusNestedResourceTypeFirst) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
