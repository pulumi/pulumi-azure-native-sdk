...
func NewDefaultRollout(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:providerhub/v20210901preview:DefaultRollout", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultRollout(ctx *pulumi.Context,
	...
	var resource DefaultRollout
	err := ctx.ReadResource("azure-native:providerhub/v20210901preview:DefaultRollout", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
