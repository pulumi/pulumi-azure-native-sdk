...
func (o LookupSkusNestedResourceTypeThirdResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSkusNestedResourceTypeThirdResult] {
	return pulumix.Output[LookupSkusNestedResourceTypeThirdResult]{
