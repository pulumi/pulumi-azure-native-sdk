...
//
// Deprecated: azure-native:providerhub/v20201120:SkusNestedResourceTypeSecond is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond to guarantee forwards compatibility.
func LookupSkusNestedResourceTypeSecond(ctx *pulumi.Context, args *LookupSkusNestedResourceTypeSecondArgs, opts ...pulumi.InvokeOption) (*LookupSkusNestedResourceTypeSecondResult, error) {
	...
	err := ctx.Invoke("azure-native:providerhub/v20201120:getSkusNestedResourceTypeSecond", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
