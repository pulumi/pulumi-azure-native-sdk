...
//
// Deprecated: azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird to guarantee forwards compatibility.
func LookupSkusNestedResourceTypeThird(ctx *pulumi.Context, args *LookupSkusNestedResourceTypeThirdArgs, opts ...pulumi.InvokeOption) (*LookupSkusNestedResourceTypeThirdResult, error) {
	...
	err := ctx.Invoke("azure-native:providerhub/v20210501preview:getSkusNestedResourceTypeThird", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
