...
func NewNotificationRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:providerhub/v20210501preview:NotificationRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationRegistration(ctx *pulumi.Context,
	...
	var resource NotificationRegistration
	err := ctx.ReadResource("azure-native:providerhub/v20210501preview:NotificationRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
