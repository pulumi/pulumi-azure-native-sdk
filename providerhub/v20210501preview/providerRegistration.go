...
func NewProviderRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:providerhub/v20210501preview:ProviderRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProviderRegistration(ctx *pulumi.Context,
	...
	var resource ProviderRegistration
	err := ctx.ReadResource("azure-native:providerhub/v20210501preview:ProviderRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
