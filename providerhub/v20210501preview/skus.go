...
func NewSkus(ctx *pulumi.Context,
	...
	var resource Skus
	err := ctx.RegisterResource("azure-native:providerhub/v20210501preview:Skus", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSkus(ctx *pulumi.Context,
	...
	var resource Skus
	err := ctx.ReadResource("azure-native:providerhub/v20210501preview:Skus", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
