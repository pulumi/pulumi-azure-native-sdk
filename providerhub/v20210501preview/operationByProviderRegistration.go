...
func NewOperationByProviderRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:providerhub/v20210501preview:OperationByProviderRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOperationByProviderRegistration(ctx *pulumi.Context,
	...
	var resource OperationByProviderRegistration
	err := ctx.ReadResource("azure-native:providerhub/v20210501preview:OperationByProviderRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
