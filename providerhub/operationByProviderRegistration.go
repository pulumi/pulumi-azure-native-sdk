...
func NewOperationByProviderRegistration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:providerhub/v20240901:OperationByProviderRegistration"),
		},
	})
...
// The Azure API version of the resource.
func (o OperationByProviderRegistrationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *OperationByProviderRegistration) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o OperationByProviderRegistrationOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *OperationByProviderRegistration) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
