...
// The Azure API version of the resource.
func (o DefaultRolloutOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DefaultRollout) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DefaultRolloutOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *DefaultRollout) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
