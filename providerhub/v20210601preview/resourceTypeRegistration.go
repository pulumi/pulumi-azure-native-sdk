...
// Deprecated: azure-native:providerhub/v20210601preview:ResourceTypeRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:ResourceTypeRegistration to guarantee forwards compatibility.
...
func NewResourceTypeRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:providerhub/v20210601preview:ResourceTypeRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceTypeRegistration(ctx *pulumi.Context,
	...
	var resource ResourceTypeRegistration
	err := ctx.ReadResource("azure-native:providerhub/v20210601preview:ResourceTypeRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
