...
func LookupSkusNestedResourceTypeSecondOutput(ctx *pulumi.Context, args LookupSkusNestedResourceTypeSecondOutputArgs, opts ...pulumi.InvokeOption) LookupSkusNestedResourceTypeSecondResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSkusNestedResourceTypeSecondResultOutput, error) {
			args := v.(LookupSkusNestedResourceTypeSecondArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:providerhub:getSkusNestedResourceTypeSecond", args, LookupSkusNestedResourceTypeSecondResultOutput{}, options).(LookupSkusNestedResourceTypeSecondResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSkusNestedResourceTypeSecondResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSkusNestedResourceTypeSecondResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
func (o LookupSkusNestedResourceTypeSecondResultOutput) Properties() SkuResourcePropertiesResponseOutput {
	return o.ApplyT(func(v LookupSkusNestedResourceTypeSecondResult) SkuResourcePropertiesResponse { return v.Properties }).(SkuResourcePropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSkusNestedResourceTypeSecondResultOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSkusNestedResourceTypeSecondResult) commontypesv6.SystemDataResponse { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
