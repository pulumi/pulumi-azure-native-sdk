...
// The Azure API version of the resource.
func (o ResourcePoolOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ResourcePool) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system data.
func (o ResourcePoolOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *ResourcePool) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
