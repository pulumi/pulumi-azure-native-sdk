...
func NewVMInstanceGuestAgent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:connectedvmwarevsphere/v20230301preview:VMInstanceGuestAgent"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere:VMInstanceGuestAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVMInstanceGuestAgent(ctx *pulumi.Context,
	...
	var resource VMInstanceGuestAgent
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere:VMInstanceGuestAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The resource id of the private link scope this machine is assigned to, if any.
func (o VMInstanceGuestAgentOutput) PrivateLinkScopeResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VMInstanceGuestAgent) pulumi.StringPtrOutput { return v.PrivateLinkScopeResourceId }).(pulumi.StringPtrOutput)
}
...
// The resource status information.
func (o VMInstanceGuestAgentOutput) Statuses() ResourceStatusResponseArrayOutput {
	return o.ApplyT(func(v *VMInstanceGuestAgent) ResourceStatusResponseArrayOutput { return v.Statuses }).(ResourceStatusResponseArrayOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o VMInstanceGuestAgentOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *VMInstanceGuestAgent) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
