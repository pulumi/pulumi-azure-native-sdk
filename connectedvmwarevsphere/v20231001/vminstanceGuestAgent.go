...
func NewVMInstanceGuestAgent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere/v20231001:VMInstanceGuestAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVMInstanceGuestAgent(ctx *pulumi.Context,
	...
	var resource VMInstanceGuestAgent
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere/v20231001:VMInstanceGuestAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
