...
// DiskModeInput is an input type that accepts values of the DiskMode enum
// A concrete instance of `DiskModeInput` can be one of the following:
//
//	DiskModePersistent
...
// FirmwareTypeInput is an input type that accepts values of the FirmwareType enum
// A concrete instance of `FirmwareTypeInput` can be one of the following:
//
//	FirmwareTypeBios
//	FirmwareTypeEfi
...
// IPAddressAllocationMethodInput is an input type that accepts values of the IPAddressAllocationMethod enum
// A concrete instance of `IPAddressAllocationMethodInput` can be one of the following:
//
...
// PowerOnBootOptionInput is an input type that accepts values of the PowerOnBootOption enum
// A concrete instance of `PowerOnBootOptionInput` can be one of the following:
//
