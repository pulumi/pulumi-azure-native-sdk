...
func NewInventoryItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere/v20230301preview:InventoryItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInventoryItem(ctx *pulumi.Context,
	...
	var resource InventoryItem
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere/v20230301preview:InventoryItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
