...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o HybridIdentityMetadatumOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *HybridIdentityMetadatum) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
