...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o InventoryItemOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *InventoryItem) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
