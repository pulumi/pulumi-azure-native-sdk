...
// Define the cluster.
//
// Deprecated: azure-native:connectedvmwarevsphere/v20220110preview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Cluster to guarantee forwards compatibility.
type Cluster struct {
...
func NewCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:connectedvmwarevsphere/v20201001preview:Cluster"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere/v20220110preview:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere/v20220110preview:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
