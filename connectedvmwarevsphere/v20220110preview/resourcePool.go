...
func NewResourcePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourcePool(ctx *pulumi.Context,
	...
	var resource ResourcePool
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
