...
func LookupVMInstanceGuestAgent(ctx *pulumi.Context, args *LookupVMInstanceGuestAgentArgs, opts ...pulumi.InvokeOption) (*LookupVMInstanceGuestAgentResult, error) {
	...
	err := ctx.Invoke("azure-native:connectedvmwarevsphere/v20231201:getVMInstanceGuestAgent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVMInstanceGuestAgentOutput(ctx *pulumi.Context, args LookupVMInstanceGuestAgentOutputArgs, opts ...pulumi.InvokeOption) LookupVMInstanceGuestAgentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVMInstanceGuestAgentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:connectedvmwarevsphere/v20231201:getVMInstanceGuestAgent", args, LookupVMInstanceGuestAgentResultOutput{}, options).(LookupVMInstanceGuestAgentResultOutput), nil
