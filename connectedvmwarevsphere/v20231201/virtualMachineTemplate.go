...
func NewVirtualMachineTemplate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineTemplate"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere/v20231201:VirtualMachineTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineTemplate(ctx *pulumi.Context,
	...
	var resource VirtualMachineTemplate
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere/v20231201:VirtualMachineTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
