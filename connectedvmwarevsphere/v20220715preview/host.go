...
func NewHost(ctx *pulumi.Context,
	...
	var resource Host
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere/v20220715preview:Host", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHost(ctx *pulumi.Context,
	...
	var resource Host
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere/v20220715preview:Host", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
