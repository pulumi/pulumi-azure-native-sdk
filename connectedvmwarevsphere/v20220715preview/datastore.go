...
func NewDatastore(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:connectedvmwarevsphere/v20230301preview:Datastore"),
		},
		{
			Type: pulumi.String("azure-native:connectedvmwarevsphere/v20231001:Datastore"),
		},
		{
			Type: pulumi.String("azure-native:connectedvmwarevsphere/v20231201:Datastore"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere/v20220715preview:Datastore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatastore(ctx *pulumi.Context,
	...
	var resource Datastore
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere/v20220715preview:Datastore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
