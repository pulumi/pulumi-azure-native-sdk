...
func NewVCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:connectedvmwarevsphere/v20220715preview:VCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVCenter(ctx *pulumi.Context,
	...
	var resource VCenter
	err := ctx.ReadResource("azure-native:connectedvmwarevsphere/v20220715preview:VCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
