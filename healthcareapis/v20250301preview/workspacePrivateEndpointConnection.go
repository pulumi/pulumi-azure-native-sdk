...
func NewWorkspacePrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:healthcareapis/v20230228:WorkspacePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:healthcareapis/v20230906:WorkspacePrivateEndpointConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:healthcareapis/v20240301:WorkspacePrivateEndpointConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20250301preview:WorkspacePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspacePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource WorkspacePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:healthcareapis/v20250301preview:WorkspacePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
