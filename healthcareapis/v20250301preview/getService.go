...
func LookupService(ctx *pulumi.Context, args *LookupServiceArgs, opts ...pulumi.InvokeOption) (*LookupServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:healthcareapis/v20250301preview:getService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServiceOutput(ctx *pulumi.Context, args LookupServiceOutputArgs, opts ...pulumi.InvokeOption) LookupServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:healthcareapis/v20250301preview:getService", args, LookupServiceResultOutput{}, options).(LookupServiceResultOutput), nil
