...
//
// Deprecated: azure-native:healthcareapis/v20221001preview:FhirService is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:FhirService to guarantee forwards compatibility.
