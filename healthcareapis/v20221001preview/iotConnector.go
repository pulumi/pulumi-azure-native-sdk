...
//
// Deprecated: azure-native:healthcareapis/v20221001preview:IotConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20221201:IotConnector to guarantee forwards compatibility.
...
func NewIotConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20221001preview:IotConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotConnector(ctx *pulumi.Context,
	...
	var resource IotConnector
	err := ctx.ReadResource("azure-native:healthcareapis/v20221001preview:IotConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
