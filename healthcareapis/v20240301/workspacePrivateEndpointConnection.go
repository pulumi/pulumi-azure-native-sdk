...
func NewWorkspacePrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20240301:WorkspacePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspacePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource WorkspacePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:healthcareapis/v20240301:WorkspacePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
