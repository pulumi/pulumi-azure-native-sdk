...
func LookupIotConnectorFhirDestination(ctx *pulumi.Context, args *LookupIotConnectorFhirDestinationArgs, opts ...pulumi.InvokeOption) (*LookupIotConnectorFhirDestinationResult, error) {
	...
	err := ctx.Invoke("azure-native:healthcareapis/v20240301:getIotConnectorFhirDestination", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupIotConnectorFhirDestinationOutput(ctx *pulumi.Context, args LookupIotConnectorFhirDestinationOutputArgs, opts ...pulumi.InvokeOption) LookupIotConnectorFhirDestinationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIotConnectorFhirDestinationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:healthcareapis/v20240301:getIotConnectorFhirDestination", args, LookupIotConnectorFhirDestinationResultOutput{}, options).(LookupIotConnectorFhirDestinationResultOutput), nil
