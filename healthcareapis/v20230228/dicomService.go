...
func NewDicomService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20230228:DicomService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDicomService(ctx *pulumi.Context,
	...
	var resource DicomService
	err := ctx.ReadResource("azure-native:healthcareapis/v20230228:DicomService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
