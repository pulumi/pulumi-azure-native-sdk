...
func NewIotConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:healthcareapis/v20231101:IotConnector"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20230228:IotConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotConnector(ctx *pulumi.Context,
	...
	var resource IotConnector
	err := ctx.ReadResource("azure-native:healthcareapis/v20230228:IotConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
