...
func LookupWorkspacePrivateEndpointConnection(ctx *pulumi.Context, args *LookupWorkspacePrivateEndpointConnectionArgs, opts ...pulumi.InvokeOption) (*LookupWorkspacePrivateEndpointConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:healthcareapis/v20230228:getWorkspacePrivateEndpointConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspacePrivateEndpointConnectionOutput(ctx *pulumi.Context, args LookupWorkspacePrivateEndpointConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspacePrivateEndpointConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspacePrivateEndpointConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:healthcareapis/v20230228:getWorkspacePrivateEndpointConnection", args, LookupWorkspacePrivateEndpointConnectionResultOutput{}, options).(LookupWorkspacePrivateEndpointConnectionResultOutput), nil
