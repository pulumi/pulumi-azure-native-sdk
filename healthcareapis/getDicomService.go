...
// The list of private endpoint connections that are set up for this resource.
func (o LookupDicomServiceResultOutput) PrivateEndpointConnections() commontypesv1.PrivateEndpointConnectionResponseArrayOutput {
	return o.ApplyT(func(v LookupDicomServiceResult) []commontypesv1.PrivateEndpointConnectionResponse {
