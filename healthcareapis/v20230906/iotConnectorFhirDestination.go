...
func NewIotConnectorFhirDestination(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20230906:IotConnectorFhirDestination", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotConnectorFhirDestination(ctx *pulumi.Context,
	...
	var resource IotConnectorFhirDestination
	err := ctx.ReadResource("azure-native:healthcareapis/v20230906:IotConnectorFhirDestination", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
