...
func NewFhirService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20220131preview:FhirService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFhirService(ctx *pulumi.Context,
	...
	var resource FhirService
	err := ctx.ReadResource("azure-native:healthcareapis/v20220131preview:FhirService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
