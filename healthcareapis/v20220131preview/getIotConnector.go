...
//
// Deprecated: azure-native:healthcareapis/v20220131preview:IotConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnector to guarantee forwards compatibility.
