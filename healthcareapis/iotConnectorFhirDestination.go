...
func NewIotConnectorFhirDestination(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:healthcareapis/v20231101:IotConnectorFhirDestination"),
		},
		{
			Type: pulumi.String("azure-native:healthcareapis/v20231201:IotConnectorFhirDestination"),
		},
		{
			Type: pulumi.String("azure-native:healthcareapis/v20240301:IotConnectorFhirDestination"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:healthcareapis/v20250401preview:IotConnectorFhirDestination"),
		},
	})
...
// The Azure API version of the resource.
func (o IotConnectorFhirDestinationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *IotConnectorFhirDestination) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
