...
func NewWorkspacePrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:healthcareapis/v20250401preview:WorkspacePrivateEndpointConnection"),
		},
	})
...
// The resource of private end point.
func (o WorkspacePrivateEndpointConnectionOutput) PrivateEndpoint() commontypesv1.PrivateEndpointResponsePtrOutput {
	return o.ApplyT(func(v *WorkspacePrivateEndpointConnection) commontypesv1.PrivateEndpointResponsePtrOutput {
		return v.PrivateEndpoint
	}).(commontypesv1.PrivateEndpointResponsePtrOutput)
}

// A collection of information about the state of the connection between service consumer and provider.
func (o WorkspacePrivateEndpointConnectionOutput) PrivateLinkServiceConnectionState() commontypesv1.PrivateLinkServiceConnectionStateResponseOutput {
	return o.ApplyT(func(v *WorkspacePrivateEndpointConnection) commontypesv1.PrivateLinkServiceConnectionStateResponseOutput {
...
// Metadata pertaining to creation and last modification of the resource.
func (o WorkspacePrivateEndpointConnectionOutput) SystemData() commontypesv1.SystemDataResponseOutput {
	return o.ApplyT(func(v *WorkspacePrivateEndpointConnection) commontypesv1.SystemDataResponseOutput {
		return v.SystemData
