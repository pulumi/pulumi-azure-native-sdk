...
func NewIotConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:healthcareapis/v20220515:IotConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotConnector(ctx *pulumi.Context,
	...
	var resource IotConnector
	err := ctx.ReadResource("azure-native:healthcareapis/v20220515:IotConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
