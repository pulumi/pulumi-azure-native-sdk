...
func NewDataflowProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:iotoperations/v20250701preview:DataflowProfile"),
		},
		{
			Type: pulumi.String("azure-native:iotoperations/v20251001:DataflowProfile"),
		},
		{
			Type: pulumi.String("azure-native:iotoperations/v20260301:DataflowProfile"),
		},
		{
...
// The Azure API version of the resource.
func (o DataflowProfileOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DataflowProfile) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DataflowProfileOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DataflowProfile) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
