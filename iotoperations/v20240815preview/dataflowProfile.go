...
func NewDataflowProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20240815preview:DataflowProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataflowProfile(ctx *pulumi.Context,
	...
	var resource DataflowProfile
	err := ctx.ReadResource("azure-native:iotoperations/v20240815preview:DataflowProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
