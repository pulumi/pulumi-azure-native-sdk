...
func NewBroker(ctx *pulumi.Context,
	...
	var resource Broker
	err := ctx.RegisterResource("azure-native:iotoperations/v20240815preview:Broker", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBroker(ctx *pulumi.Context,
	...
	var resource Broker
	err := ctx.ReadResource("azure-native:iotoperations/v20240815preview:Broker", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
