...
func NewBrokerListener(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20240701preview:BrokerListener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrokerListener(ctx *pulumi.Context,
	...
	var resource BrokerListener
	err := ctx.ReadResource("azure-native:iotoperations/v20240701preview:BrokerListener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
