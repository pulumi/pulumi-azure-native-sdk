...
func NewDataFlow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20240701preview:DataFlow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataFlow(ctx *pulumi.Context,
	...
	var resource DataFlow
	err := ctx.ReadResource("azure-native:iotoperations/v20240701preview:DataFlow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
