...
func NewBrokerAuthorization(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:iotoperations/v20240915preview:BrokerAuthorization"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20240701preview:BrokerAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrokerAuthorization(ctx *pulumi.Context,
	...
	var resource BrokerAuthorization
	err := ctx.ReadResource("azure-native:iotoperations/v20240701preview:BrokerAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
