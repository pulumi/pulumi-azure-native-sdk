...
func NewBrokerAuthentication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20241101:BrokerAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrokerAuthentication(ctx *pulumi.Context,
	...
	var resource BrokerAuthentication
	err := ctx.ReadResource("azure-native:iotoperations/v20241101:BrokerAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
