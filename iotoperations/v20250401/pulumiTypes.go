...
// InstanceFeatureInput is an input type that accepts InstanceFeatureArgs and InstanceFeatureOutput values.
// You can construct a concrete instance of `InstanceFeatureInput` via:
//
//	InstanceFeatureArgs{...}
type InstanceFeatureInput interface {
	pulumi.Input

	ToInstanceFeatureOutput() InstanceFeatureOutput
	ToInstanceFeatureOutputWithContext(context.Context) InstanceFeatureOutput
}

// The features of the AIO Instance.
type InstanceFeatureArgs struct {
	// The state of the feature.
	Mode pulumi.StringPtrInput `pulumi:"mode"`
	// The settings of the feature.
...
func (InstanceFeatureArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceFeature)(nil)).Elem()
}

func (i InstanceFeatureArgs) ToInstanceFeatureOutput() InstanceFeatureOutput {
	return i.ToInstanceFeatureOutputWithContext(context.Background())
}

func (i InstanceFeatureArgs) ToInstanceFeatureOutputWithContext(ctx context.Context) InstanceFeatureOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstanceFeatureOutput)
}

// InstanceFeatureMapInput is an input type that accepts InstanceFeatureMap and InstanceFeatureMapOutput values.
// You can construct a concrete instance of `InstanceFeatureMapInput` via:
//
//	InstanceFeatureMap{ "key": InstanceFeatureArgs{...} }
type InstanceFeatureMapInput interface {
	pulumi.Input

	ToInstanceFeatureMapOutput() InstanceFeatureMapOutput
	ToInstanceFeatureMapOutputWithContext(context.Context) InstanceFeatureMapOutput
}

type InstanceFeatureMap map[string]InstanceFeatureInput

func (InstanceFeatureMap) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]InstanceFeature)(nil)).Elem()
}

func (i InstanceFeatureMap) ToInstanceFeatureMapOutput() InstanceFeatureMapOutput {
	return i.ToInstanceFeatureMapOutputWithContext(context.Background())
}

func (i InstanceFeatureMap) ToInstanceFeatureMapOutputWithContext(ctx context.Context) InstanceFeatureMapOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstanceFeatureMapOutput)
}

// The features of the AIO Instance.
type InstanceFeatureOutput struct{ *pulumi.OutputState }

func (InstanceFeatureOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceFeature)(nil)).Elem()
}

func (o InstanceFeatureOutput) ToInstanceFeatureOutput() InstanceFeatureOutput {
	return o
}

func (o InstanceFeatureOutput) ToInstanceFeatureOutputWithContext(ctx context.Context) InstanceFeatureOutput {
	return o
}

// The state of the feature.
func (o InstanceFeatureOutput) Mode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InstanceFeature) *string { return v.Mode }).(pulumi.StringPtrOutput)
}

// The settings of the feature.
func (o InstanceFeatureOutput) Settings() pulumi.StringMapOutput {
	return o.ApplyT(func(v InstanceFeature) map[string]string { return v.Settings }).(pulumi.StringMapOutput)
}

type InstanceFeatureMapOutput struct{ *pulumi.OutputState }

func (InstanceFeatureMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]InstanceFeature)(nil)).Elem()
}

func (o InstanceFeatureMapOutput) ToInstanceFeatureMapOutput() InstanceFeatureMapOutput {
	return o
}

func (o InstanceFeatureMapOutput) ToInstanceFeatureMapOutputWithContext(ctx context.Context) InstanceFeatureMapOutput {
	return o
}

func (o InstanceFeatureMapOutput) MapIndex(k pulumi.StringInput) InstanceFeatureOutput {
	return pulumi.All(o, k).ApplyT(func(vs []interface{}) InstanceFeature {
		return vs[0].(map[string]InstanceFeature)[vs[1].(string)]
	}).(InstanceFeatureOutput)
}

// The features of the AIO Instance.
type InstanceFeatureResponse struct {
	// The state of the feature.
	Mode *string `pulumi:"mode"`
	// The settings of the feature.
	Settings map[string]string `pulumi:"settings"`
...
// The features of the AIO Instance.
type InstanceFeatureResponseOutput struct{ *pulumi.OutputState }

func (InstanceFeatureResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceFeatureResponse)(nil)).Elem()
}

func (o InstanceFeatureResponseOutput) ToInstanceFeatureResponseOutput() InstanceFeatureResponseOutput {
	return o
}

func (o InstanceFeatureResponseOutput) ToInstanceFeatureResponseOutputWithContext(ctx context.Context) InstanceFeatureResponseOutput {
	return o
}

// The state of the feature.
func (o InstanceFeatureResponseOutput) Mode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InstanceFeatureResponse) *string { return v.Mode }).(pulumi.StringPtrOutput)
}

// The settings of the feature.
func (o InstanceFeatureResponseOutput) Settings() pulumi.StringMapOutput {
	return o.ApplyT(func(v InstanceFeatureResponse) map[string]string { return v.Settings }).(pulumi.StringMapOutput)
}

type InstanceFeatureResponseMapOutput struct{ *pulumi.OutputState }

func (InstanceFeatureResponseMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]InstanceFeatureResponse)(nil)).Elem()
}

func (o InstanceFeatureResponseMapOutput) ToInstanceFeatureResponseMapOutput() InstanceFeatureResponseMapOutput {
	return o
}

func (o InstanceFeatureResponseMapOutput) ToInstanceFeatureResponseMapOutputWithContext(ctx context.Context) InstanceFeatureResponseMapOutput {
	return o
}

func (o InstanceFeatureResponseMapOutput) MapIndex(k pulumi.StringInput) InstanceFeatureResponseOutput {
	return pulumi.All(o, k).ApplyT(func(vs []interface{}) InstanceFeatureResponse {
		return vs[0].(map[string]InstanceFeatureResponse)[vs[1].(string)]
	}).(InstanceFeatureResponseOutput)
}
...
type InstanceProperties struct {
	...
	Description *string `pulumi:"description"`
	// The features of the AIO Instance.
	Features map[string]InstanceFeature `pulumi:"features"`
...
type InstancePropertiesArgs struct {
	...
	Description pulumi.StringPtrInput `pulumi:"description"`
	// The features of the AIO Instance.
	Features InstanceFeatureMapInput `pulumi:"features"`
	// The reference to the Schema Registry for this AIO Instance.
...
// The features of the AIO Instance.
func (o InstancePropertiesOutput) Features() InstanceFeatureMapOutput {
	return o.ApplyT(func(v InstanceProperties) map[string]InstanceFeature { return v.Features }).(InstanceFeatureMapOutput)
}
...
// The features of the AIO Instance.
func (o InstancePropertiesPtrOutput) Features() InstanceFeatureMapOutput {
	return o.ApplyT(func(v *InstanceProperties) map[string]InstanceFeature {
		if v == nil {
			return nil
		}
		return v.Features
	}).(InstanceFeatureMapOutput)
}
...
type InstancePropertiesResponse struct {
	...
	Description *string `pulumi:"description"`
	// The features of the AIO Instance.
	Features map[string]InstanceFeatureResponse `pulumi:"features"`
	// The status of the last operation.
	ProvisioningState string `pulumi:"provisioningState"`
	// The reference to the Schema Registry for this AIO Instance.
...
// The features of the AIO Instance.
func (o InstancePropertiesResponseOutput) Features() InstanceFeatureResponseMapOutput {
	return o.ApplyT(func(v InstancePropertiesResponse) map[string]InstanceFeatureResponse { return v.Features }).(InstanceFeatureResponseMapOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(InstanceFeatureOutput{})
	pulumi.RegisterOutputType(InstanceFeatureMapOutput{})
	pulumi.RegisterOutputType(InstanceFeatureResponseOutput{})
	pulumi.RegisterOutputType(InstanceFeatureResponseMapOutput{})
