...
func (InstanceFeatureMode) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceFeatureMode)(nil)).Elem()
}

func (e InstanceFeatureMode) ToInstanceFeatureModeOutput() InstanceFeatureModeOutput {
	return pulumi.ToOutput(e).(InstanceFeatureModeOutput)
}

func (e InstanceFeatureMode) ToInstanceFeatureModeOutputWithContext(ctx context.Context) InstanceFeatureModeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(InstanceFeatureModeOutput)
}

func (e InstanceFeatureMode) ToInstanceFeatureModePtrOutput() InstanceFeatureModePtrOutput {
	return e.ToInstanceFeatureModePtrOutputWithContext(context.Background())
}

func (e InstanceFeatureMode) ToInstanceFeatureModePtrOutputWithContext(ctx context.Context) InstanceFeatureModePtrOutput {
	return InstanceFeatureMode(e).ToInstanceFeatureModeOutputWithContext(ctx).ToInstanceFeatureModePtrOutputWithContext(ctx)
}

func (e InstanceFeatureMode) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e InstanceFeatureMode) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e InstanceFeatureMode) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e InstanceFeatureMode) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type InstanceFeatureModeOutput struct{ *pulumi.OutputState }

func (InstanceFeatureModeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceFeatureMode)(nil)).Elem()
}

func (o InstanceFeatureModeOutput) ToInstanceFeatureModeOutput() InstanceFeatureModeOutput {
	return o
}

func (o InstanceFeatureModeOutput) ToInstanceFeatureModeOutputWithContext(ctx context.Context) InstanceFeatureModeOutput {
	return o
}

func (o InstanceFeatureModeOutput) ToInstanceFeatureModePtrOutput() InstanceFeatureModePtrOutput {
	return o.ToInstanceFeatureModePtrOutputWithContext(context.Background())
}

func (o InstanceFeatureModeOutput) ToInstanceFeatureModePtrOutputWithContext(ctx context.Context) InstanceFeatureModePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v InstanceFeatureMode) *InstanceFeatureMode {
		return &v
	}).(InstanceFeatureModePtrOutput)
}

func (o InstanceFeatureModeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o InstanceFeatureModeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e InstanceFeatureMode) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o InstanceFeatureModeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o InstanceFeatureModeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e InstanceFeatureMode) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type InstanceFeatureModePtrOutput struct{ *pulumi.OutputState }

func (InstanceFeatureModePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**InstanceFeatureMode)(nil)).Elem()
}

func (o InstanceFeatureModePtrOutput) ToInstanceFeatureModePtrOutput() InstanceFeatureModePtrOutput {
	return o
}

func (o InstanceFeatureModePtrOutput) ToInstanceFeatureModePtrOutputWithContext(ctx context.Context) InstanceFeatureModePtrOutput {
	return o
}

func (o InstanceFeatureModePtrOutput) Elem() InstanceFeatureModeOutput {
	return o.ApplyT(func(v *InstanceFeatureMode) InstanceFeatureMode {
		if v != nil {
			return *v
		}
		var ret InstanceFeatureMode
		return ret
	}).(InstanceFeatureModeOutput)
}

func (o InstanceFeatureModePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o InstanceFeatureModePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *InstanceFeatureMode) *string {
		if e == nil {
			return nil
		}
...
// InstanceFeatureModeInput is an input type that accepts values of the InstanceFeatureMode enum
// A concrete instance of `InstanceFeatureModeInput` can be one of the following:
//
//	InstanceFeatureModeStable
//	InstanceFeatureModePreview
//	InstanceFeatureModeDisabled
type InstanceFeatureModeInput interface {
	pulumi.Input

	ToInstanceFeatureModeOutput() InstanceFeatureModeOutput
	ToInstanceFeatureModeOutputWithContext(context.Context) InstanceFeatureModeOutput
}

var instanceFeatureModePtrType = reflect.TypeOf((**InstanceFeatureMode)(nil)).Elem()

type InstanceFeatureModePtrInput interface {
	pulumi.Input

	ToInstanceFeatureModePtrOutput() InstanceFeatureModePtrOutput
	ToInstanceFeatureModePtrOutputWithContext(context.Context) InstanceFeatureModePtrOutput
}

type instanceFeatureModePtr string

func InstanceFeatureModePtr(v string) InstanceFeatureModePtrInput {
	return (*instanceFeatureModePtr)(&v)
}

func (*instanceFeatureModePtr) ElementType() reflect.Type {
	return instanceFeatureModePtrType
}

func (in *instanceFeatureModePtr) ToInstanceFeatureModePtrOutput() InstanceFeatureModePtrOutput {
	return pulumi.ToOutput(in).(InstanceFeatureModePtrOutput)
}

func (in *instanceFeatureModePtr) ToInstanceFeatureModePtrOutputWithContext(ctx context.Context) InstanceFeatureModePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(InstanceFeatureModePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(InstanceFeatureModeOutput{})
	pulumi.RegisterOutputType(InstanceFeatureModePtrOutput{})
