...
func NewDataflowProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20250401:DataflowProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataflowProfile(ctx *pulumi.Context,
	...
	var resource DataflowProfile
	err := ctx.ReadResource("azure-native:iotoperations/v20250401:DataflowProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
