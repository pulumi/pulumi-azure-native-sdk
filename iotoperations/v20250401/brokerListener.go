...
func NewBrokerListener(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20250401:BrokerListener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrokerListener(ctx *pulumi.Context,
	...
	var resource BrokerListener
	err := ctx.ReadResource("azure-native:iotoperations/v20250401:BrokerListener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
