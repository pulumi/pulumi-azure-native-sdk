...
func LookupBrokerAuthorization(ctx *pulumi.Context, args *LookupBrokerAuthorizationArgs, opts ...pulumi.InvokeOption) (*LookupBrokerAuthorizationResult, error) {
	...
	err := ctx.Invoke("azure-native:iotoperations/v20240915preview:getBrokerAuthorization", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupBrokerAuthorizationOutput(ctx *pulumi.Context, args LookupBrokerAuthorizationOutputArgs, opts ...pulumi.InvokeOption) LookupBrokerAuthorizationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBrokerAuthorizationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:iotoperations/v20240915preview:getBrokerAuthorization", args, LookupBrokerAuthorizationResultOutput{}, options).(LookupBrokerAuthorizationResultOutput), nil
