...
func NewBrokerAuthentication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20240915preview:BrokerAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrokerAuthentication(ctx *pulumi.Context,
	...
	var resource BrokerAuthentication
	err := ctx.ReadResource("azure-native:iotoperations/v20240915preview:BrokerAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
