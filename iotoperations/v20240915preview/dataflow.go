...
func NewDataflow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20240915preview:Dataflow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataflow(ctx *pulumi.Context,
	...
	var resource Dataflow
	err := ctx.ReadResource("azure-native:iotoperations/v20240915preview:Dataflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
