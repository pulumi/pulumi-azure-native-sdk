...
func NewBrokerAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotoperations/v20240915preview:BrokerAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrokerAuthorization(ctx *pulumi.Context,
	...
	var resource BrokerAuthorization
	err := ctx.ReadResource("azure-native:iotoperations/v20240915preview:BrokerAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
