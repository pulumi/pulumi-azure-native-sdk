...
func NewBrokerListener(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:iotoperations/v20260701:BrokerListener"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BrokerListener
	err := ctx.RegisterResource("azure-native:iotoperations:BrokerListener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrokerListener(ctx *pulumi.Context,
	...
	var resource BrokerListener
	err := ctx.ReadResource("azure-native:iotoperations:BrokerListener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
