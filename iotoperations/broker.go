...
func NewBroker(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperations/v20240701preview:Broker"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:iotoperations/v20260301:Broker"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Broker
	err := ctx.RegisterResource("azure-native:iotoperations:Broker", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBroker(ctx *pulumi.Context,
	...
	var resource Broker
	err := ctx.ReadResource("azure-native:iotoperations:Broker", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o BrokerOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Broker) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
