...
func LookupScheduledQueryRule(ctx *pulumi.Context, args *LookupScheduledQueryRuleArgs, opts ...pulumi.InvokeOption) (*LookupScheduledQueryRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:insights/v20240101preview:getScheduledQueryRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupScheduledQueryRuleOutput(ctx *pulumi.Context, args LookupScheduledQueryRuleOutputArgs, opts ...pulumi.InvokeOption) LookupScheduledQueryRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScheduledQueryRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:insights/v20240101preview:getScheduledQueryRule", args, LookupScheduledQueryRuleResultOutput{}, options).(LookupScheduledQueryRuleResultOutput), nil
