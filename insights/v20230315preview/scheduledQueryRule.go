...
func NewScheduledQueryRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:insights/v20250101preview:ScheduledQueryRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:insights/v20230315preview:ScheduledQueryRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledQueryRule(ctx *pulumi.Context,
	...
	var resource ScheduledQueryRule
	err := ctx.ReadResource("azure-native:insights/v20230315preview:ScheduledQueryRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The identity of the resource.
func (o ScheduledQueryRuleOutput) Identity() IdentityResponsePtrOutput {
	return o.ApplyT(func(v *ScheduledQueryRule) IdentityResponsePtrOutput { return v.Identity }).(IdentityResponsePtrOutput)
}
