...
func NewWebTest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20220615:WebTest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebTest(ctx *pulumi.Context,
	...
	var resource WebTest
	err := ctx.ReadResource("azure-native:insights/v20220615:WebTest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
