...
func NewWorkbook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20230601:Workbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkbook(ctx *pulumi.Context,
	...
	var resource Workbook
	err := ctx.ReadResource("azure-native:insights/v20230601:Workbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
