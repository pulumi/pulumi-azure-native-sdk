...
func NewScheduledQueryRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20250101preview:ScheduledQueryRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledQueryRule(ctx *pulumi.Context,
	...
	var resource ScheduledQueryRule
	err := ctx.ReadResource("azure-native:insights/v20250101preview:ScheduledQueryRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
