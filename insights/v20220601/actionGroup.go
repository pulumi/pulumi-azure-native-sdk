...
//
// Deprecated: azure-native:insights/v20220601:ActionGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20230101:ActionGroup to guarantee forwards compatibility.
...
func NewActionGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20220601:ActionGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActionGroup(ctx *pulumi.Context,
	...
	var resource ActionGroup
	err := ctx.ReadResource("azure-native:insights/v20220601:ActionGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
