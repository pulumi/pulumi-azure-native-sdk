...
func LookupDataCollectionRuleAssociation(ctx *pulumi.Context, args *LookupDataCollectionRuleAssociationArgs, opts ...pulumi.InvokeOption) (*LookupDataCollectionRuleAssociationResult, error) {
	...
	err := ctx.Invoke("azure-native:insights/v20220601:getDataCollectionRuleAssociation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDataCollectionRuleAssociationOutput(ctx *pulumi.Context, args LookupDataCollectionRuleAssociationOutputArgs, opts ...pulumi.InvokeOption) LookupDataCollectionRuleAssociationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDataCollectionRuleAssociationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:insights/v20220601:getDataCollectionRuleAssociation", args, LookupDataCollectionRuleAssociationResultOutput{}, options).(LookupDataCollectionRuleAssociationResultOutput), nil
