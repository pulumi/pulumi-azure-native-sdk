...
func NewDataCollectionEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20210901preview:DataCollectionEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCollectionEndpoint(ctx *pulumi.Context,
	...
	var resource DataCollectionEndpoint
	err := ctx.ReadResource("azure-native:insights/v20210901preview:DataCollectionEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
