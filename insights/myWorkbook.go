...
func NewMyWorkbook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights:MyWorkbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMyWorkbook(ctx *pulumi.Context,
	...
	var resource MyWorkbook
	err := ctx.ReadResource("azure-native:insights:MyWorkbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
