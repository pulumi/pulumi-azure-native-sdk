...
func NewComponent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20180501preview:Component", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponent(ctx *pulumi.Context,
	...
	var resource Component
	err := ctx.ReadResource("azure-native:insights/v20180501preview:Component", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
