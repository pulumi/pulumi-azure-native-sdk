...
func NewWebTest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20180501preview:WebTest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebTest(ctx *pulumi.Context,
	...
	var resource WebTest
	err := ctx.ReadResource("azure-native:insights/v20180501preview:WebTest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
