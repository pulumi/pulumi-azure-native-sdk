...
//
// Deprecated: azure-native:insights/v20210801:ScheduledQueryRule is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220801preview:ScheduledQueryRule to guarantee forwards compatibility.
...
func NewScheduledQueryRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20210801:ScheduledQueryRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledQueryRule(ctx *pulumi.Context,
	...
	var resource ScheduledQueryRule
	err := ctx.ReadResource("azure-native:insights/v20210801:ScheduledQueryRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
