...
func NewPrivateLinkScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20210901:PrivateLinkScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkScope(ctx *pulumi.Context,
	...
	var resource PrivateLinkScope
	err := ctx.ReadResource("azure-native:insights/v20210901:PrivateLinkScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
