...
// WebTestKindEnumInput is an input type that accepts values of the WebTestKindEnum enum
// A concrete instance of `WebTestKindEnumInput` can be one of the following:
//
//	WebTestKindEnumPing
//	WebTestKindEnumMultistep
//	WebTestKindEnumBasic
//	WebTestKindEnumStandard
