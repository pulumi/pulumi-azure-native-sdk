...
// EnabledInput is an input type that accepts values of the Enabled enum
// A concrete instance of `EnabledInput` can be one of the following:
//
//	EnabledTrue
//	EnabledFalse
...
// MetricTriggerTypeInput is an input type that accepts values of the MetricTriggerType enum
// A concrete instance of `MetricTriggerTypeInput` can be one of the following:
//
...
// QueryTypeInput is an input type that accepts values of the QueryType enum
// A concrete instance of `QueryTypeInput` can be one of the following:
//
