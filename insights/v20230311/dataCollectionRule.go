...
type DataCollectionRule struct {
	...
	AgentSettings DataCollectionRuleResponseAgentSettingsPtrOutput `pulumi:"agentSettings"`
	...
	Endpoints DataCollectionRuleResponseEndpointsOutput `pulumi:"endpoints"`
	...
	References DataCollectionRuleResponseReferencesPtrOutput `pulumi:"references"`
...
func NewDataCollectionRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20230311:DataCollectionRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCollectionRule(ctx *pulumi.Context,
	...
	var resource DataCollectionRule
	err := ctx.ReadResource("azure-native:insights/v20230311:DataCollectionRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type dataCollectionRuleArgs struct {
	// Agent settings used to modify agent behavior on a given host
	AgentSettings *DataCollectionRuleAgentSettings `pulumi:"agentSettings"`
	// The resource ID of the data collection endpoint that this rule can be used with.
	...
	// Defines all the references that may be used in other sections of the DCR
	References *DataCollectionRuleReferences `pulumi:"references"`
...
type DataCollectionRuleArgs struct {
	// Agent settings used to modify agent behavior on a given host
	AgentSettings DataCollectionRuleAgentSettingsPtrInput
	// The resource ID of the data collection endpoint that this rule can be used with.
	...
	// Defines all the references that may be used in other sections of the DCR
	References DataCollectionRuleReferencesPtrInput
	// The name of the resource group. The name is case insensitive.
...
// Agent settings used to modify agent behavior on a given host
func (o DataCollectionRuleOutput) AgentSettings() DataCollectionRuleResponseAgentSettingsPtrOutput {
	return o.ApplyT(func(v *DataCollectionRule) DataCollectionRuleResponseAgentSettingsPtrOutput { return v.AgentSettings }).(DataCollectionRuleResponseAgentSettingsPtrOutput)
}
...
// Defines the ingestion endpoints to send data to via this rule.
func (o DataCollectionRuleOutput) Endpoints() DataCollectionRuleResponseEndpointsOutput {
	return o.ApplyT(func(v *DataCollectionRule) DataCollectionRuleResponseEndpointsOutput { return v.Endpoints }).(DataCollectionRuleResponseEndpointsOutput)
}
...
// Defines all the references that may be used in other sections of the DCR
func (o DataCollectionRuleOutput) References() DataCollectionRuleResponseReferencesPtrOutput {
	return o.ApplyT(func(v *DataCollectionRule) DataCollectionRuleResponseReferencesPtrOutput { return v.References }).(DataCollectionRuleResponseReferencesPtrOutput)
}
