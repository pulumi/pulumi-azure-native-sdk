...
func NewDataCollectionRuleAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20230311:DataCollectionRuleAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCollectionRuleAssociation(ctx *pulumi.Context,
	...
	var resource DataCollectionRuleAssociation
	err := ctx.ReadResource("azure-native:insights/v20230311:DataCollectionRuleAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
