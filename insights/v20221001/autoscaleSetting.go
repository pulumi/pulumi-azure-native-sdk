...
func NewAutoscaleSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20221001:AutoscaleSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoscaleSetting(ctx *pulumi.Context,
	...
	var resource AutoscaleSetting
	err := ctx.ReadResource("azure-native:insights/v20221001:AutoscaleSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
