...
func NewWorkbook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20210308:Workbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkbook(ctx *pulumi.Context,
	...
	var resource Workbook
	err := ctx.ReadResource("azure-native:insights/v20210308:Workbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The unique revision id for this workbook definition
func (o WorkbookOutput) Revision() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Workbook) pulumi.StringPtrOutput { return v.Revision }).(pulumi.StringPtrOutput)
}
