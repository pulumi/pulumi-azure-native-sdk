...
func (o LookupComponentLinkedStorageAccountResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupComponentLinkedStorageAccountResult] {
	return pulumix.Output[LookupComponentLinkedStorageAccountResult]{
