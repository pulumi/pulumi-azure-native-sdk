...
func NewActivityLogAlert(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:insights/v20230101preview:ActivityLogAlert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActivityLogAlert(ctx *pulumi.Context,
	...
	var resource ActivityLogAlert
	err := ctx.ReadResource("azure-native:insights/v20230101preview:ActivityLogAlert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
