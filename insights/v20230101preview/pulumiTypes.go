...
// Predefined list of properties and configuration items for the action group.
func (o ActionGroupOutput) ActionProperties() pulumi.StringMapOutput {
	return o.ApplyT(func(v ActionGroup) map[string]string { return v.ActionProperties }).(pulumi.StringMapOutput)
}
