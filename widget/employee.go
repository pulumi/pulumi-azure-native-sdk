...
func NewEmployee(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:widget/v20211001preview:Employee"),
		},
		{
			Type: pulumi.String("azure-native:widget/v20211101:Employee"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Employee
	err := ctx.RegisterResource("azure-native:widget:Employee", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmployee(ctx *pulumi.Context,
	...
	var resource Employee
	err := ctx.ReadResource("azure-native:widget:Employee", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
