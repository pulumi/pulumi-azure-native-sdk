...
func (o LookupPolicyAssignmentArtifactResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupPolicyAssignmentArtifactResult] {
	return pulumix.Output[LookupPolicyAssignmentArtifactResult]{
