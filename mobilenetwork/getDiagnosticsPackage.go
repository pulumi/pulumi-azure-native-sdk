...
func LookupDiagnosticsPackage(ctx *pulumi.Context, args *LookupDiagnosticsPackageArgs, opts ...pulumi.InvokeOption) (*LookupDiagnosticsPackageResult, error) {
	...
	err := ctx.Invoke("azure-native:mobilenetwork:getDiagnosticsPackage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDiagnosticsPackageOutput(ctx *pulumi.Context, args LookupDiagnosticsPackageOutputArgs, opts ...pulumi.InvokeOption) LookupDiagnosticsPackageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDiagnosticsPackageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:mobilenetwork:getDiagnosticsPackage", args, LookupDiagnosticsPackageResultOutput{}, options).(LookupDiagnosticsPackageResultOutput), nil
