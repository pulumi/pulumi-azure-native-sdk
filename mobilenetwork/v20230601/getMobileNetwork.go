...
func LookupMobileNetwork(ctx *pulumi.Context, args *LookupMobileNetworkArgs, opts ...pulumi.InvokeOption) (*LookupMobileNetworkResult, error) {
	...
	err := ctx.Invoke("azure-native:mobilenetwork/v20230601:getMobileNetwork", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMobileNetworkOutput(ctx *pulumi.Context, args LookupMobileNetworkOutputArgs, opts ...pulumi.InvokeOption) LookupMobileNetworkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMobileNetworkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:mobilenetwork/v20230601:getMobileNetwork", args, LookupMobileNetworkResultOutput{}, options).(LookupMobileNetworkResultOutput), nil
