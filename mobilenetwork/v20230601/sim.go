...
func NewSim(ctx *pulumi.Context,
	...
	var resource Sim
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20230601:Sim", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSim(ctx *pulumi.Context,
	...
	var resource Sim
	err := ctx.ReadResource("azure-native:mobilenetwork/v20230601:Sim", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
