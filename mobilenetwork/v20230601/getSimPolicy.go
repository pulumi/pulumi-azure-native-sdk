...
func LookupSimPolicy(ctx *pulumi.Context, args *LookupSimPolicyArgs, opts ...pulumi.InvokeOption) (*LookupSimPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:mobilenetwork/v20230601:getSimPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupSimPolicyOutput(ctx *pulumi.Context, args LookupSimPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupSimPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSimPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:mobilenetwork/v20230601:getSimPolicy", args, LookupSimPolicyResultOutput{}, options).(LookupSimPolicyResultOutput), nil
