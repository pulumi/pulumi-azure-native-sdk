...
func NewSlice(ctx *pulumi.Context,
	...
	var resource Slice
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20230601:Slice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSlice(ctx *pulumi.Context,
	...
	var resource Slice
	err := ctx.ReadResource("azure-native:mobilenetwork/v20230601:Slice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
