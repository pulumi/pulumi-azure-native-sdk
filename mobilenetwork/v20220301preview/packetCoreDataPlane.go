...
func NewPacketCoreDataPlane(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPacketCoreDataPlane(ctx *pulumi.Context,
	...
	var resource PacketCoreDataPlane
	err := ctx.ReadResource("azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
