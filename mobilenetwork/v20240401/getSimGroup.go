...
func LookupSimGroup(ctx *pulumi.Context, args *LookupSimGroupArgs, opts ...pulumi.InvokeOption) (*LookupSimGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:mobilenetwork/v20240401:getSimGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSimGroupOutput(ctx *pulumi.Context, args LookupSimGroupOutputArgs, opts ...pulumi.InvokeOption) LookupSimGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSimGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:mobilenetwork/v20240401:getSimGroup", args, LookupSimGroupResultOutput{}, options).(LookupSimGroupResultOutput), nil
