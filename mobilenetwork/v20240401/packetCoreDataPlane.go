...
func NewPacketCoreDataPlane(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:mobilenetwork/v20230601:PacketCoreDataPlane"),
		},
		{
			Type: pulumi.String("azure-native:mobilenetwork/v20230901:PacketCoreDataPlane"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20240401:PacketCoreDataPlane", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPacketCoreDataPlane(ctx *pulumi.Context,
	...
	var resource PacketCoreDataPlane
	err := ctx.ReadResource("azure-native:mobilenetwork/v20240401:PacketCoreDataPlane", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
