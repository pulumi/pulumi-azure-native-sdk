...
func NewSimPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20240401:SimPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSimPolicy(ctx *pulumi.Context,
	...
	var resource SimPolicy
	err := ctx.ReadResource("azure-native:mobilenetwork/v20240401:SimPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
