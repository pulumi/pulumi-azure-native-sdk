...
// A reference to an in-progress installation operation
func (o InstallationResponseOutput) Operation() AsyncOperationIdResponsePtrOutput {
	return o.ApplyT(func(v InstallationResponse) *AsyncOperationIdResponse { return v.Operation }).(AsyncOperationIdResponsePtrOutput)
}

// Installation state
func (o InstallationResponseOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InstallationResponse) *string { return v.State }).(pulumi.StringPtrOutput)
}
