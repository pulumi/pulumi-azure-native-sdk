...
func LookupSim(ctx *pulumi.Context, args *LookupSimArgs, opts ...pulumi.InvokeOption) (*LookupSimResult, error) {
	...
	err := ctx.Invoke("azure-native:mobilenetwork/v20220401preview:getSim", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSimOutput(ctx *pulumi.Context, args LookupSimOutputArgs, opts ...pulumi.InvokeOption) LookupSimResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupSimResultOutput, error) {
			...
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv LookupSimResult
			secret, err := ctx.InvokePackageRaw("azure-native:mobilenetwork/v20220401preview:getSim", args, &rv, "", opts...)
			if err != nil {
