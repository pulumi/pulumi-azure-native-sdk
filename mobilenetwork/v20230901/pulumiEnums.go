...
func (in *desiredInstallationStatePtr) ToOutput(ctx context.Context) pulumix.Output[*DesiredInstallationState] {
	return pulumix.Output[*DesiredInstallationState]{
		OutputState: in.ToDesiredInstallationStatePtrOutputWithContext(ctx).OutputState,
	}
}
