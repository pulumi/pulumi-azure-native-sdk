...
func NewDiagnosticsPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20230901:DiagnosticsPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnosticsPackage(ctx *pulumi.Context,
	...
	var resource DiagnosticsPackage
	err := ctx.ReadResource("azure-native:mobilenetwork/v20230901:DiagnosticsPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
