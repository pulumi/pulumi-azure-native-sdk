...
func NewSimGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20230901:SimGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSimGroup(ctx *pulumi.Context,
	...
	var resource SimGroup
	err := ctx.ReadResource("azure-native:mobilenetwork/v20230901:SimGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
