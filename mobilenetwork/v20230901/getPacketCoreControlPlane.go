...
func LookupPacketCoreControlPlane(ctx *pulumi.Context, args *LookupPacketCoreControlPlaneArgs, opts ...pulumi.InvokeOption) (*LookupPacketCoreControlPlaneResult, error) {
	...
	err := ctx.Invoke("azure-native:mobilenetwork/v20230901:getPacketCoreControlPlane", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupPacketCoreControlPlaneOutput(ctx *pulumi.Context, args LookupPacketCoreControlPlaneOutputArgs, opts ...pulumi.InvokeOption) LookupPacketCoreControlPlaneResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPacketCoreControlPlaneResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:mobilenetwork/v20230901:getPacketCoreControlPlane", args, LookupPacketCoreControlPlaneResultOutput{}, options).(LookupPacketCoreControlPlaneResultOutput), nil
