...
func NewSimPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:mobilenetwork/v20230901:SimPolicy"),
		},
		{
			Type: pulumi.String("azure-native:mobilenetwork/v20240201:SimPolicy"),
		},
		{
			Type: pulumi.String("azure-native:mobilenetwork/v20240401:SimPolicy"),
		},
	})
...
// The Azure API version of the resource.
func (o SimPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SimPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
