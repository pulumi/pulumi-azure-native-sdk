...
func NewMobileNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20240201:MobileNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMobileNetwork(ctx *pulumi.Context,
	...
	var resource MobileNetwork
	err := ctx.ReadResource("azure-native:mobilenetwork/v20240201:MobileNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
