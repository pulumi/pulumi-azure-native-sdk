...
func LookupAttachedDataNetwork(ctx *pulumi.Context, args *LookupAttachedDataNetworkArgs, opts ...pulumi.InvokeOption) (*LookupAttachedDataNetworkResult, error) {
	...
	err := ctx.Invoke("azure-native:mobilenetwork/v20240201:getAttachedDataNetwork", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupAttachedDataNetworkOutput(ctx *pulumi.Context, args LookupAttachedDataNetworkOutputArgs, opts ...pulumi.InvokeOption) LookupAttachedDataNetworkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAttachedDataNetworkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:mobilenetwork/v20240201:getAttachedDataNetwork", args, LookupAttachedDataNetworkResultOutput{}, options).(LookupAttachedDataNetworkResultOutput), nil
