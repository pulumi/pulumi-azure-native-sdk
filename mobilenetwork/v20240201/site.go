...
func NewSite(ctx *pulumi.Context,
	...
	var resource Site
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20240201:Site", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSite(ctx *pulumi.Context,
	...
	var resource Site
	err := ctx.ReadResource("azure-native:mobilenetwork/v20240201:Site", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
