...
func NewDataNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20240201:DataNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataNetwork(ctx *pulumi.Context,
	...
	var resource DataNetwork
	err := ctx.ReadResource("azure-native:mobilenetwork/v20240201:DataNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
