...
func NewAttachedDataNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:mobilenetwork/v20240201:AttachedDataNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachedDataNetwork(ctx *pulumi.Context,
	...
	var resource AttachedDataNetwork
	err := ctx.ReadResource("azure-native:mobilenetwork/v20240201:AttachedDataNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
