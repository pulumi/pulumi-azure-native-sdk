...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o GetEnterpriseMccCacheNodesOperationCacheNodeMccIssueDetailsHistoryResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v GetEnterpriseMccCacheNodesOperationCacheNodeMccIssueDetailsHistoryResult) commontypesv5.SystemDataResponse {
		return v.SystemData
