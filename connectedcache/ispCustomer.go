...
func NewIspCustomer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:connectedcache/v20230501preview:IspCustomer"),
		},
		{
			Type: pulumi.String("azure-native:connectedcache/v20241130preview:IspCustomer"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource IspCustomer
	err := ctx.RegisterResource("azure-native:connectedcache:IspCustomer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIspCustomer(ctx *pulumi.Context,
	...
	var resource IspCustomer
	err := ctx.ReadResource("azure-native:connectedcache:IspCustomer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o IspCustomerOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *IspCustomer) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o IspCustomerOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *IspCustomer) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
