...
func NewEnterpriseMccCacheNodesOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:connectedcache:EnterpriseMccCacheNodesOperation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EnterpriseMccCacheNodesOperation
	err := ctx.RegisterResource("azure-native:connectedcache/v20230501preview:EnterpriseMccCacheNodesOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnterpriseMccCacheNodesOperation(ctx *pulumi.Context,
	...
	var resource EnterpriseMccCacheNodesOperation
	err := ctx.ReadResource("azure-native:connectedcache/v20230501preview:EnterpriseMccCacheNodesOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
