...
func NewCacheNodesOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:connectedcache:CacheNodesOperation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CacheNodesOperation
	err := ctx.RegisterResource("azure-native:connectedcache/v20230501preview:CacheNodesOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCacheNodesOperation(ctx *pulumi.Context,
	...
	var resource CacheNodesOperation
	err := ctx.ReadResource("azure-native:connectedcache/v20230501preview:CacheNodesOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
