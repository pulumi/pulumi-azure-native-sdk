...
func NewStorageClass(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetesruntime:StorageClass", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageClass(ctx *pulumi.Context,
	...
	var resource StorageClass
	err := ctx.ReadResource("azure-native:kubernetesruntime:StorageClass", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o StorageClassOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *StorageClass) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
