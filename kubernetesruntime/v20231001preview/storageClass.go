...
func NewStorageClass(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetesruntime/v20231001preview:StorageClass", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageClass(ctx *pulumi.Context,
	...
	var resource StorageClass
	err := ctx.ReadResource("azure-native:kubernetesruntime/v20231001preview:StorageClass", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
