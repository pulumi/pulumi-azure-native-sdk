...
func NewBgpPeer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetesruntime:BgpPeer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpPeer(ctx *pulumi.Context,
	...
	var resource BgpPeer
	err := ctx.ReadResource("azure-native:kubernetesruntime:BgpPeer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
