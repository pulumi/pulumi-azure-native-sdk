...
func NewDnssecConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dns/v20230701preview:DnssecConfig"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dns:DnssecConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnssecConfig(ctx *pulumi.Context,
	...
	var resource DnssecConfig
	err := ctx.ReadResource("azure-native:dns:DnssecConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DnssecConfigOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DnssecConfig) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DnssecConfigOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *DnssecConfig) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
