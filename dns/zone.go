...
func NewZone(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dns/v20150504preview:Zone"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20160401:Zone"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20170901:Zone"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20171001:Zone"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20180301preview:Zone"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20180501:Zone"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20230701preview:Zone"),
		},
		{
	...
	var resource Zone
	err := ctx.RegisterResource("azure-native:dns:Zone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZone(ctx *pulumi.Context,
	...
	var resource Zone
	err := ctx.ReadResource("azure-native:dns:Zone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ZoneOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Zone) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ZoneOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *Zone) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
