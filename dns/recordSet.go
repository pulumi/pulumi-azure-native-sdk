...
func NewRecordSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dns/v20150504preview:RecordSet"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20160401:RecordSet"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20170901:RecordSet"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20171001:RecordSet"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20180301preview:RecordSet"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20180501:RecordSet"),
		},
		{
			Type: pulumi.String("azure-native:dns/v20230701preview:RecordSet"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dns:RecordSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRecordSet(ctx *pulumi.Context,
	...
	var resource RecordSet
	err := ctx.ReadResource("azure-native:dns:RecordSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o RecordSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *RecordSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o RecordSetOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *RecordSet) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
