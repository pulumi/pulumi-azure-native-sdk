...
func LookupDnssecConfig(ctx *pulumi.Context, args *LookupDnssecConfigArgs, opts ...pulumi.InvokeOption) (*LookupDnssecConfigResult, error) {
	...
	err := ctx.Invoke("azure-native:dns:getDnssecConfig", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDnssecConfigOutput(ctx *pulumi.Context, args LookupDnssecConfigOutputArgs, opts ...pulumi.InvokeOption) LookupDnssecConfigResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDnssecConfigResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dns:getDnssecConfig", args, LookupDnssecConfigResultOutput{}, options).(LookupDnssecConfigResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDnssecConfigResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDnssecConfigResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDnssecConfigResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDnssecConfigResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
