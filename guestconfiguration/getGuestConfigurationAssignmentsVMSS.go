...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupGuestConfigurationAssignmentsVMSSResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupGuestConfigurationAssignmentsVMSSResult) commontypesv3.SystemDataResponse {
		return v.SystemData
