...
func NewGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:guestconfiguration/v20240405:GuestConfigurationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestConfigurationAssignment(ctx *pulumi.Context,
	...
	var resource GuestConfigurationAssignment
	err := ctx.ReadResource("azure-native:guestconfiguration/v20240405:GuestConfigurationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
