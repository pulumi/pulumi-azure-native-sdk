...
func NewGuestConfigurationConnectedVMwarevSphereAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:guestconfiguration/v20240405:GuestConfigurationConnectedVMwarevSphereAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestConfigurationConnectedVMwarevSphereAssignment(ctx *pulumi.Context,
	...
	var resource GuestConfigurationConnectedVMwarevSphereAssignment
	err := ctx.ReadResource("azure-native:guestconfiguration/v20240405:GuestConfigurationConnectedVMwarevSphereAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
