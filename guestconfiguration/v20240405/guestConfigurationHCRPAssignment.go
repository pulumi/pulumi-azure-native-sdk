...
func NewGuestConfigurationHCRPAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:guestconfiguration/v20240405:GuestConfigurationHCRPAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestConfigurationHCRPAssignment(ctx *pulumi.Context,
	...
	var resource GuestConfigurationHCRPAssignment
	err := ctx.ReadResource("azure-native:guestconfiguration/v20240405:GuestConfigurationHCRPAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
