...
func LookupGuestConfigurationAssignment(ctx *pulumi.Context, args *LookupGuestConfigurationAssignmentArgs, opts ...pulumi.InvokeOption) (*LookupGuestConfigurationAssignmentResult, error) {
	...
	err := ctx.Invoke("azure-native:guestconfiguration/v20240405:getGuestConfigurationAssignment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupGuestConfigurationAssignmentOutput(ctx *pulumi.Context, args LookupGuestConfigurationAssignmentOutputArgs, opts ...pulumi.InvokeOption) LookupGuestConfigurationAssignmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGuestConfigurationAssignmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:guestconfiguration/v20240405:getGuestConfigurationAssignment", args, LookupGuestConfigurationAssignmentResultOutput{}, options).(LookupGuestConfigurationAssignmentResultOutput), nil
