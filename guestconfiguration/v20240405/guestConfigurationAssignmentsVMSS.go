...
func NewGuestConfigurationAssignmentsVMSS(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:guestconfiguration/v20240405:GuestConfigurationAssignmentsVMSS", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestConfigurationAssignmentsVMSS(ctx *pulumi.Context,
	...
	var resource GuestConfigurationAssignmentsVMSS
	err := ctx.ReadResource("azure-native:guestconfiguration/v20240405:GuestConfigurationAssignmentsVMSS", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
