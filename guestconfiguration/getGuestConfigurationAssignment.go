...
// The guest configuration assignment name.
func (o LookupGuestConfigurationAssignmentResultOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupGuestConfigurationAssignmentResult) string { return v.Name }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupGuestConfigurationAssignmentResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupGuestConfigurationAssignmentResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
