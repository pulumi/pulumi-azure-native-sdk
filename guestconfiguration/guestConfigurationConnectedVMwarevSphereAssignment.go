...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o GuestConfigurationConnectedVMwarevSphereAssignmentOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *GuestConfigurationConnectedVMwarevSphereAssignment) commontypesv3.SystemDataResponseOutput {
		return v.SystemData
