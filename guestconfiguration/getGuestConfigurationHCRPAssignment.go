...
func LookupGuestConfigurationHCRPAssignment(ctx *pulumi.Context, args *LookupGuestConfigurationHCRPAssignmentArgs, opts ...pulumi.InvokeOption) (*LookupGuestConfigurationHCRPAssignmentResult, error) {
	...
	err := ctx.Invoke("azure-native:guestconfiguration:getGuestConfigurationHCRPAssignment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupGuestConfigurationHCRPAssignmentOutput(ctx *pulumi.Context, args LookupGuestConfigurationHCRPAssignmentOutputArgs, opts ...pulumi.InvokeOption) LookupGuestConfigurationHCRPAssignmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGuestConfigurationHCRPAssignmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:guestconfiguration:getGuestConfigurationHCRPAssignment", args, LookupGuestConfigurationHCRPAssignmentResultOutput{}, options).(LookupGuestConfigurationHCRPAssignmentResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupGuestConfigurationHCRPAssignmentResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupGuestConfigurationHCRPAssignmentResult) commontypesv3.SystemDataResponse {
		return v.SystemData
