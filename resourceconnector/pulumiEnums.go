...
// DistroInput is an input type that accepts values of the Distro enum
// A concrete instance of `DistroInput` can be one of the following:
//
//	DistroAKSEdge
...
// ProviderInput is an input type that accepts values of the Provider enum
// A concrete instance of `ProviderInput` can be one of the following:
//
//	ProviderVMWare
//	ProviderHCI
//	ProviderSCVMM
