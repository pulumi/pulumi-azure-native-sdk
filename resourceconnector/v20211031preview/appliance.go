...
func NewAppliance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resourceconnector/v20211031preview:Appliance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppliance(ctx *pulumi.Context,
	...
	var resource Appliance
	err := ctx.ReadResource("azure-native:resourceconnector/v20211031preview:Appliance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
