...
func ListApplianceClusterUserCredential(ctx *pulumi.Context, args *ListApplianceClusterUserCredentialArgs, opts ...pulumi.InvokeOption) (*ListApplianceClusterUserCredentialResult, error) {
	...
	err := ctx.Invoke("azure-native:resourceconnector/v20221027:listApplianceClusterUserCredential", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListApplianceClusterUserCredentialOutput(ctx *pulumi.Context, args ListApplianceClusterUserCredentialOutputArgs, opts ...pulumi.InvokeOption) ListApplianceClusterUserCredentialResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListApplianceClusterUserCredentialResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:resourceconnector/v20221027:listApplianceClusterUserCredential", args, ListApplianceClusterUserCredentialResultOutput{}, options).(ListApplianceClusterUserCredentialResultOutput), nil
