...
func NewAppliance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resourceconnector/v20221027:Appliance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppliance(ctx *pulumi.Context,
	...
	var resource Appliance
	err := ctx.ReadResource("azure-native:resourceconnector/v20221027:Appliance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
