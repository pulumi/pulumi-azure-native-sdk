...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CapacityPoolVolumeQuotaRuleOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *CapacityPoolVolumeQuotaRule) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
