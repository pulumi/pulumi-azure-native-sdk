...
// azure-native:netapp/v20200301:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220501:Account to guarantee forwards compatibility.
type Account struct {
...
func NewAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20200301:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("azure-native:netapp/v20200301:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
