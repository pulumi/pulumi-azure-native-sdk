...
// azure-native:netapp/v20170815:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20190701:Account to guarantee forwards compatibility.
func LookupAccount(ctx *pulumi.Context, args *LookupAccountArgs, opts ...pulumi.InvokeOption) (*LookupAccountResult, error) {
	var rv LookupAccountResult
	err := ctx.Invoke("azure-native:netapp/v20170815:getAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Resource tags
func (o LookupAccountResultOutput) Tags() pulumi.AnyOutput {
	return o.ApplyT(func(v LookupAccountResult) interface{} { return v.Tags }).(pulumi.AnyOutput)
}
