...
func NewVolumeGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20230701preview:VolumeGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeGroup(ctx *pulumi.Context,
	...
	var resource VolumeGroup
	err := ctx.ReadResource("azure-native:netapp/v20230701preview:VolumeGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
