...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20230501:BackupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPolicy(ctx *pulumi.Context,
	...
	var resource BackupPolicy
	err := ctx.ReadResource("azure-native:netapp/v20230501:BackupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
