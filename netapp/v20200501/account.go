...
func NewAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20200501:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("azure-native:netapp/v20200501:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
