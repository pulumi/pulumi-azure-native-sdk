...
// azure-native:netapp/v20190501:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20190701:Pool to guarantee forwards compatibility.
type Pool struct {
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("azure-native:netapp/v20190501:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Resource tags
func (o PoolOutput) Tags() pulumi.AnyOutput {
	return o.ApplyT(func(v *Pool) pulumi.AnyOutput { return v.Tags }).(pulumi.AnyOutput)
}
