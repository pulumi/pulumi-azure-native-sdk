...
func NewSnapshotPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20260101:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260115preview:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260301:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260315preview:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260401:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260415preview:SnapshotPolicy"),
		},
	})
