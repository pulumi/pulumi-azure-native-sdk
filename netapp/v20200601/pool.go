...
// azure-native:netapp/v20200601:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:Pool to guarantee forwards compatibility.
type Pool struct {
...
func NewPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.RegisterResource("azure-native:netapp/v20200601:Pool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("azure-native:netapp/v20200601:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
