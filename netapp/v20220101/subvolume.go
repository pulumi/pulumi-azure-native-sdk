...
//
// Deprecated: azure-native:netapp/v20220101:Subvolume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:Subvolume to guarantee forwards compatibility.
...
func NewSubvolume(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20220101:Subvolume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubvolume(ctx *pulumi.Context,
	...
	var resource Subvolume
	err := ctx.ReadResource("azure-native:netapp/v20220101:Subvolume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
