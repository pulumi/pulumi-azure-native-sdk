...
func NewSnapshotPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20240101:SnapshotPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotPolicy(ctx *pulumi.Context,
	...
	var resource SnapshotPolicy
	err := ctx.ReadResource("azure-native:netapp/v20240101:SnapshotPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
