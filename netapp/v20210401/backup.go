...
// Backup of a Volume
//
// Deprecated: azure-native:netapp/v20210401:Backup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:Backup to guarantee forwards compatibility.
type Backup struct {
...
func NewBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.RegisterResource("azure-native:netapp/v20210401:Backup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.ReadResource("azure-native:netapp/v20210401:Backup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
