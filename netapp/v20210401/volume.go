...
func NewVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.RegisterResource("azure-native:netapp/v20210401:Volume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.ReadResource("azure-native:netapp/v20210401:Volume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
