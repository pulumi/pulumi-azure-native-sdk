...
func GetSubvolumeMetadata(ctx *pulumi.Context, args *GetSubvolumeMetadataArgs, opts ...pulumi.InvokeOption) (*GetSubvolumeMetadataResult, error) {
	...
	err := ctx.Invoke("azure-native:netapp/v20240301preview:getSubvolumeMetadata", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSubvolumeMetadataOutput(ctx *pulumi.Context, args GetSubvolumeMetadataOutputArgs, opts ...pulumi.InvokeOption) GetSubvolumeMetadataResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSubvolumeMetadataResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:netapp/v20240301preview:getSubvolumeMetadata", args, GetSubvolumeMetadataResultOutput{}, options).(GetSubvolumeMetadataResultOutput), nil
