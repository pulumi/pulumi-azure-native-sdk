...
func NewVolumeQuotaRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20240301preview:VolumeQuotaRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeQuotaRule(ctx *pulumi.Context,
	...
	var resource VolumeQuotaRule
	err := ctx.ReadResource("azure-native:netapp/v20240301preview:VolumeQuotaRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
