...
type Account struct {
	...
	IsMultiAdEnabled pulumi.BoolOutput `pulumi:"isMultiAdEnabled"`
	...
	NfsV4IDDomain pulumi.StringPtrOutput `pulumi:"nfsV4IDDomain"`
...
func NewAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20240101:Account"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240301:Account"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240501:Account"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240501preview:Account"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240701:Account"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240701preview:Account"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:netapp/v20240301preview:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("azure-native:netapp/v20240301preview:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type accountArgs struct {
	...
	// Domain for NFSv4 user ID mapping. This property will be set for all NetApp accounts in the subscription and region and only affect non ldap NFSv4 volumes.
	NfsV4IDDomain *string `pulumi:"nfsV4IDDomain"`
...
type AccountArgs struct {
	...
	// Domain for NFSv4 user ID mapping. This property will be set for all NetApp accounts in the subscription and region and only affect non ldap NFSv4 volumes.
	NfsV4IDDomain pulumi.StringPtrInput
	// The name of the resource group. The name is case insensitive.
...
// This will have true value only if account is Multiple AD enabled.
func (o AccountOutput) IsMultiAdEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *Account) pulumi.BoolOutput { return v.IsMultiAdEnabled }).(pulumi.BoolOutput)
}
...
// Domain for NFSv4 user ID mapping. This property will be set for all NetApp accounts in the subscription and region and only affect non ldap NFSv4 volumes.
func (o AccountOutput) NfsV4IDDomain() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Account) pulumi.StringPtrOutput { return v.NfsV4IDDomain }).(pulumi.StringPtrOutput)
}
