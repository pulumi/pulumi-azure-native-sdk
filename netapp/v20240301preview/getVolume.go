...
func LookupVolume(ctx *pulumi.Context, args *LookupVolumeArgs, opts ...pulumi.InvokeOption) (*LookupVolumeResult, error) {
	...
	err := ctx.Invoke("azure-native:netapp/v20240301preview:getVolume", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupVolumeOutput(ctx *pulumi.Context, args LookupVolumeOutputArgs, opts ...pulumi.InvokeOption) LookupVolumeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVolumeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:netapp/v20240301preview:getVolume", args, LookupVolumeResultOutput{}, options).(LookupVolumeResultOutput), nil
