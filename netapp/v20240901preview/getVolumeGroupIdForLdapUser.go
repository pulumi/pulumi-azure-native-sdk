...
func GetVolumeGroupIdForLdapUser(ctx *pulumi.Context, args *GetVolumeGroupIdForLdapUserArgs, opts ...pulumi.InvokeOption) (*GetVolumeGroupIdForLdapUserResult, error) {
	...
	err := ctx.Invoke("azure-native:netapp/v20240901preview:getVolumeGroupIdForLdapUser", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVolumeGroupIdForLdapUserOutput(ctx *pulumi.Context, args GetVolumeGroupIdForLdapUserOutputArgs, opts ...pulumi.InvokeOption) GetVolumeGroupIdForLdapUserResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetVolumeGroupIdForLdapUserResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:netapp/v20240901preview:getVolumeGroupIdForLdapUser", args, GetVolumeGroupIdForLdapUserResultOutput{}, options).(GetVolumeGroupIdForLdapUserResultOutput), nil
