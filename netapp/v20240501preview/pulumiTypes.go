...
type DestinationReplicationResponse struct {
...
// Destination replication properties
type DestinationReplicationResponseOutput struct{ *pulumi.OutputState }

func (DestinationReplicationResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DestinationReplicationResponse)(nil)).Elem()
}

func (o DestinationReplicationResponseOutput) ToDestinationReplicationResponseOutput() DestinationReplicationResponseOutput {
	return o
}

func (o DestinationReplicationResponseOutput) ToDestinationReplicationResponseOutputWithContext(ctx context.Context) DestinationReplicationResponseOutput {
	return o
}

// The remote region for the destination volume.
func (o DestinationReplicationResponseOutput) Region() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DestinationReplicationResponse) *string { return v.Region }).(pulumi.StringPtrOutput)
}

// Indicates whether the replication is cross zone or cross region.
func (o DestinationReplicationResponseOutput) ReplicationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DestinationReplicationResponse) *string { return v.ReplicationType }).(pulumi.StringPtrOutput)
}

// The resource ID of the remote volume
func (o DestinationReplicationResponseOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DestinationReplicationResponse) *string { return v.ResourceId }).(pulumi.StringPtrOutput)
}

// The remote zone for the destination volume.
func (o DestinationReplicationResponseOutput) Zone() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DestinationReplicationResponse) *string { return v.Zone }).(pulumi.StringPtrOutput)
}

type DestinationReplicationResponseArrayOutput struct{ *pulumi.OutputState }

func (DestinationReplicationResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]DestinationReplicationResponse)(nil)).Elem()
}

func (o DestinationReplicationResponseArrayOutput) ToDestinationReplicationResponseArrayOutput() DestinationReplicationResponseArrayOutput {
	return o
}

func (o DestinationReplicationResponseArrayOutput) ToDestinationReplicationResponseArrayOutputWithContext(ctx context.Context) DestinationReplicationResponseArrayOutput {
	return o
}

func (o DestinationReplicationResponseArrayOutput) Index(i pulumi.IntInput) DestinationReplicationResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) DestinationReplicationResponse {
		return vs[0].([]DestinationReplicationResponse)[vs[1].(int)]
	}).(DestinationReplicationResponseOutput)
}
...
// ClientId of the multi-tenant AAD Application. Used to access cross-tenant KeyVaults.
func (o EncryptionIdentityOutput) FederatedClientId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EncryptionIdentity) *string { return v.FederatedClientId }).(pulumi.StringPtrOutput)
}
...
// ClientId of the multi-tenant AAD Application. Used to access cross-tenant KeyVaults.
func (o EncryptionIdentityPtrOutput) FederatedClientId() pulumi.StringPtrOutput {
...
// ClientId of the multi-tenant AAD Application. Used to access cross-tenant KeyVaults.
func (o EncryptionIdentityResponseOutput) FederatedClientId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EncryptionIdentityResponse) *string { return v.FederatedClientId }).(pulumi.StringPtrOutput)
}
...
// ClientId of the multi-tenant AAD Application. Used to access cross-tenant KeyVaults.
func (o EncryptionIdentityResponsePtrOutput) FederatedClientId() pulumi.StringPtrOutput {
...
type ReplicationObjectResponse struct {
	...
	DestinationReplications []DestinationReplicationResponse `pulumi:"destinationReplications"`
	// Indicates whether the local volume is the source or destination for the Volume Replication
	EndpointType *string `pulumi:"endpointType"`
	// The full path to a volume that is to be migrated into ANF. Required for Migration volumes
...
// A list of destination replications
func (o ReplicationObjectResponseOutput) DestinationReplications() DestinationReplicationResponseArrayOutput {
	return o.ApplyT(func(v ReplicationObjectResponse) []DestinationReplicationResponse { return v.DestinationReplications }).(DestinationReplicationResponseArrayOutput)
}
...
// A list of destination replications
func (o ReplicationObjectResponsePtrOutput) DestinationReplications() DestinationReplicationResponseArrayOutput {
	return o.ApplyT(func(v *ReplicationObjectResponse) []DestinationReplicationResponse {
		if v == nil {
			return nil
		}
		return v.DestinationReplications
	}).(DestinationReplicationResponseArrayOutput)
}
...
type VolumeGroupVolumePropertiesArgs struct {
	// While auto splitting the short term clone volume, if the parent pool does not have enough space to accommodate the volume after split, it will be automatically resized, which will lead to increased billing. To accept capacity pool size auto grow and create a short term clone volume, set the property as accepted.
	AcceptGrowCapacityPoolForShortTermCloneSplit pulumi.StringPtrInput `pulumi:"acceptGrowCapacityPoolForShortTermCloneSplit"`
	// Specifies whether the volume is enabled for Azure VMware Solution (AVS) datastore purpose
...
// While auto splitting the short term clone volume, if the parent pool does not have enough space to accommodate the volume after split, it will be automatically resized, which will lead to increased billing. To accept capacity pool size auto grow and create a short term clone volume, set the property as accepted.
func (o VolumeGroupVolumePropertiesOutput) AcceptGrowCapacityPoolForShortTermCloneSplit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeGroupVolumeProperties) *string { return v.AcceptGrowCapacityPoolForShortTermCloneSplit }).(pulumi.StringPtrOutput)
}
...
// Language supported for volume.
func (o VolumeGroupVolumePropertiesOutput) Language() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeGroupVolumeProperties) *string { return v.Language }).(pulumi.StringPtrOutput)
}
...
type VolumeGroupVolumePropertiesResponse struct {
	...
	InheritedSizeInBytes float64 `pulumi:"inheritedSizeInBytes"`
	// Specifies if default quota is enabled for the volume.
	IsDefaultQuotaEnabled *bool `pulumi:"isDefaultQuotaEnabled"`
	// Specifies whether volume is a Large Volume or Regular Volume.
	IsLargeVolume *bool `pulumi:"isLargeVolume"`
...
// While auto splitting the short term clone volume, if the parent pool does not have enough space to accommodate the volume after split, it will be automatically resized, which will lead to increased billing. To accept capacity pool size auto grow and create a short term clone volume, set the property as accepted.
func (o VolumeGroupVolumePropertiesResponseOutput) AcceptGrowCapacityPoolForShortTermCloneSplit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeGroupVolumePropertiesResponse) *string {
		return v.AcceptGrowCapacityPoolForShortTermCloneSplit
	}).(pulumi.StringPtrOutput)
}
...
// Space shared by short term clone volume with parent volume in bytes.
func (o VolumeGroupVolumePropertiesResponseOutput) InheritedSizeInBytes() pulumi.Float64Output {
	return o.ApplyT(func(v VolumeGroupVolumePropertiesResponse) float64 { return v.InheritedSizeInBytes }).(pulumi.Float64Output)
}
...
// Language supported for volume.
func (o VolumeGroupVolumePropertiesResponseOutput) Language() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeGroupVolumePropertiesResponse) *string { return v.Language }).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(DestinationReplicationResponseOutput{})
	pulumi.RegisterOutputType(DestinationReplicationResponseArrayOutput{})
