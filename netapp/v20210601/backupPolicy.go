...
//
// Deprecated: azure-native:netapp/v20210601:BackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:BackupPolicy to guarantee forwards compatibility.
...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20210601:BackupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPolicy(ctx *pulumi.Context,
	...
	var resource BackupPolicy
	err := ctx.ReadResource("azure-native:netapp/v20210601:BackupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
