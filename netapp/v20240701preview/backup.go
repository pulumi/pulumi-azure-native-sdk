...
type Backup struct {
	...
	IsLargeVolume pulumi.BoolOutput `pulumi:"isLargeVolume"`
	// Label for backup
...
func NewBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.RegisterResource("azure-native:netapp/v20240701preview:Backup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.ReadResource("azure-native:netapp/v20240701preview:Backup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies if the backup is for a large volume.
func (o BackupOutput) IsLargeVolume() pulumi.BoolOutput {
	return o.ApplyT(func(v *Backup) pulumi.BoolOutput { return v.IsLargeVolume }).(pulumi.BoolOutput)
}
