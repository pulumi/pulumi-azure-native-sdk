...
func LookupSubvolume(ctx *pulumi.Context, args *LookupSubvolumeArgs, opts ...pulumi.InvokeOption) (*LookupSubvolumeResult, error) {
	...
	err := ctx.Invoke("azure-native:netapp/v20240701preview:getSubvolume", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSubvolumeOutput(ctx *pulumi.Context, args LookupSubvolumeOutputArgs, opts ...pulumi.InvokeOption) LookupSubvolumeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSubvolumeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:netapp/v20240701preview:getSubvolume", args, LookupSubvolumeResultOutput{}, options).(LookupSubvolumeResultOutput), nil
