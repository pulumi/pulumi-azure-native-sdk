...
func LookupAccount(ctx *pulumi.Context, args *LookupAccountArgs, opts ...pulumi.InvokeOption) (*LookupAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:netapp/v20230501preview:getAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupAccountResult struct {
	...
	IsMultiAdEnabled bool `pulumi:"isMultiAdEnabled"`
...
func LookupAccountOutput(ctx *pulumi.Context, args LookupAccountOutputArgs, opts ...pulumi.InvokeOption) LookupAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:netapp/v20230501preview:getAccount", args, LookupAccountResultOutput{}, options).(LookupAccountResultOutput), nil
...
// This will have true value only if account is Multiple AD enabled.
func (o LookupAccountResultOutput) IsMultiAdEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupAccountResult) bool { return v.IsMultiAdEnabled }).(pulumi.BoolOutput)
}
...
// Domain for NFSv4 user ID mapping. This property will be set for all NetApp accounts in the subscription and region and only affect non ldap NFSv4 volumes.
func (o LookupAccountResultOutput) NfsV4IDDomain() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAccountResult) *string { return v.NfsV4IDDomain }).(pulumi.StringPtrOutput)
}
