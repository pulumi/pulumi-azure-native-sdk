...
func NewSubvolume(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20221101preview:Subvolume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubvolume(ctx *pulumi.Context,
	...
	var resource Subvolume
	err := ctx.ReadResource("azure-native:netapp/v20221101preview:Subvolume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
