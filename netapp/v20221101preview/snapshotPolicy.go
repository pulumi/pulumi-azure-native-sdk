...
func NewSnapshotPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20230501:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230501preview:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230701:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230701preview:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20231101:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20231101preview:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240101:SnapshotPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20240501:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240501preview:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240701:SnapshotPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240701preview:SnapshotPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:netapp/v20221101preview:SnapshotPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotPolicy(ctx *pulumi.Context,
	...
	var resource SnapshotPolicy
	err := ctx.ReadResource("azure-native:netapp/v20221101preview:SnapshotPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
