...
func NewCapacityPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20250701preview:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20250801:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20250801preview:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20250901:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20250901preview:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20251201:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20251215preview:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260101:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260115preview:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260301:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260315preview:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260401:CapacityPool"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20260415preview:CapacityPool"),
		},
		{
