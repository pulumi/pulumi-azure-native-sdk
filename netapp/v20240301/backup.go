...
func NewBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.RegisterResource("azure-native:netapp/v20240301:Backup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.ReadResource("azure-native:netapp/v20240301:Backup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
