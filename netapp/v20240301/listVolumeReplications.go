...
func ListVolumeReplications(ctx *pulumi.Context, args *ListVolumeReplicationsArgs, opts ...pulumi.InvokeOption) (*ListVolumeReplicationsResult, error) {
	...
	err := ctx.Invoke("azure-native:netapp/v20240301:listVolumeReplications", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListVolumeReplicationsOutput(ctx *pulumi.Context, args ListVolumeReplicationsOutputArgs, opts ...pulumi.InvokeOption) ListVolumeReplicationsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListVolumeReplicationsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:netapp/v20240301:listVolumeReplications", args, ListVolumeReplicationsResultOutput{}, options).(ListVolumeReplicationsResultOutput), nil
