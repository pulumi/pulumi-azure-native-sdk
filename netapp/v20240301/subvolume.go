...
func NewSubvolume(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20240301:Subvolume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubvolume(ctx *pulumi.Context,
	...
	var resource Subvolume
	err := ctx.ReadResource("azure-native:netapp/v20240301:Subvolume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Truncate subvolume to the provided size in bytes
func (o SubvolumeOutput) Size() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *Subvolume) pulumi.Float64PtrOutput { return v.Size }).(pulumi.Float64PtrOutput)
}
