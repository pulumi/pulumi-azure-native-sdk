...
func NewAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:netapp/v20190601:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("azure-native:netapp/v20190601:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Resource tags
func (o AccountOutput) Tags() pulumi.AnyOutput {
	return o.ApplyT(func(v *Account) pulumi.AnyOutput { return v.Tags }).(pulumi.AnyOutput)
}
