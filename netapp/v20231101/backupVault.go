...
func NewBackupVault(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20240901:BackupVault"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240901preview:BackupVault"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:netapp/v20231101:BackupVault", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupVault(ctx *pulumi.Context,
	...
	var resource BackupVault
	err := ctx.ReadResource("azure-native:netapp/v20231101:BackupVault", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
