...
//
// Deprecated: azure-native:netapp/v20220501:VolumeGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:VolumeGroup to guarantee forwards compatibility.
func LookupVolumeGroup(ctx *pulumi.Context, args *LookupVolumeGroupArgs, opts ...pulumi.InvokeOption) (*LookupVolumeGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:netapp/v20220501:getVolumeGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
