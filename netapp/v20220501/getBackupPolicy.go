...
//
// Deprecated: azure-native:netapp/v20220501:BackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:BackupPolicy to guarantee forwards compatibility.
func LookupBackupPolicy(ctx *pulumi.Context, args *LookupBackupPolicyArgs, opts ...pulumi.InvokeOption) (*LookupBackupPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:netapp/v20220501:getBackupPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
