...
// Volume resource
//
// Deprecated: azure-native:netapp/v20220501:Volume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:Volume to guarantee forwards compatibility.
type Volume struct {
...
func NewVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.RegisterResource("azure-native:netapp/v20220501:Volume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.ReadResource("azure-native:netapp/v20220501:Volume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
