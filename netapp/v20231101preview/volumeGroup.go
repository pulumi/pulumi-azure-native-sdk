...
func NewVolumeGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20221101preview:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230501:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230501preview:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230701:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230701preview:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20231101:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240101:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240301:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240301preview:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240501:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240501preview:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240701:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240701preview:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240901:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240901preview:VolumeGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:netapp/v20231101preview:VolumeGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeGroup(ctx *pulumi.Context,
	...
	var resource VolumeGroup
	err := ctx.ReadResource("azure-native:netapp/v20231101preview:VolumeGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
