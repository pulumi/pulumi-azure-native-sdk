...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20230501preview:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230701:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20230701preview:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20231101:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240101:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240301:BackupPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:netapp/v20240701preview:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:netapp/v20240901:BackupPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:netapp/v20231101preview:BackupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPolicy(ctx *pulumi.Context,
	...
	var resource BackupPolicy
	err := ctx.ReadResource("azure-native:netapp/v20231101preview:BackupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
