...
func NewOuContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:aad/v20221201:OuContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOuContainer(ctx *pulumi.Context,
	...
	var resource OuContainer
	err := ctx.ReadResource("azure-native:aad/v20221201:OuContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
