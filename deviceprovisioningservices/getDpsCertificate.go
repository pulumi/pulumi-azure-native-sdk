...
func LookupDpsCertificate(ctx *pulumi.Context, args *LookupDpsCertificateArgs, opts ...pulumi.InvokeOption) (*LookupDpsCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:deviceprovisioningservices:getDpsCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDpsCertificateOutput(ctx *pulumi.Context, args LookupDpsCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupDpsCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDpsCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:deviceprovisioningservices:getDpsCertificate", args, LookupDpsCertificateResultOutput{}, options).(LookupDpsCertificateResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDpsCertificateResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDpsCertificateResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Metadata pertaining to creation and last modification of the resource.
func (o LookupDpsCertificateResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDpsCertificateResult) commontypesv2.SystemDataResponse { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
