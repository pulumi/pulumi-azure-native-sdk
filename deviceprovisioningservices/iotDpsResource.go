...
func NewIotDpsResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20170821preview:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20171115:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20180122:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20200101:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20200301:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20200901preview:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20211015:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20220205:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20221212:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20230301preview:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20250201preview:IotDpsResource"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20260301preview:IotDpsResource"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:devices/v20230301preview:IotDpsResource"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:deviceprovisioningservices:IotDpsResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotDpsResource(ctx *pulumi.Context,
	...
	var resource IotDpsResource
	err := ctx.ReadResource("azure-native:deviceprovisioningservices:IotDpsResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o IotDpsResourceOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *IotDpsResource) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
