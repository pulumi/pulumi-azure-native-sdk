...
func NewDpsCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20170821preview:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20171115:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20180122:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20200101:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20200301:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20200901preview:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20211015:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20220205:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20221212:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20230301preview:DpsCertificate"),
		},
		{
			Type: pulumi.String("azure-native:deviceprovisioningservices/v20250201preview:DpsCertificate"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:deviceprovisioningservices:DpsCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDpsCertificate(ctx *pulumi.Context,
	...
	var resource DpsCertificate
	err := ctx.ReadResource("azure-native:deviceprovisioningservices:DpsCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DpsCertificateOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DpsCertificate) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Metadata pertaining to creation and last modification of the resource.
func (o DpsCertificateOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *DpsCertificate) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
