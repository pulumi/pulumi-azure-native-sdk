...
//
// Deprecated: azure-native:kubernetesconfiguration/v20220301:FluxConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:FluxConfiguration to guarantee forwards compatibility.
...
func NewFluxConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetesconfiguration/v20220301:FluxConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFluxConfiguration(ctx *pulumi.Context,
	...
	var resource FluxConfiguration
	err := ctx.ReadResource("azure-native:kubernetesconfiguration/v20220301:FluxConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
