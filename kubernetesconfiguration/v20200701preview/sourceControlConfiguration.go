...
func NewSourceControlConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetesconfiguration/v20200701preview:SourceControlConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourceControlConfiguration(ctx *pulumi.Context,
	...
	var resource SourceControlConfiguration
	err := ctx.ReadResource("azure-native:kubernetesconfiguration/v20200701preview:SourceControlConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
