...
type FluxConfiguration struct {
	...
	OciRepository OCIRepositoryDefinitionResponsePtrOutput `pulumi:"ociRepository"`
...
func NewFluxConfiguration(ctx *pulumi.Context,
	...
	if args.OciRepository != nil {
		args.OciRepository = args.OciRepository.ToOCIRepositoryDefinitionPtrOutput().ApplyT(func(v *OCIRepositoryDefinition) *OCIRepositoryDefinition { return v.Defaults() }).(OCIRepositoryDefinitionPtrOutput)
	}
	...
	err := ctx.RegisterResource("azure-native:kubernetesconfiguration/v20240401preview:FluxConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFluxConfiguration(ctx *pulumi.Context,
	...
	var resource FluxConfiguration
	err := ctx.ReadResource("azure-native:kubernetesconfiguration/v20240401preview:FluxConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type fluxConfigurationArgs struct {
	...
	// Parameters to reconcile to the OCIRepository source kind type.
	OciRepository *OCIRepositoryDefinition `pulumi:"ociRepository"`
	// Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D
...
type FluxConfigurationArgs struct {
	...
	// Parameters to reconcile to the OCIRepository source kind type.
	OciRepository OCIRepositoryDefinitionPtrInput
	// Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D
...
// Parameters to reconcile to the OCIRepository source kind type.
func (o FluxConfigurationOutput) OciRepository() OCIRepositoryDefinitionResponsePtrOutput {
	return o.ApplyT(func(v *FluxConfiguration) OCIRepositoryDefinitionResponsePtrOutput { return v.OciRepository }).(OCIRepositoryDefinitionResponsePtrOutput)
}
