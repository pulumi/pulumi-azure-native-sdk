...
func LookupFluxConfiguration(ctx *pulumi.Context, args *LookupFluxConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupFluxConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:kubernetesconfiguration/v20241101:getFluxConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupFluxConfigurationResult struct {
	...
	OciRepository *OCIRepositoryDefinitionResponse `pulumi:"ociRepository"`
...
func (val *LookupFluxConfigurationResult) Defaults() *LookupFluxConfigurationResult {
	...
	tmp.OciRepository = tmp.OciRepository.Defaults()
...
func LookupFluxConfigurationOutput(ctx *pulumi.Context, args LookupFluxConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupFluxConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFluxConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kubernetesconfiguration/v20241101:getFluxConfiguration", args, LookupFluxConfigurationResultOutput{}, options).(LookupFluxConfigurationResultOutput), nil
...
// Parameters to reconcile to the OCIRepository source kind type.
func (o LookupFluxConfigurationResultOutput) OciRepository() OCIRepositoryDefinitionResponsePtrOutput {
	return o.ApplyT(func(v LookupFluxConfigurationResult) *OCIRepositoryDefinitionResponse { return v.OciRepository }).(OCIRepositoryDefinitionResponsePtrOutput)
}
