...
//
// Deprecated: azure-native:kubernetesconfiguration/v20210301:SourceControlConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:SourceControlConfiguration to guarantee forwards compatibility.
func LookupSourceControlConfiguration(ctx *pulumi.Context, args *LookupSourceControlConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupSourceControlConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:kubernetesconfiguration/v20210301:getSourceControlConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
