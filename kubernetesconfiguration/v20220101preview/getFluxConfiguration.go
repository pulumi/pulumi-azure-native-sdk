...
func LookupFluxConfiguration(ctx *pulumi.Context, args *LookupFluxConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupFluxConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:kubernetesconfiguration/v20220101preview:getFluxConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupFluxConfigurationResult struct {
	...
	LastSourceUpdatedAt string `pulumi:"lastSourceUpdatedAt"`
	// Branch and SHA of the last source commit synced with the cluster.
	LastSourceUpdatedCommitId string `pulumi:"lastSourceUpdatedCommitId"`
...
func LookupFluxConfigurationOutput(ctx *pulumi.Context, args LookupFluxConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupFluxConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFluxConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kubernetesconfiguration/v20220101preview:getFluxConfiguration", args, LookupFluxConfigurationResultOutput{}, options).(LookupFluxConfigurationResultOutput), nil
...
// Datetime the fluxConfiguration last synced its source on the cluster.
func (o LookupFluxConfigurationResultOutput) LastSourceUpdatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFluxConfigurationResult) string { return v.LastSourceUpdatedAt }).(pulumi.StringOutput)
}

// Branch and SHA of the last source commit synced with the cluster.
func (o LookupFluxConfigurationResultOutput) LastSourceUpdatedCommitId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFluxConfigurationResult) string { return v.LastSourceUpdatedCommitId }).(pulumi.StringOutput)
}
