...
func NewFluxConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:kubernetesconfiguration/v20230501:FluxConfiguration"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:kubernetesconfiguration/v20250401:FluxConfiguration"),
		},
	})
