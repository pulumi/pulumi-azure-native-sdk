...
//
// Deprecated: azure-native:kubernetesconfiguration/v20210501preview:SourceControlConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:SourceControlConfiguration to guarantee forwards compatibility.
...
func NewSourceControlConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetesconfiguration/v20210501preview:SourceControlConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourceControlConfiguration(ctx *pulumi.Context,
	...
	var resource SourceControlConfiguration
	err := ctx.ReadResource("azure-native:kubernetesconfiguration/v20210501preview:SourceControlConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
