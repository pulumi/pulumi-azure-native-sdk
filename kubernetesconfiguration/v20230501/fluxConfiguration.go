...
func NewFluxConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:kubernetesconfiguration/v20241101:FluxConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:kubernetesconfiguration/v20230501:FluxConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFluxConfiguration(ctx *pulumi.Context,
	...
	var resource FluxConfiguration
	err := ctx.ReadResource("azure-native:kubernetesconfiguration/v20230501:FluxConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o FluxConfigurationOutput) ReconciliationWaitDuration() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FluxConfiguration) pulumi.StringPtrOutput { return v.ReconciliationWaitDuration }).(pulumi.StringPtrOutput)
}
...
func (o FluxConfigurationOutput) WaitForReconciliation() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *FluxConfiguration) pulumi.BoolPtrOutput { return v.WaitForReconciliation }).(pulumi.BoolPtrOutput)
}
