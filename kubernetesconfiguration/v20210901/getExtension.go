...
// The error detail.
func (o LookupExtensionResultOutput) ErrorInfo() ErrorDetailResponsePtrOutput {
	return o.ApplyT(func(v LookupExtensionResult) *ErrorDetailResponse { return v.ErrorInfo }).(ErrorDetailResponsePtrOutput)
}
