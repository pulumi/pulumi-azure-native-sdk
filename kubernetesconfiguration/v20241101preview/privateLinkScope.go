...
func NewPrivateLinkScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetesconfiguration/v20241101preview:PrivateLinkScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkScope(ctx *pulumi.Context,
	...
	var resource PrivateLinkScope
	err := ctx.ReadResource("azure-native:kubernetesconfiguration/v20241101preview:PrivateLinkScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
