...
func LookupAccount(ctx *pulumi.Context, args *LookupAccountArgs, opts ...pulumi.InvokeOption) (*LookupAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:graphservices/v20230413:getAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAccountOutput(ctx *pulumi.Context, args LookupAccountOutputArgs, opts ...pulumi.InvokeOption) LookupAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:graphservices/v20230413:getAccount", args, LookupAccountResultOutput{}, options).(LookupAccountResultOutput), nil
...
// Metadata pertaining to creation and last modification of the resource.
func (o LookupAccountResultOutput) SystemData() AccountResourceResponseSystemDataOutput {
	return o.ApplyT(func(v LookupAccountResult) AccountResourceResponseSystemData { return v.SystemData }).(AccountResourceResponseSystemDataOutput)
}
