...
//
// Deprecated: azure-native:azurearcdata/v20210601preview:SqlManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:SqlManagedInstance to guarantee forwards compatibility.
...
func NewSqlManagedInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20210601preview:SqlManagedInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlManagedInstance(ctx *pulumi.Context,
	...
	var resource SqlManagedInstance
	err := ctx.ReadResource("azure-native:azurearcdata/v20210601preview:SqlManagedInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
