...
func NewSqlServerInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20230115preview:SqlServerInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerInstance(ctx *pulumi.Context,
	...
	var resource SqlServerInstance
	err := ctx.ReadResource("azure-native:azurearcdata/v20230115preview:SqlServerInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
