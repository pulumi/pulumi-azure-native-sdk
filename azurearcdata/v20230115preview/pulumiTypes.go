...
type AGReplicas struct {
	...
	SecondaryRoleAllowConnections *string `pulumi:"secondaryRoleAllowConnections"`
	// The synchronization state of the availability group replicas.
	SynchronizationState *string `pulumi:"synchronizationState"`
}

// AGReplicasInput is an input type that accepts AGReplicasArgs and AGReplicasOutput values.
// You can construct a concrete instance of `AGReplicasInput` via:
//
//	AGReplicasArgs{...}
type AGReplicasInput interface {
	pulumi.Input

	ToAGReplicasOutput() AGReplicasOutput
	ToAGReplicasOutputWithContext(context.Context) AGReplicasOutput
}

// The information about each failover group replica.
type AGReplicasArgs struct {
	// The availability mode of the replica.
	AvailabilityMode pulumi.StringPtrInput `pulumi:"availabilityMode"`
	// The connected state of the replica.
	ConnectedState pulumi.StringPtrInput `pulumi:"connectedState"`
	// The health state of the replica.
	...
	// The secondary role allowed connections.
	SecondaryRoleAllowConnections pulumi.StringPtrInput `pulumi:"secondaryRoleAllowConnections"`
	// The synchronization state of the availability group replicas.
	SynchronizationState pulumi.StringPtrInput `pulumi:"synchronizationState"`
}

func (AGReplicasArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*AGReplicas)(nil)).Elem()
}

func (i AGReplicasArgs) ToAGReplicasOutput() AGReplicasOutput {
	return i.ToAGReplicasOutputWithContext(context.Background())
}

func (i AGReplicasArgs) ToAGReplicasOutputWithContext(ctx context.Context) AGReplicasOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AGReplicasOutput)
}

// AGReplicasArrayInput is an input type that accepts AGReplicasArray and AGReplicasArrayOutput values.
// You can construct a concrete instance of `AGReplicasArrayInput` via:
//
//	AGReplicasArray{ AGReplicasArgs{...} }
type AGReplicasArrayInput interface {
	pulumi.Input

	ToAGReplicasArrayOutput() AGReplicasArrayOutput
	ToAGReplicasArrayOutputWithContext(context.Context) AGReplicasArrayOutput
}

type AGReplicasArray []AGReplicasInput

func (AGReplicasArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]AGReplicas)(nil)).Elem()
}

func (i AGReplicasArray) ToAGReplicasArrayOutput() AGReplicasArrayOutput {
	return i.ToAGReplicasArrayOutputWithContext(context.Background())
}

func (i AGReplicasArray) ToAGReplicasArrayOutputWithContext(ctx context.Context) AGReplicasArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AGReplicasArrayOutput)
}

// The information about each failover group replica.
type AGReplicasOutput struct{ *pulumi.OutputState }

func (AGReplicasOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AGReplicas)(nil)).Elem()
}

func (o AGReplicasOutput) ToAGReplicasOutput() AGReplicasOutput {
	return o
}

func (o AGReplicasOutput) ToAGReplicasOutputWithContext(ctx context.Context) AGReplicasOutput {
	return o
}

// The availability mode of the replica.
func (o AGReplicasOutput) AvailabilityMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicas) *string { return v.AvailabilityMode }).(pulumi.StringPtrOutput)
}

// The connected state of the replica.
func (o AGReplicasOutput) ConnectedState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicas) *string { return v.ConnectedState }).(pulumi.StringPtrOutput)
}

// The health state of the replica.
func (o AGReplicasOutput) HealthState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicas) *string { return v.HealthState }).(pulumi.StringPtrOutput)
}

// The replica name.
func (o AGReplicasOutput) ReplicaName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicas) *string { return v.ReplicaName }).(pulumi.StringPtrOutput)
}

// The role of the replica.
func (o AGReplicasOutput) Role() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicas) *string { return v.Role }).(pulumi.StringPtrOutput)
}

// The secondary role allowed connections.
func (o AGReplicasOutput) SecondaryRoleAllowConnections() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicas) *string { return v.SecondaryRoleAllowConnections }).(pulumi.StringPtrOutput)
}

// The synchronization state of the availability group replicas.
func (o AGReplicasOutput) SynchronizationState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicas) *string { return v.SynchronizationState }).(pulumi.StringPtrOutput)
}

type AGReplicasArrayOutput struct{ *pulumi.OutputState }

func (AGReplicasArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]AGReplicas)(nil)).Elem()
}

func (o AGReplicasArrayOutput) ToAGReplicasArrayOutput() AGReplicasArrayOutput {
	return o
}

func (o AGReplicasArrayOutput) ToAGReplicasArrayOutputWithContext(ctx context.Context) AGReplicasArrayOutput {
	return o
}

func (o AGReplicasArrayOutput) Index(i pulumi.IntInput) AGReplicasOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) AGReplicas {
		return vs[0].([]AGReplicas)[vs[1].(int)]
	}).(AGReplicasOutput)
}

// The information about each failover group replica.
type AGReplicasResponse struct {
	// The availability mode of the replica.
	AvailabilityMode *string `pulumi:"availabilityMode"`
	// The connected state of the replica.
	ConnectedState *string `pulumi:"connectedState"`
...
// The information about each failover group replica.
type AGReplicasResponseOutput struct{ *pulumi.OutputState }

func (AGReplicasResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AGReplicasResponse)(nil)).Elem()
}

func (o AGReplicasResponseOutput) ToAGReplicasResponseOutput() AGReplicasResponseOutput {
	return o
}

func (o AGReplicasResponseOutput) ToAGReplicasResponseOutputWithContext(ctx context.Context) AGReplicasResponseOutput {
	return o
}

// The availability mode of the replica.
func (o AGReplicasResponseOutput) AvailabilityMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicasResponse) *string { return v.AvailabilityMode }).(pulumi.StringPtrOutput)
}

// The connected state of the replica.
func (o AGReplicasResponseOutput) ConnectedState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicasResponse) *string { return v.ConnectedState }).(pulumi.StringPtrOutput)
}

// The health state of the replica.
func (o AGReplicasResponseOutput) HealthState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicasResponse) *string { return v.HealthState }).(pulumi.StringPtrOutput)
}

// The replica name.
func (o AGReplicasResponseOutput) ReplicaName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicasResponse) *string { return v.ReplicaName }).(pulumi.StringPtrOutput)
}

// The role of the replica.
func (o AGReplicasResponseOutput) Role() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicasResponse) *string { return v.Role }).(pulumi.StringPtrOutput)
}

// The secondary role allowed connections.
func (o AGReplicasResponseOutput) SecondaryRoleAllowConnections() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicasResponse) *string { return v.SecondaryRoleAllowConnections }).(pulumi.StringPtrOutput)
}

// The synchronization state of the availability group replicas.
func (o AGReplicasResponseOutput) SynchronizationState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AGReplicasResponse) *string { return v.SynchronizationState }).(pulumi.StringPtrOutput)
}

type AGReplicasResponseArrayOutput struct{ *pulumi.OutputState }

func (AGReplicasResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]AGReplicasResponse)(nil)).Elem()
}

func (o AGReplicasResponseArrayOutput) ToAGReplicasResponseArrayOutput() AGReplicasResponseArrayOutput {
	return o
}

func (o AGReplicasResponseArrayOutput) ToAGReplicasResponseArrayOutputWithContext(ctx context.Context) AGReplicasResponseArrayOutput {
	return o
}

func (o AGReplicasResponseArrayOutput) Index(i pulumi.IntInput) AGReplicasResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) AGReplicasResponse {
		return vs[0].([]AGReplicasResponse)[vs[1].(int)]
	}).(AGReplicasResponseOutput)
}
...
type FailoverGroupProperties struct {
	...
	Status *FailoverGroupStatus `pulumi:"status"`
}
...
type FailoverGroupPropertiesArgs struct {
	...
	// The status of the failover group custom resource.
	Status FailoverGroupStatusPtrInput `pulumi:"status"`
}
...
// The status of the failover group custom resource.
func (o FailoverGroupPropertiesOutput) Status() FailoverGroupStatusPtrOutput {
	return o.ApplyT(func(v FailoverGroupProperties) *FailoverGroupStatus { return v.Status }).(FailoverGroupStatusPtrOutput)
}
...
type FailoverGroupPropertiesResponse struct {
	...
	// The status of the failover group custom resource.
	Status *FailoverGroupStatusResponse `pulumi:"status"`
}
...
// The status of the failover group custom resource.
func (o FailoverGroupPropertiesResponseOutput) Status() FailoverGroupStatusResponsePtrOutput {
	return o.ApplyT(func(v FailoverGroupPropertiesResponse) *FailoverGroupStatusResponse { return v.Status }).(FailoverGroupStatusResponsePtrOutput)
}
...
type FailoverGroupStatus struct {
	...
	Replicas []AGReplicas `pulumi:"replicas"`
...
// FailoverGroupStatusInput is an input type that accepts FailoverGroupStatusArgs and FailoverGroupStatusOutput values.
// You can construct a concrete instance of `FailoverGroupStatusInput` via:
//
//	FailoverGroupStatusArgs{...}
type FailoverGroupStatusInput interface {
	pulumi.Input

	ToFailoverGroupStatusOutput() FailoverGroupStatusOutput
	ToFailoverGroupStatusOutputWithContext(context.Context) FailoverGroupStatusOutput
}

// The status of the Kubernetes custom resource.
type FailoverGroupStatusArgs struct {
	// The time that the custom resource was last updated.
	LastUpdateTime pulumi.StringPtrInput `pulumi:"lastUpdateTime"`
	// The version of the replicaSet associated with the failover group custom resource.
	ObservedGeneration pulumi.Float64PtrInput `pulumi:"observedGeneration"`
	// A list of failover group replicas.
	Replicas AGReplicasArrayInput `pulumi:"replicas"`
	// The message in case of a failure in the failover group.
...
func (FailoverGroupStatusArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*FailoverGroupStatus)(nil)).Elem()
}

func (i FailoverGroupStatusArgs) ToFailoverGroupStatusOutput() FailoverGroupStatusOutput {
	return i.ToFailoverGroupStatusOutputWithContext(context.Background())
}

func (i FailoverGroupStatusArgs) ToFailoverGroupStatusOutputWithContext(ctx context.Context) FailoverGroupStatusOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FailoverGroupStatusOutput)
}

func (i FailoverGroupStatusArgs) ToFailoverGroupStatusPtrOutput() FailoverGroupStatusPtrOutput {
	return i.ToFailoverGroupStatusPtrOutputWithContext(context.Background())
}

func (i FailoverGroupStatusArgs) ToFailoverGroupStatusPtrOutputWithContext(ctx context.Context) FailoverGroupStatusPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FailoverGroupStatusOutput).ToFailoverGroupStatusPtrOutputWithContext(ctx)
}

// FailoverGroupStatusPtrInput is an input type that accepts FailoverGroupStatusArgs, FailoverGroupStatusPtr and FailoverGroupStatusPtrOutput values.
// You can construct a concrete instance of `FailoverGroupStatusPtrInput` via:
//
//	        FailoverGroupStatusArgs{...}
//
//	or:
//
//	        nil
type FailoverGroupStatusPtrInput interface {
	pulumi.Input

	ToFailoverGroupStatusPtrOutput() FailoverGroupStatusPtrOutput
	ToFailoverGroupStatusPtrOutputWithContext(context.Context) FailoverGroupStatusPtrOutput
}

type failoverGroupStatusPtrType FailoverGroupStatusArgs

func FailoverGroupStatusPtr(v *FailoverGroupStatusArgs) FailoverGroupStatusPtrInput {
	return (*failoverGroupStatusPtrType)(v)
}

func (*failoverGroupStatusPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**FailoverGroupStatus)(nil)).Elem()
}

func (i *failoverGroupStatusPtrType) ToFailoverGroupStatusPtrOutput() FailoverGroupStatusPtrOutput {
	return i.ToFailoverGroupStatusPtrOutputWithContext(context.Background())
}

func (i *failoverGroupStatusPtrType) ToFailoverGroupStatusPtrOutputWithContext(ctx context.Context) FailoverGroupStatusPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FailoverGroupStatusPtrOutput)
}

// The status of the Kubernetes custom resource.
type FailoverGroupStatusOutput struct{ *pulumi.OutputState }

func (FailoverGroupStatusOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FailoverGroupStatus)(nil)).Elem()
}

func (o FailoverGroupStatusOutput) ToFailoverGroupStatusOutput() FailoverGroupStatusOutput {
	return o
}

func (o FailoverGroupStatusOutput) ToFailoverGroupStatusOutputWithContext(ctx context.Context) FailoverGroupStatusOutput {
	return o
}

func (o FailoverGroupStatusOutput) ToFailoverGroupStatusPtrOutput() FailoverGroupStatusPtrOutput {
	return o.ToFailoverGroupStatusPtrOutputWithContext(context.Background())
}

func (o FailoverGroupStatusOutput) ToFailoverGroupStatusPtrOutputWithContext(ctx context.Context) FailoverGroupStatusPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v FailoverGroupStatus) *FailoverGroupStatus {
		return &v
	}).(FailoverGroupStatusPtrOutput)
}

// The time that the custom resource was last updated.
func (o FailoverGroupStatusOutput) LastUpdateTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FailoverGroupStatus) *string { return v.LastUpdateTime }).(pulumi.StringPtrOutput)
}

// The version of the replicaSet associated with the failover group custom resource.
func (o FailoverGroupStatusOutput) ObservedGeneration() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v FailoverGroupStatus) *float64 { return v.ObservedGeneration }).(pulumi.Float64PtrOutput)
}

// A list of failover group replicas.
func (o FailoverGroupStatusOutput) Replicas() AGReplicasArrayOutput {
	return o.ApplyT(func(v FailoverGroupStatus) []AGReplicas { return v.Replicas }).(AGReplicasArrayOutput)
}

// The message in case of a failure in the failover group.
func (o FailoverGroupStatusOutput) Results() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FailoverGroupStatus) *string { return v.Results }).(pulumi.StringPtrOutput)
}

// The role of the managed instance in the failover group.
func (o FailoverGroupStatusOutput) Role() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FailoverGroupStatus) *string { return v.Role }).(pulumi.StringPtrOutput)
}

// The state of the failover group custom resource.
func (o FailoverGroupStatusOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FailoverGroupStatus) *string { return v.State }).(pulumi.StringPtrOutput)
}

type FailoverGroupStatusPtrOutput struct{ *pulumi.OutputState }

func (FailoverGroupStatusPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**FailoverGroupStatus)(nil)).Elem()
}

func (o FailoverGroupStatusPtrOutput) ToFailoverGroupStatusPtrOutput() FailoverGroupStatusPtrOutput {
	return o
}

func (o FailoverGroupStatusPtrOutput) ToFailoverGroupStatusPtrOutputWithContext(ctx context.Context) FailoverGroupStatusPtrOutput {
	return o
}

func (o FailoverGroupStatusPtrOutput) Elem() FailoverGroupStatusOutput {
	return o.ApplyT(func(v *FailoverGroupStatus) FailoverGroupStatus {
		if v != nil {
			return *v
		}
		var ret FailoverGroupStatus
		return ret
	}).(FailoverGroupStatusOutput)
}

// The time that the custom resource was last updated.
func (o FailoverGroupStatusPtrOutput) LastUpdateTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatus) *string {
		if v == nil {
			return nil
		}
		return v.LastUpdateTime
...
// The version of the replicaSet associated with the failover group custom resource.
func (o FailoverGroupStatusPtrOutput) ObservedGeneration() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatus) *float64 {
		if v == nil {
			return nil
		}
		return v.ObservedGeneration
...
// A list of failover group replicas.
func (o FailoverGroupStatusPtrOutput) Replicas() AGReplicasArrayOutput {
	return o.ApplyT(func(v *FailoverGroupStatus) []AGReplicas {
		if v == nil {
			return nil
		}
		return v.Replicas
	}).(AGReplicasArrayOutput)
}

// The message in case of a failure in the failover group.
func (o FailoverGroupStatusPtrOutput) Results() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatus) *string {
		if v == nil {
			return nil
		}
...
// The role of the managed instance in the failover group.
func (o FailoverGroupStatusPtrOutput) Role() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatus) *string {
		if v == nil {
			return nil
		}
...
// The state of the failover group custom resource.
func (o FailoverGroupStatusPtrOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatus) *string {
		if v == nil {
			return nil
		}
...
// The status of the Kubernetes custom resource.
type FailoverGroupStatusResponse struct {
	// The time that the custom resource was last updated.
	LastUpdateTime *string `pulumi:"lastUpdateTime"`
	// The version of the replicaSet associated with the failover group custom resource.
	ObservedGeneration *float64 `pulumi:"observedGeneration"`
	// A list of failover group replicas.
	Replicas []AGReplicasResponse `pulumi:"replicas"`
	// The message in case of a failure in the failover group.
	Results *string `pulumi:"results"`
	// The role of the managed instance in the failover group.
	Role *string `pulumi:"role"`
...
// The status of the Kubernetes custom resource.
type FailoverGroupStatusResponseOutput struct{ *pulumi.OutputState }

func (FailoverGroupStatusResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FailoverGroupStatusResponse)(nil)).Elem()
}

func (o FailoverGroupStatusResponseOutput) ToFailoverGroupStatusResponseOutput() FailoverGroupStatusResponseOutput {
	return o
}

func (o FailoverGroupStatusResponseOutput) ToFailoverGroupStatusResponseOutputWithContext(ctx context.Context) FailoverGroupStatusResponseOutput {
	return o
}

// The time that the custom resource was last updated.
func (o FailoverGroupStatusResponseOutput) LastUpdateTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FailoverGroupStatusResponse) *string { return v.LastUpdateTime }).(pulumi.StringPtrOutput)
}

// The version of the replicaSet associated with the failover group custom resource.
func (o FailoverGroupStatusResponseOutput) ObservedGeneration() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v FailoverGroupStatusResponse) *float64 { return v.ObservedGeneration }).(pulumi.Float64PtrOutput)
}

// A list of failover group replicas.
func (o FailoverGroupStatusResponseOutput) Replicas() AGReplicasResponseArrayOutput {
	return o.ApplyT(func(v FailoverGroupStatusResponse) []AGReplicasResponse { return v.Replicas }).(AGReplicasResponseArrayOutput)
}

// The message in case of a failure in the failover group.
func (o FailoverGroupStatusResponseOutput) Results() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FailoverGroupStatusResponse) *string { return v.Results }).(pulumi.StringPtrOutput)
}

// The role of the managed instance in the failover group.
func (o FailoverGroupStatusResponseOutput) Role() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FailoverGroupStatusResponse) *string { return v.Role }).(pulumi.StringPtrOutput)
}

// The state of the failover group custom resource.
func (o FailoverGroupStatusResponseOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FailoverGroupStatusResponse) *string { return v.State }).(pulumi.StringPtrOutput)
}

type FailoverGroupStatusResponsePtrOutput struct{ *pulumi.OutputState }

func (FailoverGroupStatusResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**FailoverGroupStatusResponse)(nil)).Elem()
}

func (o FailoverGroupStatusResponsePtrOutput) ToFailoverGroupStatusResponsePtrOutput() FailoverGroupStatusResponsePtrOutput {
	return o
}

func (o FailoverGroupStatusResponsePtrOutput) ToFailoverGroupStatusResponsePtrOutputWithContext(ctx context.Context) FailoverGroupStatusResponsePtrOutput {
	return o
}

func (o FailoverGroupStatusResponsePtrOutput) Elem() FailoverGroupStatusResponseOutput {
	return o.ApplyT(func(v *FailoverGroupStatusResponse) FailoverGroupStatusResponse {
		if v != nil {
			return *v
		}
		var ret FailoverGroupStatusResponse
		return ret
	}).(FailoverGroupStatusResponseOutput)
}

// The time that the custom resource was last updated.
func (o FailoverGroupStatusResponsePtrOutput) LastUpdateTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatusResponse) *string {
		if v == nil {
			return nil
		}
		return v.LastUpdateTime
...
// The version of the replicaSet associated with the failover group custom resource.
func (o FailoverGroupStatusResponsePtrOutput) ObservedGeneration() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatusResponse) *float64 {
		if v == nil {
			return nil
		}
		return v.ObservedGeneration
...
// A list of failover group replicas.
func (o FailoverGroupStatusResponsePtrOutput) Replicas() AGReplicasResponseArrayOutput {
	return o.ApplyT(func(v *FailoverGroupStatusResponse) []AGReplicasResponse {
		if v == nil {
			return nil
		}
		return v.Replicas
	}).(AGReplicasResponseArrayOutput)
}

// The message in case of a failure in the failover group.
func (o FailoverGroupStatusResponsePtrOutput) Results() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatusResponse) *string {
		if v == nil {
			return nil
		}
...
// The role of the managed instance in the failover group.
func (o FailoverGroupStatusResponsePtrOutput) Role() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatusResponse) *string {
		if v == nil {
			return nil
		}
...
// The state of the failover group custom resource.
func (o FailoverGroupStatusResponsePtrOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FailoverGroupStatusResponse) *string {
		if v == nil {
			return nil
		}
...
func init() {
	pulumi.RegisterOutputType(AGReplicasOutput{})
	pulumi.RegisterOutputType(AGReplicasArrayOutput{})
	pulumi.RegisterOutputType(AGReplicasResponseOutput{})
	pulumi.RegisterOutputType(AGReplicasResponseArrayOutput{})
	...
	pulumi.RegisterOutputType(FailoverGroupStatusOutput{})
	pulumi.RegisterOutputType(FailoverGroupStatusPtrOutput{})
	pulumi.RegisterOutputType(FailoverGroupStatusResponseOutput{})
	pulumi.RegisterOutputType(FailoverGroupStatusResponsePtrOutput{})
