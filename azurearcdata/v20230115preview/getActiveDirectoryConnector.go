...
func LookupActiveDirectoryConnector(ctx *pulumi.Context, args *LookupActiveDirectoryConnectorArgs, opts ...pulumi.InvokeOption) (*LookupActiveDirectoryConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:azurearcdata/v20230115preview:getActiveDirectoryConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupActiveDirectoryConnectorOutput(ctx *pulumi.Context, args LookupActiveDirectoryConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupActiveDirectoryConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupActiveDirectoryConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurearcdata/v20230115preview:getActiveDirectoryConnector", args, LookupActiveDirectoryConnectorResultOutput{}, options).(LookupActiveDirectoryConnectorResultOutput), nil
