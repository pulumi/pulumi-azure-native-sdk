...
func NewActiveDirectoryConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20240101:ActiveDirectoryConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActiveDirectoryConnector(ctx *pulumi.Context,
	...
	var resource ActiveDirectoryConnector
	err := ctx.ReadResource("azure-native:azurearcdata/v20240101:ActiveDirectoryConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
