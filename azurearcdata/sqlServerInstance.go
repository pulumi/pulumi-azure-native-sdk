...
func NewSqlServerInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurearcdata/v20260101:SqlServerInstance"),
		},
	})
...
// The Azure API version of the resource.
func (o SqlServerInstanceOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SqlServerInstance) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SqlServerInstanceOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *SqlServerInstance) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
