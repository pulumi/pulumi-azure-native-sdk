...
func NewSqlAvailabilityGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:azurearcdata/v20230315preview:SqlAvailabilityGroup"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlAvailabilityGroup
	err := ctx.RegisterResource("azure-native:azurearcdata:SqlAvailabilityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlAvailabilityGroup(ctx *pulumi.Context,
	...
	var resource SqlAvailabilityGroup
	err := ctx.ReadResource("azure-native:azurearcdata:SqlAvailabilityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
