...
func NewSqlServerLicense(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurearcdata:SqlServerLicense"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SqlServerLicense
	err := ctx.RegisterResource("azure-native:azurearcdata/v20240501preview:SqlServerLicense", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerLicense(ctx *pulumi.Context,
	...
	var resource SqlServerLicense
	err := ctx.ReadResource("azure-native:azurearcdata/v20240501preview:SqlServerLicense", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
