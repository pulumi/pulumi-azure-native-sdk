...
func GetSqlServerInstanceTelemetry(ctx *pulumi.Context, args *GetSqlServerInstanceTelemetryArgs, opts ...pulumi.InvokeOption) (*GetSqlServerInstanceTelemetryResult, error) {
	...
	err := ctx.Invoke("azure-native:azurearcdata/v20240501preview:getSqlServerInstanceTelemetry", args.Defaults(), &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSqlServerInstanceTelemetryOutput(ctx *pulumi.Context, args GetSqlServerInstanceTelemetryOutputArgs, opts ...pulumi.InvokeOption) GetSqlServerInstanceTelemetryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSqlServerInstanceTelemetryResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurearcdata/v20240501preview:getSqlServerInstanceTelemetry", args.Defaults(), GetSqlServerInstanceTelemetryResultOutput{}, options).(GetSqlServerInstanceTelemetryResultOutput), nil
