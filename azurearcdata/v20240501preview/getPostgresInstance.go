...
func LookupPostgresInstance(ctx *pulumi.Context, args *LookupPostgresInstanceArgs, opts ...pulumi.InvokeOption) (*LookupPostgresInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:azurearcdata/v20240501preview:getPostgresInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupPostgresInstanceOutput(ctx *pulumi.Context, args LookupPostgresInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupPostgresInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPostgresInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurearcdata/v20240501preview:getPostgresInstance", args, LookupPostgresInstanceResultOutput{}, options).(LookupPostgresInstanceResultOutput), nil
