...
func NewSqlAvailabilityGroupDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:azurearcdata/v20230315preview:SqlAvailabilityGroupDatabase"),
		},
	})
	opts = append(opts, aliases)
	var resource SqlAvailabilityGroupDatabase
	err := ctx.RegisterResource("azure-native:azurearcdata:SqlAvailabilityGroupDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlAvailabilityGroupDatabase(ctx *pulumi.Context,
	...
	var resource SqlAvailabilityGroupDatabase
	err := ctx.ReadResource("azure-native:azurearcdata:SqlAvailabilityGroupDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
