...
func NewDataController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20250301preview:DataController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataController(ctx *pulumi.Context,
	...
	var resource DataController
	err := ctx.ReadResource("azure-native:azurearcdata/v20250301preview:DataController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
