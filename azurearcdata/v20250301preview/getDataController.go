...
func LookupDataController(ctx *pulumi.Context, args *LookupDataControllerArgs, opts ...pulumi.InvokeOption) (*LookupDataControllerResult, error) {
	...
	err := ctx.Invoke("azure-native:azurearcdata/v20250301preview:getDataController", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDataControllerOutput(ctx *pulumi.Context, args LookupDataControllerOutputArgs, opts ...pulumi.InvokeOption) LookupDataControllerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDataControllerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurearcdata/v20250301preview:getDataController", args, LookupDataControllerResultOutput{}, options).(LookupDataControllerResultOutput), nil
