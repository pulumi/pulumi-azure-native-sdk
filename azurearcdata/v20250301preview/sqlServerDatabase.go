...
func NewSqlServerDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20250301preview:SqlServerDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerDatabase(ctx *pulumi.Context,
	...
	var resource SqlServerDatabase
	err := ctx.ReadResource("azure-native:azurearcdata/v20250301preview:SqlServerDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
