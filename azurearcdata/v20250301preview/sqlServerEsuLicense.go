...
func NewSqlServerEsuLicense(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20250301preview:SqlServerEsuLicense", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerEsuLicense(ctx *pulumi.Context,
	...
	var resource SqlServerEsuLicense
	err := ctx.ReadResource("azure-native:azurearcdata/v20250301preview:SqlServerEsuLicense", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
