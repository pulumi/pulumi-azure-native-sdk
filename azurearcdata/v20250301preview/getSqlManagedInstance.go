...
func LookupSqlManagedInstance(ctx *pulumi.Context, args *LookupSqlManagedInstanceArgs, opts ...pulumi.InvokeOption) (*LookupSqlManagedInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:azurearcdata/v20250301preview:getSqlManagedInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupSqlManagedInstanceOutput(ctx *pulumi.Context, args LookupSqlManagedInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupSqlManagedInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSqlManagedInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurearcdata/v20250301preview:getSqlManagedInstance", args, LookupSqlManagedInstanceResultOutput{}, options).(LookupSqlManagedInstanceResultOutput), nil
