...
func NewSqlServerLicense(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20250301preview:SqlServerLicense", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerLicense(ctx *pulumi.Context,
	...
	var resource SqlServerLicense
	err := ctx.ReadResource("azure-native:azurearcdata/v20250301preview:SqlServerLicense", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
