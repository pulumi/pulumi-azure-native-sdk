...
func LookupSqlServerLicense(ctx *pulumi.Context, args *LookupSqlServerLicenseArgs, opts ...pulumi.InvokeOption) (*LookupSqlServerLicenseResult, error) {
	...
	err := ctx.Invoke("azure-native:azurearcdata:getSqlServerLicense", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSqlServerLicenseResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSqlServerLicenseResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
