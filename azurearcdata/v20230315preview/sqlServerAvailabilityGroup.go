...
func NewSqlServerAvailabilityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20230315preview:SqlServerAvailabilityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlServerAvailabilityGroup(ctx *pulumi.Context,
	...
	var resource SqlServerAvailabilityGroup
	err := ctx.ReadResource("azure-native:azurearcdata/v20230315preview:SqlServerAvailabilityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
