...
func NewSqlManagedInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20230315preview:SqlManagedInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlManagedInstance(ctx *pulumi.Context,
	...
	var resource SqlManagedInstance
	err := ctx.ReadResource("azure-native:azurearcdata/v20230315preview:SqlManagedInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
