...
func NewPostgresInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurearcdata/v20230315preview:PostgresInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPostgresInstance(ctx *pulumi.Context,
	...
	var resource PostgresInstance
	err := ctx.ReadResource("azure-native:azurearcdata/v20230315preview:PostgresInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
