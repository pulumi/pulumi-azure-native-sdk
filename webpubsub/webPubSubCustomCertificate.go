...
func NewWebPubSubCustomCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:webpubsub/v20250101preview:WebPubSubCustomCertificate"),
		},
		{
			Type: pulumi.String("azure-native:webpubsub/v20250801preview:WebPubSubCustomCertificate"),
		},
	})
...
// The Azure API version of the resource.
func (o WebPubSubCustomCertificateOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebPubSubCustomCertificate) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebPubSubCustomCertificateOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *WebPubSubCustomCertificate) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
