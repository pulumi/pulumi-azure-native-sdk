...
func NewWebPubSub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:webpubsub/v20240101preview:WebPubSub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebPubSub(ctx *pulumi.Context,
	...
	var resource WebPubSub
	err := ctx.ReadResource("azure-native:webpubsub/v20240101preview:WebPubSub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
