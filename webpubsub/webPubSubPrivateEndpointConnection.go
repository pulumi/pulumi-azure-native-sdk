...
func NewWebPubSubPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:webpubsub/v20250101preview:WebPubSubPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:webpubsub/v20250801preview:WebPubSubPrivateEndpointConnection"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebPubSubPrivateEndpointConnectionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *WebPubSubPrivateEndpointConnection) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
