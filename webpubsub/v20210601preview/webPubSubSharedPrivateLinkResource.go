...
func NewWebPubSubSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:webpubsub/v20210601preview:WebPubSubSharedPrivateLinkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebPubSubSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	var resource WebPubSubSharedPrivateLinkResource
	err := ctx.ReadResource("azure-native:webpubsub/v20210601preview:WebPubSubSharedPrivateLinkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
