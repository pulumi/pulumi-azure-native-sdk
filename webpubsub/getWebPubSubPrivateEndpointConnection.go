...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupWebPubSubPrivateEndpointConnectionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupWebPubSubPrivateEndpointConnectionResult) commontypesv5.SystemDataResponse {
		return v.SystemData
