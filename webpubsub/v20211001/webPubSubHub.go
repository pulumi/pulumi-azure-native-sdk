...
// A hub setting
//
// Deprecated: azure-native:webpubsub/v20211001:WebPubSubHub is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230301preview:WebPubSubHub to guarantee forwards compatibility.
...
func NewWebPubSubHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:webpubsub/v20211001:WebPubSubHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebPubSubHub(ctx *pulumi.Context,
	...
	var resource WebPubSubHub
	err := ctx.ReadResource("azure-native:webpubsub/v20211001:WebPubSubHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
