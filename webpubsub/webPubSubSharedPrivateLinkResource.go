...
func NewWebPubSubSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:webpubsub/v20230801preview:WebPubSubSharedPrivateLinkResource"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:webpubsub/v20240401preview:WebPubSubSharedPrivateLinkResource"),
		},
		{
			Type: pulumi.String("azure-native:webpubsub/v20240801preview:WebPubSubSharedPrivateLinkResource"),
		},
		{
			Type: pulumi.String("azure-native:webpubsub/v20241001preview:WebPubSubSharedPrivateLinkResource"),
		},
		{
			Type: pulumi.String("azure-native:webpubsub/v20250101preview:WebPubSubSharedPrivateLinkResource"),
		},
		{
			Type: pulumi.String("azure-native:webpubsub/v20250801preview:WebPubSubSharedPrivateLinkResource"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebPubSubSharedPrivateLinkResourceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *WebPubSubSharedPrivateLinkResource) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
