...
func (o LookupWebPubSubCustomCertificateResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWebPubSubCustomCertificateResult] {
	return pulumix.Output[LookupWebPubSubCustomCertificateResult]{
