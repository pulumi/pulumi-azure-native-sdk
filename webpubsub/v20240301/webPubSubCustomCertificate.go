...
func NewWebPubSubCustomCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:webpubsub/v20240301:WebPubSubCustomCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebPubSubCustomCertificate(ctx *pulumi.Context,
	...
	var resource WebPubSubCustomCertificate
	err := ctx.ReadResource("azure-native:webpubsub/v20240301:WebPubSubCustomCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
