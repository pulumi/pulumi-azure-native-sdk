...
func LookupWebPubSubCustomCertificate(ctx *pulumi.Context, args *LookupWebPubSubCustomCertificateArgs, opts ...pulumi.InvokeOption) (*LookupWebPubSubCustomCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:webpubsub/v20230801preview:getWebPubSubCustomCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebPubSubCustomCertificateOutput(ctx *pulumi.Context, args LookupWebPubSubCustomCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupWebPubSubCustomCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebPubSubCustomCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:webpubsub/v20230801preview:getWebPubSubCustomCertificate", args, LookupWebPubSubCustomCertificateResultOutput{}, options).(LookupWebPubSubCustomCertificateResultOutput), nil
