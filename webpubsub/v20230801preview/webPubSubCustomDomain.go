...
func NewWebPubSubCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:webpubsub/v20230801preview:WebPubSubCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebPubSubCustomDomain(ctx *pulumi.Context,
	...
	var resource WebPubSubCustomDomain
	err := ctx.ReadResource("azure-native:webpubsub/v20230801preview:WebPubSubCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
