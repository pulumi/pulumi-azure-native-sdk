...
func NewWebPubSubSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:webpubsub/v20240801preview:WebPubSubSharedPrivateLinkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebPubSubSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	var resource WebPubSubSharedPrivateLinkResource
	err := ctx.ReadResource("azure-native:webpubsub/v20240801preview:WebPubSubSharedPrivateLinkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// A list of FQDNs for third party private link service
func (o WebPubSubSharedPrivateLinkResourceOutput) Fqdns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *WebPubSubSharedPrivateLinkResource) pulumi.StringArrayOutput { return v.Fqdns }).(pulumi.StringArrayOutput)
}
