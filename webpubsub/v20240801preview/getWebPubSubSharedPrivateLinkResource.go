...
func LookupWebPubSubSharedPrivateLinkResource(ctx *pulumi.Context, args *LookupWebPubSubSharedPrivateLinkResourceArgs, opts ...pulumi.InvokeOption) (*LookupWebPubSubSharedPrivateLinkResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:webpubsub/v20240801preview:getWebPubSubSharedPrivateLinkResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebPubSubSharedPrivateLinkResourceOutput(ctx *pulumi.Context, args LookupWebPubSubSharedPrivateLinkResourceOutputArgs, opts ...pulumi.InvokeOption) LookupWebPubSubSharedPrivateLinkResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebPubSubSharedPrivateLinkResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:webpubsub/v20240801preview:getWebPubSubSharedPrivateLinkResource", args, LookupWebPubSubSharedPrivateLinkResourceResultOutput{}, options).(LookupWebPubSubSharedPrivateLinkResourceResultOutput), nil
