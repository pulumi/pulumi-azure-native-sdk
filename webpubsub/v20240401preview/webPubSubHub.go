...
func NewWebPubSubHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:webpubsub/v20240401preview:WebPubSubHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebPubSubHub(ctx *pulumi.Context,
	...
	var resource WebPubSubHub
	err := ctx.ReadResource("azure-native:webpubsub/v20240401preview:WebPubSubHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
