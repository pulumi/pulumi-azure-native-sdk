...
func ListWebPubSubKeys(ctx *pulumi.Context, args *ListWebPubSubKeysArgs, opts ...pulumi.InvokeOption) (*ListWebPubSubKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:webpubsub/v20240401preview:listWebPubSubKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebPubSubKeysOutput(ctx *pulumi.Context, args ListWebPubSubKeysOutputArgs, opts ...pulumi.InvokeOption) ListWebPubSubKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebPubSubKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:webpubsub/v20240401preview:listWebPubSubKeys", args, ListWebPubSubKeysResultOutput{}, options).(ListWebPubSubKeysResultOutput), nil
