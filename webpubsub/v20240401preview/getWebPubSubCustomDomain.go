...
func LookupWebPubSubCustomDomain(ctx *pulumi.Context, args *LookupWebPubSubCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupWebPubSubCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:webpubsub/v20240401preview:getWebPubSubCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebPubSubCustomDomainOutput(ctx *pulumi.Context, args LookupWebPubSubCustomDomainOutputArgs, opts ...pulumi.InvokeOption) LookupWebPubSubCustomDomainResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebPubSubCustomDomainResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:webpubsub/v20240401preview:getWebPubSubCustomDomain", args, LookupWebPubSubCustomDomainResultOutput{}, options).(LookupWebPubSubCustomDomainResultOutput), nil
