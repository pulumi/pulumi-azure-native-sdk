...
func NewWebhook(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:Webhook"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20251101:Webhook"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:Webhook"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:Webhook"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Webhook
	err := ctx.RegisterResource("azure-native:containerregistry:Webhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebhook(ctx *pulumi.Context,
	...
	var resource Webhook
	err := ctx.ReadResource("azure-native:containerregistry:Webhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
