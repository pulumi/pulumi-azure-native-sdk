...
func LookupExportPipeline(ctx *pulumi.Context, args *LookupExportPipelineArgs, opts ...pulumi.InvokeOption) (*LookupExportPipelineResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20230801preview:getExportPipeline", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupExportPipelineOutput(ctx *pulumi.Context, args LookupExportPipelineOutputArgs, opts ...pulumi.InvokeOption) LookupExportPipelineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupExportPipelineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerregistry/v20230801preview:getExportPipeline", args, LookupExportPipelineResultOutput{}, options).(LookupExportPipelineResultOutput), nil
