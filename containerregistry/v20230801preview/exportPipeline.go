...
func NewExportPipeline(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20230801preview:ExportPipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExportPipeline(ctx *pulumi.Context,
	...
	var resource ExportPipeline
	err := ctx.ReadResource("azure-native:containerregistry/v20230801preview:ExportPipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
