...
func LookupConnectedRegistry(ctx *pulumi.Context, args *LookupConnectedRegistryArgs, opts ...pulumi.InvokeOption) (*LookupConnectedRegistryResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20230801preview:getConnectedRegistry", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupConnectedRegistryOutput(ctx *pulumi.Context, args LookupConnectedRegistryOutputArgs, opts ...pulumi.InvokeOption) LookupConnectedRegistryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConnectedRegistryResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerregistry/v20230801preview:getConnectedRegistry", args, LookupConnectedRegistryResultOutput{}, options).(LookupConnectedRegistryResultOutput), nil
