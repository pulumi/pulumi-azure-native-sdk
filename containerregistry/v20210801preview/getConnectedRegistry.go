...
//
// Deprecated: azure-native:containerregistry/v20210801preview:ConnectedRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ConnectedRegistry to guarantee forwards compatibility.
func LookupConnectedRegistry(ctx *pulumi.Context, args *LookupConnectedRegistryArgs, opts ...pulumi.InvokeOption) (*LookupConnectedRegistryResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20210801preview:getConnectedRegistry", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
