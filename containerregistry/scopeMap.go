...
func NewScopeMap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:ScopeMap"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20251101:ScopeMap"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:ScopeMap"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:ScopeMap"),
		},
	})
