...
func NewExportPipeline(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:ExportPipeline"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:ExportPipeline"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:ExportPipeline"),
		},
	})
