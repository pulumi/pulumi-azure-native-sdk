...
//
// Deprecated: azure-native:containerregistry/v20201101preview:Registry is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Registry to guarantee forwards compatibility.
