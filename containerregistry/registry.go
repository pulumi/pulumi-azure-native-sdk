...
//
// Other available API versions: 2019-12-01-preview, 2020-11-01-preview, 2021-06-01-preview, 2021-08-01-preview, 2021-09-01, 2021-12-01-preview, 2022-02-01-preview, 2022-12-01, 2023-06-01-preview, 2023-07-01, 2023-08-01-preview, 2023-11-01-preview, 2024-11-01-preview, 2025-03-01-preview, 2025-04-01, 2025-05-01-preview, 2025-06-01-preview, 2025-11-01, 2026-01-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native containerregistry [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
...
func NewRegistry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250301preview:Registry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250401:Registry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250501preview:Registry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:Registry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20251101:Registry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:Registry"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Registry
	err := ctx.RegisterResource("azure-native:containerregistry:Registry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistry(ctx *pulumi.Context,
	...
	var resource Registry
	err := ctx.ReadResource("azure-native:containerregistry:Registry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
