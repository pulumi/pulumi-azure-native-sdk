...
func NewCacheRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250301preview:CacheRule"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250401:CacheRule"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250501preview:CacheRule"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:CacheRule"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20251101:CacheRule"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:CacheRule"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:CacheRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CacheRule
	err := ctx.RegisterResource("azure-native:containerregistry:CacheRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCacheRule(ctx *pulumi.Context,
	...
	var resource CacheRule
	err := ctx.ReadResource("azure-native:containerregistry:CacheRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
