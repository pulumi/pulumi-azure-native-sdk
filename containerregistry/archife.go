...
func NewArchife(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250301preview:Archife"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250501preview:Archife"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:Archife"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:Archife"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:Archife"),
		},
	})
