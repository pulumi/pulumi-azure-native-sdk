...
func NewWebhook(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20230701:Webhook"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20231101preview:Webhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebhook(ctx *pulumi.Context,
	...
	var resource Webhook
	err := ctx.ReadResource("azure-native:containerregistry/v20231101preview:Webhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
