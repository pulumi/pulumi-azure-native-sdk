...
func LookupCacheRule(ctx *pulumi.Context, args *LookupCacheRuleArgs, opts ...pulumi.InvokeOption) (*LookupCacheRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20231101preview:getCacheRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCacheRuleOutput(ctx *pulumi.Context, args LookupCacheRuleOutputArgs, opts ...pulumi.InvokeOption) LookupCacheRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCacheRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerregistry/v20231101preview:getCacheRule", args, LookupCacheRuleResultOutput{}, options).(LookupCacheRuleResultOutput), nil
