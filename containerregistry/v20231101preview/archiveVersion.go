...
func NewArchiveVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20231101preview:ArchiveVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArchiveVersion(ctx *pulumi.Context,
	...
	var resource ArchiveVersion
	err := ctx.ReadResource("azure-native:containerregistry/v20231101preview:ArchiveVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
