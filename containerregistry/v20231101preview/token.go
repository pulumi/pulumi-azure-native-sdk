...
func NewToken(ctx *pulumi.Context,
	...
	var resource Token
	err := ctx.RegisterResource("azure-native:containerregistry/v20231101preview:Token", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetToken(ctx *pulumi.Context,
	...
	var resource Token
	err := ctx.ReadResource("azure-native:containerregistry/v20231101preview:Token", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
