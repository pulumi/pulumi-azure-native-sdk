...
// AuditLogStatusInput is an input type that accepts values of the AuditLogStatus enum
// A concrete instance of `AuditLogStatusInput` can be one of the following:
//
...
func (in *azureADAuthenticationAsArmPolicyStatusPtr) ToOutput(ctx context.Context) pulumix.Output[*AzureADAuthenticationAsArmPolicyStatus] {
	return pulumix.Output[*AzureADAuthenticationAsArmPolicyStatus]{
		OutputState: in.ToAzureADAuthenticationAsArmPolicyStatusPtrOutputWithContext(ctx).OutputState,
	}
}
...
// ConnectedRegistryModeInput is an input type that accepts values of the ConnectedRegistryMode enum
// A concrete instance of `ConnectedRegistryModeInput` can be one of the following:
//
...
func (MetadataSearch) ElementType() reflect.Type {
	return reflect.TypeOf((*MetadataSearch)(nil)).Elem()
}

func (e MetadataSearch) ToMetadataSearchOutput() MetadataSearchOutput {
	return pulumi.ToOutput(e).(MetadataSearchOutput)
}

func (e MetadataSearch) ToMetadataSearchOutputWithContext(ctx context.Context) MetadataSearchOutput {
	return pulumi.ToOutputWithContext(ctx, e).(MetadataSearchOutput)
}

func (e MetadataSearch) ToMetadataSearchPtrOutput() MetadataSearchPtrOutput {
	return e.ToMetadataSearchPtrOutputWithContext(context.Background())
}

func (e MetadataSearch) ToMetadataSearchPtrOutputWithContext(ctx context.Context) MetadataSearchPtrOutput {
	return MetadataSearch(e).ToMetadataSearchOutputWithContext(ctx).ToMetadataSearchPtrOutputWithContext(ctx)
}

func (e MetadataSearch) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e MetadataSearch) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e MetadataSearch) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e MetadataSearch) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type MetadataSearchOutput struct{ *pulumi.OutputState }

func (MetadataSearchOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*MetadataSearch)(nil)).Elem()
}

func (o MetadataSearchOutput) ToMetadataSearchOutput() MetadataSearchOutput {
	return o
}

func (o MetadataSearchOutput) ToMetadataSearchOutputWithContext(ctx context.Context) MetadataSearchOutput {
	return o
}

func (o MetadataSearchOutput) ToMetadataSearchPtrOutput() MetadataSearchPtrOutput {
	return o.ToMetadataSearchPtrOutputWithContext(context.Background())
}

func (o MetadataSearchOutput) ToMetadataSearchPtrOutputWithContext(ctx context.Context) MetadataSearchPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v MetadataSearch) *MetadataSearch {
		return &v
	}).(MetadataSearchPtrOutput)
}

func (o MetadataSearchOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o MetadataSearchOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e MetadataSearch) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o MetadataSearchOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o MetadataSearchOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e MetadataSearch) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type MetadataSearchPtrOutput struct{ *pulumi.OutputState }

func (MetadataSearchPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**MetadataSearch)(nil)).Elem()
}

func (o MetadataSearchPtrOutput) ToMetadataSearchPtrOutput() MetadataSearchPtrOutput {
	return o
}

func (o MetadataSearchPtrOutput) ToMetadataSearchPtrOutputWithContext(ctx context.Context) MetadataSearchPtrOutput {
	return o
}

func (o MetadataSearchPtrOutput) Elem() MetadataSearchOutput {
	return o.ApplyT(func(v *MetadataSearch) MetadataSearch {
		if v != nil {
			return *v
		}
		var ret MetadataSearch
		return ret
	}).(MetadataSearchOutput)
}

func (o MetadataSearchPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o MetadataSearchPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *MetadataSearch) *string {
		if e == nil {
			return nil
		}
...
// MetadataSearchInput is an input type that accepts values of the MetadataSearch enum
// A concrete instance of `MetadataSearchInput` can be one of the following:
//
//	MetadataSearchEnabled
//	MetadataSearchDisabled
type MetadataSearchInput interface {
	pulumi.Input

	ToMetadataSearchOutput() MetadataSearchOutput
	ToMetadataSearchOutputWithContext(context.Context) MetadataSearchOutput
}

var metadataSearchPtrType = reflect.TypeOf((**MetadataSearch)(nil)).Elem()

type MetadataSearchPtrInput interface {
	pulumi.Input

	ToMetadataSearchPtrOutput() MetadataSearchPtrOutput
	ToMetadataSearchPtrOutputWithContext(context.Context) MetadataSearchPtrOutput
}

type metadataSearchPtr string

func MetadataSearchPtr(v string) MetadataSearchPtrInput {
	return (*metadataSearchPtr)(&v)
}

func (*metadataSearchPtr) ElementType() reflect.Type {
	return metadataSearchPtrType
}

func (in *metadataSearchPtr) ToMetadataSearchPtrOutput() MetadataSearchPtrOutput {
	return pulumi.ToOutput(in).(MetadataSearchPtrOutput)
}

func (in *metadataSearchPtr) ToMetadataSearchPtrOutputWithContext(ctx context.Context) MetadataSearchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(MetadataSearchPtrOutput)
}

func (in *metadataSearchPtr) ToOutput(ctx context.Context) pulumix.Output[*MetadataSearch] {
	return pulumix.Output[*MetadataSearch]{
		OutputState: in.ToMetadataSearchPtrOutputWithContext(ctx).OutputState,
	}
}
...
func (o PackageSourceTypeOutput) ToPackageSourceTypePtrOutput() PackageSourceTypePtrOutput {
	return o.ToPackageSourceTypePtrOutputWithContext(context.Background())
}

func (o PackageSourceTypeOutput) ToPackageSourceTypePtrOutputWithContext(ctx context.Context) PackageSourceTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v PackageSourceType) *PackageSourceType {
		return &v
	}).(PackageSourceTypePtrOutput)
}
...
func (o PackageSourceTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PackageSourceType) string {
		return string(e)
	}).(pulumi.StringOutput)
}
...
func (o PackageSourceTypePtrOutput) Elem() PackageSourceTypeOutput {
	return o.ApplyT(func(v *PackageSourceType) PackageSourceType {
		if v != nil {
			return *v
		}
		var ret PackageSourceType
		return ret
	}).(PackageSourceTypeOutput)
}
...
// PackageSourceTypeInput is an input type that accepts values of the PackageSourceType enum
// A concrete instance of `PackageSourceTypeInput` can be one of the following:
//
...
var packageSourceTypePtrType = reflect.TypeOf((**PackageSourceType)(nil)).Elem()
...
type packageSourceTypePtr string

func PackageSourceTypePtr(v string) PackageSourceTypePtrInput {
	return (*packageSourceTypePtr)(&v)
}

func (*packageSourceTypePtr) ElementType() reflect.Type {
	return packageSourceTypePtrType
}

func (in *packageSourceTypePtr) ToPackageSourceTypePtrOutput() PackageSourceTypePtrOutput {
	return pulumi.ToOutput(in).(PackageSourceTypePtrOutput)
}
...
// PipelineOptionsInput is an input type that accepts values of the PipelineOptions enum
// A concrete instance of `PipelineOptionsInput` can be one of the following:
//
...
// PipelineRunSourceTypeInput is an input type that accepts values of the PipelineRunSourceType enum
// A concrete instance of `PipelineRunSourceTypeInput` can be one of the following:
//
...
// PipelineRunTargetTypeInput is an input type that accepts values of the PipelineRunTargetType enum
// A concrete instance of `PipelineRunTargetTypeInput` can be one of the following:
//
...
// PipelineSourceTypeInput is an input type that accepts values of the PipelineSourceType enum
// A concrete instance of `PipelineSourceTypeInput` can be one of the following:
//
...
func init() {
	...
	pulumi.RegisterOutputType(MetadataSearchOutput{})
	pulumi.RegisterOutputType(MetadataSearchPtrOutput{})
	pulumi.RegisterOutputType(NetworkRuleBypassOptionsOutput{})
	pulumi.RegisterOutputType(NetworkRuleBypassOptionsPtrOutput{})
	pulumi.RegisterOutputType(PackageSourceTypeOutput{})
	pulumi.RegisterOutputType(PackageSourceTypePtrOutput{})
