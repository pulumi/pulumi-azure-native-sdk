...
func NewCredentialSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:CredentialSet"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20251101:CredentialSet"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:CredentialSet"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:CredentialSet"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CredentialSet
	err := ctx.RegisterResource("azure-native:containerregistry:CredentialSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCredentialSet(ctx *pulumi.Context,
	...
	var resource CredentialSet
	err := ctx.ReadResource("azure-native:containerregistry:CredentialSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
