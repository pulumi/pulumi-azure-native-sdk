...
func NewPipelineRun(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:PipelineRun"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:PipelineRun"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:PipelineRun"),
		},
	})
