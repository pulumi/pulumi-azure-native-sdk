...
func NewReplication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:Replication"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20251101:Replication"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:Replication"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:Replication"),
		},
	})
