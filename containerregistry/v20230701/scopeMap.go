...
func NewScopeMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20230701:ScopeMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeMap(ctx *pulumi.Context,
	...
	var resource ScopeMap
	err := ctx.ReadResource("azure-native:containerregistry/v20230701:ScopeMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
