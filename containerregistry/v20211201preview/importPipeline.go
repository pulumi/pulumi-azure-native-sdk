...
func NewImportPipeline(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20211201preview:ImportPipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportPipeline(ctx *pulumi.Context,
	...
	var resource ImportPipeline
	err := ctx.ReadResource("azure-native:containerregistry/v20211201preview:ImportPipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
