...
func NewReplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20211201preview:Replication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplication(ctx *pulumi.Context,
	...
	var resource Replication
	err := ctx.ReadResource("azure-native:containerregistry/v20211201preview:Replication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
