...
func NewBuildStep(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry:BuildStep", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildStep(ctx *pulumi.Context,
	...
	var resource BuildStep
	err := ctx.ReadResource("azure-native:containerregistry:BuildStep", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
