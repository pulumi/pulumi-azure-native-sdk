...
func LookupRegistry(ctx *pulumi.Context, args *LookupRegistryArgs, opts ...pulumi.InvokeOption) (*LookupRegistryResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20241101preview:getRegistry", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (val *LookupRegistryResult) Defaults() *LookupRegistryResult {
	...
	if tmp.MetadataSearch == nil {
		metadataSearch_ := "Disabled"
		tmp.MetadataSearch = &metadataSearch_
	}
...
func LookupRegistryOutput(ctx *pulumi.Context, args LookupRegistryOutputArgs, opts ...pulumi.InvokeOption) LookupRegistryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistryResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerregistry/v20241101preview:getRegistry", args, LookupRegistryResultOutput{}, options).(LookupRegistryResultOutput), nil
...
// Determines the domain name label reuse scope.
func (o LookupRegistryResultOutput) AutoGeneratedDomainNameLabelScope() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRegistryResult) *string { return v.AutoGeneratedDomainNameLabelScope }).(pulumi.StringPtrOutput)
}
...
// Determines whether registry artifacts are indexed for metadata search.
func (o LookupRegistryResultOutput) MetadataSearch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRegistryResult) *string { return v.MetadataSearch }).(pulumi.StringPtrOutput)
}
