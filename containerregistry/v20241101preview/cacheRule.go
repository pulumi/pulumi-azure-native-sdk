...
func NewCacheRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20241101preview:CacheRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCacheRule(ctx *pulumi.Context,
	...
	var resource CacheRule
	err := ctx.ReadResource("azure-native:containerregistry/v20241101preview:CacheRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
