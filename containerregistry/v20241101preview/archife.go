...
func NewArchife(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20241101preview:Archife", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArchife(ctx *pulumi.Context,
	...
	var resource Archife
	err := ctx.ReadResource("azure-native:containerregistry/v20241101preview:Archife", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
