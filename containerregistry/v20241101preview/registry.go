...
type Registry struct {
	...
	MetadataSearch pulumi.StringPtrOutput `pulumi:"metadataSearch"`
...
func NewRegistry(ctx *pulumi.Context,
	...
	if args.AutoGeneratedDomainNameLabelScope == nil {
		args.AutoGeneratedDomainNameLabelScope = pulumi.StringPtr("Unsecure")
	}
	if args.MetadataSearch == nil {
		args.MetadataSearch = pulumi.StringPtr("Disabled")
	}
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20241101preview:Registry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistry(ctx *pulumi.Context,
	...
	var resource Registry
	err := ctx.ReadResource("azure-native:containerregistry/v20241101preview:Registry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type registryArgs struct {
	...
	// Determines whether registry artifacts are indexed for metadata search.
	MetadataSearch *string `pulumi:"metadataSearch"`
	// Whether to allow trusted Azure services to access a network restricted registry.
...
type RegistryArgs struct {
	...
	// Determines whether registry artifacts are indexed for metadata search.
	MetadataSearch pulumi.StringPtrInput
	// Whether to allow trusted Azure services to access a network restricted registry.
...
// Determines the domain name label reuse scope.
func (o RegistryOutput) AutoGeneratedDomainNameLabelScope() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Registry) pulumi.StringPtrOutput { return v.AutoGeneratedDomainNameLabelScope }).(pulumi.StringPtrOutput)
}
...
// Determines whether registry artifacts are indexed for metadata search.
func (o RegistryOutput) MetadataSearch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Registry) pulumi.StringPtrOutput { return v.MetadataSearch }).(pulumi.StringPtrOutput)
}
