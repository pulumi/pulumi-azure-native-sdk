...
func LookupImportPipeline(ctx *pulumi.Context, args *LookupImportPipelineArgs, opts ...pulumi.InvokeOption) (*LookupImportPipelineResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20241101preview:getImportPipeline", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupImportPipelineOutput(ctx *pulumi.Context, args LookupImportPipelineOutputArgs, opts ...pulumi.InvokeOption) LookupImportPipelineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupImportPipelineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerregistry/v20241101preview:getImportPipeline", args, LookupImportPipelineResultOutput{}, options).(LookupImportPipelineResultOutput), nil
