...
func LookupArchife(ctx *pulumi.Context, args *LookupArchifeArgs, opts ...pulumi.InvokeOption) (*LookupArchifeResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20230601preview:getArchife", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupArchifeOutput(ctx *pulumi.Context, args LookupArchifeOutputArgs, opts ...pulumi.InvokeOption) LookupArchifeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupArchifeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerregistry/v20230601preview:getArchife", args, LookupArchifeResultOutput{}, options).(LookupArchifeResultOutput), nil
