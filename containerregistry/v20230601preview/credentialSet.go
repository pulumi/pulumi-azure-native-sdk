...
func NewCredentialSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20230601preview:CredentialSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCredentialSet(ctx *pulumi.Context,
	...
	var resource CredentialSet
	err := ctx.ReadResource("azure-native:containerregistry/v20230601preview:CredentialSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
