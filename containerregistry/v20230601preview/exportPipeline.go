...
func NewExportPipeline(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20230101preview:ExportPipeline"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20230601preview:ExportPipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExportPipeline(ctx *pulumi.Context,
	...
	var resource ExportPipeline
	err := ctx.ReadResource("azure-native:containerregistry/v20230601preview:ExportPipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ExportPipeline) ToOutput(ctx context.Context) pulumix.Output[*ExportPipeline] {
	return pulumix.Output[*ExportPipeline]{
		OutputState: i.ToExportPipelineOutputWithContext(ctx).OutputState,
	}
}
...
func (o ExportPipelineOutput) ToOutput(ctx context.Context) pulumix.Output[*ExportPipeline] {
	return pulumix.Output[*ExportPipeline]{
