...
//
// Deprecated: azure-native:containerregistry/v20210601preview:Token is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Token to guarantee forwards compatibility.
