...
//
// Deprecated: azure-native:containerregistry/v20210601preview:ImportPipeline is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ImportPipeline to guarantee forwards compatibility.
func LookupImportPipeline(ctx *pulumi.Context, args *LookupImportPipelineArgs, opts ...pulumi.InvokeOption) (*LookupImportPipelineResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20210601preview:getImportPipeline", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
