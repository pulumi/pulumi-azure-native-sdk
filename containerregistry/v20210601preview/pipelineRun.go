...
//
// Deprecated: azure-native:containerregistry/v20210601preview:PipelineRun is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:PipelineRun to guarantee forwards compatibility.
...
func NewPipelineRun(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20210601preview:PipelineRun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipelineRun(ctx *pulumi.Context,
	...
	var resource PipelineRun
	err := ctx.ReadResource("azure-native:containerregistry/v20210601preview:PipelineRun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
