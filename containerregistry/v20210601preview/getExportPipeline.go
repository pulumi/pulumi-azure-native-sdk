...
//
// Deprecated: azure-native:containerregistry/v20210601preview:ExportPipeline is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ExportPipeline to guarantee forwards compatibility.
func LookupExportPipeline(ctx *pulumi.Context, args *LookupExportPipelineArgs, opts ...pulumi.InvokeOption) (*LookupExportPipelineResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20210601preview:getExportPipeline", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
