...
func NewConnectedRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20210601preview:ConnectedRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedRegistry(ctx *pulumi.Context,
	...
	var resource ConnectedRegistry
	err := ctx.ReadResource("azure-native:containerregistry/v20210601preview:ConnectedRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
