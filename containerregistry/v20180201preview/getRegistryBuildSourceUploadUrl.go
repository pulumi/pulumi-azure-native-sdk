...
func (o GetRegistryBuildSourceUploadUrlResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetRegistryBuildSourceUploadUrlResult] {
	return pulumix.Output[GetRegistryBuildSourceUploadUrlResult]{
