...
func NewConnectedRegistry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250301preview:ConnectedRegistry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250401:ConnectedRegistry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250501preview:ConnectedRegistry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:ConnectedRegistry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20251101:ConnectedRegistry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:ConnectedRegistry"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:ConnectedRegistry"),
		},
	})
