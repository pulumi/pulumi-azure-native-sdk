...
//
// Deprecated: azure-native:containerregistry/v20171001:Replication is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Replication to guarantee forwards compatibility.
func LookupReplication(ctx *pulumi.Context, args *LookupReplicationArgs, opts ...pulumi.InvokeOption) (*LookupReplicationResult, error) {
	...
	err := ctx.Invoke("azure-native:containerregistry/v20171001:getReplication", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
