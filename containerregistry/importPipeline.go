...
func NewImportPipeline(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:containerregistry/v20250301preview:ImportPipeline"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250501preview:ImportPipeline"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20250601preview:ImportPipeline"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260101preview:ImportPipeline"),
		},
		{
			Type: pulumi.String("azure-native:containerregistry/v20260301preview:ImportPipeline"),
		},
	})
