...
//
// Deprecated: azure-native:containerregistry/v20220201preview:Registry is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Registry to guarantee forwards compatibility.
...
func NewRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerregistry/v20220201preview:Registry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistry(ctx *pulumi.Context,
	...
	var resource Registry
	err := ctx.ReadResource("azure-native:containerregistry/v20220201preview:Registry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
