...
func NewDocumentProcessor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:syntex/v20220915preview:DocumentProcessor"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DocumentProcessor
	err := ctx.RegisterResource("azure-native:syntex:DocumentProcessor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDocumentProcessor(ctx *pulumi.Context,
	...
	var resource DocumentProcessor
	err := ctx.ReadResource("azure-native:syntex:DocumentProcessor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
