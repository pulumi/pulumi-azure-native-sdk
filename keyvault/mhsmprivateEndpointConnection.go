...
func NewMHSMPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:keyvault/v20250501:MHSMPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20260201:MHSMPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20260301preview:MHSMPrivateEndpointConnection"),
		},
	})
...
// The Azure API version of the resource.
func (o MHSMPrivateEndpointConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *MHSMPrivateEndpointConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
