...
//
// Deprecated: azure-native:keyvault/v20210601preview:ManagedHsm is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.
...
func NewManagedHsm(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:keyvault/v20210601preview:ManagedHsm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedHsm(ctx *pulumi.Context,
	...
	var resource ManagedHsm
	err := ctx.ReadResource("azure-native:keyvault/v20210601preview:ManagedHsm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
