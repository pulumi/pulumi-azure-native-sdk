...
func NewMHSMPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:keyvault/v20210601preview:MHSMPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMHSMPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource MHSMPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:keyvault/v20210601preview:MHSMPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
