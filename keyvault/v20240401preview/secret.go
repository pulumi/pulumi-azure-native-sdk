...
func NewSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.RegisterResource("azure-native:keyvault/v20240401preview:Secret", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.ReadResource("azure-native:keyvault/v20240401preview:Secret", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
