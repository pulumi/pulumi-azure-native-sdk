...
func NewKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:keyvault/v20220201preview:Key"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:keyvault/v20240401preview:Key"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20241101:Key"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20241201preview:Key"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20250501:Key"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20260201:Key"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20260301preview:Key"),
		},
	})
