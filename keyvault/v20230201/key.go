...
func NewKey(ctx *pulumi.Context,
	...
	var resource Key
	err := ctx.RegisterResource("azure-native:keyvault/v20230201:Key", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKey(ctx *pulumi.Context,
	...
	var resource Key
	err := ctx.ReadResource("azure-native:keyvault/v20230201:Key", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
