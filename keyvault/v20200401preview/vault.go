...
//
// Deprecated: azure-native:keyvault/v20200401preview:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:Vault to guarantee forwards compatibility.
type Vault struct {
...
func NewVault(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:keyvault/v20220201preview:Vault"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:keyvault/v20230201:Vault"),
		},
	})
	opts = append(opts, aliases)
	var resource Vault
	err := ctx.RegisterResource("azure-native:keyvault/v20200401preview:Vault", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVault(ctx *pulumi.Context,
	...
	var resource Vault
	err := ctx.ReadResource("azure-native:keyvault/v20200401preview:Vault", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
