...
//
// Deprecated: azure-native:keyvault/v20200401preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:PrivateEndpointConnection to guarantee forwards compatibility.
...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:keyvault/v20211001:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20211101preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20220201preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20220701:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20221101:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20230201:PrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateEndpointConnection
	err := ctx.RegisterResource("azure-native:keyvault/v20200401preview:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:keyvault/v20200401preview:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
