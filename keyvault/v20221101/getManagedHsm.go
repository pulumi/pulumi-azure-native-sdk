...
//
// Deprecated: azure-native:keyvault/v20221101:ManagedHsm is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.
func LookupManagedHsm(ctx *pulumi.Context, args *LookupManagedHsmArgs, opts ...pulumi.InvokeOption) (*LookupManagedHsmResult, error) {
	...
	err := ctx.Invoke("azure-native:keyvault/v20221101:getManagedHsm", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
