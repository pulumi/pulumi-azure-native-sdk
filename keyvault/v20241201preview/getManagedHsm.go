...
func LookupManagedHsm(ctx *pulumi.Context, args *LookupManagedHsmArgs, opts ...pulumi.InvokeOption) (*LookupManagedHsmResult, error) {
	...
	err := ctx.Invoke("azure-native:keyvault/v20241201preview:getManagedHsm", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupManagedHsmOutput(ctx *pulumi.Context, args LookupManagedHsmOutputArgs, opts ...pulumi.InvokeOption) LookupManagedHsmResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedHsmResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:keyvault/v20241201preview:getManagedHsm", args, LookupManagedHsmResultOutput{}, options).(LookupManagedHsmResultOutput), nil
