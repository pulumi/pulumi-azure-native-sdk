...
func NewSecret(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:keyvault/v20230701:Secret"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20240401preview:Secret"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20241101:Secret"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20241201preview:Secret"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20250501:Secret"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20260201:Secret"),
		},
		{
			Type: pulumi.String("azure-native:keyvault/v20260301preview:Secret"),
		},
	})
