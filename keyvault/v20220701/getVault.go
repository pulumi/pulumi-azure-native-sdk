...
//
// Deprecated: azure-native:keyvault/v20220701:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:Vault to guarantee forwards compatibility.
func LookupVault(ctx *pulumi.Context, args *LookupVaultArgs, opts ...pulumi.InvokeOption) (*LookupVaultResult, error) {
	var rv LookupVaultResult
	err := ctx.Invoke("azure-native:keyvault/v20220701:getVault", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
