...
// The key resource.
//
// Deprecated: azure-native:keyvault/v20220201preview:Key is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:Key to guarantee forwards compatibility.
type Key struct {
...
func NewKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:keyvault/v20221101:Key"),
		},
		{
	...
	var resource Key
	err := ctx.RegisterResource("azure-native:keyvault/v20220201preview:Key", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKey(ctx *pulumi.Context,
	...
	var resource Key
	err := ctx.ReadResource("azure-native:keyvault/v20220201preview:Key", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
