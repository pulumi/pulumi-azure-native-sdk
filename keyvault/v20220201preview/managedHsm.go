...
func NewManagedHsm(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:keyvault/v20220201preview:ManagedHsm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedHsm(ctx *pulumi.Context,
	...
	var resource ManagedHsm
	err := ctx.ReadResource("azure-native:keyvault/v20220201preview:ManagedHsm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
