...
func LookupKey(ctx *pulumi.Context, args *LookupKeyArgs, opts ...pulumi.InvokeOption) (*LookupKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:keyvault/v20230701:getKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupKeyOutput(ctx *pulumi.Context, args LookupKeyOutputArgs, opts ...pulumi.InvokeOption) LookupKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:keyvault/v20230701:getKey", args, LookupKeyResultOutput{}, options).(LookupKeyResultOutput), nil
