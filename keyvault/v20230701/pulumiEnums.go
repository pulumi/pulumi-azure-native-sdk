...
// CertificatePermissionsInput is an input type that accepts values of the CertificatePermissions enum
// A concrete instance of `CertificatePermissionsInput` can be one of the following:
//
...
// JsonWebKeyCurveNameInput is an input type that accepts values of the JsonWebKeyCurveName enum
// A concrete instance of `JsonWebKeyCurveNameInput` can be one of the following:
//
...
// JsonWebKeyOperationInput is an input type that accepts values of the JsonWebKeyOperation enum
// A concrete instance of `JsonWebKeyOperationInput` can be one of the following:
//
...
// JsonWebKeyTypeInput is an input type that accepts values of the JsonWebKeyType enum
// A concrete instance of `JsonWebKeyTypeInput` can be one of the following:
//
//	JsonWebKeyTypeEC
...
// KeyPermissionsInput is an input type that accepts values of the KeyPermissions enum
// A concrete instance of `KeyPermissionsInput` can be one of the following:
//
//	KeyPermissionsAll
...
// KeyRotationPolicyActionTypeInput is an input type that accepts values of the KeyRotationPolicyActionType enum
// A concrete instance of `KeyRotationPolicyActionTypeInput` can be one of the following:
//
...
// ManagedHsmSkuFamilyInput is an input type that accepts values of the ManagedHsmSkuFamily enum
...
// ManagedHsmSkuNameInput is an input type that accepts values of the ManagedHsmSkuName enum
// A concrete instance of `ManagedHsmSkuNameInput` can be one of the following:
//
...
// SecretPermissionsInput is an input type that accepts values of the SecretPermissions enum
// A concrete instance of `SecretPermissionsInput` can be one of the following:
//
...
// StoragePermissionsInput is an input type that accepts values of the StoragePermissions enum
// A concrete instance of `StoragePermissionsInput` can be one of the following:
//
...
// VaultProvisioningStateInput is an input type that accepts values of the VaultProvisioningState enum
// A concrete instance of `VaultProvisioningStateInput` can be one of the following:
//
