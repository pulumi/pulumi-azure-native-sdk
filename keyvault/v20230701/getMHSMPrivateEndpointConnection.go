...
func LookupMHSMPrivateEndpointConnection(ctx *pulumi.Context, args *LookupMHSMPrivateEndpointConnectionArgs, opts ...pulumi.InvokeOption) (*LookupMHSMPrivateEndpointConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:keyvault/v20230701:getMHSMPrivateEndpointConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMHSMPrivateEndpointConnectionOutput(ctx *pulumi.Context, args LookupMHSMPrivateEndpointConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupMHSMPrivateEndpointConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMHSMPrivateEndpointConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:keyvault/v20230701:getMHSMPrivateEndpointConnection", args, LookupMHSMPrivateEndpointConnectionResultOutput{}, options).(LookupMHSMPrivateEndpointConnectionResultOutput), nil
