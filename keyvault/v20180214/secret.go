...
// azure-native:keyvault/v20180214:Secret is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:Secret to guarantee forwards compatibility.
type Secret struct {
...
func NewSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.RegisterResource("azure-native:keyvault/v20180214:Secret", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.ReadResource("azure-native:keyvault/v20180214:Secret", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
