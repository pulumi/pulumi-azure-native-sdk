...
func NewPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.RegisterResource("azure-native:devopsinfrastructure/v20231030preview:Pool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("azure-native:devopsinfrastructure/v20231030preview:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
