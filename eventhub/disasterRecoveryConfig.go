...
func NewDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventhub/v20250501preview:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-native:eventhub/v20260101:DisasterRecoveryConfig"),
		},
	})
