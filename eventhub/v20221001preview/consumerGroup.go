...
func NewConsumerGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventhub/v20230101preview:ConsumerGroup"),
		},
		{
			Type: pulumi.String("azure-native:eventhub/v20240101:ConsumerGroup"),
		},
		{
			Type: pulumi.String("azure-native:eventhub/v20240501preview:ConsumerGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20221001preview:ConsumerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsumerGroup(ctx *pulumi.Context,
	...
	var resource ConsumerGroup
	err := ctx.ReadResource("azure-native:eventhub/v20221001preview:ConsumerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
