...
func LookupEventHub(ctx *pulumi.Context, args *LookupEventHubArgs, opts ...pulumi.InvokeOption) (*LookupEventHubResult, error) {
	...
	err := ctx.Invoke("azure-native:eventhub/v20240501preview:getEventHub", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEventHubOutput(ctx *pulumi.Context, args LookupEventHubOutputArgs, opts ...pulumi.InvokeOption) LookupEventHubResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEventHubResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventhub/v20240501preview:getEventHub", args, LookupEventHubResultOutput{}, options).(LookupEventHubResultOutput), nil
...
// Denotes the unique identifier for event hub and is generated by service while creating topic. This identifier can be used in kafka runtime apis wherever a UUID is required e.g Fetch & Delete Topic. This identifier is not supported in AMQP runtime operations yet.
func (o LookupEventHubResultOutput) Identifier() pulumi.StringOutput {
	return o.ApplyT(func(v LookupEventHubResult) string { return v.Identifier }).(pulumi.StringOutput)
}
