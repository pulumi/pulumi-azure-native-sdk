...
func NewNamespaceAuthorizationRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventhub/v20230101preview:NamespaceAuthorizationRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20240501preview:NamespaceAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceAuthorizationRule(ctx *pulumi.Context,
	...
	var resource NamespaceAuthorizationRule
	err := ctx.ReadResource("azure-native:eventhub/v20240501preview:NamespaceAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
