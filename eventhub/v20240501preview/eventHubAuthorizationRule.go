...
func NewEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20240501preview:EventHubAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	var resource EventHubAuthorizationRule
	err := ctx.ReadResource("azure-native:eventhub/v20240501preview:EventHubAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
