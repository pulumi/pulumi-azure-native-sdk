...
func NewDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20240501preview:DisasterRecoveryConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	var resource DisasterRecoveryConfig
	err := ctx.ReadResource("azure-native:eventhub/v20240501preview:DisasterRecoveryConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
