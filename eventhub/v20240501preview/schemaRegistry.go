...
func NewSchemaRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20240501preview:SchemaRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchemaRegistry(ctx *pulumi.Context,
	...
	var resource SchemaRegistry
	err := ctx.ReadResource("azure-native:eventhub/v20240501preview:SchemaRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
