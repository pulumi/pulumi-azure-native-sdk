...
func (TimestampType) ElementType() reflect.Type {
	return reflect.TypeOf((*TimestampType)(nil)).Elem()
}

func (e TimestampType) ToTimestampTypeOutput() TimestampTypeOutput {
	return pulumi.ToOutput(e).(TimestampTypeOutput)
}

func (e TimestampType) ToTimestampTypeOutputWithContext(ctx context.Context) TimestampTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(TimestampTypeOutput)
}

func (e TimestampType) ToTimestampTypePtrOutput() TimestampTypePtrOutput {
	return e.ToTimestampTypePtrOutputWithContext(context.Background())
}

func (e TimestampType) ToTimestampTypePtrOutputWithContext(ctx context.Context) TimestampTypePtrOutput {
	return TimestampType(e).ToTimestampTypeOutputWithContext(ctx).ToTimestampTypePtrOutputWithContext(ctx)
}

func (e TimestampType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e TimestampType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e TimestampType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e TimestampType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type TimestampTypeOutput struct{ *pulumi.OutputState }

func (TimestampTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*TimestampType)(nil)).Elem()
}

func (o TimestampTypeOutput) ToTimestampTypeOutput() TimestampTypeOutput {
	return o
}

func (o TimestampTypeOutput) ToTimestampTypeOutputWithContext(ctx context.Context) TimestampTypeOutput {
	return o
}

func (o TimestampTypeOutput) ToTimestampTypePtrOutput() TimestampTypePtrOutput {
	return o.ToTimestampTypePtrOutputWithContext(context.Background())
}

func (o TimestampTypeOutput) ToTimestampTypePtrOutputWithContext(ctx context.Context) TimestampTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v TimestampType) *TimestampType {
		return &v
	}).(TimestampTypePtrOutput)
}

func (o TimestampTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o TimestampTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e TimestampType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o TimestampTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o TimestampTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e TimestampType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type TimestampTypePtrOutput struct{ *pulumi.OutputState }

func (TimestampTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**TimestampType)(nil)).Elem()
}

func (o TimestampTypePtrOutput) ToTimestampTypePtrOutput() TimestampTypePtrOutput {
	return o
}

func (o TimestampTypePtrOutput) ToTimestampTypePtrOutputWithContext(ctx context.Context) TimestampTypePtrOutput {
	return o
}

func (o TimestampTypePtrOutput) Elem() TimestampTypeOutput {
	return o.ApplyT(func(v *TimestampType) TimestampType {
		if v != nil {
			return *v
		}
...
func (o TimestampTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o TimestampTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *TimestampType) *string {
		if e == nil {
			return nil
		}
...
type TimestampTypeInput interface {
	...
	ToTimestampTypeOutput() TimestampTypeOutput
	ToTimestampTypeOutputWithContext(context.Context) TimestampTypeOutput
}

var timestampTypePtrType = reflect.TypeOf((**TimestampType)(nil)).Elem()

type TimestampTypePtrInput interface {
	pulumi.Input

	ToTimestampTypePtrOutput() TimestampTypePtrOutput
	ToTimestampTypePtrOutputWithContext(context.Context) TimestampTypePtrOutput
}

type timestampTypePtr string

func TimestampTypePtr(v string) TimestampTypePtrInput {
	return (*timestampTypePtr)(&v)
}

func (*timestampTypePtr) ElementType() reflect.Type {
	return timestampTypePtrType
}

func (in *timestampTypePtr) ToTimestampTypePtrOutput() TimestampTypePtrOutput {
	return pulumi.ToOutput(in).(TimestampTypePtrOutput)
}

func (in *timestampTypePtr) ToTimestampTypePtrOutputWithContext(ctx context.Context) TimestampTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(TimestampTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(TimestampTypeOutput{})
	pulumi.RegisterOutputType(TimestampTypePtrOutput{})
