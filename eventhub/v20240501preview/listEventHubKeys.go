...
func ListEventHubKeys(ctx *pulumi.Context, args *ListEventHubKeysArgs, opts ...pulumi.InvokeOption) (*ListEventHubKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:eventhub/v20240501preview:listEventHubKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListEventHubKeysOutput(ctx *pulumi.Context, args ListEventHubKeysOutputArgs, opts ...pulumi.InvokeOption) ListEventHubKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListEventHubKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventhub/v20240501preview:listEventHubKeys", args, ListEventHubKeysResultOutput{}, options).(ListEventHubKeysResultOutput), nil
