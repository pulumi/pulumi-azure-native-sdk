...
func (in *geoDRRoleTypePtr) ToOutput(ctx context.Context) pulumix.Output[*GeoDRRoleType] {
	return pulumix.Output[*GeoDRRoleType]{
		OutputState: in.ToGeoDRRoleTypePtrOutputWithContext(ctx).OutputState,
	}
}
