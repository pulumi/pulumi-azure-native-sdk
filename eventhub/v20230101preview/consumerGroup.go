...
func NewConsumerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20230101preview:ConsumerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsumerGroup(ctx *pulumi.Context,
	...
	var resource ConsumerGroup
	err := ctx.ReadResource("azure-native:eventhub/v20230101preview:ConsumerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
