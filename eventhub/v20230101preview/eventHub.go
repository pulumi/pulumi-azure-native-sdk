...
func NewEventHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20230101preview:EventHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHub(ctx *pulumi.Context,
	...
	var resource EventHub
	err := ctx.ReadResource("azure-native:eventhub/v20230101preview:EventHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
