...
//
// Deprecated: azure-native:eventhub/v20210101preview:EventHubAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHubAuthorizationRule to guarantee forwards compatibility.
...
func NewEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20210101preview:EventHubAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	var resource EventHubAuthorizationRule
	err := ctx.ReadResource("azure-native:eventhub/v20210101preview:EventHubAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
