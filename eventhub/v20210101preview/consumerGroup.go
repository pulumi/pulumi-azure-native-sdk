...
//
// Deprecated: azure-native:eventhub/v20210101preview:ConsumerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:ConsumerGroup to guarantee forwards compatibility.
...
func NewConsumerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20210101preview:ConsumerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsumerGroup(ctx *pulumi.Context,
	...
	var resource ConsumerGroup
	err := ctx.ReadResource("azure-native:eventhub/v20210101preview:ConsumerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
