...
//
// Deprecated: azure-native:eventhub/v20210101preview:EventHub is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.
...
func NewEventHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventhub/v20210101preview:EventHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHub(ctx *pulumi.Context,
	...
	var resource EventHub
	err := ctx.ReadResource("azure-native:eventhub/v20210101preview:EventHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
