...
func LookupEventHubAuthorizationRule(ctx *pulumi.Context, args *LookupEventHubAuthorizationRuleArgs, opts ...pulumi.InvokeOption) (*LookupEventHubAuthorizationRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:eventhub/v20240101:getEventHubAuthorizationRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEventHubAuthorizationRuleOutput(ctx *pulumi.Context, args LookupEventHubAuthorizationRuleOutputArgs, opts ...pulumi.InvokeOption) LookupEventHubAuthorizationRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEventHubAuthorizationRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventhub/v20240101:getEventHubAuthorizationRule", args, LookupEventHubAuthorizationRuleResultOutput{}, options).(LookupEventHubAuthorizationRuleResultOutput), nil
