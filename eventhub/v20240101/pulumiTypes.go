...
type UpgradePreferences struct {
	...
	StartDayOfWeek *string `pulumi:"startDayOfWeek"`
	// Preferred hour of the day in UTC time to begin an upgrade
	StartHourOfDay *int `pulumi:"startHourOfDay"`
}

// UpgradePreferencesInput is an input type that accepts UpgradePreferencesArgs and UpgradePreferencesOutput values.
// You can construct a concrete instance of `UpgradePreferencesInput` via:
//
//	UpgradePreferencesArgs{...}
type UpgradePreferencesInput interface {
	pulumi.Input

	ToUpgradePreferencesOutput() UpgradePreferencesOutput
	ToUpgradePreferencesOutputWithContext(context.Context) UpgradePreferencesOutput
}

// Contains all settings for the cluster upgrade window.
type UpgradePreferencesArgs struct {
	// Preferred day of the week in UTC time to begin an upgrade. If 'Any' is selected, upgrade will proceed at any given weekday
	StartDayOfWeek pulumi.StringPtrInput `pulumi:"startDayOfWeek"`
	// Preferred hour of the day in UTC time to begin an upgrade
	StartHourOfDay pulumi.IntPtrInput `pulumi:"startHourOfDay"`
}

func (UpgradePreferencesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*UpgradePreferences)(nil)).Elem()
}

func (i UpgradePreferencesArgs) ToUpgradePreferencesOutput() UpgradePreferencesOutput {
	return i.ToUpgradePreferencesOutputWithContext(context.Background())
}

func (i UpgradePreferencesArgs) ToUpgradePreferencesOutputWithContext(ctx context.Context) UpgradePreferencesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(UpgradePreferencesOutput)
}

func (i UpgradePreferencesArgs) ToUpgradePreferencesPtrOutput() UpgradePreferencesPtrOutput {
	return i.ToUpgradePreferencesPtrOutputWithContext(context.Background())
}

func (i UpgradePreferencesArgs) ToUpgradePreferencesPtrOutputWithContext(ctx context.Context) UpgradePreferencesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(UpgradePreferencesOutput).ToUpgradePreferencesPtrOutputWithContext(ctx)
}

// UpgradePreferencesPtrInput is an input type that accepts UpgradePreferencesArgs, UpgradePreferencesPtr and UpgradePreferencesPtrOutput values.
// You can construct a concrete instance of `UpgradePreferencesPtrInput` via:
//
//	        UpgradePreferencesArgs{...}
//
//	or:
//
//	        nil
type UpgradePreferencesPtrInput interface {
	pulumi.Input

	ToUpgradePreferencesPtrOutput() UpgradePreferencesPtrOutput
	ToUpgradePreferencesPtrOutputWithContext(context.Context) UpgradePreferencesPtrOutput
}

type upgradePreferencesPtrType UpgradePreferencesArgs

func UpgradePreferencesPtr(v *UpgradePreferencesArgs) UpgradePreferencesPtrInput {
	return (*upgradePreferencesPtrType)(v)
}

func (*upgradePreferencesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**UpgradePreferences)(nil)).Elem()
}

func (i *upgradePreferencesPtrType) ToUpgradePreferencesPtrOutput() UpgradePreferencesPtrOutput {
	return i.ToUpgradePreferencesPtrOutputWithContext(context.Background())
}

func (i *upgradePreferencesPtrType) ToUpgradePreferencesPtrOutputWithContext(ctx context.Context) UpgradePreferencesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(UpgradePreferencesPtrOutput)
}

// Contains all settings for the cluster upgrade window.
type UpgradePreferencesOutput struct{ *pulumi.OutputState }

func (UpgradePreferencesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*UpgradePreferences)(nil)).Elem()
}

func (o UpgradePreferencesOutput) ToUpgradePreferencesOutput() UpgradePreferencesOutput {
	return o
}

func (o UpgradePreferencesOutput) ToUpgradePreferencesOutputWithContext(ctx context.Context) UpgradePreferencesOutput {
	return o
}

func (o UpgradePreferencesOutput) ToUpgradePreferencesPtrOutput() UpgradePreferencesPtrOutput {
	return o.ToUpgradePreferencesPtrOutputWithContext(context.Background())
}

func (o UpgradePreferencesOutput) ToUpgradePreferencesPtrOutputWithContext(ctx context.Context) UpgradePreferencesPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v UpgradePreferences) *UpgradePreferences {
		return &v
	}).(UpgradePreferencesPtrOutput)
}

// Preferred day of the week in UTC time to begin an upgrade. If 'Any' is selected, upgrade will proceed at any given weekday
func (o UpgradePreferencesOutput) StartDayOfWeek() pulumi.StringPtrOutput {
	return o.ApplyT(func(v UpgradePreferences) *string { return v.StartDayOfWeek }).(pulumi.StringPtrOutput)
}

// Preferred hour of the day in UTC time to begin an upgrade
func (o UpgradePreferencesOutput) StartHourOfDay() pulumi.IntPtrOutput {
	return o.ApplyT(func(v UpgradePreferences) *int { return v.StartHourOfDay }).(pulumi.IntPtrOutput)
}

type UpgradePreferencesPtrOutput struct{ *pulumi.OutputState }

func (UpgradePreferencesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**UpgradePreferences)(nil)).Elem()
}

func (o UpgradePreferencesPtrOutput) ToUpgradePreferencesPtrOutput() UpgradePreferencesPtrOutput {
	return o
}

func (o UpgradePreferencesPtrOutput) ToUpgradePreferencesPtrOutputWithContext(ctx context.Context) UpgradePreferencesPtrOutput {
	return o
}

func (o UpgradePreferencesPtrOutput) Elem() UpgradePreferencesOutput {
	return o.ApplyT(func(v *UpgradePreferences) UpgradePreferences {
		if v != nil {
			return *v
		}
		var ret UpgradePreferences
		return ret
	}).(UpgradePreferencesOutput)
}

// Preferred day of the week in UTC time to begin an upgrade. If 'Any' is selected, upgrade will proceed at any given weekday
func (o UpgradePreferencesPtrOutput) StartDayOfWeek() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *UpgradePreferences) *string {
		if v == nil {
			return nil
		}
		return v.StartDayOfWeek
	}).(pulumi.StringPtrOutput)
}

// Preferred hour of the day in UTC time to begin an upgrade
func (o UpgradePreferencesPtrOutput) StartHourOfDay() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *UpgradePreferences) *int {
		if v == nil {
			return nil
		}
...
// Contains all settings for the cluster upgrade window.
type UpgradePreferencesResponse struct {
	// Preferred day of the week in UTC time to begin an upgrade. If 'Any' is selected, upgrade will proceed at any given weekday
	StartDayOfWeek *string `pulumi:"startDayOfWeek"`
	// Preferred hour of the day in UTC time to begin an upgrade
	StartHourOfDay *int `pulumi:"startHourOfDay"`
...
// Contains all settings for the cluster upgrade window.
type UpgradePreferencesResponseOutput struct{ *pulumi.OutputState }

func (UpgradePreferencesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*UpgradePreferencesResponse)(nil)).Elem()
}

func (o UpgradePreferencesResponseOutput) ToUpgradePreferencesResponseOutput() UpgradePreferencesResponseOutput {
	return o
}

func (o UpgradePreferencesResponseOutput) ToUpgradePreferencesResponseOutputWithContext(ctx context.Context) UpgradePreferencesResponseOutput {
	return o
}

// Preferred day of the week in UTC time to begin an upgrade. If 'Any' is selected, upgrade will proceed at any given weekday
func (o UpgradePreferencesResponseOutput) StartDayOfWeek() pulumi.StringPtrOutput {
	return o.ApplyT(func(v UpgradePreferencesResponse) *string { return v.StartDayOfWeek }).(pulumi.StringPtrOutput)
}

// Preferred hour of the day in UTC time to begin an upgrade
func (o UpgradePreferencesResponseOutput) StartHourOfDay() pulumi.IntPtrOutput {
	return o.ApplyT(func(v UpgradePreferencesResponse) *int { return v.StartHourOfDay }).(pulumi.IntPtrOutput)
}

type UpgradePreferencesResponsePtrOutput struct{ *pulumi.OutputState }

func (UpgradePreferencesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**UpgradePreferencesResponse)(nil)).Elem()
}

func (o UpgradePreferencesResponsePtrOutput) ToUpgradePreferencesResponsePtrOutput() UpgradePreferencesResponsePtrOutput {
	return o
}

func (o UpgradePreferencesResponsePtrOutput) ToUpgradePreferencesResponsePtrOutputWithContext(ctx context.Context) UpgradePreferencesResponsePtrOutput {
	return o
}

func (o UpgradePreferencesResponsePtrOutput) Elem() UpgradePreferencesResponseOutput {
	return o.ApplyT(func(v *UpgradePreferencesResponse) UpgradePreferencesResponse {
		if v != nil {
			return *v
		}
		var ret UpgradePreferencesResponse
		return ret
	}).(UpgradePreferencesResponseOutput)
}

// Preferred day of the week in UTC time to begin an upgrade. If 'Any' is selected, upgrade will proceed at any given weekday
func (o UpgradePreferencesResponsePtrOutput) StartDayOfWeek() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *UpgradePreferencesResponse) *string {
		if v == nil {
			return nil
		}
		return v.StartDayOfWeek
...
// Preferred hour of the day in UTC time to begin an upgrade
func (o UpgradePreferencesResponsePtrOutput) StartHourOfDay() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *UpgradePreferencesResponse) *int {
		if v == nil {
			return nil
		}
		return v.StartHourOfDay
...
func init() {
	...
	pulumi.RegisterOutputType(UpgradePreferencesOutput{})
	pulumi.RegisterOutputType(UpgradePreferencesPtrOutput{})
	pulumi.RegisterOutputType(UpgradePreferencesResponseOutput{})
	pulumi.RegisterOutputType(UpgradePreferencesResponsePtrOutput{})
