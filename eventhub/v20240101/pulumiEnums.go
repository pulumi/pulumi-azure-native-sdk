...
func (StartDayOfWeek) ElementType() reflect.Type {
	return reflect.TypeOf((*StartDayOfWeek)(nil)).Elem()
}

func (e StartDayOfWeek) ToStartDayOfWeekOutput() StartDayOfWeekOutput {
	return pulumi.ToOutput(e).(StartDayOfWeekOutput)
}

func (e StartDayOfWeek) ToStartDayOfWeekOutputWithContext(ctx context.Context) StartDayOfWeekOutput {
	return pulumi.ToOutputWithContext(ctx, e).(StartDayOfWeekOutput)
}

func (e StartDayOfWeek) ToStartDayOfWeekPtrOutput() StartDayOfWeekPtrOutput {
	return e.ToStartDayOfWeekPtrOutputWithContext(context.Background())
}

func (e StartDayOfWeek) ToStartDayOfWeekPtrOutputWithContext(ctx context.Context) StartDayOfWeekPtrOutput {
	return StartDayOfWeek(e).ToStartDayOfWeekOutputWithContext(ctx).ToStartDayOfWeekPtrOutputWithContext(ctx)
}

func (e StartDayOfWeek) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e StartDayOfWeek) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e StartDayOfWeek) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e StartDayOfWeek) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type StartDayOfWeekOutput struct{ *pulumi.OutputState }

func (StartDayOfWeekOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*StartDayOfWeek)(nil)).Elem()
}

func (o StartDayOfWeekOutput) ToStartDayOfWeekOutput() StartDayOfWeekOutput {
	return o
}

func (o StartDayOfWeekOutput) ToStartDayOfWeekOutputWithContext(ctx context.Context) StartDayOfWeekOutput {
	return o
}

func (o StartDayOfWeekOutput) ToStartDayOfWeekPtrOutput() StartDayOfWeekPtrOutput {
	return o.ToStartDayOfWeekPtrOutputWithContext(context.Background())
}

func (o StartDayOfWeekOutput) ToStartDayOfWeekPtrOutputWithContext(ctx context.Context) StartDayOfWeekPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v StartDayOfWeek) *StartDayOfWeek {
		return &v
	}).(StartDayOfWeekPtrOutput)
}

func (o StartDayOfWeekOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o StartDayOfWeekOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e StartDayOfWeek) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o StartDayOfWeekOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o StartDayOfWeekOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e StartDayOfWeek) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type StartDayOfWeekPtrOutput struct{ *pulumi.OutputState }

func (StartDayOfWeekPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**StartDayOfWeek)(nil)).Elem()
}

func (o StartDayOfWeekPtrOutput) ToStartDayOfWeekPtrOutput() StartDayOfWeekPtrOutput {
	return o
}

func (o StartDayOfWeekPtrOutput) ToStartDayOfWeekPtrOutputWithContext(ctx context.Context) StartDayOfWeekPtrOutput {
	return o
}

func (o StartDayOfWeekPtrOutput) Elem() StartDayOfWeekOutput {
	return o.ApplyT(func(v *StartDayOfWeek) StartDayOfWeek {
		if v != nil {
			return *v
		}
		var ret StartDayOfWeek
		return ret
	}).(StartDayOfWeekOutput)
}

func (o StartDayOfWeekPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o StartDayOfWeekPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *StartDayOfWeek) *string {
		if e == nil {
			return nil
		}
...
// StartDayOfWeekInput is an input type that accepts values of the StartDayOfWeek enum
// A concrete instance of `StartDayOfWeekInput` can be one of the following:
//
...
//	StartDayOfWeekAny
type StartDayOfWeekInput interface {
	pulumi.Input

	ToStartDayOfWeekOutput() StartDayOfWeekOutput
	ToStartDayOfWeekOutputWithContext(context.Context) StartDayOfWeekOutput
}

var startDayOfWeekPtrType = reflect.TypeOf((**StartDayOfWeek)(nil)).Elem()

type StartDayOfWeekPtrInput interface {
	pulumi.Input

	ToStartDayOfWeekPtrOutput() StartDayOfWeekPtrOutput
	ToStartDayOfWeekPtrOutputWithContext(context.Context) StartDayOfWeekPtrOutput
}

type startDayOfWeekPtr string

func StartDayOfWeekPtr(v string) StartDayOfWeekPtrInput {
	return (*startDayOfWeekPtr)(&v)
}

func (*startDayOfWeekPtr) ElementType() reflect.Type {
	return startDayOfWeekPtrType
}

func (in *startDayOfWeekPtr) ToStartDayOfWeekPtrOutput() StartDayOfWeekPtrOutput {
	return pulumi.ToOutput(in).(StartDayOfWeekPtrOutput)
}

func (in *startDayOfWeekPtr) ToStartDayOfWeekPtrOutputWithContext(ctx context.Context) StartDayOfWeekPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(StartDayOfWeekPtrOutput)
}

func (in *startDayOfWeekPtr) ToOutput(ctx context.Context) pulumix.Output[*StartDayOfWeek] {
	return pulumix.Output[*StartDayOfWeek]{
		OutputState: in.ToStartDayOfWeekPtrOutputWithContext(ctx).OutputState,
	}
}
...
func init() {
	...
	pulumi.RegisterOutputType(StartDayOfWeekOutput{})
	pulumi.RegisterOutputType(StartDayOfWeekPtrOutput{})
