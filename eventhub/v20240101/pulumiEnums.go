...
// CaptureIdentityTypeInput is an input type that accepts CaptureIdentityTypeArgs and CaptureIdentityTypeOutput values.
// You can construct a concrete instance of `CaptureIdentityTypeInput` via:
//
//	CaptureIdentityTypeArgs{...}
