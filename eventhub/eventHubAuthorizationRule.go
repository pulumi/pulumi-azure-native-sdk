...
func NewEventHubAuthorizationRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventhub/v20250501preview:EventHubAuthorizationRule"),
		},
		{
			Type: pulumi.String("azure-native:eventhub/v20260101:EventHubAuthorizationRule"),
		},
	})
...
// The Azure API version of the resource.
func (o EventHubAuthorizationRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *EventHubAuthorizationRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
