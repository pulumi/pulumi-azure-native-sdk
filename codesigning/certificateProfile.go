...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CertificateProfileOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *CertificateProfile) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
