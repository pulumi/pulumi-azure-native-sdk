...
func NewCertificateProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:codesigning/v20240930preview:CertificateProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateProfile(ctx *pulumi.Context,
	...
	var resource CertificateProfile
	err := ctx.ReadResource("azure-native:codesigning/v20240930preview:CertificateProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
