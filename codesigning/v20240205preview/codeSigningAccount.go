...
func NewCodeSigningAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:codesigning/v20240205preview:CodeSigningAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodeSigningAccount(ctx *pulumi.Context,
	...
	var resource CodeSigningAccount
	err := ctx.ReadResource("azure-native:codesigning/v20240205preview:CodeSigningAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
