...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o EndpointOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Endpoint) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
