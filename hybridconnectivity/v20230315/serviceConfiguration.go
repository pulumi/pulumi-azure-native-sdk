...
func NewServiceConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridconnectivity/v20230315:ServiceConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceConfiguration(ctx *pulumi.Context,
	...
	var resource ServiceConfiguration
	err := ctx.ReadResource("azure-native:hybridconnectivity/v20230315:ServiceConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
