...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ServiceConfigurationOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ServiceConfiguration) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
