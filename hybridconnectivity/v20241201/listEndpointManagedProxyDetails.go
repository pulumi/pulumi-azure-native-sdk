...
func ListEndpointManagedProxyDetails(ctx *pulumi.Context, args *ListEndpointManagedProxyDetailsArgs, opts ...pulumi.InvokeOption) (*ListEndpointManagedProxyDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridconnectivity/v20241201:listEndpointManagedProxyDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListEndpointManagedProxyDetailsOutput(ctx *pulumi.Context, args ListEndpointManagedProxyDetailsOutputArgs, opts ...pulumi.InvokeOption) ListEndpointManagedProxyDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListEndpointManagedProxyDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridconnectivity/v20241201:listEndpointManagedProxyDetails", args, ListEndpointManagedProxyDetailsResultOutput{}, options).(ListEndpointManagedProxyDetailsResultOutput), nil
