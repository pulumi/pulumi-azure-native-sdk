...
func ListEndpointCredentials(ctx *pulumi.Context, args *ListEndpointCredentialsArgs, opts ...pulumi.InvokeOption) (*ListEndpointCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridconnectivity/v20241201:listEndpointCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListEndpointCredentialsOutput(ctx *pulumi.Context, args ListEndpointCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListEndpointCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListEndpointCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridconnectivity/v20241201:listEndpointCredentials", args, ListEndpointCredentialsResultOutput{}, options).(ListEndpointCredentialsResultOutput), nil
