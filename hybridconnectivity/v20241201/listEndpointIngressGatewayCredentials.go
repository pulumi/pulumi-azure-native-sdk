...
func ListEndpointIngressGatewayCredentials(ctx *pulumi.Context, args *ListEndpointIngressGatewayCredentialsArgs, opts ...pulumi.InvokeOption) (*ListEndpointIngressGatewayCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridconnectivity/v20241201:listEndpointIngressGatewayCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListEndpointIngressGatewayCredentialsOutput(ctx *pulumi.Context, args ListEndpointIngressGatewayCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListEndpointIngressGatewayCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListEndpointIngressGatewayCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridconnectivity/v20241201:listEndpointIngressGatewayCredentials", args, ListEndpointIngressGatewayCredentialsResultOutput{}, options).(ListEndpointIngressGatewayCredentialsResultOutput), nil
