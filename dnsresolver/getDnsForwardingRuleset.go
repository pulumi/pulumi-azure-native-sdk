...
func LookupDnsForwardingRuleset(ctx *pulumi.Context, args *LookupDnsForwardingRulesetArgs, opts ...pulumi.InvokeOption) (*LookupDnsForwardingRulesetResult, error) {
	...
	err := ctx.Invoke("azure-native:dnsresolver:getDnsForwardingRuleset", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDnsForwardingRulesetOutput(ctx *pulumi.Context, args LookupDnsForwardingRulesetOutputArgs, opts ...pulumi.InvokeOption) LookupDnsForwardingRulesetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDnsForwardingRulesetResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dnsresolver:getDnsForwardingRuleset", args, LookupDnsForwardingRulesetResultOutput{}, options).(LookupDnsForwardingRulesetResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDnsForwardingRulesetResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDnsForwardingRulesetResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDnsForwardingRulesetResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDnsForwardingRulesetResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
