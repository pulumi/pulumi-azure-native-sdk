...
func NewOutboundEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dnsresolver/v20200401preview:OutboundEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20220701:OutboundEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20230701preview:OutboundEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20250501:OutboundEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20251001preview:OutboundEndpoint"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dnsresolver:OutboundEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOutboundEndpoint(ctx *pulumi.Context,
	...
	var resource OutboundEndpoint
	err := ctx.ReadResource("azure-native:dnsresolver:OutboundEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o OutboundEndpointOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *OutboundEndpoint) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o OutboundEndpointOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *OutboundEndpoint) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
