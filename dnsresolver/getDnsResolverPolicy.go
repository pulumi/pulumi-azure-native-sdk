...
func LookupDnsResolverPolicy(ctx *pulumi.Context, args *LookupDnsResolverPolicyArgs, opts ...pulumi.InvokeOption) (*LookupDnsResolverPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:dnsresolver:getDnsResolverPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDnsResolverPolicyOutput(ctx *pulumi.Context, args LookupDnsResolverPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupDnsResolverPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDnsResolverPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dnsresolver:getDnsResolverPolicy", args, LookupDnsResolverPolicyResultOutput{}, options).(LookupDnsResolverPolicyResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDnsResolverPolicyResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDnsResolverPolicyResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDnsResolverPolicyResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDnsResolverPolicyResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
