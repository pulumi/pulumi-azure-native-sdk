...
func LookupDnsResolver(ctx *pulumi.Context, args *LookupDnsResolverArgs, opts ...pulumi.InvokeOption) (*LookupDnsResolverResult, error) {
	...
	err := ctx.Invoke("azure-native:dnsresolver:getDnsResolver", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDnsResolverOutput(ctx *pulumi.Context, args LookupDnsResolverOutputArgs, opts ...pulumi.InvokeOption) LookupDnsResolverResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDnsResolverResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dnsresolver:getDnsResolver", args, LookupDnsResolverResultOutput{}, options).(LookupDnsResolverResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDnsResolverResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDnsResolverResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDnsResolverResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDnsResolverResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
