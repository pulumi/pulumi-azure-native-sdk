...
func NewInboundEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dnsresolver/v20200401preview:InboundEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20220701:InboundEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20230701preview:InboundEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20250501:InboundEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20251001preview:InboundEndpoint"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dnsresolver:InboundEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInboundEndpoint(ctx *pulumi.Context,
	...
	var resource InboundEndpoint
	err := ctx.ReadResource("azure-native:dnsresolver:InboundEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o InboundEndpointOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *InboundEndpoint) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// IP configurations for the inbound endpoint.
func (o InboundEndpointOutput) IpConfigurations() IpConfigurationResponseArrayOutput {
	return o.ApplyT(func(v *InboundEndpoint) IpConfigurationResponseArrayOutput { return v.IpConfigurations }).(IpConfigurationResponseArrayOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o InboundEndpointOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *InboundEndpoint) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
