...
func LookupOutboundEndpoint(ctx *pulumi.Context, args *LookupOutboundEndpointArgs, opts ...pulumi.InvokeOption) (*LookupOutboundEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:dnsresolver:getOutboundEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupOutboundEndpointOutput(ctx *pulumi.Context, args LookupOutboundEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupOutboundEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOutboundEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dnsresolver:getOutboundEndpoint", args, LookupOutboundEndpointResultOutput{}, options).(LookupOutboundEndpointResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupOutboundEndpointResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupOutboundEndpointResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupOutboundEndpointResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupOutboundEndpointResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
