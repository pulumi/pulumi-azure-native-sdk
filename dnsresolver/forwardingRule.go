...
func NewForwardingRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dnsresolver/v20200401preview:ForwardingRule"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20220701:ForwardingRule"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20230701preview:ForwardingRule"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20250501:ForwardingRule"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20251001preview:ForwardingRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dnsresolver:ForwardingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetForwardingRule(ctx *pulumi.Context,
	...
	var resource ForwardingRule
	err := ctx.ReadResource("azure-native:dnsresolver:ForwardingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ForwardingRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ForwardingRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ForwardingRuleOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ForwardingRule) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
