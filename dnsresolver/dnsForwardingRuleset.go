...
func NewDnsForwardingRuleset(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dnsresolver/v20200401preview:DnsForwardingRuleset"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20220701:DnsForwardingRuleset"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20230701preview:DnsForwardingRuleset"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dnsresolver:DnsForwardingRuleset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsForwardingRuleset(ctx *pulumi.Context,
	...
	var resource DnsForwardingRuleset
	err := ctx.ReadResource("azure-native:dnsresolver:DnsForwardingRuleset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DnsForwardingRulesetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DnsForwardingRuleset) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DnsForwardingRulesetOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DnsForwardingRuleset) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
