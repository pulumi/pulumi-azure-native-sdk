...
func NewDnsResolverPolicyVirtualNetworkLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dnsresolver/v20230701preview:DnsResolverPolicyVirtualNetworkLink"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20250501:DnsResolverPolicyVirtualNetworkLink"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20251001preview:DnsResolverPolicyVirtualNetworkLink"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink"),
		},
		{
			Type: pulumi.String("azure-native:network:DnsResolverPolicyVirtualNetworkLink"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DnsResolverPolicyVirtualNetworkLink
	err := ctx.RegisterResource("azure-native:dnsresolver:DnsResolverPolicyVirtualNetworkLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsResolverPolicyVirtualNetworkLink(ctx *pulumi.Context,
	...
	var resource DnsResolverPolicyVirtualNetworkLink
	err := ctx.ReadResource("azure-native:dnsresolver:DnsResolverPolicyVirtualNetworkLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DnsResolverPolicyVirtualNetworkLinkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DnsResolverPolicyVirtualNetworkLink) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DnsResolverPolicyVirtualNetworkLinkOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DnsResolverPolicyVirtualNetworkLink) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
