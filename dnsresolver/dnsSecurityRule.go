...
func NewDnsSecurityRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dnsresolver/v20230701preview:DnsSecurityRule"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20250501:DnsSecurityRule"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20251001preview:DnsSecurityRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230701preview:DnsSecurityRule"),
		},
		{
			Type: pulumi.String("azure-native:network:DnsSecurityRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DnsSecurityRule
	err := ctx.RegisterResource("azure-native:dnsresolver:DnsSecurityRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsSecurityRule(ctx *pulumi.Context,
	...
	var resource DnsSecurityRule
	err := ctx.ReadResource("azure-native:dnsresolver:DnsSecurityRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DnsSecurityRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DnsSecurityRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DnsSecurityRuleOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DnsSecurityRule) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
