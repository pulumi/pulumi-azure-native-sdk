...
func NewDnsResolverDomainList(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dnsresolver/v20251001preview:DnsResolverDomainList"),
		},
		{
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DnsResolverDomainListOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DnsResolverDomainList) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
