...
func NewDnsResolver(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dnsresolver/v20200401preview:DnsResolver"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20220701:DnsResolver"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20230701preview:DnsResolver"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20250501:DnsResolver"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20251001preview:DnsResolver"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dnsresolver:DnsResolver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsResolver(ctx *pulumi.Context,
	...
	var resource DnsResolver
	err := ctx.ReadResource("azure-native:dnsresolver:DnsResolver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DnsResolverOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DnsResolver) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DnsResolverOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DnsResolver) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
