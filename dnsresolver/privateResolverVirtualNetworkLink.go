...
func NewPrivateResolverVirtualNetworkLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dnsresolver/v20200401preview:PrivateResolverVirtualNetworkLink"),
		},
		{
			Type: pulumi.String("azure-native:dnsresolver/v20220701:PrivateResolverVirtualNetworkLink"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:dnsresolver/v20251001preview:PrivateResolverVirtualNetworkLink"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dnsresolver:PrivateResolverVirtualNetworkLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateResolverVirtualNetworkLink(ctx *pulumi.Context,
	...
	var resource PrivateResolverVirtualNetworkLink
	err := ctx.ReadResource("azure-native:dnsresolver:PrivateResolverVirtualNetworkLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o PrivateResolverVirtualNetworkLinkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PrivateResolverVirtualNetworkLink) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PrivateResolverVirtualNetworkLinkOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PrivateResolverVirtualNetworkLink) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
