...
// The reference to the subnet bound to the IP configuration.
func (o IpConfigurationOutput) Subnet() SubResourceOutput {
	return o.ApplyT(func(v IpConfiguration) SubResource { return v.Subnet }).(SubResourceOutput)
}
...
// The reference to the subnet bound to the IP configuration.
func (o IpConfigurationResponseOutput) Subnet() SubResourceResponseOutput {
	return o.ApplyT(func(v IpConfigurationResponse) SubResourceResponse { return v.Subnet }).(SubResourceResponseOutput)
}
