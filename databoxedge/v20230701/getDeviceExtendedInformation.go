...
func GetDeviceExtendedInformation(ctx *pulumi.Context, args *GetDeviceExtendedInformationArgs, opts ...pulumi.InvokeOption) (*GetDeviceExtendedInformationResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20230701:getDeviceExtendedInformation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDeviceExtendedInformationOutput(ctx *pulumi.Context, args GetDeviceExtendedInformationOutputArgs, opts ...pulumi.InvokeOption) GetDeviceExtendedInformationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetDeviceExtendedInformationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20230701:getDeviceExtendedInformation", args, GetDeviceExtendedInformationResultOutput{}, options).(GetDeviceExtendedInformationResultOutput), nil
