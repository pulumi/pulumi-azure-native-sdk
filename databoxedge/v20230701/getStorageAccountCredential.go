...
func LookupStorageAccountCredential(ctx *pulumi.Context, args *LookupStorageAccountCredentialArgs, opts ...pulumi.InvokeOption) (*LookupStorageAccountCredentialResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20230701:getStorageAccountCredential", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStorageAccountCredentialOutput(ctx *pulumi.Context, args LookupStorageAccountCredentialOutputArgs, opts ...pulumi.InvokeOption) LookupStorageAccountCredentialResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStorageAccountCredentialResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20230701:getStorageAccountCredential", args, LookupStorageAccountCredentialResultOutput{}, options).(LookupStorageAccountCredentialResultOutput), nil
