...
func NewFileEventTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20230701:FileEventTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileEventTrigger(ctx *pulumi.Context,
	...
	var resource FileEventTrigger
	err := ctx.ReadResource("azure-native:databoxedge/v20230701:FileEventTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *FileEventTrigger) ToOutput(ctx context.Context) pulumix.Output[*FileEventTrigger] {
	return pulumix.Output[*FileEventTrigger]{
		OutputState: i.ToFileEventTriggerOutputWithContext(ctx).OutputState,
	}
}
...
func (o FileEventTriggerOutput) ToOutput(ctx context.Context) pulumix.Output[*FileEventTrigger] {
	return pulumix.Output[*FileEventTrigger]{
