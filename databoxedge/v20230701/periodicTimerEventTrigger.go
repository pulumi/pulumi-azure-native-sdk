...
func NewPeriodicTimerEventTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20230701:PeriodicTimerEventTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeriodicTimerEventTrigger(ctx *pulumi.Context,
	...
	var resource PeriodicTimerEventTrigger
	err := ctx.ReadResource("azure-native:databoxedge/v20230701:PeriodicTimerEventTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
