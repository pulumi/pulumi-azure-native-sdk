...
func LookupDevice(ctx *pulumi.Context, args *LookupDeviceArgs, opts ...pulumi.InvokeOption) (*LookupDeviceResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20230701:getDevice", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDeviceOutput(ctx *pulumi.Context, args LookupDeviceOutputArgs, opts ...pulumi.InvokeOption) LookupDeviceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDeviceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20230701:getDevice", args, LookupDeviceResultOutput{}, options).(LookupDeviceResultOutput), nil
