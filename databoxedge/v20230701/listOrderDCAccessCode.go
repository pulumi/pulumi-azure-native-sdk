...
func ListOrderDCAccessCode(ctx *pulumi.Context, args *ListOrderDCAccessCodeArgs, opts ...pulumi.InvokeOption) (*ListOrderDCAccessCodeResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20230701:listOrderDCAccessCode", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListOrderDCAccessCodeOutput(ctx *pulumi.Context, args ListOrderDCAccessCodeOutputArgs, opts ...pulumi.InvokeOption) ListOrderDCAccessCodeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListOrderDCAccessCodeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20230701:listOrderDCAccessCode", args, ListOrderDCAccessCodeResultOutput{}, options).(ListOrderDCAccessCodeResultOutput), nil
