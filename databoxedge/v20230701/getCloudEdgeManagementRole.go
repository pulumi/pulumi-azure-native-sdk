...
func LookupCloudEdgeManagementRole(ctx *pulumi.Context, args *LookupCloudEdgeManagementRoleArgs, opts ...pulumi.InvokeOption) (*LookupCloudEdgeManagementRoleResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20230701:getCloudEdgeManagementRole", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCloudEdgeManagementRoleOutput(ctx *pulumi.Context, args LookupCloudEdgeManagementRoleOutputArgs, opts ...pulumi.InvokeOption) LookupCloudEdgeManagementRoleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCloudEdgeManagementRoleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20230701:getCloudEdgeManagementRole", args, LookupCloudEdgeManagementRoleResultOutput{}, options).(LookupCloudEdgeManagementRoleResultOutput), nil
