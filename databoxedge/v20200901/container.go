...
// azure-native:databoxedge/v20200901:Container is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.
...
func NewContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20200901:Container", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainer(ctx *pulumi.Context,
	...
	var resource Container
	err := ctx.ReadResource("azure-native:databoxedge/v20200901:Container", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
