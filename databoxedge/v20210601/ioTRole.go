...
// Compute role.
//
// Deprecated: azure-native:databoxedge/v20210601:IoTRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.
type IoTRole struct {
...
func NewIoTRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210601:IoTRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoTRole(ctx *pulumi.Context,
	...
	var resource IoTRole
	err := ctx.ReadResource("azure-native:databoxedge/v20210601:IoTRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
