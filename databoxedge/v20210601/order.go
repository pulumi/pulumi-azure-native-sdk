...
func NewOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.RegisterResource("azure-native:databoxedge/v20210601:Order", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.ReadResource("azure-native:databoxedge/v20210601:Order", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
