...
//
// Deprecated: azure-native:databoxedge/v20210601:CloudEdgeManagementRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility.
...
func NewCloudEdgeManagementRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210601:CloudEdgeManagementRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudEdgeManagementRole(ctx *pulumi.Context,
	...
	var resource CloudEdgeManagementRole
	err := ctx.ReadResource("azure-native:databoxedge/v20210601:CloudEdgeManagementRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
