...
func NewArcAddon(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210601:ArcAddon", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArcAddon(ctx *pulumi.Context,
	...
	var resource ArcAddon
	err := ctx.ReadResource("azure-native:databoxedge/v20210601:ArcAddon", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
