...
// Data policy of the storage Account.
func (o StorageAccountOutput) DataPolicy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StorageAccount) pulumi.StringPtrOutput { return v.DataPolicy }).(pulumi.StringPtrOutput)
}
