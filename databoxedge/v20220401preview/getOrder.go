...
func LookupOrder(ctx *pulumi.Context, args *LookupOrderArgs, opts ...pulumi.InvokeOption) (*LookupOrderResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20220401preview:getOrder", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupOrderOutput(ctx *pulumi.Context, args LookupOrderOutputArgs, opts ...pulumi.InvokeOption) LookupOrderResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOrderResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20220401preview:getOrder", args, LookupOrderResultOutput{}, options).(LookupOrderResultOutput), nil
...
// The contact details.
func (o LookupOrderResultOutput) ContactInformation() ContactDetailsResponsePtrOutput {
	return o.ApplyT(func(v LookupOrderResult) *ContactDetailsResponse { return v.ContactInformation }).(ContactDetailsResponsePtrOutput)
}
