...
//
// Deprecated: azure-native:databoxedge/v20220401preview:MECRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:MECRole to guarantee forwards compatibility.
func LookupMECRole(ctx *pulumi.Context, args *LookupMECRoleArgs, opts ...pulumi.InvokeOption) (*LookupMECRoleResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20220401preview:getMECRole", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
