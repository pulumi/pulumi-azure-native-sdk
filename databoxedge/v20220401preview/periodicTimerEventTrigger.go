...
// Trigger details.
//
// Deprecated: azure-native:databoxedge/v20220401preview:PeriodicTimerEventTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger to guarantee forwards compatibility.
...
func NewPeriodicTimerEventTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20220401preview:PeriodicTimerEventTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeriodicTimerEventTrigger(ctx *pulumi.Context,
	...
	var resource PeriodicTimerEventTrigger
	err := ctx.ReadResource("azure-native:databoxedge/v20220401preview:PeriodicTimerEventTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
