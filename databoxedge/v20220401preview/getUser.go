...
//
// Deprecated: azure-native:databoxedge/v20220401preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:User to guarantee forwards compatibility.
func LookupUser(ctx *pulumi.Context, args *LookupUserArgs, opts ...pulumi.InvokeOption) (*LookupUserResult, error) {
	var rv LookupUserResult
	err := ctx.Invoke("azure-native:databoxedge/v20220401preview:getUser", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
