...
func NewAddon(ctx *pulumi.Context,
	...
	var resource Addon
	err := ctx.RegisterResource("azure-native:databoxedge/v20220401preview:Addon", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddon(ctx *pulumi.Context,
	...
	var resource Addon
	err := ctx.ReadResource("azure-native:databoxedge/v20220401preview:Addon", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
