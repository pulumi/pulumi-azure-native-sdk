...
func NewKubernetesRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge:KubernetesRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubernetesRole(ctx *pulumi.Context,
	...
	var resource KubernetesRole
	err := ctx.ReadResource("azure-native:databoxedge:KubernetesRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
