...
//
// Deprecated: azure-native:databoxedge/v20221201preview:StorageAccountCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:StorageAccountCredential to guarantee forwards compatibility.
...
func NewStorageAccountCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20221201preview:StorageAccountCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccountCredential(ctx *pulumi.Context,
	...
	var resource StorageAccountCredential
	err := ctx.ReadResource("azure-native:databoxedge/v20221201preview:StorageAccountCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
