...
//
// Deprecated: azure-native:databoxedge/v20221201preview:IoTRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.
func LookupIoTRole(ctx *pulumi.Context, args *LookupIoTRoleArgs, opts ...pulumi.InvokeOption) (*LookupIoTRoleResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20221201preview:getIoTRole", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
