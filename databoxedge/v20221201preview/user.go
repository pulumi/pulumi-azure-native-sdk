...
//
// Deprecated: azure-native:databoxedge/v20221201preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:User to guarantee forwards compatibility.
type User struct {
...
func NewUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:databoxedge/v20230101preview:User"),
		},
	})
	opts = append(opts, aliases)
	var resource User
	err := ctx.RegisterResource("azure-native:databoxedge/v20221201preview:User", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.ReadResource("azure-native:databoxedge/v20221201preview:User", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
