...
func LookupDevice(ctx *pulumi.Context, args *LookupDeviceArgs, opts ...pulumi.InvokeOption) (*LookupDeviceResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20221201preview:getDevice", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The details of compute version information
func (o LookupDeviceResultOutput) ComputeVersionInformation() ComputeVersionInformationResponseOutput {
	return o.ApplyT(func(v LookupDeviceResult) ComputeVersionInformationResponse { return v.ComputeVersionInformation }).(ComputeVersionInformationResponseOutput)
}
...
func (o LookupDeviceResultOutput) KubernetesPlatform() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDeviceResult) string { return v.KubernetesPlatform }).(pulumi.StringOutput)
}
