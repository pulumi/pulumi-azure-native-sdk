...
//
// Deprecated: azure-native:databoxedge/v20221201preview:Device is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Device to guarantee forwards compatibility.
type Device struct {
...
func NewDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.RegisterResource("azure-native:databoxedge/v20221201preview:Device", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.ReadResource("azure-native:databoxedge/v20221201preview:Device", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The details of compute version information
func (o DeviceOutput) ComputeVersionInformation() ComputeVersionInformationResponseOutput {
	return o.ApplyT(func(v *Device) ComputeVersionInformationResponseOutput { return v.ComputeVersionInformation }).(ComputeVersionInformationResponseOutput)
}
...
func (o DeviceOutput) KubernetesPlatform() pulumi.StringOutput {
	return o.ApplyT(func(v *Device) pulumi.StringOutput { return v.KubernetesPlatform }).(pulumi.StringOutput)
}
