...
//
// Deprecated: azure-native:databoxedge/v20221201preview:KubernetesRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:KubernetesRole to guarantee forwards compatibility.
...
func NewKubernetesRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20221201preview:KubernetesRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubernetesRole(ctx *pulumi.Context,
	...
	var resource KubernetesRole
	err := ctx.ReadResource("azure-native:databoxedge/v20221201preview:KubernetesRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
