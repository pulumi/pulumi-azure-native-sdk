...
//
// Deprecated: azure-native:databoxedge/v20221201preview:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:StorageAccount to guarantee forwards compatibility.
...
func NewStorageAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20221201preview:StorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccount(ctx *pulumi.Context,
	...
	var resource StorageAccount
	err := ctx.ReadResource("azure-native:databoxedge/v20221201preview:StorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
