...
//
// Deprecated: azure-native:databoxedge/v20221201preview:MonitoringConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.
...
func NewMonitoringConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:databoxedge/v20230101preview:MonitoringConfig"),
		},
	})
	opts = append(opts, aliases)
	var resource MonitoringConfig
	err := ctx.RegisterResource("azure-native:databoxedge/v20221201preview:MonitoringConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringConfig(ctx *pulumi.Context,
	...
	var resource MonitoringConfig
	err := ctx.ReadResource("azure-native:databoxedge/v20221201preview:MonitoringConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
