...
//
// Deprecated: azure-native:databoxedge/v20221201preview:Share is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Share to guarantee forwards compatibility.
type Share struct {
