...
//
// Deprecated: azure-native:databoxedge/v20210601preview:BandwidthSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:BandwidthSchedule to guarantee forwards compatibility.
...
func NewBandwidthSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210601preview:BandwidthSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBandwidthSchedule(ctx *pulumi.Context,
	...
	var resource BandwidthSchedule
	err := ctx.ReadResource("azure-native:databoxedge/v20210601preview:BandwidthSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
