...
func NewDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.RegisterResource("azure-native:databoxedge/v20210601preview:Device", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.ReadResource("azure-native:databoxedge/v20210601preview:Device", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
