...
func NewFileEventTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210601preview:FileEventTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileEventTrigger(ctx *pulumi.Context,
	...
	var resource FileEventTrigger
	err := ctx.ReadResource("azure-native:databoxedge/v20210601preview:FileEventTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
