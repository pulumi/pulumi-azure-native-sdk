...
// Arc Addon.
//
// Deprecated: azure-native:databoxedge/v20210201:ArcAddon is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:ArcAddon to guarantee forwards compatibility.
...
func NewArcAddon(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210201:ArcAddon", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArcAddon(ctx *pulumi.Context,
	...
	var resource ArcAddon
	err := ctx.ReadResource("azure-native:databoxedge/v20210201:ArcAddon", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
