...
// MEC role.
//
// Deprecated: azure-native:databoxedge/v20210201:MECRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:MECRole to guarantee forwards compatibility.
type MECRole struct {
...
func NewMECRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210201:MECRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMECRole(ctx *pulumi.Context,
	...
	var resource MECRole
	err := ctx.ReadResource("azure-native:databoxedge/v20210201:MECRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
