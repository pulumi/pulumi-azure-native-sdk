...
func NewIoTAddon(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210201:IoTAddon", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoTAddon(ctx *pulumi.Context,
	...
	var resource IoTAddon
	err := ctx.ReadResource("azure-native:databoxedge/v20210201:IoTAddon", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
