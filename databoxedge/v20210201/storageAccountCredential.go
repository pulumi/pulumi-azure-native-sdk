...
func NewStorageAccountCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20210201:StorageAccountCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccountCredential(ctx *pulumi.Context,
	...
	var resource StorageAccountCredential
	err := ctx.ReadResource("azure-native:databoxedge/v20210201:StorageAccountCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
