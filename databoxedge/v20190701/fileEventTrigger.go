...
// Trigger details.
//
// Deprecated: azure-native:databoxedge/v20190701:FileEventTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.
...
func NewFileEventTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20190701:FileEventTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileEventTrigger(ctx *pulumi.Context,
	...
	var resource FileEventTrigger
	err := ctx.ReadResource("azure-native:databoxedge/v20190701:FileEventTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
