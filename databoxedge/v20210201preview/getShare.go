...
//
// Deprecated: azure-native:databoxedge/v20210201preview:Share is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Share to guarantee forwards compatibility.
func LookupShare(ctx *pulumi.Context, args *LookupShareArgs, opts ...pulumi.InvokeOption) (*LookupShareResult, error) {
	var rv LookupShareResult
	err := ctx.Invoke("azure-native:databoxedge/v20210201preview:getShare", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
