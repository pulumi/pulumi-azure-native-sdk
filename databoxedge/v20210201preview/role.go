...
func NewRole(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:databoxedge/v20220401preview:Role"),
		},
		{
			Type: pulumi.String("azure-native:databoxedge/v20221201preview:Role"),
		},
		{
			Type: pulumi.String("azure-native:databoxedge/v20230101preview:Role"),
		},
	})
	opts = append(opts, aliases)
	var resource Role
	err := ctx.RegisterResource("azure-native:databoxedge/v20210201preview:Role", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.ReadResource("azure-native:databoxedge/v20210201preview:Role", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
