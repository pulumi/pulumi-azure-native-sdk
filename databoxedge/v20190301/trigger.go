...
func NewTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20190301:Trigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrigger(ctx *pulumi.Context,
	...
	var resource Trigger
	err := ctx.ReadResource("azure-native:databoxedge/v20190301:Trigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
