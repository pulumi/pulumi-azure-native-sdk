...
// azure-native:databoxedge/v20190301:Share is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Share to guarantee forwards compatibility.
type Share struct {
...
func NewShare(ctx *pulumi.Context,
	...
	var resource Share
	err := ctx.RegisterResource("azure-native:databoxedge/v20190301:Share", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShare(ctx *pulumi.Context,
	...
	var resource Share
	err := ctx.ReadResource("azure-native:databoxedge/v20190301:Share", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
