...
type Device struct {
	...
	KubernetesWorkloadProfile pulumi.StringOutput `pulumi:"kubernetesWorkloadProfile"`
...
func NewDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.RegisterResource("azure-native:databoxedge/v20231201:Device", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.ReadResource("azure-native:databoxedge/v20231201:Device", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Kubernetes Workload Profile
func (o DeviceOutput) KubernetesWorkloadProfile() pulumi.StringOutput {
	return o.ApplyT(func(v *Device) pulumi.StringOutput { return v.KubernetesWorkloadProfile }).(pulumi.StringOutput)
}
