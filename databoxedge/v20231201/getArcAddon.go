...
func LookupArcAddon(ctx *pulumi.Context, args *LookupArcAddonArgs, opts ...pulumi.InvokeOption) (*LookupArcAddonResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20231201:getArcAddon", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupArcAddonOutput(ctx *pulumi.Context, args LookupArcAddonOutputArgs, opts ...pulumi.InvokeOption) LookupArcAddonResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupArcAddonResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20231201:getArcAddon", args, LookupArcAddonResultOutput{}, options).(LookupArcAddonResultOutput), nil
