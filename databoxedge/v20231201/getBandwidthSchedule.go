...
func LookupBandwidthSchedule(ctx *pulumi.Context, args *LookupBandwidthScheduleArgs, opts ...pulumi.InvokeOption) (*LookupBandwidthScheduleResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20231201:getBandwidthSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBandwidthScheduleOutput(ctx *pulumi.Context, args LookupBandwidthScheduleOutputArgs, opts ...pulumi.InvokeOption) LookupBandwidthScheduleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBandwidthScheduleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20231201:getBandwidthSchedule", args, LookupBandwidthScheduleResultOutput{}, options).(LookupBandwidthScheduleResultOutput), nil
