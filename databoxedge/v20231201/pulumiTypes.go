...
// Load balancer ipconfig
func (o LoadBalancerConfigResponseOutput) IpRange() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LoadBalancerConfigResponse) []string { return v.IpRange }).(pulumi.StringArrayOutput)
}
