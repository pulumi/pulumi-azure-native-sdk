...
func LookupPeriodicTimerEventTrigger(ctx *pulumi.Context, args *LookupPeriodicTimerEventTriggerArgs, opts ...pulumi.InvokeOption) (*LookupPeriodicTimerEventTriggerResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20231201:getPeriodicTimerEventTrigger", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPeriodicTimerEventTriggerOutput(ctx *pulumi.Context, args LookupPeriodicTimerEventTriggerOutputArgs, opts ...pulumi.InvokeOption) LookupPeriodicTimerEventTriggerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPeriodicTimerEventTriggerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20231201:getPeriodicTimerEventTrigger", args, LookupPeriodicTimerEventTriggerResultOutput{}, options).(LookupPeriodicTimerEventTriggerResultOutput), nil
