...
func NewMonitoringConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20201201:MonitoringConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringConfig(ctx *pulumi.Context,
	...
	var resource MonitoringConfig
	err := ctx.ReadResource("azure-native:databoxedge/v20201201:MonitoringConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
