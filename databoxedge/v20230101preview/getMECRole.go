...
func LookupMECRole(ctx *pulumi.Context, args *LookupMECRoleArgs, opts ...pulumi.InvokeOption) (*LookupMECRoleResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20230101preview:getMECRole", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMECRoleOutput(ctx *pulumi.Context, args LookupMECRoleOutputArgs, opts ...pulumi.InvokeOption) LookupMECRoleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMECRoleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20230101preview:getMECRole", args, LookupMECRoleResultOutput{}, options).(LookupMECRoleResultOutput), nil
