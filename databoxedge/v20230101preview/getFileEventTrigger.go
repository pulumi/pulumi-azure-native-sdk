...
func LookupFileEventTrigger(ctx *pulumi.Context, args *LookupFileEventTriggerArgs, opts ...pulumi.InvokeOption) (*LookupFileEventTriggerResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20230101preview:getFileEventTrigger", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupFileEventTriggerOutput(ctx *pulumi.Context, args LookupFileEventTriggerOutputArgs, opts ...pulumi.InvokeOption) LookupFileEventTriggerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFileEventTriggerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databoxedge/v20230101preview:getFileEventTrigger", args, LookupFileEventTriggerResultOutput{}, options).(LookupFileEventTriggerResultOutput), nil
