...
func NewStorageAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:databoxedge/v20230701:StorageAccount"),
		},
		{
			Type: pulumi.String("azure-native:databoxedge/v20231201:StorageAccount"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20230101preview:StorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccount(ctx *pulumi.Context,
	...
	var resource StorageAccount
	err := ctx.ReadResource("azure-native:databoxedge/v20230101preview:StorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
