...
func NewBandwidthSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20230101preview:BandwidthSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBandwidthSchedule(ctx *pulumi.Context,
	...
	var resource BandwidthSchedule
	err := ctx.ReadResource("azure-native:databoxedge/v20230101preview:BandwidthSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
