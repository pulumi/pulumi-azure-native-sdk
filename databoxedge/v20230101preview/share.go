...
func NewShare(ctx *pulumi.Context,
	...
	var resource Share
	err := ctx.RegisterResource("azure-native:databoxedge/v20230101preview:Share", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShare(ctx *pulumi.Context,
	...
	var resource Share
	err := ctx.ReadResource("azure-native:databoxedge/v20230101preview:Share", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
