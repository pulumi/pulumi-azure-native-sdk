...
func NewMECRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20230101preview:MECRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMECRole(ctx *pulumi.Context,
	...
	var resource MECRole
	err := ctx.ReadResource("azure-native:databoxedge/v20230101preview:MECRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
