...
// AzureContainerDataFormatInput is an input type that accepts values of the AzureContainerDataFormat enum
// A concrete instance of `AzureContainerDataFormatInput` can be one of the following:
//
...
// ClientPermissionTypeInput is an input type that accepts values of the ClientPermissionType enum
// A concrete instance of `ClientPermissionTypeInput` can be one of the following:
//
...
// DataPolicyInput is an input type that accepts values of the DataPolicy enum
// A concrete instance of `DataPolicyInput` can be one of the following:
//
//	DataPolicyCloud
//	DataPolicyLocal
...
// RoleStatusInput is an input type that accepts values of the RoleStatus enum
// A concrete instance of `RoleStatusInput` can be one of the following:
//
//	RoleStatusEnabled
//	RoleStatusDisabled
...
// SSLStatusInput is an input type that accepts values of the SSLStatus enum
// A concrete instance of `SSLStatusInput` can be one of the following:
//
//	SSLStatusEnabled
//	SSLStatusDisabled
...
// ShareAccessProtocolInput is an input type that accepts values of the ShareAccessProtocol enum
// A concrete instance of `ShareAccessProtocolInput` can be one of the following:
//
...
// ShareAccessTypeInput is an input type that accepts values of the ShareAccessType enum
// A concrete instance of `ShareAccessTypeInput` can be one of the following:
//
...
// ShareStatusInput is an input type that accepts values of the ShareStatus enum
// A concrete instance of `ShareStatusInput` can be one of the following:
//
//	ShareStatusOffline
//	ShareStatusUnknown
//	ShareStatusOK
...
// StorageAccountStatusInput is an input type that accepts values of the StorageAccountStatus enum
// A concrete instance of `StorageAccountStatusInput` can be one of the following:
//
