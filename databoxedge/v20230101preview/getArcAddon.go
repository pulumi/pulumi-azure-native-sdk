...
func LookupArcAddon(ctx *pulumi.Context, args *LookupArcAddonArgs, opts ...pulumi.InvokeOption) (*LookupArcAddonResult, error) {
	...
	err := ctx.Invoke("azure-native:databoxedge/v20230101preview:getArcAddon", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupArcAddonResult struct {
	...
	CustomLocationsObjectId string `pulumi:"customLocationsObjectId"`
...
// Arc Custom Locations ObjectId
func (o LookupArcAddonResultOutput) CustomLocationsObjectId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupArcAddonResult) string { return v.CustomLocationsObjectId }).(pulumi.StringOutput)
}
