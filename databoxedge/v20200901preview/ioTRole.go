...
func NewIoTRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20200901preview:IoTRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoTRole(ctx *pulumi.Context,
	...
	var resource IoTRole
	err := ctx.ReadResource("azure-native:databoxedge/v20200901preview:IoTRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
