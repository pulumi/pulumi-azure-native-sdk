...
func NewCloudEdgeManagementRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databoxedge/v20200901preview:CloudEdgeManagementRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudEdgeManagementRole(ctx *pulumi.Context,
	...
	var resource CloudEdgeManagementRole
	err := ctx.ReadResource("azure-native:databoxedge/v20200901preview:CloudEdgeManagementRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
