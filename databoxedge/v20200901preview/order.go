...
// azure-native:databoxedge/v20200901preview:Order is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20220401preview:Order to guarantee forwards compatibility.
type Order struct {
...
func NewOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.RegisterResource("azure-native:databoxedge/v20200901preview:Order", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrder(ctx *pulumi.Context,
	...
	var resource Order
	err := ctx.ReadResource("azure-native:databoxedge/v20200901preview:Order", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
