...
func NewClusterService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:mobilepacketcore/v20231015preview:ClusterService"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ClusterService
	err := ctx.RegisterResource("azure-native:mobilepacketcore:ClusterService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterService(ctx *pulumi.Context,
	...
	var resource ClusterService
	err := ctx.ReadResource("azure-native:mobilepacketcore:ClusterService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
