...
func NewSmfDeployment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:mobilepacketcore:SmfDeployment"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SmfDeployment
	err := ctx.RegisterResource("azure-native:mobilepacketcore/v20231015preview:SmfDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSmfDeployment(ctx *pulumi.Context,
	...
	var resource SmfDeployment
	err := ctx.ReadResource("azure-native:mobilepacketcore/v20231015preview:SmfDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
