...
func NewNetworkFunction(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:mobilepacketcore/v20230515preview:NetworkFunction"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkFunction
	err := ctx.RegisterResource("azure-native:mobilepacketcore:NetworkFunction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFunction(ctx *pulumi.Context,
	...
	var resource NetworkFunction
	err := ctx.ReadResource("azure-native:mobilepacketcore:NetworkFunction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
