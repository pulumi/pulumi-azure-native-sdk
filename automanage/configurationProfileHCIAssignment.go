...
// The Azure API version of the resource.
func (o ConfigurationProfileHCIAssignmentOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ConfigurationProfileHCIAssignment) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ConfigurationProfileHCIAssignmentOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *ConfigurationProfileHCIAssignment) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
