...
func LookupConfigurationProfileHCRPAssignment(ctx *pulumi.Context, args *LookupConfigurationProfileHCRPAssignmentArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationProfileHCRPAssignmentResult, error) {
	...
	err := ctx.Invoke("azure-native:automanage:getConfigurationProfileHCRPAssignment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupConfigurationProfileHCRPAssignmentResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupConfigurationProfileHCRPAssignmentResult] {
	return pulumix.Output[LookupConfigurationProfileHCRPAssignmentResult]{
