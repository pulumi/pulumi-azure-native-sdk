...
// The Azure API version of the resource.
func (o LookupConfigurationProfileAssignmentResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupConfigurationProfileAssignmentResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupConfigurationProfileAssignmentResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupConfigurationProfileAssignmentResult) commontypesv2.SystemDataResponse {
		return v.SystemData
