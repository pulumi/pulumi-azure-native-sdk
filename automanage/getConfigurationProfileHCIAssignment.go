...
func LookupConfigurationProfileHCIAssignment(ctx *pulumi.Context, args *LookupConfigurationProfileHCIAssignmentArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationProfileHCIAssignmentResult, error) {
	...
	err := ctx.Invoke("azure-native:automanage:getConfigurationProfileHCIAssignment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConfigurationProfileHCIAssignmentOutput(ctx *pulumi.Context, args LookupConfigurationProfileHCIAssignmentOutputArgs, opts ...pulumi.InvokeOption) LookupConfigurationProfileHCIAssignmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConfigurationProfileHCIAssignmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automanage:getConfigurationProfileHCIAssignment", args, LookupConfigurationProfileHCIAssignmentResultOutput{}, options).(LookupConfigurationProfileHCIAssignmentResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupConfigurationProfileHCIAssignmentResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupConfigurationProfileHCIAssignmentResult) commontypesv2.SystemDataResponse {
		return v.SystemData
