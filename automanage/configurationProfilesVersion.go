...
func NewConfigurationProfilesVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automanage:ConfigurationProfilesVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationProfilesVersion(ctx *pulumi.Context,
	...
	var resource ConfigurationProfilesVersion
	err := ctx.ReadResource("azure-native:automanage:ConfigurationProfilesVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
