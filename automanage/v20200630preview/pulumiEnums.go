...
// EnableRealTimeProtectionInput is an input type that accepts values of the EnableRealTimeProtection enum
// A concrete instance of `EnableRealTimeProtectionInput` can be one of the following:
//
...
// RunScheduledScanInput is an input type that accepts values of the RunScheduledScan enum
// A concrete instance of `RunScheduledScanInput` can be one of the following:
//
...
// ScanTypeInput is an input type that accepts values of the ScanType enum
// A concrete instance of `ScanTypeInput` can be one of the following:
//
//	ScanTypeQuick
//	ScanTypeFull
