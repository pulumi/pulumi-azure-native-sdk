...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ConfigurationProfileOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *ConfigurationProfile) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
