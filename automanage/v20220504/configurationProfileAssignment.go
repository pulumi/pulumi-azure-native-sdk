...
func NewConfigurationProfileAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automanage/v20220504:ConfigurationProfileAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationProfileAssignment(ctx *pulumi.Context,
	...
	var resource ConfigurationProfileAssignment
	err := ctx.ReadResource("azure-native:automanage/v20220504:ConfigurationProfileAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
