...
func NewMySQLSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:mysqldiscovery:MySQLSite"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MySQLSite
	err := ctx.RegisterResource("azure-native:mysqldiscovery/v20240930preview:MySQLSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMySQLSite(ctx *pulumi.Context,
	...
	var resource MySQLSite
	err := ctx.ReadResource("azure-native:mysqldiscovery/v20240930preview:MySQLSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
