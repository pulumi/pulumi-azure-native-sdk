...
func NewMySQLServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:mysqldiscovery:MySQLServer"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MySQLServer
	err := ctx.RegisterResource("azure-native:mysqldiscovery/v20240930preview:MySQLServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMySQLServer(ctx *pulumi.Context,
	...
	var resource MySQLServer
	err := ctx.ReadResource("azure-native:mysqldiscovery/v20240930preview:MySQLServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
