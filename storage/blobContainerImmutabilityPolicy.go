...
func NewBlobContainerImmutabilityPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storage/v20230101:BlobContainerImmutabilityPolicy"),
		},
		{
			Type: pulumi.String("azure-native:storage/v20230401:BlobContainerImmutabilityPolicy"),
		},
		{
			Type: pulumi.String("azure-native:storage/v20230501:BlobContainerImmutabilityPolicy"),
		},
		{
			Type: pulumi.String("azure-native:storage/v20240101:BlobContainerImmutabilityPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BlobContainerImmutabilityPolicy
	err := ctx.RegisterResource("azure-native:storage:BlobContainerImmutabilityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainerImmutabilityPolicy(ctx *pulumi.Context,
	...
	var resource BlobContainerImmutabilityPolicy
	err := ctx.ReadResource("azure-native:storage:BlobContainerImmutabilityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
