...
func NewBlobServiceProperties(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storage/v20230101:BlobServiceProperties"),
		},
		{
			Type: pulumi.String("azure-native:storage/v20230401:BlobServiceProperties"),
		},
		{
			Type: pulumi.String("azure-native:storage/v20230501:BlobServiceProperties"),
		},
		{
			Type: pulumi.String("azure-native:storage/v20240101:BlobServiceProperties"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BlobServiceProperties
	err := ctx.RegisterResource("azure-native:storage:BlobServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobServiceProperties(ctx *pulumi.Context,
	...
	var resource BlobServiceProperties
	err := ctx.ReadResource("azure-native:storage:BlobServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o BlobServicePropertiesOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *BlobServiceProperties) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
