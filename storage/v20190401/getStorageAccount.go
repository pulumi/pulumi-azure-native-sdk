...
// azure-native:storage/v20190401:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:StorageAccount to guarantee forwards compatibility.
func LookupStorageAccount(ctx *pulumi.Context, args *LookupStorageAccountArgs, opts ...pulumi.InvokeOption) (*LookupStorageAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:storage/v20190401:getStorageAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
