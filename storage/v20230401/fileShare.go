...
func NewFileShare(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20230401:FileShare", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileShare(ctx *pulumi.Context,
	...
	var resource FileShare
	err := ctx.ReadResource("azure-native:storage/v20230401:FileShare", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
