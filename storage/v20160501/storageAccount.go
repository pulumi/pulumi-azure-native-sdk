...
// The storage account.
//
// Deprecated: Version 2016-05-01 will be removed in v2 of the provider.
// azure-native:storage/v20160501:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20181101:StorageAccount to guarantee forwards compatibility.
...
func NewStorageAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20160501:StorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccount(ctx *pulumi.Context,
	...
	var resource StorageAccount
	err := ctx.ReadResource("azure-native:storage/v20160501:StorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
