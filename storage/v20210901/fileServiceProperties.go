...
func NewFileServiceProperties(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210901:FileServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileServiceProperties(ctx *pulumi.Context,
	...
	var resource FileServiceProperties
	err := ctx.ReadResource("azure-native:storage/v20210901:FileServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
