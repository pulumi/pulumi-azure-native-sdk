...
func NewQueueServiceProperties(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20230501:QueueServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueServiceProperties(ctx *pulumi.Context,
	...
	var resource QueueServiceProperties
	err := ctx.ReadResource("azure-native:storage/v20230501:QueueServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
