...
func NewQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.RegisterResource("azure-native:storage/v20230501:Queue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.ReadResource("azure-native:storage/v20230501:Queue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
