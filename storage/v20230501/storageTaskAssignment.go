...
func NewStorageTaskAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20230501:StorageTaskAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageTaskAssignment(ctx *pulumi.Context,
	...
	var resource StorageTaskAssignment
	err := ctx.ReadResource("azure-native:storage/v20230501:StorageTaskAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
