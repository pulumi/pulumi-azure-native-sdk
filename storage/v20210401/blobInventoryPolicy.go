...
//
// Deprecated: azure-native:storage/v20210401:BlobInventoryPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobInventoryPolicy to guarantee forwards compatibility.
...
func NewBlobInventoryPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210401:BlobInventoryPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobInventoryPolicy(ctx *pulumi.Context,
	...
	var resource BlobInventoryPolicy
	err := ctx.ReadResource("azure-native:storage/v20210401:BlobInventoryPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
