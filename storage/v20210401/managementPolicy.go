...
func NewManagementPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210401:ManagementPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementPolicy(ctx *pulumi.Context,
	...
	var resource ManagementPolicy
	err := ctx.ReadResource("azure-native:storage/v20210401:ManagementPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
