...
//
// Deprecated: azure-native:storage/v20210601:EncryptionScope is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:EncryptionScope to guarantee forwards compatibility.
...
func NewEncryptionScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210601:EncryptionScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEncryptionScope(ctx *pulumi.Context,
	...
	var resource EncryptionScope
	err := ctx.ReadResource("azure-native:storage/v20210601:EncryptionScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
