...
//
// Deprecated: azure-native:storage/v20210601:TableServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:TableServiceProperties to guarantee forwards compatibility.
...
func NewTableServiceProperties(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210601:TableServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableServiceProperties(ctx *pulumi.Context,
	...
	var resource TableServiceProperties
	err := ctx.ReadResource("azure-native:storage/v20210601:TableServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
