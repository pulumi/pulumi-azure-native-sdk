...
//
// Deprecated: azure-native:storage/v20210601:Table is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:Table to guarantee forwards compatibility.
func LookupTable(ctx *pulumi.Context, args *LookupTableArgs, opts ...pulumi.InvokeOption) (*LookupTableResult, error) {
	var rv LookupTableResult
	err := ctx.Invoke("azure-native:storage/v20210601:getTable", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
