...
// azure-native:storage/v20181101:BlobServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobServiceProperties to guarantee forwards compatibility.
...
func NewBlobServiceProperties(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20181101:BlobServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobServiceProperties(ctx *pulumi.Context,
	...
	var resource BlobServiceProperties
	err := ctx.ReadResource("azure-native:storage/v20181101:BlobServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
