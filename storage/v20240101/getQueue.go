...
func LookupQueue(ctx *pulumi.Context, args *LookupQueueArgs, opts ...pulumi.InvokeOption) (*LookupQueueResult, error) {
	...
	err := ctx.Invoke("azure-native:storage/v20240101:getQueue", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupQueueOutput(ctx *pulumi.Context, args LookupQueueOutputArgs, opts ...pulumi.InvokeOption) LookupQueueResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupQueueResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storage/v20240101:getQueue", args, LookupQueueResultOutput{}, options).(LookupQueueResultOutput), nil
