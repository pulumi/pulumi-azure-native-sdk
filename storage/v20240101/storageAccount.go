...
func NewStorageAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20240101:StorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAccount(ctx *pulumi.Context,
	...
	var resource StorageAccount
	err := ctx.ReadResource("azure-native:storage/v20240101:StorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
