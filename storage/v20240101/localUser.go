...
func NewLocalUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20240101:LocalUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalUser(ctx *pulumi.Context,
	...
	var resource LocalUser
	err := ctx.ReadResource("azure-native:storage/v20240101:LocalUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
