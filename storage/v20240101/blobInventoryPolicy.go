...
func NewBlobInventoryPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20240101:BlobInventoryPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobInventoryPolicy(ctx *pulumi.Context,
	...
	var resource BlobInventoryPolicy
	err := ctx.ReadResource("azure-native:storage/v20240101:BlobInventoryPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
