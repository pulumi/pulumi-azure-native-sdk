...
//
// Deprecated: azure-native:storage/v20210201:BlobContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobContainer to guarantee forwards compatibility.
...
func NewBlobContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210201:BlobContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainer(ctx *pulumi.Context,
	...
	var resource BlobContainer
	err := ctx.ReadResource("azure-native:storage/v20210201:BlobContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
