...
func NewObjectReplicationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210201:ObjectReplicationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetObjectReplicationPolicy(ctx *pulumi.Context,
	...
	var resource ObjectReplicationPolicy
	err := ctx.ReadResource("azure-native:storage/v20210201:ObjectReplicationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
