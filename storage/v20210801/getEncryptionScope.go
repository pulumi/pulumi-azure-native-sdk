...
//
// Deprecated: azure-native:storage/v20210801:EncryptionScope is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:EncryptionScope to guarantee forwards compatibility.
func LookupEncryptionScope(ctx *pulumi.Context, args *LookupEncryptionScopeArgs, opts ...pulumi.InvokeOption) (*LookupEncryptionScopeResult, error) {
	...
	err := ctx.Invoke("azure-native:storage/v20210801:getEncryptionScope", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
