...
//
// Deprecated: azure-native:storage/v20210801:BlobInventoryPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobInventoryPolicy to guarantee forwards compatibility.
...
func NewBlobInventoryPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storage/v20220901:BlobInventoryPolicy"),
		},
	})
	opts = append(opts, aliases)
	var resource BlobInventoryPolicy
	err := ctx.RegisterResource("azure-native:storage/v20210801:BlobInventoryPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobInventoryPolicy(ctx *pulumi.Context,
	...
	var resource BlobInventoryPolicy
	err := ctx.ReadResource("azure-native:storage/v20210801:BlobInventoryPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
