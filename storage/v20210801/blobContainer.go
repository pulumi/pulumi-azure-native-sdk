...
func NewBlobContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210801:BlobContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainer(ctx *pulumi.Context,
	...
	var resource BlobContainer
	err := ctx.ReadResource("azure-native:storage/v20210801:BlobContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
