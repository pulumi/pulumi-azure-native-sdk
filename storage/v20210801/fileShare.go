...
//
// Deprecated: azure-native:storage/v20210801:FileShare is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.
...
func NewFileShare(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20210801:FileShare", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileShare(ctx *pulumi.Context,
	...
	var resource FileShare
	err := ctx.ReadResource("azure-native:storage/v20210801:FileShare", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
