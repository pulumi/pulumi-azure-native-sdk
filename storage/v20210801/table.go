...
//
// Deprecated: azure-native:storage/v20210801:Table is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:Table to guarantee forwards compatibility.
type Table struct {
...
func NewTable(ctx *pulumi.Context,
	...
	var resource Table
	err := ctx.RegisterResource("azure-native:storage/v20210801:Table", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTable(ctx *pulumi.Context,
	...
	var resource Table
	err := ctx.ReadResource("azure-native:storage/v20210801:Table", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
