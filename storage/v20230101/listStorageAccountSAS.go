...
func ListStorageAccountSAS(ctx *pulumi.Context, args *ListStorageAccountSASArgs, opts ...pulumi.InvokeOption) (*ListStorageAccountSASResult, error) {
	...
	err := ctx.Invoke("azure-native:storage/v20230101:listStorageAccountSAS", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListStorageAccountSASOutput(ctx *pulumi.Context, args ListStorageAccountSASOutputArgs, opts ...pulumi.InvokeOption) ListStorageAccountSASResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListStorageAccountSASResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storage/v20230101:listStorageAccountSAS", args, ListStorageAccountSASResultOutput{}, options).(ListStorageAccountSASResultOutput), nil
