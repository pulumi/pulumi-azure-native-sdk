...
func NewTable(ctx *pulumi.Context,
	...
	var resource Table
	err := ctx.RegisterResource("azure-native:storage/v20230101:Table", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTable(ctx *pulumi.Context,
	...
	var resource Table
	err := ctx.ReadResource("azure-native:storage/v20230101:Table", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
