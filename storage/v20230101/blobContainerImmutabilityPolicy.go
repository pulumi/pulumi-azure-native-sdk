...
func NewBlobContainerImmutabilityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20230101:BlobContainerImmutabilityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainerImmutabilityPolicy(ctx *pulumi.Context,
	...
	var resource BlobContainerImmutabilityPolicy
	err := ctx.ReadResource("azure-native:storage/v20230101:BlobContainerImmutabilityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
