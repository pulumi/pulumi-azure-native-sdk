...
func NewQueueServiceProperties(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storage/v20230501:QueueServiceProperties"),
		},
		{
			Type: pulumi.String("azure-native:storage/v20240101:QueueServiceProperties"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:storage/v20230101:QueueServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueServiceProperties(ctx *pulumi.Context,
	...
	var resource QueueServiceProperties
	err := ctx.ReadResource("azure-native:storage/v20230101:QueueServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
