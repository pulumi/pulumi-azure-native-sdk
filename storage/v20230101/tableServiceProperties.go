...
func NewTableServiceProperties(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage/v20230101:TableServiceProperties", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableServiceProperties(ctx *pulumi.Context,
	...
	var resource TableServiceProperties
	err := ctx.ReadResource("azure-native:storage/v20230101:TableServiceProperties", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
