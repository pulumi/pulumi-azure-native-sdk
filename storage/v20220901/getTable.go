...
func LookupTable(ctx *pulumi.Context, args *LookupTableArgs, opts ...pulumi.InvokeOption) (*LookupTableResult, error) {
	...
	err := ctx.Invoke("azure-native:storage/v20220901:getTable", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTableOutput(ctx *pulumi.Context, args LookupTableOutputArgs, opts ...pulumi.InvokeOption) LookupTableResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTableResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storage/v20220901:getTable", args, LookupTableResultOutput{}, options).(LookupTableResultOutput), nil
