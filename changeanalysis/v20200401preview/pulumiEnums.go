...
// ChangeDetailsModeInput is an input type that accepts values of the ChangeDetailsMode enum
// A concrete instance of `ChangeDetailsModeInput` can be one of the following:
//
...
// NotificationsStateInput is an input type that accepts values of the NotificationsState enum
// A concrete instance of `NotificationsStateInput` can be one of the following:
//
