...
func NewOperatorApiConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:programmableconnectivity:OperatorApiConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource OperatorApiConnection
	err := ctx.RegisterResource("azure-native:programmableconnectivity/v20240115preview:OperatorApiConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOperatorApiConnection(ctx *pulumi.Context,
	...
	var resource OperatorApiConnection
	err := ctx.ReadResource("azure-native:programmableconnectivity/v20240115preview:OperatorApiConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
