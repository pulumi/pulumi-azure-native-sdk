...
func NewDiscoverySource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dependencymap:DiscoverySource"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DiscoverySource
	err := ctx.RegisterResource("azure-native:dependencymap/v20250131preview:DiscoverySource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoverySource(ctx *pulumi.Context,
	...
	var resource DiscoverySource
	err := ctx.ReadResource("azure-native:dependencymap/v20250131preview:DiscoverySource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
