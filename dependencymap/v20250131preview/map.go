...
func NewMap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:dependencymap:Map"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Map
	err := ctx.RegisterResource("azure-native:dependencymap/v20250131preview:Map", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMap(ctx *pulumi.Context,
	...
	var resource Map
	err := ctx.ReadResource("azure-native:dependencymap/v20250131preview:Map", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
