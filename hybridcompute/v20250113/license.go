...
func NewLicense(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20250113:License", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLicense(ctx *pulumi.Context,
	...
	var resource License
	err := ctx.ReadResource("azure-native:hybridcompute/v20250113:License", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
