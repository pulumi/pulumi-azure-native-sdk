...
func LookupMachine(ctx *pulumi.Context, args *LookupMachineArgs, opts ...pulumi.InvokeOption) (*LookupMachineResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridcompute/v20250113:getMachine", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMachineOutput(ctx *pulumi.Context, args LookupMachineOutputArgs, opts ...pulumi.InvokeOption) LookupMachineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMachineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridcompute/v20250113:getMachine", args, LookupMachineResultOutput{}, options).(LookupMachineResultOutput), nil
...
// Specifies the identity key store a machine is using.
func (o LookupMachineResultOutput) IdentityKeyStore() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupMachineResult) *string { return v.IdentityKeyStore }).(pulumi.StringPtrOutput)
}
...
// Endorsement Key Certificate of the Trusted Platform Module (TPM) that the client provides to be used during initial resource onboarding.
func (o LookupMachineResultOutput) TpmEkCertificate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupMachineResult) *string { return v.TpmEkCertificate }).(pulumi.StringPtrOutput)
}
