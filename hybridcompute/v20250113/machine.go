...
type Machine struct {
	...
	IdentityKeyStore pulumi.StringPtrOutput `pulumi:"identityKeyStore"`
	...
	TpmEkCertificate pulumi.StringPtrOutput `pulumi:"tpmEkCertificate"`
...
func NewMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20250113:Machine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachine(ctx *pulumi.Context,
	...
	var resource Machine
	err := ctx.ReadResource("azure-native:hybridcompute/v20250113:Machine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type machineArgs struct {
	...
	// Specifies the identity key store a machine is using.
	IdentityKeyStore *string `pulumi:"identityKeyStore"`
	// Indicates which kind of Arc machine placement on-premises, such as HCI, SCVMM or VMware etc.
	...
	// Endorsement Key Certificate of the Trusted Platform Module (TPM) that the client provides to be used during initial resource onboarding.
	TpmEkCertificate *string `pulumi:"tpmEkCertificate"`
	// Specifies the hybrid machine unique ID.
...
type MachineArgs struct {
	...
	// Specifies the identity key store a machine is using.
	IdentityKeyStore pulumi.StringPtrInput
	// Indicates which kind of Arc machine placement on-premises, such as HCI, SCVMM or VMware etc.
	...
	// Endorsement Key Certificate of the Trusted Platform Module (TPM) that the client provides to be used during initial resource onboarding.
	TpmEkCertificate pulumi.StringPtrInput
	// Specifies the hybrid machine unique ID.
...
// Specifies the identity key store a machine is using.
func (o MachineOutput) IdentityKeyStore() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Machine) pulumi.StringPtrOutput { return v.IdentityKeyStore }).(pulumi.StringPtrOutput)
}
...
// Endorsement Key Certificate of the Trusted Platform Module (TPM) that the client provides to be used during initial resource onboarding.
func (o MachineOutput) TpmEkCertificate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Machine) pulumi.StringPtrOutput { return v.TpmEkCertificate }).(pulumi.StringPtrOutput)
}
