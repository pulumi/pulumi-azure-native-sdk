...
func (IdentityKeyStore) ElementType() reflect.Type {
	return reflect.TypeOf((*IdentityKeyStore)(nil)).Elem()
}

func (e IdentityKeyStore) ToIdentityKeyStoreOutput() IdentityKeyStoreOutput {
	return pulumi.ToOutput(e).(IdentityKeyStoreOutput)
}

func (e IdentityKeyStore) ToIdentityKeyStoreOutputWithContext(ctx context.Context) IdentityKeyStoreOutput {
	return pulumi.ToOutputWithContext(ctx, e).(IdentityKeyStoreOutput)
}

func (e IdentityKeyStore) ToIdentityKeyStorePtrOutput() IdentityKeyStorePtrOutput {
	return e.ToIdentityKeyStorePtrOutputWithContext(context.Background())
}

func (e IdentityKeyStore) ToIdentityKeyStorePtrOutputWithContext(ctx context.Context) IdentityKeyStorePtrOutput {
	return IdentityKeyStore(e).ToIdentityKeyStoreOutputWithContext(ctx).ToIdentityKeyStorePtrOutputWithContext(ctx)
}

func (e IdentityKeyStore) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e IdentityKeyStore) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e IdentityKeyStore) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e IdentityKeyStore) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type IdentityKeyStoreOutput struct{ *pulumi.OutputState }

func (IdentityKeyStoreOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*IdentityKeyStore)(nil)).Elem()
}

func (o IdentityKeyStoreOutput) ToIdentityKeyStoreOutput() IdentityKeyStoreOutput {
	return o
}

func (o IdentityKeyStoreOutput) ToIdentityKeyStoreOutputWithContext(ctx context.Context) IdentityKeyStoreOutput {
	return o
}

func (o IdentityKeyStoreOutput) ToIdentityKeyStorePtrOutput() IdentityKeyStorePtrOutput {
	return o.ToIdentityKeyStorePtrOutputWithContext(context.Background())
}

func (o IdentityKeyStoreOutput) ToIdentityKeyStorePtrOutputWithContext(ctx context.Context) IdentityKeyStorePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v IdentityKeyStore) *IdentityKeyStore {
		return &v
	}).(IdentityKeyStorePtrOutput)
}

func (o IdentityKeyStoreOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o IdentityKeyStoreOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e IdentityKeyStore) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o IdentityKeyStoreOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o IdentityKeyStoreOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e IdentityKeyStore) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type IdentityKeyStorePtrOutput struct{ *pulumi.OutputState }

func (IdentityKeyStorePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**IdentityKeyStore)(nil)).Elem()
}

func (o IdentityKeyStorePtrOutput) ToIdentityKeyStorePtrOutput() IdentityKeyStorePtrOutput {
	return o
}

func (o IdentityKeyStorePtrOutput) ToIdentityKeyStorePtrOutputWithContext(ctx context.Context) IdentityKeyStorePtrOutput {
	return o
}

func (o IdentityKeyStorePtrOutput) Elem() IdentityKeyStoreOutput {
	return o.ApplyT(func(v *IdentityKeyStore) IdentityKeyStore {
		if v != nil {
			return *v
		}
		var ret IdentityKeyStore
		return ret
	}).(IdentityKeyStoreOutput)
}

func (o IdentityKeyStorePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o IdentityKeyStorePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *IdentityKeyStore) *string {
		if e == nil {
			return nil
		}
...
// IdentityKeyStoreInput is an input type that accepts values of the IdentityKeyStore enum
// A concrete instance of `IdentityKeyStoreInput` can be one of the following:
//
//	IdentityKeyStoreTPM
//	IdentityKeyStoreDefault
type IdentityKeyStoreInput interface {
	pulumi.Input

	ToIdentityKeyStoreOutput() IdentityKeyStoreOutput
	ToIdentityKeyStoreOutputWithContext(context.Context) IdentityKeyStoreOutput
}

var identityKeyStorePtrType = reflect.TypeOf((**IdentityKeyStore)(nil)).Elem()

type IdentityKeyStorePtrInput interface {
	pulumi.Input

	ToIdentityKeyStorePtrOutput() IdentityKeyStorePtrOutput
	ToIdentityKeyStorePtrOutputWithContext(context.Context) IdentityKeyStorePtrOutput
}

type identityKeyStorePtr string

func IdentityKeyStorePtr(v string) IdentityKeyStorePtrInput {
	return (*identityKeyStorePtr)(&v)
}

func (*identityKeyStorePtr) ElementType() reflect.Type {
	return identityKeyStorePtrType
}

func (in *identityKeyStorePtr) ToIdentityKeyStorePtrOutput() IdentityKeyStorePtrOutput {
	return pulumi.ToOutput(in).(IdentityKeyStorePtrOutput)
}

func (in *identityKeyStorePtr) ToIdentityKeyStorePtrOutputWithContext(ctx context.Context) IdentityKeyStorePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(IdentityKeyStorePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(IdentityKeyStoreOutput{})
	pulumi.RegisterOutputType(IdentityKeyStorePtrOutput{})
