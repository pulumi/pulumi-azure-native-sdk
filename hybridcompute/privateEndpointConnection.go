...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:hybridcompute/v20250219preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:hybridcompute/v20250601:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:hybridcompute/v20250821preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:hybridcompute/v20250916preview:PrivateEndpointConnection"),
		},
	})
