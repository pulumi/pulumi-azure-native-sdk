...
type DiskResponse struct {
	...
	MaxSizeInBytes *float64 `pulumi:"maxSizeInBytes"`
...
// The type of the disk.
func (o DiskResponseOutput) DiskType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DiskResponse) *string { return v.DiskType }).(pulumi.StringPtrOutput)
}

// The generated ID of the disk.
func (o DiskResponseOutput) GeneratedId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DiskResponse) *string { return v.GeneratedId }).(pulumi.StringPtrOutput)
}

// The ID of the disk.
func (o DiskResponseOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DiskResponse) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// The size of the disk, in bytes
func (o DiskResponseOutput) MaxSizeInBytes() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v DiskResponse) *float64 { return v.MaxSizeInBytes }).(pulumi.Float64PtrOutput)
}
...
// The path of the disk.
func (o DiskResponseOutput) Path() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DiskResponse) *string { return v.Path }).(pulumi.StringPtrOutput)
}

// The amount of space used on the disk, in bytes
func (o DiskResponseOutput) UsedSpaceInBytes() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v DiskResponse) *float64 { return v.UsedSpaceInBytes }).(pulumi.Float64PtrOutput)
}
...
type FirmwareProfileResponse struct {
...
// Describes the firmware of the machine
type FirmwareProfileResponseOutput struct{ *pulumi.OutputState }

func (FirmwareProfileResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FirmwareProfileResponse)(nil)).Elem()
}

func (o FirmwareProfileResponseOutput) ToFirmwareProfileResponseOutput() FirmwareProfileResponseOutput {
	return o
}

func (o FirmwareProfileResponseOutput) ToFirmwareProfileResponseOutputWithContext(ctx context.Context) FirmwareProfileResponseOutput {
	return o
}

// The serial number of the firmware
func (o FirmwareProfileResponseOutput) SerialNumber() pulumi.StringOutput {
	return o.ApplyT(func(v FirmwareProfileResponse) string { return v.SerialNumber }).(pulumi.StringOutput)
}

// The type of the firmware
func (o FirmwareProfileResponseOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v FirmwareProfileResponse) string { return v.Type }).(pulumi.StringOutput)
}
...
type HardwareProfileResponse struct {
	...
	TotalPhysicalMemoryInBytes float64 `pulumi:"totalPhysicalMemoryInBytes"`
}
...
// The total number of CPU sockets available on the machine
func (o HardwareProfileResponseOutput) NumberOfCpuSockets() pulumi.IntOutput {
	return o.ApplyT(func(v HardwareProfileResponse) int { return v.NumberOfCpuSockets }).(pulumi.IntOutput)
}

// The physical processors of the machine.
func (o HardwareProfileResponseOutput) Processors() ProcessorResponseArrayOutput {
	return o.ApplyT(func(v HardwareProfileResponse) []ProcessorResponse { return v.Processors }).(ProcessorResponseArrayOutput)
}

// The total physical memory on the machine
func (o HardwareProfileResponseOutput) TotalPhysicalMemoryInBytes() pulumi.Float64Output {
	return o.ApplyT(func(v HardwareProfileResponse) float64 { return v.TotalPhysicalMemoryInBytes }).(pulumi.Float64Output)
}
...
// The total number of physical cores on the processor.
func (o ProcessorResponseOutput) NumberOfCores() pulumi.IntOutput {
	return o.ApplyT(func(v ProcessorResponse) int { return v.NumberOfCores }).(pulumi.IntOutput)
}
...
// The disks on the machine.
func (o StorageProfileResponseOutput) Disks() DiskResponseArrayOutput {
	return o.ApplyT(func(v StorageProfileResponse) []DiskResponse { return v.Disks }).(DiskResponseArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(FirmwareProfileResponseOutput{})
