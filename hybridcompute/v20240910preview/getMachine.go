...
func LookupMachine(ctx *pulumi.Context, args *LookupMachineArgs, opts ...pulumi.InvokeOption) (*LookupMachineResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridcompute/v20240910preview:getMachine", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupMachineResult struct {
	...
	FirmwareProfile FirmwareProfileResponse `pulumi:"firmwareProfile"`
...
func LookupMachineOutput(ctx *pulumi.Context, args LookupMachineOutputArgs, opts ...pulumi.InvokeOption) LookupMachineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMachineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridcompute/v20240910preview:getMachine", args, LookupMachineResultOutput{}, options).(LookupMachineResultOutput), nil
...
// Information about the machine's firmware
func (o LookupMachineResultOutput) FirmwareProfile() FirmwareProfileResponseOutput {
	return o.ApplyT(func(v LookupMachineResult) FirmwareProfileResponse { return v.FirmwareProfile }).(FirmwareProfileResponseOutput)
}

// Information about the machine's hardware
func (o LookupMachineResultOutput) HardwareProfile() HardwareProfileResponseOutput {
	return o.ApplyT(func(v LookupMachineResult) HardwareProfileResponse { return v.HardwareProfile }).(HardwareProfileResponseOutput)
}
...
// Information about the machine's storage
func (o LookupMachineResultOutput) StorageProfile() StorageProfileResponseOutput {
	return o.ApplyT(func(v LookupMachineResult) StorageProfileResponse { return v.StorageProfile }).(StorageProfileResponseOutput)
}
