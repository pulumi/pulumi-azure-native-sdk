...
//
// Deprecated: azure-native:hybridcompute/v20211210preview:PrivateLinkScope is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20221227preview:PrivateLinkScope to guarantee forwards compatibility.
...
func NewPrivateLinkScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20211210preview:PrivateLinkScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkScope(ctx *pulumi.Context,
	...
	var resource PrivateLinkScope
	err := ctx.ReadResource("azure-native:hybridcompute/v20211210preview:PrivateLinkScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
