...
//
// Deprecated: azure-native:hybridcompute/v20210422preview:Machine is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20220510preview:Machine to guarantee forwards compatibility.
