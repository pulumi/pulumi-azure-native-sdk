...
//
// Deprecated: azure-native:hybridcompute/v20221227preview:MachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20230425preview:MachineExtension to guarantee forwards compatibility.
func LookupMachineExtension(ctx *pulumi.Context, args *LookupMachineExtensionArgs, opts ...pulumi.InvokeOption) (*LookupMachineExtensionResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridcompute/v20221227preview:getMachineExtension", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
