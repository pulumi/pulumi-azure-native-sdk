...
func NewMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20230620preview:Machine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachine(ctx *pulumi.Context,
	...
	var resource Machine
	err := ctx.ReadResource("azure-native:hybridcompute/v20230620preview:Machine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
