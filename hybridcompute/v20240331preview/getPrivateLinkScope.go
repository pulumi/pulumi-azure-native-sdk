...
func LookupPrivateLinkScope(ctx *pulumi.Context, args *LookupPrivateLinkScopeArgs, opts ...pulumi.InvokeOption) (*LookupPrivateLinkScopeResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridcompute/v20240331preview:getPrivateLinkScope", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateLinkScopeOutput(ctx *pulumi.Context, args LookupPrivateLinkScopeOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateLinkScopeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateLinkScopeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridcompute/v20240331preview:getPrivateLinkScope", args, LookupPrivateLinkScopeResultOutput{}, options).(LookupPrivateLinkScopeResultOutput), nil
