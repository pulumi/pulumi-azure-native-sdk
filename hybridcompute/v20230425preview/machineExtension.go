...
func NewMachineExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20230425preview:MachineExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineExtension(ctx *pulumi.Context,
	...
	var resource MachineExtension
	err := ctx.ReadResource("azure-native:hybridcompute/v20230425preview:MachineExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
