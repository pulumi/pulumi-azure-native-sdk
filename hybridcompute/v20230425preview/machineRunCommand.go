...
func NewMachineRunCommand(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20230425preview:MachineRunCommand", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineRunCommand(ctx *pulumi.Context,
	...
	var resource MachineRunCommand
	err := ctx.ReadResource("azure-native:hybridcompute/v20230425preview:MachineRunCommand", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
