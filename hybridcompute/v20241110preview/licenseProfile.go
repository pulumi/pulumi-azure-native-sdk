...
func NewLicenseProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20241110preview:LicenseProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLicenseProfile(ctx *pulumi.Context,
	...
	var resource LicenseProfile
	err := ctx.ReadResource("azure-native:hybridcompute/v20241110preview:LicenseProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
