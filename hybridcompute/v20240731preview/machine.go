...
type Machine struct {
	...
	FirmwareProfile FirmwareProfileResponseOutput `pulumi:"firmwareProfile"`
	// Information about the machine's hardware
	HardwareProfile HardwareProfileResponseOutput `pulumi:"hardwareProfile"`
...
func NewMachine(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:hybridcompute/v20240710:Machine"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20240731preview:Machine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachine(ctx *pulumi.Context,
	...
	var resource Machine
	err := ctx.ReadResource("azure-native:hybridcompute/v20240731preview:Machine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Information about the machine's firmware
func (o MachineOutput) FirmwareProfile() FirmwareProfileResponseOutput {
	return o.ApplyT(func(v *Machine) FirmwareProfileResponseOutput { return v.FirmwareProfile }).(FirmwareProfileResponseOutput)
}

// Information about the machine's hardware
func (o MachineOutput) HardwareProfile() HardwareProfileResponseOutput {
	return o.ApplyT(func(v *Machine) HardwareProfileResponseOutput { return v.HardwareProfile }).(HardwareProfileResponseOutput)
}
...
// Information about the machine's storage
func (o MachineOutput) StorageProfile() StorageProfileResponseOutput {
	return o.ApplyT(func(v *Machine) StorageProfileResponseOutput { return v.StorageProfile }).(StorageProfileResponseOutput)
}
