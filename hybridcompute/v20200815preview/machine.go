...
func NewMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20200815preview:Machine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachine(ctx *pulumi.Context,
	...
	var resource Machine
	err := ctx.ReadResource("azure-native:hybridcompute/v20200815preview:Machine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// List of private link scoped resources associated with this machine.
func (o MachineOutput) PrivateLinkScopedResources() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Machine) pulumi.StringArrayOutput { return v.PrivateLinkScopedResources }).(pulumi.StringArrayOutput)
}
