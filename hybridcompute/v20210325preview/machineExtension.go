...
//
// Deprecated: azure-native:hybridcompute/v20210325preview:MachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20220510preview:MachineExtension to guarantee forwards compatibility.
...
func NewMachineExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20210325preview:MachineExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineExtension(ctx *pulumi.Context,
	...
	var resource MachineExtension
	err := ctx.ReadResource("azure-native:hybridcompute/v20210325preview:MachineExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
