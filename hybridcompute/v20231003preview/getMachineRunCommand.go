...
func (o LookupMachineRunCommandResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupMachineRunCommandResult] {
	return pulumix.Output[LookupMachineRunCommandResult]{
