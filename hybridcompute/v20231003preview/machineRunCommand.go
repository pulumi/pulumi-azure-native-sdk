...
func NewMachineRunCommand(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20231003preview:MachineRunCommand", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineRunCommand(ctx *pulumi.Context,
	...
	var resource MachineRunCommand
	err := ctx.ReadResource("azure-native:hybridcompute/v20231003preview:MachineRunCommand", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *MachineRunCommand) ToOutput(ctx context.Context) pulumix.Output[*MachineRunCommand] {
	return pulumix.Output[*MachineRunCommand]{
		OutputState: i.ToMachineRunCommandOutputWithContext(ctx).OutputState,
	}
}
...
func (o MachineRunCommandOutput) ToOutput(ctx context.Context) pulumix.Output[*MachineRunCommand] {
	return pulumix.Output[*MachineRunCommand]{
