...
func NewLicense(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:hybridcompute/v20240731preview:License"),
		},
		{
			Type: pulumi.String("azure-native:hybridcompute/v20240910preview:License"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:hybridcompute/v20240520preview:License", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLicense(ctx *pulumi.Context,
	...
	var resource License
	err := ctx.ReadResource("azure-native:hybridcompute/v20240520preview:License", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
