...
func LookupTrigger(ctx *pulumi.Context, args *LookupTriggerArgs, opts ...pulumi.InvokeOption) (*LookupTriggerResult, error) {
	...
	err := ctx.Invoke("azure-native:virtualmachineimages/v20220701:getTrigger", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTriggerOutput(ctx *pulumi.Context, args LookupTriggerOutputArgs, opts ...pulumi.InvokeOption) LookupTriggerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTriggerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:virtualmachineimages/v20220701:getTrigger", args, LookupTriggerResultOutput{}, options).(LookupTriggerResultOutput), nil
