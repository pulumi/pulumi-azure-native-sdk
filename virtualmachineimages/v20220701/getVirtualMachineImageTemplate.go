...
func LookupVirtualMachineImageTemplate(ctx *pulumi.Context, args *LookupVirtualMachineImageTemplateArgs, opts ...pulumi.InvokeOption) (*LookupVirtualMachineImageTemplateResult, error) {
	...
	err := ctx.Invoke("azure-native:virtualmachineimages/v20220701:getVirtualMachineImageTemplate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupVirtualMachineImageTemplateOutput(ctx *pulumi.Context, args LookupVirtualMachineImageTemplateOutputArgs, opts ...pulumi.InvokeOption) LookupVirtualMachineImageTemplateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVirtualMachineImageTemplateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:virtualmachineimages/v20220701:getVirtualMachineImageTemplate", args, LookupVirtualMachineImageTemplateResultOutput{}, options).(LookupVirtualMachineImageTemplateResultOutput), nil
