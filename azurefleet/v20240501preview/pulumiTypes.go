...
// If not specified, defaults to 1, which represents "Max Spreading" (using as many fault domains as possible).
// This property cannot be updated.
func (o ComputeProfileOutput) PlatformFaultDomainCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ComputeProfile) *int { return v.PlatformFaultDomainCount }).(pulumi.IntPtrOutput)
}
...
// If not specified, defaults to 1, which represents "Max Spreading" (using as many fault domains as possible).
// This property cannot be updated.
func (o ComputeProfileResponseOutput) PlatformFaultDomainCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ComputeProfileResponse) *int { return v.PlatformFaultDomainCount }).(pulumi.IntPtrOutput)
}
...
type SpotPriorityProfileArgs struct {
	...
	// or update existing VMs with new VM sizes (if VMs are evicted deallocated or failed to allocate due to capacity constraint) in order to achieve the desired capacity.
	// Maintain is enabled by default.
	Maintain pulumi.BoolPtrInput `pulumi:"maintain"`
	// Price per hour of each Spot VM will never exceed this.
...
// or update existing VMs with new VM sizes (if VMs are evicted deallocated or failed to allocate due to capacity constraint) in order to achieve the desired capacity.
// Maintain is enabled by default.
func (o SpotPriorityProfileOutput) Maintain() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SpotPriorityProfile) *bool { return v.Maintain }).(pulumi.BoolPtrOutput)
}
...
// or update existing VMs with new VM sizes (if VMs are evicted deallocated or failed to allocate due to capacity constraint) in order to achieve the desired capacity.
// Maintain is enabled by default.
func (o SpotPriorityProfilePtrOutput) Maintain() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *SpotPriorityProfile) *bool {
		if v == nil {
			return nil
		}
		return v.Maintain
...
// or update existing VMs with new VM sizes (if VMs are evicted deallocated or failed to allocate due to capacity constraint) in order to achieve the desired capacity.
// Maintain is enabled by default.
func (o SpotPriorityProfileResponseOutput) Maintain() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SpotPriorityProfileResponse) *bool { return v.Maintain }).(pulumi.BoolPtrOutput)
}
...
// or update existing VMs with new VM sizes (if VMs are evicted deallocated or failed to allocate due to capacity constraint) in order to achieve the desired capacity.
// Maintain is enabled by default.
func (o SpotPriorityProfileResponsePtrOutput) Maintain() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *SpotPriorityProfileResponse) *bool {
		if v == nil {
			return nil
		}
		return v.Maintain
...
// The rank of the VM size. This is used with 'RegularPriorityAllocationStrategy.Prioritized'
// The lower the number, the higher the priority. Starting with 0.
func (o VmSizeProfileOutput) Rank() pulumi.IntPtrOutput {
	return o.ApplyT(func(v VmSizeProfile) *int { return v.Rank }).(pulumi.IntPtrOutput)
}
...
// The rank of the VM size. This is used with 'RegularPriorityAllocationStrategy.Prioritized'
// The lower the number, the higher the priority. Starting with 0.
func (o VmSizeProfileResponseOutput) Rank() pulumi.IntPtrOutput {
	return o.ApplyT(func(v VmSizeProfileResponse) *int { return v.Rank }).(pulumi.IntPtrOutput)
}
