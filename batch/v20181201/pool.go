...
// azure-native:batch/v20181201:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20200501:Pool to guarantee forwards compatibility.
type Pool struct {
...
func NewPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.RegisterResource("azure-native:batch/v20181201:Pool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("azure-native:batch/v20181201:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
