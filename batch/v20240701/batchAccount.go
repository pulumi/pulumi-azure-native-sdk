...
func NewBatchAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:batch/v20240701:BatchAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBatchAccount(ctx *pulumi.Context,
	...
	var resource BatchAccount
	err := ctx.ReadResource("azure-native:batch/v20240701:BatchAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
