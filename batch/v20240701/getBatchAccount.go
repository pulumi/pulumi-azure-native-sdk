...
func LookupBatchAccount(ctx *pulumi.Context, args *LookupBatchAccountArgs, opts ...pulumi.InvokeOption) (*LookupBatchAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:batch/v20240701:getBatchAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupBatchAccountOutput(ctx *pulumi.Context, args LookupBatchAccountOutputArgs, opts ...pulumi.InvokeOption) LookupBatchAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBatchAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:batch/v20240701:getBatchAccount", args, LookupBatchAccountResultOutput{}, options).(LookupBatchAccountResultOutput), nil
