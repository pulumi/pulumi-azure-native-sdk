...
func NewPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.RegisterResource("azure-native:batch/v20220601:Pool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("azure-native:batch/v20220601:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
