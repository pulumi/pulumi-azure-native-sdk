...
func ListBatchAccountKeys(ctx *pulumi.Context, args *ListBatchAccountKeysArgs, opts ...pulumi.InvokeOption) (*ListBatchAccountKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:batch/v20220101:listBatchAccountKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListBatchAccountKeysOutput(ctx *pulumi.Context, args ListBatchAccountKeysOutputArgs, opts ...pulumi.InvokeOption) ListBatchAccountKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListBatchAccountKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:batch/v20220101:listBatchAccountKeys", args, ListBatchAccountKeysResultOutput{}, options).(ListBatchAccountKeysResultOutput), nil
