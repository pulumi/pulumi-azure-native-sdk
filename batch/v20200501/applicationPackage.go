...
// azure-native:batch/v20200501:ApplicationPackage is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20230501:ApplicationPackage to guarantee forwards compatibility.
...
func NewApplicationPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:batch/v20200501:ApplicationPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationPackage(ctx *pulumi.Context,
	...
	var resource ApplicationPackage
	err := ctx.ReadResource("azure-native:batch/v20200501:ApplicationPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
