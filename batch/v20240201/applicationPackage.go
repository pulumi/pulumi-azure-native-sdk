...
func NewApplicationPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:batch/v20240201:ApplicationPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationPackage(ctx *pulumi.Context,
	...
	var resource ApplicationPackage
	err := ctx.ReadResource("azure-native:batch/v20240201:ApplicationPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
