...
func NewApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:batch/v20231101:Application", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplication(ctx *pulumi.Context,
	...
	var resource Application
	err := ctx.ReadResource("azure-native:batch/v20231101:Application", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
