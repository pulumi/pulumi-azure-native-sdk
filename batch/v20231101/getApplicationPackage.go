...
func LookupApplicationPackage(ctx *pulumi.Context, args *LookupApplicationPackageArgs, opts ...pulumi.InvokeOption) (*LookupApplicationPackageResult, error) {
	...
	err := ctx.Invoke("azure-native:batch/v20231101:getApplicationPackage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApplicationPackageOutput(ctx *pulumi.Context, args LookupApplicationPackageOutputArgs, opts ...pulumi.InvokeOption) LookupApplicationPackageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApplicationPackageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:batch/v20231101:getApplicationPackage", args, LookupApplicationPackageResultOutput{}, options).(LookupApplicationPackageResultOutput), nil
