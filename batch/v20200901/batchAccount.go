...
// azure-native:batch/v20200901:BatchAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20220101:BatchAccount to guarantee forwards compatibility.
...
func NewBatchAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:batch/v20200901:BatchAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBatchAccount(ctx *pulumi.Context,
	...
	var resource BatchAccount
	err := ctx.ReadResource("azure-native:batch/v20200901:BatchAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
