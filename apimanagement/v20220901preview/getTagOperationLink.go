...
func (o LookupTagOperationLinkResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTagOperationLinkResult] {
	return pulumix.Output[LookupTagOperationLinkResult]{
