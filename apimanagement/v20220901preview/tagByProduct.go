...
func NewTagByProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220901preview:TagByProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByProduct(ctx *pulumi.Context,
	...
	var resource TagByProduct
	err := ctx.ReadResource("azure-native:apimanagement/v20220901preview:TagByProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *TagByProduct) ToOutput(ctx context.Context) pulumix.Output[*TagByProduct] {
	return pulumix.Output[*TagByProduct]{
		OutputState: i.ToTagByProductOutputWithContext(ctx).OutputState,
	}
}
...
func (o TagByProductOutput) ToOutput(ctx context.Context) pulumix.Output[*TagByProduct] {
	return pulumix.Output[*TagByProduct]{
