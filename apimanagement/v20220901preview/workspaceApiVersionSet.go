...
func NewWorkspaceApiVersionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220901preview:WorkspaceApiVersionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiVersionSet(ctx *pulumi.Context,
	...
	var resource WorkspaceApiVersionSet
	err := ctx.ReadResource("azure-native:apimanagement/v20220901preview:WorkspaceApiVersionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
