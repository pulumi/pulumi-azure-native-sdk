...
func NewProductApiLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220901preview:ProductApiLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductApiLink(ctx *pulumi.Context,
	...
	var resource ProductApiLink
	err := ctx.ReadResource("azure-native:apimanagement/v20220901preview:ProductApiLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
