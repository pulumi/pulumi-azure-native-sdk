...
func LookupApiManagementService(ctx *pulumi.Context, args *LookupApiManagementServiceArgs, opts ...pulumi.InvokeOption) (*LookupApiManagementServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20220901preview:getApiManagementService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupApiManagementServiceOutput(ctx *pulumi.Context, args LookupApiManagementServiceOutputArgs, opts ...pulumi.InvokeOption) LookupApiManagementServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiManagementServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20220901preview:getApiManagementService", args, LookupApiManagementServiceResultOutput{}, options).(LookupApiManagementServiceResultOutput), nil
