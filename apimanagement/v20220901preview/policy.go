...
func NewPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.RegisterResource("azure-native:apimanagement/v20220901preview:Policy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.ReadResource("azure-native:apimanagement/v20220901preview:Policy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
