...
func LookupWorkspaceApi(ctx *pulumi.Context, args *LookupWorkspaceApiArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceApiResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20220901preview:getWorkspaceApi", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceApiOutput(ctx *pulumi.Context, args LookupWorkspaceApiOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceApiResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceApiResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20220901preview:getWorkspaceApi", args, LookupWorkspaceApiResultOutput{}, options).(LookupWorkspaceApiResultOutput), nil
