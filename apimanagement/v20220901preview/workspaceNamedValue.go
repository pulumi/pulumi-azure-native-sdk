...
func NewWorkspaceNamedValue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220901preview:WorkspaceNamedValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceNamedValue(ctx *pulumi.Context,
	...
	var resource WorkspaceNamedValue
	err := ctx.ReadResource("azure-native:apimanagement/v20220901preview:WorkspaceNamedValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
