...
func LookupAuthorizationAccessPolicy(ctx *pulumi.Context, args *LookupAuthorizationAccessPolicyArgs, opts ...pulumi.InvokeOption) (*LookupAuthorizationAccessPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20220901preview:getAuthorizationAccessPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAuthorizationAccessPolicyOutput(ctx *pulumi.Context, args LookupAuthorizationAccessPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupAuthorizationAccessPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAuthorizationAccessPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20220901preview:getAuthorizationAccessPolicy", args, LookupAuthorizationAccessPolicyResultOutput{}, options).(LookupAuthorizationAccessPolicyResultOutput), nil
