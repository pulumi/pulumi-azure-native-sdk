...
func NewWorkspaceGroupUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220901preview:WorkspaceGroupUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceGroupUser(ctx *pulumi.Context,
	...
	var resource WorkspaceGroupUser
	err := ctx.ReadResource("azure-native:apimanagement/v20220901preview:WorkspaceGroupUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
