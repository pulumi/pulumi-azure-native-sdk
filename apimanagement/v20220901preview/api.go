...
func NewApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.RegisterResource("azure-native:apimanagement/v20220901preview:Api", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.ReadResource("azure-native:apimanagement/v20220901preview:Api", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
