...
func NewPrivateEndpointConnectionByName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:PrivateEndpointConnectionByName"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:PrivateEndpointConnectionByName"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220901preview:PrivateEndpointConnectionByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionByName(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionByName
	err := ctx.ReadResource("azure-native:apimanagement/v20220901preview:PrivateEndpointConnectionByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
