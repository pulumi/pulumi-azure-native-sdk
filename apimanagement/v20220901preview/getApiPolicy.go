...
func LookupApiPolicy(ctx *pulumi.Context, args *LookupApiPolicyArgs, opts ...pulumi.InvokeOption) (*LookupApiPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20220901preview:getApiPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (o LookupApiPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupApiPolicyResult] {
	return pulumix.Output[LookupApiPolicyResult]{
