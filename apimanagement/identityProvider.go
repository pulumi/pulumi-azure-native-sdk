...
//
// Other available API versions: 2016-07-07, 2016-10-10, 2019-01-01, 2022-09-01-preview, 2023-03-01-preview, 2023-05-01-preview, 2023-09-01-preview, 2024-05-01, 2024-06-01-preview.
...
func NewIdentityProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:IdentityProvider"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:IdentityProvider"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:IdentityProvider"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement:IdentityProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityProvider(ctx *pulumi.Context,
	...
	var resource IdentityProvider
	err := ctx.ReadResource("azure-native:apimanagement:IdentityProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
