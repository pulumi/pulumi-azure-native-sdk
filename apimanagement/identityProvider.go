...
func NewIdentityProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:IdentityProvider"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:IdentityProvider"),
		},
	})
