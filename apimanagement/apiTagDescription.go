...
func NewApiTagDescription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:ApiTagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ApiTagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ApiTagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:ApiTagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ApiTagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiTagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ApiTagDescription"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApiTagDescription
	err := ctx.RegisterResource("azure-native:apimanagement:ApiTagDescription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiTagDescription(ctx *pulumi.Context,
	...
	var resource ApiTagDescription
	err := ctx.ReadResource("azure-native:apimanagement:ApiTagDescription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
