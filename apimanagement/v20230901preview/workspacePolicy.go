...
func NewWorkspacePolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:WorkspacePolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:WorkspacePolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspacePolicy
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:WorkspacePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspacePolicy(ctx *pulumi.Context,
	...
	var resource WorkspacePolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:WorkspacePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
