...
func NewWorkspaceBackend(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:WorkspaceBackend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceBackend(ctx *pulumi.Context,
	...
	var resource WorkspaceBackend
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:WorkspaceBackend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
