...
func LookupWorkspaceTagApiLink(ctx *pulumi.Context, args *LookupWorkspaceTagApiLinkArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceTagApiLinkResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230901preview:getWorkspaceTagApiLink", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceTagApiLinkOutput(ctx *pulumi.Context, args LookupWorkspaceTagApiLinkOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceTagApiLinkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceTagApiLinkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230901preview:getWorkspaceTagApiLink", args, LookupWorkspaceTagApiLinkResultOutput{}, options).(LookupWorkspaceTagApiLinkResultOutput), nil
