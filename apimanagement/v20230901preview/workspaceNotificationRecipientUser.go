...
func NewWorkspaceNotificationRecipientUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:WorkspaceNotificationRecipientUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceNotificationRecipientUser(ctx *pulumi.Context,
	...
	var resource WorkspaceNotificationRecipientUser
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:WorkspaceNotificationRecipientUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
