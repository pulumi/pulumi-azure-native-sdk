...
func ListNamedValue(ctx *pulumi.Context, args *ListNamedValueArgs, opts ...pulumi.InvokeOption) (*ListNamedValueResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230901preview:listNamedValue", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListNamedValueOutput(ctx *pulumi.Context, args ListNamedValueOutputArgs, opts ...pulumi.InvokeOption) ListNamedValueResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListNamedValueResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230901preview:listNamedValue", args, ListNamedValueResultOutput{}, options).(ListNamedValueResultOutput), nil
