...
func NewEmailTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:EmailTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmailTemplate(ctx *pulumi.Context,
	...
	var resource EmailTemplate
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:EmailTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
