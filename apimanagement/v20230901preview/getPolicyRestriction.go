...
func LookupPolicyRestriction(ctx *pulumi.Context, args *LookupPolicyRestrictionArgs, opts ...pulumi.InvokeOption) (*LookupPolicyRestrictionResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230901preview:getPolicyRestriction", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupPolicyRestrictionOutput(ctx *pulumi.Context, args LookupPolicyRestrictionOutputArgs, opts ...pulumi.InvokeOption) LookupPolicyRestrictionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPolicyRestrictionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230901preview:getPolicyRestriction", args, LookupPolicyRestrictionResultOutput{}, options).(LookupPolicyRestrictionResultOutput), nil
