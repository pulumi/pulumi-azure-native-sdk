...
func NewWorkspaceTagApiLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:WorkspaceTagApiLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceTagApiLink(ctx *pulumi.Context,
	...
	var resource WorkspaceTagApiLink
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:WorkspaceTagApiLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
