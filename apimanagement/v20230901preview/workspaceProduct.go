...
func NewWorkspaceProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:WorkspaceProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceProduct(ctx *pulumi.Context,
	...
	var resource WorkspaceProduct
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:WorkspaceProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
