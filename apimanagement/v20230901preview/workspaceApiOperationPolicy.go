...
func NewWorkspaceApiOperationPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:apimanagement:WorkspaceApiOperationPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:WorkspaceApiOperationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiOperationPolicy(ctx *pulumi.Context,
	...
	var resource WorkspaceApiOperationPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:WorkspaceApiOperationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
