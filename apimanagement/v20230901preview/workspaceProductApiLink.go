...
func NewWorkspaceProductApiLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:WorkspaceProductApiLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceProductApiLink(ctx *pulumi.Context,
	...
	var resource WorkspaceProductApiLink
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:WorkspaceProductApiLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
