...
func NewApiVersionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:ApiVersionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiVersionSet(ctx *pulumi.Context,
	...
	var resource ApiVersionSet
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:ApiVersionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
