...
func NewTag(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:Tag"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:Tag"),
		},
		{
	...
	var resource Tag
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:Tag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:Tag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
