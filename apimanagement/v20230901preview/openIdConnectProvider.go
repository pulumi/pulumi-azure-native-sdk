...
func NewOpenIdConnectProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:OpenIdConnectProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenIdConnectProvider(ctx *pulumi.Context,
	...
	var resource OpenIdConnectProvider
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:OpenIdConnectProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
