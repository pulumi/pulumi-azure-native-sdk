...
func NewWorkspaceProductGroupLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230901preview:WorkspaceProductGroupLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceProductGroupLink(ctx *pulumi.Context,
	...
	var resource WorkspaceProductGroupLink
	err := ctx.ReadResource("azure-native:apimanagement/v20230901preview:WorkspaceProductGroupLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
