...
func LookupNamedValue(ctx *pulumi.Context, args *LookupNamedValueArgs, opts ...pulumi.InvokeOption) (*LookupNamedValueResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230901preview:getNamedValue", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupNamedValueOutput(ctx *pulumi.Context, args LookupNamedValueOutputArgs, opts ...pulumi.InvokeOption) LookupNamedValueResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNamedValueResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230901preview:getNamedValue", args, LookupNamedValueResultOutput{}, options).(LookupNamedValueResultOutput), nil
