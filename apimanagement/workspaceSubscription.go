...
func NewWorkspaceSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceSubscription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceSubscription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceSubscription"),
		},
	})
