...
func NewWorkspaceTag(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceTag"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceTag"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceTag"),
		},
	})
...
// The Azure API version of the resource.
func (o WorkspaceTagOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkspaceTag) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
