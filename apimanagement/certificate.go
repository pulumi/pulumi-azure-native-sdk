...
func NewCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:Certificate"),
		},
	})
