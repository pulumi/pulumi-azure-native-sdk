...
// Backend details.
//
// Deprecated: azure-native:apimanagement/v20190101:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Backend to guarantee forwards compatibility.
type Backend struct {
...
func NewBackend(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20190101:Backend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackend(ctx *pulumi.Context,
	...
	var resource Backend
	err := ctx.ReadResource("azure-native:apimanagement/v20190101:Backend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
