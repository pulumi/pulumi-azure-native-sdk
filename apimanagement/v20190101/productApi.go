...
func NewProductApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20190101:ProductApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductApi(ctx *pulumi.Context,
	...
	var resource ProductApi
	err := ctx.ReadResource("azure-native:apimanagement/v20190101:ProductApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
