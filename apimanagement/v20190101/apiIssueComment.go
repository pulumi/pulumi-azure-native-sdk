...
//
// Deprecated: azure-native:apimanagement/v20190101:ApiIssueComment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssueComment to guarantee forwards compatibility.
...
func NewApiIssueComment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20190101:ApiIssueComment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssueComment(ctx *pulumi.Context,
	...
	var resource ApiIssueComment
	err := ctx.ReadResource("azure-native:apimanagement/v20190101:ApiIssueComment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
