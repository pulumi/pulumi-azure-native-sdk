...
func LookupApiDiagnostic(ctx *pulumi.Context, args *LookupApiDiagnosticArgs, opts ...pulumi.InvokeOption) (*LookupApiDiagnosticResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20190101:getApiDiagnostic", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiDiagnosticOutput(ctx *pulumi.Context, args LookupApiDiagnosticOutputArgs, opts ...pulumi.InvokeOption) LookupApiDiagnosticResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupApiDiagnosticResultOutput, error) {
			args := v.(LookupApiDiagnosticArgs)
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv LookupApiDiagnosticResult
			secret, err := ctx.InvokePackageRaw("azure-native:apimanagement/v20190101:getApiDiagnostic", args, &rv, "", opts...)
			if err != nil {
				return LookupApiDiagnosticResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupApiDiagnosticResultOutput)
			if secret {
				return pulumi.ToSecret(output).(LookupApiDiagnosticResultOutput), nil
			}
			return output, nil
...
// Whether to process Correlation Headers coming to Api Management Service. Only applicable to Application Insights diagnostics. Default is true.
func (o LookupApiDiagnosticResultOutput) EnableHttpCorrelationHeaders() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupApiDiagnosticResult) *bool { return v.EnableHttpCorrelationHeaders }).(pulumi.BoolPtrOutput)
}
