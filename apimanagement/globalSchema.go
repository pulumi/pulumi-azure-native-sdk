...
func NewGlobalSchema(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20211201preview:GlobalSchema"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:GlobalSchema"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement:GlobalSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalSchema(ctx *pulumi.Context,
	...
	var resource GlobalSchema
	err := ctx.ReadResource("azure-native:apimanagement:GlobalSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
