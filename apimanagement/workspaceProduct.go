...
func NewWorkspaceProduct(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceProduct"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceProduct"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceProduct"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceProduct
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceProduct(ctx *pulumi.Context,
	...
	var resource WorkspaceProduct
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WorkspaceProductOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkspaceProduct) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
