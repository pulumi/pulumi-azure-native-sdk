...
func NewTagProductLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:TagProductLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:TagProductLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:TagProductLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:TagProductLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:TagProductLink"),
		},
	})
...
// The Azure API version of the resource.
func (o TagProductLinkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TagProductLink) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
