...
func NewWorkspaceSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:WorkspaceSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceSubscription(ctx *pulumi.Context,
	...
	var resource WorkspaceSubscription
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:WorkspaceSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
