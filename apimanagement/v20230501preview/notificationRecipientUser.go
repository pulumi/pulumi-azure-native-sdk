...
func NewNotificationRecipientUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:NotificationRecipientUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationRecipientUser(ctx *pulumi.Context,
	...
	var resource NotificationRecipientUser
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:NotificationRecipientUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
