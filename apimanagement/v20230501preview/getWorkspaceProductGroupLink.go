...
func LookupWorkspaceProductGroupLink(ctx *pulumi.Context, args *LookupWorkspaceProductGroupLinkArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceProductGroupLinkResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230501preview:getWorkspaceProductGroupLink", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceProductGroupLinkOutput(ctx *pulumi.Context, args LookupWorkspaceProductGroupLinkOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceProductGroupLinkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceProductGroupLinkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230501preview:getWorkspaceProductGroupLink", args, LookupWorkspaceProductGroupLinkResultOutput{}, options).(LookupWorkspaceProductGroupLinkResultOutput), nil
