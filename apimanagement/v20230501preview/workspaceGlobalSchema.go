...
func NewWorkspaceGlobalSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:WorkspaceGlobalSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceGlobalSchema(ctx *pulumi.Context,
	...
	var resource WorkspaceGlobalSchema
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:WorkspaceGlobalSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
