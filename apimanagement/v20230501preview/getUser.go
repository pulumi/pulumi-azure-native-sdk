...
func LookupUser(ctx *pulumi.Context, args *LookupUserArgs, opts ...pulumi.InvokeOption) (*LookupUserResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230501preview:getUser", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupUserOutput(ctx *pulumi.Context, args LookupUserOutputArgs, opts ...pulumi.InvokeOption) LookupUserResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUserResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230501preview:getUser", args, LookupUserResultOutput{}, options).(LookupUserResultOutput), nil
