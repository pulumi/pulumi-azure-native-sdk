...
func NewApiIssue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:ApiIssue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssue(ctx *pulumi.Context,
	...
	var resource ApiIssue
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:ApiIssue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
