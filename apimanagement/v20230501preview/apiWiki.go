...
func NewApiWiki(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:ApiWiki", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiWiki(ctx *pulumi.Context,
	...
	var resource ApiWiki
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:ApiWiki", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
