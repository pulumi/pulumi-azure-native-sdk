...
func NewWorkspaceProductPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:WorkspaceProductPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceProductPolicy(ctx *pulumi.Context,
	...
	var resource WorkspaceProductPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:WorkspaceProductPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
