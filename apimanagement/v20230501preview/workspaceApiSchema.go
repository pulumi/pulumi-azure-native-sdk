...
func NewWorkspaceApiSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:WorkspaceApiSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiSchema(ctx *pulumi.Context,
	...
	var resource WorkspaceApiSchema
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:WorkspaceApiSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
