...
func NewGraphQLApiResolver(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:GraphQLApiResolver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGraphQLApiResolver(ctx *pulumi.Context,
	...
	var resource GraphQLApiResolver
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:GraphQLApiResolver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
