...
func NewWorkspaceApi(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:WorkspaceApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:WorkspaceApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:WorkspaceApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement:WorkspaceApi"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceApi
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:WorkspaceApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApi(ctx *pulumi.Context,
	...
	var resource WorkspaceApi
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:WorkspaceApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
