...
func LookupWorkspaceGroup(ctx *pulumi.Context, args *LookupWorkspaceGroupArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230501preview:getWorkspaceGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceGroupOutput(ctx *pulumi.Context, args LookupWorkspaceGroupOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230501preview:getWorkspaceGroup", args, LookupWorkspaceGroupResultOutput{}, options).(LookupWorkspaceGroupResultOutput), nil
