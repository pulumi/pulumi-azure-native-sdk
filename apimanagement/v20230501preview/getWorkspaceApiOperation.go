...
func LookupWorkspaceApiOperation(ctx *pulumi.Context, args *LookupWorkspaceApiOperationArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceApiOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230501preview:getWorkspaceApiOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceApiOperationOutput(ctx *pulumi.Context, args LookupWorkspaceApiOperationOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceApiOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceApiOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230501preview:getWorkspaceApiOperation", args, LookupWorkspaceApiOperationResultOutput{}, options).(LookupWorkspaceApiOperationResultOutput), nil
