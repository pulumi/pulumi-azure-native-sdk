...
func NewGroupUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230301preview:GroupUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:GroupUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:GroupUser"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:GroupUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupUser(ctx *pulumi.Context,
	...
	var resource GroupUser
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:GroupUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
