...
func NewProductGroupLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:ProductGroupLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductGroupLink(ctx *pulumi.Context,
	...
	var resource ProductGroupLink
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:ProductGroupLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
