...
func NewWorkspaceTag(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:WorkspaceTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceTag(ctx *pulumi.Context,
	...
	var resource WorkspaceTag
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:WorkspaceTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
