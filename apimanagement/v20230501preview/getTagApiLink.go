...
func LookupTagApiLink(ctx *pulumi.Context, args *LookupTagApiLinkArgs, opts ...pulumi.InvokeOption) (*LookupTagApiLinkResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230501preview:getTagApiLink", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTagApiLinkOutput(ctx *pulumi.Context, args LookupTagApiLinkOutputArgs, opts ...pulumi.InvokeOption) LookupTagApiLinkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTagApiLinkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230501preview:getTagApiLink", args, LookupTagApiLinkResultOutput{}, options).(LookupTagApiLinkResultOutput), nil
