...
func LookupProductApiLink(ctx *pulumi.Context, args *LookupProductApiLinkArgs, opts ...pulumi.InvokeOption) (*LookupProductApiLinkResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230501preview:getProductApiLink", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupProductApiLinkOutput(ctx *pulumi.Context, args LookupProductApiLinkOutputArgs, opts ...pulumi.InvokeOption) LookupProductApiLinkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupProductApiLinkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230501preview:getProductApiLink", args, LookupProductApiLinkResultOutput{}, options).(LookupProductApiLinkResultOutput), nil
