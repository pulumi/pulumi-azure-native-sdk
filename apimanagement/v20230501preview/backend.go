...
func NewBackend(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230501preview:Backend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackend(ctx *pulumi.Context,
	...
	var resource Backend
	err := ctx.ReadResource("azure-native:apimanagement/v20230501preview:Backend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
