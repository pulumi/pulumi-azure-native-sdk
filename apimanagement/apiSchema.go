...
func NewApiSchema(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:ApiSchema"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ApiSchema"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ApiSchema"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiSchema"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ApiSchema"),
		},
	})
...
// The provisioning state
func (o ApiSchemaOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v *ApiSchema) pulumi.StringOutput { return v.ProvisioningState }).(pulumi.StringOutput)
}
