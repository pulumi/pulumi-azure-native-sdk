...
func LookupApiPolicy(ctx *pulumi.Context, args *LookupApiPolicyArgs, opts ...pulumi.InvokeOption) (*LookupApiPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20220801:getApiPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupApiPolicyOutput(ctx *pulumi.Context, args LookupApiPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupApiPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20220801:getApiPolicy", args, LookupApiPolicyResultOutput{}, options).(LookupApiPolicyResultOutput), nil
