...
func NewGlobalSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:GlobalSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalSchema(ctx *pulumi.Context,
	...
	var resource GlobalSchema
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:GlobalSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
