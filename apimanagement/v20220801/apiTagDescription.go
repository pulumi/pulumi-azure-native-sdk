...
func NewApiTagDescription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:ApiTagDescription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiTagDescription(ctx *pulumi.Context,
	...
	var resource ApiTagDescription
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:ApiTagDescription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
