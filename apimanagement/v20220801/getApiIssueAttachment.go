...
func LookupApiIssueAttachment(ctx *pulumi.Context, args *LookupApiIssueAttachmentArgs, opts ...pulumi.InvokeOption) (*LookupApiIssueAttachmentResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20220801:getApiIssueAttachment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiIssueAttachmentOutput(ctx *pulumi.Context, args LookupApiIssueAttachmentOutputArgs, opts ...pulumi.InvokeOption) LookupApiIssueAttachmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiIssueAttachmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20220801:getApiIssueAttachment", args, LookupApiIssueAttachmentResultOutput{}, options).(LookupApiIssueAttachmentResultOutput), nil
