...
func NewNamedValue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:NamedValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamedValue(ctx *pulumi.Context,
	...
	var resource NamedValue
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:NamedValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
