...
func NewGroupUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:GroupUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupUser(ctx *pulumi.Context,
	...
	var resource GroupUser
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:GroupUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
