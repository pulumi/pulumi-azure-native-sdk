...
func NewAuthorizationAccessPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:AuthorizationAccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationAccessPolicy(ctx *pulumi.Context,
	...
	var resource AuthorizationAccessPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:AuthorizationAccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
