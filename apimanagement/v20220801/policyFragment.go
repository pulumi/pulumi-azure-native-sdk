...
func NewPolicyFragment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:PolicyFragment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyFragment(ctx *pulumi.Context,
	...
	var resource PolicyFragment
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:PolicyFragment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
