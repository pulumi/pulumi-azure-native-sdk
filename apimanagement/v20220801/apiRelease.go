...
func NewApiRelease(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:ApiRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiRelease(ctx *pulumi.Context,
	...
	var resource ApiRelease
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:ApiRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
