...
func NewIdentityProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:IdentityProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityProvider(ctx *pulumi.Context,
	...
	var resource IdentityProvider
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:IdentityProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
