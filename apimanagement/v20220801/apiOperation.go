...
func NewApiOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:ApiOperation"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ApiOperation"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ApiOperation"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:ApiOperation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApiOperation
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:ApiOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperation(ctx *pulumi.Context,
	...
	var resource ApiOperation
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:ApiOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
