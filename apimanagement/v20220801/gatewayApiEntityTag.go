...
func NewGatewayApiEntityTag(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220801:GatewayApiEntityTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayApiEntityTag(ctx *pulumi.Context,
	...
	var resource GatewayApiEntityTag
	err := ctx.ReadResource("azure-native:apimanagement/v20220801:GatewayApiEntityTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
