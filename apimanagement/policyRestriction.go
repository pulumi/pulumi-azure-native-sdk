...
func NewPolicyRestriction(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:PolicyRestriction"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:PolicyRestriction"),
		},
	})
