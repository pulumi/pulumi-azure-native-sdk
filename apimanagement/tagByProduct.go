...
func NewTagByProduct(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:TagByProduct"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:TagByProduct"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:TagByProduct"),
		},
	})
