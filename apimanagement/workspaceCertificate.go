...
func NewWorkspaceCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceCertificate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceCertificate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceCertificate"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceCertificate
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceCertificate(ctx *pulumi.Context,
	...
	var resource WorkspaceCertificate
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
