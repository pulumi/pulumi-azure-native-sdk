...
func NewGraphQLApiResolverPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:GraphQLApiResolverPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:GraphQLApiResolverPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:GraphQLApiResolverPolicy"),
		},
	})
