...
func NewWorkspaceTagProductLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceTagProductLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceTagProductLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceTagProductLink"),
		},
	})
