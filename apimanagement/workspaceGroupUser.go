...
func NewWorkspaceGroupUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:WorkspaceGroupUser"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:WorkspaceGroupUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceGroupUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceGroupUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceGroupUser"),
		},
	})
...
// The Azure API version of the resource.
func (o WorkspaceGroupUserOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkspaceGroupUser) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
