...
func NewWorkspaceLogger(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceLogger"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceLogger"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceLogger
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceLogger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceLogger(ctx *pulumi.Context,
	...
	var resource WorkspaceLogger
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceLogger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
