...
func NewApiRelease(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:ApiRelease"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ApiRelease"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ApiRelease"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApiRelease
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:ApiRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiRelease(ctx *pulumi.Context,
	...
	var resource ApiRelease
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:ApiRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
