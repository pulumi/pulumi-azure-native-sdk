...
func NewWorkspacePolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:WorkspacePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspacePolicy(ctx *pulumi.Context,
	...
	var resource WorkspacePolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:WorkspacePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
