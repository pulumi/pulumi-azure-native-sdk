...
func NewWorkspaceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:WorkspaceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceGroup(ctx *pulumi.Context,
	...
	var resource WorkspaceGroup
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:WorkspaceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
