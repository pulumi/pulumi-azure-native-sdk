...
func NewDocumentation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:Documentation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDocumentation(ctx *pulumi.Context,
	...
	var resource Documentation
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:Documentation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
