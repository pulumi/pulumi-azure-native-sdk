...
func ListOpenIdConnectProviderSecrets(ctx *pulumi.Context, args *ListOpenIdConnectProviderSecretsArgs, opts ...pulumi.InvokeOption) (*ListOpenIdConnectProviderSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230301preview:listOpenIdConnectProviderSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListOpenIdConnectProviderSecretsOutput(ctx *pulumi.Context, args ListOpenIdConnectProviderSecretsOutputArgs, opts ...pulumi.InvokeOption) ListOpenIdConnectProviderSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListOpenIdConnectProviderSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230301preview:listOpenIdConnectProviderSecrets", args, ListOpenIdConnectProviderSecretsResultOutput{}, options).(ListOpenIdConnectProviderSecretsResultOutput), nil
