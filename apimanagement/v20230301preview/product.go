...
func NewProduct(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:Product"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:Product"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:Product"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:Product"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Product
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:Product", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProduct(ctx *pulumi.Context,
	...
	var resource Product
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:Product", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
