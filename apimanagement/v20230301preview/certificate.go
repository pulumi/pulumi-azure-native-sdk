...
func NewCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:Certificate"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Certificate
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:Certificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificate(ctx *pulumi.Context,
	...
	var resource Certificate
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:Certificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
