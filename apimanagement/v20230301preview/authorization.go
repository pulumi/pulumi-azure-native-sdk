...
func NewAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:Authorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorization(ctx *pulumi.Context,
	...
	var resource Authorization
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:Authorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
