...
func LookupTagOperationLink(ctx *pulumi.Context, args *LookupTagOperationLinkArgs, opts ...pulumi.InvokeOption) (*LookupTagOperationLinkResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230301preview:getTagOperationLink", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTagOperationLinkOutput(ctx *pulumi.Context, args LookupTagOperationLinkOutputArgs, opts ...pulumi.InvokeOption) LookupTagOperationLinkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTagOperationLinkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230301preview:getTagOperationLink", args, LookupTagOperationLinkResultOutput{}, options).(LookupTagOperationLinkResultOutput), nil
