...
func NewWorkspaceProductPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:WorkspaceProductPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:WorkspaceProductPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:WorkspaceProductPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:WorkspaceProductPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceProductPolicy(ctx *pulumi.Context,
	...
	var resource WorkspaceProductPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:WorkspaceProductPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
