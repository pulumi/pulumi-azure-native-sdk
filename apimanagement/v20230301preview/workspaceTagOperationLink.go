...
func NewWorkspaceTagOperationLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:WorkspaceTagOperationLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceTagOperationLink(ctx *pulumi.Context,
	...
	var resource WorkspaceTagOperationLink
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:WorkspaceTagOperationLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
