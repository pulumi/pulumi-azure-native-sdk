...
func NewGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20220801:Group"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20220901preview:Group"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:Group"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:Group"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:Group"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:Group"),
		},
		{
	...
	var resource Group
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
