...
func NewTagByApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:TagByApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByApi(ctx *pulumi.Context,
	...
	var resource TagByApi
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:TagByApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
