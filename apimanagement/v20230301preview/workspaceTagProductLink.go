...
func NewWorkspaceTagProductLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:WorkspaceTagProductLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceTagProductLink(ctx *pulumi.Context,
	...
	var resource WorkspaceTagProductLink
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:WorkspaceTagProductLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
