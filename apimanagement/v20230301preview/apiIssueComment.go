...
func NewApiIssueComment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:ApiIssueComment"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:ApiIssueComment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssueComment(ctx *pulumi.Context,
	...
	var resource ApiIssueComment
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:ApiIssueComment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
