...
func NewWorkspaceNotificationRecipientUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:WorkspaceNotificationRecipientUser"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:WorkspaceNotificationRecipientUser"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:WorkspaceNotificationRecipientUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceNotificationRecipientUser(ctx *pulumi.Context,
	...
	var resource WorkspaceNotificationRecipientUser
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:WorkspaceNotificationRecipientUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
