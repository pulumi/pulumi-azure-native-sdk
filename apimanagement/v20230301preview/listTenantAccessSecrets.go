...
func ListTenantAccessSecrets(ctx *pulumi.Context, args *ListTenantAccessSecretsArgs, opts ...pulumi.InvokeOption) (*ListTenantAccessSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230301preview:listTenantAccessSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListTenantAccessSecretsOutput(ctx *pulumi.Context, args ListTenantAccessSecretsOutputArgs, opts ...pulumi.InvokeOption) ListTenantAccessSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListTenantAccessSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230301preview:listTenantAccessSecrets", args, ListTenantAccessSecretsResultOutput{}, options).(ListTenantAccessSecretsResultOutput), nil
