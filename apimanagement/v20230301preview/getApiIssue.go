...
func LookupApiIssue(ctx *pulumi.Context, args *LookupApiIssueArgs, opts ...pulumi.InvokeOption) (*LookupApiIssueResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230301preview:getApiIssue", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiIssueOutput(ctx *pulumi.Context, args LookupApiIssueOutputArgs, opts ...pulumi.InvokeOption) LookupApiIssueResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiIssueResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230301preview:getApiIssue", args, LookupApiIssueResultOutput{}, options).(LookupApiIssueResultOutput), nil
