...
func NewApiDiagnostic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:ApiDiagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiDiagnostic(ctx *pulumi.Context,
	...
	var resource ApiDiagnostic
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:ApiDiagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
