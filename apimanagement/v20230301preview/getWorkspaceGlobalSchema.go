...
func LookupWorkspaceGlobalSchema(ctx *pulumi.Context, args *LookupWorkspaceGlobalSchemaArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceGlobalSchemaResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230301preview:getWorkspaceGlobalSchema", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceGlobalSchemaOutput(ctx *pulumi.Context, args LookupWorkspaceGlobalSchemaOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceGlobalSchemaResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceGlobalSchemaResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230301preview:getWorkspaceGlobalSchema", args, LookupWorkspaceGlobalSchemaResultOutput{}, options).(LookupWorkspaceGlobalSchemaResultOutput), nil
