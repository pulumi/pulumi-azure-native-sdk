...
func ListIdentityProviderSecrets(ctx *pulumi.Context, args *ListIdentityProviderSecretsArgs, opts ...pulumi.InvokeOption) (*ListIdentityProviderSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230301preview:listIdentityProviderSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListIdentityProviderSecretsOutput(ctx *pulumi.Context, args ListIdentityProviderSecretsOutputArgs, opts ...pulumi.InvokeOption) ListIdentityProviderSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListIdentityProviderSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230301preview:listIdentityProviderSecrets", args, ListIdentityProviderSecretsResultOutput{}, options).(ListIdentityProviderSecretsResultOutput), nil
