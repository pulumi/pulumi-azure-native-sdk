...
func NewContentItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20230301preview:ContentItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentItem(ctx *pulumi.Context,
	...
	var resource ContentItem
	err := ctx.ReadResource("azure-native:apimanagement/v20230301preview:ContentItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
