...
func LookupApiTagDescription(ctx *pulumi.Context, args *LookupApiTagDescriptionArgs, opts ...pulumi.InvokeOption) (*LookupApiTagDescriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20230301preview:getApiTagDescription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiTagDescriptionOutput(ctx *pulumi.Context, args LookupApiTagDescriptionOutputArgs, opts ...pulumi.InvokeOption) LookupApiTagDescriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiTagDescriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20230301preview:getApiTagDescription", args, LookupApiTagDescriptionResultOutput{}, options).(LookupApiTagDescriptionResultOutput), nil
