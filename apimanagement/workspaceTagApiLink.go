...
func NewWorkspaceTagApiLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceTagApiLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceTagApiLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceTagApiLink"),
		},
	})
