...
func NewContentType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ContentType"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ContentType"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ContentType"),
		},
	})
