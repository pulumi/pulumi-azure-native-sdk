...
func LookupApiVersionSetOutput(ctx *pulumi.Context, args LookupApiVersionSetOutputArgs, opts ...pulumi.InvokeOption) LookupApiVersionSetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiVersionSetResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement:getApiVersionSet", args, LookupApiVersionSetResultOutput{}, options).(LookupApiVersionSetResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupApiVersionSetResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupApiVersionSetResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
