...
func NewProductGroupLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ProductGroupLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ProductGroupLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ProductGroupLink"),
		},
	})
