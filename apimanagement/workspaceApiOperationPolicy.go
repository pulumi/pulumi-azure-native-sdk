...
func NewWorkspaceApiOperationPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceApiOperationPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceApiOperationPolicy"),
		},
	})
