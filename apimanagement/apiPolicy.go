...
func NewApiPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20220401preview:ApiPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230301preview:ApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:ApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:ApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ApiPolicy"),
		},
	})
...
// The Azure API version of the resource.
func (o ApiPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ApiPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
