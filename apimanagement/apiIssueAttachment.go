...
func NewApiIssueAttachment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ApiIssueAttachment"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiIssueAttachment"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ApiIssueAttachment"),
		},
	})
...
// The Azure API version of the resource.
func (o ApiIssueAttachmentOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ApiIssueAttachment) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
