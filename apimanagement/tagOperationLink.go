...
func NewTagOperationLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230301preview:TagOperationLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:TagOperationLink"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:TagOperationLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:TagOperationLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:TagOperationLink"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TagOperationLink
	err := ctx.RegisterResource("azure-native:apimanagement:TagOperationLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagOperationLink(ctx *pulumi.Context,
	...
	var resource TagOperationLink
	err := ctx.ReadResource("azure-native:apimanagement:TagOperationLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o TagOperationLinkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TagOperationLink) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
