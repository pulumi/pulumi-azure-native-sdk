...
// Contract details.
//
// Deprecated: azure-native:apimanagement/v20220401preview:ProductGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ProductGroup to guarantee forwards compatibility.
...
func NewProductGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220401preview:ProductGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductGroup(ctx *pulumi.Context,
	...
	var resource ProductGroup
	err := ctx.ReadResource("azure-native:apimanagement/v20220401preview:ProductGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
