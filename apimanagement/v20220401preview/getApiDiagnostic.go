...
//
// Deprecated: azure-native:apimanagement/v20220401preview:ApiDiagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiDiagnostic to guarantee forwards compatibility.
func LookupApiDiagnostic(ctx *pulumi.Context, args *LookupApiDiagnosticArgs, opts ...pulumi.InvokeOption) (*LookupApiDiagnosticResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20220401preview:getApiDiagnostic", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
