...
//
// Deprecated: azure-native:apimanagement/v20220401preview:ApiSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiSchema to guarantee forwards compatibility.
...
func NewApiSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220401preview:ApiSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiSchema(ctx *pulumi.Context,
	...
	var resource ApiSchema
	err := ctx.ReadResource("azure-native:apimanagement/v20220401preview:ApiSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
