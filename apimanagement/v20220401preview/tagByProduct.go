...
//
// Deprecated: azure-native:apimanagement/v20220401preview:TagByProduct is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByProduct to guarantee forwards compatibility.
...
func NewTagByProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20220401preview:TagByProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByProduct(ctx *pulumi.Context,
	...
	var resource TagByProduct
	err := ctx.ReadResource("azure-native:apimanagement/v20220401preview:TagByProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
