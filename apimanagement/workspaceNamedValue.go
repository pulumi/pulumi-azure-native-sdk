...
func NewWorkspaceNamedValue(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceNamedValue"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceNamedValue"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceNamedValue
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceNamedValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceNamedValue(ctx *pulumi.Context,
	...
	var resource WorkspaceNamedValue
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceNamedValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
