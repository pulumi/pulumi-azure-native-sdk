...
func NewNamedValue(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:NamedValue"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:NamedValue"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:NamedValue"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:NamedValue"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:NamedValue"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:NamedValue"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:NamedValue"),
		},
	})
...
// The provisioning state
func (o NamedValueOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v *NamedValue) pulumi.StringOutput { return v.ProvisioningState }).(pulumi.StringOutput)
}
