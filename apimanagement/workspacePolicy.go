...
func NewWorkspacePolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspacePolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspacePolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspacePolicy"),
		},
	})
