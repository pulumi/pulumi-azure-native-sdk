...
func NewWorkspaceNotificationRecipientUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceNotificationRecipientUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceNotificationRecipientUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceNotificationRecipientUser"),
		},
	})
