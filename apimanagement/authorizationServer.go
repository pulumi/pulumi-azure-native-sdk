...
func NewAuthorizationServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:AuthorizationServer"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:AuthorizationServer"),
		},
	})
