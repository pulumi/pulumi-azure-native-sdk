...
//
// Deprecated: azure-native:apimanagement/v20180601preview:ApiSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:ApiSchema to guarantee forwards compatibility.
func LookupApiSchema(ctx *pulumi.Context, args *LookupApiSchemaArgs, opts ...pulumi.InvokeOption) (*LookupApiSchemaResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20180601preview:getApiSchema", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
