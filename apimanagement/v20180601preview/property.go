...
func NewProperty(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20180601preview:Property", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProperty(ctx *pulumi.Context,
	...
	var resource Property
	err := ctx.ReadResource("azure-native:apimanagement/v20180601preview:Property", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
