...
//
// Deprecated: azure-native:apimanagement/v20180601preview:OpenIdConnectProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:OpenIdConnectProvider to guarantee forwards compatibility.
func LookupOpenIdConnectProvider(ctx *pulumi.Context, args *LookupOpenIdConnectProviderArgs, opts ...pulumi.InvokeOption) (*LookupOpenIdConnectProviderResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20180601preview:getOpenIdConnectProvider", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
