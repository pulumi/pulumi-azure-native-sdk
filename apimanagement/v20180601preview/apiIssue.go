...
//
// Deprecated: azure-native:apimanagement/v20180601preview:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssue to guarantee forwards compatibility.
...
func NewApiIssue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20180601preview:ApiIssue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssue(ctx *pulumi.Context,
	...
	var resource ApiIssue
	err := ctx.ReadResource("azure-native:apimanagement/v20180601preview:ApiIssue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
