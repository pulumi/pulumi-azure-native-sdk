...
// Contract details.
//
// Deprecated: azure-native:apimanagement/v20180601preview:Group is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Group to guarantee forwards compatibility.
type Group struct {
...
func NewGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.RegisterResource("azure-native:apimanagement/v20180601preview:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("azure-native:apimanagement/v20180601preview:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
