...
func NewTagDescription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:TagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:TagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:TagDescription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:TagDescription"),
		},
	})
