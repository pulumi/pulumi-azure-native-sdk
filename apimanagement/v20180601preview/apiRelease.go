...
// Api Release details.
//
// Deprecated: azure-native:apimanagement/v20180601preview:ApiRelease is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiRelease to guarantee forwards compatibility.
...
func NewApiRelease(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20220801:ApiRelease"),
		},
	})
	opts = append(opts, aliases)
	var resource ApiRelease
	err := ctx.RegisterResource("azure-native:apimanagement/v20180601preview:ApiRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiRelease(ctx *pulumi.Context,
	...
	var resource ApiRelease
	err := ctx.ReadResource("azure-native:apimanagement/v20180601preview:ApiRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
