...
func NewGraphQLApiResolver(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:GraphQLApiResolver"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:GraphQLApiResolver"),
		},
	})
...
// The Azure API version of the resource.
func (o GraphQLApiResolverOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *GraphQLApiResolver) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
