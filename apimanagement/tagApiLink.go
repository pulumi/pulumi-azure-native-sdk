...
func NewTagApiLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:TagApiLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:TagApiLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:TagApiLink"),
		},
	})
...
// The Azure API version of the resource.
func (o TagApiLinkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TagApiLink) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
