...
func NewAuthorization(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:Authorization"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:Authorization"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:Authorization"),
		},
	})
