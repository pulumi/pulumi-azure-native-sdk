...
func ListGatewayDebugCredentials(ctx *pulumi.Context, args *ListGatewayDebugCredentialsArgs, opts ...pulumi.InvokeOption) (*ListGatewayDebugCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:listGatewayDebugCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListGatewayDebugCredentialsOutput(ctx *pulumi.Context, args ListGatewayDebugCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListGatewayDebugCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListGatewayDebugCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:listGatewayDebugCredentials", args, ListGatewayDebugCredentialsResultOutput{}, options).(ListGatewayDebugCredentialsResultOutput), nil
