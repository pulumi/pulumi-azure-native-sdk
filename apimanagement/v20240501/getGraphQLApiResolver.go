...
func LookupGraphQLApiResolver(ctx *pulumi.Context, args *LookupGraphQLApiResolverArgs, opts ...pulumi.InvokeOption) (*LookupGraphQLApiResolverResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:getGraphQLApiResolver", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGraphQLApiResolverOutput(ctx *pulumi.Context, args LookupGraphQLApiResolverOutputArgs, opts ...pulumi.InvokeOption) LookupGraphQLApiResolverResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGraphQLApiResolverResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:getGraphQLApiResolver", args, LookupGraphQLApiResolverResultOutput{}, options).(LookupGraphQLApiResolverResultOutput), nil
