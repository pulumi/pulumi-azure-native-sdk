...
func NewWorkspaceApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:WorkspaceApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApi(ctx *pulumi.Context,
	...
	var resource WorkspaceApi
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:WorkspaceApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
