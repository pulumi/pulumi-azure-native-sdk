...
func NewWorkspaceNotificationRecipientEmail(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:WorkspaceNotificationRecipientEmail", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceNotificationRecipientEmail(ctx *pulumi.Context,
	...
	var resource WorkspaceNotificationRecipientEmail
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:WorkspaceNotificationRecipientEmail", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
