...
func NewLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:Logger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:Logger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
