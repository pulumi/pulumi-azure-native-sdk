...
func LookupGroup(ctx *pulumi.Context, args *LookupGroupArgs, opts ...pulumi.InvokeOption) (*LookupGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:getGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGroupOutput(ctx *pulumi.Context, args LookupGroupOutputArgs, opts ...pulumi.InvokeOption) LookupGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:getGroup", args, LookupGroupResultOutput{}, options).(LookupGroupResultOutput), nil
