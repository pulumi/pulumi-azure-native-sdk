...
func NewCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:Cache", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:Cache", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
