...
func NewWorkspaceLogger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:WorkspaceLogger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceLogger(ctx *pulumi.Context,
	...
	var resource WorkspaceLogger
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:WorkspaceLogger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
