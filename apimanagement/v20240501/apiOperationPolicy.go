...
func NewApiOperationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:ApiOperationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperationPolicy(ctx *pulumi.Context,
	...
	var resource ApiOperationPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:ApiOperationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
