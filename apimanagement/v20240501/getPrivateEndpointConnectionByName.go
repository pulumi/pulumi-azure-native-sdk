...
func LookupPrivateEndpointConnectionByName(ctx *pulumi.Context, args *LookupPrivateEndpointConnectionByNameArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointConnectionByNameResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:getPrivateEndpointConnectionByName", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateEndpointConnectionByNameOutput(ctx *pulumi.Context, args LookupPrivateEndpointConnectionByNameOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateEndpointConnectionByNameResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateEndpointConnectionByNameResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:getPrivateEndpointConnectionByName", args, LookupPrivateEndpointConnectionByNameResultOutput{}, options).(LookupPrivateEndpointConnectionByNameResultOutput), nil
