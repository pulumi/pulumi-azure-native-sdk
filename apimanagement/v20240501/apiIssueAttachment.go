...
func NewApiIssueAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:ApiIssueAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssueAttachment(ctx *pulumi.Context,
	...
	var resource ApiIssueAttachment
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:ApiIssueAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
