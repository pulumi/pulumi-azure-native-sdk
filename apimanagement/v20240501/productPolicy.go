...
func NewProductPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:ProductPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductPolicy(ctx *pulumi.Context,
	...
	var resource ProductPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:ProductPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
