...
func NewNotificationRecipientEmail(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:NotificationRecipientEmail"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:NotificationRecipientEmail"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:NotificationRecipientEmail", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationRecipientEmail(ctx *pulumi.Context,
	...
	var resource NotificationRecipientEmail
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:NotificationRecipientEmail", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
