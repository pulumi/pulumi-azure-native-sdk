...
func NewGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:GatewayCertificateAuthority", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	var resource GatewayCertificateAuthority
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:GatewayCertificateAuthority", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
