...
func NewTagProductLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:TagProductLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagProductLink(ctx *pulumi.Context,
	...
	var resource TagProductLink
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:TagProductLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
