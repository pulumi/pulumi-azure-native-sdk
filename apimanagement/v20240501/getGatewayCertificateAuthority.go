...
func LookupGatewayCertificateAuthority(ctx *pulumi.Context, args *LookupGatewayCertificateAuthorityArgs, opts ...pulumi.InvokeOption) (*LookupGatewayCertificateAuthorityResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:getGatewayCertificateAuthority", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGatewayCertificateAuthorityOutput(ctx *pulumi.Context, args LookupGatewayCertificateAuthorityOutputArgs, opts ...pulumi.InvokeOption) LookupGatewayCertificateAuthorityResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGatewayCertificateAuthorityResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:getGatewayCertificateAuthority", args, LookupGatewayCertificateAuthorityResultOutput{}, options).(LookupGatewayCertificateAuthorityResultOutput), nil
