...
func NewApiGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:ApiGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiGateway(ctx *pulumi.Context,
	...
	var resource ApiGateway
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:ApiGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
