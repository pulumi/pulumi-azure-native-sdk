...
func NewProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:Product", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProduct(ctx *pulumi.Context,
	...
	var resource Product
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:Product", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
