...
func NewApiOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:ApiOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperation(ctx *pulumi.Context,
	...
	var resource ApiOperation
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:ApiOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
