...
func LookupDocumentation(ctx *pulumi.Context, args *LookupDocumentationArgs, opts ...pulumi.InvokeOption) (*LookupDocumentationResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:getDocumentation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDocumentationOutput(ctx *pulumi.Context, args LookupDocumentationOutputArgs, opts ...pulumi.InvokeOption) LookupDocumentationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDocumentationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:getDocumentation", args, LookupDocumentationResultOutput{}, options).(LookupDocumentationResultOutput), nil
