...
func NewTagByOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:TagByOperation"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:TagByOperation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TagByOperation
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:TagByOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByOperation(ctx *pulumi.Context,
	...
	var resource TagByOperation
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:TagByOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
