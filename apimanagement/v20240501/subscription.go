...
func NewSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:Subscription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:Subscription"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:Subscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscription(ctx *pulumi.Context,
	...
	var resource Subscription
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:Subscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
