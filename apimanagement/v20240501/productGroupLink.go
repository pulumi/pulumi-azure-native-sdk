...
func NewProductGroupLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:ProductGroupLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductGroupLink(ctx *pulumi.Context,
	...
	var resource ProductGroupLink
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:ProductGroupLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
