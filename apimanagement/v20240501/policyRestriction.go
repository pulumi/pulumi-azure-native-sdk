...
func NewPolicyRestriction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:PolicyRestriction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyRestriction(ctx *pulumi.Context,
	...
	var resource PolicyRestriction
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:PolicyRestriction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
