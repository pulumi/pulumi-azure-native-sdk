...
func ListGatewayKeys(ctx *pulumi.Context, args *ListGatewayKeysArgs, opts ...pulumi.InvokeOption) (*ListGatewayKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:listGatewayKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListGatewayKeysOutput(ctx *pulumi.Context, args ListGatewayKeysOutputArgs, opts ...pulumi.InvokeOption) ListGatewayKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListGatewayKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:listGatewayKeys", args, ListGatewayKeysResultOutput{}, options).(ListGatewayKeysResultOutput), nil
