...
func NewGraphQLApiResolverPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:GraphQLApiResolverPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGraphQLApiResolverPolicy(ctx *pulumi.Context,
	...
	var resource GraphQLApiResolverPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:GraphQLApiResolverPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
