...
func NewWorkspaceApiOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:WorkspaceApiOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiOperation(ctx *pulumi.Context,
	...
	var resource WorkspaceApiOperation
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:WorkspaceApiOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
