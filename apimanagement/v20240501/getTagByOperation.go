...
func LookupTagByOperation(ctx *pulumi.Context, args *LookupTagByOperationArgs, opts ...pulumi.InvokeOption) (*LookupTagByOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:getTagByOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTagByOperationOutput(ctx *pulumi.Context, args LookupTagByOperationOutputArgs, opts ...pulumi.InvokeOption) LookupTagByOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTagByOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:getTagByOperation", args, LookupTagByOperationResultOutput{}, options).(LookupTagByOperationResultOutput), nil
