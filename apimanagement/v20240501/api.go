...
func NewApi(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:Api"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:Api"),
		},
		{
	...
	var resource Api
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:Api", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:Api", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The provisioning state
func (o ApiOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v *Api) pulumi.StringOutput { return v.ProvisioningState }).(pulumi.StringOutput)
}
