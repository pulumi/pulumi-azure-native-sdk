...
func NewWorkspaceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:WorkspaceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceGroup(ctx *pulumi.Context,
	...
	var resource WorkspaceGroup
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:WorkspaceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
