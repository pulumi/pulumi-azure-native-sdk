...
func NewAuthorizationProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:AuthorizationProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationProvider(ctx *pulumi.Context,
	...
	var resource AuthorizationProvider
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:AuthorizationProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
