...
func LookupWorkspaceApiOperationPolicy(ctx *pulumi.Context, args *LookupWorkspaceApiOperationPolicyArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceApiOperationPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240501:getWorkspaceApiOperationPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupWorkspaceApiOperationPolicyOutput(ctx *pulumi.Context, args LookupWorkspaceApiOperationPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceApiOperationPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceApiOperationPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240501:getWorkspaceApiOperationPolicy", args, LookupWorkspaceApiOperationPolicyResultOutput{}, options).(LookupWorkspaceApiOperationPolicyResultOutput), nil
