...
func NewTagByProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:TagByProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByProduct(ctx *pulumi.Context,
	...
	var resource TagByProduct
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:TagByProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
