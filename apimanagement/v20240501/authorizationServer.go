...
func NewAuthorizationServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240501:AuthorizationServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationServer(ctx *pulumi.Context,
	...
	var resource AuthorizationServer
	err := ctx.ReadResource("azure-native:apimanagement/v20240501:AuthorizationServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
