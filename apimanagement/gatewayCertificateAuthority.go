...
func NewGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:GatewayCertificateAuthority"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:GatewayCertificateAuthority"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:GatewayCertificateAuthority"),
		},
	})
...
// The Azure API version of the resource.
func (o GatewayCertificateAuthorityOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *GatewayCertificateAuthority) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
