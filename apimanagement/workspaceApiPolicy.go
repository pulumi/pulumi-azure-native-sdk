...
func NewWorkspaceApiPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:apimanagement/v20220901preview:WorkspaceApiPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceApiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceApiPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceApiPolicy
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceApiPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiPolicy(ctx *pulumi.Context,
	...
	var resource WorkspaceApiPolicy
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceApiPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WorkspaceApiPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkspaceApiPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
