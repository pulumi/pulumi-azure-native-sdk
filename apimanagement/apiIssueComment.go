...
func NewApiIssueComment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ApiIssueComment"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiIssueComment"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ApiIssueComment"),
		},
	})
