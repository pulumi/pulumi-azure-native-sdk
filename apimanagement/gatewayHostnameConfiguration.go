...
func NewGatewayHostnameConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:GatewayHostnameConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:GatewayHostnameConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:GatewayHostnameConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:GatewayHostnameConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:GatewayHostnameConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:GatewayHostnameConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource GatewayHostnameConfiguration
	err := ctx.RegisterResource("azure-native:apimanagement:GatewayHostnameConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayHostnameConfiguration(ctx *pulumi.Context,
	...
	var resource GatewayHostnameConfiguration
	err := ctx.ReadResource("azure-native:apimanagement:GatewayHostnameConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o GatewayHostnameConfigurationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *GatewayHostnameConfiguration) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
