...
func NewProductWiki(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ProductWiki"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ProductWiki"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ProductWiki"),
		},
	})
