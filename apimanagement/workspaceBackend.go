...
func NewWorkspaceBackend(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceBackend"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceBackend"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceBackend"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceBackend
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceBackend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceBackend(ctx *pulumi.Context,
	...
	var resource WorkspaceBackend
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceBackend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Backend communication protocol. Required when backend type is 'Single'.
func (o WorkspaceBackendOutput) Protocol() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WorkspaceBackend) pulumi.StringPtrOutput { return v.Protocol }).(pulumi.StringPtrOutput)
}
...
// Runtime Url of the Backend. Required when backend type is 'Single'.
func (o WorkspaceBackendOutput) Url() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WorkspaceBackend) pulumi.StringPtrOutput { return v.Url }).(pulumi.StringPtrOutput)
}
