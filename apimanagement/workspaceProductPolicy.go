...
func NewWorkspaceProductPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceProductPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceProductPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceProductPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceProductPolicy
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceProductPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceProductPolicy(ctx *pulumi.Context,
	...
	var resource WorkspaceProductPolicy
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceProductPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WorkspaceProductPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkspaceProductPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
