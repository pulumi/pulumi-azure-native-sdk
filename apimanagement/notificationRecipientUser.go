...
func NewNotificationRecipientUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20220801:NotificationRecipientUser"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:NotificationRecipientUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:NotificationRecipientUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:NotificationRecipientUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:NotificationRecipientUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:NotificationRecipientUser"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:NotificationRecipientUser"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NotificationRecipientUser
	err := ctx.RegisterResource("azure-native:apimanagement:NotificationRecipientUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationRecipientUser(ctx *pulumi.Context,
	...
	var resource NotificationRecipientUser
	err := ctx.ReadResource("azure-native:apimanagement:NotificationRecipientUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o NotificationRecipientUserOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *NotificationRecipientUser) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
