...
func NewPrivateEndpointConnectionByName(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:PrivateEndpointConnectionByName"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:PrivateEndpointConnectionByName"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:PrivateEndpointConnectionByName"),
		},
	})
...
// The Azure API version of the resource.
func (o PrivateEndpointConnectionByNameOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PrivateEndpointConnectionByName) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
