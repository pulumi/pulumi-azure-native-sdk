...
//
// Deprecated: azure-native:apimanagement/v20210101preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:User to guarantee forwards compatibility.
func LookupUser(ctx *pulumi.Context, args *LookupUserArgs, opts ...pulumi.InvokeOption) (*LookupUserResult, error) {
	var rv LookupUserResult
	err := ctx.Invoke("azure-native:apimanagement/v20210101preview:getUser", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
