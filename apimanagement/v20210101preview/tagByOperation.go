...
//
// Deprecated: azure-native:apimanagement/v20210101preview:TagByOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByOperation to guarantee forwards compatibility.
...
func NewTagByOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20211201preview:TagByOperation"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210101preview:TagByOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByOperation(ctx *pulumi.Context,
	...
	var resource TagByOperation
	err := ctx.ReadResource("azure-native:apimanagement/v20210101preview:TagByOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
