...
//
// Deprecated: azure-native:apimanagement/v20210101preview:Subscription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Subscription to guarantee forwards compatibility.
...
func NewSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210101preview:Subscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscription(ctx *pulumi.Context,
	...
	var resource Subscription
	err := ctx.ReadResource("azure-native:apimanagement/v20210101preview:Subscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
