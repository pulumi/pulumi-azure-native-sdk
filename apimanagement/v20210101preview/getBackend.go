...
//
// Deprecated: azure-native:apimanagement/v20210101preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Backend to guarantee forwards compatibility.
func LookupBackend(ctx *pulumi.Context, args *LookupBackendArgs, opts ...pulumi.InvokeOption) (*LookupBackendResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20210101preview:getBackend", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
