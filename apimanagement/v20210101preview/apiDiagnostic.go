...
// Diagnostic details.
//
// Deprecated: azure-native:apimanagement/v20210101preview:ApiDiagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiDiagnostic to guarantee forwards compatibility.
...
func NewApiDiagnostic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210101preview:ApiDiagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiDiagnostic(ctx *pulumi.Context,
	...
	var resource ApiDiagnostic
	err := ctx.ReadResource("azure-native:apimanagement/v20210101preview:ApiDiagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
