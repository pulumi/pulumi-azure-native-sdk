...
// Logger details.
//
// Deprecated: azure-native:apimanagement/v20210101preview:Logger is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Logger to guarantee forwards compatibility.
type Logger struct {
...
func NewLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.RegisterResource("azure-native:apimanagement/v20210101preview:Logger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.ReadResource("azure-native:apimanagement/v20210101preview:Logger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
