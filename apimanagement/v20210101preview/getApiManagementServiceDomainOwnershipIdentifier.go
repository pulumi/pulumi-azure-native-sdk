...
func GetApiManagementServiceDomainOwnershipIdentifier(ctx *pulumi.Context, args *GetApiManagementServiceDomainOwnershipIdentifierArgs, opts ...pulumi.InvokeOption) (*GetApiManagementServiceDomainOwnershipIdentifierResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20210101preview:getApiManagementServiceDomainOwnershipIdentifier", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetApiManagementServiceDomainOwnershipIdentifierOutput(ctx *pulumi.Context, args GetApiManagementServiceDomainOwnershipIdentifierOutputArgs, opts ...pulumi.InvokeOption) GetApiManagementServiceDomainOwnershipIdentifierResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetApiManagementServiceDomainOwnershipIdentifierResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20210101preview:getApiManagementServiceDomainOwnershipIdentifier", args, GetApiManagementServiceDomainOwnershipIdentifierResultOutput{}, options).(GetApiManagementServiceDomainOwnershipIdentifierResultOutput), nil
