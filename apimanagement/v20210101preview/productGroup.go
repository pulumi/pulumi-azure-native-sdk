...
func NewProductGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210101preview:ProductGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductGroup(ctx *pulumi.Context,
	...
	var resource ProductGroup
	err := ctx.ReadResource("azure-native:apimanagement/v20210101preview:ProductGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
