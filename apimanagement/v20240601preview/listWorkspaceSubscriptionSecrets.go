...
func ListWorkspaceSubscriptionSecrets(ctx *pulumi.Context, args *ListWorkspaceSubscriptionSecretsArgs, opts ...pulumi.InvokeOption) (*ListWorkspaceSubscriptionSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:listWorkspaceSubscriptionSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWorkspaceSubscriptionSecretsOutput(ctx *pulumi.Context, args ListWorkspaceSubscriptionSecretsOutputArgs, opts ...pulumi.InvokeOption) ListWorkspaceSubscriptionSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkspaceSubscriptionSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:listWorkspaceSubscriptionSecrets", args, ListWorkspaceSubscriptionSecretsResultOutput{}, options).(ListWorkspaceSubscriptionSecretsResultOutput), nil
