...
func LookupApiIssueComment(ctx *pulumi.Context, args *LookupApiIssueCommentArgs, opts ...pulumi.InvokeOption) (*LookupApiIssueCommentResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:getApiIssueComment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiIssueCommentOutput(ctx *pulumi.Context, args LookupApiIssueCommentOutputArgs, opts ...pulumi.InvokeOption) LookupApiIssueCommentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiIssueCommentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:getApiIssueComment", args, LookupApiIssueCommentResultOutput{}, options).(LookupApiIssueCommentResultOutput), nil
