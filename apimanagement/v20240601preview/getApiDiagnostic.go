...
func LookupApiDiagnostic(ctx *pulumi.Context, args *LookupApiDiagnosticArgs, opts ...pulumi.InvokeOption) (*LookupApiDiagnosticResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:getApiDiagnostic", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiDiagnosticOutput(ctx *pulumi.Context, args LookupApiDiagnosticOutputArgs, opts ...pulumi.InvokeOption) LookupApiDiagnosticResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiDiagnosticResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:getApiDiagnostic", args, LookupApiDiagnosticResultOutput{}, options).(LookupApiDiagnosticResultOutput), nil
...
// Large Language Models diagnostic settings
func (o LookupApiDiagnosticResultOutput) LargeLanguageModel() LLMDiagnosticSettingsResponsePtrOutput {
	return o.ApplyT(func(v LookupApiDiagnosticResult) *LLMDiagnosticSettingsResponse { return v.LargeLanguageModel }).(LLMDiagnosticSettingsResponsePtrOutput)
}
