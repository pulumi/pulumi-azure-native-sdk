...
func LookupWorkspaceCertificate(ctx *pulumi.Context, args *LookupWorkspaceCertificateArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:getWorkspaceCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceCertificateOutput(ctx *pulumi.Context, args LookupWorkspaceCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:getWorkspaceCertificate", args, LookupWorkspaceCertificateResultOutput{}, options).(LookupWorkspaceCertificateResultOutput), nil
