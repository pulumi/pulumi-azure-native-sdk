...
func LookupApiRelease(ctx *pulumi.Context, args *LookupApiReleaseArgs, opts ...pulumi.InvokeOption) (*LookupApiReleaseResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:getApiRelease", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiReleaseOutput(ctx *pulumi.Context, args LookupApiReleaseOutputArgs, opts ...pulumi.InvokeOption) LookupApiReleaseResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiReleaseResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:getApiRelease", args, LookupApiReleaseResultOutput{}, options).(LookupApiReleaseResultOutput), nil
