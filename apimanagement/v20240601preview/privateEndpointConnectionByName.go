...
func NewPrivateEndpointConnectionByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:PrivateEndpointConnectionByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionByName(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionByName
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:PrivateEndpointConnectionByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
