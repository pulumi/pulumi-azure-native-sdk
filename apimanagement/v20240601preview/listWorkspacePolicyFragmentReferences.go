...
func ListWorkspacePolicyFragmentReferences(ctx *pulumi.Context, args *ListWorkspacePolicyFragmentReferencesArgs, opts ...pulumi.InvokeOption) (*ListWorkspacePolicyFragmentReferencesResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:listWorkspacePolicyFragmentReferences", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWorkspacePolicyFragmentReferencesOutput(ctx *pulumi.Context, args ListWorkspacePolicyFragmentReferencesOutputArgs, opts ...pulumi.InvokeOption) ListWorkspacePolicyFragmentReferencesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkspacePolicyFragmentReferencesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:listWorkspacePolicyFragmentReferences", args, ListWorkspacePolicyFragmentReferencesResultOutput{}, options).(ListWorkspacePolicyFragmentReferencesResultOutput), nil
