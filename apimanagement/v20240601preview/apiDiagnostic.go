...
func NewApiDiagnostic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:ApiDiagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ApiDiagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ApiDiagnostic"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:ApiDiagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiDiagnostic(ctx *pulumi.Context,
	...
	var resource ApiDiagnostic
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:ApiDiagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Large Language Models diagnostic settings
func (o ApiDiagnosticOutput) LargeLanguageModel() LLMDiagnosticSettingsResponsePtrOutput {
	return o.ApplyT(func(v *ApiDiagnostic) LLMDiagnosticSettingsResponsePtrOutput { return v.LargeLanguageModel }).(LLMDiagnosticSettingsResponsePtrOutput)
}
