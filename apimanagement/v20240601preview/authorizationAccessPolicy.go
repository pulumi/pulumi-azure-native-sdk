...
func NewAuthorizationAccessPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:AuthorizationAccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationAccessPolicy(ctx *pulumi.Context,
	...
	var resource AuthorizationAccessPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:AuthorizationAccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
