...
func NewCache(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:Cache"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:Cache"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:Cache"),
		},
		{
	...
	var resource Cache
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:Cache", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:Cache", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
