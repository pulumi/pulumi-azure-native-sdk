...
func NewContentItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ContentItem"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ContentItem"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ContentItem
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:ContentItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentItem(ctx *pulumi.Context,
	...
	var resource ContentItem
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:ContentItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
