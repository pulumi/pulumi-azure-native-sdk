...
func NewWorkspaceApiRelease(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:WorkspaceApiRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiRelease(ctx *pulumi.Context,
	...
	var resource WorkspaceApiRelease
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:WorkspaceApiRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
