...
func NewProductWiki(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:ProductWiki", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductWiki(ctx *pulumi.Context,
	...
	var resource ProductWiki
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:ProductWiki", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
