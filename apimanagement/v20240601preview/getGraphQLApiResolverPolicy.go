...
func LookupGraphQLApiResolverPolicy(ctx *pulumi.Context, args *LookupGraphQLApiResolverPolicyArgs, opts ...pulumi.InvokeOption) (*LookupGraphQLApiResolverPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:getGraphQLApiResolverPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupGraphQLApiResolverPolicyOutput(ctx *pulumi.Context, args LookupGraphQLApiResolverPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupGraphQLApiResolverPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGraphQLApiResolverPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:getGraphQLApiResolverPolicy", args, LookupGraphQLApiResolverPolicyResultOutput{}, options).(LookupGraphQLApiResolverPolicyResultOutput), nil
