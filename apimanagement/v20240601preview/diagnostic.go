...
func NewDiagnostic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:Diagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnostic(ctx *pulumi.Context,
	...
	var resource Diagnostic
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:Diagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Large Language Models diagnostic settings
func (o DiagnosticOutput) LargeLanguageModel() LLMDiagnosticSettingsResponsePtrOutput {
	return o.ApplyT(func(v *Diagnostic) LLMDiagnosticSettingsResponsePtrOutput { return v.LargeLanguageModel }).(LLMDiagnosticSettingsResponsePtrOutput)
}
