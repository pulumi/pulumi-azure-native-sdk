...
func NewWorkspaceApiSchema(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:WorkspaceApiSchema"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:WorkspaceApiSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiSchema(ctx *pulumi.Context,
	...
	var resource WorkspaceApiSchema
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:WorkspaceApiSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
