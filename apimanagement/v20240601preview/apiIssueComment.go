...
func NewApiIssueComment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:ApiIssueComment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssueComment(ctx *pulumi.Context,
	...
	var resource ApiIssueComment
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:ApiIssueComment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
