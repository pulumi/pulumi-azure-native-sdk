...
func LookupLogger(ctx *pulumi.Context, args *LookupLoggerArgs, opts ...pulumi.InvokeOption) (*LookupLoggerResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:getLogger", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupLoggerOutput(ctx *pulumi.Context, args LookupLoggerOutputArgs, opts ...pulumi.InvokeOption) LookupLoggerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLoggerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:getLogger", args, LookupLoggerResultOutput{}, options).(LookupLoggerResultOutput), nil
