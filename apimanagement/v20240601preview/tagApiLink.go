...
func NewTagApiLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:TagApiLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagApiLink(ctx *pulumi.Context,
	...
	var resource TagApiLink
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:TagApiLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
