...
func NewWorkspaceApiOperationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:WorkspaceApiOperationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiOperationPolicy(ctx *pulumi.Context,
	...
	var resource WorkspaceApiOperationPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:WorkspaceApiOperationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
