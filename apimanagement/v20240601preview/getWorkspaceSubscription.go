...
func LookupWorkspaceSubscription(ctx *pulumi.Context, args *LookupWorkspaceSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20240601preview:getWorkspaceSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceSubscriptionOutput(ctx *pulumi.Context, args LookupWorkspaceSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apimanagement/v20240601preview:getWorkspaceSubscription", args, LookupWorkspaceSubscriptionResultOutput{}, options).(LookupWorkspaceSubscriptionResultOutput), nil
