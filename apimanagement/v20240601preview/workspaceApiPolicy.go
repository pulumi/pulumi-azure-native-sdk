...
func NewWorkspaceApiPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:WorkspaceApiPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiPolicy(ctx *pulumi.Context,
	...
	var resource WorkspaceApiPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:WorkspaceApiPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
