...
func NewWorkspaceCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:WorkspaceCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceCertificate(ctx *pulumi.Context,
	...
	var resource WorkspaceCertificate
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:WorkspaceCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
