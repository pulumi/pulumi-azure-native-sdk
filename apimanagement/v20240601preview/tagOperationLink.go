...
func NewTagOperationLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:TagOperationLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagOperationLink(ctx *pulumi.Context,
	...
	var resource TagOperationLink
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:TagOperationLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
