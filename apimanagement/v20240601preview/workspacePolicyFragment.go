...
func NewWorkspacePolicyFragment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:WorkspacePolicyFragment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspacePolicyFragment(ctx *pulumi.Context,
	...
	var resource WorkspacePolicyFragment
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:WorkspacePolicyFragment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
