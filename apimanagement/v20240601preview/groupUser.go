...
func NewGroupUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:GroupUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupUser(ctx *pulumi.Context,
	...
	var resource GroupUser
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:GroupUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
