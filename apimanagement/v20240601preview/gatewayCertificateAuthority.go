...
func NewGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:GatewayCertificateAuthority"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:GatewayCertificateAuthority"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:GatewayCertificateAuthority", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	var resource GatewayCertificateAuthority
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:GatewayCertificateAuthority", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
