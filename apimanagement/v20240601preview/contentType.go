...
func NewContentType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20240601preview:ContentType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentType(ctx *pulumi.Context,
	...
	var resource ContentType
	err := ctx.ReadResource("azure-native:apimanagement/v20240601preview:ContentType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
