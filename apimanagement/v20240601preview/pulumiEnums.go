...
func (e ReleaseChannel) ToReleaseChannelOutput() ReleaseChannelOutput {
	return pulumi.ToOutput(e).(ReleaseChannelOutput)
}

func (e ReleaseChannel) ToReleaseChannelOutputWithContext(ctx context.Context) ReleaseChannelOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ReleaseChannelOutput)
}

func (e ReleaseChannel) ToReleaseChannelPtrOutput() ReleaseChannelPtrOutput {
	return e.ToReleaseChannelPtrOutputWithContext(context.Background())
}

func (e ReleaseChannel) ToReleaseChannelPtrOutputWithContext(ctx context.Context) ReleaseChannelPtrOutput {
	return ReleaseChannel(e).ToReleaseChannelOutputWithContext(ctx).ToReleaseChannelPtrOutputWithContext(ctx)
}

func (e ReleaseChannel) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ReleaseChannel) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ReleaseChannel) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ReleaseChannel) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}
...
func (o ReleaseChannelOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ReleaseChannelOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ReleaseChannel) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ReleaseChannelOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ReleaseChannelOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ReleaseChannel) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
func (o ReleaseChannelPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ReleaseChannelPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ReleaseChannel) *string {
		if e == nil {
			return nil
		}
...
// ReleaseChannelInput is an input type that accepts values of the ReleaseChannel enum
// A concrete instance of `ReleaseChannelInput` can be one of the following:
//
...
var releaseChannelPtrType = reflect.TypeOf((**ReleaseChannel)(nil)).Elem()
...
type releaseChannelPtr string

func ReleaseChannelPtr(v string) ReleaseChannelPtrInput {
	return (*releaseChannelPtr)(&v)
}

func (*releaseChannelPtr) ElementType() reflect.Type {
	return releaseChannelPtrType
}

func (in *releaseChannelPtr) ToReleaseChannelPtrOutput() ReleaseChannelPtrOutput {
	return pulumi.ToOutput(in).(ReleaseChannelPtrOutput)
}

func (in *releaseChannelPtr) ToReleaseChannelPtrOutputWithContext(ctx context.Context) ReleaseChannelPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ReleaseChannelPtrOutput)
}
