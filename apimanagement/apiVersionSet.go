...
func NewApiVersionSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ApiVersionSet"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiVersionSet"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ApiVersionSet"),
		},
	})
...
// The Azure API version of the resource.
func (o ApiVersionSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ApiVersionSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
