...
func NewProductApi(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230301preview:ProductApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:ProductApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ProductApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ProductApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:ProductApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ProductApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ProductApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ProductApi"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ProductApi
	err := ctx.RegisterResource("azure-native:apimanagement:ProductApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductApi(ctx *pulumi.Context,
	...
	var resource ProductApi
	err := ctx.ReadResource("azure-native:apimanagement:ProductApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ProductApiOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ProductApi) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The provisioning state
func (o ProductApiOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v *ProductApi) pulumi.StringOutput { return v.ProvisioningState }).(pulumi.StringOutput)
}
