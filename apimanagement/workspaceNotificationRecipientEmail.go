...
func NewWorkspaceNotificationRecipientEmail(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:WorkspaceNotificationRecipientEmail"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:WorkspaceNotificationRecipientEmail"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceNotificationRecipientEmail"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceNotificationRecipientEmail"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceNotificationRecipientEmail"),
		},
	})
...
// The Azure API version of the resource.
func (o WorkspaceNotificationRecipientEmailOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkspaceNotificationRecipientEmail) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
