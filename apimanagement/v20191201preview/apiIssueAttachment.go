...
func NewApiIssueAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20191201preview:ApiIssueAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssueAttachment(ctx *pulumi.Context,
	...
	var resource ApiIssueAttachment
	err := ctx.ReadResource("azure-native:apimanagement/v20191201preview:ApiIssueAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
