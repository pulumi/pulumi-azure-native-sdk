...
//
// Deprecated: azure-native:apimanagement/v20191201preview:NotificationRecipientEmail is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:NotificationRecipientEmail to guarantee forwards compatibility.
...
func NewNotificationRecipientEmail(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20191201preview:NotificationRecipientEmail", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationRecipientEmail(ctx *pulumi.Context,
	...
	var resource NotificationRecipientEmail
	err := ctx.ReadResource("azure-native:apimanagement/v20191201preview:NotificationRecipientEmail", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
