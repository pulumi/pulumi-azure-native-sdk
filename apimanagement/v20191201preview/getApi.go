...
//
// Deprecated: azure-native:apimanagement/v20191201preview:Api is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20201201:Api to guarantee forwards compatibility.
func LookupApi(ctx *pulumi.Context, args *LookupApiArgs, opts ...pulumi.InvokeOption) (*LookupApiResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20191201preview:getApi", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
