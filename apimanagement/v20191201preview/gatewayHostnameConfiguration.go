...
//
// Deprecated: azure-native:apimanagement/v20191201preview:GatewayHostnameConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayHostnameConfiguration to guarantee forwards compatibility.
...
func NewGatewayHostnameConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20191201preview:GatewayHostnameConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayHostnameConfiguration(ctx *pulumi.Context,
	...
	var resource GatewayHostnameConfiguration
	err := ctx.ReadResource("azure-native:apimanagement/v20191201preview:GatewayHostnameConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
