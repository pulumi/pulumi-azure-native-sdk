...
//
// Deprecated: azure-native:apimanagement/v20191201preview:ApiVersionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiVersionSet to guarantee forwards compatibility.
...
func NewApiVersionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20191201preview:ApiVersionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiVersionSet(ctx *pulumi.Context,
	...
	var resource ApiVersionSet
	err := ctx.ReadResource("azure-native:apimanagement/v20191201preview:ApiVersionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
