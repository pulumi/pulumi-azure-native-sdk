...
func NewApiOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ApiOperation"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiOperation"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ApiOperation"),
		},
	})
...
// The Azure API version of the resource.
func (o ApiOperationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ApiOperation) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
