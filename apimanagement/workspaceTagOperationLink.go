...
func NewWorkspaceTagOperationLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceTagOperationLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceTagOperationLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceTagOperationLink"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceTagOperationLink
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceTagOperationLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceTagOperationLink(ctx *pulumi.Context,
	...
	var resource WorkspaceTagOperationLink
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceTagOperationLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
