...
func (o LookupWorkspaceApiOperationPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWorkspaceApiOperationPolicyResult] {
	return pulumix.Output[LookupWorkspaceApiOperationPolicyResult]{
