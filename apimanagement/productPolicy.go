...
func NewProductPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:ProductPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ProductPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ProductPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ProductPolicy"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ProductPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ProductPolicy
	err := ctx.RegisterResource("azure-native:apimanagement:ProductPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductPolicy(ctx *pulumi.Context,
	...
	var resource ProductPolicy
	err := ctx.ReadResource("azure-native:apimanagement:ProductPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ProductPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ProductPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
