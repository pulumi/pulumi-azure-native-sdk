...
func NewWorkspaceApiVersionSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceApiVersionSet"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceApiVersionSet"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceApiVersionSet"),
		},
	})
