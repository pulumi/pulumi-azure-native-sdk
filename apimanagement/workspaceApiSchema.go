...
func NewWorkspaceApiSchema(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceApiSchema"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceApiSchema
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceApiSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceApiSchema(ctx *pulumi.Context,
	...
	var resource WorkspaceApiSchema
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceApiSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
