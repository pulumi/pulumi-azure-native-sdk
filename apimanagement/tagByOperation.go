...
func NewTagByOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:TagByOperation"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:TagByOperation"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:TagByOperation"),
		},
	})
...
// The Azure API version of the resource.
func (o TagByOperationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TagByOperation) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
