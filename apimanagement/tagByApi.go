...
func NewTagByApi(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:TagByApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:TagByApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:TagByApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:TagByApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:TagByApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:TagByApi"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:TagByApi"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TagByApi
	err := ctx.RegisterResource("azure-native:apimanagement:TagByApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByApi(ctx *pulumi.Context,
	...
	var resource TagByApi
	err := ctx.ReadResource("azure-native:apimanagement:TagByApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o TagByApiOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TagByApi) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
