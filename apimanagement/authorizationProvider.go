...
func NewAuthorizationProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20220901preview:AuthorizationProvider"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:AuthorizationProvider"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:AuthorizationProvider"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:AuthorizationProvider"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:AuthorizationProvider"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AuthorizationProvider
	err := ctx.RegisterResource("azure-native:apimanagement:AuthorizationProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationProvider(ctx *pulumi.Context,
	...
	var resource AuthorizationProvider
	err := ctx.ReadResource("azure-native:apimanagement:AuthorizationProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
