...
func NewSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:Subscription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:Subscription"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:Subscription"),
		},
	})
