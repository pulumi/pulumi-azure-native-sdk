...
func NewLogger(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:Logger"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:Logger"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:Logger"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Logger
	err := ctx.RegisterResource("azure-native:apimanagement:Logger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogger(ctx *pulumi.Context,
	...
	var resource Logger
	err := ctx.ReadResource("azure-native:apimanagement:Logger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o LoggerOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Logger) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
