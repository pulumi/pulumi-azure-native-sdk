...
//
// Deprecated: azure-native:apimanagement/v20191201:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20191201preview:Cache to guarantee forwards compatibility.
func LookupCache(ctx *pulumi.Context, args *LookupCacheArgs, opts ...pulumi.InvokeOption) (*LookupCacheResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20191201:getCache", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
