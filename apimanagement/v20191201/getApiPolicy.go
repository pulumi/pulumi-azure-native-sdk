...
//
// Deprecated: azure-native:apimanagement/v20191201:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiPolicy to guarantee forwards compatibility.
