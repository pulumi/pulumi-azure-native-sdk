...
//
// Deprecated: azure-native:apimanagement/v20191201:ApiOperationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperationPolicy to guarantee forwards compatibility.
func LookupApiOperationPolicy(ctx *pulumi.Context, args *LookupApiOperationPolicyArgs, opts ...pulumi.InvokeOption) (*LookupApiOperationPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20191201:getApiOperationPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
