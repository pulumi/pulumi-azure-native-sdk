...
//
// Deprecated: azure-native:apimanagement/v20191201:ProductPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ProductPolicy to guarantee forwards compatibility.
...
func NewProductPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20191201:ProductPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductPolicy(ctx *pulumi.Context,
	...
	var resource ProductPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20191201:ProductPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
