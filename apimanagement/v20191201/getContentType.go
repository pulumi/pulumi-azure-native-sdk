...
//
// Deprecated: azure-native:apimanagement/v20191201:ContentType is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ContentType to guarantee forwards compatibility.
func LookupContentType(ctx *pulumi.Context, args *LookupContentTypeArgs, opts ...pulumi.InvokeOption) (*LookupContentTypeResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20191201:getContentType", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
