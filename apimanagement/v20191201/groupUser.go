...
// User details.
//
// Deprecated: azure-native:apimanagement/v20191201:GroupUser is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GroupUser to guarantee forwards compatibility.
...
func NewGroupUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20191201:GroupUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupUser(ctx *pulumi.Context,
	...
	var resource GroupUser
	err := ctx.ReadResource("azure-native:apimanagement/v20191201:GroupUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
