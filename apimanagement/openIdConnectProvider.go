...
func NewOpenIdConnectProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:OpenIdConnectProvider"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:OpenIdConnectProvider"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:OpenIdConnectProvider"),
		},
	})
