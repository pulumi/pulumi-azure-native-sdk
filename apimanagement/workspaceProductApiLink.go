...
func NewWorkspaceProductApiLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceProductApiLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceProductApiLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceProductApiLink"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceProductApiLink
	err := ctx.RegisterResource("azure-native:apimanagement:WorkspaceProductApiLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceProductApiLink(ctx *pulumi.Context,
	...
	var resource WorkspaceProductApiLink
	err := ctx.ReadResource("azure-native:apimanagement:WorkspaceProductApiLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WorkspaceProductApiLinkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkspaceProductApiLink) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
