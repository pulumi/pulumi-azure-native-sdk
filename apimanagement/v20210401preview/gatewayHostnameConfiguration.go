...
func NewGatewayHostnameConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayHostnameConfiguration(ctx *pulumi.Context,
	...
	var resource GatewayHostnameConfiguration
	err := ctx.ReadResource("azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
