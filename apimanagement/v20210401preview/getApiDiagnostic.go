...
//
// Deprecated: azure-native:apimanagement/v20210401preview:ApiDiagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiDiagnostic to guarantee forwards compatibility.
