...
// Cache details.
//
// Deprecated: azure-native:apimanagement/v20210401preview:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Cache to guarantee forwards compatibility.
type Cache struct {
...
func NewCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.RegisterResource("azure-native:apimanagement/v20210401preview:Cache", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.ReadResource("azure-native:apimanagement/v20210401preview:Cache", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
