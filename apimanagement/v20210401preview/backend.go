...
// Backend details.
//
// Deprecated: azure-native:apimanagement/v20210401preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Backend to guarantee forwards compatibility.
type Backend struct {
