...
//
// Deprecated: azure-native:apimanagement/v20200601preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayCertificateAuthority to guarantee forwards compatibility.
...
func NewGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20200601preview:GatewayCertificateAuthority", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayCertificateAuthority(ctx *pulumi.Context,
	...
	var resource GatewayCertificateAuthority
	err := ctx.ReadResource("azure-native:apimanagement/v20200601preview:GatewayCertificateAuthority", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
