...
func NewNotificationRecipientEmail(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20200601preview:NotificationRecipientEmail", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationRecipientEmail(ctx *pulumi.Context,
	...
	var resource NotificationRecipientEmail
	err := ctx.ReadResource("azure-native:apimanagement/v20200601preview:NotificationRecipientEmail", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
