...
//
// Deprecated: azure-native:apimanagement/v20200601preview:ApiIssueComment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiIssueComment to guarantee forwards compatibility.
