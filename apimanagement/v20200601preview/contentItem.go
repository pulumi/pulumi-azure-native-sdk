...
//
// Deprecated: azure-native:apimanagement/v20200601preview:ContentItem is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ContentItem to guarantee forwards compatibility.
...
func NewContentItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20200601preview:ContentItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentItem(ctx *pulumi.Context,
	...
	var resource ContentItem
	err := ctx.ReadResource("azure-native:apimanagement/v20200601preview:ContentItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
