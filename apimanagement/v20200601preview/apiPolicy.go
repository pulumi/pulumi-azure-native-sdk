...
//
// Deprecated: azure-native:apimanagement/v20200601preview:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiPolicy to guarantee forwards compatibility.
...
func NewApiPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20200601preview:ApiPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPolicy(ctx *pulumi.Context,
	...
	var resource ApiPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20200601preview:ApiPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
