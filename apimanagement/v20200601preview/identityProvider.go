...
func NewIdentityProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20200601preview:IdentityProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityProvider(ctx *pulumi.Context,
	...
	var resource IdentityProvider
	err := ctx.ReadResource("azure-native:apimanagement/v20200601preview:IdentityProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
