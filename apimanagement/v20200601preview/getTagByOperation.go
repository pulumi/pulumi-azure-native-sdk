...
//
// Deprecated: azure-native:apimanagement/v20200601preview:TagByOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByOperation to guarantee forwards compatibility.
func LookupTagByOperation(ctx *pulumi.Context, args *LookupTagByOperationArgs, opts ...pulumi.InvokeOption) (*LookupTagByOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20200601preview:getTagByOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
