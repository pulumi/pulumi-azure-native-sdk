...
//
// Deprecated: azure-native:apimanagement/v20200601preview:ApiOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiOperation to guarantee forwards compatibility.
