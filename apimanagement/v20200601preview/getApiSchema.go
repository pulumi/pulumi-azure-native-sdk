...
//
// Deprecated: azure-native:apimanagement/v20200601preview:ApiSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiSchema to guarantee forwards compatibility.
