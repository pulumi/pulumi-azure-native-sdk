...
//
// Deprecated: azure-native:apimanagement/v20200601preview:Tag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Tag to guarantee forwards compatibility.
type Tag struct {
