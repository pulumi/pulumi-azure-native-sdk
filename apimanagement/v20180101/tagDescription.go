...
func NewTagDescription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20180101:TagDescription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagDescription(ctx *pulumi.Context,
	...
	var resource TagDescription
	err := ctx.ReadResource("azure-native:apimanagement/v20180101:TagDescription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
