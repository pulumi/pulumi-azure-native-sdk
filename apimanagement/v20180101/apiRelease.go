...
// Api Release details.
//
// Deprecated: azure-native:apimanagement/v20180101:ApiRelease is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiRelease to guarantee forwards compatibility.
...
func NewApiRelease(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20180101:ApiRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiRelease(ctx *pulumi.Context,
	...
	var resource ApiRelease
	err := ctx.ReadResource("azure-native:apimanagement/v20180101:ApiRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
