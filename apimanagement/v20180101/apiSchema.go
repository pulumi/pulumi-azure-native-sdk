...
func NewApiSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20180101:ApiSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiSchema(ctx *pulumi.Context,
	...
	var resource ApiSchema
	err := ctx.ReadResource("azure-native:apimanagement/v20180101:ApiSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
