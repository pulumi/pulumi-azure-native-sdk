...
//
// Deprecated: azure-native:apimanagement/v20180101:ApiManagementService is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiManagementService to guarantee forwards compatibility.
...
func NewApiManagementService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20180101:ApiManagementService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiManagementService(ctx *pulumi.Context,
	...
	var resource ApiManagementService
	err := ctx.ReadResource("azure-native:apimanagement/v20180101:ApiManagementService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
