...
// API details.
//
// Deprecated: azure-native:apimanagement/v20180101:Api is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180601preview:Api to guarantee forwards compatibility.
type Api struct {
...
func NewApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.RegisterResource("azure-native:apimanagement/v20180101:Api", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.ReadResource("azure-native:apimanagement/v20180101:Api", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
