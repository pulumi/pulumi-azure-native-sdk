...
func NewTag(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:Tag"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:Tag"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:Tag"),
		},
	})
...
// The Azure API version of the resource.
func (o TagOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Tag) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
