...
func NewEmailTemplate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:EmailTemplate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:EmailTemplate"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:EmailTemplate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:EmailTemplate"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:EmailTemplate"),
		},
	})
...
// The Azure API version of the resource.
func (o EmailTemplateOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *EmailTemplate) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
