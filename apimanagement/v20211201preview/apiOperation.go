...
//
// Deprecated: azure-native:apimanagement/v20211201preview:ApiOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperation to guarantee forwards compatibility.
...
func NewApiOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20211201preview:ApiOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperation(ctx *pulumi.Context,
	...
	var resource ApiOperation
	err := ctx.ReadResource("azure-native:apimanagement/v20211201preview:ApiOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
