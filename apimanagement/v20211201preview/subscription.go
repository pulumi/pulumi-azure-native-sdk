...
func NewSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20211201preview:Subscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscription(ctx *pulumi.Context,
	...
	var resource Subscription
	err := ctx.ReadResource("azure-native:apimanagement/v20211201preview:Subscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
