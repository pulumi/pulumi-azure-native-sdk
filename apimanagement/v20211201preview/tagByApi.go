...
//
// Deprecated: azure-native:apimanagement/v20211201preview:TagByApi is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByApi to guarantee forwards compatibility.
...
func NewTagByApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20211201preview:TagByApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByApi(ctx *pulumi.Context,
	...
	var resource TagByApi
	err := ctx.ReadResource("azure-native:apimanagement/v20211201preview:TagByApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
