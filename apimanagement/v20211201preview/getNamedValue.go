...
//
// Deprecated: azure-native:apimanagement/v20211201preview:NamedValue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:NamedValue to guarantee forwards compatibility.
func LookupNamedValue(ctx *pulumi.Context, args *LookupNamedValueArgs, opts ...pulumi.InvokeOption) (*LookupNamedValueResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20211201preview:getNamedValue", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
