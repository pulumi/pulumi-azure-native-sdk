...
// API details.
//
// Deprecated: azure-native:apimanagement/v20211201preview:ProductApi is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ProductApi to guarantee forwards compatibility.
...
func NewProductApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20211201preview:ProductApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductApi(ctx *pulumi.Context,
	...
	var resource ProductApi
	err := ctx.ReadResource("azure-native:apimanagement/v20211201preview:ProductApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
