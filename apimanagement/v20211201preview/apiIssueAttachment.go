...
//
// Deprecated: azure-native:apimanagement/v20211201preview:ApiIssueAttachment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssueAttachment to guarantee forwards compatibility.
...
func NewApiIssueAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20211201preview:ApiIssueAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIssueAttachment(ctx *pulumi.Context,
	...
	var resource ApiIssueAttachment
	err := ctx.ReadResource("azure-native:apimanagement/v20211201preview:ApiIssueAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
