...
// Diagnostic details.
//
// Deprecated: azure-native:apimanagement/v20211201preview:Diagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Diagnostic to guarantee forwards compatibility.
...
func NewDiagnostic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20211201preview:Diagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnostic(ctx *pulumi.Context,
	...
	var resource Diagnostic
	err := ctx.ReadResource("azure-native:apimanagement/v20211201preview:Diagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
