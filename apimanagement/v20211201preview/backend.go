...
// Backend details.
//
// Deprecated: azure-native:apimanagement/v20211201preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Backend to guarantee forwards compatibility.
type Backend struct {
