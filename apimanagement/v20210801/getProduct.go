...
//
// Deprecated: azure-native:apimanagement/v20210801:Product is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Product to guarantee forwards compatibility.
func LookupProduct(ctx *pulumi.Context, args *LookupProductArgs, opts ...pulumi.InvokeOption) (*LookupProductResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20210801:getProduct", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
