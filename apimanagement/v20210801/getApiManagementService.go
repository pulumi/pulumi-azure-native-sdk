...
//
// Deprecated: azure-native:apimanagement/v20210801:ApiManagementService is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiManagementService to guarantee forwards compatibility.
func LookupApiManagementService(ctx *pulumi.Context, args *LookupApiManagementServiceArgs, opts ...pulumi.InvokeOption) (*LookupApiManagementServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20210801:getApiManagementService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
