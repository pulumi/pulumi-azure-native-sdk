...
func NewApiPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210801:ApiPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPolicy(ctx *pulumi.Context,
	...
	var resource ApiPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20210801:ApiPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
