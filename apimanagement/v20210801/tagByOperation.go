...
func NewTagByOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210801:TagByOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagByOperation(ctx *pulumi.Context,
	...
	var resource TagByOperation
	err := ctx.ReadResource("azure-native:apimanagement/v20210801:TagByOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
