...
//
// Deprecated: azure-native:apimanagement/v20210801:Tag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Tag to guarantee forwards compatibility.
func LookupTag(ctx *pulumi.Context, args *LookupTagArgs, opts ...pulumi.InvokeOption) (*LookupTagResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20210801:getTag", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
