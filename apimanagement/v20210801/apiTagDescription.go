...
// Contract details.
//
// Deprecated: azure-native:apimanagement/v20210801:ApiTagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiTagDescription to guarantee forwards compatibility.
...
func NewApiTagDescription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20210801:ApiTagDescription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiTagDescription(ctx *pulumi.Context,
	...
	var resource ApiTagDescription
	err := ctx.ReadResource("azure-native:apimanagement/v20210801:ApiTagDescription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
