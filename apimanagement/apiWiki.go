...
//
// Other available API versions: 2022-08-01, 2022-09-01-preview, 2023-03-01-preview, 2023-05-01-preview, 2023-09-01-preview, 2024-06-01-preview, 2024-10-01-preview, 2025-03-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native apimanagement [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
type ApiWiki struct {
...
func NewApiWiki(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ApiWiki"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:ApiWiki"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:ApiWiki"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ApiWiki"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiWiki"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApiWiki
	err := ctx.RegisterResource("azure-native:apimanagement:ApiWiki", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiWiki(ctx *pulumi.Context,
	...
	var resource ApiWiki
	err := ctx.ReadResource("azure-native:apimanagement:ApiWiki", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ApiWikiOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ApiWiki) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
