...
func NewUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.RegisterResource("azure-native:apimanagement/v20170301:User", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.ReadResource("azure-native:apimanagement/v20170301:User", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Collection of groups user is part of.
func (o UserOutput) Groups() GroupContractResponseArrayOutput {
	return o.ApplyT(func(v *User) GroupContractResponseArrayOutput { return v.Groups }).(GroupContractResponseArrayOutput)
}
