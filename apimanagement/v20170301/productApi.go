...
func NewProductApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20170301:ProductApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductApi(ctx *pulumi.Context,
	...
	var resource ProductApi
	err := ctx.ReadResource("azure-native:apimanagement/v20170301:ProductApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Api Version Set Contract details.
func (o ProductApiOutput) ApiVersionSet() ApiVersionSetContractResponsePtrOutput {
	return o.ApplyT(func(v *ProductApi) ApiVersionSetContractResponsePtrOutput { return v.ApiVersionSet }).(ApiVersionSetContractResponsePtrOutput)
}
