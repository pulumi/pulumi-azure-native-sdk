...
//
// Deprecated: azure-native:apimanagement/v20170301:Property is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:Property to guarantee forwards compatibility.
func LookupProperty(ctx *pulumi.Context, args *LookupPropertyArgs, opts ...pulumi.InvokeOption) (*LookupPropertyResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20170301:getProperty", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
