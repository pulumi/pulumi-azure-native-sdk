...
//
// Deprecated: azure-native:apimanagement/v20170301:Tag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Tag to guarantee forwards compatibility.
type Tag struct {
...
func NewTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.RegisterResource("azure-native:apimanagement/v20170301:Tag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.ReadResource("azure-native:apimanagement/v20170301:Tag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
