...
//
// Deprecated: azure-native:apimanagement/v20170301:ApiIssueAttachment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssueAttachment to guarantee forwards compatibility.
func LookupApiIssueAttachment(ctx *pulumi.Context, args *LookupApiIssueAttachmentArgs, opts ...pulumi.InvokeOption) (*LookupApiIssueAttachmentResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20170301:getApiIssueAttachment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
