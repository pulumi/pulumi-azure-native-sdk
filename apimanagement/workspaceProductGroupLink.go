...
func NewWorkspaceProductGroupLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:WorkspaceProductGroupLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:WorkspaceProductGroupLink"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:WorkspaceProductGroupLink"),
		},
	})
