...
func NewProductGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:ProductGroup"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ProductGroup"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ProductGroup"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ProductGroup"),
		},
	})
...
// The Azure API version of the resource.
func (o ProductGroupOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ProductGroup) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
