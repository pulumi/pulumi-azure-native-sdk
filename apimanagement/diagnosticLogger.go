...
func NewDiagnosticLogger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement:DiagnosticLogger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnosticLogger(ctx *pulumi.Context,
	...
	var resource DiagnosticLogger
	err := ctx.ReadResource("azure-native:apimanagement:DiagnosticLogger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
