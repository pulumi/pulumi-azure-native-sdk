...
func NewDiagnostic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20230301preview:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230501preview:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20230901preview:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240501:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20240601preview:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:Diagnostic"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Diagnostic
	err := ctx.RegisterResource("azure-native:apimanagement:Diagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnostic(ctx *pulumi.Context,
	...
	var resource Diagnostic
	err := ctx.ReadResource("azure-native:apimanagement:Diagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
