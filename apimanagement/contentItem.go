...
func NewContentItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ContentItem"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ContentItem"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ContentItem"),
		},
	})
