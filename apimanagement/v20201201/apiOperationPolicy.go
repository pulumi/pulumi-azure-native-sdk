...
//
// Deprecated: azure-native:apimanagement/v20201201:ApiOperationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperationPolicy to guarantee forwards compatibility.
...
func NewApiOperationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20201201:ApiOperationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiOperationPolicy(ctx *pulumi.Context,
	...
	var resource ApiOperationPolicy
	err := ctx.ReadResource("azure-native:apimanagement/v20201201:ApiOperationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
