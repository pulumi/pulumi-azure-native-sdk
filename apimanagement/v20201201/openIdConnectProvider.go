...
//
// Deprecated: azure-native:apimanagement/v20201201:OpenIdConnectProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:OpenIdConnectProvider to guarantee forwards compatibility.
...
func NewOpenIdConnectProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20201201:OpenIdConnectProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenIdConnectProvider(ctx *pulumi.Context,
	...
	var resource OpenIdConnectProvider
	err := ctx.ReadResource("azure-native:apimanagement/v20201201:OpenIdConnectProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
