...
//
// Deprecated: azure-native:apimanagement/v20201201:ProductPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ProductPolicy to guarantee forwards compatibility.
func LookupProductPolicy(ctx *pulumi.Context, args *LookupProductPolicyArgs, opts ...pulumi.InvokeOption) (*LookupProductPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20201201:getProductPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
