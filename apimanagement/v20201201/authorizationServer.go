...
//
// Deprecated: azure-native:apimanagement/v20201201:AuthorizationServer is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:AuthorizationServer to guarantee forwards compatibility.
...
func NewAuthorizationServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20201201:AuthorizationServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationServer(ctx *pulumi.Context,
	...
	var resource AuthorizationServer
	err := ctx.ReadResource("azure-native:apimanagement/v20201201:AuthorizationServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
