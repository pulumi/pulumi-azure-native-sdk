...
func NewDiagnostic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apimanagement/v20201201:Diagnostic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnostic(ctx *pulumi.Context,
	...
	var resource Diagnostic
	err := ctx.ReadResource("azure-native:apimanagement/v20201201:Diagnostic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
