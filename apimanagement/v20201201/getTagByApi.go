...
//
// Deprecated: azure-native:apimanagement/v20201201:TagByApi is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByApi to guarantee forwards compatibility.
func LookupTagByApi(ctx *pulumi.Context, args *LookupTagByApiArgs, opts ...pulumi.InvokeOption) (*LookupTagByApiResult, error) {
	...
	err := ctx.Invoke("azure-native:apimanagement/v20201201:getTagByApi", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
