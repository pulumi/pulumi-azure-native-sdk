...
func NewApiRelease(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:apimanagement/v20241001preview:ApiRelease"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250301preview:ApiRelease"),
		},
		{
			Type: pulumi.String("azure-native:apimanagement/v20250901preview:ApiRelease"),
		},
	})
