...
func NewInput(ctx *pulumi.Context,
	...
	var resource Input
	err := ctx.RegisterResource("azure-native:streamanalytics/v20200301:Input", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInput(ctx *pulumi.Context,
	...
	var resource Input
	err := ctx.ReadResource("azure-native:streamanalytics/v20200301:Input", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
