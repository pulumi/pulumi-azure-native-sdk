...
func NewFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:streamanalytics/v20170401preview:Function", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunction(ctx *pulumi.Context,
	...
	var resource Function
	err := ctx.ReadResource("azure-native:streamanalytics/v20170401preview:Function", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
