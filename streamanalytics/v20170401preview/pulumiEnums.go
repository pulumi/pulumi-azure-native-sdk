...
// StreamingJobSkuNameInput is an input type that accepts values of the StreamingJobSkuName enum
// A concrete instance of `StreamingJobSkuNameInput` can be one of the following:
//
...
func (in *streamingJobSkuNamePtr) ToOutput(ctx context.Context) pulumix.Output[*StreamingJobSkuName] {
	return pulumix.Output[*StreamingJobSkuName]{
		OutputState: in.ToStreamingJobSkuNamePtrOutputWithContext(ctx).OutputState,
	}
}
