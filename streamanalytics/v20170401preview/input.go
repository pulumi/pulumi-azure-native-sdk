...
//
// Deprecated: azure-native:streamanalytics/v20170401preview:Input is being removed in the next major version of this provider. Upgrade to at least azure-native:streamanalytics/v20211001preview:Input to guarantee forwards compatibility.
type Input struct {
