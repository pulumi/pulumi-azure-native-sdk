...
//
// Deprecated: azure-native:streamanalytics/v20160301:Output is being removed in the next major version of this provider. Upgrade to at least azure-native:streamanalytics/v20211001preview:Output to guarantee forwards compatibility.
type Output struct {
...
func NewOutput(ctx *pulumi.Context,
	...
	var resource Output
	err := ctx.RegisterResource("azure-native:streamanalytics/v20160301:Output", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOutput(ctx *pulumi.Context,
	...
	var resource Output
	err := ctx.ReadResource("azure-native:streamanalytics/v20160301:Output", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
