...
func NewStreamingJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:streamanalytics/v20211001preview:StreamingJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingJob(ctx *pulumi.Context,
	...
	var resource StreamingJob
	err := ctx.ReadResource("azure-native:streamanalytics/v20211001preview:StreamingJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
