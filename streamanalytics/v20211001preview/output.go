...
func NewOutput(ctx *pulumi.Context,
	...
	var resource Output
	err := ctx.RegisterResource("azure-native:streamanalytics/v20211001preview:Output", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOutput(ctx *pulumi.Context,
	...
	var resource Output
	err := ctx.ReadResource("azure-native:streamanalytics/v20211001preview:Output", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
