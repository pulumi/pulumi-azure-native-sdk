...
// CapacitySkuTierInput is an input type that accepts values of the CapacitySkuTier enum
// A concrete instance of `CapacitySkuTierInput` can be one of the following:
//
...
// VCoreSkuTierInput is an input type that accepts values of the VCoreSkuTier enum
// A concrete instance of `VCoreSkuTierInput` can be one of the following:
//
