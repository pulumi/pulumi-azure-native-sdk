...
type FileShareSnapshotPropertiesArgs struct {
	// The initiator of the FileShareSnapshot. This is a user-defined value.
	InitiatorId pulumi.StringPtrInput `pulumi:"initiatorId"`
	// The metadata
...
// The initiator of the FileShareSnapshot. This is a user-defined value.
func (o FileShareSnapshotPropertiesOutput) InitiatorId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FileShareSnapshotProperties) *string { return v.InitiatorId }).(pulumi.StringPtrOutput)
}
...
// The initiator of the FileShareSnapshot. This is a user-defined value.
func (o FileShareSnapshotPropertiesPtrOutput) InitiatorId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FileShareSnapshotProperties) *string {
		if v == nil {
			return nil
		}
		return v.InitiatorId
	}).(pulumi.StringPtrOutput)
}
...
// The initiator of the FileShareSnapshot. This is a user-defined value.
func (o FileShareSnapshotPropertiesResponseOutput) InitiatorId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FileShareSnapshotPropertiesResponse) *string { return v.InitiatorId }).(pulumi.StringPtrOutput)
}
