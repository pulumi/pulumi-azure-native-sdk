...
func NewMachinePool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:redhatopenshift/v20230904:MachinePool"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MachinePool
	err := ctx.RegisterResource("azure-native:redhatopenshift/v20230401:MachinePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachinePool(ctx *pulumi.Context,
	...
	var resource MachinePool
	err := ctx.ReadResource("azure-native:redhatopenshift/v20230401:MachinePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
