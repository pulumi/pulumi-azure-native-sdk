...
func LookupMachinePool(ctx *pulumi.Context, args *LookupMachinePoolArgs, opts ...pulumi.InvokeOption) (*LookupMachinePoolResult, error) {
	...
	err := ctx.Invoke("azure-native:redhatopenshift/v20230401:getMachinePool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMachinePoolOutput(ctx *pulumi.Context, args LookupMachinePoolOutputArgs, opts ...pulumi.InvokeOption) LookupMachinePoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMachinePoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:redhatopenshift/v20230401:getMachinePool", args, LookupMachinePoolResultOutput{}, options).(LookupMachinePoolResultOutput), nil
