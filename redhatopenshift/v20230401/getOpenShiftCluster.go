...
func LookupOpenShiftCluster(ctx *pulumi.Context, args *LookupOpenShiftClusterArgs, opts ...pulumi.InvokeOption) (*LookupOpenShiftClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:redhatopenshift/v20230401:getOpenShiftCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupOpenShiftClusterOutput(ctx *pulumi.Context, args LookupOpenShiftClusterOutputArgs, opts ...pulumi.InvokeOption) LookupOpenShiftClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOpenShiftClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:redhatopenshift/v20230401:getOpenShiftCluster", args, LookupOpenShiftClusterResultOutput{}, options).(LookupOpenShiftClusterResultOutput), nil
