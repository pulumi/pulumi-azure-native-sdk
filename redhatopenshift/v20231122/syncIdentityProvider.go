...
func NewSyncIdentityProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:redhatopenshift/v20231122:SyncIdentityProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncIdentityProvider(ctx *pulumi.Context,
	...
	var resource SyncIdentityProvider
	err := ctx.ReadResource("azure-native:redhatopenshift/v20231122:SyncIdentityProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
