...
func NewMachinePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:redhatopenshift/v20231122:MachinePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachinePool(ctx *pulumi.Context,
	...
	var resource MachinePool
	err := ctx.ReadResource("azure-native:redhatopenshift/v20231122:MachinePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
