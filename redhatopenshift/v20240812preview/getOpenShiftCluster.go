...
func LookupOpenShiftCluster(ctx *pulumi.Context, args *LookupOpenShiftClusterArgs, opts ...pulumi.InvokeOption) (*LookupOpenShiftClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:redhatopenshift/v20240812preview:getOpenShiftCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupOpenShiftClusterResult struct {
	...
	PlatformWorkloadIdentityProfile *PlatformWorkloadIdentityProfileResponse `pulumi:"platformWorkloadIdentityProfile"`
...
func LookupOpenShiftClusterOutput(ctx *pulumi.Context, args LookupOpenShiftClusterOutputArgs, opts ...pulumi.InvokeOption) LookupOpenShiftClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOpenShiftClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:redhatopenshift/v20240812preview:getOpenShiftCluster", args, LookupOpenShiftClusterResultOutput{}, options).(LookupOpenShiftClusterResultOutput), nil
...
// Identity stores information about the cluster MSI(s) in a workload identity cluster.
func (o LookupOpenShiftClusterResultOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupOpenShiftClusterResult) *ManagedServiceIdentityResponse { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}
...
// The workload identity profile.
func (o LookupOpenShiftClusterResultOutput) PlatformWorkloadIdentityProfile() PlatformWorkloadIdentityProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupOpenShiftClusterResult) *PlatformWorkloadIdentityProfileResponse {
