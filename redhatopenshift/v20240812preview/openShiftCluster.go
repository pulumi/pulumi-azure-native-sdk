...
type OpenShiftCluster struct {
	...
	PlatformWorkloadIdentityProfile PlatformWorkloadIdentityProfileResponsePtrOutput `pulumi:"platformWorkloadIdentityProfile"`
...
func NewOpenShiftCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:redhatopenshift/v20230401:OpenShiftCluster"),
		},
		{
			Type: pulumi.String("azure-native:redhatopenshift/v20230701preview:OpenShiftCluster"),
		},
		{
			Type: pulumi.String("azure-native:redhatopenshift/v20230904:OpenShiftCluster"),
		},
		{
			Type: pulumi.String("azure-native:redhatopenshift/v20231122:OpenShiftCluster"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:redhatopenshift/v20240812preview:OpenShiftCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenShiftCluster(ctx *pulumi.Context,
	...
	var resource OpenShiftCluster
	err := ctx.ReadResource("azure-native:redhatopenshift/v20240812preview:OpenShiftCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type openShiftClusterArgs struct {
	...
	// The workload identity profile.
	PlatformWorkloadIdentityProfile *PlatformWorkloadIdentityProfile `pulumi:"platformWorkloadIdentityProfile"`
	// The cluster provisioning state.
...
type OpenShiftClusterArgs struct {
	...
	// The workload identity profile.
	PlatformWorkloadIdentityProfile PlatformWorkloadIdentityProfilePtrInput
	// The cluster provisioning state.
...
// Identity stores information about the cluster MSI(s) in a workload identity cluster.
func (o OpenShiftClusterOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v *OpenShiftCluster) ManagedServiceIdentityResponsePtrOutput { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}
...
// The workload identity profile.
func (o OpenShiftClusterOutput) PlatformWorkloadIdentityProfile() PlatformWorkloadIdentityProfileResponsePtrOutput {
	return o.ApplyT(func(v *OpenShiftCluster) PlatformWorkloadIdentityProfileResponsePtrOutput {
		return v.PlatformWorkloadIdentityProfile
	}).(PlatformWorkloadIdentityProfileResponsePtrOutput)
}
