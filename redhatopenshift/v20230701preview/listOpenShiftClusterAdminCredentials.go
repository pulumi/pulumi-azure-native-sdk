...
func ListOpenShiftClusterAdminCredentials(ctx *pulumi.Context, args *ListOpenShiftClusterAdminCredentialsArgs, opts ...pulumi.InvokeOption) (*ListOpenShiftClusterAdminCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:redhatopenshift/v20230701preview:listOpenShiftClusterAdminCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListOpenShiftClusterAdminCredentialsOutput(ctx *pulumi.Context, args ListOpenShiftClusterAdminCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListOpenShiftClusterAdminCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListOpenShiftClusterAdminCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:redhatopenshift/v20230701preview:listOpenShiftClusterAdminCredentials", args, ListOpenShiftClusterAdminCredentialsResultOutput{}, options).(ListOpenShiftClusterAdminCredentialsResultOutput), nil
