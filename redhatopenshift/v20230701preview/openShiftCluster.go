...
func NewOpenShiftCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:redhatopenshift/v20230701preview:OpenShiftCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenShiftCluster(ctx *pulumi.Context,
	...
	var resource OpenShiftCluster
	err := ctx.ReadResource("azure-native:redhatopenshift/v20230701preview:OpenShiftCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
