...
func ListOpenShiftClusterCredentials(ctx *pulumi.Context, args *ListOpenShiftClusterCredentialsArgs, opts ...pulumi.InvokeOption) (*ListOpenShiftClusterCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:redhatopenshift/v20230904:listOpenShiftClusterCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListOpenShiftClusterCredentialsOutput(ctx *pulumi.Context, args ListOpenShiftClusterCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListOpenShiftClusterCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListOpenShiftClusterCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:redhatopenshift/v20230904:listOpenShiftClusterCredentials", args, ListOpenShiftClusterCredentialsResultOutput{}, options).(ListOpenShiftClusterCredentialsResultOutput), nil
