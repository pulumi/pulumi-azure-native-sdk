...
func NewSyncSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:redhatopenshift/v20230904:SyncSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncSet(ctx *pulumi.Context,
	...
	var resource SyncSet
	err := ctx.ReadResource("azure-native:redhatopenshift/v20230904:SyncSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
