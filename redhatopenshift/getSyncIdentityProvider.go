...
func LookupSyncIdentityProviderOutput(ctx *pulumi.Context, args LookupSyncIdentityProviderOutputArgs, opts ...pulumi.InvokeOption) LookupSyncIdentityProviderResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSyncIdentityProviderResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:redhatopenshift:getSyncIdentityProvider", args, LookupSyncIdentityProviderResultOutput{}, options).(LookupSyncIdentityProviderResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSyncIdentityProviderResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSyncIdentityProviderResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSyncIdentityProviderResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSyncIdentityProviderResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
