...
func NewMachinePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:redhatopenshift:MachinePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachinePool(ctx *pulumi.Context,
	...
	var resource MachinePool
	err := ctx.ReadResource("azure-native:redhatopenshift:MachinePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o MachinePoolOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *MachinePool) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
