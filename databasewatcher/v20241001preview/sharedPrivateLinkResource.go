...
func NewSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databasewatcher/v20241001preview:SharedPrivateLinkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	var resource SharedPrivateLinkResource
	err := ctx.ReadResource("azure-native:databasewatcher/v20241001preview:SharedPrivateLinkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
