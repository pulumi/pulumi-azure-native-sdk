...
func NewTarget(ctx *pulumi.Context,
	...
	var resource Target
	err := ctx.RegisterResource("azure-native:databasewatcher/v20230901preview:Target", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTarget(ctx *pulumi.Context,
	...
	var resource Target
	err := ctx.ReadResource("azure-native:databasewatcher/v20230901preview:Target", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
