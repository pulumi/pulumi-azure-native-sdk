...
func LookupSharedPrivateLinkResource(ctx *pulumi.Context, args *LookupSharedPrivateLinkResourceArgs, opts ...pulumi.InvokeOption) (*LookupSharedPrivateLinkResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:databasewatcher/v20230901preview:getSharedPrivateLinkResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSharedPrivateLinkResourceOutput(ctx *pulumi.Context, args LookupSharedPrivateLinkResourceOutputArgs, opts ...pulumi.InvokeOption) LookupSharedPrivateLinkResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSharedPrivateLinkResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databasewatcher/v20230901preview:getSharedPrivateLinkResource", args, LookupSharedPrivateLinkResourceResultOutput{}, options).(LookupSharedPrivateLinkResourceResultOutput), nil
