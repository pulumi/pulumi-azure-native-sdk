...
func NewWatcher(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databasewatcher/v20240719preview:Watcher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatcher(ctx *pulumi.Context,
	...
	var resource Watcher
	err := ctx.ReadResource("azure-native:databasewatcher/v20240719preview:Watcher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
