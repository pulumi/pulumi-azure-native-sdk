...
func NewAlertRuleResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databasewatcher/v20250102:AlertRuleResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertRuleResource(ctx *pulumi.Context,
	...
	var resource AlertRuleResource
	err := ctx.ReadResource("azure-native:databasewatcher/v20250102:AlertRuleResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
