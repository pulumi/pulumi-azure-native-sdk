...
func NewCloudConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:hybridcloud/v20230101preview:CloudConnector"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CloudConnector
	err := ctx.RegisterResource("azure-native:hybridcloud:CloudConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudConnector(ctx *pulumi.Context,
	...
	var resource CloudConnector
	err := ctx.ReadResource("azure-native:hybridcloud:CloudConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
