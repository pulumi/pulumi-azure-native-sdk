...
func NewCloudConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:hybridcloud/v20230101preview:CloudConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CloudConnection
	err := ctx.RegisterResource("azure-native:hybridcloud:CloudConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudConnection(ctx *pulumi.Context,
	...
	var resource CloudConnection
	err := ctx.ReadResource("azure-native:hybridcloud:CloudConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CloudConnectionOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *CloudConnection) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
