...
// Gets the alert rule.
//
// Deprecated: azure-native:securityinsights/v20230201preview:FusionAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:FusionAlertRule to guarantee forwards compatibility.
