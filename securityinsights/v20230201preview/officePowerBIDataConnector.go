...
//
// Deprecated: azure-native:securityinsights/v20230201preview:OfficePowerBIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:OfficePowerBIDataConnector to guarantee forwards compatibility.
...
func NewOfficePowerBIDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230201preview:OfficePowerBIDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOfficePowerBIDataConnector(ctx *pulumi.Context,
	...
	var resource OfficePowerBIDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230201preview:OfficePowerBIDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
