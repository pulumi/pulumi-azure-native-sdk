...
//
// Deprecated: azure-native:securityinsights/v20230201preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.
...
func NewMLBehaviorAnalyticsAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230201preview:MLBehaviorAnalyticsAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMLBehaviorAnalyticsAlertRule(ctx *pulumi.Context,
	...
	var resource MLBehaviorAnalyticsAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20230201preview:MLBehaviorAnalyticsAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
