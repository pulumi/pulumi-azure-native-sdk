...
func NewSecurityMLAnalyticsSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230201preview:SecurityMLAnalyticsSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityMLAnalyticsSetting(ctx *pulumi.Context,
	...
	var resource SecurityMLAnalyticsSetting
	err := ctx.ReadResource("azure-native:securityinsights/v20230201preview:SecurityMLAnalyticsSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
