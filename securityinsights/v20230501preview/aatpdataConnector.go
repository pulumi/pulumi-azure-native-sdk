...
func NewAATPDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230501preview:AATPDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAATPDataConnector(ctx *pulumi.Context,
	...
	var resource AATPDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230501preview:AATPDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
