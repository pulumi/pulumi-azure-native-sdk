...
func NewAADDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230501preview:AADDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAADDataConnector(ctx *pulumi.Context,
	...
	var resource AADDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230501preview:AADDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
