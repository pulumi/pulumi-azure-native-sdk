...
func NewIncidentTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230501preview:IncidentTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncidentTask(ctx *pulumi.Context,
	...
	var resource IncidentTask
	err := ctx.ReadResource("azure-native:securityinsights/v20230501preview:IncidentTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
