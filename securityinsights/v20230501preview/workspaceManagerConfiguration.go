...
func NewWorkspaceManagerConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230501preview:WorkspaceManagerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceManagerConfiguration(ctx *pulumi.Context,
	...
	var resource WorkspaceManagerConfiguration
	err := ctx.ReadResource("azure-native:securityinsights/v20230501preview:WorkspaceManagerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
