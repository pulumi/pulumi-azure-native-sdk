...
func NewWorkspaceManagerMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230501preview:WorkspaceManagerMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceManagerMember(ctx *pulumi.Context,
	...
	var resource WorkspaceManagerMember
	err := ctx.ReadResource("azure-native:securityinsights/v20230501preview:WorkspaceManagerMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
