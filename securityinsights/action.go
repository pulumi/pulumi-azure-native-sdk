...
func NewAction(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221101:Action"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230701preview:Action"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:Action"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:Action"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:Action"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:Action"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:Action"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:Action"),
		},
		{
	...
	var resource Action
	err := ctx.RegisterResource("azure-native:securityinsights:Action", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAction(ctx *pulumi.Context,
	...
	var resource Action
	err := ctx.ReadResource("azure-native:securityinsights:Action", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ActionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Action) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
