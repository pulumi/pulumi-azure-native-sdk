...
func NewSentinelOnboardingState(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240401preview:SentinelOnboardingState", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSentinelOnboardingState(ctx *pulumi.Context,
	...
	var resource SentinelOnboardingState
	err := ctx.ReadResource("azure-native:securityinsights/v20240401preview:SentinelOnboardingState", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
