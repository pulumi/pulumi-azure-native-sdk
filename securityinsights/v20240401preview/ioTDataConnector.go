...
func NewIoTDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240401preview:IoTDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoTDataConnector(ctx *pulumi.Context,
	...
	var resource IoTDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20240401preview:IoTDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
