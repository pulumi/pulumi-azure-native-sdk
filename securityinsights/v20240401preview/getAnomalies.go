...
func LookupAnomalies(ctx *pulumi.Context, args *LookupAnomaliesArgs, opts ...pulumi.InvokeOption) (*LookupAnomaliesResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20240401preview:getAnomalies", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAnomaliesOutput(ctx *pulumi.Context, args LookupAnomaliesOutputArgs, opts ...pulumi.InvokeOption) LookupAnomaliesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAnomaliesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20240401preview:getAnomalies", args, LookupAnomaliesResultOutput{}, options).(LookupAnomaliesResultOutput), nil
