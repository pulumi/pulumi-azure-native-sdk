...
func NewMCASDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240401preview:MCASDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMCASDataConnector(ctx *pulumi.Context,
	...
	var resource MCASDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20240401preview:MCASDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
