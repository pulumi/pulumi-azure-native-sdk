...
func LookupGCPDataConnector(ctx *pulumi.Context, args *LookupGCPDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupGCPDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20240401preview:getGCPDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGCPDataConnectorOutput(ctx *pulumi.Context, args LookupGCPDataConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupGCPDataConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGCPDataConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20240401preview:getGCPDataConnector", args, LookupGCPDataConnectorResultOutput{}, options).(LookupGCPDataConnectorResultOutput), nil
