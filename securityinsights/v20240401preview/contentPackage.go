...
func NewContentPackage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:ContentPackage"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:ContentPackage"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240401preview:ContentPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentPackage(ctx *pulumi.Context,
	...
	var resource ContentPackage
	err := ctx.ReadResource("azure-native:securityinsights/v20240401preview:ContentPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
