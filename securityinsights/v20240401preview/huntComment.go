...
func NewHuntComment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240401preview:HuntComment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHuntComment(ctx *pulumi.Context,
	...
	var resource HuntComment
	err := ctx.ReadResource("azure-native:securityinsights/v20240401preview:HuntComment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
