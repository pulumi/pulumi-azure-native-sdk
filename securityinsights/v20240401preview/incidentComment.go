...
func NewIncidentComment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221201preview:IncidentComment"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201:IncidentComment"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230701preview:IncidentComment"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230801preview:IncidentComment"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:IncidentComment"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20231201preview:IncidentComment"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:IncidentComment"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:IncidentComment"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240401preview:IncidentComment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncidentComment(ctx *pulumi.Context,
	...
	var resource IncidentComment
	err := ctx.ReadResource("azure-native:securityinsights/v20240401preview:IncidentComment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
