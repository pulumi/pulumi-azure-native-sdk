...
func LookupIncidentRelation(ctx *pulumi.Context, args *LookupIncidentRelationArgs, opts ...pulumi.InvokeOption) (*LookupIncidentRelationResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20240301:getIncidentRelation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupIncidentRelationOutput(ctx *pulumi.Context, args LookupIncidentRelationOutputArgs, opts ...pulumi.InvokeOption) LookupIncidentRelationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIncidentRelationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20240301:getIncidentRelation", args, LookupIncidentRelationResultOutput{}, options).(LookupIncidentRelationResultOutput), nil
