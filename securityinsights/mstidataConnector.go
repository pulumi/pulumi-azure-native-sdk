...
func NewMSTIDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:MSTIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:MSTIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:MSTIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:MSTIDataConnector"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights:MSTIDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMSTIDataConnector(ctx *pulumi.Context,
	...
	var resource MSTIDataConnector
	err := ctx.ReadResource("azure-native:securityinsights:MSTIDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o MSTIDataConnectorOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *MSTIDataConnector) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o MSTIDataConnectorOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *MSTIDataConnector) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
