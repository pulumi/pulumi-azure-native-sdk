...
func NewWorkspaceManagerConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:WorkspaceManagerConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:WorkspaceManagerConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkspaceManagerConfiguration
	err := ctx.RegisterResource("azure-native:securityinsights:WorkspaceManagerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceManagerConfiguration(ctx *pulumi.Context,
	...
	var resource WorkspaceManagerConfiguration
	err := ctx.ReadResource("azure-native:securityinsights:WorkspaceManagerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WorkspaceManagerConfigurationOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *WorkspaceManagerConfiguration) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
