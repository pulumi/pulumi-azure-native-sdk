...
//
// Deprecated: azure-native:securityinsights/v20221101:IncidentRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:IncidentRelation to guarantee forwards compatibility.
func LookupIncidentRelation(ctx *pulumi.Context, args *LookupIncidentRelationArgs, opts ...pulumi.InvokeOption) (*LookupIncidentRelationResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20221101:getIncidentRelation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
