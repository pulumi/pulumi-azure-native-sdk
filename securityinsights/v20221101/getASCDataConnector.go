...
//
// Deprecated: azure-native:securityinsights/v20221101:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ASCDataConnector to guarantee forwards compatibility.
func LookupASCDataConnector(ctx *pulumi.Context, args *LookupASCDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupASCDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20221101:getASCDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
