...
func NewAutomationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221101:AutomationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutomationRule(ctx *pulumi.Context,
	...
	var resource AutomationRule
	err := ctx.ReadResource("azure-native:securityinsights/v20221101:AutomationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
