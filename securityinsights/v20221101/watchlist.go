...
//
// Deprecated: azure-native:securityinsights/v20221101:Watchlist is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.
...
func NewWatchlist(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221101:Watchlist", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatchlist(ctx *pulumi.Context,
	...
	var resource Watchlist
	err := ctx.ReadResource("azure-native:securityinsights/v20221101:Watchlist", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
