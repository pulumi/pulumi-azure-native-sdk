...
//
// Deprecated: azure-native:securityinsights/v20221101:AutomationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:AutomationRule to guarantee forwards compatibility.
func LookupAutomationRule(ctx *pulumi.Context, args *LookupAutomationRuleArgs, opts ...pulumi.InvokeOption) (*LookupAutomationRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20221101:getAutomationRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
