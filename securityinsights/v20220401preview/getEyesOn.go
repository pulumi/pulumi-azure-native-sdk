...
// Gets a setting.
//
// Deprecated: azure-native:securityinsights/v20220401preview:EyesOn is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:EyesOn to guarantee forwards compatibility.
func LookupEyesOn(ctx *pulumi.Context, args *LookupEyesOnArgs, opts ...pulumi.InvokeOption) (*LookupEyesOnResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220401preview:getEyesOn", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
