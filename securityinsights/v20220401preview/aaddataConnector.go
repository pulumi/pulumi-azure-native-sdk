...
//
// Deprecated: azure-native:securityinsights/v20220401preview:AADDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AADDataConnector to guarantee forwards compatibility.
...
func NewAADDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220401preview:AADDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAADDataConnector(ctx *pulumi.Context,
	...
	var resource AADDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20220401preview:AADDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
