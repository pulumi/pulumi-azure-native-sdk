...
//
// Deprecated: azure-native:securityinsights/v20220401preview:Dynamics365DataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Dynamics365DataConnector to guarantee forwards compatibility.
func LookupDynamics365DataConnector(ctx *pulumi.Context, args *LookupDynamics365DataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupDynamics365DataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220401preview:getDynamics365DataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
