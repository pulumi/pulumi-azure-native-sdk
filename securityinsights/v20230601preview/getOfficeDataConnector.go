...
func LookupOfficeDataConnector(ctx *pulumi.Context, args *LookupOfficeDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupOfficeDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20230601preview:getOfficeDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupOfficeDataConnectorOutput(ctx *pulumi.Context, args LookupOfficeDataConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupOfficeDataConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOfficeDataConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20230601preview:getOfficeDataConnector", args, LookupOfficeDataConnectorResultOutput{}, options).(LookupOfficeDataConnectorResultOutput), nil
