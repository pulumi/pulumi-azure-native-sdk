...
type MTPDataConnector struct {
	...
	FilteredProviders MtpFilteredProvidersResponsePtrOutput `pulumi:"filteredProviders"`
...
func NewMTPDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230301preview:MTPDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230401preview:MTPDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230501preview:MTPDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:MTPDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:MTPDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:MTPDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:MTPDataConnector"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230601preview:MTPDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMTPDataConnector(ctx *pulumi.Context,
	...
	var resource MTPDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230601preview:MTPDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type mtpdataConnectorArgs struct {
	...
	// The available filtered providers for the connector.
	FilteredProviders *MtpFilteredProviders `pulumi:"filteredProviders"`
	// The kind of the data connector
	// Expected value is 'MicrosoftThreatProtection'.
...
type MTPDataConnectorArgs struct {
	...
	// The available filtered providers for the connector.
	FilteredProviders MtpFilteredProvidersPtrInput
	// The kind of the data connector
	// Expected value is 'MicrosoftThreatProtection'.
...
// The available filtered providers for the connector.
func (o MTPDataConnectorOutput) FilteredProviders() MtpFilteredProvidersResponsePtrOutput {
	return o.ApplyT(func(v *MTPDataConnector) MtpFilteredProvidersResponsePtrOutput { return v.FilteredProviders }).(MtpFilteredProvidersResponsePtrOutput)
}
