...
func NewHuntRelation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231201preview:HuntRelation"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:HuntRelation"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:HuntRelation"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:HuntRelation"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230601preview:HuntRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHuntRelation(ctx *pulumi.Context,
	...
	var resource HuntRelation
	err := ctx.ReadResource("azure-native:securityinsights/v20230601preview:HuntRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
