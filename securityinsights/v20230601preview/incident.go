...
func NewIncident(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221201preview:Incident"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230701preview:Incident"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230801preview:Incident"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:Incident"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:Incident"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:Incident"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:Incident"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:Incident"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Incident
	err := ctx.RegisterResource("azure-native:securityinsights/v20230601preview:Incident", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncident(ctx *pulumi.Context,
	...
	var resource Incident
	err := ctx.ReadResource("azure-native:securityinsights/v20230601preview:Incident", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
