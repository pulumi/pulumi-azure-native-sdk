...
func NewScheduledAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230601preview:ScheduledAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledAlertRule(ctx *pulumi.Context,
	...
	var resource ScheduledAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20230601preview:ScheduledAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
