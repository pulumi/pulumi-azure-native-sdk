...
func NewBookmark(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231101:Bookmark", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBookmark(ctx *pulumi.Context,
	...
	var resource Bookmark
	err := ctx.ReadResource("azure-native:securityinsights/v20231101:Bookmark", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
