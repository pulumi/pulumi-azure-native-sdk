...
func LookupScheduledAlertRule(ctx *pulumi.Context, args *LookupScheduledAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupScheduledAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20230801preview:getScheduledAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupScheduledAlertRuleOutput(ctx *pulumi.Context, args LookupScheduledAlertRuleOutputArgs, opts ...pulumi.InvokeOption) LookupScheduledAlertRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScheduledAlertRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20230801preview:getScheduledAlertRule", args, LookupScheduledAlertRuleResultOutput{}, options).(LookupScheduledAlertRuleResultOutput), nil
