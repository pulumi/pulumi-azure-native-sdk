...
func (o LookupMDATPDataConnectorResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupMDATPDataConnectorResult] {
	return pulumix.Output[LookupMDATPDataConnectorResult]{
