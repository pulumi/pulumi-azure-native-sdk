...
func NewOfficePowerBIDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221001preview:OfficePowerBIDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221201preview:OfficePowerBIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201:OfficePowerBIDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230401preview:OfficePowerBIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230501preview:OfficePowerBIDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:OfficePowerBIDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:OfficePowerBIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:OfficePowerBIDataConnector"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230801preview:OfficePowerBIDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOfficePowerBIDataConnector(ctx *pulumi.Context,
	...
	var resource OfficePowerBIDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230801preview:OfficePowerBIDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
