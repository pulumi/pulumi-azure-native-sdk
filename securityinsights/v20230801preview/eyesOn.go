...
func NewEyesOn(ctx *pulumi.Context,
	...
	var resource EyesOn
	err := ctx.RegisterResource("azure-native:securityinsights/v20230801preview:EyesOn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEyesOn(ctx *pulumi.Context,
	...
	var resource EyesOn
	err := ctx.ReadResource("azure-native:securityinsights/v20230801preview:EyesOn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
