...
func NewMSTIDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230801preview:MSTIDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMSTIDataConnector(ctx *pulumi.Context,
	...
	var resource MSTIDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230801preview:MSTIDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
