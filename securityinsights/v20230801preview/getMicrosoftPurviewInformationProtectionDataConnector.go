...
func LookupMicrosoftPurviewInformationProtectionDataConnector(ctx *pulumi.Context, args *LookupMicrosoftPurviewInformationProtectionDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupMicrosoftPurviewInformationProtectionDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20230801preview:getMicrosoftPurviewInformationProtectionDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMicrosoftPurviewInformationProtectionDataConnectorOutput(ctx *pulumi.Context, args LookupMicrosoftPurviewInformationProtectionDataConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupMicrosoftPurviewInformationProtectionDataConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMicrosoftPurviewInformationProtectionDataConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20230801preview:getMicrosoftPurviewInformationProtectionDataConnector", args, LookupMicrosoftPurviewInformationProtectionDataConnectorResultOutput{}, options).(LookupMicrosoftPurviewInformationProtectionDataConnectorResultOutput), nil
