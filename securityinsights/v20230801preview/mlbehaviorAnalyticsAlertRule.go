...
func NewMLBehaviorAnalyticsAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230801preview:MLBehaviorAnalyticsAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMLBehaviorAnalyticsAlertRule(ctx *pulumi.Context,
	...
	var resource MLBehaviorAnalyticsAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20230801preview:MLBehaviorAnalyticsAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *MLBehaviorAnalyticsAlertRule) ToOutput(ctx context.Context) pulumix.Output[*MLBehaviorAnalyticsAlertRule] {
	return pulumix.Output[*MLBehaviorAnalyticsAlertRule]{
		OutputState: i.ToMLBehaviorAnalyticsAlertRuleOutputWithContext(ctx).OutputState,
	}
}
...
func (o MLBehaviorAnalyticsAlertRuleOutput) ToOutput(ctx context.Context) pulumix.Output[*MLBehaviorAnalyticsAlertRule] {
	return pulumix.Output[*MLBehaviorAnalyticsAlertRule]{
