...
func (o LookupOfficeDataConnectorResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOfficeDataConnectorResult] {
	return pulumix.Output[LookupOfficeDataConnectorResult]{
