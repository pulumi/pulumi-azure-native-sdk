...
func NewHunt(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:Hunt"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:Hunt"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:Hunt"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Hunt
	err := ctx.RegisterResource("azure-native:securityinsights/v20230801preview:Hunt", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHunt(ctx *pulumi.Context,
	...
	var resource Hunt
	err := ctx.ReadResource("azure-native:securityinsights/v20230801preview:Hunt", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
