...
func NewFileImport(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230601preview:FileImport"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231201preview:FileImport"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:FileImport"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:FileImport"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230801preview:FileImport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileImport(ctx *pulumi.Context,
	...
	var resource FileImport
	err := ctx.ReadResource("azure-native:securityinsights/v20230801preview:FileImport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
