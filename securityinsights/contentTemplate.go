...
func NewContentTemplate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:ContentTemplate"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:ContentTemplate"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:ContentTemplate"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:ContentTemplate"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ContentTemplate
	err := ctx.RegisterResource("azure-native:securityinsights:ContentTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentTemplate(ctx *pulumi.Context,
	...
	var resource ContentTemplate
	err := ctx.ReadResource("azure-native:securityinsights:ContentTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ContentTemplateOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ContentTemplate) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ContentTemplateOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ContentTemplate) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
