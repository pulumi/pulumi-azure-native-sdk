...
func LookupIncidentTask(ctx *pulumi.Context, args *LookupIncidentTaskArgs, opts ...pulumi.InvokeOption) (*LookupIncidentTaskResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20241001preview:getIncidentTask", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupIncidentTaskOutput(ctx *pulumi.Context, args LookupIncidentTaskOutputArgs, opts ...pulumi.InvokeOption) LookupIncidentTaskResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIncidentTaskResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20241001preview:getIncidentTask", args, LookupIncidentTaskResultOutput{}, options).(LookupIncidentTaskResultOutput), nil
