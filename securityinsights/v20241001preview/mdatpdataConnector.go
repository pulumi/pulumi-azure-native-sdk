...
func NewMDATPDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:MDATPDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMDATPDataConnector(ctx *pulumi.Context,
	...
	var resource MDATPDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:MDATPDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
