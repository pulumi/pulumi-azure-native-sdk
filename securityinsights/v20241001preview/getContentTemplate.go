...
func LookupContentTemplate(ctx *pulumi.Context, args *LookupContentTemplateArgs, opts ...pulumi.InvokeOption) (*LookupContentTemplateResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20241001preview:getContentTemplate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupContentTemplateOutput(ctx *pulumi.Context, args LookupContentTemplateOutputArgs, opts ...pulumi.InvokeOption) LookupContentTemplateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContentTemplateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20241001preview:getContentTemplate", args, LookupContentTemplateResultOutput{}, options).(LookupContentTemplateResultOutput), nil
