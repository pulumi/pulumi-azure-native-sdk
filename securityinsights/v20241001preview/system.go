...
func NewSystem(ctx *pulumi.Context,
	...
	var resource System
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:System", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSystem(ctx *pulumi.Context,
	...
	var resource System
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:System", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
