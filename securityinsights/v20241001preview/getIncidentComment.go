...
func LookupIncidentComment(ctx *pulumi.Context, args *LookupIncidentCommentArgs, opts ...pulumi.InvokeOption) (*LookupIncidentCommentResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20241001preview:getIncidentComment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupIncidentCommentOutput(ctx *pulumi.Context, args LookupIncidentCommentOutputArgs, opts ...pulumi.InvokeOption) LookupIncidentCommentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIncidentCommentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20241001preview:getIncidentComment", args, LookupIncidentCommentResultOutput{}, options).(LookupIncidentCommentResultOutput), nil
