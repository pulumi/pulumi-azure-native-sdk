...
func ListGeodataByIp(ctx *pulumi.Context, args *ListGeodataByIpArgs, opts ...pulumi.InvokeOption) (*ListGeodataByIpResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20241001preview:listGeodataByIp", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListGeodataByIpOutput(ctx *pulumi.Context, args ListGeodataByIpOutputArgs, opts ...pulumi.InvokeOption) ListGeodataByIpResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListGeodataByIpResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20241001preview:listGeodataByIp", args, ListGeodataByIpResultOutput{}, options).(ListGeodataByIpResultOutput), nil
