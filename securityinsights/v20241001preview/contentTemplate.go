...
func NewContentTemplate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:ContentTemplate"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:ContentTemplate"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:ContentTemplate"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:ContentTemplate"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:ContentTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentTemplate(ctx *pulumi.Context,
	...
	var resource ContentTemplate
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:ContentTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
