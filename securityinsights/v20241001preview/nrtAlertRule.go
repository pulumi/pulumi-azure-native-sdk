...
func NewNrtAlertRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:NrtAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:NrtAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:NrtAlertRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:NrtAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNrtAlertRule(ctx *pulumi.Context,
	...
	var resource NrtAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:NrtAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type NrtAlertRuleArgs struct {
	...
	// The sub-techniques of the alert rule
	SubTechniques pulumi.StringArrayInput
	// The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
...
// The sub-techniques of the alert rule
func (o NrtAlertRuleOutput) SubTechniques() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *NrtAlertRule) pulumi.StringArrayOutput { return v.SubTechniques }).(pulumi.StringArrayOutput)
}
