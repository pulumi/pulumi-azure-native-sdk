...
func NewAnomalySecurityMLAnalyticsSettings(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230801preview:AnomalySecurityMLAnalyticsSettings"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:AnomalySecurityMLAnalyticsSettings"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:AnomalySecurityMLAnalyticsSettings"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:AnomalySecurityMLAnalyticsSettings"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AnomalySecurityMLAnalyticsSettings
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:AnomalySecurityMLAnalyticsSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnomalySecurityMLAnalyticsSettings(ctx *pulumi.Context,
	...
	var resource AnomalySecurityMLAnalyticsSettings
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:AnomalySecurityMLAnalyticsSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
