...
func NewActivityCustomEntityQuery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:ActivityCustomEntityQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActivityCustomEntityQuery(ctx *pulumi.Context,
	...
	var resource ActivityCustomEntityQuery
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:ActivityCustomEntityQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
