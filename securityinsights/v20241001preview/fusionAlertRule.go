...
func NewFusionAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:FusionAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFusionAlertRule(ctx *pulumi.Context,
	...
	var resource FusionAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:FusionAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The sub-techniques of the alert rule
func (o FusionAlertRuleOutput) SubTechniques() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *FusionAlertRule) pulumi.StringArrayOutput { return v.SubTechniques }).(pulumi.StringArrayOutput)
}
