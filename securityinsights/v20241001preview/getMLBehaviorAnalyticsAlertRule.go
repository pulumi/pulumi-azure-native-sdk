...
func LookupMLBehaviorAnalyticsAlertRule(ctx *pulumi.Context, args *LookupMLBehaviorAnalyticsAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupMLBehaviorAnalyticsAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20241001preview:getMLBehaviorAnalyticsAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMLBehaviorAnalyticsAlertRuleOutput(ctx *pulumi.Context, args LookupMLBehaviorAnalyticsAlertRuleOutputArgs, opts ...pulumi.InvokeOption) LookupMLBehaviorAnalyticsAlertRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMLBehaviorAnalyticsAlertRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20241001preview:getMLBehaviorAnalyticsAlertRule", args, LookupMLBehaviorAnalyticsAlertRuleResultOutput{}, options).(LookupMLBehaviorAnalyticsAlertRuleResultOutput), nil
