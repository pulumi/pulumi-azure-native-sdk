...
func LookupCodelessApiPollingDataConnector(ctx *pulumi.Context, args *LookupCodelessApiPollingDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupCodelessApiPollingDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20241001preview:getCodelessApiPollingDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCodelessApiPollingDataConnectorOutput(ctx *pulumi.Context, args LookupCodelessApiPollingDataConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupCodelessApiPollingDataConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCodelessApiPollingDataConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20241001preview:getCodelessApiPollingDataConnector", args, LookupCodelessApiPollingDataConnectorResultOutput{}, options).(LookupCodelessApiPollingDataConnectorResultOutput), nil
