...
func NewBookmarkRelation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230701preview:BookmarkRelation"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:BookmarkRelation"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:BookmarkRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBookmarkRelation(ctx *pulumi.Context,
	...
	var resource BookmarkRelation
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:BookmarkRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
