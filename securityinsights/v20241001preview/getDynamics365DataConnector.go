...
func LookupDynamics365DataConnector(ctx *pulumi.Context, args *LookupDynamics365DataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupDynamics365DataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20241001preview:getDynamics365DataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDynamics365DataConnectorOutput(ctx *pulumi.Context, args LookupDynamics365DataConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupDynamics365DataConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDynamics365DataConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20241001preview:getDynamics365DataConnector", args, LookupDynamics365DataConnectorResultOutput{}, options).(LookupDynamics365DataConnectorResultOutput), nil
