...
func NewIncidentTask(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:IncidentTask"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20241001preview:IncidentTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncidentTask(ctx *pulumi.Context,
	...
	var resource IncidentTask
	err := ctx.ReadResource("azure-native:securityinsights/v20241001preview:IncidentTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
