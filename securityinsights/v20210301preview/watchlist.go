...
func NewWatchlist(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20210301preview:Watchlist", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatchlist(ctx *pulumi.Context,
	...
	var resource Watchlist
	err := ctx.ReadResource("azure-native:securityinsights/v20210301preview:Watchlist", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
