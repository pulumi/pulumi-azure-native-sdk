...
func NewIncidentRelation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20210301preview:IncidentRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncidentRelation(ctx *pulumi.Context,
	...
	var resource IncidentRelation
	err := ctx.ReadResource("azure-native:securityinsights/v20210301preview:IncidentRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
