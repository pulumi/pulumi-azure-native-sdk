...
func NewWorkspaceManagerAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231201preview:WorkspaceManagerAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceManagerAssignment(ctx *pulumi.Context,
	...
	var resource WorkspaceManagerAssignment
	err := ctx.ReadResource("azure-native:securityinsights/v20231201preview:WorkspaceManagerAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
