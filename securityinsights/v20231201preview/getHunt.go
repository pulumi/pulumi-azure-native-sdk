...
func LookupHunt(ctx *pulumi.Context, args *LookupHuntArgs, opts ...pulumi.InvokeOption) (*LookupHuntResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20231201preview:getHunt", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupHuntOutput(ctx *pulumi.Context, args LookupHuntOutputArgs, opts ...pulumi.InvokeOption) LookupHuntResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHuntResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20231201preview:getHunt", args, LookupHuntResultOutput{}, options).(LookupHuntResultOutput), nil
