...
func NewMLBehaviorAnalyticsAlertRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:MLBehaviorAnalyticsAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:MLBehaviorAnalyticsAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:MLBehaviorAnalyticsAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:MLBehaviorAnalyticsAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:MLBehaviorAnalyticsAlertRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231201preview:MLBehaviorAnalyticsAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMLBehaviorAnalyticsAlertRule(ctx *pulumi.Context,
	...
	var resource MLBehaviorAnalyticsAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20231201preview:MLBehaviorAnalyticsAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The sub-techniques of the alert rule
func (o MLBehaviorAnalyticsAlertRuleOutput) SubTechniques() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *MLBehaviorAnalyticsAlertRule) pulumi.StringArrayOutput { return v.SubTechniques }).(pulumi.StringArrayOutput)
}
