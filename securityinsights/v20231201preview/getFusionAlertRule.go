...
func LookupFusionAlertRule(ctx *pulumi.Context, args *LookupFusionAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupFusionAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20231201preview:getFusionAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupFusionAlertRuleOutput(ctx *pulumi.Context, args LookupFusionAlertRuleOutputArgs, opts ...pulumi.InvokeOption) LookupFusionAlertRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFusionAlertRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20231201preview:getFusionAlertRule", args, LookupFusionAlertRuleResultOutput{}, options).(LookupFusionAlertRuleResultOutput), nil
