...
func LookupWorkspaceManagerGroup(ctx *pulumi.Context, args *LookupWorkspaceManagerGroupArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceManagerGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20231201preview:getWorkspaceManagerGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceManagerGroupOutput(ctx *pulumi.Context, args LookupWorkspaceManagerGroupOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceManagerGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceManagerGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20231201preview:getWorkspaceManagerGroup", args, LookupWorkspaceManagerGroupResultOutput{}, options).(LookupWorkspaceManagerGroupResultOutput), nil
