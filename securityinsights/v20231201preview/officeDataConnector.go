...
func NewOfficeDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231201preview:OfficeDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOfficeDataConnector(ctx *pulumi.Context,
	...
	var resource OfficeDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20231201preview:OfficeDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
