...
func NewAction(ctx *pulumi.Context,
	...
	var resource Action
	err := ctx.RegisterResource("azure-native:securityinsights/v20231201preview:Action", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAction(ctx *pulumi.Context,
	...
	var resource Action
	err := ctx.ReadResource("azure-native:securityinsights/v20231201preview:Action", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
