...
func LookupMicrosoftSecurityIncidentCreationAlertRule(ctx *pulumi.Context, args *LookupMicrosoftSecurityIncidentCreationAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupMicrosoftSecurityIncidentCreationAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20231201preview:getMicrosoftSecurityIncidentCreationAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMicrosoftSecurityIncidentCreationAlertRuleOutput(ctx *pulumi.Context, args LookupMicrosoftSecurityIncidentCreationAlertRuleOutputArgs, opts ...pulumi.InvokeOption) LookupMicrosoftSecurityIncidentCreationAlertRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMicrosoftSecurityIncidentCreationAlertRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20231201preview:getMicrosoftSecurityIncidentCreationAlertRule", args, LookupMicrosoftSecurityIncidentCreationAlertRuleResultOutput{}, options).(LookupMicrosoftSecurityIncidentCreationAlertRuleResultOutput), nil
