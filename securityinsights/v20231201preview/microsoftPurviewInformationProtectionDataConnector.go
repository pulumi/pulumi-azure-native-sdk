...
func NewMicrosoftPurviewInformationProtectionDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231201preview:MicrosoftPurviewInformationProtectionDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMicrosoftPurviewInformationProtectionDataConnector(ctx *pulumi.Context,
	...
	var resource MicrosoftPurviewInformationProtectionDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20231201preview:MicrosoftPurviewInformationProtectionDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
