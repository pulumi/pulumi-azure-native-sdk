...
func NewGCPDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231201preview:GCPDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGCPDataConnector(ctx *pulumi.Context,
	...
	var resource GCPDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20231201preview:GCPDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
