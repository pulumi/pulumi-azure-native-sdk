...
//
// Deprecated: azure-native:securityinsights/v20220501preview:ThreatIntelligenceAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceAlertRule to guarantee forwards compatibility.
...
func NewThreatIntelligenceAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220501preview:ThreatIntelligenceAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThreatIntelligenceAlertRule(ctx *pulumi.Context,
	...
	var resource ThreatIntelligenceAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20220501preview:ThreatIntelligenceAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
