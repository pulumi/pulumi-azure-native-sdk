...
//
// Deprecated: azure-native:securityinsights/v20220501preview:CodelessUiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:CodelessUiDataConnector to guarantee forwards compatibility.
...
func NewCodelessUiDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220501preview:CodelessUiDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodelessUiDataConnector(ctx *pulumi.Context,
	...
	var resource CodelessUiDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20220501preview:CodelessUiDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
