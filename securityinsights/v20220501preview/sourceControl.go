...
//
// Deprecated: azure-native:securityinsights/v20220501preview:SourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:SourceControl to guarantee forwards compatibility.
...
func NewSourceControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220501preview:SourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourceControl(ctx *pulumi.Context,
	...
	var resource SourceControl
	err := ctx.ReadResource("azure-native:securityinsights/v20220501preview:SourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
