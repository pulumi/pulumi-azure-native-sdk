...
func NewEntityQuery(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221201preview:EntityQuery"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201preview:EntityQuery"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230301preview:EntityQuery"),
		},
	})
	opts = append(opts, aliases)
	var resource EntityQuery
	err := ctx.RegisterResource("azure-native:securityinsights/v20220501preview:EntityQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntityQuery(ctx *pulumi.Context,
	...
	var resource EntityQuery
	err := ctx.ReadResource("azure-native:securityinsights/v20220501preview:EntityQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
