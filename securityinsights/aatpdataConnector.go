...
func NewAATPDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:AATPDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:AATPDataConnector"),
		},
		{
...
// The Azure API version of the resource.
func (o AATPDataConnectorOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AATPDataConnector) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AATPDataConnectorOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *AATPDataConnector) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
