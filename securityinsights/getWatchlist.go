...
func LookupWatchlistOutput(ctx *pulumi.Context, args LookupWatchlistOutputArgs, opts ...pulumi.InvokeOption) LookupWatchlistResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWatchlistResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights:getWatchlist", args, LookupWatchlistResultOutput{}, options).(LookupWatchlistResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupWatchlistResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWatchlistResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Describes provisioning state
func (o LookupWatchlistResultOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWatchlistResult) string { return v.ProvisioningState }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupWatchlistResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupWatchlistResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
