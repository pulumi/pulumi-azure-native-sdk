...
func NewWorkspaceManagerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:WorkspaceManagerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspaceManagerGroup(ctx *pulumi.Context,
	...
	var resource WorkspaceManagerGroup
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:WorkspaceManagerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
