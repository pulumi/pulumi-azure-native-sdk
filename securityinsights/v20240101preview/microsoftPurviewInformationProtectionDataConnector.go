...
func NewMicrosoftPurviewInformationProtectionDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:MicrosoftPurviewInformationProtectionDataConnector"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:MicrosoftPurviewInformationProtectionDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMicrosoftPurviewInformationProtectionDataConnector(ctx *pulumi.Context,
	...
	var resource MicrosoftPurviewInformationProtectionDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:MicrosoftPurviewInformationProtectionDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
