...
func NewWatchlistItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:WatchlistItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatchlistItem(ctx *pulumi.Context,
	...
	var resource WatchlistItem
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:WatchlistItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
