...
func LookupSentinelOnboardingState(ctx *pulumi.Context, args *LookupSentinelOnboardingStateArgs, opts ...pulumi.InvokeOption) (*LookupSentinelOnboardingStateResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20240101preview:getSentinelOnboardingState", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSentinelOnboardingStateOutput(ctx *pulumi.Context, args LookupSentinelOnboardingStateOutputArgs, opts ...pulumi.InvokeOption) LookupSentinelOnboardingStateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSentinelOnboardingStateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20240101preview:getSentinelOnboardingState", args, LookupSentinelOnboardingStateResultOutput{}, options).(LookupSentinelOnboardingStateResultOutput), nil
