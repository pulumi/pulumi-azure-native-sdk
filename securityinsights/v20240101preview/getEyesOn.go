...
func LookupEyesOn(ctx *pulumi.Context, args *LookupEyesOnArgs, opts ...pulumi.InvokeOption) (*LookupEyesOnResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20240101preview:getEyesOn", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEyesOnOutput(ctx *pulumi.Context, args LookupEyesOnOutputArgs, opts ...pulumi.InvokeOption) LookupEyesOnResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEyesOnResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20240101preview:getEyesOn", args, LookupEyesOnResultOutput{}, options).(LookupEyesOnResultOutput), nil
