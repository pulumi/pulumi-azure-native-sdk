...
func NewOfficeIRMDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:OfficeIRMDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOfficeIRMDataConnector(ctx *pulumi.Context,
	...
	var resource OfficeIRMDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:OfficeIRMDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
