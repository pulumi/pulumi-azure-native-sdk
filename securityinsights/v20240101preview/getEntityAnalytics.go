...
func LookupEntityAnalytics(ctx *pulumi.Context, args *LookupEntityAnalyticsArgs, opts ...pulumi.InvokeOption) (*LookupEntityAnalyticsResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20240101preview:getEntityAnalytics", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEntityAnalyticsOutput(ctx *pulumi.Context, args LookupEntityAnalyticsOutputArgs, opts ...pulumi.InvokeOption) LookupEntityAnalyticsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEntityAnalyticsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20240101preview:getEntityAnalytics", args, LookupEntityAnalyticsResultOutput{}, options).(LookupEntityAnalyticsResultOutput), nil
