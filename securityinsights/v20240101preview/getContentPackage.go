...
func LookupContentPackage(ctx *pulumi.Context, args *LookupContentPackageArgs, opts ...pulumi.InvokeOption) (*LookupContentPackageResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20240101preview:getContentPackage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupContentPackageOutput(ctx *pulumi.Context, args LookupContentPackageOutputArgs, opts ...pulumi.InvokeOption) LookupContentPackageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContentPackageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20240101preview:getContentPackage", args, LookupContentPackageResultOutput{}, options).(LookupContentPackageResultOutput), nil
