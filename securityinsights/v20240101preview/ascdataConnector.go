...
func NewASCDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:ASCDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetASCDataConnector(ctx *pulumi.Context,
	...
	var resource ASCDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:ASCDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
