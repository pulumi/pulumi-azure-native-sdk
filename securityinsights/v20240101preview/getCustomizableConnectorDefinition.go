...
func LookupCustomizableConnectorDefinition(ctx *pulumi.Context, args *LookupCustomizableConnectorDefinitionArgs, opts ...pulumi.InvokeOption) (*LookupCustomizableConnectorDefinitionResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20240101preview:getCustomizableConnectorDefinition", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCustomizableConnectorDefinitionOutput(ctx *pulumi.Context, args LookupCustomizableConnectorDefinitionOutputArgs, opts ...pulumi.InvokeOption) LookupCustomizableConnectorDefinitionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCustomizableConnectorDefinitionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20240101preview:getCustomizableConnectorDefinition", args, LookupCustomizableConnectorDefinitionResultOutput{}, options).(LookupCustomizableConnectorDefinitionResultOutput), nil
