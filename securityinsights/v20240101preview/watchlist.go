...
func NewWatchlist(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230701preview:Watchlist"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:Watchlist"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20231201preview:Watchlist"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:Watchlist"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:Watchlist"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:Watchlist"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:Watchlist"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:Watchlist"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:Watchlist", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatchlist(ctx *pulumi.Context,
	...
	var resource Watchlist
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:Watchlist", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
