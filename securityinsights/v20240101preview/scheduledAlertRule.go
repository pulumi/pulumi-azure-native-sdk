...
func NewScheduledAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:ScheduledAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledAlertRule(ctx *pulumi.Context,
	...
	var resource ScheduledAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:ScheduledAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The sub-techniques of the alert rule
func (o ScheduledAlertRuleOutput) SubTechniques() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *ScheduledAlertRule) pulumi.StringArrayOutput { return v.SubTechniques }).(pulumi.StringArrayOutput)
}
