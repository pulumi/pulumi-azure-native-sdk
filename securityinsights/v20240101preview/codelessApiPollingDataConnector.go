...
func NewCodelessApiPollingDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230301preview:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230401preview:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230501preview:CodelessApiPollingDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20231201preview:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:CodelessApiPollingDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:CodelessApiPollingDataConnector"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:CodelessApiPollingDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodelessApiPollingDataConnector(ctx *pulumi.Context,
	...
	var resource CodelessApiPollingDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:CodelessApiPollingDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
