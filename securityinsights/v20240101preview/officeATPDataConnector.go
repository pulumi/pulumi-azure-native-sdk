...
func NewOfficeATPDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240101preview:OfficeATPDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOfficeATPDataConnector(ctx *pulumi.Context,
	...
	var resource OfficeATPDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20240101preview:OfficeATPDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
