...
func NewUeba(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:Ueba"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:Ueba"),
		},
		{
...
// The Azure API version of the resource.
func (o UebaOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Ueba) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o UebaOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Ueba) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
