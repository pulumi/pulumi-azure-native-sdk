...
// The query that creates alerts for this rule.
func (o GetNrtAlertRuleResultOutput) Query() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetNrtAlertRuleResult) *string { return v.Query }).(pulumi.StringPtrOutput)
}

// The severity for alerts created by this alert rule.
func (o GetNrtAlertRuleResultOutput) Severity() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetNrtAlertRuleResult) *string { return v.Severity }).(pulumi.StringPtrOutput)
}
