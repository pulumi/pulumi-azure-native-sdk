...
//
// Deprecated: azure-native:securityinsights/v20210901preview:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Action to guarantee forwards compatibility.
