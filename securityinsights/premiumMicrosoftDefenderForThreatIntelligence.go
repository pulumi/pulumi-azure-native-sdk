...
func NewPremiumMicrosoftDefenderForThreatIntelligence(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:PremiumMicrosoftDefenderForThreatIntelligence"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:PremiumMicrosoftDefenderForThreatIntelligence"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:PremiumMicrosoftDefenderForThreatIntelligence"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:PremiumMicrosoftDefenderForThreatIntelligence"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights:PremiumMicrosoftDefenderForThreatIntelligence", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPremiumMicrosoftDefenderForThreatIntelligence(ctx *pulumi.Context,
	...
	var resource PremiumMicrosoftDefenderForThreatIntelligence
	err := ctx.ReadResource("azure-native:securityinsights:PremiumMicrosoftDefenderForThreatIntelligence", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o PremiumMicrosoftDefenderForThreatIntelligenceOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PremiumMicrosoftDefenderForThreatIntelligence) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The tenant id to connect to, and get the data from.
func (o PremiumMicrosoftDefenderForThreatIntelligenceOutput) TenantId() pulumi.StringOutput {
	return o.ApplyT(func(v *PremiumMicrosoftDefenderForThreatIntelligence) pulumi.StringOutput { return v.TenantId }).(pulumi.StringOutput)
}
