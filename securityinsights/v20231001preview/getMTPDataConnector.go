...
func (o LookupMTPDataConnectorResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupMTPDataConnectorResult] {
	return pulumix.Output[LookupMTPDataConnectorResult]{
