...
func NewCustomizableConnectorDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:CustomizableConnectorDefinition"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:CustomizableConnectorDefinition"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231001preview:CustomizableConnectorDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomizableConnectorDefinition(ctx *pulumi.Context,
	...
	var resource CustomizableConnectorDefinition
	err := ctx.ReadResource("azure-native:securityinsights/v20231001preview:CustomizableConnectorDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
