...
func (o LookupOfficeATPDataConnectorResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOfficeATPDataConnectorResult] {
	return pulumix.Output[LookupOfficeATPDataConnectorResult]{
