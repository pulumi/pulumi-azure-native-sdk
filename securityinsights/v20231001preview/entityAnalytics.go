...
func NewEntityAnalytics(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231001preview:EntityAnalytics", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntityAnalytics(ctx *pulumi.Context,
	...
	var resource EntityAnalytics
	err := ctx.ReadResource("azure-native:securityinsights/v20231001preview:EntityAnalytics", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
