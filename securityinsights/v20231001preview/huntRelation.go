...
func NewHuntRelation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231001preview:HuntRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHuntRelation(ctx *pulumi.Context,
	...
	var resource HuntRelation
	err := ctx.ReadResource("azure-native:securityinsights/v20231001preview:HuntRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
