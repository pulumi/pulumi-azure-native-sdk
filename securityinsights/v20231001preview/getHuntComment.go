...
func LookupHuntComment(ctx *pulumi.Context, args *LookupHuntCommentArgs, opts ...pulumi.InvokeOption) (*LookupHuntCommentResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20231001preview:getHuntComment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHuntCommentOutput(ctx *pulumi.Context, args LookupHuntCommentOutputArgs, opts ...pulumi.InvokeOption) LookupHuntCommentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHuntCommentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20231001preview:getHuntComment", args, LookupHuntCommentResultOutput{}, options).(LookupHuntCommentResultOutput), nil
