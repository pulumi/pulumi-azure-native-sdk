...
func NewIncidentComment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231001preview:IncidentComment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncidentComment(ctx *pulumi.Context,
	...
	var resource IncidentComment
	err := ctx.ReadResource("azure-native:securityinsights/v20231001preview:IncidentComment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
