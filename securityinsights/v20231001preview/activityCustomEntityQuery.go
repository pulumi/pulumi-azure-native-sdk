...
func NewActivityCustomEntityQuery(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:ActivityCustomEntityQuery"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:ActivityCustomEntityQuery"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:ActivityCustomEntityQuery"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20231001preview:ActivityCustomEntityQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActivityCustomEntityQuery(ctx *pulumi.Context,
	...
	var resource ActivityCustomEntityQuery
	err := ctx.ReadResource("azure-native:securityinsights/v20231001preview:ActivityCustomEntityQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
