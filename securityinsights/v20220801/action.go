...
//
// Deprecated: azure-native:securityinsights/v20220801:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Action to guarantee forwards compatibility.
type Action struct {
...
func NewAction(ctx *pulumi.Context,
	...
	var resource Action
	err := ctx.RegisterResource("azure-native:securityinsights/v20220801:Action", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAction(ctx *pulumi.Context,
	...
	var resource Action
	err := ctx.ReadResource("azure-native:securityinsights/v20220801:Action", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
