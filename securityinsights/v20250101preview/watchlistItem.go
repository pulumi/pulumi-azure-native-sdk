...
func NewWatchlistItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230801preview:WatchlistItem"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:WatchlistItem"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:WatchlistItem"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20250101preview:WatchlistItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatchlistItem(ctx *pulumi.Context,
	...
	var resource WatchlistItem
	err := ctx.ReadResource("azure-native:securityinsights/v20250101preview:WatchlistItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
