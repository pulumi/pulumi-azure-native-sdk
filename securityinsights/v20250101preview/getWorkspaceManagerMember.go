...
func LookupWorkspaceManagerMember(ctx *pulumi.Context, args *LookupWorkspaceManagerMemberArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceManagerMemberResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20250101preview:getWorkspaceManagerMember", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceManagerMemberOutput(ctx *pulumi.Context, args LookupWorkspaceManagerMemberOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceManagerMemberResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceManagerMemberResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20250101preview:getWorkspaceManagerMember", args, LookupWorkspaceManagerMemberResultOutput{}, options).(LookupWorkspaceManagerMemberResultOutput), nil
