...
func NewBookmarkRelation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20250101preview:BookmarkRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBookmarkRelation(ctx *pulumi.Context,
	...
	var resource BookmarkRelation
	err := ctx.ReadResource("azure-native:securityinsights/v20250101preview:BookmarkRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
