...
func NewFusionAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20250101preview:FusionAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFusionAlertRule(ctx *pulumi.Context,
	...
	var resource FusionAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20250101preview:FusionAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
