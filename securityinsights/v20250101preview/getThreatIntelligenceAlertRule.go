...
func LookupThreatIntelligenceAlertRule(ctx *pulumi.Context, args *LookupThreatIntelligenceAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupThreatIntelligenceAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20250101preview:getThreatIntelligenceAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupThreatIntelligenceAlertRuleOutput(ctx *pulumi.Context, args LookupThreatIntelligenceAlertRuleOutputArgs, opts ...pulumi.InvokeOption) LookupThreatIntelligenceAlertRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupThreatIntelligenceAlertRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20250101preview:getThreatIntelligenceAlertRule", args, LookupThreatIntelligenceAlertRuleResultOutput{}, options).(LookupThreatIntelligenceAlertRuleResultOutput), nil
