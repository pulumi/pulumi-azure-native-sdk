...
func LookupFileImport(ctx *pulumi.Context, args *LookupFileImportArgs, opts ...pulumi.InvokeOption) (*LookupFileImportResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20250101preview:getFileImport", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupFileImportOutput(ctx *pulumi.Context, args LookupFileImportOutputArgs, opts ...pulumi.InvokeOption) LookupFileImportResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFileImportResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20250101preview:getFileImport", args, LookupFileImportResultOutput{}, options).(LookupFileImportResultOutput), nil
