...
func NewBusinessApplicationAgent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20250101preview:BusinessApplicationAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBusinessApplicationAgent(ctx *pulumi.Context,
	...
	var resource BusinessApplicationAgent
	err := ctx.ReadResource("azure-native:securityinsights/v20250101preview:BusinessApplicationAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
