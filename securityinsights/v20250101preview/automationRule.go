...
func NewAutomationRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201:AutomationRule"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:AutomationRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:AutomationRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:AutomationRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:AutomationRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:AutomationRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20250101preview:AutomationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutomationRule(ctx *pulumi.Context,
	...
	var resource AutomationRule
	err := ctx.ReadResource("azure-native:securityinsights/v20250101preview:AutomationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
