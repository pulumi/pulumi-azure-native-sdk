...
func NewEntityAnalytics(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:EntityAnalytics"),
		},
		{
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o EntityAnalyticsOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *EntityAnalytics) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
