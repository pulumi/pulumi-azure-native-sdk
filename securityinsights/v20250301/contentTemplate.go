...
func NewContentTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20250301:ContentTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentTemplate(ctx *pulumi.Context,
	...
	var resource ContentTemplate
	err := ctx.ReadResource("azure-native:securityinsights/v20250301:ContentTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
