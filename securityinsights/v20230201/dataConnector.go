...
func NewDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230201:DataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataConnector(ctx *pulumi.Context,
	...
	var resource DataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230201:DataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
