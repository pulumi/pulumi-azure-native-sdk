...
//
// Deprecated: azure-native:securityinsights/v20230201:SentinelOnboardingState is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:SentinelOnboardingState to guarantee forwards compatibility.
...
func NewSentinelOnboardingState(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230201:SentinelOnboardingState", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSentinelOnboardingState(ctx *pulumi.Context,
	...
	var resource SentinelOnboardingState
	err := ctx.ReadResource("azure-native:securityinsights/v20230201:SentinelOnboardingState", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
