...
func LookupBookmark(ctx *pulumi.Context, args *LookupBookmarkArgs, opts ...pulumi.InvokeOption) (*LookupBookmarkResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20230201:getBookmark", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBookmarkOutput(ctx *pulumi.Context, args LookupBookmarkOutputArgs, opts ...pulumi.InvokeOption) LookupBookmarkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBookmarkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20230201:getBookmark", args, LookupBookmarkResultOutput{}, options).(LookupBookmarkResultOutput), nil
