...
func NewAwsCloudTrailDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:AwsCloudTrailDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:AwsCloudTrailDataConnector"),
		},
		{
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AwsCloudTrailDataConnectorOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *AwsCloudTrailDataConnector) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
