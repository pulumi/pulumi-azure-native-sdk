...
//
// Deprecated: azure-native:securityinsights/v20190101preview:WatchlistItem is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210401:WatchlistItem to guarantee forwards compatibility.
...
func NewWatchlistItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20190101preview:WatchlistItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatchlistItem(ctx *pulumi.Context,
	...
	var resource WatchlistItem
	err := ctx.ReadResource("azure-native:securityinsights/v20190101preview:WatchlistItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
