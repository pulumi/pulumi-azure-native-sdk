...
func LookupHuntRelation(ctx *pulumi.Context, args *LookupHuntRelationArgs, opts ...pulumi.InvokeOption) (*LookupHuntRelationResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights:getHuntRelation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHuntRelationOutput(ctx *pulumi.Context, args LookupHuntRelationOutputArgs, opts ...pulumi.InvokeOption) LookupHuntRelationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHuntRelationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights:getHuntRelation", args, LookupHuntRelationResultOutput{}, options).(LookupHuntRelationResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupHuntRelationResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupHuntRelationResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
