...
func NewAnomalySecurityMLAnalyticsSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230301preview:AnomalySecurityMLAnalyticsSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnomalySecurityMLAnalyticsSettings(ctx *pulumi.Context,
	...
	var resource AnomalySecurityMLAnalyticsSettings
	err := ctx.ReadResource("azure-native:securityinsights/v20230301preview:AnomalySecurityMLAnalyticsSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
