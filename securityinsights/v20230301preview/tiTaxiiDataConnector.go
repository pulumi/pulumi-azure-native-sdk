...
func NewTiTaxiiDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230301preview:TiTaxiiDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTiTaxiiDataConnector(ctx *pulumi.Context,
	...
	var resource TiTaxiiDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230301preview:TiTaxiiDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
