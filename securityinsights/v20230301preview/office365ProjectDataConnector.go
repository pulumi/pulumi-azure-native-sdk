...
func NewOffice365ProjectDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230301preview:Office365ProjectDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOffice365ProjectDataConnector(ctx *pulumi.Context,
	...
	var resource Office365ProjectDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230301preview:Office365ProjectDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
