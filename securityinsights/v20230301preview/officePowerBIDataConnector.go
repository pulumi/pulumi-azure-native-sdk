...
func NewOfficePowerBIDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230301preview:OfficePowerBIDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOfficePowerBIDataConnector(ctx *pulumi.Context,
	...
	var resource OfficePowerBIDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230301preview:OfficePowerBIDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
