...
func NewAnomalies(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230301preview:Anomalies", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnomalies(ctx *pulumi.Context,
	...
	var resource Anomalies
	err := ctx.ReadResource("azure-native:securityinsights/v20230301preview:Anomalies", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
