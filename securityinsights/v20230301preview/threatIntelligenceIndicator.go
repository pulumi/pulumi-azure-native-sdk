...
func NewThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230301preview:ThreatIntelligenceIndicator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	var resource ThreatIntelligenceIndicator
	err := ctx.ReadResource("azure-native:securityinsights/v20230301preview:ThreatIntelligenceIndicator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
