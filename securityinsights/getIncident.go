...
//
// Other available API versions: 2021-03-01-preview, 2023-02-01-preview, 2023-03-01-preview, 2023-06-01-preview, 2023-07-01-preview, 2023-08-01-preview, 2023-09-01-preview, 2023-10-01-preview, 2023-11-01, 2023-12-01-preview, 2024-01-01-preview, 2024-03-01, 2024-04-01-preview, 2024-09-01.
...
func LookupIncidentOutput(ctx *pulumi.Context, args LookupIncidentOutputArgs, opts ...pulumi.InvokeOption) LookupIncidentResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupIncidentResultOutput, error) {
			...
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv LookupIncidentResult
			secret, err := ctx.InvokePackageRaw("azure-native:securityinsights:getIncident", args, &rv, "", opts...)
			if err != nil {
				return LookupIncidentResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupIncidentResultOutput)
			if secret {
				return pulumi.ToSecret(output).(LookupIncidentResultOutput), nil
			}
			return output, nil
