...
func NewASCDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:ASCDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:ASCDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:ASCDataConnector"),
		},
		{
...
// The Azure API version of the resource.
func (o ASCDataConnectorOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ASCDataConnector) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
