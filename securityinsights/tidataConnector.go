...
func NewTIDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:TIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:TIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:TIDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:TIDataConnector"),
		},
		{
...
// The Azure API version of the resource.
func (o TIDataConnectorOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TIDataConnector) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
