...
func NewScheduledAlertRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:ScheduledAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:ScheduledAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:ScheduledAlertRule"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:ScheduledAlertRule"),
		},
		{
...
// The Azure API version of the resource.
func (o ScheduledAlertRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ScheduledAlertRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
