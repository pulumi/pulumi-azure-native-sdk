...
//
// Deprecated: azure-native:securityinsights/v20211001:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector to guarantee forwards compatibility.
...
func NewAwsCloudTrailDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20211001:AwsCloudTrailDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAwsCloudTrailDataConnector(ctx *pulumi.Context,
	...
	var resource AwsCloudTrailDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20211001:AwsCloudTrailDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
