...
// Gets the alert rule.
//
// Deprecated: azure-native:securityinsights/v20211001:ScheduledAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ScheduledAlertRule to guarantee forwards compatibility.
func LookupScheduledAlertRule(ctx *pulumi.Context, args *LookupScheduledAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupScheduledAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20211001:getScheduledAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
