...
//
// Deprecated: azure-native:securityinsights/v20211001:OfficeDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:OfficeDataConnector to guarantee forwards compatibility.
func LookupOfficeDataConnector(ctx *pulumi.Context, args *LookupOfficeDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupOfficeDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20211001:getOfficeDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
