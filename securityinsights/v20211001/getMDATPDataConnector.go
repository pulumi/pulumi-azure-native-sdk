...
// The tenant id to connect to, and get the data from.
func (o GetMDATPDataConnectorResultOutput) TenantId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetMDATPDataConnectorResult) *string { return v.TenantId }).(pulumi.StringPtrOutput)
}
