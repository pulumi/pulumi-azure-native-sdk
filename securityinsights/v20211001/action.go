...
//
// Deprecated: azure-native:securityinsights/v20211001:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Action to guarantee forwards compatibility.
type Action struct {
