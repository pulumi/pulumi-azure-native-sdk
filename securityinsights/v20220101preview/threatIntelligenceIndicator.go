...
//
// Deprecated: azure-native:securityinsights/v20220101preview:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.
...
func NewThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220101preview:ThreatIntelligenceIndicator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	var resource ThreatIntelligenceIndicator
	err := ctx.ReadResource("azure-native:securityinsights/v20220101preview:ThreatIntelligenceIndicator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
