...
func NewDynamics365DataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220101preview:Dynamics365DataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDynamics365DataConnector(ctx *pulumi.Context,
	...
	var resource Dynamics365DataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20220101preview:Dynamics365DataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
