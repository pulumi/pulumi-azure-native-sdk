...
// Gets the alert rule.
//
// Deprecated: azure-native:securityinsights/v20220101preview:NrtAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:NrtAlertRule to guarantee forwards compatibility.
func LookupNrtAlertRule(ctx *pulumi.Context, args *LookupNrtAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupNrtAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220101preview:getNrtAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
