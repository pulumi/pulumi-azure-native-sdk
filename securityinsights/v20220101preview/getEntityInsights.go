...
func GetEntityInsights(ctx *pulumi.Context, args *GetEntityInsightsArgs, opts ...pulumi.InvokeOption) (*GetEntityInsightsResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220101preview:getEntityInsights", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEntityInsightsOutput(ctx *pulumi.Context, args GetEntityInsightsOutputArgs, opts ...pulumi.InvokeOption) GetEntityInsightsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetEntityInsightsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20220101preview:getEntityInsights", args, GetEntityInsightsResultOutput{}, options).(GetEntityInsightsResultOutput), nil
