...
func (o LookupEntityAnalyticsResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupEntityAnalyticsResult] {
	return pulumix.Output[LookupEntityAnalyticsResult]{
