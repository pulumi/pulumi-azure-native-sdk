...
//
// Deprecated: azure-native:securityinsights/v20220101preview:CodelessApiPollingDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:CodelessApiPollingDataConnector to guarantee forwards compatibility.
func LookupCodelessApiPollingDataConnector(ctx *pulumi.Context, args *LookupCodelessApiPollingDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupCodelessApiPollingDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220101preview:getCodelessApiPollingDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
