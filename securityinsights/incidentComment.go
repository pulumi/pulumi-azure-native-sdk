...
func NewIncidentComment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:IncidentComment"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:IncidentComment"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:IncidentComment"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:IncidentComment"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o IncidentCommentOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *IncidentComment) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
