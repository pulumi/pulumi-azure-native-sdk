...
func NewFileImport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230701preview:FileImport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileImport(ctx *pulumi.Context,
	...
	var resource FileImport
	err := ctx.ReadResource("azure-native:securityinsights/v20230701preview:FileImport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
