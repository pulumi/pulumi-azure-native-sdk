...
func NewBookmark(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201:Bookmark"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231201preview:Bookmark"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:Bookmark"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:Bookmark"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:Bookmark"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:Bookmark"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:Bookmark"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230701preview:Bookmark", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBookmark(ctx *pulumi.Context,
	...
	var resource Bookmark
	err := ctx.ReadResource("azure-native:securityinsights/v20230701preview:Bookmark", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
