...
func LookupMCASDataConnector(ctx *pulumi.Context, args *LookupMCASDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupMCASDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20230701preview:getMCASDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMCASDataConnectorOutput(ctx *pulumi.Context, args LookupMCASDataConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupMCASDataConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMCASDataConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20230701preview:getMCASDataConnector", args, LookupMCASDataConnectorResultOutput{}, options).(LookupMCASDataConnectorResultOutput), nil
