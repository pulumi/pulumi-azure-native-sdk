...
func NewIncidentRelation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230801preview:IncidentRelation"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:IncidentRelation"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:IncidentRelation"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:IncidentRelation"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:IncidentRelation"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230701preview:IncidentRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncidentRelation(ctx *pulumi.Context,
	...
	var resource IncidentRelation
	err := ctx.ReadResource("azure-native:securityinsights/v20230701preview:IncidentRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
