...
func NewTIDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240901:TIDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTIDataConnector(ctx *pulumi.Context,
	...
	var resource TIDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20240901:TIDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
