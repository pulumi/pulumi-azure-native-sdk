...
func NewMetadata(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20240901:Metadata", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetadata(ctx *pulumi.Context,
	...
	var resource Metadata
	err := ctx.ReadResource("azure-native:securityinsights/v20240901:Metadata", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
