...
func NewThreatIntelligenceIndicator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221101:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20221101preview:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20221201preview:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201:ThreatIntelligenceIndicator"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230801preview:ThreatIntelligenceIndicator"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20231201preview:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:ThreatIntelligenceIndicator"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:ThreatIntelligenceIndicator"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:ThreatIntelligenceIndicator"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ThreatIntelligenceIndicatorOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ThreatIntelligenceIndicator) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
