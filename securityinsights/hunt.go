...
func NewHunt(ctx *pulumi.Context,
	...
	var resource Hunt
	err := ctx.RegisterResource("azure-native:securityinsights:Hunt", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHunt(ctx *pulumi.Context,
	...
	var resource Hunt
	err := ctx.ReadResource("azure-native:securityinsights:Hunt", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
