...
func NewAwsS3DataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230401preview:AwsS3DataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAwsS3DataConnector(ctx *pulumi.Context,
	...
	var resource AwsS3DataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230401preview:AwsS3DataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
