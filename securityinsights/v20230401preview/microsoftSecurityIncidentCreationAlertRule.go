...
func NewMicrosoftSecurityIncidentCreationAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230401preview:MicrosoftSecurityIncidentCreationAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMicrosoftSecurityIncidentCreationAlertRule(ctx *pulumi.Context,
	...
	var resource MicrosoftSecurityIncidentCreationAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20230401preview:MicrosoftSecurityIncidentCreationAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
