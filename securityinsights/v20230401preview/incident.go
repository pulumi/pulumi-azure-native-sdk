...
func NewIncident(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230401preview:Incident", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIncident(ctx *pulumi.Context,
	...
	var resource Incident
	err := ctx.ReadResource("azure-native:securityinsights/v20230401preview:Incident", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
