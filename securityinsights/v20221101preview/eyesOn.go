...
//
// Deprecated: azure-native:securityinsights/v20221101preview:EyesOn is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:EyesOn to guarantee forwards compatibility.
type EyesOn struct {
...
func NewEyesOn(ctx *pulumi.Context,
	...
	var resource EyesOn
	err := ctx.RegisterResource("azure-native:securityinsights/v20221101preview:EyesOn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEyesOn(ctx *pulumi.Context,
	...
	var resource EyesOn
	err := ctx.ReadResource("azure-native:securityinsights/v20221101preview:EyesOn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
