...
func NewSecurityMLAnalyticsSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221201preview:SecurityMLAnalyticsSetting"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201:SecurityMLAnalyticsSetting"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201preview:SecurityMLAnalyticsSetting"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230301preview:SecurityMLAnalyticsSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource SecurityMLAnalyticsSetting
	err := ctx.RegisterResource("azure-native:securityinsights/v20221101preview:SecurityMLAnalyticsSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityMLAnalyticsSetting(ctx *pulumi.Context,
	...
	var resource SecurityMLAnalyticsSetting
	err := ctx.ReadResource("azure-native:securityinsights/v20221101preview:SecurityMLAnalyticsSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
