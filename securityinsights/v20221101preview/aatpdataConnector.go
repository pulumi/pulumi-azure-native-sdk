...
//
// Deprecated: azure-native:securityinsights/v20221101preview:AATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AATPDataConnector to guarantee forwards compatibility.
...
func NewAATPDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221101preview:AATPDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAATPDataConnector(ctx *pulumi.Context,
	...
	var resource AATPDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20221101preview:AATPDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
