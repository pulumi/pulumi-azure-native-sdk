...
//
// Deprecated: azure-native:securityinsights/v20221101preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:TiTaxiiDataConnector to guarantee forwards compatibility.
func LookupTiTaxiiDataConnector(ctx *pulumi.Context, args *LookupTiTaxiiDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupTiTaxiiDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20221101preview:getTiTaxiiDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
