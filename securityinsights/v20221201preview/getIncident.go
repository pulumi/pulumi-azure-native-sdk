...
// Gets an incident.
//
// Deprecated: azure-native:securityinsights/v20221201preview:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.
func LookupIncident(ctx *pulumi.Context, args *LookupIncidentArgs, opts ...pulumi.InvokeOption) (*LookupIncidentResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20221201preview:getIncident", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
