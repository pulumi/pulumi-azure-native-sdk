...
//
// Deprecated: azure-native:securityinsights/v20221201preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Ueba to guarantee forwards compatibility.
type Ueba struct {
...
func NewUeba(ctx *pulumi.Context,
	...
	var resource Ueba
	err := ctx.RegisterResource("azure-native:securityinsights/v20221201preview:Ueba", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUeba(ctx *pulumi.Context,
	...
	var resource Ueba
	err := ctx.ReadResource("azure-native:securityinsights/v20221201preview:Ueba", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
