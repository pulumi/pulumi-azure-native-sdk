...
//
// Deprecated: azure-native:securityinsights/v20221201preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Ueba to guarantee forwards compatibility.
type Ueba struct {
