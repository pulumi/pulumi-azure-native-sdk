...
// The event grouping settings.
func (o GetNrtAlertRuleResultOutput) EventGroupingSettings() EventGroupingSettingsResponsePtrOutput {
	return o.ApplyT(func(v GetNrtAlertRuleResult) *EventGroupingSettingsResponse { return v.EventGroupingSettings }).(EventGroupingSettingsResponsePtrOutput)
}
...
// Array of the sentinel entity mappings of the alert rule
func (o GetNrtAlertRuleResultOutput) SentinelEntitiesMappings() SentinelEntityMappingResponseArrayOutput {
	return o.ApplyT(func(v GetNrtAlertRuleResult) []SentinelEntityMappingResponse { return v.SentinelEntitiesMappings }).(SentinelEntityMappingResponseArrayOutput)
}
