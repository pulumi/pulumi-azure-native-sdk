...
func NewProductSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221201preview:ProductSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductSetting(ctx *pulumi.Context,
	...
	var resource ProductSetting
	err := ctx.ReadResource("azure-native:securityinsights/v20221201preview:ProductSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
