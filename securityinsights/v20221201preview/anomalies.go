...
//
// Deprecated: azure-native:securityinsights/v20221201preview:Anomalies is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Anomalies to guarantee forwards compatibility.
