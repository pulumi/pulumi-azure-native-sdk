...
//
// Deprecated: azure-native:securityinsights/v20221201preview:Anomalies is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Anomalies to guarantee forwards compatibility.
...
func NewAnomalies(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221201preview:Anomalies", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnomalies(ctx *pulumi.Context,
	...
	var resource Anomalies
	err := ctx.ReadResource("azure-native:securityinsights/v20221201preview:Anomalies", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
