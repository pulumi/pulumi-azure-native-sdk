...
func LookupRestApiPollerDataConnector(ctx *pulumi.Context, args *LookupRestApiPollerDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupRestApiPollerDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights:getRestApiPollerDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupRestApiPollerDataConnectorOutput(ctx *pulumi.Context, args LookupRestApiPollerDataConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupRestApiPollerDataConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRestApiPollerDataConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights:getRestApiPollerDataConnector", args, LookupRestApiPollerDataConnectorResultOutput{}, options).(LookupRestApiPollerDataConnectorResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupRestApiPollerDataConnectorResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRestApiPollerDataConnectorResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupRestApiPollerDataConnectorResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupRestApiPollerDataConnectorResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
