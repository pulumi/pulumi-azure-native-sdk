...
func NewAADDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:AADDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:AADDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:AADDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:AADDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:AADDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:AADDataConnector"),
		},
		{
...
// The Azure API version of the resource.
func (o AADDataConnectorOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AADDataConnector) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AADDataConnectorOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *AADDataConnector) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
