...
func NewOfficeDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:OfficeDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:OfficeDataConnector"),
		},
		{
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o OfficeDataConnectorOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *OfficeDataConnector) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
