...
func NewContentPackage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:ContentPackage"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250601:ContentPackage"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:ContentPackage"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250901:ContentPackage"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ContentPackage
	err := ctx.RegisterResource("azure-native:securityinsights:ContentPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentPackage(ctx *pulumi.Context,
	...
	var resource ContentPackage
	err := ctx.ReadResource("azure-native:securityinsights:ContentPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ContentPackageOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ContentPackage) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
