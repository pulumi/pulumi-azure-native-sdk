...
func LookupWorkspaceManagerAssignment(ctx *pulumi.Context, args *LookupWorkspaceManagerAssignmentArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceManagerAssignmentResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20230901preview:getWorkspaceManagerAssignment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkspaceManagerAssignmentOutput(ctx *pulumi.Context, args LookupWorkspaceManagerAssignmentOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceManagerAssignmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceManagerAssignmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20230901preview:getWorkspaceManagerAssignment", args, LookupWorkspaceManagerAssignmentResultOutput{}, options).(LookupWorkspaceManagerAssignmentResultOutput), nil
