...
func GetEntitiesGetTimeline(ctx *pulumi.Context, args *GetEntitiesGetTimelineArgs, opts ...pulumi.InvokeOption) (*GetEntitiesGetTimelineResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20230901preview:getEntitiesGetTimeline", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEntitiesGetTimelineOutput(ctx *pulumi.Context, args GetEntitiesGetTimelineOutputArgs, opts ...pulumi.InvokeOption) GetEntitiesGetTimelineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetEntitiesGetTimelineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20230901preview:getEntitiesGetTimeline", args, GetEntitiesGetTimelineResultOutput{}, options).(GetEntitiesGetTimelineResultOutput), nil
