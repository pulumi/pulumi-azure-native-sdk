...
func NewMTPDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230901preview:MTPDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMTPDataConnector(ctx *pulumi.Context,
	...
	var resource MTPDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230901preview:MTPDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
