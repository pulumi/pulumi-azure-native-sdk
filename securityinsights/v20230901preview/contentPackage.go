...
func NewContentPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230901preview:ContentPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentPackage(ctx *pulumi.Context,
	...
	var resource ContentPackage
	err := ctx.ReadResource("azure-native:securityinsights/v20230901preview:ContentPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
