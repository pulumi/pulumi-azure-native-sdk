...
func NewMCASDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:MCASDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:MCASDataConnector"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230901preview:MCASDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMCASDataConnector(ctx *pulumi.Context,
	...
	var resource MCASDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230901preview:MCASDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
