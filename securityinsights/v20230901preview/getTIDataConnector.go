...
func LookupTIDataConnector(ctx *pulumi.Context, args *LookupTIDataConnectorArgs, opts ...pulumi.InvokeOption) (*LookupTIDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20230901preview:getTIDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTIDataConnectorOutput(ctx *pulumi.Context, args LookupTIDataConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupTIDataConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTIDataConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityinsights/v20230901preview:getTIDataConnector", args, LookupTIDataConnectorResultOutput{}, options).(LookupTIDataConnectorResultOutput), nil
