...
func (o LookupTIDataConnectorResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTIDataConnectorResult] {
	return pulumix.Output[LookupTIDataConnectorResult]{
