...
func NewCodelessUiDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230301preview:CodelessUiDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231101:CodelessUiDataConnector"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:CodelessUiDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:CodelessUiDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:CodelessUiDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20241001preview:CodelessUiDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250101preview:CodelessUiDataConnector"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250301:CodelessUiDataConnector"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20230901preview:CodelessUiDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodelessUiDataConnector(ctx *pulumi.Context,
	...
	var resource CodelessUiDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20230901preview:CodelessUiDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
