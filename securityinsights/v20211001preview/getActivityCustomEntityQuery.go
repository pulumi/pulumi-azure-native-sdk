...
//
// Deprecated: azure-native:securityinsights/v20211001preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ActivityCustomEntityQuery to guarantee forwards compatibility.
func LookupActivityCustomEntityQuery(ctx *pulumi.Context, args *LookupActivityCustomEntityQueryArgs, opts ...pulumi.InvokeOption) (*LookupActivityCustomEntityQueryResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20211001preview:getActivityCustomEntityQuery", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
