...
func NewEntityQuery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20211001preview:EntityQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntityQuery(ctx *pulumi.Context,
	...
	var resource EntityQuery
	err := ctx.ReadResource("azure-native:securityinsights/v20211001preview:EntityQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
