...
func NewSystem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20250401preview:System"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20250701preview:System"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource System
	err := ctx.RegisterResource("azure-native:securityinsights:System", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSystem(ctx *pulumi.Context,
	...
	var resource System
	err := ctx.ReadResource("azure-native:securityinsights:System", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
