...
// Gets the alert rule.
//
// Deprecated: azure-native:securityinsights/v20220801preview:NrtAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:NrtAlertRule to guarantee forwards compatibility.
