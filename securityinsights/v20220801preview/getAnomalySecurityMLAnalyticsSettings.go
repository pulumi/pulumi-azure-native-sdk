...
//
// Deprecated: azure-native:securityinsights/v20220801preview:AnomalySecurityMLAnalyticsSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:AnomalySecurityMLAnalyticsSettings to guarantee forwards compatibility.
func LookupAnomalySecurityMLAnalyticsSettings(ctx *pulumi.Context, args *LookupAnomalySecurityMLAnalyticsSettingsArgs, opts ...pulumi.InvokeOption) (*LookupAnomalySecurityMLAnalyticsSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220801preview:getAnomalySecurityMLAnalyticsSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
