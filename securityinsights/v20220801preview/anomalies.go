...
//
// Deprecated: azure-native:securityinsights/v20220801preview:Anomalies is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Anomalies to guarantee forwards compatibility.
...
func NewAnomalies(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20221001preview:Anomalies"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20221101preview:Anomalies"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20221201preview:Anomalies"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201preview:Anomalies"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230401preview:Anomalies"),
		},
	})
	opts = append(opts, aliases)
	var resource Anomalies
	err := ctx.RegisterResource("azure-native:securityinsights/v20220801preview:Anomalies", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnomalies(ctx *pulumi.Context,
	...
	var resource Anomalies
	err := ctx.ReadResource("azure-native:securityinsights/v20220801preview:Anomalies", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
