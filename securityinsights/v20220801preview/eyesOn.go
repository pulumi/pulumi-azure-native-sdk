...
//
// Deprecated: azure-native:securityinsights/v20220801preview:EyesOn is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:EyesOn to guarantee forwards compatibility.
type EyesOn struct {
