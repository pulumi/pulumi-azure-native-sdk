...
func NewCodelessApiPollingDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220801preview:CodelessApiPollingDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodelessApiPollingDataConnector(ctx *pulumi.Context,
	...
	var resource CodelessApiPollingDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20220801preview:CodelessApiPollingDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
