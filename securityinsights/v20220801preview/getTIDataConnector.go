...
func GetTIDataConnector(ctx *pulumi.Context, args *GetTIDataConnectorArgs, opts ...pulumi.InvokeOption) (*GetTIDataConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220801preview:getTIDataConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The available data types for the connector.
func (o GetTIDataConnectorResultOutput) DataTypes() TIDataConnectorDataTypesResponseOutput {
	return o.ApplyT(func(v GetTIDataConnectorResult) TIDataConnectorDataTypesResponse { return v.DataTypes }).(TIDataConnectorDataTypesResponseOutput)
}
...
// The tenant id to connect to, and get the data from.
func (o GetTIDataConnectorResultOutput) TenantId() pulumi.StringOutput {
	return o.ApplyT(func(v GetTIDataConnectorResult) string { return v.TenantId }).(pulumi.StringOutput)
}
