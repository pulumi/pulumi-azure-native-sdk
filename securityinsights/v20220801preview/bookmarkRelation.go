...
//
// Deprecated: azure-native:securityinsights/v20220801preview:BookmarkRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:BookmarkRelation to guarantee forwards compatibility.
...
func NewBookmarkRelation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220801preview:BookmarkRelation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBookmarkRelation(ctx *pulumi.Context,
	...
	var resource BookmarkRelation
	err := ctx.ReadResource("azure-native:securityinsights/v20220801preview:BookmarkRelation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
