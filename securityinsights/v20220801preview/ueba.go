...
func NewUeba(ctx *pulumi.Context,
	...
	var resource Ueba
	err := ctx.RegisterResource("azure-native:securityinsights/v20220801preview:Ueba", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUeba(ctx *pulumi.Context,
	...
	var resource Ueba
	err := ctx.ReadResource("azure-native:securityinsights/v20220801preview:Ueba", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
