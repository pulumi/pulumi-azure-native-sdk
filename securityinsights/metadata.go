...
//
// Other available API versions: 2021-03-01-preview, 2023-02-01-preview, 2023-06-01-preview, 2023-07-01-preview, 2023-08-01-preview, 2023-09-01-preview, 2023-10-01-preview, 2023-11-01, 2023-12-01-preview, 2024-01-01-preview, 2024-03-01, 2024-04-01-preview, 2024-09-01.
...
func NewMetadata(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20231201preview:Metadata"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240101preview:Metadata"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240301:Metadata"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240401preview:Metadata"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20240901:Metadata"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Metadata
	err := ctx.RegisterResource("azure-native:securityinsights:Metadata", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetadata(ctx *pulumi.Context,
	...
	var resource Metadata
	err := ctx.ReadResource("azure-native:securityinsights:Metadata", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
