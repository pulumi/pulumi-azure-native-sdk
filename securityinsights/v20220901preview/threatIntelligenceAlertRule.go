...
func NewThreatIntelligenceAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220901preview:ThreatIntelligenceAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThreatIntelligenceAlertRule(ctx *pulumi.Context,
	...
	var resource ThreatIntelligenceAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20220901preview:ThreatIntelligenceAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
