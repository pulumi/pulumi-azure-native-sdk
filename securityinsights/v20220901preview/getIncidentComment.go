...
//
// Deprecated: azure-native:securityinsights/v20220901preview:IncidentComment is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:IncidentComment to guarantee forwards compatibility.
func LookupIncidentComment(ctx *pulumi.Context, args *LookupIncidentCommentArgs, opts ...pulumi.InvokeOption) (*LookupIncidentCommentResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220901preview:getIncidentComment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
