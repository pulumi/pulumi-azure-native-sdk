...
func NewNrtAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220901preview:NrtAlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNrtAlertRule(ctx *pulumi.Context,
	...
	var resource NrtAlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20220901preview:NrtAlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
