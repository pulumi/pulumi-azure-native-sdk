...
func NewProductSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:securityinsights/v20230201preview:ProductSetting"),
		},
		{
			Type: pulumi.String("azure-native:securityinsights/v20230301preview:ProductSetting"),
		},
	})
	opts = append(opts, aliases)
	var resource ProductSetting
	err := ctx.RegisterResource("azure-native:securityinsights/v20220901preview:ProductSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductSetting(ctx *pulumi.Context,
	...
	var resource ProductSetting
	err := ctx.ReadResource("azure-native:securityinsights/v20220901preview:ProductSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
