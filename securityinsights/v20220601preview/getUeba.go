...
// Gets a setting.
//
// Deprecated: azure-native:securityinsights/v20220601preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Ueba to guarantee forwards compatibility.
func LookupUeba(ctx *pulumi.Context, args *LookupUebaArgs, opts ...pulumi.InvokeOption) (*LookupUebaResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20220601preview:getUeba", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
