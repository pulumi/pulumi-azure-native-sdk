...
func NewAwsCloudTrailDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220601preview:AwsCloudTrailDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAwsCloudTrailDataConnector(ctx *pulumi.Context,
	...
	var resource AwsCloudTrailDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20220601preview:AwsCloudTrailDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
