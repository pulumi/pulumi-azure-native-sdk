...
//
// Deprecated: azure-native:securityinsights/v20221001preview:IoTDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:IoTDataConnector to guarantee forwards compatibility.
...
func NewIoTDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221001preview:IoTDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoTDataConnector(ctx *pulumi.Context,
	...
	var resource IoTDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20221001preview:IoTDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
