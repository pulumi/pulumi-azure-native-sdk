...
//
// Deprecated: azure-native:securityinsights/v20221001preview:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ASCDataConnector to guarantee forwards compatibility.
...
func NewASCDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221001preview:ASCDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetASCDataConnector(ctx *pulumi.Context,
	...
	var resource ASCDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20221001preview:ASCDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
