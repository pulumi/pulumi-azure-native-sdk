...
// Gets the alert rule.
//
// Deprecated: azure-native:securityinsights/v20221001preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.
func LookupMLBehaviorAnalyticsAlertRule(ctx *pulumi.Context, args *LookupMLBehaviorAnalyticsAlertRuleArgs, opts ...pulumi.InvokeOption) (*LookupMLBehaviorAnalyticsAlertRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:securityinsights/v20221001preview:getMLBehaviorAnalyticsAlertRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
