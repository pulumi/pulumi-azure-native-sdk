...
//
// Deprecated: azure-native:securityinsights/v20221001preview:MTPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MTPDataConnector to guarantee forwards compatibility.
...
func NewMTPDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221001preview:MTPDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMTPDataConnector(ctx *pulumi.Context,
	...
	var resource MTPDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20221001preview:MTPDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
