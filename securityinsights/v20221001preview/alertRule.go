...
func NewAlertRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221001preview:AlertRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertRule(ctx *pulumi.Context,
	...
	var resource AlertRule
	err := ctx.ReadResource("azure-native:securityinsights/v20221001preview:AlertRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
