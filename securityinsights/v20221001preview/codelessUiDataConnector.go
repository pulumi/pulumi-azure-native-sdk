...
func NewCodelessUiDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20221001preview:CodelessUiDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodelessUiDataConnector(ctx *pulumi.Context,
	...
	var resource CodelessUiDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20221001preview:CodelessUiDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
