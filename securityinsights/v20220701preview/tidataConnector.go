...
//
// Deprecated: azure-native:securityinsights/v20220701preview:TIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:TIDataConnector to guarantee forwards compatibility.
...
func NewTIDataConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220701preview:TIDataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTIDataConnector(ctx *pulumi.Context,
	...
	var resource TIDataConnector
	err := ctx.ReadResource("azure-native:securityinsights/v20220701preview:TIDataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
