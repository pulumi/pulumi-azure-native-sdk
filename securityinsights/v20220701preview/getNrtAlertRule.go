...
// Gets the alert rule.
//
// Deprecated: azure-native:securityinsights/v20220701preview:NrtAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:NrtAlertRule to guarantee forwards compatibility.
