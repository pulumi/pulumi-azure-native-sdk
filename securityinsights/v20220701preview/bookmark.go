...
//
// Deprecated: azure-native:securityinsights/v20220701preview:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Bookmark to guarantee forwards compatibility.
...
func NewBookmark(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220701preview:Bookmark", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBookmark(ctx *pulumi.Context,
	...
	var resource Bookmark
	err := ctx.ReadResource("azure-native:securityinsights/v20220701preview:Bookmark", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
