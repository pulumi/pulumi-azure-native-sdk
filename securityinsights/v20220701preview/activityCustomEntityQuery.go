...
//
// Deprecated: azure-native:securityinsights/v20220701preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ActivityCustomEntityQuery to guarantee forwards compatibility.
...
func NewActivityCustomEntityQuery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityinsights/v20220701preview:ActivityCustomEntityQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActivityCustomEntityQuery(ctx *pulumi.Context,
	...
	var resource ActivityCustomEntityQuery
	err := ctx.ReadResource("azure-native:securityinsights/v20220701preview:ActivityCustomEntityQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
