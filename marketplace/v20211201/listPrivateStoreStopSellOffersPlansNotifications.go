...
func ListPrivateStoreStopSellOffersPlansNotifications(ctx *pulumi.Context, args *ListPrivateStoreStopSellOffersPlansNotificationsArgs, opts ...pulumi.InvokeOption) (*ListPrivateStoreStopSellOffersPlansNotificationsResult, error) {
	...
	err := ctx.Invoke("azure-native:marketplace/v20211201:listPrivateStoreStopSellOffersPlansNotifications", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListPrivateStoreStopSellOffersPlansNotificationsOutput(ctx *pulumi.Context, args ListPrivateStoreStopSellOffersPlansNotificationsOutputArgs, opts ...pulumi.InvokeOption) ListPrivateStoreStopSellOffersPlansNotificationsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListPrivateStoreStopSellOffersPlansNotificationsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:marketplace/v20211201:listPrivateStoreStopSellOffersPlansNotifications", args, ListPrivateStoreStopSellOffersPlansNotificationsResultOutput{}, options).(ListPrivateStoreStopSellOffersPlansNotificationsResultOutput), nil
