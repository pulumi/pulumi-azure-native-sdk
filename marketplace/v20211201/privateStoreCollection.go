...
func NewPrivateStoreCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:marketplace/v20211201:PrivateStoreCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateStoreCollection(ctx *pulumi.Context,
	...
	var resource PrivateStoreCollection
	err := ctx.ReadResource("azure-native:marketplace/v20211201:PrivateStoreCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
