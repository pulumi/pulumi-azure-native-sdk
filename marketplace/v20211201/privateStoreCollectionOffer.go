...
func NewPrivateStoreCollectionOffer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:marketplace/v20211201:PrivateStoreCollectionOffer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateStoreCollectionOffer(ctx *pulumi.Context,
	...
	var resource PrivateStoreCollectionOffer
	err := ctx.ReadResource("azure-native:marketplace/v20211201:PrivateStoreCollectionOffer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
