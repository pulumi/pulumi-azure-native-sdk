...
func LookupPrivateStoreCollection(ctx *pulumi.Context, args *LookupPrivateStoreCollectionArgs, opts ...pulumi.InvokeOption) (*LookupPrivateStoreCollectionResult, error) {
	...
	err := ctx.Invoke("azure-native:marketplace/v20230101:getPrivateStoreCollection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateStoreCollectionOutput(ctx *pulumi.Context, args LookupPrivateStoreCollectionOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateStoreCollectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateStoreCollectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:marketplace/v20230101:getPrivateStoreCollection", args, LookupPrivateStoreCollectionResultOutput{}, options).(LookupPrivateStoreCollectionResultOutput), nil
