...
//
// Deprecated: azure-native:marketplace/v20220301:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.
...
func NewPrivateStoreCollectionOffer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:marketplace/v20220901:PrivateStoreCollectionOffer"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:marketplace/v20220301:PrivateStoreCollectionOffer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateStoreCollectionOffer(ctx *pulumi.Context,
	...
	var resource PrivateStoreCollectionOffer
	err := ctx.ReadResource("azure-native:marketplace/v20220301:PrivateStoreCollectionOffer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
