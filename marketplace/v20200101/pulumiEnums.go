...
// AccessibilityInput is an input type that accepts values of the Accessibility enum
// A concrete instance of `AccessibilityInput` can be one of the following:
//
