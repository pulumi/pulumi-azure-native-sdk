...
func ListPrivateStoreNewPlansNotifications(ctx *pulumi.Context, args *ListPrivateStoreNewPlansNotificationsArgs, opts ...pulumi.InvokeOption) (*ListPrivateStoreNewPlansNotificationsResult, error) {
	...
	err := ctx.Invoke("azure-native:marketplace/v20220901:listPrivateStoreNewPlansNotifications", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListPrivateStoreNewPlansNotificationsOutput(ctx *pulumi.Context, args ListPrivateStoreNewPlansNotificationsOutputArgs, opts ...pulumi.InvokeOption) ListPrivateStoreNewPlansNotificationsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListPrivateStoreNewPlansNotificationsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:marketplace/v20220901:listPrivateStoreNewPlansNotifications", args, ListPrivateStoreNewPlansNotificationsResultOutput{}, options).(ListPrivateStoreNewPlansNotificationsResultOutput), nil
