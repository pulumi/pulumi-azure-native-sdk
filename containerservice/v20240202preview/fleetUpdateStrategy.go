...
func NewFleetUpdateStrategy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:containerservice:FleetUpdateStrategy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20240202preview:FleetUpdateStrategy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleetUpdateStrategy(ctx *pulumi.Context,
	...
	var resource FleetUpdateStrategy
	err := ctx.ReadResource("azure-native:containerservice/v20240202preview:FleetUpdateStrategy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
