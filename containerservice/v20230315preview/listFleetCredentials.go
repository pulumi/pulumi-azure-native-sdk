...
func ListFleetCredentials(ctx *pulumi.Context, args *ListFleetCredentialsArgs, opts ...pulumi.InvokeOption) (*ListFleetCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20230315preview:listFleetCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListFleetCredentialsOutput(ctx *pulumi.Context, args ListFleetCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListFleetCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListFleetCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerservice/v20230315preview:listFleetCredentials", args, ListFleetCredentialsResultOutput{}, options).(ListFleetCredentialsResultOutput), nil
