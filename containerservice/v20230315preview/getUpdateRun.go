...
func LookupUpdateRun(ctx *pulumi.Context, args *LookupUpdateRunArgs, opts ...pulumi.InvokeOption) (*LookupUpdateRunResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20230315preview:getUpdateRun", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUpdateRunOutput(ctx *pulumi.Context, args LookupUpdateRunOutputArgs, opts ...pulumi.InvokeOption) LookupUpdateRunResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUpdateRunResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerservice/v20230315preview:getUpdateRun", args, LookupUpdateRunResultOutput{}, options).(LookupUpdateRunResultOutput), nil
