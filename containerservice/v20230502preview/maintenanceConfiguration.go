...
func NewMaintenanceConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20230502preview:MaintenanceConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMaintenanceConfiguration(ctx *pulumi.Context,
	...
	var resource MaintenanceConfiguration
	err := ctx.ReadResource("azure-native:containerservice/v20230502preview:MaintenanceConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
