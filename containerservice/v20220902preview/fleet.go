...
//
// Deprecated: azure-native:containerservice/v20220902preview:Fleet is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230315preview:Fleet to guarantee forwards compatibility.
type Fleet struct {
...
func NewFleet(ctx *pulumi.Context,
	...
	var resource Fleet
	err := ctx.RegisterResource("azure-native:containerservice/v20220902preview:Fleet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleet(ctx *pulumi.Context,
	...
	var resource Fleet
	err := ctx.ReadResource("azure-native:containerservice/v20220902preview:Fleet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
