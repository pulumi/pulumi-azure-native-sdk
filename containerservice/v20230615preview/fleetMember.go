...
func NewFleetMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20230615preview:FleetMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleetMember(ctx *pulumi.Context,
	...
	var resource FleetMember
	err := ctx.ReadResource("azure-native:containerservice/v20230615preview:FleetMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
