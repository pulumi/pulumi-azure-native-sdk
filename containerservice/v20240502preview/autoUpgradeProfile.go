...
func NewAutoUpgradeProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:containerservice:AutoUpgradeProfile"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AutoUpgradeProfile
	err := ctx.RegisterResource("azure-native:containerservice/v20240502preview:AutoUpgradeProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoUpgradeProfile(ctx *pulumi.Context,
	...
	var resource AutoUpgradeProfile
	err := ctx.ReadResource("azure-native:containerservice/v20240502preview:AutoUpgradeProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
