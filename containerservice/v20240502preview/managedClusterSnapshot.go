...
func NewManagedClusterSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20240502preview:ManagedClusterSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterSnapshot(ctx *pulumi.Context,
	...
	var resource ManagedClusterSnapshot
	err := ctx.ReadResource("azure-native:containerservice/v20240502preview:ManagedClusterSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
