...
func NewUpdateRun(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20240502preview:UpdateRun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUpdateRun(ctx *pulumi.Context,
	...
	var resource UpdateRun
	err := ctx.ReadResource("azure-native:containerservice/v20240502preview:UpdateRun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
