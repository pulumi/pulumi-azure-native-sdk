...
type AgentPool struct {
	...
	ArtifactStreamingProfile AgentPoolArtifactStreamingProfileResponsePtrOutput `pulumi:"artifactStreamingProfile"`
	...
	EnableCustomCATrust pulumi.BoolPtrOutput `pulumi:"enableCustomCATrust"`
	...
	GatewayProfile AgentPoolGatewayProfileResponsePtrOutput `pulumi:"gatewayProfile"`
	// GPUInstanceProfile to be used to specify GPU MIG instance profile for supported GPU VM SKU.
	GpuInstanceProfile pulumi.StringPtrOutput `pulumi:"gpuInstanceProfile"`
	// The GPU settings of an agent pool.
	GpuProfile AgentPoolGPUProfileResponsePtrOutput `pulumi:"gpuProfile"`
	...
	NodeInitializationTaints pulumi.StringArrayOutput `pulumi:"nodeInitializationTaints"`
	...
	PodIPAllocationMode pulumi.StringPtrOutput `pulumi:"podIPAllocationMode"`
	...
	VirtualMachineNodesStatus VirtualMachineNodesResponseArrayOutput `pulumi:"virtualMachineNodesStatus"`
	// Specifications on VirtualMachines agent pool.
	VirtualMachinesProfile VirtualMachinesProfileResponsePtrOutput `pulumi:"virtualMachinesProfile"`
...
func NewAgentPool(ctx *pulumi.Context,
	...
	if args.GatewayProfile != nil {
		args.GatewayProfile = args.GatewayProfile.ToAgentPoolGatewayProfilePtrOutput().ApplyT(func(v *AgentPoolGatewayProfile) *AgentPoolGatewayProfile { return v.Defaults() }).(AgentPoolGatewayProfilePtrOutput)
	}
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20240502preview:AgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentPool(ctx *pulumi.Context,
	...
	var resource AgentPool
	err := ctx.ReadResource("azure-native:containerservice/v20240502preview:AgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type agentPoolArgs struct {
	...
	// Configuration for using artifact streaming on AKS.
	ArtifactStreamingProfile *AgentPoolArtifactStreamingProfile `pulumi:"artifactStreamingProfile"`
	// The list of Availability zones to use for nodes. This can only be specified if the AgentPoolType property is 'VirtualMachineScaleSets'.
	...
	// The GPU settings of an agent pool.
	GpuProfile *AgentPoolGPUProfile `pulumi:"gpuProfile"`
	// This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}. For more information see [Azure dedicated hosts](https://docs.microsoft.com/azure/virtual-machines/dedicated-hosts).
	...
	// These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be modified after node pool is created, but nodes will not be recreated with new taints until another operation that requires recreation (e.g. node image upgrade) happens. These taints allow for required configuration to run before the node is ready to accept workloads, for example 'key1=value1:NoSchedule' that then can be removed with `kubectl taint nodes node1 key1=value1:NoSchedule-`
	NodeInitializationTaints []string `pulumi:"nodeInitializationTaints"`
	// The node labels to be persisted across all nodes in agent pool.
...
type AgentPoolArgs struct {
	...
	// Configuration for using artifact streaming on AKS.
	ArtifactStreamingProfile AgentPoolArtifactStreamingProfilePtrInput
	// The list of Availability zones to use for nodes. This can only be specified if the AgentPoolType property is 'VirtualMachineScaleSets'.
	...
	// When set to true, AKS adds a label to the node indicating that the feature is enabled and deploys a daemonset along with host services to sync custom certificate authorities from user-provided list of base64 encoded certificates into node trust stores. Defaults to false.
	EnableCustomCATrust pulumi.BoolPtrInput
	// This is only supported on certain VM sizes and in certain Azure regions. For more information, see: https://docs.microsoft.com/azure/aks/enable-host-encryption
	...
	// Profile specific to a managed agent pool in Gateway mode. This field cannot be set if agent pool mode is not Gateway.
	GatewayProfile AgentPoolGatewayProfilePtrInput
	// GPUInstanceProfile to be used to specify GPU MIG instance profile for supported GPU VM SKU.
	GpuInstanceProfile pulumi.StringPtrInput
	// The GPU settings of an agent pool.
	GpuProfile AgentPoolGPUProfilePtrInput
	// This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}. For more information see [Azure dedicated hosts](https://docs.microsoft.com/azure/virtual-machines/dedicated-hosts).
	...
	// These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be modified after node pool is created, but nodes will not be recreated with new taints until another operation that requires recreation (e.g. node image upgrade) happens. These taints allow for required configuration to run before the node is ready to accept workloads, for example 'key1=value1:NoSchedule' that then can be removed with `kubectl taint nodes node1 key1=value1:NoSchedule-`
	NodeInitializationTaints pulumi.StringArrayInput
	// The node labels to be persisted across all nodes in agent pool.
	...
	// The IP allocation mode for pods in the agent pool. Must be used with podSubnetId. The default is 'DynamicIndividual'.
	PodIPAllocationMode pulumi.StringPtrInput
	// If omitted, pod IPs are statically assigned on the node subnet (see vnetSubnetID for more details). This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}
	...
	// The status of nodes in a VirtualMachines agent pool.
	VirtualMachineNodesStatus VirtualMachineNodesArrayInput
	// Specifications on VirtualMachines agent pool.
	VirtualMachinesProfile VirtualMachinesProfilePtrInput
	// VM size availability varies by region. If a node contains insufficient compute resources (memory, cpu, etc) pods might fail to run correctly. For more details on restricted VM sizes, see: https://docs.microsoft.com/azure/aks/quotas-skus-regions
...
// Configuration for using artifact streaming on AKS.
func (o AgentPoolOutput) ArtifactStreamingProfile() AgentPoolArtifactStreamingProfileResponsePtrOutput {
	return o.ApplyT(func(v *AgentPool) AgentPoolArtifactStreamingProfileResponsePtrOutput {
		return v.ArtifactStreamingProfile
	}).(AgentPoolArtifactStreamingProfileResponsePtrOutput)
}
...
// When set to true, AKS adds a label to the node indicating that the feature is enabled and deploys a daemonset along with host services to sync custom certificate authorities from user-provided list of base64 encoded certificates into node trust stores. Defaults to false.
func (o AgentPoolOutput) EnableCustomCATrust() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AgentPool) pulumi.BoolPtrOutput { return v.EnableCustomCATrust }).(pulumi.BoolPtrOutput)
}
...
// Profile specific to a managed agent pool in Gateway mode. This field cannot be set if agent pool mode is not Gateway.
func (o AgentPoolOutput) GatewayProfile() AgentPoolGatewayProfileResponsePtrOutput {
	return o.ApplyT(func(v *AgentPool) AgentPoolGatewayProfileResponsePtrOutput { return v.GatewayProfile }).(AgentPoolGatewayProfileResponsePtrOutput)
}
...
// The GPU settings of an agent pool.
func (o AgentPoolOutput) GpuProfile() AgentPoolGPUProfileResponsePtrOutput {
	return o.ApplyT(func(v *AgentPool) AgentPoolGPUProfileResponsePtrOutput { return v.GpuProfile }).(AgentPoolGPUProfileResponsePtrOutput)
}
...
// These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be modified after node pool is created, but nodes will not be recreated with new taints until another operation that requires recreation (e.g. node image upgrade) happens. These taints allow for required configuration to run before the node is ready to accept workloads, for example 'key1=value1:NoSchedule' that then can be removed with `kubectl taint nodes node1 key1=value1:NoSchedule-`
func (o AgentPoolOutput) NodeInitializationTaints() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AgentPool) pulumi.StringArrayOutput { return v.NodeInitializationTaints }).(pulumi.StringArrayOutput)
}
...
// The IP allocation mode for pods in the agent pool. Must be used with podSubnetId. The default is 'DynamicIndividual'.
func (o AgentPoolOutput) PodIPAllocationMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentPool) pulumi.StringPtrOutput { return v.PodIPAllocationMode }).(pulumi.StringPtrOutput)
}
...
// The status of nodes in a VirtualMachines agent pool.
func (o AgentPoolOutput) VirtualMachineNodesStatus() VirtualMachineNodesResponseArrayOutput {
	return o.ApplyT(func(v *AgentPool) VirtualMachineNodesResponseArrayOutput { return v.VirtualMachineNodesStatus }).(VirtualMachineNodesResponseArrayOutput)
}

// Specifications on VirtualMachines agent pool.
func (o AgentPoolOutput) VirtualMachinesProfile() VirtualMachinesProfileResponsePtrOutput {
	return o.ApplyT(func(v *AgentPool) VirtualMachinesProfileResponsePtrOutput { return v.VirtualMachinesProfile }).(VirtualMachinesProfileResponsePtrOutput)
}
