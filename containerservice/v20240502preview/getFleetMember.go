...
func LookupFleetMember(ctx *pulumi.Context, args *LookupFleetMemberArgs, opts ...pulumi.InvokeOption) (*LookupFleetMemberResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20240502preview:getFleetMember", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupFleetMemberOutput(ctx *pulumi.Context, args LookupFleetMemberOutputArgs, opts ...pulumi.InvokeOption) LookupFleetMemberResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFleetMemberResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerservice/v20240502preview:getFleetMember", args, LookupFleetMemberResultOutput{}, options).(LookupFleetMemberResultOutput), nil
