...
//
// Deprecated: azure-native:containerservice/v20210801:MaintenanceConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:MaintenanceConfiguration to guarantee forwards compatibility.
...
func NewMaintenanceConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20210801:MaintenanceConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMaintenanceConfiguration(ctx *pulumi.Context,
	...
	var resource MaintenanceConfiguration
	err := ctx.ReadResource("azure-native:containerservice/v20210801:MaintenanceConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
