...
//
// Deprecated: azure-native:containerservice/v20220301:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:PrivateEndpointConnection to guarantee forwards compatibility.
...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20220301:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:containerservice/v20220301:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
