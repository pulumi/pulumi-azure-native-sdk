...
// Managed cluster.
//
// Deprecated: azure-native:containerservice/v20221101:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.
...
func NewManagedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20221101:ManagedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedCluster(ctx *pulumi.Context,
	...
	var resource ManagedCluster
	err := ctx.ReadResource("azure-native:containerservice/v20221101:ManagedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
