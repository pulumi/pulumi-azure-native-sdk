...
//
// Deprecated: azure-native:containerservice/v20221101:Snapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:Snapshot to guarantee forwards compatibility.
func LookupSnapshot(ctx *pulumi.Context, args *LookupSnapshotArgs, opts ...pulumi.InvokeOption) (*LookupSnapshotResult, error) {
	var rv LookupSnapshotResult
	err := ctx.Invoke("azure-native:containerservice/v20221101:getSnapshot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
