...
//
// Deprecated: azure-native:containerservice/v20220102preview:Snapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:Snapshot to guarantee forwards compatibility.
