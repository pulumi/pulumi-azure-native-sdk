...
type ManagedCluster struct {
	...
	SafeguardsProfile SafeguardsProfileResponsePtrOutput `pulumi:"safeguardsProfile"`
...
func NewManagedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20240602preview:ManagedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedCluster(ctx *pulumi.Context,
	...
	var resource ManagedCluster
	err := ctx.ReadResource("azure-native:containerservice/v20240602preview:ManagedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type managedClusterArgs struct {
	...
	// The Safeguards profile holds all the safeguards information for a given cluster
	SafeguardsProfile *SafeguardsProfile `pulumi:"safeguardsProfile"`
	// Security profile for the managed cluster.
...
type ManagedClusterArgs struct {
	...
	// The Safeguards profile holds all the safeguards information for a given cluster
	SafeguardsProfile SafeguardsProfilePtrInput
	// Security profile for the managed cluster.
...
// The Safeguards profile holds all the safeguards information for a given cluster
func (o ManagedClusterOutput) SafeguardsProfile() SafeguardsProfileResponsePtrOutput {
	return o.ApplyT(func(v *ManagedCluster) SafeguardsProfileResponsePtrOutput { return v.SafeguardsProfile }).(SafeguardsProfileResponsePtrOutput)
}
