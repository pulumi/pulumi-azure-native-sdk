...
func LookupAgentPool(ctx *pulumi.Context, args *LookupAgentPoolArgs, opts ...pulumi.InvokeOption) (*LookupAgentPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20240602preview:getAgentPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupAgentPoolResult struct {
	...
	ArtifactStreamingProfile *AgentPoolArtifactStreamingProfileResponse `pulumi:"artifactStreamingProfile"`
	...
	GpuProfile *AgentPoolGPUProfileResponse `pulumi:"gpuProfile"`
...
func LookupAgentPoolOutput(ctx *pulumi.Context, args LookupAgentPoolOutputArgs, opts ...pulumi.InvokeOption) LookupAgentPoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAgentPoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerservice/v20240602preview:getAgentPool", args, LookupAgentPoolResultOutput{}, options).(LookupAgentPoolResultOutput), nil
...
// Configuration for using artifact streaming on AKS.
func (o LookupAgentPoolResultOutput) ArtifactStreamingProfile() AgentPoolArtifactStreamingProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) *AgentPoolArtifactStreamingProfileResponse {
...
// When set to true, AKS adds a label to the node indicating that the feature is enabled and deploys a daemonset along with host services to sync custom certificate authorities from user-provided list of base64 encoded certificates into node trust stores. Defaults to false.
func (o LookupAgentPoolResultOutput) EnableCustomCATrust() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) *bool { return v.EnableCustomCATrust }).(pulumi.BoolPtrOutput)
}
...
// Profile specific to a managed agent pool in Gateway mode. This field cannot be set if agent pool mode is not Gateway.
func (o LookupAgentPoolResultOutput) GatewayProfile() AgentPoolGatewayProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) *AgentPoolGatewayProfileResponse { return v.GatewayProfile }).(AgentPoolGatewayProfileResponsePtrOutput)
}
...
// The GPU settings of an agent pool.
func (o LookupAgentPoolResultOutput) GpuProfile() AgentPoolGPUProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) *AgentPoolGPUProfileResponse { return v.GpuProfile }).(AgentPoolGPUProfileResponsePtrOutput)
}

// This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}. For more information see [Azure dedicated hosts](https://docs.microsoft.com/azure/virtual-machines/dedicated-hosts).
func (o LookupAgentPoolResultOutput) HostGroupID() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) *string { return v.HostGroupID }).(pulumi.StringPtrOutput)
}
...
// These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be modified after node pool is created, but nodes will not be recreated with new taints until another operation that requires recreation (e.g. node image upgrade) happens. These taints allow for required configuration to run before the node is ready to accept workloads, for example 'key1=value1:NoSchedule' that then can be removed with `kubectl taint nodes node1 key1=value1:NoSchedule-`
func (o LookupAgentPoolResultOutput) NodeInitializationTaints() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) []string { return v.NodeInitializationTaints }).(pulumi.StringArrayOutput)
}
...
// The IP allocation mode for pods in the agent pool. Must be used with podSubnetId. The default is 'DynamicIndividual'.
func (o LookupAgentPoolResultOutput) PodIPAllocationMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) *string { return v.PodIPAllocationMode }).(pulumi.StringPtrOutput)
}
...
// The status of nodes in a VirtualMachines agent pool.
func (o LookupAgentPoolResultOutput) VirtualMachineNodesStatus() VirtualMachineNodesResponseArrayOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) []VirtualMachineNodesResponse { return v.VirtualMachineNodesStatus }).(VirtualMachineNodesResponseArrayOutput)
}

// Specifications on VirtualMachines agent pool.
func (o LookupAgentPoolResultOutput) VirtualMachinesProfile() VirtualMachinesProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupAgentPoolResult) *VirtualMachinesProfileResponse { return v.VirtualMachinesProfile }).(VirtualMachinesProfileResponsePtrOutput)
}
