...
func NewFleet(ctx *pulumi.Context,
	...
	var resource Fleet
	err := ctx.RegisterResource("azure-native:containerservice/v20240401:Fleet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleet(ctx *pulumi.Context,
	...
	var resource Fleet
	err := ctx.ReadResource("azure-native:containerservice/v20240401:Fleet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
