...
func (SeccompDefault) ElementType() reflect.Type {
	return reflect.TypeOf((*SeccompDefault)(nil)).Elem()
}

func (e SeccompDefault) ToSeccompDefaultOutput() SeccompDefaultOutput {
	return pulumi.ToOutput(e).(SeccompDefaultOutput)
}

func (e SeccompDefault) ToSeccompDefaultOutputWithContext(ctx context.Context) SeccompDefaultOutput {
	return pulumi.ToOutputWithContext(ctx, e).(SeccompDefaultOutput)
}

func (e SeccompDefault) ToSeccompDefaultPtrOutput() SeccompDefaultPtrOutput {
	return e.ToSeccompDefaultPtrOutputWithContext(context.Background())
}

func (e SeccompDefault) ToSeccompDefaultPtrOutputWithContext(ctx context.Context) SeccompDefaultPtrOutput {
	return SeccompDefault(e).ToSeccompDefaultOutputWithContext(ctx).ToSeccompDefaultPtrOutputWithContext(ctx)
}

func (e SeccompDefault) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e SeccompDefault) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e SeccompDefault) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e SeccompDefault) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type SeccompDefaultOutput struct{ *pulumi.OutputState }

func (SeccompDefaultOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SeccompDefault)(nil)).Elem()
}

func (o SeccompDefaultOutput) ToSeccompDefaultOutput() SeccompDefaultOutput {
	return o
}

func (o SeccompDefaultOutput) ToSeccompDefaultOutputWithContext(ctx context.Context) SeccompDefaultOutput {
	return o
}

func (o SeccompDefaultOutput) ToSeccompDefaultPtrOutput() SeccompDefaultPtrOutput {
	return o.ToSeccompDefaultPtrOutputWithContext(context.Background())
}

func (o SeccompDefaultOutput) ToSeccompDefaultPtrOutputWithContext(ctx context.Context) SeccompDefaultPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SeccompDefault) *SeccompDefault {
		return &v
	}).(SeccompDefaultPtrOutput)
}

func (o SeccompDefaultOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o SeccompDefaultOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e SeccompDefault) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o SeccompDefaultOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o SeccompDefaultOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e SeccompDefault) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type SeccompDefaultPtrOutput struct{ *pulumi.OutputState }

func (SeccompDefaultPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SeccompDefault)(nil)).Elem()
}

func (o SeccompDefaultPtrOutput) ToSeccompDefaultPtrOutput() SeccompDefaultPtrOutput {
	return o
}

func (o SeccompDefaultPtrOutput) ToSeccompDefaultPtrOutputWithContext(ctx context.Context) SeccompDefaultPtrOutput {
	return o
}

func (o SeccompDefaultPtrOutput) Elem() SeccompDefaultOutput {
	return o.ApplyT(func(v *SeccompDefault) SeccompDefault {
		if v != nil {
			return *v
		}
		var ret SeccompDefault
		return ret
	}).(SeccompDefaultOutput)
}

func (o SeccompDefaultPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o SeccompDefaultPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *SeccompDefault) *string {
		if e == nil {
			return nil
		}
...
// SeccompDefaultInput is an input type that accepts values of the SeccompDefault enum
// A concrete instance of `SeccompDefaultInput` can be one of the following:
//
//	SeccompDefaultUnconfined
//	SeccompDefaultRuntimeDefault
type SeccompDefaultInput interface {
	pulumi.Input

	ToSeccompDefaultOutput() SeccompDefaultOutput
	ToSeccompDefaultOutputWithContext(context.Context) SeccompDefaultOutput
}

var seccompDefaultPtrType = reflect.TypeOf((**SeccompDefault)(nil)).Elem()

type SeccompDefaultPtrInput interface {
	pulumi.Input

	ToSeccompDefaultPtrOutput() SeccompDefaultPtrOutput
	ToSeccompDefaultPtrOutputWithContext(context.Context) SeccompDefaultPtrOutput
}

type seccompDefaultPtr string

func SeccompDefaultPtr(v string) SeccompDefaultPtrInput {
	return (*seccompDefaultPtr)(&v)
}

func (*seccompDefaultPtr) ElementType() reflect.Type {
	return seccompDefaultPtrType
}

func (in *seccompDefaultPtr) ToSeccompDefaultPtrOutput() SeccompDefaultPtrOutput {
	return pulumi.ToOutput(in).(SeccompDefaultPtrOutput)
}

func (in *seccompDefaultPtr) ToSeccompDefaultPtrOutputWithContext(ctx context.Context) SeccompDefaultPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(SeccompDefaultPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(SeccompDefaultOutput{})
	pulumi.RegisterOutputType(SeccompDefaultPtrOutput{})
