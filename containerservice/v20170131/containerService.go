...
func NewContainerService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20170131:ContainerService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerService(ctx *pulumi.Context,
	...
	var resource ContainerService
	err := ctx.ReadResource("azure-native:containerservice/v20170131:ContainerService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Properties for custom clusters.
func (o ContainerServiceOutput) CustomProfile() ContainerServiceCustomProfileResponsePtrOutput {
	return o.ApplyT(func(v *ContainerService) ContainerServiceCustomProfileResponsePtrOutput { return v.CustomProfile }).(ContainerServiceCustomProfileResponsePtrOutput)
}
...
// Properties for cluster service principals.
func (o ContainerServiceOutput) ServicePrincipalProfile() ContainerServiceServicePrincipalProfileResponsePtrOutput {
	return o.ApplyT(func(v *ContainerService) ContainerServiceServicePrincipalProfileResponsePtrOutput {
