...
func NewAgentPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20240201:AgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentPool(ctx *pulumi.Context,
	...
	var resource AgentPool
	err := ctx.ReadResource("azure-native:containerservice/v20240201:AgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
