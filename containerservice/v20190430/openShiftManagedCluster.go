...
func NewOpenShiftManagedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20190430:OpenShiftManagedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenShiftManagedCluster(ctx *pulumi.Context,
	...
	var resource OpenShiftManagedCluster
	err := ctx.ReadResource("azure-native:containerservice/v20190430:OpenShiftManagedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
