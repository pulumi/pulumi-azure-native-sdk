...
func NewLoadBalancer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20240402preview:LoadBalancer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancer(ctx *pulumi.Context,
	...
	var resource LoadBalancer
	err := ctx.ReadResource("azure-native:containerservice/v20240402preview:LoadBalancer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
