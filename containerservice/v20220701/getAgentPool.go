...
// Agent Pool.
//
// Deprecated: azure-native:containerservice/v20220701:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:AgentPool to guarantee forwards compatibility.
func LookupAgentPool(ctx *pulumi.Context, args *LookupAgentPoolArgs, opts ...pulumi.InvokeOption) (*LookupAgentPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20220701:getAgentPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
