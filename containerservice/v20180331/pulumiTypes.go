...
// Storage profile specifies what kind of storage used. Defaults to ManagedDisks.
func (o ManagedClusterAgentPoolProfileResponseOutput) StorageProfile() pulumi.StringOutput {
	return o.ApplyT(func(v ManagedClusterAgentPoolProfileResponse) string { return v.StorageProfile }).(pulumi.StringOutput)
}
