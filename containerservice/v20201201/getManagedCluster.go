...
//
// Deprecated: azure-native:containerservice/v20201201:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20210501:ManagedCluster to guarantee forwards compatibility.
func LookupManagedCluster(ctx *pulumi.Context, args *LookupManagedClusterArgs, opts ...pulumi.InvokeOption) (*LookupManagedClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20201201:getManagedCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
