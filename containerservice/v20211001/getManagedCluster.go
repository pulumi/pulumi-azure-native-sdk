...
// Managed cluster.
//
// Deprecated: azure-native:containerservice/v20211001:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:ManagedCluster to guarantee forwards compatibility.
func LookupManagedCluster(ctx *pulumi.Context, args *LookupManagedClusterArgs, opts ...pulumi.InvokeOption) (*LookupManagedClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20211001:getManagedCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
