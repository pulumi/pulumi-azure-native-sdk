...
//
// Deprecated: azure-native:containerservice/v20220602preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.
...
func NewManagedClusterSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20220602preview:ManagedClusterSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterSnapshot(ctx *pulumi.Context,
	...
	var resource ManagedClusterSnapshot
	err := ctx.ReadResource("azure-native:containerservice/v20220602preview:ManagedClusterSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
