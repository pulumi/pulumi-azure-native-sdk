...
// Agent Pool.
//
// Deprecated: azure-native:containerservice/v20220602preview:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:AgentPool to guarantee forwards compatibility.
...
func NewAgentPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20220602preview:AgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentPool(ctx *pulumi.Context,
	...
	var resource AgentPool
	err := ctx.ReadResource("azure-native:containerservice/v20220602preview:AgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
