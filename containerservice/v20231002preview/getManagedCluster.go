...
func LookupManagedCluster(ctx *pulumi.Context, args *LookupManagedClusterArgs, opts ...pulumi.InvokeOption) (*LookupManagedClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:containerservice/v20231002preview:getManagedCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupManagedClusterResult struct {
	...
	GuardrailsProfile *GuardrailsProfileResponse `pulumi:"guardrailsProfile"`
...
func LookupManagedClusterOutput(ctx *pulumi.Context, args LookupManagedClusterOutputArgs, opts ...pulumi.InvokeOption) LookupManagedClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerservice/v20231002preview:getManagedCluster", args, LookupManagedClusterResultOutput{}, options).(LookupManagedClusterResultOutput), nil
...
// The guardrails profile holds all the guardrails information for a given cluster
func (o LookupManagedClusterResultOutput) GuardrailsProfile() GuardrailsProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupManagedClusterResult) *GuardrailsProfileResponse { return v.GuardrailsProfile }).(GuardrailsProfileResponsePtrOutput)
}
