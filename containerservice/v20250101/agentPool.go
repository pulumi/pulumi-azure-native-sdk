...
type AgentPool struct {
	...
	GpuProfile GPUProfileResponsePtrOutput `pulumi:"gpuProfile"`
...
func NewAgentPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20250101:AgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentPool(ctx *pulumi.Context,
	...
	var resource AgentPool
	err := ctx.ReadResource("azure-native:containerservice/v20250101:AgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GPU settings for the Agent Pool.
func (o AgentPoolOutput) GpuProfile() GPUProfileResponsePtrOutput {
	return o.ApplyT(func(v *AgentPool) GPUProfileResponsePtrOutput { return v.GpuProfile }).(GPUProfileResponsePtrOutput)
}
