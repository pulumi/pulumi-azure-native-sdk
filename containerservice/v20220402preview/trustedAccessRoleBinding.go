...
func NewTrustedAccessRoleBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:containerservice/v20220402preview:TrustedAccessRoleBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrustedAccessRoleBinding(ctx *pulumi.Context,
	...
	var resource TrustedAccessRoleBinding
	err := ctx.ReadResource("azure-native:containerservice/v20220402preview:TrustedAccessRoleBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
