...
// NewOrderItem registers a new resource with the given unique name, arguments, and options.
func NewOrderItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:edgeorder:OrderItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetOrderItem gets an existing OrderItem resource's state with the given name, ID, and optional
...
func GetOrderItem(ctx *pulumi.Context,
	...
	var resource OrderItem
	err := ctx.ReadResource("azure-native:edgeorder:OrderItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering OrderItem resources.
...
func (i *OrderItem) ToOutput(ctx context.Context) pulumix.Output[*OrderItem] {
	return pulumix.Output[*OrderItem]{
		OutputState: i.ToOrderItemOutputWithContext(ctx).OutputState,
	}
}
...
func (o OrderItemOutput) ToOutput(ctx context.Context) pulumix.Output[*OrderItem] {
	return pulumix.Output[*OrderItem]{
