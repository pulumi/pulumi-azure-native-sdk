...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o OrderItemOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *OrderItem) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
