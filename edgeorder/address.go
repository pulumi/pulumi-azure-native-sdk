...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AddressOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Address) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
