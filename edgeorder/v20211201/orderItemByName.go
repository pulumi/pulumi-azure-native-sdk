...
func NewOrderItemByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:edgeorder/v20211201:OrderItemByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrderItemByName(ctx *pulumi.Context,
	...
	var resource OrderItemByName
	err := ctx.ReadResource("azure-native:edgeorder/v20211201:OrderItemByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
