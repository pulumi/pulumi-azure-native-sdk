...
func NewOrderItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:edgeorder/v20240201:OrderItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrderItem(ctx *pulumi.Context,
	...
	var resource OrderItem
	err := ctx.ReadResource("azure-native:edgeorder/v20240201:OrderItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
