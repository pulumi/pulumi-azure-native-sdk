...
func NewAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:edgeorder/v20240201:Address", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddress(ctx *pulumi.Context,
	...
	var resource Address
	err := ctx.ReadResource("azure-native:edgeorder/v20240201:Address", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
