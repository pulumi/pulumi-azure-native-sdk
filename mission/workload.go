...
func NewWorkload(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:mission/v20240601preview:Workload"),
		},
		{
			Type: pulumi.String("azure-native:mission/v20241201preview:Workload"),
		},
		{
			Type: pulumi.String("azure-native:mission/v20250501preview:Workload"),
		},
		{
			Type: pulumi.String("azure-native:mission/v20251101preview:Workload"),
		},
		{
			Type: pulumi.String("azure-native:mission/v20260301preview:Workload"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Workload
	err := ctx.RegisterResource("azure-native:mission:Workload", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkload(ctx *pulumi.Context,
	...
	var resource Workload
	err := ctx.ReadResource("azure-native:mission:Workload", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type WorkloadArgs struct {
	...
	// List of resource group ids.
	ResourceGroupCollection pulumi.StringArrayInput
	// The name of the resource group. The name is case insensitive.
...
// The Azure API version of the resource.
func (o WorkloadOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Workload) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Provisioning State.
func (o WorkloadOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v *Workload) pulumi.StringOutput { return v.ProvisioningState }).(pulumi.StringOutput)
}

// List of resource group ids.
func (o WorkloadOutput) ResourceGroupCollection() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Workload) pulumi.StringArrayOutput { return v.ResourceGroupCollection }).(pulumi.StringArrayOutput)
}
