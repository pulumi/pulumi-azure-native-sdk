...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o EnclaveEndpointOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *EnclaveEndpoint) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
