...
type LookupCommunityResult struct {
	...
	ManagedOnBehalfOfConfiguration commontypesv5.ManagedOnBehalfOfConfigurationResponse `pulumi:"managedOnBehalfOfConfiguration"`
...
// The managed service identities assigned to this resource.
func (o LookupCommunityResultOutput) Identity() commontypesv5.ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupCommunityResult) *commontypesv5.ManagedServiceIdentityResponse { return v.Identity }).(commontypesv5.ManagedServiceIdentityResponsePtrOutput)
}
...
// Managed On Behalf Of Configuration.
func (o LookupCommunityResultOutput) ManagedOnBehalfOfConfiguration() commontypesv5.ManagedOnBehalfOfConfigurationResponseOutput {
	return o.ApplyT(func(v LookupCommunityResult) commontypesv5.ManagedOnBehalfOfConfigurationResponse {
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupCommunityResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupCommunityResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
