...
func (Designation) ElementType() reflect.Type {
	return reflect.TypeOf((*Designation)(nil)).Elem()
}

func (e Designation) ToDesignationOutput() DesignationOutput {
	return pulumi.ToOutput(e).(DesignationOutput)
}

func (e Designation) ToDesignationOutputWithContext(ctx context.Context) DesignationOutput {
	return pulumi.ToOutputWithContext(ctx, e).(DesignationOutput)
}

func (e Designation) ToDesignationPtrOutput() DesignationPtrOutput {
	return e.ToDesignationPtrOutputWithContext(context.Background())
}

func (e Designation) ToDesignationPtrOutputWithContext(ctx context.Context) DesignationPtrOutput {
	return Designation(e).ToDesignationOutputWithContext(ctx).ToDesignationPtrOutputWithContext(ctx)
}

func (e Designation) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e Designation) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e Designation) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e Designation) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type DesignationOutput struct{ *pulumi.OutputState }

func (DesignationOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*Designation)(nil)).Elem()
}

func (o DesignationOutput) ToDesignationOutput() DesignationOutput {
	return o
}

func (o DesignationOutput) ToDesignationOutputWithContext(ctx context.Context) DesignationOutput {
	return o
}

func (o DesignationOutput) ToDesignationPtrOutput() DesignationPtrOutput {
	return o.ToDesignationPtrOutputWithContext(context.Background())
}

func (o DesignationOutput) ToDesignationPtrOutputWithContext(ctx context.Context) DesignationPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v Designation) *Designation {
		return &v
	}).(DesignationPtrOutput)
}

func (o DesignationOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o DesignationOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e Designation) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o DesignationOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DesignationOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e Designation) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type DesignationPtrOutput struct{ *pulumi.OutputState }

func (DesignationPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Designation)(nil)).Elem()
}

func (o DesignationPtrOutput) ToDesignationPtrOutput() DesignationPtrOutput {
	return o
}

func (o DesignationPtrOutput) ToDesignationPtrOutputWithContext(ctx context.Context) DesignationPtrOutput {
	return o
}

func (o DesignationPtrOutput) Elem() DesignationOutput {
	return o.ApplyT(func(v *Designation) Designation {
		if v != nil {
			return *v
		}
		var ret Designation
...
func (o DesignationPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DesignationPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *Designation) *string {
		if e == nil {
			return nil
		}
...
// DesignationInput is an input type that accepts values of the Designation enum
// A concrete instance of `DesignationInput` can be one of the following:
//
//	DesignationPooled
//	DesignationReserved
type DesignationInput interface {
	pulumi.Input

	ToDesignationOutput() DesignationOutput
	ToDesignationOutputWithContext(context.Context) DesignationOutput
}

var designationPtrType = reflect.TypeOf((**Designation)(nil)).Elem()

type DesignationPtrInput interface {
	pulumi.Input

	ToDesignationPtrOutput() DesignationPtrOutput
	ToDesignationPtrOutputWithContext(context.Context) DesignationPtrOutput
}

type designationPtr string

func DesignationPtr(v string) DesignationPtrInput {
	return (*designationPtr)(&v)
}

func (*designationPtr) ElementType() reflect.Type {
	return designationPtrType
}

func (in *designationPtr) ToDesignationPtrOutput() DesignationPtrOutput {
	return pulumi.ToOutput(in).(DesignationPtrOutput)
}

func (in *designationPtr) ToDesignationPtrOutputWithContext(ctx context.Context) DesignationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(DesignationPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(DesignationOutput{})
	pulumi.RegisterOutputType(DesignationPtrOutput{})
