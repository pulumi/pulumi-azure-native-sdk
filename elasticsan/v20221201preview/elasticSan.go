...
func NewElasticSan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:elasticsan/v20221201preview:ElasticSan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticSan(ctx *pulumi.Context,
	...
	var resource ElasticSan
	err := ctx.ReadResource("azure-native:elasticsan/v20221201preview:ElasticSan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
