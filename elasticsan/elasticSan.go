...
func NewElasticSan(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:elasticsan/v20240701preview:ElasticSan"),
		},
		{
			Type: pulumi.String("azure-native:elasticsan/v20250901:ElasticSan"),
		},
	})
...
// The Azure API version of the resource.
func (o ElasticSanOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ElasticSan) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ElasticSanOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *ElasticSan) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
