...
func NewVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.RegisterResource("azure-native:elasticsan/v20240501:Volume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.ReadResource("azure-native:elasticsan/v20240501:Volume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
