...
func NewElasticSan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:elasticsan/v20240501:ElasticSan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticSan(ctx *pulumi.Context,
	...
	var resource ElasticSan
	err := ctx.ReadResource("azure-native:elasticsan/v20240501:ElasticSan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
