...
func NewVolumeSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:elasticsan/v20240501:VolumeSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeSnapshot(ctx *pulumi.Context,
	...
	var resource VolumeSnapshot
	err := ctx.ReadResource("azure-native:elasticsan/v20240501:VolumeSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
