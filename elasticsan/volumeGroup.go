...
func NewVolumeGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:elasticsan/v20240701preview:VolumeGroup"),
		},
		{
			Type: pulumi.String("azure-native:elasticsan/v20250901:VolumeGroup"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o VolumeGroupOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *VolumeGroup) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
