...
func NewVolumeSnapshot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:elasticsan/v20260401preview:VolumeSnapshot"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VolumeSnapshot
	err := ctx.RegisterResource("azure-native:elasticsan:VolumeSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeSnapshot(ctx *pulumi.Context,
	...
	var resource VolumeSnapshot
	err := ctx.ReadResource("azure-native:elasticsan:VolumeSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
