...
type ElasticSan struct {
	...
	AutoScaleProperties AutoScalePropertiesResponsePtrOutput `pulumi:"autoScaleProperties"`
...
func NewElasticSan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:elasticsan/v20240601preview:ElasticSan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticSan(ctx *pulumi.Context,
	...
	var resource ElasticSan
	err := ctx.ReadResource("azure-native:elasticsan/v20240601preview:ElasticSan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ElasticSanArgs struct {
	// Auto Scale Properties for Elastic San Appliance.
	AutoScaleProperties AutoScalePropertiesPtrInput
	// Logical zone for Elastic San resource; example: ["1"].
...
// Auto Scale Properties for Elastic San Appliance.
func (o ElasticSanOutput) AutoScaleProperties() AutoScalePropertiesResponsePtrOutput {
	return o.ApplyT(func(v *ElasticSan) AutoScalePropertiesResponsePtrOutput { return v.AutoScaleProperties }).(AutoScalePropertiesResponsePtrOutput)
}
