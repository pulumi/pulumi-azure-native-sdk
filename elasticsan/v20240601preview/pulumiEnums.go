...
func (AutoScalePolicyEnforcement) ElementType() reflect.Type {
	return reflect.TypeOf((*AutoScalePolicyEnforcement)(nil)).Elem()
}

func (e AutoScalePolicyEnforcement) ToAutoScalePolicyEnforcementOutput() AutoScalePolicyEnforcementOutput {
	return pulumi.ToOutput(e).(AutoScalePolicyEnforcementOutput)
}

func (e AutoScalePolicyEnforcement) ToAutoScalePolicyEnforcementOutputWithContext(ctx context.Context) AutoScalePolicyEnforcementOutput {
	return pulumi.ToOutputWithContext(ctx, e).(AutoScalePolicyEnforcementOutput)
}

func (e AutoScalePolicyEnforcement) ToAutoScalePolicyEnforcementPtrOutput() AutoScalePolicyEnforcementPtrOutput {
	return e.ToAutoScalePolicyEnforcementPtrOutputWithContext(context.Background())
}

func (e AutoScalePolicyEnforcement) ToAutoScalePolicyEnforcementPtrOutputWithContext(ctx context.Context) AutoScalePolicyEnforcementPtrOutput {
	return AutoScalePolicyEnforcement(e).ToAutoScalePolicyEnforcementOutputWithContext(ctx).ToAutoScalePolicyEnforcementPtrOutputWithContext(ctx)
}

func (e AutoScalePolicyEnforcement) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e AutoScalePolicyEnforcement) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e AutoScalePolicyEnforcement) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e AutoScalePolicyEnforcement) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type AutoScalePolicyEnforcementOutput struct{ *pulumi.OutputState }

func (AutoScalePolicyEnforcementOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AutoScalePolicyEnforcement)(nil)).Elem()
}

func (o AutoScalePolicyEnforcementOutput) ToAutoScalePolicyEnforcementOutput() AutoScalePolicyEnforcementOutput {
	return o
}

func (o AutoScalePolicyEnforcementOutput) ToAutoScalePolicyEnforcementOutputWithContext(ctx context.Context) AutoScalePolicyEnforcementOutput {
	return o
}

func (o AutoScalePolicyEnforcementOutput) ToAutoScalePolicyEnforcementPtrOutput() AutoScalePolicyEnforcementPtrOutput {
	return o.ToAutoScalePolicyEnforcementPtrOutputWithContext(context.Background())
}

func (o AutoScalePolicyEnforcementOutput) ToAutoScalePolicyEnforcementPtrOutputWithContext(ctx context.Context) AutoScalePolicyEnforcementPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v AutoScalePolicyEnforcement) *AutoScalePolicyEnforcement {
		return &v
	}).(AutoScalePolicyEnforcementPtrOutput)
}

func (o AutoScalePolicyEnforcementOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o AutoScalePolicyEnforcementOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e AutoScalePolicyEnforcement) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o AutoScalePolicyEnforcementOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o AutoScalePolicyEnforcementOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e AutoScalePolicyEnforcement) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type AutoScalePolicyEnforcementPtrOutput struct{ *pulumi.OutputState }

func (AutoScalePolicyEnforcementPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AutoScalePolicyEnforcement)(nil)).Elem()
}

func (o AutoScalePolicyEnforcementPtrOutput) ToAutoScalePolicyEnforcementPtrOutput() AutoScalePolicyEnforcementPtrOutput {
	return o
}

func (o AutoScalePolicyEnforcementPtrOutput) ToAutoScalePolicyEnforcementPtrOutputWithContext(ctx context.Context) AutoScalePolicyEnforcementPtrOutput {
	return o
}

func (o AutoScalePolicyEnforcementPtrOutput) Elem() AutoScalePolicyEnforcementOutput {
	return o.ApplyT(func(v *AutoScalePolicyEnforcement) AutoScalePolicyEnforcement {
		if v != nil {
			return *v
		}
		var ret AutoScalePolicyEnforcement
		return ret
	}).(AutoScalePolicyEnforcementOutput)
}

func (o AutoScalePolicyEnforcementPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o AutoScalePolicyEnforcementPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *AutoScalePolicyEnforcement) *string {
		if e == nil {
			return nil
		}
...
// AutoScalePolicyEnforcementInput is an input type that accepts values of the AutoScalePolicyEnforcement enum
// A concrete instance of `AutoScalePolicyEnforcementInput` can be one of the following:
//
//	AutoScalePolicyEnforcementNone
//	AutoScalePolicyEnforcementEnabled
//	AutoScalePolicyEnforcementDisabled
type AutoScalePolicyEnforcementInput interface {
	pulumi.Input

	ToAutoScalePolicyEnforcementOutput() AutoScalePolicyEnforcementOutput
	ToAutoScalePolicyEnforcementOutputWithContext(context.Context) AutoScalePolicyEnforcementOutput
}

var autoScalePolicyEnforcementPtrType = reflect.TypeOf((**AutoScalePolicyEnforcement)(nil)).Elem()

type AutoScalePolicyEnforcementPtrInput interface {
	pulumi.Input

	ToAutoScalePolicyEnforcementPtrOutput() AutoScalePolicyEnforcementPtrOutput
	ToAutoScalePolicyEnforcementPtrOutputWithContext(context.Context) AutoScalePolicyEnforcementPtrOutput
}

type autoScalePolicyEnforcementPtr string

func AutoScalePolicyEnforcementPtr(v string) AutoScalePolicyEnforcementPtrInput {
	return (*autoScalePolicyEnforcementPtr)(&v)
}

func (*autoScalePolicyEnforcementPtr) ElementType() reflect.Type {
	return autoScalePolicyEnforcementPtrType
}

func (in *autoScalePolicyEnforcementPtr) ToAutoScalePolicyEnforcementPtrOutput() AutoScalePolicyEnforcementPtrOutput {
	return pulumi.ToOutput(in).(AutoScalePolicyEnforcementPtrOutput)
}

func (in *autoScalePolicyEnforcementPtr) ToAutoScalePolicyEnforcementPtrOutputWithContext(ctx context.Context) AutoScalePolicyEnforcementPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(AutoScalePolicyEnforcementPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(AutoScalePolicyEnforcementOutput{})
	pulumi.RegisterOutputType(AutoScalePolicyEnforcementPtrOutput{})
