...
func LookupVolumeSnapshot(ctx *pulumi.Context, args *LookupVolumeSnapshotArgs, opts ...pulumi.InvokeOption) (*LookupVolumeSnapshotResult, error) {
	...
	err := ctx.Invoke("azure-native:elasticsan/v20240601preview:getVolumeSnapshot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVolumeSnapshotOutput(ctx *pulumi.Context, args LookupVolumeSnapshotOutputArgs, opts ...pulumi.InvokeOption) LookupVolumeSnapshotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVolumeSnapshotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elasticsan/v20240601preview:getVolumeSnapshot", args, LookupVolumeSnapshotResultOutput{}, options).(LookupVolumeSnapshotResultOutput), nil
