...
func LookupElasticSan(ctx *pulumi.Context, args *LookupElasticSanArgs, opts ...pulumi.InvokeOption) (*LookupElasticSanResult, error) {
	...
	err := ctx.Invoke("azure-native:elasticsan/v20240601preview:getElasticSan", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Auto Scale Properties for Elastic San Appliance.
func (o LookupElasticSanResultOutput) AutoScaleProperties() AutoScalePropertiesResponsePtrOutput {
	return o.ApplyT(func(v LookupElasticSanResult) *AutoScalePropertiesResponse { return v.AutoScaleProperties }).(AutoScalePropertiesResponsePtrOutput)
}
