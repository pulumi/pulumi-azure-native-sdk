...
// Metadata pertaining to creation and last modification of the resource.
func (o ProductResponseOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ProductResponse) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
