...
func NewSubnet(ctx *pulumi.Context,
	...
	var resource Subnet
	err := ctx.RegisterResource("azure-native:network/v20170901:Subnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnet(ctx *pulumi.Context,
	...
	var resource Subnet
	err := ctx.ReadResource("azure-native:network/v20170901:Subnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
