...
func NewIpGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:IpGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpGroup(ctx *pulumi.Context,
	...
	var resource IpGroup
	err := ctx.ReadResource("azure-native:network/v20220901:IpGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
