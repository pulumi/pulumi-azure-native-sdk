...
func NewPublicIPAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:PublicIPAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIPAddress(ctx *pulumi.Context,
	...
	var resource PublicIPAddress
	err := ctx.ReadResource("azure-native:network/v20220901:PublicIPAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
