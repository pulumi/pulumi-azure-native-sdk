...
//
// Deprecated: azure-native:network/v20220901:DdosCustomPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DdosCustomPolicy to guarantee forwards compatibility.
func LookupDdosCustomPolicy(ctx *pulumi.Context, args *LookupDdosCustomPolicyArgs, opts ...pulumi.InvokeOption) (*LookupDdosCustomPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220901:getDdosCustomPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
