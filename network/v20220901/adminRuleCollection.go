...
func NewAdminRuleCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:AdminRuleCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdminRuleCollection(ctx *pulumi.Context,
	...
	var resource AdminRuleCollection
	err := ctx.ReadResource("azure-native:network/v20220901:AdminRuleCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
