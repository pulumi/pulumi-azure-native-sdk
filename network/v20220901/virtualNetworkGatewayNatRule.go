...
func NewVirtualNetworkGatewayNatRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:VirtualNetworkGatewayNatRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGatewayNatRule(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGatewayNatRule
	err := ctx.ReadResource("azure-native:network/v20220901:VirtualNetworkGatewayNatRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
