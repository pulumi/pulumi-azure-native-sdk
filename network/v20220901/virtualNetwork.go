...
func NewVirtualNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:VirtualNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetwork(ctx *pulumi.Context,
	...
	var resource VirtualNetwork
	err := ctx.ReadResource("azure-native:network/v20220901:VirtualNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
