...
func NewCustomIPPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:CustomIPPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomIPPrefix(ctx *pulumi.Context,
	...
	var resource CustomIPPrefix
	err := ctx.ReadResource("azure-native:network/v20220901:CustomIPPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
