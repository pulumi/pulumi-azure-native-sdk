...
func NewPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:PrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource PrivateEndpoint
	err := ctx.ReadResource("azure-native:network/v20220901:PrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
