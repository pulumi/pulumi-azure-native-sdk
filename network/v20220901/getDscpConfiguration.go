...
//
// Deprecated: azure-native:network/v20220901:DscpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DscpConfiguration to guarantee forwards compatibility.
func LookupDscpConfiguration(ctx *pulumi.Context, args *LookupDscpConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupDscpConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220901:getDscpConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
