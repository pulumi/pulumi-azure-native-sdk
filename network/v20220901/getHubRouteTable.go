...
//
// Deprecated: azure-native:network/v20220901:HubRouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:HubRouteTable to guarantee forwards compatibility.
func LookupHubRouteTable(ctx *pulumi.Context, args *LookupHubRouteTableArgs, opts ...pulumi.InvokeOption) (*LookupHubRouteTableResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220901:getHubRouteTable", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
