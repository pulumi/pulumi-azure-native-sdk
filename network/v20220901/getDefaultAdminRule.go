...
//
// Deprecated: azure-native:network/v20220901:DefaultAdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DefaultAdminRule to guarantee forwards compatibility.
func LookupDefaultAdminRule(ctx *pulumi.Context, args *LookupDefaultAdminRuleArgs, opts ...pulumi.InvokeOption) (*LookupDefaultAdminRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220901:getDefaultAdminRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
