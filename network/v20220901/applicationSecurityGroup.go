...
//
// Deprecated: azure-native:network/v20220901:ApplicationSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ApplicationSecurityGroup to guarantee forwards compatibility.
...
func NewApplicationSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:ApplicationSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSecurityGroup(ctx *pulumi.Context,
	...
	var resource ApplicationSecurityGroup
	err := ctx.ReadResource("azure-native:network/v20220901:ApplicationSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
