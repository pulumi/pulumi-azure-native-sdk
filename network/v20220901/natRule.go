...
//
// Deprecated: azure-native:network/v20220901:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatRule to guarantee forwards compatibility.
type NatRule struct {
...
func NewNatRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220901:NatRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNatRule(ctx *pulumi.Context,
	...
	var resource NatRule
	err := ctx.ReadResource("azure-native:network/v20220901:NatRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
