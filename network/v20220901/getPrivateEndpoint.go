...
//
// Deprecated: azure-native:network/v20220901:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateEndpoint to guarantee forwards compatibility.
func LookupPrivateEndpoint(ctx *pulumi.Context, args *LookupPrivateEndpointArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220901:getPrivateEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
