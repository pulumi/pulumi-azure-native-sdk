...
func NewVirtualNetworkLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200101:VirtualNetworkLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkLink(ctx *pulumi.Context,
	...
	var resource VirtualNetworkLink
	err := ctx.ReadResource("azure-native:network/v20200101:VirtualNetworkLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
