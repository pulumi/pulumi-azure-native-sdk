...
//
// Deprecated: azure-native:network/v20210801:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCircuit to guarantee forwards compatibility.
...
func NewExpressRouteCircuit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210801:ExpressRouteCircuit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuit(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuit
	err := ctx.ReadResource("azure-native:network/v20210801:ExpressRouteCircuit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
