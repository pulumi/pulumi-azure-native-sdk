...
func NewVirtualNetworkTap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210801:VirtualNetworkTap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkTap(ctx *pulumi.Context,
	...
	var resource VirtualNetworkTap
	err := ctx.ReadResource("azure-native:network/v20210801:VirtualNetworkTap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
