...
//
// Deprecated: azure-native:network/v20210801:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteFilter to guarantee forwards compatibility.
...
func NewRouteFilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210801:RouteFilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilter(ctx *pulumi.Context,
	...
	var resource RouteFilter
	err := ctx.ReadResource("azure-native:network/v20210801:RouteFilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
