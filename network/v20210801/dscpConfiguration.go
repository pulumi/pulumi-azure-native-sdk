...
func NewDscpConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210801:DscpConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscpConfiguration(ctx *pulumi.Context,
	...
	var resource DscpConfiguration
	err := ctx.ReadResource("azure-native:network/v20210801:DscpConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
