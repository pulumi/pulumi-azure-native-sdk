...
//
// Deprecated: azure-native:network/v20210801:VirtualHubBgpConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHubBgpConnection to guarantee forwards compatibility.
func LookupVirtualHubBgpConnection(ctx *pulumi.Context, args *LookupVirtualHubBgpConnectionArgs, opts ...pulumi.InvokeOption) (*LookupVirtualHubBgpConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20210801:getVirtualHubBgpConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
