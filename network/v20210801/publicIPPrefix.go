...
//
// Deprecated: azure-native:network/v20210801:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PublicIPPrefix to guarantee forwards compatibility.
...
func NewPublicIPPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210801:PublicIPPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIPPrefix(ctx *pulumi.Context,
	...
	var resource PublicIPPrefix
	err := ctx.ReadResource("azure-native:network/v20210801:PublicIPPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
