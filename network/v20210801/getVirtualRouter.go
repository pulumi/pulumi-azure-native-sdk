...
//
// Deprecated: azure-native:network/v20210801:VirtualRouter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualRouter to guarantee forwards compatibility.
func LookupVirtualRouter(ctx *pulumi.Context, args *LookupVirtualRouterArgs, opts ...pulumi.InvokeOption) (*LookupVirtualRouterResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20210801:getVirtualRouter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
