...
//
// Deprecated: azure-native:network/v20180801:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:PublicIPPrefix to guarantee forwards compatibility.
