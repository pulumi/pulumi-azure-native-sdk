...
//
// Deprecated: azure-native:network/v20180801:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:PublicIPAddress to guarantee forwards compatibility.
func LookupPublicIPAddress(ctx *pulumi.Context, args *LookupPublicIPAddressArgs, opts ...pulumi.InvokeOption) (*LookupPublicIPAddressResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20180801:getPublicIPAddress", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
