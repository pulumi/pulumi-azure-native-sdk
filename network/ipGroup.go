...
// The Azure API version of the resource.
func (o IpGroupOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *IpGroup) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
