...
//
// Deprecated: azure-native:network/v20190701:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteConnection to guarantee forwards compatibility.
...
func NewExpressRouteConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190701:ExpressRouteConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteConnection(ctx *pulumi.Context,
	...
	var resource ExpressRouteConnection
	err := ctx.ReadResource("azure-native:network/v20190701:ExpressRouteConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
