...
//
// Deprecated: azure-native:network/v20190701:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:VirtualNetworkGatewayConnection to guarantee forwards compatibility.
...
func NewVirtualNetworkGatewayConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190701:VirtualNetworkGatewayConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGatewayConnection(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGatewayConnection
	err := ctx.ReadResource("azure-native:network/v20190701:VirtualNetworkGatewayConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
