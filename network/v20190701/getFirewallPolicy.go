...
//
// Deprecated: azure-native:network/v20190701:FirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:FirewallPolicy to guarantee forwards compatibility.
func LookupFirewallPolicy(ctx *pulumi.Context, args *LookupFirewallPolicyArgs, opts ...pulumi.InvokeOption) (*LookupFirewallPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20190701:getFirewallPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
