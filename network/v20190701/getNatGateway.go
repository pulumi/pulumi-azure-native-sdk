...
//
// Deprecated: azure-native:network/v20190701:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:NatGateway to guarantee forwards compatibility.
func LookupNatGateway(ctx *pulumi.Context, args *LookupNatGatewayArgs, opts ...pulumi.InvokeOption) (*LookupNatGatewayResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20190701:getNatGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// A unique read-only string that changes whenever the resource is updated.
func (o LookupNatGatewayResultOutput) Etag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupNatGatewayResult) *string { return v.Etag }).(pulumi.StringPtrOutput)
}
...
// The resource GUID property of the NAT gateway resource.
func (o LookupNatGatewayResultOutput) ResourceGuid() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupNatGatewayResult) *string { return v.ResourceGuid }).(pulumi.StringPtrOutput)
}
