...
//
// Deprecated: azure-native:network/v20181101:DdosProtectionPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.
...
func NewDdosProtectionPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20181101:DdosProtectionPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosProtectionPlan(ctx *pulumi.Context,
	...
	var resource DdosProtectionPlan
	err := ctx.ReadResource("azure-native:network/v20181101:DdosProtectionPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
