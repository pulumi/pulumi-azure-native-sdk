...
//
// Deprecated: azure-native:network/v20181101:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.
func LookupExpressRouteCrossConnectionPeering(ctx *pulumi.Context, args *LookupExpressRouteCrossConnectionPeeringArgs, opts ...pulumi.InvokeOption) (*LookupExpressRouteCrossConnectionPeeringResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20181101:getExpressRouteCrossConnectionPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Gets whether the provider or the customer last modified the peering.
func (o LookupExpressRouteCrossConnectionPeeringResultOutput) LastModifiedBy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupExpressRouteCrossConnectionPeeringResult) *string { return v.LastModifiedBy }).(pulumi.StringPtrOutput)
}
