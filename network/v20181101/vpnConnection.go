...
//
// Deprecated: azure-native:network/v20181101:VpnConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnConnection to guarantee forwards compatibility.
...
func NewVpnConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20181101:VpnConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnConnection(ctx *pulumi.Context,
	...
	var resource VpnConnection
	err := ctx.ReadResource("azure-native:network/v20181101:VpnConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
