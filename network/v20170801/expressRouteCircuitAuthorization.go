...
// azure-native:network/v20170801:ExpressRouteCircuitAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:ExpressRouteCircuitAuthorization to guarantee forwards compatibility.
...
func NewExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20170801:ExpressRouteCircuitAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitAuthorization
	err := ctx.ReadResource("azure-native:network/v20170801:ExpressRouteCircuitAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
