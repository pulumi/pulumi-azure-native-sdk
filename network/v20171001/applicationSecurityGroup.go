...
func NewApplicationSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20171001:ApplicationSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSecurityGroup(ctx *pulumi.Context,
	...
	var resource ApplicationSecurityGroup
	err := ctx.ReadResource("azure-native:network/v20171001:ApplicationSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
