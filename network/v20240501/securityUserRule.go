...
func NewSecurityUserRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:SecurityUserRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityUserRule(ctx *pulumi.Context,
	...
	var resource SecurityUserRule
	err := ctx.ReadResource("azure-native:network/v20240501:SecurityUserRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
