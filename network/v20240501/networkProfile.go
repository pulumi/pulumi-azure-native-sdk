...
func NewNetworkProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220701:NetworkProfile"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:NetworkProfile"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:NetworkProfile"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:NetworkProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkProfile(ctx *pulumi.Context,
	...
	var resource NetworkProfile
	err := ctx.ReadResource("azure-native:network/v20240501:NetworkProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
