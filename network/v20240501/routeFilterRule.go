...
func NewRouteFilterRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230401:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:RouteFilterRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:RouteFilterRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:RouteFilterRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilterRule(ctx *pulumi.Context,
	...
	var resource RouteFilterRule
	err := ctx.ReadResource("azure-native:network/v20240501:RouteFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
