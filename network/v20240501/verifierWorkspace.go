...
func NewVerifierWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:VerifierWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVerifierWorkspace(ctx *pulumi.Context,
	...
	var resource VerifierWorkspace
	err := ctx.ReadResource("azure-native:network/v20240501:VerifierWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
