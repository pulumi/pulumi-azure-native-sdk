...
func NewLocalNetworkGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:LocalNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:LocalNetworkGateway"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:LocalNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalNetworkGateway(ctx *pulumi.Context,
	...
	var resource LocalNetworkGateway
	err := ctx.ReadResource("azure-native:network/v20240501:LocalNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
