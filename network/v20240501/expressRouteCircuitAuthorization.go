...
func NewExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:ExpressRouteCircuitAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitAuthorization(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitAuthorization
	err := ctx.ReadResource("azure-native:network/v20240501:ExpressRouteCircuitAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
