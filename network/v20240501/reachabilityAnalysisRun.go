...
func NewReachabilityAnalysisRun(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:ReachabilityAnalysisRun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReachabilityAnalysisRun(ctx *pulumi.Context,
	...
	var resource ReachabilityAnalysisRun
	err := ctx.ReadResource("azure-native:network/v20240501:ReachabilityAnalysisRun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
