...
func NewSecurityUserConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:SecurityUserConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityUserConfiguration(ctx *pulumi.Context,
	...
	var resource SecurityUserConfiguration
	err := ctx.ReadResource("azure-native:network/v20240501:SecurityUserConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
