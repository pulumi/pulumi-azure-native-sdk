...
func NewExpressRoutePort(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:ExpressRoutePort", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRoutePort(ctx *pulumi.Context,
	...
	var resource ExpressRoutePort
	err := ctx.ReadResource("azure-native:network/v20240501:ExpressRoutePort", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
