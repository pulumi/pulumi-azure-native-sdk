...
func NewNetworkVirtualAppliance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:NetworkVirtualAppliance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkVirtualAppliance(ctx *pulumi.Context,
	...
	var resource NetworkVirtualAppliance
	err := ctx.ReadResource("azure-native:network/v20240501:NetworkVirtualAppliance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
