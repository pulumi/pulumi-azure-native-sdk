...
func NewSecurityUserRuleCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:SecurityUserRuleCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityUserRuleCollection(ctx *pulumi.Context,
	...
	var resource SecurityUserRuleCollection
	err := ctx.ReadResource("azure-native:network/v20240501:SecurityUserRuleCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
