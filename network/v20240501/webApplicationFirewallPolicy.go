...
func NewWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240501:WebApplicationFirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApplicationFirewallPolicy(ctx *pulumi.Context,
	...
	var resource WebApplicationFirewallPolicy
	err := ctx.ReadResource("azure-native:network/v20240501:WebApplicationFirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
