...
func LookupVirtualNetworkGateway(ctx *pulumi.Context, args *LookupVirtualNetworkGatewayArgs, opts ...pulumi.InvokeOption) (*LookupVirtualNetworkGatewayResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20240501:getVirtualNetworkGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVirtualNetworkGatewayOutput(ctx *pulumi.Context, args LookupVirtualNetworkGatewayOutputArgs, opts ...pulumi.InvokeOption) LookupVirtualNetworkGatewayResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVirtualNetworkGatewayResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20240501:getVirtualNetworkGateway", args, LookupVirtualNetworkGatewayResultOutput{}, options).(LookupVirtualNetworkGatewayResultOutput), nil
...
// Property to indicate if the Express Route Gateway serves traffic when there are multiple Express Route Gateways in the vnet
func (o LookupVirtualNetworkGatewayResultOutput) AdminState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualNetworkGatewayResult) *string { return v.AdminState }).(pulumi.StringPtrOutput)
}
...
// Autoscale configuration for virutal network gateway
func (o LookupVirtualNetworkGatewayResultOutput) AutoScaleConfiguration() VirtualNetworkGatewayAutoScaleConfigurationResponsePtrOutput {
	return o.ApplyT(func(v LookupVirtualNetworkGatewayResult) *VirtualNetworkGatewayAutoScaleConfigurationResponse {
...
// disableIPSecReplayProtection flag.
func (o LookupVirtualNetworkGatewayResultOutput) DisableIPSecReplayProtection() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupVirtualNetworkGatewayResult) *bool { return v.DisableIPSecReplayProtection }).(pulumi.BoolPtrOutput)
}
...
// The identity of the virtual network gateway, if configured.
func (o LookupVirtualNetworkGatewayResultOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupVirtualNetworkGatewayResult) *ManagedServiceIdentityResponse { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}
...
// Property to indicate if the Express Route Gateway has resiliency model of MultiHomed or SingleHomed
func (o LookupVirtualNetworkGatewayResultOutput) ResiliencyModel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualNetworkGatewayResult) *string { return v.ResiliencyModel }).(pulumi.StringPtrOutput)
}
...
// The reference to the VirtualNetworkGatewayPolicyGroup resource which represents the available VirtualNetworkGatewayPolicyGroup for the gateway.
func (o LookupVirtualNetworkGatewayResultOutput) VirtualNetworkGatewayPolicyGroups() VirtualNetworkGatewayPolicyGroupResponseArrayOutput {
	return o.ApplyT(func(v LookupVirtualNetworkGatewayResult) []VirtualNetworkGatewayPolicyGroupResponse {
