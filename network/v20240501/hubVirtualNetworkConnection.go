...
func NewHubVirtualNetworkConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:HubVirtualNetworkConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:HubVirtualNetworkConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:HubVirtualNetworkConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:HubVirtualNetworkConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:HubVirtualNetworkConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource HubVirtualNetworkConnection
	err := ctx.RegisterResource("azure-native:network/v20240501:HubVirtualNetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHubVirtualNetworkConnection(ctx *pulumi.Context,
	...
	var resource HubVirtualNetworkConnection
	err := ctx.ReadResource("azure-native:network/v20240501:HubVirtualNetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
