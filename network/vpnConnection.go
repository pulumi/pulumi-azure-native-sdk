...
func NewVpnConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240701:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20241001:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250101:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250301:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250501:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20250701:VpnConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VpnConnection
	err := ctx.RegisterResource("azure-native:network:VpnConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnConnection(ctx *pulumi.Context,
	...
	var resource VpnConnection
	err := ctx.ReadResource("azure-native:network:VpnConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o VpnConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VpnConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
