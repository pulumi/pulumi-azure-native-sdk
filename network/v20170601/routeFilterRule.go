...
// azure-native:network/v20170601:RouteFilterRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20171001:RouteFilterRule to guarantee forwards compatibility.
...
func NewRouteFilterRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20170601:RouteFilterRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilterRule(ctx *pulumi.Context,
	...
	var resource RouteFilterRule
	err := ctx.ReadResource("azure-native:network/v20170601:RouteFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RouteFilterRuleOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *RouteFilterRule) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
