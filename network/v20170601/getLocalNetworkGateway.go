...
// azure-native:network/v20170601:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:LocalNetworkGateway to guarantee forwards compatibility.
