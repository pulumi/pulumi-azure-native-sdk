...
// azure-native:network/v20170601:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:VirtualNetworkGateway to guarantee forwards compatibility.
...
func NewVirtualNetworkGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20170601:VirtualNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGateway(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGateway
	err := ctx.ReadResource("azure-native:network/v20170601:VirtualNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
