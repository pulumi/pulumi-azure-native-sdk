...
func LookupDefaultAdminRule(ctx *pulumi.Context, args *LookupDefaultAdminRuleArgs, opts ...pulumi.InvokeOption) (*LookupDefaultAdminRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20240301:getDefaultAdminRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDefaultAdminRuleOutput(ctx *pulumi.Context, args LookupDefaultAdminRuleOutputArgs, opts ...pulumi.InvokeOption) LookupDefaultAdminRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDefaultAdminRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20240301:getDefaultAdminRule", args, LookupDefaultAdminRuleResultOutput{}, options).(LookupDefaultAdminRuleResultOutput), nil
