...
func NewNetworkManagerRoutingConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:NetworkManagerRoutingConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkManagerRoutingConfiguration(ctx *pulumi.Context,
	...
	var resource NetworkManagerRoutingConfiguration
	err := ctx.ReadResource("azure-native:network/v20240301:NetworkManagerRoutingConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
