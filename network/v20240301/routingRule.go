...
func NewRoutingRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:RoutingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoutingRule(ctx *pulumi.Context,
	...
	var resource RoutingRule
	err := ctx.ReadResource("azure-native:network/v20240301:RoutingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
