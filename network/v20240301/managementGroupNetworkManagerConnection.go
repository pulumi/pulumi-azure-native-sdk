...
func NewManagementGroupNetworkManagerConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:ManagementGroupNetworkManagerConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroupNetworkManagerConnection(ctx *pulumi.Context,
	...
	var resource ManagementGroupNetworkManagerConnection
	err := ctx.ReadResource("azure-native:network/v20240301:ManagementGroupNetworkManagerConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
