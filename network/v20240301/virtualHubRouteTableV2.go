...
func NewVirtualHubRouteTableV2(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:VirtualHubRouteTableV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubRouteTableV2(ctx *pulumi.Context,
	...
	var resource VirtualHubRouteTableV2
	err := ctx.ReadResource("azure-native:network/v20240301:VirtualHubRouteTableV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
