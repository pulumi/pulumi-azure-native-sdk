...
func NewPacketCapture(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:PacketCapture", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPacketCapture(ctx *pulumi.Context,
	...
	var resource PacketCapture
	err := ctx.ReadResource("azure-native:network/v20240301:PacketCapture", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
