...
func NewNetworkManager(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220501:NetworkManager"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230401:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101preview:NetworkManager"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:NetworkManager"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:NetworkManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkManager(ctx *pulumi.Context,
	...
	var resource NetworkManager
	err := ctx.ReadResource("azure-native:network/v20240301:NetworkManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Unique identifier for this resource.
func (o NetworkManagerOutput) ResourceGuid() pulumi.StringOutput {
	return o.ApplyT(func(v *NetworkManager) pulumi.StringOutput { return v.ResourceGuid }).(pulumi.StringOutput)
}
