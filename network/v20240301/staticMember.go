...
func NewStaticMember(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:StaticMember"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:StaticMember"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:StaticMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticMember(ctx *pulumi.Context,
	...
	var resource StaticMember
	err := ctx.ReadResource("azure-native:network/v20240301:StaticMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
