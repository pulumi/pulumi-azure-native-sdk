...
func NewLoadBalancerBackendAddressPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:LoadBalancerBackendAddressPool"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:LoadBalancerBackendAddressPool"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:LoadBalancerBackendAddressPool"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:LoadBalancerBackendAddressPool"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:LoadBalancerBackendAddressPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancerBackendAddressPool(ctx *pulumi.Context,
	...
	var resource LoadBalancerBackendAddressPool
	err := ctx.ReadResource("azure-native:network/v20240301:LoadBalancerBackendAddressPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Backend address synchronous mode for the backend pool
func (o LoadBalancerBackendAddressPoolOutput) SyncMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LoadBalancerBackendAddressPool) pulumi.StringPtrOutput { return v.SyncMode }).(pulumi.StringPtrOutput)
}
