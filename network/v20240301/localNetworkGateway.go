...
func NewLocalNetworkGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:LocalNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalNetworkGateway(ctx *pulumi.Context,
	...
	var resource LocalNetworkGateway
	err := ctx.ReadResource("azure-native:network/v20240301:LocalNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
