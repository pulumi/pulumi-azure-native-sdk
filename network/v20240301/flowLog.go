...
func NewFlowLog(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:FlowLog"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:FlowLog"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:FlowLog"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:FlowLog"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:FlowLog"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:FlowLog"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource FlowLog
	err := ctx.RegisterResource("azure-native:network/v20240301:FlowLog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlowLog(ctx *pulumi.Context,
	...
	var resource FlowLog
	err := ctx.ReadResource("azure-native:network/v20240301:FlowLog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
