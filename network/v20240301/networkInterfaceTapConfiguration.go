...
func NewNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240301:NetworkInterfaceTapConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	var resource NetworkInterfaceTapConfiguration
	err := ctx.ReadResource("azure-native:network/v20240301:NetworkInterfaceTapConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
