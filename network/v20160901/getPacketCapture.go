...
// azure-native:network/v20160901:PacketCapture is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180101:PacketCapture to guarantee forwards compatibility.
func LookupPacketCapture(ctx *pulumi.Context, args *LookupPacketCaptureArgs, opts ...pulumi.InvokeOption) (*LookupPacketCaptureResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20160901:getPacketCapture", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
