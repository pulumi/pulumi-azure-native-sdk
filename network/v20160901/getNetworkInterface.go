...
// azure-native:network/v20160901:NetworkInterface is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180701:NetworkInterface to guarantee forwards compatibility.
func LookupNetworkInterface(ctx *pulumi.Context, args *LookupNetworkInterfaceArgs, opts ...pulumi.InvokeOption) (*LookupNetworkInterfaceResult, error) {
	var rv LookupNetworkInterfaceResult
	err := ctx.Invoke("azure-native:network/v20160901:getNetworkInterface", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
