...
func NewBastionHost(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190801:BastionHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBastionHost(ctx *pulumi.Context,
	...
	var resource BastionHost
	err := ctx.ReadResource("azure-native:network/v20190801:BastionHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
