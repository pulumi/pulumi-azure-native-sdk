...
// VpnSite Resource.
//
// Deprecated: azure-native:network/v20190801:VpnSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnSite to guarantee forwards compatibility.
type VpnSite struct {
...
func NewVpnSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190801:VpnSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnSite(ctx *pulumi.Context,
	...
	var resource VpnSite
	err := ctx.ReadResource("azure-native:network/v20190801:VpnSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
