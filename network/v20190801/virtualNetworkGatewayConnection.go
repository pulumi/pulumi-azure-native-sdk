...
func NewVirtualNetworkGatewayConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220701:VirtualNetworkGatewayConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:VirtualNetworkGatewayConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:VirtualNetworkGatewayConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:VirtualNetworkGatewayConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:VirtualNetworkGatewayConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:VirtualNetworkGatewayConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:VirtualNetworkGatewayConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20190801:VirtualNetworkGatewayConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGatewayConnection(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGatewayConnection
	err := ctx.ReadResource("azure-native:network/v20190801:VirtualNetworkGatewayConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
