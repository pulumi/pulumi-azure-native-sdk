...
func NewNetworkInterface(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:NetworkInterface"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20190801:NetworkInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterface(ctx *pulumi.Context,
	...
	var resource NetworkInterface
	err := ctx.ReadResource("azure-native:network/v20190801:NetworkInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
