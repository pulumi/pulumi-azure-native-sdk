...
//
// Deprecated: azure-native:network/v20190801:VirtualRouter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualRouter to guarantee forwards compatibility.
...
func NewVirtualRouter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190801:VirtualRouter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouter(ctx *pulumi.Context,
	...
	var resource VirtualRouter
	err := ctx.ReadResource("azure-native:network/v20190801:VirtualRouter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
