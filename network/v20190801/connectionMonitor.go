...
//
// Deprecated: azure-native:network/v20190801:ConnectionMonitor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190901:ConnectionMonitor to guarantee forwards compatibility.
...
func NewConnectionMonitor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190801:ConnectionMonitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionMonitor(ctx *pulumi.Context,
	...
	var resource ConnectionMonitor
	err := ctx.ReadResource("azure-native:network/v20190801:ConnectionMonitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
