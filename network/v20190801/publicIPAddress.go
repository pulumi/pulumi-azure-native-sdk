...
func NewPublicIPAddress(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:PublicIPAddress"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PublicIPAddress
	err := ctx.RegisterResource("azure-native:network/v20190801:PublicIPAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIPAddress(ctx *pulumi.Context,
	...
	var resource PublicIPAddress
	err := ctx.ReadResource("azure-native:network/v20190801:PublicIPAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
