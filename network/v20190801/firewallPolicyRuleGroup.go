...
func NewFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190801:FirewallPolicyRuleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	var resource FirewallPolicyRuleGroup
	err := ctx.ReadResource("azure-native:network/v20190801:FirewallPolicyRuleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
