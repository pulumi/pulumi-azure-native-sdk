...
func NewSecurityRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190801:SecurityRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityRule(ctx *pulumi.Context,
	...
	var resource SecurityRule
	err := ctx.ReadResource("azure-native:network/v20190801:SecurityRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
