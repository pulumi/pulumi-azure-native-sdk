...
func NewP2sVpnServerConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20181201:P2sVpnServerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetP2sVpnServerConfiguration(ctx *pulumi.Context,
	...
	var resource P2sVpnServerConfiguration
	err := ctx.ReadResource("azure-native:network/v20181201:P2sVpnServerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
