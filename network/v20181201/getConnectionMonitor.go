...
//
// Deprecated: azure-native:network/v20181201:ConnectionMonitor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190901:ConnectionMonitor to guarantee forwards compatibility.
func LookupConnectionMonitor(ctx *pulumi.Context, args *LookupConnectionMonitorArgs, opts ...pulumi.InvokeOption) (*LookupConnectionMonitorResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20181201:getConnectionMonitor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
