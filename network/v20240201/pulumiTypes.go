...
// List of log scrubbing rules applied to the Web Application Firewall logs.
func (o FrontDoorPolicySettingsOutput) ScrubbingRules() WebApplicationFirewallScrubbingRulesArrayOutput {
	return o.ApplyT(func(v FrontDoorPolicySettings) []WebApplicationFirewallScrubbingRules { return v.ScrubbingRules }).(WebApplicationFirewallScrubbingRulesArrayOutput)
}

// State of the log scrubbing config. Default value is Enabled.
func (o FrontDoorPolicySettingsOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FrontDoorPolicySettings) *string { return v.State }).(pulumi.StringPtrOutput)
}
...
// List of log scrubbing rules applied to the Web Application Firewall logs.
func (o FrontDoorPolicySettingsPtrOutput) ScrubbingRules() WebApplicationFirewallScrubbingRulesArrayOutput {
	return o.ApplyT(func(v *FrontDoorPolicySettings) []WebApplicationFirewallScrubbingRules {
		if v == nil {
			return nil
		}
...
// State of the log scrubbing config. Default value is Enabled.
func (o FrontDoorPolicySettingsPtrOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FrontDoorPolicySettings) *string {
		if v == nil {
			return nil
		}
...
// List of log scrubbing rules applied to the Web Application Firewall logs.
func (o FrontDoorPolicySettingsResponseOutput) ScrubbingRules() WebApplicationFirewallScrubbingRulesResponseArrayOutput {
	return o.ApplyT(func(v FrontDoorPolicySettingsResponse) []WebApplicationFirewallScrubbingRulesResponse {
		return v.ScrubbingRules
	}).(WebApplicationFirewallScrubbingRulesResponseArrayOutput)
}

// State of the log scrubbing config. Default value is Enabled.
func (o FrontDoorPolicySettingsResponseOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FrontDoorPolicySettingsResponse) *string { return v.State }).(pulumi.StringPtrOutput)
}
...
// List of log scrubbing rules applied to the Web Application Firewall logs.
func (o FrontDoorPolicySettingsResponsePtrOutput) ScrubbingRules() WebApplicationFirewallScrubbingRulesResponseArrayOutput {
	return o.ApplyT(func(v *FrontDoorPolicySettingsResponse) []WebApplicationFirewallScrubbingRulesResponse {
		if v == nil {
			return nil
		}
...
// State of the log scrubbing config. Default value is Enabled.
func (o FrontDoorPolicySettingsResponsePtrOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FrontDoorPolicySettingsResponse) *string {
		if v == nil {
			return nil
		}
