...
//
// Deprecated: azure-native:network/v20190201:InboundNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:InboundNatRule to guarantee forwards compatibility.
...
func NewInboundNatRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190201:InboundNatRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInboundNatRule(ctx *pulumi.Context,
	...
	var resource InboundNatRule
	err := ctx.ReadResource("azure-native:network/v20190201:InboundNatRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o InboundNatRuleOutput) Etag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InboundNatRule) pulumi.StringPtrOutput { return v.Etag }).(pulumi.StringPtrOutput)
}
...
func (o InboundNatRuleOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InboundNatRule) pulumi.StringPtrOutput { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
