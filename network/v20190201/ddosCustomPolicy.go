...
//
// Deprecated: azure-native:network/v20190201:DdosCustomPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220101:DdosCustomPolicy to guarantee forwards compatibility.
...
func NewDdosCustomPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190201:DdosCustomPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosCustomPolicy(ctx *pulumi.Context,
	...
	var resource DdosCustomPolicy
	err := ctx.ReadResource("azure-native:network/v20190201:DdosCustomPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
