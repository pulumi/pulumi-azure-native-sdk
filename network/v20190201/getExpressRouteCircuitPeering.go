...
func LookupExpressRouteCircuitPeering(ctx *pulumi.Context, args *LookupExpressRouteCircuitPeeringArgs, opts ...pulumi.InvokeOption) (*LookupExpressRouteCircuitPeeringResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20190201:getExpressRouteCircuitPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupExpressRouteCircuitPeeringResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupExpressRouteCircuitPeeringResult] {
	return pulumix.Output[LookupExpressRouteCircuitPeeringResult]{
