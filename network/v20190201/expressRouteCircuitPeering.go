...
func NewExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ExpressRouteCircuitPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:ExpressRouteCircuitPeering"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20190201:ExpressRouteCircuitPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitPeering
	err := ctx.ReadResource("azure-native:network/v20190201:ExpressRouteCircuitPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
