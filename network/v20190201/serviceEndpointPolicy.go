...
func NewServiceEndpointPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190201:ServiceEndpointPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpointPolicy(ctx *pulumi.Context,
	...
	var resource ServiceEndpointPolicy
	err := ctx.ReadResource("azure-native:network/v20190201:ServiceEndpointPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
