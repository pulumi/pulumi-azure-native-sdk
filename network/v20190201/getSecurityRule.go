...
//
// Deprecated: azure-native:network/v20190201:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:SecurityRule to guarantee forwards compatibility.
func LookupSecurityRule(ctx *pulumi.Context, args *LookupSecurityRuleArgs, opts ...pulumi.InvokeOption) (*LookupSecurityRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20190201:getSecurityRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
