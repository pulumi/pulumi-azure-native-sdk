...
func NewNetworkProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190201:NetworkProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkProfile(ctx *pulumi.Context,
	...
	var resource NetworkProfile
	err := ctx.ReadResource("azure-native:network/v20190201:NetworkProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
