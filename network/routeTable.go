...
func NewRouteTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230501:RouteTable"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20231101:RouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:RouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:RouteTable"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network:RouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteTable(ctx *pulumi.Context,
	...
	var resource RouteTable
	err := ctx.ReadResource("azure-native:network:RouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o RouteTableOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *RouteTable) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
