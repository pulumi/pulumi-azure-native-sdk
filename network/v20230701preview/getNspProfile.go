...
func LookupNspProfile(ctx *pulumi.Context, args *LookupNspProfileArgs, opts ...pulumi.InvokeOption) (*LookupNspProfileResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230701preview:getNspProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupNspProfileOutput(ctx *pulumi.Context, args LookupNspProfileOutputArgs, opts ...pulumi.InvokeOption) LookupNspProfileResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNspProfileResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20230701preview:getNspProfile", args, LookupNspProfileResultOutput{}, options).(LookupNspProfileResultOutput), nil
