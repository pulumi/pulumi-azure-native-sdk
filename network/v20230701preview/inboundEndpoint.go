...
func NewInboundEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230701preview:InboundEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInboundEndpoint(ctx *pulumi.Context,
	...
	var resource InboundEndpoint
	err := ctx.ReadResource("azure-native:network/v20230701preview:InboundEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
