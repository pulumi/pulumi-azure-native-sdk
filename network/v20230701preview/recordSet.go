...
func NewRecordSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230701preview:RecordSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRecordSet(ctx *pulumi.Context,
	...
	var resource RecordSet
	err := ctx.ReadResource("azure-native:network/v20230701preview:RecordSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
