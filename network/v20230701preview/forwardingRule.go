...
func NewForwardingRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230701preview:ForwardingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetForwardingRule(ctx *pulumi.Context,
	...
	var resource ForwardingRule
	err := ctx.ReadResource("azure-native:network/v20230701preview:ForwardingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
