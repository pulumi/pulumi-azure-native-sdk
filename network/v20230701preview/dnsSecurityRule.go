...
func NewDnsSecurityRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230701preview:DnsSecurityRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsSecurityRule(ctx *pulumi.Context,
	...
	var resource DnsSecurityRule
	err := ctx.ReadResource("azure-native:network/v20230701preview:DnsSecurityRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
