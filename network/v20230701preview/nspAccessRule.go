...
func NewNspAccessRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230701preview:NspAccessRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNspAccessRule(ctx *pulumi.Context,
	...
	var resource NspAccessRule
	err := ctx.ReadResource("azure-native:network/v20230701preview:NspAccessRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
