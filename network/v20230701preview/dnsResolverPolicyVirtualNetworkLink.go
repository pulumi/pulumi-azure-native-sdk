...
func NewDnsResolverPolicyVirtualNetworkLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsResolverPolicyVirtualNetworkLink(ctx *pulumi.Context,
	...
	var resource DnsResolverPolicyVirtualNetworkLink
	err := ctx.ReadResource("azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
