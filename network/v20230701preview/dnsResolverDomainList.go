...
func NewDnsResolverDomainList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230701preview:DnsResolverDomainList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsResolverDomainList(ctx *pulumi.Context,
	...
	var resource DnsResolverDomainList
	err := ctx.ReadResource("azure-native:network/v20230701preview:DnsResolverDomainList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
