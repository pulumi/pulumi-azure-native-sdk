...
//
// Deprecated: azure-native:network/v20181001:P2sVpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190701:P2sVpnServerConfiguration to guarantee forwards compatibility.
...
func NewP2sVpnServerConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20181001:P2sVpnServerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetP2sVpnServerConfiguration(ctx *pulumi.Context,
	...
	var resource P2sVpnServerConfiguration
	err := ctx.ReadResource("azure-native:network/v20181001:P2sVpnServerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
