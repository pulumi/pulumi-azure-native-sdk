...
//
// Deprecated: azure-native:network/v20181001:P2sVpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190701:P2sVpnGateway to guarantee forwards compatibility.
func LookupP2sVpnGateway(ctx *pulumi.Context, args *LookupP2sVpnGatewayArgs, opts ...pulumi.InvokeOption) (*LookupP2sVpnGatewayResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20181001:getP2sVpnGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
