...
func NewInterfaceEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20181001:InterfaceEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceEndpoint(ctx *pulumi.Context,
	...
	var resource InterfaceEndpoint
	err := ctx.ReadResource("azure-native:network/v20181001:InterfaceEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
