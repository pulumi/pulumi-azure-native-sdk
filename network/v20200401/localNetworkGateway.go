...
//
// Deprecated: azure-native:network/v20200401:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LocalNetworkGateway to guarantee forwards compatibility.
...
func NewLocalNetworkGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200401:LocalNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalNetworkGateway(ctx *pulumi.Context,
	...
	var resource LocalNetworkGateway
	err := ctx.ReadResource("azure-native:network/v20200401:LocalNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
