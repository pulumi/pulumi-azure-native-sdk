...
//
// Deprecated: azure-native:network/v20200401:ConnectionMonitor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConnectionMonitor to guarantee forwards compatibility.
