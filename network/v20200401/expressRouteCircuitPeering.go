...
//
// Deprecated: azure-native:network/v20200401:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCircuitPeering to guarantee forwards compatibility.
...
func NewExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200401:ExpressRouteCircuitPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitPeering
	err := ctx.ReadResource("azure-native:network/v20200401:ExpressRouteCircuitPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
