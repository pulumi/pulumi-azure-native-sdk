...
// The Azure API version of the resource.
func (o NatRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *NatRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
