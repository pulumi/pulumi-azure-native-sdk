...
func NewConfigurationPolicyGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:ConfigurationPolicyGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationPolicyGroup(ctx *pulumi.Context,
	...
	var resource ConfigurationPolicyGroup
	err := ctx.ReadResource("azure-native:network/v20240101:ConfigurationPolicyGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
