...
func NewHubVirtualNetworkConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:HubVirtualNetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHubVirtualNetworkConnection(ctx *pulumi.Context,
	...
	var resource HubVirtualNetworkConnection
	err := ctx.ReadResource("azure-native:network/v20240101:HubVirtualNetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
