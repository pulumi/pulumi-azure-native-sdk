...
func NewRoutingIntent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:RoutingIntent"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:RoutingIntent"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:RoutingIntent"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:RoutingIntent"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:RoutingIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoutingIntent(ctx *pulumi.Context,
	...
	var resource RoutingIntent
	err := ctx.ReadResource("azure-native:network/v20240101:RoutingIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
