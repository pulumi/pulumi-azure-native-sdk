...
func NewExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20231101:ExpressRouteCrossConnectionPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ExpressRouteCrossConnectionPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:ExpressRouteCrossConnectionPeering"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:ExpressRouteCrossConnectionPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCrossConnectionPeering
	err := ctx.ReadResource("azure-native:network/v20240101:ExpressRouteCrossConnectionPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
