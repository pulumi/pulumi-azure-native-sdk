...
func NewHubRouteTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:HubRouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:HubRouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:HubRouteTable"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:HubRouteTable"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:HubRouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHubRouteTable(ctx *pulumi.Context,
	...
	var resource HubRouteTable
	err := ctx.ReadResource("azure-native:network/v20240101:HubRouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
