...
func NewSecurityAdminConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:SecurityAdminConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityAdminConfiguration(ctx *pulumi.Context,
	...
	var resource SecurityAdminConfiguration
	err := ctx.ReadResource("azure-native:network/v20240101:SecurityAdminConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
