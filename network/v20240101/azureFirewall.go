...
func NewAzureFirewall(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:AzureFirewall"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:AzureFirewall"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:AzureFirewall"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:AzureFirewall", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureFirewall(ctx *pulumi.Context,
	...
	var resource AzureFirewall
	err := ctx.ReadResource("azure-native:network/v20240101:AzureFirewall", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
