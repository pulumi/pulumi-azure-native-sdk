...
func NewFirewallPolicyDraft(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:FirewallPolicyDraft", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyDraft(ctx *pulumi.Context,
	...
	var resource FirewallPolicyDraft
	err := ctx.ReadResource("azure-native:network/v20240101:FirewallPolicyDraft", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
