...
func NewP2sVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240101:P2sVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetP2sVpnGateway(ctx *pulumi.Context,
	...
	var resource P2sVpnGateway
	err := ctx.ReadResource("azure-native:network/v20240101:P2sVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
