...
func NewVirtualHubRouteTableV2(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:VirtualHubRouteTableV2"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:VirtualHubRouteTableV2"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:VirtualHubRouteTableV2"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:VirtualHubRouteTableV2"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualHubRouteTableV2
	err := ctx.RegisterResource("azure-native:network/v20240101:VirtualHubRouteTableV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubRouteTableV2(ctx *pulumi.Context,
	...
	var resource VirtualHubRouteTableV2
	err := ctx.ReadResource("azure-native:network/v20240101:VirtualHubRouteTableV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
