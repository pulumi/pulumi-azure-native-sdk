...
// The Azure API version of the resource.
func (o VirtualNetworkTapOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualNetworkTap) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
