...
func NewNetworkSecurityPerimeterLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network:NetworkSecurityPerimeterLink"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkSecurityPerimeterLink
	err := ctx.RegisterResource("azure-native:network/v20240601preview:NetworkSecurityPerimeterLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityPerimeterLink(ctx *pulumi.Context,
	...
	var resource NetworkSecurityPerimeterLink
	err := ctx.ReadResource("azure-native:network/v20240601preview:NetworkSecurityPerimeterLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
