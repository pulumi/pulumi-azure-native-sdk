...
func NewNetworkSecurityPerimeterAccessRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network:NetworkSecurityPerimeterAccessRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkSecurityPerimeterAccessRule
	err := ctx.RegisterResource("azure-native:network/v20240601preview:NetworkSecurityPerimeterAccessRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityPerimeterAccessRule(ctx *pulumi.Context,
	...
	var resource NetworkSecurityPerimeterAccessRule
	err := ctx.ReadResource("azure-native:network/v20240601preview:NetworkSecurityPerimeterAccessRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
