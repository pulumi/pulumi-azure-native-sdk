...
func NewNetworkSecurityPerimeterLoggingConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:network:NetworkSecurityPerimeterLoggingConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkSecurityPerimeterLoggingConfiguration
	err := ctx.RegisterResource("azure-native:network/v20240601preview:NetworkSecurityPerimeterLoggingConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityPerimeterLoggingConfiguration(ctx *pulumi.Context,
	...
	var resource NetworkSecurityPerimeterLoggingConfiguration
	err := ctx.ReadResource("azure-native:network/v20240601preview:NetworkSecurityPerimeterLoggingConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
