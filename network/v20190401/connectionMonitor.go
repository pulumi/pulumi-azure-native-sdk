...
func NewConnectionMonitor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190401:ConnectionMonitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionMonitor(ctx *pulumi.Context,
	...
	var resource ConnectionMonitor
	err := ctx.ReadResource("azure-native:network/v20190401:ConnectionMonitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
