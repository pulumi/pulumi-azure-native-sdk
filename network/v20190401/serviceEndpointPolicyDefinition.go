...
func NewServiceEndpointPolicyDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190401:ServiceEndpointPolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpointPolicyDefinition(ctx *pulumi.Context,
	...
	var resource ServiceEndpointPolicyDefinition
	err := ctx.ReadResource("azure-native:network/v20190401:ServiceEndpointPolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
