...
// azure-native:network/v20170301:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:VirtualNetwork to guarantee forwards compatibility.
...
func NewVirtualNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20170301:VirtualNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetwork(ctx *pulumi.Context,
	...
	var resource VirtualNetwork
	err := ctx.ReadResource("azure-native:network/v20170301:VirtualNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
