...
func NewPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220501:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20220701:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:PrivateLinkServicePrivateEndpointConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network:PrivateLinkServicePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:network:PrivateLinkServicePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o PrivateLinkServicePrivateEndpointConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PrivateLinkServicePrivateEndpointConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
