...
// The Azure API version of the resource.
func (o ScopeConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ScopeConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
