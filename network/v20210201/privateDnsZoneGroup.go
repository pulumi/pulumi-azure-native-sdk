...
func NewPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:PrivateDnsZoneGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	var resource PrivateDnsZoneGroup
	err := ctx.ReadResource("azure-native:network/v20210201:PrivateDnsZoneGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Type of resource. Will be specified as private dns zone groups.
func (o PrivateDnsZoneGroupOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrivateDnsZoneGroup) pulumi.StringPtrOutput { return v.Type }).(pulumi.StringPtrOutput)
}
