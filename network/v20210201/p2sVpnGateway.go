...
//
// Deprecated: azure-native:network/v20210201:P2sVpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:P2sVpnGateway to guarantee forwards compatibility.
...
func NewP2sVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:P2sVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetP2sVpnGateway(ctx *pulumi.Context,
	...
	var resource P2sVpnGateway
	err := ctx.ReadResource("azure-native:network/v20210201:P2sVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
