...
//
// Deprecated: azure-native:network/v20210201:VirtualNetworkTap is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkTap to guarantee forwards compatibility.
...
func NewVirtualNetworkTap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:VirtualNetworkTap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkTap(ctx *pulumi.Context,
	...
	var resource VirtualNetworkTap
	err := ctx.ReadResource("azure-native:network/v20210201:VirtualNetworkTap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
