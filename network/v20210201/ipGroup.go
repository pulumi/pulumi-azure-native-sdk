...
//
// Deprecated: azure-native:network/v20210201:IpGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpGroup to guarantee forwards compatibility.
type IpGroup struct {
...
func NewIpGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:IpGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpGroup(ctx *pulumi.Context,
	...
	var resource IpGroup
	err := ctx.ReadResource("azure-native:network/v20210201:IpGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
