...
//
// Deprecated: azure-native:network/v20210201:BastionHost is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:BastionHost to guarantee forwards compatibility.
...
func NewBastionHost(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:BastionHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBastionHost(ctx *pulumi.Context,
	...
	var resource BastionHost
	err := ctx.ReadResource("azure-native:network/v20210201:BastionHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
