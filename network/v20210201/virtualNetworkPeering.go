...
//
// Deprecated: azure-native:network/v20210201:VirtualNetworkPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkPeering to guarantee forwards compatibility.
...
func NewVirtualNetworkPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:VirtualNetworkPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkPeering(ctx *pulumi.Context,
	...
	var resource VirtualNetworkPeering
	err := ctx.ReadResource("azure-native:network/v20210201:VirtualNetworkPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
