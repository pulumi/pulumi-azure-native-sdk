...
func NewVpnServerConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:VpnServerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnServerConfiguration(ctx *pulumi.Context,
	...
	var resource VpnServerConfiguration
	err := ctx.ReadResource("azure-native:network/v20210201:VpnServerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
