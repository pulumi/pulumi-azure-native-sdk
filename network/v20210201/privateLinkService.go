...
func NewPrivateLinkService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210201:PrivateLinkService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkService(ctx *pulumi.Context,
	...
	var resource PrivateLinkService
	err := ctx.ReadResource("azure-native:network/v20210201:PrivateLinkService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The resource id of private link service.
func (o PrivateLinkServiceOutput) ResourceGuid() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrivateLinkService) pulumi.StringPtrOutput { return v.ResourceGuid }).(pulumi.StringPtrOutput)
}
