...
//
// Deprecated: azure-native:network/v20190901:ExpressRoutePort is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRoutePort to guarantee forwards compatibility.
func LookupExpressRoutePort(ctx *pulumi.Context, args *LookupExpressRoutePortArgs, opts ...pulumi.InvokeOption) (*LookupExpressRoutePortResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20190901:getExpressRoutePort", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
