...
// Route resource.
//
// Deprecated: azure-native:network/v20190901:Route is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:Route to guarantee forwards compatibility.
type Route struct {
...
func NewRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.RegisterResource("azure-native:network/v20190901:Route", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.ReadResource("azure-native:network/v20190901:Route", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
