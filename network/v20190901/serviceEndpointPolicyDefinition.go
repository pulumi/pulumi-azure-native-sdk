...
//
// Deprecated: azure-native:network/v20190901:ServiceEndpointPolicyDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ServiceEndpointPolicyDefinition to guarantee forwards compatibility.
...
func NewServiceEndpointPolicyDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190901:ServiceEndpointPolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpointPolicyDefinition(ctx *pulumi.Context,
	...
	var resource ServiceEndpointPolicyDefinition
	err := ctx.ReadResource("azure-native:network/v20190901:ServiceEndpointPolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
