...
//
// Deprecated: azure-native:network/v20190901:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteConnection to guarantee forwards compatibility.
