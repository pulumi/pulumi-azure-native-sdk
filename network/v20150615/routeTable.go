...
func NewRouteTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20150615:RouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteTable(ctx *pulumi.Context,
	...
	var resource RouteTable
	err := ctx.ReadResource("azure-native:network/v20150615:RouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
