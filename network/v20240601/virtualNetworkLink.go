...
func NewVirtualNetworkLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240601:VirtualNetworkLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkLink(ctx *pulumi.Context,
	...
	var resource VirtualNetworkLink
	err := ctx.ReadResource("azure-native:network/v20240601:VirtualNetworkLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The resolution policy on the virtual network link. Only applicable for virtual network links to privatelink zones, and for A,AAAA,CNAME queries. When set to 'NxDomainRedirect', Azure DNS resolver falls back to public resolution if private dns query resolution results in non-existent domain response.
func (o VirtualNetworkLinkOutput) ResolutionPolicy() pulumi.StringPtrOutput {
