...
func NewPrivateZone(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240601:PrivateZone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateZone(ctx *pulumi.Context,
	...
	var resource PrivateZone
	err := ctx.ReadResource("azure-native:network/v20240601:PrivateZone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
