...
func NewPrivateRecordSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240601:PrivateRecordSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateRecordSet(ctx *pulumi.Context,
	...
	var resource PrivateRecordSet
	err := ctx.ReadResource("azure-native:network/v20240601:PrivateRecordSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
