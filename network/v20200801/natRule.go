...
//
// Deprecated: azure-native:network/v20200801:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatRule to guarantee forwards compatibility.
type NatRule struct {
