...
//
// Deprecated: azure-native:network/v20200801:IpAllocation is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:IpAllocation to guarantee forwards compatibility.
