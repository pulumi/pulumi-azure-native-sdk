...
//
// Deprecated: azure-native:network/v20200701:ApplicationGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ApplicationGateway to guarantee forwards compatibility.
...
func NewApplicationGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200701:ApplicationGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGateway(ctx *pulumi.Context,
	...
	var resource ApplicationGateway
	err := ctx.ReadResource("azure-native:network/v20200701:ApplicationGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
