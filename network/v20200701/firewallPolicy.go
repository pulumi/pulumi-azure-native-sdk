...
//
// Deprecated: azure-native:network/v20200701:FirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210801:FirewallPolicy to guarantee forwards compatibility.
...
func NewFirewallPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200701:FirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicy(ctx *pulumi.Context,
	...
	var resource FirewallPolicy
	err := ctx.ReadResource("azure-native:network/v20200701:FirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
