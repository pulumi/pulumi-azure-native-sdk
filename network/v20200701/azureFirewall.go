...
//
// Deprecated: azure-native:network/v20200701:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AzureFirewall to guarantee forwards compatibility.
...
func NewAzureFirewall(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200701:AzureFirewall", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureFirewall(ctx *pulumi.Context,
	...
	var resource AzureFirewall
	err := ctx.ReadResource("azure-native:network/v20200701:AzureFirewall", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
