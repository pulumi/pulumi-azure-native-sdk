...
//
// Deprecated: azure-native:network/v20200701:NetworkSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.
...
func NewNetworkSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200701:NetworkSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityGroup(ctx *pulumi.Context,
	...
	var resource NetworkSecurityGroup
	err := ctx.ReadResource("azure-native:network/v20200701:NetworkSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
