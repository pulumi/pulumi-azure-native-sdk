...
func NewExpressRouteCircuitConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230501:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ExpressRouteCircuitConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:ExpressRouteCircuitConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230401:ExpressRouteCircuitConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitConnection(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitConnection
	err := ctx.ReadResource("azure-native:network/v20230401:ExpressRouteCircuitConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
