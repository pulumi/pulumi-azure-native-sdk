...
func LookupExpressRouteCrossConnectionPeering(ctx *pulumi.Context, args *LookupExpressRouteCrossConnectionPeeringArgs, opts ...pulumi.InvokeOption) (*LookupExpressRouteCrossConnectionPeeringResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230401:getExpressRouteCrossConnectionPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupExpressRouteCrossConnectionPeeringOutput(ctx *pulumi.Context, args LookupExpressRouteCrossConnectionPeeringOutputArgs, opts ...pulumi.InvokeOption) LookupExpressRouteCrossConnectionPeeringResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupExpressRouteCrossConnectionPeeringResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20230401:getExpressRouteCrossConnectionPeering", args, LookupExpressRouteCrossConnectionPeeringResultOutput{}, options).(LookupExpressRouteCrossConnectionPeeringResultOutput), nil
