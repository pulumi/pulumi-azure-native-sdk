...
func NewDdosCustomPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230401:DdosCustomPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosCustomPolicy(ctx *pulumi.Context,
	...
	var resource DdosCustomPolicy
	err := ctx.ReadResource("azure-native:network/v20230401:DdosCustomPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
