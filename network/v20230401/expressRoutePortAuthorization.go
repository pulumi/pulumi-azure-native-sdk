...
func NewExpressRoutePortAuthorization(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20231101:ExpressRoutePortAuthorization"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ExpressRoutePortAuthorization"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230401:ExpressRoutePortAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRoutePortAuthorization(ctx *pulumi.Context,
	...
	var resource ExpressRoutePortAuthorization
	err := ctx.ReadResource("azure-native:network/v20230401:ExpressRoutePortAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
