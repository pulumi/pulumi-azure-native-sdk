...
func NewVirtualNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:VirtualNetwork"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:VirtualNetwork"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:VirtualNetwork"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230401:VirtualNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetwork(ctx *pulumi.Context,
	...
	var resource VirtualNetwork
	err := ctx.ReadResource("azure-native:network/v20230401:VirtualNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// A collection of references to flow log resources.
func (o VirtualNetworkOutput) FlowLogs() FlowLogResponseArrayOutput {
	return o.ApplyT(func(v *VirtualNetwork) FlowLogResponseArrayOutput { return v.FlowLogs }).(FlowLogResponseArrayOutput)
}
