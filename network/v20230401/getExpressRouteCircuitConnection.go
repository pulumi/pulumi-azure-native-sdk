...
func LookupExpressRouteCircuitConnection(ctx *pulumi.Context, args *LookupExpressRouteCircuitConnectionArgs, opts ...pulumi.InvokeOption) (*LookupExpressRouteCircuitConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230401:getExpressRouteCircuitConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupExpressRouteCircuitConnectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupExpressRouteCircuitConnectionResult] {
	return pulumix.Output[LookupExpressRouteCircuitConnectionResult]{
