...
func LookupExpressRoutePort(ctx *pulumi.Context, args *LookupExpressRoutePortArgs, opts ...pulumi.InvokeOption) (*LookupExpressRoutePortResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230401:getExpressRoutePort", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupExpressRoutePortResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupExpressRoutePortResult] {
	return pulumix.Output[LookupExpressRoutePortResult]{
