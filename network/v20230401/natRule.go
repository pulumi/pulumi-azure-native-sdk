...
func NewNatRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:NatRule"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:NatRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NatRule
	err := ctx.RegisterResource("azure-native:network/v20230401:NatRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNatRule(ctx *pulumi.Context,
	...
	var resource NatRule
	err := ctx.ReadResource("azure-native:network/v20230401:NatRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
