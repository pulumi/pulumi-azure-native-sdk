...
func NewIpAllocation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230401:IpAllocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpAllocation(ctx *pulumi.Context,
	...
	var resource IpAllocation
	err := ctx.ReadResource("azure-native:network/v20230401:IpAllocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
