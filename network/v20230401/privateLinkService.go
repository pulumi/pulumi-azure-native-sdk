...
func NewPrivateLinkService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:PrivateLinkService"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:PrivateLinkService"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateLinkService
	err := ctx.RegisterResource("azure-native:network/v20230401:PrivateLinkService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkService(ctx *pulumi.Context,
	...
	var resource PrivateLinkService
	err := ctx.ReadResource("azure-native:network/v20230401:PrivateLinkService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
