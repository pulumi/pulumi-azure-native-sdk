...
func NewVirtualRouter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230401:VirtualRouter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouter(ctx *pulumi.Context,
	...
	var resource VirtualRouter
	err := ctx.ReadResource("azure-native:network/v20230401:VirtualRouter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
