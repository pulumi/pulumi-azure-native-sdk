...
func LookupPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context, args *LookupPrivateLinkServicePrivateEndpointConnectionArgs, opts ...pulumi.InvokeOption) (*LookupPrivateLinkServicePrivateEndpointConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230401:getPrivateLinkServicePrivateEndpointConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (o LookupPrivateLinkServicePrivateEndpointConnectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupPrivateLinkServicePrivateEndpointConnectionResult] {
	return pulumix.Output[LookupPrivateLinkServicePrivateEndpointConnectionResult]{
