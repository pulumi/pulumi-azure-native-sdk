...
// The Azure API version of the resource.
func (o NetworkWatcherOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *NetworkWatcher) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
