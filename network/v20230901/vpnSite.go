...
func NewVpnSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:VpnSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnSite(ctx *pulumi.Context,
	...
	var resource VpnSite
	err := ctx.ReadResource("azure-native:network/v20230901:VpnSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
