...
func NewNetworkVirtualApplianceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:NetworkVirtualApplianceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkVirtualApplianceConnection(ctx *pulumi.Context,
	...
	var resource NetworkVirtualApplianceConnection
	err := ctx.ReadResource("azure-native:network/v20230901:NetworkVirtualApplianceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
