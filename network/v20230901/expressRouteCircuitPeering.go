...
func NewExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:ExpressRouteCircuitPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitPeering
	err := ctx.ReadResource("azure-native:network/v20230901:ExpressRouteCircuitPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
