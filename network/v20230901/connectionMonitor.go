...
func NewConnectionMonitor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:ConnectionMonitor"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:ConnectionMonitor"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:ConnectionMonitor"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ConnectionMonitor"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ConnectionMonitor"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:ConnectionMonitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionMonitor(ctx *pulumi.Context,
	...
	var resource ConnectionMonitor
	err := ctx.ReadResource("azure-native:network/v20230901:ConnectionMonitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
