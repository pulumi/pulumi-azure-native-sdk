...
func NewSubnet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:Subnet"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:Subnet"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:Subnet"),
		},
		{
	...
	var resource Subnet
	err := ctx.RegisterResource("azure-native:network/v20230901:Subnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnet(ctx *pulumi.Context,
	...
	var resource Subnet
	err := ctx.ReadResource("azure-native:network/v20230901:Subnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
