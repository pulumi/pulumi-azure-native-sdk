...
func NewExpressRouteConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220701:ExpressRouteConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:ExpressRouteConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20240101:ExpressRouteConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ExpressRouteConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ExpressRouteConnection
	err := ctx.RegisterResource("azure-native:network/v20230901:ExpressRouteConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteConnection(ctx *pulumi.Context,
	...
	var resource ExpressRouteConnection
	err := ctx.ReadResource("azure-native:network/v20230901:ExpressRouteConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
