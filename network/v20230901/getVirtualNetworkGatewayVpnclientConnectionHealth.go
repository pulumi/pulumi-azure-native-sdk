...
func GetVirtualNetworkGatewayVpnclientConnectionHealth(ctx *pulumi.Context, args *GetVirtualNetworkGatewayVpnclientConnectionHealthArgs, opts ...pulumi.InvokeOption) (*GetVirtualNetworkGatewayVpnclientConnectionHealthResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230901:getVirtualNetworkGatewayVpnclientConnectionHealth", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVirtualNetworkGatewayVpnclientConnectionHealthOutput(ctx *pulumi.Context, args GetVirtualNetworkGatewayVpnclientConnectionHealthOutputArgs, opts ...pulumi.InvokeOption) GetVirtualNetworkGatewayVpnclientConnectionHealthResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetVirtualNetworkGatewayVpnclientConnectionHealthResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20230901:getVirtualNetworkGatewayVpnclientConnectionHealth", args, GetVirtualNetworkGatewayVpnclientConnectionHealthResultOutput{}, options).(GetVirtualNetworkGatewayVpnclientConnectionHealthResultOutput), nil
