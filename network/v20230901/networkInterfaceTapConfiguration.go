...
func NewNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20200401:NetworkInterfaceTapConfiguration"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20220501:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20220701:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20220901:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20221101:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230201:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230401:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:NetworkInterfaceTapConfiguration"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20240101:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:NetworkInterfaceTapConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:NetworkInterfaceTapConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:NetworkInterfaceTapConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterfaceTapConfiguration(ctx *pulumi.Context,
	...
	var resource NetworkInterfaceTapConfiguration
	err := ctx.ReadResource("azure-native:network/v20230901:NetworkInterfaceTapConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
