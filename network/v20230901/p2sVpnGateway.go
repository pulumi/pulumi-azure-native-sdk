...
func NewP2sVpnGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220701:P2sVpnGateway"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230401:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:P2sVpnGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:P2sVpnGateway"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:P2sVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetP2sVpnGateway(ctx *pulumi.Context,
	...
	var resource P2sVpnGateway
	err := ctx.ReadResource("azure-native:network/v20230901:P2sVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
