...
func NewVpnConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220501:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20220701:VpnConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230401:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:VpnConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:VpnConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:VpnConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnConnection(ctx *pulumi.Context,
	...
	var resource VpnConnection
	err := ctx.ReadResource("azure-native:network/v20230901:VpnConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// DPD timeout in seconds for vpn connection.
func (o VpnConnectionOutput) DpdTimeoutSeconds() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *VpnConnection) pulumi.IntPtrOutput { return v.DpdTimeoutSeconds }).(pulumi.IntPtrOutput)
}
...
// The Routing Configuration indicating the associated and propagated route tables on this connection.
func (o VpnConnectionOutput) RoutingConfiguration() RoutingConfigurationResponsePtrOutput {
	return o.ApplyT(func(v *VpnConnection) RoutingConfigurationResponsePtrOutput { return v.RoutingConfiguration }).(RoutingConfigurationResponsePtrOutput)
}
...
// The Traffic Selector Policies to be considered by this connection.
func (o VpnConnectionOutput) TrafficSelectorPolicies() TrafficSelectorPolicyResponseArrayOutput {
	return o.ApplyT(func(v *VpnConnection) TrafficSelectorPolicyResponseArrayOutput { return v.TrafficSelectorPolicies }).(TrafficSelectorPolicyResponseArrayOutput)
}
