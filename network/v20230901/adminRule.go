...
func NewAdminRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:AdminRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdminRule(ctx *pulumi.Context,
	...
	var resource AdminRule
	err := ctx.ReadResource("azure-native:network/v20230901:AdminRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
