...
func NewNetworkWatcher(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230901:NetworkWatcher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkWatcher(ctx *pulumi.Context,
	...
	var resource NetworkWatcher
	err := ctx.ReadResource("azure-native:network/v20230901:NetworkWatcher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
