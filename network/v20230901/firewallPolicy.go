...
func NewFirewallPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:FirewallPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:FirewallPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource FirewallPolicy
	err := ctx.RegisterResource("azure-native:network/v20230901:FirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicy(ctx *pulumi.Context,
	...
	var resource FirewallPolicy
	err := ctx.ReadResource("azure-native:network/v20230901:FirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
