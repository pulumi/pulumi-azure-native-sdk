...
func NewConnectivityConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230501:ConnectivityConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectivityConfiguration(ctx *pulumi.Context,
	...
	var resource ConnectivityConfiguration
	err := ctx.ReadResource("azure-native:network/v20230501:ConnectivityConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
