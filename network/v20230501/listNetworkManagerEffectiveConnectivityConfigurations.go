...
func ListNetworkManagerEffectiveConnectivityConfigurations(ctx *pulumi.Context, args *ListNetworkManagerEffectiveConnectivityConfigurationsArgs, opts ...pulumi.InvokeOption) (*ListNetworkManagerEffectiveConnectivityConfigurationsResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230501:listNetworkManagerEffectiveConnectivityConfigurations", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ListNetworkManagerEffectiveConnectivityConfigurationsResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListNetworkManagerEffectiveConnectivityConfigurationsResult] {
	return pulumix.Output[ListNetworkManagerEffectiveConnectivityConfigurationsResult]{
