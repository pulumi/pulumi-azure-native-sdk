...
func NewScopeConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220701:ScopeConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230401:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:ScopeConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:ScopeConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230501:ScopeConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeConnection(ctx *pulumi.Context,
	...
	var resource ScopeConnection
	err := ctx.ReadResource("azure-native:network/v20230501:ScopeConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
