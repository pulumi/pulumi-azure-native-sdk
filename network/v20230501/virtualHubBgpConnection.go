...
func NewVirtualHubBgpConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230501:VirtualHubBgpConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubBgpConnection(ctx *pulumi.Context,
	...
	var resource VirtualHubBgpConnection
	err := ctx.ReadResource("azure-native:network/v20230501:VirtualHubBgpConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
