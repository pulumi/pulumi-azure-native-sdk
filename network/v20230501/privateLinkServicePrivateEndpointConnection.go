...
func NewPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230501:PrivateLinkServicePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:network/v20230501:PrivateLinkServicePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
