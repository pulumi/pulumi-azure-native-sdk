...
func NewSubscriptionNetworkManagerConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:SubscriptionNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:SubscriptionNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:SubscriptionNetworkManagerConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20240301:SubscriptionNetworkManagerConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230501:SubscriptionNetworkManagerConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionNetworkManagerConnection(ctx *pulumi.Context,
	...
	var resource SubscriptionNetworkManagerConnection
	err := ctx.ReadResource("azure-native:network/v20230501:SubscriptionNetworkManagerConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
