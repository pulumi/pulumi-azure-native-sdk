...
func NewStaticMember(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20240301:StaticMember"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230501:StaticMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticMember(ctx *pulumi.Context,
	...
	var resource StaticMember
	err := ctx.ReadResource("azure-native:network/v20230501:StaticMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
