...
func (o LookupDefaultAdminRuleResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDefaultAdminRuleResult] {
	return pulumix.Output[LookupDefaultAdminRuleResult]{
