...
func NewPrivateLinkService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230501:PrivateLinkService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkService(ctx *pulumi.Context,
	...
	var resource PrivateLinkService
	err := ctx.ReadResource("azure-native:network/v20230501:PrivateLinkService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
