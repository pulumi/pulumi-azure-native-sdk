...
func NewExpressRoutePort(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:ExpressRoutePort"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:ExpressRoutePort"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:ExpressRoutePort"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ExpressRoutePort"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ExpressRoutePort"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230501:ExpressRoutePort", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRoutePort(ctx *pulumi.Context,
	...
	var resource ExpressRoutePort
	err := ctx.ReadResource("azure-native:network/v20230501:ExpressRoutePort", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
