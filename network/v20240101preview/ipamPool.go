...
func NewIpamPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240101preview:IpamPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpamPool(ctx *pulumi.Context,
	...
	var resource IpamPool
	err := ctx.ReadResource("azure-native:network/v20240101preview:IpamPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
