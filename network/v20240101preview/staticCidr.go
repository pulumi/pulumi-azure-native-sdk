...
func NewStaticCidr(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20240101preview:StaticCidr", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticCidr(ctx *pulumi.Context,
	...
	var resource StaticCidr
	err := ctx.ReadResource("azure-native:network/v20240101preview:StaticCidr", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
