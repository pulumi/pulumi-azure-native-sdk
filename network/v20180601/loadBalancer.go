...
func NewLoadBalancer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20231101:LoadBalancer"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:LoadBalancer"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:LoadBalancer"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20180601:LoadBalancer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancer(ctx *pulumi.Context,
	...
	var resource LoadBalancer
	err := ctx.ReadResource("azure-native:network/v20180601:LoadBalancer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
