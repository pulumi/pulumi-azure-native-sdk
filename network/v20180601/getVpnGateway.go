...
//
// Deprecated: azure-native:network/v20180601:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180701:VpnGateway to guarantee forwards compatibility.
func LookupVpnGateway(ctx *pulumi.Context, args *LookupVpnGatewayArgs, opts ...pulumi.InvokeOption) (*LookupVpnGatewayResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20180601:getVpnGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The policies applied to this vpn gateway.
func (o LookupVpnGatewayResultOutput) Policies() PoliciesResponsePtrOutput {
	return o.ApplyT(func(v LookupVpnGatewayResult) *PoliciesResponse { return v.Policies }).(PoliciesResponsePtrOutput)
}
