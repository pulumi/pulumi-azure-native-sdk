...
func NewApplicationGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230601:ApplicationGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGateway(ctx *pulumi.Context,
	...
	var resource ApplicationGateway
	err := ctx.ReadResource("azure-native:network/v20230601:ApplicationGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
