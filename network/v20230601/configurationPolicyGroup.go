...
func NewConfigurationPolicyGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:ConfigurationPolicyGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:ConfigurationPolicyGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:ConfigurationPolicyGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:ConfigurationPolicyGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ConfigurationPolicyGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ConfigurationPolicyGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230601:ConfigurationPolicyGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationPolicyGroup(ctx *pulumi.Context,
	...
	var resource ConfigurationPolicyGroup
	err := ctx.ReadResource("azure-native:network/v20230601:ConfigurationPolicyGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
