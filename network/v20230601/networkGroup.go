...
func NewNetworkGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230601:NetworkGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkGroup(ctx *pulumi.Context,
	...
	var resource NetworkGroup
	err := ctx.ReadResource("azure-native:network/v20230601:NetworkGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
