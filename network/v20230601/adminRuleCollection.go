...
func NewAdminRuleCollection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:AdminRuleCollection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:AdminRuleCollection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101preview:AdminRuleCollection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230601:AdminRuleCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdminRuleCollection(ctx *pulumi.Context,
	...
	var resource AdminRuleCollection
	err := ctx.ReadResource("azure-native:network/v20230601:AdminRuleCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
