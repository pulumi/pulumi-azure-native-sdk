...
func NewExpressRouteCircuit(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ExpressRouteCircuit"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:ExpressRouteCircuit"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ExpressRouteCircuit
	err := ctx.RegisterResource("azure-native:network/v20230601:ExpressRouteCircuit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuit(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuit
	err := ctx.ReadResource("azure-native:network/v20230601:ExpressRouteCircuit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
