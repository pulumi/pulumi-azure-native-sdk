...
func NewNetworkSecurityGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:NetworkSecurityGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230601:NetworkSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityGroup(ctx *pulumi.Context,
	...
	var resource NetworkSecurityGroup
	err := ctx.ReadResource("azure-native:network/v20230601:NetworkSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
