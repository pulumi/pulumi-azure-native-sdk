...
func NewVpnSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:VpnSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:VpnSite"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230601:VpnSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnSite(ctx *pulumi.Context,
	...
	var resource VpnSite
	err := ctx.ReadResource("azure-native:network/v20230601:VpnSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
