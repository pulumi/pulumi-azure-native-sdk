...
func NewVirtualNetworkTap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:VirtualNetworkTap"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:VirtualNetworkTap"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualNetworkTap
	err := ctx.RegisterResource("azure-native:network/v20230601:VirtualNetworkTap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkTap(ctx *pulumi.Context,
	...
	var resource VirtualNetworkTap
	err := ctx.ReadResource("azure-native:network/v20230601:VirtualNetworkTap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
