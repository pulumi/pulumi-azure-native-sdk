...
func NewServiceEndpointPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20231101:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ServiceEndpointPolicy"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:ServiceEndpointPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230601:ServiceEndpointPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpointPolicy(ctx *pulumi.Context,
	...
	var resource ServiceEndpointPolicy
	err := ctx.ReadResource("azure-native:network/v20230601:ServiceEndpointPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
