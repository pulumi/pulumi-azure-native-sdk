...
func LookupPrivateDnsZoneGroup(ctx *pulumi.Context, args *LookupPrivateDnsZoneGroupArgs, opts ...pulumi.InvokeOption) (*LookupPrivateDnsZoneGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230601:getPrivateDnsZoneGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateDnsZoneGroupOutput(ctx *pulumi.Context, args LookupPrivateDnsZoneGroupOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateDnsZoneGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateDnsZoneGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20230601:getPrivateDnsZoneGroup", args, LookupPrivateDnsZoneGroupResultOutput{}, options).(LookupPrivateDnsZoneGroupResultOutput), nil
