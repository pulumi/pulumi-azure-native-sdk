...
func LookupWebApplicationFirewallPolicy(ctx *pulumi.Context, args *LookupWebApplicationFirewallPolicyArgs, opts ...pulumi.InvokeOption) (*LookupWebApplicationFirewallPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230601:getWebApplicationFirewallPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupWebApplicationFirewallPolicyOutput(ctx *pulumi.Context, args LookupWebApplicationFirewallPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupWebApplicationFirewallPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebApplicationFirewallPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20230601:getWebApplicationFirewallPolicy", args, LookupWebApplicationFirewallPolicyResultOutput{}, options).(LookupWebApplicationFirewallPolicyResultOutput), nil
