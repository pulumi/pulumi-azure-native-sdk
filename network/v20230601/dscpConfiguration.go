...
func NewDscpConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:DscpConfiguration"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:DscpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:DscpConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DscpConfiguration
	err := ctx.RegisterResource("azure-native:network/v20230601:DscpConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscpConfiguration(ctx *pulumi.Context,
	...
	var resource DscpConfiguration
	err := ctx.ReadResource("azure-native:network/v20230601:DscpConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
