...
func NewNetworkSecurityPerimeter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230801preview:NetworkSecurityPerimeter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityPerimeter(ctx *pulumi.Context,
	...
	var resource NetworkSecurityPerimeter
	err := ctx.ReadResource("azure-native:network/v20230801preview:NetworkSecurityPerimeter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
