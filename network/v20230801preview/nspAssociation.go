...
func NewNspAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230801preview:NspAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNspAssociation(ctx *pulumi.Context,
	...
	var resource NspAssociation
	err := ctx.ReadResource("azure-native:network/v20230801preview:NspAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
