...
func LookupNspAssociation(ctx *pulumi.Context, args *LookupNspAssociationArgs, opts ...pulumi.InvokeOption) (*LookupNspAssociationResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230801preview:getNspAssociation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupNspAssociationOutput(ctx *pulumi.Context, args LookupNspAssociationOutputArgs, opts ...pulumi.InvokeOption) LookupNspAssociationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNspAssociationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20230801preview:getNspAssociation", args, LookupNspAssociationResultOutput{}, options).(LookupNspAssociationResultOutput), nil
