...
func NewNspProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230801preview:NspProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNspProfile(ctx *pulumi.Context,
	...
	var resource NspProfile
	err := ctx.ReadResource("azure-native:network/v20230801preview:NspProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
