...
func NewNspLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230801preview:NspLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNspLink(ctx *pulumi.Context,
	...
	var resource NspLink
	err := ctx.ReadResource("azure-native:network/v20230801preview:NspLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
