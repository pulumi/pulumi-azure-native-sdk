...
func NewVirtualNetworkPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20180101:VirtualNetworkPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkPeering(ctx *pulumi.Context,
	...
	var resource VirtualNetworkPeering
	err := ctx.ReadResource("azure-native:network/v20180101:VirtualNetworkPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
