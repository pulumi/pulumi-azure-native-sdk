...
func NewVirtualNetworkGatewayConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190601:VirtualNetworkGatewayConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGatewayConnection(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGatewayConnection
	err := ctx.ReadResource("azure-native:network/v20190601:VirtualNetworkGatewayConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
