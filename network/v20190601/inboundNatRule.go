...
func NewInboundNatRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190601:InboundNatRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInboundNatRule(ctx *pulumi.Context,
	...
	var resource InboundNatRule
	err := ctx.ReadResource("azure-native:network/v20190601:InboundNatRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
