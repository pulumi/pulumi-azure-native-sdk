...
func NewRoute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:Route"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:Route"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:Route"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20240501:Route"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Route
	err := ctx.RegisterResource("azure-native:network/v20190601:Route", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.ReadResource("azure-native:network/v20190601:Route", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RouteOutput) Etag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Route) pulumi.StringPtrOutput { return v.Etag }).(pulumi.StringPtrOutput)
}
...
func (o RouteOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Route) pulumi.StringPtrOutput { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
