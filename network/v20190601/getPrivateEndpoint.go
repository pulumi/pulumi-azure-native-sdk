...
//
// Deprecated: azure-native:network/v20190601:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210201:PrivateEndpoint to guarantee forwards compatibility.
