...
// VirtualWAN Resource.
//
// Deprecated: azure-native:network/v20190601:VirtualWan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190701:VirtualWan to guarantee forwards compatibility.
...
func NewVirtualWan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20190601:VirtualWan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualWan(ctx *pulumi.Context,
	...
	var resource VirtualWan
	err := ctx.ReadResource("azure-native:network/v20190601:VirtualWan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
