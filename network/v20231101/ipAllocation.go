...
func NewIpAllocation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:IpAllocation"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:IpAllocation"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:IpAllocation"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:IpAllocation"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20231101:IpAllocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpAllocation(ctx *pulumi.Context,
	...
	var resource IpAllocation
	err := ctx.ReadResource("azure-native:network/v20231101:IpAllocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
