...
func NewDefaultAdminRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20231101:DefaultAdminRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultAdminRule(ctx *pulumi.Context,
	...
	var resource DefaultAdminRule
	err := ctx.ReadResource("azure-native:network/v20231101:DefaultAdminRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
