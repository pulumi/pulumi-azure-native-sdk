...
func NewRoutingIntent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20231101:RoutingIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoutingIntent(ctx *pulumi.Context,
	...
	var resource RoutingIntent
	err := ctx.ReadResource("azure-native:network/v20231101:RoutingIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
