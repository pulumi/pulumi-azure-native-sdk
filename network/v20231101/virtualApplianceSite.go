...
func NewVirtualApplianceSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:VirtualApplianceSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:VirtualApplianceSite"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:VirtualApplianceSite"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualApplianceSite
	err := ctx.RegisterResource("azure-native:network/v20231101:VirtualApplianceSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualApplianceSite(ctx *pulumi.Context,
	...
	var resource VirtualApplianceSite
	err := ctx.ReadResource("azure-native:network/v20231101:VirtualApplianceSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
