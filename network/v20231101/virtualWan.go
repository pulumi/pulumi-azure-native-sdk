...
func NewVirtualWan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20231101:VirtualWan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualWan(ctx *pulumi.Context,
	...
	var resource VirtualWan
	err := ctx.ReadResource("azure-native:network/v20231101:VirtualWan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
