...
func NewDdosProtectionPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20231101:DdosProtectionPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosProtectionPlan(ctx *pulumi.Context,
	...
	var resource DdosProtectionPlan
	err := ctx.ReadResource("azure-native:network/v20231101:DdosProtectionPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
