...
func NewScopeConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20231101:ScopeConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeConnection(ctx *pulumi.Context,
	...
	var resource ScopeConnection
	err := ctx.ReadResource("azure-native:network/v20231101:ScopeConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
