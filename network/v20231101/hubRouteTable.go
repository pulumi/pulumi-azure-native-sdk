...
func NewHubRouteTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20231101:HubRouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHubRouteTable(ctx *pulumi.Context,
	...
	var resource HubRouteTable
	err := ctx.ReadResource("azure-native:network/v20231101:HubRouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
