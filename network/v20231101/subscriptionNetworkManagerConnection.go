...
func NewSubscriptionNetworkManagerConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20231101:SubscriptionNetworkManagerConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionNetworkManagerConnection(ctx *pulumi.Context,
	...
	var resource SubscriptionNetworkManagerConnection
	err := ctx.ReadResource("azure-native:network/v20231101:SubscriptionNetworkManagerConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
