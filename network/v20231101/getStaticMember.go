...
func LookupStaticMember(ctx *pulumi.Context, args *LookupStaticMemberArgs, opts ...pulumi.InvokeOption) (*LookupStaticMemberResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20231101:getStaticMember", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStaticMemberOutput(ctx *pulumi.Context, args LookupStaticMemberOutputArgs, opts ...pulumi.InvokeOption) LookupStaticMemberResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStaticMemberResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20231101:getStaticMember", args, LookupStaticMemberResultOutput{}, options).(LookupStaticMemberResultOutput), nil
