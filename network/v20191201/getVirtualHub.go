...
//
// Deprecated: azure-native:network/v20191201:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:VirtualHub to guarantee forwards compatibility.
func LookupVirtualHub(ctx *pulumi.Context, args *LookupVirtualHubArgs, opts ...pulumi.InvokeOption) (*LookupVirtualHubResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20191201:getVirtualHub", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
