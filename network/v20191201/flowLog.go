...
func NewFlowLog(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20191201:FlowLog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlowLog(ctx *pulumi.Context,
	...
	var resource FlowLog
	err := ctx.ReadResource("azure-native:network/v20191201:FlowLog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
