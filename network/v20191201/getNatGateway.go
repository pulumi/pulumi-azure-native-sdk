...
//
// Deprecated: azure-native:network/v20191201:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatGateway to guarantee forwards compatibility.
