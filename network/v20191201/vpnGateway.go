...
// VpnGateway Resource.
//
// Deprecated: azure-native:network/v20191201:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnGateway to guarantee forwards compatibility.
...
func GetVpnGateway(ctx *pulumi.Context,
	...
	var resource VpnGateway
	err := ctx.ReadResource("azure-native:network/v20191201:VpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
