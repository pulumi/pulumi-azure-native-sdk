...
//
// Deprecated: azure-native:network/v20191201:InboundNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:InboundNatRule to guarantee forwards compatibility.
