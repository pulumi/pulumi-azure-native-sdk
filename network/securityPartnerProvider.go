...
// The Azure API version of the resource.
func (o SecurityPartnerProviderOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SecurityPartnerProvider) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
