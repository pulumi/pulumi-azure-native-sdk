...
//
// Deprecated: azure-native:network/v20180701:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:PublicIPPrefix to guarantee forwards compatibility.
func LookupPublicIPPrefix(ctx *pulumi.Context, args *LookupPublicIPPrefixArgs, opts ...pulumi.InvokeOption) (*LookupPublicIPPrefixResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20180701:getPublicIPPrefix", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The provisioning state of the Public IP prefix resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
func (o LookupPublicIPPrefixResultOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupPublicIPPrefixResult) *string { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
