...
//
// Deprecated: azure-native:network/v20180701:PacketCapture is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:PacketCapture to guarantee forwards compatibility.
...
func NewPacketCapture(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20180701:PacketCapture", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPacketCapture(ctx *pulumi.Context,
	...
	var resource PacketCapture
	err := ctx.ReadResource("azure-native:network/v20180701:PacketCapture", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
