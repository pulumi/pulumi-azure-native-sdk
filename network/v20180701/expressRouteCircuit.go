...
//
// Deprecated: azure-native:network/v20180701:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20181201:ExpressRouteCircuit to guarantee forwards compatibility.
...
func NewExpressRouteCircuit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20180701:ExpressRouteCircuit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuit(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuit
	err := ctx.ReadResource("azure-native:network/v20180701:ExpressRouteCircuit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Flag to enable Global Reach on the circuit.
func (o ExpressRouteCircuitOutput) AllowGlobalReach() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *ExpressRouteCircuit) pulumi.BoolPtrOutput { return v.AllowGlobalReach }).(pulumi.BoolPtrOutput)
}
