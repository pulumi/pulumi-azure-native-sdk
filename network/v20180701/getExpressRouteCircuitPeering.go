...
//
// Deprecated: azure-native:network/v20180701:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190201:ExpressRouteCircuitPeering to guarantee forwards compatibility.
func LookupExpressRouteCircuitPeering(ctx *pulumi.Context, args *LookupExpressRouteCircuitPeeringArgs, opts ...pulumi.InvokeOption) (*LookupExpressRouteCircuitPeeringResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20180701:getExpressRouteCircuitPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The reference of the RouteFilter resource.
func (o LookupExpressRouteCircuitPeeringResultOutput) RouteFilter() RouteFilterResponsePtrOutput {
	return o.ApplyT(func(v LookupExpressRouteCircuitPeeringResult) *RouteFilterResponse { return v.RouteFilter }).(RouteFilterResponsePtrOutput)
}
