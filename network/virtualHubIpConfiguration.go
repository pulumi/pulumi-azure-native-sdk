...
func NewVirtualHubIpConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20220501:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20220701:VirtualHubIpConfiguration"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20230201:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230401:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:VirtualHubIpConfiguration"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20231101:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:VirtualHubIpConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:VirtualHubIpConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualHubIpConfiguration
	err := ctx.RegisterResource("azure-native:network:VirtualHubIpConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubIpConfiguration(ctx *pulumi.Context,
	...
	var resource VirtualHubIpConfiguration
	err := ctx.ReadResource("azure-native:network:VirtualHubIpConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o VirtualHubIpConfigurationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualHubIpConfiguration) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
