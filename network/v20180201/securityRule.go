...
// azure-native:network/v20180201:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:SecurityRule to guarantee forwards compatibility.
...
func NewSecurityRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20180201:SecurityRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityRule(ctx *pulumi.Context,
	...
	var resource SecurityRule
	err := ctx.ReadResource("azure-native:network/v20180201:SecurityRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
