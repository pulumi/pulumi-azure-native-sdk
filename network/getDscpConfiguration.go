...
// The Azure API version of the resource.
func (o LookupDscpConfigurationResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDscpConfigurationResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
