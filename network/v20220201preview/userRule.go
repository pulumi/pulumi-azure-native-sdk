...
func NewUserRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220201preview:UserRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserRule(ctx *pulumi.Context,
	...
	var resource UserRule
	err := ctx.ReadResource("azure-native:network/v20220201preview:UserRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
