...
func NewUserRuleCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501preview:UserRuleCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserRuleCollection(ctx *pulumi.Context,
	...
	var resource UserRuleCollection
	err := ctx.ReadResource("azure-native:network/v20210501preview:UserRuleCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
