...
//
// Deprecated: azure-native:network/v20210501preview:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:StaticMember to guarantee forwards compatibility.
