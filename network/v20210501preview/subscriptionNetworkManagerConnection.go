...
func NewSubscriptionNetworkManagerConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501preview:SubscriptionNetworkManagerConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionNetworkManagerConnection(ctx *pulumi.Context,
	...
	var resource SubscriptionNetworkManagerConnection
	err := ctx.ReadResource("azure-native:network/v20210501preview:SubscriptionNetworkManagerConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
