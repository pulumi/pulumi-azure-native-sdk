...
func NewNetworkManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501preview:NetworkManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkManager(ctx *pulumi.Context,
	...
	var resource NetworkManager
	err := ctx.ReadResource("azure-native:network/v20210501preview:NetworkManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
