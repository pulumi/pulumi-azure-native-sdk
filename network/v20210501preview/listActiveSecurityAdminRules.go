...
func (o ListActiveSecurityAdminRulesResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListActiveSecurityAdminRulesResult] {
	return pulumix.Output[ListActiveSecurityAdminRulesResult]{
