...
// azure-native:network/v20161201:NetworkWatcher is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180101:NetworkWatcher to guarantee forwards compatibility.
...
func NewNetworkWatcher(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20161201:NetworkWatcher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkWatcher(ctx *pulumi.Context,
	...
	var resource NetworkWatcher
	err := ctx.ReadResource("azure-native:network/v20161201:NetworkWatcher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
