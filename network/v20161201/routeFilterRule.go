...
func NewRouteFilterRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20161201:RouteFilterRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilterRule(ctx *pulumi.Context,
	...
	var resource RouteFilterRule
	err := ctx.ReadResource("azure-native:network/v20161201:RouteFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
