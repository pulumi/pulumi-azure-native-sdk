...
func NewPacketCapture(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20161201:PacketCapture", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPacketCapture(ctx *pulumi.Context,
	...
	var resource PacketCapture
	err := ctx.ReadResource("azure-native:network/v20161201:PacketCapture", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
