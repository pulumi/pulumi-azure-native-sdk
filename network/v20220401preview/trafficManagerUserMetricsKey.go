...
func NewTrafficManagerUserMetricsKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220401preview:TrafficManagerUserMetricsKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrafficManagerUserMetricsKey(ctx *pulumi.Context,
	...
	var resource TrafficManagerUserMetricsKey
	err := ctx.ReadResource("azure-native:network/v20220401preview:TrafficManagerUserMetricsKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
