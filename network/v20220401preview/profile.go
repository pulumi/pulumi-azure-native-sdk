...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220401preview:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azure-native:network/v20220401preview:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
