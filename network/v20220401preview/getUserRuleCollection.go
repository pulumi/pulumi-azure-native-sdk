...
func LookupUserRuleCollection(ctx *pulumi.Context, args *LookupUserRuleCollectionArgs, opts ...pulumi.InvokeOption) (*LookupUserRuleCollectionResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220401preview:getUserRuleCollection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUserRuleCollectionOutput(ctx *pulumi.Context, args LookupUserRuleCollectionOutputArgs, opts ...pulumi.InvokeOption) LookupUserRuleCollectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUserRuleCollectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20220401preview:getUserRuleCollection", args, LookupUserRuleCollectionResultOutput{}, options).(LookupUserRuleCollectionResultOutput), nil
