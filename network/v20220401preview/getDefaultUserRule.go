...
func LookupDefaultUserRule(ctx *pulumi.Context, args *LookupDefaultUserRuleArgs, opts ...pulumi.InvokeOption) (*LookupDefaultUserRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220401preview:getDefaultUserRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDefaultUserRuleOutput(ctx *pulumi.Context, args LookupDefaultUserRuleOutputArgs, opts ...pulumi.InvokeOption) LookupDefaultUserRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDefaultUserRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20220401preview:getDefaultUserRule", args, LookupDefaultUserRuleResultOutput{}, options).(LookupDefaultUserRuleResultOutput), nil
