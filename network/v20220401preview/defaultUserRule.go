...
func NewDefaultUserRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220401preview:DefaultUserRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultUserRule(ctx *pulumi.Context,
	...
	var resource DefaultUserRule
	err := ctx.ReadResource("azure-native:network/v20220401preview:DefaultUserRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
