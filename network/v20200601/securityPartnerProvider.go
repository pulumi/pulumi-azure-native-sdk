...
//
// Deprecated: azure-native:network/v20200601:SecurityPartnerProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityPartnerProvider to guarantee forwards compatibility.
...
func NewSecurityPartnerProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200601:SecurityPartnerProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPartnerProvider(ctx *pulumi.Context,
	...
	var resource SecurityPartnerProvider
	err := ctx.ReadResource("azure-native:network/v20200601:SecurityPartnerProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
