...
//
// Deprecated: azure-native:network/v20200601:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubRouteTableV2 to guarantee forwards compatibility.
...
func NewVirtualHubRouteTableV2(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200601:VirtualHubRouteTableV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubRouteTableV2(ctx *pulumi.Context,
	...
	var resource VirtualHubRouteTableV2
	err := ctx.ReadResource("azure-native:network/v20200601:VirtualHubRouteTableV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
