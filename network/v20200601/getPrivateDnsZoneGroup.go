...
//
// Deprecated: azure-native:network/v20200601:PrivateDnsZoneGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210201:PrivateDnsZoneGroup to guarantee forwards compatibility.
