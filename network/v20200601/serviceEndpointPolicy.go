...
//
// Deprecated: azure-native:network/v20200601:ServiceEndpointPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ServiceEndpointPolicy to guarantee forwards compatibility.
