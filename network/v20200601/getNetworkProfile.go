...
//
// Deprecated: azure-native:network/v20200601:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkProfile to guarantee forwards compatibility.
func LookupNetworkProfile(ctx *pulumi.Context, args *LookupNetworkProfileArgs, opts ...pulumi.InvokeOption) (*LookupNetworkProfileResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20200601:getNetworkProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
