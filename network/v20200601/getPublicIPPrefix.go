...
//
// Deprecated: azure-native:network/v20200601:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPPrefix to guarantee forwards compatibility.
