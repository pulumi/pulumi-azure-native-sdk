...
//
// Deprecated: azure-native:network/v20210301:SecurityPartnerProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityPartnerProvider to guarantee forwards compatibility.
