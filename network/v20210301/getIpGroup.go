...
//
// Deprecated: azure-native:network/v20210301:IpGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:IpGroup to guarantee forwards compatibility.
func LookupIpGroup(ctx *pulumi.Context, args *LookupIpGroupArgs, opts ...pulumi.InvokeOption) (*LookupIpGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20210301:getIpGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
