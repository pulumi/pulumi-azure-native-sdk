...
//
// Deprecated: azure-native:network/v20210301:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220701:Subnet to guarantee forwards compatibility.
