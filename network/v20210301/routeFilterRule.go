...
//
// Deprecated: azure-native:network/v20210301:RouteFilterRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteFilterRule to guarantee forwards compatibility.
...
func NewRouteFilterRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210301:RouteFilterRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilterRule(ctx *pulumi.Context,
	...
	var resource RouteFilterRule
	err := ctx.ReadResource("azure-native:network/v20210301:RouteFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
