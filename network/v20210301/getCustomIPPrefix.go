...
func LookupCustomIPPrefixOutput(ctx *pulumi.Context, args LookupCustomIPPrefixOutputArgs, opts ...pulumi.InvokeOption) LookupCustomIPPrefixResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCustomIPPrefixResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:network/v20210301:getCustomIPPrefix", args, LookupCustomIPPrefixResultOutput{}, options).(LookupCustomIPPrefixResultOutput), nil
...
// The list of all Children for IPv6 /48 CustomIpPrefix.
func (o LookupCustomIPPrefixResultOutput) ChildCustomIpPrefixes() CustomIpPrefixResponseArrayOutput {
	return o.ApplyT(func(v LookupCustomIPPrefixResult) []CustomIpPrefixResponse { return v.ChildCustomIpPrefixes }).(CustomIpPrefixResponseArrayOutput)
}
...
// The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
func (o LookupCustomIPPrefixResultOutput) CustomIpPrefixParent() CustomIpPrefixResponsePtrOutput {
	return o.ApplyT(func(v LookupCustomIPPrefixResult) *CustomIpPrefixResponse { return v.CustomIpPrefixParent }).(CustomIpPrefixResponsePtrOutput)
}
