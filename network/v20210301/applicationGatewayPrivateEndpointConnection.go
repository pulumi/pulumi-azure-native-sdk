...
//
// Deprecated: azure-native:network/v20210301:ApplicationGatewayPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ApplicationGatewayPrivateEndpointConnection to guarantee forwards compatibility.
...
func NewApplicationGatewayPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210301:ApplicationGatewayPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGatewayPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource ApplicationGatewayPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:network/v20210301:ApplicationGatewayPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
