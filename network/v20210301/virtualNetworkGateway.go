...
//
// Deprecated: azure-native:network/v20210301:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkGateway to guarantee forwards compatibility.
