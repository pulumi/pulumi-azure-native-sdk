...
//
// Deprecated: azure-native:network/v20210301:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkVirtualAppliance to guarantee forwards compatibility.
func LookupNetworkVirtualAppliance(ctx *pulumi.Context, args *LookupNetworkVirtualApplianceArgs, opts ...pulumi.InvokeOption) (*LookupNetworkVirtualApplianceResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20210301:getNetworkVirtualAppliance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
