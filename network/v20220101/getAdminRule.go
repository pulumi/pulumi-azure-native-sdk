...
//
// Deprecated: azure-native:network/v20220101:AdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRule to guarantee forwards compatibility.
func LookupAdminRule(ctx *pulumi.Context, args *LookupAdminRuleArgs, opts ...pulumi.InvokeOption) (*LookupAdminRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220101:getAdminRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
