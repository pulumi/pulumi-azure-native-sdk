...
//
// Deprecated: azure-native:network/v20220101:ConnectivityConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ConnectivityConfiguration to guarantee forwards compatibility.
