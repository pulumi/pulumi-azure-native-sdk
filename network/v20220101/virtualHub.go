...
func NewVirtualHub(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220101:VirtualHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHub(ctx *pulumi.Context,
	...
	var resource VirtualHub
	err := ctx.ReadResource("azure-native:network/v20220101:VirtualHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
