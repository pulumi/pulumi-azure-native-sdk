...
//
// Deprecated: azure-native:network/v20220101:IpAllocation is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpAllocation to guarantee forwards compatibility.
func LookupIpAllocation(ctx *pulumi.Context, args *LookupIpAllocationArgs, opts ...pulumi.InvokeOption) (*LookupIpAllocationResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220101:getIpAllocation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
