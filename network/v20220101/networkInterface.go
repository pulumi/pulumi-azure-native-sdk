...
//
// Deprecated: azure-native:network/v20220101:NetworkInterface is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkInterface to guarantee forwards compatibility.
...
func NewNetworkInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220101:NetworkInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterface(ctx *pulumi.Context,
	...
	var resource NetworkInterface
	err := ctx.ReadResource("azure-native:network/v20220101:NetworkInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
