...
//
// Deprecated: azure-native:network/v20220101:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatRule to guarantee forwards compatibility.
func LookupNatRule(ctx *pulumi.Context, args *LookupNatRuleArgs, opts ...pulumi.InvokeOption) (*LookupNatRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220101:getNatRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
