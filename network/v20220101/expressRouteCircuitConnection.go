...
func NewExpressRouteCircuitConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220101:ExpressRouteCircuitConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitConnection(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitConnection
	err := ctx.ReadResource("azure-native:network/v20220101:ExpressRouteCircuitConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
