...
//
// Deprecated: azure-native:network/v20220101:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkProfile to guarantee forwards compatibility.
...
func NewNetworkProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220101:NetworkProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkProfile(ctx *pulumi.Context,
	...
	var resource NetworkProfile
	err := ctx.ReadResource("azure-native:network/v20220101:NetworkProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
