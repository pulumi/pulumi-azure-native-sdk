...
//
// Deprecated: azure-native:network/v20220101:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.
...
func NewManagementGroupNetworkManagerConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220101:ManagementGroupNetworkManagerConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroupNetworkManagerConnection(ctx *pulumi.Context,
	...
	var resource ManagementGroupNetworkManagerConnection
	err := ctx.ReadResource("azure-native:network/v20220101:ManagementGroupNetworkManagerConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
