...
func NewStaticMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220101:StaticMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticMember(ctx *pulumi.Context,
	...
	var resource StaticMember
	err := ctx.ReadResource("azure-native:network/v20220101:StaticMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
