...
//
// Deprecated: azure-native:network/v20220101:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.
func LookupVirtualNetworkGatewayNatRule(ctx *pulumi.Context, args *LookupVirtualNetworkGatewayNatRuleArgs, opts ...pulumi.InvokeOption) (*LookupVirtualNetworkGatewayNatRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220101:getVirtualNetworkGatewayNatRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
