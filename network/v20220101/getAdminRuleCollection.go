...
//
// Deprecated: azure-native:network/v20220101:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRuleCollection to guarantee forwards compatibility.
