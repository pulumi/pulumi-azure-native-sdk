...
func NewVirtualHubIpConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220101:VirtualHubIpConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubIpConfiguration(ctx *pulumi.Context,
	...
	var resource VirtualHubIpConfiguration
	err := ctx.ReadResource("azure-native:network/v20220101:VirtualHubIpConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
