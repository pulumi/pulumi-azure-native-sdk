...
//
// Deprecated: azure-native:network/v20220101:VirtualRouterPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualRouterPeering to guarantee forwards compatibility.
func LookupVirtualRouterPeering(ctx *pulumi.Context, args *LookupVirtualRouterPeeringArgs, opts ...pulumi.InvokeOption) (*LookupVirtualRouterPeeringResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220101:getVirtualRouterPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
