...
//
// Deprecated: azure-native:network/v20220101:NetworkSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkSecurityGroup to guarantee forwards compatibility.
