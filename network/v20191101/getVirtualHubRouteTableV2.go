...
//
// Deprecated: azure-native:network/v20191101:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubRouteTableV2 to guarantee forwards compatibility.
func LookupVirtualHubRouteTableV2(ctx *pulumi.Context, args *LookupVirtualHubRouteTableV2Args, opts ...pulumi.InvokeOption) (*LookupVirtualHubRouteTableV2Result, error) {
	...
	err := ctx.Invoke("azure-native:network/v20191101:getVirtualHubRouteTableV2", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
