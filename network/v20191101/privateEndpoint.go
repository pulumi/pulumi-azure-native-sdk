...
//
// Deprecated: azure-native:network/v20191101:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210201:PrivateEndpoint to guarantee forwards compatibility.
...
func NewPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20191101:PrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource PrivateEndpoint
	err := ctx.ReadResource("azure-native:network/v20191101:PrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
