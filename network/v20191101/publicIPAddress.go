...
//
// Deprecated: azure-native:network/v20191101:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.
...
func NewPublicIPAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20191101:PublicIPAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIPAddress(ctx *pulumi.Context,
	...
	var resource PublicIPAddress
	err := ctx.ReadResource("azure-native:network/v20191101:PublicIPAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
