...
//
// Deprecated: azure-native:network/v20191101:VpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnServerConfiguration to guarantee forwards compatibility.
...
func NewVpnServerConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20191101:VpnServerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnServerConfiguration(ctx *pulumi.Context,
	...
	var resource VpnServerConfiguration
	err := ctx.ReadResource("azure-native:network/v20191101:VpnServerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
