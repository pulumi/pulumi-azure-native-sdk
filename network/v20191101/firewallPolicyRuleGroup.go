...
// Rule Group resource.
//
// Deprecated: azure-native:network/v20191101:FirewallPolicyRuleGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:FirewallPolicyRuleGroup to guarantee forwards compatibility.
...
func NewFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20191101:FirewallPolicyRuleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyRuleGroup(ctx *pulumi.Context,
	...
	var resource FirewallPolicyRuleGroup
	err := ctx.ReadResource("azure-native:network/v20191101:FirewallPolicyRuleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
