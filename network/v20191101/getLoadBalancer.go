...
//
// Deprecated: azure-native:network/v20191101:LoadBalancer is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:LoadBalancer to guarantee forwards compatibility.
func LookupLoadBalancer(ctx *pulumi.Context, args *LookupLoadBalancerArgs, opts ...pulumi.InvokeOption) (*LookupLoadBalancerResult, error) {
	var rv LookupLoadBalancerResult
	err := ctx.Invoke("azure-native:network/v20191101:getLoadBalancer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
