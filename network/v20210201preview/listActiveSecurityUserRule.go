...
func (o ListActiveSecurityUserRuleResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListActiveSecurityUserRuleResult] {
	return pulumix.Output[ListActiveSecurityUserRuleResult]{
