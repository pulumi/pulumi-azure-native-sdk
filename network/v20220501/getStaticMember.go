...
//
// Deprecated: azure-native:network/v20220501:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:StaticMember to guarantee forwards compatibility.
func LookupStaticMember(ctx *pulumi.Context, args *LookupStaticMemberArgs, opts ...pulumi.InvokeOption) (*LookupStaticMemberResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220501:getStaticMember", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
