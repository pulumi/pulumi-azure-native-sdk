...
func NewRouteFilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:RouteFilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilter(ctx *pulumi.Context,
	...
	var resource RouteFilter
	err := ctx.ReadResource("azure-native:network/v20220501:RouteFilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
