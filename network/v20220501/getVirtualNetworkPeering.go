...
//
// Deprecated: azure-native:network/v20220501:VirtualNetworkPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkPeering to guarantee forwards compatibility.
func LookupVirtualNetworkPeering(ctx *pulumi.Context, args *LookupVirtualNetworkPeeringArgs, opts ...pulumi.InvokeOption) (*LookupVirtualNetworkPeeringResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220501:getVirtualNetworkPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
