...
//
// Deprecated: azure-native:network/v20220501:ExpressRouteGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteGateway to guarantee forwards compatibility.
func LookupExpressRouteGateway(ctx *pulumi.Context, args *LookupExpressRouteGatewayArgs, opts ...pulumi.InvokeOption) (*LookupExpressRouteGatewayResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220501:getExpressRouteGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
