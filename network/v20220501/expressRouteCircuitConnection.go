...
//
// Deprecated: azure-native:network/v20220501:ExpressRouteCircuitConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitConnection to guarantee forwards compatibility.
...
func NewExpressRouteCircuitConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:ExpressRouteCircuitConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuitConnection(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuitConnection
	err := ctx.ReadResource("azure-native:network/v20220501:ExpressRouteCircuitConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
