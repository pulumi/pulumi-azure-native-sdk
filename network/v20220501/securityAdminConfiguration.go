...
//
// Deprecated: azure-native:network/v20220501:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityAdminConfiguration to guarantee forwards compatibility.
...
func NewSecurityAdminConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:SecurityAdminConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityAdminConfiguration(ctx *pulumi.Context,
	...
	var resource SecurityAdminConfiguration
	err := ctx.ReadResource("azure-native:network/v20220501:SecurityAdminConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
