...
//
// Deprecated: azure-native:network/v20220501:IpAllocation is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpAllocation to guarantee forwards compatibility.
...
func NewIpAllocation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:IpAllocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpAllocation(ctx *pulumi.Context,
	...
	var resource IpAllocation
	err := ctx.ReadResource("azure-native:network/v20220501:IpAllocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
