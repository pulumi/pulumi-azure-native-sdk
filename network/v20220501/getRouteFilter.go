...
//
// Deprecated: azure-native:network/v20220501:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteFilter to guarantee forwards compatibility.
func LookupRouteFilter(ctx *pulumi.Context, args *LookupRouteFilterArgs, opts ...pulumi.InvokeOption) (*LookupRouteFilterResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220501:getRouteFilter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
