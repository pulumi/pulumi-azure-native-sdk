...
//
// Deprecated: azure-native:network/v20220501:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:CustomIPPrefix to guarantee forwards compatibility.
func LookupCustomIPPrefix(ctx *pulumi.Context, args *LookupCustomIPPrefixArgs, opts ...pulumi.InvokeOption) (*LookupCustomIPPrefixResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220501:getCustomIPPrefix", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
