...
func NewExpressRoutePortAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:ExpressRoutePortAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRoutePortAuthorization(ctx *pulumi.Context,
	...
	var resource ExpressRoutePortAuthorization
	err := ctx.ReadResource("azure-native:network/v20220501:ExpressRoutePortAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
