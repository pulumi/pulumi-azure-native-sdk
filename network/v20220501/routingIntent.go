...
//
// Deprecated: azure-native:network/v20220501:RoutingIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RoutingIntent to guarantee forwards compatibility.
...
func NewRoutingIntent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:RoutingIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoutingIntent(ctx *pulumi.Context,
	...
	var resource RoutingIntent
	err := ctx.ReadResource("azure-native:network/v20220501:RoutingIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
