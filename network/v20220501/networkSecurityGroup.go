...
func NewNetworkSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:NetworkSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityGroup(ctx *pulumi.Context,
	...
	var resource NetworkSecurityGroup
	err := ctx.ReadResource("azure-native:network/v20220501:NetworkSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
