...
func NewExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:ExpressRouteCrossConnectionPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCrossConnectionPeering
	err := ctx.ReadResource("azure-native:network/v20220501:ExpressRouteCrossConnectionPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
