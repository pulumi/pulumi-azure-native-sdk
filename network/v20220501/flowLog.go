...
// A flow log resource.
//
// Deprecated: azure-native:network/v20220501:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FlowLog to guarantee forwards compatibility.
type FlowLog struct {
...
func NewFlowLog(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220501:FlowLog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlowLog(ctx *pulumi.Context,
	...
	var resource FlowLog
	err := ctx.ReadResource("azure-native:network/v20220501:FlowLog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
