...
//
// Deprecated: azure-native:network/v20220501:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatGateway to guarantee forwards compatibility.
func LookupNatGateway(ctx *pulumi.Context, args *LookupNatGatewayArgs, opts ...pulumi.InvokeOption) (*LookupNatGatewayResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220501:getNatGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
