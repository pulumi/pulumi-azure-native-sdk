...
//
// Deprecated: azure-native:network/v20220501:ExpressRoutePortAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRoutePortAuthorization to guarantee forwards compatibility.
func LookupExpressRoutePortAuthorization(ctx *pulumi.Context, args *LookupExpressRoutePortAuthorizationArgs, opts ...pulumi.InvokeOption) (*LookupExpressRoutePortAuthorizationResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220501:getExpressRoutePortAuthorization", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
