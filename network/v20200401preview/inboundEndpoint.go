...
func NewInboundEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200401preview:InboundEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInboundEndpoint(ctx *pulumi.Context,
	...
	var resource InboundEndpoint
	err := ctx.ReadResource("azure-native:network/v20200401preview:InboundEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *InboundEndpoint) ToOutput(ctx context.Context) pulumix.Output[*InboundEndpoint] {
	return pulumix.Output[*InboundEndpoint]{
		OutputState: i.ToInboundEndpointOutputWithContext(ctx).OutputState,
	}
}
...
func (o InboundEndpointOutput) ToOutput(ctx context.Context) pulumix.Output[*InboundEndpoint] {
	return pulumix.Output[*InboundEndpoint]{
