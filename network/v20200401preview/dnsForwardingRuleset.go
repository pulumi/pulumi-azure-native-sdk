...
func NewDnsForwardingRuleset(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200401preview:DnsForwardingRuleset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsForwardingRuleset(ctx *pulumi.Context,
	...
	var resource DnsForwardingRuleset
	err := ctx.ReadResource("azure-native:network/v20200401preview:DnsForwardingRuleset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
