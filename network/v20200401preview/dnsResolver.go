...
func NewDnsResolver(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200401preview:DnsResolver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsResolver(ctx *pulumi.Context,
	...
	var resource DnsResolver
	err := ctx.ReadResource("azure-native:network/v20200401preview:DnsResolver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
