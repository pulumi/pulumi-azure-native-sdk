...
func NewOutboundEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20200401preview:OutboundEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOutboundEndpoint(ctx *pulumi.Context,
	...
	var resource OutboundEndpoint
	err := ctx.ReadResource("azure-native:network/v20200401preview:OutboundEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
