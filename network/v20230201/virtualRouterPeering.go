...
func NewVirtualRouterPeering(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230501:VirtualRouterPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:VirtualRouterPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:VirtualRouterPeering"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:VirtualRouterPeering"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualRouterPeering
	err := ctx.RegisterResource("azure-native:network/v20230201:VirtualRouterPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouterPeering(ctx *pulumi.Context,
	...
	var resource VirtualRouterPeering
	err := ctx.ReadResource("azure-native:network/v20230201:VirtualRouterPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
