...
func NewFirewallPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230201:FirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicy(ctx *pulumi.Context,
	...
	var resource FirewallPolicy
	err := ctx.ReadResource("azure-native:network/v20230201:FirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
