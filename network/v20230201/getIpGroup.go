...
func LookupIpGroup(ctx *pulumi.Context, args *LookupIpGroupArgs, opts ...pulumi.InvokeOption) (*LookupIpGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230201:getIpGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupIpGroupResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupIpGroupResult] {
	return pulumix.Output[LookupIpGroupResult]{
