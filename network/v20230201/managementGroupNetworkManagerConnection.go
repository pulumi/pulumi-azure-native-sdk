...
func NewManagementGroupNetworkManagerConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230601:ManagementGroupNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:ManagementGroupNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:ManagementGroupNetworkManagerConnection"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:ManagementGroupNetworkManagerConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ManagementGroupNetworkManagerConnection
	err := ctx.RegisterResource("azure-native:network/v20230201:ManagementGroupNetworkManagerConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroupNetworkManagerConnection(ctx *pulumi.Context,
	...
	var resource ManagementGroupNetworkManagerConnection
	err := ctx.ReadResource("azure-native:network/v20230201:ManagementGroupNetworkManagerConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
