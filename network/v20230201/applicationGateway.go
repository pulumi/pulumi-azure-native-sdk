...
type ApplicationGateway struct {
	...
	DefaultPredefinedSslPolicy pulumi.StringOutput `pulumi:"defaultPredefinedSslPolicy"`
...
func NewApplicationGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20230201:ApplicationGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGateway(ctx *pulumi.Context,
	...
	var resource ApplicationGateway
	err := ctx.ReadResource("azure-native:network/v20230201:ApplicationGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The default predefined SSL Policy applied on the application gateway resource.
func (o ApplicationGatewayOutput) DefaultPredefinedSslPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v *ApplicationGateway) pulumi.StringOutput { return v.DefaultPredefinedSslPolicy }).(pulumi.StringOutput)
}
