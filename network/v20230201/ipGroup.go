...
func NewIpGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:IpGroup"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240501:IpGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230201:IpGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpGroup(ctx *pulumi.Context,
	...
	var resource IpGroup
	err := ctx.ReadResource("azure-native:network/v20230201:IpGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
