...
func NewPublicIPPrefix(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:PublicIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:PublicIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:PublicIPPrefix"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:PublicIPPrefix"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230201:PublicIPPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIPPrefix(ctx *pulumi.Context,
	...
	var resource PublicIPPrefix
	err := ctx.ReadResource("azure-native:network/v20230201:PublicIPPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
