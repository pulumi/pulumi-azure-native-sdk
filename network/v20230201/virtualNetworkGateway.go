...
func NewVirtualNetworkGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230401:VirtualNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230501:VirtualNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230601:VirtualNetworkGateway"),
		},
		{
			Type: pulumi.String("azure-native:network/v20230901:VirtualNetworkGateway"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:network/v20240501:VirtualNetworkGateway"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230201:VirtualNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGateway(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGateway
	err := ctx.ReadResource("azure-native:network/v20230201:VirtualNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
