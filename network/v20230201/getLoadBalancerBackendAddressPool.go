...
func LookupLoadBalancerBackendAddressPool(ctx *pulumi.Context, args *LookupLoadBalancerBackendAddressPoolArgs, opts ...pulumi.InvokeOption) (*LookupLoadBalancerBackendAddressPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230201:getLoadBalancerBackendAddressPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupLoadBalancerBackendAddressPoolResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLoadBalancerBackendAddressPoolResult] {
	return pulumix.Output[LookupLoadBalancerBackendAddressPoolResult]{
