...
func LookupRouteFilterRule(ctx *pulumi.Context, args *LookupRouteFilterRuleArgs, opts ...pulumi.InvokeOption) (*LookupRouteFilterRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20230201:getRouteFilterRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupRouteFilterRuleResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRouteFilterRuleResult] {
	return pulumix.Output[LookupRouteFilterRuleResult]{
