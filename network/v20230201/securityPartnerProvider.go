...
func NewSecurityPartnerProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:network/v20230901:SecurityPartnerProvider"),
		},
		{
			Type: pulumi.String("azure-native:network/v20231101:SecurityPartnerProvider"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240101:SecurityPartnerProvider"),
		},
		{
			Type: pulumi.String("azure-native:network/v20240301:SecurityPartnerProvider"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:network/v20230201:SecurityPartnerProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPartnerProvider(ctx *pulumi.Context,
	...
	var resource SecurityPartnerProvider
	err := ctx.ReadResource("azure-native:network/v20230201:SecurityPartnerProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
