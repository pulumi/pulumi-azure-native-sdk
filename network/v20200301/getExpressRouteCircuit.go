...
//
// Deprecated: azure-native:network/v20200301:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCircuit to guarantee forwards compatibility.
