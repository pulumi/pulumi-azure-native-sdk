...
//
// Deprecated: azure-native:network/v20200301:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuit to guarantee forwards compatibility.
func LookupExpressRouteCircuit(ctx *pulumi.Context, args *LookupExpressRouteCircuitArgs, opts ...pulumi.InvokeOption) (*LookupExpressRouteCircuitResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20200301:getExpressRouteCircuit", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
