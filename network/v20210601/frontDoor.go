...
func NewFrontDoor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210601:FrontDoor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFrontDoor(ctx *pulumi.Context,
	...
	var resource FrontDoor
	err := ctx.ReadResource("azure-native:network/v20210601:FrontDoor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
