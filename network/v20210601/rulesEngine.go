...
func NewRulesEngine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210601:RulesEngine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRulesEngine(ctx *pulumi.Context,
	...
	var resource RulesEngine
	err := ctx.ReadResource("azure-native:network/v20210601:RulesEngine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
