...
//
// Deprecated: azure-native:network/v20210501:PrivateDnsZoneGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PrivateDnsZoneGroup to guarantee forwards compatibility.
