...
//
// Deprecated: azure-native:network/v20210501:HubRouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:HubRouteTable to guarantee forwards compatibility.
...
func NewHubRouteTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501:HubRouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHubRouteTable(ctx *pulumi.Context,
	...
	var resource HubRouteTable
	err := ctx.ReadResource("azure-native:network/v20210501:HubRouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
