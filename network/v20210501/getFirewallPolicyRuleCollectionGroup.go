...
//
// Deprecated: azure-native:network/v20210501:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.
func LookupFirewallPolicyRuleCollectionGroup(ctx *pulumi.Context, args *LookupFirewallPolicyRuleCollectionGroupArgs, opts ...pulumi.InvokeOption) (*LookupFirewallPolicyRuleCollectionGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20210501:getFirewallPolicyRuleCollectionGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
