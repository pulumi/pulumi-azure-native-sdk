...
func NewNatGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501:NatGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNatGateway(ctx *pulumi.Context,
	...
	var resource NatGateway
	err := ctx.ReadResource("azure-native:network/v20210501:NatGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
