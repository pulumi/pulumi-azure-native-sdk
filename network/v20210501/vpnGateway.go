...
func NewVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501:VpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnGateway(ctx *pulumi.Context,
	...
	var resource VpnGateway
	err := ctx.ReadResource("azure-native:network/v20210501:VpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
