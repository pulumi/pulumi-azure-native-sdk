...
//
// Deprecated: azure-native:network/v20210501:WebApplicationFirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:WebApplicationFirewallPolicy to guarantee forwards compatibility.
func LookupWebApplicationFirewallPolicy(ctx *pulumi.Context, args *LookupWebApplicationFirewallPolicyArgs, opts ...pulumi.InvokeOption) (*LookupWebApplicationFirewallPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20210501:getWebApplicationFirewallPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
