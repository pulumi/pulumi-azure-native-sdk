...
func NewAzureFirewall(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20210501:AzureFirewall", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureFirewall(ctx *pulumi.Context,
	...
	var resource AzureFirewall
	err := ctx.ReadResource("azure-native:network/v20210501:AzureFirewall", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
