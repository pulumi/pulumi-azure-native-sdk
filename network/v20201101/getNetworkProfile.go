...
//
// Deprecated: azure-native:network/v20201101:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkProfile to guarantee forwards compatibility.
func LookupNetworkProfile(ctx *pulumi.Context, args *LookupNetworkProfileArgs, opts ...pulumi.InvokeOption) (*LookupNetworkProfileResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20201101:getNetworkProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
