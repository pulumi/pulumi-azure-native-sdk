...
//
// Deprecated: azure-native:network/v20201101:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FlowLog to guarantee forwards compatibility.
func LookupFlowLog(ctx *pulumi.Context, args *LookupFlowLogArgs, opts ...pulumi.InvokeOption) (*LookupFlowLogResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20201101:getFlowLog", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
