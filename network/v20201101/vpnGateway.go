...
// VpnGateway Resource.
//
// Deprecated: azure-native:network/v20201101:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnGateway to guarantee forwards compatibility.
...
func NewVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20201101:VpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnGateway(ctx *pulumi.Context,
	...
	var resource VpnGateway
	err := ctx.ReadResource("azure-native:network/v20201101:VpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
