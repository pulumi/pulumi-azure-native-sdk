...
//
// Deprecated: azure-native:network/v20201101:VirtualHubBgpConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubBgpConnection to guarantee forwards compatibility.
...
func NewVirtualHubBgpConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20201101:VirtualHubBgpConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHubBgpConnection(ctx *pulumi.Context,
	...
	var resource VirtualHubBgpConnection
	err := ctx.ReadResource("azure-native:network/v20201101:VirtualHubBgpConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
