...
func NewExpressRouteConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20201101:ExpressRouteConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteConnection(ctx *pulumi.Context,
	...
	var resource ExpressRouteConnection
	err := ctx.ReadResource("azure-native:network/v20201101:ExpressRouteConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
