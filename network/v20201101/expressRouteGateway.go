...
func NewExpressRouteGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20201101:ExpressRouteGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteGateway(ctx *pulumi.Context,
	...
	var resource ExpressRouteGateway
	err := ctx.ReadResource("azure-native:network/v20201101:ExpressRouteGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
