...
//
// Deprecated: azure-native:network/v20200501:PrivateLinkService is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210201:PrivateLinkService to guarantee forwards compatibility.
func LookupPrivateLinkService(ctx *pulumi.Context, args *LookupPrivateLinkServiceArgs, opts ...pulumi.InvokeOption) (*LookupPrivateLinkServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20200501:getPrivateLinkService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
