...
//
// Deprecated: azure-native:network/v20200501:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:VirtualHub to guarantee forwards compatibility.
func LookupVirtualHub(ctx *pulumi.Context, args *LookupVirtualHubArgs, opts ...pulumi.InvokeOption) (*LookupVirtualHubResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20200501:getVirtualHub", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
