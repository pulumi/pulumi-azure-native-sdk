...
//
// Deprecated: azure-native:network/v20200501:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:Subnet to guarantee forwards compatibility.
func LookupSubnet(ctx *pulumi.Context, args *LookupSubnetArgs, opts ...pulumi.InvokeOption) (*LookupSubnetResult, error) {
	var rv LookupSubnetResult
	err := ctx.Invoke("azure-native:network/v20200501:getSubnet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
