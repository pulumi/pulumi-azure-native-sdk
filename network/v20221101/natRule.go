...
func NewNatRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20221101:NatRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNatRule(ctx *pulumi.Context,
	...
	var resource NatRule
	err := ctx.ReadResource("azure-native:network/v20221101:NatRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
