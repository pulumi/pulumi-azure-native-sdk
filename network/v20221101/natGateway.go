...
func NewNatGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20221101:NatGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNatGateway(ctx *pulumi.Context,
	...
	var resource NatGateway
	err := ctx.ReadResource("azure-native:network/v20221101:NatGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
