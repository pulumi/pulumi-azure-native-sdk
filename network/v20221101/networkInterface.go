...
func NewNetworkInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20221101:NetworkInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterface(ctx *pulumi.Context,
	...
	var resource NetworkInterface
	err := ctx.ReadResource("azure-native:network/v20221101:NetworkInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
