...
func NewPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20221101:PrivateDnsZoneGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateDnsZoneGroup(ctx *pulumi.Context,
	...
	var resource PrivateDnsZoneGroup
	err := ctx.ReadResource("azure-native:network/v20221101:PrivateDnsZoneGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
