...
func NewRouteFilterRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20221101:RouteFilterRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteFilterRule(ctx *pulumi.Context,
	...
	var resource RouteFilterRule
	err := ctx.ReadResource("azure-native:network/v20221101:RouteFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
