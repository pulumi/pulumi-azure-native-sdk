...
func NewVirtualRouterPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20221101:VirtualRouterPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouterPeering(ctx *pulumi.Context,
	...
	var resource VirtualRouterPeering
	err := ctx.ReadResource("azure-native:network/v20221101:VirtualRouterPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
