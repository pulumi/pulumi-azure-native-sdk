...
func NewRouteMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20221101:RouteMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteMap(ctx *pulumi.Context,
	...
	var resource RouteMap
	err := ctx.ReadResource("azure-native:network/v20221101:RouteMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
