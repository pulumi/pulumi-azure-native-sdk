...
func NewExpressRouteCircuit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20221101:ExpressRouteCircuit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCircuit(ctx *pulumi.Context,
	...
	var resource ExpressRouteCircuit
	err := ctx.ReadResource("azure-native:network/v20221101:ExpressRouteCircuit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
