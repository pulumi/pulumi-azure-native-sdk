...
//
// Deprecated: azure-native:network/v20220701:ScopeConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ScopeConnection to guarantee forwards compatibility.
func LookupScopeConnection(ctx *pulumi.Context, args *LookupScopeConnectionArgs, opts ...pulumi.InvokeOption) (*LookupScopeConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220701:getScopeConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
