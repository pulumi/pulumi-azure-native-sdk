...
//
// Deprecated: azure-native:network/v20220701:ExpressRoutePort is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRoutePort to guarantee forwards compatibility.
...
func NewExpressRoutePort(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:ExpressRoutePort", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRoutePort(ctx *pulumi.Context,
	...
	var resource ExpressRoutePort
	err := ctx.ReadResource("azure-native:network/v20220701:ExpressRoutePort", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
