...
func NewFirewallPolicyRuleCollectionGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:FirewallPolicyRuleCollectionGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyRuleCollectionGroup(ctx *pulumi.Context,
	...
	var resource FirewallPolicyRuleCollectionGroup
	err := ctx.ReadResource("azure-native:network/v20220701:FirewallPolicyRuleCollectionGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
