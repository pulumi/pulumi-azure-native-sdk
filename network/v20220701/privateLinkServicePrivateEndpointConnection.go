...
//
// Deprecated: azure-native:network/v20220701:PrivateLinkServicePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateLinkServicePrivateEndpointConnection to guarantee forwards compatibility.
...
func NewPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:PrivateLinkServicePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:network/v20220701:PrivateLinkServicePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
