...
//
// Deprecated: azure-native:network/v20220701:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetwork to guarantee forwards compatibility.
