...
//
// Deprecated: azure-native:network/v20220701:NetworkManager is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkManager to guarantee forwards compatibility.
func LookupNetworkManager(ctx *pulumi.Context, args *LookupNetworkManagerArgs, opts ...pulumi.InvokeOption) (*LookupNetworkManagerResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220701:getNetworkManager", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
