...
func NewPublicIPPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:PublicIPPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicIPPrefix(ctx *pulumi.Context,
	...
	var resource PublicIPPrefix
	err := ctx.ReadResource("azure-native:network/v20220701:PublicIPPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
