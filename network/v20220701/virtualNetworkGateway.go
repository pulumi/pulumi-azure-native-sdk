...
func NewVirtualNetworkGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:VirtualNetworkGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkGateway(ctx *pulumi.Context,
	...
	var resource VirtualNetworkGateway
	err := ctx.ReadResource("azure-native:network/v20220701:VirtualNetworkGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
