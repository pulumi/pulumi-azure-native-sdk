...
func NewPrivateResolverVirtualNetworkLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:PrivateResolverVirtualNetworkLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateResolverVirtualNetworkLink(ctx *pulumi.Context,
	...
	var resource PrivateResolverVirtualNetworkLink
	err := ctx.ReadResource("azure-native:network/v20220701:PrivateResolverVirtualNetworkLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
