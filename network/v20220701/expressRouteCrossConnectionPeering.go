...
//
// Deprecated: azure-native:network/v20220701:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.
...
func NewExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:ExpressRouteCrossConnectionPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExpressRouteCrossConnectionPeering(ctx *pulumi.Context,
	...
	var resource ExpressRouteCrossConnectionPeering
	err := ctx.ReadResource("azure-native:network/v20220701:ExpressRouteCrossConnectionPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
