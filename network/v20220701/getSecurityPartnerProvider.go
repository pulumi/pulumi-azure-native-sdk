...
//
// Deprecated: azure-native:network/v20220701:SecurityPartnerProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityPartnerProvider to guarantee forwards compatibility.
func LookupSecurityPartnerProvider(ctx *pulumi.Context, args *LookupSecurityPartnerProviderArgs, opts ...pulumi.InvokeOption) (*LookupSecurityPartnerProviderResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220701:getSecurityPartnerProvider", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
