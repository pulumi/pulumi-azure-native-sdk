...
func NewApplicationGatewayPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:ApplicationGatewayPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationGatewayPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource ApplicationGatewayPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:network/v20220701:ApplicationGatewayPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
