...
func NewVirtualApplianceSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:VirtualApplianceSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualApplianceSite(ctx *pulumi.Context,
	...
	var resource VirtualApplianceSite
	err := ctx.ReadResource("azure-native:network/v20220701:VirtualApplianceSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
