...
//
// Deprecated: azure-native:network/v20220701:VirtualRouterPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualRouterPeering to guarantee forwards compatibility.
...
func NewVirtualRouterPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:VirtualRouterPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualRouterPeering(ctx *pulumi.Context,
	...
	var resource VirtualRouterPeering
	err := ctx.ReadResource("azure-native:network/v20220701:VirtualRouterPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
