...
//
// Deprecated: azure-native:network/v20220701:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGateway to guarantee forwards compatibility.
func LookupVirtualNetworkGateway(ctx *pulumi.Context, args *LookupVirtualNetworkGatewayArgs, opts ...pulumi.InvokeOption) (*LookupVirtualNetworkGatewayResult, error) {
	...
	err := ctx.Invoke("azure-native:network/v20220701:getVirtualNetworkGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
