...
//
// Deprecated: azure-native:network/v20220701:PrivateLinkService is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateLinkService to guarantee forwards compatibility.
...
func NewPrivateLinkService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:network/v20220701:PrivateLinkService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkService(ctx *pulumi.Context,
	...
	var resource PrivateLinkService
	err := ctx.ReadResource("azure-native:network/v20220701:PrivateLinkService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
