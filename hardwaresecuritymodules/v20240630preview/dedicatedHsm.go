...
func NewDedicatedHsm(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hardwaresecuritymodules/v20240630preview:DedicatedHsm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHsm(ctx *pulumi.Context,
	...
	var resource DedicatedHsm
	err := ctx.ReadResource("azure-native:hardwaresecuritymodules/v20240630preview:DedicatedHsm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
