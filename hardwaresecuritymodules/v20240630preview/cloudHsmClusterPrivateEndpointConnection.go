...
func NewCloudHsmClusterPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hardwaresecuritymodules/v20240630preview:CloudHsmClusterPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudHsmClusterPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource CloudHsmClusterPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:hardwaresecuritymodules/v20240630preview:CloudHsmClusterPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
