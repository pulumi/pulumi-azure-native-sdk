...
func NewLandingZoneRegistrationOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:sovereign:LandingZoneRegistrationOperation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource LandingZoneRegistrationOperation
	err := ctx.RegisterResource("azure-native:sovereign/v20250227preview:LandingZoneRegistrationOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLandingZoneRegistrationOperation(ctx *pulumi.Context,
	...
	var resource LandingZoneRegistrationOperation
	err := ctx.ReadResource("azure-native:sovereign/v20250227preview:LandingZoneRegistrationOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
