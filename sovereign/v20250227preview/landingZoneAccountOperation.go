...
func NewLandingZoneAccountOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:sovereign:LandingZoneAccountOperation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource LandingZoneAccountOperation
	err := ctx.RegisterResource("azure-native:sovereign/v20250227preview:LandingZoneAccountOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLandingZoneAccountOperation(ctx *pulumi.Context,
	...
	var resource LandingZoneAccountOperation
	err := ctx.ReadResource("azure-native:sovereign/v20250227preview:LandingZoneAccountOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
