...
func LookupConnectedCluster(ctx *pulumi.Context, args *LookupConnectedClusterArgs, opts ...pulumi.InvokeOption) (*LookupConnectedClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:kubernetes/v20240715preview:getConnectedCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupConnectedClusterResult struct {
	...
	ArcAgentryConfigurations []ArcAgentryConfigurationsResponse `pulumi:"arcAgentryConfigurations"`
	...
	OidcIssuerProfile *OidcIssuerProfileResponse `pulumi:"oidcIssuerProfile"`
...
// Configuration settings for customizing the behavior of the connected cluster.
func (o LookupConnectedClusterResultOutput) ArcAgentryConfigurations() ArcAgentryConfigurationsResponseArrayOutput {
	return o.ApplyT(func(v LookupConnectedClusterResult) []ArcAgentryConfigurationsResponse {
...
// Details of the gateway used by the Arc router for connectivity.
func (o LookupConnectedClusterResultOutput) Gateway() GatewayResponsePtrOutput {
	return o.ApplyT(func(v LookupConnectedClusterResult) *GatewayResponse { return v.Gateway }).(GatewayResponsePtrOutput)
}
...
// Open ID Connect (OIDC) Issuer Profile for the connected cluster.
func (o LookupConnectedClusterResultOutput) OidcIssuerProfile() OidcIssuerProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupConnectedClusterResult) *OidcIssuerProfileResponse { return v.OidcIssuerProfile }).(OidcIssuerProfileResponsePtrOutput)
}
...
// Security profile for the connected cluster.
func (o LookupConnectedClusterResultOutput) SecurityProfile() SecurityProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupConnectedClusterResult) *SecurityProfileResponse { return v.SecurityProfile }).(SecurityProfileResponsePtrOutput)
}
