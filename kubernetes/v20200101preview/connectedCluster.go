...
// AAD profile of the connected cluster.
func (o ConnectedClusterOutput) AadProfile() ConnectedClusterAADProfileResponseOutput {
	return o.ApplyT(func(v *ConnectedCluster) ConnectedClusterAADProfileResponseOutput { return v.AadProfile }).(ConnectedClusterAADProfileResponseOutput)
}
...
// Represents the connectivity status of the connected cluster.
func (o ConnectedClusterOutput) ConnectivityStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ConnectedCluster) pulumi.StringPtrOutput { return v.ConnectivityStatus }).(pulumi.StringPtrOutput)
}
