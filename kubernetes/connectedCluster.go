...
func NewConnectedCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:kubernetes/v20251201preview:ConnectedCluster"),
		},
		{
			Type: pulumi.String("azure-native:kubernetes/v20260201preview:ConnectedCluster"),
		},
		{
			Type: pulumi.String("azure-native:kubernetes/v20260501:ConnectedCluster"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ConnectedCluster
	err := ctx.RegisterResource("azure-native:kubernetes:ConnectedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedCluster(ctx *pulumi.Context,
	...
	var resource ConnectedCluster
	err := ctx.ReadResource("azure-native:kubernetes:ConnectedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ConnectedClusterOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ConnectedCluster) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
