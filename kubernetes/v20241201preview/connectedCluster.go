...
type ConnectedCluster struct {
	...
	AadProfile AadProfileResponsePtrOutput `pulumi:"aadProfile"`
	...
	ArcAgentProfile ArcAgentProfileResponsePtrOutput `pulumi:"arcAgentProfile"`
	// Configuration settings for customizing the behavior of the connected cluster.
	ArcAgentryConfigurations ArcAgentryConfigurationsResponseArrayOutput `pulumi:"arcAgentryConfigurations"`
	...
	Gateway GatewayResponsePtrOutput `pulumi:"gateway"`
	...
	OidcIssuerProfile OidcIssuerProfileResponsePtrOutput `pulumi:"oidcIssuerProfile"`
...
func NewConnectedCluster(ctx *pulumi.Context,
	...
	if args.ArcAgentProfile != nil {
		args.ArcAgentProfile = args.ArcAgentProfile.ToArcAgentProfilePtrOutput().ApplyT(func(v *ArcAgentProfile) *ArcAgentProfile { return v.Defaults() }).(ArcAgentProfilePtrOutput)
	}
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:kubernetes/v20240101:ConnectedCluster"),
		},
		{
			Type: pulumi.String("azure-native:kubernetes/v20240201preview:ConnectedCluster"),
		},
		{
			Type: pulumi.String("azure-native:kubernetes/v20240601preview:ConnectedCluster"),
		},
		{
			Type: pulumi.String("azure-native:kubernetes/v20240701preview:ConnectedCluster"),
		},
		{
			Type: pulumi.String("azure-native:kubernetes/v20240715preview:ConnectedCluster"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ConnectedCluster
	err := ctx.RegisterResource("azure-native:kubernetes/v20241201preview:ConnectedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedCluster(ctx *pulumi.Context,
	...
	var resource ConnectedCluster
	err := ctx.ReadResource("azure-native:kubernetes/v20241201preview:ConnectedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type connectedClusterArgs struct {
	...
	// Configuration settings for customizing the behavior of the connected cluster.
	ArcAgentryConfigurations []ArcAgentryConfigurations `pulumi:"arcAgentryConfigurations"`
	// Indicates whether Azure Hybrid Benefit is opted in
	...
	// Open ID Connect (OIDC) Issuer Profile for the connected cluster.
	OidcIssuerProfile *OidcIssuerProfile `pulumi:"oidcIssuerProfile"`
	// This is populated only if privateLinkState is enabled. The resource id of the private link scope this connected cluster is assigned to, if any.
...
type ConnectedClusterArgs struct {
	// AAD profile for the connected cluster.
	AadProfile AadProfilePtrInput
	// Base64 encoded public certificate used by the agent to do the initial handshake to the backend services in Azure.
	AgentPublicKeyCertificate pulumi.StringInput
	// Arc agentry configuration for the provisioned cluster.
	ArcAgentProfile ArcAgentProfilePtrInput
	// Configuration settings for customizing the behavior of the connected cluster.
	ArcAgentryConfigurations ArcAgentryConfigurationsArrayInput
	// Indicates whether Azure Hybrid Benefit is opted in
	...
	// Open ID Connect (OIDC) Issuer Profile for the connected cluster.
	OidcIssuerProfile OidcIssuerProfilePtrInput
	// This is populated only if privateLinkState is enabled. The resource id of the private link scope this connected cluster is assigned to, if any.
...
// AAD profile for the connected cluster.
func (o ConnectedClusterOutput) AadProfile() AadProfileResponsePtrOutput {
	return o.ApplyT(func(v *ConnectedCluster) AadProfileResponsePtrOutput { return v.AadProfile }).(AadProfileResponsePtrOutput)
}
...
// Arc agentry configuration for the provisioned cluster.
func (o ConnectedClusterOutput) ArcAgentProfile() ArcAgentProfileResponsePtrOutput {
	return o.ApplyT(func(v *ConnectedCluster) ArcAgentProfileResponsePtrOutput { return v.ArcAgentProfile }).(ArcAgentProfileResponsePtrOutput)
}

// Configuration settings for customizing the behavior of the connected cluster.
func (o ConnectedClusterOutput) ArcAgentryConfigurations() ArcAgentryConfigurationsResponseArrayOutput {
	return o.ApplyT(func(v *ConnectedCluster) ArcAgentryConfigurationsResponseArrayOutput {
		return v.ArcAgentryConfigurations
	}).(ArcAgentryConfigurationsResponseArrayOutput)
}
...
// Details of the gateway used by the Arc router for connectivity.
func (o ConnectedClusterOutput) Gateway() GatewayResponsePtrOutput {
	return o.ApplyT(func(v *ConnectedCluster) GatewayResponsePtrOutput { return v.Gateway }).(GatewayResponsePtrOutput)
}
...
// The kind of connected cluster.
func (o ConnectedClusterOutput) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ConnectedCluster) pulumi.StringPtrOutput { return v.Kind }).(pulumi.StringPtrOutput)
}
...
// Open ID Connect (OIDC) Issuer Profile for the connected cluster.
func (o ConnectedClusterOutput) OidcIssuerProfile() OidcIssuerProfileResponsePtrOutput {
	return o.ApplyT(func(v *ConnectedCluster) OidcIssuerProfileResponsePtrOutput { return v.OidcIssuerProfile }).(OidcIssuerProfileResponsePtrOutput)
}
...
// Security profile for the connected cluster.
func (o ConnectedClusterOutput) SecurityProfile() SecurityProfileResponsePtrOutput {
	return o.ApplyT(func(v *ConnectedCluster) SecurityProfileResponsePtrOutput { return v.SecurityProfile }).(SecurityProfileResponsePtrOutput)
}
