...
func NewConnectedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kubernetes/v20231101preview:ConnectedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedCluster(ctx *pulumi.Context,
	...
	var resource ConnectedCluster
	err := ctx.ReadResource("azure-native:kubernetes/v20231101preview:ConnectedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
