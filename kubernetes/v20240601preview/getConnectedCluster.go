...
func LookupConnectedCluster(ctx *pulumi.Context, args *LookupConnectedClusterArgs, opts ...pulumi.InvokeOption) (*LookupConnectedClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:kubernetes/v20240601preview:getConnectedCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupConnectedClusterOutput(ctx *pulumi.Context, args LookupConnectedClusterOutputArgs, opts ...pulumi.InvokeOption) LookupConnectedClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConnectedClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kubernetes/v20240601preview:getConnectedCluster", args, LookupConnectedClusterResultOutput{}, options).(LookupConnectedClusterResultOutput), nil
