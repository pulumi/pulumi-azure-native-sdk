...
// The Azure API version of the resource.
func (o SecretValueOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SecretValue) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
