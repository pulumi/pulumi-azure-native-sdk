...
// The Azure API version of the resource.
func (o NetworkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Network) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
