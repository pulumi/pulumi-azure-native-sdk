...
type KafkaProfileResponse struct {
	...
	ClusterIdentity IdentityProfileResponse `pulumi:"clusterIdentity"`
...
// Identity of the internal service components inside the Kafka cluster.
func (o KafkaProfileResponseOutput) ClusterIdentity() IdentityProfileResponseOutput {
	return o.ApplyT(func(v KafkaProfileResponse) IdentityProfileResponse { return v.ClusterIdentity }).(IdentityProfileResponseOutput)
}
...
// Identity of the internal service components inside the Kafka cluster.
func (o KafkaProfileResponsePtrOutput) ClusterIdentity() IdentityProfileResponsePtrOutput {
	return o.ApplyT(func(v *KafkaProfileResponse) *IdentityProfileResponse {
		if v == nil {
			return nil
		}
		return &v.ClusterIdentity
	}).(IdentityProfileResponsePtrOutput)
}
