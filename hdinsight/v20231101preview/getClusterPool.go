...
func LookupClusterPool(ctx *pulumi.Context, args *LookupClusterPoolArgs, opts ...pulumi.InvokeOption) (*LookupClusterPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:hdinsight/v20231101preview:getClusterPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
// Defaults sets the appropriate defaults for LookupClusterPoolResult
func (val *LookupClusterPoolResult) Defaults() *LookupClusterPoolResult {
	if val == nil {
		return nil
	}
	tmp := *val
...
func LookupClusterPoolOutput(ctx *pulumi.Context, args LookupClusterPoolOutputArgs, opts ...pulumi.InvokeOption) LookupClusterPoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupClusterPoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hdinsight/v20231101preview:getClusterPool", args, LookupClusterPoolResultOutput{}, options).(LookupClusterPoolResultOutput), nil
