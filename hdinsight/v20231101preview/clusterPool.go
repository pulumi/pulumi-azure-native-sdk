...
func NewClusterPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hdinsight/v20231101preview:ClusterPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterPool(ctx *pulumi.Context,
	...
	var resource ClusterPool
	err := ctx.ReadResource("azure-native:hdinsight/v20231101preview:ClusterPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
