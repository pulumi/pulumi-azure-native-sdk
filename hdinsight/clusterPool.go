...
func NewClusterPool(ctx *pulumi.Context,
	...
	if args.NetworkProfile != nil {
		args.NetworkProfile = args.NetworkProfile.ToClusterPoolResourcePropertiesNetworkProfilePtrOutput().ApplyT(func(v *ClusterPoolResourcePropertiesNetworkProfile) *ClusterPoolResourcePropertiesNetworkProfile {
			return v.Defaults()
...
// The Azure API version of the resource.
func (o ClusterPoolOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ClusterPool) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
