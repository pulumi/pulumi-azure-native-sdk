...
func GetClusterGatewaySettings(ctx *pulumi.Context, args *GetClusterGatewaySettingsArgs, opts ...pulumi.InvokeOption) (*GetClusterGatewaySettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:hdinsight/v20250115preview:getClusterGatewaySettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetClusterGatewaySettingsResult struct {
	...
	RestAuthEntraUsers []EntraUserInfoResponse `pulumi:"restAuthEntraUsers"`
...
func GetClusterGatewaySettingsOutput(ctx *pulumi.Context, args GetClusterGatewaySettingsOutputArgs, opts ...pulumi.InvokeOption) GetClusterGatewaySettingsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetClusterGatewaySettingsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hdinsight/v20250115preview:getClusterGatewaySettings", args, GetClusterGatewaySettingsResultOutput{}, options).(GetClusterGatewaySettingsResultOutput), nil
...
// List of Entra users for gateway access.
func (o GetClusterGatewaySettingsResultOutput) RestAuthEntraUsers() EntraUserInfoResponseArrayOutput {
	return o.ApplyT(func(v GetClusterGatewaySettingsResult) []EntraUserInfoResponse { return v.RestAuthEntraUsers }).(EntraUserInfoResponseArrayOutput)
}
