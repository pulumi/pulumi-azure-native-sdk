...
func LookupApplication(ctx *pulumi.Context, args *LookupApplicationArgs, opts ...pulumi.InvokeOption) (*LookupApplicationResult, error) {
	...
	err := ctx.Invoke("azure-native:hdinsight/v20250115preview:getApplication", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApplicationOutput(ctx *pulumi.Context, args LookupApplicationOutputArgs, opts ...pulumi.InvokeOption) LookupApplicationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApplicationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hdinsight/v20250115preview:getApplication", args, LookupApplicationResultOutput{}, options).(LookupApplicationResultOutput), nil
