...
type EntraUserInfoResponse struct {
...
// Details of an Entra user for gateway access.
type EntraUserInfoResponseOutput struct{ *pulumi.OutputState }

func (EntraUserInfoResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*EntraUserInfoResponse)(nil)).Elem()
}

func (o EntraUserInfoResponseOutput) ToEntraUserInfoResponseOutput() EntraUserInfoResponseOutput {
	return o
}

func (o EntraUserInfoResponseOutput) ToEntraUserInfoResponseOutputWithContext(ctx context.Context) EntraUserInfoResponseOutput {
	return o
}

// The display name of the Entra user.
func (o EntraUserInfoResponseOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EntraUserInfoResponse) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}

// The unique object ID of the Entra user or client ID of the enterprise applications.
func (o EntraUserInfoResponseOutput) ObjectId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EntraUserInfoResponse) *string { return v.ObjectId }).(pulumi.StringPtrOutput)
}

// The User Principal Name (UPN) of the Entra user. It may be empty in certain cases, such as for enterprise applications.
func (o EntraUserInfoResponseOutput) Upn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v EntraUserInfoResponse) *string { return v.Upn }).(pulumi.StringPtrOutput)
}

type EntraUserInfoResponseArrayOutput struct{ *pulumi.OutputState }

func (EntraUserInfoResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]EntraUserInfoResponse)(nil)).Elem()
}

func (o EntraUserInfoResponseArrayOutput) ToEntraUserInfoResponseArrayOutput() EntraUserInfoResponseArrayOutput {
	return o
}

func (o EntraUserInfoResponseArrayOutput) ToEntraUserInfoResponseArrayOutputWithContext(ctx context.Context) EntraUserInfoResponseArrayOutput {
	return o
}

func (o EntraUserInfoResponseArrayOutput) Index(i pulumi.IntInput) EntraUserInfoResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) EntraUserInfoResponse {
		return vs[0].([]EntraUserInfoResponse)[vs[1].(int)]
	}).(EntraUserInfoResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(EntraUserInfoResponseOutput{})
	pulumi.RegisterOutputType(EntraUserInfoResponseArrayOutput{})
