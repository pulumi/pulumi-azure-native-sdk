...
func NewChangeDataCapture(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:datafactory:ChangeDataCapture"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ChangeDataCapture
	err := ctx.RegisterResource("azure-native:datafactory/v20180601:ChangeDataCapture", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetChangeDataCapture(ctx *pulumi.Context,
	...
	var resource ChangeDataCapture
	err := ctx.ReadResource("azure-native:datafactory/v20180601:ChangeDataCapture", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
