...
func LookupIntegrationRuntimeOutput(ctx *pulumi.Context, args LookupIntegrationRuntimeOutputArgs, opts ...pulumi.InvokeOption) LookupIntegrationRuntimeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIntegrationRuntimeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datafactory:getIntegrationRuntime", args, LookupIntegrationRuntimeResultOutput{}, options).(LookupIntegrationRuntimeResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupIntegrationRuntimeResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupIntegrationRuntimeResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
