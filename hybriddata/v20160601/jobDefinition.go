...
func NewJobDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybriddata/v20160601:JobDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobDefinition(ctx *pulumi.Context,
	...
	var resource JobDefinition
	err := ctx.ReadResource("azure-native:hybriddata/v20160601:JobDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
