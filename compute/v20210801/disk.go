...
// Disk resource.
//
// Deprecated: azure-native:compute/v20210801:Disk is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:Disk to guarantee forwards compatibility.
type Disk struct {
...
func NewDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.RegisterResource("azure-native:compute/v20210801:Disk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.ReadResource("azure-native:compute/v20210801:Disk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
