...
func NewSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20210801:Snapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshot(ctx *pulumi.Context,
	...
	var resource Snapshot
	err := ctx.ReadResource("azure-native:compute/v20210801:Snapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
