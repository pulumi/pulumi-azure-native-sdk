...
func NewCloudService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20241104:CloudService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudService(ctx *pulumi.Context,
	...
	var resource CloudService
	err := ctx.ReadResource("azure-native:compute/v20241104:CloudService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
