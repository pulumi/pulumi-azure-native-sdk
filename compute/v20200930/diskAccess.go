...
//
// Deprecated: azure-native:compute/v20200930:DiskAccess is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskAccess to guarantee forwards compatibility.
...
func NewDiskAccess(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20200930:DiskAccess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskAccess(ctx *pulumi.Context,
	...
	var resource DiskAccess
	err := ctx.ReadResource("azure-native:compute/v20200930:DiskAccess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
