...
//
// Deprecated: azure-native:compute/v20200930:GalleryImage is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryImage to guarantee forwards compatibility.
...
func NewGalleryImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20200930:GalleryImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryImage(ctx *pulumi.Context,
	...
	var resource GalleryImage
	err := ctx.ReadResource("azure-native:compute/v20200930:GalleryImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
