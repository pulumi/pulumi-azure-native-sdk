...
func NewVirtualMachineScaleSetVM(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20240301:VirtualMachineScaleSetVM", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVM(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVM
	err := ctx.ReadResource("azure-native:compute/v20240301:VirtualMachineScaleSetVM", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
