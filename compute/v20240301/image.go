...
func NewImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.RegisterResource("azure-native:compute/v20240301:Image", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.ReadResource("azure-native:compute/v20240301:Image", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
