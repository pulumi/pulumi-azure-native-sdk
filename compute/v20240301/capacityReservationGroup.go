...
func NewCapacityReservationGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20240301:CapacityReservationGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapacityReservationGroup(ctx *pulumi.Context,
	...
	var resource CapacityReservationGroup
	err := ctx.ReadResource("azure-native:compute/v20240301:CapacityReservationGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
