...
func NewVirtualMachineScaleSetVMExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20230701:VirtualMachineScaleSetVMExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVMExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVMExtension
	err := ctx.ReadResource("azure-native:compute/v20230701:VirtualMachineScaleSetVMExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
