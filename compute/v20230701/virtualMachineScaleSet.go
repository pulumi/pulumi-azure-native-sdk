...
func NewVirtualMachineScaleSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20230701:VirtualMachineScaleSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSet(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSet
	err := ctx.ReadResource("azure-native:compute/v20230701:VirtualMachineScaleSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *VirtualMachineScaleSet) ToOutput(ctx context.Context) pulumix.Output[*VirtualMachineScaleSet] {
	return pulumix.Output[*VirtualMachineScaleSet]{
		OutputState: i.ToVirtualMachineScaleSetOutputWithContext(ctx).OutputState,
	}
}
...
func (o VirtualMachineScaleSetOutput) ToOutput(ctx context.Context) pulumix.Output[*VirtualMachineScaleSet] {
	return pulumix.Output[*VirtualMachineScaleSet]{
