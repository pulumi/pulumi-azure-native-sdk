...
func (o LookupVirtualMachineScaleSetVMExtensionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVirtualMachineScaleSetVMExtensionResult] {
	return pulumix.Output[LookupVirtualMachineScaleSetVMExtensionResult]{
