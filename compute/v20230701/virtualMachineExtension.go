...
func NewVirtualMachineExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20230701:VirtualMachineExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineExtension
	err := ctx.ReadResource("azure-native:compute/v20230701:VirtualMachineExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
