...
func NewCapacityReservationGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:compute/v20230301:CapacityReservationGroup"),
		},
		{
			Type: pulumi.String("azure-native:compute/v20230901:CapacityReservationGroup"),
		},
		{
			Type: pulumi.String("azure-native:compute/v20240301:CapacityReservationGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:compute/v20230701:CapacityReservationGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapacityReservationGroup(ctx *pulumi.Context,
	...
	var resource CapacityReservationGroup
	err := ctx.ReadResource("azure-native:compute/v20230701:CapacityReservationGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
