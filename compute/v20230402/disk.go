...
func NewDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.RegisterResource("azure-native:compute/v20230402:Disk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.ReadResource("azure-native:compute/v20230402:Disk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
