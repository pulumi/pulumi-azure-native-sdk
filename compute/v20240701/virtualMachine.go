...
func NewVirtualMachine(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:compute/v20230701:VirtualMachine"),
		},
		{
			Type: pulumi.String("azure-native:compute/v20230901:VirtualMachine"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:compute/v20240701:VirtualMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachine(ctx *pulumi.Context,
	...
	var resource VirtualMachine
	err := ctx.ReadResource("azure-native:compute/v20240701:VirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
