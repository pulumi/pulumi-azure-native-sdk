...
//
// Deprecated: azure-native:compute/v20211001:Gallery is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:Gallery to guarantee forwards compatibility.
func LookupGallery(ctx *pulumi.Context, args *LookupGalleryArgs, opts ...pulumi.InvokeOption) (*LookupGalleryResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20211001:getGallery", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
