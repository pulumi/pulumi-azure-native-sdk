...
func NewDiskEncryptionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20240302:DiskEncryptionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskEncryptionSet(ctx *pulumi.Context,
	...
	var resource DiskEncryptionSet
	err := ctx.ReadResource("azure-native:compute/v20240302:DiskEncryptionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
