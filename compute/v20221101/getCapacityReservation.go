...
//
// Deprecated: azure-native:compute/v20221101:CapacityReservation is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:CapacityReservation to guarantee forwards compatibility.
func LookupCapacityReservation(ctx *pulumi.Context, args *LookupCapacityReservationArgs, opts ...pulumi.InvokeOption) (*LookupCapacityReservationResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20221101:getCapacityReservation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
