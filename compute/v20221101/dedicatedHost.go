...
func NewDedicatedHost(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20221101:DedicatedHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHost(ctx *pulumi.Context,
	...
	var resource DedicatedHost
	err := ctx.ReadResource("azure-native:compute/v20221101:DedicatedHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
