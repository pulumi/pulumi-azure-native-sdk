...
func GetLogAnalyticExportRequestRateByInterval(ctx *pulumi.Context, args *GetLogAnalyticExportRequestRateByIntervalArgs, opts ...pulumi.InvokeOption) (*GetLogAnalyticExportRequestRateByIntervalResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20221101:getLogAnalyticExportRequestRateByInterval", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o GetLogAnalyticExportRequestRateByIntervalResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetLogAnalyticExportRequestRateByIntervalResult] {
	return pulumix.Output[GetLogAnalyticExportRequestRateByIntervalResult]{
