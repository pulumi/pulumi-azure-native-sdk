...
//
// Deprecated: azure-native:compute/v20221101:ProximityPlacementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:ProximityPlacementGroup to guarantee forwards compatibility.
func LookupProximityPlacementGroup(ctx *pulumi.Context, args *LookupProximityPlacementGroupArgs, opts ...pulumi.InvokeOption) (*LookupProximityPlacementGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20221101:getProximityPlacementGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
