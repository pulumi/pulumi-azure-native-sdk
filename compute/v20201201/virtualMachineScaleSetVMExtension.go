...
//
// Deprecated: azure-native:compute/v20201201:VirtualMachineScaleSetVMExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20211101:VirtualMachineScaleSetVMExtension to guarantee forwards compatibility.
...
func NewVirtualMachineScaleSetVMExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20201201:VirtualMachineScaleSetVMExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVMExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVMExtension
	err := ctx.ReadResource("azure-native:compute/v20201201:VirtualMachineScaleSetVMExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
