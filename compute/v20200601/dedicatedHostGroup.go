...
func NewDedicatedHostGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20200601:DedicatedHostGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHostGroup(ctx *pulumi.Context,
	...
	var resource DedicatedHostGroup
	err := ctx.ReadResource("azure-native:compute/v20200601:DedicatedHostGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
