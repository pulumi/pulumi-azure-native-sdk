...
//
// Deprecated: azure-native:compute/v20210301:AvailabilitySet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:AvailabilitySet to guarantee forwards compatibility.
func LookupAvailabilitySet(ctx *pulumi.Context, args *LookupAvailabilitySetArgs, opts ...pulumi.InvokeOption) (*LookupAvailabilitySetResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20210301:getAvailabilitySet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
