...
func LookupAvailabilitySet(ctx *pulumi.Context, args *LookupAvailabilitySetArgs, opts ...pulumi.InvokeOption) (*LookupAvailabilitySetResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20160430preview:getAvailabilitySet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// If the availability set supports managed disks.
func (o LookupAvailabilitySetResultOutput) Managed() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupAvailabilitySetResult) *bool { return v.Managed }).(pulumi.BoolPtrOutput)
}
