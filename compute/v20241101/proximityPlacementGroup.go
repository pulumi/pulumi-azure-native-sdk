...
func NewProximityPlacementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20241101:ProximityPlacementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProximityPlacementGroup(ctx *pulumi.Context,
	...
	var resource ProximityPlacementGroup
	err := ctx.ReadResource("azure-native:compute/v20241101:ProximityPlacementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
