...
func NewImage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:compute/v20230701:Image"),
		},
		{
			Type: pulumi.String("azure-native:compute/v20230901:Image"),
		},
		{
	...
	var resource Image
	err := ctx.RegisterResource("azure-native:compute/v20241101:Image", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.ReadResource("azure-native:compute/v20241101:Image", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
