...
func NewRestorePoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20241101:RestorePoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRestorePoint(ctx *pulumi.Context,
	...
	var resource RestorePoint
	err := ctx.ReadResource("azure-native:compute/v20241101:RestorePoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
