...
func NewVirtualMachineRunCommandByVirtualMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20241101:VirtualMachineRunCommandByVirtualMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineRunCommandByVirtualMachine(ctx *pulumi.Context,
	...
	var resource VirtualMachineRunCommandByVirtualMachine
	err := ctx.ReadResource("azure-native:compute/v20241101:VirtualMachineRunCommandByVirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
