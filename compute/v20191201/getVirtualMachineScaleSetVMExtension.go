...
func (o LookupVirtualMachineScaleSetVMExtensionResultOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v LookupVirtualMachineScaleSetVMExtensionResult) string { return v.Location }).(pulumi.StringOutput)
}
...
func (o LookupVirtualMachineScaleSetVMExtensionResultOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupVirtualMachineScaleSetVMExtensionResult) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
