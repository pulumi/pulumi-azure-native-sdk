...
// azure-native:compute/v20191201:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.
func LookupGalleryApplicationVersion(ctx *pulumi.Context, args *LookupGalleryApplicationVersionArgs, opts ...pulumi.InvokeOption) (*LookupGalleryApplicationVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20191201:getGalleryApplicationVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
