...
func (o LookupVirtualMachineScaleSetResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVirtualMachineScaleSetResult] {
	return pulumix.Output[LookupVirtualMachineScaleSetResult]{
