...
func LookupVirtualMachineExtension(ctx *pulumi.Context, args *LookupVirtualMachineExtensionArgs, opts ...pulumi.InvokeOption) (*LookupVirtualMachineExtensionResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20230301:getVirtualMachineExtension", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupVirtualMachineExtensionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVirtualMachineExtensionResult] {
	return pulumix.Output[LookupVirtualMachineExtensionResult]{
