...
func NewSshPublicKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20230301:SshPublicKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSshPublicKey(ctx *pulumi.Context,
	...
	var resource SshPublicKey
	err := ctx.ReadResource("azure-native:compute/v20230301:SshPublicKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
