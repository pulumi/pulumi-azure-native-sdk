...
func NewAvailabilitySet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20230301:AvailabilitySet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAvailabilitySet(ctx *pulumi.Context,
	...
	var resource AvailabilitySet
	err := ctx.ReadResource("azure-native:compute/v20230301:AvailabilitySet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
