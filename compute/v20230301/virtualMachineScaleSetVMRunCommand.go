...
func NewVirtualMachineScaleSetVMRunCommand(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20230301:VirtualMachineScaleSetVMRunCommand", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVMRunCommand(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVMRunCommand
	err := ctx.ReadResource("azure-native:compute/v20230301:VirtualMachineScaleSetVMRunCommand", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
