...
func NewSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20170330:Snapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshot(ctx *pulumi.Context,
	...
	var resource Snapshot
	err := ctx.ReadResource("azure-native:compute/v20170330:Snapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The disks and snapshots sku name. Can be Standard_LRS or Premium_LRS.
func (o SnapshotOutput) Sku() DiskSkuResponsePtrOutput {
	return o.ApplyT(func(v *Snapshot) DiskSkuResponsePtrOutput { return v.Sku }).(DiskSkuResponsePtrOutput)
}
