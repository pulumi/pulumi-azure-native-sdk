...
// azure-native:compute/v20171201:VirtualMachineScaleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSet to guarantee forwards compatibility.
...
func NewVirtualMachineScaleSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20171201:VirtualMachineScaleSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSet(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSet
	err := ctx.ReadResource("azure-native:compute/v20171201:VirtualMachineScaleSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
