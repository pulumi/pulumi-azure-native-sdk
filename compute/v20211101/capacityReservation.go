...
func NewCapacityReservation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20211101:CapacityReservation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapacityReservation(ctx *pulumi.Context,
	...
	var resource CapacityReservation
	err := ctx.ReadResource("azure-native:compute/v20211101:CapacityReservation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
