...
// Gets an image.
//
// Deprecated: azure-native:compute/v20211101:Image is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:Image to guarantee forwards compatibility.
func LookupImage(ctx *pulumi.Context, args *LookupImageArgs, opts ...pulumi.InvokeOption) (*LookupImageResult, error) {
	var rv LookupImageResult
	err := ctx.Invoke("azure-native:compute/v20211101:getImage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
