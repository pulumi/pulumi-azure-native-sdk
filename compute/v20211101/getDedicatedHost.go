...
//
// Deprecated: azure-native:compute/v20211101:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHost to guarantee forwards compatibility.
func LookupDedicatedHost(ctx *pulumi.Context, args *LookupDedicatedHostArgs, opts ...pulumi.InvokeOption) (*LookupDedicatedHostResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20211101:getDedicatedHost", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
