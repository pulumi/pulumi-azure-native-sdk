...
//
// Deprecated: azure-native:compute/v20210701:VirtualMachineScaleSetVMRunCommand is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:VirtualMachineScaleSetVMRunCommand to guarantee forwards compatibility.
...
func NewVirtualMachineScaleSetVMRunCommand(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20210701:VirtualMachineScaleSetVMRunCommand", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVMRunCommand(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVMRunCommand
	err := ctx.ReadResource("azure-native:compute/v20210701:VirtualMachineScaleSetVMRunCommand", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
