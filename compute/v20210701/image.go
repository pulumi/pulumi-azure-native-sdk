...
//
// Deprecated: azure-native:compute/v20210701:Image is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:Image to guarantee forwards compatibility.
type Image struct {
...
func NewImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.RegisterResource("azure-native:compute/v20210701:Image", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.ReadResource("azure-native:compute/v20210701:Image", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
