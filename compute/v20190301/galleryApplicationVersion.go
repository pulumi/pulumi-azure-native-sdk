...
// azure-native:compute/v20190301:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.
...
func NewGalleryApplicationVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20190301:GalleryApplicationVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplicationVersion(ctx *pulumi.Context,
	...
	var resource GalleryApplicationVersion
	err := ctx.ReadResource("azure-native:compute/v20190301:GalleryApplicationVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
