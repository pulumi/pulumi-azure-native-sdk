...
// azure-native:compute/v20190701:DiskEncryptionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20200630:DiskEncryptionSet to guarantee forwards compatibility.
...
func NewDiskEncryptionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20190701:DiskEncryptionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskEncryptionSet(ctx *pulumi.Context,
	...
	var resource DiskEncryptionSet
	err := ctx.ReadResource("azure-native:compute/v20190701:DiskEncryptionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
