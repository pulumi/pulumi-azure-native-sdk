...
// azure-native:compute/v20190701:VirtualMachineScaleSetVM is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:VirtualMachineScaleSetVM to guarantee forwards compatibility.
...
func NewVirtualMachineScaleSetVM(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20190701:VirtualMachineScaleSetVM", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetVM(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetVM
	err := ctx.ReadResource("azure-native:compute/v20190701:VirtualMachineScaleSetVM", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
