...
func NewGalleryApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20190701:GalleryApplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplication(ctx *pulumi.Context,
	...
	var resource GalleryApplication
	err := ctx.ReadResource("azure-native:compute/v20190701:GalleryApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
