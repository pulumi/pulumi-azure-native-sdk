...
// azure-native:compute/v20190701:VirtualMachineScaleSetExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20211101:VirtualMachineScaleSetExtension to guarantee forwards compatibility.
...
func NewVirtualMachineScaleSetExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20190701:VirtualMachineScaleSetExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetExtension
	err := ctx.ReadResource("azure-native:compute/v20190701:VirtualMachineScaleSetExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
