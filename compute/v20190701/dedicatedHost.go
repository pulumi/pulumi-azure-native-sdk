...
// azure-native:compute/v20190701:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHost to guarantee forwards compatibility.
...
func NewDedicatedHost(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20190701:DedicatedHost", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDedicatedHost(ctx *pulumi.Context,
	...
	var resource DedicatedHost
	err := ctx.ReadResource("azure-native:compute/v20190701:DedicatedHost", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
