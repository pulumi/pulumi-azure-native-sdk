...
func NewDisk(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:compute/v20230102:Disk"),
		},
		{
			Type: pulumi.String("azure-native:compute/v20230402:Disk"),
		},
		{
			Type: pulumi.String("azure-native:compute/v20231002:Disk"),
		},
		{
	...
	var resource Disk
	err := ctx.RegisterResource("azure-native:compute/v20220702:Disk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.ReadResource("azure-native:compute/v20220702:Disk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
