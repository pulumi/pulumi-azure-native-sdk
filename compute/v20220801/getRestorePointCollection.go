...
//
// Deprecated: azure-native:compute/v20220801:RestorePointCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:RestorePointCollection to guarantee forwards compatibility.
func LookupRestorePointCollection(ctx *pulumi.Context, args *LookupRestorePointCollectionArgs, opts ...pulumi.InvokeOption) (*LookupRestorePointCollectionResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20220801:getRestorePointCollection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
