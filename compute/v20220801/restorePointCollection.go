...
func NewRestorePointCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20220801:RestorePointCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRestorePointCollection(ctx *pulumi.Context,
	...
	var resource RestorePointCollection
	err := ctx.ReadResource("azure-native:compute/v20220801:RestorePointCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
