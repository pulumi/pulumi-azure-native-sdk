...
//
// Deprecated: azure-native:compute/v20220801:CapacityReservation is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:CapacityReservation to guarantee forwards compatibility.
...
func NewCapacityReservation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20220801:CapacityReservation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapacityReservation(ctx *pulumi.Context,
	...
	var resource CapacityReservation
	err := ctx.ReadResource("azure-native:compute/v20220801:CapacityReservation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
