...
//
// Deprecated: azure-native:compute/v20220301:CapacityReservationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:CapacityReservationGroup to guarantee forwards compatibility.
func LookupCapacityReservationGroup(ctx *pulumi.Context, args *LookupCapacityReservationGroupArgs, opts ...pulumi.InvokeOption) (*LookupCapacityReservationGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20220301:getCapacityReservationGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
