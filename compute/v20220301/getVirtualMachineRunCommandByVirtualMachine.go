...
//
// Deprecated: azure-native:compute/v20220301:VirtualMachineRunCommandByVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineRunCommandByVirtualMachine to guarantee forwards compatibility.
func LookupVirtualMachineRunCommandByVirtualMachine(ctx *pulumi.Context, args *LookupVirtualMachineRunCommandByVirtualMachineArgs, opts ...pulumi.InvokeOption) (*LookupVirtualMachineRunCommandByVirtualMachineResult, error) {
	...
	err := ctx.Invoke("azure-native:compute/v20220301:getVirtualMachineRunCommandByVirtualMachine", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
