...
func NewDiskAccess(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20231002:DiskAccess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskAccess(ctx *pulumi.Context,
	...
	var resource DiskAccess
	err := ctx.ReadResource("azure-native:compute/v20231002:DiskAccess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
