...
func NewDiskAccessAPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20231002:DiskAccessAPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskAccessAPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource DiskAccessAPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:compute/v20231002:DiskAccessAPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
