...
func NewDiskEncryptionSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:compute/v20230402:DiskEncryptionSet"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:compute/v20231002:DiskEncryptionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskEncryptionSet(ctx *pulumi.Context,
	...
	var resource DiskEncryptionSet
	err := ctx.ReadResource("azure-native:compute/v20231002:DiskEncryptionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
