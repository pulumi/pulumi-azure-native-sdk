...
func NewVirtualMachineScaleSetExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20230901:VirtualMachineScaleSetExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineScaleSetExtension(ctx *pulumi.Context,
	...
	var resource VirtualMachineScaleSetExtension
	err := ctx.ReadResource("azure-native:compute/v20230901:VirtualMachineScaleSetExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
