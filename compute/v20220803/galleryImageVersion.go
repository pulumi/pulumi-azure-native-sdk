...
func NewGalleryImageVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20220803:GalleryImageVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryImageVersion(ctx *pulumi.Context,
	...
	var resource GalleryImageVersion
	err := ctx.ReadResource("azure-native:compute/v20220803:GalleryImageVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
