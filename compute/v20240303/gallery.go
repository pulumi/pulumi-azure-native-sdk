...
func NewGallery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20240303:Gallery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGallery(ctx *pulumi.Context,
	...
	var resource Gallery
	err := ctx.ReadResource("azure-native:compute/v20240303:Gallery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
