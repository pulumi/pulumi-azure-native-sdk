...
func NewGalleryInVMAccessControlProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:compute:GalleryInVMAccessControlProfile"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource GalleryInVMAccessControlProfile
	err := ctx.RegisterResource("azure-native:compute/v20240303:GalleryInVMAccessControlProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryInVMAccessControlProfile(ctx *pulumi.Context,
	...
	var resource GalleryInVMAccessControlProfile
	err := ctx.ReadResource("azure-native:compute/v20240303:GalleryInVMAccessControlProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
