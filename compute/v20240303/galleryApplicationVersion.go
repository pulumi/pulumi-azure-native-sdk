...
func NewGalleryApplicationVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:compute/v20240303:GalleryApplicationVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryApplicationVersion(ctx *pulumi.Context,
	...
	var resource GalleryApplicationVersion
	err := ctx.ReadResource("azure-native:compute/v20240303:GalleryApplicationVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
