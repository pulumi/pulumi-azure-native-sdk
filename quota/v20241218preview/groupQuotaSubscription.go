...
func NewGroupQuotaSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:quota/v20241218preview:GroupQuotaSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupQuotaSubscription(ctx *pulumi.Context,
	...
	var resource GroupQuotaSubscription
	err := ctx.ReadResource("azure-native:quota/v20241218preview:GroupQuotaSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
