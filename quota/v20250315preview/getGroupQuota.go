...
func LookupGroupQuota(ctx *pulumi.Context, args *LookupGroupQuotaArgs, opts ...pulumi.InvokeOption) (*LookupGroupQuotaResult, error) {
	...
	err := ctx.Invoke("azure-native:quota/v20250315preview:getGroupQuota", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGroupQuotaOutput(ctx *pulumi.Context, args LookupGroupQuotaOutputArgs, opts ...pulumi.InvokeOption) LookupGroupQuotaResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGroupQuotaResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:quota/v20250315preview:getGroupQuota", args, LookupGroupQuotaResultOutput{}, options).(LookupGroupQuotaResultOutput), nil
