...
func NewGroupQuota(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:quota/v20250315preview:GroupQuota", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupQuota(ctx *pulumi.Context,
	...
	var resource GroupQuota
	err := ctx.ReadResource("azure-native:quota/v20250315preview:GroupQuota", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
