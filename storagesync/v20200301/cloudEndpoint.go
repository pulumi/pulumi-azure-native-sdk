...
//
// Deprecated: azure-native:storagesync/v20200301:CloudEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:CloudEndpoint to guarantee forwards compatibility.
...
func NewCloudEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagesync/v20200301:CloudEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudEndpoint(ctx *pulumi.Context,
	...
	var resource CloudEndpoint
	err := ctx.ReadResource("azure-native:storagesync/v20200301:CloudEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
