...
func NewSyncGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagesync/v20200301:SyncGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSyncGroup(ctx *pulumi.Context,
	...
	var resource SyncGroup
	err := ctx.ReadResource("azure-native:storagesync/v20200301:SyncGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
