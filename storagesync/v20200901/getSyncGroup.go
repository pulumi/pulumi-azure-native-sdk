...
//
// Deprecated: azure-native:storagesync/v20200901:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:SyncGroup to guarantee forwards compatibility.
func LookupSyncGroup(ctx *pulumi.Context, args *LookupSyncGroupArgs, opts ...pulumi.InvokeOption) (*LookupSyncGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:storagesync/v20200901:getSyncGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Unique Id
func (o LookupSyncGroupResultOutput) UniqueId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSyncGroupResult) string { return v.UniqueId }).(pulumi.StringOutput)
}
