...
//
// Deprecated: azure-native:storagesync/v20200901:StorageSyncService is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:StorageSyncService to guarantee forwards compatibility.
...
func NewStorageSyncService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagesync/v20200901:StorageSyncService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageSyncService(ctx *pulumi.Context,
	...
	var resource StorageSyncService
	err := ctx.ReadResource("azure-native:storagesync/v20200901:StorageSyncService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
