...
func NewRegisteredServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagesync/v20181001:RegisteredServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredServer(ctx *pulumi.Context,
	...
	var resource RegisteredServer
	err := ctx.ReadResource("azure-native:storagesync/v20181001:RegisteredServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
