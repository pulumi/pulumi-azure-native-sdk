...
func LookupCloudEndpoint(ctx *pulumi.Context, args *LookupCloudEndpointArgs, opts ...pulumi.InvokeOption) (*LookupCloudEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:storagesync/v20220901:getCloudEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCloudEndpointOutput(ctx *pulumi.Context, args LookupCloudEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupCloudEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCloudEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storagesync/v20220901:getCloudEndpoint", args, LookupCloudEndpointResultOutput{}, options).(LookupCloudEndpointResultOutput), nil
