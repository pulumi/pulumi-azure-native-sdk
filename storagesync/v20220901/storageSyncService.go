...
func NewStorageSyncService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagesync/v20220901:StorageSyncService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageSyncService(ctx *pulumi.Context,
	...
	var resource StorageSyncService
	err := ctx.ReadResource("azure-native:storagesync/v20220901:StorageSyncService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
