...
// FeatureStatusInput is an input type that accepts values of the FeatureStatus enum
// A concrete instance of `FeatureStatusInput` can be one of the following:
//
//	FeatureStatusOn
//	FeatureStatusOff
...
// IncomingTrafficPolicyInput is an input type that accepts values of the IncomingTrafficPolicy enum
// A concrete instance of `IncomingTrafficPolicyInput` can be one of the following:
//
...
// InitialDownloadPolicyInput is an input type that accepts values of the InitialDownloadPolicy enum
// A concrete instance of `InitialDownloadPolicyInput` can be one of the following:
//
...
// InitialUploadPolicyInput is an input type that accepts values of the InitialUploadPolicy enum
// A concrete instance of `InitialUploadPolicyInput` can be one of the following:
//
...
// LocalCacheModeInput is an input type that accepts values of the LocalCacheMode enum
// A concrete instance of `LocalCacheModeInput` can be one of the following:
//
