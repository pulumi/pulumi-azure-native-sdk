...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o RegisteredServerOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *RegisteredServer) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
