...
func NewCloudEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagesync/v20180701:CloudEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudEndpoint(ctx *pulumi.Context,
	...
	var resource CloudEndpoint
	err := ctx.ReadResource("azure-native:storagesync/v20180701:CloudEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
