...
// azure-native:storagesync/v20190601:RegisteredServer is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:RegisteredServer to guarantee forwards compatibility.
...
func NewRegisteredServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagesync/v20190601:RegisteredServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredServer(ctx *pulumi.Context,
	...
	var resource RegisteredServer
	err := ctx.ReadResource("azure-native:storagesync/v20190601:RegisteredServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
