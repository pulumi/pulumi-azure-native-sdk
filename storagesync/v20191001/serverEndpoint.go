...
func NewServerEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagesync/v20191001:ServerEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerEndpoint(ctx *pulumi.Context,
	...
	var resource ServerEndpoint
	err := ctx.ReadResource("azure-native:storagesync/v20191001:ServerEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
