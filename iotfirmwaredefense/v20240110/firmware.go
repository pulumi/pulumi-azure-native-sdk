...
func NewFirmware(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:iotfirmwaredefense/v20240110:Firmware", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirmware(ctx *pulumi.Context,
	...
	var resource Firmware
	err := ctx.ReadResource("azure-native:iotfirmwaredefense/v20240110:Firmware", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
