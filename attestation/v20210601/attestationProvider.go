...
func NewAttestationProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:attestation/v20210601:AttestationProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestationProvider(ctx *pulumi.Context,
	...
	var resource AttestationProvider
	err := ctx.ReadResource("azure-native:attestation/v20210601:AttestationProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
