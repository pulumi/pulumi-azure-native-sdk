...
func NewKubernetesVersions(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:hybridcontainerservice/v20250201preview:KubernetesVersions"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource KubernetesVersions
	err := ctx.RegisterResource("azure-native:hybridcontainerservice:KubernetesVersions", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubernetesVersions(ctx *pulumi.Context,
	...
	var resource KubernetesVersions
	err := ctx.ReadResource("azure-native:hybridcontainerservice:KubernetesVersions", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o KubernetesVersionsOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *KubernetesVersions) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o KubernetesVersionsOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *KubernetesVersions) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
