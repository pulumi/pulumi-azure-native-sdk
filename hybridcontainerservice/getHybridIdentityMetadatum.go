...
func LookupHybridIdentityMetadatumOutput(ctx *pulumi.Context, args LookupHybridIdentityMetadatumOutputArgs, opts ...pulumi.InvokeOption) LookupHybridIdentityMetadatumResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHybridIdentityMetadatumResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridcontainerservice:getHybridIdentityMetadatum", args, LookupHybridIdentityMetadatumResultOutput{}, options).(LookupHybridIdentityMetadatumResultOutput), nil
...
// The system data.
func (o LookupHybridIdentityMetadatumResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupHybridIdentityMetadatumResult) commontypesv2.SystemDataResponse { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
