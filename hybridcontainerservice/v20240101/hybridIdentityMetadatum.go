...
func NewHybridIdentityMetadatum(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcontainerservice/v20240101:HybridIdentityMetadatum", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridIdentityMetadatum(ctx *pulumi.Context,
	...
	var resource HybridIdentityMetadatum
	err := ctx.ReadResource("azure-native:hybridcontainerservice/v20240101:HybridIdentityMetadatum", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
