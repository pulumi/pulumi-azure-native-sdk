...
func NewVMSkus(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:hybridcontainerservice/v20250201preview:VMSkus"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VMSkus
	err := ctx.RegisterResource("azure-native:hybridcontainerservice:VMSkus", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVMSkus(ctx *pulumi.Context,
	...
	var resource VMSkus
	err := ctx.ReadResource("azure-native:hybridcontainerservice:VMSkus", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o VMSkusOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VMSkus) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o VMSkusOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *VMSkus) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
