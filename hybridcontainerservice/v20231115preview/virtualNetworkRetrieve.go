...
func NewVirtualNetworkRetrieve(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcontainerservice/v20231115preview:VirtualNetworkRetrieve", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkRetrieve(ctx *pulumi.Context,
	...
	var resource VirtualNetworkRetrieve
	err := ctx.ReadResource("azure-native:hybridcontainerservice/v20231115preview:VirtualNetworkRetrieve", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
