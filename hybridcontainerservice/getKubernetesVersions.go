...
func LookupKubernetesVersions(ctx *pulumi.Context, args *LookupKubernetesVersionsArgs, opts ...pulumi.InvokeOption) (*LookupKubernetesVersionsResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridcontainerservice:getKubernetesVersions", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupKubernetesVersionsOutput(ctx *pulumi.Context, args LookupKubernetesVersionsOutputArgs, opts ...pulumi.InvokeOption) LookupKubernetesVersionsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupKubernetesVersionsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridcontainerservice:getKubernetesVersions", args, LookupKubernetesVersionsResultOutput{}, options).(LookupKubernetesVersionsResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupKubernetesVersionsResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupKubernetesVersionsResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupKubernetesVersionsResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupKubernetesVersionsResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
