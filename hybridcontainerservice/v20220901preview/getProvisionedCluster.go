...
func LookupProvisionedCluster(ctx *pulumi.Context, args *LookupProvisionedClusterArgs, opts ...pulumi.InvokeOption) (*LookupProvisionedClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridcontainerservice/v20220901preview:getProvisionedCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupProvisionedClusterOutput(ctx *pulumi.Context, args LookupProvisionedClusterOutputArgs, opts ...pulumi.InvokeOption) LookupProvisionedClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupProvisionedClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridcontainerservice/v20220901preview:getProvisionedCluster", args, LookupProvisionedClusterResultOutput{}, options).(LookupProvisionedClusterResultOutput), nil
