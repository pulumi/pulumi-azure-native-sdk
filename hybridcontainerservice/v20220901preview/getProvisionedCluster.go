...
func (o LookupProvisionedClusterResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupProvisionedClusterResult] {
	return pulumix.Output[LookupProvisionedClusterResult]{
