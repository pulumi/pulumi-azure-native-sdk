...
func NewStorageSpaceRetrieve(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridcontainerservice/v20220901preview:storageSpaceRetrieve", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageSpaceRetrieve(ctx *pulumi.Context,
	...
	var resource StorageSpaceRetrieve
	err := ctx.ReadResource("azure-native:hybridcontainerservice/v20220901preview:storageSpaceRetrieve", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
