...
func NewStandbyVirtualMachinePool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:standbypool/v20251001:StandbyVirtualMachinePool"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource StandbyVirtualMachinePool
	err := ctx.RegisterResource("azure-native:standbypool:StandbyVirtualMachinePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStandbyVirtualMachinePool(ctx *pulumi.Context,
	...
	var resource StandbyVirtualMachinePool
	err := ctx.ReadResource("azure-native:standbypool:StandbyVirtualMachinePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o StandbyVirtualMachinePoolOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *StandbyVirtualMachinePool) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
