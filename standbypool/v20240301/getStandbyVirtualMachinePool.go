...
func LookupStandbyVirtualMachinePool(ctx *pulumi.Context, args *LookupStandbyVirtualMachinePoolArgs, opts ...pulumi.InvokeOption) (*LookupStandbyVirtualMachinePoolResult, error) {
	...
	err := ctx.Invoke("azure-native:standbypool/v20240301:getStandbyVirtualMachinePool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStandbyVirtualMachinePoolOutput(ctx *pulumi.Context, args LookupStandbyVirtualMachinePoolOutputArgs, opts ...pulumi.InvokeOption) LookupStandbyVirtualMachinePoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStandbyVirtualMachinePoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:standbypool/v20240301:getStandbyVirtualMachinePool", args, LookupStandbyVirtualMachinePoolResultOutput{}, options).(LookupStandbyVirtualMachinePoolResultOutput), nil
