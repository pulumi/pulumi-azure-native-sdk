...
func NewStandbyVirtualMachinePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:standbypool/v20240301:StandbyVirtualMachinePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStandbyVirtualMachinePool(ctx *pulumi.Context,
	...
	var resource StandbyVirtualMachinePool
	err := ctx.ReadResource("azure-native:standbypool/v20240301:StandbyVirtualMachinePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
