...
func NewStandbyContainerGroupPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:standbypool/v20251001:StandbyContainerGroupPool"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource StandbyContainerGroupPool
	err := ctx.RegisterResource("azure-native:standbypool:StandbyContainerGroupPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStandbyContainerGroupPool(ctx *pulumi.Context,
	...
	var resource StandbyContainerGroupPool
	err := ctx.ReadResource("azure-native:standbypool:StandbyContainerGroupPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o StandbyContainerGroupPoolOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *StandbyContainerGroupPool) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
