...
func NewStandbyContainerGroupPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:standbypool/v20250301:StandbyContainerGroupPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStandbyContainerGroupPool(ctx *pulumi.Context,
	...
	var resource StandbyContainerGroupPool
	err := ctx.ReadResource("azure-native:standbypool/v20250301:StandbyContainerGroupPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies zones of standby container group pools.
func (o StandbyContainerGroupPoolOutput) Zones() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *StandbyContainerGroupPool) pulumi.StringArrayOutput { return v.Zones }).(pulumi.StringArrayOutput)
}
