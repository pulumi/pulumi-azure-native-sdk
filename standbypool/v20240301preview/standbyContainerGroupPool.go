...
func NewStandbyContainerGroupPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:standbypool/v20240301preview:StandbyContainerGroupPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStandbyContainerGroupPool(ctx *pulumi.Context,
	...
	var resource StandbyContainerGroupPool
	err := ctx.ReadResource("azure-native:standbypool/v20240301preview:StandbyContainerGroupPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
