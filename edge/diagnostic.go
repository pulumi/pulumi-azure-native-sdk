...
func NewDiagnostic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:edge/v20250801:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:edge/v20250815preview:Diagnostic"),
		},
		{
			Type: pulumi.String("azure-native:edge/v20260301:Diagnostic"),
		},
	})
