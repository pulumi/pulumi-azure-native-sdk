...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ConfigTemplateOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ConfigTemplate) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
