...
func NewDynamicConfigurationVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:edge/v20250801:DynamicConfigurationVersion"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DynamicConfigurationVersionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DynamicConfigurationVersion) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
