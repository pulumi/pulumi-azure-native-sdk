...
// Error Details if any failure is there
func (o SolutionVersionPropertiesResponseOutput) ErrorDetails() commontypesv5.ErrorDetailResponseOutput {
	return o.ApplyT(func(v SolutionVersionPropertiesResponse) commontypesv5.ErrorDetailResponse { return v.ErrorDetails }).(commontypesv5.ErrorDetailResponseOutput)
}
