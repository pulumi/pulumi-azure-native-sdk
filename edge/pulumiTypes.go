...
// A unique identifier for the config template, generated by the system
func (o ConfigTemplatePropertiesResponseOutput) UniqueIdentifier() pulumi.StringOutput {
	return o.ApplyT(func(v ConfigTemplatePropertiesResponse) string { return v.UniqueIdentifier }).(pulumi.StringOutput)
}
...
type ExecutionV2Properties struct {
...
// ExecutionV2PropertiesInput is an input type that accepts ExecutionV2PropertiesArgs and ExecutionV2PropertiesOutput values.
// You can construct a concrete instance of `ExecutionV2PropertiesInput` via:
//
//	ExecutionV2PropertiesArgs{...}
type ExecutionV2PropertiesInput interface {
	pulumi.Input

	ToExecutionV2PropertiesOutput() ExecutionV2PropertiesOutput
	ToExecutionV2PropertiesOutputWithContext(context.Context) ExecutionV2PropertiesOutput
}

// ExecutionV2 Properties
type ExecutionV2PropertiesArgs struct {
	// ExecutionV2 specification
	Specification pulumi.Input `pulumi:"specification"`
	// Workflow version of ExecutionV2
	WorkflowVersionId pulumi.StringPtrInput `pulumi:"workflowVersionId"`
}

func (ExecutionV2PropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ExecutionV2Properties)(nil)).Elem()
}

func (i ExecutionV2PropertiesArgs) ToExecutionV2PropertiesOutput() ExecutionV2PropertiesOutput {
	return i.ToExecutionV2PropertiesOutputWithContext(context.Background())
}

func (i ExecutionV2PropertiesArgs) ToExecutionV2PropertiesOutputWithContext(ctx context.Context) ExecutionV2PropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExecutionV2PropertiesOutput)
}

func (i ExecutionV2PropertiesArgs) ToExecutionV2PropertiesPtrOutput() ExecutionV2PropertiesPtrOutput {
	return i.ToExecutionV2PropertiesPtrOutputWithContext(context.Background())
}

func (i ExecutionV2PropertiesArgs) ToExecutionV2PropertiesPtrOutputWithContext(ctx context.Context) ExecutionV2PropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExecutionV2PropertiesOutput).ToExecutionV2PropertiesPtrOutputWithContext(ctx)
}

// ExecutionV2PropertiesPtrInput is an input type that accepts ExecutionV2PropertiesArgs, ExecutionV2PropertiesPtr and ExecutionV2PropertiesPtrOutput values.
// You can construct a concrete instance of `ExecutionV2PropertiesPtrInput` via:
//
//	        ExecutionV2PropertiesArgs{...}
//
//	or:
//
//	        nil
type ExecutionV2PropertiesPtrInput interface {
	pulumi.Input

	ToExecutionV2PropertiesPtrOutput() ExecutionV2PropertiesPtrOutput
	ToExecutionV2PropertiesPtrOutputWithContext(context.Context) ExecutionV2PropertiesPtrOutput
}

type executionV2PropertiesPtrType ExecutionV2PropertiesArgs

func ExecutionV2PropertiesPtr(v *ExecutionV2PropertiesArgs) ExecutionV2PropertiesPtrInput {
	return (*executionV2PropertiesPtrType)(v)
}

func (*executionV2PropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ExecutionV2Properties)(nil)).Elem()
}

func (i *executionV2PropertiesPtrType) ToExecutionV2PropertiesPtrOutput() ExecutionV2PropertiesPtrOutput {
	return i.ToExecutionV2PropertiesPtrOutputWithContext(context.Background())
}

func (i *executionV2PropertiesPtrType) ToExecutionV2PropertiesPtrOutputWithContext(ctx context.Context) ExecutionV2PropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExecutionV2PropertiesPtrOutput)
}

// ExecutionV2 Properties
type ExecutionV2PropertiesOutput struct{ *pulumi.OutputState }

func (ExecutionV2PropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ExecutionV2Properties)(nil)).Elem()
}

func (o ExecutionV2PropertiesOutput) ToExecutionV2PropertiesOutput() ExecutionV2PropertiesOutput {
	return o
}

func (o ExecutionV2PropertiesOutput) ToExecutionV2PropertiesOutputWithContext(ctx context.Context) ExecutionV2PropertiesOutput {
	return o
}

func (o ExecutionV2PropertiesOutput) ToExecutionV2PropertiesPtrOutput() ExecutionV2PropertiesPtrOutput {
	return o.ToExecutionV2PropertiesPtrOutputWithContext(context.Background())
}

func (o ExecutionV2PropertiesOutput) ToExecutionV2PropertiesPtrOutputWithContext(ctx context.Context) ExecutionV2PropertiesPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ExecutionV2Properties) *ExecutionV2Properties {
		return &v
	}).(ExecutionV2PropertiesPtrOutput)
}

// ExecutionV2 specification
func (o ExecutionV2PropertiesOutput) Specification() pulumi.AnyOutput {
	return o.ApplyT(func(v ExecutionV2Properties) interface{} { return v.Specification }).(pulumi.AnyOutput)
}

// Workflow version of ExecutionV2
func (o ExecutionV2PropertiesOutput) WorkflowVersionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ExecutionV2Properties) *string { return v.WorkflowVersionId }).(pulumi.StringPtrOutput)
}

type ExecutionV2PropertiesPtrOutput struct{ *pulumi.OutputState }

func (ExecutionV2PropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ExecutionV2Properties)(nil)).Elem()
}

func (o ExecutionV2PropertiesPtrOutput) ToExecutionV2PropertiesPtrOutput() ExecutionV2PropertiesPtrOutput {
	return o
}

func (o ExecutionV2PropertiesPtrOutput) ToExecutionV2PropertiesPtrOutputWithContext(ctx context.Context) ExecutionV2PropertiesPtrOutput {
	return o
}

func (o ExecutionV2PropertiesPtrOutput) Elem() ExecutionV2PropertiesOutput {
	return o.ApplyT(func(v *ExecutionV2Properties) ExecutionV2Properties {
		if v != nil {
			return *v
		}
		var ret ExecutionV2Properties
		return ret
	}).(ExecutionV2PropertiesOutput)
}

// ExecutionV2 specification
func (o ExecutionV2PropertiesPtrOutput) Specification() pulumi.AnyOutput {
	return o.ApplyT(func(v *ExecutionV2Properties) interface{} {
		if v == nil {
			return nil
		}
		return v.Specification
...
// Workflow version of ExecutionV2
func (o ExecutionV2PropertiesPtrOutput) WorkflowVersionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ExecutionV2Properties) *string {
		if v == nil {
			return nil
		}
		return v.WorkflowVersionId
...
// ExecutionV2 Properties
type ExecutionV2PropertiesResponse struct {
	// Provisioning state of resource
	ProvisioningState string `pulumi:"provisioningState"`
	// ExecutionV2 specification
	Specification interface{} `pulumi:"specification"`
	// Status of ExecutionV2
	Status ExecutionV2StatusResponse `pulumi:"status"`
	// Workflow version of ExecutionV2
	WorkflowVersionId *string `pulumi:"workflowVersionId"`
}

// ExecutionV2 Properties
type ExecutionV2PropertiesResponseOutput struct{ *pulumi.OutputState }

func (ExecutionV2PropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ExecutionV2PropertiesResponse)(nil)).Elem()
}

func (o ExecutionV2PropertiesResponseOutput) ToExecutionV2PropertiesResponseOutput() ExecutionV2PropertiesResponseOutput {
	return o
}

func (o ExecutionV2PropertiesResponseOutput) ToExecutionV2PropertiesResponseOutputWithContext(ctx context.Context) ExecutionV2PropertiesResponseOutput {
	return o
}

// Provisioning state of resource
func (o ExecutionV2PropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v ExecutionV2PropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

// ExecutionV2 specification
func (o ExecutionV2PropertiesResponseOutput) Specification() pulumi.AnyOutput {
	return o.ApplyT(func(v ExecutionV2PropertiesResponse) interface{} { return v.Specification }).(pulumi.AnyOutput)
}

// Status of ExecutionV2
func (o ExecutionV2PropertiesResponseOutput) Status() ExecutionV2StatusResponseOutput {
	return o.ApplyT(func(v ExecutionV2PropertiesResponse) ExecutionV2StatusResponse { return v.Status }).(ExecutionV2StatusResponseOutput)
}

// Workflow version of ExecutionV2
func (o ExecutionV2PropertiesResponseOutput) WorkflowVersionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ExecutionV2PropertiesResponse) *string { return v.WorkflowVersionId }).(pulumi.StringPtrOutput)
}

// ExecutionV2 Status
type ExecutionV2StatusResponse struct {
	// target resource statuses
	StageHistory []StageStatusResponse `pulumi:"stageHistory"`
	// Deployment status
	Status *int `pulumi:"status"`
...
// ExecutionV2 Status
type ExecutionV2StatusResponseOutput struct{ *pulumi.OutputState }

func (ExecutionV2StatusResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ExecutionV2StatusResponse)(nil)).Elem()
}

func (o ExecutionV2StatusResponseOutput) ToExecutionV2StatusResponseOutput() ExecutionV2StatusResponseOutput {
	return o
}

func (o ExecutionV2StatusResponseOutput) ToExecutionV2StatusResponseOutputWithContext(ctx context.Context) ExecutionV2StatusResponseOutput {
	return o
}

// target resource statuses
func (o ExecutionV2StatusResponseOutput) StageHistory() StageStatusResponseArrayOutput {
	return o.ApplyT(func(v ExecutionV2StatusResponse) []StageStatusResponse { return v.StageHistory }).(StageStatusResponseArrayOutput)
}

// Deployment status
func (o ExecutionV2StatusResponseOutput) Status() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ExecutionV2StatusResponse) *int { return v.Status }).(pulumi.IntPtrOutput)
}

// status details
func (o ExecutionV2StatusResponseOutput) StatusMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ExecutionV2StatusResponse) *string { return v.StatusMessage }).(pulumi.StringPtrOutput)
}

// The lastModified timestamp of the Status
func (o ExecutionV2StatusResponseOutput) UpdateTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ExecutionV2StatusResponse) *string { return v.UpdateTime }).(pulumi.StringPtrOutput)
}
...
// A unique identifier for the solution template, generated by the system
func (o SolutionTemplatePropertiesResponseOutput) UniqueIdentifier() pulumi.StringOutput {
	return o.ApplyT(func(v SolutionTemplatePropertiesResponse) string { return v.UniqueIdentifier }).(pulumi.StringOutput)
}
...
// Workflow Properties
type WorkflowV2PropertiesResponse struct {
	// Provisioning state of resource
	ProvisioningState string `pulumi:"provisioningState"`
	// Workflow template Id
	WorkflowTemplateId string `pulumi:"workflowTemplateId"`
...
// Workflow Properties
type WorkflowV2PropertiesResponseOutput struct{ *pulumi.OutputState }

func (WorkflowV2PropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkflowV2PropertiesResponse)(nil)).Elem()
}

func (o WorkflowV2PropertiesResponseOutput) ToWorkflowV2PropertiesResponseOutput() WorkflowV2PropertiesResponseOutput {
	return o
}

func (o WorkflowV2PropertiesResponseOutput) ToWorkflowV2PropertiesResponseOutputWithContext(ctx context.Context) WorkflowV2PropertiesResponseOutput {
	return o
}

// Provisioning state of resource
func (o WorkflowV2PropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v WorkflowV2PropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

// Workflow template Id
func (o WorkflowV2PropertiesResponseOutput) WorkflowTemplateId() pulumi.StringOutput {
	return o.ApplyT(func(v WorkflowV2PropertiesResponse) string { return v.WorkflowTemplateId }).(pulumi.StringOutput)
}
...
// Workflow Version Properties
type WorkflowVersionV2Properties struct {
	// Execution specification
	Specification interface{} `pulumi:"specification"`
	// A list of stage specs
	StageSpec []StageSpec `pulumi:"stageSpec"`
...
// WorkflowVersionV2PropertiesInput is an input type that accepts WorkflowVersionV2PropertiesArgs and WorkflowVersionV2PropertiesOutput values.
// You can construct a concrete instance of `WorkflowVersionV2PropertiesInput` via:
//
//	WorkflowVersionV2PropertiesArgs{...}
type WorkflowVersionV2PropertiesInput interface {
	pulumi.Input

	ToWorkflowVersionV2PropertiesOutput() WorkflowVersionV2PropertiesOutput
	ToWorkflowVersionV2PropertiesOutputWithContext(context.Context) WorkflowVersionV2PropertiesOutput
}

// Workflow Version Properties
type WorkflowVersionV2PropertiesArgs struct {
	// Execution specification
	Specification pulumi.Input `pulumi:"specification"`
	// A list of stage specs
	StageSpec StageSpecArrayInput `pulumi:"stageSpec"`
...
func (WorkflowVersionV2PropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkflowVersionV2Properties)(nil)).Elem()
}

func (i WorkflowVersionV2PropertiesArgs) ToWorkflowVersionV2PropertiesOutput() WorkflowVersionV2PropertiesOutput {
	return i.ToWorkflowVersionV2PropertiesOutputWithContext(context.Background())
}

func (i WorkflowVersionV2PropertiesArgs) ToWorkflowVersionV2PropertiesOutputWithContext(ctx context.Context) WorkflowVersionV2PropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(WorkflowVersionV2PropertiesOutput)
}

func (i WorkflowVersionV2PropertiesArgs) ToWorkflowVersionV2PropertiesPtrOutput() WorkflowVersionV2PropertiesPtrOutput {
	return i.ToWorkflowVersionV2PropertiesPtrOutputWithContext(context.Background())
}

func (i WorkflowVersionV2PropertiesArgs) ToWorkflowVersionV2PropertiesPtrOutputWithContext(ctx context.Context) WorkflowVersionV2PropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(WorkflowVersionV2PropertiesOutput).ToWorkflowVersionV2PropertiesPtrOutputWithContext(ctx)
}

// WorkflowVersionV2PropertiesPtrInput is an input type that accepts WorkflowVersionV2PropertiesArgs, WorkflowVersionV2PropertiesPtr and WorkflowVersionV2PropertiesPtrOutput values.
// You can construct a concrete instance of `WorkflowVersionV2PropertiesPtrInput` via:
//
//	        WorkflowVersionV2PropertiesArgs{...}
//
//	or:
//
//	        nil
type WorkflowVersionV2PropertiesPtrInput interface {
	pulumi.Input

	ToWorkflowVersionV2PropertiesPtrOutput() WorkflowVersionV2PropertiesPtrOutput
	ToWorkflowVersionV2PropertiesPtrOutputWithContext(context.Context) WorkflowVersionV2PropertiesPtrOutput
}

type workflowVersionV2PropertiesPtrType WorkflowVersionV2PropertiesArgs

func WorkflowVersionV2PropertiesPtr(v *WorkflowVersionV2PropertiesArgs) WorkflowVersionV2PropertiesPtrInput {
	return (*workflowVersionV2PropertiesPtrType)(v)
}

func (*workflowVersionV2PropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**WorkflowVersionV2Properties)(nil)).Elem()
}

func (i *workflowVersionV2PropertiesPtrType) ToWorkflowVersionV2PropertiesPtrOutput() WorkflowVersionV2PropertiesPtrOutput {
	return i.ToWorkflowVersionV2PropertiesPtrOutputWithContext(context.Background())
}

func (i *workflowVersionV2PropertiesPtrType) ToWorkflowVersionV2PropertiesPtrOutputWithContext(ctx context.Context) WorkflowVersionV2PropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(WorkflowVersionV2PropertiesPtrOutput)
}

// Workflow Version Properties
type WorkflowVersionV2PropertiesOutput struct{ *pulumi.OutputState }

func (WorkflowVersionV2PropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkflowVersionV2Properties)(nil)).Elem()
}

func (o WorkflowVersionV2PropertiesOutput) ToWorkflowVersionV2PropertiesOutput() WorkflowVersionV2PropertiesOutput {
	return o
}

func (o WorkflowVersionV2PropertiesOutput) ToWorkflowVersionV2PropertiesOutputWithContext(ctx context.Context) WorkflowVersionV2PropertiesOutput {
	return o
}

func (o WorkflowVersionV2PropertiesOutput) ToWorkflowVersionV2PropertiesPtrOutput() WorkflowVersionV2PropertiesPtrOutput {
	return o.ToWorkflowVersionV2PropertiesPtrOutputWithContext(context.Background())
}

func (o WorkflowVersionV2PropertiesOutput) ToWorkflowVersionV2PropertiesPtrOutputWithContext(ctx context.Context) WorkflowVersionV2PropertiesPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v WorkflowVersionV2Properties) *WorkflowVersionV2Properties {
		return &v
	}).(WorkflowVersionV2PropertiesPtrOutput)
}

// Execution specification
func (o WorkflowVersionV2PropertiesOutput) Specification() pulumi.AnyOutput {
	return o.ApplyT(func(v WorkflowVersionV2Properties) interface{} { return v.Specification }).(pulumi.AnyOutput)
}

// A list of stage specs
func (o WorkflowVersionV2PropertiesOutput) StageSpec() StageSpecArrayOutput {
	return o.ApplyT(func(v WorkflowVersionV2Properties) []StageSpec { return v.StageSpec }).(StageSpecArrayOutput)
}

type WorkflowVersionV2PropertiesPtrOutput struct{ *pulumi.OutputState }

func (WorkflowVersionV2PropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**WorkflowVersionV2Properties)(nil)).Elem()
}

func (o WorkflowVersionV2PropertiesPtrOutput) ToWorkflowVersionV2PropertiesPtrOutput() WorkflowVersionV2PropertiesPtrOutput {
	return o
}

func (o WorkflowVersionV2PropertiesPtrOutput) ToWorkflowVersionV2PropertiesPtrOutputWithContext(ctx context.Context) WorkflowVersionV2PropertiesPtrOutput {
	return o
}

func (o WorkflowVersionV2PropertiesPtrOutput) Elem() WorkflowVersionV2PropertiesOutput {
	return o.ApplyT(func(v *WorkflowVersionV2Properties) WorkflowVersionV2Properties {
		if v != nil {
			return *v
		}
		var ret WorkflowVersionV2Properties
		return ret
	}).(WorkflowVersionV2PropertiesOutput)
}

// Execution specification
func (o WorkflowVersionV2PropertiesPtrOutput) Specification() pulumi.AnyOutput {
	return o.ApplyT(func(v *WorkflowVersionV2Properties) interface{} {
		if v == nil {
			return nil
		}
		return v.Specification
...
// A list of stage specs
func (o WorkflowVersionV2PropertiesPtrOutput) StageSpec() StageSpecArrayOutput {
	return o.ApplyT(func(v *WorkflowVersionV2Properties) []StageSpec {
		if v == nil {
			return nil
		}
		return v.StageSpec
...
// Workflow Version Properties
type WorkflowVersionV2PropertiesResponse struct {
	// Resolved configuration values
	Configuration string `pulumi:"configuration"`
	// Provisioning state of resource
	ProvisioningState string `pulumi:"provisioningState"`
...
// Workflow Version Properties
type WorkflowVersionV2PropertiesResponseOutput struct{ *pulumi.OutputState }

func (WorkflowVersionV2PropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkflowVersionV2PropertiesResponse)(nil)).Elem()
}

func (o WorkflowVersionV2PropertiesResponseOutput) ToWorkflowVersionV2PropertiesResponseOutput() WorkflowVersionV2PropertiesResponseOutput {
	return o
}

func (o WorkflowVersionV2PropertiesResponseOutput) ToWorkflowVersionV2PropertiesResponseOutputWithContext(ctx context.Context) WorkflowVersionV2PropertiesResponseOutput {
	return o
}

// Resolved configuration values
func (o WorkflowVersionV2PropertiesResponseOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v WorkflowVersionV2PropertiesResponse) string { return v.Configuration }).(pulumi.StringOutput)
}

// Provisioning state of resource
func (o WorkflowVersionV2PropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v WorkflowVersionV2PropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

// Review id of resolved config for this workflow version
func (o WorkflowVersionV2PropertiesResponseOutput) ReviewId() pulumi.StringOutput {
	return o.ApplyT(func(v WorkflowVersionV2PropertiesResponse) string { return v.ReviewId }).(pulumi.StringOutput)
}

// Revision number of resolved config for this workflow version
func (o WorkflowVersionV2PropertiesResponseOutput) Revision() pulumi.IntOutput {
	return o.ApplyT(func(v WorkflowVersionV2PropertiesResponse) int { return v.Revision }).(pulumi.IntOutput)
}

// Execution specification
func (o WorkflowVersionV2PropertiesResponseOutput) Specification() pulumi.AnyOutput {
	return o.ApplyT(func(v WorkflowVersionV2PropertiesResponse) interface{} { return v.Specification }).(pulumi.AnyOutput)
}

// A list of stage specs
func (o WorkflowVersionV2PropertiesResponseOutput) StageSpec() StageSpecResponseArrayOutput {
	return o.ApplyT(func(v WorkflowVersionV2PropertiesResponse) []StageSpecResponse { return v.StageSpec }).(StageSpecResponseArrayOutput)
}

// State of workflow version
func (o WorkflowVersionV2PropertiesResponseOutput) State() pulumi.StringOutput {
	return o.ApplyT(func(v WorkflowVersionV2PropertiesResponse) string { return v.State }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ExecutionV2PropertiesOutput{})
	pulumi.RegisterOutputType(ExecutionV2PropertiesPtrOutput{})
	pulumi.RegisterOutputType(ExecutionV2PropertiesResponseOutput{})
	pulumi.RegisterOutputType(ExecutionV2StatusResponseOutput{})
	...
	pulumi.RegisterOutputType(WorkflowV2PropertiesResponseOutput{})
	...
	pulumi.RegisterOutputType(WorkflowVersionV2PropertiesOutput{})
	pulumi.RegisterOutputType(WorkflowVersionV2PropertiesPtrOutput{})
	pulumi.RegisterOutputType(WorkflowVersionV2PropertiesResponseOutput{})
}
