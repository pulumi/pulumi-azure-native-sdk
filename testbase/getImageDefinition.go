...
func LookupImageDefinition(ctx *pulumi.Context, args *LookupImageDefinitionArgs, opts ...pulumi.InvokeOption) (*LookupImageDefinitionResult, error) {
	...
	err := ctx.Invoke("azure-native:testbase:getImageDefinition", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupImageDefinitionOutput(ctx *pulumi.Context, args LookupImageDefinitionOutputArgs, opts ...pulumi.InvokeOption) LookupImageDefinitionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupImageDefinitionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:testbase:getImageDefinition", args, LookupImageDefinitionResultOutput{}, options).(LookupImageDefinitionResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupImageDefinitionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupImageDefinitionResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
