...
func NewImageDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:testbase/v20231101preview:ImageDefinition"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ImageDefinition
	err := ctx.RegisterResource("azure-native:testbase:ImageDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageDefinition(ctx *pulumi.Context,
	...
	var resource ImageDefinition
	err := ctx.ReadResource("azure-native:testbase:ImageDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ImageDefinitionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ImageDefinition) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
