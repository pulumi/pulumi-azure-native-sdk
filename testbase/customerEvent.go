...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CustomerEventOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *CustomerEvent) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
