...
func GetBillingHubServiceUsage(ctx *pulumi.Context, args *GetBillingHubServiceUsageArgs, opts ...pulumi.InvokeOption) (*GetBillingHubServiceUsageResult, error) {
	...
	err := ctx.Invoke("azure-native:testbase/v20231101preview:getBillingHubServiceUsage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetBillingHubServiceUsageOutput(ctx *pulumi.Context, args GetBillingHubServiceUsageOutputArgs, opts ...pulumi.InvokeOption) GetBillingHubServiceUsageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetBillingHubServiceUsageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:testbase/v20231101preview:getBillingHubServiceUsage", args, GetBillingHubServiceUsageResultOutput{}, options).(GetBillingHubServiceUsageResultOutput), nil
