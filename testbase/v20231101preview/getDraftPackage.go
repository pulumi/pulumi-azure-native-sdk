...
func LookupDraftPackage(ctx *pulumi.Context, args *LookupDraftPackageArgs, opts ...pulumi.InvokeOption) (*LookupDraftPackageResult, error) {
	...
	err := ctx.Invoke("azure-native:testbase/v20231101preview:getDraftPackage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDraftPackageOutput(ctx *pulumi.Context, args LookupDraftPackageOutputArgs, opts ...pulumi.InvokeOption) LookupDraftPackageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDraftPackageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:testbase/v20231101preview:getDraftPackage", args, LookupDraftPackageResultOutput{}, options).(LookupDraftPackageResultOutput), nil
