...
func NewCustomImage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:testbase:CustomImage"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CustomImage
	err := ctx.RegisterResource("azure-native:testbase/v20231101preview:CustomImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomImage(ctx *pulumi.Context,
	...
	var resource CustomImage
	err := ctx.ReadResource("azure-native:testbase/v20231101preview:CustomImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
