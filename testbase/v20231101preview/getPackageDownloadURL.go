...
func GetPackageDownloadURL(ctx *pulumi.Context, args *GetPackageDownloadURLArgs, opts ...pulumi.InvokeOption) (*GetPackageDownloadURLResult, error) {
	...
	err := ctx.Invoke("azure-native:testbase/v20231101preview:getPackageDownloadURL", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetPackageDownloadURLOutput(ctx *pulumi.Context, args GetPackageDownloadURLOutputArgs, opts ...pulumi.InvokeOption) GetPackageDownloadURLResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetPackageDownloadURLResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:testbase/v20231101preview:getPackageDownloadURL", args, GetPackageDownloadURLResultOutput{}, options).(GetPackageDownloadURLResultOutput), nil
