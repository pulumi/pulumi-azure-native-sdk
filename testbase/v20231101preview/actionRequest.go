...
func NewActionRequest(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:testbase:ActionRequest"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ActionRequest
	err := ctx.RegisterResource("azure-native:testbase/v20231101preview:ActionRequest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActionRequest(ctx *pulumi.Context,
	...
	var resource ActionRequest
	err := ctx.ReadResource("azure-native:testbase/v20231101preview:ActionRequest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
