...
func NewTestBaseAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:testbase/v20231101preview:TestBaseAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTestBaseAccount(ctx *pulumi.Context,
	...
	var resource TestBaseAccount
	err := ctx.ReadResource("azure-native:testbase/v20231101preview:TestBaseAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
