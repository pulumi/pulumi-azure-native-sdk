...
func NewCredential(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:testbase:Credential"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Credential
	err := ctx.RegisterResource("azure-native:testbase/v20231101preview:Credential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCredential(ctx *pulumi.Context,
	...
	var resource Credential
	err := ctx.ReadResource("azure-native:testbase/v20231101preview:Credential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
