...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o FavoriteProcessOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *FavoriteProcess) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
