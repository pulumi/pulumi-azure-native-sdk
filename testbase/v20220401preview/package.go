...
func NewPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:testbase/v20220401preview:Package", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPackage(ctx *pulumi.Context,
	...
	var resource Package
	err := ctx.ReadResource("azure-native:testbase/v20220401preview:Package", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
