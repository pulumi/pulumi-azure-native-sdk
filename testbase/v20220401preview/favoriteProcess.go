...
func NewFavoriteProcess(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:testbase/v20220401preview:FavoriteProcess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFavoriteProcess(ctx *pulumi.Context,
	...
	var resource FavoriteProcess
	err := ctx.ReadResource("azure-native:testbase/v20220401preview:FavoriteProcess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
