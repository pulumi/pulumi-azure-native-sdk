...
func NewCustomerEvent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:testbase/v20220401preview:CustomerEvent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomerEvent(ctx *pulumi.Context,
	...
	var resource CustomerEvent
	err := ctx.ReadResource("azure-native:testbase/v20220401preview:CustomerEvent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
