...
//
// Deprecated: azure-native:cache/v20221101preview:RedisEnterprise is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.
...
func NewRedisEnterprise(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cache/v20221101preview:RedisEnterprise", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedisEnterprise(ctx *pulumi.Context,
	...
	var resource RedisEnterprise
	err := ctx.ReadResource("azure-native:cache/v20221101preview:RedisEnterprise", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
