...
//
// Deprecated: azure-native:cache/v20220601:Redis is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:Redis to guarantee forwards compatibility.
type Redis struct {
...
func NewRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.RegisterResource("azure-native:cache/v20220601:Redis", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.ReadResource("azure-native:cache/v20220601:Redis", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
