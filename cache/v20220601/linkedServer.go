...
func NewLinkedServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cache/v20220601:LinkedServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedServer(ctx *pulumi.Context,
	...
	var resource LinkedServer
	err := ctx.ReadResource("azure-native:cache/v20220601:LinkedServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
