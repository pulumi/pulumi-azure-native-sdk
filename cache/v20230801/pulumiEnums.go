...
func (in *updateChannelPtr) ToOutput(ctx context.Context) pulumix.Output[*UpdateChannel] {
	return pulumix.Output[*UpdateChannel]{
		OutputState: in.ToUpdateChannelPtrOutputWithContext(ctx).OutputState,
	}
}
