...
//
// Deprecated: azure-native:cache/v20201201:LinkedServer is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:LinkedServer to guarantee forwards compatibility.
...
func NewLinkedServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cache/v20201201:LinkedServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedServer(ctx *pulumi.Context,
	...
	var resource LinkedServer
	err := ctx.ReadResource("azure-native:cache/v20201201:LinkedServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
