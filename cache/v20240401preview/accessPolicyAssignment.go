...
func NewAccessPolicyAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cache/v20240401preview:AccessPolicyAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessPolicyAssignment(ctx *pulumi.Context,
	...
	var resource AccessPolicyAssignment
	err := ctx.ReadResource("azure-native:cache/v20240401preview:AccessPolicyAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
