...
func NewPatchSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cache/v20240301:PatchSchedule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cache/v20240401preview:PatchSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPatchSchedule(ctx *pulumi.Context,
	...
	var resource PatchSchedule
	err := ctx.ReadResource("azure-native:cache/v20240401preview:PatchSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
