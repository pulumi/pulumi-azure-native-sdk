...
func LookupRedisEnterprise(ctx *pulumi.Context, args *LookupRedisEnterpriseArgs, opts ...pulumi.InvokeOption) (*LookupRedisEnterpriseResult, error) {
	...
	err := ctx.Invoke("azure-native:cache/v20241001:getRedisEnterprise", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRedisEnterpriseOutput(ctx *pulumi.Context, args LookupRedisEnterpriseOutputArgs, opts ...pulumi.InvokeOption) LookupRedisEnterpriseResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRedisEnterpriseResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cache/v20241001:getRedisEnterprise", args, LookupRedisEnterpriseResultOutput{}, options).(LookupRedisEnterpriseResultOutput), nil
