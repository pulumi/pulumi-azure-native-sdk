...
// AofFrequencyInput is an input type that accepts values of the AofFrequency enum
// A concrete instance of `AofFrequencyInput` can be one of the following:
//
//	AofFrequency_1s
//	AofFrequencyAlways
...
// ClusteringPolicyInput is an input type that accepts values of the ClusteringPolicy enum
// A concrete instance of `ClusteringPolicyInput` can be one of the following:
//
...
func (DeferUpgradeSetting) ElementType() reflect.Type {
	return reflect.TypeOf((*DeferUpgradeSetting)(nil)).Elem()
}

func (e DeferUpgradeSetting) ToDeferUpgradeSettingOutput() DeferUpgradeSettingOutput {
	return pulumi.ToOutput(e).(DeferUpgradeSettingOutput)
}

func (e DeferUpgradeSetting) ToDeferUpgradeSettingOutputWithContext(ctx context.Context) DeferUpgradeSettingOutput {
	return pulumi.ToOutputWithContext(ctx, e).(DeferUpgradeSettingOutput)
}

func (e DeferUpgradeSetting) ToDeferUpgradeSettingPtrOutput() DeferUpgradeSettingPtrOutput {
	return e.ToDeferUpgradeSettingPtrOutputWithContext(context.Background())
}

func (e DeferUpgradeSetting) ToDeferUpgradeSettingPtrOutputWithContext(ctx context.Context) DeferUpgradeSettingPtrOutput {
	return DeferUpgradeSetting(e).ToDeferUpgradeSettingOutputWithContext(ctx).ToDeferUpgradeSettingPtrOutputWithContext(ctx)
}

func (e DeferUpgradeSetting) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e DeferUpgradeSetting) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e DeferUpgradeSetting) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e DeferUpgradeSetting) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type DeferUpgradeSettingOutput struct{ *pulumi.OutputState }

func (DeferUpgradeSettingOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DeferUpgradeSetting)(nil)).Elem()
}

func (o DeferUpgradeSettingOutput) ToDeferUpgradeSettingOutput() DeferUpgradeSettingOutput {
	return o
}

func (o DeferUpgradeSettingOutput) ToDeferUpgradeSettingOutputWithContext(ctx context.Context) DeferUpgradeSettingOutput {
	return o
}

func (o DeferUpgradeSettingOutput) ToDeferUpgradeSettingPtrOutput() DeferUpgradeSettingPtrOutput {
	return o.ToDeferUpgradeSettingPtrOutputWithContext(context.Background())
}

func (o DeferUpgradeSettingOutput) ToDeferUpgradeSettingPtrOutputWithContext(ctx context.Context) DeferUpgradeSettingPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v DeferUpgradeSetting) *DeferUpgradeSetting {
		return &v
	}).(DeferUpgradeSettingPtrOutput)
}

func (o DeferUpgradeSettingOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o DeferUpgradeSettingOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DeferUpgradeSetting) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o DeferUpgradeSettingOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DeferUpgradeSettingOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DeferUpgradeSetting) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type DeferUpgradeSettingPtrOutput struct{ *pulumi.OutputState }

func (DeferUpgradeSettingPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DeferUpgradeSetting)(nil)).Elem()
}

func (o DeferUpgradeSettingPtrOutput) ToDeferUpgradeSettingPtrOutput() DeferUpgradeSettingPtrOutput {
	return o
}

func (o DeferUpgradeSettingPtrOutput) ToDeferUpgradeSettingPtrOutputWithContext(ctx context.Context) DeferUpgradeSettingPtrOutput {
	return o
}

func (o DeferUpgradeSettingPtrOutput) Elem() DeferUpgradeSettingOutput {
	return o.ApplyT(func(v *DeferUpgradeSetting) DeferUpgradeSetting {
		if v != nil {
			return *v
		}
		var ret DeferUpgradeSetting
		return ret
	}).(DeferUpgradeSettingOutput)
}

func (o DeferUpgradeSettingPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DeferUpgradeSettingPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *DeferUpgradeSetting) *string {
		if e == nil {
			return nil
		}
...
// DeferUpgradeSettingInput is an input type that accepts values of the DeferUpgradeSetting enum
// A concrete instance of `DeferUpgradeSettingInput` can be one of the following:
//
//	DeferUpgradeSettingDeferred
//	DeferUpgradeSettingNotDeferred
type DeferUpgradeSettingInput interface {
	pulumi.Input

	ToDeferUpgradeSettingOutput() DeferUpgradeSettingOutput
	ToDeferUpgradeSettingOutputWithContext(context.Context) DeferUpgradeSettingOutput
}

var deferUpgradeSettingPtrType = reflect.TypeOf((**DeferUpgradeSetting)(nil)).Elem()

type DeferUpgradeSettingPtrInput interface {
	pulumi.Input

	ToDeferUpgradeSettingPtrOutput() DeferUpgradeSettingPtrOutput
	ToDeferUpgradeSettingPtrOutputWithContext(context.Context) DeferUpgradeSettingPtrOutput
}

type deferUpgradeSettingPtr string

func DeferUpgradeSettingPtr(v string) DeferUpgradeSettingPtrInput {
	return (*deferUpgradeSettingPtr)(&v)
}

func (*deferUpgradeSettingPtr) ElementType() reflect.Type {
	return deferUpgradeSettingPtrType
}

func (in *deferUpgradeSettingPtr) ToDeferUpgradeSettingPtrOutput() DeferUpgradeSettingPtrOutput {
	return pulumi.ToOutput(in).(DeferUpgradeSettingPtrOutput)
}

func (in *deferUpgradeSettingPtr) ToDeferUpgradeSettingPtrOutputWithContext(ctx context.Context) DeferUpgradeSettingPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(DeferUpgradeSettingPtrOutput)
}
...
// RdbFrequencyInput is an input type that accepts values of the RdbFrequency enum
// A concrete instance of `RdbFrequencyInput` can be one of the following:
//
//	RdbFrequency_1h
//	RdbFrequency_6h
//	RdbFrequency_12h
...
func init() {
	...
	pulumi.RegisterOutputType(DeferUpgradeSettingOutput{})
