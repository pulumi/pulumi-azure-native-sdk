...
func NewAccessPolicyAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cache/v20250401:AccessPolicyAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessPolicyAssignment(ctx *pulumi.Context,
	...
	var resource AccessPolicyAssignment
	err := ctx.ReadResource("azure-native:cache/v20250401:AccessPolicyAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
