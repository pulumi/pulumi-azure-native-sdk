...
func NewPatchSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cache/v20200601:PatchSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPatchSchedule(ctx *pulumi.Context,
	...
	var resource PatchSchedule
	err := ctx.ReadResource("azure-native:cache/v20200601:PatchSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
