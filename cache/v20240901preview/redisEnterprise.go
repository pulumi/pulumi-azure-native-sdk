...
func NewRedisEnterprise(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cache/v20240901preview:RedisEnterprise", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedisEnterprise(ctx *pulumi.Context,
	...
	var resource RedisEnterprise
	err := ctx.ReadResource("azure-native:cache/v20240901preview:RedisEnterprise", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
