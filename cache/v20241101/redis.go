...
func NewRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.RegisterResource("azure-native:cache/v20241101:Redis", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.ReadResource("azure-native:cache/v20241101:Redis", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
