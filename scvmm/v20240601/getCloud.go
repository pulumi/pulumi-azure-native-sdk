...
func LookupCloud(ctx *pulumi.Context, args *LookupCloudArgs, opts ...pulumi.InvokeOption) (*LookupCloudResult, error) {
	...
	err := ctx.Invoke("azure-native:scvmm/v20240601:getCloud", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCloudOutput(ctx *pulumi.Context, args LookupCloudOutputArgs, opts ...pulumi.InvokeOption) LookupCloudResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCloudResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:scvmm/v20240601:getCloud", args, LookupCloudResultOutput{}, options).(LookupCloudResultOutput), nil
