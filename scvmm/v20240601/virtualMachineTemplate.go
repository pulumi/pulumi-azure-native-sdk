...
func NewVirtualMachineTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20240601:VirtualMachineTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineTemplate(ctx *pulumi.Context,
	...
	var resource VirtualMachineTemplate
	err := ctx.ReadResource("azure-native:scvmm/v20240601:VirtualMachineTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
