...
func NewVmmServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20240601:VmmServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmmServer(ctx *pulumi.Context,
	...
	var resource VmmServer
	err := ctx.ReadResource("azure-native:scvmm/v20240601:VmmServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
