...
func NewCloud(ctx *pulumi.Context,
	...
	var resource Cloud
	err := ctx.RegisterResource("azure-native:scvmm/v20240601:Cloud", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloud(ctx *pulumi.Context,
	...
	var resource Cloud
	err := ctx.ReadResource("azure-native:scvmm/v20240601:Cloud", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
