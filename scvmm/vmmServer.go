...
func NewVmmServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm:VmmServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmmServer(ctx *pulumi.Context,
	...
	var resource VmmServer
	err := ctx.ReadResource("azure-native:scvmm:VmmServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The system data.
func (o VmmServerOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *VmmServer) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
