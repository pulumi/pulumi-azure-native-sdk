...
func LookupGuestAgent(ctx *pulumi.Context, args *LookupGuestAgentArgs, opts ...pulumi.InvokeOption) (*LookupGuestAgentResult, error) {
	...
	err := ctx.Invoke("azure-native:scvmm/v20220521preview:getGuestAgent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGuestAgentOutput(ctx *pulumi.Context, args LookupGuestAgentOutputArgs, opts ...pulumi.InvokeOption) LookupGuestAgentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGuestAgentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:scvmm/v20220521preview:getGuestAgent", args, LookupGuestAgentResultOutput{}, options).(LookupGuestAgentResultOutput), nil
