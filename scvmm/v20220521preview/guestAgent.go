...
func NewGuestAgent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20220521preview:GuestAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestAgent(ctx *pulumi.Context,
	...
	var resource GuestAgent
	err := ctx.ReadResource("azure-native:scvmm/v20220521preview:GuestAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
