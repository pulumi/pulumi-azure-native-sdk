...
func LookupHybridIdentityMetadata(ctx *pulumi.Context, args *LookupHybridIdentityMetadataArgs, opts ...pulumi.InvokeOption) (*LookupHybridIdentityMetadataResult, error) {
	...
	err := ctx.Invoke("azure-native:scvmm/v20220521preview:getHybridIdentityMetadata", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHybridIdentityMetadataOutput(ctx *pulumi.Context, args LookupHybridIdentityMetadataOutputArgs, opts ...pulumi.InvokeOption) LookupHybridIdentityMetadataResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHybridIdentityMetadataResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:scvmm/v20220521preview:getHybridIdentityMetadata", args, LookupHybridIdentityMetadataResultOutput{}, options).(LookupHybridIdentityMetadataResultOutput), nil
