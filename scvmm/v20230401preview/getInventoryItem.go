...
func LookupInventoryItem(ctx *pulumi.Context, args *LookupInventoryItemArgs, opts ...pulumi.InvokeOption) (*LookupInventoryItemResult, error) {
	...
	err := ctx.Invoke("azure-native:scvmm/v20230401preview:getInventoryItem", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupInventoryItemOutput(ctx *pulumi.Context, args LookupInventoryItemOutputArgs, opts ...pulumi.InvokeOption) LookupInventoryItemResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupInventoryItemResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:scvmm/v20230401preview:getInventoryItem", args, LookupInventoryItemResultOutput{}, options).(LookupInventoryItemResultOutput), nil
