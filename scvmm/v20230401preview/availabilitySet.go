...
func NewAvailabilitySet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20230401preview:AvailabilitySet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAvailabilitySet(ctx *pulumi.Context,
	...
	var resource AvailabilitySet
	err := ctx.ReadResource("azure-native:scvmm/v20230401preview:AvailabilitySet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
