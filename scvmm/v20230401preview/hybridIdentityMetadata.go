...
func NewHybridIdentityMetadata(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20230401preview:HybridIdentityMetadata", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridIdentityMetadata(ctx *pulumi.Context,
	...
	var resource HybridIdentityMetadata
	err := ctx.ReadResource("azure-native:scvmm/v20230401preview:HybridIdentityMetadata", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
