...
func NewVirtualMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20230401preview:VirtualMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachine(ctx *pulumi.Context,
	...
	var resource VirtualMachine
	err := ctx.ReadResource("azure-native:scvmm/v20230401preview:VirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
