...
func NewGuestAgent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20231007:GuestAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestAgent(ctx *pulumi.Context,
	...
	var resource GuestAgent
	err := ctx.ReadResource("azure-native:scvmm/v20231007:GuestAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
