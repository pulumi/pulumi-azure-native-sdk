...
func NewVirtualMachineInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20231007:VirtualMachineInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineInstance(ctx *pulumi.Context,
	...
	var resource VirtualMachineInstance
	err := ctx.ReadResource("azure-native:scvmm/v20231007:VirtualMachineInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
