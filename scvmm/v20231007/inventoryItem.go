...
func NewInventoryItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scvmm/v20231007:InventoryItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInventoryItem(ctx *pulumi.Context,
	...
	var resource InventoryItem
	err := ctx.ReadResource("azure-native:scvmm/v20231007:InventoryItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type inventoryItemArgs struct {
	...
	InventoryItemResourceName *string `pulumi:"inventoryItemResourceName"`
	// They inventory type.
...
type InventoryItemArgs struct {
	// Name of the inventoryItem.
	InventoryItemResourceName pulumi.StringPtrInput
	// They inventory type.
