...
//
// Deprecated: azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachine to guarantee forwards compatibility.
...
func NewSqlVirtualMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlVirtualMachine(ctx *pulumi.Context,
	...
	var resource SqlVirtualMachine
	err := ctx.ReadResource("azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
