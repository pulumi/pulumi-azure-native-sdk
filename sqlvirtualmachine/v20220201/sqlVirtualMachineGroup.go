...
//
// Deprecated: azure-native:sqlvirtualmachine/v20220201:SqlVirtualMachineGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup to guarantee forwards compatibility.
...
func NewSqlVirtualMachineGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sqlvirtualmachine/v20220201:SqlVirtualMachineGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlVirtualMachineGroup(ctx *pulumi.Context,
	...
	var resource SqlVirtualMachineGroup
	err := ctx.ReadResource("azure-native:sqlvirtualmachine/v20220201:SqlVirtualMachineGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
