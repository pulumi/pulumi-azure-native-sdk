...
func NewAvailabilityGroupListener(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sqlvirtualmachine:AvailabilityGroupListener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAvailabilityGroupListener(ctx *pulumi.Context,
	...
	var resource AvailabilityGroupListener
	err := ctx.ReadResource("azure-native:sqlvirtualmachine:AvailabilityGroupListener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AvailabilityGroupListenerOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *AvailabilityGroupListener) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
