...
func NewAvailabilityGroupListener(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sqlvirtualmachine/v20220701preview:AvailabilityGroupListener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAvailabilityGroupListener(ctx *pulumi.Context,
	...
	var resource AvailabilityGroupListener
	err := ctx.ReadResource("azure-native:sqlvirtualmachine/v20220701preview:AvailabilityGroupListener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
