...
func NewSqlVirtualMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlVirtualMachine(ctx *pulumi.Context,
	...
	var resource SqlVirtualMachine
	err := ctx.ReadResource("azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
