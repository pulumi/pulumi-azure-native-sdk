...
func NewSqlVirtualMachineGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlVirtualMachineGroup(ctx *pulumi.Context,
	...
	var resource SqlVirtualMachineGroup
	err := ctx.ReadResource("azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
