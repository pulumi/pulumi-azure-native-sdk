...
func LookupSqlVirtualMachineGroup(ctx *pulumi.Context, args *LookupSqlVirtualMachineGroupArgs, opts ...pulumi.InvokeOption) (*LookupSqlVirtualMachineGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:sqlvirtualmachine/v20230101preview:getSqlVirtualMachineGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSqlVirtualMachineGroupOutput(ctx *pulumi.Context, args LookupSqlVirtualMachineGroupOutputArgs, opts ...pulumi.InvokeOption) LookupSqlVirtualMachineGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSqlVirtualMachineGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:sqlvirtualmachine/v20230101preview:getSqlVirtualMachineGroup", args, LookupSqlVirtualMachineGroupResultOutput{}, options).(LookupSqlVirtualMachineGroupResultOutput), nil
