...
func (in *additionalVmPatchPtr) ToOutput(ctx context.Context) pulumix.Output[*AdditionalVmPatch] {
	return pulumix.Output[*AdditionalVmPatch]{
		OutputState: in.ToAdditionalVmPatchPtrOutputWithContext(ctx).OutputState,
	}
}
...
func (in *leastPrivilegeModePtr) ToOutput(ctx context.Context) pulumix.Output[*LeastPrivilegeMode] {
	return pulumix.Output[*LeastPrivilegeMode]{
		OutputState: in.ToLeastPrivilegeModePtrOutputWithContext(ctx).OutputState,
	}
}
