...
func NewAuthority(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:verifiedid:Authority"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Authority
	err := ctx.RegisterResource("azure-native:verifiedid/v20240126preview:Authority", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthority(ctx *pulumi.Context,
	...
	var resource Authority
	err := ctx.ReadResource("azure-native:verifiedid/v20240126preview:Authority", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
