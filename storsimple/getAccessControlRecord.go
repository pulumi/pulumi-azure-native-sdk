...
func (o LookupAccessControlRecordResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAccessControlRecordResult] {
	return pulumix.Output[LookupAccessControlRecordResult]{
