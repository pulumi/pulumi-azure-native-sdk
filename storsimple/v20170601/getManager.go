...
func LookupManager(ctx *pulumi.Context, args *LookupManagerArgs, opts ...pulumi.InvokeOption) (*LookupManagerResult, error) {
	...
	err := ctx.Invoke("azure-native:storsimple/v20170601:getManager", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagerOutput(ctx *pulumi.Context, args LookupManagerOutputArgs, opts ...pulumi.InvokeOption) LookupManagerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storsimple/v20170601:getManager", args, LookupManagerResultOutput{}, options).(LookupManagerResultOutput), nil
