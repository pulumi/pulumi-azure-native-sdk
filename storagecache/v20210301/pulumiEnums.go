...
// ProvisioningStateTypeInput is an input type that accepts values of the ProvisioningStateType enum
// A concrete instance of `ProvisioningStateTypeInput` can be one of the following:
//
