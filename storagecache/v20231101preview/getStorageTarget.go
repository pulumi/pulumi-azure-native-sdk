...
func LookupStorageTarget(ctx *pulumi.Context, args *LookupStorageTargetArgs, opts ...pulumi.InvokeOption) (*LookupStorageTargetResult, error) {
	...
	err := ctx.Invoke("azure-native:storagecache/v20231101preview:getStorageTarget", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStorageTargetOutput(ctx *pulumi.Context, args LookupStorageTargetOutputArgs, opts ...pulumi.InvokeOption) LookupStorageTargetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStorageTargetResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storagecache/v20231101preview:getStorageTarget", args, LookupStorageTargetResultOutput{}, options).(LookupStorageTargetResultOutput), nil
