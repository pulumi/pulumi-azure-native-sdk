...
func NewCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.RegisterResource("azure-native:storagecache/v20231101preview:Cache", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCache(ctx *pulumi.Context,
	...
	var resource Cache
	err := ctx.ReadResource("azure-native:storagecache/v20231101preview:Cache", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
