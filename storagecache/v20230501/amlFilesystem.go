...
func NewAmlFilesystem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagecache/v20230501:AmlFilesystem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAmlFilesystem(ctx *pulumi.Context,
	...
	var resource AmlFilesystem
	err := ctx.ReadResource("azure-native:storagecache/v20230501:AmlFilesystem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
