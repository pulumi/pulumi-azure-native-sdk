...
func LookupCache(ctx *pulumi.Context, args *LookupCacheArgs, opts ...pulumi.InvokeOption) (*LookupCacheResult, error) {
	...
	err := ctx.Invoke("azure-native:storagecache/v20230301preview:getCache", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupCacheOutput(ctx *pulumi.Context, args LookupCacheOutputArgs, opts ...pulumi.InvokeOption) LookupCacheResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCacheResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storagecache/v20230301preview:getCache", args, LookupCacheResultOutput{}, options).(LookupCacheResultOutput), nil
...
// Multiplier that sets the current storage and throughput capacity of the cache. Values depend on the cache SKU - <a href="https://learn.microsoft.com/en-us/rest/api/storagecache/skus/list?tabs=HTTP">List SKUs</a>. Values above 1.0 increase the cache size and throughput - for example, the scaling factor 1.33 gives a cache that's 33% larger than its base size.
func (o LookupCacheResultOutput) ScalingFactor() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v LookupCacheResult) *float64 { return v.ScalingFactor }).(pulumi.Float64PtrOutput)
}
