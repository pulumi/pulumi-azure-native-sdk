...
type AmlFilesystem struct {
	...
	LustreVersion pulumi.StringOutput `pulumi:"lustreVersion"`
	...
	MountCommand pulumi.StringOutput `pulumi:"mountCommand"`
...
// The version of Lustre running in the AML file system
func (o AmlFilesystemOutput) LustreVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AmlFilesystem) pulumi.StringOutput { return v.LustreVersion }).(pulumi.StringOutput)
}
...
// The IPv4 address used by clients to mount the AML file system's Lustre Management Service (MGS).
func (o AmlFilesystemOutput) MgsAddress() pulumi.StringOutput {
	return o.ApplyT(func(v *AmlFilesystem) pulumi.StringOutput { return v.MgsAddress }).(pulumi.StringOutput)
}

// Recommended command to mount the AML file system
func (o AmlFilesystemOutput) MountCommand() pulumi.StringOutput {
	return o.ApplyT(func(v *AmlFilesystem) pulumi.StringOutput { return v.MountCommand }).(pulumi.StringOutput)
}
