...
func NewImportJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagecache/v20240701:ImportJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportJob(ctx *pulumi.Context,
	...
	var resource ImportJob
	err := ctx.ReadResource("azure-native:storagecache/v20240701:ImportJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// New or modified directories that have been imported into the filesystem.
func (o ImportJobOutput) ImportedDirectories() pulumi.Float64Output {
	return o.ApplyT(func(v *ImportJob) pulumi.Float64Output { return v.ImportedDirectories }).(pulumi.Float64Output)
}

// New or modified files that have been imported into the filesystem.
func (o ImportJobOutput) ImportedFiles() pulumi.Float64Output {
	return o.ApplyT(func(v *ImportJob) pulumi.Float64Output { return v.ImportedFiles }).(pulumi.Float64Output)
}

// Newly added symbolic links into the filesystem.
func (o ImportJobOutput) ImportedSymlinks() pulumi.Float64Output {
	return o.ApplyT(func(v *ImportJob) pulumi.Float64Output { return v.ImportedSymlinks }).(pulumi.Float64Output)
}
...
// Directories that already exist in the filesystem and have not been modified.
func (o ImportJobOutput) PreexistingDirectories() pulumi.Float64Output {
	return o.ApplyT(func(v *ImportJob) pulumi.Float64Output { return v.PreexistingDirectories }).(pulumi.Float64Output)
}

// Files that already exist in the filesystem and have not been modified.
func (o ImportJobOutput) PreexistingFiles() pulumi.Float64Output {
	return o.ApplyT(func(v *ImportJob) pulumi.Float64Output { return v.PreexistingFiles }).(pulumi.Float64Output)
}

// Symbolic links that already exist in the filesystem and have not been modified.
func (o ImportJobOutput) PreexistingSymlinks() pulumi.Float64Output {
	return o.ApplyT(func(v *ImportJob) pulumi.Float64Output { return v.PreexistingSymlinks }).(pulumi.Float64Output)
}
