...
func (ImportJobAdminStatus) ElementType() reflect.Type {
	return reflect.TypeOf((*ImportJobAdminStatus)(nil)).Elem()
}

func (e ImportJobAdminStatus) ToImportJobAdminStatusOutput() ImportJobAdminStatusOutput {
	return pulumi.ToOutput(e).(ImportJobAdminStatusOutput)
}

func (e ImportJobAdminStatus) ToImportJobAdminStatusOutputWithContext(ctx context.Context) ImportJobAdminStatusOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ImportJobAdminStatusOutput)
}

func (e ImportJobAdminStatus) ToImportJobAdminStatusPtrOutput() ImportJobAdminStatusPtrOutput {
	return e.ToImportJobAdminStatusPtrOutputWithContext(context.Background())
}

func (e ImportJobAdminStatus) ToImportJobAdminStatusPtrOutputWithContext(ctx context.Context) ImportJobAdminStatusPtrOutput {
	return ImportJobAdminStatus(e).ToImportJobAdminStatusOutputWithContext(ctx).ToImportJobAdminStatusPtrOutputWithContext(ctx)
}

func (e ImportJobAdminStatus) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ImportJobAdminStatus) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ImportJobAdminStatus) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ImportJobAdminStatus) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type ImportJobAdminStatusOutput struct{ *pulumi.OutputState }

func (ImportJobAdminStatusOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ImportJobAdminStatus)(nil)).Elem()
}

func (o ImportJobAdminStatusOutput) ToImportJobAdminStatusOutput() ImportJobAdminStatusOutput {
	return o
}

func (o ImportJobAdminStatusOutput) ToImportJobAdminStatusOutputWithContext(ctx context.Context) ImportJobAdminStatusOutput {
	return o
}

func (o ImportJobAdminStatusOutput) ToImportJobAdminStatusPtrOutput() ImportJobAdminStatusPtrOutput {
	return o.ToImportJobAdminStatusPtrOutputWithContext(context.Background())
}

func (o ImportJobAdminStatusOutput) ToImportJobAdminStatusPtrOutputWithContext(ctx context.Context) ImportJobAdminStatusPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ImportJobAdminStatus) *ImportJobAdminStatus {
		return &v
	}).(ImportJobAdminStatusPtrOutput)
}

func (o ImportJobAdminStatusOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ImportJobAdminStatusOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ImportJobAdminStatus) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ImportJobAdminStatusOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ImportJobAdminStatusOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ImportJobAdminStatus) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type ImportJobAdminStatusPtrOutput struct{ *pulumi.OutputState }

func (ImportJobAdminStatusPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ImportJobAdminStatus)(nil)).Elem()
}

func (o ImportJobAdminStatusPtrOutput) ToImportJobAdminStatusPtrOutput() ImportJobAdminStatusPtrOutput {
	return o
}

func (o ImportJobAdminStatusPtrOutput) ToImportJobAdminStatusPtrOutputWithContext(ctx context.Context) ImportJobAdminStatusPtrOutput {
	return o
}

func (o ImportJobAdminStatusPtrOutput) Elem() ImportJobAdminStatusOutput {
	return o.ApplyT(func(v *ImportJobAdminStatus) ImportJobAdminStatus {
		if v != nil {
			return *v
		}
		var ret ImportJobAdminStatus
		return ret
	}).(ImportJobAdminStatusOutput)
}

func (o ImportJobAdminStatusPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ImportJobAdminStatusPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ImportJobAdminStatus) *string {
		if e == nil {
			return nil
		}
...
// ImportJobAdminStatusInput is an input type that accepts values of the ImportJobAdminStatus enum
// A concrete instance of `ImportJobAdminStatusInput` can be one of the following:
//
//	ImportJobAdminStatusActive
//	ImportJobAdminStatusCancel
type ImportJobAdminStatusInput interface {
	pulumi.Input

	ToImportJobAdminStatusOutput() ImportJobAdminStatusOutput
	ToImportJobAdminStatusOutputWithContext(context.Context) ImportJobAdminStatusOutput
}

var importJobAdminStatusPtrType = reflect.TypeOf((**ImportJobAdminStatus)(nil)).Elem()

type ImportJobAdminStatusPtrInput interface {
	pulumi.Input

	ToImportJobAdminStatusPtrOutput() ImportJobAdminStatusPtrOutput
	ToImportJobAdminStatusPtrOutputWithContext(context.Context) ImportJobAdminStatusPtrOutput
}

type importJobAdminStatusPtr string

func ImportJobAdminStatusPtr(v string) ImportJobAdminStatusPtrInput {
	return (*importJobAdminStatusPtr)(&v)
}

func (*importJobAdminStatusPtr) ElementType() reflect.Type {
	return importJobAdminStatusPtrType
}

func (in *importJobAdminStatusPtr) ToImportJobAdminStatusPtrOutput() ImportJobAdminStatusPtrOutput {
	return pulumi.ToOutput(in).(ImportJobAdminStatusPtrOutput)
}

func (in *importJobAdminStatusPtr) ToImportJobAdminStatusPtrOutputWithContext(ctx context.Context) ImportJobAdminStatusPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ImportJobAdminStatusPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ImportJobAdminStatusOutput{})
	pulumi.RegisterOutputType(ImportJobAdminStatusPtrOutput{})
