...
func GetRequiredAmlFSSubnetsSize(ctx *pulumi.Context, args *GetRequiredAmlFSSubnetsSizeArgs, opts ...pulumi.InvokeOption) (*GetRequiredAmlFSSubnetsSizeResult, error) {
	...
	err := ctx.Invoke("azure-native:storagecache/v20240701:getRequiredAmlFSSubnetsSize", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetRequiredAmlFSSubnetsSizeOutput(ctx *pulumi.Context, args GetRequiredAmlFSSubnetsSizeOutputArgs, opts ...pulumi.InvokeOption) GetRequiredAmlFSSubnetsSizeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetRequiredAmlFSSubnetsSizeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storagecache/v20240701:getRequiredAmlFSSubnetsSize", args, GetRequiredAmlFSSubnetsSizeResultOutput{}, options).(GetRequiredAmlFSSubnetsSizeResultOutput), nil
