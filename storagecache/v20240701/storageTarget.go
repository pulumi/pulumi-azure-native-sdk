...
func NewStorageTarget(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagecache/v20240701:StorageTarget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageTarget(ctx *pulumi.Context,
	...
	var resource StorageTarget
	err := ctx.ReadResource("azure-native:storagecache/v20240701:StorageTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
