...
func NewStorageTarget(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storagecache/v20250701:StorageTarget"),
		},
		{
			Type: pulumi.String("azure-native:storagecache/v20260101:StorageTarget"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource StorageTarget
	err := ctx.RegisterResource("azure-native:storagecache:StorageTarget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageTarget(ctx *pulumi.Context,
	...
	var resource StorageTarget
	err := ctx.ReadResource("azure-native:storagecache:StorageTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The system meta data relating to this resource.
func (o StorageTargetOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *StorageTarget) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
