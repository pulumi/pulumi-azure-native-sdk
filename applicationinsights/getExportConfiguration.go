...
func LookupExportConfiguration(ctx *pulumi.Context, args *LookupExportConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupExportConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:applicationinsights:getExportConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupExportConfigurationOutput(ctx *pulumi.Context, args LookupExportConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupExportConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupExportConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:applicationinsights:getExportConfiguration", args, LookupExportConfigurationResultOutput{}, options).(LookupExportConfigurationResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupExportConfigurationResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupExportConfigurationResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
