...
func LookupAnalyticsItem(ctx *pulumi.Context, args *LookupAnalyticsItemArgs, opts ...pulumi.InvokeOption) (*LookupAnalyticsItemResult, error) {
	...
	err := ctx.Invoke("azure-native:applicationinsights:getAnalyticsItem", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAnalyticsItemOutput(ctx *pulumi.Context, args LookupAnalyticsItemOutputArgs, opts ...pulumi.InvokeOption) LookupAnalyticsItemResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAnalyticsItemResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:applicationinsights:getAnalyticsItem", args, LookupAnalyticsItemResultOutput{}, options).(LookupAnalyticsItemResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupAnalyticsItemResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAnalyticsItemResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
