...
func NewComponent(ctx *pulumi.Context,
	...
	if args.PublicNetworkAccessForIngestion == nil {
		args.PublicNetworkAccessForIngestion = pulumi.StringPtr("Enabled")
	}
	if args.PublicNetworkAccessForQuery == nil {
		args.PublicNetworkAccessForQuery = pulumi.StringPtr("Enabled")
	}
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20150501:Component"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20180501preview:Component"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20200202:Component"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20200202preview:Component"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:Component", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponent(ctx *pulumi.Context,
	...
	var resource Component
	err := ctx.ReadResource("azure-native:applicationinsights:Component", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ComponentOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Component) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
