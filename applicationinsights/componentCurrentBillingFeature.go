...
func NewComponentCurrentBillingFeature(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20150501:ComponentCurrentBillingFeature"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:ComponentCurrentBillingFeature", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponentCurrentBillingFeature(ctx *pulumi.Context,
	...
	var resource ComponentCurrentBillingFeature
	err := ctx.ReadResource("azure-native:applicationinsights:ComponentCurrentBillingFeature", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ComponentCurrentBillingFeatureOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ComponentCurrentBillingFeature) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
