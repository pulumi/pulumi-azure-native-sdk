...
func NewAnalyticsItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20150501:AnalyticsItem"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:AnalyticsItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnalyticsItem(ctx *pulumi.Context,
	...
	var resource AnalyticsItem
	err := ctx.ReadResource("azure-native:applicationinsights:AnalyticsItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o AnalyticsItemOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AnalyticsItem) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
