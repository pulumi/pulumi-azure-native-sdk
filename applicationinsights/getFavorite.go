...
func LookupFavorite(ctx *pulumi.Context, args *LookupFavoriteArgs, opts ...pulumi.InvokeOption) (*LookupFavoriteResult, error) {
	...
	err := ctx.Invoke("azure-native:applicationinsights:getFavorite", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupFavoriteOutput(ctx *pulumi.Context, args LookupFavoriteOutputArgs, opts ...pulumi.InvokeOption) LookupFavoriteResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFavoriteResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:applicationinsights:getFavorite", args, LookupFavoriteResultOutput{}, options).(LookupFavoriteResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupFavoriteResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFavoriteResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
