...
// Metadata pertaining to creation and last modification of the resource.
func (o MyWorkbookOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *MyWorkbook) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
