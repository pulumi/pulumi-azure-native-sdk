...
func LookupWorkbook(ctx *pulumi.Context, args *LookupWorkbookArgs, opts ...pulumi.InvokeOption) (*LookupWorkbookResult, error) {
	...
	err := ctx.Invoke("azure-native:applicationinsights:getWorkbook", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupWorkbookResult struct {
	...
	Identity *WorkbookResourceIdentityResponse `pulumi:"identity"`
...
func LookupWorkbookOutput(ctx *pulumi.Context, args LookupWorkbookOutputArgs, opts ...pulumi.InvokeOption) LookupWorkbookResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkbookResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:applicationinsights:getWorkbook", args, LookupWorkbookResultOutput{}, options).(LookupWorkbookResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupWorkbookResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWorkbookResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Identity used for BYOS
func (o LookupWorkbookResultOutput) Identity() WorkbookResourceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupWorkbookResult) *WorkbookResourceIdentityResponse { return v.Identity }).(WorkbookResourceIdentityResponsePtrOutput)
}
