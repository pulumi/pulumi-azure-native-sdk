...
func LookupMyWorkbook(ctx *pulumi.Context, args *LookupMyWorkbookArgs, opts ...pulumi.InvokeOption) (*LookupMyWorkbookResult, error) {
	...
	err := ctx.Invoke("azure-native:applicationinsights:getMyWorkbook", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMyWorkbookOutput(ctx *pulumi.Context, args LookupMyWorkbookOutputArgs, opts ...pulumi.InvokeOption) LookupMyWorkbookResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMyWorkbookResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:applicationinsights:getMyWorkbook", args, LookupMyWorkbookResultOutput{}, options).(LookupMyWorkbookResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupMyWorkbookResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupMyWorkbookResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Metadata pertaining to creation and last modification of the resource.
func (o LookupMyWorkbookResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupMyWorkbookResult) commontypesv2.SystemDataResponse { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
