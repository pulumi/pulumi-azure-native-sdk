...
func LookupComponent(ctx *pulumi.Context, args *LookupComponentArgs, opts ...pulumi.InvokeOption) (*LookupComponentResult, error) {
	...
	err := ctx.Invoke("azure-native:applicationinsights:getComponent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (val *LookupComponentResult) Defaults() *LookupComponentResult {
	...
	if tmp.PublicNetworkAccessForIngestion == nil {
		publicNetworkAccessForIngestion_ := "Enabled"
		tmp.PublicNetworkAccessForIngestion = &publicNetworkAccessForIngestion_
	}
	if tmp.PublicNetworkAccessForQuery == nil {
		publicNetworkAccessForQuery_ := "Enabled"
		tmp.PublicNetworkAccessForQuery = &publicNetworkAccessForQuery_
	}
...
func LookupComponentOutput(ctx *pulumi.Context, args LookupComponentOutputArgs, opts ...pulumi.InvokeOption) LookupComponentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupComponentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:applicationinsights:getComponent", args, LookupComponentResultOutput{}, options).(LookupComponentResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupComponentResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupComponentResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
