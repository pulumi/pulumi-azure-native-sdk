...
func NewWorkbookTemplate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20191017preview:WorkbookTemplate"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20201120:WorkbookTemplate"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:WorkbookTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkbookTemplate(ctx *pulumi.Context,
	...
	var resource WorkbookTemplate
	err := ctx.ReadResource("azure-native:applicationinsights:WorkbookTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WorkbookTemplateOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkbookTemplate) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WorkbookTemplateOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WorkbookTemplate) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
