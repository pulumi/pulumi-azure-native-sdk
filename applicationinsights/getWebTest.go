...
func LookupWebTest(ctx *pulumi.Context, args *LookupWebTestArgs, opts ...pulumi.InvokeOption) (*LookupWebTestResult, error) {
	...
	err := ctx.Invoke("azure-native:applicationinsights:getWebTest", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupWebTestResult struct {
	...
	Configuration *WebTestPropertiesConfigurationResponse `pulumi:"configuration"`
	...
	Request *WebTestPropertiesRequestResponse `pulumi:"request"`
	...
	ValidationRules *WebTestPropertiesValidationRulesResponse `pulumi:"validationRules"`
...
func LookupWebTestOutput(ctx *pulumi.Context, args LookupWebTestOutputArgs, opts ...pulumi.InvokeOption) LookupWebTestResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebTestResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:applicationinsights:getWebTest", args, LookupWebTestResultOutput{}, options).(LookupWebTestResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupWebTestResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWebTestResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}

// An XML configuration specification for a WebTest.
func (o LookupWebTestResultOutput) Configuration() WebTestPropertiesConfigurationResponsePtrOutput {
	return o.ApplyT(func(v LookupWebTestResult) *WebTestPropertiesConfigurationResponse { return v.Configuration }).(WebTestPropertiesConfigurationResponsePtrOutput)
}
...
// The collection of request properties
func (o LookupWebTestResultOutput) Request() WebTestPropertiesRequestResponsePtrOutput {
	return o.ApplyT(func(v LookupWebTestResult) *WebTestPropertiesRequestResponse { return v.Request }).(WebTestPropertiesRequestResponsePtrOutput)
}
...
// The collection of validation rule properties
func (o LookupWebTestResultOutput) ValidationRules() WebTestPropertiesValidationRulesResponsePtrOutput {
	return o.ApplyT(func(v LookupWebTestResult) *WebTestPropertiesValidationRulesResponse { return v.ValidationRules }).(WebTestPropertiesValidationRulesResponsePtrOutput)
}
