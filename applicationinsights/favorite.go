...
func NewFavorite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20150501:Favorite"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:Favorite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFavorite(ctx *pulumi.Context,
	...
	var resource Favorite
	err := ctx.ReadResource("azure-native:applicationinsights:Favorite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o FavoriteOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Favorite) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
