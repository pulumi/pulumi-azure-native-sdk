...
func LookupComponentLinkedStorageAccount(ctx *pulumi.Context, args *LookupComponentLinkedStorageAccountArgs, opts ...pulumi.InvokeOption) (*LookupComponentLinkedStorageAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:applicationinsights:getComponentLinkedStorageAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupComponentLinkedStorageAccountOutput(ctx *pulumi.Context, args LookupComponentLinkedStorageAccountOutputArgs, opts ...pulumi.InvokeOption) LookupComponentLinkedStorageAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupComponentLinkedStorageAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:applicationinsights:getComponentLinkedStorageAccount", args, LookupComponentLinkedStorageAccountResultOutput{}, options).(LookupComponentLinkedStorageAccountResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupComponentLinkedStorageAccountResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupComponentLinkedStorageAccountResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupComponentLinkedStorageAccountResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupComponentLinkedStorageAccountResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
