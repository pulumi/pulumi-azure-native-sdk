...
type Workbook struct {
	...
	Identity WorkbookResourceIdentityResponsePtrOutput `pulumi:"identity"`
...
func NewWorkbook(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20150501:Workbook"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20180617preview:Workbook"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20201020:Workbook"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20210308:Workbook"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20210801:Workbook"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20220401:Workbook"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20230601:Workbook"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:Workbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkbook(ctx *pulumi.Context,
	...
	var resource Workbook
	err := ctx.ReadResource("azure-native:applicationinsights:Workbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WorkbookOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Workbook) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Identity used for BYOS
func (o WorkbookOutput) Identity() WorkbookResourceIdentityResponsePtrOutput {
	return o.ApplyT(func(v *Workbook) WorkbookResourceIdentityResponsePtrOutput { return v.Identity }).(WorkbookResourceIdentityResponsePtrOutput)
}
