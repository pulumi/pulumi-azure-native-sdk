...
type WebTest struct {
	...
	Configuration WebTestPropertiesConfigurationResponsePtrOutput `pulumi:"configuration"`
	...
	Request WebTestPropertiesRequestResponsePtrOutput `pulumi:"request"`
	...
	ValidationRules WebTestPropertiesValidationRulesResponsePtrOutput `pulumi:"validationRules"`
...
func NewWebTest(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20150501:WebTest"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20180501preview:WebTest"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20201005preview:WebTest"),
		},
		{
			Type: pulumi.String("azure-native:applicationinsights/v20220615:WebTest"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:WebTest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebTest(ctx *pulumi.Context,
	...
	var resource WebTest
	err := ctx.ReadResource("azure-native:applicationinsights:WebTest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebTestOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebTest) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}

// An XML configuration specification for a WebTest.
func (o WebTestOutput) Configuration() WebTestPropertiesConfigurationResponsePtrOutput {
	return o.ApplyT(func(v *WebTest) WebTestPropertiesConfigurationResponsePtrOutput { return v.Configuration }).(WebTestPropertiesConfigurationResponsePtrOutput)
}
...
// The collection of request properties
func (o WebTestOutput) Request() WebTestPropertiesRequestResponsePtrOutput {
	return o.ApplyT(func(v *WebTest) WebTestPropertiesRequestResponsePtrOutput { return v.Request }).(WebTestPropertiesRequestResponsePtrOutput)
}
...
// The collection of validation rule properties
func (o WebTestOutput) ValidationRules() WebTestPropertiesValidationRulesResponsePtrOutput {
	return o.ApplyT(func(v *WebTest) WebTestPropertiesValidationRulesResponsePtrOutput { return v.ValidationRules }).(WebTestPropertiesValidationRulesResponsePtrOutput)
}
