...
func NewComponentLinkedStorageAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20200301preview:ComponentLinkedStorageAccount"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:ComponentLinkedStorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComponentLinkedStorageAccount(ctx *pulumi.Context,
	...
	var resource ComponentLinkedStorageAccount
	err := ctx.ReadResource("azure-native:applicationinsights:ComponentLinkedStorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ComponentLinkedStorageAccountOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ComponentLinkedStorageAccount) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ComponentLinkedStorageAccountOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *ComponentLinkedStorageAccount) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
