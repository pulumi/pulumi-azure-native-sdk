...
func NewExportConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:applicationinsights/v20150501:ExportConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:applicationinsights:ExportConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExportConfiguration(ctx *pulumi.Context,
	...
	var resource ExportConfiguration
	err := ctx.ReadResource("azure-native:applicationinsights:ExportConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ExportConfigurationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ExportConfiguration) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
