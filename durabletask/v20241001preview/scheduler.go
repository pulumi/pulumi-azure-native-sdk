...
func NewScheduler(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:durabletask:Scheduler"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Scheduler
	err := ctx.RegisterResource("azure-native:durabletask/v20241001preview:Scheduler", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduler(ctx *pulumi.Context,
	...
	var resource Scheduler
	err := ctx.ReadResource("azure-native:durabletask/v20241001preview:Scheduler", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
