...
func NewTaskHub(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:durabletask:TaskHub"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TaskHub
	err := ctx.RegisterResource("azure-native:durabletask/v20241001preview:TaskHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaskHub(ctx *pulumi.Context,
	...
	var resource TaskHub
	err := ctx.ReadResource("azure-native:durabletask/v20241001preview:TaskHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
