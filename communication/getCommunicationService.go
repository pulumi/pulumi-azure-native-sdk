...
func LookupCommunicationServiceOutput(ctx *pulumi.Context, args LookupCommunicationServiceOutputArgs, opts ...pulumi.InvokeOption) LookupCommunicationServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCommunicationServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:communication:getCommunicationService", args, LookupCommunicationServiceResultOutput{}, options).(LookupCommunicationServiceResultOutput), nil
...
// Managed service identity (system assigned and/or user assigned identities)
func (o LookupCommunicationServiceResultOutput) Identity() commontypesv5.ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupCommunicationServiceResult) *commontypesv5.ManagedServiceIdentityResponse {
		return v.Identity
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupCommunicationServiceResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupCommunicationServiceResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
