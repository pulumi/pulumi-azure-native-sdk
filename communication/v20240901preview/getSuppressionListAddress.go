...
func LookupSuppressionListAddress(ctx *pulumi.Context, args *LookupSuppressionListAddressArgs, opts ...pulumi.InvokeOption) (*LookupSuppressionListAddressResult, error) {
	...
	err := ctx.Invoke("azure-native:communication/v20240901preview:getSuppressionListAddress", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSuppressionListAddressOutput(ctx *pulumi.Context, args LookupSuppressionListAddressOutputArgs, opts ...pulumi.InvokeOption) LookupSuppressionListAddressResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSuppressionListAddressResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:communication/v20240901preview:getSuppressionListAddress", args, LookupSuppressionListAddressResultOutput{}, options).(LookupSuppressionListAddressResultOutput), nil
