...
func LookupSenderUsername(ctx *pulumi.Context, args *LookupSenderUsernameArgs, opts ...pulumi.InvokeOption) (*LookupSenderUsernameResult, error) {
	...
	err := ctx.Invoke("azure-native:communication/v20240901preview:getSenderUsername", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSenderUsernameOutput(ctx *pulumi.Context, args LookupSenderUsernameOutputArgs, opts ...pulumi.InvokeOption) LookupSenderUsernameResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSenderUsernameResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:communication/v20240901preview:getSenderUsername", args, LookupSenderUsernameResultOutput{}, options).(LookupSenderUsernameResultOutput), nil
