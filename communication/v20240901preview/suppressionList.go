...
func NewSuppressionList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:communication/v20240901preview:SuppressionList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSuppressionList(ctx *pulumi.Context,
	...
	var resource SuppressionList
	err := ctx.ReadResource("azure-native:communication/v20240901preview:SuppressionList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
