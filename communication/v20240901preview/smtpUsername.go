...
func NewSmtpUsername(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:communication/v20240901preview:SmtpUsername", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSmtpUsername(ctx *pulumi.Context,
	...
	var resource SmtpUsername
	err := ctx.ReadResource("azure-native:communication/v20240901preview:SmtpUsername", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
