...
func ListCommunicationServiceKeys(ctx *pulumi.Context, args *ListCommunicationServiceKeysArgs, opts ...pulumi.InvokeOption) (*ListCommunicationServiceKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:communication/v20240901preview:listCommunicationServiceKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListCommunicationServiceKeysOutput(ctx *pulumi.Context, args ListCommunicationServiceKeysOutputArgs, opts ...pulumi.InvokeOption) ListCommunicationServiceKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListCommunicationServiceKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:communication/v20240901preview:listCommunicationServiceKeys", args, ListCommunicationServiceKeysResultOutput{}, options).(ListCommunicationServiceKeysResultOutput), nil
