...
func NewSuppressionListAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:communication/v20240901preview:SuppressionListAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSuppressionListAddress(ctx *pulumi.Context,
	...
	var resource SuppressionListAddress
	err := ctx.ReadResource("azure-native:communication/v20240901preview:SuppressionListAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
