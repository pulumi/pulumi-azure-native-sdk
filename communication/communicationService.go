...
func NewCommunicationService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:communication/v20250901:CommunicationService"),
		},
		{
			Type: pulumi.String("azure-native:communication/v20260318:CommunicationService"),
		},
	})
