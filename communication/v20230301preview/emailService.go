...
func NewEmailService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:communication/v20230301preview:EmailService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmailService(ctx *pulumi.Context,
	...
	var resource EmailService
	err := ctx.ReadResource("azure-native:communication/v20230301preview:EmailService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
