...
func LookupEmailService(ctx *pulumi.Context, args *LookupEmailServiceArgs, opts ...pulumi.InvokeOption) (*LookupEmailServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:communication/v20230401preview:getEmailService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEmailServiceOutput(ctx *pulumi.Context, args LookupEmailServiceOutputArgs, opts ...pulumi.InvokeOption) LookupEmailServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEmailServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:communication/v20230401preview:getEmailService", args, LookupEmailServiceResultOutput{}, options).(LookupEmailServiceResultOutput), nil
