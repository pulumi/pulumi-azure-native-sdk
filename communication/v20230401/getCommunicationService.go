...
func LookupCommunicationService(ctx *pulumi.Context, args *LookupCommunicationServiceArgs, opts ...pulumi.InvokeOption) (*LookupCommunicationServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:communication/v20230401:getCommunicationService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCommunicationServiceOutput(ctx *pulumi.Context, args LookupCommunicationServiceOutputArgs, opts ...pulumi.InvokeOption) LookupCommunicationServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCommunicationServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:communication/v20230401:getCommunicationService", args, LookupCommunicationServiceResultOutput{}, options).(LookupCommunicationServiceResultOutput), nil
