...
func NewCommunicationService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:communication/v20230601preview:CommunicationService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCommunicationService(ctx *pulumi.Context,
	...
	var resource CommunicationService
	err := ctx.ReadResource("azure-native:communication/v20230601preview:CommunicationService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
