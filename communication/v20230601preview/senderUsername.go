...
func NewSenderUsername(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:communication/v20230601preview:SenderUsername", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSenderUsername(ctx *pulumi.Context,
	...
	var resource SenderUsername
	err := ctx.ReadResource("azure-native:communication/v20230601preview:SenderUsername", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
