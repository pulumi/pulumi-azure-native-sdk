...
//
// Deprecated: azure-native:communication/v20211001preview:EmailService is being removed in the next major version of this provider. Upgrade to at least azure-native:communication/v20230401preview:EmailService to guarantee forwards compatibility.
func LookupEmailService(ctx *pulumi.Context, args *LookupEmailServiceArgs, opts ...pulumi.InvokeOption) (*LookupEmailServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:communication/v20211001preview:getEmailService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
