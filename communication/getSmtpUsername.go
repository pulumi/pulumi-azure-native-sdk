...
func LookupSmtpUsername(ctx *pulumi.Context, args *LookupSmtpUsernameArgs, opts ...pulumi.InvokeOption) (*LookupSmtpUsernameResult, error) {
	...
	err := ctx.Invoke("azure-native:communication:getSmtpUsername", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSmtpUsernameOutput(ctx *pulumi.Context, args LookupSmtpUsernameOutputArgs, opts ...pulumi.InvokeOption) LookupSmtpUsernameResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSmtpUsernameResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:communication:getSmtpUsername", args, LookupSmtpUsernameResultOutput{}, options).(LookupSmtpUsernameResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSmtpUsernameResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSmtpUsernameResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSmtpUsernameResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSmtpUsernameResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
