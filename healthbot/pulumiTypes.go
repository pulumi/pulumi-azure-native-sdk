...
func (HealthBotKeyResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HealthBotKeyResponse)(nil)).Elem()
}
...
func (o HealthBotKeyResponseOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v HealthBotKeyResponse) *string { return v.Value }).(pulumi.StringPtrOutput)
}
...
func (o HealthBotKeyResponseArrayOutput) Index(i pulumi.IntInput) HealthBotKeyResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) HealthBotKeyResponse {
		return vs[0].([]HealthBotKeyResponse)[vs[1].(int)]
	}).(HealthBotKeyResponseOutput)
}
...
func init() {
	pulumi.RegisterOutputType(HealthBotKeyResponseOutput{})
	pulumi.RegisterOutputType(HealthBotKeyResponseArrayOutput{})
