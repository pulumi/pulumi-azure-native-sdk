...
func NewBot(ctx *pulumi.Context,
	...
	var resource Bot
	err := ctx.RegisterResource("azure-native:healthbot/v20220808:Bot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBot(ctx *pulumi.Context,
	...
	var resource Bot
	err := ctx.ReadResource("azure-native:healthbot/v20220808:Bot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
