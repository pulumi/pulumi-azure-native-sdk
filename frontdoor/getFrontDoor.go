...
func LookupFrontDoor(ctx *pulumi.Context, args *LookupFrontDoorArgs, opts ...pulumi.InvokeOption) (*LookupFrontDoorResult, error) {
	...
	err := ctx.Invoke("azure-native:frontdoor:getFrontDoor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupFrontDoorOutput(ctx *pulumi.Context, args LookupFrontDoorOutputArgs, opts ...pulumi.InvokeOption) LookupFrontDoorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFrontDoorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:frontdoor:getFrontDoor", args, LookupFrontDoorResultOutput{}, options).(LookupFrontDoorResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupFrontDoorResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFrontDoorResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
