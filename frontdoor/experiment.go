...
func NewExperiment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:frontdoor/v20191101:Experiment"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20251001:Experiment"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20251101:Experiment"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:frontdoor:Experiment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExperiment(ctx *pulumi.Context,
	...
	var resource Experiment
	err := ctx.ReadResource("azure-native:frontdoor:Experiment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The endpoint A of an experiment
func (o ExperimentOutput) EndpointA() EndpointResponsePtrOutput {
	return o.ApplyT(func(v *Experiment) EndpointResponsePtrOutput { return v.EndpointA }).(EndpointResponsePtrOutput)
}

// The endpoint B of an experiment
func (o ExperimentOutput) EndpointB() EndpointResponsePtrOutput {
	return o.ApplyT(func(v *Experiment) EndpointResponsePtrOutput { return v.EndpointB }).(EndpointResponsePtrOutput)
}
