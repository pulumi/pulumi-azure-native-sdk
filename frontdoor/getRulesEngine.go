...
func LookupRulesEngine(ctx *pulumi.Context, args *LookupRulesEngineArgs, opts ...pulumi.InvokeOption) (*LookupRulesEngineResult, error) {
	...
	err := ctx.Invoke("azure-native:frontdoor:getRulesEngine", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRulesEngineOutput(ctx *pulumi.Context, args LookupRulesEngineOutputArgs, opts ...pulumi.InvokeOption) LookupRulesEngineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRulesEngineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:frontdoor:getRulesEngine", args, LookupRulesEngineResultOutput{}, options).(LookupRulesEngineResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupRulesEngineResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRulesEngineResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
