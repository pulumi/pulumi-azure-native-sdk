...
func NewFrontDoor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:frontdoor/v20180801:FrontDoor"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20190401:FrontDoor"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20190501:FrontDoor"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20200101:FrontDoor"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20200401:FrontDoor"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20200501:FrontDoor"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20210601:FrontDoor"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20251001:FrontDoor"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20251101:FrontDoor"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:frontdoor:FrontDoor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFrontDoor(ctx *pulumi.Context,
	...
	var resource FrontDoor
	err := ctx.ReadResource("azure-native:frontdoor:FrontDoor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o FrontDoorOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *FrontDoor) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
