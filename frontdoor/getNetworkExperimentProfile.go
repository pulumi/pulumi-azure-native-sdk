...
func LookupNetworkExperimentProfile(ctx *pulumi.Context, args *LookupNetworkExperimentProfileArgs, opts ...pulumi.InvokeOption) (*LookupNetworkExperimentProfileResult, error) {
	...
	err := ctx.Invoke("azure-native:frontdoor:getNetworkExperimentProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupNetworkExperimentProfileOutput(ctx *pulumi.Context, args LookupNetworkExperimentProfileOutputArgs, opts ...pulumi.InvokeOption) LookupNetworkExperimentProfileResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNetworkExperimentProfileResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:frontdoor:getNetworkExperimentProfile", args, LookupNetworkExperimentProfileResultOutput{}, options).(LookupNetworkExperimentProfileResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupNetworkExperimentProfileResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNetworkExperimentProfileResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
