...
func NewNetworkExperimentProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:frontdoor/v20251101:NetworkExperimentProfile"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:frontdoor:NetworkExperimentProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkExperimentProfile(ctx *pulumi.Context,
	...
	var resource NetworkExperimentProfile
	err := ctx.ReadResource("azure-native:frontdoor:NetworkExperimentProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o NetworkExperimentProfileOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *NetworkExperimentProfile) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
