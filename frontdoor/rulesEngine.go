...
func NewRulesEngine(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:frontdoor/v20200101:RulesEngine"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20200401:RulesEngine"),
		},
		{
			Type: pulumi.String("azure-native:frontdoor/v20200501:RulesEngine"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:frontdoor/v20251101:RulesEngine"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:frontdoor:RulesEngine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRulesEngine(ctx *pulumi.Context,
	...
	var resource RulesEngine
	err := ctx.ReadResource("azure-native:frontdoor:RulesEngine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o RulesEngineOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *RulesEngine) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
