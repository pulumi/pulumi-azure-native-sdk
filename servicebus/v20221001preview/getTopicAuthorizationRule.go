...
func (o LookupTopicAuthorizationRuleResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTopicAuthorizationRuleResult] {
	return pulumix.Output[LookupTopicAuthorizationRuleResult]{
