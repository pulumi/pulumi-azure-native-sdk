...
func NewDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicebus/v20240101:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-native:servicebus/v20250501preview:DisasterRecoveryConfig"),
		},
		{
			Type: pulumi.String("azure-native:servicebus/v20260101:DisasterRecoveryConfig"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DisasterRecoveryConfig
	err := ctx.RegisterResource("azure-native:servicebus:DisasterRecoveryConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	var resource DisasterRecoveryConfig
	err := ctx.ReadResource("azure-native:servicebus:DisasterRecoveryConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DisasterRecoveryConfigOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DisasterRecoveryConfig) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
