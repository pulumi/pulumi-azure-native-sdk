...
func NewNamespaceVirtualNetworkRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicebus/v20180101preview:NamespaceVirtualNetworkRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceVirtualNetworkRule(ctx *pulumi.Context,
	...
	var resource NamespaceVirtualNetworkRule
	err := ctx.ReadResource("azure-native:servicebus/v20180101preview:NamespaceVirtualNetworkRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
