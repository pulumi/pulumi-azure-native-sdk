...
func NewQueueAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicebus/v20180101preview:QueueAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueAuthorizationRule(ctx *pulumi.Context,
	...
	var resource QueueAuthorizationRule
	err := ctx.ReadResource("azure-native:servicebus/v20180101preview:QueueAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
