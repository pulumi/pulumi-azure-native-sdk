...
//
// Deprecated: azure-native:servicebus/v20220101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.
...
func NewDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicebus/v20220101preview:DisasterRecoveryConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisasterRecoveryConfig(ctx *pulumi.Context,
	...
	var resource DisasterRecoveryConfig
	err := ctx.ReadResource("azure-native:servicebus/v20220101preview:DisasterRecoveryConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
