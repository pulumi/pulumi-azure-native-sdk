...
func NewSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicebus/v20240101:Subscription"),
		},
		{
			Type: pulumi.String("azure-native:servicebus/v20250501preview:Subscription"),
		},
		{
			Type: pulumi.String("azure-native:servicebus/v20260101:Subscription"),
		},
	})
...
// The Azure API version of the resource.
func (o SubscriptionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Subscription) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
