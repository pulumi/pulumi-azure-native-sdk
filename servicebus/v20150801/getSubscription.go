...
func LookupSubscription(ctx *pulumi.Context, args *LookupSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:servicebus/v20150801:getSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Entity availability status for the topic.
func (o LookupSubscriptionResultOutput) EntityAvailabilityStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSubscriptionResult) *string { return v.EntityAvailabilityStatus }).(pulumi.StringPtrOutput)
}
...
// Value that indicates whether the entity description is read-only.
func (o LookupSubscriptionResultOutput) IsReadOnly() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupSubscriptionResult) *bool { return v.IsReadOnly }).(pulumi.BoolPtrOutput)
}

// Resource location.
func (o LookupSubscriptionResultOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSubscriptionResult) *string { return v.Location }).(pulumi.StringPtrOutput)
}
