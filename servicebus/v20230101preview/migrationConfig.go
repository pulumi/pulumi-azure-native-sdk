...
func NewMigrationConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicebus/v20230101preview:MigrationConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigrationConfig(ctx *pulumi.Context,
	...
	var resource MigrationConfig
	err := ctx.ReadResource("azure-native:servicebus/v20230101preview:MigrationConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
