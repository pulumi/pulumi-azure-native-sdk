...
func NewQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.RegisterResource("azure-native:servicebus/v20230101preview:Queue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.ReadResource("azure-native:servicebus/v20230101preview:Queue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
