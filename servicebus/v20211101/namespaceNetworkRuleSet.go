...
func NewNamespaceNetworkRuleSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicebus/v20211101:NamespaceNetworkRuleSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceNetworkRuleSet(ctx *pulumi.Context,
	...
	var resource NamespaceNetworkRuleSet
	err := ctx.ReadResource("azure-native:servicebus/v20211101:NamespaceNetworkRuleSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
