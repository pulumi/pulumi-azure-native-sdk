...
//
// Deprecated: azure-native:servicebus/v20210601preview:Topic is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Topic to guarantee forwards compatibility.
type Topic struct {
...
func NewTopic(ctx *pulumi.Context,
	...
	var resource Topic
	err := ctx.RegisterResource("azure-native:servicebus/v20210601preview:Topic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopic(ctx *pulumi.Context,
	...
	var resource Topic
	err := ctx.ReadResource("azure-native:servicebus/v20210601preview:Topic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
