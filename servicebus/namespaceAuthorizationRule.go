...
func NewNamespaceAuthorizationRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicebus/v20230101preview:NamespaceAuthorizationRule"),
		},
		{
			Type: pulumi.String("azure-native:servicebus/v20240101:NamespaceAuthorizationRule"),
		},
		{
			Type: pulumi.String("azure-native:servicebus/v20250501preview:NamespaceAuthorizationRule"),
		},
		{
			Type: pulumi.String("azure-native:servicebus/v20260101:NamespaceAuthorizationRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NamespaceAuthorizationRule
	err := ctx.RegisterResource("azure-native:servicebus:NamespaceAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceAuthorizationRule(ctx *pulumi.Context,
	...
	var resource NamespaceAuthorizationRule
	err := ctx.ReadResource("azure-native:servicebus:NamespaceAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
