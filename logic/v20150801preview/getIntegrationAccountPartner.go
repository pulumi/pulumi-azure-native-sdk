...
func (o LookupIntegrationAccountPartnerResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupIntegrationAccountPartnerResult] {
	return pulumix.Output[LookupIntegrationAccountPartnerResult]{
