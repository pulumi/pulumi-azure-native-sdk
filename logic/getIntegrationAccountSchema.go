...
func (o LookupIntegrationAccountSchemaResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupIntegrationAccountSchemaResult] {
	return pulumix.Output[LookupIntegrationAccountSchemaResult]{
