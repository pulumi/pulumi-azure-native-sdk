...
func ListWorkflowCallbackUrl(ctx *pulumi.Context, args *ListWorkflowCallbackUrlArgs, opts ...pulumi.InvokeOption) (*ListWorkflowCallbackUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:logic/v20180701preview:listWorkflowCallbackUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWorkflowCallbackUrlOutput(ctx *pulumi.Context, args ListWorkflowCallbackUrlOutputArgs, opts ...pulumi.InvokeOption) ListWorkflowCallbackUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkflowCallbackUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:logic/v20180701preview:listWorkflowCallbackUrl", args, ListWorkflowCallbackUrlResultOutput{}, options).(ListWorkflowCallbackUrlResultOutput), nil
