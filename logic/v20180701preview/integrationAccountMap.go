...
func NewIntegrationAccountMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:logic/v20180701preview:IntegrationAccountMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountMap(ctx *pulumi.Context,
	...
	var resource IntegrationAccountMap
	err := ctx.ReadResource("azure-native:logic/v20180701preview:IntegrationAccountMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
