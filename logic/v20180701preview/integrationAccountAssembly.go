...
func NewIntegrationAccountAssembly(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:logic/v20180701preview:IntegrationAccountAssembly", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationAccountAssembly(ctx *pulumi.Context,
	...
	var resource IntegrationAccountAssembly
	err := ctx.ReadResource("azure-native:logic/v20180701preview:IntegrationAccountAssembly", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
