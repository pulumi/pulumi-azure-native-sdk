...
func NewEncryptionScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:EncryptionScope"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:EncryptionScope"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:EncryptionScope"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:EncryptionScope"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:EncryptionScope"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:EncryptionScope"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:EncryptionScope"),
		},
	})
