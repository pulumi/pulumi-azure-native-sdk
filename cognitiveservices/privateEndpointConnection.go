...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250601:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250701preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250901:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:PrivateEndpointConnection"),
		},
	})
