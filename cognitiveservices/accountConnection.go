...
func NewAccountConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250401preview:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250601:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250701preview:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250901:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:AccountConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:AccountConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AccountConnection
	err := ctx.RegisterResource("azure-native:cognitiveservices:AccountConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountConnection(ctx *pulumi.Context,
	...
	var resource AccountConnection
	err := ctx.ReadResource("azure-native:cognitiveservices:AccountConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o AccountConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AccountConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
