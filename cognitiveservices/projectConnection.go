...
func NewProjectConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250401preview:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250601:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250701preview:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250901:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:ProjectConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:ProjectConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ProjectConnection
	err := ctx.RegisterResource("azure-native:cognitiveservices:ProjectConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectConnection(ctx *pulumi.Context,
	...
	var resource ProjectConnection
	err := ctx.ReadResource("azure-native:cognitiveservices:ProjectConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ProjectConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ProjectConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
