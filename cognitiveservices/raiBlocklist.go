...
func NewRaiBlocklist(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:RaiBlocklist"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:RaiBlocklist"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:RaiBlocklist"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:RaiBlocklist"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:RaiBlocklist"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:RaiBlocklist"),
		},
	})
