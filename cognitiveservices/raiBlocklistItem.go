...
func NewRaiBlocklistItem(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:RaiBlocklistItem"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:RaiBlocklistItem"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:RaiBlocklistItem"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:RaiBlocklistItem"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:RaiBlocklistItem"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:RaiBlocklistItem"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:RaiBlocklistItem"),
		},
	})
