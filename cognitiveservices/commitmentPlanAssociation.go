...
// Metadata pertaining to creation and last modification of the resource.
func (o CommitmentPlanAssociationOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *CommitmentPlanAssociation) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
