...
func NewCommitmentPlanAssociation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20231001preview:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20240401preview:CommitmentPlanAssociation"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250601:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250701preview:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250901:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:CommitmentPlanAssociation"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:CommitmentPlanAssociation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CommitmentPlanAssociation
	err := ctx.RegisterResource("azure-native:cognitiveservices:CommitmentPlanAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCommitmentPlanAssociation(ctx *pulumi.Context,
	...
	var resource CommitmentPlanAssociation
	err := ctx.ReadResource("azure-native:cognitiveservices:CommitmentPlanAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
