...
func NewCommitmentPlan(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:CommitmentPlan"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:CommitmentPlan"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:CommitmentPlan"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:CommitmentPlan"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:CommitmentPlan"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:CommitmentPlan"),
		},
	})
