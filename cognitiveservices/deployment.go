...
func NewDeployment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20221001:Deployment"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20231001preview:Deployment"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250601:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250701preview:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250901:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:Deployment"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:Deployment"),
		},
	})
