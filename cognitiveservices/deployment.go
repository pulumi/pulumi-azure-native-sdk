...
// Metadata pertaining to creation and last modification of the resource.
func (o DeploymentOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *Deployment) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
