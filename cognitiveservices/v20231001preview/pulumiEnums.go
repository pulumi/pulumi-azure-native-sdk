...
func (in *byPassSelectionPtr) ToOutput(ctx context.Context) pulumix.Output[*ByPassSelection] {
	return pulumix.Output[*ByPassSelection]{
		OutputState: in.ToByPassSelectionPtrOutputWithContext(ctx).OutputState,
	}
}
