...
func NewAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20230501:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20240401preview:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20240601preview:Account"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cognitiveservices/v20231001preview:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("azure-native:cognitiveservices/v20231001preview:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
