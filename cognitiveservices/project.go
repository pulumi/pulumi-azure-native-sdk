...
func NewProject(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:Project"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:Project"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:Project"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:Project"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:Project"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:Project"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:Project"),
		},
	})
