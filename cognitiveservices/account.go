...
func NewAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250601:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250701preview:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250901:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:Account"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:Account"),
		},
	})
