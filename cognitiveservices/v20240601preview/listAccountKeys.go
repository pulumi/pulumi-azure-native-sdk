...
func ListAccountKeys(ctx *pulumi.Context, args *ListAccountKeysArgs, opts ...pulumi.InvokeOption) (*ListAccountKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:cognitiveservices/v20240601preview:listAccountKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAccountKeysOutput(ctx *pulumi.Context, args ListAccountKeysOutputArgs, opts ...pulumi.InvokeOption) ListAccountKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAccountKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cognitiveservices/v20240601preview:listAccountKeys", args, ListAccountKeysResultOutput{}, options).(ListAccountKeysResultOutput), nil
