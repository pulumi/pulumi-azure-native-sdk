...
func NewCommitmentPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cognitiveservices/v20240601preview:CommitmentPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCommitmentPlan(ctx *pulumi.Context,
	...
	var resource CommitmentPlan
	err := ctx.ReadResource("azure-native:cognitiveservices/v20240601preview:CommitmentPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
