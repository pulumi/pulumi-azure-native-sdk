...
func NewEncryptionScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cognitiveservices/v20240601preview:EncryptionScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEncryptionScope(ctx *pulumi.Context,
	...
	var resource EncryptionScope
	err := ctx.ReadResource("azure-native:cognitiveservices/v20240601preview:EncryptionScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
