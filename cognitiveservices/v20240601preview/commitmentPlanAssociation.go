...
func NewCommitmentPlanAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cognitiveservices/v20240601preview:CommitmentPlanAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCommitmentPlanAssociation(ctx *pulumi.Context,
	...
	var resource CommitmentPlanAssociation
	err := ctx.ReadResource("azure-native:cognitiveservices/v20240601preview:CommitmentPlanAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
