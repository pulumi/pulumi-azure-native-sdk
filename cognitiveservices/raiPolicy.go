...
func NewRaiPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251001preview:RaiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:RaiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:RaiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:RaiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:RaiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:RaiPolicy"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:RaiPolicy"),
		},
	})
