...
func NewOutboundRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20251201:OutboundRule"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260115preview:OutboundRule"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260301:OutboundRule"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260315preview:OutboundRule"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260501:OutboundRule"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20260515preview:OutboundRule"),
		},
	})
