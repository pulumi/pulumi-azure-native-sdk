...
func LookupCommitmentPlan(ctx *pulumi.Context, args *LookupCommitmentPlanArgs, opts ...pulumi.InvokeOption) (*LookupCommitmentPlanResult, error) {
	...
	err := ctx.Invoke("azure-native:cognitiveservices/v20241001:getCommitmentPlan", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCommitmentPlanOutput(ctx *pulumi.Context, args LookupCommitmentPlanOutputArgs, opts ...pulumi.InvokeOption) LookupCommitmentPlanResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCommitmentPlanResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cognitiveservices/v20241001:getCommitmentPlan", args, LookupCommitmentPlanResultOutput{}, options).(LookupCommitmentPlanResultOutput), nil
