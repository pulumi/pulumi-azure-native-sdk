...
func NewRaiBlocklist(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cognitiveservices/v20241001:RaiBlocklist", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRaiBlocklist(ctx *pulumi.Context,
	...
	var resource RaiBlocklist
	err := ctx.ReadResource("azure-native:cognitiveservices/v20241001:RaiBlocklist", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
