...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20231001preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20240601preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20241001:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:cognitiveservices/v20250401preview:PrivateEndpointConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cognitiveservices/v20240401preview:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:cognitiveservices/v20240401preview:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
