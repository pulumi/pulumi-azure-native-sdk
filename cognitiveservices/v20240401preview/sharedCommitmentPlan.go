...
func NewSharedCommitmentPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cognitiveservices/v20240401preview:SharedCommitmentPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSharedCommitmentPlan(ctx *pulumi.Context,
	...
	var resource SharedCommitmentPlan
	err := ctx.ReadResource("azure-native:cognitiveservices/v20240401preview:SharedCommitmentPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
