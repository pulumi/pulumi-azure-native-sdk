...
// Metadata pertaining to creation and last modification of the resource.
func (o LookupCommitmentPlanResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupCommitmentPlanResult) commontypesv2.SystemDataResponse { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
