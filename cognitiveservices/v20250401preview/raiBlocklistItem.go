...
func NewRaiBlocklistItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cognitiveservices/v20250401preview:RaiBlocklistItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRaiBlocklistItem(ctx *pulumi.Context,
	...
	var resource RaiBlocklistItem
	err := ctx.ReadResource("azure-native:cognitiveservices/v20250401preview:RaiBlocklistItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
