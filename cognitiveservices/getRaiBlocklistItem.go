...
func LookupRaiBlocklistItem(ctx *pulumi.Context, args *LookupRaiBlocklistItemArgs, opts ...pulumi.InvokeOption) (*LookupRaiBlocklistItemResult, error) {
	...
	err := ctx.Invoke("azure-native:cognitiveservices:getRaiBlocklistItem", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRaiBlocklistItemOutput(ctx *pulumi.Context, args LookupRaiBlocklistItemOutputArgs, opts ...pulumi.InvokeOption) LookupRaiBlocklistItemResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRaiBlocklistItemResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cognitiveservices:getRaiBlocklistItem", args, LookupRaiBlocklistItemResultOutput{}, options).(LookupRaiBlocklistItemResultOutput), nil
...
// Metadata pertaining to creation and last modification of the resource.
func (o LookupRaiBlocklistItemResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupRaiBlocklistItemResult) commontypesv2.SystemDataResponse { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
