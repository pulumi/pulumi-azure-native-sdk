...
//
// Deprecated: azure-native:confluent/v20210301preview:Organization is being removed in the next major version of this provider. Upgrade to at least azure-native:confluent/v20211201:Organization to guarantee forwards compatibility.
...
func NewOrganization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:confluent/v20210301preview:Organization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganization(ctx *pulumi.Context,
	...
	var resource Organization
	err := ctx.ReadResource("azure-native:confluent/v20210301preview:Organization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
