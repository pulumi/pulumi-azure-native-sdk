...
func ListOrganizationRegions(ctx *pulumi.Context, args *ListOrganizationRegionsArgs, opts ...pulumi.InvokeOption) (*ListOrganizationRegionsResult, error) {
	...
	err := ctx.Invoke("azure-native:confluent/v20240701:listOrganizationRegions", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListOrganizationRegionsOutput(ctx *pulumi.Context, args ListOrganizationRegionsOutputArgs, opts ...pulumi.InvokeOption) ListOrganizationRegionsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListOrganizationRegionsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:confluent/v20240701:listOrganizationRegions", args, ListOrganizationRegionsResultOutput{}, options).(ListOrganizationRegionsResultOutput), nil
