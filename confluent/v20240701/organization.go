...
func NewOrganization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:confluent/v20240701:Organization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganization(ctx *pulumi.Context,
	...
	var resource Organization
	err := ctx.ReadResource("azure-native:confluent/v20240701:Organization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
