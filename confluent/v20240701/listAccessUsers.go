...
func ListAccessUsers(ctx *pulumi.Context, args *ListAccessUsersArgs, opts ...pulumi.InvokeOption) (*ListAccessUsersResult, error) {
	...
	err := ctx.Invoke("azure-native:confluent/v20240701:listAccessUsers", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAccessUsersOutput(ctx *pulumi.Context, args ListAccessUsersOutputArgs, opts ...pulumi.InvokeOption) ListAccessUsersResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAccessUsersResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:confluent/v20240701:listAccessUsers", args, ListAccessUsersResultOutput{}, options).(ListAccessUsersResultOutput), nil
