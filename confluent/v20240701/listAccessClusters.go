...
func ListAccessClusters(ctx *pulumi.Context, args *ListAccessClustersArgs, opts ...pulumi.InvokeOption) (*ListAccessClustersResult, error) {
	...
	err := ctx.Invoke("azure-native:confluent/v20240701:listAccessClusters", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAccessClustersOutput(ctx *pulumi.Context, args ListAccessClustersOutputArgs, opts ...pulumi.InvokeOption) ListAccessClustersResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAccessClustersResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:confluent/v20240701:listAccessClusters", args, ListAccessClustersResultOutput{}, options).(ListAccessClustersResultOutput), nil
