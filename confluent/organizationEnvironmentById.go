...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o OrganizationEnvironmentByIdOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *OrganizationEnvironmentById) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
