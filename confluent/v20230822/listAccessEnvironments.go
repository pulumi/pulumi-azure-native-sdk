...
func ListAccessEnvironments(ctx *pulumi.Context, args *ListAccessEnvironmentsArgs, opts ...pulumi.InvokeOption) (*ListAccessEnvironmentsResult, error) {
	...
	err := ctx.Invoke("azure-native:confluent/v20230822:listAccessEnvironments", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAccessEnvironmentsOutput(ctx *pulumi.Context, args ListAccessEnvironmentsOutputArgs, opts ...pulumi.InvokeOption) ListAccessEnvironmentsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAccessEnvironmentsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:confluent/v20230822:listAccessEnvironments", args, ListAccessEnvironmentsResultOutput{}, options).(ListAccessEnvironmentsResultOutput), nil
