...
func ListBotConnectionServiceProviders(ctx *pulumi.Context, args *ListBotConnectionServiceProvidersArgs, opts ...pulumi.InvokeOption) (*ListBotConnectionServiceProvidersResult, error) {
	...
	err := ctx.Invoke("azure-native:botservice/v20230915preview:listBotConnectionServiceProviders", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListBotConnectionServiceProvidersOutput(ctx *pulumi.Context, args ListBotConnectionServiceProvidersOutputArgs, opts ...pulumi.InvokeOption) ListBotConnectionServiceProvidersResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListBotConnectionServiceProvidersResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:botservice/v20230915preview:listBotConnectionServiceProviders", args, ListBotConnectionServiceProvidersResultOutput{}, options).(ListBotConnectionServiceProvidersResultOutput), nil
