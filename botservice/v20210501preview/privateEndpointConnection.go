...
//
// Deprecated: azure-native:botservice/v20210501preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:PrivateEndpointConnection to guarantee forwards compatibility.
...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:botservice/v20210501preview:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:botservice/v20210501preview:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
