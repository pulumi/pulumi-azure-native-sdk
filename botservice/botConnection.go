...
func NewBotConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:botservice/v20230915preview:BotConnection"),
		},
	})
...
// The Azure API version of the resource.
func (o BotConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *BotConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o BotConnectionOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *BotConnection) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
