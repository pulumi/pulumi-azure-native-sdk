...
func NewChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:botservice/v20180712:Channel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetChannel(ctx *pulumi.Context,
	...
	var resource Channel
	err := ctx.ReadResource("azure-native:botservice/v20180712:Channel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
