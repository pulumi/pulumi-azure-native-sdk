...
func ListBotConnectionWithSecrets(ctx *pulumi.Context, args *ListBotConnectionWithSecretsArgs, opts ...pulumi.InvokeOption) (*ListBotConnectionWithSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:botservice/v20220915:listBotConnectionWithSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func ListBotConnectionWithSecretsOutput(ctx *pulumi.Context, args ListBotConnectionWithSecretsOutputArgs, opts ...pulumi.InvokeOption) ListBotConnectionWithSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListBotConnectionWithSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:botservice/v20220915:listBotConnectionWithSecrets", args, ListBotConnectionWithSecretsResultOutput{}, options).(ListBotConnectionWithSecretsResultOutput), nil
