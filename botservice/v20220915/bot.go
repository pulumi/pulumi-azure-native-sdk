...
func NewBot(ctx *pulumi.Context,
	...
	var resource Bot
	err := ctx.RegisterResource("azure-native:botservice/v20220915:Bot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBot(ctx *pulumi.Context,
	...
	var resource Bot
	err := ctx.ReadResource("azure-native:botservice/v20220915:Bot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
