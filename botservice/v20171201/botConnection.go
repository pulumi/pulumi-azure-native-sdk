...
func NewBotConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:botservice/v20171201:BotConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBotConnection(ctx *pulumi.Context,
	...
	var resource BotConnection
	err := ctx.ReadResource("azure-native:botservice/v20171201:BotConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
