...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NetworkSecurityPerimeterConfigurationResponseOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v NetworkSecurityPerimeterConfigurationResponse) commontypesv3.SystemDataResponse {
		return v.SystemData
