...
// Previous API Version: 2023-07-01-preview. See https://github.com/pulumi/pulumi-azure-native/discussions/1834 for information on migrating from v1 to v2 of the provider.
...
func NewProfessionalServiceSubscriptionLevel(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:professionalservice/v20230701preview:ProfessionalServiceSubscriptionLevel"),
		},
	})
	opts = append(opts, aliases)
	var resource ProfessionalServiceSubscriptionLevel
	err := ctx.RegisterResource("azure-native:professionalservice:ProfessionalServiceSubscriptionLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfessionalServiceSubscriptionLevel(ctx *pulumi.Context,
	...
	var resource ProfessionalServiceSubscriptionLevel
	err := ctx.ReadResource("azure-native:professionalservice:ProfessionalServiceSubscriptionLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
