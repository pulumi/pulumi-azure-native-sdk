...
func NewEmployee(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:contoso/v20211001preview:Employee", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmployee(ctx *pulumi.Context,
	...
	var resource Employee
	err := ctx.ReadResource("azure-native:contoso/v20211001preview:Employee", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
