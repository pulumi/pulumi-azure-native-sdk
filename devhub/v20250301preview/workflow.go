...
func NewWorkflow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devhub/v20250301preview:Workflow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflow(ctx *pulumi.Context,
	...
	var resource Workflow
	err := ctx.ReadResource("azure-native:devhub/v20250301preview:Workflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
