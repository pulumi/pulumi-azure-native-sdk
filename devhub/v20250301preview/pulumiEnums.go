...
func (RepositoryProviderType) ElementType() reflect.Type {
	return reflect.TypeOf((*RepositoryProviderType)(nil)).Elem()
}

func (e RepositoryProviderType) ToRepositoryProviderTypeOutput() RepositoryProviderTypeOutput {
	return pulumi.ToOutput(e).(RepositoryProviderTypeOutput)
}

func (e RepositoryProviderType) ToRepositoryProviderTypeOutputWithContext(ctx context.Context) RepositoryProviderTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(RepositoryProviderTypeOutput)
}

func (e RepositoryProviderType) ToRepositoryProviderTypePtrOutput() RepositoryProviderTypePtrOutput {
	return e.ToRepositoryProviderTypePtrOutputWithContext(context.Background())
}

func (e RepositoryProviderType) ToRepositoryProviderTypePtrOutputWithContext(ctx context.Context) RepositoryProviderTypePtrOutput {
	return RepositoryProviderType(e).ToRepositoryProviderTypeOutputWithContext(ctx).ToRepositoryProviderTypePtrOutputWithContext(ctx)
}

func (e RepositoryProviderType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e RepositoryProviderType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e RepositoryProviderType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e RepositoryProviderType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type RepositoryProviderTypeOutput struct{ *pulumi.OutputState }

func (RepositoryProviderTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RepositoryProviderType)(nil)).Elem()
}

func (o RepositoryProviderTypeOutput) ToRepositoryProviderTypeOutput() RepositoryProviderTypeOutput {
	return o
}

func (o RepositoryProviderTypeOutput) ToRepositoryProviderTypeOutputWithContext(ctx context.Context) RepositoryProviderTypeOutput {
	return o
}

func (o RepositoryProviderTypeOutput) ToRepositoryProviderTypePtrOutput() RepositoryProviderTypePtrOutput {
	return o.ToRepositoryProviderTypePtrOutputWithContext(context.Background())
}

func (o RepositoryProviderTypeOutput) ToRepositoryProviderTypePtrOutputWithContext(ctx context.Context) RepositoryProviderTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v RepositoryProviderType) *RepositoryProviderType {
		return &v
	}).(RepositoryProviderTypePtrOutput)
}

func (o RepositoryProviderTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o RepositoryProviderTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e RepositoryProviderType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o RepositoryProviderTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o RepositoryProviderTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e RepositoryProviderType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type RepositoryProviderTypePtrOutput struct{ *pulumi.OutputState }

func (RepositoryProviderTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**RepositoryProviderType)(nil)).Elem()
}

func (o RepositoryProviderTypePtrOutput) ToRepositoryProviderTypePtrOutput() RepositoryProviderTypePtrOutput {
	return o
}

func (o RepositoryProviderTypePtrOutput) ToRepositoryProviderTypePtrOutputWithContext(ctx context.Context) RepositoryProviderTypePtrOutput {
	return o
}

func (o RepositoryProviderTypePtrOutput) Elem() RepositoryProviderTypeOutput {
	return o.ApplyT(func(v *RepositoryProviderType) RepositoryProviderType {
		if v != nil {
			return *v
		}
		var ret RepositoryProviderType
		return ret
	}).(RepositoryProviderTypeOutput)
}

func (o RepositoryProviderTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o RepositoryProviderTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *RepositoryProviderType) *string {
		if e == nil {
			return nil
		}
...
// RepositoryProviderTypeInput is an input type that accepts values of the RepositoryProviderType enum
// A concrete instance of `RepositoryProviderTypeInput` can be one of the following:
//
//	RepositoryProviderTypeGithub
//	RepositoryProviderTypeAdo
type RepositoryProviderTypeInput interface {
	pulumi.Input

	ToRepositoryProviderTypeOutput() RepositoryProviderTypeOutput
	ToRepositoryProviderTypeOutputWithContext(context.Context) RepositoryProviderTypeOutput
}

var repositoryProviderTypePtrType = reflect.TypeOf((**RepositoryProviderType)(nil)).Elem()

type RepositoryProviderTypePtrInput interface {
	pulumi.Input

	ToRepositoryProviderTypePtrOutput() RepositoryProviderTypePtrOutput
	ToRepositoryProviderTypePtrOutputWithContext(context.Context) RepositoryProviderTypePtrOutput
}

type repositoryProviderTypePtr string

func RepositoryProviderTypePtr(v string) RepositoryProviderTypePtrInput {
	return (*repositoryProviderTypePtr)(&v)
}

func (*repositoryProviderTypePtr) ElementType() reflect.Type {
	return repositoryProviderTypePtrType
}

func (in *repositoryProviderTypePtr) ToRepositoryProviderTypePtrOutput() RepositoryProviderTypePtrOutput {
	return pulumi.ToOutput(in).(RepositoryProviderTypePtrOutput)
}

func (in *repositoryProviderTypePtr) ToRepositoryProviderTypePtrOutputWithContext(ctx context.Context) RepositoryProviderTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(RepositoryProviderTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(RepositoryProviderTypeOutput{})
	pulumi.RegisterOutputType(RepositoryProviderTypePtrOutput{})
}
