...
// The Azure API version of the resource.
func (o AzureBareMetalStorageInstanceOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AzureBareMetalStorageInstance) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AzureBareMetalStorageInstanceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *AzureBareMetalStorageInstance) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
