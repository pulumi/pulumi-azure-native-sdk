...
func NewAzureBareMetalStorageInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:baremetalinfrastructure/v20240801preview:AzureBareMetalStorageInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureBareMetalStorageInstance(ctx *pulumi.Context,
	...
	var resource AzureBareMetalStorageInstance
	err := ctx.ReadResource("azure-native:baremetalinfrastructure/v20240801preview:AzureBareMetalStorageInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
