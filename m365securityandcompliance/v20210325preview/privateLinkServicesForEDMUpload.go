...
func NewPrivateLinkServicesForEDMUpload(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:m365securityandcompliance/v20210325preview:PrivateLinkServicesForEDMUpload", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicesForEDMUpload(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicesForEDMUpload
	err := ctx.ReadResource("azure-native:m365securityandcompliance/v20210325preview:PrivateLinkServicesForEDMUpload", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
