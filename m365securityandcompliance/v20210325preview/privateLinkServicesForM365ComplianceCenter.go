...
func NewPrivateLinkServicesForM365ComplianceCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:m365securityandcompliance/v20210325preview:PrivateLinkServicesForM365ComplianceCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkServicesForM365ComplianceCenter(ctx *pulumi.Context,
	...
	var resource PrivateLinkServicesForM365ComplianceCenter
	err := ctx.ReadResource("azure-native:m365securityandcompliance/v20210325preview:PrivateLinkServicesForM365ComplianceCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *PrivateLinkServicesForM365ComplianceCenter) ToOutput(ctx context.Context) pulumix.Output[*PrivateLinkServicesForM365ComplianceCenter] {
	return pulumix.Output[*PrivateLinkServicesForM365ComplianceCenter]{
		OutputState: i.ToPrivateLinkServicesForM365ComplianceCenterOutputWithContext(ctx).OutputState,
	}
}
...
func (o PrivateLinkServicesForM365ComplianceCenterOutput) ToOutput(ctx context.Context) pulumix.Output[*PrivateLinkServicesForM365ComplianceCenter] {
	return pulumix.Output[*PrivateLinkServicesForM365ComplianceCenter]{
