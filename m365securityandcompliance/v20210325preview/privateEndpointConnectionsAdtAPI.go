...
func NewPrivateEndpointConnectionsAdtAPI(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:m365securityandcompliance:PrivateEndpointConnectionsAdtAPI"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateEndpointConnectionsAdtAPI
	err := ctx.RegisterResource("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsAdtAPI", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsAdtAPI(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsAdtAPI
	err := ctx.ReadResource("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsAdtAPI", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
