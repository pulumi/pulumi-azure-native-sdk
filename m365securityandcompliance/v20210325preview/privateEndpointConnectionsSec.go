...
func NewPrivateEndpointConnectionsSec(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:m365securityandcompliance:PrivateEndpointConnectionsSec"),
		},
	})
...
func GetPrivateEndpointConnectionsSec(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsSec
	err := ctx.ReadResource("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsSec", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
