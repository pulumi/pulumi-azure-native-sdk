...
func (o LookupPrivateEndpointConnectionsCompResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupPrivateEndpointConnectionsCompResult] {
	return pulumix.Output[LookupPrivateEndpointConnectionsCompResult]{
