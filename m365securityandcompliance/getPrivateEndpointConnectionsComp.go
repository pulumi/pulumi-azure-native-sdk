...
func LookupPrivateEndpointConnectionsComp(ctx *pulumi.Context, args *LookupPrivateEndpointConnectionsCompArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointConnectionsCompResult, error) {
	...
	err := ctx.Invoke("azure-native:m365securityandcompliance:getPrivateEndpointConnectionsComp", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateEndpointConnectionsCompOutput(ctx *pulumi.Context, args LookupPrivateEndpointConnectionsCompOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateEndpointConnectionsCompResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateEndpointConnectionsCompResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:m365securityandcompliance:getPrivateEndpointConnectionsComp", args, LookupPrivateEndpointConnectionsCompResultOutput{}, options).(LookupPrivateEndpointConnectionsCompResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupPrivateEndpointConnectionsCompResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPrivateEndpointConnectionsCompResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Required property for system data
func (o LookupPrivateEndpointConnectionsCompResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPrivateEndpointConnectionsCompResult) commontypesv2.SystemDataResponse {
		return v.SystemData
