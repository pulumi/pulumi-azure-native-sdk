...
func NewEnvironmentType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20241001preview:EnvironmentType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentType(ctx *pulumi.Context,
	...
	var resource EnvironmentType
	err := ctx.ReadResource("azure-native:devcenter/v20241001preview:EnvironmentType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
