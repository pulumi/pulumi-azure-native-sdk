...
type DevCenter struct {
	...
	RestrictedResourceTypes pulumi.StringArrayOutput `pulumi:"restrictedResourceTypes"`
...
func NewDevCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20241001preview:DevCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevCenter(ctx *pulumi.Context,
	...
	var resource DevCenter
	err := ctx.ReadResource("azure-native:devcenter/v20241001preview:DevCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type devCenterArgs struct {
	...
	// Indicates the resource types that are restricted from being accessed by a project unless allowed by a project policy.
	RestrictedResourceTypes []string `pulumi:"restrictedResourceTypes"`
	// Resource tags.
...
type DevCenterArgs struct {
	...
	// Indicates the resource types that are restricted from being accessed by a project unless allowed by a project policy.
	RestrictedResourceTypes pulumi.StringArrayInput
	// Resource tags.
...
// Indicates the resource types that are restricted from being accessed by a project unless allowed by a project policy.
func (o DevCenterOutput) RestrictedResourceTypes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *DevCenter) pulumi.StringArrayOutput { return v.RestrictedResourceTypes }).(pulumi.StringArrayOutput)
}
