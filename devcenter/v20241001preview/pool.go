...
type Pool struct {
	...
	StopOnNoConnect StopOnNoConnectConfigurationResponsePtrOutput `pulumi:"stopOnNoConnect"`
...
func NewPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20240601preview:Pool"),
		},
		{
	...
	var resource Pool
	err := ctx.RegisterResource("azure-native:devcenter/v20241001preview:Pool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("azure-native:devcenter/v20241001preview:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type poolArgs struct {
	...
	// Stop on no connect configuration settings for Dev Boxes created in this pool.
	StopOnNoConnect *StopOnNoConnectConfiguration `pulumi:"stopOnNoConnect"`
	// Resource tags.
...
type PoolArgs struct {
	...
	// Stop on no connect configuration settings for Dev Boxes created in this pool.
	StopOnNoConnect StopOnNoConnectConfigurationPtrInput
	// Resource tags.
...
// Stop on no connect configuration settings for Dev Boxes created in this pool.
func (o PoolOutput) StopOnNoConnect() StopOnNoConnectConfigurationResponsePtrOutput {
	return o.ApplyT(func(v *Pool) StopOnNoConnectConfigurationResponsePtrOutput { return v.StopOnNoConnect }).(StopOnNoConnectConfigurationResponsePtrOutput)
}
