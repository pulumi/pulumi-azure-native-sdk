...
func LookupAttachedNetworkByDevCenter(ctx *pulumi.Context, args *LookupAttachedNetworkByDevCenterArgs, opts ...pulumi.InvokeOption) (*LookupAttachedNetworkByDevCenterResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20241001preview:getAttachedNetworkByDevCenter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAttachedNetworkByDevCenterOutput(ctx *pulumi.Context, args LookupAttachedNetworkByDevCenterOutputArgs, opts ...pulumi.InvokeOption) LookupAttachedNetworkByDevCenterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAttachedNetworkByDevCenterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20241001preview:getAttachedNetworkByDevCenter", args, LookupAttachedNetworkByDevCenterResultOutput{}, options).(LookupAttachedNetworkByDevCenterResultOutput), nil
