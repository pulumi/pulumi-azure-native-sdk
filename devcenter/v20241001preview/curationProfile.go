...
func NewCurationProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20241001preview:CurationProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCurationProfile(ctx *pulumi.Context,
	...
	var resource CurationProfile
	err := ctx.ReadResource("azure-native:devcenter/v20241001preview:CurationProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
