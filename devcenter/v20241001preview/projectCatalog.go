...
func NewProjectCatalog(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20240601preview:ProjectCatalog"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20241001preview:ProjectCatalog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectCatalog(ctx *pulumi.Context,
	...
	var resource ProjectCatalog
	err := ctx.ReadResource("azure-native:devcenter/v20241001preview:ProjectCatalog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
