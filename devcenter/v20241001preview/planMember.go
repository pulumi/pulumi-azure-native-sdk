...
func NewPlanMember(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20240801preview:PlanMember"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PlanMember
	err := ctx.RegisterResource("azure-native:devcenter/v20241001preview:PlanMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPlanMember(ctx *pulumi.Context,
	...
	var resource PlanMember
	err := ctx.ReadResource("azure-native:devcenter/v20241001preview:PlanMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
