...
func NewProjectPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20241001preview:ProjectPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectPolicy(ctx *pulumi.Context,
	...
	var resource ProjectPolicy
	err := ctx.ReadResource("azure-native:devcenter/v20241001preview:ProjectPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
