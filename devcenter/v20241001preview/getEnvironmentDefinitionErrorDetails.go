...
func GetEnvironmentDefinitionErrorDetails(ctx *pulumi.Context, args *GetEnvironmentDefinitionErrorDetailsArgs, opts ...pulumi.InvokeOption) (*GetEnvironmentDefinitionErrorDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20241001preview:getEnvironmentDefinitionErrorDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEnvironmentDefinitionErrorDetailsOutput(ctx *pulumi.Context, args GetEnvironmentDefinitionErrorDetailsOutputArgs, opts ...pulumi.InvokeOption) GetEnvironmentDefinitionErrorDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetEnvironmentDefinitionErrorDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20241001preview:getEnvironmentDefinitionErrorDetails", args, GetEnvironmentDefinitionErrorDetailsResultOutput{}, options).(GetEnvironmentDefinitionErrorDetailsResultOutput), nil
