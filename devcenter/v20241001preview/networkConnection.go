...
func NewNetworkConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20241001preview:NetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnection(ctx *pulumi.Context,
	...
	var resource NetworkConnection
	err := ctx.ReadResource("azure-native:devcenter/v20241001preview:NetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
