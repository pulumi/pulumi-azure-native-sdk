...
func NewSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20250401preview:Schedule"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20250701preview:Schedule"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20251001preview:Schedule"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20260101preview:Schedule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Schedule
	err := ctx.RegisterResource("azure-native:devcenter:Schedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchedule(ctx *pulumi.Context,
	...
	var resource Schedule
	err := ctx.ReadResource("azure-native:devcenter:Schedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ScheduleOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Schedule) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
