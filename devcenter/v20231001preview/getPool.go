...
func LookupPool(ctx *pulumi.Context, args *LookupPoolArgs, opts ...pulumi.InvokeOption) (*LookupPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20231001preview:getPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPoolOutput(ctx *pulumi.Context, args LookupPoolOutputArgs, opts ...pulumi.InvokeOption) LookupPoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPoolResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20231001preview:getPool", args, LookupPoolResultOutput{}, options).(LookupPoolResultOutput), nil
