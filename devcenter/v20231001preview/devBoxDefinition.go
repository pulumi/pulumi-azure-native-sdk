...
func NewDevBoxDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20230801preview:DevBoxDefinition"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240201:DevBoxDefinition"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240501preview:DevBoxDefinition"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240601preview:DevBoxDefinition"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240701preview:DevBoxDefinition"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240801preview:DevBoxDefinition"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20231001preview:DevBoxDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevBoxDefinition(ctx *pulumi.Context,
	...
	var resource DevBoxDefinition
	err := ctx.ReadResource("azure-native:devcenter/v20231001preview:DevBoxDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
