...
func NewEnvironmentType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20240201:EnvironmentType"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240501preview:EnvironmentType"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240601preview:EnvironmentType"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240701preview:EnvironmentType"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EnvironmentType
	err := ctx.RegisterResource("azure-native:devcenter/v20231001preview:EnvironmentType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentType(ctx *pulumi.Context,
	...
	var resource EnvironmentType
	err := ctx.ReadResource("azure-native:devcenter/v20231001preview:EnvironmentType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
