...
func NewSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20231001preview:Schedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchedule(ctx *pulumi.Context,
	...
	var resource Schedule
	err := ctx.ReadResource("azure-native:devcenter/v20231001preview:Schedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
