...
func NewProjectEnvironmentType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20240601preview:ProjectEnvironmentType"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240701preview:ProjectEnvironmentType"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240801preview:ProjectEnvironmentType"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ProjectEnvironmentType
	err := ctx.RegisterResource("azure-native:devcenter/v20231001preview:ProjectEnvironmentType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectEnvironmentType(ctx *pulumi.Context,
	...
	var resource ProjectEnvironmentType
	err := ctx.ReadResource("azure-native:devcenter/v20231001preview:ProjectEnvironmentType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
