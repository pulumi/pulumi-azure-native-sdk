...
func NewProject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20240701preview:Project", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProject(ctx *pulumi.Context,
	...
	var resource Project
	err := ctx.ReadResource("azure-native:devcenter/v20240701preview:Project", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
