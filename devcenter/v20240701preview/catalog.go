...
func NewCatalog(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20241001preview:Catalog"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Catalog
	err := ctx.RegisterResource("azure-native:devcenter/v20240701preview:Catalog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCatalog(ctx *pulumi.Context,
	...
	var resource Catalog
	err := ctx.ReadResource("azure-native:devcenter/v20240701preview:Catalog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
