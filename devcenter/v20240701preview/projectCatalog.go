...
func NewProjectCatalog(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20240701preview:ProjectCatalog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectCatalog(ctx *pulumi.Context,
	...
	var resource ProjectCatalog
	err := ctx.ReadResource("azure-native:devcenter/v20240701preview:ProjectCatalog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
