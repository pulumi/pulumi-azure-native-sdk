...
func NewDevCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20240601preview:DevCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevCenter(ctx *pulumi.Context,
	...
	var resource DevCenter
	err := ctx.ReadResource("azure-native:devcenter/v20240601preview:DevCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
