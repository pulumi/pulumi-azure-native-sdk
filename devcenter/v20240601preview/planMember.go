...
func NewPlanMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20240601preview:PlanMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPlanMember(ctx *pulumi.Context,
	...
	var resource PlanMember
	err := ctx.ReadResource("azure-native:devcenter/v20240601preview:PlanMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
