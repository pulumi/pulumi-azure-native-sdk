...
func NewEncryptionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20240601preview:EncryptionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEncryptionSet(ctx *pulumi.Context,
	...
	var resource EncryptionSet
	err := ctx.ReadResource("azure-native:devcenter/v20240601preview:EncryptionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
