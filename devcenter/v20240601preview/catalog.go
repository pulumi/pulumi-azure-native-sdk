...
func NewCatalog(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20240601preview:Catalog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCatalog(ctx *pulumi.Context,
	...
	var resource Catalog
	err := ctx.ReadResource("azure-native:devcenter/v20240601preview:Catalog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
