...
func NewPlan(ctx *pulumi.Context,
	...
	var resource Plan
	err := ctx.RegisterResource("azure-native:devcenter/v20240601preview:Plan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPlan(ctx *pulumi.Context,
	...
	var resource Plan
	err := ctx.ReadResource("azure-native:devcenter/v20240601preview:Plan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
