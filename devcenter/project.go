...
func NewProject(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20250401preview:Project"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20250701preview:Project"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20251001preview:Project"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20260101preview:Project"),
		},
	})
...
// Managed identity properties
func (o ProjectOutput) Identity() commontypesv4.ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v *Project) commontypesv4.ManagedServiceIdentityResponsePtrOutput { return v.Identity }).(commontypesv4.ManagedServiceIdentityResponsePtrOutput)
}
