...
func NewCatalog(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20251001preview:Catalog"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20260101preview:Catalog"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CatalogOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Catalog) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
