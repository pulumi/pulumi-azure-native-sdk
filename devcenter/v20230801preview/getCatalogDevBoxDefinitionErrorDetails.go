...
func GetCatalogDevBoxDefinitionErrorDetails(ctx *pulumi.Context, args *GetCatalogDevBoxDefinitionErrorDetailsArgs, opts ...pulumi.InvokeOption) (*GetCatalogDevBoxDefinitionErrorDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20230801preview:getCatalogDevBoxDefinitionErrorDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetCatalogDevBoxDefinitionErrorDetailsOutput(ctx *pulumi.Context, args GetCatalogDevBoxDefinitionErrorDetailsOutputArgs, opts ...pulumi.InvokeOption) GetCatalogDevBoxDefinitionErrorDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetCatalogDevBoxDefinitionErrorDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20230801preview:getCatalogDevBoxDefinitionErrorDetails", args, GetCatalogDevBoxDefinitionErrorDetailsResultOutput{}, options).(GetCatalogDevBoxDefinitionErrorDetailsResultOutput), nil
