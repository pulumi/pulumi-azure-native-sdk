...
func GetCatalogSyncErrorDetails(ctx *pulumi.Context, args *GetCatalogSyncErrorDetailsArgs, opts ...pulumi.InvokeOption) (*GetCatalogSyncErrorDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20240201:getCatalogSyncErrorDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetCatalogSyncErrorDetailsOutput(ctx *pulumi.Context, args GetCatalogSyncErrorDetailsOutputArgs, opts ...pulumi.InvokeOption) GetCatalogSyncErrorDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetCatalogSyncErrorDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20240201:getCatalogSyncErrorDetails", args, GetCatalogSyncErrorDetailsResultOutput{}, options).(GetCatalogSyncErrorDetailsResultOutput), nil
