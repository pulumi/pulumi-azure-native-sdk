...
// PoolDevBoxDefinitionInput is an input type that accepts PoolDevBoxDefinitionArgs and PoolDevBoxDefinitionOutput values.
// You can construct a concrete instance of `PoolDevBoxDefinitionInput` via:
//
//	PoolDevBoxDefinitionArgs{...}
type PoolDevBoxDefinitionInput interface {
	pulumi.Input

	ToPoolDevBoxDefinitionOutput() PoolDevBoxDefinitionOutput
	ToPoolDevBoxDefinitionOutputWithContext(context.Context) PoolDevBoxDefinitionOutput
}

// Represents a definition for a Developer Machine.
type PoolDevBoxDefinitionArgs struct {
	// Image reference information.
...
func (PoolDevBoxDefinitionArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*PoolDevBoxDefinition)(nil)).Elem()
}

func (i PoolDevBoxDefinitionArgs) ToPoolDevBoxDefinitionOutput() PoolDevBoxDefinitionOutput {
	return i.ToPoolDevBoxDefinitionOutputWithContext(context.Background())
}

func (i PoolDevBoxDefinitionArgs) ToPoolDevBoxDefinitionOutputWithContext(ctx context.Context) PoolDevBoxDefinitionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PoolDevBoxDefinitionOutput)
}

func (i PoolDevBoxDefinitionArgs) ToPoolDevBoxDefinitionPtrOutput() PoolDevBoxDefinitionPtrOutput {
	return i.ToPoolDevBoxDefinitionPtrOutputWithContext(context.Background())
}

func (i PoolDevBoxDefinitionArgs) ToPoolDevBoxDefinitionPtrOutputWithContext(ctx context.Context) PoolDevBoxDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PoolDevBoxDefinitionOutput).ToPoolDevBoxDefinitionPtrOutputWithContext(ctx)
}

// PoolDevBoxDefinitionPtrInput is an input type that accepts PoolDevBoxDefinitionArgs, PoolDevBoxDefinitionPtr and PoolDevBoxDefinitionPtrOutput values.
// You can construct a concrete instance of `PoolDevBoxDefinitionPtrInput` via:
//
//	        PoolDevBoxDefinitionArgs{...}
//
//	or:
//
//	        nil
type PoolDevBoxDefinitionPtrInput interface {
	pulumi.Input

	ToPoolDevBoxDefinitionPtrOutput() PoolDevBoxDefinitionPtrOutput
	ToPoolDevBoxDefinitionPtrOutputWithContext(context.Context) PoolDevBoxDefinitionPtrOutput
}

type poolDevBoxDefinitionPtrType PoolDevBoxDefinitionArgs

func PoolDevBoxDefinitionPtr(v *PoolDevBoxDefinitionArgs) PoolDevBoxDefinitionPtrInput {
	return (*poolDevBoxDefinitionPtrType)(v)
}

func (*poolDevBoxDefinitionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PoolDevBoxDefinition)(nil)).Elem()
}

func (i *poolDevBoxDefinitionPtrType) ToPoolDevBoxDefinitionPtrOutput() PoolDevBoxDefinitionPtrOutput {
	return i.ToPoolDevBoxDefinitionPtrOutputWithContext(context.Background())
}

func (i *poolDevBoxDefinitionPtrType) ToPoolDevBoxDefinitionPtrOutputWithContext(ctx context.Context) PoolDevBoxDefinitionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PoolDevBoxDefinitionPtrOutput)
}

// Represents a definition for a Developer Machine.
type PoolDevBoxDefinitionOutput struct{ *pulumi.OutputState }

func (PoolDevBoxDefinitionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PoolDevBoxDefinition)(nil)).Elem()
}

func (o PoolDevBoxDefinitionOutput) ToPoolDevBoxDefinitionOutput() PoolDevBoxDefinitionOutput {
	return o
}

func (o PoolDevBoxDefinitionOutput) ToPoolDevBoxDefinitionOutputWithContext(ctx context.Context) PoolDevBoxDefinitionOutput {
	return o
}

func (o PoolDevBoxDefinitionOutput) ToPoolDevBoxDefinitionPtrOutput() PoolDevBoxDefinitionPtrOutput {
	return o.ToPoolDevBoxDefinitionPtrOutputWithContext(context.Background())
}

func (o PoolDevBoxDefinitionOutput) ToPoolDevBoxDefinitionPtrOutputWithContext(ctx context.Context) PoolDevBoxDefinitionPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v PoolDevBoxDefinition) *PoolDevBoxDefinition {
		return &v
	}).(PoolDevBoxDefinitionPtrOutput)
}

// Image reference information.
func (o PoolDevBoxDefinitionOutput) ImageReference() ImageReferencePtrOutput {
	return o.ApplyT(func(v PoolDevBoxDefinition) *ImageReference { return v.ImageReference }).(ImageReferencePtrOutput)
}

// The SKU for Dev Boxes created from the Pool.
func (o PoolDevBoxDefinitionOutput) Sku() SkuPtrOutput {
	return o.ApplyT(func(v PoolDevBoxDefinition) *Sku { return v.Sku }).(SkuPtrOutput)
}

type PoolDevBoxDefinitionPtrOutput struct{ *pulumi.OutputState }

func (PoolDevBoxDefinitionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PoolDevBoxDefinition)(nil)).Elem()
}

func (o PoolDevBoxDefinitionPtrOutput) ToPoolDevBoxDefinitionPtrOutput() PoolDevBoxDefinitionPtrOutput {
	return o
}

func (o PoolDevBoxDefinitionPtrOutput) ToPoolDevBoxDefinitionPtrOutputWithContext(ctx context.Context) PoolDevBoxDefinitionPtrOutput {
	return o
}

func (o PoolDevBoxDefinitionPtrOutput) Elem() PoolDevBoxDefinitionOutput {
	return o.ApplyT(func(v *PoolDevBoxDefinition) PoolDevBoxDefinition {
		if v != nil {
			return *v
		}
		var ret PoolDevBoxDefinition
		return ret
	}).(PoolDevBoxDefinitionOutput)
}

// Image reference information.
func (o PoolDevBoxDefinitionPtrOutput) ImageReference() ImageReferencePtrOutput {
	return o.ApplyT(func(v *PoolDevBoxDefinition) *ImageReference {
		if v == nil {
			return nil
		}
...
// The SKU for Dev Boxes created from the Pool.
func (o PoolDevBoxDefinitionPtrOutput) Sku() SkuPtrOutput {
	return o.ApplyT(func(v *PoolDevBoxDefinition) *Sku {
		if v == nil {
			return nil
		}
		return v.Sku
...
// Represents a definition for a Developer Machine.
type PoolDevBoxDefinitionResponse struct {
...
// Represents a definition for a Developer Machine.
type PoolDevBoxDefinitionResponseOutput struct{ *pulumi.OutputState }

func (PoolDevBoxDefinitionResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PoolDevBoxDefinitionResponse)(nil)).Elem()
}

func (o PoolDevBoxDefinitionResponseOutput) ToPoolDevBoxDefinitionResponseOutput() PoolDevBoxDefinitionResponseOutput {
	return o
}

func (o PoolDevBoxDefinitionResponseOutput) ToPoolDevBoxDefinitionResponseOutputWithContext(ctx context.Context) PoolDevBoxDefinitionResponseOutput {
	return o
}

// Image reference information for the currently active image (only populated during updates).
func (o PoolDevBoxDefinitionResponseOutput) ActiveImageReference() ImageReferenceResponseOutput {
	return o.ApplyT(func(v PoolDevBoxDefinitionResponse) ImageReferenceResponse { return v.ActiveImageReference }).(ImageReferenceResponseOutput)
}

// Image reference information.
func (o PoolDevBoxDefinitionResponseOutput) ImageReference() ImageReferenceResponsePtrOutput {
	return o.ApplyT(func(v PoolDevBoxDefinitionResponse) *ImageReferenceResponse { return v.ImageReference }).(ImageReferenceResponsePtrOutput)
}

// The SKU for Dev Boxes created from the Pool.
func (o PoolDevBoxDefinitionResponseOutput) Sku() SkuResponsePtrOutput {
	return o.ApplyT(func(v PoolDevBoxDefinitionResponse) *SkuResponse { return v.Sku }).(SkuResponsePtrOutput)
}

type PoolDevBoxDefinitionResponsePtrOutput struct{ *pulumi.OutputState }

func (PoolDevBoxDefinitionResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PoolDevBoxDefinitionResponse)(nil)).Elem()
}

func (o PoolDevBoxDefinitionResponsePtrOutput) ToPoolDevBoxDefinitionResponsePtrOutput() PoolDevBoxDefinitionResponsePtrOutput {
	return o
}

func (o PoolDevBoxDefinitionResponsePtrOutput) ToPoolDevBoxDefinitionResponsePtrOutputWithContext(ctx context.Context) PoolDevBoxDefinitionResponsePtrOutput {
	return o
}

func (o PoolDevBoxDefinitionResponsePtrOutput) Elem() PoolDevBoxDefinitionResponseOutput {
	return o.ApplyT(func(v *PoolDevBoxDefinitionResponse) PoolDevBoxDefinitionResponse {
		if v != nil {
			return *v
		}
		var ret PoolDevBoxDefinitionResponse
		return ret
	}).(PoolDevBoxDefinitionResponseOutput)
}

// Image reference information for the currently active image (only populated during updates).
func (o PoolDevBoxDefinitionResponsePtrOutput) ActiveImageReference() ImageReferenceResponsePtrOutput {
	return o.ApplyT(func(v *PoolDevBoxDefinitionResponse) *ImageReferenceResponse {
		if v == nil {
			return nil
		}
		return &v.ActiveImageReference
	}).(ImageReferenceResponsePtrOutput)
}

// Image reference information.
func (o PoolDevBoxDefinitionResponsePtrOutput) ImageReference() ImageReferenceResponsePtrOutput {
	return o.ApplyT(func(v *PoolDevBoxDefinitionResponse) *ImageReferenceResponse {
		if v == nil {
			return nil
		}
...
// The SKU for Dev Boxes created from the Pool.
func (o PoolDevBoxDefinitionResponsePtrOutput) Sku() SkuResponsePtrOutput {
	return o.ApplyT(func(v *PoolDevBoxDefinitionResponse) *SkuResponse {
		if v == nil {
			return nil
		}
		return v.Sku
...
// Policy action to be taken on the resources. This is optional, and defaults to allow
func (o ResourcePolicyOutput) Action() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourcePolicy) *string { return v.Action }).(pulumi.StringPtrOutput)
}
...
// Optional. The resource type being restricted or allowed by a project policy. Used with a given action to restrict or allow access to a resource type.
func (o ResourcePolicyOutput) ResourceType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourcePolicy) *string { return v.ResourceType }).(pulumi.StringPtrOutput)
}
...
// Policy action to be taken on the resources. This is optional, and defaults to allow
func (o ResourcePolicyResponseOutput) Action() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourcePolicyResponse) *string { return v.Action }).(pulumi.StringPtrOutput)
}
...
// Optional. The resource type being restricted or allowed by a project policy. Used with a given action to restrict or allow access to a resource type.
func (o ResourcePolicyResponseOutput) ResourceType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourcePolicyResponse) *string { return v.ResourceType }).(pulumi.StringPtrOutput)
}
...
// StopOnNoConnectConfigurationInput is an input type that accepts StopOnNoConnectConfigurationArgs and StopOnNoConnectConfigurationOutput values.
// You can construct a concrete instance of `StopOnNoConnectConfigurationInput` via:
//
//	StopOnNoConnectConfigurationArgs{...}
type StopOnNoConnectConfigurationInput interface {
	pulumi.Input

	ToStopOnNoConnectConfigurationOutput() StopOnNoConnectConfigurationOutput
	ToStopOnNoConnectConfigurationOutputWithContext(context.Context) StopOnNoConnectConfigurationOutput
}

// Stop on no connect configuration settings for Dev Boxes created in this pool.
type StopOnNoConnectConfigurationArgs struct {
	// The specified time in minutes to wait before stopping a Dev Box if no connection is made.
	GracePeriodMinutes pulumi.IntPtrInput `pulumi:"gracePeriodMinutes"`
	// Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
	Status pulumi.StringPtrInput `pulumi:"status"`
...
func (StopOnNoConnectConfigurationArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*StopOnNoConnectConfiguration)(nil)).Elem()
}

func (i StopOnNoConnectConfigurationArgs) ToStopOnNoConnectConfigurationOutput() StopOnNoConnectConfigurationOutput {
	return i.ToStopOnNoConnectConfigurationOutputWithContext(context.Background())
}

func (i StopOnNoConnectConfigurationArgs) ToStopOnNoConnectConfigurationOutputWithContext(ctx context.Context) StopOnNoConnectConfigurationOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StopOnNoConnectConfigurationOutput)
}

func (i StopOnNoConnectConfigurationArgs) ToStopOnNoConnectConfigurationPtrOutput() StopOnNoConnectConfigurationPtrOutput {
	return i.ToStopOnNoConnectConfigurationPtrOutputWithContext(context.Background())
}

func (i StopOnNoConnectConfigurationArgs) ToStopOnNoConnectConfigurationPtrOutputWithContext(ctx context.Context) StopOnNoConnectConfigurationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StopOnNoConnectConfigurationOutput).ToStopOnNoConnectConfigurationPtrOutputWithContext(ctx)
}

// StopOnNoConnectConfigurationPtrInput is an input type that accepts StopOnNoConnectConfigurationArgs, StopOnNoConnectConfigurationPtr and StopOnNoConnectConfigurationPtrOutput values.
// You can construct a concrete instance of `StopOnNoConnectConfigurationPtrInput` via:
//
//	        StopOnNoConnectConfigurationArgs{...}
//
//	or:
//
//	        nil
type StopOnNoConnectConfigurationPtrInput interface {
	pulumi.Input

	ToStopOnNoConnectConfigurationPtrOutput() StopOnNoConnectConfigurationPtrOutput
	ToStopOnNoConnectConfigurationPtrOutputWithContext(context.Context) StopOnNoConnectConfigurationPtrOutput
}

type stopOnNoConnectConfigurationPtrType StopOnNoConnectConfigurationArgs

func StopOnNoConnectConfigurationPtr(v *StopOnNoConnectConfigurationArgs) StopOnNoConnectConfigurationPtrInput {
	return (*stopOnNoConnectConfigurationPtrType)(v)
}

func (*stopOnNoConnectConfigurationPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**StopOnNoConnectConfiguration)(nil)).Elem()
}

func (i *stopOnNoConnectConfigurationPtrType) ToStopOnNoConnectConfigurationPtrOutput() StopOnNoConnectConfigurationPtrOutput {
	return i.ToStopOnNoConnectConfigurationPtrOutputWithContext(context.Background())
}

func (i *stopOnNoConnectConfigurationPtrType) ToStopOnNoConnectConfigurationPtrOutputWithContext(ctx context.Context) StopOnNoConnectConfigurationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StopOnNoConnectConfigurationPtrOutput)
}

// Stop on no connect configuration settings for Dev Boxes created in this pool.
type StopOnNoConnectConfigurationOutput struct{ *pulumi.OutputState }

func (StopOnNoConnectConfigurationOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*StopOnNoConnectConfiguration)(nil)).Elem()
}

func (o StopOnNoConnectConfigurationOutput) ToStopOnNoConnectConfigurationOutput() StopOnNoConnectConfigurationOutput {
	return o
}

func (o StopOnNoConnectConfigurationOutput) ToStopOnNoConnectConfigurationOutputWithContext(ctx context.Context) StopOnNoConnectConfigurationOutput {
	return o
}

func (o StopOnNoConnectConfigurationOutput) ToStopOnNoConnectConfigurationPtrOutput() StopOnNoConnectConfigurationPtrOutput {
	return o.ToStopOnNoConnectConfigurationPtrOutputWithContext(context.Background())
}

func (o StopOnNoConnectConfigurationOutput) ToStopOnNoConnectConfigurationPtrOutputWithContext(ctx context.Context) StopOnNoConnectConfigurationPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v StopOnNoConnectConfiguration) *StopOnNoConnectConfiguration {
		return &v
	}).(StopOnNoConnectConfigurationPtrOutput)
}

// The specified time in minutes to wait before stopping a Dev Box if no connection is made.
func (o StopOnNoConnectConfigurationOutput) GracePeriodMinutes() pulumi.IntPtrOutput {
	return o.ApplyT(func(v StopOnNoConnectConfiguration) *int { return v.GracePeriodMinutes }).(pulumi.IntPtrOutput)
}

// Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
func (o StopOnNoConnectConfigurationOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v StopOnNoConnectConfiguration) *string { return v.Status }).(pulumi.StringPtrOutput)
}

type StopOnNoConnectConfigurationPtrOutput struct{ *pulumi.OutputState }

func (StopOnNoConnectConfigurationPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**StopOnNoConnectConfiguration)(nil)).Elem()
}

func (o StopOnNoConnectConfigurationPtrOutput) ToStopOnNoConnectConfigurationPtrOutput() StopOnNoConnectConfigurationPtrOutput {
	return o
}

func (o StopOnNoConnectConfigurationPtrOutput) ToStopOnNoConnectConfigurationPtrOutputWithContext(ctx context.Context) StopOnNoConnectConfigurationPtrOutput {
	return o
}

func (o StopOnNoConnectConfigurationPtrOutput) Elem() StopOnNoConnectConfigurationOutput {
	return o.ApplyT(func(v *StopOnNoConnectConfiguration) StopOnNoConnectConfiguration {
		if v != nil {
			return *v
		}
		var ret StopOnNoConnectConfiguration
		return ret
	}).(StopOnNoConnectConfigurationOutput)
}

// The specified time in minutes to wait before stopping a Dev Box if no connection is made.
func (o StopOnNoConnectConfigurationPtrOutput) GracePeriodMinutes() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *StopOnNoConnectConfiguration) *int {
		if v == nil {
			return nil
		}
		return v.GracePeriodMinutes
...
// Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
func (o StopOnNoConnectConfigurationPtrOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StopOnNoConnectConfiguration) *string {
		if v == nil {
			return nil
		}
		return v.Status
...
// Stop on no connect configuration settings for Dev Boxes created in this pool.
type StopOnNoConnectConfigurationResponse struct {
	// The specified time in minutes to wait before stopping a Dev Box if no connection is made.
	GracePeriodMinutes *int `pulumi:"gracePeriodMinutes"`
	// Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
	Status *string `pulumi:"status"`
...
// Stop on no connect configuration settings for Dev Boxes created in this pool.
type StopOnNoConnectConfigurationResponseOutput struct{ *pulumi.OutputState }

func (StopOnNoConnectConfigurationResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*StopOnNoConnectConfigurationResponse)(nil)).Elem()
}

func (o StopOnNoConnectConfigurationResponseOutput) ToStopOnNoConnectConfigurationResponseOutput() StopOnNoConnectConfigurationResponseOutput {
	return o
}

func (o StopOnNoConnectConfigurationResponseOutput) ToStopOnNoConnectConfigurationResponseOutputWithContext(ctx context.Context) StopOnNoConnectConfigurationResponseOutput {
	return o
}

// The specified time in minutes to wait before stopping a Dev Box if no connection is made.
func (o StopOnNoConnectConfigurationResponseOutput) GracePeriodMinutes() pulumi.IntPtrOutput {
	return o.ApplyT(func(v StopOnNoConnectConfigurationResponse) *int { return v.GracePeriodMinutes }).(pulumi.IntPtrOutput)
}

// Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
func (o StopOnNoConnectConfigurationResponseOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v StopOnNoConnectConfigurationResponse) *string { return v.Status }).(pulumi.StringPtrOutput)
}

type StopOnNoConnectConfigurationResponsePtrOutput struct{ *pulumi.OutputState }

func (StopOnNoConnectConfigurationResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**StopOnNoConnectConfigurationResponse)(nil)).Elem()
}

func (o StopOnNoConnectConfigurationResponsePtrOutput) ToStopOnNoConnectConfigurationResponsePtrOutput() StopOnNoConnectConfigurationResponsePtrOutput {
	return o
}

func (o StopOnNoConnectConfigurationResponsePtrOutput) ToStopOnNoConnectConfigurationResponsePtrOutputWithContext(ctx context.Context) StopOnNoConnectConfigurationResponsePtrOutput {
	return o
}

func (o StopOnNoConnectConfigurationResponsePtrOutput) Elem() StopOnNoConnectConfigurationResponseOutput {
	return o.ApplyT(func(v *StopOnNoConnectConfigurationResponse) StopOnNoConnectConfigurationResponse {
		if v != nil {
			return *v
		}
		var ret StopOnNoConnectConfigurationResponse
		return ret
	}).(StopOnNoConnectConfigurationResponseOutput)
}

// The specified time in minutes to wait before stopping a Dev Box if no connection is made.
func (o StopOnNoConnectConfigurationResponsePtrOutput) GracePeriodMinutes() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *StopOnNoConnectConfigurationResponse) *int {
		if v == nil {
			return nil
		}
		return v.GracePeriodMinutes
...
// Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
func (o StopOnNoConnectConfigurationResponsePtrOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StopOnNoConnectConfigurationResponse) *string {
		if v == nil {
			return nil
		}
		return v.Status
...
func init() {
	...
	pulumi.RegisterOutputType(PoolDevBoxDefinitionOutput{})
	pulumi.RegisterOutputType(PoolDevBoxDefinitionPtrOutput{})
	pulumi.RegisterOutputType(PoolDevBoxDefinitionResponseOutput{})
	pulumi.RegisterOutputType(PoolDevBoxDefinitionResponsePtrOutput{})
	...
	pulumi.RegisterOutputType(StopOnNoConnectConfigurationOutput{})
	pulumi.RegisterOutputType(StopOnNoConnectConfigurationPtrOutput{})
	pulumi.RegisterOutputType(StopOnNoConnectConfigurationResponseOutput{})
	pulumi.RegisterOutputType(StopOnNoConnectConfigurationResponsePtrOutput{})
