...
func NewDevBoxDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20251001preview:DevBoxDefinition"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20260101preview:DevBoxDefinition"),
		},
	})
