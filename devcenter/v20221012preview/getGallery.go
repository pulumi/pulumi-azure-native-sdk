...
// Gets a gallery
//
// Deprecated: azure-native:devcenter/v20221012preview:Gallery is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:Gallery to guarantee forwards compatibility.
func LookupGallery(ctx *pulumi.Context, args *LookupGalleryArgs, opts ...pulumi.InvokeOption) (*LookupGalleryResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20221012preview:getGallery", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
