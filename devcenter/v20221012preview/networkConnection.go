...
//
// Deprecated: azure-native:devcenter/v20221012preview:NetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:NetworkConnection to guarantee forwards compatibility.
...
func NewNetworkConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20221012preview:NetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnection(ctx *pulumi.Context,
	...
	var resource NetworkConnection
	err := ctx.ReadResource("azure-native:devcenter/v20221012preview:NetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
