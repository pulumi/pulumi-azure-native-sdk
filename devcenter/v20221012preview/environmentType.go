...
//
// Deprecated: azure-native:devcenter/v20221012preview:EnvironmentType is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:EnvironmentType to guarantee forwards compatibility.
...
func NewEnvironmentType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20221012preview:EnvironmentType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentType(ctx *pulumi.Context,
	...
	var resource EnvironmentType
	err := ctx.ReadResource("azure-native:devcenter/v20221012preview:EnvironmentType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
