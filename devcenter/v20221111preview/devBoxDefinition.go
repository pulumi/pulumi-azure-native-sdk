...
func NewDevBoxDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20221111preview:DevBoxDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevBoxDefinition(ctx *pulumi.Context,
	...
	var resource DevBoxDefinition
	err := ctx.ReadResource("azure-native:devcenter/v20221111preview:DevBoxDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
