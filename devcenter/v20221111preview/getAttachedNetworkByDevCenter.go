...
//
// Deprecated: azure-native:devcenter/v20221111preview:AttachedNetworkByDevCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:AttachedNetworkByDevCenter to guarantee forwards compatibility.
func LookupAttachedNetworkByDevCenter(ctx *pulumi.Context, args *LookupAttachedNetworkByDevCenterArgs, opts ...pulumi.InvokeOption) (*LookupAttachedNetworkByDevCenterResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20221111preview:getAttachedNetworkByDevCenter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
