...
func NewAttachedNetworkByDevCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20221111preview:AttachedNetworkByDevCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachedNetworkByDevCenter(ctx *pulumi.Context,
	...
	var resource AttachedNetworkByDevCenter
	err := ctx.ReadResource("azure-native:devcenter/v20221111preview:AttachedNetworkByDevCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
