...
func NewProjectEnvironmentType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20240801preview:ProjectEnvironmentType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectEnvironmentType(ctx *pulumi.Context,
	...
	var resource ProjectEnvironmentType
	err := ctx.ReadResource("azure-native:devcenter/v20240801preview:ProjectEnvironmentType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
