...
func LookupSchedule(ctx *pulumi.Context, args *LookupScheduleArgs, opts ...pulumi.InvokeOption) (*LookupScheduleResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20240801preview:getSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupScheduleOutput(ctx *pulumi.Context, args LookupScheduleOutputArgs, opts ...pulumi.InvokeOption) LookupScheduleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScheduleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20240801preview:getSchedule", args, LookupScheduleResultOutput{}, options).(LookupScheduleResultOutput), nil
