...
func LookupDevCenter(ctx *pulumi.Context, args *LookupDevCenterArgs, opts ...pulumi.InvokeOption) (*LookupDevCenterResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20240801preview:getDevCenter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDevCenterOutput(ctx *pulumi.Context, args LookupDevCenterOutputArgs, opts ...pulumi.InvokeOption) LookupDevCenterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDevCenterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20240801preview:getDevCenter", args, LookupDevCenterResultOutput{}, options).(LookupDevCenterResultOutput), nil
...
// Indicates the resource types that are restricted from being accessed by a project unless allowed by a curation profile.
func (o LookupDevCenterResultOutput) RestrictedResourceTypes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupDevCenterResult) []string { return v.RestrictedResourceTypes }).(pulumi.StringArrayOutput)
}
