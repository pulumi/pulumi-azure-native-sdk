...
func NewNetworkConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20240501preview:NetworkConnection"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240601preview:NetworkConnection"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20240701preview:NetworkConnection"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20241001preview:NetworkConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:devcenter/v20240801preview:NetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnection(ctx *pulumi.Context,
	...
	var resource NetworkConnection
	err := ctx.ReadResource("azure-native:devcenter/v20240801preview:NetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
