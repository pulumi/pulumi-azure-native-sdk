...
func LookupProjectEnvironmentTypeOutput(ctx *pulumi.Context, args LookupProjectEnvironmentTypeOutputArgs, opts ...pulumi.InvokeOption) LookupProjectEnvironmentTypeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupProjectEnvironmentTypeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter:getProjectEnvironmentType", args, LookupProjectEnvironmentTypeResultOutput{}, options).(LookupProjectEnvironmentTypeResultOutput), nil
...
// Managed identity properties
func (o LookupProjectEnvironmentTypeResultOutput) Identity() commontypesv4.ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupProjectEnvironmentTypeResult) *commontypesv4.ManagedServiceIdentityResponse {
		return v.Identity
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupProjectEnvironmentTypeResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupProjectEnvironmentTypeResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
