...
func NewDevCenter(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20250401preview:DevCenter"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20250701preview:DevCenter"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20251001preview:DevCenter"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20260101preview:DevCenter"),
		},
	})
