...
func NewEncryptionSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20240701preview:EncryptionSet"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:devcenter/v20251001preview:EncryptionSet"),
		},
		{
			Type: pulumi.String("azure-native:devcenter/v20260101preview:EncryptionSet"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EncryptionSet
	err := ctx.RegisterResource("azure-native:devcenter:EncryptionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEncryptionSet(ctx *pulumi.Context,
	...
	var resource EncryptionSet
	err := ctx.ReadResource("azure-native:devcenter:EncryptionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
