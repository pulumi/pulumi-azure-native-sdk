...
func LookupEncryptionSet(ctx *pulumi.Context, args *LookupEncryptionSetArgs, opts ...pulumi.InvokeOption) (*LookupEncryptionSetResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20240501preview:getEncryptionSet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEncryptionSetOutput(ctx *pulumi.Context, args LookupEncryptionSetOutputArgs, opts ...pulumi.InvokeOption) LookupEncryptionSetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEncryptionSetResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20240501preview:getEncryptionSet", args, LookupEncryptionSetResultOutput{}, options).(LookupEncryptionSetResultOutput), nil
