...
func GetProjectCatalogSyncErrorDetails(ctx *pulumi.Context, args *GetProjectCatalogSyncErrorDetailsArgs, opts ...pulumi.InvokeOption) (*GetProjectCatalogSyncErrorDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:devcenter/v20240501preview:getProjectCatalogSyncErrorDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetProjectCatalogSyncErrorDetailsOutput(ctx *pulumi.Context, args GetProjectCatalogSyncErrorDetailsOutputArgs, opts ...pulumi.InvokeOption) GetProjectCatalogSyncErrorDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetProjectCatalogSyncErrorDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devcenter/v20240501preview:getProjectCatalogSyncErrorDetails", args, GetProjectCatalogSyncErrorDetailsResultOutput{}, options).(GetProjectCatalogSyncErrorDetailsResultOutput), nil
