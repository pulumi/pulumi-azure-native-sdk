...
func NewGrafana(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dashboard/v20231001preview:Grafana", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGrafana(ctx *pulumi.Context,
	...
	var resource Grafana
	err := ctx.ReadResource("azure-native:dashboard/v20231001preview:Grafana", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
