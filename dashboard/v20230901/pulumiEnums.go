...
func (in *marketplaceAutoRenewPtr) ToOutput(ctx context.Context) pulumix.Output[*MarketplaceAutoRenew] {
	return pulumix.Output[*MarketplaceAutoRenew]{
		OutputState: in.ToMarketplaceAutoRenewPtrOutputWithContext(ctx).OutputState,
	}
}
...
func (in *startTLSPolicyPtr) ToOutput(ctx context.Context) pulumix.Output[*StartTLSPolicy] {
	return pulumix.Output[*StartTLSPolicy]{
		OutputState: in.ToStartTLSPolicyPtrOutputWithContext(ctx).OutputState,
	}
}
