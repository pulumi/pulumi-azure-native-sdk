...
func NewIntegrationFabric(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dashboard/v20241001:IntegrationFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationFabric(ctx *pulumi.Context,
	...
	var resource IntegrationFabric
	err := ctx.ReadResource("azure-native:dashboard/v20241001:IntegrationFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
