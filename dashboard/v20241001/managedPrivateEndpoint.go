...
func NewManagedPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dashboard/v20241001:ManagedPrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource ManagedPrivateEndpoint
	err := ctx.ReadResource("azure-native:dashboard/v20241001:ManagedPrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
