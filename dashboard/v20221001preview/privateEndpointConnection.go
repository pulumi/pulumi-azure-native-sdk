...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dashboard/v20230901:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:dashboard/v20231001preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:dashboard/v20241001:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:dashboard:PrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateEndpointConnection
	err := ctx.RegisterResource("azure-native:dashboard/v20221001preview:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:dashboard/v20221001preview:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
