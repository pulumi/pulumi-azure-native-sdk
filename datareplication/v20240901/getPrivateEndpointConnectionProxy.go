...
func LookupPrivateEndpointConnectionProxy(ctx *pulumi.Context, args *LookupPrivateEndpointConnectionProxyArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointConnectionProxyResult, error) {
	...
	err := ctx.Invoke("azure-native:datareplication/v20240901:getPrivateEndpointConnectionProxy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateEndpointConnectionProxyOutput(ctx *pulumi.Context, args LookupPrivateEndpointConnectionProxyOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateEndpointConnectionProxyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateEndpointConnectionProxyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datareplication/v20240901:getPrivateEndpointConnectionProxy", args, LookupPrivateEndpointConnectionProxyResultOutput{}, options).(LookupPrivateEndpointConnectionProxyResultOutput), nil
