...
func NewReplicationExtension(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:datareplication/v20260501:ReplicationExtension"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReplicationExtension
	err := ctx.RegisterResource("azure-native:datareplication:ReplicationExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplicationExtension(ctx *pulumi.Context,
	...
	var resource ReplicationExtension
	err := ctx.ReadResource("azure-native:datareplication:ReplicationExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ReplicationExtensionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ReplicationExtension) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
