...
func LookupReplicationExtension(ctx *pulumi.Context, args *LookupReplicationExtensionArgs, opts ...pulumi.InvokeOption) (*LookupReplicationExtensionResult, error) {
	...
	err := ctx.Invoke("azure-native:datareplication/v20210216preview:getReplicationExtension", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReplicationExtensionOutput(ctx *pulumi.Context, args LookupReplicationExtensionOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationExtensionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReplicationExtensionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datareplication/v20210216preview:getReplicationExtension", args, LookupReplicationExtensionResultOutput{}, options).(LookupReplicationExtensionResultOutput), nil
