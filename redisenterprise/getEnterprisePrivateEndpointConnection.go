...
func LookupEnterprisePrivateEndpointConnection(ctx *pulumi.Context, args *LookupEnterprisePrivateEndpointConnectionArgs, opts ...pulumi.InvokeOption) (*LookupEnterprisePrivateEndpointConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:redisenterprise:getEnterprisePrivateEndpointConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEnterprisePrivateEndpointConnectionOutput(ctx *pulumi.Context, args LookupEnterprisePrivateEndpointConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupEnterprisePrivateEndpointConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEnterprisePrivateEndpointConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:redisenterprise:getEnterprisePrivateEndpointConnection", args, LookupEnterprisePrivateEndpointConnectionResultOutput{}, options).(LookupEnterprisePrivateEndpointConnectionResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupEnterprisePrivateEndpointConnectionResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupEnterprisePrivateEndpointConnectionResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
