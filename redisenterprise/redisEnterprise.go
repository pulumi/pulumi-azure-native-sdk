...
func NewRedisEnterprise(ctx *pulumi.Context,
	...
	if args.PublicNetworkAccess == nil {
		return nil, errors.New("invalid value for required argument 'PublicNetworkAccess'")
	}
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:redisenterprise/v20250701:RedisEnterprise"),
		},
		{
			Type: pulumi.String("azure-native:redisenterprise/v20250801preview:RedisEnterprise"),
		},
		{
			Type: pulumi.String("azure-native:redisenterprise/v20260201preview:RedisEnterprise"),
		},
		{
			Type: pulumi.String("azure-native:redisenterprise/v20260501preview:RedisEnterprise"),
		},
	})
...
type RedisEnterpriseArgs struct {
	...
	// Whether or not public network traffic can access the Redis cluster. Only 'Enabled' or 'Disabled' can be set. null is returned only for clusters created using an old API version which do not have this property and cannot be set.
	PublicNetworkAccess pulumi.StringInput
	// The name of the resource group. The name is case insensitive.
...
// Whether or not public network traffic can access the Redis cluster. Only 'Enabled' or 'Disabled' can be set. null is returned only for clusters created using an old API version which do not have this property and cannot be set.
func (o RedisEnterpriseOutput) PublicNetworkAccess() pulumi.StringOutput {
	return o.ApplyT(func(v *RedisEnterprise) pulumi.StringOutput { return v.PublicNetworkAccess }).(pulumi.StringOutput)
}
