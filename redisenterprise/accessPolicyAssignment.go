...
func NewAccessPolicyAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:redisenterprise/v20250701:AccessPolicyAssignment"),
		},
		{
			Type: pulumi.String("azure-native:redisenterprise/v20250801preview:AccessPolicyAssignment"),
		},
		{
			Type: pulumi.String("azure-native:redisenterprise/v20260201preview:AccessPolicyAssignment"),
		},
		{
			Type: pulumi.String("azure-native:redisenterprise/v20260501preview:AccessPolicyAssignment"),
		},
	})
