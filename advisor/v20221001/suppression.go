...
//
// Deprecated: azure-native:advisor/v20221001:Suppression is being removed in the next major version of this provider. Upgrade to at least azure-native:advisor/v20230101:Suppression to guarantee forwards compatibility.
...
func NewSuppression(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:advisor/v20221001:Suppression", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSuppression(ctx *pulumi.Context,
	...
	var resource Suppression
	err := ctx.ReadResource("azure-native:advisor/v20221001:Suppression", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
