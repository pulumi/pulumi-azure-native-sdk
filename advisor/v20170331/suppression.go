...
func NewSuppression(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:advisor/v20170331:Suppression", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSuppression(ctx *pulumi.Context,
	...
	var resource Suppression
	err := ctx.ReadResource("azure-native:advisor/v20170331:Suppression", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
