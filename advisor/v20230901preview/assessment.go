...
func NewAssessment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:advisor:Assessment"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Assessment
	err := ctx.RegisterResource("azure-native:advisor/v20230901preview:Assessment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssessment(ctx *pulumi.Context,
	...
	var resource Assessment
	err := ctx.ReadResource("azure-native:advisor/v20230901preview:Assessment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
