...
func LookupSuppression(ctx *pulumi.Context, args *LookupSuppressionArgs, opts ...pulumi.InvokeOption) (*LookupSuppressionResult, error) {
	...
	err := ctx.Invoke("azure-native:advisor/v20230901preview:getSuppression", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSuppressionOutput(ctx *pulumi.Context, args LookupSuppressionOutputArgs, opts ...pulumi.InvokeOption) LookupSuppressionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSuppressionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:advisor/v20230901preview:getSuppression", args, LookupSuppressionResultOutput{}, options).(LookupSuppressionResultOutput), nil
