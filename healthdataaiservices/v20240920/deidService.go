...
func NewDeidService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:healthdataaiservices/v20240920:DeidService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeidService(ctx *pulumi.Context,
	...
	var resource DeidService
	err := ctx.ReadResource("azure-native:healthdataaiservices/v20240920:DeidService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
