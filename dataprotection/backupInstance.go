...
func NewBackupInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20250701:BackupInstance"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250901:BackupInstance"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20260301:BackupInstance"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20260401preview:BackupInstance"),
		},
	})
