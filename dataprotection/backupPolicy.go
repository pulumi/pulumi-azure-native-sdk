...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20230801preview:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20231101:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20231201:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20240201preview:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20240301:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20240401:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250101:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250201:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250701:BackupPolicy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250901:BackupPolicy"),
		},
	})
...
// Metadata pertaining to creation and last modification of the resource.
func (o BackupPolicyOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *BackupPolicy) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
