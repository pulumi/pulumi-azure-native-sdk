...
// Deprecated: azure-native:dataprotection/v20221201:ResourceGuard is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:ResourceGuard to guarantee forwards compatibility.
func LookupResourceGuard(ctx *pulumi.Context, args *LookupResourceGuardArgs, opts ...pulumi.InvokeOption) (*LookupResourceGuardResult, error) {
	...
	err := ctx.Invoke("azure-native:dataprotection/v20221201:getResourceGuard", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
