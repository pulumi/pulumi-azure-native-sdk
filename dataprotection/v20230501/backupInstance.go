...
func NewBackupInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20240301:BackupInstance"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20240401:BackupInstance"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250101:BackupInstance"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250201:BackupInstance"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dataprotection/v20230501:BackupInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupInstance(ctx *pulumi.Context,
	...
	var resource BackupInstance
	err := ctx.ReadResource("azure-native:dataprotection/v20230501:BackupInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
