...
func LookupDppResourceGuardProxy(ctx *pulumi.Context, args *LookupDppResourceGuardProxyArgs, opts ...pulumi.InvokeOption) (*LookupDppResourceGuardProxyResult, error) {
	...
	err := ctx.Invoke("azure-native:dataprotection/v20240401:getDppResourceGuardProxy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDppResourceGuardProxyOutput(ctx *pulumi.Context, args LookupDppResourceGuardProxyOutputArgs, opts ...pulumi.InvokeOption) LookupDppResourceGuardProxyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDppResourceGuardProxyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dataprotection/v20240401:getDppResourceGuardProxy", args, LookupDppResourceGuardProxyResultOutput{}, options).(LookupDppResourceGuardProxyResultOutput), nil
