...
func NewBackupVault(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20240401:BackupVault"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250101:BackupVault"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250201:BackupVault"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250701:BackupVault"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250901:BackupVault"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BackupVault
	err := ctx.RegisterResource("azure-native:dataprotection:BackupVault", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupVault(ctx *pulumi.Context,
	...
	var resource BackupVault
	err := ctx.ReadResource("azure-native:dataprotection:BackupVault", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o BackupVaultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *BackupVault) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Metadata pertaining to creation and last modification of the resource.
func (o BackupVaultOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *BackupVault) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
