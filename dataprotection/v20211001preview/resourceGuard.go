...
func NewResourceGuard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dataprotection/v20211001preview:ResourceGuard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceGuard(ctx *pulumi.Context,
	...
	var resource ResourceGuard
	err := ctx.ReadResource("azure-native:dataprotection/v20211001preview:ResourceGuard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
