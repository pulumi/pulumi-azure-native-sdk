...
//
// Deprecated: azure-native:dataprotection/v20220301:BackupInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupInstance to guarantee forwards compatibility.
func LookupBackupInstance(ctx *pulumi.Context, args *LookupBackupInstanceArgs, opts ...pulumi.InvokeOption) (*LookupBackupInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:dataprotection/v20220301:getBackupInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
