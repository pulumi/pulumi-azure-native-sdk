...
func LookupBackupInstance(ctx *pulumi.Context, args *LookupBackupInstanceArgs, opts ...pulumi.InvokeOption) (*LookupBackupInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:dataprotection/v20230801preview:getBackupInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBackupInstanceOutput(ctx *pulumi.Context, args LookupBackupInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupBackupInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBackupInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dataprotection/v20230801preview:getBackupInstance", args, LookupBackupInstanceResultOutput{}, options).(LookupBackupInstanceResultOutput), nil
