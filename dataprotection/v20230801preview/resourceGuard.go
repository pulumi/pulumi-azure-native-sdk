...
func NewResourceGuard(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20240301:ResourceGuard"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20240401:ResourceGuard"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250101:ResourceGuard"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dataprotection/v20230801preview:ResourceGuard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceGuard(ctx *pulumi.Context,
	...
	var resource ResourceGuard
	err := ctx.ReadResource("azure-native:dataprotection/v20230801preview:ResourceGuard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
