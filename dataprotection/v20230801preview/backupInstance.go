...
func NewBackupInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dataprotection/v20230801preview:BackupInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupInstance(ctx *pulumi.Context,
	...
	var resource BackupInstance
	err := ctx.ReadResource("azure-native:dataprotection/v20230801preview:BackupInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
