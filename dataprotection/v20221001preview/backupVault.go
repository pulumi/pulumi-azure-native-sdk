...
func NewBackupVault(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dataprotection/v20221001preview:BackupVault", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupVault(ctx *pulumi.Context,
	...
	var resource BackupVault
	err := ctx.ReadResource("azure-native:dataprotection/v20221001preview:BackupVault", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
