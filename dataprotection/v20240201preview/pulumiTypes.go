...
type GenericBackupDatasourceParameters struct {
	...
	ResourceSelectors []string `pulumi:"resourceSelectors"`
}

// GenericBackupDatasourceParametersInput is an input type that accepts GenericBackupDatasourceParametersArgs and GenericBackupDatasourceParametersOutput values.
// You can construct a concrete instance of `GenericBackupDatasourceParametersInput` via:
//
//	GenericBackupDatasourceParametersArgs{...}
type GenericBackupDatasourceParametersInput interface {
	pulumi.Input

	ToGenericBackupDatasourceParametersOutput() GenericBackupDatasourceParametersOutput
	ToGenericBackupDatasourceParametersOutputWithContext(context.Context) GenericBackupDatasourceParametersOutput
}

// Generic parameters to be used during configuration of backup
type GenericBackupDatasourceParametersArgs struct {
	// Type of the specific object - used for deserializing
	// Expected value is 'GenericBackupDatasourceParameters'.
	ObjectType pulumi.StringInput `pulumi:"objectType"`
	// List of resource selectors to be backed up during configuration of backup
	ResourceSelectors pulumi.StringArrayInput `pulumi:"resourceSelectors"`
}

func (GenericBackupDatasourceParametersArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GenericBackupDatasourceParameters)(nil)).Elem()
}

func (i GenericBackupDatasourceParametersArgs) ToGenericBackupDatasourceParametersOutput() GenericBackupDatasourceParametersOutput {
	return i.ToGenericBackupDatasourceParametersOutputWithContext(context.Background())
}

func (i GenericBackupDatasourceParametersArgs) ToGenericBackupDatasourceParametersOutputWithContext(ctx context.Context) GenericBackupDatasourceParametersOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GenericBackupDatasourceParametersOutput)
}

// Generic parameters to be used during configuration of backup
type GenericBackupDatasourceParametersOutput struct{ *pulumi.OutputState }

func (GenericBackupDatasourceParametersOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GenericBackupDatasourceParameters)(nil)).Elem()
}

func (o GenericBackupDatasourceParametersOutput) ToGenericBackupDatasourceParametersOutput() GenericBackupDatasourceParametersOutput {
	return o
}

func (o GenericBackupDatasourceParametersOutput) ToGenericBackupDatasourceParametersOutputWithContext(ctx context.Context) GenericBackupDatasourceParametersOutput {
	return o
}

// Type of the specific object - used for deserializing
// Expected value is 'GenericBackupDatasourceParameters'.
func (o GenericBackupDatasourceParametersOutput) ObjectType() pulumi.StringOutput {
	return o.ApplyT(func(v GenericBackupDatasourceParameters) string { return v.ObjectType }).(pulumi.StringOutput)
}

// List of resource selectors to be backed up during configuration of backup
func (o GenericBackupDatasourceParametersOutput) ResourceSelectors() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GenericBackupDatasourceParameters) []string { return v.ResourceSelectors }).(pulumi.StringArrayOutput)
}

// Generic parameters to be used during configuration of backup
type GenericBackupDatasourceParametersResponse struct {
	// Type of the specific object - used for deserializing
	// Expected value is 'GenericBackupDatasourceParameters'.
	ObjectType string `pulumi:"objectType"`
	// List of resource selectors to be backed up during configuration of backup
...
// Generic parameters to be used during configuration of backup
type GenericBackupDatasourceParametersResponseOutput struct{ *pulumi.OutputState }

func (GenericBackupDatasourceParametersResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GenericBackupDatasourceParametersResponse)(nil)).Elem()
}

func (o GenericBackupDatasourceParametersResponseOutput) ToGenericBackupDatasourceParametersResponseOutput() GenericBackupDatasourceParametersResponseOutput {
	return o
}

func (o GenericBackupDatasourceParametersResponseOutput) ToGenericBackupDatasourceParametersResponseOutputWithContext(ctx context.Context) GenericBackupDatasourceParametersResponseOutput {
	return o
}

// Type of the specific object - used for deserializing
// Expected value is 'GenericBackupDatasourceParameters'.
func (o GenericBackupDatasourceParametersResponseOutput) ObjectType() pulumi.StringOutput {
	return o.ApplyT(func(v GenericBackupDatasourceParametersResponse) string { return v.ObjectType }).(pulumi.StringOutput)
}

// List of resource selectors to be backed up during configuration of backup
func (o GenericBackupDatasourceParametersResponseOutput) ResourceSelectors() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GenericBackupDatasourceParametersResponse) []string { return v.ResourceSelectors }).(pulumi.StringArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(GenericBackupDatasourceParametersOutput{})
	pulumi.RegisterOutputType(GenericBackupDatasourceParametersResponseOutput{})
