...
type AdlsBlobBackupDatasourceParameters struct {
	...
	// Type of the specific object - used for deserializing
	// Expected value is 'AdlsBlobBackupDatasourceParameters'.
	ObjectType string `pulumi:"objectType"`
}

// AdlsBlobBackupDatasourceParametersInput is an input type that accepts AdlsBlobBackupDatasourceParametersArgs and AdlsBlobBackupDatasourceParametersOutput values.
// You can construct a concrete instance of `AdlsBlobBackupDatasourceParametersInput` via:
//
//	AdlsBlobBackupDatasourceParametersArgs{...}
type AdlsBlobBackupDatasourceParametersInput interface {
	pulumi.Input

	ToAdlsBlobBackupDatasourceParametersOutput() AdlsBlobBackupDatasourceParametersOutput
	ToAdlsBlobBackupDatasourceParametersOutputWithContext(context.Context) AdlsBlobBackupDatasourceParametersOutput
}

// Parameters to be used during configuration of backup of azure data lake storage account blobs
type AdlsBlobBackupDatasourceParametersArgs struct {
	// List of containers to be backed up during configuration of backup of blobs
...
func (AdlsBlobBackupDatasourceParametersArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*AdlsBlobBackupDatasourceParameters)(nil)).Elem()
}

func (i AdlsBlobBackupDatasourceParametersArgs) ToAdlsBlobBackupDatasourceParametersOutput() AdlsBlobBackupDatasourceParametersOutput {
	return i.ToAdlsBlobBackupDatasourceParametersOutputWithContext(context.Background())
}

func (i AdlsBlobBackupDatasourceParametersArgs) ToAdlsBlobBackupDatasourceParametersOutputWithContext(ctx context.Context) AdlsBlobBackupDatasourceParametersOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AdlsBlobBackupDatasourceParametersOutput)
}

// Parameters to be used during configuration of backup of azure data lake storage account blobs
type AdlsBlobBackupDatasourceParametersOutput struct{ *pulumi.OutputState }

func (AdlsBlobBackupDatasourceParametersOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AdlsBlobBackupDatasourceParameters)(nil)).Elem()
}

func (o AdlsBlobBackupDatasourceParametersOutput) ToAdlsBlobBackupDatasourceParametersOutput() AdlsBlobBackupDatasourceParametersOutput {
	return o
}

func (o AdlsBlobBackupDatasourceParametersOutput) ToAdlsBlobBackupDatasourceParametersOutputWithContext(ctx context.Context) AdlsBlobBackupDatasourceParametersOutput {
	return o
}

// List of containers to be backed up during configuration of backup of blobs
func (o AdlsBlobBackupDatasourceParametersOutput) ContainersList() pulumi.StringArrayOutput {
	return o.ApplyT(func(v AdlsBlobBackupDatasourceParameters) []string { return v.ContainersList }).(pulumi.StringArrayOutput)
}

// Type of the specific object - used for deserializing
// Expected value is 'AdlsBlobBackupDatasourceParameters'.
func (o AdlsBlobBackupDatasourceParametersOutput) ObjectType() pulumi.StringOutput {
	return o.ApplyT(func(v AdlsBlobBackupDatasourceParameters) string { return v.ObjectType }).(pulumi.StringOutput)
}

// Parameters to be used during configuration of backup of azure data lake storage account blobs
type AdlsBlobBackupDatasourceParametersResponse struct {
	// List of containers to be backed up during configuration of backup of blobs
	ContainersList []string `pulumi:"containersList"`
	// Type of the specific object - used for deserializing
	// Expected value is 'AdlsBlobBackupDatasourceParameters'.
...
// Parameters to be used during configuration of backup of azure data lake storage account blobs
type AdlsBlobBackupDatasourceParametersResponseOutput struct{ *pulumi.OutputState }

func (AdlsBlobBackupDatasourceParametersResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AdlsBlobBackupDatasourceParametersResponse)(nil)).Elem()
}

func (o AdlsBlobBackupDatasourceParametersResponseOutput) ToAdlsBlobBackupDatasourceParametersResponseOutput() AdlsBlobBackupDatasourceParametersResponseOutput {
	return o
}

func (o AdlsBlobBackupDatasourceParametersResponseOutput) ToAdlsBlobBackupDatasourceParametersResponseOutputWithContext(ctx context.Context) AdlsBlobBackupDatasourceParametersResponseOutput {
	return o
}

// List of containers to be backed up during configuration of backup of blobs
func (o AdlsBlobBackupDatasourceParametersResponseOutput) ContainersList() pulumi.StringArrayOutput {
	return o.ApplyT(func(v AdlsBlobBackupDatasourceParametersResponse) []string { return v.ContainersList }).(pulumi.StringArrayOutput)
}

// Type of the specific object - used for deserializing
// Expected value is 'AdlsBlobBackupDatasourceParameters'.
func (o AdlsBlobBackupDatasourceParametersResponseOutput) ObjectType() pulumi.StringOutput {
	return o.ApplyT(func(v AdlsBlobBackupDatasourceParametersResponse) string { return v.ObjectType }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(AdlsBlobBackupDatasourceParametersOutput{})
	pulumi.RegisterOutputType(AdlsBlobBackupDatasourceParametersResponseOutput{})
