...
func LookupResourceGuard(ctx *pulumi.Context, args *LookupResourceGuardArgs, opts ...pulumi.InvokeOption) (*LookupResourceGuardResult, error) {
	...
	err := ctx.Invoke("azure-native:dataprotection/v20231101:getResourceGuard", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupResourceGuardOutput(ctx *pulumi.Context, args LookupResourceGuardOutputArgs, opts ...pulumi.InvokeOption) LookupResourceGuardResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupResourceGuardResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dataprotection/v20231101:getResourceGuard", args, LookupResourceGuardResultOutput{}, options).(LookupResourceGuardResultOutput), nil
