...
// Gets or sets the user assigned identities.
func (o DppIdentityDetailsOutput) UserAssignedIdentities() pulumi.MapOutput {
	return o.ApplyT(func(v DppIdentityDetails) map[string]interface{} { return v.UserAssignedIdentities }).(pulumi.MapOutput)
}
...
// Gets or sets the user assigned identities.
func (o DppIdentityDetailsPtrOutput) UserAssignedIdentities() pulumi.MapOutput {
	return o.ApplyT(func(v *DppIdentityDetails) map[string]interface{} {
		if v == nil {
			return nil
		}
