...
func NewDppResourceGuardProxy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20231201:DppResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20240201preview:DppResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20240301:DppResourceGuardProxy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20250201:DppResourceGuardProxy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:dataprotection/v20230401preview:DppResourceGuardProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDppResourceGuardProxy(ctx *pulumi.Context,
	...
	var resource DppResourceGuardProxy
	err := ctx.ReadResource("azure-native:dataprotection/v20230401preview:DppResourceGuardProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
