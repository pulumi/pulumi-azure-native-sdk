...
func NewDppResourceGuardProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dataprotection/v20230601preview:DppResourceGuardProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDppResourceGuardProxy(ctx *pulumi.Context,
	...
	var resource DppResourceGuardProxy
	err := ctx.ReadResource("azure-native:dataprotection/v20230601preview:DppResourceGuardProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
