...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dataprotection/v20230601preview:BackupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPolicy(ctx *pulumi.Context,
	...
	var resource BackupPolicy
	err := ctx.ReadResource("azure-native:dataprotection/v20230601preview:BackupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
