...
func NewDppResourceGuardProxy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20250701:DppResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20250901:DppResourceGuardProxy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DppResourceGuardProxy
	err := ctx.RegisterResource("azure-native:dataprotection:DppResourceGuardProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDppResourceGuardProxy(ctx *pulumi.Context,
	...
	var resource DppResourceGuardProxy
	err := ctx.ReadResource("azure-native:dataprotection:DppResourceGuardProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Metadata pertaining to creation and last modification of the resource.
func (o DppResourceGuardProxyOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *DppResourceGuardProxy) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
