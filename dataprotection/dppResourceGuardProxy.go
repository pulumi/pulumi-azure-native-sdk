...
func NewDppResourceGuardProxy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dataprotection/v20260301:DppResourceGuardProxy"),
		},
		{
			Type: pulumi.String("azure-native:dataprotection/v20260401preview:DppResourceGuardProxy"),
		},
	})
