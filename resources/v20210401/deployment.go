...
//
// Deprecated: azure-native:resources/v20210401:Deployment is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:Deployment to guarantee forwards compatibility.
...
func NewDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20210401:Deployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeployment(ctx *pulumi.Context,
	...
	var resource Deployment
	err := ctx.ReadResource("azure-native:resources/v20210401:Deployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
