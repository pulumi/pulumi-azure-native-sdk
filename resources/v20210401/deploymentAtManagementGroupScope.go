...
//
// Deprecated: azure-native:resources/v20210401:DeploymentAtManagementGroupScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtManagementGroupScope to guarantee forwards compatibility.
...
func NewDeploymentAtManagementGroupScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20210401:DeploymentAtManagementGroupScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtManagementGroupScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtManagementGroupScope
	err := ctx.ReadResource("azure-native:resources/v20210401:DeploymentAtManagementGroupScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
