...
func NewAzurePowerShellScript(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20230801:AzurePowerShellScript", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzurePowerShellScript(ctx *pulumi.Context,
	...
	var resource AzurePowerShellScript
	err := ctx.ReadResource("azure-native:resources/v20230801:AzurePowerShellScript", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
