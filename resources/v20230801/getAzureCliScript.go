...
func LookupAzureCliScript(ctx *pulumi.Context, args *LookupAzureCliScriptArgs, opts ...pulumi.InvokeOption) (*LookupAzureCliScriptResult, error) {
	...
	err := ctx.Invoke("azure-native:resources/v20230801:getAzureCliScript", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupAzureCliScriptOutput(ctx *pulumi.Context, args LookupAzureCliScriptOutputArgs, opts ...pulumi.InvokeOption) LookupAzureCliScriptResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAzureCliScriptResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:resources/v20230801:getAzureCliScript", args, LookupAzureCliScriptResultOutput{}, options).(LookupAzureCliScriptResultOutput), nil
