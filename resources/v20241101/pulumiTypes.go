...
type DeploymentDiagnosticsDefinitionResponse struct {
...
type DeploymentDiagnosticsDefinitionResponseOutput struct{ *pulumi.OutputState }

func (DeploymentDiagnosticsDefinitionResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DeploymentDiagnosticsDefinitionResponse)(nil)).Elem()
}

func (o DeploymentDiagnosticsDefinitionResponseOutput) ToDeploymentDiagnosticsDefinitionResponseOutput() DeploymentDiagnosticsDefinitionResponseOutput {
	return o
}

func (o DeploymentDiagnosticsDefinitionResponseOutput) ToDeploymentDiagnosticsDefinitionResponseOutputWithContext(ctx context.Context) DeploymentDiagnosticsDefinitionResponseOutput {
	return o
}

// The error additional info.
func (o DeploymentDiagnosticsDefinitionResponseOutput) AdditionalInfo() ErrorAdditionalInfoResponseArrayOutput {
	return o.ApplyT(func(v DeploymentDiagnosticsDefinitionResponse) []ErrorAdditionalInfoResponse { return v.AdditionalInfo }).(ErrorAdditionalInfoResponseArrayOutput)
}

// The error code.
func (o DeploymentDiagnosticsDefinitionResponseOutput) Code() pulumi.StringOutput {
	return o.ApplyT(func(v DeploymentDiagnosticsDefinitionResponse) string { return v.Code }).(pulumi.StringOutput)
}

// Denotes the additional response level.
func (o DeploymentDiagnosticsDefinitionResponseOutput) Level() pulumi.StringOutput {
	return o.ApplyT(func(v DeploymentDiagnosticsDefinitionResponse) string { return v.Level }).(pulumi.StringOutput)
}

// The error message.
func (o DeploymentDiagnosticsDefinitionResponseOutput) Message() pulumi.StringOutput {
	return o.ApplyT(func(v DeploymentDiagnosticsDefinitionResponse) string { return v.Message }).(pulumi.StringOutput)
}

// The error target.
func (o DeploymentDiagnosticsDefinitionResponseOutput) Target() pulumi.StringOutput {
	return o.ApplyT(func(v DeploymentDiagnosticsDefinitionResponse) string { return v.Target }).(pulumi.StringOutput)
}

type DeploymentDiagnosticsDefinitionResponseArrayOutput struct{ *pulumi.OutputState }

func (DeploymentDiagnosticsDefinitionResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]DeploymentDiagnosticsDefinitionResponse)(nil)).Elem()
}

func (o DeploymentDiagnosticsDefinitionResponseArrayOutput) ToDeploymentDiagnosticsDefinitionResponseArrayOutput() DeploymentDiagnosticsDefinitionResponseArrayOutput {
	return o
}

func (o DeploymentDiagnosticsDefinitionResponseArrayOutput) ToDeploymentDiagnosticsDefinitionResponseArrayOutputWithContext(ctx context.Context) DeploymentDiagnosticsDefinitionResponseArrayOutput {
	return o
}

func (o DeploymentDiagnosticsDefinitionResponseArrayOutput) Index(i pulumi.IntInput) DeploymentDiagnosticsDefinitionResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) DeploymentDiagnosticsDefinitionResponse {
		return vs[0].([]DeploymentDiagnosticsDefinitionResponse)[vs[1].(int)]
	}).(DeploymentDiagnosticsDefinitionResponseOutput)
}
...
// The validation level of the deployment
func (o DeploymentPropertiesOutput) ValidationLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DeploymentProperties) *string { return v.ValidationLevel }).(pulumi.StringPtrOutput)
}
...
type DeploymentPropertiesExtendedResponse struct {
	...
	Diagnostics []DeploymentDiagnosticsDefinitionResponse `pulumi:"diagnostics"`
...
// Contains diagnostic information collected during validation process.
func (o DeploymentPropertiesExtendedResponseOutput) Diagnostics() DeploymentDiagnosticsDefinitionResponseArrayOutput {
	return o.ApplyT(func(v DeploymentPropertiesExtendedResponse) []DeploymentDiagnosticsDefinitionResponse {
		return v.Diagnostics
	}).(DeploymentDiagnosticsDefinitionResponseArrayOutput)
}
...
// The validation level of the deployment
func (o DeploymentPropertiesExtendedResponseOutput) ValidationLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DeploymentPropertiesExtendedResponse) *string { return v.ValidationLevel }).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(DeploymentDiagnosticsDefinitionResponseOutput{})
	pulumi.RegisterOutputType(DeploymentDiagnosticsDefinitionResponseArrayOutput{})
