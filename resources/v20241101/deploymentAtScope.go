...
func NewDeploymentAtScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20241101:DeploymentAtScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtScope
	err := ctx.ReadResource("azure-native:resources/v20241101:DeploymentAtScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
