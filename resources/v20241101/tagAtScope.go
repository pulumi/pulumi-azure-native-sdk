...
func NewTagAtScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20241101:TagAtScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagAtScope(ctx *pulumi.Context,
	...
	var resource TagAtScope
	err := ctx.ReadResource("azure-native:resources/v20241101:TagAtScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
