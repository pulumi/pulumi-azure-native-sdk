...
// Defines how resources deployed by the stack are locked.
func (o DeploymentStackAtManagementGroupOutput) DenySettings() DenySettingsResponsePtrOutput {
	return o.ApplyT(func(v *DeploymentStackAtManagementGroup) DenySettingsResponsePtrOutput { return v.DenySettings }).(DenySettingsResponsePtrOutput)
}
