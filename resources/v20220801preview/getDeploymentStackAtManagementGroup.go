...
// Defines how resources deployed by the stack are locked.
func (o LookupDeploymentStackAtManagementGroupResultOutput) DenySettings() DenySettingsResponsePtrOutput {
	return o.ApplyT(func(v LookupDeploymentStackAtManagementGroupResult) *DenySettingsResponse { return v.DenySettings }).(DenySettingsResponsePtrOutput)
}
