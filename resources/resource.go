...
func NewResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:resources/v20230701:Resource"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:resources/v20241101:Resource"),
		},
		{
			Type: pulumi.String("azure-native:resources/v20250301:Resource"),
		},
	})
...
// The Azure API version of the resource.
func (o ResourceOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Resource) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
