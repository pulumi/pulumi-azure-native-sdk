...
func LookupAzurePowerShellScriptOutput(ctx *pulumi.Context, args LookupAzurePowerShellScriptOutputArgs, opts ...pulumi.InvokeOption) LookupAzurePowerShellScriptResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAzurePowerShellScriptResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:resources/v20191001preview:getAzurePowerShellScript", args, LookupAzurePowerShellScriptResultOutput{}, options).(LookupAzurePowerShellScriptResultOutput), nil
...
// Managed identity to be used for this deployment script. Currently, only user-assigned MSI is supported.
func (o LookupAzurePowerShellScriptResultOutput) Identity() ManagedServiceIdentityResponseOutput {
	return o.ApplyT(func(v LookupAzurePowerShellScriptResult) ManagedServiceIdentityResponse { return v.Identity }).(ManagedServiceIdentityResponseOutput)
}
