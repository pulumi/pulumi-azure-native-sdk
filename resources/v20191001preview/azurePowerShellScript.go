...
// Managed identity to be used for this deployment script. Currently, only user-assigned MSI is supported.
func (o AzurePowerShellScriptOutput) Identity() ManagedServiceIdentityResponseOutput {
	return o.ApplyT(func(v *AzurePowerShellScript) ManagedServiceIdentityResponseOutput { return v.Identity }).(ManagedServiceIdentityResponseOutput)
}
