...
func NewDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:resources/v20230701:DeploymentAtSubscriptionScope"),
		},
		{
			Type: pulumi.String("azure-native:resources/v20240301:DeploymentAtSubscriptionScope"),
		},
		{
			Type: pulumi.String("azure-native:resources/v20241101:DeploymentAtSubscriptionScope"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:resources/v20240701:DeploymentAtSubscriptionScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtSubscriptionScope
	err := ctx.ReadResource("azure-native:resources/v20240701:DeploymentAtSubscriptionScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
