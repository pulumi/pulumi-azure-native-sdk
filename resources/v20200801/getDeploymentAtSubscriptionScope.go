...
// Gets a deployment.
//
// Deprecated: azure-native:resources/v20200801:DeploymentAtSubscriptionScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtSubscriptionScope to guarantee forwards compatibility.
func LookupDeploymentAtSubscriptionScope(ctx *pulumi.Context, args *LookupDeploymentAtSubscriptionScopeArgs, opts ...pulumi.InvokeOption) (*LookupDeploymentAtSubscriptionScopeResult, error) {
	...
	err := ctx.Invoke("azure-native:resources/v20200801:getDeploymentAtSubscriptionScope", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
