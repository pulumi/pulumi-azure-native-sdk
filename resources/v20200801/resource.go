...
//
// Deprecated: azure-native:resources/v20200801:Resource is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:Resource to guarantee forwards compatibility.
...
func NewResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20200801:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResource(ctx *pulumi.Context,
	...
	var resource Resource
	err := ctx.ReadResource("azure-native:resources/v20200801:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
