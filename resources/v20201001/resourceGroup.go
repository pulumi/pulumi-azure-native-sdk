...
func NewResourceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20201001:ResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceGroup(ctx *pulumi.Context,
	...
	var resource ResourceGroup
	err := ctx.ReadResource("azure-native:resources/v20201001:ResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
