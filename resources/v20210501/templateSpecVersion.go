...
func NewTemplateSpecVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20210501:TemplateSpecVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTemplateSpecVersion(ctx *pulumi.Context,
	...
	var resource TemplateSpecVersion
	err := ctx.ReadResource("azure-native:resources/v20210501:TemplateSpecVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
