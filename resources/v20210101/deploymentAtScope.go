...
//
// Deprecated: azure-native:resources/v20210101:DeploymentAtScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtScope to guarantee forwards compatibility.
...
func NewDeploymentAtScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20210101:DeploymentAtScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtScope
	err := ctx.ReadResource("azure-native:resources/v20210101:DeploymentAtScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
