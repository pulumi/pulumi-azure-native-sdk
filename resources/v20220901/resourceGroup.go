...
func NewResourceGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:resources/v20240301:ResourceGroup"),
		},
		{
			Type: pulumi.String("azure-native:resources/v20240701:ResourceGroup"),
		},
		{
			Type: pulumi.String("azure-native:resources/v20241101:ResourceGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ResourceGroup
	err := ctx.RegisterResource("azure-native:resources/v20220901:ResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceGroup(ctx *pulumi.Context,
	...
	var resource ResourceGroup
	err := ctx.ReadResource("azure-native:resources/v20220901:ResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
