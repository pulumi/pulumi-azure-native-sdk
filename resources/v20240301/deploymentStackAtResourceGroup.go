...
func NewDeploymentStackAtResourceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20240301:DeploymentStackAtResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentStackAtResourceGroup(ctx *pulumi.Context,
	...
	var resource DeploymentStackAtResourceGroup
	err := ctx.ReadResource("azure-native:resources/v20240301:DeploymentStackAtResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
