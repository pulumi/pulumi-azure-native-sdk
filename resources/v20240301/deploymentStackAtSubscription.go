...
func NewDeploymentStackAtSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20240301:DeploymentStackAtSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentStackAtSubscription(ctx *pulumi.Context,
	...
	var resource DeploymentStackAtSubscription
	err := ctx.ReadResource("azure-native:resources/v20240301:DeploymentStackAtSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
