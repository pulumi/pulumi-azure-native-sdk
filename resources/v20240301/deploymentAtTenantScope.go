...
func NewDeploymentAtTenantScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:resources/v20230701:DeploymentAtTenantScope"),
		},
		{
			Type: pulumi.String("azure-native:resources/v20240701:DeploymentAtTenantScope"),
		},
		{
			Type: pulumi.String("azure-native:resources/v20241101:DeploymentAtTenantScope"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DeploymentAtTenantScope
	err := ctx.RegisterResource("azure-native:resources/v20240301:DeploymentAtTenantScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtTenantScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtTenantScope
	err := ctx.ReadResource("azure-native:resources/v20240301:DeploymentAtTenantScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
