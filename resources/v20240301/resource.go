...
func NewResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20240301:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResource(ctx *pulumi.Context,
	...
	var resource Resource
	err := ctx.ReadResource("azure-native:resources/v20240301:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
