...
func NewDeploymentStackAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20240301:DeploymentStackAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentStackAtManagementGroup(ctx *pulumi.Context,
	...
	var resource DeploymentStackAtManagementGroup
	err := ctx.ReadResource("azure-native:resources/v20240301:DeploymentStackAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
