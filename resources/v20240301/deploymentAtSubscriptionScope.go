...
func NewDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20240301:DeploymentAtSubscriptionScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtSubscriptionScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtSubscriptionScope
	err := ctx.ReadResource("azure-native:resources/v20240301:DeploymentAtSubscriptionScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
