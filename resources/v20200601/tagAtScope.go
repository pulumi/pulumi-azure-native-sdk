...
//
// Deprecated: azure-native:resources/v20200601:TagAtScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:TagAtScope to guarantee forwards compatibility.
...
func NewTagAtScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20200601:TagAtScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagAtScope(ctx *pulumi.Context,
	...
	var resource TagAtScope
	err := ctx.ReadResource("azure-native:resources/v20200601:TagAtScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
