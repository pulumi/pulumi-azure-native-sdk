...
// Gets a deployment.
//
// Deprecated: azure-native:resources/v20200601:DeploymentAtTenantScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.
func LookupDeploymentAtTenantScope(ctx *pulumi.Context, args *LookupDeploymentAtTenantScopeArgs, opts ...pulumi.InvokeOption) (*LookupDeploymentAtTenantScopeResult, error) {
	...
	err := ctx.Invoke("azure-native:resources/v20200601:getDeploymentAtTenantScope", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
