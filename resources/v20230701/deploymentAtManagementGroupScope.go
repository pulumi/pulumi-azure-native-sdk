...
func NewDeploymentAtManagementGroupScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20230701:DeploymentAtManagementGroupScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtManagementGroupScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtManagementGroupScope
	err := ctx.ReadResource("azure-native:resources/v20230701:DeploymentAtManagementGroupScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *DeploymentAtManagementGroupScope) ToOutput(ctx context.Context) pulumix.Output[*DeploymentAtManagementGroupScope] {
	return pulumix.Output[*DeploymentAtManagementGroupScope]{
		OutputState: i.ToDeploymentAtManagementGroupScopeOutputWithContext(ctx).OutputState,
	}
}
...
func (o DeploymentAtManagementGroupScopeOutput) ToOutput(ctx context.Context) pulumix.Output[*DeploymentAtManagementGroupScope] {
	return pulumix.Output[*DeploymentAtManagementGroupScope]{
