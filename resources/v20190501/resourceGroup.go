...
//
// Deprecated: azure-native:resources/v20190501:ResourceGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:ResourceGroup to guarantee forwards compatibility.
...
func NewResourceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources/v20190501:ResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceGroup(ctx *pulumi.Context,
	...
	var resource ResourceGroup
	err := ctx.ReadResource("azure-native:resources/v20190501:ResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
