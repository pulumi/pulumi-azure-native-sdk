...
type Redis struct {
	...
	DisableAccessKeyAuthentication pulumi.BoolPtrOutput `pulumi:"disableAccessKeyAuthentication"`
...
func NewRedis(ctx *pulumi.Context,
	...
	if args.DisableAccessKeyAuthentication == nil {
		args.DisableAccessKeyAuthentication = pulumi.BoolPtr(false)
	}
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cache/v20230801:Redis"),
		},
		{
			Type: pulumi.String("azure-native:cache/v20240301:Redis"),
		},
		{
			Type: pulumi.String("azure-native:cache/v20240401preview:Redis"),
		},
		{
			Type: pulumi.String("azure-native:cache/v20241101:Redis"),
		},
		{
			Type: pulumi.String("azure-native:cache:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20150801:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20160401:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20170201:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20171001:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20180301:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20190701:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20200601:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20201201:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20210601:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20220501:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20220601:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230401:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230501preview:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230801:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240301:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240401preview:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20241101:Redis"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20250801preview:Redis"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Redis
	err := ctx.RegisterResource("azure-native:redis:Redis", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.ReadResource("azure-native:redis:Redis", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type redisArgs struct {
	// Authentication to Redis through access keys is disabled when set as true. Default value is false.
	DisableAccessKeyAuthentication *bool `pulumi:"disableAccessKeyAuthentication"`
	// Specifies whether the non-ssl Redis server port (6379) is enabled.
...
type RedisArgs struct {
	// Authentication to Redis through access keys is disabled when set as true. Default value is false.
	DisableAccessKeyAuthentication pulumi.BoolPtrInput
	// Specifies whether the non-ssl Redis server port (6379) is enabled.
	...
	// Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will automatically select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in regions where zones are supported and 'NoZones' in regions where zones are not supported.
	ZonalAllocationPolicy pulumi.StringPtrInput
	// A list of availability zones denoting where the resource needs to come from.
...
// The Azure API version of the resource.
func (o RedisOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Redis) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}

// Authentication to Redis through access keys is disabled when set as true. Default value is false.
func (o RedisOutput) DisableAccessKeyAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Redis) pulumi.BoolPtrOutput { return v.DisableAccessKeyAuthentication }).(pulumi.BoolPtrOutput)
}
...
// Optional: Specifies the update channel for the monthly Redis updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'.
func (o RedisOutput) UpdateChannel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Redis) pulumi.StringPtrOutput { return v.UpdateChannel }).(pulumi.StringPtrOutput)
}

// Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will automatically select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in regions where zones are supported and 'NoZones' in regions where zones are not supported.
func (o RedisOutput) ZonalAllocationPolicy() pulumi.StringPtrOutput {
