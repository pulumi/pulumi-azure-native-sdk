...
func NewPatchSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:redis/v20171001:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20180301:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20190701:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20200601:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20201201:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20210601:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20220501:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20220601:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230401:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230501preview:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230801:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240301:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240401preview:PatchSchedule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20241101:PatchSchedule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PatchSchedule
	err := ctx.RegisterResource("azure-native:redis:PatchSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPatchSchedule(ctx *pulumi.Context,
	...
	var resource PatchSchedule
	err := ctx.ReadResource("azure-native:redis:PatchSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o PatchScheduleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PatchSchedule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PatchScheduleOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *PatchSchedule) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
