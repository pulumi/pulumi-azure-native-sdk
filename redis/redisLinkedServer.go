...
func NewRedisLinkedServer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:redis/v20170201:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20171001:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20180301:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20190701:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20200601:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20201201:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20210601:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20220501:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20220601:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230401:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230501preview:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230801:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240301:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240401preview:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20241101:RedisLinkedServer"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20250801preview:RedisLinkedServer"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource RedisLinkedServer
	err := ctx.RegisterResource("azure-native:redis:RedisLinkedServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedisLinkedServer(ctx *pulumi.Context,
	...
	var resource RedisLinkedServer
	err := ctx.ReadResource("azure-native:redis:RedisLinkedServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o RedisLinkedServerOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *RedisLinkedServer) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
