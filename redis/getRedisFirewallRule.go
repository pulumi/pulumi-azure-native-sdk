...
func LookupRedisFirewallRule(ctx *pulumi.Context, args *LookupRedisFirewallRuleArgs, opts ...pulumi.InvokeOption) (*LookupRedisFirewallRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:redis:getRedisFirewallRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRedisFirewallRuleOutput(ctx *pulumi.Context, args LookupRedisFirewallRuleOutputArgs, opts ...pulumi.InvokeOption) LookupRedisFirewallRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRedisFirewallRuleResultOutput, error) {
			args := v.(LookupRedisFirewallRuleArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:redis:getRedisFirewallRule", args, LookupRedisFirewallRuleResultOutput{}, options).(LookupRedisFirewallRuleResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupRedisFirewallRuleResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRedisFirewallRuleResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
