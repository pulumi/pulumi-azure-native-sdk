...
func LookupRedis(ctx *pulumi.Context, args *LookupRedisArgs, opts ...pulumi.InvokeOption) (*LookupRedisResult, error) {
	...
	err := ctx.Invoke("azure-native:redis:getRedis", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (val *LookupRedisResult) Defaults() *LookupRedisResult {
	...
	tmp := *val
	if tmp.DisableAccessKeyAuthentication == nil {
		disableAccessKeyAuthentication_ := false
		tmp.DisableAccessKeyAuthentication = &disableAccessKeyAuthentication_
	}
...
func LookupRedisOutput(ctx *pulumi.Context, args LookupRedisOutputArgs, opts ...pulumi.InvokeOption) LookupRedisResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRedisResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:redis:getRedis", args, LookupRedisResultOutput{}, options).(LookupRedisResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupRedisResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRedisResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}

// Authentication to Redis through access keys is disabled when set as true. Default value is false.
func (o LookupRedisResultOutput) DisableAccessKeyAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRedisResult) *bool { return v.DisableAccessKeyAuthentication }).(pulumi.BoolPtrOutput)
}
...
// Optional: Specifies the update channel for the monthly Redis updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'.
func (o LookupRedisResultOutput) UpdateChannel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRedisResult) *string { return v.UpdateChannel }).(pulumi.StringPtrOutput)
}

// Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will automatically select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in regions where zones are supported and 'NoZones' in regions where zones are not supported.
func (o LookupRedisResultOutput) ZonalAllocationPolicy() pulumi.StringPtrOutput {
