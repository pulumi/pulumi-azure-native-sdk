...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AccessPolicyAssignmentOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *AccessPolicyAssignment) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
