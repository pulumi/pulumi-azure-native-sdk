...
func NewFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:redis/v20160401:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20170201:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20171001:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20180301:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20190701:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20200601:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20201201:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20210601:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20220501:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20220601:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230401:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230501preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230801:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240301:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240401preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20241101:FirewallRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource FirewallRule
	err := ctx.RegisterResource("azure-native:redis:FirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallRule(ctx *pulumi.Context,
	...
	var resource FirewallRule
	err := ctx.ReadResource("azure-native:redis:FirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o FirewallRuleOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *FirewallRule) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
