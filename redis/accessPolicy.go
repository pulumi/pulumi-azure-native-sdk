...
func NewAccessPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cache/v20241101:AccessPolicy"),
		},
		{
			Type: pulumi.String("azure-native:cache:AccessPolicy"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230501preview:AccessPolicy"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20230801:AccessPolicy"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240301:AccessPolicy"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20240401preview:AccessPolicy"),
		},
		{
			Type: pulumi.String("azure-native:redis/v20241101:AccessPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AccessPolicy
	err := ctx.RegisterResource("azure-native:redis:AccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessPolicy(ctx *pulumi.Context,
	...
	var resource AccessPolicy
	err := ctx.ReadResource("azure-native:redis:AccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AccessPolicyOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *AccessPolicy) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
