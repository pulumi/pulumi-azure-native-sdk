...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LinkedServerOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *LinkedServer) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
