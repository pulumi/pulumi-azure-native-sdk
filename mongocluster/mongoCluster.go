...
func NewMongoCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:mongocluster/v20240301preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20240601preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20240701:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20241001preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250401preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250701preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250801preview:MongoCluster"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250901:MongoCluster"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MongoCluster
	err := ctx.RegisterResource("azure-native:mongocluster:MongoCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoCluster(ctx *pulumi.Context,
	...
	var resource MongoCluster
	err := ctx.ReadResource("azure-native:mongocluster:MongoCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o MongoClusterOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *MongoCluster) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o MongoClusterOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *MongoCluster) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
