...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:mongocluster/v20260201preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20260601:PrivateEndpointConnection"),
		},
	})
