...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:mongocluster/v20240301preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20240601preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20240701:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20241001preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250401preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250701preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250801preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250901:PrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateEndpointConnection
	err := ctx.RegisterResource("azure-native:mongocluster:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:mongocluster:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The resource-specific properties for this resource.
func (o PrivateEndpointConnectionOutput) Properties() commontypesv5.PrivateEndpointConnectionPropertiesResponseOutput {
	return o.ApplyT(func(v *PrivateEndpointConnection) commontypesv5.PrivateEndpointConnectionPropertiesResponseOutput {
		return v.Properties
	}).(commontypesv5.PrivateEndpointConnectionPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PrivateEndpointConnectionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PrivateEndpointConnection) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
