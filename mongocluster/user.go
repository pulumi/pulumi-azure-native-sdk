...
func NewUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:mongocluster/v20250801preview:User"),
		},
		{
			Type: pulumi.String("azure-native:mongocluster/v20250901:User"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o UserOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *User) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
