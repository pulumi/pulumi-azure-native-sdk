...
func NewCosmosDbDataConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20230815:CosmosDbDataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCosmosDbDataConnection(ctx *pulumi.Context,
	...
	var resource CosmosDbDataConnection
	err := ctx.ReadResource("azure-native:kusto/v20230815:CosmosDbDataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
