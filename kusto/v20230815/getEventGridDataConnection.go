...
func LookupEventGridDataConnection(ctx *pulumi.Context, args *LookupEventGridDataConnectionArgs, opts ...pulumi.InvokeOption) (*LookupEventGridDataConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20230815:getEventGridDataConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupEventGridDataConnectionOutput(ctx *pulumi.Context, args LookupEventGridDataConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupEventGridDataConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEventGridDataConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kusto/v20230815:getEventGridDataConnection", args, LookupEventGridDataConnectionResultOutput{}, options).(LookupEventGridDataConnectionResultOutput), nil
