...
func LookupAttachedDatabaseConfiguration(ctx *pulumi.Context, args *LookupAttachedDatabaseConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupAttachedDatabaseConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20230815:getAttachedDatabaseConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupAttachedDatabaseConfigurationResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAttachedDatabaseConfigurationResult] {
	return pulumix.Output[LookupAttachedDatabaseConfigurationResult]{
