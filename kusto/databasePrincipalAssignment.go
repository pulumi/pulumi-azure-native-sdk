...
func NewDatabasePrincipalAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:kusto/v20220707:DatabasePrincipalAssignment"),
		},
		{
			Type: pulumi.String("azure-native:kusto/v20221111:DatabasePrincipalAssignment"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:kusto/v20240413:DatabasePrincipalAssignment"),
		},
		{
			Type: pulumi.String("azure-native:kusto/v20250214:DatabasePrincipalAssignment"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DatabasePrincipalAssignment
	err := ctx.RegisterResource("azure-native:kusto:DatabasePrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabasePrincipalAssignment(ctx *pulumi.Context,
	...
	var resource DatabasePrincipalAssignment
	err := ctx.ReadResource("azure-native:kusto:DatabasePrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
