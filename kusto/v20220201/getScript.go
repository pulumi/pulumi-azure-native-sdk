...
//
// Deprecated: azure-native:kusto/v20220201:Script is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:Script to guarantee forwards compatibility.
func LookupScript(ctx *pulumi.Context, args *LookupScriptArgs, opts ...pulumi.InvokeOption) (*LookupScriptResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20220201:getScript", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
