...
// Defaults sets the appropriate defaults for GetEventHubDataConnectionResult
func (val *GetEventHubDataConnectionResult) Defaults() *GetEventHubDataConnectionResult {
	if val == nil {
		return nil
	}
	tmp := *val
...
// Indication for database routing information from the data connection, by default only database routing information is allowed
func (o GetEventHubDataConnectionResultOutput) DatabaseRouting() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetEventHubDataConnectionResult) *string { return v.DatabaseRouting }).(pulumi.StringPtrOutput)
}
...
// The object ID of the managedIdentityResourceId
func (o GetEventHubDataConnectionResultOutput) ManagedIdentityObjectId() pulumi.StringOutput {
	return o.ApplyT(func(v GetEventHubDataConnectionResult) string { return v.ManagedIdentityObjectId }).(pulumi.StringOutput)
}

// The resource ID of a managed identity (system or user assigned) to be used to authenticate with event hub.
func (o GetEventHubDataConnectionResultOutput) ManagedIdentityResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetEventHubDataConnectionResult) *string { return v.ManagedIdentityResourceId }).(pulumi.StringPtrOutput)
}
...
// When defined, the data connection retrieves existing Event hub events created since the Retrieval start date. It can only retrieve events retained by the Event hub, based on its retention period.
func (o GetEventHubDataConnectionResultOutput) RetrievalStartDate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetEventHubDataConnectionResult) *string { return v.RetrievalStartDate }).(pulumi.StringPtrOutput)
}
