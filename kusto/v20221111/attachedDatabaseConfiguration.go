...
//
// Deprecated: azure-native:kusto/v20221111:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility.
...
func NewAttachedDatabaseConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20221111:AttachedDatabaseConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachedDatabaseConfiguration(ctx *pulumi.Context,
	...
	var resource AttachedDatabaseConfiguration
	err := ctx.ReadResource("azure-native:kusto/v20221111:AttachedDatabaseConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
