...
func NewScript(ctx *pulumi.Context,
	...
	var resource Script
	err := ctx.RegisterResource("azure-native:kusto/v20221111:Script", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScript(ctx *pulumi.Context,
	...
	var resource Script
	err := ctx.ReadResource("azure-native:kusto/v20221111:Script", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
