...
func NewManagedPrivateEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20221111:ManagedPrivateEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedPrivateEndpoint(ctx *pulumi.Context,
	...
	var resource ManagedPrivateEndpoint
	err := ctx.ReadResource("azure-native:kusto/v20221111:ManagedPrivateEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
