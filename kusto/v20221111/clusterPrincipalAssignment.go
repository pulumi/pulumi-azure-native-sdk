...
func NewClusterPrincipalAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20221111:ClusterPrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterPrincipalAssignment(ctx *pulumi.Context,
	...
	var resource ClusterPrincipalAssignment
	err := ctx.ReadResource("azure-native:kusto/v20221111:ClusterPrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
