...
//
// Deprecated: azure-native:kusto/v20221111:ReadWriteDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ReadWriteDatabase to guarantee forwards compatibility.
...
func NewReadWriteDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20221111:ReadWriteDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadWriteDatabase(ctx *pulumi.Context,
	...
	var resource ReadWriteDatabase
	err := ctx.ReadResource("azure-native:kusto/v20221111:ReadWriteDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
