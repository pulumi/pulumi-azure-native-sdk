...
func NewEventHubDataConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:kusto/v20250214:EventHubDataConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:kusto:EventHubDataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubDataConnection(ctx *pulumi.Context,
	...
	var resource EventHubDataConnection
	err := ctx.ReadResource("azure-native:kusto:EventHubDataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
