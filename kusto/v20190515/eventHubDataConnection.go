...
//
// Deprecated: azure-native:kusto/v20190515:EventHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:EventHubDataConnection to guarantee forwards compatibility.
...
func NewEventHubDataConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:kusto/v20220707:EventHubDataConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:kusto/v20190515:EventHubDataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubDataConnection(ctx *pulumi.Context,
	...
	var resource EventHubDataConnection
	err := ctx.ReadResource("azure-native:kusto/v20190515:EventHubDataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
