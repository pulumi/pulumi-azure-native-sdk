...
//
// Deprecated: azure-native:kusto/v20190515:IotHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.
...
func NewIotHubDataConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20190515:IotHubDataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubDataConnection(ctx *pulumi.Context,
	...
	var resource IotHubDataConnection
	err := ctx.ReadResource("azure-native:kusto/v20190515:IotHubDataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
