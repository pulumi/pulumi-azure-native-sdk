...
func NewCosmosDbDataConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:kusto/v20250214:CosmosDbDataConnection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:kusto:CosmosDbDataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCosmosDbDataConnection(ctx *pulumi.Context,
	...
	var resource CosmosDbDataConnection
	err := ctx.ReadResource("azure-native:kusto:CosmosDbDataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
