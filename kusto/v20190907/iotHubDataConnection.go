...
func NewIotHubDataConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20190907:IotHubDataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubDataConnection(ctx *pulumi.Context,
	...
	var resource IotHubDataConnection
	err := ctx.ReadResource("azure-native:kusto/v20190907:IotHubDataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
