...
func NewEventHubConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20170907privatepreview:EventHubConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubConnection(ctx *pulumi.Context,
	...
	var resource EventHubConnection
	err := ctx.ReadResource("azure-native:kusto/v20170907privatepreview:EventHubConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
