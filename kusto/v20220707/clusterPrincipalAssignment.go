...
//
// Deprecated: azure-native:kusto/v20220707:ClusterPrincipalAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ClusterPrincipalAssignment to guarantee forwards compatibility.
...
func NewClusterPrincipalAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20220707:ClusterPrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterPrincipalAssignment(ctx *pulumi.Context,
	...
	var resource ClusterPrincipalAssignment
	err := ctx.ReadResource("azure-native:kusto/v20220707:ClusterPrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
