...
func LookupCosmosDbDataConnection(ctx *pulumi.Context, args *LookupCosmosDbDataConnectionArgs, opts ...pulumi.InvokeOption) (*LookupCosmosDbDataConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20240413:getCosmosDbDataConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCosmosDbDataConnectionOutput(ctx *pulumi.Context, args LookupCosmosDbDataConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupCosmosDbDataConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCosmosDbDataConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kusto/v20240413:getCosmosDbDataConnection", args, LookupCosmosDbDataConnectionResultOutput{}, options).(LookupCosmosDbDataConnectionResultOutput), nil
