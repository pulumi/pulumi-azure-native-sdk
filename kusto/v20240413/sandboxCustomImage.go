...
func NewSandboxCustomImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20240413:SandboxCustomImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSandboxCustomImage(ctx *pulumi.Context,
	...
	var resource SandboxCustomImage
	err := ctx.ReadResource("azure-native:kusto/v20240413:SandboxCustomImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
