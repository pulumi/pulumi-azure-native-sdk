...
func LookupIotHubDataConnection(ctx *pulumi.Context, args *LookupIotHubDataConnectionArgs, opts ...pulumi.InvokeOption) (*LookupIotHubDataConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20240413:getIotHubDataConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupIotHubDataConnectionOutput(ctx *pulumi.Context, args LookupIotHubDataConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupIotHubDataConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIotHubDataConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kusto/v20240413:getIotHubDataConnection", args, LookupIotHubDataConnectionResultOutput{}, options).(LookupIotHubDataConnectionResultOutput), nil
