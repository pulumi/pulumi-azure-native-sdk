...
func NewAttachedDatabaseConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20240413:AttachedDatabaseConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachedDatabaseConfiguration(ctx *pulumi.Context,
	...
	var resource AttachedDatabaseConfiguration
	err := ctx.ReadResource("azure-native:kusto/v20240413:AttachedDatabaseConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
