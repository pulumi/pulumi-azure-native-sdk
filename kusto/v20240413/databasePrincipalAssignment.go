...
func NewDatabasePrincipalAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20240413:DatabasePrincipalAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabasePrincipalAssignment(ctx *pulumi.Context,
	...
	var resource DatabasePrincipalAssignment
	err := ctx.ReadResource("azure-native:kusto/v20240413:DatabasePrincipalAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
