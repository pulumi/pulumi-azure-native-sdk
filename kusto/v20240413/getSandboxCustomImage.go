...
func LookupSandboxCustomImage(ctx *pulumi.Context, args *LookupSandboxCustomImageArgs, opts ...pulumi.InvokeOption) (*LookupSandboxCustomImageResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20240413:getSandboxCustomImage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSandboxCustomImageOutput(ctx *pulumi.Context, args LookupSandboxCustomImageOutputArgs, opts ...pulumi.InvokeOption) LookupSandboxCustomImageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSandboxCustomImageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kusto/v20240413:getSandboxCustomImage", args, LookupSandboxCustomImageResultOutput{}, options).(LookupSandboxCustomImageResultOutput), nil
