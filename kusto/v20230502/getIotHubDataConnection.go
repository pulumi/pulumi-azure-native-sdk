...
func LookupIotHubDataConnection(ctx *pulumi.Context, args *LookupIotHubDataConnectionArgs, opts ...pulumi.InvokeOption) (*LookupIotHubDataConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20230502:getIotHubDataConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (o LookupIotHubDataConnectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupIotHubDataConnectionResult] {
	return pulumix.Output[LookupIotHubDataConnectionResult]{
