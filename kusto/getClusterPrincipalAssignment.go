...
func (o LookupClusterPrincipalAssignmentResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupClusterPrincipalAssignmentResult] {
	return pulumix.Output[LookupClusterPrincipalAssignmentResult]{
