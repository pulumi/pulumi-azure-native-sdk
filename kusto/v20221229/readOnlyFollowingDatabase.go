...
func NewReadOnlyFollowingDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20221229:ReadOnlyFollowingDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadOnlyFollowingDatabase(ctx *pulumi.Context,
	...
	var resource ReadOnlyFollowingDatabase
	err := ctx.ReadResource("azure-native:kusto/v20221229:ReadOnlyFollowingDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
