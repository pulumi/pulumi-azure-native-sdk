...
func NewEventGridDataConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20221229:EventGridDataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventGridDataConnection(ctx *pulumi.Context,
	...
	var resource EventGridDataConnection
	err := ctx.ReadResource("azure-native:kusto/v20221229:EventGridDataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
