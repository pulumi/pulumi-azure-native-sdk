...
func NewReadWriteDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20221229:ReadWriteDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadWriteDatabase(ctx *pulumi.Context,
	...
	var resource ReadWriteDatabase
	err := ctx.ReadResource("azure-native:kusto/v20221229:ReadWriteDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
