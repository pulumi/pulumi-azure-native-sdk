...
func NewEventHubDataConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20221229:EventHubDataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubDataConnection(ctx *pulumi.Context,
	...
	var resource EventHubDataConnection
	err := ctx.ReadResource("azure-native:kusto/v20221229:EventHubDataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
