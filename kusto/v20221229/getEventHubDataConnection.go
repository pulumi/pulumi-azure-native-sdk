...
func LookupEventHubDataConnection(ctx *pulumi.Context, args *LookupEventHubDataConnectionArgs, opts ...pulumi.InvokeOption) (*LookupEventHubDataConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20221229:getEventHubDataConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupEventHubDataConnectionOutput(ctx *pulumi.Context, args LookupEventHubDataConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupEventHubDataConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEventHubDataConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kusto/v20221229:getEventHubDataConnection", args, LookupEventHubDataConnectionResultOutput{}, options).(LookupEventHubDataConnectionResultOutput), nil
