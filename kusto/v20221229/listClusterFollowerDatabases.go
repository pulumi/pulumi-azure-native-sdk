...
func ListClusterFollowerDatabases(ctx *pulumi.Context, args *ListClusterFollowerDatabasesArgs, opts ...pulumi.InvokeOption) (*ListClusterFollowerDatabasesResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20221229:listClusterFollowerDatabases", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListClusterFollowerDatabasesOutput(ctx *pulumi.Context, args ListClusterFollowerDatabasesOutputArgs, opts ...pulumi.InvokeOption) ListClusterFollowerDatabasesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListClusterFollowerDatabasesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kusto/v20221229:listClusterFollowerDatabases", args, ListClusterFollowerDatabasesResultOutput{}, options).(ListClusterFollowerDatabasesResultOutput), nil
