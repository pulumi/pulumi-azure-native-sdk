...
func LookupReadWriteDatabase(ctx *pulumi.Context, args *LookupReadWriteDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupReadWriteDatabaseResult, error) {
	...
	err := ctx.Invoke("azure-native:kusto/v20221229:getReadWriteDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupReadWriteDatabaseOutput(ctx *pulumi.Context, args LookupReadWriteDatabaseOutputArgs, opts ...pulumi.InvokeOption) LookupReadWriteDatabaseResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReadWriteDatabaseResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:kusto/v20221229:getReadWriteDatabase", args, LookupReadWriteDatabaseResultOutput{}, options).(LookupReadWriteDatabaseResultOutput), nil
