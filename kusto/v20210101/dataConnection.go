...
func NewDataConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:kusto/v20210101:DataConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataConnection(ctx *pulumi.Context,
	...
	var resource DataConnection
	err := ctx.ReadResource("azure-native:kusto/v20210101:DataConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
