...
//
// Deprecated: azure-native:datamigration/v20220130preview:File is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:File to guarantee forwards compatibility.
func LookupFile(ctx *pulumi.Context, args *LookupFileArgs, opts ...pulumi.InvokeOption) (*LookupFileResult, error) {
	...
	err := ctx.Invoke("azure-native:datamigration/v20220130preview:getFile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
