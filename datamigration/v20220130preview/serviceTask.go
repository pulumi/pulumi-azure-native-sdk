...
// A task resource
//
// Deprecated: azure-native:datamigration/v20220130preview:ServiceTask is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:ServiceTask to guarantee forwards compatibility.
...
func NewServiceTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datamigration/v20220130preview:ServiceTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceTask(ctx *pulumi.Context,
	...
	var resource ServiceTask
	err := ctx.ReadResource("azure-native:datamigration/v20220130preview:ServiceTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
