...
func NewFile(ctx *pulumi.Context,
	...
	var resource File
	err := ctx.RegisterResource("azure-native:datamigration/v20220130preview:File", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFile(ctx *pulumi.Context,
	...
	var resource File
	err := ctx.ReadResource("azure-native:datamigration/v20220130preview:File", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
