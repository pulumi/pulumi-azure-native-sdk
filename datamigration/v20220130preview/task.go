...
func NewTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.RegisterResource("azure-native:datamigration/v20220130preview:Task", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.ReadResource("azure-native:datamigration/v20220130preview:Task", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
