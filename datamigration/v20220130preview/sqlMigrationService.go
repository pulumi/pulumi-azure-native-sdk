...
func NewSqlMigrationService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datamigration/v20220130preview:SqlMigrationService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlMigrationService(ctx *pulumi.Context,
	...
	var resource SqlMigrationService
	err := ctx.ReadResource("azure-native:datamigration/v20220130preview:SqlMigrationService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
