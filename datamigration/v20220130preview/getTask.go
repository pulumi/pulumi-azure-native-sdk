...
//
// Deprecated: azure-native:datamigration/v20220130preview:Task is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:Task to guarantee forwards compatibility.
func LookupTask(ctx *pulumi.Context, args *LookupTaskArgs, opts ...pulumi.InvokeOption) (*LookupTaskResult, error) {
	...
	err := ctx.Invoke("azure-native:datamigration/v20220130preview:getTask", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
