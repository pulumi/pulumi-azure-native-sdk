...
// BackupModeInput is an input type that accepts values of the BackupMode enum
// A concrete instance of `BackupModeInput` can be one of the following:
//
...
// MongoDbReplicationInput is an input type that accepts values of the MongoDbReplication enum
// A concrete instance of `MongoDbReplicationInput` can be one of the following:
//
...
// MongoDbShardKeyOrderInput is an input type that accepts values of the MongoDbShardKeyOrder enum
// A concrete instance of `MongoDbShardKeyOrderInput` can be one of the following:
//
...
// MySqlTargetPlatformTypeInput is an input type that accepts values of the MySqlTargetPlatformType enum
// A concrete instance of `MySqlTargetPlatformTypeInput` can be one of the following:
//
...
// ServerLevelPermissionsGroupInput is an input type that accepts values of the ServerLevelPermissionsGroup enum
// A concrete instance of `ServerLevelPermissionsGroupInput` can be one of the following:
//
...
// SsisMigrationOverwriteOptionInput is an input type that accepts values of the SsisMigrationOverwriteOption enum
// A concrete instance of `SsisMigrationOverwriteOptionInput` can be one of the following:
//
...
// SsisStoreTypeInput is an input type that accepts values of the SsisStoreType enum
// A concrete instance of `SsisStoreTypeInput` can be one of the following:
//
