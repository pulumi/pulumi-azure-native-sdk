...
func NewServiceTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datamigration/v20230715preview:ServiceTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceTask(ctx *pulumi.Context,
	...
	var resource ServiceTask
	err := ctx.ReadResource("azure-native:datamigration/v20230715preview:ServiceTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
