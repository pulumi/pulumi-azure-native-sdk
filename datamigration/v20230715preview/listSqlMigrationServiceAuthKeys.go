...
func ListSqlMigrationServiceAuthKeys(ctx *pulumi.Context, args *ListSqlMigrationServiceAuthKeysArgs, opts ...pulumi.InvokeOption) (*ListSqlMigrationServiceAuthKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:datamigration/v20230715preview:listSqlMigrationServiceAuthKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListSqlMigrationServiceAuthKeysOutput(ctx *pulumi.Context, args ListSqlMigrationServiceAuthKeysOutputArgs, opts ...pulumi.InvokeOption) ListSqlMigrationServiceAuthKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListSqlMigrationServiceAuthKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datamigration/v20230715preview:listSqlMigrationServiceAuthKeys", args, ListSqlMigrationServiceAuthKeysResultOutput{}, options).(ListSqlMigrationServiceAuthKeysResultOutput), nil
