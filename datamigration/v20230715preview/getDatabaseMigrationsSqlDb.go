...
func LookupDatabaseMigrationsSqlDb(ctx *pulumi.Context, args *LookupDatabaseMigrationsSqlDbArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseMigrationsSqlDbResult, error) {
	...
	err := ctx.Invoke("azure-native:datamigration/v20230715preview:getDatabaseMigrationsSqlDb", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDatabaseMigrationsSqlDbOutput(ctx *pulumi.Context, args LookupDatabaseMigrationsSqlDbOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseMigrationsSqlDbResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseMigrationsSqlDbResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datamigration/v20230715preview:getDatabaseMigrationsSqlDb", args, LookupDatabaseMigrationsSqlDbResultOutput{}, options).(LookupDatabaseMigrationsSqlDbResultOutput), nil
