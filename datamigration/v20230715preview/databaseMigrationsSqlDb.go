...
func NewDatabaseMigrationsSqlDb(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datamigration/v20230715preview:DatabaseMigrationsSqlDb", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseMigrationsSqlDb(ctx *pulumi.Context,
	...
	var resource DatabaseMigrationsSqlDb
	err := ctx.ReadResource("azure-native:datamigration/v20230715preview:DatabaseMigrationsSqlDb", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
