...
// A project resource
//
// Deprecated: azure-native:datamigration/v20180715preview:Project is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20210630:Project to guarantee forwards compatibility.
type Project struct {
...
func NewProject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datamigration/v20180715preview:Project", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProject(ctx *pulumi.Context,
	...
	var resource Project
	err := ctx.ReadResource("azure-native:datamigration/v20180715preview:Project", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
