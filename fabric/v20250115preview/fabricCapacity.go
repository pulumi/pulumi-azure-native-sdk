...
func NewFabricCapacity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:fabric/v20250115preview:FabricCapacity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFabricCapacity(ctx *pulumi.Context,
	...
	var resource FabricCapacity
	err := ctx.ReadResource("azure-native:fabric/v20250115preview:FabricCapacity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
