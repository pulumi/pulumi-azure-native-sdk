...
func NewComputePolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datalakeanalytics/v20151001preview:ComputePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputePolicy(ctx *pulumi.Context,
	...
	var resource ComputePolicy
	err := ctx.ReadResource("azure-native:datalakeanalytics/v20151001preview:ComputePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
