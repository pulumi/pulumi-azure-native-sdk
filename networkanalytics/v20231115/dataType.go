...
func NewDataType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:networkanalytics:DataType"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DataType
	err := ctx.RegisterResource("azure-native:networkanalytics/v20231115:DataType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataType(ctx *pulumi.Context,
	...
	var resource DataType
	err := ctx.ReadResource("azure-native:networkanalytics/v20231115:DataType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
