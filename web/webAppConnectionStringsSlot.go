...
func NewWebAppConnectionStringsSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppConnectionStringsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppConnectionStringsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppConnectionStringsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppConnectionStringsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppConnectionStringsSlot"),
		},
	})
...
// The Azure API version of the resource.
func (o WebAppConnectionStringsSlotOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppConnectionStringsSlot) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
