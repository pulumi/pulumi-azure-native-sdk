...
func LookupWebAppPublicCertificateOutput(ctx *pulumi.Context, args LookupWebAppPublicCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppPublicCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppPublicCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20201001:getWebAppPublicCertificate", args, LookupWebAppPublicCertificateResultOutput{}, options).(LookupWebAppPublicCertificateResultOutput), nil
...
// The system metadata relating to this resource.
func (o LookupWebAppPublicCertificateResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupWebAppPublicCertificateResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
