...
func LookupWebAppPublicCertificateSlot(ctx *pulumi.Context, args *LookupWebAppPublicCertificateSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPublicCertificateSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20201001:getWebAppPublicCertificateSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupWebAppPublicCertificateSlotResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWebAppPublicCertificateSlotResult] {
	return pulumix.Output[LookupWebAppPublicCertificateSlotResult]{
