...
func NewWebAppSourceControl(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppSourceControl"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppSourceControl
	err := ctx.RegisterResource("azure-native:web/v20201001:WebAppSourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSourceControl(ctx *pulumi.Context,
	...
	var resource WebAppSourceControl
	err := ctx.ReadResource("azure-native:web/v20201001:WebAppSourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
