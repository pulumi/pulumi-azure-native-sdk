...
func NewWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20201001:WebAppHostNameBindingSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBindingSlot
	err := ctx.ReadResource("azure-native:web/v20201001:WebAppHostNameBindingSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *WebAppHostNameBindingSlot) ToOutput(ctx context.Context) pulumix.Output[*WebAppHostNameBindingSlot] {
	return pulumix.Output[*WebAppHostNameBindingSlot]{
		OutputState: i.ToWebAppHostNameBindingSlotOutputWithContext(ctx).OutputState,
	}
}
...
func (o WebAppHostNameBindingSlotOutput) ToOutput(ctx context.Context) pulumix.Output[*WebAppHostNameBindingSlot] {
	return pulumix.Output[*WebAppHostNameBindingSlot]{
...
// The system metadata relating to this resource.
func (o WebAppHostNameBindingSlotOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppHostNameBindingSlot) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
