...
func LookupWebAppDeployment(ctx *pulumi.Context, args *LookupWebAppDeploymentArgs, opts ...pulumi.InvokeOption) (*LookupWebAppDeploymentResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20201001:getWebAppDeployment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppDeploymentOutput(ctx *pulumi.Context, args LookupWebAppDeploymentOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppDeploymentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppDeploymentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20201001:getWebAppDeployment", args, LookupWebAppDeploymentResultOutput{}, options).(LookupWebAppDeploymentResultOutput), nil
