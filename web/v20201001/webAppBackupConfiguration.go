...
func NewWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20201001:WebAppBackupConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppBackupConfiguration
	err := ctx.ReadResource("azure-native:web/v20201001:WebAppBackupConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *WebAppBackupConfiguration) ToOutput(ctx context.Context) pulumix.Output[*WebAppBackupConfiguration] {
	return pulumix.Output[*WebAppBackupConfiguration]{
		OutputState: i.ToWebAppBackupConfigurationOutputWithContext(ctx).OutputState,
	}
}
...
func (o WebAppBackupConfigurationOutput) ToOutput(ctx context.Context) pulumix.Output[*WebAppBackupConfiguration] {
	return pulumix.Output[*WebAppBackupConfiguration]{
...
// The system metadata relating to this resource.
func (o WebAppBackupConfigurationOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppBackupConfiguration) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
