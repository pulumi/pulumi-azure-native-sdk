...
func NewWebAppPublicCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppPublicCertificate"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppPublicCertificate"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppPublicCertificate
	err := ctx.RegisterResource("azure-native:web/v20201001:WebAppPublicCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPublicCertificate(ctx *pulumi.Context,
	...
	var resource WebAppPublicCertificate
	err := ctx.ReadResource("azure-native:web/v20201001:WebAppPublicCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
