...
func ListStaticSiteFunctionAppSettings(ctx *pulumi.Context, args *ListStaticSiteFunctionAppSettingsArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteFunctionAppSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20201001:listStaticSiteFunctionAppSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListStaticSiteFunctionAppSettingsOutput(ctx *pulumi.Context, args ListStaticSiteFunctionAppSettingsOutputArgs, opts ...pulumi.InvokeOption) ListStaticSiteFunctionAppSettingsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (ListStaticSiteFunctionAppSettingsResultOutput, error) {
			...
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv ListStaticSiteFunctionAppSettingsResult
			secret, err := ctx.InvokePackageRaw("azure-native:web/v20201001:listStaticSiteFunctionAppSettings", args, &rv, "", opts...)
			if err != nil {
				return ListStaticSiteFunctionAppSettingsResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(ListStaticSiteFunctionAppSettingsResultOutput)
			if secret {
				return pulumi.ToSecret(output).(ListStaticSiteFunctionAppSettingsResultOutput), nil
			}
			return output, nil
...
// The system metadata relating to this resource.
func (o ListStaticSiteFunctionAppSettingsResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ListStaticSiteFunctionAppSettingsResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
