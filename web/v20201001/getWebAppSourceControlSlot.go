...
func LookupWebAppSourceControlSlot(ctx *pulumi.Context, args *LookupWebAppSourceControlSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSourceControlSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20201001:getWebAppSourceControlSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppSourceControlSlotOutput(ctx *pulumi.Context, args LookupWebAppSourceControlSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppSourceControlSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppSourceControlSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20201001:getWebAppSourceControlSlot", args, LookupWebAppSourceControlSlotResultOutput{}, options).(LookupWebAppSourceControlSlotResultOutput), nil
