...
func NewWebAppAuthSettingsV2Slot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20210301:WebAppAuthSettingsV2Slot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20220301:WebAppAuthSettingsV2Slot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppAuthSettingsV2Slot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppAuthSettingsV2Slot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppAuthSettingsV2Slot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppAuthSettingsV2Slot"),
		},
		{
