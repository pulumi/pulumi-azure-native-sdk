...
func ListWebAppSitePushSettings(ctx *pulumi.Context, args *ListWebAppSitePushSettingsArgs, opts ...pulumi.InvokeOption) (*ListWebAppSitePushSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20201001:listWebAppSitePushSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppSitePushSettingsOutput(ctx *pulumi.Context, args ListWebAppSitePushSettingsOutputArgs, opts ...pulumi.InvokeOption) ListWebAppSitePushSettingsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (ListWebAppSitePushSettingsResultOutput, error) {
			...
			opts = utilities.PkgInvokeDefaultOpts(opts)
			var rv ListWebAppSitePushSettingsResult
			secret, err := ctx.InvokePackageRaw("azure-native:web/v20201001:listWebAppSitePushSettings", args, &rv, "", opts...)
			if err != nil {
				return ListWebAppSitePushSettingsResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(ListWebAppSitePushSettingsResultOutput)
			if secret {
				return pulumi.ToSecret(output).(ListWebAppSitePushSettingsResultOutput), nil
			}
			return output, nil
...
// The system metadata relating to this resource.
func (o ListWebAppSitePushSettingsResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ListWebAppSitePushSettingsResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
