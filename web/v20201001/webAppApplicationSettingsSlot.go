...
func NewWebAppApplicationSettingsSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppApplicationSettingsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppApplicationSettingsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppApplicationSettingsSlot"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:web/v20201001:WebAppApplicationSettingsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppApplicationSettingsSlot(ctx *pulumi.Context,
	...
	var resource WebAppApplicationSettingsSlot
	err := ctx.ReadResource("azure-native:web/v20201001:WebAppApplicationSettingsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
