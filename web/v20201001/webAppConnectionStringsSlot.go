...
func NewWebAppConnectionStringsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20201001:WebAppConnectionStringsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConnectionStringsSlot(ctx *pulumi.Context,
	...
	var resource WebAppConnectionStringsSlot
	err := ctx.ReadResource("azure-native:web/v20201001:WebAppConnectionStringsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
