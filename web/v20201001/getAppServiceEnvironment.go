...
func LookupAppServiceEnvironment(ctx *pulumi.Context, args *LookupAppServiceEnvironmentArgs, opts ...pulumi.InvokeOption) (*LookupAppServiceEnvironmentResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20201001:getAppServiceEnvironment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAppServiceEnvironmentOutput(ctx *pulumi.Context, args LookupAppServiceEnvironmentOutputArgs, opts ...pulumi.InvokeOption) LookupAppServiceEnvironmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAppServiceEnvironmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20201001:getAppServiceEnvironment", args, LookupAppServiceEnvironmentResultOutput{}, options).(LookupAppServiceEnvironmentResultOutput), nil
