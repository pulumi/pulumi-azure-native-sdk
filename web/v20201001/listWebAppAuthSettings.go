...
func ListWebAppAuthSettings(ctx *pulumi.Context, args *ListWebAppAuthSettingsArgs, opts ...pulumi.InvokeOption) (*ListWebAppAuthSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20201001:listWebAppAuthSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ListWebAppAuthSettingsResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListWebAppAuthSettingsResult] {
	return pulumix.Output[ListWebAppAuthSettingsResult]{
...
// The system metadata relating to this resource.
func (o ListWebAppAuthSettingsResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ListWebAppAuthSettingsResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
