...
func NewWebAppSourceControl(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppSourceControl"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppSourceControl"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppSourceControl"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppSourceControl"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppSourceControl"),
		},
	})
...
// The Azure API version of the resource.
func (o WebAppSourceControlOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppSourceControl) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
