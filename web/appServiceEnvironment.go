...
func NewAppServiceEnvironment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20250301:AppServiceEnvironment"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:AppServiceEnvironment"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:AppServiceEnvironment"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:AppServiceEnvironment"),
		},
	})
