...
func NewWebAppSiteExtensionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppSiteExtensionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppSiteExtensionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppSiteExtensionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppSiteExtensionSlot"),
		},
	})
