...
func NewWebAppApplicationSettings(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppApplicationSettings"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppApplicationSettings"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppApplicationSettings"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppApplicationSettings"),
		},
	})
