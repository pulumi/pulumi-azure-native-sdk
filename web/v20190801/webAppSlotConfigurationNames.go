...
//
// Deprecated: azure-native:web/v20190801:WebAppSlotConfigurationNames is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSlotConfigurationNames to guarantee forwards compatibility.
...
func NewWebAppSlotConfigurationNames(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20190801:WebAppSlotConfigurationNames", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSlotConfigurationNames(ctx *pulumi.Context,
	...
	var resource WebAppSlotConfigurationNames
	err := ctx.ReadResource("azure-native:web/v20190801:WebAppSlotConfigurationNames", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
