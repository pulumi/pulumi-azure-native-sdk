...
func NewWebAppPremierAddOn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20190801:WebAppPremierAddOn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPremierAddOn(ctx *pulumi.Context,
	...
	var resource WebAppPremierAddOn
	err := ctx.ReadResource("azure-native:web/v20190801:WebAppPremierAddOn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
