...
//
// Deprecated: azure-native:web/v20190801:WebAppBackupConfigurationSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppBackupConfigurationSlot to guarantee forwards compatibility.
...
func NewWebAppBackupConfigurationSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20190801:WebAppBackupConfigurationSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppBackupConfigurationSlot(ctx *pulumi.Context,
	...
	var resource WebAppBackupConfigurationSlot
	err := ctx.ReadResource("azure-native:web/v20190801:WebAppBackupConfigurationSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
