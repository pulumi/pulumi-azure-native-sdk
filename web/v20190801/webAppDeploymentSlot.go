...
//
// Deprecated: azure-native:web/v20190801:WebAppDeploymentSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppDeploymentSlot to guarantee forwards compatibility.
...
func NewWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20190801:WebAppDeploymentSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	var resource WebAppDeploymentSlot
	err := ctx.ReadResource("azure-native:web/v20190801:WebAppDeploymentSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
