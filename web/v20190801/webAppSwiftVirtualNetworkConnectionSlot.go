...
//
// Deprecated: azure-native:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnectionSlot to guarantee forwards compatibility.
...
func NewWebAppSwiftVirtualNetworkConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSwiftVirtualNetworkConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppSwiftVirtualNetworkConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
