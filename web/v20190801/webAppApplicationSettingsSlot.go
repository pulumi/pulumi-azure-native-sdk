...
//
// Deprecated: azure-native:web/v20190801:WebAppApplicationSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppApplicationSettingsSlot to guarantee forwards compatibility.
...
func NewWebAppApplicationSettingsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20190801:WebAppApplicationSettingsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppApplicationSettingsSlot(ctx *pulumi.Context,
	...
	var resource WebAppApplicationSettingsSlot
	err := ctx.ReadResource("azure-native:web/v20190801:WebAppApplicationSettingsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
