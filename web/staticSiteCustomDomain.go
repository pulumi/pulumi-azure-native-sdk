...
func NewStaticSiteCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20250301:StaticSiteCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:StaticSiteCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:StaticSiteCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:StaticSiteCustomDomain"),
		},
	})
