...
//
// Deprecated: azure-native:web/v20200601:AppServicePlan is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:AppServicePlan to guarantee forwards compatibility.
func LookupAppServicePlan(ctx *pulumi.Context, args *LookupAppServicePlanArgs, opts ...pulumi.InvokeOption) (*LookupAppServicePlanResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200601:getAppServicePlan", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
