...
//
// Deprecated: azure-native:web/v20200601:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.
...
func NewWebAppRelayServiceConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20200601:WebAppRelayServiceConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20200601:WebAppRelayServiceConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
