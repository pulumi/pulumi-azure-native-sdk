...
//
// Deprecated: azure-native:web/v20200601:AppServicePlanRouteForVnet is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:AppServicePlanRouteForVnet to guarantee forwards compatibility.
