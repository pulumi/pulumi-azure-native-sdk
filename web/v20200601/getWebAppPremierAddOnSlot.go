...
//
// Deprecated: azure-native:web/v20200601:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPremierAddOnSlot to guarantee forwards compatibility.
func LookupWebAppPremierAddOnSlot(ctx *pulumi.Context, args *LookupWebAppPremierAddOnSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPremierAddOnSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200601:getWebAppPremierAddOnSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
