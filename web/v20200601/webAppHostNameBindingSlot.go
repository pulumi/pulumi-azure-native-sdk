...
//
// Deprecated: azure-native:web/v20200601:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHostNameBindingSlot to guarantee forwards compatibility.
...
func NewWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20200601:WebAppHostNameBindingSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBindingSlot
	err := ctx.ReadResource("azure-native:web/v20200601:WebAppHostNameBindingSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
