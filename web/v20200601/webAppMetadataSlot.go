...
//
// Deprecated: azure-native:web/v20200601:WebAppMetadataSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppMetadataSlot to guarantee forwards compatibility.
...
func NewWebAppMetadataSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20200601:WebAppMetadataSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppMetadataSlot(ctx *pulumi.Context,
	...
	var resource WebAppMetadataSlot
	err := ctx.ReadResource("azure-native:web/v20200601:WebAppMetadataSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
