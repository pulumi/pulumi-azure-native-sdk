...
//
// Deprecated: azure-native:web/v20200601:WebAppSwiftVirtualNetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnection to guarantee forwards compatibility.
func LookupWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context, args *LookupWebAppSwiftVirtualNetworkConnectionArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSwiftVirtualNetworkConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200601:getWebAppSwiftVirtualNetworkConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
