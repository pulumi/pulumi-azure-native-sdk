...
//
// Deprecated: azure-native:web/v20200601:StaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:StaticSite to guarantee forwards compatibility.
func LookupStaticSite(ctx *pulumi.Context, args *LookupStaticSiteArgs, opts ...pulumi.InvokeOption) (*LookupStaticSiteResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200601:getStaticSite", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
