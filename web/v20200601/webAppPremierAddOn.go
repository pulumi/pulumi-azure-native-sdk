...
// Premier add-on.
//
// Deprecated: azure-native:web/v20200601:WebAppPremierAddOn is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility.
...
func NewWebAppPremierAddOn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20200601:WebAppPremierAddOn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPremierAddOn(ctx *pulumi.Context,
	...
	var resource WebAppPremierAddOn
	err := ctx.ReadResource("azure-native:web/v20200601:WebAppPremierAddOn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
