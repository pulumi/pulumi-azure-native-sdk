...
func NewWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppBackupConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppBackupConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppBackupConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppBackupConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppBackupConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppBackupConfiguration
	err := ctx.RegisterResource("azure-native:web:WebAppBackupConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppBackupConfiguration
	err := ctx.ReadResource("azure-native:web:WebAppBackupConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppBackupConfigurationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppBackupConfiguration) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
