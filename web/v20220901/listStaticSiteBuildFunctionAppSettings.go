...
func ListStaticSiteBuildFunctionAppSettings(ctx *pulumi.Context, args *ListStaticSiteBuildFunctionAppSettingsArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteBuildFunctionAppSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:listStaticSiteBuildFunctionAppSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListStaticSiteBuildFunctionAppSettingsOutput(ctx *pulumi.Context, args ListStaticSiteBuildFunctionAppSettingsOutputArgs, opts ...pulumi.InvokeOption) ListStaticSiteBuildFunctionAppSettingsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListStaticSiteBuildFunctionAppSettingsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:listStaticSiteBuildFunctionAppSettings", args, ListStaticSiteBuildFunctionAppSettingsResultOutput{}, options).(ListStaticSiteBuildFunctionAppSettingsResultOutput), nil
