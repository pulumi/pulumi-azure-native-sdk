...
func LookupWebAppDiagnosticLogsConfiguration(ctx *pulumi.Context, args *LookupWebAppDiagnosticLogsConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupWebAppDiagnosticLogsConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:getWebAppDiagnosticLogsConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupWebAppDiagnosticLogsConfigurationOutput(ctx *pulumi.Context, args LookupWebAppDiagnosticLogsConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppDiagnosticLogsConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppDiagnosticLogsConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:getWebAppDiagnosticLogsConfiguration", args, LookupWebAppDiagnosticLogsConfigurationResultOutput{}, options).(LookupWebAppDiagnosticLogsConfigurationResultOutput), nil
