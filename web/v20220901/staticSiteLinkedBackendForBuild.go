...
func NewStaticSiteLinkedBackendForBuild(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220901:StaticSiteLinkedBackendForBuild", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteLinkedBackendForBuild(ctx *pulumi.Context,
	...
	var resource StaticSiteLinkedBackendForBuild
	err := ctx.ReadResource("azure-native:web/v20220901:StaticSiteLinkedBackendForBuild", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
