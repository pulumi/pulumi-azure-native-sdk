...
func NewWebAppAzureStorageAccountsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220901:WebAppAzureStorageAccountsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAzureStorageAccountsSlot(ctx *pulumi.Context,
	...
	var resource WebAppAzureStorageAccountsSlot
	err := ctx.ReadResource("azure-native:web/v20220901:WebAppAzureStorageAccountsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *WebAppAzureStorageAccountsSlot) ToOutput(ctx context.Context) pulumix.Output[*WebAppAzureStorageAccountsSlot] {
	return pulumix.Output[*WebAppAzureStorageAccountsSlot]{
		OutputState: i.ToWebAppAzureStorageAccountsSlotOutputWithContext(ctx).OutputState,
	}
}
...
func (o WebAppAzureStorageAccountsSlotOutput) ToOutput(ctx context.Context) pulumix.Output[*WebAppAzureStorageAccountsSlot] {
	return pulumix.Output[*WebAppAzureStorageAccountsSlot]{
