...
//
// Deprecated: azure-native:web/v20220901:WebApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebApp to guarantee forwards compatibility.
func LookupWebApp(ctx *pulumi.Context, args *LookupWebAppArgs, opts ...pulumi.InvokeOption) (*LookupWebAppResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:getWebApp", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
