...
func NewAppServiceEnvironmentAseCustomDnsSuffixConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220901:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceEnvironmentAseCustomDnsSuffixConfiguration(ctx *pulumi.Context,
	...
	var resource AppServiceEnvironmentAseCustomDnsSuffixConfiguration
	err := ctx.ReadResource("azure-native:web/v20220901:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
