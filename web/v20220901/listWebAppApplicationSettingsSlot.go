...
func ListWebAppApplicationSettingsSlot(ctx *pulumi.Context, args *ListWebAppApplicationSettingsSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppApplicationSettingsSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:listWebAppApplicationSettingsSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppApplicationSettingsSlotOutput(ctx *pulumi.Context, args ListWebAppApplicationSettingsSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppApplicationSettingsSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppApplicationSettingsSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:listWebAppApplicationSettingsSlot", args, ListWebAppApplicationSettingsSlotResultOutput{}, options).(ListWebAppApplicationSettingsSlotResultOutput), nil
