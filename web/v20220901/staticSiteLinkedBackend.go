...
func NewStaticSiteLinkedBackend(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220901:StaticSiteLinkedBackend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteLinkedBackend(ctx *pulumi.Context,
	...
	var resource StaticSiteLinkedBackend
	err := ctx.ReadResource("azure-native:web/v20220901:StaticSiteLinkedBackend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
