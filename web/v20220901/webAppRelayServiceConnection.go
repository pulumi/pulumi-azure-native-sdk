...
func NewWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220901:WebAppRelayServiceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnection
	err := ctx.ReadResource("azure-native:web/v20220901:WebAppRelayServiceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *WebAppRelayServiceConnection) ToOutput(ctx context.Context) pulumix.Output[*WebAppRelayServiceConnection] {
	return pulumix.Output[*WebAppRelayServiceConnection]{
		OutputState: i.ToWebAppRelayServiceConnectionOutputWithContext(ctx).OutputState,
	}
}
...
func (o WebAppRelayServiceConnectionOutput) ToOutput(ctx context.Context) pulumix.Output[*WebAppRelayServiceConnection] {
	return pulumix.Output[*WebAppRelayServiceConnection]{
