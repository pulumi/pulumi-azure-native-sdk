...
func LookupWebAppPublicCertificate(ctx *pulumi.Context, args *LookupWebAppPublicCertificateArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPublicCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:getWebAppPublicCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppPublicCertificateOutput(ctx *pulumi.Context, args LookupWebAppPublicCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppPublicCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppPublicCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:getWebAppPublicCertificate", args, LookupWebAppPublicCertificateResultOutput{}, options).(LookupWebAppPublicCertificateResultOutput), nil
