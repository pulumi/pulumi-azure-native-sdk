...
func LookupStaticSiteBuildDatabaseConnection(ctx *pulumi.Context, args *LookupStaticSiteBuildDatabaseConnectionArgs, opts ...pulumi.InvokeOption) (*LookupStaticSiteBuildDatabaseConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:getStaticSiteBuildDatabaseConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStaticSiteBuildDatabaseConnectionOutput(ctx *pulumi.Context, args LookupStaticSiteBuildDatabaseConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupStaticSiteBuildDatabaseConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStaticSiteBuildDatabaseConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:getStaticSiteBuildDatabaseConnection", args, LookupStaticSiteBuildDatabaseConnectionResultOutput{}, options).(LookupStaticSiteBuildDatabaseConnectionResultOutput), nil
