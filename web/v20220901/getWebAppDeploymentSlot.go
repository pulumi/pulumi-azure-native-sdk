...
func LookupWebAppDeploymentSlot(ctx *pulumi.Context, args *LookupWebAppDeploymentSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppDeploymentSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:getWebAppDeploymentSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupWebAppDeploymentSlotResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWebAppDeploymentSlotResult] {
	return pulumix.Output[LookupWebAppDeploymentSlotResult]{
