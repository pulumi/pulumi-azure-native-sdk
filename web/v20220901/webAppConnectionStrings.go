...
func NewWebAppConnectionStrings(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppConnectionStrings"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppConnectionStrings
	err := ctx.RegisterResource("azure-native:web/v20220901:WebAppConnectionStrings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConnectionStrings(ctx *pulumi.Context,
	...
	var resource WebAppConnectionStrings
	err := ctx.ReadResource("azure-native:web/v20220901:WebAppConnectionStrings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
