...
func LookupWebAppHybridConnection(ctx *pulumi.Context, args *LookupWebAppHybridConnectionArgs, opts ...pulumi.InvokeOption) (*LookupWebAppHybridConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:getWebAppHybridConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppHybridConnectionOutput(ctx *pulumi.Context, args LookupWebAppHybridConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppHybridConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppHybridConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:getWebAppHybridConnection", args, LookupWebAppHybridConnectionResultOutput{}, options).(LookupWebAppHybridConnectionResultOutput), nil
