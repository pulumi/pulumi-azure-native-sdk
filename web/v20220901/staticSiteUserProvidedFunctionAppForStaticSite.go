...
func NewStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220901:StaticSiteUserProvidedFunctionAppForStaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSiteUserProvidedFunctionAppForStaticSite
	err := ctx.ReadResource("azure-native:web/v20220901:StaticSiteUserProvidedFunctionAppForStaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *StaticSiteUserProvidedFunctionAppForStaticSite) ToOutput(ctx context.Context) pulumix.Output[*StaticSiteUserProvidedFunctionAppForStaticSite] {
	return pulumix.Output[*StaticSiteUserProvidedFunctionAppForStaticSite]{
		OutputState: i.ToStaticSiteUserProvidedFunctionAppForStaticSiteOutputWithContext(ctx).OutputState,
	}
}
...
func (o StaticSiteUserProvidedFunctionAppForStaticSiteOutput) ToOutput(ctx context.Context) pulumix.Output[*StaticSiteUserProvidedFunctionAppForStaticSite] {
	return pulumix.Output[*StaticSiteUserProvidedFunctionAppForStaticSite]{
