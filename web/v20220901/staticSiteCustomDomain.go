...
func NewStaticSiteCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220901:StaticSiteCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteCustomDomain(ctx *pulumi.Context,
	...
	var resource StaticSiteCustomDomain
	err := ctx.ReadResource("azure-native:web/v20220901:StaticSiteCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
