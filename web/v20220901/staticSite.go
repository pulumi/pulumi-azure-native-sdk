...
func NewStaticSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220901:StaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSite
	err := ctx.ReadResource("azure-native:web/v20220901:StaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Database connections for the static site
func (o StaticSiteOutput) DatabaseConnections() DatabaseConnectionOverviewResponseArrayOutput {
	return o.ApplyT(func(v *StaticSite) DatabaseConnectionOverviewResponseArrayOutput { return v.DatabaseConnections }).(DatabaseConnectionOverviewResponseArrayOutput)
}
...
func (o StaticSiteOutput) EnterpriseGradeCdnStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StaticSite) pulumi.StringPtrOutput { return v.EnterpriseGradeCdnStatus }).(pulumi.StringPtrOutput)
}
...
// Backends linked to the static side
func (o StaticSiteOutput) LinkedBackends() StaticSiteLinkedBackendResponseArrayOutput {
...
// The provider that submitted the last deployment to the primary environment of the static site.
func (o StaticSiteOutput) Provider() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StaticSite) pulumi.StringPtrOutput { return v.Provider }).(pulumi.StringPtrOutput)
}

// State indicating whether public traffic are allowed or not for a static web app. Allowed Values: 'Enabled', 'Disabled' or an empty string.
func (o StaticSiteOutput) PublicNetworkAccess() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StaticSite) pulumi.StringPtrOutput { return v.PublicNetworkAccess }).(pulumi.StringPtrOutput)
}
