...
func ListWebAppBackupStatusSecrets(ctx *pulumi.Context, args *ListWebAppBackupStatusSecretsArgs, opts ...pulumi.InvokeOption) (*ListWebAppBackupStatusSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:listWebAppBackupStatusSecrets", args.Defaults(), &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppBackupStatusSecretsOutput(ctx *pulumi.Context, args ListWebAppBackupStatusSecretsOutputArgs, opts ...pulumi.InvokeOption) ListWebAppBackupStatusSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppBackupStatusSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:listWebAppBackupStatusSecrets", args.Defaults(), ListWebAppBackupStatusSecretsResultOutput{}, options).(ListWebAppBackupStatusSecretsResultOutput), nil
