...
func ListStaticSiteFunctionAppSettings(ctx *pulumi.Context, args *ListStaticSiteFunctionAppSettingsArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteFunctionAppSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:listStaticSiteFunctionAppSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListStaticSiteFunctionAppSettingsOutput(ctx *pulumi.Context, args ListStaticSiteFunctionAppSettingsOutputArgs, opts ...pulumi.InvokeOption) ListStaticSiteFunctionAppSettingsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListStaticSiteFunctionAppSettingsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:listStaticSiteFunctionAppSettings", args, ListStaticSiteFunctionAppSettingsResultOutput{}, options).(ListStaticSiteFunctionAppSettingsResultOutput), nil
