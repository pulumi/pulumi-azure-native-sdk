...
func ListWebAppSyncFunctionTriggers(ctx *pulumi.Context, args *ListWebAppSyncFunctionTriggersArgs, opts ...pulumi.InvokeOption) (*ListWebAppSyncFunctionTriggersResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220901:listWebAppSyncFunctionTriggers", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppSyncFunctionTriggersOutput(ctx *pulumi.Context, args ListWebAppSyncFunctionTriggersOutputArgs, opts ...pulumi.InvokeOption) ListWebAppSyncFunctionTriggersResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppSyncFunctionTriggersResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20220901:listWebAppSyncFunctionTriggers", args, ListWebAppSyncFunctionTriggersResultOutput{}, options).(ListWebAppSyncFunctionTriggersResultOutput), nil
