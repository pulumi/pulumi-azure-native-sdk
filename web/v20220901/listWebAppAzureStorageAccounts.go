...
func (o ListWebAppAzureStorageAccountsResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListWebAppAzureStorageAccountsResult] {
	return pulumix.Output[ListWebAppAzureStorageAccountsResult]{
