...
//
// Deprecated: azure-native:web/v20220301:WebAppPublicCertificateSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPublicCertificateSlot to guarantee forwards compatibility.
func LookupWebAppPublicCertificateSlot(ctx *pulumi.Context, args *LookupWebAppPublicCertificateSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPublicCertificateSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220301:getWebAppPublicCertificateSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
