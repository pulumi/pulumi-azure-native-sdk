...
//
// Deprecated: azure-native:web/v20220301:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAuthSettingsSlot to guarantee forwards compatibility.
...
func NewWebAppAuthSettingsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220301:WebAppAuthSettingsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAuthSettingsSlot(ctx *pulumi.Context,
	...
	var resource WebAppAuthSettingsSlot
	err := ctx.ReadResource("azure-native:web/v20220301:WebAppAuthSettingsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
