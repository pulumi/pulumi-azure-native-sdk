...
//
// Deprecated: azure-native:web/v20220301:WebAppAuthSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAuthSettings to guarantee forwards compatibility.
...
func NewWebAppAuthSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220301:WebAppAuthSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAuthSettings(ctx *pulumi.Context,
	...
	var resource WebAppAuthSettings
	err := ctx.ReadResource("azure-native:web/v20220301:WebAppAuthSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
