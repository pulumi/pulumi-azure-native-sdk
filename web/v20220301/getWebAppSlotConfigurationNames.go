...
//
// Deprecated: azure-native:web/v20220301:WebAppSlotConfigurationNames is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSlotConfigurationNames to guarantee forwards compatibility.
func LookupWebAppSlotConfigurationNames(ctx *pulumi.Context, args *LookupWebAppSlotConfigurationNamesArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSlotConfigurationNamesResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20220301:getWebAppSlotConfigurationNames", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
