...
func NewWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220301:WebAppPremierAddOnSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	var resource WebAppPremierAddOnSlot
	err := ctx.ReadResource("azure-native:web/v20220301:WebAppPremierAddOnSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
