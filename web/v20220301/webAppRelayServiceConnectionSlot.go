...
func NewWebAppRelayServiceConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220301:WebAppRelayServiceConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20220301:WebAppRelayServiceConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
