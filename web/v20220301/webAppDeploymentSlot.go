...
//
// Deprecated: azure-native:web/v20220301:WebAppDeploymentSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDeploymentSlot to guarantee forwards compatibility.
...
func NewWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppDeploymentSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppDeploymentSlot
	err := ctx.RegisterResource("azure-native:web/v20220301:WebAppDeploymentSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	var resource WebAppDeploymentSlot
	err := ctx.ReadResource("azure-native:web/v20220301:WebAppDeploymentSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
