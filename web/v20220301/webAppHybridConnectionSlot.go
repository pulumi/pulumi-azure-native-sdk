...
//
// Deprecated: azure-native:web/v20220301:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHybridConnectionSlot to guarantee forwards compatibility.
...
func NewWebAppHybridConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220301:WebAppHybridConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHybridConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppHybridConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20220301:WebAppHybridConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
