...
func NewStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20220301:StaticSiteUserProvidedFunctionAppForStaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSiteUserProvidedFunctionAppForStaticSite
	err := ctx.ReadResource("azure-native:web/v20220301:StaticSiteUserProvidedFunctionAppForStaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
