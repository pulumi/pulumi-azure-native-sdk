...
//
// Deprecated: azure-native:web/v20210201:WebAppRelayServiceConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppRelayServiceConnection to guarantee forwards compatibility.
...
func NewWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210201:WebAppRelayServiceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnection
	err := ctx.ReadResource("azure-native:web/v20210201:WebAppRelayServiceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
