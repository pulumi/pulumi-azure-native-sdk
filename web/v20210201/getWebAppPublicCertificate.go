...
//
// Deprecated: azure-native:web/v20210201:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPublicCertificate to guarantee forwards compatibility.
func LookupWebAppPublicCertificate(ctx *pulumi.Context, args *LookupWebAppPublicCertificateArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPublicCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20210201:getWebAppPublicCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
