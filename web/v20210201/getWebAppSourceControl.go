...
//
// Deprecated: azure-native:web/v20210201:WebAppSourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSourceControl to guarantee forwards compatibility.
func LookupWebAppSourceControl(ctx *pulumi.Context, args *LookupWebAppSourceControlArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSourceControlResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20210201:getWebAppSourceControl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// If GitHub Action is selected, than the associated configuration.
func (o LookupWebAppSourceControlResultOutput) GitHubActionConfiguration() GitHubActionConfigurationResponsePtrOutput {
	return o.ApplyT(func(v LookupWebAppSourceControlResult) *GitHubActionConfigurationResponse {
