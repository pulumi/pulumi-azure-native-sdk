...
//
// Deprecated: azure-native:web/v20210201:StaticSiteCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSiteCustomDomain to guarantee forwards compatibility.
...
func NewStaticSiteCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:StaticSiteCustomDomain"),
		},
	})
	opts = append(opts, aliases)
	var resource StaticSiteCustomDomain
	err := ctx.RegisterResource("azure-native:web/v20210201:StaticSiteCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteCustomDomain(ctx *pulumi.Context,
	...
	var resource StaticSiteCustomDomain
	err := ctx.ReadResource("azure-native:web/v20210201:StaticSiteCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
