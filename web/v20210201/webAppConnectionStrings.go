...
//
// Deprecated: azure-native:web/v20210201:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppConnectionStrings to guarantee forwards compatibility.
...
func NewWebAppConnectionStrings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210201:WebAppConnectionStrings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConnectionStrings(ctx *pulumi.Context,
	...
	var resource WebAppConnectionStrings
	err := ctx.ReadResource("azure-native:web/v20210201:WebAppConnectionStrings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
