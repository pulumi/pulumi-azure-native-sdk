...
func NewWebAppFtpAllowed(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210201:WebAppFtpAllowed", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppFtpAllowed(ctx *pulumi.Context,
	...
	var resource WebAppFtpAllowed
	err := ctx.ReadResource("azure-native:web/v20210201:WebAppFtpAllowed", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
