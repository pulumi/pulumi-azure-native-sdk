...
//
// Deprecated: azure-native:web/v20210201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSiteUserProvidedFunctionAppForStaticSiteBuild to guarantee forwards compatibility.
...
func NewStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context,
	...
	var resource StaticSiteUserProvidedFunctionAppForStaticSiteBuild
	err := ctx.ReadResource("azure-native:web/v20210201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
