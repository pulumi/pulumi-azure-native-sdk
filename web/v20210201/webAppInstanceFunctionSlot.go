...
//
// Deprecated: azure-native:web/v20210201:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppInstanceFunctionSlot to guarantee forwards compatibility.
...
func NewWebAppInstanceFunctionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210201:WebAppInstanceFunctionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppInstanceFunctionSlot(ctx *pulumi.Context,
	...
	var resource WebAppInstanceFunctionSlot
	err := ctx.ReadResource("azure-native:web/v20210201:WebAppInstanceFunctionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
