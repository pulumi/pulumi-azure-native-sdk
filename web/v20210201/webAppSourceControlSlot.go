...
//
// Deprecated: azure-native:web/v20210201:WebAppSourceControlSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSourceControlSlot to guarantee forwards compatibility.
...
func NewWebAppSourceControlSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210201:WebAppSourceControlSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSourceControlSlot(ctx *pulumi.Context,
	...
	var resource WebAppSourceControlSlot
	err := ctx.ReadResource("azure-native:web/v20210201:WebAppSourceControlSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
