...
func LookupWebAppOutput(ctx *pulumi.Context, args LookupWebAppOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web:getWebApp", args, LookupWebAppResultOutput{}, options).(LookupWebAppResultOutput), nil
...
// Specifies the scope of uniqueness for the default hostname during resource creation
func (o LookupWebAppResultOutput) AutoGeneratedDomainNameLabelScope() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWebAppResult) *string { return v.AutoGeneratedDomainNameLabelScope }).(pulumi.StringPtrOutput)
}
...
// The Azure API version of the resource.
func (o LookupWebAppResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWebAppResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Dapr configuration of the app.
func (o LookupWebAppResultOutput) DaprConfig() DaprConfigResponsePtrOutput {
	return o.ApplyT(func(v LookupWebAppResult) *DaprConfigResponse { return v.DaprConfig }).(DaprConfigResponsePtrOutput)
}
...
// Property to configure various DNS related settings for a site.
func (o LookupWebAppResultOutput) DnsConfiguration() SiteDnsConfigResponsePtrOutput {
	return o.ApplyT(func(v LookupWebAppResult) *SiteDnsConfigResponse { return v.DnsConfiguration }).(SiteDnsConfigResponsePtrOutput)
}
...
// Whether to use end to end encryption between the FrontEnd and the Worker
func (o LookupWebAppResultOutput) EndToEndEncryptionEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWebAppResult) *bool { return v.EndToEndEncryptionEnabled }).(pulumi.BoolPtrOutput)
}
...
// Configuration specific of the Azure Function app.
func (o LookupWebAppResultOutput) FunctionAppConfig() FunctionAppConfigResponsePtrOutput {
	return o.ApplyT(func(v LookupWebAppResult) *FunctionAppConfigResponse { return v.FunctionAppConfig }).(FunctionAppConfigResponsePtrOutput)
}
...
// Specifies the IP mode of the app.
func (o LookupWebAppResultOutput) IpMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWebAppResult) *string { return v.IpMode }).(pulumi.StringPtrOutput)
}
...
// Function app resource requirements.
func (o LookupWebAppResultOutput) ResourceConfig() ResourceConfigResponsePtrOutput {
	return o.ApplyT(func(v LookupWebAppResult) *ResourceConfigResponse { return v.ResourceConfig }).(ResourceConfigResponsePtrOutput)
}
...
// Workload profile name for function app to execute on.
func (o LookupWebAppResultOutput) WorkloadProfileName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWebAppResult) *string { return v.WorkloadProfileName }).(pulumi.StringPtrOutput)
}
