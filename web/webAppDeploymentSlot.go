...
func NewWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppDeploymentSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppDeploymentSlot"),
		},
	})
...
// The Azure API version of the resource.
func (o WebAppDeploymentSlotOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppDeploymentSlot) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
