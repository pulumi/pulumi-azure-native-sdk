...
func NewWebAppPrivateEndpointConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20210201:WebAppPrivateEndpointConnectionSlot"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppPrivateEndpointConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppPrivateEndpointConnectionSlot"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppPrivateEndpointConnectionSlot
	err := ctx.RegisterResource("azure-native:web:WebAppPrivateEndpointConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPrivateEndpointConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppPrivateEndpointConnectionSlot
	err := ctx.ReadResource("azure-native:web:WebAppPrivateEndpointConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppPrivateEndpointConnectionSlotOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppPrivateEndpointConnectionSlot) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebAppPrivateEndpointConnectionSlotOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppPrivateEndpointConnectionSlot) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
