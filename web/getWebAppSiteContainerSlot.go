...
// <code>true</code> if all AppSettings and ConnectionStrings have to be passed to the container as environment variables; <code>false</code> otherwise.
func (o LookupWebAppSiteContainerSlotResultOutput) InheritAppSettingsAndConnectionStrings() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWebAppSiteContainerSlotResult) *bool { return v.InheritAppSettingsAndConnectionStrings }).(pulumi.BoolPtrOutput)
}
