...
func NewWebAppVnetConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppVnetConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppVnetConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppVnetConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppVnetConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppVnetConnection"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebAppVnetConnectionOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppVnetConnection) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
