...
func NewStaticSiteUserProvidedFunctionAppForStaticSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:StaticSiteUserProvidedFunctionAppForStaticSite"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o StaticSiteUserProvidedFunctionAppForStaticSiteOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *StaticSiteUserProvidedFunctionAppForStaticSite) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
