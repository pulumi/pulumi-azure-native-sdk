...
func NewWebAppPublicCertificateSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppPublicCertificateSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppPublicCertificateSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppPublicCertificateSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppPublicCertificateSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppPublicCertificateSlot"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebAppPublicCertificateSlotOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppPublicCertificateSlot) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
