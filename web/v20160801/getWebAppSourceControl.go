...
//
// Deprecated: azure-native:web/v20160801:WebAppSourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSourceControl to guarantee forwards compatibility.
func LookupWebAppSourceControl(ctx *pulumi.Context, args *LookupWebAppSourceControlArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSourceControlResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20160801:getWebAppSourceControl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
