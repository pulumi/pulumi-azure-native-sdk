...
func (o LookupWebAppFunctionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWebAppFunctionResult] {
	return pulumix.Output[LookupWebAppFunctionResult]{
