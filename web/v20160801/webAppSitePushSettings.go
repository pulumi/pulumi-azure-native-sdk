...
//
// Deprecated: azure-native:web/v20160801:WebAppSitePushSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSitePushSettings to guarantee forwards compatibility.
...
func NewWebAppSitePushSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20160801:WebAppSitePushSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSitePushSettings(ctx *pulumi.Context,
	...
	var resource WebAppSitePushSettings
	err := ctx.ReadResource("azure-native:web/v20160801:WebAppSitePushSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
