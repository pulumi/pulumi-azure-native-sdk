...
func NewWebAppBackupConfigurationSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20160801:WebAppBackupConfigurationSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppBackupConfigurationSlot(ctx *pulumi.Context,
	...
	var resource WebAppBackupConfigurationSlot
	err := ctx.ReadResource("azure-native:web/v20160801:WebAppBackupConfigurationSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
