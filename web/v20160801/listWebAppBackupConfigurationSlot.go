...
func ListWebAppBackupConfigurationSlotOutput(ctx *pulumi.Context, args ListWebAppBackupConfigurationSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppBackupConfigurationSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppBackupConfigurationSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20160801:listWebAppBackupConfigurationSlot", args, ListWebAppBackupConfigurationSlotResultOutput{}, options).(ListWebAppBackupConfigurationSlotResultOutput), nil
...
// Name of the backup.
func (o ListWebAppBackupConfigurationSlotResultOutput) BackupRequestName() pulumi.StringOutput {
	return o.ApplyT(func(v ListWebAppBackupConfigurationSlotResult) string { return v.BackupRequestName }).(pulumi.StringOutput)
}
