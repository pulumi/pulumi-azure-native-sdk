...
func ListWebAppPublishingCredentialsOutput(ctx *pulumi.Context, args ListWebAppPublishingCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListWebAppPublishingCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppPublishingCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20160801:listWebAppPublishingCredentials", args, ListWebAppPublishingCredentialsResultOutput{}, options).(ListWebAppPublishingCredentialsResultOutput), nil
...
// Username
func (o ListWebAppPublishingCredentialsResultOutput) UserName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ListWebAppPublishingCredentialsResult) *string { return v.UserName }).(pulumi.StringPtrOutput)
}
