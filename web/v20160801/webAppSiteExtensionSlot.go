...
func NewWebAppSiteExtensionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppSiteExtensionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppSiteExtensionSlot"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:web/v20160801:WebAppSiteExtensionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSiteExtensionSlot(ctx *pulumi.Context,
	...
	var resource WebAppSiteExtensionSlot
	err := ctx.ReadResource("azure-native:web/v20160801:WebAppSiteExtensionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Installer command line parameters.
func (o WebAppSiteExtensionSlotOutput) InstallationArgs() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebAppSiteExtensionSlot) pulumi.StringPtrOutput { return v.InstallationArgs }).(pulumi.StringPtrOutput)
}
