...
func ListWebAppBackupConfiguration(ctx *pulumi.Context, args *ListWebAppBackupConfigurationArgs, opts ...pulumi.InvokeOption) (*ListWebAppBackupConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20160801:listWebAppBackupConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func ListWebAppBackupConfigurationOutput(ctx *pulumi.Context, args ListWebAppBackupConfigurationOutputArgs, opts ...pulumi.InvokeOption) ListWebAppBackupConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppBackupConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20160801:listWebAppBackupConfiguration", args, ListWebAppBackupConfigurationResultOutput{}, options).(ListWebAppBackupConfigurationResultOutput), nil
...
// Name of the backup.
func (o ListWebAppBackupConfigurationResultOutput) BackupRequestName() pulumi.StringOutput {
	return o.ApplyT(func(v ListWebAppBackupConfigurationResult) string { return v.BackupRequestName }).(pulumi.StringOutput)
}
