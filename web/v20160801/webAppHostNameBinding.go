...
func NewWebAppHostNameBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20160801:WebAppHostNameBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBinding(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBinding
	err := ctx.ReadResource("azure-native:web/v20160801:WebAppHostNameBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
