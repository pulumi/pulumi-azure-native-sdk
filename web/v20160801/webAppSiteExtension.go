...
func GetWebAppSiteExtension(ctx *pulumi.Context,
	...
	var resource WebAppSiteExtension
	err := ctx.ReadResource("azure-native:web/v20160801:WebAppSiteExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *WebAppSiteExtension) ToOutput(ctx context.Context) pulumix.Output[*WebAppSiteExtension] {
	return pulumix.Output[*WebAppSiteExtension]{
		OutputState: i.ToWebAppSiteExtensionOutputWithContext(ctx).OutputState,
	}
}
...
func (o WebAppSiteExtensionOutput) ToOutput(ctx context.Context) pulumix.Output[*WebAppSiteExtension] {
	return pulumix.Output[*WebAppSiteExtension]{
...
// Installer command line parameters.
func (o WebAppSiteExtensionOutput) InstallationArgs() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebAppSiteExtension) pulumi.StringPtrOutput { return v.InstallationArgs }).(pulumi.StringPtrOutput)
}
