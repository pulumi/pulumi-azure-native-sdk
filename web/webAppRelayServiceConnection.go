...
func NewWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppRelayServiceConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppRelayServiceConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppRelayServiceConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppRelayServiceConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppRelayServiceConnection"),
		},
	})
