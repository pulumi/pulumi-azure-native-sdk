...
//
// Deprecated: azure-native:web/v20210101:WebAppDeploymentSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDeploymentSlot to guarantee forwards compatibility.
func LookupWebAppDeploymentSlot(ctx *pulumi.Context, args *LookupWebAppDeploymentSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppDeploymentSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20210101:getWebAppDeploymentSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
