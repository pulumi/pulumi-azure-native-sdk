...
// App Service plan.
//
// Deprecated: azure-native:web/v20210101:AppServicePlan is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.
...
func NewAppServicePlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210101:AppServicePlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServicePlan(ctx *pulumi.Context,
	...
	var resource AppServicePlan
	err := ctx.ReadResource("azure-native:web/v20210101:AppServicePlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
