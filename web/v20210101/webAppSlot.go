...
func NewWebAppSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210101:WebAppSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSlot(ctx *pulumi.Context,
	...
	var resource WebAppSlot
	err := ctx.ReadResource("azure-native:web/v20210101:WebAppSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
