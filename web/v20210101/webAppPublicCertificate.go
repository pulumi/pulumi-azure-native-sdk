...
//
// Deprecated: azure-native:web/v20210101:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPublicCertificate to guarantee forwards compatibility.
...
func NewWebAppPublicCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220301:WebAppPublicCertificate"),
		},
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppPublicCertificate"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppPublicCertificate
	err := ctx.RegisterResource("azure-native:web/v20210101:WebAppPublicCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPublicCertificate(ctx *pulumi.Context,
	...
	var resource WebAppPublicCertificate
	err := ctx.ReadResource("azure-native:web/v20210101:WebAppPublicCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
