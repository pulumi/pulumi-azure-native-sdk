...
//
// Deprecated: azure-native:web/v20210101:WebAppAzureStorageAccounts is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAzureStorageAccounts to guarantee forwards compatibility.
