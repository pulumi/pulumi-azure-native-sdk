...
func NewWebAppSiteExtensionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210101:WebAppSiteExtensionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSiteExtensionSlot(ctx *pulumi.Context,
	...
	var resource WebAppSiteExtensionSlot
	err := ctx.ReadResource("azure-native:web/v20210101:WebAppSiteExtensionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
