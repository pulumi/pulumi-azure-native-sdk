...
//
// Deprecated: azure-native:web/v20210101:AppServiceEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20210115:AppServiceEnvironment to guarantee forwards compatibility.
func LookupAppServiceEnvironment(ctx *pulumi.Context, args *LookupAppServiceEnvironmentArgs, opts ...pulumi.InvokeOption) (*LookupAppServiceEnvironmentResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20210101:getAppServiceEnvironment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
