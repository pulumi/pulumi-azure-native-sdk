...
//
// Deprecated: azure-native:web/v20210101:WebAppSitePushSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettingsSlot to guarantee forwards compatibility.
...
func NewWebAppSitePushSettingsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210101:WebAppSitePushSettingsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSitePushSettingsSlot(ctx *pulumi.Context,
	...
	var resource WebAppSitePushSettingsSlot
	err := ctx.ReadResource("azure-native:web/v20210101:WebAppSitePushSettingsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
