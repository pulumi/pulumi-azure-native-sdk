...
func NewWebAppAuthSettings(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppAuthSettings"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppAuthSettings"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppAuthSettings"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppAuthSettings"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppAuthSettings"),
		},
	})
...
// The Azure API version of the resource.
func (o WebAppAuthSettingsOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppAuthSettings) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
