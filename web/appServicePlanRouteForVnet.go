...
func NewAppServicePlanRouteForVnet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20231201:AppServicePlanRouteForVnet"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:AppServicePlanRouteForVnet"),
		},
		{
			Type: pulumi.String("azure-native:web/v20241101:AppServicePlanRouteForVnet"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:AppServicePlanRouteForVnet"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:AppServicePlanRouteForVnet"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:AppServicePlanRouteForVnet"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:AppServicePlanRouteForVnet"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AppServicePlanRouteForVnet
	err := ctx.RegisterResource("azure-native:web:AppServicePlanRouteForVnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServicePlanRouteForVnet(ctx *pulumi.Context,
	...
	var resource AppServicePlanRouteForVnet
	err := ctx.ReadResource("azure-native:web:AppServicePlanRouteForVnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o AppServicePlanRouteForVnetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AppServicePlanRouteForVnet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AppServicePlanRouteForVnetOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *AppServicePlanRouteForVnet) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
