...
//
// Deprecated: azure-native:web/v20200901:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSiteExtensionSlot to guarantee forwards compatibility.
...
func NewWebAppSiteExtensionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppSiteExtensionSlot"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppSiteExtensionSlot
	err := ctx.RegisterResource("azure-native:web/v20200901:WebAppSiteExtensionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSiteExtensionSlot(ctx *pulumi.Context,
	...
	var resource WebAppSiteExtensionSlot
	err := ctx.ReadResource("azure-native:web/v20200901:WebAppSiteExtensionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
