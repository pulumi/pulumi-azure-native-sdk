...
//
// Deprecated: azure-native:web/v20200901:WebAppSourceControlSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSourceControlSlot to guarantee forwards compatibility.
func LookupWebAppSourceControlSlot(ctx *pulumi.Context, args *LookupWebAppSourceControlSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSourceControlSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200901:getWebAppSourceControlSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
