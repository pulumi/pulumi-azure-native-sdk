...
// Deprecated: azure-native:web/v20200901:WebAppAuthSettingsV2Slot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAuthSettingsV2Slot to guarantee forwards compatibility.
...
func NewWebAppAuthSettingsV2Slot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20200901:WebAppAuthSettingsV2Slot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAuthSettingsV2Slot(ctx *pulumi.Context,
	...
	var resource WebAppAuthSettingsV2Slot
	err := ctx.ReadResource("azure-native:web/v20200901:WebAppAuthSettingsV2Slot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
