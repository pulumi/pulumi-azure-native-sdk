...
//
// Deprecated: azure-native:web/v20200901:WebAppPremierAddOn is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility.
func LookupWebAppPremierAddOn(ctx *pulumi.Context, args *LookupWebAppPremierAddOnArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPremierAddOnResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200901:getWebAppPremierAddOn", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
