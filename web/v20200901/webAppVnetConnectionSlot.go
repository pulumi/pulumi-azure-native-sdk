...
//
// Deprecated: azure-native:web/v20200901:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppVnetConnectionSlot to guarantee forwards compatibility.
...
func NewWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20200901:WebAppVnetConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppVnetConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20200901:WebAppVnetConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
