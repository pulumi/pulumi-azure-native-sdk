...
func ListStaticSiteSecrets(ctx *pulumi.Context, args *ListStaticSiteSecretsArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200901:listStaticSiteSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The system metadata relating to this resource.
func (o ListStaticSiteSecretsResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v ListStaticSiteSecretsResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
