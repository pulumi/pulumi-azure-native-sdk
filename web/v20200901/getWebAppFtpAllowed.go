...
func LookupWebAppFtpAllowed(ctx *pulumi.Context, args *LookupWebAppFtpAllowedArgs, opts ...pulumi.InvokeOption) (*LookupWebAppFtpAllowedResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20200901:getWebAppFtpAllowed", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppFtpAllowedOutput(ctx *pulumi.Context, args LookupWebAppFtpAllowedOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppFtpAllowedResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppFtpAllowedResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20200901:getWebAppFtpAllowed", args, LookupWebAppFtpAllowedResultOutput{}, options).(LookupWebAppFtpAllowedResultOutput), nil
