...
//
// Deprecated: azure-native:web/v20200901:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppConnectionStrings to guarantee forwards compatibility.
...
func NewWebAppConnectionStrings(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppConnectionStrings"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppConnectionStrings
	err := ctx.RegisterResource("azure-native:web/v20200901:WebAppConnectionStrings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConnectionStrings(ctx *pulumi.Context,
	...
	var resource WebAppConnectionStrings
	err := ctx.ReadResource("azure-native:web/v20200901:WebAppConnectionStrings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The system metadata relating to this resource.
func (o WebAppConnectionStringsOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppConnectionStrings) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
