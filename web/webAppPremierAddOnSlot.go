...
func NewWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppPremierAddOnSlot"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppPremierAddOnSlot
	err := ctx.RegisterResource("azure-native:web:WebAppPremierAddOnSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	var resource WebAppPremierAddOnSlot
	err := ctx.ReadResource("azure-native:web:WebAppPremierAddOnSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppPremierAddOnSlotOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppPremierAddOnSlot) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
