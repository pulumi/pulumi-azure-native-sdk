...
func NewWebAppSiteExtension(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppSiteExtension"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppSiteExtension"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppSiteExtension"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppSiteExtension"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppSiteExtension"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppSiteExtension
	err := ctx.RegisterResource("azure-native:web:WebAppSiteExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSiteExtension(ctx *pulumi.Context,
	...
	var resource WebAppSiteExtension
	err := ctx.ReadResource("azure-native:web:WebAppSiteExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppSiteExtensionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppSiteExtension) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
