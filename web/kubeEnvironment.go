...
//
// Other available API versions: 2021-01-01, 2021-01-15, 2021-02-01, 2021-03-01, 2022-03-01, 2022-09-01, 2023-01-01, 2023-12-01, 2024-04-01, 2025-03-01, 2025-05-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native web [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
...
func NewKubeEnvironment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:KubeEnvironment"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:KubeEnvironment"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:KubeEnvironment"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:KubeEnvironment"),
		},
	})
...
// The Azure API version of the resource.
func (o KubeEnvironmentOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *KubeEnvironment) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
