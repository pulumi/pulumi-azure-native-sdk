...
func NewWebAppFtpAllowedSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppFtpAllowedSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppFtpAllowedSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppFtpAllowedSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppFtpAllowedSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppFtpAllowedSlot"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppFtpAllowedSlot
	err := ctx.RegisterResource("azure-native:web:WebAppFtpAllowedSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppFtpAllowedSlot(ctx *pulumi.Context,
	...
	var resource WebAppFtpAllowedSlot
	err := ctx.ReadResource("azure-native:web:WebAppFtpAllowedSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppFtpAllowedSlotOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppFtpAllowedSlot) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebAppFtpAllowedSlotOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppFtpAllowedSlot) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
