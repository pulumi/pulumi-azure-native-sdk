...
func NewStaticSiteLinkedBackend(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20250301:StaticSiteLinkedBackend"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:StaticSiteLinkedBackend"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:StaticSiteLinkedBackend"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:StaticSiteLinkedBackend"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o StaticSiteLinkedBackendOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *StaticSiteLinkedBackend) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
