...
func NewWebAppSwiftVirtualNetworkConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
	})
