...
//
// Other available API versions: 2018-02-01, 2018-11-01, 2019-08-01, 2020-06-01, 2020-09-01, 2020-10-01, 2021-01-15, 2021-02-01, 2021-03-01, 2022-03-01, 2022-09-01, 2023-01-01, 2023-12-01, 2024-04-01, 2025-03-01, 2025-05-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native web [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
...
func NewWebAppSwiftVirtualNetworkConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppSwiftVirtualNetworkConnectionSlot"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppSwiftVirtualNetworkConnectionSlot
	err := ctx.RegisterResource("azure-native:web:WebAppSwiftVirtualNetworkConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSwiftVirtualNetworkConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppSwiftVirtualNetworkConnectionSlot
	err := ctx.ReadResource("azure-native:web:WebAppSwiftVirtualNetworkConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
