...
func NewWebApp(ctx *pulumi.Context,
	...
	var resource WebApp
	err := ctx.RegisterResource("azure-native:web/v20180201:WebApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApp(ctx *pulumi.Context,
	...
	var resource WebApp
	err := ctx.ReadResource("azure-native:web/v20180201:WebApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GeoDistributions for this site
func (o WebAppOutput) GeoDistributions() GeoDistributionResponseArrayOutput {
	return o.ApplyT(func(v *WebApp) GeoDistributionResponseArrayOutput { return v.GeoDistributions }).(GeoDistributionResponseArrayOutput)
}
