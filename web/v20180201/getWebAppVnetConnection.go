...
//
// Deprecated: azure-native:web/v20180201:WebAppVnetConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppVnetConnection to guarantee forwards compatibility.
func LookupWebAppVnetConnection(ctx *pulumi.Context, args *LookupWebAppVnetConnectionArgs, opts ...pulumi.InvokeOption) (*LookupWebAppVnetConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20180201:getWebAppVnetConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
