...
//
// Deprecated: azure-native:web/v20180201:WebAppBackupConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppBackupConfiguration to guarantee forwards compatibility.
...
func NewWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20180201:WebAppBackupConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppBackupConfiguration
	err := ctx.ReadResource("azure-native:web/v20180201:WebAppBackupConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
