...
//
// Deprecated: azure-native:web/v20180201:WebAppFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppFunction to guarantee forwards compatibility.
func LookupWebAppFunction(ctx *pulumi.Context, args *LookupWebAppFunctionArgs, opts ...pulumi.InvokeOption) (*LookupWebAppFunctionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20180201:getWebAppFunction", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
