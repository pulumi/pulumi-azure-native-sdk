...
func NewWebAppSlotConfigurationNames(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20180201:WebAppSlotConfigurationNames", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSlotConfigurationNames(ctx *pulumi.Context,
	...
	var resource WebAppSlotConfigurationNames
	err := ctx.ReadResource("azure-native:web/v20180201:WebAppSlotConfigurationNames", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
