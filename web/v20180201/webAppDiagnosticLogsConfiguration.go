...
//
// Deprecated: azure-native:web/v20180201:WebAppDiagnosticLogsConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppDiagnosticLogsConfiguration to guarantee forwards compatibility.
...
func NewWebAppDiagnosticLogsConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20180201:WebAppDiagnosticLogsConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDiagnosticLogsConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppDiagnosticLogsConfiguration
	err := ctx.ReadResource("azure-native:web/v20180201:WebAppDiagnosticLogsConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
