...
func NewWebAppMetadata(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20180201:WebAppMetadata", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppMetadata(ctx *pulumi.Context,
	...
	var resource WebAppMetadata
	err := ctx.ReadResource("azure-native:web/v20180201:WebAppMetadata", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
