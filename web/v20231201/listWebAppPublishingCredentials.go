...
func ListWebAppPublishingCredentials(ctx *pulumi.Context, args *ListWebAppPublishingCredentialsArgs, opts ...pulumi.InvokeOption) (*ListWebAppPublishingCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listWebAppPublishingCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppPublishingCredentialsOutput(ctx *pulumi.Context, args ListWebAppPublishingCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListWebAppPublishingCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppPublishingCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listWebAppPublishingCredentials", args, ListWebAppPublishingCredentialsResultOutput{}, options).(ListWebAppPublishingCredentialsResultOutput), nil
