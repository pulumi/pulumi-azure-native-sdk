...
func LookupWebAppSiteExtensionSlot(ctx *pulumi.Context, args *LookupWebAppSiteExtensionSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSiteExtensionSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:getWebAppSiteExtensionSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppSiteExtensionSlotOutput(ctx *pulumi.Context, args LookupWebAppSiteExtensionSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppSiteExtensionSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppSiteExtensionSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:getWebAppSiteExtensionSlot", args, LookupWebAppSiteExtensionSlotResultOutput{}, options).(LookupWebAppSiteExtensionSlotResultOutput), nil
