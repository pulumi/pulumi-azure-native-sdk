...
func NewWebAppFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:WebAppFunction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppFunction(ctx *pulumi.Context,
	...
	var resource WebAppFunction
	err := ctx.ReadResource("azure-native:web/v20231201:WebAppFunction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
