...
func ListAppServicePlanHybridConnectionKeys(ctx *pulumi.Context, args *ListAppServicePlanHybridConnectionKeysArgs, opts ...pulumi.InvokeOption) (*ListAppServicePlanHybridConnectionKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listAppServicePlanHybridConnectionKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAppServicePlanHybridConnectionKeysOutput(ctx *pulumi.Context, args ListAppServicePlanHybridConnectionKeysOutputArgs, opts ...pulumi.InvokeOption) ListAppServicePlanHybridConnectionKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAppServicePlanHybridConnectionKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listAppServicePlanHybridConnectionKeys", args, ListAppServicePlanHybridConnectionKeysResultOutput{}, options).(ListAppServicePlanHybridConnectionKeysResultOutput), nil
