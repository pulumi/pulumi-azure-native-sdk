...
func NewWebAppSourceControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:WebAppSourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSourceControl(ctx *pulumi.Context,
	...
	var resource WebAppSourceControl
	err := ctx.ReadResource("azure-native:web/v20231201:WebAppSourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
