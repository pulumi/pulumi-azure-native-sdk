...
func NewWebAppSitePushSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:WebAppSitePushSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSitePushSettings(ctx *pulumi.Context,
	...
	var resource WebAppSitePushSettings
	err := ctx.ReadResource("azure-native:web/v20231201:WebAppSitePushSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
