...
func LookupWebAppVnetConnectionSlot(ctx *pulumi.Context, args *LookupWebAppVnetConnectionSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppVnetConnectionSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:getWebAppVnetConnectionSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppVnetConnectionSlotOutput(ctx *pulumi.Context, args LookupWebAppVnetConnectionSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppVnetConnectionSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppVnetConnectionSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:getWebAppVnetConnectionSlot", args, LookupWebAppVnetConnectionSlotResultOutput{}, options).(LookupWebAppVnetConnectionSlotResultOutput), nil
