...
func LookupWebAppHybridConnectionSlot(ctx *pulumi.Context, args *LookupWebAppHybridConnectionSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppHybridConnectionSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:getWebAppHybridConnectionSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppHybridConnectionSlotOutput(ctx *pulumi.Context, args LookupWebAppHybridConnectionSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppHybridConnectionSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppHybridConnectionSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:getWebAppHybridConnectionSlot", args, LookupWebAppHybridConnectionSlotResultOutput{}, options).(LookupWebAppHybridConnectionSlotResultOutput), nil
