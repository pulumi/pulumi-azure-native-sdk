...
func LookupWebAppSlotConfigurationNames(ctx *pulumi.Context, args *LookupWebAppSlotConfigurationNamesArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSlotConfigurationNamesResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:getWebAppSlotConfigurationNames", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppSlotConfigurationNamesOutput(ctx *pulumi.Context, args LookupWebAppSlotConfigurationNamesOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppSlotConfigurationNamesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppSlotConfigurationNamesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:getWebAppSlotConfigurationNames", args, LookupWebAppSlotConfigurationNamesResultOutput{}, options).(LookupWebAppSlotConfigurationNamesResultOutput), nil
