...
func NewWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppPremierAddOnSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppPremierAddOnSlot"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:WebAppPremierAddOnSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	var resource WebAppPremierAddOnSlot
	err := ctx.ReadResource("azure-native:web/v20231201:WebAppPremierAddOnSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
