...
func LookupStaticSiteLinkedBackendForBuild(ctx *pulumi.Context, args *LookupStaticSiteLinkedBackendForBuildArgs, opts ...pulumi.InvokeOption) (*LookupStaticSiteLinkedBackendForBuildResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:getStaticSiteLinkedBackendForBuild", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStaticSiteLinkedBackendForBuildOutput(ctx *pulumi.Context, args LookupStaticSiteLinkedBackendForBuildOutputArgs, opts ...pulumi.InvokeOption) LookupStaticSiteLinkedBackendForBuildResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStaticSiteLinkedBackendForBuildResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:getStaticSiteLinkedBackendForBuild", args, LookupStaticSiteLinkedBackendForBuildResultOutput{}, options).(LookupStaticSiteLinkedBackendForBuildResultOutput), nil
