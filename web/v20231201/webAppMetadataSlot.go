...
func NewWebAppMetadataSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:WebAppMetadataSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppMetadataSlot(ctx *pulumi.Context,
	...
	var resource WebAppMetadataSlot
	err := ctx.ReadResource("azure-native:web/v20231201:WebAppMetadataSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
