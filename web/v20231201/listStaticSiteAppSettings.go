...
func ListStaticSiteAppSettings(ctx *pulumi.Context, args *ListStaticSiteAppSettingsArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteAppSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listStaticSiteAppSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListStaticSiteAppSettingsOutput(ctx *pulumi.Context, args ListStaticSiteAppSettingsOutputArgs, opts ...pulumi.InvokeOption) ListStaticSiteAppSettingsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListStaticSiteAppSettingsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listStaticSiteAppSettings", args, ListStaticSiteAppSettingsResultOutput{}, options).(ListStaticSiteAppSettingsResultOutput), nil
