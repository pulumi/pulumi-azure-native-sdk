...
func ListWorkflowTriggerCallbackUrl(ctx *pulumi.Context, args *ListWorkflowTriggerCallbackUrlArgs, opts ...pulumi.InvokeOption) (*ListWorkflowTriggerCallbackUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listWorkflowTriggerCallbackUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWorkflowTriggerCallbackUrlOutput(ctx *pulumi.Context, args ListWorkflowTriggerCallbackUrlOutputArgs, opts ...pulumi.InvokeOption) ListWorkflowTriggerCallbackUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkflowTriggerCallbackUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listWorkflowTriggerCallbackUrl", args, ListWorkflowTriggerCallbackUrlResultOutput{}, options).(ListWorkflowTriggerCallbackUrlResultOutput), nil
