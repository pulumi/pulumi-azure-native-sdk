...
func ListStaticSiteSecrets(ctx *pulumi.Context, args *ListStaticSiteSecretsArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listStaticSiteSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListStaticSiteSecretsOutput(ctx *pulumi.Context, args ListStaticSiteSecretsOutputArgs, opts ...pulumi.InvokeOption) ListStaticSiteSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListStaticSiteSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listStaticSiteSecrets", args, ListStaticSiteSecretsResultOutput{}, options).(ListStaticSiteSecretsResultOutput), nil
