...
func NewWebAppSiteContainerSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:WebAppSiteContainerSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSiteContainerSlot(ctx *pulumi.Context,
	...
	var resource WebAppSiteContainerSlot
	err := ctx.ReadResource("azure-native:web/v20231201:WebAppSiteContainerSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
