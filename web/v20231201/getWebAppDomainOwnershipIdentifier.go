...
func LookupWebAppDomainOwnershipIdentifier(ctx *pulumi.Context, args *LookupWebAppDomainOwnershipIdentifierArgs, opts ...pulumi.InvokeOption) (*LookupWebAppDomainOwnershipIdentifierResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:getWebAppDomainOwnershipIdentifier", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppDomainOwnershipIdentifierOutput(ctx *pulumi.Context, args LookupWebAppDomainOwnershipIdentifierOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppDomainOwnershipIdentifierResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppDomainOwnershipIdentifierResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:getWebAppDomainOwnershipIdentifier", args, LookupWebAppDomainOwnershipIdentifierResultOutput{}, options).(LookupWebAppDomainOwnershipIdentifierResultOutput), nil
