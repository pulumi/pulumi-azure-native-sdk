...
func ListWebAppPublishingCredentialsSlot(ctx *pulumi.Context, args *ListWebAppPublishingCredentialsSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppPublishingCredentialsSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listWebAppPublishingCredentialsSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppPublishingCredentialsSlotOutput(ctx *pulumi.Context, args ListWebAppPublishingCredentialsSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppPublishingCredentialsSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppPublishingCredentialsSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listWebAppPublishingCredentialsSlot", args, ListWebAppPublishingCredentialsSlotResultOutput{}, options).(ListWebAppPublishingCredentialsSlotResultOutput), nil
