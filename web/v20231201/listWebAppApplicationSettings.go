...
func ListWebAppApplicationSettings(ctx *pulumi.Context, args *ListWebAppApplicationSettingsArgs, opts ...pulumi.InvokeOption) (*ListWebAppApplicationSettingsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listWebAppApplicationSettings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppApplicationSettingsOutput(ctx *pulumi.Context, args ListWebAppApplicationSettingsOutputArgs, opts ...pulumi.InvokeOption) ListWebAppApplicationSettingsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppApplicationSettingsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listWebAppApplicationSettings", args, ListWebAppApplicationSettingsResultOutput{}, options).(ListWebAppApplicationSettingsResultOutput), nil
