...
func LookupWebAppDeploymentSlot(ctx *pulumi.Context, args *LookupWebAppDeploymentSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppDeploymentSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:getWebAppDeploymentSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppDeploymentSlotOutput(ctx *pulumi.Context, args LookupWebAppDeploymentSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppDeploymentSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppDeploymentSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:getWebAppDeploymentSlot", args, LookupWebAppDeploymentSlotResultOutput{}, options).(LookupWebAppDeploymentSlotResultOutput), nil
