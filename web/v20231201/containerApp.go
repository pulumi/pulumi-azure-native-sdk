...
func NewContainerApp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:ContainerApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerApp(ctx *pulumi.Context,
	...
	var resource ContainerApp
	err := ctx.ReadResource("azure-native:web/v20231201:ContainerApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
