...
func NewWebAppPrivateEndpointConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:WebAppPrivateEndpointConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPrivateEndpointConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppPrivateEndpointConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20231201:WebAppPrivateEndpointConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
