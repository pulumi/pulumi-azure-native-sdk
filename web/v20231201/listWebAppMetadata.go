...
func ListWebAppMetadata(ctx *pulumi.Context, args *ListWebAppMetadataArgs, opts ...pulumi.InvokeOption) (*ListWebAppMetadataResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listWebAppMetadata", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppMetadataOutput(ctx *pulumi.Context, args ListWebAppMetadataOutputArgs, opts ...pulumi.InvokeOption) ListWebAppMetadataResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppMetadataResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listWebAppMetadata", args, ListWebAppMetadataResultOutput{}, options).(ListWebAppMetadataResultOutput), nil
