...
func ListWebAppFunctionSecretsSlot(ctx *pulumi.Context, args *ListWebAppFunctionSecretsSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppFunctionSecretsSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listWebAppFunctionSecretsSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppFunctionSecretsSlotOutput(ctx *pulumi.Context, args ListWebAppFunctionSecretsSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppFunctionSecretsSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppFunctionSecretsSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listWebAppFunctionSecretsSlot", args, ListWebAppFunctionSecretsSlotResultOutput{}, options).(ListWebAppFunctionSecretsSlotResultOutput), nil
