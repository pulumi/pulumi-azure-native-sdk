...
func NewWebAppScmAllowed(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:WebAppScmAllowed", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppScmAllowed(ctx *pulumi.Context,
	...
	var resource WebAppScmAllowed
	err := ctx.ReadResource("azure-native:web/v20231201:WebAppScmAllowed", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
