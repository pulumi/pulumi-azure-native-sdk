...
func NewAppServiceEnvironmentAseCustomDnsSuffixConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:AppServiceEnvironmentAseCustomDnsSuffixConfiguration"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:web/v20231201:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceEnvironmentAseCustomDnsSuffixConfiguration(ctx *pulumi.Context,
	...
	var resource AppServiceEnvironmentAseCustomDnsSuffixConfiguration
	err := ctx.ReadResource("azure-native:web/v20231201:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
