...
func ListWebAppSiteBackups(ctx *pulumi.Context, args *ListWebAppSiteBackupsArgs, opts ...pulumi.InvokeOption) (*ListWebAppSiteBackupsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20231201:listWebAppSiteBackups", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppSiteBackupsOutput(ctx *pulumi.Context, args ListWebAppSiteBackupsOutputArgs, opts ...pulumi.InvokeOption) ListWebAppSiteBackupsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppSiteBackupsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20231201:listWebAppSiteBackups", args, ListWebAppSiteBackupsResultOutput{}, options).(ListWebAppSiteBackupsResultOutput), nil
