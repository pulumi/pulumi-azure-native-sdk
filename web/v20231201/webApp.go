...
func NewWebApp(ctx *pulumi.Context,
	...
	var resource WebApp
	err := ctx.RegisterResource("azure-native:web/v20231201:WebApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApp(ctx *pulumi.Context,
	...
	var resource WebApp
	err := ctx.ReadResource("azure-native:web/v20231201:WebApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
