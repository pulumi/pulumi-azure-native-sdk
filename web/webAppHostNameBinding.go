...
func NewWebAppHostNameBinding(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppHostNameBinding"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppHostNameBinding"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppHostNameBinding"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppHostNameBinding"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppHostNameBinding"),
		},
	})
