...
//
// Deprecated: azure-native:web/v20201201:WebAppPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPrivateEndpointConnection to guarantee forwards compatibility.
...
func NewWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20201201:WebAppPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource WebAppPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:web/v20201201:WebAppPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
