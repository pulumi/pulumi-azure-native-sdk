...
func NewWebAppInstanceFunctionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20201201:WebAppInstanceFunctionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppInstanceFunctionSlot(ctx *pulumi.Context,
	...
	var resource WebAppInstanceFunctionSlot
	err := ctx.ReadResource("azure-native:web/v20201201:WebAppInstanceFunctionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
