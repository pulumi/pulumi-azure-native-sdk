...
func NewWebAppAuthSettingsV2Slot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20201201:WebAppAuthSettingsV2Slot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAuthSettingsV2Slot(ctx *pulumi.Context,
	...
	var resource WebAppAuthSettingsV2Slot
	err := ctx.ReadResource("azure-native:web/v20201201:WebAppAuthSettingsV2Slot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
