...
func NewWebAppMetadata(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppMetadata"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppMetadata"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppMetadata"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppMetadata"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppMetadata"),
		},
	})
