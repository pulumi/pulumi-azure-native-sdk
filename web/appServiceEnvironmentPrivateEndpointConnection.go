...
func NewAppServiceEnvironmentPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:AppServiceEnvironmentPrivateEndpointConnection"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:AppServiceEnvironmentPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:AppServiceEnvironmentPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:AppServiceEnvironmentPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:AppServiceEnvironmentPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:AppServiceEnvironmentPrivateEndpointConnection"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AppServiceEnvironmentPrivateEndpointConnectionOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *AppServiceEnvironmentPrivateEndpointConnection) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
