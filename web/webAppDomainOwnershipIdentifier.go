...
func NewWebAppDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppDomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppDomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppDomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppDomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppDomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppDomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppDomainOwnershipIdentifier"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppDomainOwnershipIdentifier"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppDomainOwnershipIdentifier
	err := ctx.RegisterResource("azure-native:web:WebAppDomainOwnershipIdentifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	var resource WebAppDomainOwnershipIdentifier
	err := ctx.ReadResource("azure-native:web:WebAppDomainOwnershipIdentifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppDomainOwnershipIdentifierOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppDomainOwnershipIdentifier) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebAppDomainOwnershipIdentifierOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppDomainOwnershipIdentifier) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
...
// String representation of the identity.
func (o WebAppDomainOwnershipIdentifierOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebAppDomainOwnershipIdentifier) pulumi.StringPtrOutput { return v.Value }).(pulumi.StringPtrOutput)
}
