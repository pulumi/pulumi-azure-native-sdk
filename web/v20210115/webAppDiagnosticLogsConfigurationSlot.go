...
func NewWebAppDiagnosticLogsConfigurationSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210115:WebAppDiagnosticLogsConfigurationSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDiagnosticLogsConfigurationSlot(ctx *pulumi.Context,
	...
	var resource WebAppDiagnosticLogsConfigurationSlot
	err := ctx.ReadResource("azure-native:web/v20210115:WebAppDiagnosticLogsConfigurationSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
