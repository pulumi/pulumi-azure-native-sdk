...
//
// Deprecated: azure-native:web/v20210115:WebAppVnetConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppVnetConnection to guarantee forwards compatibility.
...
func NewWebAppVnetConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210115:WebAppVnetConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppVnetConnection(ctx *pulumi.Context,
	...
	var resource WebAppVnetConnection
	err := ctx.ReadResource("azure-native:web/v20210115:WebAppVnetConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
