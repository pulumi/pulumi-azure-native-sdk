...
func NewWebAppSourceControlSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210115:WebAppSourceControlSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSourceControlSlot(ctx *pulumi.Context,
	...
	var resource WebAppSourceControlSlot
	err := ctx.ReadResource("azure-native:web/v20210115:WebAppSourceControlSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
