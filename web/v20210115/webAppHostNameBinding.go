...
//
// Deprecated: azure-native:web/v20210115:WebAppHostNameBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHostNameBinding to guarantee forwards compatibility.
...
func NewWebAppHostNameBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210115:WebAppHostNameBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBinding(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBinding
	err := ctx.ReadResource("azure-native:web/v20210115:WebAppHostNameBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
