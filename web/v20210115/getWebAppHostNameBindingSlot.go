...
//
// Deprecated: azure-native:web/v20210115:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHostNameBindingSlot to guarantee forwards compatibility.
func LookupWebAppHostNameBindingSlot(ctx *pulumi.Context, args *LookupWebAppHostNameBindingSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppHostNameBindingSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20210115:getWebAppHostNameBindingSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
