...
//
// Deprecated: azure-native:web/v20210115:WebAppSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSlot to guarantee forwards compatibility.
...
func NewWebAppSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210115:WebAppSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSlot(ctx *pulumi.Context,
	...
	var resource WebAppSlot
	err := ctx.ReadResource("azure-native:web/v20210115:WebAppSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
