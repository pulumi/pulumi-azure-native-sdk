...
//
// Deprecated: azure-native:web/v20210115:AppServicePlanRouteForVnet is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServicePlanRouteForVnet to guarantee forwards compatibility.
...
func NewAppServicePlanRouteForVnet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210115:AppServicePlanRouteForVnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServicePlanRouteForVnet(ctx *pulumi.Context,
	...
	var resource AppServicePlanRouteForVnet
	err := ctx.ReadResource("azure-native:web/v20210115:AppServicePlanRouteForVnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
