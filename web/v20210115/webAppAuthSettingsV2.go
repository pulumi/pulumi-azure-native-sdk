...
//
// Deprecated: azure-native:web/v20210115:WebAppAuthSettingsV2 is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20210201:WebAppAuthSettingsV2 to guarantee forwards compatibility.
...
func NewWebAppAuthSettingsV2(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210115:WebAppAuthSettingsV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAuthSettingsV2(ctx *pulumi.Context,
	...
	var resource WebAppAuthSettingsV2
	err := ctx.ReadResource("azure-native:web/v20210115:WebAppAuthSettingsV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
