...
//
// Deprecated: azure-native:web/v20210115:StaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20210201:StaticSite to guarantee forwards compatibility.
...
func NewStaticSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210115:StaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSite
	err := ctx.ReadResource("azure-native:web/v20210115:StaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
