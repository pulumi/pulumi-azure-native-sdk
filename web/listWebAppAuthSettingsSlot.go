...
func (o ListWebAppAuthSettingsSlotResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListWebAppAuthSettingsSlotResult] {
	return pulumix.Output[ListWebAppAuthSettingsSlotResult]{
