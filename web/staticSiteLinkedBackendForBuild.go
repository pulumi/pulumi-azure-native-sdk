...
func NewStaticSiteLinkedBackendForBuild(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:StaticSiteLinkedBackendForBuild"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:StaticSiteLinkedBackendForBuild"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:StaticSiteLinkedBackendForBuild"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:StaticSiteLinkedBackendForBuild"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:StaticSiteLinkedBackendForBuild"),
		},
	})
...
// The Azure API version of the resource.
func (o StaticSiteLinkedBackendForBuildOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *StaticSiteLinkedBackendForBuild) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o StaticSiteLinkedBackendForBuildOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *StaticSiteLinkedBackendForBuild) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
