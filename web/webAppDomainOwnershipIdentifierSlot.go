...
func NewWebAppDomainOwnershipIdentifierSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppDomainOwnershipIdentifierSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppDomainOwnershipIdentifierSlot"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppDomainOwnershipIdentifierSlot
	err := ctx.RegisterResource("azure-native:web:WebAppDomainOwnershipIdentifierSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDomainOwnershipIdentifierSlot(ctx *pulumi.Context,
	...
	var resource WebAppDomainOwnershipIdentifierSlot
	err := ctx.ReadResource("azure-native:web:WebAppDomainOwnershipIdentifierSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppDomainOwnershipIdentifierSlotOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppDomainOwnershipIdentifierSlot) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebAppDomainOwnershipIdentifierSlotOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppDomainOwnershipIdentifierSlot) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
