...
func NewSiteAuthSettings(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:SiteAuthSettings"),
		},
	})
...
// GetSiteAuthSettings gets an existing SiteAuthSettings resource's state with the given name, ID, and optional
...
// Input properties used for looking up and filtering SiteAuthSettings resources.
