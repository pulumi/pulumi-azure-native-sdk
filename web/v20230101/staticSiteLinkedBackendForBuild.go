...
func NewStaticSiteLinkedBackendForBuild(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:StaticSiteLinkedBackendForBuild", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteLinkedBackendForBuild(ctx *pulumi.Context,
	...
	var resource StaticSiteLinkedBackendForBuild
	err := ctx.ReadResource("azure-native:web/v20230101:StaticSiteLinkedBackendForBuild", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *StaticSiteLinkedBackendForBuild) ToOutput(ctx context.Context) pulumix.Output[*StaticSiteLinkedBackendForBuild] {
	return pulumix.Output[*StaticSiteLinkedBackendForBuild]{
		OutputState: i.ToStaticSiteLinkedBackendForBuildOutputWithContext(ctx).OutputState,
	}
}
...
func (o StaticSiteLinkedBackendForBuildOutput) ToOutput(ctx context.Context) pulumix.Output[*StaticSiteLinkedBackendForBuild] {
	return pulumix.Output[*StaticSiteLinkedBackendForBuild]{
