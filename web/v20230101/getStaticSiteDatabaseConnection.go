...
func LookupStaticSiteDatabaseConnection(ctx *pulumi.Context, args *LookupStaticSiteDatabaseConnectionArgs, opts ...pulumi.InvokeOption) (*LookupStaticSiteDatabaseConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getStaticSiteDatabaseConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStaticSiteDatabaseConnectionOutput(ctx *pulumi.Context, args LookupStaticSiteDatabaseConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupStaticSiteDatabaseConnectionResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupStaticSiteDatabaseConnectionResult, error) {
			args := v.(LookupStaticSiteDatabaseConnectionArgs)
			r, err := LookupStaticSiteDatabaseConnection(ctx, &args, opts...)
			var s LookupStaticSiteDatabaseConnectionResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o LookupStaticSiteDatabaseConnectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupStaticSiteDatabaseConnectionResult] {
	return pulumix.Output[LookupStaticSiteDatabaseConnectionResult]{
