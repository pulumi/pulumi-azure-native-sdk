...
func LookupKubeEnvironment(ctx *pulumi.Context, args *LookupKubeEnvironmentArgs, opts ...pulumi.InvokeOption) (*LookupKubeEnvironmentResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getKubeEnvironment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupKubeEnvironmentOutput(ctx *pulumi.Context, args LookupKubeEnvironmentOutputArgs, opts ...pulumi.InvokeOption) LookupKubeEnvironmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupKubeEnvironmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:getKubeEnvironment", args, LookupKubeEnvironmentResultOutput{}, options).(LookupKubeEnvironmentResultOutput), nil
