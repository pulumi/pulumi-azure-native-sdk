...
func NewWebAppSourceControlSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppSourceControlSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSourceControlSlot(ctx *pulumi.Context,
	...
	var resource WebAppSourceControlSlot
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppSourceControlSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *WebAppSourceControlSlot) ToOutput(ctx context.Context) pulumix.Output[*WebAppSourceControlSlot] {
	return pulumix.Output[*WebAppSourceControlSlot]{
		OutputState: i.ToWebAppSourceControlSlotOutputWithContext(ctx).OutputState,
	}
}
...
func (o WebAppSourceControlSlotOutput) ToOutput(ctx context.Context) pulumix.Output[*WebAppSourceControlSlot] {
	return pulumix.Output[*WebAppSourceControlSlot]{
