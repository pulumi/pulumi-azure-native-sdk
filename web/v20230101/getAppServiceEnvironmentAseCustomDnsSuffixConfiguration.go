...
func LookupAppServiceEnvironmentAseCustomDnsSuffixConfiguration(ctx *pulumi.Context, args *LookupAppServiceEnvironmentAseCustomDnsSuffixConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupAppServiceEnvironmentAseCustomDnsSuffixConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getAppServiceEnvironmentAseCustomDnsSuffixConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAppServiceEnvironmentAseCustomDnsSuffixConfigurationOutput(ctx *pulumi.Context, args LookupAppServiceEnvironmentAseCustomDnsSuffixConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupAppServiceEnvironmentAseCustomDnsSuffixConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAppServiceEnvironmentAseCustomDnsSuffixConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:getAppServiceEnvironmentAseCustomDnsSuffixConfiguration", args, LookupAppServiceEnvironmentAseCustomDnsSuffixConfigurationResultOutput{}, options).(LookupAppServiceEnvironmentAseCustomDnsSuffixConfigurationResultOutput), nil
