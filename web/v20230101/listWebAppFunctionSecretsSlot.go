...
func ListWebAppFunctionSecretsSlot(ctx *pulumi.Context, args *ListWebAppFunctionSecretsSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppFunctionSecretsSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:listWebAppFunctionSecretsSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ListWebAppFunctionSecretsSlotResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListWebAppFunctionSecretsSlotResult] {
	return pulumix.Output[ListWebAppFunctionSecretsSlotResult]{
