...
func NewWebAppVnetConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppVnetConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppVnetConnection
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppVnetConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppVnetConnection(ctx *pulumi.Context,
	...
	var resource WebAppVnetConnection
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppVnetConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *WebAppVnetConnection) ToOutput(ctx context.Context) pulumix.Output[*WebAppVnetConnection] {
	return pulumix.Output[*WebAppVnetConnection]{
		OutputState: i.ToWebAppVnetConnectionOutputWithContext(ctx).OutputState,
	}
}
...
func (o WebAppVnetConnectionOutput) ToOutput(ctx context.Context) pulumix.Output[*WebAppVnetConnection] {
	return pulumix.Output[*WebAppVnetConnection]{
