...
func LookupWebAppVnetConnection(ctx *pulumi.Context, args *LookupWebAppVnetConnectionArgs, opts ...pulumi.InvokeOption) (*LookupWebAppVnetConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getWebAppVnetConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupWebAppVnetConnectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWebAppVnetConnectionResult] {
	return pulumix.Output[LookupWebAppVnetConnectionResult]{
