...
func ListWebAppAzureStorageAccountsSlot(ctx *pulumi.Context, args *ListWebAppAzureStorageAccountsSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppAzureStorageAccountsSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:listWebAppAzureStorageAccountsSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppAzureStorageAccountsSlotOutput(ctx *pulumi.Context, args ListWebAppAzureStorageAccountsSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppAzureStorageAccountsSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppAzureStorageAccountsSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:listWebAppAzureStorageAccountsSlot", args, ListWebAppAzureStorageAccountsSlotResultOutput{}, options).(ListWebAppAzureStorageAccountsSlotResultOutput), nil
