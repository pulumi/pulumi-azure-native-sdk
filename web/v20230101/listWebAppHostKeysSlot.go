...
func ListWebAppHostKeysSlot(ctx *pulumi.Context, args *ListWebAppHostKeysSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppHostKeysSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:listWebAppHostKeysSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppHostKeysSlotOutput(ctx *pulumi.Context, args ListWebAppHostKeysSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppHostKeysSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppHostKeysSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:listWebAppHostKeysSlot", args, ListWebAppHostKeysSlotResultOutput{}, options).(ListWebAppHostKeysSlotResultOutput), nil
