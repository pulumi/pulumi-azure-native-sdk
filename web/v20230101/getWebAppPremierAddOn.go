...
func LookupWebAppPremierAddOn(ctx *pulumi.Context, args *LookupWebAppPremierAddOnArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPremierAddOnResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getWebAppPremierAddOn", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppPremierAddOnOutput(ctx *pulumi.Context, args LookupWebAppPremierAddOnOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppPremierAddOnResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppPremierAddOnResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:getWebAppPremierAddOn", args, LookupWebAppPremierAddOnResultOutput{}, options).(LookupWebAppPremierAddOnResultOutput), nil
