...
func NewWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppHostNameBindingSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	var resource WebAppHostNameBindingSlot
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppHostNameBindingSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
