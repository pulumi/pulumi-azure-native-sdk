...
func NewKubeEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:KubeEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubeEnvironment(ctx *pulumi.Context,
	...
	var resource KubeEnvironment
	err := ctx.ReadResource("azure-native:web/v20230101:KubeEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
