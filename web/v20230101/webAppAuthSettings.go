...
func NewWebAppAuthSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppAuthSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAuthSettings(ctx *pulumi.Context,
	...
	var resource WebAppAuthSettings
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppAuthSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
