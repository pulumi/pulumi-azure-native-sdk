...
func NewWebAppApplicationSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppApplicationSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppApplicationSettings(ctx *pulumi.Context,
	...
	var resource WebAppApplicationSettings
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppApplicationSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
