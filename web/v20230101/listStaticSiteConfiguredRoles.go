...
func ListStaticSiteConfiguredRoles(ctx *pulumi.Context, args *ListStaticSiteConfiguredRolesArgs, opts ...pulumi.InvokeOption) (*ListStaticSiteConfiguredRolesResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:listStaticSiteConfiguredRoles", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListStaticSiteConfiguredRolesOutput(ctx *pulumi.Context, args ListStaticSiteConfiguredRolesOutputArgs, opts ...pulumi.InvokeOption) ListStaticSiteConfiguredRolesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListStaticSiteConfiguredRolesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:listStaticSiteConfiguredRoles", args, ListStaticSiteConfiguredRolesResultOutput{}, options).(ListStaticSiteConfiguredRolesResultOutput), nil
