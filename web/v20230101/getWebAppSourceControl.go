...
func LookupWebAppSourceControl(ctx *pulumi.Context, args *LookupWebAppSourceControlArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSourceControlResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getWebAppSourceControl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppSourceControlOutput(ctx *pulumi.Context, args LookupWebAppSourceControlOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppSourceControlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppSourceControlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:getWebAppSourceControl", args, LookupWebAppSourceControlResultOutput{}, options).(LookupWebAppSourceControlResultOutput), nil
