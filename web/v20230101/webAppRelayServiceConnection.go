...
func NewWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppRelayServiceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppRelayServiceConnection(ctx *pulumi.Context,
	...
	var resource WebAppRelayServiceConnection
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppRelayServiceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
