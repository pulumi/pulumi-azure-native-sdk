...
func NewAppServiceEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:AppServiceEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceEnvironment(ctx *pulumi.Context,
	...
	var resource AppServiceEnvironment
	err := ctx.ReadResource("azure-native:web/v20230101:AppServiceEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
