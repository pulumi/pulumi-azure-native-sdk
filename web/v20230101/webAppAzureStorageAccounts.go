...
func NewWebAppAzureStorageAccounts(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppAzureStorageAccounts", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAzureStorageAccounts(ctx *pulumi.Context,
	...
	var resource WebAppAzureStorageAccounts
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppAzureStorageAccounts", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
