...
func ListWebAppAzureStorageAccounts(ctx *pulumi.Context, args *ListWebAppAzureStorageAccountsArgs, opts ...pulumi.InvokeOption) (*ListWebAppAzureStorageAccountsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:listWebAppAzureStorageAccounts", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppAzureStorageAccountsOutput(ctx *pulumi.Context, args ListWebAppAzureStorageAccountsOutputArgs, opts ...pulumi.InvokeOption) ListWebAppAzureStorageAccountsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppAzureStorageAccountsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:listWebAppAzureStorageAccounts", args, ListWebAppAzureStorageAccountsResultOutput{}, options).(ListWebAppAzureStorageAccountsResultOutput), nil
