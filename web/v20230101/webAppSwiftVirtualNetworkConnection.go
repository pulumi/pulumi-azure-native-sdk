...
func NewWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppSwiftVirtualNetworkConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppSwiftVirtualNetworkConnection
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppSwiftVirtualNetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context,
	...
	var resource WebAppSwiftVirtualNetworkConnection
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppSwiftVirtualNetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
