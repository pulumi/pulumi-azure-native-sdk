...
func LookupWebAppRelayServiceConnection(ctx *pulumi.Context, args *LookupWebAppRelayServiceConnectionArgs, opts ...pulumi.InvokeOption) (*LookupWebAppRelayServiceConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getWebAppRelayServiceConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupWebAppRelayServiceConnectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWebAppRelayServiceConnectionResult] {
	return pulumix.Output[LookupWebAppRelayServiceConnectionResult]{
