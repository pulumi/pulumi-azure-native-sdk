...
func LookupWebAppFunction(ctx *pulumi.Context, args *LookupWebAppFunctionArgs, opts ...pulumi.InvokeOption) (*LookupWebAppFunctionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getWebAppFunction", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppFunctionOutput(ctx *pulumi.Context, args LookupWebAppFunctionOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppFunctionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppFunctionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:getWebAppFunction", args, LookupWebAppFunctionResultOutput{}, options).(LookupWebAppFunctionResultOutput), nil
