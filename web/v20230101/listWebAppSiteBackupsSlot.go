...
func ListWebAppSiteBackupsSlot(ctx *pulumi.Context, args *ListWebAppSiteBackupsSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppSiteBackupsSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:listWebAppSiteBackupsSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppSiteBackupsSlotOutput(ctx *pulumi.Context, args ListWebAppSiteBackupsSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppSiteBackupsSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppSiteBackupsSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:listWebAppSiteBackupsSlot", args, ListWebAppSiteBackupsSlotResultOutput{}, options).(ListWebAppSiteBackupsSlotResultOutput), nil
