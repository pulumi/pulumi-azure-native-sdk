...
func LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context, args *LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs, opts ...pulumi.InvokeOption) (*LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20230101:getStaticSiteUserProvidedFunctionAppForStaticSiteBuild", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildOutput(ctx *pulumi.Context, args LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildOutputArgs, opts ...pulumi.InvokeOption) LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20230101:getStaticSiteUserProvidedFunctionAppForStaticSiteBuild", args, LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildResultOutput{}, options).(LookupStaticSiteUserProvidedFunctionAppForStaticSiteBuildResultOutput), nil
