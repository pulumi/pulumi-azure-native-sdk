...
func NewWebAppPublicCertificateSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20230101:WebAppPublicCertificateSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPublicCertificateSlot(ctx *pulumi.Context,
	...
	var resource WebAppPublicCertificateSlot
	err := ctx.ReadResource("azure-native:web/v20230101:WebAppPublicCertificateSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
