...
func NewWebAppSourceControlSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppSourceControlSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20240401:WebAppSourceControlSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppSourceControlSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppSourceControlSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppSourceControlSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppSourceControlSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppSourceControlSlot"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppSourceControlSlot
	err := ctx.RegisterResource("azure-native:web:WebAppSourceControlSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSourceControlSlot(ctx *pulumi.Context,
	...
	var resource WebAppSourceControlSlot
	err := ctx.ReadResource("azure-native:web:WebAppSourceControlSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// If GitHub Action is selected, than the associated configuration.
func (o WebAppSourceControlSlotOutput) GitHubActionConfiguration() GitHubActionConfigurationResponsePtrOutput {
	return o.ApplyT(func(v *WebAppSourceControlSlot) GitHubActionConfigurationResponsePtrOutput {
