...
func NewWebAppFtpAllowed(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppFtpAllowed"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppFtpAllowed"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppFtpAllowed"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppFtpAllowed"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppFtpAllowed"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppFtpAllowed
	err := ctx.RegisterResource("azure-native:web:WebAppFtpAllowed", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppFtpAllowed(ctx *pulumi.Context,
	...
	var resource WebAppFtpAllowed
	err := ctx.ReadResource("azure-native:web:WebAppFtpAllowed", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppFtpAllowedOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppFtpAllowed) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
