...
//
// Deprecated: azure-native:web/v20210301:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppConnectionStringsSlot to guarantee forwards compatibility.
...
func NewWebAppConnectionStringsSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppConnectionStringsSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConnectionStringsSlot(ctx *pulumi.Context,
	...
	var resource WebAppConnectionStringsSlot
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppConnectionStringsSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
