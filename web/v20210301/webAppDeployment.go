...
//
// Deprecated: azure-native:web/v20210301:WebAppDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDeployment to guarantee forwards compatibility.
...
func NewWebAppDeployment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppDeployment"),
		},
	})
	opts = append(opts, aliases)
	var resource WebAppDeployment
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeployment(ctx *pulumi.Context,
	...
	var resource WebAppDeployment
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
