...
func NewWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppSwiftVirtualNetworkConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSwiftVirtualNetworkConnection(ctx *pulumi.Context,
	...
	var resource WebAppSwiftVirtualNetworkConnection
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppSwiftVirtualNetworkConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
