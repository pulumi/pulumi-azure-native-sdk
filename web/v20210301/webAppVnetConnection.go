...
func NewWebAppVnetConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppVnetConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppVnetConnection(ctx *pulumi.Context,
	...
	var resource WebAppVnetConnection
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppVnetConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
