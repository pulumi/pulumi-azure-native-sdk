...
//
// Deprecated: azure-native:web/v20210301:WebAppSiteExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSiteExtension to guarantee forwards compatibility.
...
func NewWebAppSiteExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppSiteExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSiteExtension(ctx *pulumi.Context,
	...
	var resource WebAppSiteExtension
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppSiteExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
