...
//
// Deprecated: azure-native:web/v20210301:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.
...
func NewWebAppDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppDomainOwnershipIdentifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	var resource WebAppDomainOwnershipIdentifier
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppDomainOwnershipIdentifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
