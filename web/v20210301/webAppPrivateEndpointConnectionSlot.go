...
//
// Deprecated: azure-native:web/v20210301:WebAppPrivateEndpointConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPrivateEndpointConnectionSlot to guarantee forwards compatibility.
...
func NewWebAppPrivateEndpointConnectionSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppPrivateEndpointConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPrivateEndpointConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppPrivateEndpointConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppPrivateEndpointConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
