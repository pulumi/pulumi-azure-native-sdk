...
func NewWebAppFtpAllowedSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppFtpAllowedSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppFtpAllowedSlot(ctx *pulumi.Context,
	...
	var resource WebAppFtpAllowedSlot
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppFtpAllowedSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
