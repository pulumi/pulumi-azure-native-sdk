...
// Premier add-on.
//
// Deprecated: azure-native:web/v20210301:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPremierAddOnSlot to guarantee forwards compatibility.
...
func NewWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20210301:WebAppPremierAddOnSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPremierAddOnSlot(ctx *pulumi.Context,
	...
	var resource WebAppPremierAddOnSlot
	err := ctx.ReadResource("azure-native:web/v20210301:WebAppPremierAddOnSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
