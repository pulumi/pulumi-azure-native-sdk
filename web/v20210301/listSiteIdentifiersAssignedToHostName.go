...
func ListSiteIdentifiersAssignedToHostName(ctx *pulumi.Context, args *ListSiteIdentifiersAssignedToHostNameArgs, opts ...pulumi.InvokeOption) (*ListSiteIdentifiersAssignedToHostNameResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20210301:listSiteIdentifiersAssignedToHostName", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListSiteIdentifiersAssignedToHostNameOutput(ctx *pulumi.Context, args ListSiteIdentifiersAssignedToHostNameOutputArgs, opts ...pulumi.InvokeOption) ListSiteIdentifiersAssignedToHostNameResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListSiteIdentifiersAssignedToHostNameResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20210301:listSiteIdentifiersAssignedToHostName", args, ListSiteIdentifiersAssignedToHostNameResultOutput{}, options).(ListSiteIdentifiersAssignedToHostNameResultOutput), nil
