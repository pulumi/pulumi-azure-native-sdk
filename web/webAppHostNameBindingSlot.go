...
func NewWebAppHostNameBindingSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppHostNameBindingSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppHostNameBindingSlot"),
		},
	})
