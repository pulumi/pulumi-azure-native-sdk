...
func NewWebAppSlotConfigurationNames(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppSlotConfigurationNames"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppSlotConfigurationNames"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppSlotConfigurationNames"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppSlotConfigurationNames"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppSlotConfigurationNames"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebAppSlotConfigurationNamesOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppSlotConfigurationNames) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
