...
func NewWebAppAzureStorageAccounts(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppAzureStorageAccounts"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppAzureStorageAccounts"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppAzureStorageAccounts"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppAzureStorageAccounts"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppAzureStorageAccounts"),
		},
	})
