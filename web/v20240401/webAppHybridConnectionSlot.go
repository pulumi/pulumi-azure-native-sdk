...
func NewWebAppHybridConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppHybridConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppHybridConnectionSlot"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppHybridConnectionSlot
	err := ctx.RegisterResource("azure-native:web/v20240401:WebAppHybridConnectionSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHybridConnectionSlot(ctx *pulumi.Context,
	...
	var resource WebAppHybridConnectionSlot
	err := ctx.ReadResource("azure-native:web/v20240401:WebAppHybridConnectionSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
