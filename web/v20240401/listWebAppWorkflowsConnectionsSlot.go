...
func ListWebAppWorkflowsConnectionsSlot(ctx *pulumi.Context, args *ListWebAppWorkflowsConnectionsSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppWorkflowsConnectionsSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:listWebAppWorkflowsConnectionsSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppWorkflowsConnectionsSlotOutput(ctx *pulumi.Context, args ListWebAppWorkflowsConnectionsSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppWorkflowsConnectionsSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppWorkflowsConnectionsSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:listWebAppWorkflowsConnectionsSlot", args, ListWebAppWorkflowsConnectionsSlotResultOutput{}, options).(ListWebAppWorkflowsConnectionsSlotResultOutput), nil
