...
func LookupWebAppSwiftVirtualNetworkConnectionSlot(ctx *pulumi.Context, args *LookupWebAppSwiftVirtualNetworkConnectionSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSwiftVirtualNetworkConnectionSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:getWebAppSwiftVirtualNetworkConnectionSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppSwiftVirtualNetworkConnectionSlotOutput(ctx *pulumi.Context, args LookupWebAppSwiftVirtualNetworkConnectionSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppSwiftVirtualNetworkConnectionSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppSwiftVirtualNetworkConnectionSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:getWebAppSwiftVirtualNetworkConnectionSlot", args, LookupWebAppSwiftVirtualNetworkConnectionSlotResultOutput{}, options).(LookupWebAppSwiftVirtualNetworkConnectionSlotResultOutput), nil
