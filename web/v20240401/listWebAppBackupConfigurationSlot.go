...
func ListWebAppBackupConfigurationSlot(ctx *pulumi.Context, args *ListWebAppBackupConfigurationSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppBackupConfigurationSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:listWebAppBackupConfigurationSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func ListWebAppBackupConfigurationSlotOutput(ctx *pulumi.Context, args ListWebAppBackupConfigurationSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppBackupConfigurationSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppBackupConfigurationSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:listWebAppBackupConfigurationSlot", args, ListWebAppBackupConfigurationSlotResultOutput{}, options).(ListWebAppBackupConfigurationSlotResultOutput), nil
