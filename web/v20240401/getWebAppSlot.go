...
func LookupWebAppSlot(ctx *pulumi.Context, args *LookupWebAppSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:getWebAppSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupWebAppSlotOutput(ctx *pulumi.Context, args LookupWebAppSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:getWebAppSlot", args, LookupWebAppSlotResultOutput{}, options).(LookupWebAppSlotResultOutput), nil
