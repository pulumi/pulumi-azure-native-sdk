...
func NewWebAppDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:WebAppDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeployment(ctx *pulumi.Context,
	...
	var resource WebAppDeployment
	err := ctx.ReadResource("azure-native:web/v20240401:WebAppDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
