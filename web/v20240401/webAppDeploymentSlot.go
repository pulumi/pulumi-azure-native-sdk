...
func NewWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:WebAppDeploymentSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppDeploymentSlot(ctx *pulumi.Context,
	...
	var resource WebAppDeploymentSlot
	err := ctx.ReadResource("azure-native:web/v20240401:WebAppDeploymentSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
