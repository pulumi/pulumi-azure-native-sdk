...
func NewAppServicePlanRouteForVnet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:AppServicePlanRouteForVnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServicePlanRouteForVnet(ctx *pulumi.Context,
	...
	var resource AppServicePlanRouteForVnet
	err := ctx.ReadResource("azure-native:web/v20240401:AppServicePlanRouteForVnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
