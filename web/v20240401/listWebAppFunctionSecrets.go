...
func ListWebAppFunctionSecrets(ctx *pulumi.Context, args *ListWebAppFunctionSecretsArgs, opts ...pulumi.InvokeOption) (*ListWebAppFunctionSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:listWebAppFunctionSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppFunctionSecretsOutput(ctx *pulumi.Context, args ListWebAppFunctionSecretsOutputArgs, opts ...pulumi.InvokeOption) ListWebAppFunctionSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppFunctionSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:listWebAppFunctionSecrets", args, ListWebAppFunctionSecretsResultOutput{}, options).(ListWebAppFunctionSecretsResultOutput), nil
