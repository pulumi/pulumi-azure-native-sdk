...
func NewStaticSiteDatabaseConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:StaticSiteDatabaseConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteDatabaseConnection(ctx *pulumi.Context,
	...
	var resource StaticSiteDatabaseConnection
	err := ctx.ReadResource("azure-native:web/v20240401:StaticSiteDatabaseConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
