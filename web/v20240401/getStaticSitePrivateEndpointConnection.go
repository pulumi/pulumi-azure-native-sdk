...
func LookupStaticSitePrivateEndpointConnection(ctx *pulumi.Context, args *LookupStaticSitePrivateEndpointConnectionArgs, opts ...pulumi.InvokeOption) (*LookupStaticSitePrivateEndpointConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:getStaticSitePrivateEndpointConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStaticSitePrivateEndpointConnectionOutput(ctx *pulumi.Context, args LookupStaticSitePrivateEndpointConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupStaticSitePrivateEndpointConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStaticSitePrivateEndpointConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:getStaticSitePrivateEndpointConnection", args, LookupStaticSitePrivateEndpointConnectionResultOutput{}, options).(LookupStaticSitePrivateEndpointConnectionResultOutput), nil
