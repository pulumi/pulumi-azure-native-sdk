...
func NewAppServiceEnvironmentPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:AppServiceEnvironmentPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceEnvironmentPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource AppServiceEnvironmentPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:web/v20240401:AppServiceEnvironmentPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
