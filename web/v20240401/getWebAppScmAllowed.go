...
func LookupWebAppScmAllowed(ctx *pulumi.Context, args *LookupWebAppScmAllowedArgs, opts ...pulumi.InvokeOption) (*LookupWebAppScmAllowedResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:getWebAppScmAllowed", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppScmAllowedOutput(ctx *pulumi.Context, args LookupWebAppScmAllowedOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppScmAllowedResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppScmAllowedResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:getWebAppScmAllowed", args, LookupWebAppScmAllowedResultOutput{}, options).(LookupWebAppScmAllowedResultOutput), nil
