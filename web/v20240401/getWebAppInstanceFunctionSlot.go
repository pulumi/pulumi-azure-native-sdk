...
func LookupWebAppInstanceFunctionSlot(ctx *pulumi.Context, args *LookupWebAppInstanceFunctionSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppInstanceFunctionSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:getWebAppInstanceFunctionSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppInstanceFunctionSlotOutput(ctx *pulumi.Context, args LookupWebAppInstanceFunctionSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppInstanceFunctionSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppInstanceFunctionSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:getWebAppInstanceFunctionSlot", args, LookupWebAppInstanceFunctionSlotResultOutput{}, options).(LookupWebAppInstanceFunctionSlotResultOutput), nil
