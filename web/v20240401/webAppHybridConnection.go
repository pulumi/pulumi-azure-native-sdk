...
func NewWebAppHybridConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:WebAppHybridConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHybridConnection(ctx *pulumi.Context,
	...
	var resource WebAppHybridConnection
	err := ctx.ReadResource("azure-native:web/v20240401:WebAppHybridConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
