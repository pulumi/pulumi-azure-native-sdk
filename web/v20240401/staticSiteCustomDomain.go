...
func NewStaticSiteCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:StaticSiteCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:StaticSiteCustomDomain"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource StaticSiteCustomDomain
	err := ctx.RegisterResource("azure-native:web/v20240401:StaticSiteCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteCustomDomain(ctx *pulumi.Context,
	...
	var resource StaticSiteCustomDomain
	err := ctx.ReadResource("azure-native:web/v20240401:StaticSiteCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
