...
func ListWorkflowRunActionExpressionTraces(ctx *pulumi.Context, args *ListWorkflowRunActionExpressionTracesArgs, opts ...pulumi.InvokeOption) (*ListWorkflowRunActionExpressionTracesResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:listWorkflowRunActionExpressionTraces", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWorkflowRunActionExpressionTracesOutput(ctx *pulumi.Context, args ListWorkflowRunActionExpressionTracesOutputArgs, opts ...pulumi.InvokeOption) ListWorkflowRunActionExpressionTracesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWorkflowRunActionExpressionTracesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:listWorkflowRunActionExpressionTraces", args, ListWorkflowRunActionExpressionTracesResultOutput{}, options).(ListWorkflowRunActionExpressionTracesResultOutput), nil
