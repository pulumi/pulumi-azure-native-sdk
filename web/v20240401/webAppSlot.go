...
func NewWebAppSlot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:WebAppSlot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSlot(ctx *pulumi.Context,
	...
	var resource WebAppSlot
	err := ctx.ReadResource("azure-native:web/v20240401:WebAppSlot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies the scope of uniqueness for the default hostname during resource creation
func (o WebAppSlotOutput) AutoGeneratedDomainNameLabelScope() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebAppSlot) pulumi.StringPtrOutput { return v.AutoGeneratedDomainNameLabelScope }).(pulumi.StringPtrOutput)
}
...
// Dapr configuration of the app.
func (o WebAppSlotOutput) DaprConfig() DaprConfigResponsePtrOutput {
	return o.ApplyT(func(v *WebAppSlot) DaprConfigResponsePtrOutput { return v.DaprConfig }).(DaprConfigResponsePtrOutput)
}
...
// Property to configure various DNS related settings for a site.
func (o WebAppSlotOutput) DnsConfiguration() SiteDnsConfigResponsePtrOutput {
	return o.ApplyT(func(v *WebAppSlot) SiteDnsConfigResponsePtrOutput { return v.DnsConfiguration }).(SiteDnsConfigResponsePtrOutput)
}
...
// Configuration specific of the Azure Function app.
func (o WebAppSlotOutput) FunctionAppConfig() FunctionAppConfigResponsePtrOutput {
	return o.ApplyT(func(v *WebAppSlot) FunctionAppConfigResponsePtrOutput { return v.FunctionAppConfig }).(FunctionAppConfigResponsePtrOutput)
}
...
// Specifies the IP mode of the app.
func (o WebAppSlotOutput) IpMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebAppSlot) pulumi.StringPtrOutput { return v.IpMode }).(pulumi.StringPtrOutput)
}
...
// Function app resource requirements.
func (o WebAppSlotOutput) ResourceConfig() ResourceConfigResponsePtrOutput {
	return o.ApplyT(func(v *WebAppSlot) ResourceConfigResponsePtrOutput { return v.ResourceConfig }).(ResourceConfigResponsePtrOutput)
}
...
// Current SKU of application based on associated App Service Plan. Some valid SKU values are Free, Shared, Basic, Dynamic, FlexConsumption, Standard, Premium, PremiumV2, PremiumV3, Isolated, IsolatedV2
func (o WebAppSlotOutput) Sku() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppSlot) pulumi.StringOutput { return v.Sku }).(pulumi.StringOutput)
}
...
// To enable Backup and Restore operations over virtual network
func (o WebAppSlotOutput) VnetBackupRestoreEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *WebAppSlot) pulumi.BoolPtrOutput { return v.VnetBackupRestoreEnabled }).(pulumi.BoolPtrOutput)
}
...
// Workload profile name for function app to execute on.
func (o WebAppSlotOutput) WorkloadProfileName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebAppSlot) pulumi.StringPtrOutput { return v.WorkloadProfileName }).(pulumi.StringPtrOutput)
}
