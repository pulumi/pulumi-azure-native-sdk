...
func LookupWebAppPremierAddOnSlot(ctx *pulumi.Context, args *LookupWebAppPremierAddOnSlotArgs, opts ...pulumi.InvokeOption) (*LookupWebAppPremierAddOnSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:getWebAppPremierAddOnSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppPremierAddOnSlotOutput(ctx *pulumi.Context, args LookupWebAppPremierAddOnSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppPremierAddOnSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppPremierAddOnSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:getWebAppPremierAddOnSlot", args, LookupWebAppPremierAddOnSlotResultOutput{}, options).(LookupWebAppPremierAddOnSlotResultOutput), nil
