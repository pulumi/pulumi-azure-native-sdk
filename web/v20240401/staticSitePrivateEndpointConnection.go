...
func NewStaticSitePrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:StaticSitePrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSitePrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource StaticSitePrivateEndpointConnection
	err := ctx.ReadResource("azure-native:web/v20240401:StaticSitePrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
