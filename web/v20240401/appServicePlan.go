...
func NewAppServicePlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:AppServicePlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServicePlan(ctx *pulumi.Context,
	...
	var resource AppServicePlan
	err := ctx.ReadResource("azure-native:web/v20240401:AppServicePlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
