...
func LookupStaticSiteCustomDomain(ctx *pulumi.Context, args *LookupStaticSiteCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupStaticSiteCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:getStaticSiteCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStaticSiteCustomDomainOutput(ctx *pulumi.Context, args LookupStaticSiteCustomDomainOutputArgs, opts ...pulumi.InvokeOption) LookupStaticSiteCustomDomainResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStaticSiteCustomDomainResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:getStaticSiteCustomDomain", args, LookupStaticSiteCustomDomainResultOutput{}, options).(LookupStaticSiteCustomDomainResultOutput), nil
