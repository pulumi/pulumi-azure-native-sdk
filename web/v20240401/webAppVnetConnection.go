...
func NewWebAppVnetConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppVnetConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20231201:WebAppVnetConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppVnetConnection
	err := ctx.RegisterResource("azure-native:web/v20240401:WebAppVnetConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppVnetConnection(ctx *pulumi.Context,
	...
	var resource WebAppVnetConnection
	err := ctx.ReadResource("azure-native:web/v20240401:WebAppVnetConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
