...
func LookupWebAppVnetConnection(ctx *pulumi.Context, args *LookupWebAppVnetConnectionArgs, opts ...pulumi.InvokeOption) (*LookupWebAppVnetConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:getWebAppVnetConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWebAppVnetConnectionOutput(ctx *pulumi.Context, args LookupWebAppVnetConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppVnetConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppVnetConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:getWebAppVnetConnection", args, LookupWebAppVnetConnectionResultOutput{}, options).(LookupWebAppVnetConnectionResultOutput), nil
