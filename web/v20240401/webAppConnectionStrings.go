...
func NewWebAppConnectionStrings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:WebAppConnectionStrings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppConnectionStrings(ctx *pulumi.Context,
	...
	var resource WebAppConnectionStrings
	err := ctx.ReadResource("azure-native:web/v20240401:WebAppConnectionStrings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
