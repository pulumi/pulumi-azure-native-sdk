...
func NewStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context,
	...
	var resource StaticSiteUserProvidedFunctionAppForStaticSiteBuild
	err := ctx.ReadResource("azure-native:web/v20240401:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
