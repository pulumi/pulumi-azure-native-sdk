...
func ListWebAppSyncFunctionTriggersSlot(ctx *pulumi.Context, args *ListWebAppSyncFunctionTriggersSlotArgs, opts ...pulumi.InvokeOption) (*ListWebAppSyncFunctionTriggersSlotResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20240401:listWebAppSyncFunctionTriggersSlot", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListWebAppSyncFunctionTriggersSlotOutput(ctx *pulumi.Context, args ListWebAppSyncFunctionTriggersSlotOutputArgs, opts ...pulumi.InvokeOption) ListWebAppSyncFunctionTriggersSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListWebAppSyncFunctionTriggersSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20240401:listWebAppSyncFunctionTriggersSlot", args, ListWebAppSyncFunctionTriggersSlotResultOutput{}, options).(ListWebAppSyncFunctionTriggersSlotResultOutput), nil
