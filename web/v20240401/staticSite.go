...
func NewStaticSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:StaticSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticSite(ctx *pulumi.Context,
	...
	var resource StaticSite
	err := ctx.ReadResource("azure-native:web/v20240401:StaticSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
