...
func NewWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20240401:WebAppBackupConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppBackupConfiguration(ctx *pulumi.Context,
	...
	var resource WebAppBackupConfiguration
	err := ctx.ReadResource("azure-native:web/v20240401:WebAppBackupConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
