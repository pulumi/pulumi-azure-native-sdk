...
func NewWebAppScmAllowed(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppScmAllowed"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppScmAllowed"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppScmAllowed"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppScmAllowed"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppScmAllowed"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppScmAllowed
	err := ctx.RegisterResource("azure-native:web:WebAppScmAllowed", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppScmAllowed(ctx *pulumi.Context,
	...
	var resource WebAppScmAllowed
	err := ctx.ReadResource("azure-native:web:WebAppScmAllowed", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o WebAppScmAllowedOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppScmAllowed) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
