...
func NewAppServiceEnvironmentAseCustomDnsSuffixConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:AppServiceEnvironmentAseCustomDnsSuffixConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:AppServiceEnvironmentAseCustomDnsSuffixConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:AppServiceEnvironmentAseCustomDnsSuffixConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:AppServiceEnvironmentAseCustomDnsSuffixConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:AppServiceEnvironmentAseCustomDnsSuffixConfiguration"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AppServiceEnvironmentAseCustomDnsSuffixConfigurationOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *AppServiceEnvironmentAseCustomDnsSuffixConfiguration) SystemDataResponseOutput {
		return v.SystemData
