...
func LookupAppServicePlanOutput(ctx *pulumi.Context, args LookupAppServicePlanOutputArgs, opts ...pulumi.InvokeOption) LookupAppServicePlanResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAppServicePlanResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web/v20160901:getAppServicePlan", args, LookupAppServicePlanResultOutput{}, options).(LookupAppServicePlanResultOutput), nil
...
// App Service plan administration site.
func (o LookupAppServicePlanResultOutput) AdminSiteName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAppServicePlanResult) *string { return v.AdminSiteName }).(pulumi.StringPtrOutput)
}
