...
type WebApp struct {
	...
	DaprConfig DaprConfigResponsePtrOutput `pulumi:"daprConfig"`
	// Default hostname of the app. Read-only.
	DefaultHostName pulumi.StringOutput `pulumi:"defaultHostName"`
	// Property to configure various DNS related settings for a site.
	DnsConfiguration SiteDnsConfigResponsePtrOutput `pulumi:"dnsConfiguration"`
	...
	FunctionAppConfig FunctionAppConfigResponsePtrOutput `pulumi:"functionAppConfig"`
	...
	ResourceConfig ResourceConfigResponsePtrOutput `pulumi:"resourceConfig"`
...
func NewWebApp(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebApp"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebApp"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebApp"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebApp"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebApp"),
		},
	})
...
type webAppArgs struct {
	...
	// Dapr configuration of the app.
	DaprConfig *DaprConfig `pulumi:"daprConfig"`
	// Property to configure various DNS related settings for a site.
	...
	// Configuration specific of the Azure Function app.
	FunctionAppConfig *FunctionAppConfig `pulumi:"functionAppConfig"`
	// Hostname SSL states are used to manage the SSL bindings for app's hostnames.
...
type WebAppArgs struct {
	...
	// Configuration specific of the Azure Function app.
	FunctionAppConfig FunctionAppConfigPtrInput
	// Hostname SSL states are used to manage the SSL bindings for app's hostnames.
...
// Specifies the scope of uniqueness for the default hostname during resource creation
func (o WebAppOutput) AutoGeneratedDomainNameLabelScope() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebApp) pulumi.StringPtrOutput { return v.AutoGeneratedDomainNameLabelScope }).(pulumi.StringPtrOutput)
}
...
// The Azure API version of the resource.
func (o WebAppOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebApp) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Dapr configuration of the app.
func (o WebAppOutput) DaprConfig() DaprConfigResponsePtrOutput {
	return o.ApplyT(func(v *WebApp) DaprConfigResponsePtrOutput { return v.DaprConfig }).(DaprConfigResponsePtrOutput)
}
...
// Property to configure various DNS related settings for a site.
func (o WebAppOutput) DnsConfiguration() SiteDnsConfigResponsePtrOutput {
	return o.ApplyT(func(v *WebApp) SiteDnsConfigResponsePtrOutput { return v.DnsConfiguration }).(SiteDnsConfigResponsePtrOutput)
}
...
// Whether to use end to end encryption between the FrontEnd and the Worker
func (o WebAppOutput) EndToEndEncryptionEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *WebApp) pulumi.BoolPtrOutput { return v.EndToEndEncryptionEnabled }).(pulumi.BoolPtrOutput)
}
...
// Configuration specific of the Azure Function app.
func (o WebAppOutput) FunctionAppConfig() FunctionAppConfigResponsePtrOutput {
	return o.ApplyT(func(v *WebApp) FunctionAppConfigResponsePtrOutput { return v.FunctionAppConfig }).(FunctionAppConfigResponsePtrOutput)
}
...
// Specifies the IP mode of the app.
func (o WebAppOutput) IpMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebApp) pulumi.StringPtrOutput { return v.IpMode }).(pulumi.StringPtrOutput)
}
...
// Function app resource requirements.
func (o WebAppOutput) ResourceConfig() ResourceConfigResponsePtrOutput {
	return o.ApplyT(func(v *WebApp) ResourceConfigResponsePtrOutput { return v.ResourceConfig }).(ResourceConfigResponsePtrOutput)
}
...
// Workload profile name for function app to execute on.
func (o WebAppOutput) WorkloadProfileName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WebApp) pulumi.StringPtrOutput { return v.WorkloadProfileName }).(pulumi.StringPtrOutput)
}
