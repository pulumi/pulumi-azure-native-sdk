...
//
// Deprecated: azure-native:web/v20181101:WebAppApplicationSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppApplicationSettings to guarantee forwards compatibility.
...
func NewWebAppApplicationSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20181101:WebAppApplicationSettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppApplicationSettings(ctx *pulumi.Context,
	...
	var resource WebAppApplicationSettings
	err := ctx.ReadResource("azure-native:web/v20181101:WebAppApplicationSettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
