...
//
// Deprecated: azure-native:web/v20181101:WebAppHybridConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHybridConnection to guarantee forwards compatibility.
...
func NewWebAppHybridConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20181101:WebAppHybridConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppHybridConnection(ctx *pulumi.Context,
	...
	var resource WebAppHybridConnection
	err := ctx.ReadResource("azure-native:web/v20181101:WebAppHybridConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
