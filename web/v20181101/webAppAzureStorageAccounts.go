...
//
// Deprecated: azure-native:web/v20181101:WebAppAzureStorageAccounts is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAzureStorageAccounts to guarantee forwards compatibility.
...
func NewWebAppAzureStorageAccounts(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20181101:WebAppAzureStorageAccounts", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppAzureStorageAccounts(ctx *pulumi.Context,
	...
	var resource WebAppAzureStorageAccounts
	err := ctx.ReadResource("azure-native:web/v20181101:WebAppAzureStorageAccounts", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
