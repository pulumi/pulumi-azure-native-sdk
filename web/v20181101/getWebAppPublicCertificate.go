...
//
// Deprecated: azure-native:web/v20181101:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPublicCertificate to guarantee forwards compatibility.
