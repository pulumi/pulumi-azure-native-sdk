...
func NewWebAppSiteExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20181101:WebAppSiteExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSiteExtension(ctx *pulumi.Context,
	...
	var resource WebAppSiteExtension
	err := ctx.ReadResource("azure-native:web/v20181101:WebAppSiteExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
