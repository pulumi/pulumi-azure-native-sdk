...
func ListWebAppPublishingCredentials(ctx *pulumi.Context, args *ListWebAppPublishingCredentialsArgs, opts ...pulumi.InvokeOption) (*ListWebAppPublishingCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:web/v20181101:listWebAppPublishingCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ListWebAppPublishingCredentialsResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListWebAppPublishingCredentialsResult] {
	return pulumix.Output[ListWebAppPublishingCredentialsResult]{
