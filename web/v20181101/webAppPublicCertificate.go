...
func NewWebAppPublicCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:web/v20181101:WebAppPublicCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppPublicCertificate(ctx *pulumi.Context,
	...
	var resource WebAppPublicCertificate
	err := ctx.ReadResource("azure-native:web/v20181101:WebAppPublicCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
