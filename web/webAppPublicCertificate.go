...
func NewWebAppPublicCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppPublicCertificate"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppPublicCertificate"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppPublicCertificate"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppPublicCertificate"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppPublicCertificate"),
		},
	})
