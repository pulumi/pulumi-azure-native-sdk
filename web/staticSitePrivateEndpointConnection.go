...
func NewStaticSitePrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:StaticSitePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:StaticSitePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:StaticSitePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:StaticSitePrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:StaticSitePrivateEndpointConnection"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o StaticSitePrivateEndpointConnectionOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *StaticSitePrivateEndpointConnection) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
