...
func NewWebAppVnetConnectionSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppVnetConnectionSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppVnetConnectionSlot"),
		},
	})
...
// The Azure API version of the resource.
func (o WebAppVnetConnectionSlotOutput) AzureApiVersion() pulumi.StringOutput {
