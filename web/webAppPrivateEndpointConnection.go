...
func NewWebAppPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppPrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppPrivateEndpointConnection"),
		},
	})
