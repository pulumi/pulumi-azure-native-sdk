...
func LookupWebAppSlotOutput(ctx *pulumi.Context, args LookupWebAppSlotOutputArgs, opts ...pulumi.InvokeOption) LookupWebAppSlotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebAppSlotResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:web:getWebAppSlot", args, LookupWebAppSlotResultOutput{}, options).(LookupWebAppSlotResultOutput), nil
...
// Specifies the scope of uniqueness for the default hostname during resource creation
func (o LookupWebAppSlotResultOutput) AutoGeneratedDomainNameLabelScope() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWebAppSlotResult) *string { return v.AutoGeneratedDomainNameLabelScope }).(pulumi.StringPtrOutput)
}
...
// The Azure API version of the resource.
func (o LookupWebAppSlotResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWebAppSlotResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// <code>true</code> to enable client affinity partitioning using CHIPS cookies, this will add the <code>partitioned</code> property to the affinity cookies; <code>false</code> to stop sending partitioned affinity cookies. Default is <code>false</code>.
func (o LookupWebAppSlotResultOutput) ClientAffinityPartitioningEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWebAppSlotResult) *bool { return v.ClientAffinityPartitioningEnabled }).(pulumi.BoolPtrOutput)
}

// <code>true</code> to override client affinity cookie domain with X-Forwarded-Host request header. <code>false</code> to use default domain. Default is <code>false</code>.
func (o LookupWebAppSlotResultOutput) ClientAffinityProxyEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWebAppSlotResult) *bool { return v.ClientAffinityProxyEnabled }).(pulumi.BoolPtrOutput)
}
...
// Specifies the IP mode of the app.
func (o LookupWebAppSlotResultOutput) IpMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWebAppSlotResult) *string { return v.IpMode }).(pulumi.StringPtrOutput)
}
...
// Property to configure various outbound traffic routing options over virtual network for a site
func (o LookupWebAppSlotResultOutput) OutboundVnetRouting() OutboundVnetRoutingResponsePtrOutput {
	return o.ApplyT(func(v LookupWebAppSlotResult) *OutboundVnetRoutingResponse { return v.OutboundVnetRouting }).(OutboundVnetRoutingResponsePtrOutput)
}
...
// Current SKU of application based on associated App Service Plan. Some valid SKU values are Free, Shared, Basic, Dynamic, FlexConsumption, Standard, Premium, PremiumV2, PremiumV3, Isolated, IsolatedV2
func (o LookupWebAppSlotResultOutput) Sku() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWebAppSlotResult) string { return v.Sku }).(pulumi.StringOutput)
}
...
// Whether to enable ssh access.
func (o LookupWebAppSlotResultOutput) SshEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupWebAppSlotResult) *bool { return v.SshEnabled }).(pulumi.BoolPtrOutput)
}
