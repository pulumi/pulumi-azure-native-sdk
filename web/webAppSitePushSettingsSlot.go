...
func NewWebAppSitePushSettingsSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppSitePushSettingsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppSitePushSettingsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppSitePushSettingsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppSitePushSettingsSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppSitePushSettingsSlot"),
		},
	})
