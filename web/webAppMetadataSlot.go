...
func NewWebAppMetadataSlot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20220901:WebAppMetadataSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20230101:WebAppMetadataSlot"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:WebAppMetadataSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:WebAppMetadataSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:WebAppMetadataSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:WebAppMetadataSlot"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:WebAppMetadataSlot"),
		},
	})
...
// The Azure API version of the resource.
func (o WebAppMetadataSlotOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *WebAppMetadataSlot) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
