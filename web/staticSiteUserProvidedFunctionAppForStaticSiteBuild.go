...
func NewStaticSiteUserProvidedFunctionAppForStaticSiteBuild(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20230101:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"),
		},
	})
...
// The Azure API version of the resource.
func (o StaticSiteUserProvidedFunctionAppForStaticSiteBuildOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *StaticSiteUserProvidedFunctionAppForStaticSiteBuild) pulumi.StringOutput {
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o StaticSiteUserProvidedFunctionAppForStaticSiteBuildOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *StaticSiteUserProvidedFunctionAppForStaticSiteBuild) SystemDataResponseOutput {
		return v.SystemData
