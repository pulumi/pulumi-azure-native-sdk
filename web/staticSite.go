...
func NewStaticSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:web/v20241101:StaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250301:StaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20250501:StaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260301preview:StaticSite"),
		},
		{
			Type: pulumi.String("azure-native:web/v20260315:StaticSite"),
		},
	})
