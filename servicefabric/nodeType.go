...
func NewNodeType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20250301preview:NodeType"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20250601preview:NodeType"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20251001preview:NodeType"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260201:NodeType"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260501preview:NodeType"),
		},
	})
...
// The Azure API version of the resource.
func (o NodeTypeOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *NodeType) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
