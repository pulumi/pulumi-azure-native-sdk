...
func NewManagedClusterApplicationTypeVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20250601preview:ManagedClusterApplicationTypeVersion"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20251001preview:ManagedClusterApplicationTypeVersion"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260201:ManagedClusterApplicationTypeVersion"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260501preview:ManagedClusterApplicationTypeVersion"),
		},
	})
