...
//
// Deprecated: azure-native:servicefabric/v20210901privatepreview:ApplicationType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:ApplicationType to guarantee forwards compatibility.
func LookupApplicationType(ctx *pulumi.Context, args *LookupApplicationTypeArgs, opts ...pulumi.InvokeOption) (*LookupApplicationTypeResult, error) {
	...
	err := ctx.Invoke("azure-native:servicefabric/v20210901privatepreview:getApplicationType", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
