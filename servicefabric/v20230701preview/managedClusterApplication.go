...
func NewManagedClusterApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20230701preview:ManagedClusterApplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterApplication(ctx *pulumi.Context,
	...
	var resource ManagedClusterApplication
	err := ctx.ReadResource("azure-native:servicefabric/v20230701preview:ManagedClusterApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
