...
func NewManagedClusterService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20241101preview:ManagedClusterService"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20230701preview:ManagedClusterService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterService(ctx *pulumi.Context,
	...
	var resource ManagedClusterService
	err := ctx.ReadResource("azure-native:servicefabric/v20230701preview:ManagedClusterService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
