...
func NewManagedCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20251001preview:ManagedCluster"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260201:ManagedCluster"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260501preview:ManagedCluster"),
		},
	})
