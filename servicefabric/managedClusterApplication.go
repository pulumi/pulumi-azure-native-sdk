...
func NewManagedClusterApplication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20250301preview:ManagedClusterApplication"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20250601preview:ManagedClusterApplication"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20251001preview:ManagedClusterApplication"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260201:ManagedClusterApplication"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260501preview:ManagedClusterApplication"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ManagedClusterApplication
	err := ctx.RegisterResource("azure-native:servicefabric:ManagedClusterApplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterApplication(ctx *pulumi.Context,
	...
	var resource ManagedClusterApplication
	err := ctx.ReadResource("azure-native:servicefabric:ManagedClusterApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
