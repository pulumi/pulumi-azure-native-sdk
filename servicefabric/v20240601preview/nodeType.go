...
type NodeType struct {
	...
	ComputerNamePrefix pulumi.StringPtrOutput `pulumi:"computerNamePrefix"`
	...
	VmApplications VmApplicationResponseArrayOutput `pulumi:"vmApplications"`
...
func NewNodeType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20231101preview:NodeType"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20241101preview:NodeType"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20240601preview:NodeType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeType(ctx *pulumi.Context,
	...
	var resource NodeType
	err := ctx.ReadResource("azure-native:servicefabric/v20240601preview:NodeType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type nodeTypeArgs struct {
	...
	// Specifies the NAT configuration on default public Load Balancer for the node type. This is only supported for node types use the default public Load Balancer.
	NatConfigurations []NodeTypeNatConfig `pulumi:"natConfigurations"`
	// Specifies the resource id of a NAT Gateway to attach to the subnet of this node type. Node type must use custom load balancer.
	...
	// Specifies the gallery applications that should be made available to the underlying VMSS.
	VmApplications []VmApplication `pulumi:"vmApplications"`
	// Set of extensions that should be installed onto the virtual machines.
...
type NodeTypeArgs struct {
	...
	// Specifies the NAT configuration on default public Load Balancer for the node type. This is only supported for node types use the default public Load Balancer.
	NatConfigurations NodeTypeNatConfigArrayInput
	// Specifies the resource id of a NAT Gateway to attach to the subnet of this node type. Node type must use custom load balancer.
	...
	// Specifies the gallery applications that should be made available to the underlying VMSS.
	VmApplications VmApplicationArrayInput
	// Set of extensions that should be installed onto the virtual machines.
...
// Specifies the computer name prefix. Limited to 9 characters. If specified, allows for a longer name to be specified for the node type name.
func (o NodeTypeOutput) ComputerNamePrefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NodeType) pulumi.StringPtrOutput { return v.ComputerNamePrefix }).(pulumi.StringPtrOutput)
}
...
// Specifies the NAT configuration on default public Load Balancer for the node type. This is only supported for node types use the default public Load Balancer.
func (o NodeTypeOutput) NatConfigurations() NodeTypeNatConfigResponseArrayOutput {
	return o.ApplyT(func(v *NodeType) NodeTypeNatConfigResponseArrayOutput { return v.NatConfigurations }).(NodeTypeNatConfigResponseArrayOutput)
}
...
// Specifies the gallery applications that should be made available to the underlying VMSS.
func (o NodeTypeOutput) VmApplications() VmApplicationResponseArrayOutput {
	return o.ApplyT(func(v *NodeType) VmApplicationResponseArrayOutput { return v.VmApplications }).(VmApplicationResponseArrayOutput)
}
