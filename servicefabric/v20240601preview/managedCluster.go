...
type ManagedCluster struct {
	...
	CustomFqdn pulumi.StringPtrOutput `pulumi:"customFqdn"`
...
func NewManagedCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20240601preview:ManagedCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedCluster(ctx *pulumi.Context,
	...
	var resource ManagedCluster
	err := ctx.ReadResource("azure-native:servicefabric/v20240601preview:ManagedCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ManagedClusterArgs struct {
	...
	// If using autoGeneratedDomainNameLabelScope, this is the fully qualified domain name using SFMC's domain, pointing to the public load balancer of the cluster.
	CustomFqdn pulumi.StringPtrInput
	// Specify the resource id of a DDoS network protection plan that will be associated with the virtual network of the cluster.
...
// If using autoGeneratedDomainNameLabelScope, this is the fully qualified domain name using SFMC's domain, pointing to the public load balancer of the cluster.
func (o ManagedClusterOutput) CustomFqdn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ManagedCluster) pulumi.StringPtrOutput { return v.CustomFqdn }).(pulumi.StringPtrOutput)
}
