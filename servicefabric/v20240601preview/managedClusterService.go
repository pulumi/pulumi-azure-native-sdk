...
func NewManagedClusterService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20240601preview:ManagedClusterService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterService(ctx *pulumi.Context,
	...
	var resource ManagedClusterService
	err := ctx.ReadResource("azure-native:servicefabric/v20240601preview:ManagedClusterService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
