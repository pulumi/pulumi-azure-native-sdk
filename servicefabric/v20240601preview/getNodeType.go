...
func LookupNodeType(ctx *pulumi.Context, args *LookupNodeTypeArgs, opts ...pulumi.InvokeOption) (*LookupNodeTypeResult, error) {
	...
	err := ctx.Invoke("azure-native:servicefabric/v20240601preview:getNodeType", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupNodeTypeResult struct {
	...
	VmApplications []VmApplicationResponse `pulumi:"vmApplications"`
...
func LookupNodeTypeOutput(ctx *pulumi.Context, args LookupNodeTypeOutputArgs, opts ...pulumi.InvokeOption) LookupNodeTypeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNodeTypeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicefabric/v20240601preview:getNodeType", args, LookupNodeTypeResultOutput{}, options).(LookupNodeTypeResultOutput), nil
...
// Specifies the gallery applications that should be made available to the underlying VMSS.
func (o LookupNodeTypeResultOutput) VmApplications() VmApplicationResponseArrayOutput {
	return o.ApplyT(func(v LookupNodeTypeResult) []VmApplicationResponse { return v.VmApplications }).(VmApplicationResponseArrayOutput)
}
