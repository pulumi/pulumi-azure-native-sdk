...
//
// Deprecated: azure-native:servicefabric/v20211101preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20220101:ManagedCluster to guarantee forwards compatibility.
func LookupManagedCluster(ctx *pulumi.Context, args *LookupManagedClusterArgs, opts ...pulumi.InvokeOption) (*LookupManagedClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:servicefabric/v20211101preview:getManagedCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
