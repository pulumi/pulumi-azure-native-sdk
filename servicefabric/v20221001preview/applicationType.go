...
//
// Deprecated: azure-native:servicefabric/v20221001preview:ApplicationType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:ApplicationType to guarantee forwards compatibility.
...
func NewApplicationType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20221001preview:ApplicationType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationType(ctx *pulumi.Context,
	...
	var resource ApplicationType
	err := ctx.ReadResource("azure-native:servicefabric/v20221001preview:ApplicationType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
