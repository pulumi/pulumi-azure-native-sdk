...
func NewManagedClusterApplicationType(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20250301preview:ManagedClusterApplicationType"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20250601preview:ManagedClusterApplicationType"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20251001preview:ManagedClusterApplicationType"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260201:ManagedClusterApplicationType"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260501preview:ManagedClusterApplicationType"),
		},
	})
