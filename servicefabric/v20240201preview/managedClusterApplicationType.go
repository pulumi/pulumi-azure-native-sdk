...
func NewManagedClusterApplicationType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20240201preview:ManagedClusterApplicationType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterApplicationType(ctx *pulumi.Context,
	...
	var resource ManagedClusterApplicationType
	err := ctx.ReadResource("azure-native:servicefabric/v20240201preview:ManagedClusterApplicationType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
