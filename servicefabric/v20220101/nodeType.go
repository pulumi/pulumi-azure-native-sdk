...
func NewNodeType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20220101:NodeType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeType(ctx *pulumi.Context,
	...
	var resource NodeType
	err := ctx.ReadResource("azure-native:servicefabric/v20220101:NodeType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
