...
// azure-native:servicefabric/v20190301:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20201201preview:Cluster to guarantee forwards compatibility.
type Cluster struct {
...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20190301:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azure-native:servicefabric/v20190301:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
