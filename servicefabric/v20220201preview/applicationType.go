...
func NewApplicationType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20220201preview:ApplicationType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationType(ctx *pulumi.Context,
	...
	var resource ApplicationType
	err := ctx.ReadResource("azure-native:servicefabric/v20220201preview:ApplicationType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
