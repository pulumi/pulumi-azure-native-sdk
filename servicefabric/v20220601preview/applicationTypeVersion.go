...
//
// Deprecated: azure-native:servicefabric/v20220601preview:ApplicationTypeVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:ApplicationTypeVersion to guarantee forwards compatibility.
...
func NewApplicationTypeVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20220601preview:ApplicationTypeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationTypeVersion(ctx *pulumi.Context,
	...
	var resource ApplicationTypeVersion
	err := ctx.ReadResource("azure-native:servicefabric/v20220601preview:ApplicationTypeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
