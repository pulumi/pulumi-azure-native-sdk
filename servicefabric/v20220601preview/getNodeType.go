...
//
// Deprecated: azure-native:servicefabric/v20220601preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:NodeType to guarantee forwards compatibility.
func LookupNodeType(ctx *pulumi.Context, args *LookupNodeTypeArgs, opts ...pulumi.InvokeOption) (*LookupNodeTypeResult, error) {
	...
	err := ctx.Invoke("azure-native:servicefabric/v20220601preview:getNodeType", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
