...
//
// Deprecated: azure-native:servicefabric/v20220601preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230301preview:NodeType to guarantee forwards compatibility.
