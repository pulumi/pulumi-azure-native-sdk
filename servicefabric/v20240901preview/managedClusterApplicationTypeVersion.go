...
func NewManagedClusterApplicationTypeVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20240901preview:ManagedClusterApplicationTypeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterApplicationTypeVersion(ctx *pulumi.Context,
	...
	var resource ManagedClusterApplicationTypeVersion
	err := ctx.ReadResource("azure-native:servicefabric/v20240901preview:ManagedClusterApplicationTypeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
