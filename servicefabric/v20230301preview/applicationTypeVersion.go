...
func NewApplicationTypeVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20230301preview:ApplicationTypeVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationTypeVersion(ctx *pulumi.Context,
	...
	var resource ApplicationTypeVersion
	err := ctx.ReadResource("azure-native:servicefabric/v20230301preview:ApplicationTypeVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
