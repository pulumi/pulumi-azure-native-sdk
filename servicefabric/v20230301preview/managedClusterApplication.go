...
func NewManagedClusterApplication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20241101preview:ManagedClusterApplication"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:servicefabric/v20230301preview:ManagedClusterApplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterApplication(ctx *pulumi.Context,
	...
	var resource ManagedClusterApplication
	err := ctx.ReadResource("azure-native:servicefabric/v20230301preview:ManagedClusterApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
