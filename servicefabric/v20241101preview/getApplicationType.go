...
func LookupApplicationType(ctx *pulumi.Context, args *LookupApplicationTypeArgs, opts ...pulumi.InvokeOption) (*LookupApplicationTypeResult, error) {
	...
	err := ctx.Invoke("azure-native:servicefabric/v20241101preview:getApplicationType", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApplicationTypeOutput(ctx *pulumi.Context, args LookupApplicationTypeOutputArgs, opts ...pulumi.InvokeOption) LookupApplicationTypeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApplicationTypeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicefabric/v20241101preview:getApplicationType", args, LookupApplicationTypeResultOutput{}, options).(LookupApplicationTypeResultOutput), nil
