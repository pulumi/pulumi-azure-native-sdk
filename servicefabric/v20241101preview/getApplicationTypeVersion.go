...
func LookupApplicationTypeVersion(ctx *pulumi.Context, args *LookupApplicationTypeVersionArgs, opts ...pulumi.InvokeOption) (*LookupApplicationTypeVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:servicefabric/v20241101preview:getApplicationTypeVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApplicationTypeVersionOutput(ctx *pulumi.Context, args LookupApplicationTypeVersionOutputArgs, opts ...pulumi.InvokeOption) LookupApplicationTypeVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApplicationTypeVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicefabric/v20241101preview:getApplicationTypeVersion", args, LookupApplicationTypeVersionResultOutput{}, options).(LookupApplicationTypeVersionResultOutput), nil
