...
func LookupManagedClusterApplicationType(ctx *pulumi.Context, args *LookupManagedClusterApplicationTypeArgs, opts ...pulumi.InvokeOption) (*LookupManagedClusterApplicationTypeResult, error) {
	...
	err := ctx.Invoke("azure-native:servicefabric/v20241101preview:getManagedClusterApplicationType", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedClusterApplicationTypeOutput(ctx *pulumi.Context, args LookupManagedClusterApplicationTypeOutputArgs, opts ...pulumi.InvokeOption) LookupManagedClusterApplicationTypeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedClusterApplicationTypeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicefabric/v20241101preview:getManagedClusterApplicationType", args, LookupManagedClusterApplicationTypeResultOutput{}, options).(LookupManagedClusterApplicationTypeResultOutput), nil
