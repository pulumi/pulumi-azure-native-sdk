...
func NewManagedClusterService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicefabric/v20250301preview:ManagedClusterService"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20250601preview:ManagedClusterService"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20251001preview:ManagedClusterService"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260201:ManagedClusterService"),
		},
		{
			Type: pulumi.String("azure-native:servicefabric/v20260501preview:ManagedClusterService"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ManagedClusterService
	err := ctx.RegisterResource("azure-native:servicefabric:ManagedClusterService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedClusterService(ctx *pulumi.Context,
	...
	var resource ManagedClusterService
	err := ctx.ReadResource("azure-native:servicefabric:ManagedClusterService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ManagedClusterServiceOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagedClusterService) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
