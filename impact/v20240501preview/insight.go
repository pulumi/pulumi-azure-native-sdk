...
func NewInsight(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:impact:Insight"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Insight
	err := ctx.RegisterResource("azure-native:impact/v20240501preview:Insight", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInsight(ctx *pulumi.Context,
	...
	var resource Insight
	err := ctx.ReadResource("azure-native:impact/v20240501preview:Insight", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
