...
func LookupAppServiceCertificateOrderCertificate(ctx *pulumi.Context, args *LookupAppServiceCertificateOrderCertificateArgs, opts ...pulumi.InvokeOption) (*LookupAppServiceCertificateOrderCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:certificateregistration/v20220901:getAppServiceCertificateOrderCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAppServiceCertificateOrderCertificateOutput(ctx *pulumi.Context, args LookupAppServiceCertificateOrderCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupAppServiceCertificateOrderCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAppServiceCertificateOrderCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:certificateregistration/v20220901:getAppServiceCertificateOrderCertificate", args, LookupAppServiceCertificateOrderCertificateResultOutput{}, options).(LookupAppServiceCertificateOrderCertificateResultOutput), nil
