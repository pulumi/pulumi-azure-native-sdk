...
func NewAppServiceCertificateOrderCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:certificateregistration/v20230101:AppServiceCertificateOrderCertificate"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AppServiceCertificateOrderCertificate
	err := ctx.RegisterResource("azure-native:certificateregistration/v20220901:AppServiceCertificateOrderCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceCertificateOrderCertificate(ctx *pulumi.Context,
	...
	var resource AppServiceCertificateOrderCertificate
	err := ctx.ReadResource("azure-native:certificateregistration/v20220901:AppServiceCertificateOrderCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *AppServiceCertificateOrderCertificate) ToOutput(ctx context.Context) pulumix.Output[*AppServiceCertificateOrderCertificate] {
	return pulumix.Output[*AppServiceCertificateOrderCertificate]{
		OutputState: i.ToAppServiceCertificateOrderCertificateOutputWithContext(ctx).OutputState,
	}
}
...
func (o AppServiceCertificateOrderCertificateOutput) ToOutput(ctx context.Context) pulumix.Output[*AppServiceCertificateOrderCertificate] {
	return pulumix.Output[*AppServiceCertificateOrderCertificate]{
