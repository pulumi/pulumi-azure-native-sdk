...
//
// Deprecated: azure-native:certificateregistration/v20210101:AppServiceCertificateOrder is being removed in the next major version of this provider. Upgrade to at least azure-native:certificateregistration/v20220901:AppServiceCertificateOrder to guarantee forwards compatibility.
...
func NewAppServiceCertificateOrder(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:certificateregistration/v20220901:AppServiceCertificateOrder"),
		},
	})
	opts = append(opts, aliases)
	var resource AppServiceCertificateOrder
	err := ctx.RegisterResource("azure-native:certificateregistration/v20210101:AppServiceCertificateOrder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceCertificateOrder(ctx *pulumi.Context,
	...
	var resource AppServiceCertificateOrder
	err := ctx.ReadResource("azure-native:certificateregistration/v20210101:AppServiceCertificateOrder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
