...
//
// Deprecated: azure-native:certificateregistration/v20220301:AppServiceCertificateOrder is being removed in the next major version of this provider. Upgrade to at least azure-native:certificateregistration/v20220901:AppServiceCertificateOrder to guarantee forwards compatibility.
func LookupAppServiceCertificateOrder(ctx *pulumi.Context, args *LookupAppServiceCertificateOrderArgs, opts ...pulumi.InvokeOption) (*LookupAppServiceCertificateOrderResult, error) {
	...
	err := ctx.Invoke("azure-native:certificateregistration/v20220301:getAppServiceCertificateOrder", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
