...
func NewAppServiceCertificateOrderCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:certificateregistration/v20190801:AppServiceCertificateOrderCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceCertificateOrderCertificate(ctx *pulumi.Context,
	...
	var resource AppServiceCertificateOrderCertificate
	err := ctx.ReadResource("azure-native:certificateregistration/v20190801:AppServiceCertificateOrderCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
