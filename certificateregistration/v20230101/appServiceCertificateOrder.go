...
func NewAppServiceCertificateOrder(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:certificateregistration/v20230101:AppServiceCertificateOrder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceCertificateOrder(ctx *pulumi.Context,
	...
	var resource AppServiceCertificateOrder
	err := ctx.ReadResource("azure-native:certificateregistration/v20230101:AppServiceCertificateOrder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
