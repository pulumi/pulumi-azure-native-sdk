...
// azure-native:certificateregistration/v20180201:AppServiceCertificateOrder is being removed in the next major version of this provider. Upgrade to at least azure-native:certificateregistration/v20201001:AppServiceCertificateOrder to guarantee forwards compatibility.
...
func NewAppServiceCertificateOrder(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:certificateregistration/v20180201:AppServiceCertificateOrder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceCertificateOrder(ctx *pulumi.Context,
	...
	var resource AppServiceCertificateOrder
	err := ctx.ReadResource("azure-native:certificateregistration/v20180201:AppServiceCertificateOrder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
