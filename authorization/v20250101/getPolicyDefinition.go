...
func LookupPolicyDefinition(ctx *pulumi.Context, args *LookupPolicyDefinitionArgs, opts ...pulumi.InvokeOption) (*LookupPolicyDefinitionResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20250101:getPolicyDefinition", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupPolicyDefinitionOutput(ctx *pulumi.Context, args LookupPolicyDefinitionOutputArgs, opts ...pulumi.InvokeOption) LookupPolicyDefinitionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPolicyDefinitionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20250101:getPolicyDefinition", args, LookupPolicyDefinitionResultOutput{}, options).(LookupPolicyDefinitionResultOutput), nil
...
func (o LookupPolicyDefinitionResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPolicyDefinitionResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
