...
func NewPolicyDefinitionVersionAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20250101:PolicyDefinitionVersionAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinitionVersionAtManagementGroup(ctx *pulumi.Context,
	...
	var resource PolicyDefinitionVersionAtManagementGroup
	err := ctx.ReadResource("azure-native:authorization/v20250101:PolicyDefinitionVersionAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
