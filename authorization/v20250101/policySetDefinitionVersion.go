...
func NewPolicySetDefinitionVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20250101:PolicySetDefinitionVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinitionVersion(ctx *pulumi.Context,
	...
	var resource PolicySetDefinitionVersion
	err := ctx.ReadResource("azure-native:authorization/v20250101:PolicySetDefinitionVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
