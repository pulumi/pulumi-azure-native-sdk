...
func ListPolicySetDefinitionVersionAllAtManagementGroup(ctx *pulumi.Context, args *ListPolicySetDefinitionVersionAllAtManagementGroupArgs, opts ...pulumi.InvokeOption) (*ListPolicySetDefinitionVersionAllAtManagementGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20230401:listPolicySetDefinitionVersionAllAtManagementGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListPolicySetDefinitionVersionAllAtManagementGroupOutput(ctx *pulumi.Context, args ListPolicySetDefinitionVersionAllAtManagementGroupOutputArgs, opts ...pulumi.InvokeOption) ListPolicySetDefinitionVersionAllAtManagementGroupResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (ListPolicySetDefinitionVersionAllAtManagementGroupResult, error) {
			args := v.(ListPolicySetDefinitionVersionAllAtManagementGroupArgs)
			r, err := ListPolicySetDefinitionVersionAllAtManagementGroup(ctx, &args, opts...)
			var s ListPolicySetDefinitionVersionAllAtManagementGroupResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o ListPolicySetDefinitionVersionAllAtManagementGroupResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListPolicySetDefinitionVersionAllAtManagementGroupResult] {
	return pulumix.Output[ListPolicySetDefinitionVersionAllAtManagementGroupResult]{
