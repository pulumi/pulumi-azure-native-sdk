...
func NewPolicyDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20230401:PolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinition(ctx *pulumi.Context,
	...
	var resource PolicyDefinition
	err := ctx.ReadResource("azure-native:authorization/v20230401:PolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *PolicyDefinition) ToOutput(ctx context.Context) pulumix.Output[*PolicyDefinition] {
	return pulumix.Output[*PolicyDefinition]{
		OutputState: i.ToPolicyDefinitionOutputWithContext(ctx).OutputState,
	}
}
...
func (o PolicyDefinitionOutput) ToOutput(ctx context.Context) pulumix.Output[*PolicyDefinition] {
	return pulumix.Output[*PolicyDefinition]{
