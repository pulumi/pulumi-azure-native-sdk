...
func (o ListPolicySetDefinitionVersionAllResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListPolicySetDefinitionVersionAllResult] {
	return pulumix.Output[ListPolicySetDefinitionVersionAllResult]{
