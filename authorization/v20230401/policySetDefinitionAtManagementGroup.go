...
func NewPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20230401:PolicySetDefinitionAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	var resource PolicySetDefinitionAtManagementGroup
	err := ctx.ReadResource("azure-native:authorization/v20230401:PolicySetDefinitionAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *PolicySetDefinitionAtManagementGroup) ToOutput(ctx context.Context) pulumix.Output[*PolicySetDefinitionAtManagementGroup] {
	return pulumix.Output[*PolicySetDefinitionAtManagementGroup]{
		OutputState: i.ToPolicySetDefinitionAtManagementGroupOutputWithContext(ctx).OutputState,
	}
}
...
func (o PolicySetDefinitionAtManagementGroupOutput) ToOutput(ctx context.Context) pulumix.Output[*PolicySetDefinitionAtManagementGroup] {
	return pulumix.Output[*PolicySetDefinitionAtManagementGroup]{
