...
func NewRoleDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20220501preview:RoleDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleDefinition(ctx *pulumi.Context,
	...
	var resource RoleDefinition
	err := ctx.ReadResource("azure-native:authorization/v20220501preview:RoleDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
