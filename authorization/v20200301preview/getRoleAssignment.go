...
func LookupRoleAssignment(ctx *pulumi.Context, args *LookupRoleAssignmentArgs, opts ...pulumi.InvokeOption) (*LookupRoleAssignmentResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20200301preview:getRoleAssignment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupRoleAssignmentOutput(ctx *pulumi.Context, args LookupRoleAssignmentOutputArgs, opts ...pulumi.InvokeOption) LookupRoleAssignmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRoleAssignmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20200301preview:getRoleAssignment", args, LookupRoleAssignmentResultOutput{}, options).(LookupRoleAssignmentResultOutput), nil
