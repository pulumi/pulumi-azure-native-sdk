...
func LookupPolicyDefinitionVersion(ctx *pulumi.Context, args *LookupPolicyDefinitionVersionArgs, opts ...pulumi.InvokeOption) (*LookupPolicyDefinitionVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20250301:getPolicyDefinitionVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupPolicyDefinitionVersionOutput(ctx *pulumi.Context, args LookupPolicyDefinitionVersionOutputArgs, opts ...pulumi.InvokeOption) LookupPolicyDefinitionVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPolicyDefinitionVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20250301:getPolicyDefinitionVersion", args, LookupPolicyDefinitionVersionResultOutput{}, options).(LookupPolicyDefinitionVersionResultOutput), nil
...
// The details of the source of external evaluation results required by the policy during enforcement evaluation.
func (o LookupPolicyDefinitionVersionResultOutput) ExternalEvaluationEnforcementSettings() ExternalEvaluationEnforcementSettingsResponsePtrOutput {
	return o.ApplyT(func(v LookupPolicyDefinitionVersionResult) *ExternalEvaluationEnforcementSettingsResponse {
