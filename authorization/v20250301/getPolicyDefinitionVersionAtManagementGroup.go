...
func LookupPolicyDefinitionVersionAtManagementGroup(ctx *pulumi.Context, args *LookupPolicyDefinitionVersionAtManagementGroupArgs, opts ...pulumi.InvokeOption) (*LookupPolicyDefinitionVersionAtManagementGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20250301:getPolicyDefinitionVersionAtManagementGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupPolicyDefinitionVersionAtManagementGroupResult struct {
	...
	ExternalEvaluationEnforcementSettings *ExternalEvaluationEnforcementSettingsResponse `pulumi:"externalEvaluationEnforcementSettings"`
	// The ID of the policy definition version.
	Id string `pulumi:"id"`
...
func LookupPolicyDefinitionVersionAtManagementGroupOutput(ctx *pulumi.Context, args LookupPolicyDefinitionVersionAtManagementGroupOutputArgs, opts ...pulumi.InvokeOption) LookupPolicyDefinitionVersionAtManagementGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPolicyDefinitionVersionAtManagementGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20250301:getPolicyDefinitionVersionAtManagementGroup", args, LookupPolicyDefinitionVersionAtManagementGroupResultOutput{}, options).(LookupPolicyDefinitionVersionAtManagementGroupResultOutput), nil
...
// The details of the source of external evaluation results required by the policy during enforcement evaluation.
func (o LookupPolicyDefinitionVersionAtManagementGroupResultOutput) ExternalEvaluationEnforcementSettings() ExternalEvaluationEnforcementSettingsResponsePtrOutput {
	return o.ApplyT(func(v LookupPolicyDefinitionVersionAtManagementGroupResult) *ExternalEvaluationEnforcementSettingsResponse {
