...
func NewPolicyAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20250301:PolicyAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyAssignment(ctx *pulumi.Context,
	...
	var resource PolicyAssignment
	err := ctx.ReadResource("azure-native:authorization/v20250301:PolicyAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
