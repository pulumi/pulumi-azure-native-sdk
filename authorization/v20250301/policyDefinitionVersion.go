...
type PolicyDefinitionVersion struct {
	...
	ExternalEvaluationEnforcementSettings ExternalEvaluationEnforcementSettingsResponsePtrOutput `pulumi:"externalEvaluationEnforcementSettings"`
...
func NewPolicyDefinitionVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization:PolicyDefinitionVersion"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PolicyDefinitionVersion
	err := ctx.RegisterResource("azure-native:authorization/v20250301:PolicyDefinitionVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinitionVersion(ctx *pulumi.Context,
	...
	var resource PolicyDefinitionVersion
	err := ctx.ReadResource("azure-native:authorization/v20250301:PolicyDefinitionVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type policyDefinitionVersionArgs struct {
	...
	// The details of the source of external evaluation results required by the policy during enforcement evaluation.
	ExternalEvaluationEnforcementSettings *ExternalEvaluationEnforcementSettings `pulumi:"externalEvaluationEnforcementSettings"`
	// The policy definition metadata.  Metadata is an open ended object and is typically a collection of key value pairs.
...
type PolicyDefinitionVersionArgs struct {
	...
	// The details of the source of external evaluation results required by the policy during enforcement evaluation.
	ExternalEvaluationEnforcementSettings ExternalEvaluationEnforcementSettingsPtrInput
	// The policy definition metadata.  Metadata is an open ended object and is typically a collection of key value pairs.
...
// The details of the source of external evaluation results required by the policy during enforcement evaluation.
func (o PolicyDefinitionVersionOutput) ExternalEvaluationEnforcementSettings() ExternalEvaluationEnforcementSettingsResponsePtrOutput {
	return o.ApplyT(func(v *PolicyDefinitionVersion) ExternalEvaluationEnforcementSettingsResponsePtrOutput {
		return v.ExternalEvaluationEnforcementSettings
	}).(ExternalEvaluationEnforcementSettingsResponsePtrOutput)
}
