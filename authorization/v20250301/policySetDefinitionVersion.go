...
func NewPolicySetDefinitionVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization:PolicySetDefinitionVersion"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PolicySetDefinitionVersion
	err := ctx.RegisterResource("azure-native:authorization/v20250301:PolicySetDefinitionVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinitionVersion(ctx *pulumi.Context,
	...
	var resource PolicySetDefinitionVersion
	err := ctx.ReadResource("azure-native:authorization/v20250301:PolicySetDefinitionVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
