...
func ListPolicySetDefinitionVersionAllBuiltins(ctx *pulumi.Context, args *ListPolicySetDefinitionVersionAllBuiltinsArgs, opts ...pulumi.InvokeOption) (*ListPolicySetDefinitionVersionAllBuiltinsResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20250301:listPolicySetDefinitionVersionAllBuiltins", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListPolicySetDefinitionVersionAllBuiltinsOutput(ctx *pulumi.Context, args ListPolicySetDefinitionVersionAllBuiltinsOutputArgs, opts ...pulumi.InvokeOption) ListPolicySetDefinitionVersionAllBuiltinsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListPolicySetDefinitionVersionAllBuiltinsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20250301:listPolicySetDefinitionVersionAllBuiltins", args, ListPolicySetDefinitionVersionAllBuiltinsResultOutput{}, options).(ListPolicySetDefinitionVersionAllBuiltinsResultOutput), nil
