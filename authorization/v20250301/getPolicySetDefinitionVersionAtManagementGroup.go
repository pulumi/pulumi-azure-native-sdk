...
func LookupPolicySetDefinitionVersionAtManagementGroup(ctx *pulumi.Context, args *LookupPolicySetDefinitionVersionAtManagementGroupArgs, opts ...pulumi.InvokeOption) (*LookupPolicySetDefinitionVersionAtManagementGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20250301:getPolicySetDefinitionVersionAtManagementGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPolicySetDefinitionVersionAtManagementGroupOutput(ctx *pulumi.Context, args LookupPolicySetDefinitionVersionAtManagementGroupOutputArgs, opts ...pulumi.InvokeOption) LookupPolicySetDefinitionVersionAtManagementGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPolicySetDefinitionVersionAtManagementGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20250301:getPolicySetDefinitionVersionAtManagementGroup", args, LookupPolicySetDefinitionVersionAtManagementGroupResultOutput{}, options).(LookupPolicySetDefinitionVersionAtManagementGroupResultOutput), nil
...
func (LookupPolicySetDefinitionVersionAtManagementGroupOutputArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupPolicySetDefinitionVersionAtManagementGroupArgs)(nil)).Elem()
}
...
func (LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupPolicySetDefinitionVersionAtManagementGroupResult)(nil)).Elem()
}
...
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) *string { return v.Description }).(pulumi.StringPtrOutput)
}

// The display name of the policy set definition.
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}

// The ID of the policy set definition version.
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) string { return v.Id }).(pulumi.StringOutput)
}

// The policy set definition metadata.  Metadata is an open ended object and is typically a collection of key value pairs.
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) Metadata() pulumi.AnyOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) interface{} { return v.Metadata }).(pulumi.AnyOutput)
}

// The name of the policy set definition version.
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) string { return v.Name }).(pulumi.StringOutput)
}
...
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) Parameters() ParameterDefinitionsValueResponseMapOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) map[string]ParameterDefinitionsValueResponse {
		return v.Parameters
...
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) PolicyDefinitionGroups() PolicyDefinitionGroupResponseArrayOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) []PolicyDefinitionGroupResponse {
...
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) PolicyDefinitions() PolicyDefinitionReferenceResponseArrayOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) []PolicyDefinitionReferenceResponse {
...
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) PolicyType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) *string { return v.PolicyType }).(pulumi.StringPtrOutput)
}

// The system metadata relating to this resource.
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) SystemDataResponse {
		return v.SystemData
...
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) string { return v.Type }).(pulumi.StringOutput)
}

// The policy set definition version in #.#.# format.
func (o LookupPolicySetDefinitionVersionAtManagementGroupResultOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupPolicySetDefinitionVersionAtManagementGroupResult) *string { return v.Version }).(pulumi.StringPtrOutput)
}

func init() {
	pulumi.RegisterOutputType(LookupPolicySetDefinitionVersionAtManagementGroupResultOutput{})
}
