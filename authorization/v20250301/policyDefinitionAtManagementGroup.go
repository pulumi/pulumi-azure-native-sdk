...
func NewPolicyDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20250301:PolicyDefinitionAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	var resource PolicyDefinitionAtManagementGroup
	err := ctx.ReadResource("azure-native:authorization/v20250301:PolicyDefinitionAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The details of the source of external evaluation results required by the policy during enforcement evaluation.
func (o PolicyDefinitionAtManagementGroupOutput) ExternalEvaluationEnforcementSettings() ExternalEvaluationEnforcementSettingsResponsePtrOutput {
	return o.ApplyT(func(v *PolicyDefinitionAtManagementGroup) ExternalEvaluationEnforcementSettingsResponsePtrOutput {
