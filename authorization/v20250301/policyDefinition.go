...
func NewPolicyDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20250301:PolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinition(ctx *pulumi.Context,
	...
	var resource PolicyDefinition
	err := ctx.ReadResource("azure-native:authorization/v20250301:PolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The details of the source of external evaluation results required by the policy during enforcement evaluation.
func (o PolicyDefinitionOutput) ExternalEvaluationEnforcementSettings() ExternalEvaluationEnforcementSettingsResponsePtrOutput {
	return o.ApplyT(func(v *PolicyDefinition) ExternalEvaluationEnforcementSettingsResponsePtrOutput {
