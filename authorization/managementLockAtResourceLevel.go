...
// The Azure API version of the resource.
func (o ManagementLockAtResourceLevelOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagementLockAtResourceLevel) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
