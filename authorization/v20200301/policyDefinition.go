...
//
// Deprecated: azure-native:authorization/v20200301:PolicyDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20210601:PolicyDefinition to guarantee forwards compatibility.
...
func NewPolicyDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20200301:PolicyDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinition(ctx *pulumi.Context,
	...
	var resource PolicyDefinition
	err := ctx.ReadResource("azure-native:authorization/v20200301:PolicyDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
