...
func LookupVariableValue(ctx *pulumi.Context, args *LookupVariableValueArgs, opts ...pulumi.InvokeOption) (*LookupVariableValueResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20241201preview:getVariableValue", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVariableValueOutput(ctx *pulumi.Context, args LookupVariableValueOutputArgs, opts ...pulumi.InvokeOption) LookupVariableValueResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVariableValueResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20241201preview:getVariableValue", args, LookupVariableValueResultOutput{}, options).(LookupVariableValueResultOutput), nil
