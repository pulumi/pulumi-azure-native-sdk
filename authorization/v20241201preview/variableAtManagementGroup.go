...
func NewVariableAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20241201preview:VariableAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVariableAtManagementGroup(ctx *pulumi.Context,
	...
	var resource VariableAtManagementGroup
	err := ctx.ReadResource("azure-native:authorization/v20241201preview:VariableAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
