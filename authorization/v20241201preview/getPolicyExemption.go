...
func LookupPolicyExemption(ctx *pulumi.Context, args *LookupPolicyExemptionArgs, opts ...pulumi.InvokeOption) (*LookupPolicyExemptionResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20241201preview:getPolicyExemption", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupPolicyExemptionOutput(ctx *pulumi.Context, args LookupPolicyExemptionOutputArgs, opts ...pulumi.InvokeOption) LookupPolicyExemptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPolicyExemptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20241201preview:getPolicyExemption", args, LookupPolicyExemptionResultOutput{}, options).(LookupPolicyExemptionResultOutput), nil
