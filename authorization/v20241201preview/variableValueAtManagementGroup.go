...
func NewVariableValueAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20241201preview:VariableValueAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVariableValueAtManagementGroup(ctx *pulumi.Context,
	...
	var resource VariableValueAtManagementGroup
	err := ctx.ReadResource("azure-native:authorization/v20241201preview:VariableValueAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
