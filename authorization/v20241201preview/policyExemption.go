...
func NewPolicyExemption(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20241201preview:PolicyExemption", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyExemption(ctx *pulumi.Context,
	...
	var resource PolicyExemption
	err := ctx.ReadResource("azure-native:authorization/v20241201preview:PolicyExemption", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
