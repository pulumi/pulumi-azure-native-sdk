...
func NewVariableValue(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization:VariableValue"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VariableValue
	err := ctx.RegisterResource("azure-native:authorization/v20241201preview:VariableValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVariableValue(ctx *pulumi.Context,
	...
	var resource VariableValue
	err := ctx.ReadResource("azure-native:authorization/v20241201preview:VariableValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
