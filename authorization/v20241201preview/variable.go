...
func NewVariable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20241201preview:Variable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVariable(ctx *pulumi.Context,
	...
	var resource Variable
	err := ctx.ReadResource("azure-native:authorization/v20241201preview:Variable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
