...
func NewManagementLockAtResourceLevel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20160901:ManagementLockAtResourceLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockAtResourceLevel(ctx *pulumi.Context,
	...
	var resource ManagementLockAtResourceLevel
	err := ctx.ReadResource("azure-native:authorization/v20160901:ManagementLockAtResourceLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
