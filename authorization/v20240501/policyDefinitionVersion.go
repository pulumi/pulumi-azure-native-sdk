...
func NewPolicyDefinitionVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20240501:PolicyDefinitionVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyDefinitionVersion(ctx *pulumi.Context,
	...
	var resource PolicyDefinitionVersion
	err := ctx.ReadResource("azure-native:authorization/v20240501:PolicyDefinitionVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
