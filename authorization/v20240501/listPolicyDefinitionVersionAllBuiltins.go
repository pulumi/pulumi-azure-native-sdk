...
func ListPolicyDefinitionVersionAllBuiltins(ctx *pulumi.Context, args *ListPolicyDefinitionVersionAllBuiltinsArgs, opts ...pulumi.InvokeOption) (*ListPolicyDefinitionVersionAllBuiltinsResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20240501:listPolicyDefinitionVersionAllBuiltins", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListPolicyDefinitionVersionAllBuiltinsOutput(ctx *pulumi.Context, args ListPolicyDefinitionVersionAllBuiltinsOutputArgs, opts ...pulumi.InvokeOption) ListPolicyDefinitionVersionAllBuiltinsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListPolicyDefinitionVersionAllBuiltinsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20240501:listPolicyDefinitionVersionAllBuiltins", args, ListPolicyDefinitionVersionAllBuiltinsResultOutput{}, options).(ListPolicyDefinitionVersionAllBuiltinsResultOutput), nil
