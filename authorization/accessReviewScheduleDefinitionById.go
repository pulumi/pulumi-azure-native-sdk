...
// The Azure API version of the resource.
func (o AccessReviewScheduleDefinitionByIdOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AccessReviewScheduleDefinitionById) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Access Review schedule definition recurrence range.
func (o AccessReviewScheduleDefinitionByIdOutput) Range() AccessReviewRecurrenceRangeResponsePtrOutput {
	return o.ApplyT(func(v *AccessReviewScheduleDefinitionById) AccessReviewRecurrenceRangeResponsePtrOutput {
		return v.Range
...
// This is used to define what to include in scope of the review. The scope definition includes the resourceId and roleDefinitionId.
func (o AccessReviewScheduleDefinitionByIdOutput) Scope() AccessReviewScopeResponseOutput {
	return o.ApplyT(func(v *AccessReviewScheduleDefinitionById) AccessReviewScopeResponseOutput { return v.Scope }).(AccessReviewScopeResponseOutput)
}
