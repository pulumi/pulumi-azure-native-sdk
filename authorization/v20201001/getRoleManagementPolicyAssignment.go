...
func LookupRoleManagementPolicyAssignment(ctx *pulumi.Context, args *LookupRoleManagementPolicyAssignmentArgs, opts ...pulumi.InvokeOption) (*LookupRoleManagementPolicyAssignmentResult, error) {
	...
	err := ctx.Invoke("azure-native:authorization/v20201001:getRoleManagementPolicyAssignment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRoleManagementPolicyAssignmentOutput(ctx *pulumi.Context, args LookupRoleManagementPolicyAssignmentOutputArgs, opts ...pulumi.InvokeOption) LookupRoleManagementPolicyAssignmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRoleManagementPolicyAssignmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization/v20201001:getRoleManagementPolicyAssignment", args, LookupRoleManagementPolicyAssignmentResultOutput{}, options).(LookupRoleManagementPolicyAssignmentResultOutput), nil
