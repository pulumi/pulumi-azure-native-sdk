...
func NewRoleManagementPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20201001:RoleManagementPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleManagementPolicy(ctx *pulumi.Context,
	...
	var resource RoleManagementPolicy
	err := ctx.ReadResource("azure-native:authorization/v20201001:RoleManagementPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
