...
func NewPimRoleEligibilitySchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:authorization:PimRoleEligibilitySchedule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PimRoleEligibilitySchedule
	err := ctx.RegisterResource("azure-native:authorization/v20201001:PimRoleEligibilitySchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPimRoleEligibilitySchedule(ctx *pulumi.Context,
	...
	var resource PimRoleEligibilitySchedule
	err := ctx.ReadResource("azure-native:authorization/v20201001:PimRoleEligibilitySchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type PimRoleEligibilityScheduleArgs struct {
	...
	// The name of the role eligibility to create. It can be any valid GUID.
	RoleEligibilityScheduleRequestName pulumi.StringPtrInput
	// Schedule info of the role eligibility schedule
...
// The type of the role assignment schedule request. Eg: SelfActivate, AdminAssign etc
func (o PimRoleEligibilityScheduleOutput) RequestType() pulumi.StringOutput {
	return o.ApplyT(func(v *PimRoleEligibilitySchedule) pulumi.StringOutput { return v.RequestType }).(pulumi.StringOutput)
}
