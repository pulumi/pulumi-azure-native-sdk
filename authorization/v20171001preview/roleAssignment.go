...
func NewRoleAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20171001preview:RoleAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleAssignment(ctx *pulumi.Context,
	...
	var resource RoleAssignment
	err := ctx.ReadResource("azure-native:authorization/v20171001preview:RoleAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
