...
//
// Deprecated: azure-native:authorization/v20200901:PolicySetDefinitionAtManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20210601:PolicySetDefinitionAtManagementGroup to guarantee forwards compatibility.
...
func NewPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20200901:PolicySetDefinitionAtManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinitionAtManagementGroup(ctx *pulumi.Context,
	...
	var resource PolicySetDefinitionAtManagementGroup
	err := ctx.ReadResource("azure-native:authorization/v20200901:PolicySetDefinitionAtManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
