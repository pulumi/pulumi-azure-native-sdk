...
func LookupAccessReviewScheduleDefinitionByIdOutput(ctx *pulumi.Context, args LookupAccessReviewScheduleDefinitionByIdOutputArgs, opts ...pulumi.InvokeOption) LookupAccessReviewScheduleDefinitionByIdResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAccessReviewScheduleDefinitionByIdResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:authorization:getAccessReviewScheduleDefinitionById", args, LookupAccessReviewScheduleDefinitionByIdResultOutput{}, options).(LookupAccessReviewScheduleDefinitionByIdResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupAccessReviewScheduleDefinitionByIdResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAccessReviewScheduleDefinitionByIdResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Access Review schedule definition recurrence range.
func (o LookupAccessReviewScheduleDefinitionByIdResultOutput) Range() AccessReviewRecurrenceRangeResponsePtrOutput {
	return o.ApplyT(func(v LookupAccessReviewScheduleDefinitionByIdResult) *AccessReviewRecurrenceRangeResponse {
		return v.Range
...
// This is used to define what to include in scope of the review. The scope definition includes the resourceId and roleDefinitionId.
func (o LookupAccessReviewScheduleDefinitionByIdResultOutput) Scope() AccessReviewScopeResponseOutput {
	return o.ApplyT(func(v LookupAccessReviewScheduleDefinitionByIdResult) AccessReviewScopeResponse { return v.Scope }).(AccessReviewScopeResponseOutput)
}
