...
func NewManagementLockAtResourceLevel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20200501:ManagementLockAtResourceLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockAtResourceLevel(ctx *pulumi.Context,
	...
	var resource ManagementLockAtResourceLevel
	err := ctx.ReadResource("azure-native:authorization/v20200501:ManagementLockAtResourceLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ManagementLockAtResourceLevel) ToOutput(ctx context.Context) pulumix.Output[*ManagementLockAtResourceLevel] {
	return pulumix.Output[*ManagementLockAtResourceLevel]{
		OutputState: i.ToManagementLockAtResourceLevelOutputWithContext(ctx).OutputState,
	}
}
...
func (o ManagementLockAtResourceLevelOutput) ToOutput(ctx context.Context) pulumix.Output[*ManagementLockAtResourceLevel] {
	return pulumix.Output[*ManagementLockAtResourceLevel]{
...
func (o ManagementLockAtResourceLevelOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *ManagementLockAtResourceLevel) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
