...
func NewPolicySetDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:authorization/v20230401:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20240501:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20250101:PolicySetDefinition"),
		},
		{
			Type: pulumi.String("azure-native:authorization/v20250301:PolicySetDefinition"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:authorization/v20210601:PolicySetDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinition(ctx *pulumi.Context,
	...
	var resource PolicySetDefinition
	err := ctx.ReadResource("azure-native:authorization/v20210601:PolicySetDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
