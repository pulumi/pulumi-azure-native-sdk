...
func (o LookupAccessReviewHistoryDefinitionByIdResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAccessReviewHistoryDefinitionByIdResult] {
	return pulumix.Output[LookupAccessReviewHistoryDefinitionByIdResult]{
