...
func NewAccessReviewScheduleDefinitionById(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessReviewScheduleDefinitionById(ctx *pulumi.Context,
	...
	var resource AccessReviewScheduleDefinitionById
	err := ctx.ReadResource("azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
