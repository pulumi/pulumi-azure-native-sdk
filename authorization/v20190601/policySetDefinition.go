...
func NewPolicySetDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20190601:PolicySetDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicySetDefinition(ctx *pulumi.Context,
	...
	var resource PolicySetDefinition
	err := ctx.ReadResource("azure-native:authorization/v20190601:PolicySetDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
