...
func NewRoleManagementPolicyAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20240901preview:RoleManagementPolicyAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleManagementPolicyAssignment(ctx *pulumi.Context,
	...
	var resource RoleManagementPolicyAssignment
	err := ctx.ReadResource("azure-native:authorization/v20240901preview:RoleManagementPolicyAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
