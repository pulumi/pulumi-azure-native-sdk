...
func NewManagementLockAtResourceGroupLevel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:authorization/v20170401:ManagementLockAtResourceGroupLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementLockAtResourceGroupLevel(ctx *pulumi.Context,
	...
	var resource ManagementLockAtResourceGroupLevel
	err := ctx.ReadResource("azure-native:authorization/v20170401:ManagementLockAtResourceGroupLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
