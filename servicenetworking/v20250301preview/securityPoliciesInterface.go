...
type SecurityPoliciesInterface struct {
	...
	IpAccessRulesPolicy IpAccessRulesPolicyResponsePtrOutput `pulumi:"ipAccessRulesPolicy"`
...
func NewSecurityPoliciesInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicenetworking/v20250301preview:SecurityPoliciesInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPoliciesInterface(ctx *pulumi.Context,
	...
	var resource SecurityPoliciesInterface
	err := ctx.ReadResource("azure-native:servicenetworking/v20250301preview:SecurityPoliciesInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type securityPoliciesInterfaceArgs struct {
	// Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
	IpAccessRulesPolicy *IpAccessRulesPolicy `pulumi:"ipAccessRulesPolicy"`
	// The geo-location where the resource lives
...
type SecurityPoliciesInterfaceArgs struct {
	// Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
	IpAccessRulesPolicy IpAccessRulesPolicyPtrInput
	// The geo-location where the resource lives
...
// Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
func (o SecurityPoliciesInterfaceOutput) IpAccessRulesPolicy() IpAccessRulesPolicyResponsePtrOutput {
	return o.ApplyT(func(v *SecurityPoliciesInterface) IpAccessRulesPolicyResponsePtrOutput { return v.IpAccessRulesPolicy }).(IpAccessRulesPolicyResponsePtrOutput)
}
