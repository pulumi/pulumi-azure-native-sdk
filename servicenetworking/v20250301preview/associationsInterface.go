...
func NewAssociationsInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicenetworking/v20250301preview:AssociationsInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssociationsInterface(ctx *pulumi.Context,
	...
	var resource AssociationsInterface
	err := ctx.ReadResource("azure-native:servicenetworking/v20250301preview:AssociationsInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
