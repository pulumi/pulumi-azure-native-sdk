...
func LookupFrontendsInterface(ctx *pulumi.Context, args *LookupFrontendsInterfaceArgs, opts ...pulumi.InvokeOption) (*LookupFrontendsInterfaceResult, error) {
	...
	err := ctx.Invoke("azure-native:servicenetworking/v20250301preview:getFrontendsInterface", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupFrontendsInterfaceOutput(ctx *pulumi.Context, args LookupFrontendsInterfaceOutputArgs, opts ...pulumi.InvokeOption) LookupFrontendsInterfaceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFrontendsInterfaceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicenetworking/v20250301preview:getFrontendsInterface", args, LookupFrontendsInterfaceResultOutput{}, options).(LookupFrontendsInterfaceResultOutput), nil
...
// Frontend Security Policy Configuration
func (o LookupFrontendsInterfaceResultOutput) SecurityPolicyConfigurations() SecurityPolicyConfigurationsResponsePtrOutput {
	return o.ApplyT(func(v LookupFrontendsInterfaceResult) *SecurityPolicyConfigurationsResponse {
