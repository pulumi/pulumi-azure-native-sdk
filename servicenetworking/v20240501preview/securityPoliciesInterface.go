...
func NewSecurityPoliciesInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicenetworking/v20240501preview:SecurityPoliciesInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPoliciesInterface(ctx *pulumi.Context,
	...
	var resource SecurityPoliciesInterface
	err := ctx.ReadResource("azure-native:servicenetworking/v20240501preview:SecurityPoliciesInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
