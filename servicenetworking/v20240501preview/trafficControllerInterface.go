...
func NewTrafficControllerInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicenetworking/v20240501preview:TrafficControllerInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrafficControllerInterface(ctx *pulumi.Context,
	...
	var resource TrafficControllerInterface
	err := ctx.ReadResource("azure-native:servicenetworking/v20240501preview:TrafficControllerInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
