...
func NewFrontendsInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:servicenetworking/v20250101:FrontendsInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFrontendsInterface(ctx *pulumi.Context,
	...
	var resource FrontendsInterface
	err := ctx.ReadResource("azure-native:servicenetworking/v20250101:FrontendsInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
