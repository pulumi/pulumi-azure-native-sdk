...
func LookupAssociationsInterface(ctx *pulumi.Context, args *LookupAssociationsInterfaceArgs, opts ...pulumi.InvokeOption) (*LookupAssociationsInterfaceResult, error) {
	...
	err := ctx.Invoke("azure-native:servicenetworking/v20250101:getAssociationsInterface", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAssociationsInterfaceOutput(ctx *pulumi.Context, args LookupAssociationsInterfaceOutputArgs, opts ...pulumi.InvokeOption) LookupAssociationsInterfaceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAssociationsInterfaceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicenetworking/v20250101:getAssociationsInterface", args, LookupAssociationsInterfaceResultOutput{}, options).(LookupAssociationsInterfaceResultOutput), nil
