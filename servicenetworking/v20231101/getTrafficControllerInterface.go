...
func LookupTrafficControllerInterface(ctx *pulumi.Context, args *LookupTrafficControllerInterfaceArgs, opts ...pulumi.InvokeOption) (*LookupTrafficControllerInterfaceResult, error) {
	...
	err := ctx.Invoke("azure-native:servicenetworking/v20231101:getTrafficControllerInterface", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTrafficControllerInterfaceOutput(ctx *pulumi.Context, args LookupTrafficControllerInterfaceOutputArgs, opts ...pulumi.InvokeOption) LookupTrafficControllerInterfaceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTrafficControllerInterfaceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:servicenetworking/v20231101:getTrafficControllerInterface", args, LookupTrafficControllerInterfaceResultOutput{}, options).(LookupTrafficControllerInterfaceResultOutput), nil
