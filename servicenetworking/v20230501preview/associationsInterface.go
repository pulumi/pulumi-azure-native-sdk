...
func NewAssociationsInterface(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:servicenetworking/v20231101:AssociationsInterface"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:servicenetworking/v20250301preview:AssociationsInterface"),
		},
		{
