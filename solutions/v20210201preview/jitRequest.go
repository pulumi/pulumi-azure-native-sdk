...
//
// Deprecated: azure-native:solutions/v20210201preview:JitRequest is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.
...
func NewJitRequest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:solutions/v20210201preview:JitRequest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJitRequest(ctx *pulumi.Context,
	...
	var resource JitRequest
	err := ctx.ReadResource("azure-native:solutions/v20210201preview:JitRequest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
