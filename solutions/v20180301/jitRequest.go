...
func NewJitRequest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:solutions/v20180301:JitRequest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJitRequest(ctx *pulumi.Context,
	...
	var resource JitRequest
	err := ctx.ReadResource("azure-native:solutions/v20180301:JitRequest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
