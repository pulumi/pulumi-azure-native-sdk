...
func NewApplicationDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:solutions/v20190701:ApplicationDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationDefinition(ctx *pulumi.Context,
	...
	var resource ApplicationDefinition
	err := ctx.ReadResource("azure-native:solutions/v20190701:ApplicationDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
