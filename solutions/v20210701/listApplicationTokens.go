...
func ListApplicationTokens(ctx *pulumi.Context, args *ListApplicationTokensArgs, opts ...pulumi.InvokeOption) (*ListApplicationTokensResult, error) {
	...
	err := ctx.Invoke("azure-native:solutions/v20210701:listApplicationTokens", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListApplicationTokensOutput(ctx *pulumi.Context, args ListApplicationTokensOutputArgs, opts ...pulumi.InvokeOption) ListApplicationTokensResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListApplicationTokensResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:solutions/v20210701:listApplicationTokens", args, ListApplicationTokensResultOutput{}, options).(ListApplicationTokensResultOutput), nil
