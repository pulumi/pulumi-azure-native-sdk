...
func NewJitRequest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:solutions/v20231201preview:JitRequest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJitRequest(ctx *pulumi.Context,
	...
	var resource JitRequest
	err := ctx.ReadResource("azure-native:solutions/v20231201preview:JitRequest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
