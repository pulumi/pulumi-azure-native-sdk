...
// ApplicationArtifactTypeInput is an input type that accepts values of the ApplicationArtifactType enum
// A concrete instance of `ApplicationArtifactTypeInput` can be one of the following:
//
...
// ApplicationDefinitionArtifactNameInput is an input type that accepts values of the ApplicationDefinitionArtifactName enum
// A concrete instance of `ApplicationDefinitionArtifactNameInput` can be one of the following:
//
...
// ApplicationLockLevelInput is an input type that accepts values of the ApplicationLockLevel enum
// A concrete instance of `ApplicationLockLevelInput` can be one of the following:
//
...
// ApplicationManagementModeInput is an input type that accepts values of the ApplicationManagementMode enum
// A concrete instance of `ApplicationManagementModeInput` can be one of the following:
//
...
// JitApprovalModeInput is an input type that accepts values of the JitApprovalMode enum
// A concrete instance of `JitApprovalModeInput` can be one of the following:
//
...
// JitApproverTypeInput is an input type that accepts values of the JitApproverType enum
// A concrete instance of `JitApproverTypeInput` can be one of the following:
//
//	JitApproverTypeUser
...
// JitSchedulingTypeInput is an input type that accepts values of the JitSchedulingType enum
// A concrete instance of `JitSchedulingTypeInput` can be one of the following:
//
