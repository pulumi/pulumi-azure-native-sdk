...
func ListApplicationAllowedUpgradePlans(ctx *pulumi.Context, args *ListApplicationAllowedUpgradePlansArgs, opts ...pulumi.InvokeOption) (*ListApplicationAllowedUpgradePlansResult, error) {
	...
	err := ctx.Invoke("azure-native:solutions/v20231201preview:listApplicationAllowedUpgradePlans", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListApplicationAllowedUpgradePlansOutput(ctx *pulumi.Context, args ListApplicationAllowedUpgradePlansOutputArgs, opts ...pulumi.InvokeOption) ListApplicationAllowedUpgradePlansResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListApplicationAllowedUpgradePlansResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:solutions/v20231201preview:listApplicationAllowedUpgradePlans", args, ListApplicationAllowedUpgradePlansResultOutput{}, options).(ListApplicationAllowedUpgradePlansResultOutput), nil
