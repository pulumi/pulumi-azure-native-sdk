...
func NewMonitoredResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:scom:MonitoredResource"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MonitoredResource
	err := ctx.RegisterResource("azure-native:scom/v20230707preview:MonitoredResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoredResource(ctx *pulumi.Context,
	...
	var resource MonitoredResource
	err := ctx.ReadResource("azure-native:scom/v20230707preview:MonitoredResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
