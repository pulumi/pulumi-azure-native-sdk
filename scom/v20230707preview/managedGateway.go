...
func NewManagedGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:scom:ManagedGateway"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ManagedGateway
	err := ctx.RegisterResource("azure-native:scom/v20230707preview:ManagedGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedGateway(ctx *pulumi.Context,
	...
	var resource ManagedGateway
	err := ctx.ReadResource("azure-native:scom/v20230707preview:ManagedGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
