...
func NewAsset(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:deviceregistry/v20250701preview:Asset"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20251001:Asset"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20251101preview:Asset"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260301preview:Asset"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260401:Asset"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20261101preview:Asset"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AssetOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Asset) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
