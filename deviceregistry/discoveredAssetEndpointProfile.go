...
func NewDiscoveredAssetEndpointProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:deviceregistry/v20240901preview:DiscoveredAssetEndpointProfile"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DiscoveredAssetEndpointProfile
	err := ctx.RegisterResource("azure-native:deviceregistry:DiscoveredAssetEndpointProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveredAssetEndpointProfile(ctx *pulumi.Context,
	...
	var resource DiscoveredAssetEndpointProfile
	err := ctx.ReadResource("azure-native:deviceregistry:DiscoveredAssetEndpointProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
