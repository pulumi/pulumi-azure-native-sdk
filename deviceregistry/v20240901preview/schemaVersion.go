...
func NewSchemaVersion(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:deviceregistry:SchemaVersion"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SchemaVersion
	err := ctx.RegisterResource("azure-native:deviceregistry/v20240901preview:SchemaVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchemaVersion(ctx *pulumi.Context,
	...
	var resource SchemaVersion
	err := ctx.ReadResource("azure-native:deviceregistry/v20240901preview:SchemaVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
