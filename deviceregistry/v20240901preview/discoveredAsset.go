...
func NewDiscoveredAsset(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:deviceregistry:DiscoveredAsset"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DiscoveredAsset
	err := ctx.RegisterResource("azure-native:deviceregistry/v20240901preview:DiscoveredAsset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveredAsset(ctx *pulumi.Context,
	...
	var resource DiscoveredAsset
	err := ctx.ReadResource("azure-native:deviceregistry/v20240901preview:DiscoveredAsset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
