...
func NewSchema(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:deviceregistry:Schema"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Schema
	err := ctx.RegisterResource("azure-native:deviceregistry/v20240901preview:Schema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchema(ctx *pulumi.Context,
	...
	var resource Schema
	err := ctx.ReadResource("azure-native:deviceregistry/v20240901preview:Schema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
