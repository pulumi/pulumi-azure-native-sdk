...
func NewNamespaceAsset(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260301preview:NamespaceAsset"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260401:NamespaceAsset"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20261101preview:NamespaceAsset"),
		},
	})
