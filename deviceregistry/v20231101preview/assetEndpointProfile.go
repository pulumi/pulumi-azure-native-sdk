...
func NewAssetEndpointProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:deviceregistry/v20231101preview:AssetEndpointProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssetEndpointProfile(ctx *pulumi.Context,
	...
	var resource AssetEndpointProfile
	err := ctx.ReadResource("azure-native:deviceregistry/v20231101preview:AssetEndpointProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
