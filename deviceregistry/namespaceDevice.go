...
func NewNamespaceDevice(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260301preview:NamespaceDevice"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260401:NamespaceDevice"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20261101preview:NamespaceDevice"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NamespaceDeviceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NamespaceDevice) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
