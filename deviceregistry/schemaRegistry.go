...
func NewSchemaRegistry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260301preview:SchemaRegistry"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260401:SchemaRegistry"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20261101preview:SchemaRegistry"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SchemaRegistry
	err := ctx.RegisterResource("azure-native:deviceregistry:SchemaRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchemaRegistry(ctx *pulumi.Context,
	...
	var resource SchemaRegistry
	err := ctx.ReadResource("azure-native:deviceregistry:SchemaRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
