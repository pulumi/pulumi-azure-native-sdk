...
func NewAssetEndpointProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260301preview:AssetEndpointProfile"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20260401:AssetEndpointProfile"),
		},
		{
			Type: pulumi.String("azure-native:deviceregistry/v20261101preview:AssetEndpointProfile"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AssetEndpointProfileOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *AssetEndpointProfile) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
