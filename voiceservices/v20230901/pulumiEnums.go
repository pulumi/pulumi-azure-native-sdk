...
func (in *apiBridgeActivationStatePtr) ToOutput(ctx context.Context) pulumix.Output[*ApiBridgeActivationState] {
	return pulumix.Output[*ApiBridgeActivationState]{
		OutputState: in.ToApiBridgeActivationStatePtrOutputWithContext(ctx).OutputState,
	}
}
