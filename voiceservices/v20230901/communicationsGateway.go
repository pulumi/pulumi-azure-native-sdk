...
func NewCommunicationsGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:voiceservices/v20230901:CommunicationsGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCommunicationsGateway(ctx *pulumi.Context,
	...
	var resource CommunicationsGateway
	err := ctx.ReadResource("azure-native:voiceservices/v20230901:CommunicationsGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
