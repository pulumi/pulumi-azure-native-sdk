...
type CommunicationsGateway struct {
	...
	AllocatedMediaAddressPrefixes pulumi.StringArrayOutput `pulumi:"allocatedMediaAddressPrefixes"`
	// A list of IP allocated prefixes which may be used to receive signaling data from this Communications Gateway.
	AllocatedSignalingAddressPrefixes pulumi.StringArrayOutput `pulumi:"allocatedSignalingAddressPrefixes"`
	// Details of API bridge functionality, if required
	ApiBridge ApiBridgePropertiesResponsePtrOutput `pulumi:"apiBridge"`
	...
	CustomSipHeaders CustomSipHeadersPropertiesResponsePtrOutput `pulumi:"customSipHeaders"`
	// Details of DNS Domains to delegate to the Communications Gateway.
	DnsDelegations DnsDelegationsPropertiesResponsePtrOutput `pulumi:"dnsDelegations"`
...
func NewCommunicationsGateway(ctx *pulumi.Context,
	...
	if args.ApiBridge != nil {
		args.ApiBridge = args.ApiBridge.ToApiBridgePropertiesPtrOutput().ApplyT(func(v *ApiBridgeProperties) *ApiBridgeProperties { return v.Defaults() }).(ApiBridgePropertiesPtrOutput)
	}
...
type communicationsGatewayArgs struct {
	// Details of API bridge functionality, if required
	ApiBridge *ApiBridgeProperties `pulumi:"apiBridge"`
	// The scope at which the auto-generated domain name can be re-used
	...
	// Custom SIP Header to add to any subscriber with a custom_header value, if required.
	CustomSipHeaders *CustomSipHeadersProperties `pulumi:"customSipHeaders"`
	// Details of DNS Domains to delegate to the Communications Gateway.
	DnsDelegations *DnsDelegationsProperties `pulumi:"dnsDelegations"`
	// How to handle 911 calls
...
type CommunicationsGatewayArgs struct {
	// Details of API bridge functionality, if required
	ApiBridge ApiBridgePropertiesPtrInput
	// The scope at which the auto-generated domain name can be re-used
	...
	// Custom SIP Header to add to any subscriber with a custom_header value, if required.
	CustomSipHeaders CustomSipHeadersPropertiesPtrInput
	// Details of DNS Domains to delegate to the Communications Gateway.
	DnsDelegations DnsDelegationsPropertiesPtrInput
	// How to handle 911 calls
...
// A list of allocated IP prefixes which may be used to receive media data from this Communications Gateway.
func (o CommunicationsGatewayOutput) AllocatedMediaAddressPrefixes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *CommunicationsGateway) pulumi.StringArrayOutput { return v.AllocatedMediaAddressPrefixes }).(pulumi.StringArrayOutput)
}

// A list of IP allocated prefixes which may be used to receive signaling data from this Communications Gateway.
func (o CommunicationsGatewayOutput) AllocatedSignalingAddressPrefixes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *CommunicationsGateway) pulumi.StringArrayOutput { return v.AllocatedSignalingAddressPrefixes }).(pulumi.StringArrayOutput)
}

// Details of API bridge functionality, if required
func (o CommunicationsGatewayOutput) ApiBridge() ApiBridgePropertiesResponsePtrOutput {
	return o.ApplyT(func(v *CommunicationsGateway) ApiBridgePropertiesResponsePtrOutput { return v.ApiBridge }).(ApiBridgePropertiesResponsePtrOutput)
}
...
// The Azure API version of the resource.
func (o CommunicationsGatewayOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CommunicationsGateway) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Custom SIP Header to add to any subscriber with a custom_header value, if required.
func (o CommunicationsGatewayOutput) CustomSipHeaders() CustomSipHeadersPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *CommunicationsGateway) CustomSipHeadersPropertiesResponsePtrOutput { return v.CustomSipHeaders }).(CustomSipHeadersPropertiesResponsePtrOutput)
}

// Details of DNS Domains to delegate to the Communications Gateway.
func (o CommunicationsGatewayOutput) DnsDelegations() DnsDelegationsPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *CommunicationsGateway) DnsDelegationsPropertiesResponsePtrOutput { return v.DnsDelegations }).(DnsDelegationsPropertiesResponsePtrOutput)
}
