...
func NewTestLine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:voiceservices/v20230403:TestLine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTestLine(ctx *pulumi.Context,
	...
	var resource TestLine
	err := ctx.ReadResource("azure-native:voiceservices/v20230403:TestLine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
