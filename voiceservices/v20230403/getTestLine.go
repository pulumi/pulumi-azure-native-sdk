...
func LookupTestLine(ctx *pulumi.Context, args *LookupTestLineArgs, opts ...pulumi.InvokeOption) (*LookupTestLineResult, error) {
	...
	err := ctx.Invoke("azure-native:voiceservices/v20230403:getTestLine", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTestLineOutput(ctx *pulumi.Context, args LookupTestLineOutputArgs, opts ...pulumi.InvokeOption) LookupTestLineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTestLineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:voiceservices/v20230403:getTestLine", args, LookupTestLineResultOutput{}, options).(LookupTestLineResultOutput), nil
