...
func NewServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20240301preview:Server", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20240301preview:Server", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
