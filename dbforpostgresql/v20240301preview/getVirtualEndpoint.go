...
func LookupVirtualEndpoint(ctx *pulumi.Context, args *LookupVirtualEndpointArgs, opts ...pulumi.InvokeOption) (*LookupVirtualEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:dbforpostgresql/v20240301preview:getVirtualEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVirtualEndpointOutput(ctx *pulumi.Context, args LookupVirtualEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupVirtualEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVirtualEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbforpostgresql/v20240301preview:getVirtualEndpoint", args, LookupVirtualEndpointResultOutput{}, options).(LookupVirtualEndpointResultOutput), nil
