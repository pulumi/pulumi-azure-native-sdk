...
func LookupSingleServer(ctx *pulumi.Context, args *LookupSingleServerArgs, opts ...pulumi.InvokeOption) (*LookupSingleServerResult, error) {
	...
	err := ctx.Invoke("azure-native:dbforpostgresql:getSingleServer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupSingleServerResult struct {
	...
	Sku *SingleServerSkuResponse `pulumi:"sku"`
...
func LookupSingleServerOutput(ctx *pulumi.Context, args LookupSingleServerOutputArgs, opts ...pulumi.InvokeOption) LookupSingleServerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSingleServerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbforpostgresql:getSingleServer", args, LookupSingleServerResultOutput{}, options).(LookupSingleServerResultOutput), nil
...
// The SKU (pricing tier) of the server.
func (o LookupSingleServerResultOutput) Sku() SingleServerSkuResponsePtrOutput {
	return o.ApplyT(func(v LookupSingleServerResult) *SingleServerSkuResponse { return v.Sku }).(SingleServerSkuResponsePtrOutput)
}
