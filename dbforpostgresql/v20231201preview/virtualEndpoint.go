...
func NewVirtualEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20231201preview:VirtualEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualEndpoint(ctx *pulumi.Context,
	...
	var resource VirtualEndpoint
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20231201preview:VirtualEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
