...
// ServerSecurityAlertPolicyStateEnumInput is an input type that accepts values of the ServerSecurityAlertPolicyStateEnum enum
// A concrete instance of `ServerSecurityAlertPolicyStateEnumInput` can be one of the following:
//
//	ServerSecurityAlertPolicyStateEnumEnabled
//	ServerSecurityAlertPolicyStateEnumDisabled
