...
// HAEnabledEnumInput is an input type that accepts values of the HAEnabledEnum enum
// A concrete instance of `HAEnabledEnumInput` can be one of the following:
//
