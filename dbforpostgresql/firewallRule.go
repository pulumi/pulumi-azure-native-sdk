...
func NewFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20231201preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20240301preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20240801:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20241101preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20250101preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20250601preview:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20250801:FirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20260101preview:FirewallRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource FirewallRule
	err := ctx.RegisterResource("azure-native:dbforpostgresql:FirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallRule(ctx *pulumi.Context,
	...
	var resource FirewallRule
	err := ctx.ReadResource("azure-native:dbforpostgresql:FirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o FirewallRuleOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *FirewallRule) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
