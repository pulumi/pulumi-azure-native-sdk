...
func NewConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20240801:Configuration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfiguration(ctx *pulumi.Context,
	...
	var resource Configuration
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20240801:Configuration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
