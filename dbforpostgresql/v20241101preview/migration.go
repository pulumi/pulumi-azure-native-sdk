...
func NewMigration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20241101preview:Migration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigration(ctx *pulumi.Context,
	...
	var resource Migration
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20241101preview:Migration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
