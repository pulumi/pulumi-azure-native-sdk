...
func NewDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20241101preview:Database", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabase(ctx *pulumi.Context,
	...
	var resource Database
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20241101preview:Database", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
