...
func NewAdministrator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20241101preview:Administrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdministrator(ctx *pulumi.Context,
	...
	var resource Administrator
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20241101preview:Administrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
