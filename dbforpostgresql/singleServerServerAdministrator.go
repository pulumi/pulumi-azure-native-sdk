...
func NewSingleServerServerAdministrator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20171201:SingleServerServerAdministrator"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20171201preview:ServerAdministrator"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20171201preview:SingleServerServerAdministrator"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SingleServerServerAdministrator
	err := ctx.RegisterResource("azure-native:dbforpostgresql:SingleServerServerAdministrator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSingleServerServerAdministrator(ctx *pulumi.Context,
	...
	var resource SingleServerServerAdministrator
	err := ctx.ReadResource("azure-native:dbforpostgresql:SingleServerServerAdministrator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
