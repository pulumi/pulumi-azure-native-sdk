...
// CitusVersionInput is an input type that accepts values of the CitusVersion enum
// A concrete instance of `CitusVersionInput` can be one of the following:
//
//	CitusVersion_8_3
//	CitusVersion_9_0
//	CitusVersion_9_1
...
// PostgreSQLVersionInput is an input type that accepts values of the PostgreSQLVersion enum
// A concrete instance of `PostgreSQLVersionInput` can be one of the following:
//
//	PostgreSQLVersion_11
//	PostgreSQLVersion_12
...
// ServerEditionInput is an input type that accepts values of the ServerEdition enum
// A concrete instance of `ServerEditionInput` can be one of the following:
//
...
// ServerRoleInput is an input type that accepts values of the ServerRole enum
// A concrete instance of `ServerRoleInput` can be one of the following:
//
