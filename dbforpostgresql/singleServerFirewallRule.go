...
func NewSingleServerFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20171201:SingleServerFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:dbforpostgresql/v20171201preview:SingleServerFirewallRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SingleServerFirewallRule
	err := ctx.RegisterResource("azure-native:dbforpostgresql:SingleServerFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSingleServerFirewallRule(ctx *pulumi.Context,
	...
	var resource SingleServerFirewallRule
	err := ctx.ReadResource("azure-native:dbforpostgresql:SingleServerFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
