...
type Server struct {
	...
	Sku PostgreSqlSkuResponsePtrOutput `pulumi:"sku"`
...
func NewServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20220308preview:Server", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServer(ctx *pulumi.Context,
	...
	var resource Server
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20220308preview:Server", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The SKU (pricing tier) of the server.
func (o ServerOutput) Sku() PostgreSqlSkuResponsePtrOutput {
	return o.ApplyT(func(v *Server) PostgreSqlSkuResponsePtrOutput { return v.Sku }).(PostgreSqlSkuResponsePtrOutput)
}
