...
func (val *AuthConfig) Defaults() *AuthConfig {
	...
	tmp := *val
	if isZero(tmp.PasswordAuthEnabled) {
		passwordAuthEnabled_ := true
		tmp.PasswordAuthEnabled = &passwordAuthEnabled_
	}
...
func (val *AuthConfigArgs) Defaults() *AuthConfigArgs {
	...
	tmp := *val
	if isZero(tmp.PasswordAuthEnabled) {
		tmp.PasswordAuthEnabled = pulumi.BoolPtr(true)
	}
	if isZero(tmp.TenantId) {
...
// If true, Azure Active Directory authentication is enabled.
func (o AuthConfigOutput) ActiveDirectoryAuthEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AuthConfig) *bool { return v.ActiveDirectoryAuthEnabled }).(pulumi.BoolPtrOutput)
}

// If true, Password authentication is enabled.
func (o AuthConfigOutput) PasswordAuthEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AuthConfig) *bool { return v.PasswordAuthEnabled }).(pulumi.BoolPtrOutput)
}
...
// If true, Azure Active Directory authentication is enabled.
func (o AuthConfigPtrOutput) ActiveDirectoryAuthEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AuthConfig) *bool {
		if v == nil {
			return nil
		}
...
// If true, Password authentication is enabled.
func (o AuthConfigPtrOutput) PasswordAuthEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AuthConfig) *bool {
		if v == nil {
			return nil
		}
...
// If true, Azure Active Directory authentication is enabled.
func (o AuthConfigResponseOutput) ActiveDirectoryAuthEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AuthConfigResponse) *bool { return v.ActiveDirectoryAuthEnabled }).(pulumi.BoolPtrOutput)
}

// If true, Password authentication is enabled.
func (o AuthConfigResponseOutput) PasswordAuthEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v AuthConfigResponse) *bool { return v.PasswordAuthEnabled }).(pulumi.BoolPtrOutput)
}
...
// If true, Azure Active Directory authentication is enabled.
func (o AuthConfigResponsePtrOutput) ActiveDirectoryAuthEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AuthConfigResponse) *bool {
		if v == nil {
			return nil
		}
		return v.ActiveDirectoryAuthEnabled
...
// If true, Password authentication is enabled.
func (o AuthConfigResponsePtrOutput) PasswordAuthEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *AuthConfigResponse) *bool {
		if v == nil {
			return nil
		}
...
// PostgreSqlSkuInput is an input type that accepts PostgreSqlSkuArgs and PostgreSqlSkuOutput values.
// You can construct a concrete instance of `PostgreSqlSkuInput` via:
//
//	PostgreSqlSkuArgs{...}
type PostgreSqlSkuInput interface {
	pulumi.Input

	ToPostgreSqlSkuOutput() PostgreSqlSkuOutput
	ToPostgreSqlSkuOutputWithContext(context.Context) PostgreSqlSkuOutput
}

// Sku information related properties of a server.
type PostgreSqlSkuArgs struct {
	// The name of the sku, typically, tier + family + cores, e.g. Standard_D4s_v3.
...
func (PostgreSqlSkuArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*PostgreSqlSku)(nil)).Elem()
}

func (i PostgreSqlSkuArgs) ToPostgreSqlSkuOutput() PostgreSqlSkuOutput {
	return i.ToPostgreSqlSkuOutputWithContext(context.Background())
}

func (i PostgreSqlSkuArgs) ToPostgreSqlSkuOutputWithContext(ctx context.Context) PostgreSqlSkuOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PostgreSqlSkuOutput)
}

func (i PostgreSqlSkuArgs) ToPostgreSqlSkuPtrOutput() PostgreSqlSkuPtrOutput {
	return i.ToPostgreSqlSkuPtrOutputWithContext(context.Background())
}

func (i PostgreSqlSkuArgs) ToPostgreSqlSkuPtrOutputWithContext(ctx context.Context) PostgreSqlSkuPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PostgreSqlSkuOutput).ToPostgreSqlSkuPtrOutputWithContext(ctx)
}

// PostgreSqlSkuPtrInput is an input type that accepts PostgreSqlSkuArgs, PostgreSqlSkuPtr and PostgreSqlSkuPtrOutput values.
// You can construct a concrete instance of `PostgreSqlSkuPtrInput` via:
//
//	        PostgreSqlSkuArgs{...}
//
//	or:
//
//	        nil
type PostgreSqlSkuPtrInput interface {
	pulumi.Input

	ToPostgreSqlSkuPtrOutput() PostgreSqlSkuPtrOutput
	ToPostgreSqlSkuPtrOutputWithContext(context.Context) PostgreSqlSkuPtrOutput
}

type postgreSqlSkuPtrType PostgreSqlSkuArgs

func PostgreSqlSkuPtr(v *PostgreSqlSkuArgs) PostgreSqlSkuPtrInput {
	return (*postgreSqlSkuPtrType)(v)
}

func (*postgreSqlSkuPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PostgreSqlSku)(nil)).Elem()
}

func (i *postgreSqlSkuPtrType) ToPostgreSqlSkuPtrOutput() PostgreSqlSkuPtrOutput {
	return i.ToPostgreSqlSkuPtrOutputWithContext(context.Background())
}

func (i *postgreSqlSkuPtrType) ToPostgreSqlSkuPtrOutputWithContext(ctx context.Context) PostgreSqlSkuPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PostgreSqlSkuPtrOutput)
}

// Sku information related properties of a server.
type PostgreSqlSkuOutput struct{ *pulumi.OutputState }

func (PostgreSqlSkuOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PostgreSqlSku)(nil)).Elem()
}

func (o PostgreSqlSkuOutput) ToPostgreSqlSkuOutput() PostgreSqlSkuOutput {
	return o
}

func (o PostgreSqlSkuOutput) ToPostgreSqlSkuOutputWithContext(ctx context.Context) PostgreSqlSkuOutput {
	return o
}

func (o PostgreSqlSkuOutput) ToPostgreSqlSkuPtrOutput() PostgreSqlSkuPtrOutput {
	return o.ToPostgreSqlSkuPtrOutputWithContext(context.Background())
}

func (o PostgreSqlSkuOutput) ToPostgreSqlSkuPtrOutputWithContext(ctx context.Context) PostgreSqlSkuPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v PostgreSqlSku) *PostgreSqlSku {
		return &v
	}).(PostgreSqlSkuPtrOutput)
}

// The name of the sku, typically, tier + family + cores, e.g. Standard_D4s_v3.
func (o PostgreSqlSkuOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v PostgreSqlSku) string { return v.Name }).(pulumi.StringOutput)
}
...
func (PostgreSqlSkuPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PostgreSqlSku)(nil)).Elem()
}

func (o PostgreSqlSkuPtrOutput) ToPostgreSqlSkuPtrOutput() PostgreSqlSkuPtrOutput {
	return o
}

func (o PostgreSqlSkuPtrOutput) ToPostgreSqlSkuPtrOutputWithContext(ctx context.Context) PostgreSqlSkuPtrOutput {
	return o
}

func (o PostgreSqlSkuPtrOutput) Elem() PostgreSqlSkuOutput {
	return o.ApplyT(func(v *PostgreSqlSku) PostgreSqlSku {
		if v != nil {
			return *v
		}
		var ret PostgreSqlSku
		return ret
	}).(PostgreSqlSkuOutput)
}

// The name of the sku, typically, tier + family + cores, e.g. Standard_D4s_v3.
func (o PostgreSqlSkuPtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PostgreSqlSku) *string {
		if v == nil {
			return nil
		}
		return &v.Name
...
// The tier of the particular SKU, e.g. Burstable.
func (o PostgreSqlSkuPtrOutput) Tier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PostgreSqlSku) *string {
		if v == nil {
			return nil
		}
...
// Sku information related properties of a server.
type PostgreSqlSkuResponse struct {
	// The name of the sku, typically, tier + family + cores, e.g. Standard_D4s_v3.
	Name string `pulumi:"name"`
	// The tier of the particular SKU, e.g. Burstable.
	Tier string `pulumi:"tier"`
...
// Sku information related properties of a server.
type PostgreSqlSkuResponseOutput struct{ *pulumi.OutputState }

func (PostgreSqlSkuResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PostgreSqlSkuResponse)(nil)).Elem()
}

func (o PostgreSqlSkuResponseOutput) ToPostgreSqlSkuResponseOutput() PostgreSqlSkuResponseOutput {
	return o
}

func (o PostgreSqlSkuResponseOutput) ToPostgreSqlSkuResponseOutputWithContext(ctx context.Context) PostgreSqlSkuResponseOutput {
	return o
}

// The name of the sku, typically, tier + family + cores, e.g. Standard_D4s_v3.
func (o PostgreSqlSkuResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v PostgreSqlSkuResponse) string { return v.Name }).(pulumi.StringOutput)
}

// The tier of the particular SKU, e.g. Burstable.
func (o PostgreSqlSkuResponseOutput) Tier() pulumi.StringOutput {
	return o.ApplyT(func(v PostgreSqlSkuResponse) string { return v.Tier }).(pulumi.StringOutput)
}

type PostgreSqlSkuResponsePtrOutput struct{ *pulumi.OutputState }

func (PostgreSqlSkuResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PostgreSqlSkuResponse)(nil)).Elem()
}

func (o PostgreSqlSkuResponsePtrOutput) ToPostgreSqlSkuResponsePtrOutput() PostgreSqlSkuResponsePtrOutput {
	return o
}

func (o PostgreSqlSkuResponsePtrOutput) ToPostgreSqlSkuResponsePtrOutputWithContext(ctx context.Context) PostgreSqlSkuResponsePtrOutput {
	return o
}

func (o PostgreSqlSkuResponsePtrOutput) Elem() PostgreSqlSkuResponseOutput {
	return o.ApplyT(func(v *PostgreSqlSkuResponse) PostgreSqlSkuResponse {
		if v != nil {
			return *v
		}
		var ret PostgreSqlSkuResponse
		return ret
	}).(PostgreSqlSkuResponseOutput)
}

// The name of the sku, typically, tier + family + cores, e.g. Standard_D4s_v3.
func (o PostgreSqlSkuResponsePtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PostgreSqlSkuResponse) *string {
		if v == nil {
			return nil
		}
		return &v.Name
...
// The tier of the particular SKU, e.g. Burstable.
func (o PostgreSqlSkuResponsePtrOutput) Tier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PostgreSqlSkuResponse) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterOutputType(PostgreSqlSkuOutput{})
	pulumi.RegisterOutputType(PostgreSqlSkuPtrOutput{})
	pulumi.RegisterOutputType(PostgreSqlSkuResponseOutput{})
	pulumi.RegisterOutputType(PostgreSqlSkuResponsePtrOutput{})
