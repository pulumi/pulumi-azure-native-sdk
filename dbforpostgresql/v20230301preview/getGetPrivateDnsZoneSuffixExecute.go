...
func GetGetPrivateDnsZoneSuffixExecute(ctx *pulumi.Context, args *GetGetPrivateDnsZoneSuffixExecuteArgs, opts ...pulumi.InvokeOption) (*GetGetPrivateDnsZoneSuffixExecuteResult, error) {
	...
	err := ctx.Invoke("azure-native:dbforpostgresql/v20230301preview:getGetPrivateDnsZoneSuffixExecute", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetGetPrivateDnsZoneSuffixExecuteOutput(ctx *pulumi.Context, args GetGetPrivateDnsZoneSuffixExecuteOutputArgs, opts ...pulumi.InvokeOption) GetGetPrivateDnsZoneSuffixExecuteResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetGetPrivateDnsZoneSuffixExecuteResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbforpostgresql/v20230301preview:getGetPrivateDnsZoneSuffixExecute", args, GetGetPrivateDnsZoneSuffixExecuteResultOutput{}, options).(GetGetPrivateDnsZoneSuffixExecuteResultOutput), nil
