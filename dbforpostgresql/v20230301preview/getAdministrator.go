...
func LookupAdministrator(ctx *pulumi.Context, args *LookupAdministratorArgs, opts ...pulumi.InvokeOption) (*LookupAdministratorResult, error) {
	...
	err := ctx.Invoke("azure-native:dbforpostgresql/v20230301preview:getAdministrator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAdministratorOutput(ctx *pulumi.Context, args LookupAdministratorOutputArgs, opts ...pulumi.InvokeOption) LookupAdministratorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAdministratorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbforpostgresql/v20230301preview:getAdministrator", args, LookupAdministratorResultOutput{}, options).(LookupAdministratorResultOutput), nil
