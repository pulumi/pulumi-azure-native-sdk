...
func NewServerKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20200101privatepreview:ServerKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerKey(ctx *pulumi.Context,
	...
	var resource ServerKey
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20200101privatepreview:ServerKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
