...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ServerGroupClusterOutput) SystemData() commontypesv4.SystemDataResponseOutput {
	return o.ApplyT(func(v *ServerGroupCluster) commontypesv4.SystemDataResponseOutput { return v.SystemData }).(commontypesv4.SystemDataResponseOutput)
}
