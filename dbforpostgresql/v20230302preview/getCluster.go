...
func LookupCluster(ctx *pulumi.Context, args *LookupClusterArgs, opts ...pulumi.InvokeOption) (*LookupClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:dbforpostgresql/v20230302preview:getCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupClusterOutput(ctx *pulumi.Context, args LookupClusterOutputArgs, opts ...pulumi.InvokeOption) LookupClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:dbforpostgresql/v20230302preview:getCluster", args, LookupClusterResultOutput{}, options).(LookupClusterResultOutput), nil
...
// Authentication configuration of a cluster.
func (o LookupClusterResultOutput) AuthConfig() AuthConfigResponsePtrOutput {
	return o.ApplyT(func(v LookupClusterResult) *AuthConfigResponse { return v.AuthConfig }).(AuthConfigResponsePtrOutput)
}
...
// If cluster backup is stored in another Azure region in addition to the copy of the backup stored in the cluster's region. Enabled only at the time of cluster creation.
func (o LookupClusterResultOutput) EnableGeoBackup() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupClusterResult) *bool { return v.EnableGeoBackup }).(pulumi.BoolPtrOutput)
}
