...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:dbforpostgresql/v20230302preview:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azure-native:dbforpostgresql/v20230302preview:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Authentication configuration of a cluster.
func (o ClusterOutput) AuthConfig() AuthConfigResponsePtrOutput {
	return o.ApplyT(func(v *Cluster) AuthConfigResponsePtrOutput { return v.AuthConfig }).(AuthConfigResponsePtrOutput)
}
...
// If cluster backup is stored in another Azure region in addition to the copy of the backup stored in the cluster's region. Enabled only at the time of cluster creation.
func (o ClusterOutput) EnableGeoBackup() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Cluster) pulumi.BoolPtrOutput { return v.EnableGeoBackup }).(pulumi.BoolPtrOutput)
}
