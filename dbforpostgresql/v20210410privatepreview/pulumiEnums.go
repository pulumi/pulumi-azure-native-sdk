...
// GeoRedundantBackupOptionInput is an input type that accepts values of the GeoRedundantBackupOption enum
// A concrete instance of `GeoRedundantBackupOptionInput` can be one of the following:
//
//	GeoRedundantBackupOptionEnabled
//	GeoRedundantBackupOptionDisabled
...
func (in *geoRedundantBackupOptionPtr) ToOutput(ctx context.Context) pulumix.Output[*GeoRedundantBackupOption] {
	return pulumix.Output[*GeoRedundantBackupOption]{
		OutputState: in.ToGeoRedundantBackupOptionPtrOutputWithContext(ctx).OutputState,
	}
}
