...
//
// Deprecated: azure-native:dbforpostgresql/v20210601preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20210615privatepreview:Server to guarantee forwards compatibility.
