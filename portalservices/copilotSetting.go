...
func NewCopilotSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:portalservices:CopilotSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCopilotSetting(ctx *pulumi.Context,
	...
	var resource CopilotSetting
	err := ctx.ReadResource("azure-native:portalservices:CopilotSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CopilotSettingOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *CopilotSetting) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
