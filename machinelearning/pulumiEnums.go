...
// AssetTypeInput is an input type that accepts values of the AssetType enum
// A concrete instance of `AssetTypeInput` can be one of the following:
//
//	AssetTypeModule
//	AssetTypeResource
...
// ColumnFormatInput is an input type that accepts values of the ColumnFormat enum
// A concrete instance of `ColumnFormatInput` can be one of the following:
//
//	ColumnFormatByte
//	ColumnFormatChar
...
// ColumnTypeInput is an input type that accepts values of the ColumnType enum
// A concrete instance of `ColumnTypeInput` can be one of the following:
//
//	ColumnTypeBoolean
//	ColumnTypeInteger
//	ColumnTypeNumber
...
// DiagnosticsLevelInput is an input type that accepts values of the DiagnosticsLevel enum
// A concrete instance of `DiagnosticsLevelInput` can be one of the following:
//
...
// InputPortTypeInput is an input type that accepts values of the InputPortType enum
// A concrete instance of `InputPortTypeInput` can be one of the following:
//
...
// OutputPortTypeInput is an input type that accepts values of the OutputPortType enum
// A concrete instance of `OutputPortTypeInput` can be one of the following:
//
