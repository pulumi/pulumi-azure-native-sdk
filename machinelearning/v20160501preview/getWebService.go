...
func LookupWebServiceOutput(ctx *pulumi.Context, args LookupWebServiceOutputArgs, opts ...pulumi.InvokeOption) LookupWebServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWebServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:machinelearning/v20160501preview:getWebService", args, LookupWebServiceResultOutput{}, options).(LookupWebServiceResultOutput), nil
...
// Specifies the name of the resource.
func (o LookupWebServiceResultOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWebServiceResult) *string { return v.Name }).(pulumi.StringPtrOutput)
}
