...
func NewDevOpsConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security:DevOpsConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevOpsConfiguration(ctx *pulumi.Context,
	...
	var resource DevOpsConfiguration
	err := ctx.ReadResource("azure-native:security:DevOpsConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Metadata pertaining to creation and last modification of the resource.
func (o DevOpsConfigurationOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *DevOpsConfiguration) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
