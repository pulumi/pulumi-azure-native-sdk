...
func NewSecurityStandard(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:security:SecurityStandard"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SecurityStandard
	err := ctx.RegisterResource("azure-native:security/v20240801:SecurityStandard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityStandard(ctx *pulumi.Context,
	...
	var resource SecurityStandard
	err := ctx.ReadResource("azure-native:security/v20240801:SecurityStandard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
