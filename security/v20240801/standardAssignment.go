...
func NewStandardAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:security:StandardAssignment"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource StandardAssignment
	err := ctx.RegisterResource("azure-native:security/v20240801:StandardAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStandardAssignment(ctx *pulumi.Context,
	...
	var resource StandardAssignment
	err := ctx.ReadResource("azure-native:security/v20240801:StandardAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
