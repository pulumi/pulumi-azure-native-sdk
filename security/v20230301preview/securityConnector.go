...
func NewSecurityConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:security/v20240301preview:SecurityConnector"),
		},
		{
			Type: pulumi.String("azure-native:security/v20240701preview:SecurityConnector"),
		},
		{
			Type: pulumi.String("azure-native:security/v20240801preview:SecurityConnector"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SecurityConnector
	err := ctx.RegisterResource("azure-native:security/v20230301preview:SecurityConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityConnector(ctx *pulumi.Context,
	...
	var resource SecurityConnector
	err := ctx.ReadResource("azure-native:security/v20230301preview:SecurityConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
