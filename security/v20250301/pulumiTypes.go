...
type AgentlessConfiguration struct {
	...
	AgentlessAutoDiscovery *string `pulumi:"agentlessAutoDiscovery"`
	// Agentless Enablement states.
	AgentlessEnabled *string `pulumi:"agentlessEnabled"`
	...
	InventoryList []InventoryList `pulumi:"inventoryList"`
	// Types for inventory list.
	InventoryListType *string `pulumi:"inventoryListType"`
	// Gets or sets the scanners for the connector.
	Scanners []string `pulumi:"scanners"`
}

// AgentlessConfigurationInput is an input type that accepts AgentlessConfigurationArgs and AgentlessConfigurationOutput values.
// You can construct a concrete instance of `AgentlessConfigurationInput` via:
//
//	AgentlessConfigurationArgs{...}
type AgentlessConfigurationInput interface {
	pulumi.Input

	ToAgentlessConfigurationOutput() AgentlessConfigurationOutput
	ToAgentlessConfigurationOutputWithContext(context.Context) AgentlessConfigurationOutput
}

// Details about Agentless configuration.
type AgentlessConfigurationArgs struct {
	// AutoDiscovery states.
	AgentlessAutoDiscovery pulumi.StringPtrInput `pulumi:"agentlessAutoDiscovery"`
	// Agentless Enablement states.
	AgentlessEnabled pulumi.StringPtrInput `pulumi:"agentlessEnabled"`
	// Gets or sets the inventory list for inclusion or exclusion from Agentless.
	// Will be ignored if agentless auto-discovery is enabled.
	InventoryList InventoryListArrayInput `pulumi:"inventoryList"`
	// Types for inventory list.
	InventoryListType pulumi.StringPtrInput `pulumi:"inventoryListType"`
	// Gets or sets the scanners for the connector.
	Scanners pulumi.StringArrayInput `pulumi:"scanners"`
}

func (AgentlessConfigurationArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*AgentlessConfiguration)(nil)).Elem()
}

func (i AgentlessConfigurationArgs) ToAgentlessConfigurationOutput() AgentlessConfigurationOutput {
	return i.ToAgentlessConfigurationOutputWithContext(context.Background())
}

func (i AgentlessConfigurationArgs) ToAgentlessConfigurationOutputWithContext(ctx context.Context) AgentlessConfigurationOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AgentlessConfigurationOutput)
}

func (i AgentlessConfigurationArgs) ToAgentlessConfigurationPtrOutput() AgentlessConfigurationPtrOutput {
	return i.ToAgentlessConfigurationPtrOutputWithContext(context.Background())
}

func (i AgentlessConfigurationArgs) ToAgentlessConfigurationPtrOutputWithContext(ctx context.Context) AgentlessConfigurationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AgentlessConfigurationOutput).ToAgentlessConfigurationPtrOutputWithContext(ctx)
}

// AgentlessConfigurationPtrInput is an input type that accepts AgentlessConfigurationArgs, AgentlessConfigurationPtr and AgentlessConfigurationPtrOutput values.
// You can construct a concrete instance of `AgentlessConfigurationPtrInput` via:
//
//	        AgentlessConfigurationArgs{...}
//
//	or:
//
//	        nil
type AgentlessConfigurationPtrInput interface {
	pulumi.Input

	ToAgentlessConfigurationPtrOutput() AgentlessConfigurationPtrOutput
	ToAgentlessConfigurationPtrOutputWithContext(context.Context) AgentlessConfigurationPtrOutput
}

type agentlessConfigurationPtrType AgentlessConfigurationArgs

func AgentlessConfigurationPtr(v *AgentlessConfigurationArgs) AgentlessConfigurationPtrInput {
	return (*agentlessConfigurationPtrType)(v)
}

func (*agentlessConfigurationPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**AgentlessConfiguration)(nil)).Elem()
}

func (i *agentlessConfigurationPtrType) ToAgentlessConfigurationPtrOutput() AgentlessConfigurationPtrOutput {
	return i.ToAgentlessConfigurationPtrOutputWithContext(context.Background())
}

func (i *agentlessConfigurationPtrType) ToAgentlessConfigurationPtrOutputWithContext(ctx context.Context) AgentlessConfigurationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AgentlessConfigurationPtrOutput)
}

// Details about Agentless configuration.
type AgentlessConfigurationOutput struct{ *pulumi.OutputState }

func (AgentlessConfigurationOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AgentlessConfiguration)(nil)).Elem()
}

func (o AgentlessConfigurationOutput) ToAgentlessConfigurationOutput() AgentlessConfigurationOutput {
	return o
}

func (o AgentlessConfigurationOutput) ToAgentlessConfigurationOutputWithContext(ctx context.Context) AgentlessConfigurationOutput {
	return o
}

func (o AgentlessConfigurationOutput) ToAgentlessConfigurationPtrOutput() AgentlessConfigurationPtrOutput {
	return o.ToAgentlessConfigurationPtrOutputWithContext(context.Background())
}

func (o AgentlessConfigurationOutput) ToAgentlessConfigurationPtrOutputWithContext(ctx context.Context) AgentlessConfigurationPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v AgentlessConfiguration) *AgentlessConfiguration {
		return &v
	}).(AgentlessConfigurationPtrOutput)
}

// AutoDiscovery states.
func (o AgentlessConfigurationOutput) AgentlessAutoDiscovery() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AgentlessConfiguration) *string { return v.AgentlessAutoDiscovery }).(pulumi.StringPtrOutput)
}

// Agentless Enablement states.
func (o AgentlessConfigurationOutput) AgentlessEnabled() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AgentlessConfiguration) *string { return v.AgentlessEnabled }).(pulumi.StringPtrOutput)
}

// Gets or sets the inventory list for inclusion or exclusion from Agentless.
// Will be ignored if agentless auto-discovery is enabled.
func (o AgentlessConfigurationOutput) InventoryList() InventoryListArrayOutput {
	return o.ApplyT(func(v AgentlessConfiguration) []InventoryList { return v.InventoryList }).(InventoryListArrayOutput)
}

// Types for inventory list.
func (o AgentlessConfigurationOutput) InventoryListType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AgentlessConfiguration) *string { return v.InventoryListType }).(pulumi.StringPtrOutput)
}

// Gets or sets the scanners for the connector.
func (o AgentlessConfigurationOutput) Scanners() pulumi.StringArrayOutput {
	return o.ApplyT(func(v AgentlessConfiguration) []string { return v.Scanners }).(pulumi.StringArrayOutput)
}

type AgentlessConfigurationPtrOutput struct{ *pulumi.OutputState }

func (AgentlessConfigurationPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AgentlessConfiguration)(nil)).Elem()
}

func (o AgentlessConfigurationPtrOutput) ToAgentlessConfigurationPtrOutput() AgentlessConfigurationPtrOutput {
	return o
}

func (o AgentlessConfigurationPtrOutput) ToAgentlessConfigurationPtrOutputWithContext(ctx context.Context) AgentlessConfigurationPtrOutput {
	return o
}

func (o AgentlessConfigurationPtrOutput) Elem() AgentlessConfigurationOutput {
	return o.ApplyT(func(v *AgentlessConfiguration) AgentlessConfiguration {
		if v != nil {
			return *v
		}
		var ret AgentlessConfiguration
		return ret
	}).(AgentlessConfigurationOutput)
}

// AutoDiscovery states.
func (o AgentlessConfigurationPtrOutput) AgentlessAutoDiscovery() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentlessConfiguration) *string {
		if v == nil {
			return nil
		}
		return v.AgentlessAutoDiscovery
	}).(pulumi.StringPtrOutput)
}

// Agentless Enablement states.
func (o AgentlessConfigurationPtrOutput) AgentlessEnabled() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentlessConfiguration) *string {
		if v == nil {
			return nil
		}
		return v.AgentlessEnabled
	}).(pulumi.StringPtrOutput)
}

// Gets or sets the inventory list for inclusion or exclusion from Agentless.
// Will be ignored if agentless auto-discovery is enabled.
func (o AgentlessConfigurationPtrOutput) InventoryList() InventoryListArrayOutput {
	return o.ApplyT(func(v *AgentlessConfiguration) []InventoryList {
		if v == nil {
			return nil
		}
		return v.InventoryList
	}).(InventoryListArrayOutput)
}

// Types for inventory list.
func (o AgentlessConfigurationPtrOutput) InventoryListType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentlessConfiguration) *string {
		if v == nil {
			return nil
		}
		return v.InventoryListType
	}).(pulumi.StringPtrOutput)
}

// Gets or sets the scanners for the connector.
func (o AgentlessConfigurationPtrOutput) Scanners() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AgentlessConfiguration) []string {
		if v == nil {
			return nil
		}
...
// Details about Agentless configuration.
type AgentlessConfigurationResponse struct {
	// AutoDiscovery states.
	AgentlessAutoDiscovery *string `pulumi:"agentlessAutoDiscovery"`
	// Agentless Enablement states.
	AgentlessEnabled *string `pulumi:"agentlessEnabled"`
	// Gets or sets the inventory list for inclusion or exclusion from Agentless.
	// Will be ignored if agentless auto-discovery is enabled.
	InventoryList []InventoryListResponse `pulumi:"inventoryList"`
	// Types for inventory list.
	InventoryListType *string `pulumi:"inventoryListType"`
	// Gets or sets the scanners for the connector.
	Scanners []string `pulumi:"scanners"`
...
// Details about Agentless configuration.
type AgentlessConfigurationResponseOutput struct{ *pulumi.OutputState }

func (AgentlessConfigurationResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AgentlessConfigurationResponse)(nil)).Elem()
}

func (o AgentlessConfigurationResponseOutput) ToAgentlessConfigurationResponseOutput() AgentlessConfigurationResponseOutput {
	return o
}

func (o AgentlessConfigurationResponseOutput) ToAgentlessConfigurationResponseOutputWithContext(ctx context.Context) AgentlessConfigurationResponseOutput {
	return o
}

// AutoDiscovery states.
func (o AgentlessConfigurationResponseOutput) AgentlessAutoDiscovery() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AgentlessConfigurationResponse) *string { return v.AgentlessAutoDiscovery }).(pulumi.StringPtrOutput)
}

// Agentless Enablement states.
func (o AgentlessConfigurationResponseOutput) AgentlessEnabled() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AgentlessConfigurationResponse) *string { return v.AgentlessEnabled }).(pulumi.StringPtrOutput)
}

// Gets or sets the inventory list for inclusion or exclusion from Agentless.
// Will be ignored if agentless auto-discovery is enabled.
func (o AgentlessConfigurationResponseOutput) InventoryList() InventoryListResponseArrayOutput {
	return o.ApplyT(func(v AgentlessConfigurationResponse) []InventoryListResponse { return v.InventoryList }).(InventoryListResponseArrayOutput)
}

// Types for inventory list.
func (o AgentlessConfigurationResponseOutput) InventoryListType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AgentlessConfigurationResponse) *string { return v.InventoryListType }).(pulumi.StringPtrOutput)
}

// Gets or sets the scanners for the connector.
func (o AgentlessConfigurationResponseOutput) Scanners() pulumi.StringArrayOutput {
	return o.ApplyT(func(v AgentlessConfigurationResponse) []string { return v.Scanners }).(pulumi.StringArrayOutput)
}

type AgentlessConfigurationResponsePtrOutput struct{ *pulumi.OutputState }

func (AgentlessConfigurationResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AgentlessConfigurationResponse)(nil)).Elem()
}

func (o AgentlessConfigurationResponsePtrOutput) ToAgentlessConfigurationResponsePtrOutput() AgentlessConfigurationResponsePtrOutput {
	return o
}

func (o AgentlessConfigurationResponsePtrOutput) ToAgentlessConfigurationResponsePtrOutputWithContext(ctx context.Context) AgentlessConfigurationResponsePtrOutput {
	return o
}

func (o AgentlessConfigurationResponsePtrOutput) Elem() AgentlessConfigurationResponseOutput {
	return o.ApplyT(func(v *AgentlessConfigurationResponse) AgentlessConfigurationResponse {
		if v != nil {
			return *v
		}
		var ret AgentlessConfigurationResponse
		return ret
	}).(AgentlessConfigurationResponseOutput)
}

// AutoDiscovery states.
func (o AgentlessConfigurationResponsePtrOutput) AgentlessAutoDiscovery() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentlessConfigurationResponse) *string {
		if v == nil {
			return nil
		}
		return v.AgentlessAutoDiscovery
...
// Agentless Enablement states.
func (o AgentlessConfigurationResponsePtrOutput) AgentlessEnabled() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentlessConfigurationResponse) *string {
		if v == nil {
			return nil
		}
...
// Gets or sets the inventory list for inclusion or exclusion from Agentless.
// Will be ignored if agentless auto-discovery is enabled.
func (o AgentlessConfigurationResponsePtrOutput) InventoryList() InventoryListResponseArrayOutput {
	return o.ApplyT(func(v *AgentlessConfigurationResponse) []InventoryListResponse {
		if v == nil {
			return nil
		}
		return v.InventoryList
	}).(InventoryListResponseArrayOutput)
}

// Types for inventory list.
func (o AgentlessConfigurationResponsePtrOutput) InventoryListType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AgentlessConfigurationResponse) *string {
		if v == nil {
			return nil
		}
...
// Gets or sets the scanners for the connector.
func (o AgentlessConfigurationResponsePtrOutput) Scanners() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AgentlessConfigurationResponse) []string {
		if v == nil {
			return nil
		}
...
type DevOpsConfigurationProperties struct {
	// Details about Agentless configuration.
	AgentlessConfiguration *AgentlessConfiguration `pulumi:"agentlessConfiguration"`
	// Authorization payload.
...
type DevOpsConfigurationPropertiesArgs struct {
	// Details about Agentless configuration.
	AgentlessConfiguration AgentlessConfigurationPtrInput `pulumi:"agentlessConfiguration"`
	// Authorization payload.
...
// Details about Agentless configuration.
func (o DevOpsConfigurationPropertiesOutput) AgentlessConfiguration() AgentlessConfigurationPtrOutput {
	return o.ApplyT(func(v DevOpsConfigurationProperties) *AgentlessConfiguration { return v.AgentlessConfiguration }).(AgentlessConfigurationPtrOutput)
}
...
// Details about Agentless configuration.
func (o DevOpsConfigurationPropertiesPtrOutput) AgentlessConfiguration() AgentlessConfigurationPtrOutput {
	return o.ApplyT(func(v *DevOpsConfigurationProperties) *AgentlessConfiguration {
		if v == nil {
			return nil
		}
		return v.AgentlessConfiguration
	}).(AgentlessConfigurationPtrOutput)
}
...
type DevOpsConfigurationPropertiesResponse struct {
	// Details about Agentless configuration.
	AgentlessConfiguration *AgentlessConfigurationResponse `pulumi:"agentlessConfiguration"`
	// Authorization payload.
...
// Details about Agentless configuration.
func (o DevOpsConfigurationPropertiesResponseOutput) AgentlessConfiguration() AgentlessConfigurationResponsePtrOutput {
	return o.ApplyT(func(v DevOpsConfigurationPropertiesResponse) *AgentlessConfigurationResponse {
		return v.AgentlessConfiguration
	}).(AgentlessConfigurationResponsePtrOutput)
}
...
type InventoryList struct {
	...
	InventoryKind *string `pulumi:"inventoryKind"`
	// Gets or sets the value for inventory type.
	Value *string `pulumi:"value"`
}

// InventoryListInput is an input type that accepts InventoryListArgs and InventoryListOutput values.
// You can construct a concrete instance of `InventoryListInput` via:
//
//	InventoryListArgs{...}
type InventoryListInput interface {
	pulumi.Input

	ToInventoryListOutput() InventoryListOutput
	ToInventoryListOutputWithContext(context.Context) InventoryListOutput
}

// Model for inventory to be included or excluded from Agentless.
type InventoryListArgs struct {
	// Types for inventory kind.
	InventoryKind pulumi.StringPtrInput `pulumi:"inventoryKind"`
	// Gets or sets the value for inventory type.
	Value pulumi.StringPtrInput `pulumi:"value"`
}

func (InventoryListArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*InventoryList)(nil)).Elem()
}

func (i InventoryListArgs) ToInventoryListOutput() InventoryListOutput {
	return i.ToInventoryListOutputWithContext(context.Background())
}

func (i InventoryListArgs) ToInventoryListOutputWithContext(ctx context.Context) InventoryListOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InventoryListOutput)
}

// InventoryListArrayInput is an input type that accepts InventoryListArray and InventoryListArrayOutput values.
// You can construct a concrete instance of `InventoryListArrayInput` via:
//
//	InventoryListArray{ InventoryListArgs{...} }
type InventoryListArrayInput interface {
	pulumi.Input

	ToInventoryListArrayOutput() InventoryListArrayOutput
	ToInventoryListArrayOutputWithContext(context.Context) InventoryListArrayOutput
}

type InventoryListArray []InventoryListInput

func (InventoryListArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]InventoryList)(nil)).Elem()
}

func (i InventoryListArray) ToInventoryListArrayOutput() InventoryListArrayOutput {
	return i.ToInventoryListArrayOutputWithContext(context.Background())
}

func (i InventoryListArray) ToInventoryListArrayOutputWithContext(ctx context.Context) InventoryListArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InventoryListArrayOutput)
}

// Model for inventory to be included or excluded from Agentless.
type InventoryListOutput struct{ *pulumi.OutputState }

func (InventoryListOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*InventoryList)(nil)).Elem()
}

func (o InventoryListOutput) ToInventoryListOutput() InventoryListOutput {
	return o
}

func (o InventoryListOutput) ToInventoryListOutputWithContext(ctx context.Context) InventoryListOutput {
	return o
}

// Types for inventory kind.
func (o InventoryListOutput) InventoryKind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InventoryList) *string { return v.InventoryKind }).(pulumi.StringPtrOutput)
}

// Gets or sets the value for inventory type.
func (o InventoryListOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InventoryList) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type InventoryListArrayOutput struct{ *pulumi.OutputState }

func (InventoryListArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]InventoryList)(nil)).Elem()
}

func (o InventoryListArrayOutput) ToInventoryListArrayOutput() InventoryListArrayOutput {
	return o
}

func (o InventoryListArrayOutput) ToInventoryListArrayOutputWithContext(ctx context.Context) InventoryListArrayOutput {
	return o
}

func (o InventoryListArrayOutput) Index(i pulumi.IntInput) InventoryListOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) InventoryList {
		return vs[0].([]InventoryList)[vs[1].(int)]
	}).(InventoryListOutput)
}
...
// Model for inventory to be included or excluded from Agentless.
type InventoryListResponseOutput struct{ *pulumi.OutputState }

func (InventoryListResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*InventoryListResponse)(nil)).Elem()
}

func (o InventoryListResponseOutput) ToInventoryListResponseOutput() InventoryListResponseOutput {
	return o
}

func (o InventoryListResponseOutput) ToInventoryListResponseOutputWithContext(ctx context.Context) InventoryListResponseOutput {
	return o
}

// Types for inventory kind.
func (o InventoryListResponseOutput) InventoryKind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InventoryListResponse) *string { return v.InventoryKind }).(pulumi.StringPtrOutput)
}

// Gets or sets the value for inventory type.
func (o InventoryListResponseOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InventoryListResponse) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type InventoryListResponseArrayOutput struct{ *pulumi.OutputState }

func (InventoryListResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]InventoryListResponse)(nil)).Elem()
}

func (o InventoryListResponseArrayOutput) ToInventoryListResponseArrayOutput() InventoryListResponseArrayOutput {
	return o
}

func (o InventoryListResponseArrayOutput) ToInventoryListResponseArrayOutputWithContext(ctx context.Context) InventoryListResponseArrayOutput {
	return o
}

func (o InventoryListResponseArrayOutput) Index(i pulumi.IntInput) InventoryListResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) InventoryListResponse {
		return vs[0].([]InventoryListResponse)[vs[1].(int)]
	}).(InventoryListResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(AgentlessConfigurationOutput{})
	pulumi.RegisterOutputType(AgentlessConfigurationPtrOutput{})
	pulumi.RegisterOutputType(AgentlessConfigurationResponseOutput{})
	pulumi.RegisterOutputType(AgentlessConfigurationResponsePtrOutput{})
	...
	pulumi.RegisterOutputType(InventoryListOutput{})
	pulumi.RegisterOutputType(InventoryListArrayOutput{})
	pulumi.RegisterOutputType(InventoryListResponseOutput{})
	pulumi.RegisterOutputType(InventoryListResponseArrayOutput{})
