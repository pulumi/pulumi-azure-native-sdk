...
type SecurityContact struct {
	...
	NotificationsByRole SecurityContactPropertiesNotificationsByRoleResponsePtrOutput `pulumi:"notificationsByRole"`
...
// Defines whether to send email notifications from Microsoft Defender for Cloud to persons with specific RBAC roles on the subscription.
func (o SecurityContactOutput) NotificationsByRole() SecurityContactPropertiesNotificationsByRoleResponsePtrOutput {
	return o.ApplyT(func(v *SecurityContact) SecurityContactPropertiesNotificationsByRoleResponsePtrOutput {
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SecurityContactOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *SecurityContact) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
