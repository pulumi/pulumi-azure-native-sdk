...
func NewPricing(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:security:Pricing"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Pricing
	err := ctx.RegisterResource("azure-native:security/v20240101:Pricing", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPricing(ctx *pulumi.Context,
	...
	var resource Pricing
	err := ctx.ReadResource("azure-native:security/v20240101:Pricing", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
