...
// AlertNotificationsInput is an input type that accepts values of the AlertNotifications enum
// A concrete instance of `AlertNotificationsInput` can be one of the following:
//
...
// AlertsToAdminsInput is an input type that accepts values of the AlertsToAdmins enum
// A concrete instance of `AlertsToAdminsInput` can be one of the following:
//
//	AlertsToAdminsOn
//	AlertsToAdminsOff
