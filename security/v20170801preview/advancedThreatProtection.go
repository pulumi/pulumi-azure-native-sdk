...
func NewAdvancedThreatProtection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security/v20170801preview:AdvancedThreatProtection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdvancedThreatProtection(ctx *pulumi.Context,
	...
	var resource AdvancedThreatProtection
	err := ctx.ReadResource("azure-native:security/v20170801preview:AdvancedThreatProtection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
