...
// Previous API Version: 2019-01-01. See https://github.com/pulumi/pulumi-azure-native/discussions/1834 for information on migrating from v1 to v2 of the provider.
...
func NewAdvancedThreatProtection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:security/v20190101:AdvancedThreatProtection"),
		},
	})
	opts = append(opts, aliases)
	var resource AdvancedThreatProtection
	err := ctx.RegisterResource("azure-native:security:AdvancedThreatProtection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdvancedThreatProtection(ctx *pulumi.Context,
	...
	var resource AdvancedThreatProtection
	err := ctx.ReadResource("azure-native:security:AdvancedThreatProtection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
