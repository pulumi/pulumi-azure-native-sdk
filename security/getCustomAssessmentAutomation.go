...
// The Azure API version of the resource.
func (o LookupCustomAssessmentAutomationResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCustomAssessmentAutomationResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
