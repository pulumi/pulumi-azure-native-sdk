...
func ListGitLabSubgroup(ctx *pulumi.Context, args *ListGitLabSubgroupArgs, opts ...pulumi.InvokeOption) (*ListGitLabSubgroupResult, error) {
	...
	err := ctx.Invoke("azure-native:security/v20240515preview:listGitLabSubgroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListGitLabSubgroupOutput(ctx *pulumi.Context, args ListGitLabSubgroupOutputArgs, opts ...pulumi.InvokeOption) ListGitLabSubgroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListGitLabSubgroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:security/v20240515preview:listGitLabSubgroup", args, ListGitLabSubgroupResultOutput{}, options).(ListGitLabSubgroupResultOutput), nil
