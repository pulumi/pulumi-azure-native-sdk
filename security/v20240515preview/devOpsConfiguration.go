...
func NewDevOpsConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security/v20240515preview:DevOpsConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevOpsConfiguration(ctx *pulumi.Context,
	...
	var resource DevOpsConfiguration
	err := ctx.ReadResource("azure-native:security/v20240515preview:DevOpsConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
