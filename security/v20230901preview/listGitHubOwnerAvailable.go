...
func (o ListGitHubOwnerAvailableResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListGitHubOwnerAvailableResult] {
	return pulumix.Output[ListGitHubOwnerAvailableResult]{
