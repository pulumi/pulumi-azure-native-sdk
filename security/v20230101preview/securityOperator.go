...
func NewSecurityOperator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:security:SecurityOperator"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SecurityOperator
	err := ctx.RegisterResource("azure-native:security/v20230101preview:SecurityOperator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityOperator(ctx *pulumi.Context,
	...
	var resource SecurityOperator
	err := ctx.ReadResource("azure-native:security/v20230101preview:SecurityOperator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
