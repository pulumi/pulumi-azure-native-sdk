...
func NewAPICollectionByAzureApiManagementService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security/v20231115:APICollectionByAzureApiManagementService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAPICollectionByAzureApiManagementService(ctx *pulumi.Context,
	...
	var resource APICollectionByAzureApiManagementService
	err := ctx.ReadResource("azure-native:security/v20231115:APICollectionByAzureApiManagementService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
