...
func LookupSecurityStandard(ctx *pulumi.Context, args *LookupSecurityStandardArgs, opts ...pulumi.InvokeOption) (*LookupSecurityStandardResult, error) {
	...
	err := ctx.Invoke("azure-native:security:getSecurityStandard", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSecurityStandardResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSecurityStandardResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
