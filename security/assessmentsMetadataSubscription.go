...
func NewAssessmentsMetadataSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security:AssessmentsMetadataSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssessmentsMetadataSubscription(ctx *pulumi.Context,
	...
	var resource AssessmentsMetadataSubscription
	err := ctx.ReadResource("azure-native:security:AssessmentsMetadataSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
