...
func NewDefenderForStorage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security/v20221201preview:DefenderForStorage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefenderForStorage(ctx *pulumi.Context,
	...
	var resource DefenderForStorage
	err := ctx.ReadResource("azure-native:security/v20221201preview:DefenderForStorage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
