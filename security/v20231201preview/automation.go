...
func NewAutomation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security/v20231201preview:Automation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutomation(ctx *pulumi.Context,
	...
	var resource Automation
	err := ctx.ReadResource("azure-native:security/v20231201preview:Automation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
