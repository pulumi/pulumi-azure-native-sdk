...
func NewSecurityContact(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security/v20231201preview:SecurityContact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityContact(ctx *pulumi.Context,
	...
	var resource SecurityContact
	err := ctx.ReadResource("azure-native:security/v20231201preview:SecurityContact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
