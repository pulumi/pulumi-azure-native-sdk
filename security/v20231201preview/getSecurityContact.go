...
func LookupSecurityContact(ctx *pulumi.Context, args *LookupSecurityContactArgs, opts ...pulumi.InvokeOption) (*LookupSecurityContactResult, error) {
	...
	err := ctx.Invoke("azure-native:security/v20231201preview:getSecurityContact", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSecurityContactOutput(ctx *pulumi.Context, args LookupSecurityContactOutputArgs, opts ...pulumi.InvokeOption) LookupSecurityContactResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSecurityContactResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:security/v20231201preview:getSecurityContact", args, LookupSecurityContactResultOutput{}, options).(LookupSecurityContactResultOutput), nil
