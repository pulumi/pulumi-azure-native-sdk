...
// The Azure API version of the resource.
func (o CustomAssessmentAutomationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CustomAssessmentAutomation) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
