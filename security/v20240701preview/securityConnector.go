...
func NewSecurityConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security/v20240701preview:SecurityConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityConnector(ctx *pulumi.Context,
	...
	var resource SecurityConnector
	err := ctx.ReadResource("azure-native:security/v20240701preview:SecurityConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
