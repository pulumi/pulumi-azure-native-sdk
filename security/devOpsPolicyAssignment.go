...
func NewDevOpsPolicyAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:security/v20240515preview:DevOpsPolicyAssignment"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DevOpsPolicyAssignment
	err := ctx.RegisterResource("azure-native:security:DevOpsPolicyAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevOpsPolicyAssignment(ctx *pulumi.Context,
	...
	var resource DevOpsPolicyAssignment
	err := ctx.ReadResource("azure-native:security:DevOpsPolicyAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
