...
func NewDeviceSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:security:DeviceSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceSecurityGroup(ctx *pulumi.Context,
	...
	var resource DeviceSecurityGroup
	err := ctx.ReadResource("azure-native:security:DeviceSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *DeviceSecurityGroup) ToOutput(ctx context.Context) pulumix.Output[*DeviceSecurityGroup] {
	return pulumix.Output[*DeviceSecurityGroup]{
		OutputState: i.ToDeviceSecurityGroupOutputWithContext(ctx).OutputState,
	}
}
...
func (o DeviceSecurityGroupOutput) ToOutput(ctx context.Context) pulumix.Output[*DeviceSecurityGroup] {
	return pulumix.Output[*DeviceSecurityGroup]{
