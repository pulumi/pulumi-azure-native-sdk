...
// OrganizationMembershipTypeInput is an input type that accepts values of the OrganizationMembershipType enum
// A concrete instance of `OrganizationMembershipTypeInput` can be one of the following:
//
...
func (in *organizationMembershipTypePtr) ToOutput(ctx context.Context) pulumix.Output[*OrganizationMembershipType] {
	return pulumix.Output[*OrganizationMembershipType]{
		OutputState: in.ToOrganizationMembershipTypePtrOutputWithContext(ctx).OutputState,
	}
}
...
func (in *severityEnumPtr) ToOutput(ctx context.Context) pulumix.Output[*SeverityEnum] {
	return pulumix.Output[*SeverityEnum]{
		OutputState: in.ToSeverityEnumPtrOutputWithContext(ctx).OutputState,
	}
}
...
func (in *supportedCloudEnumPtr) ToOutput(ctx context.Context) pulumix.Output[*SupportedCloudEnum] {
	return pulumix.Output[*SupportedCloudEnum]{
		OutputState: in.ToSupportedCloudEnumPtrOutputWithContext(ctx).OutputState,
	}
}
