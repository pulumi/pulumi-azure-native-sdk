...
//
// Deprecated: azure-native:peering/v20210101:Peering is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:Peering to guarantee forwards compatibility.
type Peering struct {
...
func NewPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20210101:Peering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeering(ctx *pulumi.Context,
	...
	var resource Peering
	err := ctx.ReadResource("azure-native:peering/v20210101:Peering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
