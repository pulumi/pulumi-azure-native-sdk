...
// azure-native:peering/v20200401:RegisteredAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredAsn to guarantee forwards compatibility.
...
func NewRegisteredAsn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20200401:RegisteredAsn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredAsn(ctx *pulumi.Context,
	...
	var resource RegisteredAsn
	err := ctx.ReadResource("azure-native:peering/v20200401:RegisteredAsn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
