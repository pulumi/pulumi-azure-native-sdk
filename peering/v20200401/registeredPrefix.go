...
func NewRegisteredPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20200401:RegisteredPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredPrefix(ctx *pulumi.Context,
	...
	var resource RegisteredPrefix
	err := ctx.ReadResource("azure-native:peering/v20200401:RegisteredPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
