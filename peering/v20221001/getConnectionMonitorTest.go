...
func LookupConnectionMonitorTest(ctx *pulumi.Context, args *LookupConnectionMonitorTestArgs, opts ...pulumi.InvokeOption) (*LookupConnectionMonitorTestResult, error) {
	...
	err := ctx.Invoke("azure-native:peering/v20221001:getConnectionMonitorTest", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConnectionMonitorTestOutput(ctx *pulumi.Context, args LookupConnectionMonitorTestOutputArgs, opts ...pulumi.InvokeOption) LookupConnectionMonitorTestResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConnectionMonitorTestResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:peering/v20221001:getConnectionMonitorTest", args, LookupConnectionMonitorTestResultOutput{}, options).(LookupConnectionMonitorTestResultOutput), nil
