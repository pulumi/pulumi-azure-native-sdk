...
//
// Deprecated: azure-native:peering/v20220601:RegisteredAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredAsn to guarantee forwards compatibility.
func LookupRegisteredAsn(ctx *pulumi.Context, args *LookupRegisteredAsnArgs, opts ...pulumi.InvokeOption) (*LookupRegisteredAsnResult, error) {
	...
	err := ctx.Invoke("azure-native:peering/v20220601:getRegisteredAsn", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
