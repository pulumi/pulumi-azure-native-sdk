...
func NewConnectionMonitorTest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20220601:ConnectionMonitorTest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionMonitorTest(ctx *pulumi.Context,
	...
	var resource ConnectionMonitorTest
	err := ctx.ReadResource("azure-native:peering/v20220601:ConnectionMonitorTest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
