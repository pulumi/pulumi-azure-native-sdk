...
func NewPeeringService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20220601:PeeringService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeeringService(ctx *pulumi.Context,
	...
	var resource PeeringService
	err := ctx.ReadResource("azure-native:peering/v20220601:PeeringService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
