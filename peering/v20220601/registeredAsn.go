...
func NewRegisteredAsn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20220601:RegisteredAsn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegisteredAsn(ctx *pulumi.Context,
	...
	var resource RegisteredAsn
	err := ctx.ReadResource("azure-native:peering/v20220601:RegisteredAsn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
