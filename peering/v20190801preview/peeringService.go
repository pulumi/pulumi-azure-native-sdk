...
// azure-native:peering/v20190801preview:PeeringService is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:PeeringService to guarantee forwards compatibility.
...
func NewPeeringService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20190801preview:PeeringService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeeringService(ctx *pulumi.Context,
	...
	var resource PeeringService
	err := ctx.ReadResource("azure-native:peering/v20190801preview:PeeringService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
