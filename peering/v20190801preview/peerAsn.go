...
func NewPeerAsn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20190801preview:PeerAsn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeerAsn(ctx *pulumi.Context,
	...
	var resource PeerAsn
	err := ctx.ReadResource("azure-native:peering/v20190801preview:PeerAsn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The contact information of the peer.
func (o PeerAsnOutput) PeerContactInfo() ContactInfoResponsePtrOutput {
	return o.ApplyT(func(v *PeerAsn) ContactInfoResponsePtrOutput { return v.PeerContactInfo }).(ContactInfoResponsePtrOutput)
}
