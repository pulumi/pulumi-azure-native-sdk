...
//
// Deprecated: azure-native:peering/v20210601:PeerAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:PeerAsn to guarantee forwards compatibility.
type PeerAsn struct {
...
func NewPeerAsn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20210601:PeerAsn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeerAsn(ctx *pulumi.Context,
	...
	var resource PeerAsn
	err := ctx.ReadResource("azure-native:peering/v20210601:PeerAsn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
