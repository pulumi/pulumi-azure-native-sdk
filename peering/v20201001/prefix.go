...
func NewPrefix(ctx *pulumi.Context,
	...
	var resource Prefix
	err := ctx.RegisterResource("azure-native:peering/v20201001:Prefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrefix(ctx *pulumi.Context,
	...
	var resource Prefix
	err := ctx.ReadResource("azure-native:peering/v20201001:Prefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
