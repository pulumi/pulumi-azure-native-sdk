...
func NewPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:peering/v20201001:Peering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeering(ctx *pulumi.Context,
	...
	var resource Peering
	err := ctx.ReadResource("azure-native:peering/v20201001:Peering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
