...
// azure-native:peering/v20201001:Peering is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:Peering to guarantee forwards compatibility.
func LookupPeering(ctx *pulumi.Context, args *LookupPeeringArgs, opts ...pulumi.InvokeOption) (*LookupPeeringResult, error) {
	...
	err := ctx.Invoke("azure-native:peering/v20201001:getPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
