...
func NewIoTHubEventSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights/v20171115:IoTHubEventSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoTHubEventSource(ctx *pulumi.Context,
	...
	var resource IoTHubEventSource
	err := ctx.ReadResource("azure-native:timeseriesinsights/v20171115:IoTHubEventSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
