...
func NewReferenceDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights/v20171115:ReferenceDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReferenceDataSet(ctx *pulumi.Context,
	...
	var resource ReferenceDataSet
	err := ctx.ReadResource("azure-native:timeseriesinsights/v20171115:ReferenceDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
