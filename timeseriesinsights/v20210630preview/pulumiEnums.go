...
// IngressStartAtTypeInput is an input type that accepts values of the IngressStartAtType enum
// A concrete instance of `IngressStartAtTypeInput` can be one of the following:
//
...
// LocalTimestampFormatInput is an input type that accepts values of the LocalTimestampFormat enum
// A concrete instance of `LocalTimestampFormatInput` can be one of the following:
//
...
// StorageLimitExceededBehaviorInput is an input type that accepts values of the StorageLimitExceededBehavior enum
// A concrete instance of `StorageLimitExceededBehaviorInput` can be one of the following:
//
