...
func NewGen1Environment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights/v20210630preview:Gen1Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGen1Environment(ctx *pulumi.Context,
	...
	var resource Gen1Environment
	err := ctx.ReadResource("azure-native:timeseriesinsights/v20210630preview:Gen1Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *Gen1Environment) ToOutput(ctx context.Context) pulumix.Output[*Gen1Environment] {
	return pulumix.Output[*Gen1Environment]{
		OutputState: i.ToGen1EnvironmentOutputWithContext(ctx).OutputState,
	}
}
...
func (o Gen1EnvironmentOutput) ToOutput(ctx context.Context) pulumix.Output[*Gen1Environment] {
	return pulumix.Output[*Gen1Environment]{
