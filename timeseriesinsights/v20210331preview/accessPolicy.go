...
func NewAccessPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights/v20210331preview:AccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessPolicy(ctx *pulumi.Context,
	...
	var resource AccessPolicy
	err := ctx.ReadResource("azure-native:timeseriesinsights/v20210331preview:AccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
