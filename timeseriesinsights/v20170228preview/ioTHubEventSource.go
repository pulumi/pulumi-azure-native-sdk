...
//
// Deprecated: azure-native:timeseriesinsights/v20170228preview:IoTHubEventSource is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.
...
func NewIoTHubEventSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights/v20170228preview:IoTHubEventSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIoTHubEventSource(ctx *pulumi.Context,
	...
	var resource IoTHubEventSource
	err := ctx.ReadResource("azure-native:timeseriesinsights/v20170228preview:IoTHubEventSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
