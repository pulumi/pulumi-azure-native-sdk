...
func NewEventHubEventSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights/v20170228preview:EventHubEventSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventHubEventSource(ctx *pulumi.Context,
	...
	var resource EventHubEventSource
	err := ctx.ReadResource("azure-native:timeseriesinsights/v20170228preview:EventHubEventSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
