...
func NewSapLandscapeMonitor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20240201preview:SapLandscapeMonitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSapLandscapeMonitor(ctx *pulumi.Context,
	...
	var resource SapLandscapeMonitor
	err := ctx.ReadResource("azure-native:workloads/v20240201preview:SapLandscapeMonitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
