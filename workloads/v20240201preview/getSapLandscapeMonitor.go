...
func LookupSapLandscapeMonitor(ctx *pulumi.Context, args *LookupSapLandscapeMonitorArgs, opts ...pulumi.InvokeOption) (*LookupSapLandscapeMonitorResult, error) {
	...
	err := ctx.Invoke("azure-native:workloads/v20240201preview:getSapLandscapeMonitor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSapLandscapeMonitorOutput(ctx *pulumi.Context, args LookupSapLandscapeMonitorOutputArgs, opts ...pulumi.InvokeOption) LookupSapLandscapeMonitorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSapLandscapeMonitorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads/v20240201preview:getSapLandscapeMonitor", args, LookupSapLandscapeMonitorResultOutput{}, options).(LookupSapLandscapeMonitorResultOutput), nil
