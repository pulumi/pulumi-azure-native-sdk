...
func NewMonitor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20240201preview:Monitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitor(ctx *pulumi.Context,
	...
	var resource Monitor
	err := ctx.ReadResource("azure-native:workloads/v20240201preview:Monitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
