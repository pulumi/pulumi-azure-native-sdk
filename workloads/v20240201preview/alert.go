...
func NewAlert(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:workloads:Alert"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Alert
	err := ctx.RegisterResource("azure-native:workloads/v20240201preview:Alert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlert(ctx *pulumi.Context,
	...
	var resource Alert
	err := ctx.ReadResource("azure-native:workloads/v20240201preview:Alert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
