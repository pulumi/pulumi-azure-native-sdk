...
func LookupSAPApplicationServerInstance(ctx *pulumi.Context, args *LookupSAPApplicationServerInstanceArgs, opts ...pulumi.InvokeOption) (*LookupSAPApplicationServerInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:workloads/v20230401:getSAPApplicationServerInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSAPApplicationServerInstanceOutput(ctx *pulumi.Context, args LookupSAPApplicationServerInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupSAPApplicationServerInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSAPApplicationServerInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads/v20230401:getSAPApplicationServerInstance", args, LookupSAPApplicationServerInstanceResultOutput{}, options).(LookupSAPApplicationServerInstanceResultOutput), nil
