...
func NewSAPCentralInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20230401:SAPCentralInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAPCentralInstance(ctx *pulumi.Context,
	...
	var resource SAPCentralInstance
	err := ctx.ReadResource("azure-native:workloads/v20230401:SAPCentralInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
