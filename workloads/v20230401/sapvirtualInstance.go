...
func NewSAPVirtualInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20230401:SAPVirtualInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAPVirtualInstance(ctx *pulumi.Context,
	...
	var resource SAPVirtualInstance
	err := ctx.ReadResource("azure-native:workloads/v20230401:SAPVirtualInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *SAPVirtualInstance) ToOutput(ctx context.Context) pulumix.Output[*SAPVirtualInstance] {
	return pulumix.Output[*SAPVirtualInstance]{
		OutputState: i.ToSAPVirtualInstanceOutputWithContext(ctx).OutputState,
	}
}
...
func (o SAPVirtualInstanceOutput) ToOutput(ctx context.Context) pulumix.Output[*SAPVirtualInstance] {
	return pulumix.Output[*SAPVirtualInstance]{
