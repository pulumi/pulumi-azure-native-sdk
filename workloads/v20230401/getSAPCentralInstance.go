...
func LookupSAPCentralInstance(ctx *pulumi.Context, args *LookupSAPCentralInstanceArgs, opts ...pulumi.InvokeOption) (*LookupSAPCentralInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:workloads/v20230401:getSAPCentralInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSAPCentralInstanceOutput(ctx *pulumi.Context, args LookupSAPCentralInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupSAPCentralInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSAPCentralInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads/v20230401:getSAPCentralInstance", args, LookupSAPCentralInstanceResultOutput{}, options).(LookupSAPCentralInstanceResultOutput), nil
