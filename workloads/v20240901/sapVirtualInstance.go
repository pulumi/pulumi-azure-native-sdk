...
func NewSapVirtualInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20240901:SapVirtualInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSapVirtualInstance(ctx *pulumi.Context,
	...
	var resource SapVirtualInstance
	err := ctx.ReadResource("azure-native:workloads/v20240901:SapVirtualInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
