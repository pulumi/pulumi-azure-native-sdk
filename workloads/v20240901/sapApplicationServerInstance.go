...
func NewSapApplicationServerInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20240901:SapApplicationServerInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSapApplicationServerInstance(ctx *pulumi.Context,
	...
	var resource SapApplicationServerInstance
	err := ctx.ReadResource("azure-native:workloads/v20240901:SapApplicationServerInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
