...
func LookupSapDatabaseInstanceOutput(ctx *pulumi.Context, args LookupSapDatabaseInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupSapDatabaseInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSapDatabaseInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads:getSapDatabaseInstance", args, LookupSapDatabaseInstanceResultOutput{}, options).(LookupSapDatabaseInstanceResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSapDatabaseInstanceResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSapDatabaseInstanceResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSapDatabaseInstanceResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSapDatabaseInstanceResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
