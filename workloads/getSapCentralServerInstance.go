...
func LookupSapCentralServerInstance(ctx *pulumi.Context, args *LookupSapCentralServerInstanceArgs, opts ...pulumi.InvokeOption) (*LookupSapCentralServerInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:workloads:getSapCentralServerInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSapCentralServerInstanceOutput(ctx *pulumi.Context, args LookupSapCentralServerInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupSapCentralServerInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSapCentralServerInstanceResultOutput, error) {
			args := v.(LookupSapCentralServerInstanceArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:workloads:getSapCentralServerInstance", args, LookupSapCentralServerInstanceResultOutput{}, options).(LookupSapCentralServerInstanceResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSapCentralServerInstanceResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSapCentralServerInstanceResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSapCentralServerInstanceResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSapCentralServerInstanceResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
