...
func LookupSapVirtualInstanceOutput(ctx *pulumi.Context, args LookupSapVirtualInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupSapVirtualInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSapVirtualInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads:getSapVirtualInstance", args, LookupSapVirtualInstanceResultOutput{}, options).(LookupSapVirtualInstanceResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSapVirtualInstanceResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSapVirtualInstanceResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSapVirtualInstanceResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSapVirtualInstanceResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
