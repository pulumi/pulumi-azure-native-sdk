...
func NewSAPDatabaseInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20231001preview:SAPDatabaseInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAPDatabaseInstance(ctx *pulumi.Context,
	...
	var resource SAPDatabaseInstance
	err := ctx.ReadResource("azure-native:workloads/v20231001preview:SAPDatabaseInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
