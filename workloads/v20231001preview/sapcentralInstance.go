...
func NewSAPCentralInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:workloads/v20240901:SAPCentralInstance"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:workloads/v20231001preview:SAPCentralInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAPCentralInstance(ctx *pulumi.Context,
	...
	var resource SAPCentralInstance
	err := ctx.ReadResource("azure-native:workloads/v20231001preview:SAPCentralInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
