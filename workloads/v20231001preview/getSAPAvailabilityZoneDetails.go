...
func GetSAPAvailabilityZoneDetails(ctx *pulumi.Context, args *GetSAPAvailabilityZoneDetailsArgs, opts ...pulumi.InvokeOption) (*GetSAPAvailabilityZoneDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:workloads/v20231001preview:getSAPAvailabilityZoneDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSAPAvailabilityZoneDetailsOutput(ctx *pulumi.Context, args GetSAPAvailabilityZoneDetailsOutputArgs, opts ...pulumi.InvokeOption) GetSAPAvailabilityZoneDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSAPAvailabilityZoneDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads/v20231001preview:getSAPAvailabilityZoneDetails", args, GetSAPAvailabilityZoneDetailsResultOutput{}, options).(GetSAPAvailabilityZoneDetailsResultOutput), nil
