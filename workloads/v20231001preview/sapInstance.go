...
func NewSapInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:workloads:SapInstance"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SapInstance
	err := ctx.RegisterResource("azure-native:workloads/v20231001preview:SapInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSapInstance(ctx *pulumi.Context,
	...
	var resource SapInstance
	err := ctx.ReadResource("azure-native:workloads/v20231001preview:SapInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
