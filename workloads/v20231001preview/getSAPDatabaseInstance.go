...
func LookupSAPDatabaseInstance(ctx *pulumi.Context, args *LookupSAPDatabaseInstanceArgs, opts ...pulumi.InvokeOption) (*LookupSAPDatabaseInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:workloads/v20231001preview:getSAPDatabaseInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSAPDatabaseInstanceOutput(ctx *pulumi.Context, args LookupSAPDatabaseInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupSAPDatabaseInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSAPDatabaseInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads/v20231001preview:getSAPDatabaseInstance", args, LookupSAPDatabaseInstanceResultOutput{}, options).(LookupSAPDatabaseInstanceResultOutput), nil
