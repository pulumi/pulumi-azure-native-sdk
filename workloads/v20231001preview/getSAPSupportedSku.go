...
func GetSAPSupportedSku(ctx *pulumi.Context, args *GetSAPSupportedSkuArgs, opts ...pulumi.InvokeOption) (*GetSAPSupportedSkuResult, error) {
	...
	err := ctx.Invoke("azure-native:workloads/v20231001preview:getSAPSupportedSku", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSAPSupportedSkuOutput(ctx *pulumi.Context, args GetSAPSupportedSkuOutputArgs, opts ...pulumi.InvokeOption) GetSAPSupportedSkuResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSAPSupportedSkuResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads/v20231001preview:getSAPSupportedSku", args, GetSAPSupportedSkuResultOutput{}, options).(GetSAPSupportedSkuResultOutput), nil
