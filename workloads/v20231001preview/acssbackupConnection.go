...
func NewACSSBackupConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:workloads:ACSSBackupConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ACSSBackupConnection
	err := ctx.RegisterResource("azure-native:workloads/v20231001preview:ACSSBackupConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetACSSBackupConnection(ctx *pulumi.Context,
	...
	var resource ACSSBackupConnection
	err := ctx.ReadResource("azure-native:workloads/v20231001preview:ACSSBackupConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
