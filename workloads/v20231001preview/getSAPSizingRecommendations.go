...
func GetSAPSizingRecommendations(ctx *pulumi.Context, args *GetSAPSizingRecommendationsArgs, opts ...pulumi.InvokeOption) (*GetSAPSizingRecommendationsResult, error) {
	...
	err := ctx.Invoke("azure-native:workloads/v20231001preview:getSAPSizingRecommendations", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSAPSizingRecommendationsOutput(ctx *pulumi.Context, args GetSAPSizingRecommendationsOutputArgs, opts ...pulumi.InvokeOption) GetSAPSizingRecommendationsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSAPSizingRecommendationsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:workloads/v20231001preview:getSAPSizingRecommendations", args, GetSAPSizingRecommendationsResultOutput{}, options).(GetSAPSizingRecommendationsResultOutput), nil
