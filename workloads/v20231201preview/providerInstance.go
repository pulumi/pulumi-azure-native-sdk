...
func NewProviderInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20231201preview:ProviderInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProviderInstance(ctx *pulumi.Context,
	...
	var resource ProviderInstance
	err := ctx.ReadResource("azure-native:workloads/v20231201preview:ProviderInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
