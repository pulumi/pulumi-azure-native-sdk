...
func NewSapDatabaseInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:workloads/v20240901:SapDatabaseInstance"),
		},
		{
...
// The Azure API version of the resource.
func (o SapDatabaseInstanceOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SapDatabaseInstance) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SapDatabaseInstanceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *SapDatabaseInstance) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
