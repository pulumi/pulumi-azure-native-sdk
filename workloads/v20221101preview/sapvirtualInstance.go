...
func NewSAPVirtualInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20221101preview:SAPVirtualInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAPVirtualInstance(ctx *pulumi.Context,
	...
	var resource SAPVirtualInstance
	err := ctx.ReadResource("azure-native:workloads/v20221101preview:SAPVirtualInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
