...
func NewSAPApplicationServerInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:workloads/v20221101preview:SAPApplicationServerInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAPApplicationServerInstance(ctx *pulumi.Context,
	...
	var resource SAPApplicationServerInstance
	err := ctx.ReadResource("azure-native:workloads/v20221101preview:SAPApplicationServerInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
