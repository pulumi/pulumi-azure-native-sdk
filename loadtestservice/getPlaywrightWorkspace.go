...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupPlaywrightWorkspaceResultOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPlaywrightWorkspaceResult) commontypesv6.SystemDataResponse { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
...
// The workspace ID in GUID format.
func (o LookupPlaywrightWorkspaceResultOutput) WorkspaceId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPlaywrightWorkspaceResult) string { return v.WorkspaceId }).(pulumi.StringOutput)
}
