...
func NewLoadTest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:loadtestservice/v20241201preview:LoadTest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadTest(ctx *pulumi.Context,
	...
	var resource LoadTest
	err := ctx.ReadResource("azure-native:loadtestservice/v20241201preview:LoadTest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
