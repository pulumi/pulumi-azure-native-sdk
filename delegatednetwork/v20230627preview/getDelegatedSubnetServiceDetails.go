...
func LookupDelegatedSubnetServiceDetails(ctx *pulumi.Context, args *LookupDelegatedSubnetServiceDetailsArgs, opts ...pulumi.InvokeOption) (*LookupDelegatedSubnetServiceDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:delegatednetwork/v20230627preview:getDelegatedSubnetServiceDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDelegatedSubnetServiceDetailsOutput(ctx *pulumi.Context, args LookupDelegatedSubnetServiceDetailsOutputArgs, opts ...pulumi.InvokeOption) LookupDelegatedSubnetServiceDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDelegatedSubnetServiceDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:delegatednetwork/v20230627preview:getDelegatedSubnetServiceDetails", args, LookupDelegatedSubnetServiceDetailsResultOutput{}, options).(LookupDelegatedSubnetServiceDetailsResultOutput), nil
