...
func NewControllerDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:delegatednetwork/v20230518preview:ControllerDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetControllerDetails(ctx *pulumi.Context,
	...
	var resource ControllerDetails
	err := ctx.ReadResource("azure-native:delegatednetwork/v20230518preview:ControllerDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
