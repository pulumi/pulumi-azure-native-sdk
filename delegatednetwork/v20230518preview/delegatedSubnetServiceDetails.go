...
func NewDelegatedSubnetServiceDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:delegatednetwork/v20230518preview:DelegatedSubnetServiceDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDelegatedSubnetServiceDetails(ctx *pulumi.Context,
	...
	var resource DelegatedSubnetServiceDetails
	err := ctx.ReadResource("azure-native:delegatednetwork/v20230518preview:DelegatedSubnetServiceDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
