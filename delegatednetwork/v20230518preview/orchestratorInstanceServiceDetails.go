...
func NewOrchestratorInstanceServiceDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:delegatednetwork/v20230518preview:OrchestratorInstanceServiceDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrchestratorInstanceServiceDetails(ctx *pulumi.Context,
	...
	var resource OrchestratorInstanceServiceDetails
	err := ctx.ReadResource("azure-native:delegatednetwork/v20230518preview:OrchestratorInstanceServiceDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
