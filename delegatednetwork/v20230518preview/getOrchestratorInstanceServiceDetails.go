...
func LookupOrchestratorInstanceServiceDetails(ctx *pulumi.Context, args *LookupOrchestratorInstanceServiceDetailsArgs, opts ...pulumi.InvokeOption) (*LookupOrchestratorInstanceServiceDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:delegatednetwork/v20230518preview:getOrchestratorInstanceServiceDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupOrchestratorInstanceServiceDetailsOutput(ctx *pulumi.Context, args LookupOrchestratorInstanceServiceDetailsOutputArgs, opts ...pulumi.InvokeOption) LookupOrchestratorInstanceServiceDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOrchestratorInstanceServiceDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:delegatednetwork/v20230518preview:getOrchestratorInstanceServiceDetails", args, LookupOrchestratorInstanceServiceDetailsResultOutput{}, options).(LookupOrchestratorInstanceServiceDetailsResultOutput), nil
