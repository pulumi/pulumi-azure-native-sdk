...
func NewVolumeSnapshot(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:containerstorage/v20230301preview:VolumeSnapshot"),
		},
	})
	opts = append(opts, aliases)
	var resource VolumeSnapshot
	err := ctx.RegisterResource("azure-native:containerstorage:VolumeSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeSnapshot(ctx *pulumi.Context,
	...
	var resource VolumeSnapshot
	err := ctx.ReadResource("azure-native:containerstorage:VolumeSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
