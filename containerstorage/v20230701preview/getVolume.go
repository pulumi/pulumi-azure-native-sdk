...
func LookupVolume(ctx *pulumi.Context, args *LookupVolumeArgs, opts ...pulumi.InvokeOption) (*LookupVolumeResult, error) {
	...
	err := ctx.Invoke("azure-native:containerstorage/v20230701preview:getVolume", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVolumeOutput(ctx *pulumi.Context, args LookupVolumeOutputArgs, opts ...pulumi.InvokeOption) LookupVolumeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVolumeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:containerstorage/v20230701preview:getVolume", args, LookupVolumeResultOutput{}, options).(LookupVolumeResultOutput), nil
