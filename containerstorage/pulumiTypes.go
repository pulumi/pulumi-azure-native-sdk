...
type EncryptionArgs struct {
	// The managed service identities assigned to this resource.
	Identity commontypesv4.ManagedServiceIdentityPtrInput `pulumi:"identity"`
	// The name of the key vault key.
...
// The managed service identities assigned to this resource.
func (o EncryptionOutput) Identity() commontypesv4.ManagedServiceIdentityPtrOutput {
	return o.ApplyT(func(v Encryption) *commontypesv4.ManagedServiceIdentity { return v.Identity }).(commontypesv4.ManagedServiceIdentityPtrOutput)
}
...
// The managed service identities assigned to this resource.
func (o EncryptionPtrOutput) Identity() commontypesv4.ManagedServiceIdentityPtrOutput {
	return o.ApplyT(func(v *Encryption) *commontypesv4.ManagedServiceIdentity {
		if v == nil {
			return nil
		}
		return v.Identity
	}).(commontypesv4.ManagedServiceIdentityPtrOutput)
}
...
// The managed service identities assigned to this resource.
func (o EncryptionResponseOutput) Identity() commontypesv4.ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v EncryptionResponse) *commontypesv4.ManagedServiceIdentityResponse { return v.Identity }).(commontypesv4.ManagedServiceIdentityResponsePtrOutput)
}
...
// The managed service identities assigned to this resource.
func (o EncryptionResponsePtrOutput) Identity() commontypesv4.ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v *EncryptionResponse) *commontypesv4.ManagedServiceIdentityResponse {
		if v == nil {
			return nil
		}
		return v.Identity
