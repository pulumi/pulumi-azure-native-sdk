...
func (o LookupEnterprisePolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupEnterprisePolicyResult] {
	return pulumix.Output[LookupEnterprisePolicyResult]{
