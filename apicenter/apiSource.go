...
func NewApiSource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:apicenter/v20240601preview:ApiSource"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApiSource
	err := ctx.RegisterResource("azure-native:apicenter:ApiSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiSource(ctx *pulumi.Context,
	...
	var resource ApiSource
	err := ctx.ReadResource("azure-native:apicenter:ApiSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
