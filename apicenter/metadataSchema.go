...
func NewMetadataSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apicenter:MetadataSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetadataSchema(ctx *pulumi.Context,
	...
	var resource MetadataSchema
	err := ctx.ReadResource("azure-native:apicenter:MetadataSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o MetadataSchemaOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *MetadataSchema) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
