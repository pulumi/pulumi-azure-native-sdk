...
func NewApiDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apicenter/v20240301:ApiDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiDefinition(ctx *pulumi.Context,
	...
	var resource ApiDefinition
	err := ctx.ReadResource("azure-native:apicenter/v20240301:ApiDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
