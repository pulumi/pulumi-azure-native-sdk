...
func LookupApiVersion(ctx *pulumi.Context, args *LookupApiVersionArgs, opts ...pulumi.InvokeOption) (*LookupApiVersionResult, error) {
	...
	err := ctx.Invoke("azure-native:apicenter:getApiVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiVersionOutput(ctx *pulumi.Context, args LookupApiVersionOutputArgs, opts ...pulumi.InvokeOption) LookupApiVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:apicenter:getApiVersion", args, LookupApiVersionResultOutput{}, options).(LookupApiVersionResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupApiVersionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupApiVersionResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
