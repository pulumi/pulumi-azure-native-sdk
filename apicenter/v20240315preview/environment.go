...
func NewEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apicenter/v20240315preview:Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironment(ctx *pulumi.Context,
	...
	var resource Environment
	err := ctx.ReadResource("azure-native:apicenter/v20240315preview:Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
