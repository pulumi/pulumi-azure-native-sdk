...
func NewApi(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:apicenter:Api"),
		},
		{
	...
	var resource Api
	err := ctx.RegisterResource("azure-native:apicenter/v20240315preview:Api", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.ReadResource("azure-native:apicenter/v20240315preview:Api", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
