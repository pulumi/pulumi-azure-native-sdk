...
func NewApiVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:apicenter/v20240601preview:ApiVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiVersion(ctx *pulumi.Context,
	...
	var resource ApiVersion
	err := ctx.ReadResource("azure-native:apicenter/v20240601preview:ApiVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
