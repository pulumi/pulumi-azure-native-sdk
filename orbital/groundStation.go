...
func NewGroundStation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:orbital:GroundStation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroundStation(ctx *pulumi.Context,
	...
	var resource GroundStation
	err := ctx.ReadResource("azure-native:orbital:GroundStation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
