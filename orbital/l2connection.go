...
func NewL2Connection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:orbital:L2Connection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetL2Connection(ctx *pulumi.Context,
	...
	var resource L2Connection
	err := ctx.ReadResource("azure-native:orbital:L2Connection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
