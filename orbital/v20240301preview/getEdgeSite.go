...
func LookupEdgeSite(ctx *pulumi.Context, args *LookupEdgeSiteArgs, opts ...pulumi.InvokeOption) (*LookupEdgeSiteResult, error) {
	...
	err := ctx.Invoke("azure-native:orbital/v20240301preview:getEdgeSite", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEdgeSiteOutput(ctx *pulumi.Context, args LookupEdgeSiteOutputArgs, opts ...pulumi.InvokeOption) LookupEdgeSiteResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEdgeSiteResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:orbital/v20240301preview:getEdgeSite", args, LookupEdgeSiteResultOutput{}, options).(LookupEdgeSiteResultOutput), nil
