...
func LookupGroundStation(ctx *pulumi.Context, args *LookupGroundStationArgs, opts ...pulumi.InvokeOption) (*LookupGroundStationResult, error) {
	...
	err := ctx.Invoke("azure-native:orbital/v20240301preview:getGroundStation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGroundStationOutput(ctx *pulumi.Context, args LookupGroundStationOutputArgs, opts ...pulumi.InvokeOption) LookupGroundStationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGroundStationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:orbital/v20240301preview:getGroundStation", args, LookupGroundStationResultOutput{}, options).(LookupGroundStationResultOutput), nil
