...
func NewEdgeSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:orbital/v20240301preview:EdgeSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEdgeSite(ctx *pulumi.Context,
	...
	var resource EdgeSite
	err := ctx.ReadResource("azure-native:orbital/v20240301preview:EdgeSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
