...
func NewSpacecraft(ctx *pulumi.Context,
	...
	if args.TleLine1 == nil {
		return nil, errors.New("invalid value for required argument 'TleLine1'")
	}
	if args.TleLine2 == nil {
	...
	err := ctx.RegisterResource("azure-native:orbital/v20221101:Spacecraft", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpacecraft(ctx *pulumi.Context,
	...
	var resource Spacecraft
	err := ctx.ReadResource("azure-native:orbital/v20221101:Spacecraft", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// NORAD ID of the spacecraft.
func (o SpacecraftOutput) NoradId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Spacecraft) pulumi.StringPtrOutput { return v.NoradId }).(pulumi.StringPtrOutput)
}
...
func (o SpacecraftOutput) TleLine1() pulumi.StringOutput {
	return o.ApplyT(func(v *Spacecraft) pulumi.StringOutput { return v.TleLine1 }).(pulumi.StringOutput)
}

// Line 2 of the two-line element set (TLE).
func (o SpacecraftOutput) TleLine2() pulumi.StringOutput {
	return o.ApplyT(func(v *Spacecraft) pulumi.StringOutput { return v.TleLine2 }).(pulumi.StringOutput)
}
