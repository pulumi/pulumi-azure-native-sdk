...
func LookupSpacecraftOutput(ctx *pulumi.Context, args LookupSpacecraftOutputArgs, opts ...pulumi.InvokeOption) LookupSpacecraftResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSpacecraftResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:orbital/v20221101:getSpacecraft", args, LookupSpacecraftResultOutput{}, options).(LookupSpacecraftResultOutput), nil
...
// NORAD ID of the spacecraft.
func (o LookupSpacecraftResultOutput) NoradId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSpacecraftResult) *string { return v.NoradId }).(pulumi.StringPtrOutput)
}
...
// Title line of the two-line element set (TLE).
func (o LookupSpacecraftResultOutput) TitleLine() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSpacecraftResult) string { return v.TitleLine }).(pulumi.StringOutput)
}

// Line 1 of the two-line element set (TLE).
func (o LookupSpacecraftResultOutput) TleLine1() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSpacecraftResult) string { return v.TleLine1 }).(pulumi.StringOutput)
}

// Line 2 of the two-line element set (TLE).
func (o LookupSpacecraftResultOutput) TleLine2() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSpacecraftResult) string { return v.TleLine2 }).(pulumi.StringOutput)
}
