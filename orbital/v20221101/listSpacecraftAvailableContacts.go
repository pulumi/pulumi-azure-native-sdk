...
func ListSpacecraftAvailableContacts(ctx *pulumi.Context, args *ListSpacecraftAvailableContactsArgs, opts ...pulumi.InvokeOption) (*ListSpacecraftAvailableContactsResult, error) {
	...
	err := ctx.Invoke("azure-native:orbital/v20221101:listSpacecraftAvailableContacts", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListSpacecraftAvailableContactsOutput(ctx *pulumi.Context, args ListSpacecraftAvailableContactsOutputArgs, opts ...pulumi.InvokeOption) ListSpacecraftAvailableContactsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListSpacecraftAvailableContactsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:orbital/v20221101:listSpacecraftAvailableContacts", args, ListSpacecraftAvailableContactsResultOutput{}, options).(ListSpacecraftAvailableContactsResultOutput), nil
