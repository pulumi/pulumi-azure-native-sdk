...
func LookupContactProfile(ctx *pulumi.Context, args *LookupContactProfileArgs, opts ...pulumi.InvokeOption) (*LookupContactProfileResult, error) {
	...
	err := ctx.Invoke("azure-native:orbital/v20221101:getContactProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupContactProfileOutput(ctx *pulumi.Context, args LookupContactProfileOutputArgs, opts ...pulumi.InvokeOption) LookupContactProfileResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContactProfileResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:orbital/v20221101:getContactProfile", args, LookupContactProfileResultOutput{}, options).(LookupContactProfileResultOutput), nil
