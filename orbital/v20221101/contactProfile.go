...
func NewContactProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:orbital/v20221101:ContactProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContactProfile(ctx *pulumi.Context,
	...
	var resource ContactProfile
	err := ctx.ReadResource("azure-native:orbital/v20221101:ContactProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type contactProfileArgs struct {
	...
	// Third-party mission configuration of the Contact Profile. Describes RF links, modem processing, and IP endpoints.
	ThirdPartyConfigurations []ContactProfileThirdPartyConfiguration `pulumi:"thirdPartyConfigurations"`
}
...
// Third-party mission configuration of the Contact Profile. Describes RF links, modem processing, and IP endpoints.
func (o ContactProfileOutput) ThirdPartyConfigurations() ContactProfileThirdPartyConfigurationResponseArrayOutput {
	return o.ApplyT(func(v *ContactProfile) ContactProfileThirdPartyConfigurationResponseArrayOutput {
		return v.ThirdPartyConfigurations
	}).(ContactProfileThirdPartyConfigurationResponseArrayOutput)
}
