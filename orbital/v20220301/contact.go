...
func NewContact(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:orbital/v20220301:Contact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContact(ctx *pulumi.Context,
	...
	var resource Contact
	err := ctx.ReadResource("azure-native:orbital/v20220301:Contact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
