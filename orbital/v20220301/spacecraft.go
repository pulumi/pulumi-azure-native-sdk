...
func NewSpacecraft(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:orbital/v20220301:Spacecraft", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpacecraft(ctx *pulumi.Context,
	...
	var resource Spacecraft
	err := ctx.ReadResource("azure-native:orbital/v20220301:Spacecraft", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
