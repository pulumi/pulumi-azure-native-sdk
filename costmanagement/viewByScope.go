...
func NewViewByScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:costmanagement/v20250301:ViewByScope"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ViewByScope
	err := ctx.RegisterResource("azure-native:costmanagement:ViewByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetViewByScope(ctx *pulumi.Context,
	...
	var resource ViewByScope
	err := ctx.ReadResource("azure-native:costmanagement:ViewByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
