...
type Export struct {
	...
	DataOverwriteBehavior pulumi.StringPtrOutput `pulumi:"dataOverwriteBehavior"`
	...
	ExportDescription pulumi.StringPtrOutput `pulumi:"exportDescription"`
	...
	SystemSuspensionContext ExportSuspensionContextResponseOutput `pulumi:"systemSuspensionContext"`
	// Resource type.
...
func NewExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.RegisterResource("azure-native:costmanagement/v20230701preview:Export", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.ReadResource("azure-native:costmanagement/v20230701preview:Export", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ExportArgs struct {
	...
	// Allow customers to select overwrite data(OverwritePreviousReport) for exports. This setting will enable overwrite data for the same month in customer storage account. By default set to CreateNewReport.
	DataOverwriteBehavior pulumi.StringPtrInput
	// Has the definition for the export.
	...
	// The export description set by customer at time of export creation/update.
	ExportDescription pulumi.StringPtrInput
	// Export Name.
...
// Allow customers to select compress data(gzip) for exports. This setting will enable destination file compression scheme at runtime. By default set to None.
func (o ExportOutput) CompressionMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Export) pulumi.StringPtrOutput { return v.CompressionMode }).(pulumi.StringPtrOutput)
}

// Allow customers to select overwrite data(OverwritePreviousReport) for exports. This setting will enable overwrite data for the same month in customer storage account. By default set to CreateNewReport.
func (o ExportOutput) DataOverwriteBehavior() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Export) pulumi.StringPtrOutput { return v.DataOverwriteBehavior }).(pulumi.StringPtrOutput)
}
...
// The export description set by customer at time of export creation/update.
func (o ExportOutput) ExportDescription() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Export) pulumi.StringPtrOutput { return v.ExportDescription }).(pulumi.StringPtrOutput)
}
...
// The export suspension reason if export is in SystemSuspended state.
func (o ExportOutput) SystemSuspensionContext() ExportSuspensionContextResponseOutput {
	return o.ApplyT(func(v *Export) ExportSuspensionContextResponseOutput { return v.SystemSuspensionContext }).(ExportSuspensionContextResponseOutput)
}
