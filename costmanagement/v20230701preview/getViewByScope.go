...
func LookupViewByScope(ctx *pulumi.Context, args *LookupViewByScopeArgs, opts ...pulumi.InvokeOption) (*LookupViewByScopeResult, error) {
	...
	err := ctx.Invoke("azure-native:costmanagement/v20230701preview:getViewByScope", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupViewByScopeOutput(ctx *pulumi.Context, args LookupViewByScopeOutputArgs, opts ...pulumi.InvokeOption) LookupViewByScopeResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupViewByScopeResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:costmanagement/v20230701preview:getViewByScope", args, LookupViewByScopeResultOutput{}, options).(LookupViewByScopeResultOutput), nil
