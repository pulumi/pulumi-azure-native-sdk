...
func NewTagInheritanceSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20231101:TagInheritanceSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagInheritanceSetting(ctx *pulumi.Context,
	...
	var resource TagInheritanceSetting
	err := ctx.ReadResource("azure-native:costmanagement/v20231101:TagInheritanceSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
