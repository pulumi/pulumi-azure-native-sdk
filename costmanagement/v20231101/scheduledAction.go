...
func NewScheduledAction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20231101:ScheduledAction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledAction(ctx *pulumi.Context,
	...
	var resource ScheduledAction
	err := ctx.ReadResource("azure-native:costmanagement/v20231101:ScheduledAction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
