...
//
// Deprecated: azure-native:costmanagement/v20221001:ScheduledAction is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20230401preview:ScheduledAction to guarantee forwards compatibility.
...
func NewScheduledAction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20221001:ScheduledAction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledAction(ctx *pulumi.Context,
	...
	var resource ScheduledAction
	err := ctx.ReadResource("azure-native:costmanagement/v20221001:ScheduledAction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
