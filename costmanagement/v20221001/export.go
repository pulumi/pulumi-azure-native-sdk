...
// An export resource.
//
// Deprecated: azure-native:costmanagement/v20221001:Export is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20230401preview:Export to guarantee forwards compatibility.
type Export struct {
...
func NewExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.RegisterResource("azure-native:costmanagement/v20221001:Export", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.ReadResource("azure-native:costmanagement/v20221001:Export", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
