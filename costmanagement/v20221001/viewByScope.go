...
func NewViewByScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20221001:ViewByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetViewByScope(ctx *pulumi.Context,
	...
	var resource ViewByScope
	err := ctx.ReadResource("azure-native:costmanagement/v20221001:ViewByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
