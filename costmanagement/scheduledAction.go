...
// Kind of the scheduled action.
func (o ScheduledActionOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *ScheduledAction) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
