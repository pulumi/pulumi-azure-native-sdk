...
// SortDirectionInput is an input type that accepts values of the SortDirection enum
// A concrete instance of `SortDirectionInput` can be one of the following:
//
...
func (in *sortDirectionPtr) ToOutput(ctx context.Context) pulumix.Output[*SortDirection] {
	return pulumix.Output[*SortDirection]{
		OutputState: in.ToSortDirectionPtrOutputWithContext(ctx).OutputState,
	}
}
...
//	TimeframeTypeYearToDate
//	TimeframeTypeTheLastWeek
//	TimeframeTypeTheLastMonth
//	TimeframeTypeTheLastYear
//	TimeframeTypeCustom
