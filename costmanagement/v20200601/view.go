...
func NewView(ctx *pulumi.Context,
	...
	var resource View
	err := ctx.RegisterResource("azure-native:costmanagement/v20200601:View", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetView(ctx *pulumi.Context,
	...
	var resource View
	err := ctx.ReadResource("azure-native:costmanagement/v20200601:View", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
