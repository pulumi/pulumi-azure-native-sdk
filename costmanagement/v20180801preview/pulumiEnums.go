...
// ReportColumnTypeInput is an input type that accepts values of the ReportColumnType enum
// A concrete instance of `ReportColumnTypeInput` can be one of the following:
//
//	ReportColumnTypeTag
