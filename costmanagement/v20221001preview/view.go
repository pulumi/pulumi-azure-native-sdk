...
//
// Deprecated: azure-native:costmanagement/v20221001preview:View is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221005preview:View to guarantee forwards compatibility.
type View struct {
...
func NewView(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:costmanagement/v20221001:View"),
		},
		{
	...
	var resource View
	err := ctx.RegisterResource("azure-native:costmanagement/v20221001preview:View", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetView(ctx *pulumi.Context,
	...
	var resource View
	err := ctx.ReadResource("azure-native:costmanagement/v20221001preview:View", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
