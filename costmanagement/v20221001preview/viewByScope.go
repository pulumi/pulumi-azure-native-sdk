...
//
// Deprecated: azure-native:costmanagement/v20221001preview:ViewByScope is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221005preview:ViewByScope to guarantee forwards compatibility.
...
func NewViewByScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20221001preview:ViewByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetViewByScope(ctx *pulumi.Context,
	...
	var resource ViewByScope
	err := ctx.ReadResource("azure-native:costmanagement/v20221001preview:ViewByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
