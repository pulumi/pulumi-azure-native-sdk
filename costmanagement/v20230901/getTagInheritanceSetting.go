...
func LookupTagInheritanceSetting(ctx *pulumi.Context, args *LookupTagInheritanceSettingArgs, opts ...pulumi.InvokeOption) (*LookupTagInheritanceSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:costmanagement/v20230901:getTagInheritanceSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTagInheritanceSettingOutput(ctx *pulumi.Context, args LookupTagInheritanceSettingOutputArgs, opts ...pulumi.InvokeOption) LookupTagInheritanceSettingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTagInheritanceSettingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:costmanagement/v20230901:getTagInheritanceSetting", args, LookupTagInheritanceSettingResultOutput{}, options).(LookupTagInheritanceSettingResultOutput), nil
