...
func NewCostAllocationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20230901:CostAllocationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCostAllocationRule(ctx *pulumi.Context,
	...
	var resource CostAllocationRule
	err := ctx.ReadResource("azure-native:costmanagement/v20230901:CostAllocationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
