...
func NewMarkupRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:costmanagement/v20221005preview:MarkupRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MarkupRule
	err := ctx.RegisterResource("azure-native:costmanagement:MarkupRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMarkupRule(ctx *pulumi.Context,
	...
	var resource MarkupRule
	err := ctx.ReadResource("azure-native:costmanagement:MarkupRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
