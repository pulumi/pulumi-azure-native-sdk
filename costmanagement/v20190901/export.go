...
func NewExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.RegisterResource("azure-native:costmanagement/v20190901:Export", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExport(ctx *pulumi.Context,
	...
	var resource Export
	err := ctx.ReadResource("azure-native:costmanagement/v20190901:Export", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
