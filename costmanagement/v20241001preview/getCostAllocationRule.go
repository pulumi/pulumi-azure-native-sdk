...
func LookupCostAllocationRule(ctx *pulumi.Context, args *LookupCostAllocationRuleArgs, opts ...pulumi.InvokeOption) (*LookupCostAllocationRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:costmanagement/v20241001preview:getCostAllocationRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCostAllocationRuleOutput(ctx *pulumi.Context, args LookupCostAllocationRuleOutputArgs, opts ...pulumi.InvokeOption) LookupCostAllocationRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCostAllocationRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:costmanagement/v20241001preview:getCostAllocationRule", args, LookupCostAllocationRuleResultOutput{}, options).(LookupCostAllocationRuleResultOutput), nil
