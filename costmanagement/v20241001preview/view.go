...
func NewView(ctx *pulumi.Context,
	...
	var resource View
	err := ctx.RegisterResource("azure-native:costmanagement/v20241001preview:View", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetView(ctx *pulumi.Context,
	...
	var resource View
	err := ctx.ReadResource("azure-native:costmanagement/v20241001preview:View", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
