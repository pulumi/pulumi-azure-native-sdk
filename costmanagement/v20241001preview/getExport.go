...
func LookupExport(ctx *pulumi.Context, args *LookupExportArgs, opts ...pulumi.InvokeOption) (*LookupExportResult, error) {
	...
	err := ctx.Invoke("azure-native:costmanagement/v20241001preview:getExport", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupExportOutput(ctx *pulumi.Context, args LookupExportOutputArgs, opts ...pulumi.InvokeOption) LookupExportResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupExportResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:costmanagement/v20241001preview:getExport", args, LookupExportResultOutput{}, options).(LookupExportResultOutput), nil
...
// Allow customers to select compress data(gzip) for exports. This setting will enable destination file compression scheme at runtime. By default set to None.
func (o LookupExportResultOutput) CompressionMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupExportResult) *string { return v.CompressionMode }).(pulumi.StringPtrOutput)
}

// Allow customers to select overwrite data(OverwritePreviousReport) for exports. This setting will enable overwrite data for the same month in customer storage account. By default set to CreateNewReport.
func (o LookupExportResultOutput) DataOverwriteBehavior() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupExportResult) *string { return v.DataOverwriteBehavior }).(pulumi.StringPtrOutput)
}
...
// The export description set by customer at time of export creation/update.
func (o LookupExportResultOutput) ExportDescription() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupExportResult) *string { return v.ExportDescription }).(pulumi.StringPtrOutput)
}
...
// The export suspension reason if export is in SystemSuspended state.
func (o LookupExportResultOutput) SystemSuspensionContext() ExportSuspensionContextResponseOutput {
	return o.ApplyT(func(v LookupExportResult) ExportSuspensionContextResponse { return v.SystemSuspensionContext }).(ExportSuspensionContextResponseOutput)
}
