...
func NewTagInheritanceSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:costmanagement/v20230901:TagInheritanceSetting"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20241001preview:TagInheritanceSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagInheritanceSetting(ctx *pulumi.Context,
	...
	var resource TagInheritanceSetting
	err := ctx.ReadResource("azure-native:costmanagement/v20241001preview:TagInheritanceSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
