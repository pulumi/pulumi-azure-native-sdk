...
// ConnectorBillingModelInput is an input type that accepts values of the ConnectorBillingModel enum
// A concrete instance of `ConnectorBillingModelInput` can be one of the following:
//
