...
func NewView(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:costmanagement/v20230701preview:View"),
		},
		{
			Type: pulumi.String("azure-native:costmanagement/v20230801:View"),
		},
		{
			Type: pulumi.String("azure-native:costmanagement/v20230901:View"),
		},
		{
	...
	var resource View
	err := ctx.RegisterResource("azure-native:costmanagement/v20240801:View", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetView(ctx *pulumi.Context,
	...
	var resource View
	err := ctx.ReadResource("azure-native:costmanagement/v20240801:View", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
