...
func NewScheduledActionByScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:costmanagement/v20230301:ScheduledActionByScope"),
		},
		{
			Type: pulumi.String("azure-native:costmanagement/v20230401preview:ScheduledActionByScope"),
		},
		{
			Type: pulumi.String("azure-native:costmanagement/v20230701preview:ScheduledActionByScope"),
		},
		{
			Type: pulumi.String("azure-native:costmanagement/v20230801:ScheduledActionByScope"),
		},
		{
			Type: pulumi.String("azure-native:costmanagement/v20230901:ScheduledActionByScope"),
		},
		{
			Type: pulumi.String("azure-native:costmanagement/v20231101:ScheduledActionByScope"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ScheduledActionByScope
	err := ctx.RegisterResource("azure-native:costmanagement/v20240801:ScheduledActionByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledActionByScope(ctx *pulumi.Context,
	...
	var resource ScheduledActionByScope
	err := ctx.ReadResource("azure-native:costmanagement/v20240801:ScheduledActionByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
