...
func NewScheduledActionByScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20230301:ScheduledActionByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledActionByScope(ctx *pulumi.Context,
	...
	var resource ScheduledActionByScope
	err := ctx.ReadResource("azure-native:costmanagement/v20230301:ScheduledActionByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
