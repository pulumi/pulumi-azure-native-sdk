...
func NewViewByScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:costmanagement/v20230701preview:ViewByScope"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:costmanagement/v20231101:ViewByScope"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:costmanagement/v20230301:ViewByScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetViewByScope(ctx *pulumi.Context,
	...
	var resource ViewByScope
	err := ctx.ReadResource("azure-native:costmanagement/v20230301:ViewByScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
