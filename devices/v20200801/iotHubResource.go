...
//
// Deprecated: azure-native:devices/v20200801:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:IotHubResource to guarantee forwards compatibility.
...
func NewIotHubResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devices/v20200801:IotHubResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubResource(ctx *pulumi.Context,
	...
	var resource IotHubResource
	err := ctx.ReadResource("azure-native:devices/v20200801:IotHubResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
