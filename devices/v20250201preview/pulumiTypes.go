...
type IotHubDefinitionDescription struct {
	...
	SelectedUserAssignedIdentityResourceId *string `pulumi:"selectedUserAssignedIdentityResourceId"`
}
...
type IotHubDefinitionDescriptionArgs struct {
	...
	// The selected user-assigned identity resource Id associated with IoT Hub. This is required when authenticationType is UserAssigned.
	SelectedUserAssignedIdentityResourceId pulumi.StringPtrInput `pulumi:"selectedUserAssignedIdentityResourceId"`
}
...
// IotHub MI authentication type: KeyBased, UserAssigned, SystemAssigned.
func (o IotHubDefinitionDescriptionOutput) AuthenticationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubDefinitionDescription) *string { return v.AuthenticationType }).(pulumi.StringPtrOutput)
}

// Connection string of the IoT hub.
func (o IotHubDefinitionDescriptionOutput) ConnectionString() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubDefinitionDescription) *string { return v.ConnectionString }).(pulumi.StringPtrOutput)
}
...
// The selected user-assigned identity resource Id associated with IoT Hub. This is required when authenticationType is UserAssigned.
func (o IotHubDefinitionDescriptionOutput) SelectedUserAssignedIdentityResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubDefinitionDescription) *string { return v.SelectedUserAssignedIdentityResourceId }).(pulumi.StringPtrOutput)
}
...
// IotHub MI authentication type: KeyBased, UserAssigned, SystemAssigned.
func (o IotHubDefinitionDescriptionResponseOutput) AuthenticationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubDefinitionDescriptionResponse) *string { return v.AuthenticationType }).(pulumi.StringPtrOutput)
}

// Connection string of the IoT hub.
func (o IotHubDefinitionDescriptionResponseOutput) ConnectionString() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubDefinitionDescriptionResponse) *string { return v.ConnectionString }).(pulumi.StringPtrOutput)
}
...
// The selected user-assigned identity resource Id associated with IoT Hub. This is required when authenticationType is UserAssigned.
func (o IotHubDefinitionDescriptionResponseOutput) SelectedUserAssignedIdentityResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IotHubDefinitionDescriptionResponse) *string { return v.SelectedUserAssignedIdentityResourceId }).(pulumi.StringPtrOutput)
}
