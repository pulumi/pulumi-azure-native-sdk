...
func (IotHubAuthenticationType) ElementType() reflect.Type {
	return reflect.TypeOf((*IotHubAuthenticationType)(nil)).Elem()
}

func (e IotHubAuthenticationType) ToIotHubAuthenticationTypeOutput() IotHubAuthenticationTypeOutput {
	return pulumi.ToOutput(e).(IotHubAuthenticationTypeOutput)
}

func (e IotHubAuthenticationType) ToIotHubAuthenticationTypeOutputWithContext(ctx context.Context) IotHubAuthenticationTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(IotHubAuthenticationTypeOutput)
}

func (e IotHubAuthenticationType) ToIotHubAuthenticationTypePtrOutput() IotHubAuthenticationTypePtrOutput {
	return e.ToIotHubAuthenticationTypePtrOutputWithContext(context.Background())
}

func (e IotHubAuthenticationType) ToIotHubAuthenticationTypePtrOutputWithContext(ctx context.Context) IotHubAuthenticationTypePtrOutput {
	return IotHubAuthenticationType(e).ToIotHubAuthenticationTypeOutputWithContext(ctx).ToIotHubAuthenticationTypePtrOutputWithContext(ctx)
}

func (e IotHubAuthenticationType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e IotHubAuthenticationType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e IotHubAuthenticationType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e IotHubAuthenticationType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type IotHubAuthenticationTypeOutput struct{ *pulumi.OutputState }

func (IotHubAuthenticationTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*IotHubAuthenticationType)(nil)).Elem()
}

func (o IotHubAuthenticationTypeOutput) ToIotHubAuthenticationTypeOutput() IotHubAuthenticationTypeOutput {
	return o
}

func (o IotHubAuthenticationTypeOutput) ToIotHubAuthenticationTypeOutputWithContext(ctx context.Context) IotHubAuthenticationTypeOutput {
	return o
}

func (o IotHubAuthenticationTypeOutput) ToIotHubAuthenticationTypePtrOutput() IotHubAuthenticationTypePtrOutput {
	return o.ToIotHubAuthenticationTypePtrOutputWithContext(context.Background())
}

func (o IotHubAuthenticationTypeOutput) ToIotHubAuthenticationTypePtrOutputWithContext(ctx context.Context) IotHubAuthenticationTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v IotHubAuthenticationType) *IotHubAuthenticationType {
		return &v
	}).(IotHubAuthenticationTypePtrOutput)
}

func (o IotHubAuthenticationTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o IotHubAuthenticationTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e IotHubAuthenticationType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o IotHubAuthenticationTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o IotHubAuthenticationTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e IotHubAuthenticationType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type IotHubAuthenticationTypePtrOutput struct{ *pulumi.OutputState }

func (IotHubAuthenticationTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**IotHubAuthenticationType)(nil)).Elem()
}

func (o IotHubAuthenticationTypePtrOutput) ToIotHubAuthenticationTypePtrOutput() IotHubAuthenticationTypePtrOutput {
	return o
}

func (o IotHubAuthenticationTypePtrOutput) ToIotHubAuthenticationTypePtrOutputWithContext(ctx context.Context) IotHubAuthenticationTypePtrOutput {
	return o
}

func (o IotHubAuthenticationTypePtrOutput) Elem() IotHubAuthenticationTypeOutput {
	return o.ApplyT(func(v *IotHubAuthenticationType) IotHubAuthenticationType {
		if v != nil {
			return *v
		}
		var ret IotHubAuthenticationType
		return ret
	}).(IotHubAuthenticationTypeOutput)
}

func (o IotHubAuthenticationTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o IotHubAuthenticationTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *IotHubAuthenticationType) *string {
		if e == nil {
			return nil
		}
...
// IotHubAuthenticationTypeInput is an input type that accepts values of the IotHubAuthenticationType enum
// A concrete instance of `IotHubAuthenticationTypeInput` can be one of the following:
//
//	IotHubAuthenticationTypeKeyBased
//	IotHubAuthenticationTypeUserAssigned
//	IotHubAuthenticationTypeSystemAssigned
type IotHubAuthenticationTypeInput interface {
	pulumi.Input

	ToIotHubAuthenticationTypeOutput() IotHubAuthenticationTypeOutput
	ToIotHubAuthenticationTypeOutputWithContext(context.Context) IotHubAuthenticationTypeOutput
}

var iotHubAuthenticationTypePtrType = reflect.TypeOf((**IotHubAuthenticationType)(nil)).Elem()

type IotHubAuthenticationTypePtrInput interface {
	pulumi.Input

	ToIotHubAuthenticationTypePtrOutput() IotHubAuthenticationTypePtrOutput
	ToIotHubAuthenticationTypePtrOutputWithContext(context.Context) IotHubAuthenticationTypePtrOutput
}

type iotHubAuthenticationTypePtr string

func IotHubAuthenticationTypePtr(v string) IotHubAuthenticationTypePtrInput {
	return (*iotHubAuthenticationTypePtr)(&v)
}

func (*iotHubAuthenticationTypePtr) ElementType() reflect.Type {
	return iotHubAuthenticationTypePtrType
}

func (in *iotHubAuthenticationTypePtr) ToIotHubAuthenticationTypePtrOutput() IotHubAuthenticationTypePtrOutput {
	return pulumi.ToOutput(in).(IotHubAuthenticationTypePtrOutput)
}

func (in *iotHubAuthenticationTypePtr) ToIotHubAuthenticationTypePtrOutputWithContext(ctx context.Context) IotHubAuthenticationTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(IotHubAuthenticationTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(IotHubAuthenticationTypeOutput{})
	pulumi.RegisterOutputType(IotHubAuthenticationTypePtrOutput{})
