...
// azure-native:devices/v20181201preview:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20221115preview:IotHubResource to guarantee forwards compatibility.
func LookupIotHubResource(ctx *pulumi.Context, args *LookupIotHubResourceArgs, opts ...pulumi.InvokeOption) (*LookupIotHubResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:devices/v20181201preview:getIotHubResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
