...
//
// Deprecated: azure-native:devices/v20210201preview:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20221115preview:Certificate to guarantee forwards compatibility.
