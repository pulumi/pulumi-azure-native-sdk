...
func NewIotHubResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:devices/v20230630preview:IotHubResource"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:devices/v20230630:IotHubResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubResource(ctx *pulumi.Context,
	...
	var resource IotHubResource
	err := ctx.ReadResource("azure-native:devices/v20230630:IotHubResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
