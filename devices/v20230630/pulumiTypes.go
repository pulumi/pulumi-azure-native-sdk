...
// Id of the cosmos DB sql container endpoint
func (o RoutingCosmosDBSqlApiPropertiesResponseOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v RoutingCosmosDBSqlApiPropertiesResponse) string { return v.Id }).(pulumi.StringOutput)
}
