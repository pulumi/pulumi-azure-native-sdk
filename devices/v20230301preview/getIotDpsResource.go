...
func LookupIotDpsResource(ctx *pulumi.Context, args *LookupIotDpsResourceArgs, opts ...pulumi.InvokeOption) (*LookupIotDpsResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:devices/v20230301preview:getIotDpsResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupIotDpsResourceOutput(ctx *pulumi.Context, args LookupIotDpsResourceOutputArgs, opts ...pulumi.InvokeOption) LookupIotDpsResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIotDpsResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devices/v20230301preview:getIotDpsResource", args, LookupIotDpsResourceResultOutput{}, options).(LookupIotDpsResourceResultOutput), nil
