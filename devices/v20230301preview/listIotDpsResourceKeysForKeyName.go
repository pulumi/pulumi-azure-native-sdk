...
func ListIotDpsResourceKeysForKeyName(ctx *pulumi.Context, args *ListIotDpsResourceKeysForKeyNameArgs, opts ...pulumi.InvokeOption) (*ListIotDpsResourceKeysForKeyNameResult, error) {
	...
	err := ctx.Invoke("azure-native:devices/v20230301preview:listIotDpsResourceKeysForKeyName", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListIotDpsResourceKeysForKeyNameOutput(ctx *pulumi.Context, args ListIotDpsResourceKeysForKeyNameOutputArgs, opts ...pulumi.InvokeOption) ListIotDpsResourceKeysForKeyNameResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListIotDpsResourceKeysForKeyNameResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devices/v20230301preview:listIotDpsResourceKeysForKeyName", args, ListIotDpsResourceKeysForKeyNameResultOutput{}, options).(ListIotDpsResourceKeysForKeyNameResultOutput), nil
