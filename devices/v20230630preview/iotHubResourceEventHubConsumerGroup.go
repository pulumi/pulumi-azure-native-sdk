...
func NewIotHubResourceEventHubConsumerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devices/v20230630preview:IotHubResourceEventHubConsumerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubResourceEventHubConsumerGroup(ctx *pulumi.Context,
	...
	var resource IotHubResourceEventHubConsumerGroup
	err := ctx.ReadResource("azure-native:devices/v20230630preview:IotHubResourceEventHubConsumerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
