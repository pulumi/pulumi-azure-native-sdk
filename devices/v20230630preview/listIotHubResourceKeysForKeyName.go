...
func ListIotHubResourceKeysForKeyName(ctx *pulumi.Context, args *ListIotHubResourceKeysForKeyNameArgs, opts ...pulumi.InvokeOption) (*ListIotHubResourceKeysForKeyNameResult, error) {
	...
	err := ctx.Invoke("azure-native:devices/v20230630preview:listIotHubResourceKeysForKeyName", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListIotHubResourceKeysForKeyNameOutput(ctx *pulumi.Context, args ListIotHubResourceKeysForKeyNameOutputArgs, opts ...pulumi.InvokeOption) ListIotHubResourceKeysForKeyNameResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListIotHubResourceKeysForKeyNameResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devices/v20230630preview:listIotHubResourceKeysForKeyName", args, ListIotHubResourceKeysForKeyNameResultOutput{}, options).(ListIotHubResourceKeysForKeyNameResultOutput), nil
