...
//
// Deprecated: azure-native:devices/v20210701:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:Certificate to guarantee forwards compatibility.
func LookupCertificate(ctx *pulumi.Context, args *LookupCertificateArgs, opts ...pulumi.InvokeOption) (*LookupCertificateResult, error) {
	var rv LookupCertificateResult
	err := ctx.Invoke("azure-native:devices/v20210701:getCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
