...
func NewDpsCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devices/v20211015:DpsCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDpsCertificate(ctx *pulumi.Context,
	...
	var resource DpsCertificate
	err := ctx.ReadResource("azure-native:devices/v20211015:DpsCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
