...
//
// Deprecated: azure-native:devices/v20210303preview:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:Certificate to guarantee forwards compatibility.
