...
func NewIotDpsResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devices/v20170821preview:IotDpsResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotDpsResource(ctx *pulumi.Context,
	...
	var resource IotDpsResource
	err := ctx.ReadResource("azure-native:devices/v20170821preview:IotDpsResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
