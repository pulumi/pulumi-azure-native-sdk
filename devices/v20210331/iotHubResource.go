...
func NewIotHubResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devices/v20210331:IotHubResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubResource(ctx *pulumi.Context,
	...
	var resource IotHubResource
	err := ctx.ReadResource("azure-native:devices/v20210331:IotHubResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
