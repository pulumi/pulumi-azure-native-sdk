...
// azure-native:devices/v20200101:IotDpsResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20200901preview:IotDpsResource to guarantee forwards compatibility.
...
func NewIotDpsResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devices/v20200101:IotDpsResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotDpsResource(ctx *pulumi.Context,
	...
	var resource IotDpsResource
	err := ctx.ReadResource("azure-native:devices/v20200101:IotDpsResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
