...
// azure-native:devices/v20190322preview:IotHubResourceEventHubConsumerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20210303preview:IotHubResourceEventHubConsumerGroup to guarantee forwards compatibility.
...
func NewIotHubResourceEventHubConsumerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devices/v20190322preview:IotHubResourceEventHubConsumerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubResourceEventHubConsumerGroup(ctx *pulumi.Context,
	...
	var resource IotHubResourceEventHubConsumerGroup
	err := ctx.ReadResource("azure-native:devices/v20190322preview:IotHubResourceEventHubConsumerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
