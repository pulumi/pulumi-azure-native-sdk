...
// azure-native:devices/v20160203:IotHubResourceEventHubConsumerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20170701:IotHubResourceEventHubConsumerGroup to guarantee forwards compatibility.
...
func NewIotHubResourceEventHubConsumerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devices/v20160203:IotHubResourceEventHubConsumerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIotHubResourceEventHubConsumerGroup(ctx *pulumi.Context,
	...
	var resource IotHubResourceEventHubConsumerGroup
	err := ctx.ReadResource("azure-native:devices/v20160203:IotHubResourceEventHubConsumerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Event Hub-compatible consumer group name.
func (o IotHubResourceEventHubConsumerGroupOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IotHubResourceEventHubConsumerGroup) pulumi.StringPtrOutput { return v.Name }).(pulumi.StringPtrOutput)
}

// The tags.
func (o IotHubResourceEventHubConsumerGroupOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *IotHubResourceEventHubConsumerGroup) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
