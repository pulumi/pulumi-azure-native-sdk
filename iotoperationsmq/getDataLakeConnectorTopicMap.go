...
func LookupDataLakeConnectorTopicMap(ctx *pulumi.Context, args *LookupDataLakeConnectorTopicMapArgs, opts ...pulumi.InvokeOption) (*LookupDataLakeConnectorTopicMapResult, error) {
	...
	err := ctx.Invoke("azure-native:iotoperationsmq:getDataLakeConnectorTopicMap", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (o LookupDataLakeConnectorTopicMapResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDataLakeConnectorTopicMapResult] {
	return pulumix.Output[LookupDataLakeConnectorTopicMapResult]{
