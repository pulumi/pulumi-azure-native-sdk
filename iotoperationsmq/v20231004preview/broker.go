...
func NewBroker(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsmq:Broker"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Broker
	err := ctx.RegisterResource("azure-native:iotoperationsmq/v20231004preview:Broker", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBroker(ctx *pulumi.Context,
	...
	var resource Broker
	err := ctx.ReadResource("azure-native:iotoperationsmq/v20231004preview:Broker", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
