...
func LookupDiagnosticService(ctx *pulumi.Context, args *LookupDiagnosticServiceArgs, opts ...pulumi.InvokeOption) (*LookupDiagnosticServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:iotoperationsmq/v20231004preview:getDiagnosticService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDiagnosticServiceOutput(ctx *pulumi.Context, args LookupDiagnosticServiceOutputArgs, opts ...pulumi.InvokeOption) LookupDiagnosticServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDiagnosticServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:iotoperationsmq/v20231004preview:getDiagnosticService", args, LookupDiagnosticServiceResultOutput{}, options).(LookupDiagnosticServiceResultOutput), nil
