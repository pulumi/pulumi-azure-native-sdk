...
func NewKafkaConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsmq:KafkaConnector"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource KafkaConnector
	err := ctx.RegisterResource("azure-native:iotoperationsmq/v20231004preview:KafkaConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaConnector(ctx *pulumi.Context,
	...
	var resource KafkaConnector
	err := ctx.ReadResource("azure-native:iotoperationsmq/v20231004preview:KafkaConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
