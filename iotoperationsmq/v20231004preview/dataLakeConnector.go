...
func NewDataLakeConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsmq:DataLakeConnector"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DataLakeConnector
	err := ctx.RegisterResource("azure-native:iotoperationsmq/v20231004preview:DataLakeConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataLakeConnector(ctx *pulumi.Context,
	...
	var resource DataLakeConnector
	err := ctx.ReadResource("azure-native:iotoperationsmq/v20231004preview:DataLakeConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
