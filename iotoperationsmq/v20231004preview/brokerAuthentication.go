...
func NewBrokerAuthentication(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsmq:BrokerAuthentication"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BrokerAuthentication
	err := ctx.RegisterResource("azure-native:iotoperationsmq/v20231004preview:BrokerAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrokerAuthentication(ctx *pulumi.Context,
	...
	var resource BrokerAuthentication
	err := ctx.ReadResource("azure-native:iotoperationsmq/v20231004preview:BrokerAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
