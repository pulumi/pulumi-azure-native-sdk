...
func NewKafkaConnectorTopicMap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsmq:KafkaConnectorTopicMap"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource KafkaConnectorTopicMap
	err := ctx.RegisterResource("azure-native:iotoperationsmq/v20231004preview:KafkaConnectorTopicMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaConnectorTopicMap(ctx *pulumi.Context,
	...
	var resource KafkaConnectorTopicMap
	err := ctx.ReadResource("azure-native:iotoperationsmq/v20231004preview:KafkaConnectorTopicMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
