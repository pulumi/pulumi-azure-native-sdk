...
func NewDataLakeConnectorTopicMap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsmq:DataLakeConnectorTopicMap"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DataLakeConnectorTopicMap
	err := ctx.RegisterResource("azure-native:iotoperationsmq/v20231004preview:DataLakeConnectorTopicMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataLakeConnectorTopicMap(ctx *pulumi.Context,
	...
	var resource DataLakeConnectorTopicMap
	err := ctx.ReadResource("azure-native:iotoperationsmq/v20231004preview:DataLakeConnectorTopicMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
