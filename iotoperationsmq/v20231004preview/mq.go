...
func NewMq(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsmq:Mq"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Mq
	err := ctx.RegisterResource("azure-native:iotoperationsmq/v20231004preview:Mq", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMq(ctx *pulumi.Context,
	...
	var resource Mq
	err := ctx.ReadResource("azure-native:iotoperationsmq/v20231004preview:Mq", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
