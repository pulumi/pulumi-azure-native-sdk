...
func NewMqttBridgeTopicMap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:iotoperationsmq/v20231004preview:MqttBridgeTopicMap"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MqttBridgeTopicMap
	err := ctx.RegisterResource("azure-native:iotoperationsmq:MqttBridgeTopicMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMqttBridgeTopicMap(ctx *pulumi.Context,
	...
	var resource MqttBridgeTopicMap
	err := ctx.ReadResource("azure-native:iotoperationsmq:MqttBridgeTopicMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o MqttBridgeTopicMapOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *MqttBridgeTopicMap) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
