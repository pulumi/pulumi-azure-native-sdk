...
func LookupDataLakeConnector(ctx *pulumi.Context, args *LookupDataLakeConnectorArgs, opts ...pulumi.InvokeOption) (*LookupDataLakeConnectorResult, error) {
	...
	err := ctx.Invoke("azure-native:iotoperationsmq:getDataLakeConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDataLakeConnectorResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDataLakeConnectorResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
