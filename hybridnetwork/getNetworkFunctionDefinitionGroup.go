...
func LookupNetworkFunctionDefinitionGroup(ctx *pulumi.Context, args *LookupNetworkFunctionDefinitionGroupArgs, opts ...pulumi.InvokeOption) (*LookupNetworkFunctionDefinitionGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridnetwork:getNetworkFunctionDefinitionGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupNetworkFunctionDefinitionGroupResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupNetworkFunctionDefinitionGroupResult) commontypesv3.SystemDataResponse {
		return v.SystemData
