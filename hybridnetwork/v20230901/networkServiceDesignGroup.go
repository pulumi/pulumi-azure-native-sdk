...
func NewNetworkServiceDesignGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20230901:NetworkServiceDesignGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkServiceDesignGroup(ctx *pulumi.Context,
	...
	var resource NetworkServiceDesignGroup
	err := ctx.ReadResource("azure-native:hybridnetwork/v20230901:NetworkServiceDesignGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
