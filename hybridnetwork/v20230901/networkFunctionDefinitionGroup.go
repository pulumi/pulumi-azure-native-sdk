...
func NewNetworkFunctionDefinitionGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20230901:NetworkFunctionDefinitionGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFunctionDefinitionGroup(ctx *pulumi.Context,
	...
	var resource NetworkFunctionDefinitionGroup
	err := ctx.ReadResource("azure-native:hybridnetwork/v20230901:NetworkFunctionDefinitionGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
