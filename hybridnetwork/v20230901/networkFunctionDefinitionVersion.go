...
func NewNetworkFunctionDefinitionVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20230901:NetworkFunctionDefinitionVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFunctionDefinitionVersion(ctx *pulumi.Context,
	...
	var resource NetworkFunctionDefinitionVersion
	err := ctx.ReadResource("azure-native:hybridnetwork/v20230901:NetworkFunctionDefinitionVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
