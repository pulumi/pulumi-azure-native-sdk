...
func ListArtifactManifestCredential(ctx *pulumi.Context, args *ListArtifactManifestCredentialArgs, opts ...pulumi.InvokeOption) (*ListArtifactManifestCredentialResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridnetwork/v20230901:listArtifactManifestCredential", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListArtifactManifestCredentialOutput(ctx *pulumi.Context, args ListArtifactManifestCredentialOutputArgs, opts ...pulumi.InvokeOption) ListArtifactManifestCredentialResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListArtifactManifestCredentialResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridnetwork/v20230901:listArtifactManifestCredential", args, ListArtifactManifestCredentialResultOutput{}, options).(ListArtifactManifestCredentialResultOutput), nil
