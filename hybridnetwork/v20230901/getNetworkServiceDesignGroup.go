...
func LookupNetworkServiceDesignGroup(ctx *pulumi.Context, args *LookupNetworkServiceDesignGroupArgs, opts ...pulumi.InvokeOption) (*LookupNetworkServiceDesignGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridnetwork/v20230901:getNetworkServiceDesignGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupNetworkServiceDesignGroupOutput(ctx *pulumi.Context, args LookupNetworkServiceDesignGroupOutputArgs, opts ...pulumi.InvokeOption) LookupNetworkServiceDesignGroupResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupNetworkServiceDesignGroupResult, error) {
			args := v.(LookupNetworkServiceDesignGroupArgs)
			r, err := LookupNetworkServiceDesignGroup(ctx, &args, opts...)
			var s LookupNetworkServiceDesignGroupResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o LookupNetworkServiceDesignGroupResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupNetworkServiceDesignGroupResult] {
	return pulumix.Output[LookupNetworkServiceDesignGroupResult]{
