...
func NewArtifactManifest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20230901:ArtifactManifest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactManifest(ctx *pulumi.Context,
	...
	var resource ArtifactManifest
	err := ctx.ReadResource("azure-native:hybridnetwork/v20230901:ArtifactManifest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
