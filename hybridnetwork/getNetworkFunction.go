...
// The managed identity of the network function.
func (o LookupNetworkFunctionResultOutput) Identity() commontypesv3.ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupNetworkFunctionResult) *commontypesv3.ManagedServiceIdentityResponse { return v.Identity }).(commontypesv3.ManagedServiceIdentityResponsePtrOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupNetworkFunctionResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupNetworkFunctionResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
