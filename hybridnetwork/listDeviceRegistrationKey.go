...
func (o ListDeviceRegistrationKeyResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListDeviceRegistrationKeyResult] {
	return pulumix.Output[ListDeviceRegistrationKeyResult]{
