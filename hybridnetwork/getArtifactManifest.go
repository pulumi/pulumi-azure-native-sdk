...
func (o LookupArtifactManifestResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupArtifactManifestResult] {
	return pulumix.Output[LookupArtifactManifestResult]{
