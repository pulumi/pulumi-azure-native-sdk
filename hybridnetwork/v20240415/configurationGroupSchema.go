...
func NewConfigurationGroupSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20240415:ConfigurationGroupSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationGroupSchema(ctx *pulumi.Context,
	...
	var resource ConfigurationGroupSchema
	err := ctx.ReadResource("azure-native:hybridnetwork/v20240415:ConfigurationGroupSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
