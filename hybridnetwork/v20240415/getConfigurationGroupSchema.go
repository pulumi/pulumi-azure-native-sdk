...
func LookupConfigurationGroupSchema(ctx *pulumi.Context, args *LookupConfigurationGroupSchemaArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationGroupSchemaResult, error) {
	...
	err := ctx.Invoke("azure-native:hybridnetwork/v20240415:getConfigurationGroupSchema", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConfigurationGroupSchemaOutput(ctx *pulumi.Context, args LookupConfigurationGroupSchemaOutputArgs, opts ...pulumi.InvokeOption) LookupConfigurationGroupSchemaResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConfigurationGroupSchemaResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:hybridnetwork/v20240415:getConfigurationGroupSchema", args, LookupConfigurationGroupSchemaResultOutput{}, options).(LookupConfigurationGroupSchemaResultOutput), nil
