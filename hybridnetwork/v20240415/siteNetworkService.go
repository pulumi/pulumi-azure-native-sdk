...
func NewSiteNetworkService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20240415:SiteNetworkService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSiteNetworkService(ctx *pulumi.Context,
	...
	var resource SiteNetworkService
	err := ctx.ReadResource("azure-native:hybridnetwork/v20240415:SiteNetworkService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
