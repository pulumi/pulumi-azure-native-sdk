...
func NewPublisher(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20240415:Publisher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublisher(ctx *pulumi.Context,
	...
	var resource Publisher
	err := ctx.ReadResource("azure-native:hybridnetwork/v20240415:Publisher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
