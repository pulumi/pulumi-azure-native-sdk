...
func NewNetworkServiceDesignVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20240415:NetworkServiceDesignVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkServiceDesignVersion(ctx *pulumi.Context,
	...
	var resource NetworkServiceDesignVersion
	err := ctx.ReadResource("azure-native:hybridnetwork/v20240415:NetworkServiceDesignVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
