...
func NewArtifactStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20240415:ArtifactStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactStore(ctx *pulumi.Context,
	...
	var resource ArtifactStore
	err := ctx.ReadResource("azure-native:hybridnetwork/v20240415:ArtifactStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
