...
func NewVendorSkuPreview(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20200101preview:VendorSkuPreview", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVendorSkuPreview(ctx *pulumi.Context,
	...
	var resource VendorSkuPreview
	err := ctx.ReadResource("azure-native:hybridnetwork/v20200101preview:VendorSkuPreview", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
