...
func NewVendorSkus(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20210501:VendorSkus", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVendorSkus(ctx *pulumi.Context,
	...
	var resource VendorSkus
	err := ctx.ReadResource("azure-native:hybridnetwork/v20210501:VendorSkus", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
