...
func NewVendor(ctx *pulumi.Context,
	...
	var resource Vendor
	err := ctx.RegisterResource("azure-native:hybridnetwork/v20210501:Vendor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVendor(ctx *pulumi.Context,
	...
	var resource Vendor
	err := ctx.ReadResource("azure-native:hybridnetwork/v20210501:Vendor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
