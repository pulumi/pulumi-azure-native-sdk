...
// The Azure API version of the resource.
func (o ArtifactStoreOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ArtifactStore) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ArtifactStoreOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *ArtifactStore) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
