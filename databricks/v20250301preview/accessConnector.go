...
func NewAccessConnector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databricks/v20250301preview:AccessConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessConnector(ctx *pulumi.Context,
	...
	var resource AccessConnector
	err := ctx.ReadResource("azure-native:databricks/v20250301preview:AccessConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
