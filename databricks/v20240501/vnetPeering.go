...
func NewVNetPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databricks/v20240501:VNetPeering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVNetPeering(ctx *pulumi.Context,
	...
	var resource VNetPeering
	err := ctx.ReadResource("azure-native:databricks/v20240501:VNetPeering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
