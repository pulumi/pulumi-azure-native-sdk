...
func LookupVNetPeering(ctx *pulumi.Context, args *LookupVNetPeeringArgs, opts ...pulumi.InvokeOption) (*LookupVNetPeeringResult, error) {
	...
	err := ctx.Invoke("azure-native:databricks/v20240501:getVNetPeering", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVNetPeeringOutput(ctx *pulumi.Context, args LookupVNetPeeringOutputArgs, opts ...pulumi.InvokeOption) LookupVNetPeeringResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVNetPeeringResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:databricks/v20240501:getVNetPeering", args, LookupVNetPeeringResultOutput{}, options).(LookupVNetPeeringResultOutput), nil
