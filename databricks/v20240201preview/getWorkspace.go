...
func LookupWorkspace(ctx *pulumi.Context, args *LookupWorkspaceArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceResult, error) {
	...
	err := ctx.Invoke("azure-native:databricks/v20240201preview:getWorkspace", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
// Gets or Sets Private DBFS Access configuration information
func (o LookupWorkspaceResultOutput) PrivateDbfsAccess() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *string { return v.PrivateDbfsAccess }).(pulumi.StringPtrOutput)
}
