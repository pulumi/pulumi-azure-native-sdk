...
type Workspace struct {
	...
	PrivateDbfsAccess pulumi.StringPtrOutput `pulumi:"privateDbfsAccess"`
...
func NewWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:databricks/v20240201preview:Workspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspace(ctx *pulumi.Context,
	...
	var resource Workspace
	err := ctx.ReadResource("azure-native:databricks/v20240201preview:Workspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type workspaceArgs struct {
	...
	// Gets or Sets Private DBFS Access configuration information
	PrivateDbfsAccess *string `pulumi:"privateDbfsAccess"`
	// The network access type for accessing workspace. Set value to disabled to access workspace only via private link.
...
type WorkspaceArgs struct {
	...
	// Gets or Sets Private DBFS Access configuration information
	PrivateDbfsAccess pulumi.StringPtrInput
	// The network access type for accessing workspace. Set value to disabled to access workspace only via private link.
...
// Gets or Sets Private DBFS Access configuration information
func (o WorkspaceOutput) PrivateDbfsAccess() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Workspace) pulumi.StringPtrOutput { return v.PrivateDbfsAccess }).(pulumi.StringPtrOutput)
}
