...
//
// Deprecated: azure-native:migrate/v20191001preview:MoveResource is being removed in the next major version of this provider. Upgrade to at least azure-native:migrate/v20220801:MoveResource to guarantee forwards compatibility.
...
func NewMoveResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20191001preview:MoveResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMoveResource(ctx *pulumi.Context,
	...
	var resource MoveResource
	err := ctx.ReadResource("azure-native:migrate/v20191001preview:MoveResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
