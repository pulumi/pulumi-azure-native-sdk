...
func NewPrivateEndpointConnectionOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:migrate/v20240115:PrivateEndpointConnectionOperation"),
		},
		{
			Type: pulumi.String("azure-native:migrate/v20240303preview:PrivateEndpointConnectionOperation"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:migrate:PrivateEndpointConnectionOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionOperation(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionOperation
	err := ctx.ReadResource("azure-native:migrate:PrivateEndpointConnectionOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
