...
func NewPrivateEndpointConnectionControllerPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:migrate/v20200501:PrivateEndpointConnectionControllerPrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateEndpointConnectionControllerPrivateEndpointConnection
	err := ctx.RegisterResource("azure-native:migrate/v20230101:PrivateEndpointConnectionControllerPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionControllerPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionControllerPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:migrate/v20230101:PrivateEndpointConnectionControllerPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
