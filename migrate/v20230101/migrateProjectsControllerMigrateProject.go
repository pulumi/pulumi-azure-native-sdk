...
func NewMigrateProjectsControllerMigrateProject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230101:MigrateProjectsControllerMigrateProject", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigrateProjectsControllerMigrateProject(ctx *pulumi.Context,
	...
	var resource MigrateProjectsControllerMigrateProject
	err := ctx.ReadResource("azure-native:migrate/v20230101:MigrateProjectsControllerMigrateProject", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
