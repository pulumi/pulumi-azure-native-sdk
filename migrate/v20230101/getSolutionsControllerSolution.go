...
func (o LookupSolutionsControllerSolutionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSolutionsControllerSolutionResult] {
	return pulumix.Output[LookupSolutionsControllerSolutionResult]{
