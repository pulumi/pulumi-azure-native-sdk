...
func NewPrivateEndpointConnectionProxyController(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:migrate:PrivateEndpointConnectionProxyController"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateEndpointConnectionProxyController
	err := ctx.RegisterResource("azure-native:migrate/v20230101:PrivateEndpointConnectionProxyController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionProxyController(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionProxyController
	err := ctx.ReadResource("azure-native:migrate/v20230101:PrivateEndpointConnectionProxyController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
