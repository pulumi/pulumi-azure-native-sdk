...
func NewMoveCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230801:MoveCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMoveCollection(ctx *pulumi.Context,
	...
	var resource MoveCollection
	err := ctx.ReadResource("azure-native:migrate/v20230801:MoveCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
