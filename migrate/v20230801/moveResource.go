...
func NewMoveResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:migrate/v20220801:MoveResource"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MoveResource
	err := ctx.RegisterResource("azure-native:migrate/v20230801:MoveResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMoveResource(ctx *pulumi.Context,
	...
	var resource MoveResource
	err := ctx.ReadResource("azure-native:migrate/v20230801:MoveResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *MoveResource) ToOutput(ctx context.Context) pulumix.Output[*MoveResource] {
	return pulumix.Output[*MoveResource]{
		OutputState: i.ToMoveResourceOutputWithContext(ctx).OutputState,
	}
}
...
func (o MoveResourceOutput) ToOutput(ctx context.Context) pulumix.Output[*MoveResource] {
	return pulumix.Output[*MoveResource]{
