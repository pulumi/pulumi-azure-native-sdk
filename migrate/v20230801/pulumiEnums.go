...
func (in *moveTypePtr) ToOutput(ctx context.Context) pulumix.Output[*MoveType] {
	return pulumix.Output[*MoveType]{
		OutputState: in.ToMoveTypePtrOutputWithContext(ctx).OutputState,
	}
}
