...
func NewWebAppCollectorOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:migrate/v20240115:WebAppCollectorOperation"),
		},
		{
			Type: pulumi.String("azure-native:migrate/v20240303preview:WebAppCollectorOperation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WebAppCollectorOperation
	err := ctx.RegisterResource("azure-native:migrate:WebAppCollectorOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppCollectorOperation(ctx *pulumi.Context,
	...
	var resource WebAppCollectorOperation
	err := ctx.ReadResource("azure-native:migrate:WebAppCollectorOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebAppCollectorOperationOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *WebAppCollectorOperation) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
