...
func LookupMoveResource(ctx *pulumi.Context, args *LookupMoveResourceArgs, opts ...pulumi.InvokeOption) (*LookupMoveResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20220801:getMoveResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMoveResourceOutput(ctx *pulumi.Context, args LookupMoveResourceOutputArgs, opts ...pulumi.InvokeOption) LookupMoveResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMoveResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20220801:getMoveResource", args, LookupMoveResourceResultOutput{}, options).(LookupMoveResourceResultOutput), nil
