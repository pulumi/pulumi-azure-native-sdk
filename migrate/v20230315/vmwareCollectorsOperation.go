...
func NewVmwareCollectorsOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230315:VmwareCollectorsOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmwareCollectorsOperation(ctx *pulumi.Context,
	...
	var resource VmwareCollectorsOperation
	err := ctx.ReadResource("azure-native:migrate/v20230315:VmwareCollectorsOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
