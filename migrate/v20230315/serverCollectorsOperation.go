...
func NewServerCollectorsOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230315:ServerCollectorsOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerCollectorsOperation(ctx *pulumi.Context,
	...
	var resource ServerCollectorsOperation
	err := ctx.ReadResource("azure-native:migrate/v20230315:ServerCollectorsOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
