...
func (o LookupAvsAssessmentsOperationResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAvsAssessmentsOperationResult] {
	return pulumix.Output[LookupAvsAssessmentsOperationResult]{
