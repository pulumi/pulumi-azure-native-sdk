...
func LookupServerCollectorsOperationOutput(ctx *pulumi.Context, args LookupServerCollectorsOperationOutputArgs, opts ...pulumi.InvokeOption) LookupServerCollectorsOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerCollectorsOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate:getServerCollectorsOperation", args, LookupServerCollectorsOperationResultOutput{}, options).(LookupServerCollectorsOperationResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupServerCollectorsOperationResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupServerCollectorsOperationResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupServerCollectorsOperationResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupServerCollectorsOperationResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
