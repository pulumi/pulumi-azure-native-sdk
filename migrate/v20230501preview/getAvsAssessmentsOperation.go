...
func LookupAvsAssessmentsOperation(ctx *pulumi.Context, args *LookupAvsAssessmentsOperationArgs, opts ...pulumi.InvokeOption) (*LookupAvsAssessmentsOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20230501preview:getAvsAssessmentsOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAvsAssessmentsOperationOutput(ctx *pulumi.Context, args LookupAvsAssessmentsOperationOutputArgs, opts ...pulumi.InvokeOption) LookupAvsAssessmentsOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAvsAssessmentsOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20230501preview:getAvsAssessmentsOperation", args, LookupAvsAssessmentsOperationResultOutput{}, options).(LookupAvsAssessmentsOperationResultOutput), nil
