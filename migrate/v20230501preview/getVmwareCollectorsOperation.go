...
func LookupVmwareCollectorsOperation(ctx *pulumi.Context, args *LookupVmwareCollectorsOperationArgs, opts ...pulumi.InvokeOption) (*LookupVmwareCollectorsOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20230501preview:getVmwareCollectorsOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVmwareCollectorsOperationOutput(ctx *pulumi.Context, args LookupVmwareCollectorsOperationOutputArgs, opts ...pulumi.InvokeOption) LookupVmwareCollectorsOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVmwareCollectorsOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20230501preview:getVmwareCollectorsOperation", args, LookupVmwareCollectorsOperationResultOutput{}, options).(LookupVmwareCollectorsOperationResultOutput), nil
