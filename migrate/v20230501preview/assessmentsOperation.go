...
func NewAssessmentsOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230501preview:AssessmentsOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssessmentsOperation(ctx *pulumi.Context,
	...
	var resource AssessmentsOperation
	err := ctx.ReadResource("azure-native:migrate/v20230501preview:AssessmentsOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
