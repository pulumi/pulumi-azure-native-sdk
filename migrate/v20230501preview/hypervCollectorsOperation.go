...
func NewHypervCollectorsOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230501preview:HypervCollectorsOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHypervCollectorsOperation(ctx *pulumi.Context,
	...
	var resource HypervCollectorsOperation
	err := ctx.ReadResource("azure-native:migrate/v20230501preview:HypervCollectorsOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
