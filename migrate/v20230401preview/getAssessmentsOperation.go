...
func LookupAssessmentsOperation(ctx *pulumi.Context, args *LookupAssessmentsOperationArgs, opts ...pulumi.InvokeOption) (*LookupAssessmentsOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20230401preview:getAssessmentsOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAssessmentsOperationOutput(ctx *pulumi.Context, args LookupAssessmentsOperationOutputArgs, opts ...pulumi.InvokeOption) LookupAssessmentsOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAssessmentsOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20230401preview:getAssessmentsOperation", args, LookupAssessmentsOperationResultOutput{}, options).(LookupAssessmentsOperationResultOutput), nil
