...
func NewAvsAssessmentsOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230401preview:AvsAssessmentsOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAvsAssessmentsOperation(ctx *pulumi.Context,
	...
	var resource AvsAssessmentsOperation
	err := ctx.ReadResource("azure-native:migrate/v20230401preview:AvsAssessmentsOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
