...
func LookupHypervCollectorsOperation(ctx *pulumi.Context, args *LookupHypervCollectorsOperationArgs, opts ...pulumi.InvokeOption) (*LookupHypervCollectorsOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20230401preview:getHypervCollectorsOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHypervCollectorsOperationOutput(ctx *pulumi.Context, args LookupHypervCollectorsOperationOutputArgs, opts ...pulumi.InvokeOption) LookupHypervCollectorsOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHypervCollectorsOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20230401preview:getHypervCollectorsOperation", args, LookupHypervCollectorsOperationResultOutput{}, options).(LookupHypervCollectorsOperationResultOutput), nil
