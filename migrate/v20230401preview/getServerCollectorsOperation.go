...
func LookupServerCollectorsOperation(ctx *pulumi.Context, args *LookupServerCollectorsOperationArgs, opts ...pulumi.InvokeOption) (*LookupServerCollectorsOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20230401preview:getServerCollectorsOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServerCollectorsOperationOutput(ctx *pulumi.Context, args LookupServerCollectorsOperationOutputArgs, opts ...pulumi.InvokeOption) LookupServerCollectorsOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServerCollectorsOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20230401preview:getServerCollectorsOperation", args, LookupServerCollectorsOperationResultOutput{}, options).(LookupServerCollectorsOperationResultOutput), nil
