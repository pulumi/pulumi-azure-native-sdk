...
func NewAssessmentProjectsOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230401preview:AssessmentProjectsOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssessmentProjectsOperation(ctx *pulumi.Context,
	...
	var resource AssessmentProjectsOperation
	err := ctx.ReadResource("azure-native:migrate/v20230401preview:AssessmentProjectsOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
