...
func NewSqlAssessmentV2Operation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230909preview:SqlAssessmentV2Operation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlAssessmentV2Operation(ctx *pulumi.Context,
	...
	var resource SqlAssessmentV2Operation
	err := ctx.ReadResource("azure-native:migrate/v20230909preview:SqlAssessmentV2Operation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
