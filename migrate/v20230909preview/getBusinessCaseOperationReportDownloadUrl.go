...
func GetBusinessCaseOperationReportDownloadUrl(ctx *pulumi.Context, args *GetBusinessCaseOperationReportDownloadUrlArgs, opts ...pulumi.InvokeOption) (*GetBusinessCaseOperationReportDownloadUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20230909preview:getBusinessCaseOperationReportDownloadUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetBusinessCaseOperationReportDownloadUrlOutput(ctx *pulumi.Context, args GetBusinessCaseOperationReportDownloadUrlOutputArgs, opts ...pulumi.InvokeOption) GetBusinessCaseOperationReportDownloadUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetBusinessCaseOperationReportDownloadUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20230909preview:getBusinessCaseOperationReportDownloadUrl", args, GetBusinessCaseOperationReportDownloadUrlResultOutput{}, options).(GetBusinessCaseOperationReportDownloadUrlResultOutput), nil
