...
func LookupSqlCollectorOperation(ctx *pulumi.Context, args *LookupSqlCollectorOperationArgs, opts ...pulumi.InvokeOption) (*LookupSqlCollectorOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20230909preview:getSqlCollectorOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSqlCollectorOperationOutput(ctx *pulumi.Context, args LookupSqlCollectorOperationOutputArgs, opts ...pulumi.InvokeOption) LookupSqlCollectorOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSqlCollectorOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20230909preview:getSqlCollectorOperation", args, LookupSqlCollectorOperationResultOutput{}, options).(LookupSqlCollectorOperationResultOutput), nil
