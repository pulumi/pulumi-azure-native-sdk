...
func LookupGroupsOperation(ctx *pulumi.Context, args *LookupGroupsOperationArgs, opts ...pulumi.InvokeOption) (*LookupGroupsOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20230909preview:getGroupsOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGroupsOperationOutput(ctx *pulumi.Context, args LookupGroupsOperationOutputArgs, opts ...pulumi.InvokeOption) LookupGroupsOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGroupsOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate/v20230909preview:getGroupsOperation", args, LookupGroupsOperationResultOutput{}, options).(LookupGroupsOperationResultOutput), nil
