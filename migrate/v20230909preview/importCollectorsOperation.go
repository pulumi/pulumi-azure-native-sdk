...
func NewImportCollectorsOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230909preview:ImportCollectorsOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportCollectorsOperation(ctx *pulumi.Context,
	...
	var resource ImportCollectorsOperation
	err := ctx.ReadResource("azure-native:migrate/v20230909preview:ImportCollectorsOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
