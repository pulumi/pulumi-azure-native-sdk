...
func NewBusinessCaseOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230909preview:BusinessCaseOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBusinessCaseOperation(ctx *pulumi.Context,
	...
	var resource BusinessCaseOperation
	err := ctx.ReadResource("azure-native:migrate/v20230909preview:BusinessCaseOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
