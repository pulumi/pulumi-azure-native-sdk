...
func NewGroupsOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20230909preview:GroupsOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupsOperation(ctx *pulumi.Context,
	...
	var resource GroupsOperation
	err := ctx.ReadResource("azure-native:migrate/v20230909preview:GroupsOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
