...
func NewMigrateAgent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:migrate/v20220501preview:MigrateAgent"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MigrateAgent
	err := ctx.RegisterResource("azure-native:migrate:MigrateAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigrateAgent(ctx *pulumi.Context,
	...
	var resource MigrateAgent
	err := ctx.ReadResource("azure-native:migrate:MigrateAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o MigrateAgentOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *MigrateAgent) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
