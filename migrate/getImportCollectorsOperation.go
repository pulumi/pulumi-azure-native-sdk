...
func LookupImportCollectorsOperation(ctx *pulumi.Context, args *LookupImportCollectorsOperationArgs, opts ...pulumi.InvokeOption) (*LookupImportCollectorsOperationResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate:getImportCollectorsOperation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupImportCollectorsOperationOutput(ctx *pulumi.Context, args LookupImportCollectorsOperationOutputArgs, opts ...pulumi.InvokeOption) LookupImportCollectorsOperationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupImportCollectorsOperationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:migrate:getImportCollectorsOperation", args, LookupImportCollectorsOperationResultOutput{}, options).(LookupImportCollectorsOperationResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupImportCollectorsOperationResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupImportCollectorsOperationResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
