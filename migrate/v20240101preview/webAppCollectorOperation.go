...
func NewWebAppCollectorOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20240101preview:WebAppCollectorOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppCollectorOperation(ctx *pulumi.Context,
	...
	var resource WebAppCollectorOperation
	err := ctx.ReadResource("azure-native:migrate/v20240101preview:WebAppCollectorOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
