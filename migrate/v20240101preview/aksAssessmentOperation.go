...
func NewAksAssessmentOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20240101preview:AksAssessmentOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAksAssessmentOperation(ctx *pulumi.Context,
	...
	var resource AksAssessmentOperation
	err := ctx.ReadResource("azure-native:migrate/v20240101preview:AksAssessmentOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
