...
func NewSqlCollectorOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20240101preview:SqlCollectorOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlCollectorOperation(ctx *pulumi.Context,
	...
	var resource SqlCollectorOperation
	err := ctx.ReadResource("azure-native:migrate/v20240101preview:SqlCollectorOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
