...
//
// Deprecated: azure-native:migrate/v20210801:MoveCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:migrate/v20220801:MoveCollection to guarantee forwards compatibility.
func LookupMoveCollection(ctx *pulumi.Context, args *LookupMoveCollectionArgs, opts ...pulumi.InvokeOption) (*LookupMoveCollectionResult, error) {
	...
	err := ctx.Invoke("azure-native:migrate/v20210801:getMoveCollection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
