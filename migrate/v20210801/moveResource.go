...
func NewMoveResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate/v20210801:MoveResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMoveResource(ctx *pulumi.Context,
	...
	var resource MoveResource
	err := ctx.ReadResource("azure-native:migrate/v20210801:MoveResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
