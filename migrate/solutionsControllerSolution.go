...
func NewSolutionsControllerSolution(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:migrate:SolutionsControllerSolution", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSolutionsControllerSolution(ctx *pulumi.Context,
	...
	var resource SolutionsControllerSolution
	err := ctx.ReadResource("azure-native:migrate:SolutionsControllerSolution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
