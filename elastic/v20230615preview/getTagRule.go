...
func LookupTagRule(ctx *pulumi.Context, args *LookupTagRuleArgs, opts ...pulumi.InvokeOption) (*LookupTagRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20230615preview:getTagRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTagRuleOutput(ctx *pulumi.Context, args LookupTagRuleOutputArgs, opts ...pulumi.InvokeOption) LookupTagRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTagRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20230615preview:getTagRule", args, LookupTagRuleResultOutput{}, options).(LookupTagRuleResultOutput), nil
