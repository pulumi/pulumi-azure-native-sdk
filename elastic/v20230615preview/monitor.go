...
func NewMonitor(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:elastic/v20231101preview:Monitor"),
		},
		{
			Type: pulumi.String("azure-native:elastic/v20240101preview:Monitor"),
		},
		{
			Type: pulumi.String("azure-native:elastic/v20240301:Monitor"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Monitor
	err := ctx.RegisterResource("azure-native:elastic/v20230615preview:Monitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitor(ctx *pulumi.Context,
	...
	var resource Monitor
	err := ctx.ReadResource("azure-native:elastic/v20230615preview:Monitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
