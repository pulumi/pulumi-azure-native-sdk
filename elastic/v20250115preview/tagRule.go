...
func NewTagRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:elastic/v20231101preview:TagRule"),
		},
		{
			Type: pulumi.String("azure-native:elastic/v20240101preview:TagRule"),
		},
		{
			Type: pulumi.String("azure-native:elastic/v20240301:TagRule"),
		},
		{
			Type: pulumi.String("azure-native:elastic/v20240501preview:TagRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:elastic/v20250115preview:TagRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagRule(ctx *pulumi.Context,
	...
	var resource TagRule
	err := ctx.ReadResource("azure-native:elastic/v20250115preview:TagRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
