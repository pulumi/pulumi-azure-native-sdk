...
func LookupMonitor(ctx *pulumi.Context, args *LookupMonitorArgs, opts ...pulumi.InvokeOption) (*LookupMonitorResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20250115preview:getMonitor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMonitorOutput(ctx *pulumi.Context, args LookupMonitorOutputArgs, opts ...pulumi.InvokeOption) LookupMonitorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMonitorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20250115preview:getMonitor", args, LookupMonitorResultOutput{}, options).(LookupMonitorResultOutput), nil
...
// The kind of the Elastic resource - observability, security, search etc.
func (o LookupMonitorResultOutput) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupMonitorResult) *string { return v.Kind }).(pulumi.StringPtrOutput)
}
