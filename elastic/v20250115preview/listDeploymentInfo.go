...
func ListDeploymentInfo(ctx *pulumi.Context, args *ListDeploymentInfoArgs, opts ...pulumi.InvokeOption) (*ListDeploymentInfoResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20250115preview:listDeploymentInfo", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type ListDeploymentInfoResult struct {
	...
	ProjectType string `pulumi:"projectType"`
...
func ListDeploymentInfoOutput(ctx *pulumi.Context, args ListDeploymentInfoOutputArgs, opts ...pulumi.InvokeOption) ListDeploymentInfoResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListDeploymentInfoResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20250115preview:listDeploymentInfo", args, ListDeploymentInfoResultOutput{}, options).(ListDeploymentInfoResultOutput), nil
...
// ConfigurationType Type - Applicable for Serverless only.
func (o ListDeploymentInfoResultOutput) ConfigurationType() pulumi.StringOutput {
	return o.ApplyT(func(v ListDeploymentInfoResult) string { return v.ConfigurationType }).(pulumi.StringOutput)
}
...
// Project Type - Applicable for Serverless only.
func (o ListDeploymentInfoResultOutput) ProjectType() pulumi.StringOutput {
	return o.ApplyT(func(v ListDeploymentInfoResult) string { return v.ProjectType }).(pulumi.StringOutput)
}
