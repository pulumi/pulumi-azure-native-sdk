...
func NewMonitor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:elastic/v20250115preview:Monitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitor(ctx *pulumi.Context,
	...
	var resource Monitor
	err := ctx.ReadResource("azure-native:elastic/v20250115preview:Monitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The kind of the Elastic resource - observability, security, search etc.
func (o MonitorOutput) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Monitor) pulumi.StringPtrOutput { return v.Kind }).(pulumi.StringPtrOutput)
}
