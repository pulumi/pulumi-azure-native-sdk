...
func (HostingType) ElementType() reflect.Type {
	return reflect.TypeOf((*HostingType)(nil)).Elem()
}

func (e HostingType) ToHostingTypeOutput() HostingTypeOutput {
	return pulumi.ToOutput(e).(HostingTypeOutput)
}

func (e HostingType) ToHostingTypeOutputWithContext(ctx context.Context) HostingTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(HostingTypeOutput)
}

func (e HostingType) ToHostingTypePtrOutput() HostingTypePtrOutput {
	return e.ToHostingTypePtrOutputWithContext(context.Background())
}

func (e HostingType) ToHostingTypePtrOutputWithContext(ctx context.Context) HostingTypePtrOutput {
	return HostingType(e).ToHostingTypeOutputWithContext(ctx).ToHostingTypePtrOutputWithContext(ctx)
}

func (e HostingType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e HostingType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e HostingType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e HostingType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type HostingTypeOutput struct{ *pulumi.OutputState }

func (HostingTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HostingType)(nil)).Elem()
}

func (o HostingTypeOutput) ToHostingTypeOutput() HostingTypeOutput {
	return o
}

func (o HostingTypeOutput) ToHostingTypeOutputWithContext(ctx context.Context) HostingTypeOutput {
	return o
}

func (o HostingTypeOutput) ToHostingTypePtrOutput() HostingTypePtrOutput {
	return o.ToHostingTypePtrOutputWithContext(context.Background())
}

func (o HostingTypeOutput) ToHostingTypePtrOutputWithContext(ctx context.Context) HostingTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v HostingType) *HostingType {
		return &v
	}).(HostingTypePtrOutput)
}

func (o HostingTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o HostingTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e HostingType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o HostingTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o HostingTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e HostingType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type HostingTypePtrOutput struct{ *pulumi.OutputState }

func (HostingTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**HostingType)(nil)).Elem()
}

func (o HostingTypePtrOutput) ToHostingTypePtrOutput() HostingTypePtrOutput {
	return o
}

func (o HostingTypePtrOutput) ToHostingTypePtrOutputWithContext(ctx context.Context) HostingTypePtrOutput {
	return o
}

func (o HostingTypePtrOutput) Elem() HostingTypeOutput {
	return o.ApplyT(func(v *HostingType) HostingType {
		if v != nil {
			return *v
		}
		var ret HostingType
...
func (o HostingTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o HostingTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *HostingType) *string {
		if e == nil {
			return nil
		}
...
// HostingTypeInput is an input type that accepts values of the HostingType enum
// A concrete instance of `HostingTypeInput` can be one of the following:
//
//	HostingTypeHosted
//	HostingTypeServerless
type HostingTypeInput interface {
	pulumi.Input

	ToHostingTypeOutput() HostingTypeOutput
	ToHostingTypeOutputWithContext(context.Context) HostingTypeOutput
}

var hostingTypePtrType = reflect.TypeOf((**HostingType)(nil)).Elem()

type HostingTypePtrInput interface {
	pulumi.Input

	ToHostingTypePtrOutput() HostingTypePtrOutput
	ToHostingTypePtrOutputWithContext(context.Context) HostingTypePtrOutput
}

type hostingTypePtr string

func HostingTypePtr(v string) HostingTypePtrInput {
	return (*hostingTypePtr)(&v)
}

func (*hostingTypePtr) ElementType() reflect.Type {
	return hostingTypePtrType
}

func (in *hostingTypePtr) ToHostingTypePtrOutput() HostingTypePtrOutput {
	return pulumi.ToOutput(in).(HostingTypePtrOutput)
}

func (in *hostingTypePtr) ToHostingTypePtrOutputWithContext(ctx context.Context) HostingTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(HostingTypePtrOutput)
}
...
func (ProjectType) ElementType() reflect.Type {
	return reflect.TypeOf((*ProjectType)(nil)).Elem()
}

func (e ProjectType) ToProjectTypeOutput() ProjectTypeOutput {
	return pulumi.ToOutput(e).(ProjectTypeOutput)
}

func (e ProjectType) ToProjectTypeOutputWithContext(ctx context.Context) ProjectTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ProjectTypeOutput)
}

func (e ProjectType) ToProjectTypePtrOutput() ProjectTypePtrOutput {
	return e.ToProjectTypePtrOutputWithContext(context.Background())
}

func (e ProjectType) ToProjectTypePtrOutputWithContext(ctx context.Context) ProjectTypePtrOutput {
	return ProjectType(e).ToProjectTypeOutputWithContext(ctx).ToProjectTypePtrOutputWithContext(ctx)
}

func (e ProjectType) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ProjectType) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ProjectType) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ProjectType) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}
...
func (o ProjectTypeOutput) ToProjectTypePtrOutput() ProjectTypePtrOutput {
	return o.ToProjectTypePtrOutputWithContext(context.Background())
}

func (o ProjectTypeOutput) ToProjectTypePtrOutputWithContext(ctx context.Context) ProjectTypePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ProjectType) *ProjectType {
		return &v
	}).(ProjectTypePtrOutput)
}

func (o ProjectTypeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ProjectTypeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ProjectType) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ProjectTypeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ProjectTypeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ProjectType) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
func (o ProjectTypePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ProjectTypePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ProjectType) *string {
		if e == nil {
			return nil
		}
...
// ProjectTypeInput is an input type that accepts values of the ProjectType enum
// A concrete instance of `ProjectTypeInput` can be one of the following:
//
...
var projectTypePtrType = reflect.TypeOf((**ProjectType)(nil)).Elem()

type ProjectTypePtrInput interface {
	pulumi.Input

	ToProjectTypePtrOutput() ProjectTypePtrOutput
	ToProjectTypePtrOutputWithContext(context.Context) ProjectTypePtrOutput
}

type projectTypePtr string

func ProjectTypePtr(v string) ProjectTypePtrInput {
	return (*projectTypePtr)(&v)
}

func (*projectTypePtr) ElementType() reflect.Type {
	return projectTypePtrType
}

func (in *projectTypePtr) ToProjectTypePtrOutput() ProjectTypePtrOutput {
	return pulumi.ToOutput(in).(ProjectTypePtrOutput)
}

func (in *projectTypePtr) ToProjectTypePtrOutputWithContext(ctx context.Context) ProjectTypePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ProjectTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(HostingTypeOutput{})
	pulumi.RegisterOutputType(HostingTypePtrOutput{})
