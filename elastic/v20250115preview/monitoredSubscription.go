...
func NewMonitoredSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:elastic/v20250115preview:MonitoredSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoredSubscription(ctx *pulumi.Context,
	...
	var resource MonitoredSubscription
	err := ctx.ReadResource("azure-native:elastic/v20250115preview:MonitoredSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
