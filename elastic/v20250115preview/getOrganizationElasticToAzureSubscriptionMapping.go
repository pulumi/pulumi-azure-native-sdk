...
func GetOrganizationElasticToAzureSubscriptionMapping(ctx *pulumi.Context, args *GetOrganizationElasticToAzureSubscriptionMappingArgs, opts ...pulumi.InvokeOption) (*GetOrganizationElasticToAzureSubscriptionMappingResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20250115preview:getOrganizationElasticToAzureSubscriptionMapping", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetOrganizationElasticToAzureSubscriptionMappingOutput(ctx *pulumi.Context, args GetOrganizationElasticToAzureSubscriptionMappingOutputArgs, opts ...pulumi.InvokeOption) GetOrganizationElasticToAzureSubscriptionMappingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetOrganizationElasticToAzureSubscriptionMappingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20250115preview:getOrganizationElasticToAzureSubscriptionMapping", args, GetOrganizationElasticToAzureSubscriptionMappingResultOutput{}, options).(GetOrganizationElasticToAzureSubscriptionMappingResultOutput), nil
