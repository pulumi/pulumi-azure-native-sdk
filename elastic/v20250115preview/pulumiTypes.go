...
// The hosting type of the resource.
func (o ConnectedPartnerResourcePropertiesResponseOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConnectedPartnerResourcePropertiesResponse) *string { return v.Type }).(pulumi.StringPtrOutput)
}
...
// The hosting type of the resource.
func (o ConnectedPartnerResourcePropertiesResponsePtrOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ConnectedPartnerResourcePropertiesResponse) *string {
		if v == nil {
			return nil
		}
...
type MonitorProperties struct {
	...
	HostingType *string `pulumi:"hostingType"`
	...
	ProjectDetails *ProjectDetails `pulumi:"projectDetails"`
...
// Hosting type of the monitor resource - either Hosted deployments OR Serverless Projects.
func (o MonitorPropertiesOutput) HostingType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v MonitorProperties) *string { return v.HostingType }).(pulumi.StringPtrOutput)
}
...
// Project details of the monitor resource IF it belongs to Serverless offer kind.
func (o MonitorPropertiesOutput) ProjectDetails() ProjectDetailsPtrOutput {
	return o.ApplyT(func(v MonitorProperties) *ProjectDetails { return v.ProjectDetails }).(ProjectDetailsPtrOutput)
}
...
// Hosting type of the monitor resource - either Hosted deployments OR Serverless Projects.
func (o MonitorPropertiesPtrOutput) HostingType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *MonitorProperties) *string {
		if v == nil {
			return nil
		}
		return v.HostingType
	}).(pulumi.StringPtrOutput)
}
...
// Project details of the monitor resource IF it belongs to Serverless offer kind.
func (o MonitorPropertiesPtrOutput) ProjectDetails() ProjectDetailsPtrOutput {
	return o.ApplyT(func(v *MonitorProperties) *ProjectDetails {
		if v == nil {
			return nil
		}
		return v.ProjectDetails
	}).(ProjectDetailsPtrOutput)
}
...
type MonitorPropertiesResponse struct {
	...
	// Project details of the monitor resource IF it belongs to Serverless offer kind.
	ProjectDetails *ProjectDetailsResponse `pulumi:"projectDetails"`
...
// Hosting type of the monitor resource - either Hosted deployments OR Serverless Projects.
func (o MonitorPropertiesResponseOutput) HostingType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v MonitorPropertiesResponse) *string { return v.HostingType }).(pulumi.StringPtrOutput)
}
...
// Project details of the monitor resource IF it belongs to Serverless offer kind.
func (o MonitorPropertiesResponseOutput) ProjectDetails() ProjectDetailsResponsePtrOutput {
	return o.ApplyT(func(v MonitorPropertiesResponse) *ProjectDetailsResponse { return v.ProjectDetails }).(ProjectDetailsResponsePtrOutput)
}
...
// ProjectDetailsInput is an input type that accepts ProjectDetailsArgs and ProjectDetailsOutput values.
// You can construct a concrete instance of `ProjectDetailsInput` via:
//
//	ProjectDetailsArgs{...}
type ProjectDetailsInput interface {
	pulumi.Input

	ToProjectDetailsOutput() ProjectDetailsOutput
	ToProjectDetailsOutputWithContext(context.Context) ProjectDetailsOutput
}

// Project details of the monitor resource IF it belongs to Serverless offer kind.
type ProjectDetailsArgs struct {
	// Configuration type of the Elasticsearch project
	ConfigurationType pulumi.StringPtrInput `pulumi:"configurationType"`
	// Project type; ex: Elasticsearch / Observability / Security
	ProjectType pulumi.StringPtrInput `pulumi:"projectType"`
}

func (ProjectDetailsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ProjectDetails)(nil)).Elem()
}

func (i ProjectDetailsArgs) ToProjectDetailsOutput() ProjectDetailsOutput {
	return i.ToProjectDetailsOutputWithContext(context.Background())
}

func (i ProjectDetailsArgs) ToProjectDetailsOutputWithContext(ctx context.Context) ProjectDetailsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProjectDetailsOutput)
}

func (i ProjectDetailsArgs) ToProjectDetailsPtrOutput() ProjectDetailsPtrOutput {
	return i.ToProjectDetailsPtrOutputWithContext(context.Background())
}

func (i ProjectDetailsArgs) ToProjectDetailsPtrOutputWithContext(ctx context.Context) ProjectDetailsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProjectDetailsOutput).ToProjectDetailsPtrOutputWithContext(ctx)
}

// ProjectDetailsPtrInput is an input type that accepts ProjectDetailsArgs, ProjectDetailsPtr and ProjectDetailsPtrOutput values.
// You can construct a concrete instance of `ProjectDetailsPtrInput` via:
//
//	        ProjectDetailsArgs{...}
//
//	or:
//
//	        nil
type ProjectDetailsPtrInput interface {
	pulumi.Input

	ToProjectDetailsPtrOutput() ProjectDetailsPtrOutput
	ToProjectDetailsPtrOutputWithContext(context.Context) ProjectDetailsPtrOutput
}

type projectDetailsPtrType ProjectDetailsArgs

func ProjectDetailsPtr(v *ProjectDetailsArgs) ProjectDetailsPtrInput {
	return (*projectDetailsPtrType)(v)
}

func (*projectDetailsPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ProjectDetails)(nil)).Elem()
}

func (i *projectDetailsPtrType) ToProjectDetailsPtrOutput() ProjectDetailsPtrOutput {
	return i.ToProjectDetailsPtrOutputWithContext(context.Background())
}

func (i *projectDetailsPtrType) ToProjectDetailsPtrOutputWithContext(ctx context.Context) ProjectDetailsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProjectDetailsPtrOutput)
}

// Project details of the monitor resource IF it belongs to Serverless offer kind.
type ProjectDetailsOutput struct{ *pulumi.OutputState }

func (ProjectDetailsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ProjectDetails)(nil)).Elem()
}

func (o ProjectDetailsOutput) ToProjectDetailsOutput() ProjectDetailsOutput {
	return o
}

func (o ProjectDetailsOutput) ToProjectDetailsOutputWithContext(ctx context.Context) ProjectDetailsOutput {
	return o
}

func (o ProjectDetailsOutput) ToProjectDetailsPtrOutput() ProjectDetailsPtrOutput {
	return o.ToProjectDetailsPtrOutputWithContext(context.Background())
}

func (o ProjectDetailsOutput) ToProjectDetailsPtrOutputWithContext(ctx context.Context) ProjectDetailsPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ProjectDetails) *ProjectDetails {
		return &v
	}).(ProjectDetailsPtrOutput)
}

// Configuration type of the Elasticsearch project
func (o ProjectDetailsOutput) ConfigurationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProjectDetails) *string { return v.ConfigurationType }).(pulumi.StringPtrOutput)
}

// Project type; ex: Elasticsearch / Observability / Security
func (o ProjectDetailsOutput) ProjectType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProjectDetails) *string { return v.ProjectType }).(pulumi.StringPtrOutput)
}

type ProjectDetailsPtrOutput struct{ *pulumi.OutputState }

func (ProjectDetailsPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ProjectDetails)(nil)).Elem()
}

func (o ProjectDetailsPtrOutput) ToProjectDetailsPtrOutput() ProjectDetailsPtrOutput {
	return o
}

func (o ProjectDetailsPtrOutput) ToProjectDetailsPtrOutputWithContext(ctx context.Context) ProjectDetailsPtrOutput {
	return o
}

func (o ProjectDetailsPtrOutput) Elem() ProjectDetailsOutput {
	return o.ApplyT(func(v *ProjectDetails) ProjectDetails {
		if v != nil {
			return *v
		}
...
// Configuration type of the Elasticsearch project
func (o ProjectDetailsPtrOutput) ConfigurationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProjectDetails) *string {
		if v == nil {
			return nil
		}
...
// Project type; ex: Elasticsearch / Observability / Security
func (o ProjectDetailsPtrOutput) ProjectType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProjectDetails) *string {
		if v == nil {
			return nil
		}
...
// Project details of the monitor resource IF it belongs to Serverless offer kind.
type ProjectDetailsResponseOutput struct{ *pulumi.OutputState }

func (ProjectDetailsResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ProjectDetailsResponse)(nil)).Elem()
}

func (o ProjectDetailsResponseOutput) ToProjectDetailsResponseOutput() ProjectDetailsResponseOutput {
	return o
}

func (o ProjectDetailsResponseOutput) ToProjectDetailsResponseOutputWithContext(ctx context.Context) ProjectDetailsResponseOutput {
	return o
}

// Configuration type of the Elasticsearch project
func (o ProjectDetailsResponseOutput) ConfigurationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProjectDetailsResponse) *string { return v.ConfigurationType }).(pulumi.StringPtrOutput)
}

// Project type; ex: Elasticsearch / Observability / Security
func (o ProjectDetailsResponseOutput) ProjectType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProjectDetailsResponse) *string { return v.ProjectType }).(pulumi.StringPtrOutput)
}

type ProjectDetailsResponsePtrOutput struct{ *pulumi.OutputState }

func (ProjectDetailsResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ProjectDetailsResponse)(nil)).Elem()
}

func (o ProjectDetailsResponsePtrOutput) ToProjectDetailsResponsePtrOutput() ProjectDetailsResponsePtrOutput {
	return o
}

func (o ProjectDetailsResponsePtrOutput) ToProjectDetailsResponsePtrOutputWithContext(ctx context.Context) ProjectDetailsResponsePtrOutput {
	return o
}

func (o ProjectDetailsResponsePtrOutput) Elem() ProjectDetailsResponseOutput {
	return o.ApplyT(func(v *ProjectDetailsResponse) ProjectDetailsResponse {
		if v != nil {
			return *v
		}
		var ret ProjectDetailsResponse
		return ret
	}).(ProjectDetailsResponseOutput)
}

// Configuration type of the Elasticsearch project
func (o ProjectDetailsResponsePtrOutput) ConfigurationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProjectDetailsResponse) *string {
		if v == nil {
			return nil
		}
		return v.ConfigurationType
...
// Project type; ex: Elasticsearch / Observability / Security
func (o ProjectDetailsResponsePtrOutput) ProjectType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProjectDetailsResponse) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterOutputType(ProjectDetailsOutput{})
	pulumi.RegisterOutputType(ProjectDetailsPtrOutput{})
	pulumi.RegisterOutputType(ProjectDetailsResponseOutput{})
	pulumi.RegisterOutputType(ProjectDetailsResponsePtrOutput{})
