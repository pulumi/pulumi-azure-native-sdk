...
//
// Deprecated: azure-native:elastic/v20210901preview:TagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20220901preview:TagRule to guarantee forwards compatibility.
type TagRule struct {
