...
func GetOrganizationApiKey(ctx *pulumi.Context, args *GetOrganizationApiKeyArgs, opts ...pulumi.InvokeOption) (*GetOrganizationApiKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20230501preview:getOrganizationApiKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetOrganizationApiKeyOutput(ctx *pulumi.Context, args GetOrganizationApiKeyOutputArgs, opts ...pulumi.InvokeOption) GetOrganizationApiKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetOrganizationApiKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20230501preview:getOrganizationApiKey", args, GetOrganizationApiKeyResultOutput{}, options).(GetOrganizationApiKeyResultOutput), nil
