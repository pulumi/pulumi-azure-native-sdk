...
// Monitor resource.
//
// Deprecated: azure-native:elastic/v20220701preview:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20220901preview:Monitor to guarantee forwards compatibility.
