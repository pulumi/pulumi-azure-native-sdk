...
func NewOpenAI(ctx *pulumi.Context,
	...
	var resource OpenAI
	err := ctx.RegisterResource("azure-native:elastic/v20240501preview:OpenAI", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOpenAI(ctx *pulumi.Context,
	...
	var resource OpenAI
	err := ctx.ReadResource("azure-native:elastic/v20240501preview:OpenAI", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
