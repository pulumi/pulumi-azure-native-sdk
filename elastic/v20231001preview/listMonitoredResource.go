...
func ListMonitoredResource(ctx *pulumi.Context, args *ListMonitoredResourceArgs, opts ...pulumi.InvokeOption) (*ListMonitoredResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20231001preview:listMonitoredResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListMonitoredResourceOutput(ctx *pulumi.Context, args ListMonitoredResourceOutputArgs, opts ...pulumi.InvokeOption) ListMonitoredResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListMonitoredResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20231001preview:listMonitoredResource", args, ListMonitoredResourceResultOutput{}, options).(ListMonitoredResourceResultOutput), nil
