...
func NewTagRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:elastic/v20230201preview:TagRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagRule(ctx *pulumi.Context,
	...
	var resource TagRule
	err := ctx.ReadResource("azure-native:elastic/v20230201preview:TagRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
