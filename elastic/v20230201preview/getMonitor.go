...
func LookupMonitor(ctx *pulumi.Context, args *LookupMonitorArgs, opts ...pulumi.InvokeOption) (*LookupMonitorResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20230201preview:getMonitor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Flag to determine if User API Key has to be generated and shared.
func (o LookupMonitorResultOutput) GenerateApiKey() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupMonitorResult) bool { return v.GenerateApiKey }).(pulumi.BoolOutput)
}
