...
type Monitor struct {
	...
	GenerateApiKey pulumi.BoolOutput `pulumi:"generateApiKey"`
...
func NewMonitor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:elastic/v20230201preview:Monitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitor(ctx *pulumi.Context,
	...
	var resource Monitor
	err := ctx.ReadResource("azure-native:elastic/v20230201preview:Monitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Flag to determine if User API Key has to be generated and shared.
func (o MonitorOutput) GenerateApiKey() pulumi.BoolOutput {
	return o.ApplyT(func(v *Monitor) pulumi.BoolOutput { return v.GenerateApiKey }).(pulumi.BoolOutput)
}
