...
func LookupOpenAI(ctx *pulumi.Context, args *LookupOpenAIArgs, opts ...pulumi.InvokeOption) (*LookupOpenAIResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20240615preview:getOpenAI", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupOpenAIOutput(ctx *pulumi.Context, args LookupOpenAIOutputArgs, opts ...pulumi.InvokeOption) LookupOpenAIResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOpenAIResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20240615preview:getOpenAI", args, LookupOpenAIResultOutput{}, options).(LookupOpenAIResultOutput), nil
