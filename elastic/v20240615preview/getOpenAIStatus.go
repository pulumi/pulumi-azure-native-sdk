...
func GetOpenAIStatus(ctx *pulumi.Context, args *GetOpenAIStatusArgs, opts ...pulumi.InvokeOption) (*GetOpenAIStatusResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20240615preview:getOpenAIStatus", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetOpenAIStatusOutput(ctx *pulumi.Context, args GetOpenAIStatusOutputArgs, opts ...pulumi.InvokeOption) GetOpenAIStatusResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetOpenAIStatusResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20240615preview:getOpenAIStatus", args, GetOpenAIStatusResultOutput{}, options).(GetOpenAIStatusResultOutput), nil
