...
func ListUpgradableVersionDetails(ctx *pulumi.Context, args *ListUpgradableVersionDetailsArgs, opts ...pulumi.InvokeOption) (*ListUpgradableVersionDetailsResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20240615preview:listUpgradableVersionDetails", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListUpgradableVersionDetailsOutput(ctx *pulumi.Context, args ListUpgradableVersionDetailsOutputArgs, opts ...pulumi.InvokeOption) ListUpgradableVersionDetailsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListUpgradableVersionDetailsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20240615preview:listUpgradableVersionDetails", args, ListUpgradableVersionDetailsResultOutput{}, options).(ListUpgradableVersionDetailsResultOutput), nil
