...
func ListConnectedPartnerResource(ctx *pulumi.Context, args *ListConnectedPartnerResourceArgs, opts ...pulumi.InvokeOption) (*ListConnectedPartnerResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20240615preview:listConnectedPartnerResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListConnectedPartnerResourceOutput(ctx *pulumi.Context, args ListConnectedPartnerResourceOutputArgs, opts ...pulumi.InvokeOption) ListConnectedPartnerResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListConnectedPartnerResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:elastic/v20240615preview:listConnectedPartnerResource", args, ListConnectedPartnerResourceResultOutput{}, options).(ListConnectedPartnerResourceResultOutput), nil
