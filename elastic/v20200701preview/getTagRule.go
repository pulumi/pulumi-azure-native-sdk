...
//
// Deprecated: azure-native:elastic/v20200701preview:TagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20230615preview:TagRule to guarantee forwards compatibility.
func LookupTagRule(ctx *pulumi.Context, args *LookupTagRuleArgs, opts ...pulumi.InvokeOption) (*LookupTagRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:elastic/v20200701preview:getTagRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
