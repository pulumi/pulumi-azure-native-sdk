...
func LookupUserAssignedIdentity(ctx *pulumi.Context, args *LookupUserAssignedIdentityArgs, opts ...pulumi.InvokeOption) (*LookupUserAssignedIdentityResult, error) {
	...
	err := ctx.Invoke("azure-native:managedidentity/v20250131preview:getUserAssignedIdentity", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUserAssignedIdentityOutput(ctx *pulumi.Context, args LookupUserAssignedIdentityOutputArgs, opts ...pulumi.InvokeOption) LookupUserAssignedIdentityResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUserAssignedIdentityResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:managedidentity/v20250131preview:getUserAssignedIdentity", args, LookupUserAssignedIdentityResultOutput{}, options).(LookupUserAssignedIdentityResultOutput), nil
...
// Enum to configure regional restrictions on identity assignment, as necessary.
func (o LookupUserAssignedIdentityResultOutput) IsolationScope() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupUserAssignedIdentityResult) *string { return v.IsolationScope }).(pulumi.StringPtrOutput)
}
