...
type FederatedIdentityCredential struct {
	...
	ClaimsMatchingExpression FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpressionPtrOutput `pulumi:"claimsMatchingExpression"`
...
func NewFederatedIdentityCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managedidentity/v20250131preview:FederatedIdentityCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFederatedIdentityCredential(ctx *pulumi.Context,
	...
	var resource FederatedIdentityCredential
	err := ctx.ReadResource("azure-native:managedidentity/v20250131preview:FederatedIdentityCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type federatedIdentityCredentialArgs struct {
	...
	// Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
	ClaimsMatchingExpression *FederatedIdentityCredentialPropertiesClaimsMatchingExpression `pulumi:"claimsMatchingExpression"`
...
type FederatedIdentityCredentialArgs struct {
	...
	// Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
	ClaimsMatchingExpression FederatedIdentityCredentialPropertiesClaimsMatchingExpressionPtrInput
	// The name of the federated identity credential resource.
...
// Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
func (o FederatedIdentityCredentialOutput) ClaimsMatchingExpression() FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpressionPtrOutput {
	return o.ApplyT(func(v *FederatedIdentityCredential) FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpressionPtrOutput {
		return v.ClaimsMatchingExpression
	}).(FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpressionPtrOutput)
}
...
// The identifier of the external identity. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
func (o FederatedIdentityCredentialOutput) Subject() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FederatedIdentityCredential) pulumi.StringPtrOutput { return v.Subject }).(pulumi.StringPtrOutput)
}
