...
func LookupFederatedIdentityCredential(ctx *pulumi.Context, args *LookupFederatedIdentityCredentialArgs, opts ...pulumi.InvokeOption) (*LookupFederatedIdentityCredentialResult, error) {
	...
	err := ctx.Invoke("azure-native:managedidentity/v20250131preview:getFederatedIdentityCredential", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupFederatedIdentityCredentialResult struct {
	...
	ClaimsMatchingExpression *FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpression `pulumi:"claimsMatchingExpression"`
...
func LookupFederatedIdentityCredentialOutput(ctx *pulumi.Context, args LookupFederatedIdentityCredentialOutputArgs, opts ...pulumi.InvokeOption) LookupFederatedIdentityCredentialResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFederatedIdentityCredentialResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:managedidentity/v20250131preview:getFederatedIdentityCredential", args, LookupFederatedIdentityCredentialResultOutput{}, options).(LookupFederatedIdentityCredentialResultOutput), nil
...
// Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
func (o LookupFederatedIdentityCredentialResultOutput) ClaimsMatchingExpression() FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpressionPtrOutput {
	return o.ApplyT(func(v LookupFederatedIdentityCredentialResult) *FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpression {
...
// The identifier of the external identity. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
func (o LookupFederatedIdentityCredentialResultOutput) Subject() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFederatedIdentityCredentialResult) *string { return v.Subject }).(pulumi.StringPtrOutput)
}
