...
func NewFederatedIdentityCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managedidentity/v20241130:FederatedIdentityCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFederatedIdentityCredential(ctx *pulumi.Context,
	...
	var resource FederatedIdentityCredential
	err := ctx.ReadResource("azure-native:managedidentity/v20241130:FederatedIdentityCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
