...
//
// Deprecated: azure-native:signalrservice/v20210401preview:SignalR is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalR to guarantee forwards compatibility.
func LookupSignalR(ctx *pulumi.Context, args *LookupSignalRArgs, opts ...pulumi.InvokeOption) (*LookupSignalRResult, error) {
	...
	err := ctx.Invoke("azure-native:signalrservice/v20210401preview:getSignalR", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
