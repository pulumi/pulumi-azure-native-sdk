...
//
// Deprecated: azure-native:signalrservice/v20210401preview:SignalRPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRPrivateEndpointConnection to guarantee forwards compatibility.
...
func NewSignalRPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20210401preview:SignalRPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource SignalRPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:signalrservice/v20210401preview:SignalRPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
