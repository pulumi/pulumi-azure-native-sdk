...
func NewSignalRReplica(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20230301preview:SignalRReplica", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRReplica(ctx *pulumi.Context,
	...
	var resource SignalRReplica
	err := ctx.ReadResource("azure-native:signalrservice/v20230301preview:SignalRReplica", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
