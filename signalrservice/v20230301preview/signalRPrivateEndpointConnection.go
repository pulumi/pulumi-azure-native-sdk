...
func NewSignalRPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20230301preview:SignalRPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource SignalRPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:signalrservice/v20230301preview:SignalRPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
