...
func NewSignalRCustomCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:signalrservice/v20230801preview:SignalRCustomCertificate"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240101preview:SignalRCustomCertificate"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240301:SignalRCustomCertificate"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20230301preview:SignalRCustomCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRCustomCertificate(ctx *pulumi.Context,
	...
	var resource SignalRCustomCertificate
	err := ctx.ReadResource("azure-native:signalrservice/v20230301preview:SignalRCustomCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
