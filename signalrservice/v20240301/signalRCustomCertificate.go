...
func NewSignalRCustomCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20240301:SignalRCustomCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRCustomCertificate(ctx *pulumi.Context,
	...
	var resource SignalRCustomCertificate
	err := ctx.ReadResource("azure-native:signalrservice/v20240301:SignalRCustomCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
