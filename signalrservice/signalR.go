...
func NewSignalR(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:signalrservice/v20250101preview:SignalR"),
		},
	})
...
// The Azure API version of the resource.
func (o SignalROutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SignalR) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SignalROutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *SignalR) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
