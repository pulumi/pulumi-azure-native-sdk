...
func NewSignalRSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:signalrservice/v20250101preview:SignalRSharedPrivateLinkResource"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SignalRSharedPrivateLinkResourceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *SignalRSharedPrivateLinkResource) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
