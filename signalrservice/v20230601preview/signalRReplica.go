...
func NewSignalRReplica(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:signalrservice/v20240101preview:SignalRReplica"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240301:SignalRReplica"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240401preview:SignalRReplica"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240801preview:SignalRReplica"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20230601preview:SignalRReplica", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRReplica(ctx *pulumi.Context,
	...
	var resource SignalRReplica
	err := ctx.ReadResource("azure-native:signalrservice/v20230601preview:SignalRReplica", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
