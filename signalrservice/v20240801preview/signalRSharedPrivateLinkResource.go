...
func NewSignalRSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20240801preview:SignalRSharedPrivateLinkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	var resource SignalRSharedPrivateLinkResource
	err := ctx.ReadResource("azure-native:signalrservice/v20240801preview:SignalRSharedPrivateLinkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// A list of FQDNs for third party private link service
func (o SignalRSharedPrivateLinkResourceOutput) Fqdns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *SignalRSharedPrivateLinkResource) pulumi.StringArrayOutput { return v.Fqdns }).(pulumi.StringArrayOutput)
}
