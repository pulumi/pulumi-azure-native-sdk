...
func LookupSignalRPrivateEndpointConnection(ctx *pulumi.Context, args *LookupSignalRPrivateEndpointConnectionArgs, opts ...pulumi.InvokeOption) (*LookupSignalRPrivateEndpointConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:signalrservice/v20240401preview:getSignalRPrivateEndpointConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSignalRPrivateEndpointConnectionOutput(ctx *pulumi.Context, args LookupSignalRPrivateEndpointConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupSignalRPrivateEndpointConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSignalRPrivateEndpointConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:signalrservice/v20240401preview:getSignalRPrivateEndpointConnection", args, LookupSignalRPrivateEndpointConnectionResultOutput{}, options).(LookupSignalRPrivateEndpointConnectionResultOutput), nil
