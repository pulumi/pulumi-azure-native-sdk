...
// ServiceKindInput is an input type that accepts values of the ServiceKind enum
// A concrete instance of `ServiceKindInput` can be one of the following:
//
//	ServiceKindSignalR
...
// SignalRRequestTypeInput is an input type that accepts values of the SignalRRequestType enum
// A concrete instance of `SignalRRequestTypeInput` can be one of the following:
//
...
// SignalRSkuTierInput is an input type that accepts values of the SignalRSkuTier enum
// A concrete instance of `SignalRSkuTierInput` can be one of the following:
//
//	SignalRSkuTierFree
//	SignalRSkuTierBasic
