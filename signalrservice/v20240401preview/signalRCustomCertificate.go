...
func NewSignalRCustomCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20240401preview:SignalRCustomCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRCustomCertificate(ctx *pulumi.Context,
	...
	var resource SignalRCustomCertificate
	err := ctx.ReadResource("azure-native:signalrservice/v20240401preview:SignalRCustomCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
