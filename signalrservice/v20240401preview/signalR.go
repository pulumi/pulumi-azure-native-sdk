...
type SignalR struct {
	...
	ApplicationFirewall ApplicationFirewallSettingsResponsePtrOutput `pulumi:"applicationFirewall"`
...
func NewSignalR(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:signalrservice/v20230801preview:SignalR"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240101preview:SignalR"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240301:SignalR"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20240401preview:SignalR", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalR(ctx *pulumi.Context,
	...
	var resource SignalR
	err := ctx.ReadResource("azure-native:signalrservice/v20240401preview:SignalR", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type signalRArgs struct {
	// Application firewall settings for the resource
	ApplicationFirewall *ApplicationFirewallSettings `pulumi:"applicationFirewall"`
	// Cross-Origin Resource Sharing (CORS) settings.
...
type SignalRArgs struct {
	// Application firewall settings for the resource
	ApplicationFirewall ApplicationFirewallSettingsPtrInput
	// Cross-Origin Resource Sharing (CORS) settings.
...
// Application firewall settings for the resource
func (o SignalROutput) ApplicationFirewall() ApplicationFirewallSettingsResponsePtrOutput {
	return o.ApplyT(func(v *SignalR) ApplicationFirewallSettingsResponsePtrOutput { return v.ApplicationFirewall }).(ApplicationFirewallSettingsResponsePtrOutput)
}
