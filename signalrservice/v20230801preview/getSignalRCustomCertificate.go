...
func LookupSignalRCustomCertificate(ctx *pulumi.Context, args *LookupSignalRCustomCertificateArgs, opts ...pulumi.InvokeOption) (*LookupSignalRCustomCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:signalrservice/v20230801preview:getSignalRCustomCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSignalRCustomCertificateOutput(ctx *pulumi.Context, args LookupSignalRCustomCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupSignalRCustomCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSignalRCustomCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:signalrservice/v20230801preview:getSignalRCustomCertificate", args, LookupSignalRCustomCertificateResultOutput{}, options).(LookupSignalRCustomCertificateResultOutput), nil
