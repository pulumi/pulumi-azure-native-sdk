...
func LookupSignalRSharedPrivateLinkResource(ctx *pulumi.Context, args *LookupSignalRSharedPrivateLinkResourceArgs, opts ...pulumi.InvokeOption) (*LookupSignalRSharedPrivateLinkResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:signalrservice/v20230801preview:getSignalRSharedPrivateLinkResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSignalRSharedPrivateLinkResourceOutput(ctx *pulumi.Context, args LookupSignalRSharedPrivateLinkResourceOutputArgs, opts ...pulumi.InvokeOption) LookupSignalRSharedPrivateLinkResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSignalRSharedPrivateLinkResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:signalrservice/v20230801preview:getSignalRSharedPrivateLinkResource", args, LookupSignalRSharedPrivateLinkResourceResultOutput{}, options).(LookupSignalRSharedPrivateLinkResourceResultOutput), nil
