...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSignalRPrivateEndpointConnectionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSignalRPrivateEndpointConnectionResult) commontypesv5.SystemDataResponse {
		return v.SystemData
