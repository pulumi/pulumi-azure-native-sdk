...
func LookupSignalRCustomDomainOutput(ctx *pulumi.Context, args LookupSignalRCustomDomainOutputArgs, opts ...pulumi.InvokeOption) LookupSignalRCustomDomainResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSignalRCustomDomainResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:signalrservice:getSignalRCustomDomain", args, LookupSignalRCustomDomainResultOutput{}, options).(LookupSignalRCustomDomainResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSignalRCustomDomainResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSignalRCustomDomainResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupSignalRCustomDomainResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSignalRCustomDomainResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
