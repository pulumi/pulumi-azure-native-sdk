...
func NewSignalRCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20241001preview:SignalRCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRCustomDomain(ctx *pulumi.Context,
	...
	var resource SignalRCustomDomain
	err := ctx.ReadResource("azure-native:signalrservice/v20241001preview:SignalRCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
