...
func NewSignalRSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20241001preview:SignalRSharedPrivateLinkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	var resource SignalRSharedPrivateLinkResource
	err := ctx.ReadResource("azure-native:signalrservice/v20241001preview:SignalRSharedPrivateLinkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
