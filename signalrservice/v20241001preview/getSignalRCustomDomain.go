...
func LookupSignalRCustomDomain(ctx *pulumi.Context, args *LookupSignalRCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupSignalRCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:signalrservice/v20241001preview:getSignalRCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSignalRCustomDomainOutput(ctx *pulumi.Context, args LookupSignalRCustomDomainOutputArgs, opts ...pulumi.InvokeOption) LookupSignalRCustomDomainResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSignalRCustomDomainResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:signalrservice/v20241001preview:getSignalRCustomDomain", args, LookupSignalRCustomDomainResultOutput{}, options).(LookupSignalRCustomDomainResultOutput), nil
