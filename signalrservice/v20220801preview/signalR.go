...
func NewSignalR(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:signalrservice/v20220801preview:SignalR", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalR(ctx *pulumi.Context,
	...
	var resource SignalR
	err := ctx.ReadResource("azure-native:signalrservice/v20220801preview:SignalR", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
