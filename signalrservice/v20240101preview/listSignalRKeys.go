...
func ListSignalRKeys(ctx *pulumi.Context, args *ListSignalRKeysArgs, opts ...pulumi.InvokeOption) (*ListSignalRKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:signalrservice/v20240101preview:listSignalRKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListSignalRKeysOutput(ctx *pulumi.Context, args ListSignalRKeysOutputArgs, opts ...pulumi.InvokeOption) ListSignalRKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListSignalRKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:signalrservice/v20240101preview:listSignalRKeys", args, ListSignalRKeysResultOutput{}, options).(ListSignalRKeysResultOutput), nil
