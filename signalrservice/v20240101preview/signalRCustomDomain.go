...
func NewSignalRCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:signalrservice/v20230801preview:SignalRCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240301:SignalRCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:signalrservice/v20240401preview:SignalRCustomDomain"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SignalRCustomDomain
	err := ctx.RegisterResource("azure-native:signalrservice/v20240101preview:SignalRCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSignalRCustomDomain(ctx *pulumi.Context,
	...
	var resource SignalRCustomDomain
	err := ctx.ReadResource("azure-native:signalrservice/v20240101preview:SignalRCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
