...
func LookupSignalR(ctx *pulumi.Context, args *LookupSignalRArgs, opts ...pulumi.InvokeOption) (*LookupSignalRResult, error) {
	...
	err := ctx.Invoke("azure-native:signalrservice/v20240101preview:getSignalR", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupSignalROutput(ctx *pulumi.Context, args LookupSignalROutputArgs, opts ...pulumi.InvokeOption) LookupSignalRResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSignalRResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:signalrservice/v20240101preview:getSignalR", args, LookupSignalRResultOutput{}, options).(LookupSignalRResultOutput), nil
