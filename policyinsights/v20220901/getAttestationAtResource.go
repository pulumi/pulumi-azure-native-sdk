...
func (o LookupAttestationAtResourceResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAttestationAtResourceResult] {
	return pulumix.Output[LookupAttestationAtResourceResult]{
