...
func NewAttestationAtResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:policyinsights/v20241001:AttestationAtResource"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AttestationAtResource
	err := ctx.RegisterResource("azure-native:policyinsights/v20220901:AttestationAtResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestationAtResource(ctx *pulumi.Context,
	...
	var resource AttestationAtResource
	err := ctx.ReadResource("azure-native:policyinsights/v20220901:AttestationAtResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
