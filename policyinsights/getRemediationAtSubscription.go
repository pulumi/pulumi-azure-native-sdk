...
// The remediation failure threshold settings
func (o LookupRemediationAtSubscriptionResultOutput) FailureThreshold() RemediationPropertiesFailureThresholdResponsePtrOutput {
	return o.ApplyT(func(v LookupRemediationAtSubscriptionResult) *RemediationPropertiesFailureThresholdResponse {
