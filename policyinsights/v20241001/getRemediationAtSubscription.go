...
func LookupRemediationAtSubscription(ctx *pulumi.Context, args *LookupRemediationAtSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupRemediationAtSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:policyinsights/v20241001:getRemediationAtSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRemediationAtSubscriptionOutput(ctx *pulumi.Context, args LookupRemediationAtSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupRemediationAtSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRemediationAtSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:policyinsights/v20241001:getRemediationAtSubscription", args, LookupRemediationAtSubscriptionResultOutput{}, options).(LookupRemediationAtSubscriptionResultOutput), nil
