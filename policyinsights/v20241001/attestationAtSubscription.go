...
func NewAttestationAtSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:policyinsights/v20241001:AttestationAtSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestationAtSubscription(ctx *pulumi.Context,
	...
	var resource AttestationAtSubscription
	err := ctx.ReadResource("azure-native:policyinsights/v20241001:AttestationAtSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
