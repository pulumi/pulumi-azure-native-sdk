...
func NewAttestationAtResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:policyinsights/v20241001:AttestationAtResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestationAtResource(ctx *pulumi.Context,
	...
	var resource AttestationAtResource
	err := ctx.ReadResource("azure-native:policyinsights/v20241001:AttestationAtResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
