...
func NewRemediationAtSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:policyinsights/v20241001:RemediationAtSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtSubscription(ctx *pulumi.Context,
	...
	var resource RemediationAtSubscription
	err := ctx.ReadResource("azure-native:policyinsights/v20241001:RemediationAtSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
