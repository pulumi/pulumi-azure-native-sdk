...
func ListRemediationDeploymentsAtManagementGroup(ctx *pulumi.Context, args *ListRemediationDeploymentsAtManagementGroupArgs, opts ...pulumi.InvokeOption) (*ListRemediationDeploymentsAtManagementGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:policyinsights/v20241001:listRemediationDeploymentsAtManagementGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListRemediationDeploymentsAtManagementGroupOutput(ctx *pulumi.Context, args ListRemediationDeploymentsAtManagementGroupOutputArgs, opts ...pulumi.InvokeOption) ListRemediationDeploymentsAtManagementGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListRemediationDeploymentsAtManagementGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:policyinsights/v20241001:listRemediationDeploymentsAtManagementGroup", args, ListRemediationDeploymentsAtManagementGroupResultOutput{}, options).(ListRemediationDeploymentsAtManagementGroupResultOutput), nil
