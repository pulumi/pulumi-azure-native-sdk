...
func LookupRemediationAtResource(ctx *pulumi.Context, args *LookupRemediationAtResourceArgs, opts ...pulumi.InvokeOption) (*LookupRemediationAtResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:policyinsights/v20241001:getRemediationAtResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRemediationAtResourceOutput(ctx *pulumi.Context, args LookupRemediationAtResourceOutputArgs, opts ...pulumi.InvokeOption) LookupRemediationAtResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRemediationAtResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:policyinsights/v20241001:getRemediationAtResource", args, LookupRemediationAtResourceResultOutput{}, options).(LookupRemediationAtResourceResultOutput), nil
