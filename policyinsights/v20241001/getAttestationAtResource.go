...
func LookupAttestationAtResource(ctx *pulumi.Context, args *LookupAttestationAtResourceArgs, opts ...pulumi.InvokeOption) (*LookupAttestationAtResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:policyinsights/v20241001:getAttestationAtResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAttestationAtResourceOutput(ctx *pulumi.Context, args LookupAttestationAtResourceOutputArgs, opts ...pulumi.InvokeOption) LookupAttestationAtResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAttestationAtResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:policyinsights/v20241001:getAttestationAtResource", args, LookupAttestationAtResourceResultOutput{}, options).(LookupAttestationAtResourceResultOutput), nil
