...
func NewAttestationAtResourceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:policyinsights/v20241001:AttestationAtResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestationAtResourceGroup(ctx *pulumi.Context,
	...
	var resource AttestationAtResourceGroup
	err := ctx.ReadResource("azure-native:policyinsights/v20241001:AttestationAtResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
