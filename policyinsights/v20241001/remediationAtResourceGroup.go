...
func NewRemediationAtResourceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:policyinsights/v20241001:RemediationAtResourceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtResourceGroup(ctx *pulumi.Context,
	...
	var resource RemediationAtResourceGroup
	err := ctx.ReadResource("azure-native:policyinsights/v20241001:RemediationAtResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
