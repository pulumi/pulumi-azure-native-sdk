...
func ListRemediationDeploymentsAtResourceGroup(ctx *pulumi.Context, args *ListRemediationDeploymentsAtResourceGroupArgs, opts ...pulumi.InvokeOption) (*ListRemediationDeploymentsAtResourceGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:policyinsights/v20241001:listRemediationDeploymentsAtResourceGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListRemediationDeploymentsAtResourceGroupOutput(ctx *pulumi.Context, args ListRemediationDeploymentsAtResourceGroupOutputArgs, opts ...pulumi.InvokeOption) ListRemediationDeploymentsAtResourceGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListRemediationDeploymentsAtResourceGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:policyinsights/v20241001:listRemediationDeploymentsAtResourceGroup", args, ListRemediationDeploymentsAtResourceGroupResultOutput{}, options).(ListRemediationDeploymentsAtResourceGroupResultOutput), nil
