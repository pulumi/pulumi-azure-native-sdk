...
func LookupRemediationAtManagementGroup(ctx *pulumi.Context, args *LookupRemediationAtManagementGroupArgs, opts ...pulumi.InvokeOption) (*LookupRemediationAtManagementGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:policyinsights/v20241001:getRemediationAtManagementGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRemediationAtManagementGroupOutput(ctx *pulumi.Context, args LookupRemediationAtManagementGroupOutputArgs, opts ...pulumi.InvokeOption) LookupRemediationAtManagementGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRemediationAtManagementGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:policyinsights/v20241001:getRemediationAtManagementGroup", args, LookupRemediationAtManagementGroupResultOutput{}, options).(LookupRemediationAtManagementGroupResultOutput), nil
