...
func LookupAttestationAtSubscription(ctx *pulumi.Context, args *LookupAttestationAtSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupAttestationAtSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:policyinsights/v20241001:getAttestationAtSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAttestationAtSubscriptionOutput(ctx *pulumi.Context, args LookupAttestationAtSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupAttestationAtSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAttestationAtSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:policyinsights/v20241001:getAttestationAtSubscription", args, LookupAttestationAtSubscriptionResultOutput{}, options).(LookupAttestationAtSubscriptionResultOutput), nil
