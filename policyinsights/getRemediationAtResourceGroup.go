...
func (o LookupRemediationAtResourceGroupResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRemediationAtResourceGroupResult] {
	return pulumix.Output[LookupRemediationAtResourceGroupResult]{
