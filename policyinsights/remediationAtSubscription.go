...
func NewRemediationAtSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:policyinsights/v20241001:RemediationAtSubscription"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource RemediationAtSubscription
	err := ctx.RegisterResource("azure-native:policyinsights:RemediationAtSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemediationAtSubscription(ctx *pulumi.Context,
	...
	var resource RemediationAtSubscription
	err := ctx.ReadResource("azure-native:policyinsights:RemediationAtSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o RemediationAtSubscriptionOutput) SystemData() commontypesv1.SystemDataResponseOutput {
	return o.ApplyT(func(v *RemediationAtSubscription) commontypesv1.SystemDataResponseOutput { return v.SystemData }).(commontypesv1.SystemDataResponseOutput)
}
