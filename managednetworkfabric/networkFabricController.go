...
type NetworkFabricController struct {
	...
	InfrastructureServices NetworkFabricControllerPropertiesResponseInfrastructureServicesOutput `pulumi:"infrastructureServices"`
	...
	ManagedResourceGroupConfiguration NetworkFabricControllerPropertiesResponseManagedResourceGroupConfigurationPtrOutput `pulumi:"managedResourceGroupConfiguration"`
	...
	WorkloadServices NetworkFabricControllerPropertiesResponseWorkloadServicesOutput `pulumi:"workloadServices"`
}
...
func NewNetworkFabricController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managednetworkfabric:NetworkFabricController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFabricController(ctx *pulumi.Context,
	...
	var resource NetworkFabricController
	err := ctx.ReadResource("azure-native:managednetworkfabric:NetworkFabricController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type networkFabricControllerArgs struct {
	...
	// Managed Resource Group configuration properties.
	ManagedResourceGroupConfiguration *NetworkFabricControllerPropertiesManagedResourceGroupConfiguration `pulumi:"managedResourceGroupConfiguration"`
...
type NetworkFabricControllerArgs struct {
	...
	// Managed Resource Group configuration properties.
	ManagedResourceGroupConfiguration NetworkFabricControllerPropertiesManagedResourceGroupConfigurationPtrInput
	// Name of the Network Fabric Controller
...
// InfrastructureServices IP ranges.
func (o NetworkFabricControllerOutput) InfrastructureServices() NetworkFabricControllerPropertiesResponseInfrastructureServicesOutput {
	return o.ApplyT(func(v *NetworkFabricController) NetworkFabricControllerPropertiesResponseInfrastructureServicesOutput {
		return v.InfrastructureServices
	}).(NetworkFabricControllerPropertiesResponseInfrastructureServicesOutput)
}
...
// Managed Resource Group configuration properties.
func (o NetworkFabricControllerOutput) ManagedResourceGroupConfiguration() NetworkFabricControllerPropertiesResponseManagedResourceGroupConfigurationPtrOutput {
	return o.ApplyT(func(v *NetworkFabricController) NetworkFabricControllerPropertiesResponseManagedResourceGroupConfigurationPtrOutput {
		return v.ManagedResourceGroupConfiguration
	}).(NetworkFabricControllerPropertiesResponseManagedResourceGroupConfigurationPtrOutput)
}
...
// WorkloadServices IP ranges.
func (o NetworkFabricControllerOutput) WorkloadServices() NetworkFabricControllerPropertiesResponseWorkloadServicesOutput {
	return o.ApplyT(func(v *NetworkFabricController) NetworkFabricControllerPropertiesResponseWorkloadServicesOutput {
		return v.WorkloadServices
	}).(NetworkFabricControllerPropertiesResponseWorkloadServicesOutput)
}
