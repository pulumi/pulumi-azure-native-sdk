...
func NewNetworkFabricController(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:NetworkFabricController"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:NetworkFabricController"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NetworkFabricControllerOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NetworkFabricController) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
