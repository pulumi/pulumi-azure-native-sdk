...
func NewIpExtendedCommunity(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:IpExtendedCommunity"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:IpExtendedCommunity"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o IpExtendedCommunityOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *IpExtendedCommunity) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
