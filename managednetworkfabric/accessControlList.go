...
// The Azure API version of the resource.
func (o AccessControlListOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AccessControlList) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AccessControlListOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *AccessControlList) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
