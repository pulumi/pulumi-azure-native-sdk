...
func NewNetworkDevice(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:NetworkDevice"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:NetworkDevice"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NetworkDeviceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NetworkDevice) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
