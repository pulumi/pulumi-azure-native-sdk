...
func NewIpPrefix(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:IpPrefix"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:IpPrefix"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o IpPrefixOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *IpPrefix) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
