...
func NewL3IsolationDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230201preview:L3IsolationDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetL3IsolationDomain(ctx *pulumi.Context,
	...
	var resource L3IsolationDomain
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230201preview:L3IsolationDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
