...
func NewIpPrefixList(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:managednetworkfabric:IpPrefixList"),
		},
	})
	opts = append(opts, aliases)
	var resource IpPrefixList
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230201preview:IpPrefixList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpPrefixList(ctx *pulumi.Context,
	...
	var resource IpPrefixList
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230201preview:IpPrefixList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
