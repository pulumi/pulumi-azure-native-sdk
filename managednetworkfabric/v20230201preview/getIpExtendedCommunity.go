...
func LookupIpExtendedCommunity(ctx *pulumi.Context, args *LookupIpExtendedCommunityArgs, opts ...pulumi.InvokeOption) (*LookupIpExtendedCommunityResult, error) {
	...
	err := ctx.Invoke("azure-native:managednetworkfabric/v20230201preview:getIpExtendedCommunity", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupIpExtendedCommunityOutput(ctx *pulumi.Context, args LookupIpExtendedCommunityOutputArgs, opts ...pulumi.InvokeOption) LookupIpExtendedCommunityResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIpExtendedCommunityResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:managednetworkfabric/v20230201preview:getIpExtendedCommunity", args, LookupIpExtendedCommunityResultOutput{}, options).(LookupIpExtendedCommunityResultOutput), nil
