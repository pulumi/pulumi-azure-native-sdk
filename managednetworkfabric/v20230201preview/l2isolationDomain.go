...
func NewL2IsolationDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230201preview:L2IsolationDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetL2IsolationDomain(ctx *pulumi.Context,
	...
	var resource L2IsolationDomain
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230201preview:L2IsolationDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
