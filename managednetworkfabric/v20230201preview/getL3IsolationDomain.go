...
type LookupL3IsolationDomainResult struct {
	...
	AggregateRouteConfiguration *L3IsolationDomainPatchPropertiesResponseAggregateRouteConfiguration `pulumi:"aggregateRouteConfiguration"`
...
// List of Ipv4 and Ipv6 route configurations.
func (o LookupL3IsolationDomainResultOutput) AggregateRouteConfiguration() L3IsolationDomainPatchPropertiesResponseAggregateRouteConfigurationPtrOutput {
	return o.ApplyT(func(v LookupL3IsolationDomainResult) *L3IsolationDomainPatchPropertiesResponseAggregateRouteConfiguration {
