...
func NewNetworkDevice(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230201preview:NetworkDevice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkDevice(ctx *pulumi.Context,
	...
	var resource NetworkDevice
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230201preview:NetworkDevice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
