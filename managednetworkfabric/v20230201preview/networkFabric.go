...
type NetworkFabric struct {
	...
	ManagementNetworkConfiguration NetworkFabricPropertiesResponseManagementNetworkConfigurationOutput `pulumi:"managementNetworkConfiguration"`
	...
	TerminalServerConfiguration NetworkFabricPropertiesResponseTerminalServerConfigurationOutput `pulumi:"terminalServerConfiguration"`
...
func NewNetworkFabric(ctx *pulumi.Context,
	...
	if isZero(args.Ipv4Prefix) {
		args.Ipv4Prefix = pulumi.StringPtr("10.1.0.0/19")
	}
	if isZero(args.Ipv6Prefix) {
		args.Ipv6Prefix = pulumi.StringPtr("3FFE:FFFF:0:CD40::/59")
	}
	args.ManagementNetworkConfiguration = args.ManagementNetworkConfiguration.ToNetworkFabricPropertiesManagementNetworkConfigurationOutput().ApplyT(func(v NetworkFabricPropertiesManagementNetworkConfiguration) NetworkFabricPropertiesManagementNetworkConfiguration {
		return *v.Defaults()
	}).(NetworkFabricPropertiesManagementNetworkConfigurationOutput)
	args.TerminalServerConfiguration = args.TerminalServerConfiguration.ToNetworkFabricPropertiesTerminalServerConfigurationOutput().ApplyT(func(v NetworkFabricPropertiesTerminalServerConfiguration) NetworkFabricPropertiesTerminalServerConfiguration {
		return *v.Defaults()
	}).(NetworkFabricPropertiesTerminalServerConfigurationOutput)
	...
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230201preview:NetworkFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFabric(ctx *pulumi.Context,
	...
	var resource NetworkFabric
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230201preview:NetworkFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type networkFabricArgs struct {
	...
	// Configuration to be used to setup the management network.
	ManagementNetworkConfiguration NetworkFabricPropertiesManagementNetworkConfiguration `pulumi:"managementNetworkConfiguration"`
	// Azure resource ID for the NetworkFabricController the NetworkFabric belongs.
	...
	// Network and credentials configuration currently applied to terminal server.
	TerminalServerConfiguration NetworkFabricPropertiesTerminalServerConfiguration `pulumi:"terminalServerConfiguration"`
}
...
type NetworkFabricArgs struct {
	...
	// Configuration to be used to setup the management network.
	ManagementNetworkConfiguration NetworkFabricPropertiesManagementNetworkConfigurationInput
	// Azure resource ID for the NetworkFabricController the NetworkFabric belongs.
	...
	// Network and credentials configuration currently applied to terminal server.
	TerminalServerConfiguration NetworkFabricPropertiesTerminalServerConfigurationInput
}
...
// Configuration to be used to setup the management network.
func (o NetworkFabricOutput) ManagementNetworkConfiguration() NetworkFabricPropertiesResponseManagementNetworkConfigurationOutput {
	return o.ApplyT(func(v *NetworkFabric) NetworkFabricPropertiesResponseManagementNetworkConfigurationOutput {
		return v.ManagementNetworkConfiguration
	}).(NetworkFabricPropertiesResponseManagementNetworkConfigurationOutput)
}
...
// Network and credentials configuration currently applied to terminal server.
func (o NetworkFabricOutput) TerminalServerConfiguration() NetworkFabricPropertiesResponseTerminalServerConfigurationOutput {
	return o.ApplyT(func(v *NetworkFabric) NetworkFabricPropertiesResponseTerminalServerConfigurationOutput {
		return v.TerminalServerConfiguration
	}).(NetworkFabricPropertiesResponseTerminalServerConfigurationOutput)
}
