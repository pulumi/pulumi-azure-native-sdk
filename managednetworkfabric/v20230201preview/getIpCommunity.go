...
func LookupIpCommunity(ctx *pulumi.Context, args *LookupIpCommunityArgs, opts ...pulumi.InvokeOption) (*LookupIpCommunityResult, error) {
	...
	err := ctx.Invoke("azure-native:managednetworkfabric/v20230201preview:getIpCommunity", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupIpCommunityOutput(ctx *pulumi.Context, args LookupIpCommunityOutputArgs, opts ...pulumi.InvokeOption) LookupIpCommunityResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIpCommunityResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:managednetworkfabric/v20230201preview:getIpCommunity", args, LookupIpCommunityResultOutput{}, options).(LookupIpCommunityResultOutput), nil
