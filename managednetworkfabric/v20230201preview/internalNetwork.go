...
func NewInternalNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230201preview:InternalNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInternalNetwork(ctx *pulumi.Context,
	...
	var resource InternalNetwork
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230201preview:InternalNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
