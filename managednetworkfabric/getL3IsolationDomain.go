...
func LookupL3IsolationDomain(ctx *pulumi.Context, args *LookupL3IsolationDomainArgs, opts ...pulumi.InvokeOption) (*LookupL3IsolationDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:managednetworkfabric:getL3IsolationDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupL3IsolationDomainOutput(ctx *pulumi.Context, args LookupL3IsolationDomainOutputArgs, opts ...pulumi.InvokeOption) LookupL3IsolationDomainResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupL3IsolationDomainResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:managednetworkfabric:getL3IsolationDomain", args, LookupL3IsolationDomainResultOutput{}, options).(LookupL3IsolationDomainResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupL3IsolationDomainResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupL3IsolationDomainResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupL3IsolationDomainResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupL3IsolationDomainResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
