...
type LookupNetworkFabricControllerResult struct {
	...
	InfrastructureServices NetworkFabricControllerPropertiesResponseInfrastructureServices `pulumi:"infrastructureServices"`
	...
	ManagedResourceGroupConfiguration *NetworkFabricControllerPropertiesResponseManagedResourceGroupConfiguration `pulumi:"managedResourceGroupConfiguration"`
	...
	WorkloadServices NetworkFabricControllerPropertiesResponseWorkloadServices `pulumi:"workloadServices"`
}
...
// InfrastructureServices IP ranges.
func (o LookupNetworkFabricControllerResultOutput) InfrastructureServices() NetworkFabricControllerPropertiesResponseInfrastructureServicesOutput {
	return o.ApplyT(func(v LookupNetworkFabricControllerResult) NetworkFabricControllerPropertiesResponseInfrastructureServices {
...
// Managed Resource Group configuration properties.
func (o LookupNetworkFabricControllerResultOutput) ManagedResourceGroupConfiguration() NetworkFabricControllerPropertiesResponseManagedResourceGroupConfigurationPtrOutput {
	return o.ApplyT(func(v LookupNetworkFabricControllerResult) *NetworkFabricControllerPropertiesResponseManagedResourceGroupConfiguration {
...
// WorkloadServices IP ranges.
func (o LookupNetworkFabricControllerResultOutput) WorkloadServices() NetworkFabricControllerPropertiesResponseWorkloadServicesOutput {
	return o.ApplyT(func(v LookupNetworkFabricControllerResult) NetworkFabricControllerPropertiesResponseWorkloadServices {
