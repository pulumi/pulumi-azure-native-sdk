...
func NewNetworkTapRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20250715:NetworkTapRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkTapRule
	err := ctx.RegisterResource("azure-native:managednetworkfabric:NetworkTapRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkTapRule(ctx *pulumi.Context,
	...
	var resource NetworkTapRule
	err := ctx.ReadResource("azure-native:managednetworkfabric:NetworkTapRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
