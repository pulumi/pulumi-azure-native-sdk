...
func NewNetworkTap(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:managednetworkfabric:NetworkTap"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkTap
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230615:NetworkTap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkTap(ctx *pulumi.Context,
	...
	var resource NetworkTap
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230615:NetworkTap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *NetworkTap) ToOutput(ctx context.Context) pulumix.Output[*NetworkTap] {
	return pulumix.Output[*NetworkTap]{
		OutputState: i.ToNetworkTapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NetworkTapOutput) ToOutput(ctx context.Context) pulumix.Output[*NetworkTap] {
	return pulumix.Output[*NetworkTap]{
