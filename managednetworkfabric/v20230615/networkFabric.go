...
func NewNetworkFabric(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230615:NetworkFabric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFabric(ctx *pulumi.Context,
	...
	var resource NetworkFabric
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230615:NetworkFabric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
