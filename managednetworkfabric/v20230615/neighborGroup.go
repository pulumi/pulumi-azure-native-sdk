...
func NewNeighborGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:managednetworkfabric:NeighborGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NeighborGroup
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230615:NeighborGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNeighborGroup(ctx *pulumi.Context,
	...
	var resource NeighborGroup
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230615:NeighborGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
