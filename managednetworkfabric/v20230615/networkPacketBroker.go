...
func NewNetworkPacketBroker(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:managednetworkfabric:NetworkPacketBroker"),
		},
	})
	opts = append(opts, aliases)
	var resource NetworkPacketBroker
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230615:NetworkPacketBroker", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkPacketBroker(ctx *pulumi.Context,
	...
	var resource NetworkPacketBroker
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230615:NetworkPacketBroker", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
