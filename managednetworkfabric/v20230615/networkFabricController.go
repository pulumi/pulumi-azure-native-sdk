...
func NewNetworkFabricController(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20230201preview:NetworkFabricController"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkFabricController
	err := ctx.RegisterResource("azure-native:managednetworkfabric/v20230615:NetworkFabricController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFabricController(ctx *pulumi.Context,
	...
	var resource NetworkFabricController
	err := ctx.ReadResource("azure-native:managednetworkfabric/v20230615:NetworkFabricController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *NetworkFabricController) ToOutput(ctx context.Context) pulumix.Output[*NetworkFabricController] {
	return pulumix.Output[*NetworkFabricController]{
		OutputState: i.ToNetworkFabricControllerOutputWithContext(ctx).OutputState,
	}
}
...
func (o NetworkFabricControllerOutput) ToOutput(ctx context.Context) pulumix.Output[*NetworkFabricController] {
	return pulumix.Output[*NetworkFabricController]{
