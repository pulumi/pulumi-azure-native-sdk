...
type L3IsolationDomain struct {
	...
	AggregateRouteConfiguration L3IsolationDomainPatchPropertiesResponseAggregateRouteConfigurationPtrOutput `pulumi:"aggregateRouteConfiguration"`
...
func NewL3IsolationDomain(ctx *pulumi.Context,
	...
	if isZero(args.RedistributeConnectedSubnets) {
		args.RedistributeConnectedSubnets = pulumi.StringPtr("True")
	}
	if isZero(args.RedistributeStaticRoutes) {
...
type l3isolationDomainArgs struct {
	// List of Ipv4 and Ipv6 route configurations.
	AggregateRouteConfiguration *L3IsolationDomainPatchPropertiesAggregateRouteConfiguration `pulumi:"aggregateRouteConfiguration"`
	// Switch configuration description.
...
type L3IsolationDomainArgs struct {
	// List of Ipv4 and Ipv6 route configurations.
	AggregateRouteConfiguration L3IsolationDomainPatchPropertiesAggregateRouteConfigurationPtrInput
	// Switch configuration description.
...
// List of Ipv4 and Ipv6 route configurations.
func (o L3IsolationDomainOutput) AggregateRouteConfiguration() L3IsolationDomainPatchPropertiesResponseAggregateRouteConfigurationPtrOutput {
	return o.ApplyT(func(v *L3IsolationDomain) L3IsolationDomainPatchPropertiesResponseAggregateRouteConfigurationPtrOutput {
		return v.AggregateRouteConfiguration
	}).(L3IsolationDomainPatchPropertiesResponseAggregateRouteConfigurationPtrOutput)
}
