...
func NewNetworkToNetworkInterconnect(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:NetworkToNetworkInterconnect"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:NetworkToNetworkInterconnect"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20250715:NetworkToNetworkInterconnect"),
		},
	})
