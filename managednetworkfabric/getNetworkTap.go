...
func LookupNetworkTap(ctx *pulumi.Context, args *LookupNetworkTapArgs, opts ...pulumi.InvokeOption) (*LookupNetworkTapResult, error) {
	...
	err := ctx.Invoke("azure-native:managednetworkfabric:getNetworkTap", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupNetworkTapOutput(ctx *pulumi.Context, args LookupNetworkTapOutputArgs, opts ...pulumi.InvokeOption) LookupNetworkTapResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNetworkTapResultOutput, error) {
			args := v.(LookupNetworkTapArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:managednetworkfabric:getNetworkTap", args, LookupNetworkTapResultOutput{}, options).(LookupNetworkTapResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupNetworkTapResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupNetworkTapResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
