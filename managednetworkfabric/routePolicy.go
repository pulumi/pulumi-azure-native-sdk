...
func NewRoutePolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:RoutePolicy"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:RoutePolicy"),
		},
	})
...
// The Azure API version of the resource.
func (o RoutePolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *RoutePolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o RoutePolicyOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *RoutePolicy) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
