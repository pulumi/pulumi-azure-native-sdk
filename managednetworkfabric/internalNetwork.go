...
func NewInternalNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:InternalNetwork"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:InternalNetwork"),
		},
	})
...
// The Azure API version of the resource.
func (o InternalNetworkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *InternalNetwork) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o InternalNetworkOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *InternalNetwork) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
