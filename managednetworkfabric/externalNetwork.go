...
func NewExternalNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:ExternalNetwork"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:ExternalNetwork"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ExternalNetworkOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ExternalNetwork) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
