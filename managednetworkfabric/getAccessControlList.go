...
type LookupAccessControlListResult struct {
	...
	Conditions []AccessControlListPropertiesResponseConditions `pulumi:"conditions"`
...
// Access Control List conditions.
func (o LookupAccessControlListResultOutput) Conditions() AccessControlListPropertiesResponseConditionsArrayOutput {
	return o.ApplyT(func(v LookupAccessControlListResult) []AccessControlListPropertiesResponseConditions {
		return v.Conditions
