...
type LookupNetworkFabricResult struct {
	...
	ManagementNetworkConfiguration NetworkFabricPropertiesResponseManagementNetworkConfiguration `pulumi:"managementNetworkConfiguration"`
	...
	TerminalServerConfiguration NetworkFabricPropertiesResponseTerminalServerConfiguration `pulumi:"terminalServerConfiguration"`
...
func (val *LookupNetworkFabricResult) Defaults() *LookupNetworkFabricResult {
	...
	tmp := *val
	if isZero(tmp.Ipv4Prefix) {
		ipv4Prefix_ := "10.1.0.0/19"
		tmp.Ipv4Prefix = &ipv4Prefix_
	}
	if isZero(tmp.Ipv6Prefix) {
		ipv6Prefix_ := "3FFE:FFFF:0:CD40::/59"
		tmp.Ipv6Prefix = &ipv6Prefix_
	}
	tmp.ManagementNetworkConfiguration = *tmp.ManagementNetworkConfiguration.Defaults()

	tmp.TerminalServerConfiguration = *tmp.TerminalServerConfiguration.Defaults()
...
// Configuration to be used to setup the management network.
func (o LookupNetworkFabricResultOutput) ManagementNetworkConfiguration() NetworkFabricPropertiesResponseManagementNetworkConfigurationOutput {
	return o.ApplyT(func(v LookupNetworkFabricResult) NetworkFabricPropertiesResponseManagementNetworkConfiguration {
...
// Network and credentials configuration currently applied to terminal server.
func (o LookupNetworkFabricResultOutput) TerminalServerConfiguration() NetworkFabricPropertiesResponseTerminalServerConfigurationOutput {
	return o.ApplyT(func(v LookupNetworkFabricResult) NetworkFabricPropertiesResponseTerminalServerConfiguration {
