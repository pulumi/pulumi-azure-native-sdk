...
func NewNetworkRack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:NetworkRack"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:NetworkRack"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkRack
	err := ctx.RegisterResource("azure-native:managednetworkfabric:NetworkRack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkRack(ctx *pulumi.Context,
	...
	var resource NetworkRack
	err := ctx.ReadResource("azure-native:managednetworkfabric:NetworkRack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o NetworkRackOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *NetworkRack) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NetworkRackOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NetworkRack) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
