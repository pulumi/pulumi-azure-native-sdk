...
func NewL2IsolationDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240215preview:L2IsolationDomain"),
		},
		{
			Type: pulumi.String("azure-native:managednetworkfabric/v20240615preview:L2IsolationDomain"),
		},
	})
...
// The Azure API version of the resource.
func (o L2IsolationDomainOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *L2IsolationDomain) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o L2IsolationDomainOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *L2IsolationDomain) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
