...
func NewB2CTenant(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azureactivedirectory/v20230118preview:B2CTenant", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetB2CTenant(ctx *pulumi.Context,
	...
	var resource B2CTenant
	err := ctx.ReadResource("azure-native:azureactivedirectory/v20230118preview:B2CTenant", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
