...
func NewGuestUsage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azureactivedirectory/v20230118preview:GuestUsage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestUsage(ctx *pulumi.Context,
	...
	var resource GuestUsage
	err := ctx.ReadResource("azure-native:azureactivedirectory/v20230118preview:GuestUsage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
