...
func LookupB2CTenant(ctx *pulumi.Context, args *LookupB2CTenantArgs, opts ...pulumi.InvokeOption) (*LookupB2CTenantResult, error) {
	...
	err := ctx.Invoke("azure-native:azureactivedirectory/v20230118preview:getB2CTenant", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupB2CTenantOutput(ctx *pulumi.Context, args LookupB2CTenantOutputArgs, opts ...pulumi.InvokeOption) LookupB2CTenantResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupB2CTenantResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azureactivedirectory/v20230118preview:getB2CTenant", args, LookupB2CTenantResultOutput{}, options).(LookupB2CTenantResultOutput), nil
