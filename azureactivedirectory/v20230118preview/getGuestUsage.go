...
func LookupGuestUsage(ctx *pulumi.Context, args *LookupGuestUsageArgs, opts ...pulumi.InvokeOption) (*LookupGuestUsageResult, error) {
	...
	err := ctx.Invoke("azure-native:azureactivedirectory/v20230118preview:getGuestUsage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGuestUsageOutput(ctx *pulumi.Context, args LookupGuestUsageOutputArgs, opts ...pulumi.InvokeOption) LookupGuestUsageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGuestUsageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azureactivedirectory/v20230118preview:getGuestUsage", args, LookupGuestUsageResultOutput{}, options).(LookupGuestUsageResultOutput), nil
