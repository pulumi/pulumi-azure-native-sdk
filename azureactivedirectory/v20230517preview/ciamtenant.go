...
func NewCIAMTenant(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:azureactivedirectory:CIAMTenant"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CIAMTenant
	err := ctx.RegisterResource("azure-native:azureactivedirectory/v20230517preview:CIAMTenant", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCIAMTenant(ctx *pulumi.Context,
	...
	var resource CIAMTenant
	err := ctx.ReadResource("azure-native:azureactivedirectory/v20230517preview:CIAMTenant", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
