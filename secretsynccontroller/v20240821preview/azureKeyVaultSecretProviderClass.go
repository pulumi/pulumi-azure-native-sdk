...
func NewAzureKeyVaultSecretProviderClass(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:secretsynccontroller:AzureKeyVaultSecretProviderClass"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AzureKeyVaultSecretProviderClass
	err := ctx.RegisterResource("azure-native:secretsynccontroller/v20240821preview:AzureKeyVaultSecretProviderClass", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureKeyVaultSecretProviderClass(ctx *pulumi.Context,
	...
	var resource AzureKeyVaultSecretProviderClass
	err := ctx.ReadResource("azure-native:secretsynccontroller/v20240821preview:AzureKeyVaultSecretProviderClass", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
