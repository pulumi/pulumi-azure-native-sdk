...
func NewSecretSync(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:secretsynccontroller:SecretSync"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SecretSync
	err := ctx.RegisterResource("azure-native:secretsynccontroller/v20240821preview:SecretSync", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretSync(ctx *pulumi.Context,
	...
	var resource SecretSync
	err := ctx.ReadResource("azure-native:secretsynccontroller/v20240821preview:SecretSync", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
