...
func NewUpdateRun(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240401:UpdateRun"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240901preview:UpdateRun"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240215preview:UpdateRun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUpdateRun(ctx *pulumi.Context,
	...
	var resource UpdateRun
	err := ctx.ReadResource("azure-native:azurestackhci/v20240215preview:UpdateRun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
