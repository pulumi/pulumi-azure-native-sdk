...
func NewDeploymentSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240901preview:DeploymentSetting"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240215preview:DeploymentSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentSetting(ctx *pulumi.Context,
	...
	var resource DeploymentSetting
	err := ctx.ReadResource("azure-native:azurestackhci/v20240215preview:DeploymentSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
