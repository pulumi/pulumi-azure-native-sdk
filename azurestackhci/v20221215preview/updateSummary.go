...
func NewUpdateSummary(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20221215preview:UpdateSummary", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUpdateSummary(ctx *pulumi.Context,
	...
	var resource UpdateSummary
	err := ctx.ReadResource("azure-native:azurestackhci/v20221215preview:UpdateSummary", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *UpdateSummary) ToOutput(ctx context.Context) pulumix.Output[*UpdateSummary] {
	return pulumix.Output[*UpdateSummary]{
		OutputState: i.ToUpdateSummaryOutputWithContext(ctx).OutputState,
	}
}
...
func (o UpdateSummaryOutput) ToOutput(ctx context.Context) pulumix.Output[*UpdateSummary] {
	return pulumix.Output[*UpdateSummary]{
