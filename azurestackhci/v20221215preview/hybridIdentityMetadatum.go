...
func NewHybridIdentityMetadatum(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:azurestackhci:HybridIdentityMetadatum"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20221215preview:HybridIdentityMetadatum", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridIdentityMetadatum(ctx *pulumi.Context,
	...
	var resource HybridIdentityMetadatum
	err := ctx.ReadResource("azure-native:azurestackhci/v20221215preview:HybridIdentityMetadatum", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
