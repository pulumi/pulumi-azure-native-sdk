...
func NewUpdate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240215preview:Update"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240401:Update"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240901preview:Update"),
		},
		{
	...
	var resource Update
	err := ctx.RegisterResource("azure-native:azurestackhci/v20221215preview:Update", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUpdate(ctx *pulumi.Context,
	...
	var resource Update
	err := ctx.ReadResource("azure-native:azurestackhci/v20221215preview:Update", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The timestamp of resource creation (UTC).
func (o UpdateOutput) CreatedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Update) pulumi.StringPtrOutput { return v.CreatedAt }).(pulumi.StringPtrOutput)
}

// The identity that created the resource.
func (o UpdateOutput) CreatedBy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Update) pulumi.StringPtrOutput { return v.CreatedBy }).(pulumi.StringPtrOutput)
}

// The type of identity that created the resource.
func (o UpdateOutput) CreatedByType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Update) pulumi.StringPtrOutput { return v.CreatedByType }).(pulumi.StringPtrOutput)
}
...
// The timestamp of resource last modification (UTC)
func (o UpdateOutput) LastModifiedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Update) pulumi.StringPtrOutput { return v.LastModifiedAt }).(pulumi.StringPtrOutput)
}

// The identity that last modified the resource.
func (o UpdateOutput) LastModifiedBy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Update) pulumi.StringPtrOutput { return v.LastModifiedBy }).(pulumi.StringPtrOutput)
}

// The type of identity that last modified the resource.
func (o UpdateOutput) LastModifiedByType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Update) pulumi.StringPtrOutput { return v.LastModifiedByType }).(pulumi.StringPtrOutput)
}
