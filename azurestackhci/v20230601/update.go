...
func NewUpdate(ctx *pulumi.Context,
	...
	var resource Update
	err := ctx.RegisterResource("azure-native:azurestackhci/v20230601:Update", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUpdate(ctx *pulumi.Context,
	...
	var resource Update
	err := ctx.ReadResource("azure-native:azurestackhci/v20230601:Update", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
