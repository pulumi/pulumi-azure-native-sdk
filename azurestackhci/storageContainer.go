...
func NewStorageContainer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250601preview:StorageContainer"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250901preview:StorageContainer"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201preview:StorageContainer"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:StorageContainer"),
		},
	})
