...
func NewNetworkInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20241001preview:NetworkInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterface(ctx *pulumi.Context,
	...
	var resource NetworkInterface
	err := ctx.ReadResource("azure-native:azurestackhci/v20241001preview:NetworkInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
