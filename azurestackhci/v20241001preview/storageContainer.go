...
func NewStorageContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20241001preview:StorageContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageContainer(ctx *pulumi.Context,
	...
	var resource StorageContainer
	err := ctx.ReadResource("azure-native:azurestackhci/v20241001preview:StorageContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
