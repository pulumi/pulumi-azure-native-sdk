...
func NewNetworkinterfaceRetrieve(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20230701preview:NetworkinterfaceRetrieve"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20230701preview:networkinterfaceRetrieve"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20230901preview:NetworkinterfaceRetrieve"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20230901preview:networkinterfaceRetrieve"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240101:NetworkinterfaceRetrieve"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240101:networkinterfaceRetrieve"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240201preview:NetworkinterfaceRetrieve"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240201preview:networkinterfaceRetrieve"),
		},
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250401preview:NetworkinterfaceRetrieve"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250401preview:networkinterfaceRetrieve"),
		},
