...
func NewMarketplaceGalleryImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240501preview:MarketplaceGalleryImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMarketplaceGalleryImage(ctx *pulumi.Context,
	...
	var resource MarketplaceGalleryImage
	err := ctx.ReadResource("azure-native:azurestackhci/v20240501preview:MarketplaceGalleryImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
