...
func NewGalleryImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240501preview:GalleryImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryImage(ctx *pulumi.Context,
	...
	var resource GalleryImage
	err := ctx.ReadResource("azure-native:azurestackhci/v20240501preview:GalleryImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
