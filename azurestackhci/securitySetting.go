...
func NewSecuritySetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240401:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240901preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20241201preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250201preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250915preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20251001:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20251101preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20251201preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260215preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260301preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260430:SecuritySetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260501preview:SecuritySetting"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SecuritySetting
	err := ctx.RegisterResource("azure-native:azurestackhci:SecuritySetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecuritySetting(ctx *pulumi.Context,
	...
	var resource SecuritySetting
	err := ctx.ReadResource("azure-native:azurestackhci:SecuritySetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
