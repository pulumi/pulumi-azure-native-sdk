...
func NewVirtualHardDisk(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250601preview:VirtualHardDisk"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250901preview:VirtualHardDisk"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201preview:VirtualHardDisk"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualHardDisk
	err := ctx.RegisterResource("azure-native:azurestackhci:VirtualHardDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHardDisk(ctx *pulumi.Context,
	...
	var resource VirtualHardDisk
	err := ctx.ReadResource("azure-native:azurestackhci:VirtualHardDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o VirtualHardDiskOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *VirtualHardDisk) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
