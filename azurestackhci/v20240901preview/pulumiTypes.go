...
type ClusterReportedPropertiesResponse struct {
	...
	HardwareClass string `pulumi:"hardwareClass"`
...
// Hardware class of the cluster.
func (o ClusterReportedPropertiesResponseOutput) HardwareClass() pulumi.StringOutput {
	return o.ApplyT(func(v ClusterReportedPropertiesResponse) string { return v.HardwareClass }).(pulumi.StringOutput)
}
...
// Hardware class of the cluster.
func (o DeploymentClusterResponseOutput) HardwareClass() pulumi.StringOutput {
	return o.ApplyT(func(v DeploymentClusterResponse) string { return v.HardwareClass }).(pulumi.StringOutput)
}
...
// Hardware class of the cluster.
func (o DeploymentClusterResponsePtrOutput) HardwareClass() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DeploymentClusterResponse) *string {
		if v == nil {
			return nil
		}
		return &v.HardwareClass
	}).(pulumi.StringPtrOutput)
}
...
type HciNicDetailResponse struct {
	...
	RdmaCapability string `pulumi:"rdmaCapability"`
...
// Defaults sets the appropriate defaults for HciNicDetailResponse
func (val *HciNicDetailResponse) Defaults() *HciNicDetailResponse {
	if val == nil {
		return nil
	}
	tmp := *val
	if utilities.IsZero(tmp.RdmaCapability) {
		tmp.RdmaCapability = "Disabled"
	}
	return &tmp
}
...
// Describes the RDMA capability of the network adapter.
func (o HciNicDetailResponseOutput) RdmaCapability() pulumi.StringOutput {
	return o.ApplyT(func(v HciNicDetailResponse) string { return v.RdmaCapability }).(pulumi.StringOutput)
}
...
// SecretsLocationDetailsInput is an input type that accepts SecretsLocationDetailsArgs and SecretsLocationDetailsOutput values.
// You can construct a concrete instance of `SecretsLocationDetailsInput` via:
//
//	SecretsLocationDetailsArgs{...}
type SecretsLocationDetailsInput interface {
	pulumi.Input

	ToSecretsLocationDetailsOutput() SecretsLocationDetailsOutput
	ToSecretsLocationDetailsOutputWithContext(context.Context) SecretsLocationDetailsOutput
}

// Secrets location details
type SecretsLocationDetailsArgs struct {
	// secrets location
...
func (SecretsLocationDetailsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*SecretsLocationDetails)(nil)).Elem()
}

func (i SecretsLocationDetailsArgs) ToSecretsLocationDetailsOutput() SecretsLocationDetailsOutput {
	return i.ToSecretsLocationDetailsOutputWithContext(context.Background())
}

func (i SecretsLocationDetailsArgs) ToSecretsLocationDetailsOutputWithContext(ctx context.Context) SecretsLocationDetailsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SecretsLocationDetailsOutput)
}

// SecretsLocationDetailsArrayInput is an input type that accepts SecretsLocationDetailsArray and SecretsLocationDetailsArrayOutput values.
// You can construct a concrete instance of `SecretsLocationDetailsArrayInput` via:
//
//	SecretsLocationDetailsArray{ SecretsLocationDetailsArgs{...} }
type SecretsLocationDetailsArrayInput interface {
	pulumi.Input

	ToSecretsLocationDetailsArrayOutput() SecretsLocationDetailsArrayOutput
	ToSecretsLocationDetailsArrayOutputWithContext(context.Context) SecretsLocationDetailsArrayOutput
}

type SecretsLocationDetailsArray []SecretsLocationDetailsInput

func (SecretsLocationDetailsArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]SecretsLocationDetails)(nil)).Elem()
}

func (i SecretsLocationDetailsArray) ToSecretsLocationDetailsArrayOutput() SecretsLocationDetailsArrayOutput {
	return i.ToSecretsLocationDetailsArrayOutputWithContext(context.Background())
}

func (i SecretsLocationDetailsArray) ToSecretsLocationDetailsArrayOutputWithContext(ctx context.Context) SecretsLocationDetailsArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SecretsLocationDetailsArrayOutput)
}

// Secrets location details
type SecretsLocationDetailsOutput struct{ *pulumi.OutputState }

func (SecretsLocationDetailsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SecretsLocationDetails)(nil)).Elem()
}

func (o SecretsLocationDetailsOutput) ToSecretsLocationDetailsOutput() SecretsLocationDetailsOutput {
	return o
}

func (o SecretsLocationDetailsOutput) ToSecretsLocationDetailsOutputWithContext(ctx context.Context) SecretsLocationDetailsOutput {
	return o
}

// secrets location
func (o SecretsLocationDetailsOutput) SecretsLocation() pulumi.StringOutput {
	return o.ApplyT(func(v SecretsLocationDetails) string { return v.SecretsLocation }).(pulumi.StringOutput)
}

// Type of secrets to store
func (o SecretsLocationDetailsOutput) SecretsType() pulumi.StringOutput {
	return o.ApplyT(func(v SecretsLocationDetails) string { return v.SecretsType }).(pulumi.StringOutput)
}

type SecretsLocationDetailsArrayOutput struct{ *pulumi.OutputState }

func (SecretsLocationDetailsArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]SecretsLocationDetails)(nil)).Elem()
}

func (o SecretsLocationDetailsArrayOutput) ToSecretsLocationDetailsArrayOutput() SecretsLocationDetailsArrayOutput {
	return o
}

func (o SecretsLocationDetailsArrayOutput) ToSecretsLocationDetailsArrayOutputWithContext(ctx context.Context) SecretsLocationDetailsArrayOutput {
	return o
}

func (o SecretsLocationDetailsArrayOutput) Index(i pulumi.IntInput) SecretsLocationDetailsOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) SecretsLocationDetails {
		return vs[0].([]SecretsLocationDetails)[vs[1].(int)]
	}).(SecretsLocationDetailsOutput)
}

// Secrets location details
type SecretsLocationDetailsResponse struct {
	// secrets location
	SecretsLocation string `pulumi:"secretsLocation"`
	// Type of secrets to store
	SecretsType string `pulumi:"secretsType"`
...
// Secrets location details
type SecretsLocationDetailsResponseOutput struct{ *pulumi.OutputState }

func (SecretsLocationDetailsResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SecretsLocationDetailsResponse)(nil)).Elem()
}

func (o SecretsLocationDetailsResponseOutput) ToSecretsLocationDetailsResponseOutput() SecretsLocationDetailsResponseOutput {
	return o
}

func (o SecretsLocationDetailsResponseOutput) ToSecretsLocationDetailsResponseOutputWithContext(ctx context.Context) SecretsLocationDetailsResponseOutput {
	return o
}

// secrets location
func (o SecretsLocationDetailsResponseOutput) SecretsLocation() pulumi.StringOutput {
	return o.ApplyT(func(v SecretsLocationDetailsResponse) string { return v.SecretsLocation }).(pulumi.StringOutput)
}

// Type of secrets to store
func (o SecretsLocationDetailsResponseOutput) SecretsType() pulumi.StringOutput {
	return o.ApplyT(func(v SecretsLocationDetailsResponse) string { return v.SecretsType }).(pulumi.StringOutput)
}

type SecretsLocationDetailsResponseArrayOutput struct{ *pulumi.OutputState }

func (SecretsLocationDetailsResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]SecretsLocationDetailsResponse)(nil)).Elem()
}

func (o SecretsLocationDetailsResponseArrayOutput) ToSecretsLocationDetailsResponseArrayOutput() SecretsLocationDetailsResponseArrayOutput {
	return o
}

func (o SecretsLocationDetailsResponseArrayOutput) ToSecretsLocationDetailsResponseArrayOutputWithContext(ctx context.Context) SecretsLocationDetailsResponseArrayOutput {
	return o
}

func (o SecretsLocationDetailsResponseArrayOutput) Index(i pulumi.IntInput) SecretsLocationDetailsResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) SecretsLocationDetailsResponse {
		return vs[0].([]SecretsLocationDetailsResponse)[vs[1].(int)]
	}).(SecretsLocationDetailsResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(SecretsLocationDetailsOutput{})
	pulumi.RegisterOutputType(SecretsLocationDetailsArrayOutput{})
	pulumi.RegisterOutputType(SecretsLocationDetailsResponseOutput{})
	pulumi.RegisterOutputType(SecretsLocationDetailsResponseArrayOutput{})
