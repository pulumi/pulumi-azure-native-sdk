...
func NewSecuritySetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240901preview:SecuritySetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecuritySetting(ctx *pulumi.Context,
	...
	var resource SecuritySetting
	err := ctx.ReadResource("azure-native:azurestackhci/v20240901preview:SecuritySetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
