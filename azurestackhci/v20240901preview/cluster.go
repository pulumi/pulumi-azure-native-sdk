...
type Cluster struct {
	...
	SecretsLocations SecretsLocationDetailsResponseArrayOutput `pulumi:"secretsLocations"`
...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240901preview:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azure-native:azurestackhci/v20240901preview:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type clusterArgs struct {
	...
	// List of secret locations.
	SecretsLocations []SecretsLocationDetails `pulumi:"secretsLocations"`
	// Software Assurance properties of the cluster.
...
type ClusterArgs struct {
	...
	// List of secret locations.
	SecretsLocations SecretsLocationDetailsArrayInput
	// Software Assurance properties of the cluster.
...
// List of secret locations.
func (o ClusterOutput) SecretsLocations() SecretsLocationDetailsResponseArrayOutput {
	return o.ApplyT(func(v *Cluster) SecretsLocationDetailsResponseArrayOutput { return v.SecretsLocations }).(SecretsLocationDetailsResponseArrayOutput)
}
