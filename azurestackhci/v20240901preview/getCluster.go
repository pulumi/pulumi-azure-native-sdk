...
func LookupCluster(ctx *pulumi.Context, args *LookupClusterArgs, opts ...pulumi.InvokeOption) (*LookupClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20240901preview:getCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupClusterResult struct {
	...
	SecretsLocations []SecretsLocationDetailsResponse `pulumi:"secretsLocations"`
...
func LookupClusterOutput(ctx *pulumi.Context, args LookupClusterOutputArgs, opts ...pulumi.InvokeOption) LookupClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci/v20240901preview:getCluster", args, LookupClusterResultOutput{}, options).(LookupClusterResultOutput), nil
...
// List of secret locations.
func (o LookupClusterResultOutput) SecretsLocations() SecretsLocationDetailsResponseArrayOutput {
	return o.ApplyT(func(v LookupClusterResult) []SecretsLocationDetailsResponse { return v.SecretsLocations }).(SecretsLocationDetailsResponseArrayOutput)
}
