...
func NewHciEdgeDeviceJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240901preview:HciEdgeDeviceJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHciEdgeDeviceJob(ctx *pulumi.Context,
	...
	var resource HciEdgeDeviceJob
	err := ctx.ReadResource("azure-native:azurestackhci/v20240901preview:HciEdgeDeviceJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
