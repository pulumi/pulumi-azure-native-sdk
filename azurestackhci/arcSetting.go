...
func NewArcSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:ArcSetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260430:ArcSetting"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260501preview:ArcSetting"),
		},
	})
