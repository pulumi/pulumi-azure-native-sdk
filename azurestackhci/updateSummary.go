...
func NewUpdateSummary(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240401:UpdateSummary"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240901preview:UpdateSummary"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:UpdateSummary"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260430:UpdateSummary"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260501preview:UpdateSummary"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource UpdateSummary
	err := ctx.RegisterResource("azure-native:azurestackhci:UpdateSummary", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUpdateSummary(ctx *pulumi.Context,
	...
	var resource UpdateSummary
	err := ctx.ReadResource("azure-native:azurestackhci:UpdateSummary", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
