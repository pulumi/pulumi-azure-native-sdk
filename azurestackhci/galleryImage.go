...
func NewGalleryImage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:GalleryImage"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource GalleryImage
	err := ctx.RegisterResource("azure-native:azurestackhci:GalleryImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryImage(ctx *pulumi.Context,
	...
	var resource GalleryImage
	err := ctx.ReadResource("azure-native:azurestackhci:GalleryImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
