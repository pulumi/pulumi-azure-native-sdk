...
func NewArcSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20210101preview:ArcSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArcSetting(ctx *pulumi.Context,
	...
	var resource ArcSetting
	err := ctx.ReadResource("azure-native:azurestackhci/v20210101preview:ArcSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
