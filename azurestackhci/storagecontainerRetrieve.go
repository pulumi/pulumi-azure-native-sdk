...
func NewStoragecontainerRetrieve(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci:StoragecontainerRetrieve", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStoragecontainerRetrieve(ctx *pulumi.Context,
	...
	var resource StoragecontainerRetrieve
	err := ctx.ReadResource("azure-native:azurestackhci:StoragecontainerRetrieve", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
