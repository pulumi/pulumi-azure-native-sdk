...
func NewLogicalNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250901preview:LogicalNetwork"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201preview:LogicalNetwork"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:LogicalNetwork"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource LogicalNetwork
	err := ctx.RegisterResource("azure-native:azurestackhci:LogicalNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogicalNetwork(ctx *pulumi.Context,
	...
	var resource LogicalNetwork
	err := ctx.ReadResource("azure-native:azurestackhci:LogicalNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
