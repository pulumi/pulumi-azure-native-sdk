...
type HciHardwareProfileResponse struct {
	// Process type of the device
	ProcessorType string `pulumi:"processorType"`
}

// Hardware configurations for HCI device.
type HciHardwareProfileResponseOutput struct{ *pulumi.OutputState }

func (HciHardwareProfileResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HciHardwareProfileResponse)(nil)).Elem()
}

func (o HciHardwareProfileResponseOutput) ToHciHardwareProfileResponseOutput() HciHardwareProfileResponseOutput {
	return o
}

func (o HciHardwareProfileResponseOutput) ToHciHardwareProfileResponseOutputWithContext(ctx context.Context) HciHardwareProfileResponseOutput {
	return o
}

// Process type of the device
func (o HciHardwareProfileResponseOutput) ProcessorType() pulumi.StringOutput {
	return o.ApplyT(func(v HciHardwareProfileResponse) string { return v.ProcessorType }).(pulumi.StringOutput)
}
...
type HciReportedPropertiesResponse struct {
	...
	HardwareProfile HciHardwareProfileResponse `pulumi:"hardwareProfile"`
	...
	StorageProfile HciStorageProfileResponse `pulumi:"storageProfile"`
}
...
// Hci device hardware specific information.
func (o HciReportedPropertiesResponseOutput) HardwareProfile() HciHardwareProfileResponseOutput {
	return o.ApplyT(func(v HciReportedPropertiesResponse) HciHardwareProfileResponse { return v.HardwareProfile }).(HciHardwareProfileResponseOutput)
}
...
// Hci device storage specific information.
func (o HciReportedPropertiesResponseOutput) StorageProfile() HciStorageProfileResponseOutput {
	return o.ApplyT(func(v HciReportedPropertiesResponse) HciStorageProfileResponse { return v.StorageProfile }).(HciStorageProfileResponseOutput)
}

// Storage configurations for HCI device.
type HciStorageProfileResponse struct {
	// Number of storage disks in the device with $CanPool as true.
	PoolableDisksCount float64 `pulumi:"poolableDisksCount"`
}

// Storage configurations for HCI device.
type HciStorageProfileResponseOutput struct{ *pulumi.OutputState }

func (HciStorageProfileResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HciStorageProfileResponse)(nil)).Elem()
}

func (o HciStorageProfileResponseOutput) ToHciStorageProfileResponseOutput() HciStorageProfileResponseOutput {
	return o
}

func (o HciStorageProfileResponseOutput) ToHciStorageProfileResponseOutputWithContext(ctx context.Context) HciStorageProfileResponseOutput {
	return o
}

// Number of storage disks in the device with $CanPool as true.
func (o HciStorageProfileResponseOutput) PoolableDisksCount() pulumi.Float64Output {
	return o.ApplyT(func(v HciStorageProfileResponse) float64 { return v.PoolableDisksCount }).(pulumi.Float64Output)
}
...
func init() {
	...
	pulumi.RegisterOutputType(HciHardwareProfileResponseOutput{})
	...
	pulumi.RegisterOutputType(HciStorageProfileResponseOutput{})
