...
func LookupArcSetting(ctx *pulumi.Context, args *LookupArcSettingArgs, opts ...pulumi.InvokeOption) (*LookupArcSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20241201preview:getArcSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupArcSettingOutput(ctx *pulumi.Context, args LookupArcSettingOutputArgs, opts ...pulumi.InvokeOption) LookupArcSettingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupArcSettingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci/v20241201preview:getArcSetting", args, LookupArcSettingResultOutput{}, options).(LookupArcSettingResultOutput), nil
