...
func NewGuestAgent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250901preview:GuestAgent"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201preview:GuestAgent"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource GuestAgent
	err := ctx.RegisterResource("azure-native:azurestackhci:GuestAgent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestAgent(ctx *pulumi.Context,
	...
	var resource GuestAgent
	err := ctx.ReadResource("azure-native:azurestackhci:GuestAgent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o GuestAgentOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *GuestAgent) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
