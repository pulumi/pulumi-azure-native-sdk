...
type EdgeDevice struct {
	...
	DeviceConfiguration DeviceConfigurationResponsePtrOutput `pulumi:"deviceConfiguration"`
...
func NewEdgeDevice(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240101:EdgeDevice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEdgeDevice(ctx *pulumi.Context,
	...
	var resource EdgeDevice
	err := ctx.ReadResource("azure-native:azurestackhci/v20240101:EdgeDevice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type EdgeDeviceArgs struct {
	// Device Configuration
	DeviceConfiguration DeviceConfigurationPtrInput
	// Name of Device
...
// Device Configuration
func (o EdgeDeviceOutput) DeviceConfiguration() DeviceConfigurationResponsePtrOutput {
	return o.ApplyT(func(v *EdgeDevice) DeviceConfigurationResponsePtrOutput { return v.DeviceConfiguration }).(DeviceConfigurationResponsePtrOutput)
}
