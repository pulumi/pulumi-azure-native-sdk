...
// ArcSetting details.
//
// Deprecated: azure-native:azurestackhci/v20220301:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:ArcSetting to guarantee forwards compatibility.
...
func NewArcSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20220301:ArcSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArcSetting(ctx *pulumi.Context,
	...
	var resource ArcSetting
	err := ctx.ReadResource("azure-native:azurestackhci/v20220301:ArcSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
