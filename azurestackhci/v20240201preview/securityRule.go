...
func NewSecurityRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240201preview:SecurityRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityRule(ctx *pulumi.Context,
	...
	var resource SecurityRule
	err := ctx.ReadResource("azure-native:azurestackhci/v20240201preview:SecurityRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
