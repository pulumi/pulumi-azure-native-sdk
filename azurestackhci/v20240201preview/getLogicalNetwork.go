...
func LookupLogicalNetwork(ctx *pulumi.Context, args *LookupLogicalNetworkArgs, opts ...pulumi.InvokeOption) (*LookupLogicalNetworkResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20240201preview:getLogicalNetwork", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupLogicalNetworkOutput(ctx *pulumi.Context, args LookupLogicalNetworkOutputArgs, opts ...pulumi.InvokeOption) LookupLogicalNetworkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLogicalNetworkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci/v20240201preview:getLogicalNetwork", args, LookupLogicalNetworkResultOutput{}, options).(LookupLogicalNetworkResultOutput), nil
