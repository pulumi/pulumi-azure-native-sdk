...
func LookupGalleryImage(ctx *pulumi.Context, args *LookupGalleryImageArgs, opts ...pulumi.InvokeOption) (*LookupGalleryImageResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20240201preview:getGalleryImage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGalleryImageOutput(ctx *pulumi.Context, args LookupGalleryImageOutputArgs, opts ...pulumi.InvokeOption) LookupGalleryImageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGalleryImageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci/v20240201preview:getGalleryImage", args, LookupGalleryImageResultOutput{}, options).(LookupGalleryImageResultOutput), nil
