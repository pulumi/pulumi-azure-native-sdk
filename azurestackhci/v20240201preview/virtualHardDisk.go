...
func NewVirtualHardDisk(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240201preview:VirtualHardDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHardDisk(ctx *pulumi.Context,
	...
	var resource VirtualHardDisk
	err := ctx.ReadResource("azure-native:azurestackhci/v20240201preview:VirtualHardDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
