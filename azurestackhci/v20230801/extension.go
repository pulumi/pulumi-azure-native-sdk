...
func NewExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20230801:Extension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExtension(ctx *pulumi.Context,
	...
	var resource Extension
	err := ctx.ReadResource("azure-native:azurestackhci/v20230801:Extension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
