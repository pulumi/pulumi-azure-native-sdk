...
func NewVirtualmachineRetrieve(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci:VirtualmachineRetrieve", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualmachineRetrieve(ctx *pulumi.Context,
	...
	var resource VirtualmachineRetrieve
	err := ctx.ReadResource("azure-native:azurestackhci:VirtualmachineRetrieve", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
