...
func LookupDeploymentSetting(ctx *pulumi.Context, args *LookupDeploymentSettingArgs, opts ...pulumi.InvokeOption) (*LookupDeploymentSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci:getDeploymentSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDeploymentSettingOutput(ctx *pulumi.Context, args LookupDeploymentSettingOutputArgs, opts ...pulumi.InvokeOption) LookupDeploymentSettingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDeploymentSettingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci:getDeploymentSetting", args, LookupDeploymentSettingResultOutput{}, options).(LookupDeploymentSettingResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDeploymentSettingResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDeploymentSettingResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
