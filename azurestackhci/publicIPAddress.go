...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PublicIPAddressOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PublicIPAddress) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
