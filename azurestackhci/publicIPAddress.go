...
func NewPublicIPAddress(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201preview:PublicIPAddress"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:PublicIPAddress"),
		},
	})
