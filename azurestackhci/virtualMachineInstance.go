...
func NewVirtualMachineInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250601preview:VirtualMachineInstance"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250901preview:VirtualMachineInstance"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201preview:VirtualMachineInstance"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:VirtualMachineInstance"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualMachineInstance
	err := ctx.RegisterResource("azure-native:azurestackhci:VirtualMachineInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineInstance(ctx *pulumi.Context,
	...
	var resource VirtualMachineInstance
	err := ctx.ReadResource("azure-native:azurestackhci:VirtualMachineInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
