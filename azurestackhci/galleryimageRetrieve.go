...
func NewGalleryimageRetrieve(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci:GalleryimageRetrieve", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGalleryimageRetrieve(ctx *pulumi.Context,
	...
	var resource GalleryimageRetrieve
	err := ctx.ReadResource("azure-native:azurestackhci:GalleryimageRetrieve", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
