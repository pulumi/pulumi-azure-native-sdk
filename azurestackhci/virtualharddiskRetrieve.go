...
func NewVirtualharddiskRetrieve(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci:VirtualharddiskRetrieve", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualharddiskRetrieve(ctx *pulumi.Context,
	...
	var resource VirtualharddiskRetrieve
	err := ctx.ReadResource("azure-native:azurestackhci:VirtualharddiskRetrieve", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
