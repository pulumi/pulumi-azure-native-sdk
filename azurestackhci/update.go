...
func NewUpdate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:Update"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260430:Update"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260501preview:Update"),
		},
	})
...
func GetUpdate(ctx *pulumi.Context,
	...
	var resource Update
	err := ctx.ReadResource("azure-native:azurestackhci:Update", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
