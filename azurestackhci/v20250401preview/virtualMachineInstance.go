...
type VirtualMachineInstance struct {
	...
	HostNodeName pulumi.StringOutput `pulumi:"hostNodeName"`
	...
	HyperVVmId pulumi.StringOutput `pulumi:"hyperVVmId"`
	...
	PlacementProfile VirtualMachineInstancePropertiesPlacementProfileResponsePtrOutput `pulumi:"placementProfile"`
...
func NewVirtualMachineInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20250401preview:VirtualMachineInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineInstance(ctx *pulumi.Context,
	...
	var resource VirtualMachineInstance
	err := ctx.ReadResource("azure-native:azurestackhci/v20250401preview:VirtualMachineInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type virtualMachineInstanceArgs struct {
	...
	// PlacementProfile - Specifies the placement related settings for the virtual machine.
	PlacementProfile *VirtualMachineInstancePropertiesPlacementProfile `pulumi:"placementProfile"`
	// Unique identifier defined by ARC to identify the guest of the VM.
...
type VirtualMachineInstanceArgs struct {
	...
	// PlacementProfile - Specifies the placement related settings for the virtual machine.
	PlacementProfile VirtualMachineInstancePropertiesPlacementProfilePtrInput
	// Unique identifier defined by ARC to identify the guest of the VM.
...
// Name of the host node that the VM is on.
func (o VirtualMachineInstanceOutput) HostNodeName() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualMachineInstance) pulumi.StringOutput { return v.HostNodeName }).(pulumi.StringOutput)
}
...
// Unique identifier for the Hyper-V VM resource.
func (o VirtualMachineInstanceOutput) HyperVVmId() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualMachineInstance) pulumi.StringOutput { return v.HyperVVmId }).(pulumi.StringOutput)
}
...
// PlacementProfile - Specifies the placement related settings for the virtual machine.
func (o VirtualMachineInstanceOutput) PlacementProfile() VirtualMachineInstancePropertiesPlacementProfileResponsePtrOutput {
	return o.ApplyT(func(v *VirtualMachineInstance) VirtualMachineInstancePropertiesPlacementProfileResponsePtrOutput {
