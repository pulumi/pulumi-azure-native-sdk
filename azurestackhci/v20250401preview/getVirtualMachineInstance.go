...
func LookupVirtualMachineInstance(ctx *pulumi.Context, args *LookupVirtualMachineInstanceArgs, opts ...pulumi.InvokeOption) (*LookupVirtualMachineInstanceResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20250401preview:getVirtualMachineInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupVirtualMachineInstanceResult struct {
	...
	HostNodeName string `pulumi:"hostNodeName"`
	...
	HyperVVmId string `pulumi:"hyperVVmId"`
	...
	PlacementProfile *VirtualMachineInstancePropertiesPlacementProfileResponse `pulumi:"placementProfile"`
...
func LookupVirtualMachineInstanceOutput(ctx *pulumi.Context, args LookupVirtualMachineInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupVirtualMachineInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVirtualMachineInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci/v20250401preview:getVirtualMachineInstance", args, LookupVirtualMachineInstanceResultOutput{}, options).(LookupVirtualMachineInstanceResultOutput), nil
...
// Name of the host node that the VM is on.
func (o LookupVirtualMachineInstanceResultOutput) HostNodeName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupVirtualMachineInstanceResult) string { return v.HostNodeName }).(pulumi.StringOutput)
}
...
// Unique identifier for the Hyper-V VM resource.
func (o LookupVirtualMachineInstanceResultOutput) HyperVVmId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupVirtualMachineInstanceResult) string { return v.HyperVVmId }).(pulumi.StringOutput)
}
...
// PlacementProfile - Specifies the placement related settings for the virtual machine.
func (o LookupVirtualMachineInstanceResultOutput) PlacementProfile() VirtualMachineInstancePropertiesPlacementProfileResponsePtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineInstanceResult) *VirtualMachineInstancePropertiesPlacementProfileResponse {
		return v.PlacementProfile
	}).(VirtualMachineInstancePropertiesPlacementProfileResponsePtrOutput)
}
