...
func NewLogicalNetwork(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240201preview:LogicalNetwork"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240501preview:LogicalNetwork"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240715preview:LogicalNetwork"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240801preview:LogicalNetwork"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20241001preview:LogicalNetwork"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20250401preview:LogicalNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogicalNetwork(ctx *pulumi.Context,
	...
	var resource LogicalNetwork
	err := ctx.ReadResource("azure-native:azurestackhci/v20250401preview:LogicalNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
