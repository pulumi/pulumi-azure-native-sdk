...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SnapshotOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Snapshot) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
