...
func NewNetworkInterface(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240501preview:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240715preview:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240801preview:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20241001preview:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250201preview:NetworkInterface"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250901preview:NetworkInterface"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201preview:NetworkInterface"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkInterface
	err := ctx.RegisterResource("azure-native:azurestackhci:NetworkInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterface(ctx *pulumi.Context,
	...
	var resource NetworkInterface
	err := ctx.ReadResource("azure-native:azurestackhci:NetworkInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NetworkInterfaceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NetworkInterface) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
