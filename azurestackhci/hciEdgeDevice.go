...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o HciEdgeDeviceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *HciEdgeDevice) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
