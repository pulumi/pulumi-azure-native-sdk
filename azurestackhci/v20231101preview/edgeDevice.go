...
func NewEdgeDevice(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20231101preview:EdgeDevice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEdgeDevice(ctx *pulumi.Context,
	...
	var resource EdgeDevice
	err := ctx.ReadResource("azure-native:azurestackhci/v20231101preview:EdgeDevice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
