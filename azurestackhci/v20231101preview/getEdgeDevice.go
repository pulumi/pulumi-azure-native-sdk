...
func LookupEdgeDevice(ctx *pulumi.Context, args *LookupEdgeDeviceArgs, opts ...pulumi.InvokeOption) (*LookupEdgeDeviceResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20231101preview:getEdgeDevice", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEdgeDeviceOutput(ctx *pulumi.Context, args LookupEdgeDeviceOutputArgs, opts ...pulumi.InvokeOption) LookupEdgeDeviceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEdgeDeviceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci/v20231101preview:getEdgeDevice", args, LookupEdgeDeviceResultOutput{}, options).(LookupEdgeDeviceResultOutput), nil
