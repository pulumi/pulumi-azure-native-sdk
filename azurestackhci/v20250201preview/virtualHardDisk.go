...
func NewVirtualHardDisk(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240201preview:VirtualHardDisk"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240501preview:VirtualHardDisk"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240715preview:VirtualHardDisk"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240801preview:VirtualHardDisk"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20250201preview:VirtualHardDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHardDisk(ctx *pulumi.Context,
	...
	var resource VirtualHardDisk
	err := ctx.ReadResource("azure-native:azurestackhci/v20250201preview:VirtualHardDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
