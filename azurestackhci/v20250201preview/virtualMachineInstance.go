...
func NewVirtualMachineInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20250201preview:VirtualMachineInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineInstance(ctx *pulumi.Context,
	...
	var resource VirtualMachineInstance
	err := ctx.ReadResource("azure-native:azurestackhci/v20250201preview:VirtualMachineInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
