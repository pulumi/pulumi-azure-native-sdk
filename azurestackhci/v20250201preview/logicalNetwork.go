...
func NewLogicalNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20250201preview:LogicalNetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogicalNetwork(ctx *pulumi.Context,
	...
	var resource LogicalNetwork
	err := ctx.ReadResource("azure-native:azurestackhci/v20250201preview:LogicalNetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
