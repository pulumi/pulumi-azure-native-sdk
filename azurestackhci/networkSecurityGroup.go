...
type NetworkSecurityGroup struct {
	...
	Status NetworkSecurityGroupStatusResponseOutput `pulumi:"status"`
...
func NewNetworkSecurityGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20240715preview:NetworkSecurityGroup"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250401preview:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250601preview:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20250901preview:NetworkSecurityGroup"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260201preview:NetworkSecurityGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NetworkSecurityGroup
	err := ctx.RegisterResource("azure-native:azurestackhci:NetworkSecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityGroup(ctx *pulumi.Context,
	...
	var resource NetworkSecurityGroup
	err := ctx.ReadResource("azure-native:azurestackhci:NetworkSecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The observed state of Network Security Group
func (o NetworkSecurityGroupOutput) Status() NetworkSecurityGroupStatusResponseOutput {
	return o.ApplyT(func(v *NetworkSecurityGroup) NetworkSecurityGroupStatusResponseOutput { return v.Status }).(NetworkSecurityGroupStatusResponseOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o NetworkSecurityGroupOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NetworkSecurityGroup) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
