...
//
// Deprecated: azure-native:azurestackhci/v20220901:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.
func LookupExtension(ctx *pulumi.Context, args *LookupExtensionArgs, opts ...pulumi.InvokeOption) (*LookupExtensionResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20220901:getExtension", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
