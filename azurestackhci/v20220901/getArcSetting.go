...
//
// Deprecated: azure-native:azurestackhci/v20220901:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:ArcSetting to guarantee forwards compatibility.
func LookupArcSetting(ctx *pulumi.Context, args *LookupArcSettingArgs, opts ...pulumi.InvokeOption) (*LookupArcSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20220901:getArcSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
