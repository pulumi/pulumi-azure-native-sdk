...
func NewUpdateRun(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:UpdateRun"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260430:UpdateRun"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260501preview:UpdateRun"),
		},
	})
