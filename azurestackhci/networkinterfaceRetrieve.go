...
func NewNetworkinterfaceRetrieve(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci:NetworkinterfaceRetrieve", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkinterfaceRetrieve(ctx *pulumi.Context,
	...
	var resource NetworkinterfaceRetrieve
	err := ctx.ReadResource("azure-native:azurestackhci:NetworkinterfaceRetrieve", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
