...
func LookupMarketplaceGalleryImage(ctx *pulumi.Context, args *LookupMarketplaceGalleryImageArgs, opts ...pulumi.InvokeOption) (*LookupMarketplaceGalleryImageResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20240715preview:getMarketplaceGalleryImage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMarketplaceGalleryImageOutput(ctx *pulumi.Context, args LookupMarketplaceGalleryImageOutputArgs, opts ...pulumi.InvokeOption) LookupMarketplaceGalleryImageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMarketplaceGalleryImageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci/v20240715preview:getMarketplaceGalleryImage", args, LookupMarketplaceGalleryImageResultOutput{}, options).(LookupMarketplaceGalleryImageResultOutput), nil
