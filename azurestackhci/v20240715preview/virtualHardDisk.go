...
func NewVirtualHardDisk(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240715preview:VirtualHardDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualHardDisk(ctx *pulumi.Context,
	...
	var resource VirtualHardDisk
	err := ctx.ReadResource("azure-native:azurestackhci/v20240715preview:VirtualHardDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Operating system type of the OS disk. Possible values are: Windows, Linux.
func (o VirtualHardDiskOutput) OsType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VirtualHardDisk) pulumi.StringPtrOutput { return v.OsType }).(pulumi.StringPtrOutput)
}
