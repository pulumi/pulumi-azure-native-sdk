...
func LookupStorageContainer(ctx *pulumi.Context, args *LookupStorageContainerArgs, opts ...pulumi.InvokeOption) (*LookupStorageContainerResult, error) {
	...
	err := ctx.Invoke("azure-native:azurestackhci/v20240715preview:getStorageContainer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStorageContainerOutput(ctx *pulumi.Context, args LookupStorageContainerOutputArgs, opts ...pulumi.InvokeOption) LookupStorageContainerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStorageContainerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azurestackhci/v20240715preview:getStorageContainer", args, LookupStorageContainerResultOutput{}, options).(LookupStorageContainerResultOutput), nil
