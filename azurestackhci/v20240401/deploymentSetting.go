...
func NewDeploymentSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240401:DeploymentSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentSetting(ctx *pulumi.Context,
	...
	var resource DeploymentSetting
	err := ctx.ReadResource("azure-native:azurestackhci/v20240401:DeploymentSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
