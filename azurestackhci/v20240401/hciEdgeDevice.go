...
func NewHciEdgeDevice(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20240401:HciEdgeDevice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHciEdgeDevice(ctx *pulumi.Context,
	...
	var resource HciEdgeDevice
	err := ctx.ReadResource("azure-native:azurestackhci/v20240401:HciEdgeDevice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
