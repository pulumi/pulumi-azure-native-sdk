...
func NewHciEdgeDeviceJob(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260401preview:HciEdgeDeviceJob"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260430:HciEdgeDeviceJob"),
		},
		{
			Type: pulumi.String("azure-native:azurestackhci/v20260501preview:HciEdgeDeviceJob"),
		},
	})
