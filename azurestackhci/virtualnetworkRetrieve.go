...
func NewVirtualnetworkRetrieve(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci:VirtualnetworkRetrieve", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualnetworkRetrieve(ctx *pulumi.Context,
	...
	var resource VirtualnetworkRetrieve
	err := ctx.ReadResource("azure-native:azurestackhci:VirtualnetworkRetrieve", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
