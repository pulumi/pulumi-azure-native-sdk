...
//
// Deprecated: azure-native:azurestackhci/v20220501:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.
...
func NewExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azurestackhci/v20220501:Extension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExtension(ctx *pulumi.Context,
	...
	var resource Extension
	err := ctx.ReadResource("azure-native:azurestackhci/v20220501:Extension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
