...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupPublicIPAddressResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPublicIPAddressResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
