...
func NewAndroidMAMPolicyByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:intune/v20150114privatepreview:AndroidMAMPolicyByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAndroidMAMPolicyByName(ctx *pulumi.Context,
	...
	var resource AndroidMAMPolicyByName
	err := ctx.ReadResource("azure-native:intune/v20150114privatepreview:AndroidMAMPolicyByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
