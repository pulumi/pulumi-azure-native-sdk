...
func LookupPrivateEndpointConnectionsForSCCPowershellOutput(ctx *pulumi.Context, args LookupPrivateEndpointConnectionsForSCCPowershellOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateEndpointConnectionsForSCCPowershellResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateEndpointConnectionsForSCCPowershellResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityandcompliance:getPrivateEndpointConnectionsForSCCPowershell", args, LookupPrivateEndpointConnectionsForSCCPowershellResultOutput{}, options).(LookupPrivateEndpointConnectionsForSCCPowershellResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupPrivateEndpointConnectionsForSCCPowershellResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPrivateEndpointConnectionsForSCCPowershellResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Required property for system data
func (o LookupPrivateEndpointConnectionsForSCCPowershellResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPrivateEndpointConnectionsForSCCPowershellResult) commontypesv2.SystemDataResponse {
		return v.SystemData
