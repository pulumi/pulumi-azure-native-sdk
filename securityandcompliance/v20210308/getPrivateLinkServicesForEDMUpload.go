...
func LookupPrivateLinkServicesForEDMUpload(ctx *pulumi.Context, args *LookupPrivateLinkServicesForEDMUploadArgs, opts ...pulumi.InvokeOption) (*LookupPrivateLinkServicesForEDMUploadResult, error) {
	...
	err := ctx.Invoke("azure-native:securityandcompliance/v20210308:getPrivateLinkServicesForEDMUpload", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateLinkServicesForEDMUploadOutput(ctx *pulumi.Context, args LookupPrivateLinkServicesForEDMUploadOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateLinkServicesForEDMUploadResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateLinkServicesForEDMUploadResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityandcompliance/v20210308:getPrivateLinkServicesForEDMUpload", args, LookupPrivateLinkServicesForEDMUploadResultOutput{}, options).(LookupPrivateLinkServicesForEDMUploadResultOutput), nil
