...
func NewPrivateEndpointConnectionsForEDM(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForEDM", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionsForEDM(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionsForEDM
	err := ctx.ReadResource("azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForEDM", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
