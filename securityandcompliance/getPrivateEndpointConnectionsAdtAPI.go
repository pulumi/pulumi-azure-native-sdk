...
func LookupPrivateEndpointConnectionsAdtAPI(ctx *pulumi.Context, args *LookupPrivateEndpointConnectionsAdtAPIArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointConnectionsAdtAPIResult, error) {
	...
	err := ctx.Invoke("azure-native:securityandcompliance:getPrivateEndpointConnectionsAdtAPI", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateEndpointConnectionsAdtAPIOutput(ctx *pulumi.Context, args LookupPrivateEndpointConnectionsAdtAPIOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateEndpointConnectionsAdtAPIResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateEndpointConnectionsAdtAPIResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityandcompliance:getPrivateEndpointConnectionsAdtAPI", args, LookupPrivateEndpointConnectionsAdtAPIResultOutput{}, options).(LookupPrivateEndpointConnectionsAdtAPIResultOutput), nil
