...
// Required property for system data
func (o PrivateEndpointConnectionsAdtAPIOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *PrivateEndpointConnectionsAdtAPI) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
