...
func LookupPrivateEndpointConnectionsForEDM(ctx *pulumi.Context, args *LookupPrivateEndpointConnectionsForEDMArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointConnectionsForEDMResult, error) {
	...
	err := ctx.Invoke("azure-native:securityandcompliance:getPrivateEndpointConnectionsForEDM", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPrivateEndpointConnectionsForEDMOutput(ctx *pulumi.Context, args LookupPrivateEndpointConnectionsForEDMOutputArgs, opts ...pulumi.InvokeOption) LookupPrivateEndpointConnectionsForEDMResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPrivateEndpointConnectionsForEDMResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:securityandcompliance:getPrivateEndpointConnectionsForEDM", args, LookupPrivateEndpointConnectionsForEDMResultOutput{}, options).(LookupPrivateEndpointConnectionsForEDMResultOutput), nil
...
// Required property for system data
func (o LookupPrivateEndpointConnectionsForEDMResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPrivateEndpointConnectionsForEDMResult) commontypesv2.SystemDataResponse {
		return v.SystemData
