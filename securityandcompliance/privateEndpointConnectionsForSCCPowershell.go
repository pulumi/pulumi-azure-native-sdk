...
// Required property for system data
func (o PrivateEndpointConnectionsForSCCPowershellOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *PrivateEndpointConnectionsForSCCPowershell) commontypesv2.SystemDataResponseOutput {
		return v.SystemData
