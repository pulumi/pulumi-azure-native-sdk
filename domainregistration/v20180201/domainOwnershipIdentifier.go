...
func NewDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:domainregistration/v20180201:DomainOwnershipIdentifier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainOwnershipIdentifier(ctx *pulumi.Context,
	...
	var resource DomainOwnershipIdentifier
	err := ctx.ReadResource("azure-native:domainregistration/v20180201:DomainOwnershipIdentifier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
