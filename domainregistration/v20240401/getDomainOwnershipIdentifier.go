...
func LookupDomainOwnershipIdentifier(ctx *pulumi.Context, args *LookupDomainOwnershipIdentifierArgs, opts ...pulumi.InvokeOption) (*LookupDomainOwnershipIdentifierResult, error) {
	...
	err := ctx.Invoke("azure-native:domainregistration/v20240401:getDomainOwnershipIdentifier", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDomainOwnershipIdentifierOutput(ctx *pulumi.Context, args LookupDomainOwnershipIdentifierOutputArgs, opts ...pulumi.InvokeOption) LookupDomainOwnershipIdentifierResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDomainOwnershipIdentifierResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:domainregistration/v20240401:getDomainOwnershipIdentifier", args, LookupDomainOwnershipIdentifierResultOutput{}, options).(LookupDomainOwnershipIdentifierResultOutput), nil
