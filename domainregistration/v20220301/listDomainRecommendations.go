...
func ListDomainRecommendations(ctx *pulumi.Context, args *ListDomainRecommendationsArgs, opts ...pulumi.InvokeOption) (*ListDomainRecommendationsResult, error) {
	...
	err := ctx.Invoke("azure-native:domainregistration/v20220301:listDomainRecommendations", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListDomainRecommendationsOutput(ctx *pulumi.Context, args ListDomainRecommendationsOutputArgs, opts ...pulumi.InvokeOption) ListDomainRecommendationsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListDomainRecommendationsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:domainregistration/v20220301:listDomainRecommendations", args, ListDomainRecommendationsResultOutput{}, options).(ListDomainRecommendationsResultOutput), nil
