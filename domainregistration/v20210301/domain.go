...
func NewDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.RegisterResource("azure-native:domainregistration/v20210301:Domain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.ReadResource("azure-native:domainregistration/v20210301:Domain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
