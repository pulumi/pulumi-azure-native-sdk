...
func LookupIotHubResource(ctx *pulumi.Context, args *LookupIotHubResourceArgs, opts ...pulumi.InvokeOption) (*LookupIotHubResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:iothub:getIotHubResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupIotHubResourceOutput(ctx *pulumi.Context, args LookupIotHubResourceOutputArgs, opts ...pulumi.InvokeOption) LookupIotHubResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIotHubResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:iothub:getIotHubResource", args, LookupIotHubResourceResultOutput{}, options).(LookupIotHubResourceResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupIotHubResourceResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupIotHubResourceResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
