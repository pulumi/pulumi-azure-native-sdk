...
func NewSpringbootserver(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazurespringboot/v20230101preview:Springbootserver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpringbootserver(ctx *pulumi.Context,
	...
	var resource Springbootserver
	err := ctx.ReadResource("azure-native:offazurespringboot/v20230101preview:Springbootserver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
