...
func NewSpringbootapp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazurespringboot/v20240401preview:Springbootapp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpringbootapp(ctx *pulumi.Context,
	...
	var resource Springbootapp
	err := ctx.ReadResource("azure-native:offazurespringboot/v20240401preview:Springbootapp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
