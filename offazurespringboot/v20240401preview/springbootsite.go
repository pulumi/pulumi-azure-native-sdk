...
func NewSpringbootsite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazurespringboot/v20240401preview:Springbootsite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpringbootsite(ctx *pulumi.Context,
	...
	var resource Springbootsite
	err := ctx.ReadResource("azure-native:offazurespringboot/v20240401preview:Springbootsite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
