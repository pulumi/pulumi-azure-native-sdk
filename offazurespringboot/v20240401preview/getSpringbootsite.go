...
func LookupSpringbootsite(ctx *pulumi.Context, args *LookupSpringbootsiteArgs, opts ...pulumi.InvokeOption) (*LookupSpringbootsiteResult, error) {
	...
	err := ctx.Invoke("azure-native:offazurespringboot/v20240401preview:getSpringbootsite", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSpringbootsiteOutput(ctx *pulumi.Context, args LookupSpringbootsiteOutputArgs, opts ...pulumi.InvokeOption) LookupSpringbootsiteResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSpringbootsiteResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazurespringboot/v20240401preview:getSpringbootsite", args, LookupSpringbootsiteResultOutput{}, options).(LookupSpringbootsiteResultOutput), nil
