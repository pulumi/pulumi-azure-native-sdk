...
// AgentVMSizeTypesInput is an input type that accepts values of the AgentVMSizeTypes enum
// A concrete instance of `AgentVMSizeTypesInput` can be one of the following:
//
...
// OrchestratorTypeInput is an input type that accepts values of the OrchestratorType enum
// A concrete instance of `OrchestratorTypeInput` can be one of the following:
//
...
// SystemServiceTypeInput is an input type that accepts values of the SystemServiceType enum
// A concrete instance of `SystemServiceTypeInput` can be one of the following:
//
