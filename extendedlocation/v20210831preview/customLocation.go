...
func NewCustomLocation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:extendedlocation/v20210831preview:CustomLocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomLocation(ctx *pulumi.Context,
	...
	var resource CustomLocation
	err := ctx.ReadResource("azure-native:extendedlocation/v20210831preview:CustomLocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
