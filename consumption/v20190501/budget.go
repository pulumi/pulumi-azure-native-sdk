...
func NewBudget(ctx *pulumi.Context,
	...
	var resource Budget
	err := ctx.RegisterResource("azure-native:consumption/v20190501:Budget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBudget(ctx *pulumi.Context,
	...
	var resource Budget
	err := ctx.ReadResource("azure-native:consumption/v20190501:Budget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// May be used to filter budgets by user-specified dimensions and/or tags.
func (o BudgetOutput) Filter() FilterResponsePtrOutput {
	return o.ApplyT(func(v *Budget) FilterResponsePtrOutput { return v.Filter }).(FilterResponsePtrOutput)
}
