...
func NewBudgetByResourceGroupName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:consumption/v20180331:BudgetByResourceGroupName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBudgetByResourceGroupName(ctx *pulumi.Context,
	...
	var resource BudgetByResourceGroupName
	err := ctx.ReadResource("azure-native:consumption/v20180331:BudgetByResourceGroupName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
