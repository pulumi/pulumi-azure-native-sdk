...
func NewBudget(ctx *pulumi.Context,
	...
	var resource Budget
	err := ctx.RegisterResource("azure-native:consumption/v20240801:Budget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBudget(ctx *pulumi.Context,
	...
	var resource Budget
	err := ctx.ReadResource("azure-native:consumption/v20240801:Budget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
