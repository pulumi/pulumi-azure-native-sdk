...
func ListLocalRulestackSecurityServices(ctx *pulumi.Context, args *ListLocalRulestackSecurityServicesArgs, opts ...pulumi.InvokeOption) (*ListLocalRulestackSecurityServicesResult, error) {
	...
	err := ctx.Invoke("azure-native:cloudngfw/v20230901preview:listLocalRulestackSecurityServices", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListLocalRulestackSecurityServicesOutput(ctx *pulumi.Context, args ListLocalRulestackSecurityServicesOutputArgs, opts ...pulumi.InvokeOption) ListLocalRulestackSecurityServicesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListLocalRulestackSecurityServicesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cloudngfw/v20230901preview:listLocalRulestackSecurityServices", args, ListLocalRulestackSecurityServicesResultOutput{}, options).(ListLocalRulestackSecurityServicesResultOutput), nil
