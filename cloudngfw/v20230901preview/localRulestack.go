...
func NewLocalRulestack(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20230901preview:LocalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalRulestack(ctx *pulumi.Context,
	...
	var resource LocalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20230901preview:LocalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
