...
func NewPostRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20230901preview:PostRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPostRule(ctx *pulumi.Context,
	...
	var resource PostRule
	err := ctx.ReadResource("azure-native:cloudngfw/v20230901preview:PostRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
