...
func NewCertificateObjectGlobalRulestack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudngfw/v20250206preview:CertificateObjectGlobalRulestack"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20240207preview:CertificateObjectGlobalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateObjectGlobalRulestack(ctx *pulumi.Context,
	...
	var resource CertificateObjectGlobalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20240207preview:CertificateObjectGlobalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
