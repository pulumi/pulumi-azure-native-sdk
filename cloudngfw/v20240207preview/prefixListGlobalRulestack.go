...
func NewPrefixListGlobalRulestack(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20240207preview:PrefixListGlobalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrefixListGlobalRulestack(ctx *pulumi.Context,
	...
	var resource PrefixListGlobalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20240207preview:PrefixListGlobalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
