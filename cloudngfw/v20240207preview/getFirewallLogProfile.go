...
func GetFirewallLogProfile(ctx *pulumi.Context, args *GetFirewallLogProfileArgs, opts ...pulumi.InvokeOption) (*GetFirewallLogProfileResult, error) {
	...
	err := ctx.Invoke("azure-native:cloudngfw/v20240207preview:getFirewallLogProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetFirewallLogProfileOutput(ctx *pulumi.Context, args GetFirewallLogProfileOutputArgs, opts ...pulumi.InvokeOption) GetFirewallLogProfileResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetFirewallLogProfileResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cloudngfw/v20240207preview:getFirewallLogProfile", args, GetFirewallLogProfileResultOutput{}, options).(GetFirewallLogProfileResultOutput), nil
