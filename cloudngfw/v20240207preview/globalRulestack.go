...
func NewGlobalRulestack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudngfw/v20230901preview:GlobalRulestack"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20240207preview:GlobalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalRulestack(ctx *pulumi.Context,
	...
	var resource GlobalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20240207preview:GlobalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
