...
func ListGlobalRulestackCountries(ctx *pulumi.Context, args *ListGlobalRulestackCountriesArgs, opts ...pulumi.InvokeOption) (*ListGlobalRulestackCountriesResult, error) {
	...
	err := ctx.Invoke("azure-native:cloudngfw/v20240119preview:listGlobalRulestackCountries", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListGlobalRulestackCountriesOutput(ctx *pulumi.Context, args ListGlobalRulestackCountriesOutputArgs, opts ...pulumi.InvokeOption) ListGlobalRulestackCountriesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListGlobalRulestackCountriesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cloudngfw/v20240119preview:listGlobalRulestackCountries", args, ListGlobalRulestackCountriesResultOutput{}, options).(ListGlobalRulestackCountriesResultOutput), nil
