...
func NewPreRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20240119preview:PreRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPreRule(ctx *pulumi.Context,
	...
	var resource PreRule
	err := ctx.ReadResource("azure-native:cloudngfw/v20240119preview:PreRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
