...
func NewFqdnListLocalRulestack(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20240119preview:FqdnListLocalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFqdnListLocalRulestack(ctx *pulumi.Context,
	...
	var resource FqdnListLocalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20240119preview:FqdnListLocalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
