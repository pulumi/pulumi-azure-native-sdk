...
func ListLocalRulestackCountries(ctx *pulumi.Context, args *ListLocalRulestackCountriesArgs, opts ...pulumi.InvokeOption) (*ListLocalRulestackCountriesResult, error) {
	...
	err := ctx.Invoke("azure-native:cloudngfw/v20240119preview:listLocalRulestackCountries", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListLocalRulestackCountriesOutput(ctx *pulumi.Context, args ListLocalRulestackCountriesOutputArgs, opts ...pulumi.InvokeOption) ListLocalRulestackCountriesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListLocalRulestackCountriesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cloudngfw/v20240119preview:listLocalRulestackCountries", args, ListLocalRulestackCountriesResultOutput{}, options).(ListLocalRulestackCountriesResultOutput), nil
