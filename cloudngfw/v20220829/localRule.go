...
func NewLocalRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20220829:LocalRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalRule(ctx *pulumi.Context,
	...
	var resource LocalRule
	err := ctx.ReadResource("azure-native:cloudngfw/v20220829:LocalRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
