...
func NewPrefixListLocalRulestack(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20220829:PrefixListLocalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrefixListLocalRulestack(ctx *pulumi.Context,
	...
	var resource PrefixListLocalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20220829:PrefixListLocalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
