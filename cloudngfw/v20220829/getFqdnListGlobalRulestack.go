...
func LookupFqdnListGlobalRulestack(ctx *pulumi.Context, args *LookupFqdnListGlobalRulestackArgs, opts ...pulumi.InvokeOption) (*LookupFqdnListGlobalRulestackResult, error) {
	...
	err := ctx.Invoke("azure-native:cloudngfw/v20220829:getFqdnListGlobalRulestack", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupFqdnListGlobalRulestackOutput(ctx *pulumi.Context, args LookupFqdnListGlobalRulestackOutputArgs, opts ...pulumi.InvokeOption) LookupFqdnListGlobalRulestackResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFqdnListGlobalRulestackResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cloudngfw/v20220829:getFqdnListGlobalRulestack", args, LookupFqdnListGlobalRulestackResultOutput{}, options).(LookupFqdnListGlobalRulestackResultOutput), nil
