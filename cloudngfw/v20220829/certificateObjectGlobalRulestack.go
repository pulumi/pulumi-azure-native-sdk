...
func NewCertificateObjectGlobalRulestack(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20220829:CertificateObjectGlobalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateObjectGlobalRulestack(ctx *pulumi.Context,
	...
	var resource CertificateObjectGlobalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20220829:CertificateObjectGlobalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
