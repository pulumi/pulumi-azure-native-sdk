...
func NewGlobalRulestack(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20220829:GlobalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalRulestack(ctx *pulumi.Context,
	...
	var resource GlobalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20220829:GlobalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
