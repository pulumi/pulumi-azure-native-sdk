...
func NewFirewall(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudngfw/v20251008:Firewall"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20260126preview:Firewall"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Firewall
	err := ctx.RegisterResource("azure-native:cloudngfw:Firewall", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewall(ctx *pulumi.Context,
	...
	var resource Firewall
	err := ctx.ReadResource("azure-native:cloudngfw:Firewall", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o FirewallOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *Firewall) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
