...
func NewCertificateObjectLocalRulestack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudngfw/v20250523:CertificateObjectLocalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20250707preview:CertificateObjectLocalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20251008:CertificateObjectLocalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20260126preview:CertificateObjectLocalRulestack"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CertificateObjectLocalRulestack
	err := ctx.RegisterResource("azure-native:cloudngfw:CertificateObjectLocalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateObjectLocalRulestack(ctx *pulumi.Context,
	...
	var resource CertificateObjectLocalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw:CertificateObjectLocalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CertificateObjectLocalRulestackOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *CertificateObjectLocalRulestack) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
