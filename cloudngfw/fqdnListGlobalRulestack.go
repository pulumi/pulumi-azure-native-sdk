...
func NewFqdnListGlobalRulestack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudngfw/v20250523:FqdnListGlobalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20250707preview:FqdnListGlobalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20251008:FqdnListGlobalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20260126preview:FqdnListGlobalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20260511preview:FqdnListGlobalRulestack"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource FqdnListGlobalRulestack
	err := ctx.RegisterResource("azure-native:cloudngfw:FqdnListGlobalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFqdnListGlobalRulestack(ctx *pulumi.Context,
	...
	var resource FqdnListGlobalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw:FqdnListGlobalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
