...
func LookupCertificateObjectGlobalRulestack(ctx *pulumi.Context, args *LookupCertificateObjectGlobalRulestackArgs, opts ...pulumi.InvokeOption) (*LookupCertificateObjectGlobalRulestackResult, error) {
	...
	err := ctx.Invoke("azure-native:cloudngfw/v20231010preview:getCertificateObjectGlobalRulestack", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCertificateObjectGlobalRulestackOutput(ctx *pulumi.Context, args LookupCertificateObjectGlobalRulestackOutputArgs, opts ...pulumi.InvokeOption) LookupCertificateObjectGlobalRulestackResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCertificateObjectGlobalRulestackResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cloudngfw/v20231010preview:getCertificateObjectGlobalRulestack", args, LookupCertificateObjectGlobalRulestackResultOutput{}, options).(LookupCertificateObjectGlobalRulestackResultOutput), nil
