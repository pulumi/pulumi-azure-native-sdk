...
func NewCertificateObjectLocalRulestack(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20231010preview:CertificateObjectLocalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateObjectLocalRulestack(ctx *pulumi.Context,
	...
	var resource CertificateObjectLocalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw/v20231010preview:CertificateObjectLocalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
