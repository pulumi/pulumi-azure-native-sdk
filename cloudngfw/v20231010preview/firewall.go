...
func NewFirewall(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cloudngfw/v20231010preview:Firewall", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewall(ctx *pulumi.Context,
	...
	var resource Firewall
	err := ctx.ReadResource("azure-native:cloudngfw/v20231010preview:Firewall", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
