...
func NewPrefixListGlobalRulestack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudngfw/v20260511preview:PrefixListGlobalRulestack"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrefixListGlobalRulestack
	err := ctx.RegisterResource("azure-native:cloudngfw:PrefixListGlobalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrefixListGlobalRulestack(ctx *pulumi.Context,
	...
	var resource PrefixListGlobalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw:PrefixListGlobalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
