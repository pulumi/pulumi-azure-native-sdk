...
func NewLocalRulestack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudngfw/v20251008:LocalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20260126preview:LocalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20260511preview:LocalRulestack"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource LocalRulestack
	err := ctx.RegisterResource("azure-native:cloudngfw:LocalRulestack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLocalRulestack(ctx *pulumi.Context,
	...
	var resource LocalRulestack
	err := ctx.ReadResource("azure-native:cloudngfw:LocalRulestack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
