...
func LookupFqdnListLocalRulestack(ctx *pulumi.Context, args *LookupFqdnListLocalRulestackArgs, opts ...pulumi.InvokeOption) (*LookupFqdnListLocalRulestackResult, error) {
	...
	err := ctx.Invoke("azure-native:cloudngfw:getFqdnListLocalRulestack", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupFqdnListLocalRulestackOutput(ctx *pulumi.Context, args LookupFqdnListLocalRulestackOutputArgs, opts ...pulumi.InvokeOption) LookupFqdnListLocalRulestackResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFqdnListLocalRulestackResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cloudngfw:getFqdnListLocalRulestack", args, LookupFqdnListLocalRulestackResultOutput{}, options).(LookupFqdnListLocalRulestackResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupFqdnListLocalRulestackResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFqdnListLocalRulestackResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupFqdnListLocalRulestackResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupFqdnListLocalRulestackResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
