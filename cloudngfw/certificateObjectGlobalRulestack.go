...
func NewCertificateObjectGlobalRulestack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cloudngfw/v20250523:CertificateObjectGlobalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20250707preview:CertificateObjectGlobalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20251008:CertificateObjectGlobalRulestack"),
		},
		{
			Type: pulumi.String("azure-native:cloudngfw/v20260126preview:CertificateObjectGlobalRulestack"),
		},
	})
...
// The Azure API version of the resource.
func (o CertificateObjectGlobalRulestackOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CertificateObjectGlobalRulestack) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CertificateObjectGlobalRulestackOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *CertificateObjectGlobalRulestack) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
