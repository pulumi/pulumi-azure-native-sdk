...
func NewSolution(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:agfoodplatform/v20230601preview:Solution", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSolution(ctx *pulumi.Context,
	...
	var resource Solution
	err := ctx.ReadResource("azure-native:agfoodplatform/v20230601preview:Solution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
