...
func NewDataConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:agfoodplatform:DataConnector"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DataConnector
	err := ctx.RegisterResource("azure-native:agfoodplatform/v20230601preview:DataConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataConnector(ctx *pulumi.Context,
	...
	var resource DataConnector
	err := ctx.ReadResource("azure-native:agfoodplatform/v20230601preview:DataConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
