...
func NewPrometheusRuleGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:alertsmanagement/v20230301:PrometheusRuleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrometheusRuleGroup(ctx *pulumi.Context,
	...
	var resource PrometheusRuleGroup
	err := ctx.ReadResource("azure-native:alertsmanagement/v20230301:PrometheusRuleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
