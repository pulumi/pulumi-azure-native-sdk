...
func NewAlertProcessingRuleByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:alertsmanagement/v20240301preview:AlertProcessingRuleByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertProcessingRuleByName(ctx *pulumi.Context,
	...
	var resource AlertProcessingRuleByName
	err := ctx.ReadResource("azure-native:alertsmanagement/v20240301preview:AlertProcessingRuleByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
