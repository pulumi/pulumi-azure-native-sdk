...
type CorrelateAlerts struct {
	...
	CorrelationUpdates *CorrelationUpdates `pulumi:"correlationUpdates"`
...
func (val *CorrelateAlerts) Defaults() *CorrelateAlerts {
	...
	tmp := *val
	tmp.CorrelationUpdates = tmp.CorrelationUpdates.Defaults()
...
type CorrelateAlertsArgs struct {
	...
	// Defines the updates to be applied for correlation.
	CorrelationUpdates CorrelationUpdatesPtrInput `pulumi:"correlationUpdates"`
	// Indicates how to handle child alerts notifications.
...
// Defines the updates to be applied for correlation.
func (o CorrelateAlertsOutput) CorrelationUpdates() CorrelationUpdatesPtrOutput {
	return o.ApplyT(func(v CorrelateAlerts) *CorrelationUpdates { return v.CorrelationUpdates }).(CorrelationUpdatesPtrOutput)
}
...
type CorrelateAlertsResponse struct {
	...
	CorrelationInterval string `pulumi:"correlationInterval"`
	// Defines the updates to be applied for correlation.
	CorrelationUpdates *CorrelationUpdatesResponse `pulumi:"correlationUpdates"`
	// Indicates how to handle child alerts notifications.
	NotificationsForCorrelatedAlerts *string `pulumi:"notificationsForCorrelatedAlerts"`
	// The priority of this correlation.
	Priority int `pulumi:"priority"`
...
// Defines the updates to be applied for correlation.
func (o CorrelateAlertsResponseOutput) CorrelationUpdates() CorrelationUpdatesResponsePtrOutput {
	return o.ApplyT(func(v CorrelateAlertsResponse) *CorrelationUpdatesResponse { return v.CorrelationUpdates }).(CorrelationUpdatesResponsePtrOutput)
}
...
// Defaults sets the appropriate defaults for CorrelationUpdates
func (val *CorrelationUpdates) Defaults() *CorrelationUpdates {
	if val == nil {
		return nil
	}
	tmp := *val
	if utilities.IsZero(tmp.UpdateType) {
		tmp.UpdateType = "timeBased"
	}
	return &tmp
}

// CorrelationUpdatesInput is an input type that accepts CorrelationUpdatesArgs and CorrelationUpdatesOutput values.
// You can construct a concrete instance of `CorrelationUpdatesInput` via:
//
//	CorrelationUpdatesArgs{...}
type CorrelationUpdatesInput interface {
	pulumi.Input

	ToCorrelationUpdatesOutput() CorrelationUpdatesOutput
	ToCorrelationUpdatesOutputWithContext(context.Context) CorrelationUpdatesOutput
}

// Defines the updates to be applied for correlation.
type CorrelationUpdatesArgs struct {
	// The action group ids.
...
// Defaults sets the appropriate defaults for CorrelationUpdatesArgs
func (val *CorrelationUpdatesArgs) Defaults() *CorrelationUpdatesArgs {
	if val == nil {
		return nil
	}
	tmp := *val
	if tmp.UpdateType == nil {
		tmp.UpdateType = pulumi.String("timeBased")
	}
	return &tmp
}
func (CorrelationUpdatesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*CorrelationUpdates)(nil)).Elem()
}

func (i CorrelationUpdatesArgs) ToCorrelationUpdatesOutput() CorrelationUpdatesOutput {
	return i.ToCorrelationUpdatesOutputWithContext(context.Background())
}

func (i CorrelationUpdatesArgs) ToCorrelationUpdatesOutputWithContext(ctx context.Context) CorrelationUpdatesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CorrelationUpdatesOutput)
}

func (i CorrelationUpdatesArgs) ToCorrelationUpdatesPtrOutput() CorrelationUpdatesPtrOutput {
	return i.ToCorrelationUpdatesPtrOutputWithContext(context.Background())
}

func (i CorrelationUpdatesArgs) ToCorrelationUpdatesPtrOutputWithContext(ctx context.Context) CorrelationUpdatesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CorrelationUpdatesOutput).ToCorrelationUpdatesPtrOutputWithContext(ctx)
}

// CorrelationUpdatesPtrInput is an input type that accepts CorrelationUpdatesArgs, CorrelationUpdatesPtr and CorrelationUpdatesPtrOutput values.
// You can construct a concrete instance of `CorrelationUpdatesPtrInput` via:
//
//	        CorrelationUpdatesArgs{...}
//
//	or:
//
//	        nil
type CorrelationUpdatesPtrInput interface {
	pulumi.Input

	ToCorrelationUpdatesPtrOutput() CorrelationUpdatesPtrOutput
	ToCorrelationUpdatesPtrOutputWithContext(context.Context) CorrelationUpdatesPtrOutput
}

type correlationUpdatesPtrType CorrelationUpdatesArgs

func CorrelationUpdatesPtr(v *CorrelationUpdatesArgs) CorrelationUpdatesPtrInput {
	return (*correlationUpdatesPtrType)(v)
}

func (*correlationUpdatesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**CorrelationUpdates)(nil)).Elem()
}

func (i *correlationUpdatesPtrType) ToCorrelationUpdatesPtrOutput() CorrelationUpdatesPtrOutput {
	return i.ToCorrelationUpdatesPtrOutputWithContext(context.Background())
}

func (i *correlationUpdatesPtrType) ToCorrelationUpdatesPtrOutputWithContext(ctx context.Context) CorrelationUpdatesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CorrelationUpdatesPtrOutput)
}

// Defines the updates to be applied for correlation.
type CorrelationUpdatesOutput struct{ *pulumi.OutputState }

func (CorrelationUpdatesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CorrelationUpdates)(nil)).Elem()
}

func (o CorrelationUpdatesOutput) ToCorrelationUpdatesOutput() CorrelationUpdatesOutput {
	return o
}

func (o CorrelationUpdatesOutput) ToCorrelationUpdatesOutputWithContext(ctx context.Context) CorrelationUpdatesOutput {
	return o
}

func (o CorrelationUpdatesOutput) ToCorrelationUpdatesPtrOutput() CorrelationUpdatesPtrOutput {
	return o.ToCorrelationUpdatesPtrOutputWithContext(context.Background())
}

func (o CorrelationUpdatesOutput) ToCorrelationUpdatesPtrOutputWithContext(ctx context.Context) CorrelationUpdatesPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v CorrelationUpdates) *CorrelationUpdates {
		return &v
	}).(CorrelationUpdatesPtrOutput)
}

// The action group ids.
func (o CorrelationUpdatesOutput) ActionGroups() pulumi.StringArrayOutput {
	return o.ApplyT(func(v CorrelationUpdates) []string { return v.ActionGroups }).(pulumi.StringArrayOutput)
}

// The update interval for notification updates in ISO8601 format.
func (o CorrelationUpdatesOutput) UpdateInterval() pulumi.StringOutput {
	return o.ApplyT(func(v CorrelationUpdates) string { return v.UpdateInterval }).(pulumi.StringOutput)
}

// The type of update that needs to be performed.
func (o CorrelationUpdatesOutput) UpdateType() pulumi.StringOutput {
	return o.ApplyT(func(v CorrelationUpdates) string { return v.UpdateType }).(pulumi.StringOutput)
}

type CorrelationUpdatesPtrOutput struct{ *pulumi.OutputState }

func (CorrelationUpdatesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**CorrelationUpdates)(nil)).Elem()
}

func (o CorrelationUpdatesPtrOutput) ToCorrelationUpdatesPtrOutput() CorrelationUpdatesPtrOutput {
	return o
}

func (o CorrelationUpdatesPtrOutput) ToCorrelationUpdatesPtrOutputWithContext(ctx context.Context) CorrelationUpdatesPtrOutput {
	return o
}

func (o CorrelationUpdatesPtrOutput) Elem() CorrelationUpdatesOutput {
	return o.ApplyT(func(v *CorrelationUpdates) CorrelationUpdates {
		if v != nil {
			return *v
		}
		var ret CorrelationUpdates
		return ret
	}).(CorrelationUpdatesOutput)
}

// The action group ids.
func (o CorrelationUpdatesPtrOutput) ActionGroups() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *CorrelationUpdates) []string {
		if v == nil {
			return nil
		}
...
// The update interval for notification updates in ISO8601 format.
func (o CorrelationUpdatesPtrOutput) UpdateInterval() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CorrelationUpdates) *string {
		if v == nil {
			return nil
		}
...
// The type of update that needs to be performed.
func (o CorrelationUpdatesPtrOutput) UpdateType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CorrelationUpdates) *string {
		if v == nil {
			return nil
		}
...
// Defines the updates to be applied for correlation.
type CorrelationUpdatesResponse struct {
	// The action group ids.
	ActionGroups []string `pulumi:"actionGroups"`
	// The update interval for notification updates in ISO8601 format.
	UpdateInterval string `pulumi:"updateInterval"`
...
// Defaults sets the appropriate defaults for CorrelationUpdatesResponse
func (val *CorrelationUpdatesResponse) Defaults() *CorrelationUpdatesResponse {
	if val == nil {
		return nil
	}
	tmp := *val
...
// Defines the updates to be applied for correlation.
type CorrelationUpdatesResponseOutput struct{ *pulumi.OutputState }

func (CorrelationUpdatesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CorrelationUpdatesResponse)(nil)).Elem()
}

func (o CorrelationUpdatesResponseOutput) ToCorrelationUpdatesResponseOutput() CorrelationUpdatesResponseOutput {
	return o
}

func (o CorrelationUpdatesResponseOutput) ToCorrelationUpdatesResponseOutputWithContext(ctx context.Context) CorrelationUpdatesResponseOutput {
	return o
}

// The action group ids.
func (o CorrelationUpdatesResponseOutput) ActionGroups() pulumi.StringArrayOutput {
	return o.ApplyT(func(v CorrelationUpdatesResponse) []string { return v.ActionGroups }).(pulumi.StringArrayOutput)
}

// The update interval for notification updates in ISO8601 format.
func (o CorrelationUpdatesResponseOutput) UpdateInterval() pulumi.StringOutput {
	return o.ApplyT(func(v CorrelationUpdatesResponse) string { return v.UpdateInterval }).(pulumi.StringOutput)
}

// The type of update that needs to be performed.
func (o CorrelationUpdatesResponseOutput) UpdateType() pulumi.StringOutput {
	return o.ApplyT(func(v CorrelationUpdatesResponse) string { return v.UpdateType }).(pulumi.StringOutput)
}

type CorrelationUpdatesResponsePtrOutput struct{ *pulumi.OutputState }

func (CorrelationUpdatesResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**CorrelationUpdatesResponse)(nil)).Elem()
}

func (o CorrelationUpdatesResponsePtrOutput) ToCorrelationUpdatesResponsePtrOutput() CorrelationUpdatesResponsePtrOutput {
	return o
}

func (o CorrelationUpdatesResponsePtrOutput) ToCorrelationUpdatesResponsePtrOutputWithContext(ctx context.Context) CorrelationUpdatesResponsePtrOutput {
	return o
}

func (o CorrelationUpdatesResponsePtrOutput) Elem() CorrelationUpdatesResponseOutput {
	return o.ApplyT(func(v *CorrelationUpdatesResponse) CorrelationUpdatesResponse {
		if v != nil {
			return *v
		}
		var ret CorrelationUpdatesResponse
		return ret
	}).(CorrelationUpdatesResponseOutput)
}

// The action group ids.
func (o CorrelationUpdatesResponsePtrOutput) ActionGroups() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *CorrelationUpdatesResponse) []string {
		if v == nil {
			return nil
		}
		return v.ActionGroups
...
// The update interval for notification updates in ISO8601 format.
func (o CorrelationUpdatesResponsePtrOutput) UpdateInterval() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CorrelationUpdatesResponse) *string {
		if v == nil {
			return nil
		}
...
// The type of update that needs to be performed.
func (o CorrelationUpdatesResponsePtrOutput) UpdateType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CorrelationUpdatesResponse) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterOutputType(CorrelationUpdatesOutput{})
	pulumi.RegisterOutputType(CorrelationUpdatesPtrOutput{})
	pulumi.RegisterOutputType(CorrelationUpdatesResponseOutput{})
	pulumi.RegisterOutputType(CorrelationUpdatesResponsePtrOutput{})
