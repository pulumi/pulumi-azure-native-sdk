...
func NewAlertProcessingRuleByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:alertsmanagement:AlertProcessingRuleByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertProcessingRuleByName(ctx *pulumi.Context,
	...
	var resource AlertProcessingRuleByName
	err := ctx.ReadResource("azure-native:alertsmanagement:AlertProcessingRuleByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AlertProcessingRuleByNameOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *AlertProcessingRuleByName) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
