...
// The time at which the investigation execution completed (in UTC)
func (o InvestigationExecutionResponseOutput) CompletedAt() pulumi.StringOutput {
	return o.ApplyT(func(v InvestigationExecutionResponse) string { return v.CompletedAt }).(pulumi.StringOutput)
}
