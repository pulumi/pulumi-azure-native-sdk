...
func NewGatewayCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20220301preview:GatewayCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayCustomDomain(ctx *pulumi.Context,
	...
	var resource GatewayCustomDomain
	err := ctx.ReadResource("azure-native:appplatform/v20220301preview:GatewayCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
