...
//
// Deprecated: azure-native:appplatform/v20220301preview:BuildServiceAgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:BuildServiceAgentPool to guarantee forwards compatibility.
func LookupBuildServiceAgentPool(ctx *pulumi.Context, args *LookupBuildServiceAgentPoolArgs, opts ...pulumi.InvokeOption) (*LookupBuildServiceAgentPoolResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20220301preview:getBuildServiceAgentPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
