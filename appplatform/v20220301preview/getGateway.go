...
//
// Deprecated: azure-native:appplatform/v20220301preview:Gateway is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Gateway to guarantee forwards compatibility.
func LookupGateway(ctx *pulumi.Context, args *LookupGatewayArgs, opts ...pulumi.InvokeOption) (*LookupGatewayResult, error) {
	var rv LookupGatewayResult
	err := ctx.Invoke("azure-native:appplatform/v20220301preview:getGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
