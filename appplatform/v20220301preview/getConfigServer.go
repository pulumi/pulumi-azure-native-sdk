...
//
// Deprecated: azure-native:appplatform/v20220301preview:ConfigServer is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ConfigServer to guarantee forwards compatibility.
func LookupConfigServer(ctx *pulumi.Context, args *LookupConfigServerArgs, opts ...pulumi.InvokeOption) (*LookupConfigServerResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20220301preview:getConfigServer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
