...
//
// Deprecated: azure-native:appplatform/v20220301preview:ConfigServer is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ConfigServer to guarantee forwards compatibility.
