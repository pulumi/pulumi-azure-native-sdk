...
//
// Deprecated: azure-native:appplatform/v20220301preview:Binding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Binding to guarantee forwards compatibility.
func LookupBinding(ctx *pulumi.Context, args *LookupBindingArgs, opts ...pulumi.InvokeOption) (*LookupBindingResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20220301preview:getBinding", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
