...
//
// Deprecated: azure-native:appplatform/v20220301preview:GatewayRouteConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:GatewayRouteConfig to guarantee forwards compatibility.
...
func NewGatewayRouteConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20220301preview:GatewayRouteConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayRouteConfig(ctx *pulumi.Context,
	...
	var resource GatewayRouteConfig
	err := ctx.ReadResource("azure-native:appplatform/v20220301preview:GatewayRouteConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
