...
//
// Deprecated: azure-native:appplatform/v20220301preview:MonitoringSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:MonitoringSetting to guarantee forwards compatibility.
func LookupMonitoringSetting(ctx *pulumi.Context, args *LookupMonitoringSettingArgs, opts ...pulumi.InvokeOption) (*LookupMonitoringSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20220301preview:getMonitoringSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
