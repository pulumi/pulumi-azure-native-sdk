...
func NewGatewayRouteConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20220501preview:GatewayRouteConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayRouteConfig(ctx *pulumi.Context,
	...
	var resource GatewayRouteConfig
	err := ctx.ReadResource("azure-native:appplatform/v20220501preview:GatewayRouteConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
