...
//
// Deprecated: azure-native:appplatform/v20220501preview:Binding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Binding to guarantee forwards compatibility.
