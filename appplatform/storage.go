...
// The Azure API version of the resource.
func (o StorageOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Storage) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
