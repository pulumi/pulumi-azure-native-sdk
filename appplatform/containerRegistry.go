...
func NewContainerRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform:ContainerRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerRegistry(ctx *pulumi.Context,
	...
	var resource ContainerRegistry
	err := ctx.ReadResource("azure-native:appplatform:ContainerRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ContainerRegistryOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ContainerRegistry) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
