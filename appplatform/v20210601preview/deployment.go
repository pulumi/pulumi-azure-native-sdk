...
//
// Deprecated: azure-native:appplatform/v20210601preview:Deployment is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Deployment to guarantee forwards compatibility.
