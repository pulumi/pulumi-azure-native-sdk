...
func NewServiceRegistry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230701preview:ServiceRegistry"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:ServiceRegistry"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:ServiceRegistry"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:ServiceRegistry"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:ServiceRegistry"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ServiceRegistry
	err := ctx.RegisterResource("azure-native:appplatform/v20231101preview:ServiceRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceRegistry(ctx *pulumi.Context,
	...
	var resource ServiceRegistry
	err := ctx.ReadResource("azure-native:appplatform/v20231101preview:ServiceRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
