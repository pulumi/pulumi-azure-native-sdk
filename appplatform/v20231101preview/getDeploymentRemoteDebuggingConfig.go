...
func GetDeploymentRemoteDebuggingConfig(ctx *pulumi.Context, args *GetDeploymentRemoteDebuggingConfigArgs, opts ...pulumi.InvokeOption) (*GetDeploymentRemoteDebuggingConfigResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20231101preview:getDeploymentRemoteDebuggingConfig", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDeploymentRemoteDebuggingConfigOutput(ctx *pulumi.Context, args GetDeploymentRemoteDebuggingConfigOutputArgs, opts ...pulumi.InvokeOption) GetDeploymentRemoteDebuggingConfigResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetDeploymentRemoteDebuggingConfigResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20231101preview:getDeploymentRemoteDebuggingConfig", args, GetDeploymentRemoteDebuggingConfigResultOutput{}, options).(GetDeploymentRemoteDebuggingConfigResultOutput), nil
