...
func NewGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20221201:Gateway"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230701preview:Gateway"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:Gateway"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:Gateway"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:Gateway"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:Gateway"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Gateway
	err := ctx.RegisterResource("azure-native:appplatform/v20231101preview:Gateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGateway(ctx *pulumi.Context,
	...
	var resource Gateway
	err := ctx.ReadResource("azure-native:appplatform/v20231101preview:Gateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
