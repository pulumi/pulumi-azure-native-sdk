...
func NewBuildServiceBuilder(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230701preview:BuildServiceBuilder"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:BuildServiceBuilder"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BuildServiceBuilder
	err := ctx.RegisterResource("azure-native:appplatform/v20231101preview:BuildServiceBuilder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildServiceBuilder(ctx *pulumi.Context,
	...
	var resource BuildServiceBuilder
	err := ctx.ReadResource("azure-native:appplatform/v20231101preview:BuildServiceBuilder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *BuildServiceBuilder) ToOutput(ctx context.Context) pulumix.Output[*BuildServiceBuilder] {
	return pulumix.Output[*BuildServiceBuilder]{
		OutputState: i.ToBuildServiceBuilderOutputWithContext(ctx).OutputState,
	}
}
...
func (o BuildServiceBuilderOutput) ToOutput(ctx context.Context) pulumix.Output[*BuildServiceBuilder] {
	return pulumix.Output[*BuildServiceBuilder]{
