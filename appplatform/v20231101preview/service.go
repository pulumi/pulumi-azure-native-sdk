...
func NewService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:Service"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:Service"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:Service"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:Service"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20231101preview:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetService(ctx *pulumi.Context,
	...
	var resource Service
	err := ctx.ReadResource("azure-native:appplatform/v20231101preview:Service", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
