...
func NewApiPortalCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform:ApiPortalCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPortalCustomDomain(ctx *pulumi.Context,
	...
	var resource ApiPortalCustomDomain
	err := ctx.ReadResource("azure-native:appplatform:ApiPortalCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ApiPortalCustomDomainOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ApiPortalCustomDomain) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
