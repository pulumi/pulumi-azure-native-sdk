...
func NewBuildServiceBuild(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform:BuildServiceBuild", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildServiceBuild(ctx *pulumi.Context,
	...
	var resource BuildServiceBuild
	err := ctx.ReadResource("azure-native:appplatform:BuildServiceBuild", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o BuildServiceBuildOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *BuildServiceBuild) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
