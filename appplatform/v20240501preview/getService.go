...
func LookupService(ctx *pulumi.Context, args *LookupServiceArgs, opts ...pulumi.InvokeOption) (*LookupServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20240501preview:getService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupServiceOutput(ctx *pulumi.Context, args LookupServiceOutputArgs, opts ...pulumi.InvokeOption) LookupServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20240501preview:getService", args, LookupServiceResultOutput{}, options).(LookupServiceResultOutput), nil
...
// Managed Identity of the Service resource
func (o LookupServiceResultOutput) Identity() SystemAssignedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupServiceResult) *SystemAssignedServiceIdentityResponse { return v.Identity }).(SystemAssignedServiceIdentityResponsePtrOutput)
}
