...
func NewApm(ctx *pulumi.Context,
	...
	var resource Apm
	err := ctx.RegisterResource("azure-native:appplatform/v20240501preview:Apm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApm(ctx *pulumi.Context,
	...
	var resource Apm
	err := ctx.ReadResource("azure-native:appplatform/v20240501preview:Apm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
