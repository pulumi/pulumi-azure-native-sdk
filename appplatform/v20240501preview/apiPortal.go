...
func NewApiPortal(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240501preview:ApiPortal", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPortal(ctx *pulumi.Context,
	...
	var resource ApiPortal
	err := ctx.ReadResource("azure-native:appplatform/v20240501preview:ApiPortal", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
