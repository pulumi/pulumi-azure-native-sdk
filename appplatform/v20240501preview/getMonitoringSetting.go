...
func LookupMonitoringSetting(ctx *pulumi.Context, args *LookupMonitoringSettingArgs, opts ...pulumi.InvokeOption) (*LookupMonitoringSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20240501preview:getMonitoringSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMonitoringSettingOutput(ctx *pulumi.Context, args LookupMonitoringSettingOutputArgs, opts ...pulumi.InvokeOption) LookupMonitoringSettingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMonitoringSettingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20240501preview:getMonitoringSetting", args, LookupMonitoringSettingResultOutput{}, options).(LookupMonitoringSettingResultOutput), nil
