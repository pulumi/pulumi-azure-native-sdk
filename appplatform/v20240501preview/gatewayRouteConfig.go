...
func NewGatewayRouteConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230701preview:GatewayRouteConfig"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:GatewayRouteConfig"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:GatewayRouteConfig"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:GatewayRouteConfig"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240501preview:GatewayRouteConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayRouteConfig(ctx *pulumi.Context,
	...
	var resource GatewayRouteConfig
	err := ctx.ReadResource("azure-native:appplatform/v20240501preview:GatewayRouteConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
