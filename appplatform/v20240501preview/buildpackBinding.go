...
func NewBuildpackBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240501preview:BuildpackBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildpackBinding(ctx *pulumi.Context,
	...
	var resource BuildpackBinding
	err := ctx.ReadResource("azure-native:appplatform/v20240501preview:BuildpackBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
