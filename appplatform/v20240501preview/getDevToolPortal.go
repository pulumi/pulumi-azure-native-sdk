...
func LookupDevToolPortal(ctx *pulumi.Context, args *LookupDevToolPortalArgs, opts ...pulumi.InvokeOption) (*LookupDevToolPortalResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20240501preview:getDevToolPortal", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDevToolPortalOutput(ctx *pulumi.Context, args LookupDevToolPortalOutputArgs, opts ...pulumi.InvokeOption) LookupDevToolPortalResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDevToolPortalResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20240501preview:getDevToolPortal", args, LookupDevToolPortalResultOutput{}, options).(LookupDevToolPortalResultOutput), nil
