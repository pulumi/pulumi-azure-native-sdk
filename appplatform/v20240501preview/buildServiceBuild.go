...
func NewBuildServiceBuild(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240501preview:BuildServiceBuild", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildServiceBuild(ctx *pulumi.Context,
	...
	var resource BuildServiceBuild
	err := ctx.ReadResource("azure-native:appplatform/v20240501preview:BuildServiceBuild", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
