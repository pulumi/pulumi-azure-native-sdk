...
func LookupApiPortalCustomDomain(ctx *pulumi.Context, args *LookupApiPortalCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupApiPortalCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20240501preview:getApiPortalCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApiPortalCustomDomainOutput(ctx *pulumi.Context, args LookupApiPortalCustomDomainOutputArgs, opts ...pulumi.InvokeOption) LookupApiPortalCustomDomainResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiPortalCustomDomainResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20240501preview:getApiPortalCustomDomain", args, LookupApiPortalCustomDomainResultOutput{}, options).(LookupApiPortalCustomDomainResultOutput), nil
