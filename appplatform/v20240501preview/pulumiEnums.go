...
func (PrivateStorageAccess) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateStorageAccess)(nil)).Elem()
}

func (e PrivateStorageAccess) ToPrivateStorageAccessOutput() PrivateStorageAccessOutput {
	return pulumi.ToOutput(e).(PrivateStorageAccessOutput)
}

func (e PrivateStorageAccess) ToPrivateStorageAccessOutputWithContext(ctx context.Context) PrivateStorageAccessOutput {
	return pulumi.ToOutputWithContext(ctx, e).(PrivateStorageAccessOutput)
}

func (e PrivateStorageAccess) ToPrivateStorageAccessPtrOutput() PrivateStorageAccessPtrOutput {
	return e.ToPrivateStorageAccessPtrOutputWithContext(context.Background())
}

func (e PrivateStorageAccess) ToPrivateStorageAccessPtrOutputWithContext(ctx context.Context) PrivateStorageAccessPtrOutput {
	return PrivateStorageAccess(e).ToPrivateStorageAccessOutputWithContext(ctx).ToPrivateStorageAccessPtrOutputWithContext(ctx)
}

func (e PrivateStorageAccess) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e PrivateStorageAccess) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e PrivateStorageAccess) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e PrivateStorageAccess) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type PrivateStorageAccessOutput struct{ *pulumi.OutputState }

func (PrivateStorageAccessOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateStorageAccess)(nil)).Elem()
}

func (o PrivateStorageAccessOutput) ToPrivateStorageAccessOutput() PrivateStorageAccessOutput {
	return o
}

func (o PrivateStorageAccessOutput) ToPrivateStorageAccessOutputWithContext(ctx context.Context) PrivateStorageAccessOutput {
	return o
}

func (o PrivateStorageAccessOutput) ToPrivateStorageAccessPtrOutput() PrivateStorageAccessPtrOutput {
	return o.ToPrivateStorageAccessPtrOutputWithContext(context.Background())
}

func (o PrivateStorageAccessOutput) ToPrivateStorageAccessPtrOutputWithContext(ctx context.Context) PrivateStorageAccessPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v PrivateStorageAccess) *PrivateStorageAccess {
		return &v
	}).(PrivateStorageAccessPtrOutput)
}

func (o PrivateStorageAccessOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o PrivateStorageAccessOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PrivateStorageAccess) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o PrivateStorageAccessOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o PrivateStorageAccessOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e PrivateStorageAccess) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type PrivateStorageAccessPtrOutput struct{ *pulumi.OutputState }

func (PrivateStorageAccessPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PrivateStorageAccess)(nil)).Elem()
}

func (o PrivateStorageAccessPtrOutput) ToPrivateStorageAccessPtrOutput() PrivateStorageAccessPtrOutput {
	return o
}

func (o PrivateStorageAccessPtrOutput) ToPrivateStorageAccessPtrOutputWithContext(ctx context.Context) PrivateStorageAccessPtrOutput {
	return o
}

func (o PrivateStorageAccessPtrOutput) Elem() PrivateStorageAccessOutput {
	return o.ApplyT(func(v *PrivateStorageAccess) PrivateStorageAccess {
		if v != nil {
			return *v
		}
		var ret PrivateStorageAccess
		return ret
	}).(PrivateStorageAccessOutput)
}

func (o PrivateStorageAccessPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o PrivateStorageAccessPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *PrivateStorageAccess) *string {
		if e == nil {
			return nil
		}
...
// PrivateStorageAccessInput is an input type that accepts values of the PrivateStorageAccess enum
// A concrete instance of `PrivateStorageAccessInput` can be one of the following:
//
//	PrivateStorageAccessEnabled
//	PrivateStorageAccessDisabled
type PrivateStorageAccessInput interface {
	pulumi.Input

	ToPrivateStorageAccessOutput() PrivateStorageAccessOutput
	ToPrivateStorageAccessOutputWithContext(context.Context) PrivateStorageAccessOutput
}

var privateStorageAccessPtrType = reflect.TypeOf((**PrivateStorageAccess)(nil)).Elem()

type PrivateStorageAccessPtrInput interface {
	pulumi.Input

	ToPrivateStorageAccessPtrOutput() PrivateStorageAccessPtrOutput
	ToPrivateStorageAccessPtrOutputWithContext(context.Context) PrivateStorageAccessPtrOutput
}

type privateStorageAccessPtr string

func PrivateStorageAccessPtr(v string) PrivateStorageAccessPtrInput {
	return (*privateStorageAccessPtr)(&v)
}

func (*privateStorageAccessPtr) ElementType() reflect.Type {
	return privateStorageAccessPtrType
}

func (in *privateStorageAccessPtr) ToPrivateStorageAccessPtrOutput() PrivateStorageAccessPtrOutput {
	return pulumi.ToOutput(in).(PrivateStorageAccessPtrOutput)
}

func (in *privateStorageAccessPtr) ToPrivateStorageAccessPtrOutputWithContext(ctx context.Context) PrivateStorageAccessPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(PrivateStorageAccessPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(PrivateStorageAccessOutput{})
	pulumi.RegisterOutputType(PrivateStorageAccessPtrOutput{})
