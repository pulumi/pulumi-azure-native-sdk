...
func NewDevToolPortal(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230501preview:DevToolPortal"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:DevToolPortal"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:DevToolPortal"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240501preview:DevToolPortal", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevToolPortal(ctx *pulumi.Context,
	...
	var resource DevToolPortal
	err := ctx.ReadResource("azure-native:appplatform/v20240501preview:DevToolPortal", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
