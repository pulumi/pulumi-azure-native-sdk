...
func NewContainerRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240501preview:ContainerRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerRegistry(ctx *pulumi.Context,
	...
	var resource ContainerRegistry
	err := ctx.ReadResource("azure-native:appplatform/v20240501preview:ContainerRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
