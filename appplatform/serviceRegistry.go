...
func NewServiceRegistry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:ServiceRegistry"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:appplatform:ServiceRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceRegistry(ctx *pulumi.Context,
	...
	var resource ServiceRegistry
	err := ctx.ReadResource("azure-native:appplatform:ServiceRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ServiceRegistryOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceRegistry) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
