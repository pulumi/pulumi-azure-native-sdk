...
func NewBuildServiceAgentPool(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:BuildServiceAgentPool"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:BuildServiceAgentPool"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:BuildServiceAgentPool"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:appplatform:BuildServiceAgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildServiceAgentPool(ctx *pulumi.Context,
	...
	var resource BuildServiceAgentPool
	err := ctx.ReadResource("azure-native:appplatform:BuildServiceAgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o BuildServiceAgentPoolOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *BuildServiceAgentPool) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
