...
// The Azure API version of the resource.
func (o LookupGatewayCustomDomainResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupGatewayCustomDomainResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
