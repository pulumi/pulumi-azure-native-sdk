...
//
// Deprecated: azure-native:appplatform/v20220901preview:BuildServiceAgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:BuildServiceAgentPool to guarantee forwards compatibility.
...
func NewBuildServiceAgentPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20220901preview:BuildServiceAgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildServiceAgentPool(ctx *pulumi.Context,
	...
	var resource BuildServiceAgentPool
	err := ctx.ReadResource("azure-native:appplatform/v20220901preview:BuildServiceAgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
