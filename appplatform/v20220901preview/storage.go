...
//
// Deprecated: azure-native:appplatform/v20220901preview:Storage is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Storage to guarantee forwards compatibility.
type Storage struct {
...
func NewStorage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20220901preview:Storage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorage(ctx *pulumi.Context,
	...
	var resource Storage
	err := ctx.ReadResource("azure-native:appplatform/v20220901preview:Storage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
