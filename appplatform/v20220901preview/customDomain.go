...
//
// Deprecated: azure-native:appplatform/v20220901preview:CustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:CustomDomain to guarantee forwards compatibility.
