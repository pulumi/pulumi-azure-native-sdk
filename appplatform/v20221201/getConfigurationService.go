...
//
// Deprecated: azure-native:appplatform/v20221201:ConfigurationService is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ConfigurationService to guarantee forwards compatibility.
func LookupConfigurationService(ctx *pulumi.Context, args *LookupConfigurationServiceArgs, opts ...pulumi.InvokeOption) (*LookupConfigurationServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20221201:getConfigurationService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
