...
//
// Deprecated: azure-native:appplatform/v20221201:GatewayRouteConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:GatewayRouteConfig to guarantee forwards compatibility.
...
func NewGatewayRouteConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20221201:GatewayRouteConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayRouteConfig(ctx *pulumi.Context,
	...
	var resource GatewayRouteConfig
	err := ctx.ReadResource("azure-native:appplatform/v20221201:GatewayRouteConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
