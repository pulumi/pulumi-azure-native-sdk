...
// API portal resource
//
// Deprecated: azure-native:appplatform/v20221201:ApiPortal is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ApiPortal to guarantee forwards compatibility.
...
func NewApiPortal(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20221201:ApiPortal", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPortal(ctx *pulumi.Context,
	...
	var resource ApiPortal
	err := ctx.ReadResource("azure-native:appplatform/v20221201:ApiPortal", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
