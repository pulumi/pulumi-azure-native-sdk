...
//
// Deprecated: azure-native:appplatform/v20230101preview:DevToolPortal is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:DevToolPortal to guarantee forwards compatibility.
func LookupDevToolPortal(ctx *pulumi.Context, args *LookupDevToolPortalArgs, opts ...pulumi.InvokeOption) (*LookupDevToolPortalResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230101preview:getDevToolPortal", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
