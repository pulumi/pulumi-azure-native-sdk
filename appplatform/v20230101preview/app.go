...
//
// Deprecated: azure-native:appplatform/v20230101preview:App is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:App to guarantee forwards compatibility.
type App struct {
...
func NewApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.RegisterResource("azure-native:appplatform/v20230101preview:App", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.ReadResource("azure-native:appplatform/v20230101preview:App", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
