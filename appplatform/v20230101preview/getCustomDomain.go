...
//
// Deprecated: azure-native:appplatform/v20230101preview:CustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:CustomDomain to guarantee forwards compatibility.
func LookupCustomDomain(ctx *pulumi.Context, args *LookupCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230101preview:getCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
