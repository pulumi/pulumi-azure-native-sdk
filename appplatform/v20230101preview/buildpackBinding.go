...
//
// Deprecated: azure-native:appplatform/v20230101preview:BuildpackBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:BuildpackBinding to guarantee forwards compatibility.
...
func NewBuildpackBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230101preview:BuildpackBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildpackBinding(ctx *pulumi.Context,
	...
	var resource BuildpackBinding
	err := ctx.ReadResource("azure-native:appplatform/v20230101preview:BuildpackBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
