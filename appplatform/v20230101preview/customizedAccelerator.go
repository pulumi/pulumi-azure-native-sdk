...
func NewCustomizedAccelerator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230101preview:CustomizedAccelerator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomizedAccelerator(ctx *pulumi.Context,
	...
	var resource CustomizedAccelerator
	err := ctx.ReadResource("azure-native:appplatform/v20230101preview:CustomizedAccelerator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
