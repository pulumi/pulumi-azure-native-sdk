...
func NewApiPortalCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230101preview:ApiPortalCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPortalCustomDomain(ctx *pulumi.Context,
	...
	var resource ApiPortalCustomDomain
	err := ctx.ReadResource("azure-native:appplatform/v20230101preview:ApiPortalCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
