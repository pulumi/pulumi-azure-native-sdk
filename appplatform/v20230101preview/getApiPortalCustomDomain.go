...
//
// Deprecated: azure-native:appplatform/v20230101preview:ApiPortalCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ApiPortalCustomDomain to guarantee forwards compatibility.
func LookupApiPortalCustomDomain(ctx *pulumi.Context, args *LookupApiPortalCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupApiPortalCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230101preview:getApiPortalCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
