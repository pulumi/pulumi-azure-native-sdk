...
func NewConfigurationService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230101preview:ConfigurationService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationService(ctx *pulumi.Context,
	...
	var resource ConfigurationService
	err := ctx.ReadResource("azure-native:appplatform/v20230101preview:ConfigurationService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
