...
func LookupGatewayRouteConfig(ctx *pulumi.Context, args *LookupGatewayRouteConfigArgs, opts ...pulumi.InvokeOption) (*LookupGatewayRouteConfigResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20231201:getGatewayRouteConfig", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupGatewayRouteConfigOutput(ctx *pulumi.Context, args LookupGatewayRouteConfigOutputArgs, opts ...pulumi.InvokeOption) LookupGatewayRouteConfigResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGatewayRouteConfigResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20231201:getGatewayRouteConfig", args, LookupGatewayRouteConfigResultOutput{}, options).(LookupGatewayRouteConfigResultOutput), nil
