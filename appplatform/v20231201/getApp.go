...
func LookupApp(ctx *pulumi.Context, args *LookupAppArgs, opts ...pulumi.InvokeOption) (*LookupAppResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20231201:getApp", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupAppOutput(ctx *pulumi.Context, args LookupAppOutputArgs, opts ...pulumi.InvokeOption) LookupAppResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAppResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20231201:getApp", args, LookupAppResultOutput{}, options).(LookupAppResultOutput), nil
