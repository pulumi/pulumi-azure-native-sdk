...
func LookupCustomizedAccelerator(ctx *pulumi.Context, args *LookupCustomizedAcceleratorArgs, opts ...pulumi.InvokeOption) (*LookupCustomizedAcceleratorResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20231201:getCustomizedAccelerator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupCustomizedAcceleratorOutput(ctx *pulumi.Context, args LookupCustomizedAcceleratorOutputArgs, opts ...pulumi.InvokeOption) LookupCustomizedAcceleratorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCustomizedAcceleratorResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20231201:getCustomizedAccelerator", args, LookupCustomizedAcceleratorResultOutput{}, options).(LookupCustomizedAcceleratorResultOutput), nil
