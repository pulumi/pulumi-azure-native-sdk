...
func LookupGatewayCustomDomain(ctx *pulumi.Context, args *LookupGatewayCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupGatewayCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20231201:getGatewayCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGatewayCustomDomainOutput(ctx *pulumi.Context, args LookupGatewayCustomDomainOutputArgs, opts ...pulumi.InvokeOption) LookupGatewayCustomDomainResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGatewayCustomDomainResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20231201:getGatewayCustomDomain", args, LookupGatewayCustomDomainResultOutput{}, options).(LookupGatewayCustomDomainResultOutput), nil
