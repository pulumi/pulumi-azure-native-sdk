...
func NewConfigServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20231201:ConfigServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigServer(ctx *pulumi.Context,
	...
	var resource ConfigServer
	err := ctx.ReadResource("azure-native:appplatform/v20231201:ConfigServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
