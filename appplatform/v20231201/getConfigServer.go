...
func LookupConfigServer(ctx *pulumi.Context, args *LookupConfigServerArgs, opts ...pulumi.InvokeOption) (*LookupConfigServerResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20231201:getConfigServer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConfigServerOutput(ctx *pulumi.Context, args LookupConfigServerOutputArgs, opts ...pulumi.InvokeOption) LookupConfigServerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConfigServerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20231201:getConfigServer", args, LookupConfigServerResultOutput{}, options).(LookupConfigServerResultOutput), nil
