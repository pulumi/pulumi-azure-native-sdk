...
func LookupApm(ctx *pulumi.Context, args *LookupApmArgs, opts ...pulumi.InvokeOption) (*LookupApmResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20231201:getApm", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApmOutput(ctx *pulumi.Context, args LookupApmOutputArgs, opts ...pulumi.InvokeOption) LookupApmResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApmResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20231201:getApm", args, LookupApmResultOutput{}, options).(LookupApmResultOutput), nil
