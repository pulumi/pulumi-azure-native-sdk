...
func NewBinding(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:Binding"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:Binding"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:Binding"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:Binding"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:Binding"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Binding
	err := ctx.RegisterResource("azure-native:appplatform:Binding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBinding(ctx *pulumi.Context,
	...
	var resource Binding
	err := ctx.ReadResource("azure-native:appplatform:Binding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o BindingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Binding) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
