...
func NewStorage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230301preview:Storage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorage(ctx *pulumi.Context,
	...
	var resource Storage
	err := ctx.ReadResource("azure-native:appplatform/v20230301preview:Storage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
