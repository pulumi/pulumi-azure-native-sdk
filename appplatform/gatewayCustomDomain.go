...
func NewGatewayCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230701preview:GatewayCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:GatewayCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:GatewayCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:GatewayCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:GatewayCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:GatewayCustomDomain"),
		},
	})
...
// The Azure API version of the resource.
func (o GatewayCustomDomainOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *GatewayCustomDomain) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
