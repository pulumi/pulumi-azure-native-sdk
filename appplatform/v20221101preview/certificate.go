...
//
// Deprecated: azure-native:appplatform/v20221101preview:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Certificate to guarantee forwards compatibility.
