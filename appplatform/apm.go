...
func NewApm(ctx *pulumi.Context,
	...
	var resource Apm
	err := ctx.RegisterResource("azure-native:appplatform:Apm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApm(ctx *pulumi.Context,
	...
	var resource Apm
	err := ctx.ReadResource("azure-native:appplatform:Apm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ApmOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Apm) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
