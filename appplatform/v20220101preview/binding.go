...
func NewBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20220101preview:Binding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBinding(ctx *pulumi.Context,
	...
	var resource Binding
	err := ctx.ReadResource("azure-native:appplatform/v20220101preview:Binding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
