...
// The Azure API version of the resource.
func (o MonitoringSettingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *MonitoringSetting) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
