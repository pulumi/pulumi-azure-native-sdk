...
func NewApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.RegisterResource("azure-native:appplatform/v20200701:App", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.ReadResource("azure-native:appplatform/v20200701:App", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
