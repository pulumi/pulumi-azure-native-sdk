...
//
// Deprecated: azure-native:appplatform/v20200701:ConfigServer is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ConfigServer to guarantee forwards compatibility.
...
func NewConfigServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20200701:ConfigServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigServer(ctx *pulumi.Context,
	...
	var resource ConfigServer
	err := ctx.ReadResource("azure-native:appplatform/v20200701:ConfigServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
