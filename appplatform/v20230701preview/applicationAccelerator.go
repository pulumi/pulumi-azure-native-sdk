...
func NewApplicationAccelerator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230701preview:ApplicationAccelerator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationAccelerator(ctx *pulumi.Context,
	...
	var resource ApplicationAccelerator
	err := ctx.ReadResource("azure-native:appplatform/v20230701preview:ApplicationAccelerator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
