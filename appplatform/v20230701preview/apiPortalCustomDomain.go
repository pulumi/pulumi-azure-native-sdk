...
func NewApiPortalCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:ApiPortalCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:ApiPortalCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:ApiPortalCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:ApiPortalCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:ApiPortalCustomDomain"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApiPortalCustomDomain
	err := ctx.RegisterResource("azure-native:appplatform/v20230701preview:ApiPortalCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPortalCustomDomain(ctx *pulumi.Context,
	...
	var resource ApiPortalCustomDomain
	err := ctx.ReadResource("azure-native:appplatform/v20230701preview:ApiPortalCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
