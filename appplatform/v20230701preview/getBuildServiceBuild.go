...
func LookupBuildServiceBuild(ctx *pulumi.Context, args *LookupBuildServiceBuildArgs, opts ...pulumi.InvokeOption) (*LookupBuildServiceBuildResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230701preview:getBuildServiceBuild", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupBuildServiceBuildOutput(ctx *pulumi.Context, args LookupBuildServiceBuildOutputArgs, opts ...pulumi.InvokeOption) LookupBuildServiceBuildResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBuildServiceBuildResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20230701preview:getBuildServiceBuild", args, LookupBuildServiceBuildResultOutput{}, options).(LookupBuildServiceBuildResultOutput), nil
