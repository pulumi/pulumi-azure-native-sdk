...
func NewBuildServiceAgentPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230701preview:BuildServiceAgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildServiceAgentPool(ctx *pulumi.Context,
	...
	var resource BuildServiceAgentPool
	err := ctx.ReadResource("azure-native:appplatform/v20230701preview:BuildServiceAgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
