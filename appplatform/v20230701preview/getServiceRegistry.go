...
func LookupServiceRegistry(ctx *pulumi.Context, args *LookupServiceRegistryArgs, opts ...pulumi.InvokeOption) (*LookupServiceRegistryResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230701preview:getServiceRegistry", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServiceRegistryOutput(ctx *pulumi.Context, args LookupServiceRegistryOutputArgs, opts ...pulumi.InvokeOption) LookupServiceRegistryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServiceRegistryResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20230701preview:getServiceRegistry", args, LookupServiceRegistryResultOutput{}, options).(LookupServiceRegistryResultOutput), nil
