...
func NewConfigurationService(ctx *pulumi.Context,
	...
	if args.Properties != nil {
		args.Properties = args.Properties.ToConfigurationServicePropertiesPtrOutput().ApplyT(func(v *ConfigurationServiceProperties) *ConfigurationServiceProperties { return v.Defaults() }).(ConfigurationServicePropertiesPtrOutput)
	}
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:ConfigurationService"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:ConfigurationService"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ConfigurationService
	err := ctx.RegisterResource("azure-native:appplatform/v20230701preview:ConfigurationService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationService(ctx *pulumi.Context,
	...
	var resource ConfigurationService
	err := ctx.ReadResource("azure-native:appplatform/v20230701preview:ConfigurationService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ConfigurationService) ToOutput(ctx context.Context) pulumix.Output[*ConfigurationService] {
	return pulumix.Output[*ConfigurationService]{
		OutputState: i.ToConfigurationServiceOutputWithContext(ctx).OutputState,
	}
}
...
func (o ConfigurationServiceOutput) ToOutput(ctx context.Context) pulumix.Output[*ConfigurationService] {
	return pulumix.Output[*ConfigurationService]{
