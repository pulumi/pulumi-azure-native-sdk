...
//
// Deprecated: azure-native:appplatform/v20220401:ConfigServer is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ConfigServer to guarantee forwards compatibility.
func LookupConfigServer(ctx *pulumi.Context, args *LookupConfigServerArgs, opts ...pulumi.InvokeOption) (*LookupConfigServerResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20220401:getConfigServer", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
