...
//
// Deprecated: azure-native:appplatform/v20220401:BuildpackBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:BuildpackBinding to guarantee forwards compatibility.
func LookupBuildpackBinding(ctx *pulumi.Context, args *LookupBuildpackBindingArgs, opts ...pulumi.InvokeOption) (*LookupBuildpackBindingResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20220401:getBuildpackBinding", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
