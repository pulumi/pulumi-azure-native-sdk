...
//
// Deprecated: azure-native:appplatform/v20220401:ServiceRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ServiceRegistry to guarantee forwards compatibility.
func LookupServiceRegistry(ctx *pulumi.Context, args *LookupServiceRegistryArgs, opts ...pulumi.InvokeOption) (*LookupServiceRegistryResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20220401:getServiceRegistry", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
