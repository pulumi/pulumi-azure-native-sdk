...
func NewApplicationAccelerator(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230501preview:ApplicationAccelerator"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:ApplicationAccelerator"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:ApplicationAccelerator"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:ApplicationAccelerator"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApplicationAccelerator
	err := ctx.RegisterResource("azure-native:appplatform:ApplicationAccelerator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationAccelerator(ctx *pulumi.Context,
	...
	var resource ApplicationAccelerator
	err := ctx.ReadResource("azure-native:appplatform:ApplicationAccelerator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
