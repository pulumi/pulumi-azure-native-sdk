...
func LookupApplicationLiveView(ctx *pulumi.Context, args *LookupApplicationLiveViewArgs, opts ...pulumi.InvokeOption) (*LookupApplicationLiveViewResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform:getApplicationLiveView", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupApplicationLiveViewOutput(ctx *pulumi.Context, args LookupApplicationLiveViewOutputArgs, opts ...pulumi.InvokeOption) LookupApplicationLiveViewResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApplicationLiveViewResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform:getApplicationLiveView", args, LookupApplicationLiveViewResultOutput{}, options).(LookupApplicationLiveViewResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupApplicationLiveViewResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupApplicationLiveViewResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
