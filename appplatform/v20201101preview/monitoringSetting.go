...
func NewMonitoringSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20201101preview:MonitoringSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringSetting(ctx *pulumi.Context,
	...
	var resource MonitoringSetting
	err := ctx.ReadResource("azure-native:appplatform/v20201101preview:MonitoringSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
