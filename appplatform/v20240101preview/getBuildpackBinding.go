...
func LookupBuildpackBinding(ctx *pulumi.Context, args *LookupBuildpackBindingArgs, opts ...pulumi.InvokeOption) (*LookupBuildpackBindingResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20240101preview:getBuildpackBinding", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBuildpackBindingOutput(ctx *pulumi.Context, args LookupBuildpackBindingOutputArgs, opts ...pulumi.InvokeOption) LookupBuildpackBindingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBuildpackBindingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20240101preview:getBuildpackBinding", args, LookupBuildpackBindingResultOutput{}, options).(LookupBuildpackBindingResultOutput), nil
