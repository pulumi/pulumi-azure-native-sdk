...
func NewApplicationLiveView(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240101preview:ApplicationLiveView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationLiveView(ctx *pulumi.Context,
	...
	var resource ApplicationLiveView
	err := ctx.ReadResource("azure-native:appplatform/v20240101preview:ApplicationLiveView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
