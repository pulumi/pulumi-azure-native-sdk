...
func NewDevToolPortal(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240101preview:DevToolPortal", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevToolPortal(ctx *pulumi.Context,
	...
	var resource DevToolPortal
	err := ctx.ReadResource("azure-native:appplatform/v20240101preview:DevToolPortal", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
