...
func ListBuildServiceBuilderDeployments(ctx *pulumi.Context, args *ListBuildServiceBuilderDeploymentsArgs, opts ...pulumi.InvokeOption) (*ListBuildServiceBuilderDeploymentsResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20240101preview:listBuildServiceBuilderDeployments", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListBuildServiceBuilderDeploymentsOutput(ctx *pulumi.Context, args ListBuildServiceBuilderDeploymentsOutputArgs, opts ...pulumi.InvokeOption) ListBuildServiceBuilderDeploymentsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListBuildServiceBuilderDeploymentsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20240101preview:listBuildServiceBuilderDeployments", args, ListBuildServiceBuilderDeploymentsResultOutput{}, options).(ListBuildServiceBuilderDeploymentsResultOutput), nil
