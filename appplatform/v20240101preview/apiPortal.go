...
func NewApiPortal(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:ApiPortal"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:ApiPortal"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20240101preview:ApiPortal", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiPortal(ctx *pulumi.Context,
	...
	var resource ApiPortal
	err := ctx.ReadResource("azure-native:appplatform/v20240101preview:ApiPortal", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
