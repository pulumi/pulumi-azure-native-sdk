...
func NewApp(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:App"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:App"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:App"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:App"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource App
	err := ctx.RegisterResource("azure-native:appplatform/v20240101preview:App", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.ReadResource("azure-native:appplatform/v20240101preview:App", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
