...
func NewMonitoringSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230701preview:MonitoringSetting"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:MonitoringSetting"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:MonitoringSetting"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:MonitoringSetting"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MonitoringSetting
	err := ctx.RegisterResource("azure-native:appplatform/v20240101preview:MonitoringSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringSetting(ctx *pulumi.Context,
	...
	var resource MonitoringSetting
	err := ctx.ReadResource("azure-native:appplatform/v20240101preview:MonitoringSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
