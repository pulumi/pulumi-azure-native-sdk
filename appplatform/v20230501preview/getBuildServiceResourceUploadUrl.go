...
func GetBuildServiceResourceUploadUrl(ctx *pulumi.Context, args *GetBuildServiceResourceUploadUrlArgs, opts ...pulumi.InvokeOption) (*GetBuildServiceResourceUploadUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230501preview:getBuildServiceResourceUploadUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetBuildServiceResourceUploadUrlOutput(ctx *pulumi.Context, args GetBuildServiceResourceUploadUrlOutputArgs, opts ...pulumi.InvokeOption) GetBuildServiceResourceUploadUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetBuildServiceResourceUploadUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20230501preview:getBuildServiceResourceUploadUrl", args, GetBuildServiceResourceUploadUrlResultOutput{}, options).(GetBuildServiceResourceUploadUrlResultOutput), nil
