...
func NewApp(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:App"),
		},
		{
	...
	var resource App
	err := ctx.RegisterResource("azure-native:appplatform/v20230501preview:App", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.ReadResource("azure-native:appplatform/v20230501preview:App", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
