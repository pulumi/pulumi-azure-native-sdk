...
func GetBuildServiceBuildResultLog(ctx *pulumi.Context, args *GetBuildServiceBuildResultLogArgs, opts ...pulumi.InvokeOption) (*GetBuildServiceBuildResultLogResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230501preview:getBuildServiceBuildResultLog", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetBuildServiceBuildResultLogOutput(ctx *pulumi.Context, args GetBuildServiceBuildResultLogOutputArgs, opts ...pulumi.InvokeOption) GetBuildServiceBuildResultLogResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetBuildServiceBuildResultLogResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20230501preview:getBuildServiceBuildResultLog", args, GetBuildServiceBuildResultLogResultOutput{}, options).(GetBuildServiceBuildResultLogResultOutput), nil
