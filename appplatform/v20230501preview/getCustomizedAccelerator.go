...
func (o LookupCustomizedAcceleratorResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupCustomizedAcceleratorResult] {
	return pulumix.Output[LookupCustomizedAcceleratorResult]{
