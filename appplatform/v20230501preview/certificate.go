...
func NewCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230901preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:Certificate"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230501preview:Certificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificate(ctx *pulumi.Context,
	...
	var resource Certificate
	err := ctx.ReadResource("azure-native:appplatform/v20230501preview:Certificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
