...
func NewBuildServiceBuilder(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230501preview:BuildServiceBuilder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuildServiceBuilder(ctx *pulumi.Context,
	...
	var resource BuildServiceBuilder
	err := ctx.ReadResource("azure-native:appplatform/v20230501preview:BuildServiceBuilder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
