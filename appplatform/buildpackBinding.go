...
// The Azure API version of the resource.
func (o BuildpackBindingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *BuildpackBinding) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
