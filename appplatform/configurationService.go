...
func NewConfigurationService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform:ConfigurationService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationService(ctx *pulumi.Context,
	...
	var resource ConfigurationService
	err := ctx.ReadResource("azure-native:appplatform:ConfigurationService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ConfigurationServiceOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ConfigurationService) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
