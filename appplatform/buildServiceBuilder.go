...
// The Azure API version of the resource.
func (o BuildServiceBuilderOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *BuildServiceBuilder) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
