...
func GetAppResourceUploadUrl(ctx *pulumi.Context, args *GetAppResourceUploadUrlArgs, opts ...pulumi.InvokeOption) (*GetAppResourceUploadUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230901preview:getAppResourceUploadUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAppResourceUploadUrlOutput(ctx *pulumi.Context, args GetAppResourceUploadUrlOutputArgs, opts ...pulumi.InvokeOption) GetAppResourceUploadUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetAppResourceUploadUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20230901preview:getAppResourceUploadUrl", args, GetAppResourceUploadUrlResultOutput{}, options).(GetAppResourceUploadUrlResultOutput), nil
