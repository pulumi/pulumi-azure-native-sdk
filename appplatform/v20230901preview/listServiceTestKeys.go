...
func ListServiceTestKeys(ctx *pulumi.Context, args *ListServiceTestKeysArgs, opts ...pulumi.InvokeOption) (*ListServiceTestKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230901preview:listServiceTestKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListServiceTestKeysOutput(ctx *pulumi.Context, args ListServiceTestKeysOutputArgs, opts ...pulumi.InvokeOption) ListServiceTestKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListServiceTestKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20230901preview:listServiceTestKeys", args, ListServiceTestKeysResultOutput{}, options).(ListServiceTestKeysResultOutput), nil
