...
func NewStorage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230701preview:Storage"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231101preview:Storage"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20231201:Storage"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:Storage"),
		},
		{
			Type: pulumi.String("azure-native:appplatform/v20240501preview:Storage"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Storage
	err := ctx.RegisterResource("azure-native:appplatform/v20230901preview:Storage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorage(ctx *pulumi.Context,
	...
	var resource Storage
	err := ctx.ReadResource("azure-native:appplatform/v20230901preview:Storage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
