...
func NewServiceRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230901preview:ServiceRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceRegistry(ctx *pulumi.Context,
	...
	var resource ServiceRegistry
	err := ctx.ReadResource("azure-native:appplatform/v20230901preview:ServiceRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
