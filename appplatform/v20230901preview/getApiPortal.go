...
func LookupApiPortal(ctx *pulumi.Context, args *LookupApiPortalArgs, opts ...pulumi.InvokeOption) (*LookupApiPortalResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230901preview:getApiPortal", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupApiPortalOutput(ctx *pulumi.Context, args LookupApiPortalOutputArgs, opts ...pulumi.InvokeOption) LookupApiPortalResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupApiPortalResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20230901preview:getApiPortal", args, LookupApiPortalResultOutput{}, options).(LookupApiPortalResultOutput), nil
