...
func GetDeploymentLogFileUrl(ctx *pulumi.Context, args *GetDeploymentLogFileUrlArgs, opts ...pulumi.InvokeOption) (*GetDeploymentLogFileUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:appplatform/v20230901preview:getDeploymentLogFileUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDeploymentLogFileUrlOutput(ctx *pulumi.Context, args GetDeploymentLogFileUrlOutputArgs, opts ...pulumi.InvokeOption) GetDeploymentLogFileUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetDeploymentLogFileUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:appplatform/v20230901preview:getDeploymentLogFileUrl", args, GetDeploymentLogFileUrlResultOutput{}, options).(GetDeploymentLogFileUrlResultOutput), nil
