...
func NewContainerRegistry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20230701preview:ContainerRegistry"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:appplatform/v20240101preview:ContainerRegistry"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ContainerRegistry
	err := ctx.RegisterResource("azure-native:appplatform/v20230901preview:ContainerRegistry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerRegistry(ctx *pulumi.Context,
	...
	var resource ContainerRegistry
	err := ctx.ReadResource("azure-native:appplatform/v20230901preview:ContainerRegistry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
