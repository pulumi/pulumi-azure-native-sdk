...
func NewCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:appplatform/v20230901preview:Certificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificate(ctx *pulumi.Context,
	...
	var resource Certificate
	err := ctx.ReadResource("azure-native:appplatform/v20230901preview:Certificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
