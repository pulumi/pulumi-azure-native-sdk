...
// azure-native:scheduler/v20160101:JobCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:scheduler/v20160301:JobCollection to guarantee forwards compatibility.
...
func NewJobCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:scheduler/v20160101:JobCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobCollection(ctx *pulumi.Context,
	...
	var resource JobCollection
	err := ctx.ReadResource("azure-native:scheduler/v20160101:JobCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
