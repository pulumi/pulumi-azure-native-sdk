...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o IamRoleOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *IamRole) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
