...
// The Azure API version of the resource.
func (o KmsKeyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *KmsKey) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o KmsKeyOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *KmsKey) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
