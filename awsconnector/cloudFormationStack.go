...
// The Azure API version of the resource.
func (o CloudFormationStackOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CloudFormationStack) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CloudFormationStackOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *CloudFormationStack) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
