...
func LookupS3BucketOutput(ctx *pulumi.Context, args LookupS3BucketOutputArgs, opts ...pulumi.InvokeOption) LookupS3BucketResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupS3BucketResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:awsconnector:getS3Bucket", args, LookupS3BucketResultOutput{}, options).(LookupS3BucketResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupS3BucketResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupS3BucketResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupS3BucketResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupS3BucketResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
