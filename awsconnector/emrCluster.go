...
func NewEmrCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector/v20241201:EmrCluster"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EmrCluster
	err := ctx.RegisterResource("azure-native:awsconnector:EmrCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmrCluster(ctx *pulumi.Context,
	...
	var resource EmrCluster
	err := ctx.ReadResource("azure-native:awsconnector:EmrCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o EmrClusterOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *EmrCluster) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o EmrClusterOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *EmrCluster) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
