...
// The Azure API version of the resource.
func (o LookupIamRoleResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupIamRoleResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupIamRoleResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupIamRoleResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
