...
type EmrCluster struct {
	...
	Properties EmrClusterPropertiesResponseOutput `pulumi:"properties"`
...
func NewEmrCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:EmrCluster"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EmrCluster
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:EmrCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEmrCluster(ctx *pulumi.Context,
	...
	var resource EmrCluster
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:EmrCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type emrClusterArgs struct {
	...
	// The resource-specific properties for this resource.
	Properties *EmrClusterProperties `pulumi:"properties"`
...
type EmrClusterArgs struct {
	...
	// The resource-specific properties for this resource.
	Properties EmrClusterPropertiesPtrInput
	// The name of the resource group. The name is case insensitive.
...
// The geo-location where the resource lives
func (o EmrClusterOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *EmrCluster) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}
...
// The resource-specific properties for this resource.
func (o EmrClusterOutput) Properties() EmrClusterPropertiesResponseOutput {
	return o.ApplyT(func(v *EmrCluster) EmrClusterPropertiesResponseOutput { return v.Properties }).(EmrClusterPropertiesResponseOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o EmrClusterOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *EmrCluster) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}

// Resource tags.
func (o EmrClusterOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *EmrCluster) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}

// The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
func (o EmrClusterOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v *EmrCluster) pulumi.StringOutput { return v.Type }).(pulumi.StringOutput)
}
