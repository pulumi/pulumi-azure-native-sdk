...
func NewSecretsManagerSecret(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:SecretsManagerSecret"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SecretsManagerSecret
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:SecretsManagerSecret", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretsManagerSecret(ctx *pulumi.Context,
	...
	var resource SecretsManagerSecret
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:SecretsManagerSecret", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
