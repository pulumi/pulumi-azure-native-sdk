...
func NewS3Bucket(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:S3Bucket"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource S3Bucket
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:S3Bucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetS3Bucket(ctx *pulumi.Context,
	...
	var resource S3Bucket
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:S3Bucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
