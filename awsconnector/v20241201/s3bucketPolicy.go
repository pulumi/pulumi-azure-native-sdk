...
func NewS3BucketPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:S3BucketPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource S3BucketPolicy
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:S3BucketPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetS3BucketPolicy(ctx *pulumi.Context,
	...
	var resource S3BucketPolicy
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:S3BucketPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
