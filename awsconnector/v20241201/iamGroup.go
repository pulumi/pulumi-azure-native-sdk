...
func NewIamGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:IamGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource IamGroup
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:IamGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIamGroup(ctx *pulumi.Context,
	...
	var resource IamGroup
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:IamGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
