...
func NewConfigServiceConfigurationRecorder(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:ConfigServiceConfigurationRecorder"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ConfigServiceConfigurationRecorder
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:ConfigServiceConfigurationRecorder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigServiceConfigurationRecorder(ctx *pulumi.Context,
	...
	var resource ConfigServiceConfigurationRecorder
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:ConfigServiceConfigurationRecorder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
