...
func NewEfsMountTarget(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:EfsMountTarget"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EfsMountTarget
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:EfsMountTarget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEfsMountTarget(ctx *pulumi.Context,
	...
	var resource EfsMountTarget
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:EfsMountTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
