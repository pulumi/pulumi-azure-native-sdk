...
func NewApiGatewayStage(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:ApiGatewayStage"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApiGatewayStage
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:ApiGatewayStage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiGatewayStage(ctx *pulumi.Context,
	...
	var resource ApiGatewayStage
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:ApiGatewayStage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
