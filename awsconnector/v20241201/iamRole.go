...
func NewIamRole(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:IamRole"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource IamRole
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:IamRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIamRole(ctx *pulumi.Context,
	...
	var resource IamRole
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:IamRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
