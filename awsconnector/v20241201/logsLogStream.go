...
func NewLogsLogStream(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:LogsLogStream"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource LogsLogStream
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:LogsLogStream", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogsLogStream(ctx *pulumi.Context,
	...
	var resource LogsLogStream
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:LogsLogStream", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
