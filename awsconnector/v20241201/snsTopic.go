...
func NewSnsTopic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:SnsTopic"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SnsTopic
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:SnsTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnsTopic(ctx *pulumi.Context,
	...
	var resource SnsTopic
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:SnsTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
