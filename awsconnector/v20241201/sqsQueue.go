...
func NewSqsQueue(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:SqsQueue"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SqsQueue
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:SqsQueue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqsQueue(ctx *pulumi.Context,
	...
	var resource SqsQueue
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:SqsQueue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
