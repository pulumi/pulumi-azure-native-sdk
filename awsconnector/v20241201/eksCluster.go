...
func NewEksCluster(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:EksCluster"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EksCluster
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:EksCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEksCluster(ctx *pulumi.Context,
	...
	var resource EksCluster
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:EksCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
