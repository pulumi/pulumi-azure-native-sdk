...
func NewLightsailInstance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:LightsailInstance"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource LightsailInstance
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:LightsailInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLightsailInstance(ctx *pulumi.Context,
	...
	var resource LightsailInstance
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:LightsailInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
