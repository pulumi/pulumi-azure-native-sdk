...
func NewKmsKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:KmsKey"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource KmsKey
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:KmsKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKmsKey(ctx *pulumi.Context,
	...
	var resource KmsKey
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:KmsKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
