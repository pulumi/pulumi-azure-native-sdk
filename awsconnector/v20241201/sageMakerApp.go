...
func NewSageMakerApp(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:SageMakerApp"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SageMakerApp
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:SageMakerApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSageMakerApp(ctx *pulumi.Context,
	...
	var resource SageMakerApp
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:SageMakerApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
