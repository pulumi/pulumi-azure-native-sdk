...
func NewEc2Instance(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:Ec2Instance"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Ec2Instance
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:Ec2Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEc2Instance(ctx *pulumi.Context,
	...
	var resource Ec2Instance
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:Ec2Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
