...
func NewCloudFormationStack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:CloudFormationStack"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CloudFormationStack
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:CloudFormationStack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudFormationStack(ctx *pulumi.Context,
	...
	var resource CloudFormationStack
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:CloudFormationStack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
