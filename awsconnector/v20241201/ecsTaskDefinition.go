...
func NewEcsTaskDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector:EcsTaskDefinition"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EcsTaskDefinition
	err := ctx.RegisterResource("azure-native:awsconnector/v20241201:EcsTaskDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEcsTaskDefinition(ctx *pulumi.Context,
	...
	var resource EcsTaskDefinition
	err := ctx.ReadResource("azure-native:awsconnector/v20241201:EcsTaskDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
