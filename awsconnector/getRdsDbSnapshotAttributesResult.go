...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupRdsDbSnapshotAttributesResultResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupRdsDbSnapshotAttributesResultResult) commontypesv5.SystemDataResponse {
		return v.SystemData
