...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ApiGatewayStageOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ApiGatewayStage) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
