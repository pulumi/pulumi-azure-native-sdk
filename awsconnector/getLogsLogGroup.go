...
func LookupLogsLogGroupOutput(ctx *pulumi.Context, args LookupLogsLogGroupOutputArgs, opts ...pulumi.InvokeOption) LookupLogsLogGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLogsLogGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:awsconnector:getLogsLogGroup", args, LookupLogsLogGroupResultOutput{}, options).(LookupLogsLogGroupResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupLogsLogGroupResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLogsLogGroupResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupLogsLogGroupResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupLogsLogGroupResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
