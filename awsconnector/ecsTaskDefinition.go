...
// The Azure API version of the resource.
func (o EcsTaskDefinitionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *EcsTaskDefinition) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o EcsTaskDefinitionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *EcsTaskDefinition) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
