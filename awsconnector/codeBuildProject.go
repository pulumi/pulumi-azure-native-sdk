...
func NewCodeBuildProject(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector/v20241201:CodeBuildProject"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CodeBuildProject
	err := ctx.RegisterResource("azure-native:awsconnector:CodeBuildProject", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCodeBuildProject(ctx *pulumi.Context,
	...
	var resource CodeBuildProject
	err := ctx.ReadResource("azure-native:awsconnector:CodeBuildProject", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o CodeBuildProjectOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CodeBuildProject) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CodeBuildProjectOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *CodeBuildProject) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
