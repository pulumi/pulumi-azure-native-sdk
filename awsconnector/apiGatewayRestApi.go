...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ApiGatewayRestApiOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ApiGatewayRestApi) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
