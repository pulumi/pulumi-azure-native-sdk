...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SnsTopicOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *SnsTopic) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
