...
// The Azure API version of the resource.
func (o ConfigServiceConfigurationRecorderOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ConfigServiceConfigurationRecorder) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ConfigServiceConfigurationRecorderOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ConfigServiceConfigurationRecorder) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
