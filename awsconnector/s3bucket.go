...
// The Azure API version of the resource.
func (o S3BucketOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *S3Bucket) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o S3BucketOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *S3Bucket) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
