...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SqsQueueOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *SqsQueue) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
