...
func NewEc2NetworkAcl(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:awsconnector/v20241201:Ec2NetworkAcl"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Ec2NetworkAcl
	err := ctx.RegisterResource("azure-native:awsconnector:Ec2NetworkAcl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEc2NetworkAcl(ctx *pulumi.Context,
	...
	var resource Ec2NetworkAcl
	err := ctx.ReadResource("azure-native:awsconnector:Ec2NetworkAcl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o Ec2NetworkAclOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Ec2NetworkAcl) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o Ec2NetworkAclOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Ec2NetworkAcl) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
