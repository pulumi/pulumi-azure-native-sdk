...
func NewHierarchySetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:management/v20230401:HierarchySetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHierarchySetting(ctx *pulumi.Context,
	...
	var resource HierarchySetting
	err := ctx.ReadResource("azure-native:management/v20230401:HierarchySetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
