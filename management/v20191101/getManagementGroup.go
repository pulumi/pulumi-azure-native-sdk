...
// azure-native:management/v20191101:ManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:management/v20200201:ManagementGroup to guarantee forwards compatibility.
...
// The hierarchial path from the root group to the current group.
func (o LookupManagementGroupResultOutput) Path() ManagementGroupPathElementResponseArrayOutput {
	return o.ApplyT(func(v LookupManagementGroupResult) []ManagementGroupPathElementResponse { return v.Path }).(ManagementGroupPathElementResponseArrayOutput)
}
