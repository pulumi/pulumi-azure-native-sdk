...
func NewManagementGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:management/v20201001:ManagementGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroup(ctx *pulumi.Context,
	...
	var resource ManagementGroup
	err := ctx.ReadResource("azure-native:management/v20201001:ManagementGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
