...
func NewManagementGroupSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:management/v20201001:ManagementGroupSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroupSubscription(ctx *pulumi.Context,
	...
	var resource ManagementGroupSubscription
	err := ctx.ReadResource("azure-native:management/v20201001:ManagementGroupSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
