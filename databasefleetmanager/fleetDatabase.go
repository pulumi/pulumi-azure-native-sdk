...
func NewFleetDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:databasefleetmanager/v20250201preview:FleetDatabase"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource FleetDatabase
	err := ctx.RegisterResource("azure-native:databasefleetmanager:FleetDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleetDatabase(ctx *pulumi.Context,
	...
	var resource FleetDatabase
	err := ctx.ReadResource("azure-native:databasefleetmanager:FleetDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o FleetDatabaseOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *FleetDatabase) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o FleetDatabaseOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *FleetDatabase) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
