...
func NewFleetTier(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:databasefleetmanager:FleetTier"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource FleetTier
	err := ctx.RegisterResource("azure-native:databasefleetmanager/v20250201preview:FleetTier", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleetTier(ctx *pulumi.Context,
	...
	var resource FleetTier
	err := ctx.ReadResource("azure-native:databasefleetmanager/v20250201preview:FleetTier", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
