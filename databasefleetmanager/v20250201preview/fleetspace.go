...
func NewFleetspace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:databasefleetmanager:Fleetspace"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Fleetspace
	err := ctx.RegisterResource("azure-native:databasefleetmanager/v20250201preview:Fleetspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleetspace(ctx *pulumi.Context,
	...
	var resource Fleetspace
	err := ctx.ReadResource("azure-native:databasefleetmanager/v20250201preview:Fleetspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
