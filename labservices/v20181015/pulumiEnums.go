...
// AddRemoveInput is an input type that accepts values of the AddRemove enum
// A concrete instance of `AddRemoveInput` can be one of the following:
//
//	AddRemoveAdd
//	AddRemoveRemove
...
// ConfigurationStateInput is an input type that accepts values of the ConfigurationState enum
// A concrete instance of `ConfigurationStateInput` can be one of the following:
//
...
// LabUserAccessModeInput is an input type that accepts values of the LabUserAccessMode enum
// A concrete instance of `LabUserAccessModeInput` can be one of the following:
//
...
// ManagedLabVmSizeInput is an input type that accepts values of the ManagedLabVmSize enum
// A concrete instance of `ManagedLabVmSizeInput` can be one of the following:
//
