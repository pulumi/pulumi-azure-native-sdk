...
type ResourceOperationErrorResponse struct {
...
// Error details of the latest operation failure on this resource
type ResourceOperationErrorResponseOutput struct{ *pulumi.OutputState }

func (ResourceOperationErrorResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ResourceOperationErrorResponse)(nil)).Elem()
}

func (o ResourceOperationErrorResponseOutput) ToResourceOperationErrorResponseOutput() ResourceOperationErrorResponseOutput {
	return o
}

func (o ResourceOperationErrorResponseOutput) ToResourceOperationErrorResponseOutputWithContext(ctx context.Context) ResourceOperationErrorResponseOutput {
	return o
}

// The operation action that failed
func (o ResourceOperationErrorResponseOutput) Action() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourceOperationErrorResponse) *string { return v.Action }).(pulumi.StringPtrOutput)
}

// The code that corresponds to the type of operation failure
func (o ResourceOperationErrorResponseOutput) Code() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourceOperationErrorResponse) *string { return v.Code }).(pulumi.StringPtrOutput)
}

// The operation failure message
func (o ResourceOperationErrorResponseOutput) Message() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourceOperationErrorResponse) *string { return v.Message }).(pulumi.StringPtrOutput)
}

// The datetime of when the error occured
func (o ResourceOperationErrorResponseOutput) Timestamp() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ResourceOperationErrorResponse) *string { return v.Timestamp }).(pulumi.StringPtrOutput)
}
...
type VirtualMachineProfile struct {
	...
	Sku commontypesv2.Sku `pulumi:"sku"`
...
type VirtualMachineProfileArgs struct {
	...
	// The SKU for the lab. Defines the type of virtual machines used in the lab.
	Sku commontypesv2.SkuInput `pulumi:"sku"`
	// The initial quota alloted to each lab user. Must be a time span between 0 and 9999 hours.
...
// The SKU for the lab. Defines the type of virtual machines used in the lab.
func (o VirtualMachineProfileOutput) Sku() commontypesv2.SkuOutput {
	return o.ApplyT(func(v VirtualMachineProfile) commontypesv2.Sku { return v.Sku }).(commontypesv2.SkuOutput)
}
...
type VirtualMachineProfileResponse struct {
	...
	// The SKU for the lab. Defines the type of virtual machines used in the lab.
	Sku commontypesv2.SkuResponse `pulumi:"sku"`
	// The initial quota alloted to each lab user. Must be a time span between 0 and 9999 hours.
	UsageQuota string `pulumi:"usageQuota"`
	// Enabling this option will use the same password for all user VMs.
...
// The SKU for the lab. Defines the type of virtual machines used in the lab.
func (o VirtualMachineProfileResponseOutput) Sku() commontypesv2.SkuResponseOutput {
	return o.ApplyT(func(v VirtualMachineProfileResponse) commontypesv2.SkuResponse { return v.Sku }).(commontypesv2.SkuResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ResourceOperationErrorResponseOutput{})
