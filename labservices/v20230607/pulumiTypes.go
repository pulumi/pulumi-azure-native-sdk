...
func (o ResourceOperationErrorResponseOutput) ToOutput(ctx context.Context) pulumix.Output[ResourceOperationErrorResponse] {
	return pulumix.Output[ResourceOperationErrorResponse]{
		OutputState: o.OutputState,
	}
}
