...
func NewLabPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:labservices/v20230607:LabPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLabPlan(ctx *pulumi.Context,
	...
	var resource LabPlan
	err := ctx.ReadResource("azure-native:labservices/v20230607:LabPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
