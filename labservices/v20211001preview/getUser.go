...
//
// Deprecated: azure-native:labservices/v20211001preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:labservices/v20220801:User to guarantee forwards compatibility.
