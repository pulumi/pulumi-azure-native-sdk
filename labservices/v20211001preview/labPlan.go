...
func NewLabPlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:labservices/v20211001preview:LabPlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLabPlan(ctx *pulumi.Context,
	...
	var resource LabPlan
	err := ctx.ReadResource("azure-native:labservices/v20211001preview:LabPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
