...
func NewLab(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:labservices/v20230607:Lab"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Lab
	err := ctx.RegisterResource("azure-native:labservices/v20220801:Lab", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLab(ctx *pulumi.Context,
	...
	var resource Lab
	err := ctx.ReadResource("azure-native:labservices/v20220801:Lab", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
