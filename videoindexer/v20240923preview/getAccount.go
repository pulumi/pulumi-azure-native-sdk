...
func LookupAccount(ctx *pulumi.Context, args *LookupAccountArgs, opts ...pulumi.InvokeOption) (*LookupAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:videoindexer/v20240923preview:getAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupAccountResult struct {
	...
	OpenAiServices *OpenAiServicesForPutRequestResponse `pulumi:"openAiServices"`
	...
	TotalMinutesIndexed float64 `pulumi:"totalMinutesIndexed"`
...
func LookupAccountOutput(ctx *pulumi.Context, args LookupAccountOutputArgs, opts ...pulumi.InvokeOption) LookupAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:videoindexer/v20240923preview:getAccount", args, LookupAccountResultOutput{}, options).(LookupAccountResultOutput), nil
...
// The openAi services details
func (o LookupAccountResultOutput) OpenAiServices() OpenAiServicesForPutRequestResponsePtrOutput {
	return o.ApplyT(func(v LookupAccountResult) *OpenAiServicesForPutRequestResponse { return v.OpenAiServices }).(OpenAiServicesForPutRequestResponsePtrOutput)
}
...
// An integer representing the total minutes that have been indexed on the account
func (o LookupAccountResultOutput) TotalMinutesIndexed() pulumi.Float64Output {
	return o.ApplyT(func(v LookupAccountResult) float64 { return v.TotalMinutesIndexed }).(pulumi.Float64Output)
}
