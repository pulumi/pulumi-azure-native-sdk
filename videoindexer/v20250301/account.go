...
type Account struct {
	...
	TotalMinutesIndexed pulumi.Float64Output `pulumi:"totalMinutesIndexed"`
...
func NewAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:videoindexer/v20240601preview:Account"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:videoindexer/v20250301:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("azure-native:videoindexer/v20250301:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An integer representing the total minutes that have been indexed on the account
func (o AccountOutput) TotalMinutesIndexed() pulumi.Float64Output {
	return o.ApplyT(func(v *Account) pulumi.Float64Output { return v.TotalMinutesIndexed }).(pulumi.Float64Output)
}
