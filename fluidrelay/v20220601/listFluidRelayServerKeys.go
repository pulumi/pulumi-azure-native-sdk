...
func ListFluidRelayServerKeys(ctx *pulumi.Context, args *ListFluidRelayServerKeysArgs, opts ...pulumi.InvokeOption) (*ListFluidRelayServerKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:fluidrelay/v20220601:listFluidRelayServerKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListFluidRelayServerKeysOutput(ctx *pulumi.Context, args ListFluidRelayServerKeysOutputArgs, opts ...pulumi.InvokeOption) ListFluidRelayServerKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListFluidRelayServerKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:fluidrelay/v20220601:listFluidRelayServerKeys", args, ListFluidRelayServerKeysResultOutput{}, options).(ListFluidRelayServerKeysResultOutput), nil
