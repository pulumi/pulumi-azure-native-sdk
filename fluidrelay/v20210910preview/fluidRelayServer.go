...
func NewFluidRelayServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:fluidrelay/v20210910preview:FluidRelayServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFluidRelayServer(ctx *pulumi.Context,
	...
	var resource FluidRelayServer
	err := ctx.ReadResource("azure-native:fluidrelay/v20210910preview:FluidRelayServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
