...
// A FluidRelay Server.
//
// Deprecated: azure-native:fluidrelay/v20220215:FluidRelayServer is being removed in the next major version of this provider. Upgrade to at least azure-native:fluidrelay/v20220601:FluidRelayServer to guarantee forwards compatibility.
...
func NewFluidRelayServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:fluidrelay/v20220215:FluidRelayServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFluidRelayServer(ctx *pulumi.Context,
	...
	var resource FluidRelayServer
	err := ctx.ReadResource("azure-native:fluidrelay/v20220215:FluidRelayServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
