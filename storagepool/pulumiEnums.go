...
// IscsiTargetAclModeInput is an input type that accepts values of the IscsiTargetAclMode enum
// A concrete instance of `IscsiTargetAclModeInput` can be one of the following:
//
