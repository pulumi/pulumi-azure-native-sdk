...
func (o LookupManagedNetworkGroupResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupManagedNetworkGroupResult] {
	return pulumix.Output[LookupManagedNetworkGroupResult]{
