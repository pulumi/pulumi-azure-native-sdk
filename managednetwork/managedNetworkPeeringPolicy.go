...
// The Azure API version of the resource.
func (o ManagedNetworkPeeringPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagedNetworkPeeringPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
