...
func LookupGraphQuery(ctx *pulumi.Context, args *LookupGraphQueryArgs, opts ...pulumi.InvokeOption) (*LookupGraphQueryResult, error) {
	...
	err := ctx.Invoke("azure-native:resourcegraph/v20190401:getGraphQuery", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGraphQueryOutput(ctx *pulumi.Context, args LookupGraphQueryOutputArgs, opts ...pulumi.InvokeOption) LookupGraphQueryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGraphQueryResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:resourcegraph/v20190401:getGraphQuery", args, LookupGraphQueryResultOutput{}, options).(LookupGraphQueryResultOutput), nil
