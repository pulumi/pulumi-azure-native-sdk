...
func NewGraphQuery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resourcegraph/v20210301:GraphQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGraphQuery(ctx *pulumi.Context,
	...
	var resource GraphQuery
	err := ctx.ReadResource("azure-native:resourcegraph/v20210301:GraphQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
