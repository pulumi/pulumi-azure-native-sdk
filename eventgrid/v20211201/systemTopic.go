...
//
// Deprecated: azure-native:eventgrid/v20211201:SystemTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:SystemTopic to guarantee forwards compatibility.
...
func NewSystemTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20211201:SystemTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSystemTopic(ctx *pulumi.Context,
	...
	var resource SystemTopic
	err := ctx.ReadResource("azure-native:eventgrid/v20211201:SystemTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
