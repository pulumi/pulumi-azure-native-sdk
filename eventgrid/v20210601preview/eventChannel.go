...
func NewEventChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20210601preview:EventChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventChannel(ctx *pulumi.Context,
	...
	var resource EventChannel
	err := ctx.ReadResource("azure-native:eventgrid/v20210601preview:EventChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
