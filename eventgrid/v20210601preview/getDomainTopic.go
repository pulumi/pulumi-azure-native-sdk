...
//
// Deprecated: azure-native:eventgrid/v20210601preview:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.
