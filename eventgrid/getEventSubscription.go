...
func LookupEventSubscriptionOutput(ctx *pulumi.Context, args LookupEventSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupEventSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEventSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid:getEventSubscription", args, LookupEventSubscriptionResultOutput{}, options).(LookupEventSubscriptionResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupEventSubscriptionResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupEventSubscriptionResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata relating to the Event Grid resource.
func (o LookupEventSubscriptionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupEventSubscriptionResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
