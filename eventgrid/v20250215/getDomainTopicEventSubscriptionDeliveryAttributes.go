...
func GetDomainTopicEventSubscriptionDeliveryAttributes(ctx *pulumi.Context, args *GetDomainTopicEventSubscriptionDeliveryAttributesArgs, opts ...pulumi.InvokeOption) (*GetDomainTopicEventSubscriptionDeliveryAttributesResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20250215:getDomainTopicEventSubscriptionDeliveryAttributes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDomainTopicEventSubscriptionDeliveryAttributesOutput(ctx *pulumi.Context, args GetDomainTopicEventSubscriptionDeliveryAttributesOutputArgs, opts ...pulumi.InvokeOption) GetDomainTopicEventSubscriptionDeliveryAttributesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetDomainTopicEventSubscriptionDeliveryAttributesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20250215:getDomainTopicEventSubscriptionDeliveryAttributes", args, GetDomainTopicEventSubscriptionDeliveryAttributesResultOutput{}, options).(GetDomainTopicEventSubscriptionDeliveryAttributesResultOutput), nil
