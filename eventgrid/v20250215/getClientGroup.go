...
func LookupClientGroup(ctx *pulumi.Context, args *LookupClientGroupArgs, opts ...pulumi.InvokeOption) (*LookupClientGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20250215:getClientGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupClientGroupOutput(ctx *pulumi.Context, args LookupClientGroupOutputArgs, opts ...pulumi.InvokeOption) LookupClientGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupClientGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20250215:getClientGroup", args, LookupClientGroupResultOutput{}, options).(LookupClientGroupResultOutput), nil
