...
func GetNamespaceTopicEventSubscriptionFullUrl(ctx *pulumi.Context, args *GetNamespaceTopicEventSubscriptionFullUrlArgs, opts ...pulumi.InvokeOption) (*GetNamespaceTopicEventSubscriptionFullUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20250215:getNamespaceTopicEventSubscriptionFullUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetNamespaceTopicEventSubscriptionFullUrlOutput(ctx *pulumi.Context, args GetNamespaceTopicEventSubscriptionFullUrlOutputArgs, opts ...pulumi.InvokeOption) GetNamespaceTopicEventSubscriptionFullUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetNamespaceTopicEventSubscriptionFullUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20250215:getNamespaceTopicEventSubscriptionFullUrl", args, GetNamespaceTopicEventSubscriptionFullUrlResultOutput{}, options).(GetNamespaceTopicEventSubscriptionFullUrlResultOutput), nil
