...
func LookupTopicSpace(ctx *pulumi.Context, args *LookupTopicSpaceArgs, opts ...pulumi.InvokeOption) (*LookupTopicSpaceResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20250215:getTopicSpace", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTopicSpaceOutput(ctx *pulumi.Context, args LookupTopicSpaceOutputArgs, opts ...pulumi.InvokeOption) LookupTopicSpaceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTopicSpaceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20250215:getTopicSpace", args, LookupTopicSpaceResultOutput{}, options).(LookupTopicSpaceResultOutput), nil
