...
func NewCaCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20250215:CaCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCaCertificate(ctx *pulumi.Context,
	...
	var resource CaCertificate
	err := ctx.ReadResource("azure-native:eventgrid/v20250215:CaCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
