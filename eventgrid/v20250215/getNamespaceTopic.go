...
func LookupNamespaceTopic(ctx *pulumi.Context, args *LookupNamespaceTopicArgs, opts ...pulumi.InvokeOption) (*LookupNamespaceTopicResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20250215:getNamespaceTopic", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupNamespaceTopicOutput(ctx *pulumi.Context, args LookupNamespaceTopicOutputArgs, opts ...pulumi.InvokeOption) LookupNamespaceTopicResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNamespaceTopicResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20250215:getNamespaceTopic", args, LookupNamespaceTopicResultOutput{}, options).(LookupNamespaceTopicResultOutput), nil
