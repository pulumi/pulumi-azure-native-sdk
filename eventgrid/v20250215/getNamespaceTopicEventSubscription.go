...
func LookupNamespaceTopicEventSubscription(ctx *pulumi.Context, args *LookupNamespaceTopicEventSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupNamespaceTopicEventSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20250215:getNamespaceTopicEventSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupNamespaceTopicEventSubscriptionOutput(ctx *pulumi.Context, args LookupNamespaceTopicEventSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupNamespaceTopicEventSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNamespaceTopicEventSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20250215:getNamespaceTopicEventSubscription", args, LookupNamespaceTopicEventSubscriptionResultOutput{}, options).(LookupNamespaceTopicEventSubscriptionResultOutput), nil
