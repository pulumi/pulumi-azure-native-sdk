...
func ListDomainSharedAccessKeys(ctx *pulumi.Context, args *ListDomainSharedAccessKeysArgs, opts ...pulumi.InvokeOption) (*ListDomainSharedAccessKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20250215:listDomainSharedAccessKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListDomainSharedAccessKeysOutput(ctx *pulumi.Context, args ListDomainSharedAccessKeysOutputArgs, opts ...pulumi.InvokeOption) ListDomainSharedAccessKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListDomainSharedAccessKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20250215:listDomainSharedAccessKeys", args, ListDomainSharedAccessKeysResultOutput{}, options).(ListDomainSharedAccessKeysResultOutput), nil
