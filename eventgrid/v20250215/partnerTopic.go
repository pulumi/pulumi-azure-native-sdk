...
func NewPartnerTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20250215:PartnerTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerTopic(ctx *pulumi.Context,
	...
	var resource PartnerTopic
	err := ctx.ReadResource("azure-native:eventgrid/v20250215:PartnerTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
