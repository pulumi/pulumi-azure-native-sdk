...
func NewNamespaceTopicEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource NamespaceTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
