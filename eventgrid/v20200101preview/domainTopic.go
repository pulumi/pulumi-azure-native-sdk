...
// azure-native:eventgrid/v20200101preview:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.
...
func NewDomainTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20200101preview:DomainTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainTopic(ctx *pulumi.Context,
	...
	var resource DomainTopic
	err := ctx.ReadResource("azure-native:eventgrid/v20200101preview:DomainTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Provisioning state of the domain topic.
func (o DomainTopicOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DomainTopic) pulumi.StringPtrOutput { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
