...
func ListNamespaceSharedAccessKeys(ctx *pulumi.Context, args *ListNamespaceSharedAccessKeysArgs, opts ...pulumi.InvokeOption) (*ListNamespaceSharedAccessKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20241215preview:listNamespaceSharedAccessKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListNamespaceSharedAccessKeysOutput(ctx *pulumi.Context, args ListNamespaceSharedAccessKeysOutputArgs, opts ...pulumi.InvokeOption) ListNamespaceSharedAccessKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListNamespaceSharedAccessKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20241215preview:listNamespaceSharedAccessKeys", args, ListNamespaceSharedAccessKeysResultOutput{}, options).(ListNamespaceSharedAccessKeysResultOutput), nil
