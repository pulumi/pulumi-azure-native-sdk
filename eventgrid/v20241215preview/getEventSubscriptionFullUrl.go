...
func GetEventSubscriptionFullUrl(ctx *pulumi.Context, args *GetEventSubscriptionFullUrlArgs, opts ...pulumi.InvokeOption) (*GetEventSubscriptionFullUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20241215preview:getEventSubscriptionFullUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEventSubscriptionFullUrlOutput(ctx *pulumi.Context, args GetEventSubscriptionFullUrlOutputArgs, opts ...pulumi.InvokeOption) GetEventSubscriptionFullUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetEventSubscriptionFullUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20241215preview:getEventSubscriptionFullUrl", args, GetEventSubscriptionFullUrlResultOutput{}, options).(GetEventSubscriptionFullUrlResultOutput), nil
