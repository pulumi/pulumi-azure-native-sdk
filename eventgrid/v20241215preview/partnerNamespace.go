...
func NewPartnerNamespace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20231215preview:PartnerNamespace"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:PartnerNamespace"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20241215preview:PartnerNamespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerNamespace(ctx *pulumi.Context,
	...
	var resource PartnerNamespace
	err := ctx.ReadResource("azure-native:eventgrid/v20241215preview:PartnerNamespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
