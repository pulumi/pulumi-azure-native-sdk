...
func GetTopicEventSubscriptionDeliveryAttributes(ctx *pulumi.Context, args *GetTopicEventSubscriptionDeliveryAttributesArgs, opts ...pulumi.InvokeOption) (*GetTopicEventSubscriptionDeliveryAttributesResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20241215preview:getTopicEventSubscriptionDeliveryAttributes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetTopicEventSubscriptionDeliveryAttributesOutput(ctx *pulumi.Context, args GetTopicEventSubscriptionDeliveryAttributesOutputArgs, opts ...pulumi.InvokeOption) GetTopicEventSubscriptionDeliveryAttributesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetTopicEventSubscriptionDeliveryAttributesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20241215preview:getTopicEventSubscriptionDeliveryAttributes", args, GetTopicEventSubscriptionDeliveryAttributesResultOutput{}, options).(GetTopicEventSubscriptionDeliveryAttributesResultOutput), nil
