...
func NewClientGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20241215preview:ClientGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClientGroup(ctx *pulumi.Context,
	...
	var resource ClientGroup
	err := ctx.ReadResource("azure-native:eventgrid/v20241215preview:ClientGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
