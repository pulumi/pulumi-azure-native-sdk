...
func NewDomainTopicEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource DomainTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
