...
func NewTopicEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20241215preview:TopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource TopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20241215preview:TopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
