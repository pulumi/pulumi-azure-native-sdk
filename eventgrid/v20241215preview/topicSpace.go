...
func NewTopicSpace(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:TopicSpace"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TopicSpace
	err := ctx.RegisterResource("azure-native:eventgrid/v20241215preview:TopicSpace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicSpace(ctx *pulumi.Context,
	...
	var resource TopicSpace
	err := ctx.ReadResource("azure-native:eventgrid/v20241215preview:TopicSpace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
