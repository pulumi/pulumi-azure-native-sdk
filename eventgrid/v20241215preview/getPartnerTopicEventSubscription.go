...
func LookupPartnerTopicEventSubscription(ctx *pulumi.Context, args *LookupPartnerTopicEventSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupPartnerTopicEventSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20241215preview:getPartnerTopicEventSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupPartnerTopicEventSubscriptionOutput(ctx *pulumi.Context, args LookupPartnerTopicEventSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupPartnerTopicEventSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPartnerTopicEventSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20241215preview:getPartnerTopicEventSubscription", args, LookupPartnerTopicEventSubscriptionResultOutput{}, options).(LookupPartnerTopicEventSubscriptionResultOutput), nil
