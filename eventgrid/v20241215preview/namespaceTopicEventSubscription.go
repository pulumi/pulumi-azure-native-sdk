...
func NewNamespaceTopicEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource NamespaceTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Tags relating to Event Subscription resource.
func (o NamespaceTopicEventSubscriptionOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *NamespaceTopicEventSubscription) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
