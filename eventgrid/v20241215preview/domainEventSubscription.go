...
func NewDomainEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20241215preview:DomainEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainEventSubscription(ctx *pulumi.Context,
	...
	var resource DomainEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20241215preview:DomainEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
