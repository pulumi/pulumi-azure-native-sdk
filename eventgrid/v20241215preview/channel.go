...
func NewChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20241215preview:Channel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetChannel(ctx *pulumi.Context,
	...
	var resource Channel
	err := ctx.ReadResource("azure-native:eventgrid/v20241215preview:Channel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
