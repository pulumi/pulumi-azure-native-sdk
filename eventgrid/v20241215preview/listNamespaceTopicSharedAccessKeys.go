...
func ListNamespaceTopicSharedAccessKeys(ctx *pulumi.Context, args *ListNamespaceTopicSharedAccessKeysArgs, opts ...pulumi.InvokeOption) (*ListNamespaceTopicSharedAccessKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20241215preview:listNamespaceTopicSharedAccessKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListNamespaceTopicSharedAccessKeysOutput(ctx *pulumi.Context, args ListNamespaceTopicSharedAccessKeysOutputArgs, opts ...pulumi.InvokeOption) ListNamespaceTopicSharedAccessKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListNamespaceTopicSharedAccessKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20241215preview:listNamespaceTopicSharedAccessKeys", args, ListNamespaceTopicSharedAccessKeysResultOutput{}, options).(ListNamespaceTopicSharedAccessKeysResultOutput), nil
