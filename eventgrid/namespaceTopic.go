...
func NewNamespaceTopic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:NamespaceTopic"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:NamespaceTopic"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NamespaceTopic
	err := ctx.RegisterResource("azure-native:eventgrid:NamespaceTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceTopic(ctx *pulumi.Context,
	...
	var resource NamespaceTopic
	err := ctx.ReadResource("azure-native:eventgrid:NamespaceTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The system metadata relating to the Event Grid resource.
func (o NamespaceTopicOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NamespaceTopic) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
