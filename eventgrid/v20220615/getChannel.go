...
func LookupChannel(ctx *pulumi.Context, args *LookupChannelArgs, opts ...pulumi.InvokeOption) (*LookupChannelResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20220615:getChannel", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupChannelOutput(ctx *pulumi.Context, args LookupChannelOutputArgs, opts ...pulumi.InvokeOption) LookupChannelResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupChannelResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20220615:getChannel", args, LookupChannelResultOutput{}, options).(LookupChannelResultOutput), nil
