...
func LookupSystemTopicEventSubscription(ctx *pulumi.Context, args *LookupSystemTopicEventSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupSystemTopicEventSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20220615:getSystemTopicEventSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupSystemTopicEventSubscriptionOutput(ctx *pulumi.Context, args LookupSystemTopicEventSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupSystemTopicEventSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSystemTopicEventSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20220615:getSystemTopicEventSubscription", args, LookupSystemTopicEventSubscriptionResultOutput{}, options).(LookupSystemTopicEventSubscriptionResultOutput), nil
