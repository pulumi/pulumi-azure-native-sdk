...
func NewDomainEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:DomainEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20241215preview:DomainEventSubscription"),
		},
		{
