...
func NewDomainEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20231215preview:DomainEventSubscription"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DomainEventSubscription
	err := ctx.RegisterResource("azure-native:eventgrid/v20220615:DomainEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainEventSubscription(ctx *pulumi.Context,
	...
	var resource DomainEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20220615:DomainEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *DomainEventSubscription) ToOutput(ctx context.Context) pulumix.Output[*DomainEventSubscription] {
	return pulumix.Output[*DomainEventSubscription]{
		OutputState: i.ToDomainEventSubscriptionOutputWithContext(ctx).OutputState,
	}
}
...
func (o DomainEventSubscriptionOutput) ToOutput(ctx context.Context) pulumix.Output[*DomainEventSubscription] {
	return pulumix.Output[*DomainEventSubscription]{
