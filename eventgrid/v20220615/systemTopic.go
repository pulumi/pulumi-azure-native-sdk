...
func NewSystemTopic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20231215preview:SystemTopic"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:SystemTopic"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SystemTopic
	err := ctx.RegisterResource("azure-native:eventgrid/v20220615:SystemTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSystemTopic(ctx *pulumi.Context,
	...
	var resource SystemTopic
	err := ctx.ReadResource("azure-native:eventgrid/v20220615:SystemTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
