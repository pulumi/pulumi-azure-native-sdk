...
func NewPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20220615:PartnerTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource PartnerTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20220615:PartnerTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *PartnerTopicEventSubscription) ToOutput(ctx context.Context) pulumix.Output[*PartnerTopicEventSubscription] {
	return pulumix.Output[*PartnerTopicEventSubscription]{
		OutputState: i.ToPartnerTopicEventSubscriptionOutputWithContext(ctx).OutputState,
	}
}
...
func (o PartnerTopicEventSubscriptionOutput) ToOutput(ctx context.Context) pulumix.Output[*PartnerTopicEventSubscription] {
	return pulumix.Output[*PartnerTopicEventSubscription]{
