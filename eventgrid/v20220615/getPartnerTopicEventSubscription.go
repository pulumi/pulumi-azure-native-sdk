...
func LookupPartnerTopicEventSubscription(ctx *pulumi.Context, args *LookupPartnerTopicEventSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupPartnerTopicEventSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20220615:getPartnerTopicEventSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func (o LookupPartnerTopicEventSubscriptionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupPartnerTopicEventSubscriptionResult] {
	return pulumix.Output[LookupPartnerTopicEventSubscriptionResult]{
