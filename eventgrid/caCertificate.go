...
func NewCaCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:CaCertificate"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CaCertificate
	err := ctx.RegisterResource("azure-native:eventgrid:CaCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCaCertificate(ctx *pulumi.Context,
	...
	var resource CaCertificate
	err := ctx.ReadResource("azure-native:eventgrid:CaCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
