...
func NewDomainTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20231215preview:DomainTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:DomainTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250215:DomainTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:DomainTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:DomainTopicEventSubscription"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DomainTopicEventSubscription
	err := ctx.RegisterResource("azure-native:eventgrid:DomainTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource DomainTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid:DomainTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DomainTopicEventSubscriptionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DomainTopicEventSubscription) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata relating to the Event Grid resource.
func (o DomainTopicEventSubscriptionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DomainTopicEventSubscription) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
