...
func NewDomainTopic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:DomainTopic"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:DomainTopic"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:DomainTopic"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DomainTopic
	err := ctx.RegisterResource("azure-native:eventgrid:DomainTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainTopic(ctx *pulumi.Context,
	...
	var resource DomainTopic
	err := ctx.ReadResource("azure-native:eventgrid:DomainTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The system metadata relating to the Event Grid resource.
func (o DomainTopicOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *DomainTopic) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
