...
func NewPartnerTopic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20241215preview:PartnerTopic"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20231215preview:PartnerTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerTopic(ctx *pulumi.Context,
	...
	var resource PartnerTopic
	err := ctx.ReadResource("azure-native:eventgrid/v20231215preview:PartnerTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
