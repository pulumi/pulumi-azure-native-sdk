...
func GetEventSubscriptionFullUrl(ctx *pulumi.Context, args *GetEventSubscriptionFullUrlArgs, opts ...pulumi.InvokeOption) (*GetEventSubscriptionFullUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20231215preview:getEventSubscriptionFullUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o GetEventSubscriptionFullUrlResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetEventSubscriptionFullUrlResult] {
	return pulumix.Output[GetEventSubscriptionFullUrlResult]{
