...
func NewPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20231215preview:PartnerTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource PartnerTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20231215preview:PartnerTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
