...
func NewClient(ctx *pulumi.Context,
	...
	var resource Client
	err := ctx.RegisterResource("azure-native:eventgrid/v20231215preview:Client", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClient(ctx *pulumi.Context,
	...
	var resource Client
	err := ctx.ReadResource("azure-native:eventgrid/v20231215preview:Client", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
