...
func NewDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:Domain"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20241215preview:Domain"),
		},
		{
	...
	var resource Domain
	err := ctx.RegisterResource("azure-native:eventgrid/v20231215preview:Domain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.ReadResource("azure-native:eventgrid/v20231215preview:Domain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Sku pricing tier for the Event Grid Domain resource.
func (o DomainOutput) Sku() ResourceSkuResponsePtrOutput {
	return o.ApplyT(func(v *Domain) ResourceSkuResponsePtrOutput { return v.Sku }).(ResourceSkuResponsePtrOutput)
}
