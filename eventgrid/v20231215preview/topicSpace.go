...
func NewTopicSpace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20231215preview:TopicSpace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicSpace(ctx *pulumi.Context,
	...
	var resource TopicSpace
	err := ctx.ReadResource("azure-native:eventgrid/v20231215preview:TopicSpace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
