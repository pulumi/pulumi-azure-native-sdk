...
func NewSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:SystemTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20241215preview:SystemTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250215:SystemTopicEventSubscription"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20231215preview:SystemTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource SystemTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20231215preview:SystemTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
