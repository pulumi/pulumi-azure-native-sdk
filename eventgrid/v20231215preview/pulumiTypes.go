...
func (i PushInfoArgs) ToOutput(ctx context.Context) pulumix.Output[PushInfo] {
	return pulumix.Output[PushInfo]{
		OutputState: i.ToPushInfoOutputWithContext(ctx).OutputState,
	}
}
...
func (i *pushInfoPtrType) ToOutput(ctx context.Context) pulumix.Output[*PushInfo] {
	return pulumix.Output[*PushInfo]{
		OutputState: i.ToPushInfoPtrOutputWithContext(ctx).OutputState,
	}
}
...
func (o PushInfoOutput) ToOutput(ctx context.Context) pulumix.Output[PushInfo] {
	return pulumix.Output[PushInfo]{
		OutputState: o.OutputState,
	}
}
...
func (o PushInfoPtrOutput) ToOutput(ctx context.Context) pulumix.Output[*PushInfo] {
	return pulumix.Output[*PushInfo]{
		OutputState: o.OutputState,
	}
}
...
func (o PushInfoResponseOutput) ToOutput(ctx context.Context) pulumix.Output[PushInfoResponse] {
	return pulumix.Output[PushInfoResponse]{
		OutputState: o.OutputState,
	}
}
...
func (o PushInfoResponsePtrOutput) ToOutput(ctx context.Context) pulumix.Output[*PushInfoResponse] {
	return pulumix.Output[*PushInfoResponse]{
		OutputState: o.OutputState,
	}
}
