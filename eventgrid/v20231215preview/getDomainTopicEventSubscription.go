...
func LookupDomainTopicEventSubscription(ctx *pulumi.Context, args *LookupDomainTopicEventSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupDomainTopicEventSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20231215preview:getDomainTopicEventSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDomainTopicEventSubscriptionOutput(ctx *pulumi.Context, args LookupDomainTopicEventSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupDomainTopicEventSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDomainTopicEventSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20231215preview:getDomainTopicEventSubscription", args, LookupDomainTopicEventSubscriptionResultOutput{}, options).(LookupDomainTopicEventSubscriptionResultOutput), nil
