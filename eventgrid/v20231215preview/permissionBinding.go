...
func NewPermissionBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20231215preview:PermissionBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPermissionBinding(ctx *pulumi.Context,
	...
	var resource PermissionBinding
	err := ctx.ReadResource("azure-native:eventgrid/v20231215preview:PermissionBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
