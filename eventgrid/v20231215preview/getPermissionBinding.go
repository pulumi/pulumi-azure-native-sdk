...
func LookupPermissionBinding(ctx *pulumi.Context, args *LookupPermissionBindingArgs, opts ...pulumi.InvokeOption) (*LookupPermissionBindingResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20231215preview:getPermissionBinding", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPermissionBindingOutput(ctx *pulumi.Context, args LookupPermissionBindingOutputArgs, opts ...pulumi.InvokeOption) LookupPermissionBindingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPermissionBindingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20231215preview:getPermissionBinding", args, LookupPermissionBindingResultOutput{}, options).(LookupPermissionBindingResultOutput), nil
