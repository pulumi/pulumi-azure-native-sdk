...
func NewPartnerTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:PartnerTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:PartnerTopicEventSubscription"),
		},
	})
...
// The Azure API version of the resource.
func (o PartnerTopicEventSubscriptionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PartnerTopicEventSubscription) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata relating to the Event Grid resource.
func (o PartnerTopicEventSubscriptionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PartnerTopicEventSubscription) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
