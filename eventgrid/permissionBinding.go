...
func NewPermissionBinding(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:PermissionBinding"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:PermissionBinding"),
		},
	})
