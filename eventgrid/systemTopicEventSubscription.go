...
func NewSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:SystemTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:SystemTopicEventSubscription"),
		},
	})
...
// The Azure API version of the resource.
func (o SystemTopicEventSubscriptionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SystemTopicEventSubscription) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata relating to the Event Grid resource.
func (o SystemTopicEventSubscriptionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *SystemTopicEventSubscription) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
