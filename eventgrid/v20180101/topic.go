...
// azure-native:eventgrid/v20180101:Topic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20200401preview:Topic to guarantee forwards compatibility.
type Topic struct {
...
func NewTopic(ctx *pulumi.Context,
	...
	var resource Topic
	err := ctx.RegisterResource("azure-native:eventgrid/v20180101:Topic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopic(ctx *pulumi.Context,
	...
	var resource Topic
	err := ctx.ReadResource("azure-native:eventgrid/v20180101:Topic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
