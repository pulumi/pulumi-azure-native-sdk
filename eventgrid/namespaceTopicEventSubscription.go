...
func NewNamespaceTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:NamespaceTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:NamespaceTopicEventSubscription"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource NamespaceTopicEventSubscription
	err := ctx.RegisterResource("azure-native:eventgrid:NamespaceTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource NamespaceTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid:NamespaceTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The system metadata relating to the Event Grid resource.
func (o NamespaceTopicEventSubscriptionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *NamespaceTopicEventSubscription) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
