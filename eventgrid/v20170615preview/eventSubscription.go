...
func NewEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20170615preview:EventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventSubscription(ctx *pulumi.Context,
	...
	var resource EventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20170615preview:EventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Information about the destination where events have to be delivered for the event subscription.
func (o EventSubscriptionOutput) Destination() EventSubscriptionDestinationResponsePtrOutput {
	return o.ApplyT(func(v *EventSubscription) EventSubscriptionDestinationResponsePtrOutput { return v.Destination }).(EventSubscriptionDestinationResponsePtrOutput)
}
