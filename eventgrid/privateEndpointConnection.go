...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:PrivateEndpointConnection"),
		},
	})
