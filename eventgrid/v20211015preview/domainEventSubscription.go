...
// Event Subscription
//
// Deprecated: azure-native:eventgrid/v20211015preview:DomainEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainEventSubscription to guarantee forwards compatibility.
...
func NewDomainEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20211015preview:DomainEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainEventSubscription(ctx *pulumi.Context,
	...
	var resource DomainEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20211015preview:DomainEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
