...
// Domain Topic.
//
// Deprecated: azure-native:eventgrid/v20211015preview:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.
...
func NewDomainTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20211015preview:DomainTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainTopic(ctx *pulumi.Context,
	...
	var resource DomainTopic
	err := ctx.ReadResource("azure-native:eventgrid/v20211015preview:DomainTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
