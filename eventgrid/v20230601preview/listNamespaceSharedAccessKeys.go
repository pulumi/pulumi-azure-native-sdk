...
func (o ListNamespaceSharedAccessKeysResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListNamespaceSharedAccessKeysResult] {
	return pulumix.Output[ListNamespaceSharedAccessKeysResult]{
