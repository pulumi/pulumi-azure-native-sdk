...
func GetChannelFullUrl(ctx *pulumi.Context, args *GetChannelFullUrlArgs, opts ...pulumi.InvokeOption) (*GetChannelFullUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20230601preview:getChannelFullUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetChannelFullUrlOutput(ctx *pulumi.Context, args GetChannelFullUrlOutputArgs, opts ...pulumi.InvokeOption) GetChannelFullUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetChannelFullUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20230601preview:getChannelFullUrl", args, GetChannelFullUrlResultOutput{}, options).(GetChannelFullUrlResultOutput), nil
