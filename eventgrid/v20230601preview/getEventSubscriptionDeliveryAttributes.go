...
func GetEventSubscriptionDeliveryAttributes(ctx *pulumi.Context, args *GetEventSubscriptionDeliveryAttributesArgs, opts ...pulumi.InvokeOption) (*GetEventSubscriptionDeliveryAttributesResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20230601preview:getEventSubscriptionDeliveryAttributes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEventSubscriptionDeliveryAttributesOutput(ctx *pulumi.Context, args GetEventSubscriptionDeliveryAttributesOutputArgs, opts ...pulumi.InvokeOption) GetEventSubscriptionDeliveryAttributesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetEventSubscriptionDeliveryAttributesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20230601preview:getEventSubscriptionDeliveryAttributes", args, GetEventSubscriptionDeliveryAttributesResultOutput{}, options).(GetEventSubscriptionDeliveryAttributesResultOutput), nil
