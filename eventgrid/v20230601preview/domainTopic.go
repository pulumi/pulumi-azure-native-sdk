...
func NewDomainTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20230601preview:DomainTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainTopic(ctx *pulumi.Context,
	...
	var resource DomainTopic
	err := ctx.ReadResource("azure-native:eventgrid/v20230601preview:DomainTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
