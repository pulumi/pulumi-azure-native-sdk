...
func LookupPartnerTopic(ctx *pulumi.Context, args *LookupPartnerTopicArgs, opts ...pulumi.InvokeOption) (*LookupPartnerTopicResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20230601preview:getPartnerTopic", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPartnerTopicOutput(ctx *pulumi.Context, args LookupPartnerTopicOutputArgs, opts ...pulumi.InvokeOption) LookupPartnerTopicResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPartnerTopicResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20230601preview:getPartnerTopic", args, LookupPartnerTopicResultOutput{}, options).(LookupPartnerTopicResultOutput), nil
