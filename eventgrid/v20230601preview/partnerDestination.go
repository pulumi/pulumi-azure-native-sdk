...
func NewPartnerDestination(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20231215preview:PartnerDestination"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20230601preview:PartnerDestination", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerDestination(ctx *pulumi.Context,
	...
	var resource PartnerDestination
	err := ctx.ReadResource("azure-native:eventgrid/v20230601preview:PartnerDestination", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
