...
func NewSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20230601preview:SystemTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSystemTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource SystemTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20230601preview:SystemTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
