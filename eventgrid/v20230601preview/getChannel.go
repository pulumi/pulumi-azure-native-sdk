...
func LookupChannel(ctx *pulumi.Context, args *LookupChannelArgs, opts ...pulumi.InvokeOption) (*LookupChannelResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20230601preview:getChannel", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupChannelOutput(ctx *pulumi.Context, args LookupChannelOutputArgs, opts ...pulumi.InvokeOption) LookupChannelResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupChannelResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20230601preview:getChannel", args, LookupChannelResultOutput{}, options).(LookupChannelResultOutput), nil
