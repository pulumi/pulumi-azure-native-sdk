...
func NewNamespaceTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20240601preview:NamespaceTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20230601preview:NamespaceTopicEventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceTopicEventSubscription(ctx *pulumi.Context,
	...
	var resource NamespaceTopicEventSubscription
	err := ctx.ReadResource("azure-native:eventgrid/v20230601preview:NamespaceTopicEventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
