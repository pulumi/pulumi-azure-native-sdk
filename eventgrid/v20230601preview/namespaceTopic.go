...
func NewNamespaceTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20230601preview:NamespaceTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceTopic(ctx *pulumi.Context,
	...
	var resource NamespaceTopic
	err := ctx.ReadResource("azure-native:eventgrid/v20230601preview:NamespaceTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
