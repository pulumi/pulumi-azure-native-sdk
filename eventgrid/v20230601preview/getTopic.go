...
func LookupTopic(ctx *pulumi.Context, args *LookupTopicArgs, opts ...pulumi.InvokeOption) (*LookupTopicResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20230601preview:getTopic", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupTopicOutput(ctx *pulumi.Context, args LookupTopicOutputArgs, opts ...pulumi.InvokeOption) LookupTopicResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTopicResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20230601preview:getTopic", args, LookupTopicResultOutput{}, options).(LookupTopicResultOutput), nil
