...
func (o GetPartnerTopicEventSubscriptionFullUrlResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetPartnerTopicEventSubscriptionFullUrlResult] {
	return pulumix.Output[GetPartnerTopicEventSubscriptionFullUrlResult]{
