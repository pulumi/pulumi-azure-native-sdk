...
func GetPartnerTopicEventSubscriptionFullUrl(ctx *pulumi.Context, args *GetPartnerTopicEventSubscriptionFullUrlArgs, opts ...pulumi.InvokeOption) (*GetPartnerTopicEventSubscriptionFullUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20230601preview:getPartnerTopicEventSubscriptionFullUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetPartnerTopicEventSubscriptionFullUrlOutput(ctx *pulumi.Context, args GetPartnerTopicEventSubscriptionFullUrlOutputArgs, opts ...pulumi.InvokeOption) GetPartnerTopicEventSubscriptionFullUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetPartnerTopicEventSubscriptionFullUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20230601preview:getPartnerTopicEventSubscriptionFullUrl", args, GetPartnerTopicEventSubscriptionFullUrlResultOutput{}, options).(GetPartnerTopicEventSubscriptionFullUrlResultOutput), nil
