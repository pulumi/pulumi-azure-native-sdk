...
func NewPartnerNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20230601preview:PartnerNamespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerNamespace(ctx *pulumi.Context,
	...
	var resource PartnerNamespace
	err := ctx.ReadResource("azure-native:eventgrid/v20230601preview:PartnerNamespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
