...
func NewPartnerRegistration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250215:PartnerRegistration"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:PartnerRegistration"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:PartnerRegistration"),
		},
	})
...
// The Azure API version of the resource.
func (o PartnerRegistrationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PartnerRegistration) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata relating to the Event Grid resource.
func (o PartnerRegistrationOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PartnerRegistration) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
