...
func NewClient(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:eventgrid/v20230601preview:Client"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:Client"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Client
	err := ctx.RegisterResource("azure-native:eventgrid:Client", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClient(ctx *pulumi.Context,
	...
	var resource Client
	err := ctx.ReadResource("azure-native:eventgrid:Client", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The system metadata relating to the Event Grid resource.
func (o ClientOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Client) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
