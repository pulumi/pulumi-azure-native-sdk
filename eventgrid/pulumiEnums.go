...
func (in *staticRoutingEnrichmentTypePtr) ToOutput(ctx context.Context) pulumix.Output[*StaticRoutingEnrichmentType] {
	return pulumix.Output[*StaticRoutingEnrichmentType]{
		OutputState: in.ToStaticRoutingEnrichmentTypePtrOutputWithContext(ctx).OutputState,
	}
}
