...
func LookupDomainEventSubscriptionOutput(ctx *pulumi.Context, args LookupDomainEventSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupDomainEventSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDomainEventSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid:getDomainEventSubscription", args, LookupDomainEventSubscriptionResultOutput{}, options).(LookupDomainEventSubscriptionResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDomainEventSubscriptionResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDomainEventSubscriptionResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata relating to the Event Grid resource.
func (o LookupDomainEventSubscriptionResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDomainEventSubscriptionResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
