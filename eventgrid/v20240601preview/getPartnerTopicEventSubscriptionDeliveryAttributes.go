...
func GetPartnerTopicEventSubscriptionDeliveryAttributes(ctx *pulumi.Context, args *GetPartnerTopicEventSubscriptionDeliveryAttributesArgs, opts ...pulumi.InvokeOption) (*GetPartnerTopicEventSubscriptionDeliveryAttributesResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20240601preview:getPartnerTopicEventSubscriptionDeliveryAttributes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetPartnerTopicEventSubscriptionDeliveryAttributesOutput(ctx *pulumi.Context, args GetPartnerTopicEventSubscriptionDeliveryAttributesOutputArgs, opts ...pulumi.InvokeOption) GetPartnerTopicEventSubscriptionDeliveryAttributesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetPartnerTopicEventSubscriptionDeliveryAttributesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20240601preview:getPartnerTopicEventSubscriptionDeliveryAttributes", args, GetPartnerTopicEventSubscriptionDeliveryAttributesResultOutput{}, options).(GetPartnerTopicEventSubscriptionDeliveryAttributesResultOutput), nil
