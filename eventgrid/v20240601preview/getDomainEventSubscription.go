...
func LookupDomainEventSubscription(ctx *pulumi.Context, args *LookupDomainEventSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupDomainEventSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20240601preview:getDomainEventSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDomainEventSubscriptionOutput(ctx *pulumi.Context, args LookupDomainEventSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupDomainEventSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDomainEventSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20240601preview:getDomainEventSubscription", args, LookupDomainEventSubscriptionResultOutput{}, options).(LookupDomainEventSubscriptionResultOutput), nil
