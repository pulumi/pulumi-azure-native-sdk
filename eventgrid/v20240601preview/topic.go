...
func NewTopic(ctx *pulumi.Context,
	...
	var resource Topic
	err := ctx.RegisterResource("azure-native:eventgrid/v20240601preview:Topic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopic(ctx *pulumi.Context,
	...
	var resource Topic
	err := ctx.ReadResource("azure-native:eventgrid/v20240601preview:Topic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
