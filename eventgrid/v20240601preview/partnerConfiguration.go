...
func NewPartnerConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20240601preview:PartnerConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerConfiguration(ctx *pulumi.Context,
	...
	var resource PartnerConfiguration
	err := ctx.ReadResource("azure-native:eventgrid/v20240601preview:PartnerConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
