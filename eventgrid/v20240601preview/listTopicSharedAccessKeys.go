...
func ListTopicSharedAccessKeys(ctx *pulumi.Context, args *ListTopicSharedAccessKeysArgs, opts ...pulumi.InvokeOption) (*ListTopicSharedAccessKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20240601preview:listTopicSharedAccessKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListTopicSharedAccessKeysOutput(ctx *pulumi.Context, args ListTopicSharedAccessKeysOutputArgs, opts ...pulumi.InvokeOption) ListTopicSharedAccessKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListTopicSharedAccessKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20240601preview:listTopicSharedAccessKeys", args, ListTopicSharedAccessKeysResultOutput{}, options).(ListTopicSharedAccessKeysResultOutput), nil
