...
func GetDomainTopicEventSubscriptionFullUrl(ctx *pulumi.Context, args *GetDomainTopicEventSubscriptionFullUrlArgs, opts ...pulumi.InvokeOption) (*GetDomainTopicEventSubscriptionFullUrlResult, error) {
	...
	err := ctx.Invoke("azure-native:eventgrid/v20240601preview:getDomainTopicEventSubscriptionFullUrl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDomainTopicEventSubscriptionFullUrlOutput(ctx *pulumi.Context, args GetDomainTopicEventSubscriptionFullUrlOutputArgs, opts ...pulumi.InvokeOption) GetDomainTopicEventSubscriptionFullUrlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetDomainTopicEventSubscriptionFullUrlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:eventgrid/v20240601preview:getDomainTopicEventSubscriptionFullUrl", args, GetDomainTopicEventSubscriptionFullUrlResultOutput{}, options).(GetDomainTopicEventSubscriptionFullUrlResultOutput), nil
