...
func NewPartnerDestination(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:eventgrid/v20240601preview:PartnerDestination", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPartnerDestination(ctx *pulumi.Context,
	...
	var resource PartnerDestination
	err := ctx.ReadResource("azure-native:eventgrid/v20240601preview:PartnerDestination", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
