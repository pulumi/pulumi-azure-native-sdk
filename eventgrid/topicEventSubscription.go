...
func NewTopicEventSubscription(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:eventgrid/v20250401preview:TopicEventSubscription"),
		},
		{
			Type: pulumi.String("azure-native:eventgrid/v20250715preview:TopicEventSubscription"),
		},
	})
...
// The Azure API version of the resource.
func (o TopicEventSubscriptionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TopicEventSubscription) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata relating to the Event Grid resource.
func (o TopicEventSubscriptionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *TopicEventSubscription) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
