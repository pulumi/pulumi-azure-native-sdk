...
func NewStorageInsightConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:operationalinsights/v20250201:StorageInsightConfig"),
		},
		{
			Type: pulumi.String("azure-native:operationalinsights/v20250701:StorageInsightConfig"),
		},
	})
...
// The Azure API version of the resource.
func (o StorageInsightConfigOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *StorageInsightConfig) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
