...
func LookupQuery(ctx *pulumi.Context, args *LookupQueryArgs, opts ...pulumi.InvokeOption) (*LookupQueryResult, error) {
	...
	err := ctx.Invoke("azure-native:operationalinsights/v20250201:getQuery", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupQueryOutput(ctx *pulumi.Context, args LookupQueryOutputArgs, opts ...pulumi.InvokeOption) LookupQueryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupQueryResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:operationalinsights/v20250201:getQuery", args, LookupQueryResultOutput{}, options).(LookupQueryResultOutput), nil
