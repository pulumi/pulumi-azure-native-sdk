...
func LookupWorkspace(ctx *pulumi.Context, args *LookupWorkspaceArgs, opts ...pulumi.InvokeOption) (*LookupWorkspaceResult, error) {
	...
	err := ctx.Invoke("azure-native:operationalinsights/v20250201:getWorkspace", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupWorkspaceResult struct {
	...
	Failover *WorkspaceFailoverPropertiesResponse `pulumi:"failover"`
	// Workspace features.
	...
	Replication *WorkspaceReplicationPropertiesResponse `pulumi:"replication"`
...
func LookupWorkspaceOutput(ctx *pulumi.Context, args LookupWorkspaceOutputArgs, opts ...pulumi.InvokeOption) LookupWorkspaceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkspaceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:operationalinsights/v20250201:getWorkspace", args, LookupWorkspaceResultOutput{}, options).(LookupWorkspaceResultOutput), nil
...
// workspace failover properties.
func (o LookupWorkspaceResultOutput) Failover() WorkspaceFailoverPropertiesResponsePtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *WorkspaceFailoverPropertiesResponse { return v.Failover }).(WorkspaceFailoverPropertiesResponsePtrOutput)
}
...
// workspace replication properties.
func (o LookupWorkspaceResultOutput) Replication() WorkspaceReplicationPropertiesResponsePtrOutput {
	return o.ApplyT(func(v LookupWorkspaceResult) *WorkspaceReplicationPropertiesResponse { return v.Replication }).(WorkspaceReplicationPropertiesResponsePtrOutput)
}
