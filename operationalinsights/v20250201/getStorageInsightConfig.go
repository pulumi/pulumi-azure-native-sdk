...
func LookupStorageInsightConfig(ctx *pulumi.Context, args *LookupStorageInsightConfigArgs, opts ...pulumi.InvokeOption) (*LookupStorageInsightConfigResult, error) {
	...
	err := ctx.Invoke("azure-native:operationalinsights/v20250201:getStorageInsightConfig", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStorageInsightConfigOutput(ctx *pulumi.Context, args LookupStorageInsightConfigOutputArgs, opts ...pulumi.InvokeOption) LookupStorageInsightConfigResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStorageInsightConfigResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:operationalinsights/v20250201:getStorageInsightConfig", args, LookupStorageInsightConfigResultOutput{}, options).(LookupStorageInsightConfigResultOutput), nil
