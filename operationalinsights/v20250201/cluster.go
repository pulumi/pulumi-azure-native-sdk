...
type Cluster struct {
	...
	Replication ClusterReplicationPropertiesResponsePtrOutput `pulumi:"replication"`
	// The sku properties.
...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20250201:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("azure-native:operationalinsights/v20250201:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type clusterArgs struct {
	...
	// Cluster's replication properties.
	Replication *ClusterReplicationProperties `pulumi:"replication"`
...
type ClusterArgs struct {
	...
	// Cluster's replication properties.
	Replication ClusterReplicationPropertiesPtrInput
	// The name of the resource group. The name is case insensitive.
...
// Cluster's replication properties.
func (o ClusterOutput) Replication() ClusterReplicationPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *Cluster) ClusterReplicationPropertiesResponsePtrOutput { return v.Replication }).(ClusterReplicationPropertiesResponsePtrOutput)
}
