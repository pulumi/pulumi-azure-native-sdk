...
type Workspace struct {
	...
	Failover WorkspaceFailoverPropertiesResponsePtrOutput `pulumi:"failover"`
	// Workspace features.
	...
	Replication WorkspaceReplicationPropertiesResponsePtrOutput `pulumi:"replication"`
...
func NewWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20250201:Workspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkspace(ctx *pulumi.Context,
	...
	var resource Workspace
	err := ctx.ReadResource("azure-native:operationalinsights/v20250201:Workspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type workspaceArgs struct {
	...
	// workspace replication properties.
	Replication *WorkspaceReplicationProperties `pulumi:"replication"`
...
type WorkspaceArgs struct {
	...
	// workspace replication properties.
	Replication WorkspaceReplicationPropertiesPtrInput
	// The name of the resource group. The name is case insensitive.
...
// workspace failover properties.
func (o WorkspaceOutput) Failover() WorkspaceFailoverPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *Workspace) WorkspaceFailoverPropertiesResponsePtrOutput { return v.Failover }).(WorkspaceFailoverPropertiesResponsePtrOutput)
}
...
// workspace replication properties.
func (o WorkspaceOutput) Replication() WorkspaceReplicationPropertiesResponsePtrOutput {
	return o.ApplyT(func(v *Workspace) WorkspaceReplicationPropertiesResponsePtrOutput { return v.Replication }).(WorkspaceReplicationPropertiesResponsePtrOutput)
}
