...
func LookupCluster(ctx *pulumi.Context, args *LookupClusterArgs, opts ...pulumi.InvokeOption) (*LookupClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:operationalinsights/v20250201:getCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupClusterResult struct {
	...
	Replication *ClusterReplicationPropertiesResponse `pulumi:"replication"`
	// The sku properties.
...
func LookupClusterOutput(ctx *pulumi.Context, args LookupClusterOutputArgs, opts ...pulumi.InvokeOption) LookupClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:operationalinsights/v20250201:getCluster", args, LookupClusterResultOutput{}, options).(LookupClusterResultOutput), nil
...
// Cluster's replication properties.
func (o LookupClusterResultOutput) Replication() ClusterReplicationPropertiesResponsePtrOutput {
	return o.ApplyT(func(v LookupClusterResult) *ClusterReplicationPropertiesResponse { return v.Replication }).(ClusterReplicationPropertiesResponsePtrOutput)
}
