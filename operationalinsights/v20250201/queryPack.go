...
func NewQueryPack(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20250201:QueryPack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueryPack(ctx *pulumi.Context,
	...
	var resource QueryPack
	err := ctx.ReadResource("azure-native:operationalinsights/v20250201:QueryPack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
