...
func LookupSavedSearch(ctx *pulumi.Context, args *LookupSavedSearchArgs, opts ...pulumi.InvokeOption) (*LookupSavedSearchResult, error) {
	...
	err := ctx.Invoke("azure-native:operationalinsights/v20250201:getSavedSearch", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSavedSearchOutput(ctx *pulumi.Context, args LookupSavedSearchOutputArgs, opts ...pulumi.InvokeOption) LookupSavedSearchResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSavedSearchResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:operationalinsights/v20250201:getSavedSearch", args, LookupSavedSearchResultOutput{}, options).(LookupSavedSearchResultOutput), nil
