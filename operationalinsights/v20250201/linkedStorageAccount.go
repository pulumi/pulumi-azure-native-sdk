...
func NewLinkedStorageAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20250201:LinkedStorageAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedStorageAccount(ctx *pulumi.Context,
	...
	var resource LinkedStorageAccount
	err := ctx.ReadResource("azure-native:operationalinsights/v20250201:LinkedStorageAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
