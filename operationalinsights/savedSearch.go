...
func NewSavedSearch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights:SavedSearch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSavedSearch(ctx *pulumi.Context,
	...
	var resource SavedSearch
	err := ctx.ReadResource("azure-native:operationalinsights:SavedSearch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o SavedSearchOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SavedSearch) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
