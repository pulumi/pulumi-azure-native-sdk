...
func NewQueryPack(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:operationalinsights/v20250701:QueryPack"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o QueryPackOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *QueryPack) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
