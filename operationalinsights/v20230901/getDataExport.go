...
func LookupDataExport(ctx *pulumi.Context, args *LookupDataExportArgs, opts ...pulumi.InvokeOption) (*LookupDataExportResult, error) {
	...
	err := ctx.Invoke("azure-native:operationalinsights/v20230901:getDataExport", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDataExportOutput(ctx *pulumi.Context, args LookupDataExportOutputArgs, opts ...pulumi.InvokeOption) LookupDataExportResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDataExportResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:operationalinsights/v20230901:getDataExport", args, LookupDataExportResultOutput{}, options).(LookupDataExportResultOutput), nil
