...
func NewSavedSearch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20230901:SavedSearch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSavedSearch(ctx *pulumi.Context,
	...
	var resource SavedSearch
	err := ctx.ReadResource("azure-native:operationalinsights/v20230901:SavedSearch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
