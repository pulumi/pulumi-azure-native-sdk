...
func NewQuery(ctx *pulumi.Context,
	...
	var resource Query
	err := ctx.RegisterResource("azure-native:operationalinsights/v20230901:Query", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQuery(ctx *pulumi.Context,
	...
	var resource Query
	err := ctx.ReadResource("azure-native:operationalinsights/v20230901:Query", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
