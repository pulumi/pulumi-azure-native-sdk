...
func NewDataExport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20230901:DataExport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataExport(ctx *pulumi.Context,
	...
	var resource DataExport
	err := ctx.ReadResource("azure-native:operationalinsights/v20230901:DataExport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
