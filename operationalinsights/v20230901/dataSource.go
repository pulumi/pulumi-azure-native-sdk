...
func NewDataSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20230901:DataSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSource(ctx *pulumi.Context,
	...
	var resource DataSource
	err := ctx.ReadResource("azure-native:operationalinsights/v20230901:DataSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
