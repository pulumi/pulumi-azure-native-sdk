...
func NewLinkedService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20230901:LinkedService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLinkedService(ctx *pulumi.Context,
	...
	var resource LinkedService
	err := ctx.ReadResource("azure-native:operationalinsights/v20230901:LinkedService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
