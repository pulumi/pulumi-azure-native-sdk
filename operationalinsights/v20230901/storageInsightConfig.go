...
func NewStorageInsightConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:operationalinsights/v20230901:StorageInsightConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageInsightConfig(ctx *pulumi.Context,
	...
	var resource StorageInsightConfig
	err := ctx.ReadResource("azure-native:operationalinsights/v20230901:StorageInsightConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
