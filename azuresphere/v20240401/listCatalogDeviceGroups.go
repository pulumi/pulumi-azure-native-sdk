...
func ListCatalogDeviceGroups(ctx *pulumi.Context, args *ListCatalogDeviceGroupsArgs, opts ...pulumi.InvokeOption) (*ListCatalogDeviceGroupsResult, error) {
	...
	err := ctx.Invoke("azure-native:azuresphere/v20240401:listCatalogDeviceGroups", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListCatalogDeviceGroupsOutput(ctx *pulumi.Context, args ListCatalogDeviceGroupsOutputArgs, opts ...pulumi.InvokeOption) ListCatalogDeviceGroupsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListCatalogDeviceGroupsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azuresphere/v20240401:listCatalogDeviceGroups", args, ListCatalogDeviceGroupsResultOutput{}, options).(ListCatalogDeviceGroupsResultOutput), nil
