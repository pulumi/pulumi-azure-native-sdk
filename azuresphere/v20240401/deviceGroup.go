...
func NewDeviceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azuresphere/v20240401:DeviceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceGroup(ctx *pulumi.Context,
	...
	var resource DeviceGroup
	err := ctx.ReadResource("azure-native:azuresphere/v20240401:DeviceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
