...
func NewProduct(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:azuresphere/v20240401:Product"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Product
	err := ctx.RegisterResource("azure-native:azuresphere/v20220901preview:Product", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProduct(ctx *pulumi.Context,
	...
	var resource Product
	err := ctx.ReadResource("azure-native:azuresphere/v20220901preview:Product", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
