...
func NewImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.RegisterResource("azure-native:azuresphere/v20220901preview:Image", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.ReadResource("azure-native:azuresphere/v20220901preview:Image", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
