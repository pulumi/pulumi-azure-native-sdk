...
func LookupSharedPrivateLinkResource(ctx *pulumi.Context, args *LookupSharedPrivateLinkResourceArgs, opts ...pulumi.InvokeOption) (*LookupSharedPrivateLinkResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:search/v20231101:getSharedPrivateLinkResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupSharedPrivateLinkResourceResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSharedPrivateLinkResourceResult] {
	return pulumix.Output[LookupSharedPrivateLinkResourceResult]{
