...
func NewSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:search/v20240601preview:SharedPrivateLinkResource"),
		},
		{
			Type: pulumi.String("azure-native:search/v20250201preview:SharedPrivateLinkResource"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:search/v20240301preview:SharedPrivateLinkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	var resource SharedPrivateLinkResource
	err := ctx.ReadResource("azure-native:search/v20240301preview:SharedPrivateLinkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
