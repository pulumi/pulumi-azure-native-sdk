...
type Service struct {
	...
	DataExfiltrationProtections pulumi.StringArrayOutput `pulumi:"dataExfiltrationProtections"`
	...
	ServiceUpgradedAt pulumi.StringOutput `pulumi:"serviceUpgradedAt"`
	...
	UpgradeAvailable pulumi.StringPtrOutput `pulumi:"upgradeAvailable"`
}
...
type ServiceArgs struct {
	...
	// A list of data exfiltration scenarios that are explicitly disallowed for the search service. Currently, the only supported value is 'All' to disable all possible data export scenarios with more fine grained controls planned for the future.
	DataExfiltrationProtections pulumi.StringArrayInput
	// When set to true, calls to the search service will not be permitted to utilize API keys for authentication. This cannot be set to true if 'dataPlaneAuthOptions' are defined.
	...
	// Indicates if the search service has an upgrade available.
	UpgradeAvailable pulumi.StringPtrInput
}
...
// Configure this property to support the search service using either the Default Compute or Azure Confidential Compute.
func (o ServiceOutput) ComputeType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Service) pulumi.StringPtrOutput { return v.ComputeType }).(pulumi.StringPtrOutput)
}

// A list of data exfiltration scenarios that are explicitly disallowed for the search service. Currently, the only supported value is 'All' to disable all possible data export scenarios with more fine grained controls planned for the future.
func (o ServiceOutput) DataExfiltrationProtections() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Service) pulumi.StringArrayOutput { return v.DataExfiltrationProtections }).(pulumi.StringArrayOutput)
}
...
// The endpoint of the Azure AI Search service.
func (o ServiceOutput) Endpoint() pulumi.StringPtrOutput {
...
// The date and time the search service was last upgraded. This field will be null until the service gets upgraded for the first time.
func (o ServiceOutput) ServiceUpgradedAt() pulumi.StringOutput {
	return o.ApplyT(func(v *Service) pulumi.StringOutput { return v.ServiceUpgradedAt }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ServiceOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *Service) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
...
// Indicates if the search service has an upgrade available.
func (o ServiceOutput) UpgradeAvailable() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Service) pulumi.StringPtrOutput { return v.UpgradeAvailable }).(pulumi.StringPtrOutput)
}
