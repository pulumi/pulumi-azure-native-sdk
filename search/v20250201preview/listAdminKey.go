...
func ListAdminKey(ctx *pulumi.Context, args *ListAdminKeyArgs, opts ...pulumi.InvokeOption) (*ListAdminKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:search/v20250201preview:listAdminKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAdminKeyOutput(ctx *pulumi.Context, args ListAdminKeyOutputArgs, opts ...pulumi.InvokeOption) ListAdminKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAdminKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:search/v20250201preview:listAdminKey", args, ListAdminKeyResultOutput{}, options).(ListAdminKeyResultOutput), nil
