...
func LookupService(ctx *pulumi.Context, args *LookupServiceArgs, opts ...pulumi.InvokeOption) (*LookupServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:search/v20250201preview:getService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupServiceResult struct {
	...
	ServiceUpgradeDate string `pulumi:"serviceUpgradeDate"`
...
func LookupServiceOutput(ctx *pulumi.Context, args LookupServiceOutputArgs, opts ...pulumi.InvokeOption) LookupServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:search/v20250201preview:getService", args, LookupServiceResultOutput{}, options).(LookupServiceResultOutput), nil
...
// The date and time the search service was last upgraded. This field will be null until the service gets upgraded for the first time.
func (o LookupServiceResultOutput) ServiceUpgradeDate() pulumi.StringOutput {
	return o.ApplyT(func(v LookupServiceResult) string { return v.ServiceUpgradeDate }).(pulumi.StringOutput)
}
...
// Indicates whether or not the search service has an upgrade available.
func (o LookupServiceResultOutput) UpgradeAvailable() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupServiceResult) bool { return v.UpgradeAvailable }).(pulumi.BoolOutput)
}
