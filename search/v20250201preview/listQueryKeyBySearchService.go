...
func ListQueryKeyBySearchService(ctx *pulumi.Context, args *ListQueryKeyBySearchServiceArgs, opts ...pulumi.InvokeOption) (*ListQueryKeyBySearchServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:search/v20250201preview:listQueryKeyBySearchService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListQueryKeyBySearchServiceOutput(ctx *pulumi.Context, args ListQueryKeyBySearchServiceOutputArgs, opts ...pulumi.InvokeOption) ListQueryKeyBySearchServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListQueryKeyBySearchServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:search/v20250201preview:listQueryKeyBySearchService", args, ListQueryKeyBySearchServiceResultOutput{}, options).(ListQueryKeyBySearchServiceResultOutput), nil
