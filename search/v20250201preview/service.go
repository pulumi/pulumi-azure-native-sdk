...
type Service struct {
	...
	ServiceUpgradeDate pulumi.StringOutput `pulumi:"serviceUpgradeDate"`
...
func NewService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:search/v20250201preview:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetService(ctx *pulumi.Context,
	...
	var resource Service
	err := ctx.ReadResource("azure-native:search/v20250201preview:Service", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The date and time the search service was last upgraded. This field will be null until the service gets upgraded for the first time.
func (o ServiceOutput) ServiceUpgradeDate() pulumi.StringOutput {
	return o.ApplyT(func(v *Service) pulumi.StringOutput { return v.ServiceUpgradeDate }).(pulumi.StringOutput)
}
...
// Indicates whether or not the search service has an upgrade available.
func (o ServiceOutput) UpgradeAvailable() pulumi.BoolOutput {
	return o.ApplyT(func(v *Service) pulumi.BoolOutput { return v.UpgradeAvailable }).(pulumi.BoolOutput)
}
