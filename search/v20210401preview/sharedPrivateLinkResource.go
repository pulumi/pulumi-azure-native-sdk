...
func NewSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:search/v20210401preview:SharedPrivateLinkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSharedPrivateLinkResource(ctx *pulumi.Context,
	...
	var resource SharedPrivateLinkResource
	err := ctx.ReadResource("azure-native:search/v20210401preview:SharedPrivateLinkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
