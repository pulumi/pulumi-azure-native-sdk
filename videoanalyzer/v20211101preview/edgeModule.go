...
func NewEdgeModule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:videoanalyzer/v20211101preview:EdgeModule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEdgeModule(ctx *pulumi.Context,
	...
	var resource EdgeModule
	err := ctx.ReadResource("azure-native:videoanalyzer/v20211101preview:EdgeModule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
