...
// AccessPolicyEccAlgoInput is an input type that accepts values of the AccessPolicyEccAlgo enum
// A concrete instance of `AccessPolicyEccAlgoInput` can be one of the following:
//
...
// AccessPolicyRsaAlgoInput is an input type that accepts values of the AccessPolicyRsaAlgo enum
// A concrete instance of `AccessPolicyRsaAlgoInput` can be one of the following:
//
...
// EncoderSystemPresetTypeInput is an input type that accepts values of the EncoderSystemPresetType enum
// A concrete instance of `EncoderSystemPresetTypeInput` can be one of the following:
//
...
// RtspTransportInput is an input type that accepts values of the RtspTransport enum
// A concrete instance of `RtspTransportInput` can be one of the following:
//
//	RtspTransportHttp
//	RtspTransportTcp
...
// VideoScaleModeInput is an input type that accepts values of the VideoScaleMode enum
// A concrete instance of `VideoScaleModeInput` can be one of the following:
//
//	VideoScaleModePad
