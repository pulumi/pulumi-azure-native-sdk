...
func NewVideoAnalyzer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:videoanalyzer:VideoAnalyzer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVideoAnalyzer(ctx *pulumi.Context,
	...
	var resource VideoAnalyzer
	err := ctx.ReadResource("azure-native:videoanalyzer:VideoAnalyzer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
