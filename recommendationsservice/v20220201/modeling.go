...
func NewModeling(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recommendationsservice/v20220201:Modeling", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModeling(ctx *pulumi.Context,
	...
	var resource Modeling
	err := ctx.ReadResource("azure-native:recommendationsservice/v20220201:Modeling", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *Modeling) ToOutput(ctx context.Context) pulumix.Output[*Modeling] {
	return pulumix.Output[*Modeling]{
		OutputState: i.ToModelingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ModelingOutput) ToOutput(ctx context.Context) pulumix.Output[*Modeling] {
	return pulumix.Output[*Modeling]{
