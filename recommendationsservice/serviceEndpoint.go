...
func NewServiceEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recommendationsservice:ServiceEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpoint(ctx *pulumi.Context,
	...
	var resource ServiceEndpoint
	err := ctx.ReadResource("azure-native:recommendationsservice:ServiceEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ServiceEndpointOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceEndpoint) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Metadata pertaining to creation and last modification of the resource.
func (o ServiceEndpointOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *ServiceEndpoint) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
