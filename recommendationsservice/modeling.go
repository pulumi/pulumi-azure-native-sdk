...
// Metadata pertaining to creation and last modification of the resource.
func (o ModelingOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *Modeling) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
