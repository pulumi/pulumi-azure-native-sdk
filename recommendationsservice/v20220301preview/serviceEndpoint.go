...
func NewServiceEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:recommendationsservice/v20220301preview:ServiceEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEndpoint(ctx *pulumi.Context,
	...
	var resource ServiceEndpoint
	err := ctx.ReadResource("azure-native:recommendationsservice/v20220301preview:ServiceEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
