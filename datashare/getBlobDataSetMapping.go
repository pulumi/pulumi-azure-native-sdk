...
func (o LookupBlobDataSetMappingResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupBlobDataSetMappingResult] {
	return pulumix.Output[LookupBlobDataSetMappingResult]{
