...
func LookupBlobDataSetMapping(ctx *pulumi.Context, args *LookupBlobDataSetMappingArgs, opts ...pulumi.InvokeOption) (*LookupBlobDataSetMappingResult, error) {
	...
	err := ctx.Invoke("azure-native:datashare:getBlobDataSetMapping", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupBlobDataSetMappingOutput(ctx *pulumi.Context, args LookupBlobDataSetMappingOutputArgs, opts ...pulumi.InvokeOption) LookupBlobDataSetMappingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBlobDataSetMappingResultOutput, error) {
			args := v.(LookupBlobDataSetMappingArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:datashare:getBlobDataSetMapping", args, LookupBlobDataSetMappingResultOutput{}, options).(LookupBlobDataSetMappingResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupBlobDataSetMappingResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupBlobDataSetMappingResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
