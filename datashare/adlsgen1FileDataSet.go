...
func NewADLSGen1FileDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare:ADLSGen1FileDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen1FileDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen1FileDataSet
	err := ctx.ReadResource("azure-native:datashare:ADLSGen1FileDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
