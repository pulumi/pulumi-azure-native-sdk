...
func LookupKustoTableDataSet(ctx *pulumi.Context, args *LookupKustoTableDataSetArgs, opts ...pulumi.InvokeOption) (*LookupKustoTableDataSetResult, error) {
	...
	err := ctx.Invoke("azure-native:datashare:getKustoTableDataSet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupKustoTableDataSetResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupKustoTableDataSetResult] {
	return pulumix.Output[LookupKustoTableDataSetResult]{
