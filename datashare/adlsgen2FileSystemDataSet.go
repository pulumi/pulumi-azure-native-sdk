...
// The Azure API version of the resource.
func (o ADLSGen2FileSystemDataSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ADLSGen2FileSystemDataSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
