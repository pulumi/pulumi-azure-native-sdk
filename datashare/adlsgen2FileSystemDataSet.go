...
func NewADLSGen2FileSystemDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare:ADLSGen2FileSystemDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FileSystemDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen2FileSystemDataSet
	err := ctx.ReadResource("azure-native:datashare:ADLSGen2FileSystemDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
