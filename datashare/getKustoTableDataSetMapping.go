...
func LookupKustoTableDataSetMapping(ctx *pulumi.Context, args *LookupKustoTableDataSetMappingArgs, opts ...pulumi.InvokeOption) (*LookupKustoTableDataSetMappingResult, error) {
	...
	err := ctx.Invoke("azure-native:datashare:getKustoTableDataSetMapping", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupKustoTableDataSetMappingOutput(ctx *pulumi.Context, args LookupKustoTableDataSetMappingOutputArgs, opts ...pulumi.InvokeOption) LookupKustoTableDataSetMappingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupKustoTableDataSetMappingResultOutput, error) {
			args := v.(LookupKustoTableDataSetMappingArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:datashare:getKustoTableDataSetMapping", args, LookupKustoTableDataSetMappingResultOutput{}, options).(LookupKustoTableDataSetMappingResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupKustoTableDataSetMappingResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupKustoTableDataSetMappingResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
