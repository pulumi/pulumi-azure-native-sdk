...
func LookupADLSGen2FileDataSet(ctx *pulumi.Context, args *LookupADLSGen2FileDataSetArgs, opts ...pulumi.InvokeOption) (*LookupADLSGen2FileDataSetResult, error) {
	...
	err := ctx.Invoke("azure-native:datashare:getADLSGen2FileDataSet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupADLSGen2FileDataSetOutput(ctx *pulumi.Context, args LookupADLSGen2FileDataSetOutputArgs, opts ...pulumi.InvokeOption) LookupADLSGen2FileDataSetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupADLSGen2FileDataSetResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datashare:getADLSGen2FileDataSet", args, LookupADLSGen2FileDataSetResultOutput{}, options).(LookupADLSGen2FileDataSetResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupADLSGen2FileDataSetResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupADLSGen2FileDataSetResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
