...
func NewADLSGen2FileDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:ADLSGen2FileDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FileDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen2FileDataSet
	err := ctx.ReadResource("azure-native:datashare/v20200901:ADLSGen2FileDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
