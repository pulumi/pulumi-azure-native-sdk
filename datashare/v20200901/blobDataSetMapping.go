...
func NewBlobDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:BlobDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobDataSetMapping(ctx *pulumi.Context,
	...
	var resource BlobDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20200901:BlobDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
