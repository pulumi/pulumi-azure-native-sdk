...
func NewInvitation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:Invitation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInvitation(ctx *pulumi.Context,
	...
	var resource Invitation
	err := ctx.ReadResource("azure-native:datashare/v20200901:Invitation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
