...
//
// Deprecated: azure-native:datashare/v20200901:KustoDatabaseDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoDatabaseDataSet to guarantee forwards compatibility.
...
func NewKustoDatabaseDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:KustoDatabaseDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoDatabaseDataSet(ctx *pulumi.Context,
	...
	var resource KustoDatabaseDataSet
	err := ctx.ReadResource("azure-native:datashare/v20200901:KustoDatabaseDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
