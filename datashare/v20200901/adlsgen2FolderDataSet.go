...
func NewADLSGen2FolderDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:ADLSGen2FolderDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FolderDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen2FolderDataSet
	err := ctx.ReadResource("azure-native:datashare/v20200901:ADLSGen2FolderDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
