...
func NewBlobDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:BlobDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobDataSet(ctx *pulumi.Context,
	...
	var resource BlobDataSet
	err := ctx.ReadResource("azure-native:datashare/v20200901:BlobDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
