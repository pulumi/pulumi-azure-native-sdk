...
func NewBlobContainerDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:BlobContainerDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainerDataSet(ctx *pulumi.Context,
	...
	var resource BlobContainerDataSet
	err := ctx.ReadResource("azure-native:datashare/v20200901:BlobContainerDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
