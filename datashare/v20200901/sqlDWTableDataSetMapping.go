...
func NewSqlDWTableDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:SqlDWTableDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDWTableDataSetMapping(ctx *pulumi.Context,
	...
	var resource SqlDWTableDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20200901:SqlDWTableDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
