...
//
// Deprecated: azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet to guarantee forwards compatibility.
...
func NewSynapseWorkspaceSqlPoolTableDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSynapseWorkspaceSqlPoolTableDataSet(ctx *pulumi.Context,
	...
	var resource SynapseWorkspaceSqlPoolTableDataSet
	err := ctx.ReadResource("azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
