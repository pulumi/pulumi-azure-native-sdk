...
// The Azure API version of the resource.
func (o BlobFolderDataSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *BlobFolderDataSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
