...
func LookupADLSGen2FileSystemDataSetMapping(ctx *pulumi.Context, args *LookupADLSGen2FileSystemDataSetMappingArgs, opts ...pulumi.InvokeOption) (*LookupADLSGen2FileSystemDataSetMappingResult, error) {
	...
	err := ctx.Invoke("azure-native:datashare:getADLSGen2FileSystemDataSetMapping", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupADLSGen2FileSystemDataSetMappingOutput(ctx *pulumi.Context, args LookupADLSGen2FileSystemDataSetMappingOutputArgs, opts ...pulumi.InvokeOption) LookupADLSGen2FileSystemDataSetMappingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupADLSGen2FileSystemDataSetMappingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datashare:getADLSGen2FileSystemDataSetMapping", args, LookupADLSGen2FileSystemDataSetMappingResultOutput{}, options).(LookupADLSGen2FileSystemDataSetMappingResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupADLSGen2FileSystemDataSetMappingResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupADLSGen2FileSystemDataSetMappingResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
