...
func NewScheduledSynchronizationSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare:ScheduledSynchronizationSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledSynchronizationSetting(ctx *pulumi.Context,
	...
	var resource ScheduledSynchronizationSetting
	err := ctx.ReadResource("azure-native:datashare:ScheduledSynchronizationSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
