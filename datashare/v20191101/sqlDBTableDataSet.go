...
//
// Deprecated: azure-native:datashare/v20191101:SqlDBTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.
...
func NewSqlDBTableDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:SqlDBTableDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDBTableDataSet(ctx *pulumi.Context,
	...
	var resource SqlDBTableDataSet
	err := ctx.ReadResource("azure-native:datashare/v20191101:SqlDBTableDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
