...
//
// Deprecated: azure-native:datashare/v20191101:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.
...
func NewADLSGen2FileDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:ADLSGen2FileDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FileDataSetMapping(ctx *pulumi.Context,
	...
	var resource ADLSGen2FileDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20191101:ADLSGen2FileDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
