...
func NewSqlDBTableDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:SqlDBTableDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDBTableDataSetMapping(ctx *pulumi.Context,
	...
	var resource SqlDBTableDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20191101:SqlDBTableDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
