...
//
// Deprecated: azure-native:datashare/v20191101:BlobContainerDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobContainerDataSet to guarantee forwards compatibility.
...
func NewBlobContainerDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:BlobContainerDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobContainerDataSet(ctx *pulumi.Context,
	...
	var resource BlobContainerDataSet
	err := ctx.ReadResource("azure-native:datashare/v20191101:BlobContainerDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
