...
func NewScheduledTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:ScheduledTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledTrigger(ctx *pulumi.Context,
	...
	var resource ScheduledTrigger
	err := ctx.ReadResource("azure-native:datashare/v20191101:ScheduledTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
