...
func NewSqlDWTableDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:SqlDWTableDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDWTableDataSet(ctx *pulumi.Context,
	...
	var resource SqlDWTableDataSet
	err := ctx.ReadResource("azure-native:datashare/v20191101:SqlDWTableDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
