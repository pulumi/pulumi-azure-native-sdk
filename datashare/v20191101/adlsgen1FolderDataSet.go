...
func NewADLSGen1FolderDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20191101:ADLSGen1FolderDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen1FolderDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen1FolderDataSet
	err := ctx.ReadResource("azure-native:datashare/v20191101:ADLSGen1FolderDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
