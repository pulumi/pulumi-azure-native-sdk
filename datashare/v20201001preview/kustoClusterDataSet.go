...
func NewKustoClusterDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20201001preview:KustoClusterDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoClusterDataSet(ctx *pulumi.Context,
	...
	var resource KustoClusterDataSet
	err := ctx.ReadResource("azure-native:datashare/v20201001preview:KustoClusterDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
