...
func (o LookupBlobStorageAccountDataSetResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupBlobStorageAccountDataSetResult] {
	return pulumix.Output[LookupBlobStorageAccountDataSetResult]{
