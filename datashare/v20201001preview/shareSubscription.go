...
func NewShareSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20201001preview:ShareSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShareSubscription(ctx *pulumi.Context,
	...
	var resource ShareSubscription
	err := ctx.ReadResource("azure-native:datashare/v20201001preview:ShareSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
