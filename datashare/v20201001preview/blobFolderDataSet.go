...
//
// Deprecated: azure-native:datashare/v20201001preview:BlobFolderDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobFolderDataSet to guarantee forwards compatibility.
...
func NewBlobFolderDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20201001preview:BlobFolderDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobFolderDataSet(ctx *pulumi.Context,
	...
	var resource BlobFolderDataSet
	err := ctx.ReadResource("azure-native:datashare/v20201001preview:BlobFolderDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
