...
//
// Deprecated: azure-native:datashare/v20201001preview:ADLSGen2FileSystemDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet to guarantee forwards compatibility.
...
func NewADLSGen2FileSystemDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20201001preview:ADLSGen2FileSystemDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FileSystemDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen2FileSystemDataSet
	err := ctx.ReadResource("azure-native:datashare/v20201001preview:ADLSGen2FileSystemDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
