...
func NewSynapseWorkspaceSqlPoolTableDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSynapseWorkspaceSqlPoolTableDataSet(ctx *pulumi.Context,
	...
	var resource SynapseWorkspaceSqlPoolTableDataSet
	err := ctx.ReadResource("azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
