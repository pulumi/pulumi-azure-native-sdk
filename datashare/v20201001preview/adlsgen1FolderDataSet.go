...
//
// Deprecated: azure-native:datashare/v20201001preview:ADLSGen1FolderDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen1FolderDataSet to guarantee forwards compatibility.
...
func NewADLSGen1FolderDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20201001preview:ADLSGen1FolderDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen1FolderDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen1FolderDataSet
	err := ctx.ReadResource("azure-native:datashare/v20201001preview:ADLSGen1FolderDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
