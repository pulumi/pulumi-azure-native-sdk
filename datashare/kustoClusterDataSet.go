...
// The Azure API version of the resource.
func (o KustoClusterDataSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *KustoClusterDataSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
