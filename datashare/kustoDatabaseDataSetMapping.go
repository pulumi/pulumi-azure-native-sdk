...
func NewKustoDatabaseDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare:KustoDatabaseDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoDatabaseDataSetMapping(ctx *pulumi.Context,
	...
	var resource KustoDatabaseDataSetMapping
	err := ctx.ReadResource("azure-native:datashare:KustoDatabaseDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o KustoDatabaseDataSetMappingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *KustoDatabaseDataSetMapping) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
