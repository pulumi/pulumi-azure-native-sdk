...
//
// Deprecated: azure-native:datashare/v20181101preview:BlobDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility.
func LookupBlobDataSet(ctx *pulumi.Context, args *LookupBlobDataSetArgs, opts ...pulumi.InvokeOption) (*LookupBlobDataSetResult, error) {
	...
	err := ctx.Invoke("azure-native:datashare/v20181101preview:getBlobDataSet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
