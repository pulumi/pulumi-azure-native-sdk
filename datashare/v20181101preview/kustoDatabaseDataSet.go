...
func NewKustoDatabaseDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20181101preview:KustoDatabaseDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoDatabaseDataSet(ctx *pulumi.Context,
	...
	var resource KustoDatabaseDataSet
	err := ctx.ReadResource("azure-native:datashare/v20181101preview:KustoDatabaseDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
