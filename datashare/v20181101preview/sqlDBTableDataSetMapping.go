...
func NewSqlDBTableDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDBTableDataSetMapping(ctx *pulumi.Context,
	...
	var resource SqlDBTableDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
