...
func NewKustoDatabaseDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare:KustoDatabaseDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustoDatabaseDataSet(ctx *pulumi.Context,
	...
	var resource KustoDatabaseDataSet
	err := ctx.ReadResource("azure-native:datashare:KustoDatabaseDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *KustoDatabaseDataSet) ToOutput(ctx context.Context) pulumix.Output[*KustoDatabaseDataSet] {
	return pulumix.Output[*KustoDatabaseDataSet]{
		OutputState: i.ToKustoDatabaseDataSetOutputWithContext(ctx).OutputState,
	}
}
...
func (o KustoDatabaseDataSetOutput) ToOutput(ctx context.Context) pulumix.Output[*KustoDatabaseDataSet] {
	return pulumix.Output[*KustoDatabaseDataSet]{
