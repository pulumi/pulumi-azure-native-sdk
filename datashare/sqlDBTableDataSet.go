...
// The Azure API version of the resource.
func (o SqlDBTableDataSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SqlDBTableDataSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
