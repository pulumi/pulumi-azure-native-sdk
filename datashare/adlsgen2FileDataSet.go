...
func GetADLSGen2FileDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen2FileDataSet
	err := ctx.ReadResource("azure-native:datashare:ADLSGen2FileDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ADLSGen2FileDataSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ADLSGen2FileDataSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
