...
// The Azure API version of the resource.
func (o SynapseWorkspaceSqlPoolTableDataSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SynapseWorkspaceSqlPoolTableDataSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
