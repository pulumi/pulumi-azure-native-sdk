...
func NewSqlDWTableDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare:SqlDWTableDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDWTableDataSetMapping(ctx *pulumi.Context,
	...
	var resource SqlDWTableDataSetMapping
	err := ctx.ReadResource("azure-native:datashare:SqlDWTableDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o SqlDWTableDataSetMappingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SqlDWTableDataSetMapping) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
