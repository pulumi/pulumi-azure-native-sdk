...
func NewBlobFolderDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20210801:BlobFolderDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlobFolderDataSetMapping(ctx *pulumi.Context,
	...
	var resource BlobFolderDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20210801:BlobFolderDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// System Data of the Azure resource.
func (o BlobFolderDataSetMappingOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *BlobFolderDataSetMapping) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
