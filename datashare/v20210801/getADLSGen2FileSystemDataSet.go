...
func (o LookupADLSGen2FileSystemDataSetResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupADLSGen2FileSystemDataSetResult] {
	return pulumix.Output[LookupADLSGen2FileSystemDataSetResult]{
