...
func (o LookupKustoDatabaseDataSetResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupKustoDatabaseDataSetResult] {
	return pulumix.Output[LookupKustoDatabaseDataSetResult]{
