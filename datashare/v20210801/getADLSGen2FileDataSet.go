...
func (o LookupADLSGen2FileDataSetResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupADLSGen2FileDataSetResult] {
	return pulumix.Output[LookupADLSGen2FileDataSetResult]{
