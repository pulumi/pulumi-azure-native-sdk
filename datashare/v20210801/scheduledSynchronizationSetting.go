...
func NewScheduledSynchronizationSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20210801:ScheduledSynchronizationSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledSynchronizationSetting(ctx *pulumi.Context,
	...
	var resource ScheduledSynchronizationSetting
	err := ctx.ReadResource("azure-native:datashare/v20210801:ScheduledSynchronizationSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// System Data of the Azure resource.
func (o ScheduledSynchronizationSettingOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *ScheduledSynchronizationSetting) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
