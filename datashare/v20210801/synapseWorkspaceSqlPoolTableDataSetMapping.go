...
func NewSynapseWorkspaceSqlPoolTableDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSynapseWorkspaceSqlPoolTableDataSetMapping(ctx *pulumi.Context,
	...
	var resource SynapseWorkspaceSqlPoolTableDataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
