...
func (o LookupKustoClusterDataSetResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupKustoClusterDataSetResult] {
	return pulumix.Output[LookupKustoClusterDataSetResult]{
