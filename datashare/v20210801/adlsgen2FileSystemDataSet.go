...
func NewADLSGen2FileSystemDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FileSystemDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen2FileSystemDataSet
	err := ctx.ReadResource("azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ADLSGen2FileSystemDataSet) ToOutput(ctx context.Context) pulumix.Output[*ADLSGen2FileSystemDataSet] {
	return pulumix.Output[*ADLSGen2FileSystemDataSet]{
		OutputState: i.ToADLSGen2FileSystemDataSetOutputWithContext(ctx).OutputState,
	}
}
...
func (o ADLSGen2FileSystemDataSetOutput) ToOutput(ctx context.Context) pulumix.Output[*ADLSGen2FileSystemDataSet] {
	return pulumix.Output[*ADLSGen2FileSystemDataSet]{
