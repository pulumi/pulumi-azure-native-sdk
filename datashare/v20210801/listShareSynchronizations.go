...
func (o ListShareSynchronizationsResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListShareSynchronizationsResult] {
	return pulumix.Output[ListShareSynchronizationsResult]{
