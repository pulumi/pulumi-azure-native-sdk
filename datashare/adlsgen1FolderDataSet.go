...
// The Azure API version of the resource.
func (o ADLSGen1FolderDataSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ADLSGen1FolderDataSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
