...
func (o LookupKustoClusterDataSetMappingResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupKustoClusterDataSetMappingResult] {
	return pulumix.Output[LookupKustoClusterDataSetMappingResult]{
