...
func NewADLSGen2FolderDataSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare:ADLSGen2FolderDataSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetADLSGen2FolderDataSet(ctx *pulumi.Context,
	...
	var resource ADLSGen2FolderDataSet
	err := ctx.ReadResource("azure-native:datashare:ADLSGen2FolderDataSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ADLSGen2FolderDataSet) ToOutput(ctx context.Context) pulumix.Output[*ADLSGen2FolderDataSet] {
	return pulumix.Output[*ADLSGen2FolderDataSet]{
		OutputState: i.ToADLSGen2FolderDataSetOutputWithContext(ctx).OutputState,
	}
}
...
func (o ADLSGen2FolderDataSetOutput) ToOutput(ctx context.Context) pulumix.Output[*ADLSGen2FolderDataSet] {
	return pulumix.Output[*ADLSGen2FolderDataSet]{
