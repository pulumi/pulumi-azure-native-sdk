...
// MultiFactorAuthProviderInput is an input type that accepts values of the MultiFactorAuthProvider enum
// A concrete instance of `MultiFactorAuthProviderInput` can be one of the following:
//
