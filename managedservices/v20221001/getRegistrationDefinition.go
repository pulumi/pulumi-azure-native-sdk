...
func LookupRegistrationDefinition(ctx *pulumi.Context, args *LookupRegistrationDefinitionArgs, opts ...pulumi.InvokeOption) (*LookupRegistrationDefinitionResult, error) {
	...
	err := ctx.Invoke("azure-native:managedservices/v20221001:getRegistrationDefinition", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRegistrationDefinitionOutput(ctx *pulumi.Context, args LookupRegistrationDefinitionOutputArgs, opts ...pulumi.InvokeOption) LookupRegistrationDefinitionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRegistrationDefinitionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:managedservices/v20221001:getRegistrationDefinition", args, LookupRegistrationDefinitionResultOutput{}, options).(LookupRegistrationDefinitionResultOutput), nil
