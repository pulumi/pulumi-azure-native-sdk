...
func NewRegistrationDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managedservices/v20190901:RegistrationDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistrationDefinition(ctx *pulumi.Context,
	...
	var resource RegistrationDefinition
	err := ctx.ReadResource("azure-native:managedservices/v20190901:RegistrationDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
