...
func NewRegistrationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managedservices/v20190901:RegistrationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistrationAssignment(ctx *pulumi.Context,
	...
	var resource RegistrationAssignment
	err := ctx.ReadResource("azure-native:managedservices/v20190901:RegistrationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
