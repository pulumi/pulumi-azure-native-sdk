...
func NewRegistrationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:managedservices/v20180601preview:RegistrationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistrationAssignment(ctx *pulumi.Context,
	...
	var resource RegistrationAssignment
	err := ctx.ReadResource("azure-native:managedservices/v20180601preview:RegistrationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
