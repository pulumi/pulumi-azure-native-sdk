...
func (o ListMonitorLinkedResourcesResultOutput) ToOutput(ctx context.Context) pulumix.Output[ListMonitorLinkedResourcesResult] {
	return pulumix.Output[ListMonitorLinkedResourcesResult]{
