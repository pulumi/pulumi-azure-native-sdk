...
func ListMonitorLinkedResources(ctx *pulumi.Context, args *ListMonitorLinkedResourcesArgs, opts ...pulumi.InvokeOption) (*ListMonitorLinkedResourcesResult, error) {
	...
	err := ctx.Invoke("azure-native:datadog/v20230707:listMonitorLinkedResources", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListMonitorLinkedResourcesOutput(ctx *pulumi.Context, args ListMonitorLinkedResourcesOutputArgs, opts ...pulumi.InvokeOption) ListMonitorLinkedResourcesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListMonitorLinkedResourcesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datadog/v20230707:listMonitorLinkedResources", args, ListMonitorLinkedResourcesResultOutput{}, options).(ListMonitorLinkedResourcesResultOutput), nil
