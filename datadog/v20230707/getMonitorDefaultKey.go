...
func GetMonitorDefaultKey(ctx *pulumi.Context, args *GetMonitorDefaultKeyArgs, opts ...pulumi.InvokeOption) (*GetMonitorDefaultKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:datadog/v20230707:getMonitorDefaultKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetMonitorDefaultKeyOutput(ctx *pulumi.Context, args GetMonitorDefaultKeyOutputArgs, opts ...pulumi.InvokeOption) GetMonitorDefaultKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetMonitorDefaultKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datadog/v20230707:getMonitorDefaultKey", args, GetMonitorDefaultKeyResultOutput{}, options).(GetMonitorDefaultKeyResultOutput), nil
