...
func ListMonitorHosts(ctx *pulumi.Context, args *ListMonitorHostsArgs, opts ...pulumi.InvokeOption) (*ListMonitorHostsResult, error) {
	...
	err := ctx.Invoke("azure-native:datadog/v20230707:listMonitorHosts", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListMonitorHostsOutput(ctx *pulumi.Context, args ListMonitorHostsOutputArgs, opts ...pulumi.InvokeOption) ListMonitorHostsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListMonitorHostsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datadog/v20230707:listMonitorHosts", args, ListMonitorHostsResultOutput{}, options).(ListMonitorHostsResultOutput), nil
