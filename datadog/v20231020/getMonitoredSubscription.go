...
func LookupMonitoredSubscription(ctx *pulumi.Context, args *LookupMonitoredSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupMonitoredSubscriptionResult, error) {
	...
	err := ctx.Invoke("azure-native:datadog/v20231020:getMonitoredSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMonitoredSubscriptionOutput(ctx *pulumi.Context, args LookupMonitoredSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupMonitoredSubscriptionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMonitoredSubscriptionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datadog/v20231020:getMonitoredSubscription", args, LookupMonitoredSubscriptionResultOutput{}, options).(LookupMonitoredSubscriptionResultOutput), nil
