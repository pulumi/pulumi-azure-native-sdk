...
func ListMonitorApiKeys(ctx *pulumi.Context, args *ListMonitorApiKeysArgs, opts ...pulumi.InvokeOption) (*ListMonitorApiKeysResult, error) {
	...
	err := ctx.Invoke("azure-native:datadog/v20230101:listMonitorApiKeys", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListMonitorApiKeysOutput(ctx *pulumi.Context, args ListMonitorApiKeysOutputArgs, opts ...pulumi.InvokeOption) ListMonitorApiKeysResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListMonitorApiKeysResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:datadog/v20230101:listMonitorApiKeys", args, ListMonitorApiKeysResultOutput{}, options).(ListMonitorApiKeysResultOutput), nil
