...
func NewTrafficManagerUserMetricsKey(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180401:TrafficManagerUserMetricsKey"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180801:TrafficManagerUserMetricsKey"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20220401:TrafficManagerUserMetricsKey"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20220401preview:TrafficManagerUserMetricsKey"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20240401preview:TrafficManagerUserMetricsKey"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TrafficManagerUserMetricsKey
	err := ctx.RegisterResource("azure-native:trafficmanager:TrafficManagerUserMetricsKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrafficManagerUserMetricsKey(ctx *pulumi.Context,
	...
	var resource TrafficManagerUserMetricsKey
	err := ctx.ReadResource("azure-native:trafficmanager:TrafficManagerUserMetricsKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o TrafficManagerUserMetricsKeyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TrafficManagerUserMetricsKey) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
