...
func LookupTrafficManagerUserMetricsKey(ctx *pulumi.Context, args *LookupTrafficManagerUserMetricsKeyArgs, opts ...pulumi.InvokeOption) (*LookupTrafficManagerUserMetricsKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:trafficmanager:getTrafficManagerUserMetricsKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTrafficManagerUserMetricsKeyOutput(ctx *pulumi.Context, args LookupTrafficManagerUserMetricsKeyOutputArgs, opts ...pulumi.InvokeOption) LookupTrafficManagerUserMetricsKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTrafficManagerUserMetricsKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:trafficmanager:getTrafficManagerUserMetricsKey", args, LookupTrafficManagerUserMetricsKeyResultOutput{}, options).(LookupTrafficManagerUserMetricsKeyResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupTrafficManagerUserMetricsKeyResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupTrafficManagerUserMetricsKeyResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
