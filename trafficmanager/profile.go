...
func NewProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:trafficmanager/v20151101:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20170301:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20170501:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180201:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180301:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180401:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180801:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20220401:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20220401preview:Profile"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20240401preview:Profile"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Profile
	err := ctx.RegisterResource("azure-native:trafficmanager:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azure-native:trafficmanager:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
