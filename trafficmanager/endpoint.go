...
type Endpoint struct {
	...
	CustomHeaders EndpointPropertiesCustomHeadersItemResponseArrayOutput `pulumi:"customHeaders"`
	...
	Subnets EndpointPropertiesSubnetsItemResponseArrayOutput `pulumi:"subnets"`
...
func NewEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:trafficmanager/v20151101:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20170301:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20170501:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180201:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180301:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180401:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20180801:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20220401:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20220401preview:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:trafficmanager/v20240401preview:Endpoint"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Endpoint
	err := ctx.RegisterResource("azure-native:trafficmanager:Endpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpoint(ctx *pulumi.Context,
	...
	var resource Endpoint
	err := ctx.ReadResource("azure-native:trafficmanager:Endpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type EndpointArgs struct {
	...
	// List of custom headers.
	CustomHeaders EndpointPropertiesCustomHeadersItemArrayInput
	// Specifies the location of the external or nested endpoints when using the 'Performance' traffic routing method.
	...
	// The list of subnets, IP addresses, and/or address ranges mapped to this endpoint when using the 'Subnet' traffic routing method. An empty list will match all ranges not covered by other endpoints.
	Subnets EndpointPropertiesSubnetsItemArrayInput
	// The fully-qualified DNS name or IP address of the endpoint. Traffic Manager returns this value in DNS responses to direct traffic to this endpoint.
...
// List of custom headers.
func (o EndpointOutput) CustomHeaders() EndpointPropertiesCustomHeadersItemResponseArrayOutput {
	return o.ApplyT(func(v *Endpoint) EndpointPropertiesCustomHeadersItemResponseArrayOutput { return v.CustomHeaders }).(EndpointPropertiesCustomHeadersItemResponseArrayOutput)
}
...
// The list of subnets, IP addresses, and/or address ranges mapped to this endpoint when using the 'Subnet' traffic routing method. An empty list will match all ranges not covered by other endpoints.
func (o EndpointOutput) Subnets() EndpointPropertiesSubnetsItemResponseArrayOutput {
	return o.ApplyT(func(v *Endpoint) EndpointPropertiesSubnetsItemResponseArrayOutput { return v.Subnets }).(EndpointPropertiesSubnetsItemResponseArrayOutput)
}
