...
func NewSqlSitesController(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:offazure/v20240701preview:SqlSitesController"),
		},
		{
			Type: pulumi.String("azure-native:offazure/v20241201preview:SqlSitesController"),
		},
	})
...
// The Azure API version of the resource.
func (o SqlSitesControllerOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SqlSitesController) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SqlSitesControllerOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *SqlSitesController) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
