...
func NewImportSitesController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20231001preview:ImportSitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportSitesController(ctx *pulumi.Context,
	...
	var resource ImportSitesController
	err := ctx.ReadResource("azure-native:offazure/v20231001preview:ImportSitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
