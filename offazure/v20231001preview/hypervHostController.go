...
func NewHypervHostController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20231001preview:HypervHostController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHypervHostController(ctx *pulumi.Context,
	...
	var resource HypervHostController
	err := ctx.ReadResource("azure-native:offazure/v20231001preview:HypervHostController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
