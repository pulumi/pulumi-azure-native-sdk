...
func NewSqlDiscoverySiteDataSourceController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20231001preview:SqlDiscoverySiteDataSourceController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDiscoverySiteDataSourceController(ctx *pulumi.Context,
	...
	var resource SqlDiscoverySiteDataSourceController
	err := ctx.ReadResource("azure-native:offazure/v20231001preview:SqlDiscoverySiteDataSourceController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
