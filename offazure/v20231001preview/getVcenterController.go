...
func LookupVcenterController(ctx *pulumi.Context, args *LookupVcenterControllerArgs, opts ...pulumi.InvokeOption) (*LookupVcenterControllerResult, error) {
	...
	err := ctx.Invoke("azure-native:offazure/v20231001preview:getVcenterController", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVcenterControllerOutput(ctx *pulumi.Context, args LookupVcenterControllerOutputArgs, opts ...pulumi.InvokeOption) LookupVcenterControllerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVcenterControllerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazure/v20231001preview:getVcenterController", args, LookupVcenterControllerResultOutput{}, options).(LookupVcenterControllerResultOutput), nil
