...
func NewPrivateEndpointConnectionController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20231001preview:PrivateEndpointConnectionController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionController(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionController
	err := ctx.ReadResource("azure-native:offazure/v20231001preview:PrivateEndpointConnectionController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
