...
func LookupHypervSitesControllerOutput(ctx *pulumi.Context, args LookupHypervSitesControllerOutputArgs, opts ...pulumi.InvokeOption) LookupHypervSitesControllerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHypervSitesControllerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazure:getHypervSitesController", args, LookupHypervSitesControllerResultOutput{}, options).(LookupHypervSitesControllerResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupHypervSitesControllerResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupHypervSitesControllerResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupHypervSitesControllerResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupHypervSitesControllerResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
