...
func NewMasterSitesController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20230606:MasterSitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMasterSitesController(ctx *pulumi.Context,
	...
	var resource MasterSitesController
	err := ctx.ReadResource("azure-native:offazure/v20230606:MasterSitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
