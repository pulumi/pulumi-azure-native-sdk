...
func NewServerSitesController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20230606:ServerSitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerSitesController(ctx *pulumi.Context,
	...
	var resource ServerSitesController
	err := ctx.ReadResource("azure-native:offazure/v20230606:ServerSitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
