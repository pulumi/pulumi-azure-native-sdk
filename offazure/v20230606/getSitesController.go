...
func LookupSitesController(ctx *pulumi.Context, args *LookupSitesControllerArgs, opts ...pulumi.InvokeOption) (*LookupSitesControllerResult, error) {
	...
	err := ctx.Invoke("azure-native:offazure/v20230606:getSitesController", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSitesControllerOutput(ctx *pulumi.Context, args LookupSitesControllerOutputArgs, opts ...pulumi.InvokeOption) LookupSitesControllerResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupSitesControllerResult, error) {
			args := v.(LookupSitesControllerArgs)
			r, err := LookupSitesController(ctx, &args, opts...)
			var s LookupSitesControllerResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o LookupSitesControllerResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSitesControllerResult] {
	return pulumix.Output[LookupSitesControllerResult]{
