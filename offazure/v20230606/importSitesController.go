...
func NewImportSitesController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20230606:ImportSitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportSitesController(ctx *pulumi.Context,
	...
	var resource ImportSitesController
	err := ctx.ReadResource("azure-native:offazure/v20230606:ImportSitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ImportSitesController) ToOutput(ctx context.Context) pulumix.Output[*ImportSitesController] {
	return pulumix.Output[*ImportSitesController]{
		OutputState: i.ToImportSitesControllerOutputWithContext(ctx).OutputState,
	}
}
...
func (o ImportSitesControllerOutput) ToOutput(ctx context.Context) pulumix.Output[*ImportSitesController] {
	return pulumix.Output[*ImportSitesController]{
