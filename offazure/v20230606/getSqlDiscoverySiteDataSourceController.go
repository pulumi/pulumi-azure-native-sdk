...
func LookupSqlDiscoverySiteDataSourceController(ctx *pulumi.Context, args *LookupSqlDiscoverySiteDataSourceControllerArgs, opts ...pulumi.InvokeOption) (*LookupSqlDiscoverySiteDataSourceControllerResult, error) {
	...
	err := ctx.Invoke("azure-native:offazure/v20230606:getSqlDiscoverySiteDataSourceController", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSqlDiscoverySiteDataSourceControllerOutput(ctx *pulumi.Context, args LookupSqlDiscoverySiteDataSourceControllerOutputArgs, opts ...pulumi.InvokeOption) LookupSqlDiscoverySiteDataSourceControllerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSqlDiscoverySiteDataSourceControllerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazure/v20230606:getSqlDiscoverySiteDataSourceController", args, LookupSqlDiscoverySiteDataSourceControllerResultOutput{}, options).(LookupSqlDiscoverySiteDataSourceControllerResultOutput), nil
