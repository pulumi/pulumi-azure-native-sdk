...
func NewSitesController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20230606:SitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSitesController(ctx *pulumi.Context,
	...
	var resource SitesController
	err := ctx.ReadResource("azure-native:offazure/v20230606:SitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
