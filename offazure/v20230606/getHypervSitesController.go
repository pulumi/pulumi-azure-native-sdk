...
func LookupHypervSitesController(ctx *pulumi.Context, args *LookupHypervSitesControllerArgs, opts ...pulumi.InvokeOption) (*LookupHypervSitesControllerResult, error) {
	...
	err := ctx.Invoke("azure-native:offazure/v20230606:getHypervSitesController", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHypervSitesControllerOutput(ctx *pulumi.Context, args LookupHypervSitesControllerOutputArgs, opts ...pulumi.InvokeOption) LookupHypervSitesControllerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHypervSitesControllerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazure/v20230606:getHypervSitesController", args, LookupHypervSitesControllerResultOutput{}, options).(LookupHypervSitesControllerResultOutput), nil
