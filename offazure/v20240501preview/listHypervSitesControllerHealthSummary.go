...
func ListHypervSitesControllerHealthSummary(ctx *pulumi.Context, args *ListHypervSitesControllerHealthSummaryArgs, opts ...pulumi.InvokeOption) (*ListHypervSitesControllerHealthSummaryResult, error) {
	...
	err := ctx.Invoke("azure-native:offazure/v20240501preview:listHypervSitesControllerHealthSummary", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListHypervSitesControllerHealthSummaryOutput(ctx *pulumi.Context, args ListHypervSitesControllerHealthSummaryOutputArgs, opts ...pulumi.InvokeOption) ListHypervSitesControllerHealthSummaryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListHypervSitesControllerHealthSummaryResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazure/v20240501preview:listHypervSitesControllerHealthSummary", args, ListHypervSitesControllerHealthSummaryResultOutput{}, options).(ListHypervSitesControllerHealthSummaryResultOutput), nil
