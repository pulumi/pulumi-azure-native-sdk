...
func NewHypervClusterControllerCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20240501preview:HypervClusterControllerCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHypervClusterControllerCluster(ctx *pulumi.Context,
	...
	var resource HypervClusterControllerCluster
	err := ctx.ReadResource("azure-native:offazure/v20240501preview:HypervClusterControllerCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
