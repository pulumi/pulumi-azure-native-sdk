...
func NewSitesController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20240501preview:SitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSitesController(ctx *pulumi.Context,
	...
	var resource SitesController
	err := ctx.ReadResource("azure-native:offazure/v20240501preview:SitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
