...
func ListServerSitesControllerHealthSummary(ctx *pulumi.Context, args *ListServerSitesControllerHealthSummaryArgs, opts ...pulumi.InvokeOption) (*ListServerSitesControllerHealthSummaryResult, error) {
	...
	err := ctx.Invoke("azure-native:offazure/v20240501preview:listServerSitesControllerHealthSummary", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListServerSitesControllerHealthSummaryOutput(ctx *pulumi.Context, args ListServerSitesControllerHealthSummaryOutputArgs, opts ...pulumi.InvokeOption) ListServerSitesControllerHealthSummaryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListServerSitesControllerHealthSummaryResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazure/v20240501preview:listServerSitesControllerHealthSummary", args, ListServerSitesControllerHealthSummaryResultOutput{}, options).(ListServerSitesControllerHealthSummaryResultOutput), nil
