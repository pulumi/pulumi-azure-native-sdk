...
func NewVcenterController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20240501preview:VcenterController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVcenterController(ctx *pulumi.Context,
	...
	var resource VcenterController
	err := ctx.ReadResource("azure-native:offazure/v20240501preview:VcenterController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
