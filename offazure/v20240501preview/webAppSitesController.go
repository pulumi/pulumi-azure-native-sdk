...
func NewWebAppSitesController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20240501preview:WebAppSitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebAppSitesController(ctx *pulumi.Context,
	...
	var resource WebAppSitesController
	err := ctx.ReadResource("azure-native:offazure/v20240501preview:WebAppSitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
