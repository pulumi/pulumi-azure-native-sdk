...
func LookupMasterSitesController(ctx *pulumi.Context, args *LookupMasterSitesControllerArgs, opts ...pulumi.InvokeOption) (*LookupMasterSitesControllerResult, error) {
	...
	err := ctx.Invoke("azure-native:offazure/v20240501preview:getMasterSitesController", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMasterSitesControllerOutput(ctx *pulumi.Context, args LookupMasterSitesControllerOutputArgs, opts ...pulumi.InvokeOption) LookupMasterSitesControllerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMasterSitesControllerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazure/v20240501preview:getMasterSitesController", args, LookupMasterSitesControllerResultOutput{}, options).(LookupMasterSitesControllerResultOutput), nil
