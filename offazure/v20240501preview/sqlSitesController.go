...
func NewSqlSitesController(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure/v20240501preview:SqlSitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlSitesController(ctx *pulumi.Context,
	...
	var resource SqlSitesController
	err := ctx.ReadResource("azure-native:offazure/v20240501preview:SqlSitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
