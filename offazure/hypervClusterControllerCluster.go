...
func NewHypervClusterControllerCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:offazure:HypervClusterControllerCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHypervClusterControllerCluster(ctx *pulumi.Context,
	...
	var resource HypervClusterControllerCluster
	err := ctx.ReadResource("azure-native:offazure:HypervClusterControllerCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
