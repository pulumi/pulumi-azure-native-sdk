...
func NewServerSitesController(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:offazure/v20240701preview:ServerSitesController"),
		},
		{
			Type: pulumi.String("azure-native:offazure/v20241201preview:ServerSitesController"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ServerSitesController
	err := ctx.RegisterResource("azure-native:offazure:ServerSitesController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerSitesController(ctx *pulumi.Context,
	...
	var resource ServerSitesController
	err := ctx.ReadResource("azure-native:offazure:ServerSitesController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ServerSitesControllerOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *ServerSitesController) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
