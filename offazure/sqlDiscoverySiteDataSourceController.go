...
func NewSqlDiscoverySiteDataSourceController(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:offazure/v20241201preview:SqlDiscoverySiteDataSourceController"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o SqlDiscoverySiteDataSourceControllerOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *SqlDiscoverySiteDataSourceController) commontypesv3.SystemDataResponseOutput {
		return v.SystemData
