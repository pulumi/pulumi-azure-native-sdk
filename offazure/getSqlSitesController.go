...
func LookupSqlSitesController(ctx *pulumi.Context, args *LookupSqlSitesControllerArgs, opts ...pulumi.InvokeOption) (*LookupSqlSitesControllerResult, error) {
	...
	err := ctx.Invoke("azure-native:offazure:getSqlSitesController", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSqlSitesControllerOutput(ctx *pulumi.Context, args LookupSqlSitesControllerOutputArgs, opts ...pulumi.InvokeOption) LookupSqlSitesControllerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSqlSitesControllerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:offazure:getSqlSitesController", args, LookupSqlSitesControllerResultOutput{}, options).(LookupSqlSitesControllerResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSqlSitesControllerResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSqlSitesControllerResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
