...
func NewPrivateEndpointConnectionController(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:offazure/v20241201preview:PrivateEndpointConnectionController"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:offazure:PrivateEndpointConnectionController", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionController(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionController
	err := ctx.ReadResource("azure-native:offazure:PrivateEndpointConnectionController", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PrivateEndpointConnectionControllerOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *PrivateEndpointConnectionController) commontypesv3.SystemDataResponseOutput {
		return v.SystemData
