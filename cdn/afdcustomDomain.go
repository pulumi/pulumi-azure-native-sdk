...
func NewAFDCustomDomain(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20220501preview:AFDCustomDomain"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20240501preview:AFDCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20240601preview:AFDCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20240901:AFDCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20250101preview:AFDCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20250415:AFDCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20250601:AFDCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20250701preview:AFDCustomDomain"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20250901preview:AFDCustomDomain"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AFDCustomDomainOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v *AFDCustomDomain) commontypesv6.SystemDataResponseOutput { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
