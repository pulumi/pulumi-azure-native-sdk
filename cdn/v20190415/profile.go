...
//
// Deprecated: Version 2019-04-15 will be removed in v2 of the provider.
// azure-native:cdn/v20190415:Profile is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20200901:Profile to guarantee forwards compatibility.
type Profile struct {
...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20190415:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azure-native:cdn/v20190415:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
