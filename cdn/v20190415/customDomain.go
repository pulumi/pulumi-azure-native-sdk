...
func NewCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20190415:CustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomDomain(ctx *pulumi.Context,
	...
	var resource CustomDomain
	err := ctx.ReadResource("azure-native:cdn/v20190415:CustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
