...
func NewOrigin(ctx *pulumi.Context,
	...
	var resource Origin
	err := ctx.RegisterResource("azure-native:cdn/v20200331:Origin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrigin(ctx *pulumi.Context,
	...
	var resource Origin
	err := ctx.ReadResource("azure-native:cdn/v20200331:Origin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
