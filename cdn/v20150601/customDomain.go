...
// azure-native:cdn/v20150601:CustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20161002:CustomDomain to guarantee forwards compatibility.
...
func NewCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20150601:CustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomDomain(ctx *pulumi.Context,
	...
	var resource CustomDomain
	err := ctx.ReadResource("azure-native:cdn/v20150601:CustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
