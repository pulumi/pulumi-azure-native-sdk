...
func LookupAFDOrigin(ctx *pulumi.Context, args *LookupAFDOriginArgs, opts ...pulumi.InvokeOption) (*LookupAFDOriginResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20240901:getAFDOrigin", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupAFDOriginOutput(ctx *pulumi.Context, args LookupAFDOriginOutputArgs, opts ...pulumi.InvokeOption) LookupAFDOriginResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAFDOriginResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn/v20240901:getAFDOrigin", args, LookupAFDOriginResultOutput{}, options).(LookupAFDOriginResultOutput), nil
