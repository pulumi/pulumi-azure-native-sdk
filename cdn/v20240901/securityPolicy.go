...
func NewSecurityPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20220501preview:SecurityPolicy"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20221101preview:SecurityPolicy"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20240601preview:SecurityPolicy"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cdn/v20240901:SecurityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPolicy(ctx *pulumi.Context,
	...
	var resource SecurityPolicy
	err := ctx.ReadResource("azure-native:cdn/v20240901:SecurityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The name of the profile which holds the security policy.
func (o SecurityPolicyOutput) ProfileName() pulumi.StringOutput {
	return o.ApplyT(func(v *SecurityPolicy) pulumi.StringOutput { return v.ProfileName }).(pulumi.StringOutput)
}
