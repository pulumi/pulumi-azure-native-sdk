...
func LookupOrigin(ctx *pulumi.Context, args *LookupOriginArgs, opts ...pulumi.InvokeOption) (*LookupOriginResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20240901:getOrigin", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupOriginOutput(ctx *pulumi.Context, args LookupOriginOutputArgs, opts ...pulumi.InvokeOption) LookupOriginResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOriginResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn/v20240901:getOrigin", args, LookupOriginResultOutput{}, options).(LookupOriginResultOutput), nil
