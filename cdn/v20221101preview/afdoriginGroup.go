...
func NewAFDOriginGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20221101preview:AFDOriginGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDOriginGroup(ctx *pulumi.Context,
	...
	var resource AFDOriginGroup
	err := ctx.ReadResource("azure-native:cdn/v20221101preview:AFDOriginGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
