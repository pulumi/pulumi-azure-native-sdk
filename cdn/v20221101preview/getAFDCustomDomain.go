...
//
// Deprecated: azure-native:cdn/v20221101preview:AFDCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDCustomDomain to guarantee forwards compatibility.
func LookupAFDCustomDomain(ctx *pulumi.Context, args *LookupAFDCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupAFDCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20221101preview:getAFDCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
