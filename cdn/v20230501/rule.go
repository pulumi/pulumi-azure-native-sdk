...
func NewRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.RegisterResource("azure-native:cdn/v20230501:Rule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.ReadResource("azure-native:cdn/v20230501:Rule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
