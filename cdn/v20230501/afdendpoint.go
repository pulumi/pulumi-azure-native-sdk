...
func NewAFDEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20230501:AFDEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDEndpoint(ctx *pulumi.Context,
	...
	var resource AFDEndpoint
	err := ctx.ReadResource("azure-native:cdn/v20230501:AFDEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
