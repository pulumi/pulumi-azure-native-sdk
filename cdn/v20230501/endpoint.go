...
func NewEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20230701preview:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20240201:Endpoint"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20240501preview:Endpoint"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cdn/v20230501:Endpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpoint(ctx *pulumi.Context,
	...
	var resource Endpoint
	err := ctx.ReadResource("azure-native:cdn/v20230501:Endpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
