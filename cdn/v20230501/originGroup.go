...
func NewOriginGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20230501:OriginGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOriginGroup(ctx *pulumi.Context,
	...
	var resource OriginGroup
	err := ctx.ReadResource("azure-native:cdn/v20230501:OriginGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
