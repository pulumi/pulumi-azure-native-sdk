...
func NewRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.RegisterResource("azure-native:cdn/v20230501:Route", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.ReadResource("azure-native:cdn/v20230501:Route", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
