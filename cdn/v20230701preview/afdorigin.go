...
func NewAFDOrigin(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20240501preview:AFDOrigin"),
		},
		{
			Type: pulumi.String("azure-native:cdn/v20240601preview:AFDOrigin"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cdn/v20230701preview:AFDOrigin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDOrigin(ctx *pulumi.Context,
	...
	var resource AFDOrigin
	err := ctx.ReadResource("azure-native:cdn/v20230701preview:AFDOrigin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
