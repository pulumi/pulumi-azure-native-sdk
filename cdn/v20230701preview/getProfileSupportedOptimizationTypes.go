...
func GetProfileSupportedOptimizationTypes(ctx *pulumi.Context, args *GetProfileSupportedOptimizationTypesArgs, opts ...pulumi.InvokeOption) (*GetProfileSupportedOptimizationTypesResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20230701preview:getProfileSupportedOptimizationTypes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetProfileSupportedOptimizationTypesOutput(ctx *pulumi.Context, args GetProfileSupportedOptimizationTypesOutputArgs, opts ...pulumi.InvokeOption) GetProfileSupportedOptimizationTypesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetProfileSupportedOptimizationTypesResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn/v20230701preview:getProfileSupportedOptimizationTypes", args, GetProfileSupportedOptimizationTypesResultOutput{}, options).(GetProfileSupportedOptimizationTypesResultOutput), nil
