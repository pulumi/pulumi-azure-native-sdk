...
func LookupAFDEndpoint(ctx *pulumi.Context, args *LookupAFDEndpointArgs, opts ...pulumi.InvokeOption) (*LookupAFDEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20230701preview:getAFDEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAFDEndpointOutput(ctx *pulumi.Context, args LookupAFDEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupAFDEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAFDEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn/v20230701preview:getAFDEndpoint", args, LookupAFDEndpointResultOutput{}, options).(LookupAFDEndpointResultOutput), nil
