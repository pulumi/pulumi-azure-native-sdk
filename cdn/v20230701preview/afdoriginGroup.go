...
func NewAFDOriginGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20240501preview:AFDOriginGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:cdn/v20230701preview:AFDOriginGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDOriginGroup(ctx *pulumi.Context,
	...
	var resource AFDOriginGroup
	err := ctx.ReadResource("azure-native:cdn/v20230701preview:AFDOriginGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
