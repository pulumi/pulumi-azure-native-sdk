...
func NewAFDCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20230701preview:AFDCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDCustomDomain(ctx *pulumi.Context,
	...
	var resource AFDCustomDomain
	err := ctx.ReadResource("azure-native:cdn/v20230701preview:AFDCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
