...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20160402:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azure-native:cdn/v20160402:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The SKU (pricing tier) of the CDN profile.
func (o ProfileOutput) Sku() SkuResponsePtrOutput {
	return o.ApplyT(func(v *Profile) SkuResponsePtrOutput { return v.Sku }).(SkuResponsePtrOutput)
}
