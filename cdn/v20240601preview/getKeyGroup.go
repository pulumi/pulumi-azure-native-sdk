...
func LookupKeyGroup(ctx *pulumi.Context, args *LookupKeyGroupArgs, opts ...pulumi.InvokeOption) (*LookupKeyGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20240601preview:getKeyGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupKeyGroupOutput(ctx *pulumi.Context, args LookupKeyGroupOutputArgs, opts ...pulumi.InvokeOption) LookupKeyGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupKeyGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn/v20240601preview:getKeyGroup", args, LookupKeyGroupResultOutput{}, options).(LookupKeyGroupResultOutput), nil
