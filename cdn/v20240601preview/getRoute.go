...
func LookupRoute(ctx *pulumi.Context, args *LookupRouteArgs, opts ...pulumi.InvokeOption) (*LookupRouteResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20240601preview:getRoute", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupRouteOutput(ctx *pulumi.Context, args LookupRouteOutputArgs, opts ...pulumi.InvokeOption) LookupRouteResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRouteResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn/v20240601preview:getRoute", args, LookupRouteResultOutput{}, options).(LookupRouteResultOutput), nil
...
// Whether or not gRPC is enabled on this route. Permitted values are 'Enabled' or 'Disabled'
func (o LookupRouteResultOutput) GrpcState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRouteResult) *string { return v.GrpcState }).(pulumi.StringPtrOutput)
}
