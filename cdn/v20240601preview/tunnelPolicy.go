...
func NewTunnelPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cdn:TunnelPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TunnelPolicy
	err := ctx.RegisterResource("azure-native:cdn/v20240601preview:TunnelPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTunnelPolicy(ctx *pulumi.Context,
	...
	var resource TunnelPolicy
	err := ctx.ReadResource("azure-native:cdn/v20240601preview:TunnelPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
