...
func LookupProfile(ctx *pulumi.Context, args *LookupProfileArgs, opts ...pulumi.InvokeOption) (*LookupProfileResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20240601preview:getProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupProfileOutput(ctx *pulumi.Context, args LookupProfileOutputArgs, opts ...pulumi.InvokeOption) LookupProfileResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupProfileResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn/v20240601preview:getProfile", args, LookupProfileResultOutput{}, options).(LookupProfileResultOutput), nil
