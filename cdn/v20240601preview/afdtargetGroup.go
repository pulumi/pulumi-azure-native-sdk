...
func NewAFDTargetGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:cdn:AFDTargetGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AFDTargetGroup
	err := ctx.RegisterResource("azure-native:cdn/v20240601preview:AFDTargetGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDTargetGroup(ctx *pulumi.Context,
	...
	var resource AFDTargetGroup
	err := ctx.ReadResource("azure-native:cdn/v20240601preview:AFDTargetGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
