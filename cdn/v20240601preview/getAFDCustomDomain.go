...
func LookupAFDCustomDomain(ctx *pulumi.Context, args *LookupAFDCustomDomainArgs, opts ...pulumi.InvokeOption) (*LookupAFDCustomDomainResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20240601preview:getAFDCustomDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupAFDCustomDomainResult struct {
	...
	MtlsSettings *AFDDomainMtlsParametersResponse `pulumi:"mtlsSettings"`
	// Resource name.
	...
	ReferencedRoutePaths []AFDDomainReferencedRoutePathResponse `pulumi:"referencedRoutePaths"`
...
func LookupAFDCustomDomainOutput(ctx *pulumi.Context, args LookupAFDCustomDomainOutputArgs, opts ...pulumi.InvokeOption) LookupAFDCustomDomainResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAFDCustomDomainResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn/v20240601preview:getAFDCustomDomain", args, LookupAFDCustomDomainResultOutput{}, options).(LookupAFDCustomDomainResultOutput), nil
...
// The configuration specifying how to enable mutual TLS for the domain, including specifying allowed FQDN and which server certificate(s) to use.
func (o LookupAFDCustomDomainResultOutput) MtlsSettings() AFDDomainMtlsParametersResponsePtrOutput {
	return o.ApplyT(func(v LookupAFDCustomDomainResult) *AFDDomainMtlsParametersResponse { return v.MtlsSettings }).(AFDDomainMtlsParametersResponsePtrOutput)
}
...
// The JSON object list that contains the overall picture of how routes are used for the shared custom domain across different profiles.
func (o LookupAFDCustomDomainResultOutput) ReferencedRoutePaths() AFDDomainReferencedRoutePathResponseArrayOutput {
	return o.ApplyT(func(v LookupAFDCustomDomainResult) []AFDDomainReferencedRoutePathResponse {
