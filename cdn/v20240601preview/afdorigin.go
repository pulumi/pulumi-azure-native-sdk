...
func NewAFDOrigin(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20240601preview:AFDOrigin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDOrigin(ctx *pulumi.Context,
	...
	var resource AFDOrigin
	err := ctx.ReadResource("azure-native:cdn/v20240601preview:AFDOrigin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
