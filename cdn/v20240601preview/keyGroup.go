...
func NewKeyGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20240601preview:KeyGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyGroup(ctx *pulumi.Context,
	...
	var resource KeyGroup
	err := ctx.ReadResource("azure-native:cdn/v20240601preview:KeyGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
