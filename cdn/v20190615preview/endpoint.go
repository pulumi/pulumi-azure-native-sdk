...
func NewEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20190615preview:Endpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpoint(ctx *pulumi.Context,
	...
	var resource Endpoint
	err := ctx.ReadResource("azure-native:cdn/v20190615preview:Endpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
