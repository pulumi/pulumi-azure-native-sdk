...
func LookupAFDEndpointOutput(ctx *pulumi.Context, args LookupAFDEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupAFDEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAFDEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:cdn:getAFDEndpoint", args, LookupAFDEndpointResultOutput{}, options).(LookupAFDEndpointResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupAFDEndpointResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAFDEndpointResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupAFDEndpointResultOutput) SystemData() commontypesv6.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupAFDEndpointResult) commontypesv6.SystemDataResponse { return v.SystemData }).(commontypesv6.SystemDataResponseOutput)
}
