...
type Route struct {
	...
	GrpcState pulumi.StringPtrOutput `pulumi:"grpcState"`
...
func NewRoute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20240601preview:Route"),
		},
		{
	...
	var resource Route
	err := ctx.RegisterResource("azure-native:cdn/v20240501preview:Route", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.ReadResource("azure-native:cdn/v20240501preview:Route", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type routeArgs struct {
	...
	// Whether or not gRPC is enabled on this route. Permitted values are 'Enabled' or 'Disabled'
	GrpcState *string `pulumi:"grpcState"`
	// Whether to automatically redirect HTTP traffic to HTTPS traffic. Note that this is a easy way to set up this rule and it will be the first rule that gets executed.
...
type RouteArgs struct {
	...
	// Whether or not gRPC is enabled on this route. Permitted values are 'Enabled' or 'Disabled'
	GrpcState pulumi.StringPtrInput
	// Whether to automatically redirect HTTP traffic to HTTPS traffic. Note that this is a easy way to set up this rule and it will be the first rule that gets executed.
...
// Whether or not gRPC is enabled on this route. Permitted values are 'Enabled' or 'Disabled'
func (o RouteOutput) GrpcState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Route) pulumi.StringPtrOutput { return v.GrpcState }).(pulumi.StringPtrOutput)
}
