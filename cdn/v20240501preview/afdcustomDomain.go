...
type AFDCustomDomain struct {
	...
	MtlsSettings AFDDomainMtlsParametersResponsePtrOutput `pulumi:"mtlsSettings"`
	// Resource name.
...
func NewAFDCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20240501preview:AFDCustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDCustomDomain(ctx *pulumi.Context,
	...
	var resource AFDCustomDomain
	err := ctx.ReadResource("azure-native:cdn/v20240501preview:AFDCustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type afdcustomDomainArgs struct {
	...
	// The configuration specifying how to enable mutual TLS for the domain, including specifying allowed FQDN and which server certificate(s) to use.
	MtlsSettings *AFDDomainMtlsParameters `pulumi:"mtlsSettings"`
	// Resource reference to the Azure resource where custom domain ownership was prevalidated
...
type AFDCustomDomainArgs struct {
	...
	// The configuration specifying how to enable mutual TLS for the domain, including specifying allowed FQDN and which server certificate(s) to use.
	MtlsSettings AFDDomainMtlsParametersPtrInput
	// Resource reference to the Azure resource where custom domain ownership was prevalidated
...
// The configuration specifying how to enable mutual TLS for the domain, including specifying allowed FQDN and which server certificate(s) to use.
func (o AFDCustomDomainOutput) MtlsSettings() AFDDomainMtlsParametersResponsePtrOutput {
	return o.ApplyT(func(v *AFDCustomDomain) AFDDomainMtlsParametersResponsePtrOutput { return v.MtlsSettings }).(AFDDomainMtlsParametersResponsePtrOutput)
}
