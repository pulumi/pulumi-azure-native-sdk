...
//
// Deprecated: azure-native:cdn/v20200901:OriginGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:OriginGroup to guarantee forwards compatibility.
...
func NewOriginGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20200901:OriginGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOriginGroup(ctx *pulumi.Context,
	...
	var resource OriginGroup
	err := ctx.ReadResource("azure-native:cdn/v20200901:OriginGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
