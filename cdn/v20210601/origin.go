...
//
// Deprecated: azure-native:cdn/v20210601:Origin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Origin to guarantee forwards compatibility.
type Origin struct {
...
func NewOrigin(ctx *pulumi.Context,
	...
	var resource Origin
	err := ctx.RegisterResource("azure-native:cdn/v20210601:Origin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrigin(ctx *pulumi.Context,
	...
	var resource Origin
	err := ctx.ReadResource("azure-native:cdn/v20210601:Origin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
