...
//
// Deprecated: azure-native:cdn/v20210601:AFDOriginGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:AFDOriginGroup to guarantee forwards compatibility.
...
func NewAFDOriginGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20210601:AFDOriginGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDOriginGroup(ctx *pulumi.Context,
	...
	var resource AFDOriginGroup
	err := ctx.ReadResource("azure-native:cdn/v20210601:AFDOriginGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
