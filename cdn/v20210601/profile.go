...
//
// Deprecated: azure-native:cdn/v20210601:Profile is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Profile to guarantee forwards compatibility.
type Profile struct {
...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20210601:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("azure-native:cdn/v20210601:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
