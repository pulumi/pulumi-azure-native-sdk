...
func NewSecurityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20240201:SecurityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPolicy(ctx *pulumi.Context,
	...
	var resource SecurityPolicy
	err := ctx.ReadResource("azure-native:cdn/v20240201:SecurityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
