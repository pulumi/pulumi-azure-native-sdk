...
func NewRuleSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:cdn/v20220501preview:RuleSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuleSet(ctx *pulumi.Context,
	...
	var resource RuleSet
	err := ctx.ReadResource("azure-native:cdn/v20220501preview:RuleSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
