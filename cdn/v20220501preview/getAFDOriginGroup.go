...
//
// Deprecated: azure-native:cdn/v20220501preview:AFDOriginGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDOriginGroup to guarantee forwards compatibility.
func LookupAFDOriginGroup(ctx *pulumi.Context, args *LookupAFDOriginGroupArgs, opts ...pulumi.InvokeOption) (*LookupAFDOriginGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20220501preview:getAFDOriginGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
