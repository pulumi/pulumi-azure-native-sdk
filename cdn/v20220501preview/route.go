...
//
// Deprecated: azure-native:cdn/v20220501preview:Route is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Route to guarantee forwards compatibility.
type Route struct {
