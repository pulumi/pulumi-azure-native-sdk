...
//
// Deprecated: azure-native:cdn/v20220501preview:AFDEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:AFDEndpoint to guarantee forwards compatibility.
func LookupAFDEndpoint(ctx *pulumi.Context, args *LookupAFDEndpointArgs, opts ...pulumi.InvokeOption) (*LookupAFDEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:cdn/v20220501preview:getAFDEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
