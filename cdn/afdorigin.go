...
func NewAFDOrigin(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:cdn/v20251201:AFDOrigin"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AFDOrigin
	err := ctx.RegisterResource("azure-native:cdn:AFDOrigin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAFDOrigin(ctx *pulumi.Context,
	...
	var resource AFDOrigin
	err := ctx.ReadResource("azure-native:cdn:AFDOrigin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
