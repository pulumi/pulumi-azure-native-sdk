...
// ActionRoutingInput is an input type that accepts values of the ActionRouting enum
// A concrete instance of `ActionRoutingInput` can be one of the following:
//
//	ActionRoutingProxy
...
// ResourceTypeRoutingInput is an input type that accepts values of the ResourceTypeRouting enum
// A concrete instance of `ResourceTypeRoutingInput` can be one of the following:
//
