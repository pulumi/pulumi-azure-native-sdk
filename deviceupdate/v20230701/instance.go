...
func NewInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:deviceupdate/v20230701:Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstance(ctx *pulumi.Context,
	...
	var resource Instance
	err := ctx.ReadResource("azure-native:deviceupdate/v20230701:Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
