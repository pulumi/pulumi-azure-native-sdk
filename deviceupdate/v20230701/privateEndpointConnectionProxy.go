...
func NewPrivateEndpointConnectionProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnectionProxy(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnectionProxy
	err := ctx.ReadResource("azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
