...
//
// Deprecated: azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy to guarantee forwards compatibility.
func LookupPrivateEndpointConnectionProxy(ctx *pulumi.Context, args *LookupPrivateEndpointConnectionProxyArgs, opts ...pulumi.InvokeOption) (*LookupPrivateEndpointConnectionProxyResult, error) {
	...
	err := ctx.Invoke("azure-native:deviceupdate/v20221201preview:getPrivateEndpointConnectionProxy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
