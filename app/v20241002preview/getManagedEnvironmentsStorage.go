...
func LookupManagedEnvironmentsStorage(ctx *pulumi.Context, args *LookupManagedEnvironmentsStorageArgs, opts ...pulumi.InvokeOption) (*LookupManagedEnvironmentsStorageResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20241002preview:getManagedEnvironmentsStorage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagedEnvironmentsStorageOutput(ctx *pulumi.Context, args LookupManagedEnvironmentsStorageOutputArgs, opts ...pulumi.InvokeOption) LookupManagedEnvironmentsStorageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagedEnvironmentsStorageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20241002preview:getManagedEnvironmentsStorage", args, LookupManagedEnvironmentsStorageResultOutput{}, options).(LookupManagedEnvironmentsStorageResultOutput), nil
