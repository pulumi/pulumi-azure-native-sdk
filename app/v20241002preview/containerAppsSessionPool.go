...
func NewContainerAppsSessionPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20241002preview:ContainerAppsSessionPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAppsSessionPool(ctx *pulumi.Context,
	...
	var resource ContainerAppsSessionPool
	err := ctx.ReadResource("azure-native:app/v20241002preview:ContainerAppsSessionPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
