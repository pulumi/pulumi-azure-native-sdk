...
func LookupConnectedEnvironmentsCertificate(ctx *pulumi.Context, args *LookupConnectedEnvironmentsCertificateArgs, opts ...pulumi.InvokeOption) (*LookupConnectedEnvironmentsCertificateResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20241002preview:getConnectedEnvironmentsCertificate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConnectedEnvironmentsCertificateOutput(ctx *pulumi.Context, args LookupConnectedEnvironmentsCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupConnectedEnvironmentsCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConnectedEnvironmentsCertificateResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20241002preview:getConnectedEnvironmentsCertificate", args, LookupConnectedEnvironmentsCertificateResultOutput{}, options).(LookupConnectedEnvironmentsCertificateResultOutput), nil
