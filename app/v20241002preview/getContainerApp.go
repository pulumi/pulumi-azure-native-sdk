...
func LookupContainerApp(ctx *pulumi.Context, args *LookupContainerAppArgs, opts ...pulumi.InvokeOption) (*LookupContainerAppResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20241002preview:getContainerApp", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupContainerAppOutput(ctx *pulumi.Context, args LookupContainerAppOutputArgs, opts ...pulumi.InvokeOption) LookupContainerAppResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContainerAppResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20241002preview:getContainerApp", args, LookupContainerAppResultOutput{}, options).(LookupContainerAppResultOutput), nil
