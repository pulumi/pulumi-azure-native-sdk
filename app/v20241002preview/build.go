...
func NewBuild(ctx *pulumi.Context,
	...
	var resource Build
	err := ctx.RegisterResource("azure-native:app/v20241002preview:Build", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuild(ctx *pulumi.Context,
	...
	var resource Build
	err := ctx.ReadResource("azure-native:app/v20241002preview:Build", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
