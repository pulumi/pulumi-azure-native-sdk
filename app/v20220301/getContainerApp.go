...
// Container App.
//
// Deprecated: azure-native:app/v20220301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:ContainerApp to guarantee forwards compatibility.
func LookupContainerApp(ctx *pulumi.Context, args *LookupContainerAppArgs, opts ...pulumi.InvokeOption) (*LookupContainerAppResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20220301:getContainerApp", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
