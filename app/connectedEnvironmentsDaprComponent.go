...
func NewConnectedEnvironmentsDaprComponent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:app/v20250701:ConnectedEnvironmentsDaprComponent"),
		},
		{
			Type: pulumi.String("azure-native:app/v20251002preview:ConnectedEnvironmentsDaprComponent"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ConnectedEnvironmentsDaprComponentOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ConnectedEnvironmentsDaprComponent) commontypesv5.SystemDataResponseOutput {
		return v.SystemData
