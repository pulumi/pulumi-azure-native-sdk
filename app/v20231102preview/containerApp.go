...
func NewContainerApp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20231102preview:ContainerApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerApp(ctx *pulumi.Context,
	...
	var resource ContainerApp
	err := ctx.ReadResource("azure-native:app/v20231102preview:ContainerApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
