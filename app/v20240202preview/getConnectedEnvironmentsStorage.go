...
func LookupConnectedEnvironmentsStorage(ctx *pulumi.Context, args *LookupConnectedEnvironmentsStorageArgs, opts ...pulumi.InvokeOption) (*LookupConnectedEnvironmentsStorageResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20240202preview:getConnectedEnvironmentsStorage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupConnectedEnvironmentsStorageOutput(ctx *pulumi.Context, args LookupConnectedEnvironmentsStorageOutputArgs, opts ...pulumi.InvokeOption) LookupConnectedEnvironmentsStorageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConnectedEnvironmentsStorageResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20240202preview:getConnectedEnvironmentsStorage", args, LookupConnectedEnvironmentsStorageResultOutput{}, options).(LookupConnectedEnvironmentsStorageResultOutput), nil
