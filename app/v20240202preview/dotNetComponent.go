...
func NewDotNetComponent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240202preview:DotNetComponent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDotNetComponent(ctx *pulumi.Context,
	...
	var resource DotNetComponent
	err := ctx.ReadResource("azure-native:app/v20240202preview:DotNetComponent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
