...
func LookupDaprComponent(ctx *pulumi.Context, args *LookupDaprComponentArgs, opts ...pulumi.InvokeOption) (*LookupDaprComponentResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20240202preview:getDaprComponent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupDaprComponentOutput(ctx *pulumi.Context, args LookupDaprComponentOutputArgs, opts ...pulumi.InvokeOption) LookupDaprComponentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDaprComponentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20240202preview:getDaprComponent", args, LookupDaprComponentResultOutput{}, options).(LookupDaprComponentResultOutput), nil
