...
func NewDaprComponent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240202preview:DaprComponent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDaprComponent(ctx *pulumi.Context,
	...
	var resource DaprComponent
	err := ctx.ReadResource("azure-native:app/v20240202preview:DaprComponent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
