...
func NewConnectedEnvironmentsStorage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240202preview:ConnectedEnvironmentsStorage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedEnvironmentsStorage(ctx *pulumi.Context,
	...
	var resource ConnectedEnvironmentsStorage
	err := ctx.ReadResource("azure-native:app/v20240202preview:ConnectedEnvironmentsStorage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
