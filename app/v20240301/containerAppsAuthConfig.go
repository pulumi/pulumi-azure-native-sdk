...
func NewContainerAppsAuthConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240301:ContainerAppsAuthConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAppsAuthConfig(ctx *pulumi.Context,
	...
	var resource ContainerAppsAuthConfig
	err := ctx.ReadResource("azure-native:app/v20240301:ContainerAppsAuthConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
