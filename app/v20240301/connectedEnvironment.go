...
func NewConnectedEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240301:ConnectedEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedEnvironment(ctx *pulumi.Context,
	...
	var resource ConnectedEnvironment
	err := ctx.ReadResource("azure-native:app/v20240301:ConnectedEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
