...
func ListContainerAppCustomHostNameAnalysis(ctx *pulumi.Context, args *ListContainerAppCustomHostNameAnalysisArgs, opts ...pulumi.InvokeOption) (*ListContainerAppCustomHostNameAnalysisResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20240301:listContainerAppCustomHostNameAnalysis", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListContainerAppCustomHostNameAnalysisOutput(ctx *pulumi.Context, args ListContainerAppCustomHostNameAnalysisOutputArgs, opts ...pulumi.InvokeOption) ListContainerAppCustomHostNameAnalysisResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListContainerAppCustomHostNameAnalysisResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20240301:listContainerAppCustomHostNameAnalysis", args, ListContainerAppCustomHostNameAnalysisResultOutput{}, options).(ListContainerAppCustomHostNameAnalysisResultOutput), nil
