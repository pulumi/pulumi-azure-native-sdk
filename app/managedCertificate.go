...
func NewManagedCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:app/v20250701:ManagedCertificate"),
		},
		{
			Type: pulumi.String("azure-native:app/v20251002preview:ManagedCertificate"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ManagedCertificateOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ManagedCertificate) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
