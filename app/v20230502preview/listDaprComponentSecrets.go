...
func ListDaprComponentSecrets(ctx *pulumi.Context, args *ListDaprComponentSecretsArgs, opts ...pulumi.InvokeOption) (*ListDaprComponentSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20230502preview:listDaprComponentSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListDaprComponentSecretsOutput(ctx *pulumi.Context, args ListDaprComponentSecretsOutputArgs, opts ...pulumi.InvokeOption) ListDaprComponentSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListDaprComponentSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20230502preview:listDaprComponentSecrets", args, ListDaprComponentSecretsResultOutput{}, options).(ListDaprComponentSecretsResultOutput), nil
