...
func LookupContainerAppsAuthConfig(ctx *pulumi.Context, args *LookupContainerAppsAuthConfigArgs, opts ...pulumi.InvokeOption) (*LookupContainerAppsAuthConfigResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20230502preview:getContainerAppsAuthConfig", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupContainerAppsAuthConfigOutput(ctx *pulumi.Context, args LookupContainerAppsAuthConfigOutputArgs, opts ...pulumi.InvokeOption) LookupContainerAppsAuthConfigResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContainerAppsAuthConfigResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20230502preview:getContainerAppsAuthConfig", args, LookupContainerAppsAuthConfigResultOutput{}, options).(LookupContainerAppsAuthConfigResultOutput), nil
