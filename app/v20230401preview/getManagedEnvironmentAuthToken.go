...
func GetManagedEnvironmentAuthToken(ctx *pulumi.Context, args *GetManagedEnvironmentAuthTokenArgs, opts ...pulumi.InvokeOption) (*GetManagedEnvironmentAuthTokenResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20230401preview:getManagedEnvironmentAuthToken", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetManagedEnvironmentAuthTokenOutput(ctx *pulumi.Context, args GetManagedEnvironmentAuthTokenOutputArgs, opts ...pulumi.InvokeOption) GetManagedEnvironmentAuthTokenResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetManagedEnvironmentAuthTokenResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20230401preview:getManagedEnvironmentAuthToken", args, GetManagedEnvironmentAuthTokenResultOutput{}, options).(GetManagedEnvironmentAuthTokenResultOutput), nil
