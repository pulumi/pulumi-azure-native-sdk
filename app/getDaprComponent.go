...
func LookupDaprComponentOutput(ctx *pulumi.Context, args LookupDaprComponentOutputArgs, opts ...pulumi.InvokeOption) LookupDaprComponentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDaprComponentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app:getDaprComponent", args, LookupDaprComponentResultOutput{}, options).(LookupDaprComponentResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupDaprComponentResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDaprComponentResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupDaprComponentResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDaprComponentResult) commontypesv5.SystemDataResponse { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
