...
func NewCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:app/v20241002preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:app/v20250101:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:app/v20250202preview:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:app/v20250701:Certificate"),
		},
		{
			Type: pulumi.String("azure-native:app/v20251002preview:Certificate"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CertificateOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Certificate) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
