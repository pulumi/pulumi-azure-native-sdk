...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupConnectedEnvironmentsCertificateResultOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupConnectedEnvironmentsCertificateResult) commontypesv5.SystemDataResponse {
		return v.SystemData
