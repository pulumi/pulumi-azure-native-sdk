...
func NewManagedEnvironmentsStorage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20221101preview:ManagedEnvironmentsStorage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedEnvironmentsStorage(ctx *pulumi.Context,
	...
	var resource ManagedEnvironmentsStorage
	err := ctx.ReadResource("azure-native:app/v20221101preview:ManagedEnvironmentsStorage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
