...
func NewLogicApp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240802preview:LogicApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogicApp(ctx *pulumi.Context,
	...
	var resource LogicApp
	err := ctx.ReadResource("azure-native:app/v20240802preview:LogicApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
