...
func NewManagedEnvironmentPrivateEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240802preview:ManagedEnvironmentPrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedEnvironmentPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource ManagedEnvironmentPrivateEndpointConnection
	err := ctx.ReadResource("azure-native:app/v20240802preview:ManagedEnvironmentPrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
