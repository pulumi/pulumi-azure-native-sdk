...
func NewBuilder(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:app:Builder"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Builder
	err := ctx.RegisterResource("azure-native:app/v20240802preview:Builder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuilder(ctx *pulumi.Context,
	...
	var resource Builder
	err := ctx.ReadResource("azure-native:app/v20240802preview:Builder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
