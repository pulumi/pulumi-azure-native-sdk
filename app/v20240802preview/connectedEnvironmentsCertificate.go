...
func NewConnectedEnvironmentsCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240802preview:ConnectedEnvironmentsCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedEnvironmentsCertificate(ctx *pulumi.Context,
	...
	var resource ConnectedEnvironmentsCertificate
	err := ctx.ReadResource("azure-native:app/v20240802preview:ConnectedEnvironmentsCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
