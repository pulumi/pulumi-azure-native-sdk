...
func NewAppResiliency(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20240802preview:AppResiliency", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppResiliency(ctx *pulumi.Context,
	...
	var resource AppResiliency
	err := ctx.ReadResource("azure-native:app/v20240802preview:AppResiliency", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
