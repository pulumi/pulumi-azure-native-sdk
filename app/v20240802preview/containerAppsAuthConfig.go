...
func NewContainerAppsAuthConfig(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:app/v20230502preview:ContainerAppsAuthConfig"),
		},
		{
			Type: pulumi.String("azure-native:app/v20230801preview:ContainerAppsAuthConfig"),
		},
		{
			Type: pulumi.String("azure-native:app/v20231102preview:ContainerAppsAuthConfig"),
		},
		{
			Type: pulumi.String("azure-native:app/v20240202preview:ContainerAppsAuthConfig"),
		},
		{
			Type: pulumi.String("azure-native:app/v20240301:ContainerAppsAuthConfig"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:app/v20240802preview:ContainerAppsAuthConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAppsAuthConfig(ctx *pulumi.Context,
	...
	var resource ContainerAppsAuthConfig
	err := ctx.ReadResource("azure-native:app/v20240802preview:ContainerAppsAuthConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
