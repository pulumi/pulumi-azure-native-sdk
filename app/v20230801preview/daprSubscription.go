...
func NewDaprSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20230801preview:DaprSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDaprSubscription(ctx *pulumi.Context,
	...
	var resource DaprSubscription
	err := ctx.ReadResource("azure-native:app/v20230801preview:DaprSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *DaprSubscription) ToOutput(ctx context.Context) pulumix.Output[*DaprSubscription] {
	return pulumix.Output[*DaprSubscription]{
		OutputState: i.ToDaprSubscriptionOutputWithContext(ctx).OutputState,
	}
}
...
func (o DaprSubscriptionOutput) ToOutput(ctx context.Context) pulumix.Output[*DaprSubscription] {
	return pulumix.Output[*DaprSubscription]{
