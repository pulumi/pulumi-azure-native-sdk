...
func LookupConnectedEnvironmentsDaprComponent(ctx *pulumi.Context, args *LookupConnectedEnvironmentsDaprComponentArgs, opts ...pulumi.InvokeOption) (*LookupConnectedEnvironmentsDaprComponentResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20230801preview:getConnectedEnvironmentsDaprComponent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupConnectedEnvironmentsDaprComponentOutput(ctx *pulumi.Context, args LookupConnectedEnvironmentsDaprComponentOutputArgs, opts ...pulumi.InvokeOption) LookupConnectedEnvironmentsDaprComponentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupConnectedEnvironmentsDaprComponentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20230801preview:getConnectedEnvironmentsDaprComponent", args, LookupConnectedEnvironmentsDaprComponentResultOutput{}, options).(LookupConnectedEnvironmentsDaprComponentResultOutput), nil
