...
func NewManagedEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20230801preview:ManagedEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedEnvironment(ctx *pulumi.Context,
	...
	var resource ManagedEnvironment
	err := ctx.ReadResource("azure-native:app/v20230801preview:ManagedEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
