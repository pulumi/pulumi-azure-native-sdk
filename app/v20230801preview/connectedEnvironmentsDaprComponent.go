...
func NewConnectedEnvironmentsDaprComponent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20230801preview:ConnectedEnvironmentsDaprComponent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectedEnvironmentsDaprComponent(ctx *pulumi.Context,
	...
	var resource ConnectedEnvironmentsDaprComponent
	err := ctx.ReadResource("azure-native:app/v20230801preview:ConnectedEnvironmentsDaprComponent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
