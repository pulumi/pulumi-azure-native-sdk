...
func NewContainerAppsSourceControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20230801preview:ContainerAppsSourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAppsSourceControl(ctx *pulumi.Context,
	...
	var resource ContainerAppsSourceControl
	err := ctx.ReadResource("azure-native:app/v20230801preview:ContainerAppsSourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
