...
func NewBuilder(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20230801preview:Builder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuilder(ctx *pulumi.Context,
	...
	var resource Builder
	err := ctx.ReadResource("azure-native:app/v20230801preview:Builder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
