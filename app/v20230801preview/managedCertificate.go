...
func NewManagedCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:app/v20230801preview:ManagedCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedCertificate(ctx *pulumi.Context,
	...
	var resource ManagedCertificate
	err := ctx.ReadResource("azure-native:app/v20230801preview:ManagedCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
