...
func ListConnectedEnvironmentsDaprComponentSecrets(ctx *pulumi.Context, args *ListConnectedEnvironmentsDaprComponentSecretsArgs, opts ...pulumi.InvokeOption) (*ListConnectedEnvironmentsDaprComponentSecretsResult, error) {
	...
	err := ctx.Invoke("azure-native:app/v20230801preview:listConnectedEnvironmentsDaprComponentSecrets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListConnectedEnvironmentsDaprComponentSecretsOutput(ctx *pulumi.Context, args ListConnectedEnvironmentsDaprComponentSecretsOutputArgs, opts ...pulumi.InvokeOption) ListConnectedEnvironmentsDaprComponentSecretsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListConnectedEnvironmentsDaprComponentSecretsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:app/v20230801preview:listConnectedEnvironmentsDaprComponentSecrets", args, ListConnectedEnvironmentsDaprComponentSecretsResultOutput{}, options).(ListConnectedEnvironmentsDaprComponentSecretsResultOutput), nil
