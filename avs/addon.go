...
func NewAddon(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20250901:Addon"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AddonOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Addon) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
