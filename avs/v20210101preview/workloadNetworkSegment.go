...
// NSX Segment
//
// Deprecated: azure-native:avs/v20210101preview:WorkloadNetworkSegment is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkSegment to guarantee forwards compatibility.
...
func NewWorkloadNetworkSegment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20210101preview:WorkloadNetworkSegment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkSegment(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkSegment
	err := ctx.ReadResource("azure-native:avs/v20210101preview:WorkloadNetworkSegment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
