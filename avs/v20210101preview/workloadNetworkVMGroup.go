...
// NSX VM Group
//
// Deprecated: azure-native:avs/v20210101preview:WorkloadNetworkVMGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkVMGroup to guarantee forwards compatibility.
...
func NewWorkloadNetworkVMGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20210101preview:WorkloadNetworkVMGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkVMGroup(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkVMGroup
	err := ctx.ReadResource("azure-native:avs/v20210101preview:WorkloadNetworkVMGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
