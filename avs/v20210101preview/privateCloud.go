...
//
// Deprecated: azure-native:avs/v20210101preview:PrivateCloud is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:PrivateCloud to guarantee forwards compatibility.
...
func NewPrivateCloud(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20210101preview:PrivateCloud", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateCloud(ctx *pulumi.Context,
	...
	var resource PrivateCloud
	err := ctx.ReadResource("azure-native:avs/v20210101preview:PrivateCloud", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
