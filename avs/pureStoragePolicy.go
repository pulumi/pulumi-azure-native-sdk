...
func NewPureStoragePolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20250901:PureStoragePolicy"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PureStoragePolicyOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *PureStoragePolicy) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
