...
func NewScriptExecution(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20250901:ScriptExecution"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ScriptExecutionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *ScriptExecution) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
