...
func NewWorkloadNetworkPublicIP(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20250901:WorkloadNetworkPublicIP"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WorkloadNetworkPublicIPOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *WorkloadNetworkPublicIP) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
