...
// NSX Port Mirroring
//
// Deprecated: azure-native:avs/v20200717preview:WorkloadNetworkPortMirroring is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkPortMirroring to guarantee forwards compatibility.
...
func NewWorkloadNetworkPortMirroring(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20200717preview:WorkloadNetworkPortMirroring", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkPortMirroring(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkPortMirroring
	err := ctx.ReadResource("azure-native:avs/v20200717preview:WorkloadNetworkPortMirroring", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
