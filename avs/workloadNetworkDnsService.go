...
func NewWorkloadNetworkDnsService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20240901:WorkloadNetworkDnsService"),
		},
		{
			Type: pulumi.String("azure-native:avs/v20250901:WorkloadNetworkDnsService"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WorkloadNetworkDnsServiceOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *WorkloadNetworkDnsService) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
