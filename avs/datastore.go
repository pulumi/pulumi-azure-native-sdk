...
func NewDatastore(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20250901:Datastore"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o DatastoreOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Datastore) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
