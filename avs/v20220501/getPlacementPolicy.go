...
func LookupPlacementPolicy(ctx *pulumi.Context, args *LookupPlacementPolicyArgs, opts ...pulumi.InvokeOption) (*LookupPlacementPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20220501:getPlacementPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPlacementPolicyOutput(ctx *pulumi.Context, args LookupPlacementPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupPlacementPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPlacementPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20220501:getPlacementPolicy", args, LookupPlacementPolicyResultOutput{}, options).(LookupPlacementPolicyResultOutput), nil
