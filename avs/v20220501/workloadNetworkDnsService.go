...
func NewWorkloadNetworkDnsService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20220501:WorkloadNetworkDnsService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkDnsService(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkDnsService
	err := ctx.ReadResource("azure-native:avs/v20220501:WorkloadNetworkDnsService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *WorkloadNetworkDnsService) ToOutput(ctx context.Context) pulumix.Output[*WorkloadNetworkDnsService] {
	return pulumix.Output[*WorkloadNetworkDnsService]{
		OutputState: i.ToWorkloadNetworkDnsServiceOutputWithContext(ctx).OutputState,
	}
}
...
func (o WorkloadNetworkDnsServiceOutput) ToOutput(ctx context.Context) pulumix.Output[*WorkloadNetworkDnsService] {
	return pulumix.Output[*WorkloadNetworkDnsService]{
