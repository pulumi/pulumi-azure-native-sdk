...
func NewWorkloadNetworkDnsZone(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20220501:WorkloadNetworkDnsZone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkDnsZone(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkDnsZone
	err := ctx.ReadResource("azure-native:avs/v20220501:WorkloadNetworkDnsZone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
