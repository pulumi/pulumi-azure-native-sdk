...
func NewScriptExecution(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20220501:ScriptExecution", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScriptExecution(ctx *pulumi.Context,
	...
	var resource ScriptExecution
	err := ctx.ReadResource("azure-native:avs/v20220501:ScriptExecution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
