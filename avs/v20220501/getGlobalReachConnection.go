...
func (o LookupGlobalReachConnectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupGlobalReachConnectionResult] {
	return pulumix.Output[LookupGlobalReachConnectionResult]{
