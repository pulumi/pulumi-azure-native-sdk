...
// NSX DNS Zone
//
// Deprecated: azure-native:avs/v20210601:WorkloadNetworkDnsZone is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDnsZone to guarantee forwards compatibility.
func LookupWorkloadNetworkDnsZone(ctx *pulumi.Context, args *LookupWorkloadNetworkDnsZoneArgs, opts ...pulumi.InvokeOption) (*LookupWorkloadNetworkDnsZoneResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20210601:getWorkloadNetworkDnsZone", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
