...
func NewWorkloadNetworkVMGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20210601:WorkloadNetworkVMGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkVMGroup(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkVMGroup
	err := ctx.ReadResource("azure-native:avs/v20210601:WorkloadNetworkVMGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
