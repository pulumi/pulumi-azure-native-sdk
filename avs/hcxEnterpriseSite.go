...
func NewHcxEnterpriseSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20240901:HcxEnterpriseSite"),
		},
		{
			Type: pulumi.String("azure-native:avs/v20250901:HcxEnterpriseSite"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o HcxEnterpriseSiteOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *HcxEnterpriseSite) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
