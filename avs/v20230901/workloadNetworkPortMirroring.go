...
func NewWorkloadNetworkPortMirroring(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230901:WorkloadNetworkPortMirroring", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkPortMirroring(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkPortMirroring
	err := ctx.ReadResource("azure-native:avs/v20230901:WorkloadNetworkPortMirroring", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
