...
func LookupWorkloadNetworkSegment(ctx *pulumi.Context, args *LookupWorkloadNetworkSegmentArgs, opts ...pulumi.InvokeOption) (*LookupWorkloadNetworkSegmentResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230901:getWorkloadNetworkSegment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkloadNetworkSegmentOutput(ctx *pulumi.Context, args LookupWorkloadNetworkSegmentOutputArgs, opts ...pulumi.InvokeOption) LookupWorkloadNetworkSegmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkloadNetworkSegmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20230901:getWorkloadNetworkSegment", args, LookupWorkloadNetworkSegmentResultOutput{}, options).(LookupWorkloadNetworkSegmentResultOutput), nil
