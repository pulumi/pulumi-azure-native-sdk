...
func LookupWorkloadNetworkDhcp(ctx *pulumi.Context, args *LookupWorkloadNetworkDhcpArgs, opts ...pulumi.InvokeOption) (*LookupWorkloadNetworkDhcpResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230901:getWorkloadNetworkDhcp", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkloadNetworkDhcpOutput(ctx *pulumi.Context, args LookupWorkloadNetworkDhcpOutputArgs, opts ...pulumi.InvokeOption) LookupWorkloadNetworkDhcpResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkloadNetworkDhcpResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20230901:getWorkloadNetworkDhcp", args, LookupWorkloadNetworkDhcpResultOutput{}, options).(LookupWorkloadNetworkDhcpResultOutput), nil
