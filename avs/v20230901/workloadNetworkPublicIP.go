...
func NewWorkloadNetworkPublicIP(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230901:WorkloadNetworkPublicIP", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkPublicIP(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkPublicIP
	err := ctx.ReadResource("azure-native:avs/v20230901:WorkloadNetworkPublicIP", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
