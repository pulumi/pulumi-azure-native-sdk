...
func NewHcxEnterpriseSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230901:HcxEnterpriseSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHcxEnterpriseSite(ctx *pulumi.Context,
	...
	var resource HcxEnterpriseSite
	err := ctx.ReadResource("azure-native:avs/v20230901:HcxEnterpriseSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
