...
func NewWorkloadNetworkDnsZone(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230901:WorkloadNetworkDnsZone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkDnsZone(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkDnsZone
	err := ctx.ReadResource("azure-native:avs/v20230901:WorkloadNetworkDnsZone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Number of DNS Services using the DNS zone.
func (o WorkloadNetworkDnsZoneOutput) DnsServices() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *WorkloadNetworkDnsZone) pulumi.IntPtrOutput { return v.DnsServices }).(pulumi.IntPtrOutput)
}
