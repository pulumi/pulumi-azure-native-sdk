...
func NewWorkloadNetworkSegment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230901:WorkloadNetworkSegment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkSegment(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkSegment
	err := ctx.ReadResource("azure-native:avs/v20230901:WorkloadNetworkSegment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
