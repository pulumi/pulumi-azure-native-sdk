...
func NewWorkloadNetworkDhcp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230901:WorkloadNetworkDhcp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkDhcp(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkDhcp
	err := ctx.ReadResource("azure-native:avs/v20230901:WorkloadNetworkDhcp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
