...
func LookupWorkloadNetworkVMGroup(ctx *pulumi.Context, args *LookupWorkloadNetworkVMGroupArgs, opts ...pulumi.InvokeOption) (*LookupWorkloadNetworkVMGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230301:getWorkloadNetworkVMGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkloadNetworkVMGroupOutput(ctx *pulumi.Context, args LookupWorkloadNetworkVMGroupOutputArgs, opts ...pulumi.InvokeOption) LookupWorkloadNetworkVMGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkloadNetworkVMGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20230301:getWorkloadNetworkVMGroup", args, LookupWorkloadNetworkVMGroupResultOutput{}, options).(LookupWorkloadNetworkVMGroupResultOutput), nil
