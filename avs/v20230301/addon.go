...
func NewAddon(ctx *pulumi.Context,
	...
	var resource Addon
	err := ctx.RegisterResource("azure-native:avs/v20230301:Addon", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddon(ctx *pulumi.Context,
	...
	var resource Addon
	err := ctx.ReadResource("azure-native:avs/v20230301:Addon", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
