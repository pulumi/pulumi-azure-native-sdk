...
func NewWorkloadNetworkDnsService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230301:WorkloadNetworkDnsService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadNetworkDnsService(ctx *pulumi.Context,
	...
	var resource WorkloadNetworkDnsService
	err := ctx.ReadResource("azure-native:avs/v20230301:WorkloadNetworkDnsService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
