...
func NewPlacementPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230301:PlacementPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPlacementPolicy(ctx *pulumi.Context,
	...
	var resource PlacementPolicy
	err := ctx.ReadResource("azure-native:avs/v20230301:PlacementPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
