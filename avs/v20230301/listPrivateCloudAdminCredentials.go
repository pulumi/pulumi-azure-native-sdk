...
func ListPrivateCloudAdminCredentials(ctx *pulumi.Context, args *ListPrivateCloudAdminCredentialsArgs, opts ...pulumi.InvokeOption) (*ListPrivateCloudAdminCredentialsResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230301:listPrivateCloudAdminCredentials", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListPrivateCloudAdminCredentialsOutput(ctx *pulumi.Context, args ListPrivateCloudAdminCredentialsOutputArgs, opts ...pulumi.InvokeOption) ListPrivateCloudAdminCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListPrivateCloudAdminCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20230301:listPrivateCloudAdminCredentials", args, ListPrivateCloudAdminCredentialsResultOutput{}, options).(ListPrivateCloudAdminCredentialsResultOutput), nil
