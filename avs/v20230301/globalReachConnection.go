...
func NewGlobalReachConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230301:GlobalReachConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalReachConnection(ctx *pulumi.Context,
	...
	var resource GlobalReachConnection
	err := ctx.ReadResource("azure-native:avs/v20230301:GlobalReachConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
