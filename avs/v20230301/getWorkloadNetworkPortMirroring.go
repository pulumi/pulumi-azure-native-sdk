...
func LookupWorkloadNetworkPortMirroring(ctx *pulumi.Context, args *LookupWorkloadNetworkPortMirroringArgs, opts ...pulumi.InvokeOption) (*LookupWorkloadNetworkPortMirroringResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230301:getWorkloadNetworkPortMirroring", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkloadNetworkPortMirroringOutput(ctx *pulumi.Context, args LookupWorkloadNetworkPortMirroringOutputArgs, opts ...pulumi.InvokeOption) LookupWorkloadNetworkPortMirroringResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkloadNetworkPortMirroringResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20230301:getWorkloadNetworkPortMirroring", args, LookupWorkloadNetworkPortMirroringResultOutput{}, options).(LookupWorkloadNetworkPortMirroringResultOutput), nil
