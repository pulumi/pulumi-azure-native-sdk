...
func LookupGlobalReachConnection(ctx *pulumi.Context, args *LookupGlobalReachConnectionArgs, opts ...pulumi.InvokeOption) (*LookupGlobalReachConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230301:getGlobalReachConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupGlobalReachConnectionOutput(ctx *pulumi.Context, args LookupGlobalReachConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupGlobalReachConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupGlobalReachConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20230301:getGlobalReachConnection", args, LookupGlobalReachConnectionResultOutput{}, options).(LookupGlobalReachConnectionResultOutput), nil
