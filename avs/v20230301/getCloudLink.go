...
func LookupCloudLink(ctx *pulumi.Context, args *LookupCloudLinkArgs, opts ...pulumi.InvokeOption) (*LookupCloudLinkResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230301:getCloudLink", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCloudLinkOutput(ctx *pulumi.Context, args LookupCloudLinkOutputArgs, opts ...pulumi.InvokeOption) LookupCloudLinkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCloudLinkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20230301:getCloudLink", args, LookupCloudLinkResultOutput{}, options).(LookupCloudLinkResultOutput), nil
