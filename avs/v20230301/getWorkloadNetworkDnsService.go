...
func LookupWorkloadNetworkDnsService(ctx *pulumi.Context, args *LookupWorkloadNetworkDnsServiceArgs, opts ...pulumi.InvokeOption) (*LookupWorkloadNetworkDnsServiceResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230301:getWorkloadNetworkDnsService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkloadNetworkDnsServiceOutput(ctx *pulumi.Context, args LookupWorkloadNetworkDnsServiceOutputArgs, opts ...pulumi.InvokeOption) LookupWorkloadNetworkDnsServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkloadNetworkDnsServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:avs/v20230301:getWorkloadNetworkDnsService", args, LookupWorkloadNetworkDnsServiceResultOutput{}, options).(LookupWorkloadNetworkDnsServiceResultOutput), nil
