...
func LookupWorkloadNetworkPublicIP(ctx *pulumi.Context, args *LookupWorkloadNetworkPublicIPArgs, opts ...pulumi.InvokeOption) (*LookupWorkloadNetworkPublicIPResult, error) {
	...
	err := ctx.Invoke("azure-native:avs/v20230301:getWorkloadNetworkPublicIP", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupWorkloadNetworkPublicIPResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWorkloadNetworkPublicIPResult] {
	return pulumix.Output[LookupWorkloadNetworkPublicIPResult]{
