...
func NewPrivateCloud(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230301:PrivateCloud", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateCloud(ctx *pulumi.Context,
	...
	var resource PrivateCloud
	err := ctx.ReadResource("azure-native:avs/v20230301:PrivateCloud", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
