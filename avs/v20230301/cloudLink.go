...
func NewCloudLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20230301:CloudLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudLink(ctx *pulumi.Context,
	...
	var resource CloudLink
	err := ctx.ReadResource("azure-native:avs/v20230301:CloudLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
