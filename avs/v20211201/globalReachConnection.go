...
//
// Deprecated: azure-native:avs/v20211201:GlobalReachConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:GlobalReachConnection to guarantee forwards compatibility.
...
func NewGlobalReachConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:avs/v20211201:GlobalReachConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalReachConnection(ctx *pulumi.Context,
	...
	var resource GlobalReachConnection
	err := ctx.ReadResource("azure-native:avs/v20211201:GlobalReachConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
