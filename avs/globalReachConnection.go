...
func NewGlobalReachConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20240901:GlobalReachConnection"),
		},
		{
			Type: pulumi.String("azure-native:avs/v20250901:GlobalReachConnection"),
		},
	})
...
// The Azure API version of the resource.
func (o GlobalReachConnectionOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *GlobalReachConnection) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o GlobalReachConnectionOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *GlobalReachConnection) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
