...
func NewCloudLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20240901:CloudLink"),
		},
		{
			Type: pulumi.String("azure-native:avs/v20250901:CloudLink"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CloudLinkOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *CloudLink) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
