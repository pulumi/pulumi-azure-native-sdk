...
func NewWorkloadNetworkPortMirroring(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:avs/v20250901:WorkloadNetworkPortMirroring"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WorkloadNetworkPortMirroringOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *WorkloadNetworkPortMirroring) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
