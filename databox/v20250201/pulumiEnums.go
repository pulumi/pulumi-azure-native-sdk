...
// DataAccountTypeInput is an input type that accepts values of the DataAccountType enum
// A concrete instance of `DataAccountTypeInput` can be one of the following:
//
...
// DoubleEncryptionInput is an input type that accepts values of the DoubleEncryption enum
// A concrete instance of `DoubleEncryptionInput` can be one of the following:
//
...
// FilterFileTypeInput is an input type that accepts values of the FilterFileType enum
// A concrete instance of `FilterFileTypeInput` can be one of the following:
//
...
func (o HardwareEncryptionOutput) ToHardwareEncryptionPtrOutput() HardwareEncryptionPtrOutput {
	return o.ToHardwareEncryptionPtrOutputWithContext(context.Background())
}

func (o HardwareEncryptionOutput) ToHardwareEncryptionPtrOutputWithContext(ctx context.Context) HardwareEncryptionPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v HardwareEncryption) *HardwareEncryption {
		return &v
	}).(HardwareEncryptionPtrOutput)
}
...
func (o HardwareEncryptionOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e HardwareEncryption) string {
		return string(e)
	}).(pulumi.StringOutput)
}
...
func (o HardwareEncryptionPtrOutput) Elem() HardwareEncryptionOutput {
	return o.ApplyT(func(v *HardwareEncryption) HardwareEncryption {
		if v != nil {
			return *v
		}
		var ret HardwareEncryption
		return ret
	}).(HardwareEncryptionOutput)
}
...
// HardwareEncryptionInput is an input type that accepts values of the HardwareEncryption enum
// A concrete instance of `HardwareEncryptionInput` can be one of the following:
//
...
var hardwareEncryptionPtrType = reflect.TypeOf((**HardwareEncryption)(nil)).Elem()
...
type hardwareEncryptionPtr string

func HardwareEncryptionPtr(v string) HardwareEncryptionPtrInput {
	return (*hardwareEncryptionPtr)(&v)
}

func (*hardwareEncryptionPtr) ElementType() reflect.Type {
	return hardwareEncryptionPtrType
}

func (in *hardwareEncryptionPtr) ToHardwareEncryptionPtrOutput() HardwareEncryptionPtrOutput {
	return pulumi.ToOutput(in).(HardwareEncryptionPtrOutput)
}
...
// JobDeliveryTypeInput is an input type that accepts values of the JobDeliveryType enum
// A concrete instance of `JobDeliveryTypeInput` can be one of the following:
//
...
// KekTypeInput is an input type that accepts values of the KekType enum
// A concrete instance of `KekTypeInput` can be one of the following:
//
...
// LogCollectionLevelInput is an input type that accepts values of the LogCollectionLevel enum
// A concrete instance of `LogCollectionLevelInput` can be one of the following:
//
...
const (
	...
	// Data Box Disk.
	ModelNameDataBoxDisk = ModelName("DataBoxDisk")
	// Data Box Heavy.
	ModelNameDataBoxHeavy = ModelName("DataBoxHeavy")
	// Data Box Customer Disk
	ModelNameDataBoxCustomerDisk = ModelName("DataBoxCustomerDisk")
...
func (ModelName) ElementType() reflect.Type {
	return reflect.TypeOf((*ModelName)(nil)).Elem()
}

func (e ModelName) ToModelNameOutput() ModelNameOutput {
	return pulumi.ToOutput(e).(ModelNameOutput)
}

func (e ModelName) ToModelNameOutputWithContext(ctx context.Context) ModelNameOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ModelNameOutput)
}

func (e ModelName) ToModelNamePtrOutput() ModelNamePtrOutput {
	return e.ToModelNamePtrOutputWithContext(context.Background())
}

func (e ModelName) ToModelNamePtrOutputWithContext(ctx context.Context) ModelNamePtrOutput {
	return ModelName(e).ToModelNameOutputWithContext(ctx).ToModelNamePtrOutputWithContext(ctx)
}

func (e ModelName) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ModelName) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ModelName) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ModelName) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type ModelNameOutput struct{ *pulumi.OutputState }

func (ModelNameOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ModelName)(nil)).Elem()
}

func (o ModelNameOutput) ToModelNameOutput() ModelNameOutput {
	return o
}

func (o ModelNameOutput) ToModelNameOutputWithContext(ctx context.Context) ModelNameOutput {
	return o
}

func (o ModelNameOutput) ToModelNamePtrOutput() ModelNamePtrOutput {
	return o.ToModelNamePtrOutputWithContext(context.Background())
}

func (o ModelNameOutput) ToModelNamePtrOutputWithContext(ctx context.Context) ModelNamePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ModelName) *ModelName {
		return &v
	}).(ModelNamePtrOutput)
}

func (o ModelNameOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ModelNameOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ModelName) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ModelNameOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ModelNameOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ModelName) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type ModelNamePtrOutput struct{ *pulumi.OutputState }

func (ModelNamePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ModelName)(nil)).Elem()
}

func (o ModelNamePtrOutput) ToModelNamePtrOutput() ModelNamePtrOutput {
	return o
}

func (o ModelNamePtrOutput) ToModelNamePtrOutputWithContext(ctx context.Context) ModelNamePtrOutput {
	return o
}

func (o ModelNamePtrOutput) Elem() ModelNameOutput {
	return o.ApplyT(func(v *ModelName) ModelName {
		if v != nil {
			return *v
		}
		var ret ModelName
...
func (o ModelNamePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ModelNamePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ModelName) *string {
		if e == nil {
			return nil
		}
...
// ModelNameInput is an input type that accepts values of the ModelName enum
// A concrete instance of `ModelNameInput` can be one of the following:
//
//	ModelNameDataBox
//	ModelNameDataBoxDisk
//	ModelNameDataBoxHeavy
//	ModelNameDataBoxCustomerDisk
//	ModelNameAzureDataBox120
//	ModelNameAzureDataBox525
type ModelNameInput interface {
	pulumi.Input

	ToModelNameOutput() ModelNameOutput
	ToModelNameOutputWithContext(context.Context) ModelNameOutput
}

var modelNamePtrType = reflect.TypeOf((**ModelName)(nil)).Elem()

type ModelNamePtrInput interface {
	pulumi.Input

	ToModelNamePtrOutput() ModelNamePtrOutput
	ToModelNamePtrOutputWithContext(context.Context) ModelNamePtrOutput
}

type modelNamePtr string

func ModelNamePtr(v string) ModelNamePtrInput {
	return (*modelNamePtr)(&v)
}

func (*modelNamePtr) ElementType() reflect.Type {
	return modelNamePtrType
}

func (in *modelNamePtr) ToModelNamePtrOutput() ModelNamePtrOutput {
	return pulumi.ToOutput(in).(ModelNamePtrOutput)
}

func (in *modelNamePtr) ToModelNamePtrOutputWithContext(ctx context.Context) ModelNamePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ModelNamePtrOutput)
}
...
func (StorageAccountAccessTier) ElementType() reflect.Type {
	return reflect.TypeOf((*StorageAccountAccessTier)(nil)).Elem()
}

func (e StorageAccountAccessTier) ToStorageAccountAccessTierOutput() StorageAccountAccessTierOutput {
	return pulumi.ToOutput(e).(StorageAccountAccessTierOutput)
}
...
func (e StorageAccountAccessTier) ToStorageAccountAccessTierOutputWithContext(ctx context.Context) StorageAccountAccessTierOutput {
	return pulumi.ToOutputWithContext(ctx, e).(StorageAccountAccessTierOutput)
}

func (e StorageAccountAccessTier) ToStorageAccountAccessTierPtrOutput() StorageAccountAccessTierPtrOutput {
	return e.ToStorageAccountAccessTierPtrOutputWithContext(context.Background())
}
...
func (e StorageAccountAccessTier) ToStorageAccountAccessTierPtrOutputWithContext(ctx context.Context) StorageAccountAccessTierPtrOutput {
	return StorageAccountAccessTier(e).ToStorageAccountAccessTierOutputWithContext(ctx).ToStorageAccountAccessTierPtrOutputWithContext(ctx)
}
...
func (o StorageAccountAccessTierOutput) ToStorageAccountAccessTierPtrOutput() StorageAccountAccessTierPtrOutput {
	return o.ToStorageAccountAccessTierPtrOutputWithContext(context.Background())
}
...
func (o StorageAccountAccessTierOutput) ToStorageAccountAccessTierPtrOutputWithContext(ctx context.Context) StorageAccountAccessTierPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v StorageAccountAccessTier) *StorageAccountAccessTier {
		return &v
	}).(StorageAccountAccessTierPtrOutput)
}
...
func (o StorageAccountAccessTierOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e StorageAccountAccessTier) string {
		return string(e)
	}).(pulumi.StringOutput)
}
...
func (o StorageAccountAccessTierPtrOutput) Elem() StorageAccountAccessTierOutput {
	return o.ApplyT(func(v *StorageAccountAccessTier) StorageAccountAccessTier {
		if v != nil {
			return *v
		}
		var ret StorageAccountAccessTier
		return ret
	}).(StorageAccountAccessTierOutput)
}
...
// StorageAccountAccessTierInput is an input type that accepts values of the StorageAccountAccessTier enum
// A concrete instance of `StorageAccountAccessTierInput` can be one of the following:
//
...
var storageAccountAccessTierPtrType = reflect.TypeOf((**StorageAccountAccessTier)(nil)).Elem()
...
type storageAccountAccessTierPtr string

func StorageAccountAccessTierPtr(v string) StorageAccountAccessTierPtrInput {
	return (*storageAccountAccessTierPtr)(&v)
}

func (*storageAccountAccessTierPtr) ElementType() reflect.Type {
	return storageAccountAccessTierPtrType
}

func (in *storageAccountAccessTierPtr) ToStorageAccountAccessTierPtrOutput() StorageAccountAccessTierPtrOutput {
	return pulumi.ToOutput(in).(StorageAccountAccessTierPtrOutput)
}
...
// TransferConfigurationTypeInput is an input type that accepts values of the TransferConfigurationType enum
// A concrete instance of `TransferConfigurationTypeInput` can be one of the following:
//
...
// TransferTypeInput is an input type that accepts values of the TransferType enum
// A concrete instance of `TransferTypeInput` can be one of the following:
//
...
func init() {
	...
	pulumi.RegisterOutputType(HardwareEncryptionOutput{})
	pulumi.RegisterOutputType(HardwareEncryptionPtrOutput{})
	...
	pulumi.RegisterOutputType(ModelNameOutput{})
	pulumi.RegisterOutputType(ModelNamePtrOutput{})
	...
	pulumi.RegisterOutputType(StorageAccountAccessTierOutput{})
	pulumi.RegisterOutputType(StorageAccountAccessTierPtrOutput{})
