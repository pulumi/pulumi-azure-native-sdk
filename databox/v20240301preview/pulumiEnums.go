...
const (
	// Data Box.
	ModelNamesDataBox = ModelNames("DataBox")
	// Data Box Disk.
	ModelNamesDataBoxDisk = ModelNames("DataBoxDisk")
	// Data Box Heavy.
	ModelNamesDataBoxHeavy = ModelNames("DataBoxHeavy")
	// Data Box Customer Disk
	ModelNamesDataBoxCustomerDisk = ModelNames("DataBoxCustomerDisk")
	// Data Box V2 100TB.
	ModelNamesDataBoxV2x100 = ModelNames("DataBoxV2x100")
	// Data Box V2 500TB.
	ModelNamesDataBoxV2x500 = ModelNames("DataBoxV2x500")
)

func (ModelNames) ElementType() reflect.Type {
	return reflect.TypeOf((*ModelNames)(nil)).Elem()
}

func (e ModelNames) ToModelNamesOutput() ModelNamesOutput {
	return pulumi.ToOutput(e).(ModelNamesOutput)
}

func (e ModelNames) ToModelNamesOutputWithContext(ctx context.Context) ModelNamesOutput {
	return pulumi.ToOutputWithContext(ctx, e).(ModelNamesOutput)
}

func (e ModelNames) ToModelNamesPtrOutput() ModelNamesPtrOutput {
	return e.ToModelNamesPtrOutputWithContext(context.Background())
}

func (e ModelNames) ToModelNamesPtrOutputWithContext(ctx context.Context) ModelNamesPtrOutput {
	return ModelNames(e).ToModelNamesOutputWithContext(ctx).ToModelNamesPtrOutputWithContext(ctx)
}

func (e ModelNames) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e ModelNames) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e ModelNames) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e ModelNames) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type ModelNamesOutput struct{ *pulumi.OutputState }

func (ModelNamesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ModelNames)(nil)).Elem()
}

func (o ModelNamesOutput) ToModelNamesOutput() ModelNamesOutput {
	return o
}

func (o ModelNamesOutput) ToModelNamesOutputWithContext(ctx context.Context) ModelNamesOutput {
	return o
}

func (o ModelNamesOutput) ToModelNamesPtrOutput() ModelNamesPtrOutput {
	return o.ToModelNamesPtrOutputWithContext(context.Background())
}

func (o ModelNamesOutput) ToModelNamesPtrOutputWithContext(ctx context.Context) ModelNamesPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ModelNames) *ModelNames {
		return &v
	}).(ModelNamesPtrOutput)
}

func (o ModelNamesOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o ModelNamesOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ModelNames) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o ModelNamesOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ModelNamesOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e ModelNames) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type ModelNamesPtrOutput struct{ *pulumi.OutputState }

func (ModelNamesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ModelNames)(nil)).Elem()
}

func (o ModelNamesPtrOutput) ToModelNamesPtrOutput() ModelNamesPtrOutput {
	return o
}

func (o ModelNamesPtrOutput) ToModelNamesPtrOutputWithContext(ctx context.Context) ModelNamesPtrOutput {
	return o
}

func (o ModelNamesPtrOutput) Elem() ModelNamesOutput {
	return o.ApplyT(func(v *ModelNames) ModelNames {
		if v != nil {
			return *v
		}
		var ret ModelNames
...
func (o ModelNamesPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o ModelNamesPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *ModelNames) *string {
		if e == nil {
			return nil
		}
...
// ModelNamesInput is an input type that accepts values of the ModelNames enum
// A concrete instance of `ModelNamesInput` can be one of the following:
//
//	ModelNamesDataBox
//	ModelNamesDataBoxDisk
//	ModelNamesDataBoxHeavy
//	ModelNamesDataBoxCustomerDisk
//	ModelNamesDataBoxV2x100
//	ModelNamesDataBoxV2x500
type ModelNamesInput interface {
	pulumi.Input

	ToModelNamesOutput() ModelNamesOutput
	ToModelNamesOutputWithContext(context.Context) ModelNamesOutput
}

var modelNamesPtrType = reflect.TypeOf((**ModelNames)(nil)).Elem()

type ModelNamesPtrInput interface {
	pulumi.Input

	ToModelNamesPtrOutput() ModelNamesPtrOutput
	ToModelNamesPtrOutputWithContext(context.Context) ModelNamesPtrOutput
}

type modelNamesPtr string

func ModelNamesPtr(v string) ModelNamesPtrInput {
	return (*modelNamesPtr)(&v)
}

func (*modelNamesPtr) ElementType() reflect.Type {
	return modelNamesPtrType
}

func (in *modelNamesPtr) ToModelNamesPtrOutput() ModelNamesPtrOutput {
	return pulumi.ToOutput(in).(ModelNamesPtrOutput)
}

func (in *modelNamesPtr) ToModelNamesPtrOutputWithContext(ctx context.Context) ModelNamesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(ModelNamesPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ModelNamesOutput{})
	pulumi.RegisterOutputType(ModelNamesPtrOutput{})
