...
// Job Resource.
//
// Deprecated: azure-native:databox/v20210301:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:databox/v20221201:Job to guarantee forwards compatibility.
type Job struct {
...
func NewJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.RegisterResource("azure-native:databox/v20210301:Job", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.ReadResource("azure-native:databox/v20210301:Job", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
