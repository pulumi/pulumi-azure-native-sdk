...
func NewJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.RegisterResource("azure-native:databox/v20240201preview:Job", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJob(ctx *pulumi.Context,
	...
	var resource Job
	err := ctx.ReadResource("azure-native:databox/v20240201preview:Job", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
