...
func NewJobDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagemover/v20230301:JobDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobDefinition(ctx *pulumi.Context,
	...
	var resource JobDefinition
	err := ctx.ReadResource("azure-native:storagemover/v20230301:JobDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
