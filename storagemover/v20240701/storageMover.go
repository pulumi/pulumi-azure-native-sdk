...
func NewStorageMover(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storagemover/v20230701preview:StorageMover"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:storagemover/v20240701:StorageMover", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageMover(ctx *pulumi.Context,
	...
	var resource StorageMover
	err := ctx.ReadResource("azure-native:storagemover/v20240701:StorageMover", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
