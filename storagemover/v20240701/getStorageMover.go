...
func LookupStorageMover(ctx *pulumi.Context, args *LookupStorageMoverArgs, opts ...pulumi.InvokeOption) (*LookupStorageMoverResult, error) {
	...
	err := ctx.Invoke("azure-native:storagemover/v20240701:getStorageMover", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStorageMoverOutput(ctx *pulumi.Context, args LookupStorageMoverOutputArgs, opts ...pulumi.InvokeOption) LookupStorageMoverResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStorageMoverResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:storagemover/v20240701:getStorageMover", args, LookupStorageMoverResultOutput{}, options).(LookupStorageMoverResultOutput), nil
