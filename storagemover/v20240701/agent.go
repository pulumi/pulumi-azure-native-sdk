...
func NewAgent(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storagemover/v20230301:Agent"),
		},
		{
	...
	var resource Agent
	err := ctx.RegisterResource("azure-native:storagemover/v20240701:Agent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgent(ctx *pulumi.Context,
	...
	var resource Agent
	err := ctx.ReadResource("azure-native:storagemover/v20240701:Agent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
