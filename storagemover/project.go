...
func NewProject(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:storagemover/v20250701:Project"),
		},
		{
			Type: pulumi.String("azure-native:storagemover/v20250801:Project"),
		},
	})
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o ProjectOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *Project) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
