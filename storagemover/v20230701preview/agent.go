...
func NewAgent(ctx *pulumi.Context,
	...
	var resource Agent
	err := ctx.RegisterResource("azure-native:storagemover/v20230701preview:Agent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgent(ctx *pulumi.Context,
	...
	var resource Agent
	err := ctx.ReadResource("azure-native:storagemover/v20230701preview:Agent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
