...
func NewStorageMover(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagemover/v20231001:StorageMover", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageMover(ctx *pulumi.Context,
	...
	var resource StorageMover
	err := ctx.ReadResource("azure-native:storagemover/v20231001:StorageMover", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
