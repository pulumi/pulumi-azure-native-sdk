...
func NewEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storagemover/v20231001:Endpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpoint(ctx *pulumi.Context,
	...
	var resource Endpoint
	err := ctx.ReadResource("azure-native:storagemover/v20231001:Endpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
