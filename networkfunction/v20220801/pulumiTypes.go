...
func (i CollectorPolicyArgs) ToOutput(ctx context.Context) pulumix.Output[CollectorPolicy] {
...
func (o CollectorPolicyResponseOutput) ToOutput(ctx context.Context) pulumix.Output[CollectorPolicyResponse] {
	return pulumix.Output[CollectorPolicyResponse]{
		OutputState: o.OutputState,
	}
}
...
// Resource location.
func (o CollectorPolicyResponseOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CollectorPolicyResponse) *string { return v.Location }).(pulumi.StringPtrOutput)
}
...
// Metadata pertaining to creation and last modification of the resource.
func (o CollectorPolicyResponseOutput) SystemData() TrackedResourceResponseSystemDataOutput {
	return o.ApplyT(func(v CollectorPolicyResponse) TrackedResourceResponseSystemData { return v.SystemData }).(TrackedResourceResponseSystemDataOutput)
}

// Resource tags.
func (o CollectorPolicyResponseOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v CollectorPolicyResponse) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func (o CollectorPolicyResponseArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]CollectorPolicyResponse] {
	return pulumix.Output[[]CollectorPolicyResponse]{
		OutputState: o.OutputState,
	}
}
