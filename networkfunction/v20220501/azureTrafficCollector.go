...
func NewAzureTrafficCollector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkfunction/v20220501:AzureTrafficCollector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureTrafficCollector(ctx *pulumi.Context,
	...
	var resource AzureTrafficCollector
	err := ctx.ReadResource("azure-native:networkfunction/v20220501:AzureTrafficCollector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
