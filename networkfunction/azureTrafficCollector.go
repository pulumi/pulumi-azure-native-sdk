...
func NewAzureTrafficCollector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkfunction:AzureTrafficCollector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureTrafficCollector(ctx *pulumi.Context,
	...
	var resource AzureTrafficCollector
	err := ctx.ReadResource("azure-native:networkfunction:AzureTrafficCollector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o AzureTrafficCollectorOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *AzureTrafficCollector) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
