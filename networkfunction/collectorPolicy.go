...
func NewCollectorPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:networkfunction:CollectorPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCollectorPolicy(ctx *pulumi.Context,
	...
	var resource CollectorPolicy
	err := ctx.ReadResource("azure-native:networkfunction:CollectorPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CollectorPolicyOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *CollectorPolicy) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
