...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o CollectorPolicyOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *CollectorPolicy) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
