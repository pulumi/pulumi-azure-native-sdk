...
// The system data of the business process development artifact.
func (o SaveOrGetBusinessProcessDevelopmentArtifactResponseResponseOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v SaveOrGetBusinessProcessDevelopmentArtifactResponseResponse) commontypesv3.SystemDataResponse {
		return v.SystemData
