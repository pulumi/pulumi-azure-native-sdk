...
func LookupInfrastructureResource(ctx *pulumi.Context, args *LookupInfrastructureResourceArgs, opts ...pulumi.InvokeOption) (*LookupInfrastructureResourceResult, error) {
	...
	err := ctx.Invoke("azure-native:integrationspaces/v20231114preview:getInfrastructureResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupInfrastructureResourceOutput(ctx *pulumi.Context, args LookupInfrastructureResourceOutputArgs, opts ...pulumi.InvokeOption) LookupInfrastructureResourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupInfrastructureResourceResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:integrationspaces/v20231114preview:getInfrastructureResource", args, LookupInfrastructureResourceResultOutput{}, options).(LookupInfrastructureResourceResultOutput), nil
