...
func NewApplicationResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:integrationspaces:ApplicationResource"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApplicationResource
	err := ctx.RegisterResource("azure-native:integrationspaces/v20231114preview:ApplicationResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationResource(ctx *pulumi.Context,
	...
	var resource ApplicationResource
	err := ctx.ReadResource("azure-native:integrationspaces/v20231114preview:ApplicationResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
