...
func NewInfrastructureResource(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:integrationspaces/v20231114preview:InfrastructureResource"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource InfrastructureResource
	err := ctx.RegisterResource("azure-native:integrationspaces:InfrastructureResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInfrastructureResource(ctx *pulumi.Context,
	...
	var resource InfrastructureResource
	err := ctx.ReadResource("azure-native:integrationspaces:InfrastructureResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
