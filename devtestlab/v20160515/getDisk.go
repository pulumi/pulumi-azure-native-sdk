...
// The provisioning status of the resource.
func (o LookupDiskResultOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDiskResult) *string { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
...
// The unique immutable identifier of a resource (Guid).
func (o LookupDiskResultOutput) UniqueIdentifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDiskResult) *string { return v.UniqueIdentifier }).(pulumi.StringPtrOutput)
}
