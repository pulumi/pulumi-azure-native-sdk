...
// The provisioning status of the resource.
func (o DiskOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Disk) pulumi.StringPtrOutput { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
...
// The unique immutable identifier of a resource (Guid).
func (o DiskOutput) UniqueIdentifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Disk) pulumi.StringPtrOutput { return v.UniqueIdentifier }).(pulumi.StringPtrOutput)
}
