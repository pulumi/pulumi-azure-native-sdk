...
func (o LookupVirtualMachineScheduleResultOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineScheduleResult) *string { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
...
func (o LookupVirtualMachineScheduleResultOutput) UniqueIdentifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineScheduleResult) *string { return v.UniqueIdentifier }).(pulumi.StringPtrOutput)
}
