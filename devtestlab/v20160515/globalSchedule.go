...
func NewGlobalSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devtestlab/v20160515:GlobalSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalSchedule(ctx *pulumi.Context,
	...
	var resource GlobalSchedule
	err := ctx.ReadResource("azure-native:devtestlab/v20160515:GlobalSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The provisioning status of the resource.
func (o GlobalScheduleOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GlobalSchedule) pulumi.StringPtrOutput { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
...
// The unique immutable identifier of a resource (Guid).
func (o GlobalScheduleOutput) UniqueIdentifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GlobalSchedule) pulumi.StringPtrOutput { return v.UniqueIdentifier }).(pulumi.StringPtrOutput)
}
