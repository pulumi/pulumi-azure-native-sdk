...
// The applicable schedule for the virtual machine.
func (o LookupVirtualMachineResultOutput) ApplicableSchedule() ApplicableScheduleResponsePtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *ApplicableScheduleResponse { return v.ApplicableSchedule }).(ApplicableScheduleResponsePtrOutput)
}

// The artifact deployment status for the virtual machine.
func (o LookupVirtualMachineResultOutput) ArtifactDeploymentStatus() ArtifactDeploymentStatusPropertiesResponsePtrOutput {
...
// The compute virtual machine properties.
func (o LookupVirtualMachineResultOutput) ComputeVm() ComputeVmPropertiesResponsePtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *ComputeVmPropertiesResponse { return v.ComputeVm }).(ComputeVmPropertiesResponsePtrOutput)
}

// The email address of creator of the virtual machine.
func (o LookupVirtualMachineResultOutput) CreatedByUser() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *string { return v.CreatedByUser }).(pulumi.StringPtrOutput)
}

// The object identifier of the creator of the virtual machine.
func (o LookupVirtualMachineResultOutput) CreatedByUserId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *string { return v.CreatedByUserId }).(pulumi.StringPtrOutput)
}
...
// The fully-qualified domain name of the virtual machine.
func (o LookupVirtualMachineResultOutput) Fqdn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *string { return v.Fqdn }).(pulumi.StringPtrOutput)
}
...
// The OS type of the virtual machine.
func (o LookupVirtualMachineResultOutput) OsType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *string { return v.OsType }).(pulumi.StringPtrOutput)
}
...
// The provisioning status of the resource.
func (o LookupVirtualMachineResultOutput) ProvisioningState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *string { return v.ProvisioningState }).(pulumi.StringPtrOutput)
}
...
// The unique immutable identifier of a resource (Guid).
func (o LookupVirtualMachineResultOutput) UniqueIdentifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *string { return v.UniqueIdentifier }).(pulumi.StringPtrOutput)
}
...
// Tells source of creation of lab virtual machine. Output property only.
func (o LookupVirtualMachineResultOutput) VirtualMachineCreationSource() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualMachineResult) *string { return v.VirtualMachineCreationSource }).(pulumi.StringPtrOutput)
}
