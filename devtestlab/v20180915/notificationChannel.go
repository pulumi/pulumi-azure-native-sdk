...
func NewNotificationChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devtestlab/v20180915:NotificationChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationChannel(ctx *pulumi.Context,
	...
	var resource NotificationChannel
	err := ctx.ReadResource("azure-native:devtestlab/v20180915:NotificationChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
