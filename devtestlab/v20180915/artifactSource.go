...
func NewArtifactSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devtestlab/v20180915:ArtifactSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactSource(ctx *pulumi.Context,
	...
	var resource ArtifactSource
	err := ctx.ReadResource("azure-native:devtestlab/v20180915:ArtifactSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
