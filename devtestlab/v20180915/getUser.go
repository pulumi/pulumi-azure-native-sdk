...
func LookupUser(ctx *pulumi.Context, args *LookupUserArgs, opts ...pulumi.InvokeOption) (*LookupUserResult, error) {
	...
	err := ctx.Invoke("azure-native:devtestlab/v20180915:getUser", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUserOutput(ctx *pulumi.Context, args LookupUserOutputArgs, opts ...pulumi.InvokeOption) LookupUserResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUserResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:devtestlab/v20180915:getUser", args, LookupUserResultOutput{}, options).(LookupUserResultOutput), nil
