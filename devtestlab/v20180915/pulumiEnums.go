...
// CustomImageOsTypeInput is an input type that accepts values of the CustomImageOsType enum
// A concrete instance of `CustomImageOsTypeInput` can be one of the following:
//
...
// EnableStatusInput is an input type that accepts values of the EnableStatus enum
// A concrete instance of `EnableStatusInput` can be one of the following:
//
//	EnableStatusEnabled
...
// HostCachingOptionsInput is an input type that accepts values of the HostCachingOptions enum
// A concrete instance of `HostCachingOptionsInput` can be one of the following:
//
...
// LinuxOsStateInput is an input type that accepts values of the LinuxOsState enum
// A concrete instance of `LinuxOsStateInput` can be one of the following:
//
...
// NotificationChannelEventTypeInput is an input type that accepts values of the NotificationChannelEventType enum
// A concrete instance of `NotificationChannelEventTypeInput` can be one of the following:
//
...
// PolicyEvaluatorTypeInput is an input type that accepts values of the PolicyEvaluatorType enum
// A concrete instance of `PolicyEvaluatorTypeInput` can be one of the following:
//
...
// PolicyFactNameInput is an input type that accepts values of the PolicyFactName enum
// A concrete instance of `PolicyFactNameInput` can be one of the following:
//
...
// PremiumDataDiskInput is an input type that accepts values of the PremiumDataDisk enum
// A concrete instance of `PremiumDataDiskInput` can be one of the following:
//
...
// SourceControlTypeInput is an input type that accepts values of the SourceControlType enum
// A concrete instance of `SourceControlTypeInput` can be one of the following:
//
...
// UsagePermissionTypeInput is an input type that accepts values of the UsagePermissionType enum
// A concrete instance of `UsagePermissionTypeInput` can be one of the following:
//
...
// WindowsOsStateInput is an input type that accepts values of the WindowsOsState enum
// A concrete instance of `WindowsOsStateInput` can be one of the following:
//
