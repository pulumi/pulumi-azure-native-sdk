...
func NewVirtualMachineSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:devtestlab:VirtualMachineSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualMachineSchedule(ctx *pulumi.Context,
	...
	var resource VirtualMachineSchedule
	err := ctx.ReadResource("azure-native:devtestlab:VirtualMachineSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o VirtualMachineScheduleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualMachineSchedule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o VirtualMachineScheduleOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *VirtualMachineSchedule) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
