...
func NewDigitalTwin(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:digitaltwins/v20220531:DigitalTwin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDigitalTwin(ctx *pulumi.Context,
	...
	var resource DigitalTwin
	err := ctx.ReadResource("azure-native:digitaltwins/v20220531:DigitalTwin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
