...
func NewTimeSeriesDatabaseConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTimeSeriesDatabaseConnection(ctx *pulumi.Context,
	...
	var resource TimeSeriesDatabaseConnection
	err := ctx.ReadResource("azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
