...
func NewDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	var resource DigitalTwinsEndpoint
	err := ctx.ReadResource("azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
