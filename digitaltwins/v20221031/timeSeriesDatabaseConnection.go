...
func NewTimeSeriesDatabaseConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource TimeSeriesDatabaseConnection
	err := ctx.RegisterResource("azure-native:digitaltwins/v20221031:TimeSeriesDatabaseConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTimeSeriesDatabaseConnection(ctx *pulumi.Context,
	...
	var resource TimeSeriesDatabaseConnection
	err := ctx.ReadResource("azure-native:digitaltwins/v20221031:TimeSeriesDatabaseConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
