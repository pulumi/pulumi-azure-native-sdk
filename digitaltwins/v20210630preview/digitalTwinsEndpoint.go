...
func NewDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint"),
		},
	})
	opts = append(opts, aliases)
	var resource DigitalTwinsEndpoint
	err := ctx.RegisterResource("azure-native:digitaltwins/v20210630preview:DigitalTwinsEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDigitalTwinsEndpoint(ctx *pulumi.Context,
	...
	var resource DigitalTwinsEndpoint
	err := ctx.ReadResource("azure-native:digitaltwins/v20210630preview:DigitalTwinsEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
