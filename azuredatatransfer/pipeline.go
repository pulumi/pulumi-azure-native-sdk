...
func NewPipeline(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azuredatatransfer:Pipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipeline(ctx *pulumi.Context,
	...
	var resource Pipeline
	err := ctx.ReadResource("azure-native:azuredatatransfer:Pipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
