...
func NewFlow(ctx *pulumi.Context,
	...
	var resource Flow
	err := ctx.RegisterResource("azure-native:azuredatatransfer/v20240911:Flow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlow(ctx *pulumi.Context,
	...
	var resource Flow
	err := ctx.ReadResource("azure-native:azuredatatransfer/v20240911:Flow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
