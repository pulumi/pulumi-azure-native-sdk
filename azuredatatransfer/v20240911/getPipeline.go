...
func LookupPipeline(ctx *pulumi.Context, args *LookupPipelineArgs, opts ...pulumi.InvokeOption) (*LookupPipelineResult, error) {
	...
	err := ctx.Invoke("azure-native:azuredatatransfer/v20240911:getPipeline", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPipelineOutput(ctx *pulumi.Context, args LookupPipelineOutputArgs, opts ...pulumi.InvokeOption) LookupPipelineResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPipelineResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azuredatatransfer/v20240911:getPipeline", args, LookupPipelineResultOutput{}, options).(LookupPipelineResultOutput), nil
