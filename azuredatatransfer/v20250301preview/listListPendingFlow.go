...
func ListListPendingFlow(ctx *pulumi.Context, args *ListListPendingFlowArgs, opts ...pulumi.InvokeOption) (*ListListPendingFlowResult, error) {
	...
	err := ctx.Invoke("azure-native:azuredatatransfer/v20250301preview:listListPendingFlow", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListListPendingFlowOutput(ctx *pulumi.Context, args ListListPendingFlowOutputArgs, opts ...pulumi.InvokeOption) ListListPendingFlowResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListListPendingFlowResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:azuredatatransfer/v20250301preview:listListPendingFlow", args, ListListPendingFlowResultOutput{}, options).(ListListPendingFlowResultOutput), nil
