...
func NewPipeline(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:azuredatatransfer/v20250301preview:Pipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipeline(ctx *pulumi.Context,
	...
	var resource Pipeline
	err := ctx.ReadResource("azure-native:azuredatatransfer/v20250301preview:Pipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The managed identity of the pipeline resource, if configured.
func (o PipelineOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v *Pipeline) ManagedServiceIdentityResponsePtrOutput { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}
