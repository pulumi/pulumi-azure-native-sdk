...
func ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventId(ctx *pulumi.Context, args *ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdArgs, opts ...pulumi.InvokeOption) (*ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdResult, error) {
	...
	err := ctx.Invoke("azure-native:resourcehealth/v20230701preview:listSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventId", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdOutput(ctx *pulumi.Context, args ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdOutputArgs, opts ...pulumi.InvokeOption) ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:resourcehealth/v20230701preview:listSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventId", args, ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdResultOutput{}, options).(ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdResultOutput), nil
