...
// End time of maintenance for the impacted resource.
func (o EventImpactedResourceResponseOutput) MaintenanceEndTime() pulumi.StringOutput {
	return o.ApplyT(func(v EventImpactedResourceResponse) string { return v.MaintenanceEndTime }).(pulumi.StringOutput)
}

// Start time of maintenance for the impacted resource.
func (o EventImpactedResourceResponseOutput) MaintenanceStartTime() pulumi.StringOutput {
	return o.ApplyT(func(v EventImpactedResourceResponse) string { return v.MaintenanceStartTime }).(pulumi.StringOutput)
}
...
// Resource group name of the impacted resource.
func (o EventImpactedResourceResponseOutput) ResourceGroup() pulumi.StringOutput {
	return o.ApplyT(func(v EventImpactedResourceResponse) string { return v.ResourceGroup }).(pulumi.StringOutput)
}

// Resource name of the impacted resource.
func (o EventImpactedResourceResponseOutput) ResourceName() pulumi.StringOutput {
	return o.ApplyT(func(v EventImpactedResourceResponse) string { return v.ResourceName }).(pulumi.StringOutput)
}

// Status of the impacted resource.
func (o EventImpactedResourceResponseOutput) Status() pulumi.StringOutput {
	return o.ApplyT(func(v EventImpactedResourceResponse) string { return v.Status }).(pulumi.StringOutput)
}
