...
// Deprecated: azure-native:logz/v20201001preview:SubAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:SubAccount to guarantee forwards compatibility.
...
func NewSubAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:logz/v20201001preview:SubAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubAccount(ctx *pulumi.Context,
	...
	var resource SubAccount
	err := ctx.ReadResource("azure-native:logz/v20201001preview:SubAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
