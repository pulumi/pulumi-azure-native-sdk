...
func (o LookupSubAccountTagRuleResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSubAccountTagRuleResult] {
	return pulumix.Output[LookupSubAccountTagRuleResult]{
