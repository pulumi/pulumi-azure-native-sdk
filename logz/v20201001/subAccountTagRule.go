...
func NewSubAccountTagRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:logz/v20220101preview:SubAccountTagRule"),
		},
	})
	opts = append(opts, aliases)
	var resource SubAccountTagRule
	err := ctx.RegisterResource("azure-native:logz/v20201001:SubAccountTagRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubAccountTagRule(ctx *pulumi.Context,
	...
	var resource SubAccountTagRule
	err := ctx.ReadResource("azure-native:logz/v20201001:SubAccountTagRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
