...
// AwardInput is an input type that accepts AwardArgs and AwardOutput values.
// You can construct a concrete instance of `AwardInput` via:
//
//	AwardArgs{...}
type AwardInput interface {
	pulumi.Input

	ToAwardOutput() AwardOutput
	ToAwardOutputWithContext(context.Context) AwardOutput
}

// Award details for milestone completion
type AwardArgs struct {
	// Credit amount to be awarded
	Credit CommitmentPtrInput `pulumi:"credit"`
	// Duration for which the benefit is active. Will be in format P{int}M or P{int}Y. Any values representing up to 12 years are valid. Upper limit examples: P144M, P12Y.
...
func (AwardArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*Award)(nil)).Elem()
}

func (i AwardArgs) ToAwardOutput() AwardOutput {
	return i.ToAwardOutputWithContext(context.Background())
}

func (i AwardArgs) ToAwardOutputWithContext(ctx context.Context) AwardOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AwardOutput)
}

func (i AwardArgs) ToAwardPtrOutput() AwardPtrOutput {
	return i.ToAwardPtrOutputWithContext(context.Background())
}

func (i AwardArgs) ToAwardPtrOutputWithContext(ctx context.Context) AwardPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AwardOutput).ToAwardPtrOutputWithContext(ctx)
}

// AwardPtrInput is an input type that accepts AwardArgs, AwardPtr and AwardPtrOutput values.
// You can construct a concrete instance of `AwardPtrInput` via:
//
//	        AwardArgs{...}
//
//	or:
//
//	        nil
type AwardPtrInput interface {
	pulumi.Input

	ToAwardPtrOutput() AwardPtrOutput
	ToAwardPtrOutputWithContext(context.Context) AwardPtrOutput
}

type awardPtrType AwardArgs

func AwardPtr(v *AwardArgs) AwardPtrInput {
	return (*awardPtrType)(v)
}

func (*awardPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Award)(nil)).Elem()
}

func (i *awardPtrType) ToAwardPtrOutput() AwardPtrOutput {
	return i.ToAwardPtrOutputWithContext(context.Background())
}

func (i *awardPtrType) ToAwardPtrOutputWithContext(ctx context.Context) AwardPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AwardPtrOutput)
}

// Award details for milestone completion
type AwardOutput struct{ *pulumi.OutputState }

func (AwardOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*Award)(nil)).Elem()
}

func (o AwardOutput) ToAwardOutput() AwardOutput {
	return o
}

func (o AwardOutput) ToAwardOutputWithContext(ctx context.Context) AwardOutput {
	return o
}

func (o AwardOutput) ToAwardPtrOutput() AwardPtrOutput {
	return o.ToAwardPtrOutputWithContext(context.Background())
}

func (o AwardOutput) ToAwardPtrOutputWithContext(ctx context.Context) AwardPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v Award) *Award {
		return &v
	}).(AwardPtrOutput)
}

// Credit amount to be awarded
func (o AwardOutput) Credit() CommitmentPtrOutput {
	return o.ApplyT(func(v Award) *Commitment { return v.Credit }).(CommitmentPtrOutput)
}

// Duration for which the benefit is active. Will be in format P{int}M or P{int}Y. Any values representing up to 12 years are valid. Upper limit examples: P144M, P12Y.
func (o AwardOutput) Duration() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Award) *string { return v.Duration }).(pulumi.StringPtrOutput)
}

// End date when the credit expires
func (o AwardOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Award) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Start date when the credit becomes effective
func (o AwardOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Award) *string { return v.StartAt }).(pulumi.StringPtrOutput)
}

type AwardPtrOutput struct{ *pulumi.OutputState }

func (AwardPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Award)(nil)).Elem()
}

func (o AwardPtrOutput) ToAwardPtrOutput() AwardPtrOutput {
	return o
}

func (o AwardPtrOutput) ToAwardPtrOutputWithContext(ctx context.Context) AwardPtrOutput {
	return o
}

func (o AwardPtrOutput) Elem() AwardOutput {
	return o.ApplyT(func(v *Award) Award {
		if v != nil {
			return *v
		}
		var ret Award
...
// Credit amount to be awarded
func (o AwardPtrOutput) Credit() CommitmentPtrOutput {
	return o.ApplyT(func(v *Award) *Commitment {
		if v == nil {
			return nil
		}
		return v.Credit
...
// Duration for which the benefit is active. Will be in format P{int}M or P{int}Y. Any values representing up to 12 years are valid. Upper limit examples: P144M, P12Y.
func (o AwardPtrOutput) Duration() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Award) *string {
		if v == nil {
			return nil
		}
		return v.Duration
...
// End date when the credit expires
func (o AwardPtrOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Award) *string {
		if v == nil {
			return nil
		}
...
// Start date when the credit becomes effective
func (o AwardPtrOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Award) *string {
		if v == nil {
			return nil
		}
...
// Award details for milestone completion
type AwardResponseOutput struct{ *pulumi.OutputState }

func (AwardResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AwardResponse)(nil)).Elem()
}

func (o AwardResponseOutput) ToAwardResponseOutput() AwardResponseOutput {
	return o
}

func (o AwardResponseOutput) ToAwardResponseOutputWithContext(ctx context.Context) AwardResponseOutput {
	return o
}

// Points to BalanceVersion document that indicates the remaining commitment balance when the credit was created.
func (o AwardResponseOutput) BalanceVersion() pulumi.Float64Output {
	return o.ApplyT(func(v AwardResponse) float64 { return v.BalanceVersion }).(pulumi.Float64Output)
}

// Credit amount to be awarded
func (o AwardResponseOutput) Credit() CommitmentResponsePtrOutput {
	return o.ApplyT(func(v AwardResponse) *CommitmentResponse { return v.Credit }).(CommitmentResponsePtrOutput)
}

// Duration for which the benefit is active. Will be in format P{int}M or P{int}Y. Any values representing up to 12 years are valid. Upper limit examples: P144M, P12Y.
func (o AwardResponseOutput) Duration() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AwardResponse) *string { return v.Duration }).(pulumi.StringPtrOutput)
}

// End date when the credit expires
func (o AwardResponseOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AwardResponse) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Resource ID for the awarded credit.
func (o AwardResponseOutput) ResourceId() pulumi.StringOutput {
	return o.ApplyT(func(v AwardResponse) string { return v.ResourceId }).(pulumi.StringOutput)
}

// Start date when the credit becomes effective
func (o AwardResponseOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AwardResponse) *string { return v.StartAt }).(pulumi.StringPtrOutput)
}

// This is the globally unique identifier of the credit which will not change for its lifetime.
func (o AwardResponseOutput) SystemId() pulumi.StringOutput {
	return o.ApplyT(func(v AwardResponse) string { return v.SystemId }).(pulumi.StringOutput)
}

type AwardResponsePtrOutput struct{ *pulumi.OutputState }

func (AwardResponsePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AwardResponse)(nil)).Elem()
}

func (o AwardResponsePtrOutput) ToAwardResponsePtrOutput() AwardResponsePtrOutput {
	return o
}

func (o AwardResponsePtrOutput) ToAwardResponsePtrOutputWithContext(ctx context.Context) AwardResponsePtrOutput {
	return o
}

func (o AwardResponsePtrOutput) Elem() AwardResponseOutput {
	return o.ApplyT(func(v *AwardResponse) AwardResponse {
		if v != nil {
			return *v
		}
		var ret AwardResponse
		return ret
	}).(AwardResponseOutput)
}

// Points to BalanceVersion document that indicates the remaining commitment balance when the credit was created.
func (o AwardResponsePtrOutput) BalanceVersion() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *AwardResponse) *float64 {
		if v == nil {
			return nil
		}
...
// Credit amount to be awarded
func (o AwardResponsePtrOutput) Credit() CommitmentResponsePtrOutput {
	return o.ApplyT(func(v *AwardResponse) *CommitmentResponse {
		if v == nil {
			return nil
		}
		return v.Credit
...
// Duration for which the benefit is active. Will be in format P{int}M or P{int}Y. Any values representing up to 12 years are valid. Upper limit examples: P144M, P12Y.
func (o AwardResponsePtrOutput) Duration() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AwardResponse) *string {
		if v == nil {
			return nil
		}
		return v.Duration
...
// End date when the credit expires
func (o AwardResponsePtrOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AwardResponse) *string {
		if v == nil {
			return nil
		}
...
// Resource ID for the awarded credit.
func (o AwardResponsePtrOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AwardResponse) *string {
		if v == nil {
			return nil
		}
...
// Start date when the credit becomes effective
func (o AwardResponsePtrOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AwardResponse) *string {
		if v == nil {
			return nil
		}
...
// This is the globally unique identifier of the credit which will not change for its lifetime.
func (o AwardResponsePtrOutput) SystemId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AwardResponse) *string {
		if v == nil {
			return nil
		}
...
type ConditionalCreditMilestone struct {
	...
	SpendTarget *Price `pulumi:"spendTarget"`
	// Current status of the milestone
	Status *string `pulumi:"status"`
}

// ConditionalCreditMilestoneInput is an input type that accepts ConditionalCreditMilestoneArgs and ConditionalCreditMilestoneOutput values.
// You can construct a concrete instance of `ConditionalCreditMilestoneInput` via:
//
//	ConditionalCreditMilestoneArgs{...}
type ConditionalCreditMilestoneInput interface {
	pulumi.Input

	ToConditionalCreditMilestoneOutput() ConditionalCreditMilestoneOutput
	ToConditionalCreditMilestoneOutputWithContext(context.Context) ConditionalCreditMilestoneOutput
}

// Milestone definition within a conditional credit
type ConditionalCreditMilestoneArgs struct {
	// Award details for this milestone (only present for primary conditional credits)
	Award AwardPtrInput `pulumi:"award"`
	// End date for this milestone
	EndAt pulumi.StringPtrInput `pulumi:"endAt"`
	// Unique identifier for the milestone
	...
	// Spend target for this milestone
	SpendTarget PricePtrInput `pulumi:"spendTarget"`
	// Current status of the milestone
	Status pulumi.StringPtrInput `pulumi:"status"`
}

func (ConditionalCreditMilestoneArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ConditionalCreditMilestone)(nil)).Elem()
}

func (i ConditionalCreditMilestoneArgs) ToConditionalCreditMilestoneOutput() ConditionalCreditMilestoneOutput {
	return i.ToConditionalCreditMilestoneOutputWithContext(context.Background())
}

func (i ConditionalCreditMilestoneArgs) ToConditionalCreditMilestoneOutputWithContext(ctx context.Context) ConditionalCreditMilestoneOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ConditionalCreditMilestoneOutput)
}

// ConditionalCreditMilestoneArrayInput is an input type that accepts ConditionalCreditMilestoneArray and ConditionalCreditMilestoneArrayOutput values.
// You can construct a concrete instance of `ConditionalCreditMilestoneArrayInput` via:
//
//	ConditionalCreditMilestoneArray{ ConditionalCreditMilestoneArgs{...} }
type ConditionalCreditMilestoneArrayInput interface {
	pulumi.Input

	ToConditionalCreditMilestoneArrayOutput() ConditionalCreditMilestoneArrayOutput
	ToConditionalCreditMilestoneArrayOutputWithContext(context.Context) ConditionalCreditMilestoneArrayOutput
}

type ConditionalCreditMilestoneArray []ConditionalCreditMilestoneInput

func (ConditionalCreditMilestoneArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ConditionalCreditMilestone)(nil)).Elem()
}

func (i ConditionalCreditMilestoneArray) ToConditionalCreditMilestoneArrayOutput() ConditionalCreditMilestoneArrayOutput {
	return i.ToConditionalCreditMilestoneArrayOutputWithContext(context.Background())
}

func (i ConditionalCreditMilestoneArray) ToConditionalCreditMilestoneArrayOutputWithContext(ctx context.Context) ConditionalCreditMilestoneArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ConditionalCreditMilestoneArrayOutput)
}

// Milestone definition within a conditional credit
type ConditionalCreditMilestoneOutput struct{ *pulumi.OutputState }

func (ConditionalCreditMilestoneOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ConditionalCreditMilestone)(nil)).Elem()
}

func (o ConditionalCreditMilestoneOutput) ToConditionalCreditMilestoneOutput() ConditionalCreditMilestoneOutput {
	return o
}

func (o ConditionalCreditMilestoneOutput) ToConditionalCreditMilestoneOutputWithContext(ctx context.Context) ConditionalCreditMilestoneOutput {
	return o
}

// Award details for this milestone (only present for primary conditional credits)
func (o ConditionalCreditMilestoneOutput) Award() AwardPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestone) *Award { return v.Award }).(AwardPtrOutput)
}

// End date for this milestone
func (o ConditionalCreditMilestoneOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestone) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Unique identifier for the milestone
func (o ConditionalCreditMilestoneOutput) MilestoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestone) *string { return v.MilestoneId }).(pulumi.StringPtrOutput)
}

// Display name for the milestone
func (o ConditionalCreditMilestoneOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestone) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Spend target for this milestone
func (o ConditionalCreditMilestoneOutput) SpendTarget() PricePtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestone) *Price { return v.SpendTarget }).(PricePtrOutput)
}

// Current status of the milestone
func (o ConditionalCreditMilestoneOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestone) *string { return v.Status }).(pulumi.StringPtrOutput)
}

type ConditionalCreditMilestoneArrayOutput struct{ *pulumi.OutputState }

func (ConditionalCreditMilestoneArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ConditionalCreditMilestone)(nil)).Elem()
}

func (o ConditionalCreditMilestoneArrayOutput) ToConditionalCreditMilestoneArrayOutput() ConditionalCreditMilestoneArrayOutput {
	return o
}

func (o ConditionalCreditMilestoneArrayOutput) ToConditionalCreditMilestoneArrayOutputWithContext(ctx context.Context) ConditionalCreditMilestoneArrayOutput {
	return o
}

func (o ConditionalCreditMilestoneArrayOutput) Index(i pulumi.IntInput) ConditionalCreditMilestoneOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ConditionalCreditMilestone {
		return vs[0].([]ConditionalCreditMilestone)[vs[1].(int)]
	}).(ConditionalCreditMilestoneOutput)
}

// Milestone definition within a conditional credit
type ConditionalCreditMilestoneResponse struct {
	// Award details for this milestone (only present for primary conditional credits)
	Award *AwardResponse `pulumi:"award"`
	// End date for this milestone
	EndAt *string `pulumi:"endAt"`
	// Unique identifier for the milestone
	MilestoneId *string `pulumi:"milestoneId"`
	...
	Name *string `pulumi:"name"`
	// Spend target for this milestone
	SpendTarget *PriceResponse `pulumi:"spendTarget"`
	// Current status of the milestone
	Status *string `pulumi:"status"`
}

// Milestone definition within a conditional credit
type ConditionalCreditMilestoneResponseOutput struct{ *pulumi.OutputState }

func (ConditionalCreditMilestoneResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ConditionalCreditMilestoneResponse)(nil)).Elem()
}

func (o ConditionalCreditMilestoneResponseOutput) ToConditionalCreditMilestoneResponseOutput() ConditionalCreditMilestoneResponseOutput {
	return o
}

func (o ConditionalCreditMilestoneResponseOutput) ToConditionalCreditMilestoneResponseOutputWithContext(ctx context.Context) ConditionalCreditMilestoneResponseOutput {
	return o
}

// Award details for this milestone (only present for primary conditional credits)
func (o ConditionalCreditMilestoneResponseOutput) Award() AwardResponsePtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestoneResponse) *AwardResponse { return v.Award }).(AwardResponsePtrOutput)
}

// End date for this milestone
func (o ConditionalCreditMilestoneResponseOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestoneResponse) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Unique identifier for the milestone
func (o ConditionalCreditMilestoneResponseOutput) MilestoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestoneResponse) *string { return v.MilestoneId }).(pulumi.StringPtrOutput)
}

// Display name for the milestone
func (o ConditionalCreditMilestoneResponseOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestoneResponse) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Spend target for this milestone
func (o ConditionalCreditMilestoneResponseOutput) SpendTarget() PriceResponsePtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestoneResponse) *PriceResponse { return v.SpendTarget }).(PriceResponsePtrOutput)
}

// Current status of the milestone
func (o ConditionalCreditMilestoneResponseOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConditionalCreditMilestoneResponse) *string { return v.Status }).(pulumi.StringPtrOutput)
}

type ConditionalCreditMilestoneResponseArrayOutput struct{ *pulumi.OutputState }

func (ConditionalCreditMilestoneResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ConditionalCreditMilestoneResponse)(nil)).Elem()
}

func (o ConditionalCreditMilestoneResponseArrayOutput) ToConditionalCreditMilestoneResponseArrayOutput() ConditionalCreditMilestoneResponseArrayOutput {
	return o
}

func (o ConditionalCreditMilestoneResponseArrayOutput) ToConditionalCreditMilestoneResponseArrayOutputWithContext(ctx context.Context) ConditionalCreditMilestoneResponseArrayOutput {
	return o
}

func (o ConditionalCreditMilestoneResponseArrayOutput) Index(i pulumi.IntInput) ConditionalCreditMilestoneResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ConditionalCreditMilestoneResponse {
		return vs[0].([]ConditionalCreditMilestoneResponse)[vs[1].(int)]
	}).(ConditionalCreditMilestoneResponseOutput)
}
...
type ContributorConditionalCreditMilestoneResponse struct {
	// Award details for this milestone (only present for primary conditional credits)
	Award *AwardResponse `pulumi:"award"`
	// End date for this milestone
	EndAt *string `pulumi:"endAt"`
...
// Milestone definition for contributor conditional credit (excludes award details)
type ContributorConditionalCreditMilestoneResponseOutput struct{ *pulumi.OutputState }

func (ContributorConditionalCreditMilestoneResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ContributorConditionalCreditMilestoneResponse)(nil)).Elem()
}

func (o ContributorConditionalCreditMilestoneResponseOutput) ToContributorConditionalCreditMilestoneResponseOutput() ContributorConditionalCreditMilestoneResponseOutput {
	return o
}

func (o ContributorConditionalCreditMilestoneResponseOutput) ToContributorConditionalCreditMilestoneResponseOutputWithContext(ctx context.Context) ContributorConditionalCreditMilestoneResponseOutput {
	return o
}

// Award details for this milestone (only present for primary conditional credits)
func (o ContributorConditionalCreditMilestoneResponseOutput) Award() AwardResponsePtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditMilestoneResponse) *AwardResponse { return v.Award }).(AwardResponsePtrOutput)
}

// End date for this milestone
func (o ContributorConditionalCreditMilestoneResponseOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditMilestoneResponse) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Unique identifier for the milestone
func (o ContributorConditionalCreditMilestoneResponseOutput) MilestoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditMilestoneResponse) *string { return v.MilestoneId }).(pulumi.StringPtrOutput)
}

// Display name for the milestone
func (o ContributorConditionalCreditMilestoneResponseOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditMilestoneResponse) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Spend target for this milestone
func (o ContributorConditionalCreditMilestoneResponseOutput) SpendTarget() PriceResponsePtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditMilestoneResponse) *PriceResponse { return v.SpendTarget }).(PriceResponsePtrOutput)
}

// Current status of the milestone
func (o ContributorConditionalCreditMilestoneResponseOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditMilestoneResponse) *string { return v.Status }).(pulumi.StringPtrOutput)
}

type ContributorConditionalCreditMilestoneResponseArrayOutput struct{ *pulumi.OutputState }

func (ContributorConditionalCreditMilestoneResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ContributorConditionalCreditMilestoneResponse)(nil)).Elem()
}

func (o ContributorConditionalCreditMilestoneResponseArrayOutput) ToContributorConditionalCreditMilestoneResponseArrayOutput() ContributorConditionalCreditMilestoneResponseArrayOutput {
	return o
}

func (o ContributorConditionalCreditMilestoneResponseArrayOutput) ToContributorConditionalCreditMilestoneResponseArrayOutputWithContext(ctx context.Context) ContributorConditionalCreditMilestoneResponseArrayOutput {
	return o
}

func (o ContributorConditionalCreditMilestoneResponseArrayOutput) Index(i pulumi.IntInput) ContributorConditionalCreditMilestoneResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ContributorConditionalCreditMilestoneResponse {
		return vs[0].([]ContributorConditionalCreditMilestoneResponse)[vs[1].(int)]
	}).(ContributorConditionalCreditMilestoneResponseOutput)
}
...
// ContributorConditionalCreditPropertiesInput is an input type that accepts ContributorConditionalCreditPropertiesArgs and ContributorConditionalCreditPropertiesOutput values.
// You can construct a concrete instance of `ContributorConditionalCreditPropertiesInput` via:
//
//	ContributorConditionalCreditPropertiesArgs{...}
type ContributorConditionalCreditPropertiesInput interface {
	pulumi.Input

	ToContributorConditionalCreditPropertiesOutput() ContributorConditionalCreditPropertiesOutput
	ToContributorConditionalCreditPropertiesOutputWithContext(context.Context) ContributorConditionalCreditPropertiesOutput
}

// Properties for contributor conditional credit.
type ContributorConditionalCreditPropertiesArgs struct {
	// The billing account resource ID
	BillingAccountResourceId pulumi.StringPtrInput `pulumi:"billingAccountResourceId"`
	// Display name for the conditional credit
	...
	// Fully-qualified billing account resource identifier of the primary CACO. Format must be Azure Resource ID: /providers/Microsoft.Billing/billingAccounts/{acctId:orgId}.
	PrimaryBillingAccountResourceId pulumi.StringPtrInput `pulumi:"primaryBillingAccountResourceId"`
	// Resource ID of the primary conditional credit (required for contributors)
	PrimaryResourceId pulumi.StringPtrInput `pulumi:"primaryResourceId"`
	// Product code for the conditional credit
...
func (ContributorConditionalCreditPropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ContributorConditionalCreditProperties)(nil)).Elem()
}

func (i ContributorConditionalCreditPropertiesArgs) ToContributorConditionalCreditPropertiesOutput() ContributorConditionalCreditPropertiesOutput {
	return i.ToContributorConditionalCreditPropertiesOutputWithContext(context.Background())
}

func (i ContributorConditionalCreditPropertiesArgs) ToContributorConditionalCreditPropertiesOutputWithContext(ctx context.Context) ContributorConditionalCreditPropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ContributorConditionalCreditPropertiesOutput)
}

func (i ContributorConditionalCreditPropertiesArgs) ToContributorConditionalCreditPropertiesPtrOutput() ContributorConditionalCreditPropertiesPtrOutput {
	return i.ToContributorConditionalCreditPropertiesPtrOutputWithContext(context.Background())
}

func (i ContributorConditionalCreditPropertiesArgs) ToContributorConditionalCreditPropertiesPtrOutputWithContext(ctx context.Context) ContributorConditionalCreditPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ContributorConditionalCreditPropertiesOutput).ToContributorConditionalCreditPropertiesPtrOutputWithContext(ctx)
}

// ContributorConditionalCreditPropertiesPtrInput is an input type that accepts ContributorConditionalCreditPropertiesArgs, ContributorConditionalCreditPropertiesPtr and ContributorConditionalCreditPropertiesPtrOutput values.
// You can construct a concrete instance of `ContributorConditionalCreditPropertiesPtrInput` via:
//
//	        ContributorConditionalCreditPropertiesArgs{...}
//
//	or:
//
//	        nil
type ContributorConditionalCreditPropertiesPtrInput interface {
	pulumi.Input

	ToContributorConditionalCreditPropertiesPtrOutput() ContributorConditionalCreditPropertiesPtrOutput
	ToContributorConditionalCreditPropertiesPtrOutputWithContext(context.Context) ContributorConditionalCreditPropertiesPtrOutput
}

type contributorConditionalCreditPropertiesPtrType ContributorConditionalCreditPropertiesArgs

func ContributorConditionalCreditPropertiesPtr(v *ContributorConditionalCreditPropertiesArgs) ContributorConditionalCreditPropertiesPtrInput {
	return (*contributorConditionalCreditPropertiesPtrType)(v)
}

func (*contributorConditionalCreditPropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ContributorConditionalCreditProperties)(nil)).Elem()
}

func (i *contributorConditionalCreditPropertiesPtrType) ToContributorConditionalCreditPropertiesPtrOutput() ContributorConditionalCreditPropertiesPtrOutput {
	return i.ToContributorConditionalCreditPropertiesPtrOutputWithContext(context.Background())
}

func (i *contributorConditionalCreditPropertiesPtrType) ToContributorConditionalCreditPropertiesPtrOutputWithContext(ctx context.Context) ContributorConditionalCreditPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ContributorConditionalCreditPropertiesPtrOutput)
}

// Properties for contributor conditional credit.
type ContributorConditionalCreditPropertiesOutput struct{ *pulumi.OutputState }

func (ContributorConditionalCreditPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ContributorConditionalCreditProperties)(nil)).Elem()
}

func (o ContributorConditionalCreditPropertiesOutput) ToContributorConditionalCreditPropertiesOutput() ContributorConditionalCreditPropertiesOutput {
	return o
}

func (o ContributorConditionalCreditPropertiesOutput) ToContributorConditionalCreditPropertiesOutputWithContext(ctx context.Context) ContributorConditionalCreditPropertiesOutput {
	return o
}

func (o ContributorConditionalCreditPropertiesOutput) ToContributorConditionalCreditPropertiesPtrOutput() ContributorConditionalCreditPropertiesPtrOutput {
	return o.ToContributorConditionalCreditPropertiesPtrOutputWithContext(context.Background())
}

func (o ContributorConditionalCreditPropertiesOutput) ToContributorConditionalCreditPropertiesPtrOutputWithContext(ctx context.Context) ContributorConditionalCreditPropertiesPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ContributorConditionalCreditProperties) *ContributorConditionalCreditProperties {
		return &v
	}).(ContributorConditionalCreditPropertiesPtrOutput)
}

// The billing account resource ID
func (o ContributorConditionalCreditPropertiesOutput) BillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.BillingAccountResourceId }).(pulumi.StringPtrOutput)
}

// Display name for the conditional credit
func (o ContributorConditionalCreditPropertiesOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}

// End date of the conditional credit (derived from last milestone)
func (o ContributorConditionalCreditPropertiesOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Type of conditional credit entity
// Expected value is 'Contributor'.
func (o ContributorConditionalCreditPropertiesOutput) EntityType() pulumi.StringOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) string { return v.EntityType }).(pulumi.StringOutput)
}

// Fully-qualified billing account resource identifier of the primary CACO. Format must be Azure Resource ID: /providers/Microsoft.Billing/billingAccounts/{acctId:orgId}.
func (o ContributorConditionalCreditPropertiesOutput) PrimaryBillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.PrimaryBillingAccountResourceId }).(pulumi.StringPtrOutput)
}

// Resource ID of the primary conditional credit (required for contributors)
func (o ContributorConditionalCreditPropertiesOutput) PrimaryResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.PrimaryResourceId }).(pulumi.StringPtrOutput)
}

// Product code for the conditional credit
func (o ContributorConditionalCreditPropertiesOutput) ProductCode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.ProductCode }).(pulumi.StringPtrOutput)
}

// Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
func (o ContributorConditionalCreditPropertiesOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.ResourceId }).(pulumi.StringPtrOutput)
}

// Start date of the conditional credit
func (o ContributorConditionalCreditPropertiesOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.StartAt }).(pulumi.StringPtrOutput)
}

// The status of the conditional credit
func (o ContributorConditionalCreditPropertiesOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.Status }).(pulumi.StringPtrOutput)
}

// System identifier shared between primary and contributor conditional credits representing the same conditional credit program
func (o ContributorConditionalCreditPropertiesOutput) SystemId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditProperties) *string { return v.SystemId }).(pulumi.StringPtrOutput)
}

type ContributorConditionalCreditPropertiesPtrOutput struct{ *pulumi.OutputState }

func (ContributorConditionalCreditPropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ContributorConditionalCreditProperties)(nil)).Elem()
}

func (o ContributorConditionalCreditPropertiesPtrOutput) ToContributorConditionalCreditPropertiesPtrOutput() ContributorConditionalCreditPropertiesPtrOutput {
	return o
}

func (o ContributorConditionalCreditPropertiesPtrOutput) ToContributorConditionalCreditPropertiesPtrOutputWithContext(ctx context.Context) ContributorConditionalCreditPropertiesPtrOutput {
	return o
}

func (o ContributorConditionalCreditPropertiesPtrOutput) Elem() ContributorConditionalCreditPropertiesOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) ContributorConditionalCreditProperties {
		if v != nil {
			return *v
		}
		var ret ContributorConditionalCreditProperties
		return ret
	}).(ContributorConditionalCreditPropertiesOutput)
}

// The billing account resource ID
func (o ContributorConditionalCreditPropertiesPtrOutput) BillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
		return v.BillingAccountResourceId
	}).(pulumi.StringPtrOutput)
}

// Display name for the conditional credit
func (o ContributorConditionalCreditPropertiesPtrOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// End date of the conditional credit (derived from last milestone)
func (o ContributorConditionalCreditPropertiesPtrOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Type of conditional credit entity
// Expected value is 'Contributor'.
func (o ContributorConditionalCreditPropertiesPtrOutput) EntityType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Fully-qualified billing account resource identifier of the primary CACO. Format must be Azure Resource ID: /providers/Microsoft.Billing/billingAccounts/{acctId:orgId}.
func (o ContributorConditionalCreditPropertiesPtrOutput) PrimaryBillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
		return v.PrimaryBillingAccountResourceId
	}).(pulumi.StringPtrOutput)
}

// Resource ID of the primary conditional credit (required for contributors)
func (o ContributorConditionalCreditPropertiesPtrOutput) PrimaryResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
		return v.PrimaryResourceId
	}).(pulumi.StringPtrOutput)
}

// Product code for the conditional credit
func (o ContributorConditionalCreditPropertiesPtrOutput) ProductCode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
func (o ContributorConditionalCreditPropertiesPtrOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Start date of the conditional credit
func (o ContributorConditionalCreditPropertiesPtrOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// The status of the conditional credit
func (o ContributorConditionalCreditPropertiesPtrOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// System identifier shared between primary and contributor conditional credits representing the same conditional credit program
func (o ContributorConditionalCreditPropertiesPtrOutput) SystemId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ContributorConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Properties for contributor conditional credit.
type ContributorConditionalCreditPropertiesResponse struct {
	...
	Milestones []ContributorConditionalCreditMilestoneResponse `pulumi:"milestones"`
	// Fully-qualified billing account resource identifier of the primary CACO. Format must be Azure Resource ID: /providers/Microsoft.Billing/billingAccounts/{acctId:orgId}.
	PrimaryBillingAccountResourceId *string `pulumi:"primaryBillingAccountResourceId"`
	// Resource ID of the primary conditional credit (required for contributors)
	PrimaryResourceId *string `pulumi:"primaryResourceId"`
...
// Properties for contributor conditional credit.
type ContributorConditionalCreditPropertiesResponseOutput struct{ *pulumi.OutputState }

func (ContributorConditionalCreditPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ContributorConditionalCreditPropertiesResponse)(nil)).Elem()
}

func (o ContributorConditionalCreditPropertiesResponseOutput) ToContributorConditionalCreditPropertiesResponseOutput() ContributorConditionalCreditPropertiesResponseOutput {
	return o
}

func (o ContributorConditionalCreditPropertiesResponseOutput) ToContributorConditionalCreditPropertiesResponseOutputWithContext(ctx context.Context) ContributorConditionalCreditPropertiesResponseOutput {
	return o
}

// Fully-qualified identifier of the benefit under applicable benefit list.
func (o ContributorConditionalCreditPropertiesResponseOutput) BenefitResourceId() pulumi.StringOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) string { return v.BenefitResourceId }).(pulumi.StringOutput)
}

// The billing account resource ID
func (o ContributorConditionalCreditPropertiesResponseOutput) BillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.BillingAccountResourceId }).(pulumi.StringPtrOutput)
}

// Display name for the conditional credit
func (o ContributorConditionalCreditPropertiesResponseOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}

// End date of the conditional credit (derived from last milestone)
func (o ContributorConditionalCreditPropertiesResponseOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Type of conditional credit entity
// Expected value is 'Contributor'.
func (o ContributorConditionalCreditPropertiesResponseOutput) EntityType() pulumi.StringOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) string { return v.EntityType }).(pulumi.StringOutput)
}

// List of milestones copied from primary conditional credit (excludes award details)
func (o ContributorConditionalCreditPropertiesResponseOutput) Milestones() ContributorConditionalCreditMilestoneResponseArrayOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) []ContributorConditionalCreditMilestoneResponse {
		return v.Milestones
	}).(ContributorConditionalCreditMilestoneResponseArrayOutput)
}

// Fully-qualified billing account resource identifier of the primary CACO. Format must be Azure Resource ID: /providers/Microsoft.Billing/billingAccounts/{acctId:orgId}.
func (o ContributorConditionalCreditPropertiesResponseOutput) PrimaryBillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string {
		return v.PrimaryBillingAccountResourceId
	}).(pulumi.StringPtrOutput)
}

// Resource ID of the primary conditional credit (required for contributors)
func (o ContributorConditionalCreditPropertiesResponseOutput) PrimaryResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.PrimaryResourceId }).(pulumi.StringPtrOutput)
}

// Product code for the conditional credit
func (o ContributorConditionalCreditPropertiesResponseOutput) ProductCode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.ProductCode }).(pulumi.StringPtrOutput)
}

// The provisioning state of the resource
func (o ContributorConditionalCreditPropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

// Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
func (o ContributorConditionalCreditPropertiesResponseOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.ResourceId }).(pulumi.StringPtrOutput)
}

// Start date of the conditional credit
func (o ContributorConditionalCreditPropertiesResponseOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.StartAt }).(pulumi.StringPtrOutput)
}

// The status of the conditional credit
func (o ContributorConditionalCreditPropertiesResponseOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.Status }).(pulumi.StringPtrOutput)
}

// System identifier shared between primary and contributor conditional credits representing the same conditional credit program
func (o ContributorConditionalCreditPropertiesResponseOutput) SystemId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ContributorConditionalCreditPropertiesResponse) *string { return v.SystemId }).(pulumi.StringPtrOutput)
}
...
// CreditReasonInput is an input type that accepts CreditReasonArgs and CreditReasonOutput values.
// You can construct a concrete instance of `CreditReasonInput` via:
//
//	CreditReasonArgs{...}
type CreditReasonInput interface {
	pulumi.Input

	ToCreditReasonOutput() CreditReasonOutput
	ToCreditReasonOutputWithContext(context.Context) CreditReasonOutput
}

// The reason for the credit. Not required if not applicable.
type CreditReasonArgs struct {
	// The reason code for credit.
	Code pulumi.StringPtrInput `pulumi:"code"`
	// The free string description of the credit.
...
func (CreditReasonArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*CreditReason)(nil)).Elem()
}

func (i CreditReasonArgs) ToCreditReasonOutput() CreditReasonOutput {
	return i.ToCreditReasonOutputWithContext(context.Background())
}

func (i CreditReasonArgs) ToCreditReasonOutputWithContext(ctx context.Context) CreditReasonOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CreditReasonOutput)
}

func (i CreditReasonArgs) ToCreditReasonPtrOutput() CreditReasonPtrOutput {
	return i.ToCreditReasonPtrOutputWithContext(context.Background())
}

func (i CreditReasonArgs) ToCreditReasonPtrOutputWithContext(ctx context.Context) CreditReasonPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CreditReasonOutput).ToCreditReasonPtrOutputWithContext(ctx)
}

// CreditReasonPtrInput is an input type that accepts CreditReasonArgs, CreditReasonPtr and CreditReasonPtrOutput values.
// You can construct a concrete instance of `CreditReasonPtrInput` via:
//
//	        CreditReasonArgs{...}
//
//	or:
//
//	        nil
type CreditReasonPtrInput interface {
	pulumi.Input

	ToCreditReasonPtrOutput() CreditReasonPtrOutput
	ToCreditReasonPtrOutputWithContext(context.Context) CreditReasonPtrOutput
}

type creditReasonPtrType CreditReasonArgs

func CreditReasonPtr(v *CreditReasonArgs) CreditReasonPtrInput {
	return (*creditReasonPtrType)(v)
}

func (*creditReasonPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**CreditReason)(nil)).Elem()
}

func (i *creditReasonPtrType) ToCreditReasonPtrOutput() CreditReasonPtrOutput {
	return i.ToCreditReasonPtrOutputWithContext(context.Background())
}

func (i *creditReasonPtrType) ToCreditReasonPtrOutputWithContext(ctx context.Context) CreditReasonPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CreditReasonPtrOutput)
}

// The reason for the credit. Not required if not applicable.
type CreditReasonOutput struct{ *pulumi.OutputState }

func (CreditReasonOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CreditReason)(nil)).Elem()
}

func (o CreditReasonOutput) ToCreditReasonOutput() CreditReasonOutput {
	return o
}

func (o CreditReasonOutput) ToCreditReasonOutputWithContext(ctx context.Context) CreditReasonOutput {
	return o
}

func (o CreditReasonOutput) ToCreditReasonPtrOutput() CreditReasonPtrOutput {
	return o.ToCreditReasonPtrOutputWithContext(context.Background())
}

func (o CreditReasonOutput) ToCreditReasonPtrOutputWithContext(ctx context.Context) CreditReasonPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v CreditReason) *CreditReason {
		return &v
	}).(CreditReasonPtrOutput)
}

// The reason code for credit.
func (o CreditReasonOutput) Code() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CreditReason) *string { return v.Code }).(pulumi.StringPtrOutput)
}

// The free string description of the credit.
func (o CreditReasonOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CreditReason) *string { return v.Description }).(pulumi.StringPtrOutput)
}

type CreditReasonPtrOutput struct{ *pulumi.OutputState }

func (CreditReasonPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**CreditReason)(nil)).Elem()
}

func (o CreditReasonPtrOutput) ToCreditReasonPtrOutput() CreditReasonPtrOutput {
	return o
}

func (o CreditReasonPtrOutput) ToCreditReasonPtrOutputWithContext(ctx context.Context) CreditReasonPtrOutput {
	return o
}

func (o CreditReasonPtrOutput) Elem() CreditReasonOutput {
	return o.ApplyT(func(v *CreditReason) CreditReason {
		if v != nil {
			return *v
		}
		var ret CreditReason
		return ret
	}).(CreditReasonOutput)
}

// The reason code for credit.
func (o CreditReasonPtrOutput) Code() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CreditReason) *string {
		if v == nil {
			return nil
		}
		return v.Code
...
// The free string description of the credit.
func (o CreditReasonPtrOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CreditReason) *string {
		if v == nil {
			return nil
		}
...
// The reason code for credit.
func (o CreditReasonResponseOutput) Code() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CreditReasonResponse) *string { return v.Code }).(pulumi.StringPtrOutput)
}

// The free string description of the credit.
func (o CreditReasonResponseOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CreditReasonResponse) *string { return v.Description }).(pulumi.StringPtrOutput)
}
...
// The reason code for credit.
func (o CreditReasonResponsePtrOutput) Code() pulumi.StringPtrOutput {
...
type PrimaryConditionalCreditProperties struct {
	...
	AllowContributors *string `pulumi:"allowContributors"`
	// The billing account resource ID
	BillingAccountResourceId *string `pulumi:"billingAccountResourceId"`
	// Display name for the conditional credit
	DisplayName *string `pulumi:"displayName"`
	...
	Milestones []ConditionalCreditMilestone `pulumi:"milestones"`
	// Product code for the conditional credit
	ProductCode *string `pulumi:"productCode"`
	// Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
	ResourceId *string `pulumi:"resourceId"`
...
// PrimaryConditionalCreditPropertiesInput is an input type that accepts PrimaryConditionalCreditPropertiesArgs and PrimaryConditionalCreditPropertiesOutput values.
// You can construct a concrete instance of `PrimaryConditionalCreditPropertiesInput` via:
//
//	PrimaryConditionalCreditPropertiesArgs{...}
type PrimaryConditionalCreditPropertiesInput interface {
	pulumi.Input

	ToPrimaryConditionalCreditPropertiesOutput() PrimaryConditionalCreditPropertiesOutput
	ToPrimaryConditionalCreditPropertiesOutputWithContext(context.Context) PrimaryConditionalCreditPropertiesOutput
}

// Properties for primary conditional credit.
type PrimaryConditionalCreditPropertiesArgs struct {
	// Whether this conditional credit allows contributor billing accounts
	AllowContributors pulumi.StringPtrInput `pulumi:"allowContributors"`
	// The billing account resource ID
	BillingAccountResourceId pulumi.StringPtrInput `pulumi:"billingAccountResourceId"`
	// Display name for the conditional credit
	DisplayName pulumi.StringPtrInput `pulumi:"displayName"`
	...
	EntityType pulumi.StringInput `pulumi:"entityType"`
	// List of milestones for this conditional credit (must include awards)
	Milestones ConditionalCreditMilestoneArrayInput `pulumi:"milestones"`
	// Product code for the conditional credit
	ProductCode pulumi.StringPtrInput `pulumi:"productCode"`
	// Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
	ResourceId pulumi.StringPtrInput `pulumi:"resourceId"`
...
func (PrimaryConditionalCreditPropertiesArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*PrimaryConditionalCreditProperties)(nil)).Elem()
}

func (i PrimaryConditionalCreditPropertiesArgs) ToPrimaryConditionalCreditPropertiesOutput() PrimaryConditionalCreditPropertiesOutput {
	return i.ToPrimaryConditionalCreditPropertiesOutputWithContext(context.Background())
}

func (i PrimaryConditionalCreditPropertiesArgs) ToPrimaryConditionalCreditPropertiesOutputWithContext(ctx context.Context) PrimaryConditionalCreditPropertiesOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrimaryConditionalCreditPropertiesOutput)
}

func (i PrimaryConditionalCreditPropertiesArgs) ToPrimaryConditionalCreditPropertiesPtrOutput() PrimaryConditionalCreditPropertiesPtrOutput {
	return i.ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(context.Background())
}

func (i PrimaryConditionalCreditPropertiesArgs) ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(ctx context.Context) PrimaryConditionalCreditPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrimaryConditionalCreditPropertiesOutput).ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(ctx)
}

// PrimaryConditionalCreditPropertiesPtrInput is an input type that accepts PrimaryConditionalCreditPropertiesArgs, PrimaryConditionalCreditPropertiesPtr and PrimaryConditionalCreditPropertiesPtrOutput values.
// You can construct a concrete instance of `PrimaryConditionalCreditPropertiesPtrInput` via:
//
//	        PrimaryConditionalCreditPropertiesArgs{...}
//
//	or:
//
//	        nil
type PrimaryConditionalCreditPropertiesPtrInput interface {
	pulumi.Input

	ToPrimaryConditionalCreditPropertiesPtrOutput() PrimaryConditionalCreditPropertiesPtrOutput
	ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(context.Context) PrimaryConditionalCreditPropertiesPtrOutput
}

type primaryConditionalCreditPropertiesPtrType PrimaryConditionalCreditPropertiesArgs

func PrimaryConditionalCreditPropertiesPtr(v *PrimaryConditionalCreditPropertiesArgs) PrimaryConditionalCreditPropertiesPtrInput {
	return (*primaryConditionalCreditPropertiesPtrType)(v)
}

func (*primaryConditionalCreditPropertiesPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PrimaryConditionalCreditProperties)(nil)).Elem()
}

func (i *primaryConditionalCreditPropertiesPtrType) ToPrimaryConditionalCreditPropertiesPtrOutput() PrimaryConditionalCreditPropertiesPtrOutput {
	return i.ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(context.Background())
}

func (i *primaryConditionalCreditPropertiesPtrType) ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(ctx context.Context) PrimaryConditionalCreditPropertiesPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrimaryConditionalCreditPropertiesPtrOutput)
}

// Properties for primary conditional credit.
type PrimaryConditionalCreditPropertiesOutput struct{ *pulumi.OutputState }

func (PrimaryConditionalCreditPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PrimaryConditionalCreditProperties)(nil)).Elem()
}

func (o PrimaryConditionalCreditPropertiesOutput) ToPrimaryConditionalCreditPropertiesOutput() PrimaryConditionalCreditPropertiesOutput {
	return o
}

func (o PrimaryConditionalCreditPropertiesOutput) ToPrimaryConditionalCreditPropertiesOutputWithContext(ctx context.Context) PrimaryConditionalCreditPropertiesOutput {
	return o
}

func (o PrimaryConditionalCreditPropertiesOutput) ToPrimaryConditionalCreditPropertiesPtrOutput() PrimaryConditionalCreditPropertiesPtrOutput {
	return o.ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(context.Background())
}

func (o PrimaryConditionalCreditPropertiesOutput) ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(ctx context.Context) PrimaryConditionalCreditPropertiesPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v PrimaryConditionalCreditProperties) *PrimaryConditionalCreditProperties {
		return &v
	}).(PrimaryConditionalCreditPropertiesPtrOutput)
}

// Whether this conditional credit allows contributor billing accounts
func (o PrimaryConditionalCreditPropertiesOutput) AllowContributors() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.AllowContributors }).(pulumi.StringPtrOutput)
}

// The billing account resource ID
func (o PrimaryConditionalCreditPropertiesOutput) BillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.BillingAccountResourceId }).(pulumi.StringPtrOutput)
}

// Display name for the conditional credit
func (o PrimaryConditionalCreditPropertiesOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}

// End date of the conditional credit (derived from last milestone)
func (o PrimaryConditionalCreditPropertiesOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Type of conditional credit entity
// Expected value is 'Primary'.
func (o PrimaryConditionalCreditPropertiesOutput) EntityType() pulumi.StringOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) string { return v.EntityType }).(pulumi.StringOutput)
}

// List of milestones for this conditional credit (must include awards)
func (o PrimaryConditionalCreditPropertiesOutput) Milestones() ConditionalCreditMilestoneArrayOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) []ConditionalCreditMilestone { return v.Milestones }).(ConditionalCreditMilestoneArrayOutput)
}

// Product code for the conditional credit
func (o PrimaryConditionalCreditPropertiesOutput) ProductCode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.ProductCode }).(pulumi.StringPtrOutput)
}

// Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
func (o PrimaryConditionalCreditPropertiesOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.ResourceId }).(pulumi.StringPtrOutput)
}

// Start date of the conditional credit
func (o PrimaryConditionalCreditPropertiesOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.StartAt }).(pulumi.StringPtrOutput)
}

// The status of the conditional credit
func (o PrimaryConditionalCreditPropertiesOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.Status }).(pulumi.StringPtrOutput)
}

// System identifier shared between primary and contributor conditional credits representing the same conditional credit program
func (o PrimaryConditionalCreditPropertiesOutput) SystemId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditProperties) *string { return v.SystemId }).(pulumi.StringPtrOutput)
}

type PrimaryConditionalCreditPropertiesPtrOutput struct{ *pulumi.OutputState }

func (PrimaryConditionalCreditPropertiesPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PrimaryConditionalCreditProperties)(nil)).Elem()
}

func (o PrimaryConditionalCreditPropertiesPtrOutput) ToPrimaryConditionalCreditPropertiesPtrOutput() PrimaryConditionalCreditPropertiesPtrOutput {
	return o
}

func (o PrimaryConditionalCreditPropertiesPtrOutput) ToPrimaryConditionalCreditPropertiesPtrOutputWithContext(ctx context.Context) PrimaryConditionalCreditPropertiesPtrOutput {
	return o
}

func (o PrimaryConditionalCreditPropertiesPtrOutput) Elem() PrimaryConditionalCreditPropertiesOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) PrimaryConditionalCreditProperties {
		if v != nil {
			return *v
		}
		var ret PrimaryConditionalCreditProperties
		return ret
	}).(PrimaryConditionalCreditPropertiesOutput)
}

// Whether this conditional credit allows contributor billing accounts
func (o PrimaryConditionalCreditPropertiesPtrOutput) AllowContributors() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
		return v.AllowContributors
	}).(pulumi.StringPtrOutput)
}

// The billing account resource ID
func (o PrimaryConditionalCreditPropertiesPtrOutput) BillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Display name for the conditional credit
func (o PrimaryConditionalCreditPropertiesPtrOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// End date of the conditional credit (derived from last milestone)
func (o PrimaryConditionalCreditPropertiesPtrOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Type of conditional credit entity
// Expected value is 'Primary'.
func (o PrimaryConditionalCreditPropertiesPtrOutput) EntityType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// List of milestones for this conditional credit (must include awards)
func (o PrimaryConditionalCreditPropertiesPtrOutput) Milestones() ConditionalCreditMilestoneArrayOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) []ConditionalCreditMilestone {
		if v == nil {
			return nil
		}
		return v.Milestones
	}).(ConditionalCreditMilestoneArrayOutput)
}

// Product code for the conditional credit
func (o PrimaryConditionalCreditPropertiesPtrOutput) ProductCode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
func (o PrimaryConditionalCreditPropertiesPtrOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Start date of the conditional credit
func (o PrimaryConditionalCreditPropertiesPtrOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// The status of the conditional credit
func (o PrimaryConditionalCreditPropertiesPtrOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// System identifier shared between primary and contributor conditional credits representing the same conditional credit program
func (o PrimaryConditionalCreditPropertiesPtrOutput) SystemId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PrimaryConditionalCreditProperties) *string {
		if v == nil {
			return nil
		}
...
// Properties for primary conditional credit.
type PrimaryConditionalCreditPropertiesResponse struct {
	// Whether this conditional credit allows contributor billing accounts
	AllowContributors *string `pulumi:"allowContributors"`
	// Fully-qualified identifier of the benefit under applicable benefit list.
	BenefitResourceId string `pulumi:"benefitResourceId"`
	...
	EntityType string `pulumi:"entityType"`
	// List of milestones for this conditional credit (must include awards)
	Milestones []ConditionalCreditMilestoneResponse `pulumi:"milestones"`
	// Product code for the conditional credit
	ProductCode *string `pulumi:"productCode"`
	// The provisioning state of the resource
	ProvisioningState string `pulumi:"provisioningState"`
...
// Properties for primary conditional credit.
type PrimaryConditionalCreditPropertiesResponseOutput struct{ *pulumi.OutputState }

func (PrimaryConditionalCreditPropertiesResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PrimaryConditionalCreditPropertiesResponse)(nil)).Elem()
}

func (o PrimaryConditionalCreditPropertiesResponseOutput) ToPrimaryConditionalCreditPropertiesResponseOutput() PrimaryConditionalCreditPropertiesResponseOutput {
	return o
}

func (o PrimaryConditionalCreditPropertiesResponseOutput) ToPrimaryConditionalCreditPropertiesResponseOutputWithContext(ctx context.Context) PrimaryConditionalCreditPropertiesResponseOutput {
	return o
}

// Whether this conditional credit allows contributor billing accounts
func (o PrimaryConditionalCreditPropertiesResponseOutput) AllowContributors() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.AllowContributors }).(pulumi.StringPtrOutput)
}

// Fully-qualified identifier of the benefit under applicable benefit list.
func (o PrimaryConditionalCreditPropertiesResponseOutput) BenefitResourceId() pulumi.StringOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) string { return v.BenefitResourceId }).(pulumi.StringOutput)
}

// The billing account resource ID
func (o PrimaryConditionalCreditPropertiesResponseOutput) BillingAccountResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.BillingAccountResourceId }).(pulumi.StringPtrOutput)
}

// Display name for the conditional credit
func (o PrimaryConditionalCreditPropertiesResponseOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}

// End date of the conditional credit (derived from last milestone)
func (o PrimaryConditionalCreditPropertiesResponseOutput) EndAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.EndAt }).(pulumi.StringPtrOutput)
}

// Type of conditional credit entity
// Expected value is 'Primary'.
func (o PrimaryConditionalCreditPropertiesResponseOutput) EntityType() pulumi.StringOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) string { return v.EntityType }).(pulumi.StringOutput)
}

// List of milestones for this conditional credit (must include awards)
func (o PrimaryConditionalCreditPropertiesResponseOutput) Milestones() ConditionalCreditMilestoneResponseArrayOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) []ConditionalCreditMilestoneResponse {
		return v.Milestones
	}).(ConditionalCreditMilestoneResponseArrayOutput)
}

// Product code for the conditional credit
func (o PrimaryConditionalCreditPropertiesResponseOutput) ProductCode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.ProductCode }).(pulumi.StringPtrOutput)
}

// The provisioning state of the resource
func (o PrimaryConditionalCreditPropertiesResponseOutput) ProvisioningState() pulumi.StringOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) string { return v.ProvisioningState }).(pulumi.StringOutput)
}

// Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
func (o PrimaryConditionalCreditPropertiesResponseOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.ResourceId }).(pulumi.StringPtrOutput)
}

// Start date of the conditional credit
func (o PrimaryConditionalCreditPropertiesResponseOutput) StartAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.StartAt }).(pulumi.StringPtrOutput)
}

// The status of the conditional credit
func (o PrimaryConditionalCreditPropertiesResponseOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.Status }).(pulumi.StringPtrOutput)
}

// System identifier shared between primary and contributor conditional credits representing the same conditional credit program
func (o PrimaryConditionalCreditPropertiesResponseOutput) SystemId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrimaryConditionalCreditPropertiesResponse) *string { return v.SystemId }).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(AwardOutput{})
	pulumi.RegisterOutputType(AwardPtrOutput{})
	pulumi.RegisterOutputType(AwardResponseOutput{})
	pulumi.RegisterOutputType(AwardResponsePtrOutput{})
	...
	pulumi.RegisterOutputType(ConditionalCreditMilestoneOutput{})
	pulumi.RegisterOutputType(ConditionalCreditMilestoneArrayOutput{})
	pulumi.RegisterOutputType(ConditionalCreditMilestoneResponseOutput{})
	pulumi.RegisterOutputType(ConditionalCreditMilestoneResponseArrayOutput{})
	...
	pulumi.RegisterOutputType(ContributorConditionalCreditMilestoneResponseOutput{})
	pulumi.RegisterOutputType(ContributorConditionalCreditMilestoneResponseArrayOutput{})
	pulumi.RegisterOutputType(ContributorConditionalCreditPropertiesOutput{})
	pulumi.RegisterOutputType(ContributorConditionalCreditPropertiesPtrOutput{})
	pulumi.RegisterOutputType(ContributorConditionalCreditPropertiesResponseOutput{})
	...
	pulumi.RegisterOutputType(CreditReasonOutput{})
	pulumi.RegisterOutputType(CreditReasonPtrOutput{})
	...
	pulumi.RegisterOutputType(PrimaryConditionalCreditPropertiesOutput{})
	pulumi.RegisterOutputType(PrimaryConditionalCreditPropertiesPtrOutput{})
	pulumi.RegisterOutputType(PrimaryConditionalCreditPropertiesResponseOutput{})
