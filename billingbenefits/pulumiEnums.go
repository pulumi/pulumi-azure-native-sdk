...
func (MilestoneStatus) ElementType() reflect.Type {
	return reflect.TypeOf((*MilestoneStatus)(nil)).Elem()
}

func (e MilestoneStatus) ToMilestoneStatusOutput() MilestoneStatusOutput {
	return pulumi.ToOutput(e).(MilestoneStatusOutput)
}

func (e MilestoneStatus) ToMilestoneStatusOutputWithContext(ctx context.Context) MilestoneStatusOutput {
	return pulumi.ToOutputWithContext(ctx, e).(MilestoneStatusOutput)
}

func (e MilestoneStatus) ToMilestoneStatusPtrOutput() MilestoneStatusPtrOutput {
	return e.ToMilestoneStatusPtrOutputWithContext(context.Background())
}

func (e MilestoneStatus) ToMilestoneStatusPtrOutputWithContext(ctx context.Context) MilestoneStatusPtrOutput {
	return MilestoneStatus(e).ToMilestoneStatusOutputWithContext(ctx).ToMilestoneStatusPtrOutputWithContext(ctx)
}

func (e MilestoneStatus) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e MilestoneStatus) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e MilestoneStatus) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e MilestoneStatus) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type MilestoneStatusOutput struct{ *pulumi.OutputState }

func (MilestoneStatusOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*MilestoneStatus)(nil)).Elem()
}

func (o MilestoneStatusOutput) ToMilestoneStatusOutput() MilestoneStatusOutput {
	return o
}

func (o MilestoneStatusOutput) ToMilestoneStatusOutputWithContext(ctx context.Context) MilestoneStatusOutput {
	return o
}

func (o MilestoneStatusOutput) ToMilestoneStatusPtrOutput() MilestoneStatusPtrOutput {
	return o.ToMilestoneStatusPtrOutputWithContext(context.Background())
}

func (o MilestoneStatusOutput) ToMilestoneStatusPtrOutputWithContext(ctx context.Context) MilestoneStatusPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v MilestoneStatus) *MilestoneStatus {
		return &v
	}).(MilestoneStatusPtrOutput)
}

func (o MilestoneStatusOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o MilestoneStatusOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e MilestoneStatus) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o MilestoneStatusOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o MilestoneStatusOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e MilestoneStatus) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type MilestoneStatusPtrOutput struct{ *pulumi.OutputState }

func (MilestoneStatusPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**MilestoneStatus)(nil)).Elem()
}

func (o MilestoneStatusPtrOutput) ToMilestoneStatusPtrOutput() MilestoneStatusPtrOutput {
	return o
}

func (o MilestoneStatusPtrOutput) ToMilestoneStatusPtrOutputWithContext(ctx context.Context) MilestoneStatusPtrOutput {
	return o
}

func (o MilestoneStatusPtrOutput) Elem() MilestoneStatusOutput {
	return o.ApplyT(func(v *MilestoneStatus) MilestoneStatus {
		if v != nil {
			return *v
		}
		var ret MilestoneStatus
		return ret
	}).(MilestoneStatusOutput)
}

func (o MilestoneStatusPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o MilestoneStatusPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *MilestoneStatus) *string {
		if e == nil {
			return nil
		}
...
// MilestoneStatusInput is an input type that accepts values of the MilestoneStatus enum
// A concrete instance of `MilestoneStatusInput` can be one of the following:
//
...
type MilestoneStatusInput interface {
	pulumi.Input

	ToMilestoneStatusOutput() MilestoneStatusOutput
	ToMilestoneStatusOutputWithContext(context.Context) MilestoneStatusOutput
}

var milestoneStatusPtrType = reflect.TypeOf((**MilestoneStatus)(nil)).Elem()

type MilestoneStatusPtrInput interface {
	pulumi.Input

	ToMilestoneStatusPtrOutput() MilestoneStatusPtrOutput
	ToMilestoneStatusPtrOutputWithContext(context.Context) MilestoneStatusPtrOutput
}

type milestoneStatusPtr string

func MilestoneStatusPtr(v string) MilestoneStatusPtrInput {
	return (*milestoneStatusPtr)(&v)
}

func (*milestoneStatusPtr) ElementType() reflect.Type {
	return milestoneStatusPtrType
}

func (in *milestoneStatusPtr) ToMilestoneStatusPtrOutput() MilestoneStatusPtrOutput {
	return pulumi.ToOutput(in).(MilestoneStatusPtrOutput)
}

func (in *milestoneStatusPtr) ToMilestoneStatusPtrOutputWithContext(ctx context.Context) MilestoneStatusPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(MilestoneStatusPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(MilestoneStatusOutput{})
	pulumi.RegisterOutputType(MilestoneStatusPtrOutput{})
