...
func NewStorageTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storageactions:StorageTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageTask(ctx *pulumi.Context,
	...
	var resource StorageTask
	err := ctx.ReadResource("azure-native:storageactions:StorageTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
