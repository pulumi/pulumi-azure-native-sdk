...
func NewStorageTask(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:storageactions:StorageTask"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource StorageTask
	err := ctx.RegisterResource("azure-native:storageactions/v20230101:StorageTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageTask(ctx *pulumi.Context,
	...
	var resource StorageTask
	err := ctx.ReadResource("azure-native:storageactions/v20230101:StorageTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
