...
func NewMetricAlert(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20260101:MetricAlert"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MetricAlert
	err := ctx.RegisterResource("azure-native:monitor:MetricAlert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetricAlert(ctx *pulumi.Context,
	...
	var resource MetricAlert
	err := ctx.ReadResource("azure-native:monitor:MetricAlert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o MetricAlertOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *MetricAlert) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
