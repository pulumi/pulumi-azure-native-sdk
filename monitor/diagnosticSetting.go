...
func NewDiagnosticSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20170501preview:DiagnosticSetting"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210501preview:DiagnosticSetting"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DiagnosticSetting
	err := ctx.RegisterResource("azure-native:monitor:DiagnosticSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiagnosticSetting(ctx *pulumi.Context,
	...
	var resource DiagnosticSetting
	err := ctx.ReadResource("azure-native:monitor:DiagnosticSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The system metadata related to this resource.
func (o DiagnosticSettingOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *DiagnosticSetting) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
