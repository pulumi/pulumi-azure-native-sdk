...
func NewManagementGroupDiagnosticSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20200101preview:ManagementGroupDiagnosticSetting"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210501preview:ManagementGroupDiagnosticSetting"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ManagementGroupDiagnosticSetting
	err := ctx.RegisterResource("azure-native:monitor:ManagementGroupDiagnosticSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagementGroupDiagnosticSetting(ctx *pulumi.Context,
	...
	var resource ManagementGroupDiagnosticSetting
	err := ctx.ReadResource("azure-native:monitor:ManagementGroupDiagnosticSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ManagementGroupDiagnosticSettingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagementGroupDiagnosticSetting) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
