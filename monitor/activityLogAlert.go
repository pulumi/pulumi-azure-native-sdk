...
func NewActivityLogAlert(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20170401:ActivityLogAlert"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20201001:ActivityLogAlert"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20230101preview:ActivityLogAlert"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20260101:ActivityLogAlert"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ActivityLogAlert
	err := ctx.RegisterResource("azure-native:monitor:ActivityLogAlert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActivityLogAlert(ctx *pulumi.Context,
	...
	var resource ActivityLogAlert
	err := ctx.ReadResource("azure-native:monitor:ActivityLogAlert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o ActivityLogAlertOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ActivityLogAlert) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
