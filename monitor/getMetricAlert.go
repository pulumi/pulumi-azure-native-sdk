...
func LookupMetricAlert(ctx *pulumi.Context, args *LookupMetricAlertArgs, opts ...pulumi.InvokeOption) (*LookupMetricAlertResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor:getMetricAlert", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMetricAlertOutput(ctx *pulumi.Context, args LookupMetricAlertOutputArgs, opts ...pulumi.InvokeOption) LookupMetricAlertResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMetricAlertResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor:getMetricAlert", args, LookupMetricAlertResultOutput{}, options).(LookupMetricAlertResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupMetricAlertResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupMetricAlertResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
