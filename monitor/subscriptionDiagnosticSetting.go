...
func NewSubscriptionDiagnosticSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20170501preview:SubscriptionDiagnosticSetting"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210501preview:SubscriptionDiagnosticSetting"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SubscriptionDiagnosticSetting
	err := ctx.RegisterResource("azure-native:monitor:SubscriptionDiagnosticSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionDiagnosticSetting(ctx *pulumi.Context,
	...
	var resource SubscriptionDiagnosticSetting
	err := ctx.ReadResource("azure-native:monitor:SubscriptionDiagnosticSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o SubscriptionDiagnosticSettingOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SubscriptionDiagnosticSetting) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata related to this resource.
func (o SubscriptionDiagnosticSettingOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v *SubscriptionDiagnosticSetting) commontypesv2.SystemDataResponseOutput { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
