...
func NewMonitoringAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:monitor/v20210603preview:MonitoringAccount"),
		},
	})
	opts = append(opts, aliases)
	var resource MonitoringAccount
	err := ctx.RegisterResource("azure-native:monitor:MonitoringAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringAccount(ctx *pulumi.Context,
	...
	var resource MonitoringAccount
	err := ctx.ReadResource("azure-native:monitor:MonitoringAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
