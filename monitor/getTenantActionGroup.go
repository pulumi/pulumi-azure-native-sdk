...
func LookupTenantActionGroup(ctx *pulumi.Context, args *LookupTenantActionGroupArgs, opts ...pulumi.InvokeOption) (*LookupTenantActionGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor:getTenantActionGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupTenantActionGroupOutput(ctx *pulumi.Context, args LookupTenantActionGroupOutputArgs, opts ...pulumi.InvokeOption) LookupTenantActionGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTenantActionGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor:getTenantActionGroup", args, LookupTenantActionGroupResultOutput{}, options).(LookupTenantActionGroupResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupTenantActionGroupResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupTenantActionGroupResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
