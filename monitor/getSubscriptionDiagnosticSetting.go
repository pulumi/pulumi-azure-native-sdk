...
func LookupSubscriptionDiagnosticSetting(ctx *pulumi.Context, args *LookupSubscriptionDiagnosticSettingArgs, opts ...pulumi.InvokeOption) (*LookupSubscriptionDiagnosticSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor:getSubscriptionDiagnosticSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSubscriptionDiagnosticSettingOutput(ctx *pulumi.Context, args LookupSubscriptionDiagnosticSettingOutputArgs, opts ...pulumi.InvokeOption) LookupSubscriptionDiagnosticSettingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSubscriptionDiagnosticSettingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor:getSubscriptionDiagnosticSetting", args, LookupSubscriptionDiagnosticSettingResultOutput{}, options).(LookupSubscriptionDiagnosticSettingResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupSubscriptionDiagnosticSettingResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSubscriptionDiagnosticSettingResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata related to this resource.
func (o LookupSubscriptionDiagnosticSettingResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupSubscriptionDiagnosticSettingResult) commontypesv2.SystemDataResponse {
		return v.SystemData
