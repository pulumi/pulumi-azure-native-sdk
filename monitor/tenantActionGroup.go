...
func NewTenantActionGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20230301preview:TenantActionGroup"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20230501preview:TenantActionGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TenantActionGroup
	err := ctx.RegisterResource("azure-native:monitor:TenantActionGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTenantActionGroup(ctx *pulumi.Context,
	...
	var resource TenantActionGroup
	err := ctx.ReadResource("azure-native:monitor:TenantActionGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o TenantActionGroupOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *TenantActionGroup) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
