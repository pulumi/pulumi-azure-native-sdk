...
func NewDataCollectionRuleAssociation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20191101preview:DataCollectionRuleAssociation"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210401:DataCollectionRuleAssociation"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210901preview:DataCollectionRuleAssociation"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20220601:DataCollectionRuleAssociation"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20230311:DataCollectionRuleAssociation"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20240311:DataCollectionRuleAssociation"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DataCollectionRuleAssociation
	err := ctx.RegisterResource("azure-native:monitor:DataCollectionRuleAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCollectionRuleAssociation(ctx *pulumi.Context,
	...
	var resource DataCollectionRuleAssociation
	err := ctx.ReadResource("azure-native:monitor:DataCollectionRuleAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DataCollectionRuleAssociationOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DataCollectionRuleAssociation) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
