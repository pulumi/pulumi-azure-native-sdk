...
func LookupScheduledQueryRule(ctx *pulumi.Context, args *LookupScheduledQueryRuleArgs, opts ...pulumi.InvokeOption) (*LookupScheduledQueryRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor:getScheduledQueryRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupScheduledQueryRuleResult struct {
	...
	Identity *MicrosoftCommonIdentityResponse `pulumi:"identity"`
...
func LookupScheduledQueryRuleOutput(ctx *pulumi.Context, args LookupScheduledQueryRuleOutputArgs, opts ...pulumi.InvokeOption) LookupScheduledQueryRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScheduledQueryRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor:getScheduledQueryRule", args, LookupScheduledQueryRuleResultOutput{}, options).(LookupScheduledQueryRuleResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupScheduledQueryRuleResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupScheduledQueryRuleResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The rule criteria that defines the conditions of the scheduled query rule.
func (o LookupScheduledQueryRuleResultOutput) Criteria() ScheduledQueryRuleCriteriaResponsePtrOutput {
	return o.ApplyT(func(v LookupScheduledQueryRuleResult) *ScheduledQueryRuleCriteriaResponse { return v.Criteria }).(ScheduledQueryRuleCriteriaResponsePtrOutput)
}
...
// The flag which indicates whether this scheduled query rule is enabled. Value should be true or false
func (o LookupScheduledQueryRuleResultOutput) Enabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupScheduledQueryRuleResult) *bool { return v.Enabled }).(pulumi.BoolPtrOutput)
}
...
// The identity of the resource.
func (o LookupScheduledQueryRuleResultOutput) Identity() MicrosoftCommonIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupScheduledQueryRuleResult) *MicrosoftCommonIdentityResponse { return v.Identity }).(MicrosoftCommonIdentityResponsePtrOutput)
}
