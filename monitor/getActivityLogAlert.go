...
func LookupActivityLogAlert(ctx *pulumi.Context, args *LookupActivityLogAlertArgs, opts ...pulumi.InvokeOption) (*LookupActivityLogAlertResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor:getActivityLogAlert", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
func LookupActivityLogAlertOutput(ctx *pulumi.Context, args LookupActivityLogAlertOutputArgs, opts ...pulumi.InvokeOption) LookupActivityLogAlertResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupActivityLogAlertResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor:getActivityLogAlert", args, LookupActivityLogAlertResultOutput{}, options).(LookupActivityLogAlertResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupActivityLogAlertResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupActivityLogAlertResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
