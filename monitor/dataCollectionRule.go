...
func NewDataCollectionRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20191101preview:DataCollectionRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210401:DataCollectionRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210901preview:DataCollectionRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20220601:DataCollectionRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:monitor:DataCollectionRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCollectionRule(ctx *pulumi.Context,
	...
	var resource DataCollectionRule
	err := ctx.ReadResource("azure-native:monitor:DataCollectionRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DataCollectionRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DataCollectionRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
