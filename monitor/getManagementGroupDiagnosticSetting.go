...
func LookupManagementGroupDiagnosticSetting(ctx *pulumi.Context, args *LookupManagementGroupDiagnosticSettingArgs, opts ...pulumi.InvokeOption) (*LookupManagementGroupDiagnosticSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor:getManagementGroupDiagnosticSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupManagementGroupDiagnosticSettingOutput(ctx *pulumi.Context, args LookupManagementGroupDiagnosticSettingOutputArgs, opts ...pulumi.InvokeOption) LookupManagementGroupDiagnosticSettingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupManagementGroupDiagnosticSettingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor:getManagementGroupDiagnosticSetting", args, LookupManagementGroupDiagnosticSettingResultOutput{}, options).(LookupManagementGroupDiagnosticSettingResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupManagementGroupDiagnosticSettingResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupManagementGroupDiagnosticSettingResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The system metadata related to this resource.
func (o LookupManagementGroupDiagnosticSettingResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupManagementGroupDiagnosticSettingResult) commontypesv2.SystemDataResponse {
		return v.SystemData
