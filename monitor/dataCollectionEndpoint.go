...
func NewDataCollectionEndpoint(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:insights/v20230311:DataCollectionEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:insights:DataCollectionEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210401:DataCollectionEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210901preview:DataCollectionEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20220601:DataCollectionEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20230311:DataCollectionEndpoint"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20240311:DataCollectionEndpoint"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DataCollectionEndpoint
	err := ctx.RegisterResource("azure-native:monitor:DataCollectionEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCollectionEndpoint(ctx *pulumi.Context,
	...
	var resource DataCollectionEndpoint
	err := ctx.ReadResource("azure-native:monitor:DataCollectionEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o DataCollectionEndpointOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DataCollectionEndpoint) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
