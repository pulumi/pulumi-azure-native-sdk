...
func NewPrivateLinkScope(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20191017preview:PrivateLinkScope"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210701preview:PrivateLinkScope"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210901:PrivateLinkScope"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20230601preview:PrivateLinkScope"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateLinkScope
	err := ctx.RegisterResource("azure-native:monitor:PrivateLinkScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateLinkScope(ctx *pulumi.Context,
	...
	var resource PrivateLinkScope
	err := ctx.ReadResource("azure-native:monitor:PrivateLinkScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
