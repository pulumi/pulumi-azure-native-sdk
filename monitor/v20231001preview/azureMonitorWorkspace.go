...
func NewAzureMonitorWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:monitor/v20231001preview:AzureMonitorWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureMonitorWorkspace(ctx *pulumi.Context,
	...
	var resource AzureMonitorWorkspace
	err := ctx.ReadResource("azure-native:monitor/v20231001preview:AzureMonitorWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
