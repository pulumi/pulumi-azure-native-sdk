...
func LookupActionGroup(ctx *pulumi.Context, args *LookupActionGroupArgs, opts ...pulumi.InvokeOption) (*LookupActionGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor:getActionGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupActionGroupResult struct {
	...
	IncidentReceivers []IncidentReceiverResponse `pulumi:"incidentReceivers"`
...
func LookupActionGroupOutput(ctx *pulumi.Context, args LookupActionGroupOutputArgs, opts ...pulumi.InvokeOption) LookupActionGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupActionGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor:getActionGroup", args, LookupActionGroupResultOutput{}, options).(LookupActionGroupResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupActionGroupResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupActionGroupResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The managed service identities assigned to this resource.
func (o LookupActionGroupResultOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupActionGroupResult) *ManagedServiceIdentityResponse { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}

// The list of incident receivers that are part of this action group.
func (o LookupActionGroupResultOutput) IncidentReceivers() IncidentReceiverResponseArrayOutput {
	return o.ApplyT(func(v LookupActionGroupResult) []IncidentReceiverResponse { return v.IncidentReceivers }).(IncidentReceiverResponseArrayOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupActionGroupResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupActionGroupResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
