...
type ScheduledQueryRule struct {
	...
	Identity MicrosoftCommonIdentityResponsePtrOutput `pulumi:"identity"`
...
func NewScheduledQueryRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:monitor/v20180416:ScheduledQueryRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20200501preview:ScheduledQueryRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210201preview:ScheduledQueryRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20210801:ScheduledQueryRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20220615:ScheduledQueryRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20220801preview:ScheduledQueryRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20230315preview:ScheduledQueryRule"),
		},
		{
			Type: pulumi.String("azure-native:monitor/v20231201:ScheduledQueryRule"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:monitor:ScheduledQueryRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduledQueryRule(ctx *pulumi.Context,
	...
	var resource ScheduledQueryRule
	err := ctx.ReadResource("azure-native:monitor:ScheduledQueryRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type scheduledQueryRuleArgs struct {
	...
	// The identity of the resource.
	Identity *MicrosoftCommonIdentity `pulumi:"identity"`
	// Indicates the type of scheduled query rule. The default is LogAlert.
...
type ScheduledQueryRuleArgs struct {
	...
	// The identity of the resource.
	Identity MicrosoftCommonIdentityPtrInput
	// Indicates the type of scheduled query rule. The default is LogAlert.
...
// The Azure API version of the resource.
func (o ScheduledQueryRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ScheduledQueryRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The rule criteria that defines the conditions of the scheduled query rule.
func (o ScheduledQueryRuleOutput) Criteria() ScheduledQueryRuleCriteriaResponsePtrOutput {
	return o.ApplyT(func(v *ScheduledQueryRule) ScheduledQueryRuleCriteriaResponsePtrOutput { return v.Criteria }).(ScheduledQueryRuleCriteriaResponsePtrOutput)
}
...
// The flag which indicates whether this scheduled query rule is enabled. Value should be true or false
func (o ScheduledQueryRuleOutput) Enabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *ScheduledQueryRule) pulumi.BoolPtrOutput { return v.Enabled }).(pulumi.BoolPtrOutput)
}
...
// The identity of the resource.
func (o ScheduledQueryRuleOutput) Identity() MicrosoftCommonIdentityResponsePtrOutput {
	return o.ApplyT(func(v *ScheduledQueryRule) MicrosoftCommonIdentityResponsePtrOutput { return v.Identity }).(MicrosoftCommonIdentityResponsePtrOutput)
}
