...
func NewAuthenticationSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:monitor/v20250503preview:AuthenticationSetting"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AuthenticationSetting
	err := ctx.RegisterResource("azure-native:monitor:AuthenticationSetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthenticationSetting(ctx *pulumi.Context,
	...
	var resource AuthenticationSetting
	err := ctx.ReadResource("azure-native:monitor:AuthenticationSetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
