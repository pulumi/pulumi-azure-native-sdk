...
func LookupDiagnosticSetting(ctx *pulumi.Context, args *LookupDiagnosticSettingArgs, opts ...pulumi.InvokeOption) (*LookupDiagnosticSettingResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor:getDiagnosticSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDiagnosticSettingOutput(ctx *pulumi.Context, args LookupDiagnosticSettingOutputArgs, opts ...pulumi.InvokeOption) LookupDiagnosticSettingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDiagnosticSettingResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor:getDiagnosticSetting", args, LookupDiagnosticSettingResultOutput{}, options).(LookupDiagnosticSettingResultOutput), nil
...
// The system metadata related to this resource.
func (o LookupDiagnosticSettingResultOutput) SystemData() commontypesv2.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupDiagnosticSettingResult) commontypesv2.SystemDataResponse { return v.SystemData }).(commontypesv2.SystemDataResponseOutput)
}
