...
func LookupPipelineGroup(ctx *pulumi.Context, args *LookupPipelineGroupArgs, opts ...pulumi.InvokeOption) (*LookupPipelineGroupResult, error) {
	...
	err := ctx.Invoke("azure-native:monitor/v20241001preview:getPipelineGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPipelineGroupOutput(ctx *pulumi.Context, args LookupPipelineGroupOutputArgs, opts ...pulumi.InvokeOption) LookupPipelineGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPipelineGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:monitor/v20241001preview:getPipelineGroup", args, LookupPipelineGroupResultOutput{}, options).(LookupPipelineGroupResultOutput), nil
