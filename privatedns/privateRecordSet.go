...
func NewPrivateRecordSet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:privatedns/v20180901:PrivateRecordSet"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20200101:PrivateRecordSet"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20200601:PrivateRecordSet"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20240601:PrivateRecordSet"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateRecordSet
	err := ctx.RegisterResource("azure-native:privatedns:PrivateRecordSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateRecordSet(ctx *pulumi.Context,
	...
	var resource PrivateRecordSet
	err := ctx.ReadResource("azure-native:privatedns:PrivateRecordSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o PrivateRecordSetOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PrivateRecordSet) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
