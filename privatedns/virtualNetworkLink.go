...
func NewVirtualNetworkLink(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:privatedns/v20180901:VirtualNetworkLink"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20200101:VirtualNetworkLink"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20200601:VirtualNetworkLink"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20240601:VirtualNetworkLink"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualNetworkLink
	err := ctx.RegisterResource("azure-native:privatedns:VirtualNetworkLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkLink(ctx *pulumi.Context,
	...
	var resource VirtualNetworkLink
	err := ctx.ReadResource("azure-native:privatedns:VirtualNetworkLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o VirtualNetworkLinkOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VirtualNetworkLink) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o VirtualNetworkLinkOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *VirtualNetworkLink) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
