...
func LookupVirtualNetworkLink(ctx *pulumi.Context, args *LookupVirtualNetworkLinkArgs, opts ...pulumi.InvokeOption) (*LookupVirtualNetworkLinkResult, error) {
	...
	err := ctx.Invoke("azure-native:privatedns:getVirtualNetworkLink", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVirtualNetworkLinkOutput(ctx *pulumi.Context, args LookupVirtualNetworkLinkOutputArgs, opts ...pulumi.InvokeOption) LookupVirtualNetworkLinkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVirtualNetworkLinkResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:privatedns:getVirtualNetworkLink", args, LookupVirtualNetworkLinkResultOutput{}, options).(LookupVirtualNetworkLinkResultOutput), nil
...
// The Azure API version of the resource.
func (o LookupVirtualNetworkLinkResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupVirtualNetworkLinkResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// The resolution policy on the virtual network link. Only applicable for virtual network links to privatelink zones, and for A,AAAA,CNAME queries. When set to 'NxDomainRedirect', Azure DNS resolver falls back to public resolution if private dns query resolution results in non-existent domain response.
func (o LookupVirtualNetworkLinkResultOutput) ResolutionPolicy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualNetworkLinkResult) *string { return v.ResolutionPolicy }).(pulumi.StringPtrOutput)
}

// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupVirtualNetworkLinkResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupVirtualNetworkLinkResult) commontypesv3.SystemDataResponse { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
