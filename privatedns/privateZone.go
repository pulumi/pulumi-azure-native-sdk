...
func NewPrivateZone(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:privatedns/v20180901:PrivateZone"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20200101:PrivateZone"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20200601:PrivateZone"),
		},
		{
			Type: pulumi.String("azure-native:privatedns/v20240601:PrivateZone"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PrivateZone
	err := ctx.RegisterResource("azure-native:privatedns:PrivateZone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateZone(ctx *pulumi.Context,
	...
	var resource PrivateZone
	err := ctx.ReadResource("azure-native:privatedns:PrivateZone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Azure API version of the resource.
func (o PrivateZoneOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *PrivateZone) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o PrivateZoneOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *PrivateZone) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
