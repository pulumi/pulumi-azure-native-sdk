...
func NewServerDetails(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:analysisservices:ServerDetails", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerDetails(ctx *pulumi.Context,
	...
	var resource ServerDetails
	err := ctx.ReadResource("azure-native:analysisservices:ServerDetails", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
