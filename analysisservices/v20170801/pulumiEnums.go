...
// ConnectionModeInput is an input type that accepts values of the ConnectionMode enum
// A concrete instance of `ConnectionModeInput` can be one of the following:
//
//	ConnectionModeAll
