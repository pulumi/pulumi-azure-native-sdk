...
func NewThroughputPoolAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb:ThroughputPoolAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThroughputPoolAccount(ctx *pulumi.Context,
	...
	var resource ThroughputPoolAccount
	err := ctx.ReadResource("azure-native:documentdb:ThroughputPoolAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
