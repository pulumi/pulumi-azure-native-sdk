...
//
// Deprecated: azure-native:documentdb/v20210701preview:MongoDBResourceMongoDBDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:MongoDBResourceMongoDBDatabase to guarantee forwards compatibility.
...
func NewMongoDBResourceMongoDBDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20210701preview:MongoDBResourceMongoDBDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoDBResourceMongoDBDatabase(ctx *pulumi.Context,
	...
	var resource MongoDBResourceMongoDBDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20210701preview:MongoDBResourceMongoDBDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
