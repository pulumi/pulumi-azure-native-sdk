...
//
// Deprecated: azure-native:documentdb/v20210701preview:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.
func LookupSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context, args *LookupSqlResourceSqlUserDefinedFunctionArgs, opts ...pulumi.InvokeOption) (*LookupSqlResourceSqlUserDefinedFunctionResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20210701preview:getSqlResourceSqlUserDefinedFunction", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Identity for the resource.
func (o LookupSqlResourceSqlUserDefinedFunctionResultOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupSqlResourceSqlUserDefinedFunctionResult) *ManagedServiceIdentityResponse {
		return v.Identity
