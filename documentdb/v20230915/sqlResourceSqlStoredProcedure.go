...
func NewSqlResourceSqlStoredProcedure(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230915:SqlResourceSqlStoredProcedure", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlStoredProcedure(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlStoredProcedure
	err := ctx.ReadResource("azure-native:documentdb/v20230915:SqlResourceSqlStoredProcedure", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
