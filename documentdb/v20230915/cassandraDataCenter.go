...
func NewCassandraDataCenter(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20231115:CassandraDataCenter"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20231115preview:CassandraDataCenter"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240215preview:CassandraDataCenter"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515:CassandraDataCenter"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515preview:CassandraDataCenter"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240815:CassandraDataCenter"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240901preview:CassandraDataCenter"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CassandraDataCenter
	err := ctx.RegisterResource("azure-native:documentdb/v20230915:CassandraDataCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraDataCenter(ctx *pulumi.Context,
	...
	var resource CassandraDataCenter
	err := ctx.ReadResource("azure-native:documentdb/v20230915:CassandraDataCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
