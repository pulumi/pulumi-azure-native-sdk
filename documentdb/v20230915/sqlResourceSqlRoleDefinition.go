...
func NewSqlResourceSqlRoleDefinition(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20230315:SqlResourceSqlRoleDefinition"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20231115:SqlResourceSqlRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20231115preview:SqlResourceSqlRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240215preview:SqlResourceSqlRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515:SqlResourceSqlRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515preview:SqlResourceSqlRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240815:SqlResourceSqlRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240901preview:SqlResourceSqlRoleDefinition"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20241115:SqlResourceSqlRoleDefinition"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SqlResourceSqlRoleDefinition
	err := ctx.RegisterResource("azure-native:documentdb/v20230915:SqlResourceSqlRoleDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlRoleDefinition(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlRoleDefinition
	err := ctx.ReadResource("azure-native:documentdb/v20230915:SqlResourceSqlRoleDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
