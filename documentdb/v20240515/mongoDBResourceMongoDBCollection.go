...
func NewMongoDBResourceMongoDBCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240515:MongoDBResourceMongoDBCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoDBResourceMongoDBCollection(ctx *pulumi.Context,
	...
	var resource MongoDBResourceMongoDBCollection
	err := ctx.ReadResource("azure-native:documentdb/v20240515:MongoDBResourceMongoDBCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
