...
func NewTableResourceTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240515:TableResourceTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableResourceTable(ctx *pulumi.Context,
	...
	var resource TableResourceTable
	err := ctx.ReadResource("azure-native:documentdb/v20240515:TableResourceTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
