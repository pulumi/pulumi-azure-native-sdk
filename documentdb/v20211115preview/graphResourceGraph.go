...
//
// Deprecated: azure-native:documentdb/v20211115preview:GraphResourceGraph is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GraphResourceGraph to guarantee forwards compatibility.
...
func NewGraphResourceGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20211115preview:GraphResourceGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGraphResourceGraph(ctx *pulumi.Context,
	...
	var resource GraphResourceGraph
	err := ctx.ReadResource("azure-native:documentdb/v20211115preview:GraphResourceGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
