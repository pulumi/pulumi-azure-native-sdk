...
func NewGremlinResourceGremlinGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230915preview:GremlinResourceGremlinGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGremlinResourceGremlinGraph(ctx *pulumi.Context,
	...
	var resource GremlinResourceGremlinGraph
	err := ctx.ReadResource("azure-native:documentdb/v20230915preview:GremlinResourceGremlinGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
