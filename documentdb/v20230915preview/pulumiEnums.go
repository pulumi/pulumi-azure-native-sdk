...
func (CustomerManagedKeyStatus) ElementType() reflect.Type {
	return reflect.TypeOf((*CustomerManagedKeyStatus)(nil)).Elem()
}

func (e CustomerManagedKeyStatus) ToCustomerManagedKeyStatusOutput() CustomerManagedKeyStatusOutput {
	return pulumi.ToOutput(e).(CustomerManagedKeyStatusOutput)
}

func (e CustomerManagedKeyStatus) ToCustomerManagedKeyStatusOutputWithContext(ctx context.Context) CustomerManagedKeyStatusOutput {
	return pulumi.ToOutputWithContext(ctx, e).(CustomerManagedKeyStatusOutput)
}

func (e CustomerManagedKeyStatus) ToCustomerManagedKeyStatusPtrOutput() CustomerManagedKeyStatusPtrOutput {
	return e.ToCustomerManagedKeyStatusPtrOutputWithContext(context.Background())
}

func (e CustomerManagedKeyStatus) ToCustomerManagedKeyStatusPtrOutputWithContext(ctx context.Context) CustomerManagedKeyStatusPtrOutput {
	return CustomerManagedKeyStatus(e).ToCustomerManagedKeyStatusOutputWithContext(ctx).ToCustomerManagedKeyStatusPtrOutputWithContext(ctx)
}

func (e CustomerManagedKeyStatus) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e CustomerManagedKeyStatus) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e CustomerManagedKeyStatus) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e CustomerManagedKeyStatus) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type CustomerManagedKeyStatusOutput struct{ *pulumi.OutputState }

func (CustomerManagedKeyStatusOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CustomerManagedKeyStatus)(nil)).Elem()
}

func (o CustomerManagedKeyStatusOutput) ToCustomerManagedKeyStatusOutput() CustomerManagedKeyStatusOutput {
	return o
}

func (o CustomerManagedKeyStatusOutput) ToCustomerManagedKeyStatusOutputWithContext(ctx context.Context) CustomerManagedKeyStatusOutput {
	return o
}

func (o CustomerManagedKeyStatusOutput) ToCustomerManagedKeyStatusPtrOutput() CustomerManagedKeyStatusPtrOutput {
	return o.ToCustomerManagedKeyStatusPtrOutputWithContext(context.Background())
}

func (o CustomerManagedKeyStatusOutput) ToCustomerManagedKeyStatusPtrOutputWithContext(ctx context.Context) CustomerManagedKeyStatusPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v CustomerManagedKeyStatus) *CustomerManagedKeyStatus {
		return &v
	}).(CustomerManagedKeyStatusPtrOutput)
}

func (o CustomerManagedKeyStatusOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o CustomerManagedKeyStatusOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e CustomerManagedKeyStatus) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o CustomerManagedKeyStatusOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o CustomerManagedKeyStatusOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e CustomerManagedKeyStatus) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type CustomerManagedKeyStatusPtrOutput struct{ *pulumi.OutputState }

func (CustomerManagedKeyStatusPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**CustomerManagedKeyStatus)(nil)).Elem()
}

func (o CustomerManagedKeyStatusPtrOutput) ToCustomerManagedKeyStatusPtrOutput() CustomerManagedKeyStatusPtrOutput {
	return o
}

func (o CustomerManagedKeyStatusPtrOutput) ToCustomerManagedKeyStatusPtrOutputWithContext(ctx context.Context) CustomerManagedKeyStatusPtrOutput {
	return o
}

func (o CustomerManagedKeyStatusPtrOutput) Elem() CustomerManagedKeyStatusOutput {
	return o.ApplyT(func(v *CustomerManagedKeyStatus) CustomerManagedKeyStatus {
		if v != nil {
			return *v
		}
		var ret CustomerManagedKeyStatus
		return ret
	}).(CustomerManagedKeyStatusOutput)
}

func (o CustomerManagedKeyStatusPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o CustomerManagedKeyStatusPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *CustomerManagedKeyStatus) *string {
		if e == nil {
			return nil
		}
...
// CustomerManagedKeyStatusInput is an input type that accepts values of the CustomerManagedKeyStatus enum
// A concrete instance of `CustomerManagedKeyStatusInput` can be one of the following:
//
//	CustomerManagedKeyStatus_Access_to_your_account_is_currently_revoked_because_the_Azure_Cosmos_DB_service_is_unable_to_obtain_the_AAD_authentication_token_for_the_account_s_default_identity_for_more_details_about_this_error_and_how_to_restore_access_to_your_account_please_visit_https_learn_microsoft_com_en_Us_azure_cosmos_Db_cmk_Troubleshooting_Guide_azure_Active_Directory_Token_Acquisition_Error_4000_
//	CustomerManagedKeyStatus_Access_to_your_account_is_currently_revoked_because_the_Azure_Cosmos_DB_account_s_key_vault_key_URI_does_not_follow_the_expected_format_for_more_details_about_this_error_and_how_to_restore_access_to_your_account_please_visit_https_learn_microsoft_com_en_Us_azure_cosmos_Db_cmk_Troubleshooting_Guide_improper_Syntax_Detected_On_The_Key_Vault_Uri_Property_4006_
//	CustomerManagedKeyStatus_Access_to_your_account_is_currently_revoked_because_the_current_default_identity_no_longer_has_permission_to_the_associated_Key_Vault_key_for_more_details_about_this_error_and_how_to_restore_access_to_your_account_please_visit_https_learn_microsoft_com_en_Us_azure_cosmos_Db_cmk_Troubleshooting_Guide_default_Identity_Is_Unauthorized_To_Access_The_Azure_Key_Vault_Key_4002_
...
//	CustomerManagedKeyStatus_Access_to_your_account_is_currently_revoked_because_the_correspondent_Azure_Key_Vault_was_not_found_for_more_details_about_this_error_and_how_to_restore_access_to_your_account_please_visit_https_learn_microsoft_com_en_Us_azure_cosmos_Db_cmk_Troubleshooting_Guide_azure_Key_Vault_Resource_Not_Found_4017_
//	CustomerManagedKeyStatus_Access_to_your_account_is_currently_revoked_for_more_details_about_this_error_and_how_to_restore_access_to_your_account_please_visit_https_learn_microsoft_com_en_Us_azure_cosmos_Db_cmk_Troubleshooting_Guide
//	CustomerManagedKeyStatus_Access_to_the_configured_customer_managed_key_confirmed_
type CustomerManagedKeyStatusInput interface {
	pulumi.Input

	ToCustomerManagedKeyStatusOutput() CustomerManagedKeyStatusOutput
	ToCustomerManagedKeyStatusOutputWithContext(context.Context) CustomerManagedKeyStatusOutput
}

var customerManagedKeyStatusPtrType = reflect.TypeOf((**CustomerManagedKeyStatus)(nil)).Elem()

type CustomerManagedKeyStatusPtrInput interface {
	pulumi.Input

	ToCustomerManagedKeyStatusPtrOutput() CustomerManagedKeyStatusPtrOutput
	ToCustomerManagedKeyStatusPtrOutputWithContext(context.Context) CustomerManagedKeyStatusPtrOutput
}

type customerManagedKeyStatusPtr string

func CustomerManagedKeyStatusPtr(v string) CustomerManagedKeyStatusPtrInput {
	return (*customerManagedKeyStatusPtr)(&v)
}

func (*customerManagedKeyStatusPtr) ElementType() reflect.Type {
	return customerManagedKeyStatusPtrType
}

func (in *customerManagedKeyStatusPtr) ToCustomerManagedKeyStatusPtrOutput() CustomerManagedKeyStatusPtrOutput {
	return pulumi.ToOutput(in).(CustomerManagedKeyStatusPtrOutput)
}

func (in *customerManagedKeyStatusPtr) ToCustomerManagedKeyStatusPtrOutputWithContext(ctx context.Context) CustomerManagedKeyStatusPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(CustomerManagedKeyStatusPtrOutput)
}

func (in *customerManagedKeyStatusPtr) ToOutput(ctx context.Context) pulumix.Output[*CustomerManagedKeyStatus] {
	return pulumix.Output[*CustomerManagedKeyStatus]{
		OutputState: in.ToCustomerManagedKeyStatusPtrOutputWithContext(ctx).OutputState,
	}
}
...
func init() {
	...
	pulumi.RegisterOutputType(CustomerManagedKeyStatusOutput{})
	pulumi.RegisterOutputType(CustomerManagedKeyStatusPtrOutput{})
