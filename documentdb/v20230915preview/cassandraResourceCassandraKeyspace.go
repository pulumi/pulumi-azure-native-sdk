...
func NewCassandraResourceCassandraKeyspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230915preview:CassandraResourceCassandraKeyspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraResourceCassandraKeyspace(ctx *pulumi.Context,
	...
	var resource CassandraResourceCassandraKeyspace
	err := ctx.ReadResource("azure-native:documentdb/v20230915preview:CassandraResourceCassandraKeyspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
