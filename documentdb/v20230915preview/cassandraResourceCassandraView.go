...
func NewCassandraResourceCassandraView(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20231115preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240215preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240901preview:CassandraResourceCassandraView"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20241201preview:CassandraResourceCassandraView"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource CassandraResourceCassandraView
	err := ctx.RegisterResource("azure-native:documentdb/v20230915preview:CassandraResourceCassandraView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraResourceCassandraView(ctx *pulumi.Context,
	...
	var resource CassandraResourceCassandraView
	err := ctx.ReadResource("azure-native:documentdb/v20230915preview:CassandraResourceCassandraView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
