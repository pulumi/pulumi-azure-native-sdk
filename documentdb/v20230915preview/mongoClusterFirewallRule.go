...
func NewMongoClusterFirewallRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20240601preview:MongoClusterFirewallRule"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240701:MongoClusterFirewallRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MongoClusterFirewallRule
	err := ctx.RegisterResource("azure-native:documentdb/v20230915preview:MongoClusterFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoClusterFirewallRule(ctx *pulumi.Context,
	...
	var resource MongoClusterFirewallRule
	err := ctx.ReadResource("azure-native:documentdb/v20230915preview:MongoClusterFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
