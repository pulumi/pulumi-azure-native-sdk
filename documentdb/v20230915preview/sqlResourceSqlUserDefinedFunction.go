...
func NewSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20231115:SqlResourceSqlUserDefinedFunction"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20231115preview:SqlResourceSqlUserDefinedFunction"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240215preview:SqlResourceSqlUserDefinedFunction"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515:SqlResourceSqlUserDefinedFunction"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515preview:SqlResourceSqlUserDefinedFunction"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240815:SqlResourceSqlUserDefinedFunction"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240901preview:SqlResourceSqlUserDefinedFunction"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20241115:SqlResourceSqlUserDefinedFunction"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20241201preview:SqlResourceSqlUserDefinedFunction"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230915preview:SqlResourceSqlUserDefinedFunction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlUserDefinedFunction
	err := ctx.ReadResource("azure-native:documentdb/v20230915preview:SqlResourceSqlUserDefinedFunction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
