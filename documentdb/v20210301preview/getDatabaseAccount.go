...
//
// Deprecated: azure-native:documentdb/v20210301preview:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20210401preview:DatabaseAccount to guarantee forwards compatibility.
func LookupDatabaseAccount(ctx *pulumi.Context, args *LookupDatabaseAccountArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20210301preview:getDatabaseAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
