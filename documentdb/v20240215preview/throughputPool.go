...
func NewThroughputPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240215preview:ThroughputPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThroughputPool(ctx *pulumi.Context,
	...
	var resource ThroughputPool
	err := ctx.ReadResource("azure-native:documentdb/v20240215preview:ThroughputPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
