...
func NewMongoDBResourceMongoDBDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20230915:MongoDBResourceMongoDBDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20230915preview:MongoDBResourceMongoDBDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20231115:MongoDBResourceMongoDBDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20231115preview:MongoDBResourceMongoDBDatabase"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20240815:MongoDBResourceMongoDBDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240901preview:MongoDBResourceMongoDBDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20241115:MongoDBResourceMongoDBDatabase"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240215preview:MongoDBResourceMongoDBDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoDBResourceMongoDBDatabase(ctx *pulumi.Context,
	...
	var resource MongoDBResourceMongoDBDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20240215preview:MongoDBResourceMongoDBDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Identity for the resource.
func (o MongoDBResourceMongoDBDatabaseOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v *MongoDBResourceMongoDBDatabase) ManagedServiceIdentityResponsePtrOutput { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}
