...
func NewDatabaseAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240215preview:DatabaseAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccount(ctx *pulumi.Context,
	...
	var resource DatabaseAccount
	err := ctx.ReadResource("azure-native:documentdb/v20240215preview:DatabaseAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
