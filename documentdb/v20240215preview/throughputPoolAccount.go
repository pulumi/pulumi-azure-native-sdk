...
func NewThroughputPoolAccount(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20240901preview:ThroughputPoolAccount"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240215preview:ThroughputPoolAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetThroughputPoolAccount(ctx *pulumi.Context,
	...
	var resource ThroughputPoolAccount
	err := ctx.ReadResource("azure-native:documentdb/v20240215preview:ThroughputPoolAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
