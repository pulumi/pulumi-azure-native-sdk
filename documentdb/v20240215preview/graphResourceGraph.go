...
func NewGraphResourceGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240215preview:GraphResourceGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGraphResourceGraph(ctx *pulumi.Context,
	...
	var resource GraphResourceGraph
	err := ctx.ReadResource("azure-native:documentdb/v20240215preview:GraphResourceGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
