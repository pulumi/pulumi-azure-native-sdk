...
//
// Deprecated: azure-native:documentdb/v20220515preview:CassandraCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:CassandraCluster to guarantee forwards compatibility.
func LookupCassandraCluster(ctx *pulumi.Context, args *LookupCassandraClusterArgs, opts ...pulumi.InvokeOption) (*LookupCassandraClusterResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20220515preview:getCassandraCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
