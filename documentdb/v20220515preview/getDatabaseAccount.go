...
//
// Deprecated: azure-native:documentdb/v20220515preview:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:DatabaseAccount to guarantee forwards compatibility.
func LookupDatabaseAccount(ctx *pulumi.Context, args *LookupDatabaseAccountArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20220515preview:getDatabaseAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
// The object that represents the metadata for the Account Keys of the Cosmos DB account.
func (o LookupDatabaseAccountResultOutput) KeysMetadata() DatabaseAccountKeysMetadataResponsePtrOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) *DatabaseAccountKeysMetadataResponse { return v.KeysMetadata }).(DatabaseAccountKeysMetadataResponsePtrOutput)
}
