...
//
// Deprecated: azure-native:documentdb/v20210315:SqlResourceSqlDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlDatabase to guarantee forwards compatibility.
...
func NewSqlResourceSqlDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20210315:SqlResourceSqlDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlDatabase(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20210315:SqlResourceSqlDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
