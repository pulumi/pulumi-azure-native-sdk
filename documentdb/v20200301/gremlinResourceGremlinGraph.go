...
// azure-native:documentdb/v20200301:GremlinResourceGremlinGraph is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph to guarantee forwards compatibility.
...
func NewGremlinResourceGremlinGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20200301:GremlinResourceGremlinGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGremlinResourceGremlinGraph(ctx *pulumi.Context,
	...
	var resource GremlinResourceGremlinGraph
	err := ctx.ReadResource("azure-native:documentdb/v20200301:GremlinResourceGremlinGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
