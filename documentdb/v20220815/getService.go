...
//
// Deprecated: azure-native:documentdb/v20220815:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:Service to guarantee forwards compatibility.
func LookupService(ctx *pulumi.Context, args *LookupServiceArgs, opts ...pulumi.InvokeOption) (*LookupServiceResult, error) {
	var rv LookupServiceResult
	err := ctx.Invoke("azure-native:documentdb/v20220815:getService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
