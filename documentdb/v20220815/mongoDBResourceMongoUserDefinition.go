...
func NewMongoDBResourceMongoUserDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20220815:MongoDBResourceMongoUserDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoDBResourceMongoUserDefinition(ctx *pulumi.Context,
	...
	var resource MongoDBResourceMongoUserDefinition
	err := ctx.ReadResource("azure-native:documentdb/v20220815:MongoDBResourceMongoUserDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
