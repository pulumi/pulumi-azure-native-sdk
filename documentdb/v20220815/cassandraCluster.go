...
//
// Deprecated: azure-native:documentdb/v20220815:CassandraCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:CassandraCluster to guarantee forwards compatibility.
...
func NewCassandraCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20220815:CassandraCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraCluster(ctx *pulumi.Context,
	...
	var resource CassandraCluster
	err := ctx.ReadResource("azure-native:documentdb/v20220815:CassandraCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
