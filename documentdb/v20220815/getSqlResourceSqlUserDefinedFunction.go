...
//
// Deprecated: azure-native:documentdb/v20220815:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.
func LookupSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context, args *LookupSqlResourceSqlUserDefinedFunctionArgs, opts ...pulumi.InvokeOption) (*LookupSqlResourceSqlUserDefinedFunctionResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20220815:getSqlResourceSqlUserDefinedFunction", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
