...
// azure-native:documentdb/v20160319:DatabaseAccountSqlDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20160331:DatabaseAccountSqlDatabase to guarantee forwards compatibility.
...
func NewDatabaseAccountSqlDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20160319:DatabaseAccountSqlDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountSqlDatabase(ctx *pulumi.Context,
	...
	var resource DatabaseAccountSqlDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20160319:DatabaseAccountSqlDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
