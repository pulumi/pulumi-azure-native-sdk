...
func NewDatabaseAccountCassandraTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20160319:DatabaseAccountCassandraTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountCassandraTable(ctx *pulumi.Context,
	...
	var resource DatabaseAccountCassandraTable
	err := ctx.ReadResource("azure-native:documentdb/v20160319:DatabaseAccountCassandraTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
