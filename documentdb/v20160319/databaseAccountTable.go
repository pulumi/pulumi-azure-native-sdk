...
func NewDatabaseAccountTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20160319:DatabaseAccountTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountTable(ctx *pulumi.Context,
	...
	var resource DatabaseAccountTable
	err := ctx.ReadResource("azure-native:documentdb/v20160319:DatabaseAccountTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
