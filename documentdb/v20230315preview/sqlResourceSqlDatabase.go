...
func NewSqlResourceSqlDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230315preview:SqlResourceSqlDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlDatabase(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20230315preview:SqlResourceSqlDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
