...
func NewGremlinResourceGremlinGraph(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20221115preview:GremlinResourceGremlinGraph"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20230301preview:GremlinResourceGremlinGraph"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230315preview:GremlinResourceGremlinGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGremlinResourceGremlinGraph(ctx *pulumi.Context,
	...
	var resource GremlinResourceGremlinGraph
	err := ctx.ReadResource("azure-native:documentdb/v20230315preview:GremlinResourceGremlinGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *GremlinResourceGremlinGraph) ToOutput(ctx context.Context) pulumix.Output[*GremlinResourceGremlinGraph] {
	return pulumix.Output[*GremlinResourceGremlinGraph]{
		OutputState: i.ToGremlinResourceGremlinGraphOutputWithContext(ctx).OutputState,
	}
}
...
func (o GremlinResourceGremlinGraphOutput) ToOutput(ctx context.Context) pulumix.Output[*GremlinResourceGremlinGraph] {
	return pulumix.Output[*GremlinResourceGremlinGraph]{
