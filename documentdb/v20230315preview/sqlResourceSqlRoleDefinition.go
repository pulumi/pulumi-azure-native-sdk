...
func NewSqlResourceSqlRoleDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230315preview:SqlResourceSqlRoleDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlRoleDefinition(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlRoleDefinition
	err := ctx.ReadResource("azure-native:documentdb/v20230315preview:SqlResourceSqlRoleDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
