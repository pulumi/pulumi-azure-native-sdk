...
func NewGremlinResourceGremlinDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230315preview:GremlinResourceGremlinDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGremlinResourceGremlinDatabase(ctx *pulumi.Context,
	...
	var resource GremlinResourceGremlinDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20230315preview:GremlinResourceGremlinDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
