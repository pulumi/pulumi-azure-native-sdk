...
func NewCassandraCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230315preview:CassandraCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraCluster(ctx *pulumi.Context,
	...
	var resource CassandraCluster
	err := ctx.ReadResource("azure-native:documentdb/v20230315preview:CassandraCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
