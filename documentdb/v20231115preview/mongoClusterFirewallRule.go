...
func NewMongoClusterFirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20231115preview:MongoClusterFirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoClusterFirewallRule(ctx *pulumi.Context,
	...
	var resource MongoClusterFirewallRule
	err := ctx.ReadResource("azure-native:documentdb/v20231115preview:MongoClusterFirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
