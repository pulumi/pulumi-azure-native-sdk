...
//
// Deprecated: azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.
...
func NewMongoDBResourceMongoRoleDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoDBResourceMongoRoleDefinition(ctx *pulumi.Context,
	...
	var resource MongoDBResourceMongoRoleDefinition
	err := ctx.ReadResource("azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
