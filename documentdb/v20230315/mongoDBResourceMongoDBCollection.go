...
//
// Deprecated: azure-native:documentdb/v20230315:MongoDBResourceMongoDBCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:MongoDBResourceMongoDBCollection to guarantee forwards compatibility.
...
func NewMongoDBResourceMongoDBCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230315:MongoDBResourceMongoDBCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoDBResourceMongoDBCollection(ctx *pulumi.Context,
	...
	var resource MongoDBResourceMongoDBCollection
	err := ctx.ReadResource("azure-native:documentdb/v20230315:MongoDBResourceMongoDBCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
