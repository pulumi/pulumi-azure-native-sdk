...
//
// Deprecated: azure-native:documentdb/v20221115:TableResourceTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:TableResourceTable to guarantee forwards compatibility.
func LookupTableResourceTable(ctx *pulumi.Context, args *LookupTableResourceTableArgs, opts ...pulumi.InvokeOption) (*LookupTableResourceTableResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20221115:getTableResourceTable", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
