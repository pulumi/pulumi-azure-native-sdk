...
//
// Deprecated: azure-native:documentdb/v20221115:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:DatabaseAccount to guarantee forwards compatibility.
func LookupDatabaseAccount(ctx *pulumi.Context, args *LookupDatabaseAccountArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20221115:getDatabaseAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
