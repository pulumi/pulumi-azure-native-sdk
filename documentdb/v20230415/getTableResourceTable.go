...
func (o LookupTableResourceTableResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTableResourceTableResult] {
	return pulumix.Output[LookupTableResourceTableResult]{
