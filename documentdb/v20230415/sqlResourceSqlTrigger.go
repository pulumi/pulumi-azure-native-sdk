...
func NewSqlResourceSqlTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230415:SqlResourceSqlTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlTrigger(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlTrigger
	err := ctx.ReadResource("azure-native:documentdb/v20230415:SqlResourceSqlTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
