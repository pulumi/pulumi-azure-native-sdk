...
func NewSqlResourceSqlRoleAssignment(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20230315preview:SqlResourceSqlRoleAssignment"),
		},
		{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20231115:SqlResourceSqlRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20231115preview:SqlResourceSqlRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240215preview:SqlResourceSqlRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515:SqlResourceSqlRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240515preview:SqlResourceSqlRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240815:SqlResourceSqlRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20240901preview:SqlResourceSqlRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20241115:SqlResourceSqlRoleAssignment"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20241201preview:SqlResourceSqlRoleAssignment"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230415:SqlResourceSqlRoleAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlRoleAssignment(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlRoleAssignment
	err := ctx.ReadResource("azure-native:documentdb/v20230415:SqlResourceSqlRoleAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
