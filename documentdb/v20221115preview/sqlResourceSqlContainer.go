...
func NewSqlResourceSqlContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20221115preview:SqlResourceSqlContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlContainer(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlContainer
	err := ctx.ReadResource("azure-native:documentdb/v20221115preview:SqlResourceSqlContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
