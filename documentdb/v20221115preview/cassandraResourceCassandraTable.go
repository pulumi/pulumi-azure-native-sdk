...
func NewCassandraResourceCassandraTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20221115preview:CassandraResourceCassandraTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraResourceCassandraTable(ctx *pulumi.Context,
	...
	var resource CassandraResourceCassandraTable
	err := ctx.ReadResource("azure-native:documentdb/v20221115preview:CassandraResourceCassandraTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
