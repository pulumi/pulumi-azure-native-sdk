...
func NewDatabaseAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20220815preview:DatabaseAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccount(ctx *pulumi.Context,
	...
	var resource DatabaseAccount
	err := ctx.ReadResource("azure-native:documentdb/v20220815preview:DatabaseAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Flag to indicate whether to enable MaterializedViews on the Cosmos DB account
func (o DatabaseAccountOutput) EnableMaterializedViews() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *DatabaseAccount) pulumi.BoolPtrOutput { return v.EnableMaterializedViews }).(pulumi.BoolPtrOutput)
}
