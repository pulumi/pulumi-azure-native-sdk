...
func NewDatabaseAccountCassandraTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20220815:DatabaseAccountCassandraTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20220815preview:DatabaseAccountCassandraTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20221115:DatabaseAccountCassandraTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20230315:DatabaseAccountCassandraTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20230415:DatabaseAccountCassandraTable"),
		},
	})
	opts = append(opts, aliases)
	var resource DatabaseAccountCassandraTable
	err := ctx.RegisterResource("azure-native:documentdb/v20150408:DatabaseAccountCassandraTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountCassandraTable(ctx *pulumi.Context,
	...
	var resource DatabaseAccountCassandraTable
	err := ctx.ReadResource("azure-native:documentdb/v20150408:DatabaseAccountCassandraTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
