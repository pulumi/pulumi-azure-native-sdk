...
func NewNotebookWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230301preview:NotebookWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebookWorkspace(ctx *pulumi.Context,
	...
	var resource NotebookWorkspace
	err := ctx.ReadResource("azure-native:documentdb/v20230301preview:NotebookWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
