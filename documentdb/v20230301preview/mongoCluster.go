...
func NewMongoCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20230301preview:MongoCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoCluster(ctx *pulumi.Context,
	...
	var resource MongoCluster
	err := ctx.ReadResource("azure-native:documentdb/v20230301preview:MongoCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
