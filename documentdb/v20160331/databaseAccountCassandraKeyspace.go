...
func NewDatabaseAccountCassandraKeyspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20160331:DatabaseAccountCassandraKeyspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountCassandraKeyspace(ctx *pulumi.Context,
	...
	var resource DatabaseAccountCassandraKeyspace
	err := ctx.ReadResource("azure-native:documentdb/v20160331:DatabaseAccountCassandraKeyspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
