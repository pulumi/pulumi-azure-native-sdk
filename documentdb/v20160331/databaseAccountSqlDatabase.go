...
func NewDatabaseAccountSqlDatabase(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20220815:DatabaseAccountSqlDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20220815preview:DatabaseAccountSqlDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20221115:DatabaseAccountSqlDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20221115preview:DatabaseAccountSqlDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20230301preview:DatabaseAccountSqlDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20230315:DatabaseAccountSqlDatabase"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20230415:DatabaseAccountSqlDatabase"),
		},
	})
	opts = append(opts, aliases)
	var resource DatabaseAccountSqlDatabase
	err := ctx.RegisterResource("azure-native:documentdb/v20160331:DatabaseAccountSqlDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountSqlDatabase(ctx *pulumi.Context,
	...
	var resource DatabaseAccountSqlDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20160331:DatabaseAccountSqlDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
