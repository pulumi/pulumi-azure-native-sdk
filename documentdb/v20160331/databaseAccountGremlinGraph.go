...
func NewDatabaseAccountGremlinGraph(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20160331:DatabaseAccountGremlinGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountGremlinGraph(ctx *pulumi.Context,
	...
	var resource DatabaseAccountGremlinGraph
	err := ctx.ReadResource("azure-native:documentdb/v20160331:DatabaseAccountGremlinGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
