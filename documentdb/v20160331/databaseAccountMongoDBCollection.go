...
func NewDatabaseAccountMongoDBCollection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20160331:DatabaseAccountMongoDBCollection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountMongoDBCollection(ctx *pulumi.Context,
	...
	var resource DatabaseAccountMongoDBCollection
	err := ctx.ReadResource("azure-native:documentdb/v20160331:DatabaseAccountMongoDBCollection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
