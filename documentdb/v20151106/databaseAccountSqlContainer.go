...
func NewDatabaseAccountSqlContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20151106:DatabaseAccountSqlContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountSqlContainer(ctx *pulumi.Context,
	...
	var resource DatabaseAccountSqlContainer
	err := ctx.ReadResource("azure-native:documentdb/v20151106:DatabaseAccountSqlContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
