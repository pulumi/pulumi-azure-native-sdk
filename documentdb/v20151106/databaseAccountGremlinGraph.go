...
// azure-native:documentdb/v20151106:DatabaseAccountGremlinGraph is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20160331:DatabaseAccountGremlinGraph to guarantee forwards compatibility.
...
func NewDatabaseAccountGremlinGraph(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20221115:DatabaseAccountGremlinGraph"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20230315:DatabaseAccountGremlinGraph"),
		},
	})
	opts = append(opts, aliases)
	var resource DatabaseAccountGremlinGraph
	err := ctx.RegisterResource("azure-native:documentdb/v20151106:DatabaseAccountGremlinGraph", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountGremlinGraph(ctx *pulumi.Context,
	...
	var resource DatabaseAccountGremlinGraph
	err := ctx.ReadResource("azure-native:documentdb/v20151106:DatabaseAccountGremlinGraph", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
