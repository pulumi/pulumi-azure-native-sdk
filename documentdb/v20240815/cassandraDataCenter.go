...
func NewCassandraDataCenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240815:CassandraDataCenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraDataCenter(ctx *pulumi.Context,
	...
	var resource CassandraDataCenter
	err := ctx.ReadResource("azure-native:documentdb/v20240815:CassandraDataCenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
