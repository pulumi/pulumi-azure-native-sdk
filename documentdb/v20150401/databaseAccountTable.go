...
// azure-native:documentdb/v20150401:DatabaseAccountTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20160331:DatabaseAccountTable to guarantee forwards compatibility.
...
func NewDatabaseAccountTable(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:documentdb/v20220815:DatabaseAccountTable"),
		},
		{
			Type: pulumi.String("azure-native:documentdb/v20220815preview:DatabaseAccountTable"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20150401:DatabaseAccountTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccountTable(ctx *pulumi.Context,
	...
	var resource DatabaseAccountTable
	err := ctx.ReadResource("azure-native:documentdb/v20150401:DatabaseAccountTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
