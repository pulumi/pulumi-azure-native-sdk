...
func NewTableResourceTableRoleDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20241201preview:TableResourceTableRoleDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableResourceTableRoleDefinition(ctx *pulumi.Context,
	...
	var resource TableResourceTableRoleDefinition
	err := ctx.ReadResource("azure-native:documentdb/v20241201preview:TableResourceTableRoleDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
