...
func NewCassandraResourceCassandraView(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20241201preview:CassandraResourceCassandraView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCassandraResourceCassandraView(ctx *pulumi.Context,
	...
	var resource CassandraResourceCassandraView
	err := ctx.ReadResource("azure-native:documentdb/v20241201preview:CassandraResourceCassandraView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
