...
//
// Deprecated: azure-native:documentdb/v20220515:SqlResourceSqlContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlContainer to guarantee forwards compatibility.
...
func NewSqlResourceSqlContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20220515:SqlResourceSqlContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlContainer(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlContainer
	err := ctx.ReadResource("azure-native:documentdb/v20220515:SqlResourceSqlContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
