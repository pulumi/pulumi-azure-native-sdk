...
//
// Deprecated: azure-native:documentdb/v20220515:NotebookWorkspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:NotebookWorkspace to guarantee forwards compatibility.
...
func NewNotebookWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20220515:NotebookWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebookWorkspace(ctx *pulumi.Context,
	...
	var resource NotebookWorkspace
	err := ctx.ReadResource("azure-native:documentdb/v20220515:NotebookWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
