...
func NewTableResourceTableRoleAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb:TableResourceTableRoleAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableResourceTableRoleAssignment(ctx *pulumi.Context,
	...
	var resource TableResourceTableRoleAssignment
	err := ctx.ReadResource("azure-native:documentdb:TableResourceTableRoleAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
