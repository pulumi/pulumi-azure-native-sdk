...
func NewSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20211015preview:SqlResourceSqlUserDefinedFunction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlUserDefinedFunction
	err := ctx.ReadResource("azure-native:documentdb/v20211015preview:SqlResourceSqlUserDefinedFunction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
