...
type DatabaseAccount struct {
	...
	CapacityMode pulumi.StringPtrOutput `pulumi:"capacityMode"`
	// The object that represents the migration state for the CapacityMode of the Cosmos DB account.
	CapacityModeChangeTransitionState CapacityModeChangeTransitionStateResponsePtrOutput `pulumi:"capacityModeChangeTransitionState"`
...
func NewDatabaseAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20240515preview:DatabaseAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseAccount(ctx *pulumi.Context,
	...
	var resource DatabaseAccount
	err := ctx.ReadResource("azure-native:documentdb/v20240515preview:DatabaseAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Indicates the capacityMode of the Cosmos DB account.
func (o DatabaseAccountOutput) CapacityMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DatabaseAccount) pulumi.StringPtrOutput { return v.CapacityMode }).(pulumi.StringPtrOutput)
}

// The object that represents the migration state for the CapacityMode of the Cosmos DB account.
func (o DatabaseAccountOutput) CapacityModeChangeTransitionState() CapacityModeChangeTransitionStateResponsePtrOutput {
	return o.ApplyT(func(v *DatabaseAccount) CapacityModeChangeTransitionStateResponsePtrOutput {
