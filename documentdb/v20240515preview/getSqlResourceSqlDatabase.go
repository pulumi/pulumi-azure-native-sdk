...
func LookupSqlResourceSqlDatabase(ctx *pulumi.Context, args *LookupSqlResourceSqlDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupSqlResourceSqlDatabaseResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20240515preview:getSqlResourceSqlDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSqlResourceSqlDatabaseOutput(ctx *pulumi.Context, args LookupSqlResourceSqlDatabaseOutputArgs, opts ...pulumi.InvokeOption) LookupSqlResourceSqlDatabaseResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSqlResourceSqlDatabaseResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:documentdb/v20240515preview:getSqlResourceSqlDatabase", args, LookupSqlResourceSqlDatabaseResultOutput{}, options).(LookupSqlResourceSqlDatabaseResultOutput), nil
...
// Identity for the resource.
func (o LookupSqlResourceSqlDatabaseResultOutput) Identity() ManagedServiceIdentityResponsePtrOutput {
	return o.ApplyT(func(v LookupSqlResourceSqlDatabaseResult) *ManagedServiceIdentityResponse { return v.Identity }).(ManagedServiceIdentityResponsePtrOutput)
}
