...
func ListMongoClusterConnectionStrings(ctx *pulumi.Context, args *ListMongoClusterConnectionStringsArgs, opts ...pulumi.InvokeOption) (*ListMongoClusterConnectionStringsResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20241001preview:listMongoClusterConnectionStrings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListMongoClusterConnectionStringsOutput(ctx *pulumi.Context, args ListMongoClusterConnectionStringsOutputArgs, opts ...pulumi.InvokeOption) ListMongoClusterConnectionStringsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListMongoClusterConnectionStringsResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:documentdb/v20241001preview:listMongoClusterConnectionStrings", args, ListMongoClusterConnectionStringsResultOutput{}, options).(ListMongoClusterConnectionStringsResultOutput), nil
