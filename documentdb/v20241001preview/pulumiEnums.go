...
func (DataApiMode) ElementType() reflect.Type {
	return reflect.TypeOf((*DataApiMode)(nil)).Elem()
}

func (e DataApiMode) ToDataApiModeOutput() DataApiModeOutput {
	return pulumi.ToOutput(e).(DataApiModeOutput)
}

func (e DataApiMode) ToDataApiModeOutputWithContext(ctx context.Context) DataApiModeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(DataApiModeOutput)
}

func (e DataApiMode) ToDataApiModePtrOutput() DataApiModePtrOutput {
	return e.ToDataApiModePtrOutputWithContext(context.Background())
}

func (e DataApiMode) ToDataApiModePtrOutputWithContext(ctx context.Context) DataApiModePtrOutput {
	return DataApiMode(e).ToDataApiModeOutputWithContext(ctx).ToDataApiModePtrOutputWithContext(ctx)
}

func (e DataApiMode) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e DataApiMode) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e DataApiMode) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e DataApiMode) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type DataApiModeOutput struct{ *pulumi.OutputState }

func (DataApiModeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DataApiMode)(nil)).Elem()
}

func (o DataApiModeOutput) ToDataApiModeOutput() DataApiModeOutput {
	return o
}

func (o DataApiModeOutput) ToDataApiModeOutputWithContext(ctx context.Context) DataApiModeOutput {
	return o
}

func (o DataApiModeOutput) ToDataApiModePtrOutput() DataApiModePtrOutput {
	return o.ToDataApiModePtrOutputWithContext(context.Background())
}

func (o DataApiModeOutput) ToDataApiModePtrOutputWithContext(ctx context.Context) DataApiModePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v DataApiMode) *DataApiMode {
		return &v
	}).(DataApiModePtrOutput)
}

func (o DataApiModeOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o DataApiModeOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DataApiMode) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o DataApiModeOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DataApiModeOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DataApiMode) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type DataApiModePtrOutput struct{ *pulumi.OutputState }

func (DataApiModePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DataApiMode)(nil)).Elem()
}

func (o DataApiModePtrOutput) ToDataApiModePtrOutput() DataApiModePtrOutput {
	return o
}

func (o DataApiModePtrOutput) ToDataApiModePtrOutputWithContext(ctx context.Context) DataApiModePtrOutput {
	return o
}

func (o DataApiModePtrOutput) Elem() DataApiModeOutput {
	return o.ApplyT(func(v *DataApiMode) DataApiMode {
		if v != nil {
			return *v
		}
		var ret DataApiMode
...
func (o DataApiModePtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DataApiModePtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *DataApiMode) *string {
		if e == nil {
			return nil
		}
...
// DataApiModeInput is an input type that accepts values of the DataApiMode enum
// A concrete instance of `DataApiModeInput` can be one of the following:
//
//	DataApiModeEnabled
//	DataApiModeDisabled
type DataApiModeInput interface {
	pulumi.Input

	ToDataApiModeOutput() DataApiModeOutput
	ToDataApiModeOutputWithContext(context.Context) DataApiModeOutput
}

var dataApiModePtrType = reflect.TypeOf((**DataApiMode)(nil)).Elem()

type DataApiModePtrInput interface {
	pulumi.Input

	ToDataApiModePtrOutput() DataApiModePtrOutput
	ToDataApiModePtrOutputWithContext(context.Context) DataApiModePtrOutput
}

type dataApiModePtr string

func DataApiModePtr(v string) DataApiModePtrInput {
	return (*dataApiModePtr)(&v)
}

func (*dataApiModePtr) ElementType() reflect.Type {
	return dataApiModePtrType
}

func (in *dataApiModePtr) ToDataApiModePtrOutput() DataApiModePtrOutput {
	return pulumi.ToOutput(in).(DataApiModePtrOutput)
}

func (in *dataApiModePtr) ToDataApiModePtrOutputWithContext(ctx context.Context) DataApiModePtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(DataApiModePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(DataApiModeOutput{})
	pulumi.RegisterOutputType(DataApiModePtrOutput{})
