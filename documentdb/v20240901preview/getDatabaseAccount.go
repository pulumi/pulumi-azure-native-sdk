...
func LookupDatabaseAccount(ctx *pulumi.Context, args *LookupDatabaseAccountArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:documentdb/v20240901preview:getDatabaseAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
...
type LookupDatabaseAccountResult struct {
	...
	CapacityModeChangeTransitionState *CapacityModeChangeTransitionStateResponse `pulumi:"capacityModeChangeTransitionState"`
	...
	DiagnosticLogSettings *DiagnosticLogSettingsResponse `pulumi:"diagnosticLogSettings"`
...
func LookupDatabaseAccountOutput(ctx *pulumi.Context, args LookupDatabaseAccountOutputArgs, opts ...pulumi.InvokeOption) LookupDatabaseAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDatabaseAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:documentdb/v20240901preview:getDatabaseAccount", args, LookupDatabaseAccountResultOutput{}, options).(LookupDatabaseAccountResultOutput), nil
...
// Indicates the capacityMode of the Cosmos DB account.
func (o LookupDatabaseAccountResultOutput) CapacityMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) *string { return v.CapacityMode }).(pulumi.StringPtrOutput)
}

// The object that represents the migration state for the CapacityMode of the Cosmos DB account.
func (o LookupDatabaseAccountResultOutput) CapacityModeChangeTransitionState() CapacityModeChangeTransitionStateResponsePtrOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) *CapacityModeChangeTransitionStateResponse {
		return v.CapacityModeChangeTransitionState
	}).(CapacityModeChangeTransitionStateResponsePtrOutput)
}
...
// Indicates the status of the Customer Managed Key feature on the account. In case there are errors, the property provides troubleshooting guidance.
func (o LookupDatabaseAccountResultOutput) CustomerManagedKeyStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) *string { return v.CustomerManagedKeyStatus }).(pulumi.StringPtrOutput)
}
...
// Enum to indicate default Priority Level of request for Priority Based Execution.
func (o LookupDatabaseAccountResultOutput) DefaultPriorityLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) *string { return v.DefaultPriorityLevel }).(pulumi.StringPtrOutput)
}

// The Object representing the different Diagnostic log settings for the Cosmos DB Account.
func (o LookupDatabaseAccountResultOutput) DiagnosticLogSettings() DiagnosticLogSettingsResponsePtrOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) *DiagnosticLogSettingsResponse { return v.DiagnosticLogSettings }).(DiagnosticLogSettingsResponsePtrOutput)
}
...
// Flag to indicate enabling/disabling of Per-Region Per-partition autoscale Preview feature on the account
func (o LookupDatabaseAccountResultOutput) EnablePerRegionPerPartitionAutoscale() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) *bool { return v.EnablePerRegionPerPartitionAutoscale }).(pulumi.BoolPtrOutput)
}

// Flag to indicate enabling/disabling of Priority Based Execution Preview feature on the account
func (o LookupDatabaseAccountResultOutput) EnablePriorityBasedExecution() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupDatabaseAccountResult) *bool { return v.EnablePriorityBasedExecution }).(pulumi.BoolPtrOutput)
}
