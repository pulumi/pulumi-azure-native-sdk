...
func NewMongoDBResourceMongoRoleDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20231115:MongoDBResourceMongoRoleDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoDBResourceMongoRoleDefinition(ctx *pulumi.Context,
	...
	var resource MongoDBResourceMongoRoleDefinition
	err := ctx.ReadResource("azure-native:documentdb/v20231115:MongoDBResourceMongoRoleDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
