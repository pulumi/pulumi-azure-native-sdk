...
func NewSqlResourceSqlRoleAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20231115:SqlResourceSqlRoleAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlRoleAssignment(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlRoleAssignment
	err := ctx.ReadResource("azure-native:documentdb/v20231115:SqlResourceSqlRoleAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
