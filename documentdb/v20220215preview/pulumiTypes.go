...
// Defaults sets the appropriate defaults for ClientEncryptionPolicy
func (val *ClientEncryptionPolicy) Defaults() *ClientEncryptionPolicy {
	if val == nil {
		return nil
	}
	tmp := *val
	if tmp.PolicyFormatVersion == nil {
		policyFormatVersion_ := 1
		tmp.PolicyFormatVersion = &policyFormatVersion_
	}
	return &tmp
}
...
type ClientEncryptionPolicyArgs struct {
	...
	// Version of the client encryption policy definition. Please note, user passed value is ignored. Default policy version is 1.
	PolicyFormatVersion pulumi.IntPtrInput `pulumi:"policyFormatVersion"`
}

// Defaults sets the appropriate defaults for ClientEncryptionPolicyArgs
func (val *ClientEncryptionPolicyArgs) Defaults() *ClientEncryptionPolicyArgs {
	if val == nil {
		return nil
	}
	tmp := *val
	if tmp.PolicyFormatVersion == nil {
		tmp.PolicyFormatVersion = pulumi.IntPtr(1)
	}
	return &tmp
}
...
// Version of the client encryption policy definition. Please note, user passed value is ignored. Default policy version is 1.
func (o ClientEncryptionPolicyOutput) PolicyFormatVersion() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ClientEncryptionPolicy) *int { return v.PolicyFormatVersion }).(pulumi.IntPtrOutput)
}
...
// Defaults sets the appropriate defaults for ClientEncryptionPolicyResponse
func (val *ClientEncryptionPolicyResponse) Defaults() *ClientEncryptionPolicyResponse {
	if val == nil {
		return nil
	}
	tmp := *val
...
// Version of the client encryption policy definition. Please note, user passed value is ignored. Default policy version is 1.
func (o ClientEncryptionPolicyResponseOutput) PolicyFormatVersion() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ClientEncryptionPolicyResponse) *int { return v.PolicyFormatVersion }).(pulumi.IntPtrOutput)
}
...
func (val *SqlContainerGetPropertiesResponseResource) Defaults() *SqlContainerGetPropertiesResponseResource {
	...
	tmp := *val
	tmp.ClientEncryptionPolicy = tmp.ClientEncryptionPolicy.Defaults()
