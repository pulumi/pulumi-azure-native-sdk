...
// azure-native:documentdb/v20200901:SqlResourceSqlTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlTrigger to guarantee forwards compatibility.
...
func NewSqlResourceSqlTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20200901:SqlResourceSqlTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlTrigger(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlTrigger
	err := ctx.ReadResource("azure-native:documentdb/v20200901:SqlResourceSqlTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
