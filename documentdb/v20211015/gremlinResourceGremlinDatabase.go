...
//
// Deprecated: azure-native:documentdb/v20211015:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.
...
func NewGremlinResourceGremlinDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20211015:GremlinResourceGremlinDatabase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGremlinResourceGremlinDatabase(ctx *pulumi.Context,
	...
	var resource GremlinResourceGremlinDatabase
	err := ctx.ReadResource("azure-native:documentdb/v20211015:GremlinResourceGremlinDatabase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
