...
//
// Deprecated: azure-native:documentdb/v20210415:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.
...
func NewSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:documentdb/v20210415:SqlResourceSqlUserDefinedFunction", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlResourceSqlUserDefinedFunction(ctx *pulumi.Context,
	...
	var resource SqlResourceSqlUserDefinedFunction
	err := ctx.ReadResource("azure-native:documentdb/v20210415:SqlResourceSqlUserDefinedFunction", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
