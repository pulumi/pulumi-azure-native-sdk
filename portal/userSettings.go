...
// The Azure API version of the resource.
func (o UserSettingsOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *UserSettings) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
