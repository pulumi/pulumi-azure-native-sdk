...
func ListListTenantConfigurationViolation(ctx *pulumi.Context, args *ListListTenantConfigurationViolationArgs, opts ...pulumi.InvokeOption) (*ListListTenantConfigurationViolationResult, error) {
	...
	err := ctx.Invoke("azure-native:portal/v20221201preview:listListTenantConfigurationViolation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListListTenantConfigurationViolationOutput(ctx *pulumi.Context, args ListListTenantConfigurationViolationOutputArgs, opts ...pulumi.InvokeOption) ListListTenantConfigurationViolationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListListTenantConfigurationViolationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:portal/v20221201preview:listListTenantConfigurationViolation", args, ListListTenantConfigurationViolationResultOutput{}, options).(ListListTenantConfigurationViolationResultOutput), nil
