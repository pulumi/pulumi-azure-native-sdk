...
func NewDashboard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:portal/v20221201preview:Dashboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("azure-native:portal/v20221201preview:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
