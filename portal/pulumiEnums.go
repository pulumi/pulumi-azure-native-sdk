...
// FontSizeInput is an input type that accepts values of the FontSize enum
// A concrete instance of `FontSizeInput` can be one of the following:
//
...
// FontStyleInput is an input type that accepts values of the FontStyle enum
// A concrete instance of `FontStyleInput` can be one of the following:
//
...
// ShellTypeInput is an input type that accepts values of the ShellType enum
// A concrete instance of `ShellTypeInput` can be one of the following:
//
//	ShellTypeBash
//	ShellTypePwsh
//	ShellTypePowershell
