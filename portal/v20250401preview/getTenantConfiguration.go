...
func LookupTenantConfiguration(ctx *pulumi.Context, args *LookupTenantConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupTenantConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:portal/v20250401preview:getTenantConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTenantConfigurationOutput(ctx *pulumi.Context, args LookupTenantConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupTenantConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTenantConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:portal/v20250401preview:getTenantConfiguration", args, LookupTenantConfigurationResultOutput{}, options).(LookupTenantConfigurationResultOutput), nil
