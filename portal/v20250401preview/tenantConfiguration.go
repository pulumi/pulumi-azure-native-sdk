...
func NewTenantConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:portal/v20250401preview:TenantConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTenantConfiguration(ctx *pulumi.Context,
	...
	var resource TenantConfiguration
	err := ctx.ReadResource("azure-native:portal/v20250401preview:TenantConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
