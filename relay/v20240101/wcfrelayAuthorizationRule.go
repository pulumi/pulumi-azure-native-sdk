...
func NewWCFRelayAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:relay/v20240101:WCFRelayAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWCFRelayAuthorizationRule(ctx *pulumi.Context,
	...
	var resource WCFRelayAuthorizationRule
	err := ctx.ReadResource("azure-native:relay/v20240101:WCFRelayAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
