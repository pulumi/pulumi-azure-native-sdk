...
func LookupHybridConnectionAuthorizationRule(ctx *pulumi.Context, args *LookupHybridConnectionAuthorizationRuleArgs, opts ...pulumi.InvokeOption) (*LookupHybridConnectionAuthorizationRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:relay/v20240101:getHybridConnectionAuthorizationRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHybridConnectionAuthorizationRuleOutput(ctx *pulumi.Context, args LookupHybridConnectionAuthorizationRuleOutputArgs, opts ...pulumi.InvokeOption) LookupHybridConnectionAuthorizationRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHybridConnectionAuthorizationRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:relay/v20240101:getHybridConnectionAuthorizationRule", args, LookupHybridConnectionAuthorizationRuleResultOutput{}, options).(LookupHybridConnectionAuthorizationRuleResultOutput), nil
