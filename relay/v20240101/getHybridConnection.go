...
func LookupHybridConnection(ctx *pulumi.Context, args *LookupHybridConnectionArgs, opts ...pulumi.InvokeOption) (*LookupHybridConnectionResult, error) {
	...
	err := ctx.Invoke("azure-native:relay/v20240101:getHybridConnection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHybridConnectionOutput(ctx *pulumi.Context, args LookupHybridConnectionOutputArgs, opts ...pulumi.InvokeOption) LookupHybridConnectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHybridConnectionResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:relay/v20240101:getHybridConnection", args, LookupHybridConnectionResultOutput{}, options).(LookupHybridConnectionResultOutput), nil
