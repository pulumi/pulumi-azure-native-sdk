...
func LookupWCFRelay(ctx *pulumi.Context, args *LookupWCFRelayArgs, opts ...pulumi.InvokeOption) (*LookupWCFRelayResult, error) {
	...
	err := ctx.Invoke("azure-native:relay/v20240101:getWCFRelay", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWCFRelayOutput(ctx *pulumi.Context, args LookupWCFRelayOutputArgs, opts ...pulumi.InvokeOption) LookupWCFRelayResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWCFRelayResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:relay/v20240101:getWCFRelay", args, LookupWCFRelayResultOutput{}, options).(LookupWCFRelayResultOutput), nil
