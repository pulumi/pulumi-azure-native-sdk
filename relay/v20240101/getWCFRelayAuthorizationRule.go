...
func LookupWCFRelayAuthorizationRule(ctx *pulumi.Context, args *LookupWCFRelayAuthorizationRuleArgs, opts ...pulumi.InvokeOption) (*LookupWCFRelayAuthorizationRuleResult, error) {
	...
	err := ctx.Invoke("azure-native:relay/v20240101:getWCFRelayAuthorizationRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWCFRelayAuthorizationRuleOutput(ctx *pulumi.Context, args LookupWCFRelayAuthorizationRuleOutputArgs, opts ...pulumi.InvokeOption) LookupWCFRelayAuthorizationRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWCFRelayAuthorizationRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:relay/v20240101:getWCFRelayAuthorizationRule", args, LookupWCFRelayAuthorizationRuleResultOutput{}, options).(LookupWCFRelayAuthorizationRuleResultOutput), nil
