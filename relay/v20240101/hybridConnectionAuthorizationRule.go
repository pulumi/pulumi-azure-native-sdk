...
func NewHybridConnectionAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:relay/v20240101:HybridConnectionAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridConnectionAuthorizationRule(ctx *pulumi.Context,
	...
	var resource HybridConnectionAuthorizationRule
	err := ctx.ReadResource("azure-native:relay/v20240101:HybridConnectionAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
