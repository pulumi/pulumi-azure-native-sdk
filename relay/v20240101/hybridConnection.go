...
func NewHybridConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:relay/v20240101:HybridConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridConnection(ctx *pulumi.Context,
	...
	var resource HybridConnection
	err := ctx.ReadResource("azure-native:relay/v20240101:HybridConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
