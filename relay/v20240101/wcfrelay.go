...
func NewWCFRelay(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:relay/v20240101:WCFRelay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWCFRelay(ctx *pulumi.Context,
	...
	var resource WCFRelay
	err := ctx.ReadResource("azure-native:relay/v20240101:WCFRelay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
