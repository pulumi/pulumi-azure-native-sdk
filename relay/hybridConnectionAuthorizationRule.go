...
// The Azure API version of the resource.
func (o HybridConnectionAuthorizationRuleOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *HybridConnectionAuthorizationRule) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o HybridConnectionAuthorizationRuleOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v *HybridConnectionAuthorizationRule) commontypesv3.SystemDataResponseOutput { return v.SystemData }).(commontypesv3.SystemDataResponseOutput)
}
