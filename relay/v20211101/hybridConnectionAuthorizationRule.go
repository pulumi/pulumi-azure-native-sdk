...
func NewHybridConnectionAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:relay/v20211101:HybridConnectionAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridConnectionAuthorizationRule(ctx *pulumi.Context,
	...
	var resource HybridConnectionAuthorizationRule
	err := ctx.ReadResource("azure-native:relay/v20211101:HybridConnectionAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The geo-location where the resource lives
func (o HybridConnectionAuthorizationRuleOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *HybridConnectionAuthorizationRule) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}
