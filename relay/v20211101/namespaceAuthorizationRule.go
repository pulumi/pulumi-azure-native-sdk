...
func NewNamespaceAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:relay/v20211101:NamespaceAuthorizationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceAuthorizationRule(ctx *pulumi.Context,
	...
	var resource NamespaceAuthorizationRule
	err := ctx.ReadResource("azure-native:relay/v20211101:NamespaceAuthorizationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
