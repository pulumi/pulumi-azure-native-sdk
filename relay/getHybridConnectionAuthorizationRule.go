...
// The Azure API version of the resource.
func (o LookupHybridConnectionAuthorizationRuleResultOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupHybridConnectionAuthorizationRuleResult) string { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupHybridConnectionAuthorizationRuleResultOutput) SystemData() commontypesv3.SystemDataResponseOutput {
	return o.ApplyT(func(v LookupHybridConnectionAuthorizationRuleResult) commontypesv3.SystemDataResponse {
		return v.SystemData
