...
func NewNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:relay/v20160701:Namespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespace(ctx *pulumi.Context,
	...
	var resource Namespace
	err := ctx.ReadResource("azure-native:relay/v20160701:Namespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
