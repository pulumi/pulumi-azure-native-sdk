...
func NewMediaService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20180601preview:MediaService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMediaService(ctx *pulumi.Context,
	...
	var resource MediaService
	err := ctx.ReadResource("azure-native:media/v20180601preview:MediaService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
