...
// Gets a Transform.
//
// Deprecated: azure-native:media/v20211101:Transform is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Transform to guarantee forwards compatibility.
func LookupTransform(ctx *pulumi.Context, args *LookupTransformArgs, opts ...pulumi.InvokeOption) (*LookupTransformResult, error) {
	...
	err := ctx.Invoke("azure-native:media/v20211101:getTransform", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
