...
func NewTransform(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20211101:Transform", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransform(ctx *pulumi.Context,
	...
	var resource Transform
	err := ctx.ReadResource("azure-native:media/v20211101:Transform", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
