...
func NewAccountFilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20211101:AccountFilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountFilter(ctx *pulumi.Context,
	...
	var resource AccountFilter
	err := ctx.ReadResource("azure-native:media/v20211101:AccountFilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
