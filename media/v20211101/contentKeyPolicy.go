...
//
// Deprecated: azure-native:media/v20211101:ContentKeyPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:ContentKeyPolicy to guarantee forwards compatibility.
...
func NewContentKeyPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20211101:ContentKeyPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentKeyPolicy(ctx *pulumi.Context,
	...
	var resource ContentKeyPolicy
	err := ctx.ReadResource("azure-native:media/v20211101:ContentKeyPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
