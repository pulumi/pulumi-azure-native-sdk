...
// MediaGraphRtspTransportInput is an input type that accepts values of the MediaGraphRtspTransport enum
// A concrete instance of `MediaGraphRtspTransportInput` can be one of the following:
//
