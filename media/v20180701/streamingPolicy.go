...
//
// Deprecated: azure-native:media/v20180701:StreamingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.
...
func NewStreamingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20180701:StreamingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingPolicy(ctx *pulumi.Context,
	...
	var resource StreamingPolicy
	err := ctx.ReadResource("azure-native:media/v20180701:StreamingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
