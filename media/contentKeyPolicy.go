...
// The Azure API version of the resource.
func (o ContentKeyPolicyOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ContentKeyPolicy) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
