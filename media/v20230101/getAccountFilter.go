...
func LookupAccountFilter(ctx *pulumi.Context, args *LookupAccountFilterArgs, opts ...pulumi.InvokeOption) (*LookupAccountFilterResult, error) {
	...
	err := ctx.Invoke("azure-native:media/v20230101:getAccountFilter", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAccountFilterOutput(ctx *pulumi.Context, args LookupAccountFilterOutputArgs, opts ...pulumi.InvokeOption) LookupAccountFilterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAccountFilterResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:media/v20230101:getAccountFilter", args, LookupAccountFilterResultOutput{}, options).(LookupAccountFilterResultOutput), nil
