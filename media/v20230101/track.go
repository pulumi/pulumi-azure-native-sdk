...
func NewTrack(ctx *pulumi.Context,
	...
	var resource Track
	err := ctx.RegisterResource("azure-native:media/v20230101:Track", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrack(ctx *pulumi.Context,
	...
	var resource Track
	err := ctx.ReadResource("azure-native:media/v20230101:Track", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
