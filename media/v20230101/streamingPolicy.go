...
func NewStreamingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20230101:StreamingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingPolicy(ctx *pulumi.Context,
	...
	var resource StreamingPolicy
	err := ctx.ReadResource("azure-native:media/v20230101:StreamingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
