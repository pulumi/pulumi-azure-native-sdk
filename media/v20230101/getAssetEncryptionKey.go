...
func GetAssetEncryptionKey(ctx *pulumi.Context, args *GetAssetEncryptionKeyArgs, opts ...pulumi.InvokeOption) (*GetAssetEncryptionKeyResult, error) {
	...
	err := ctx.Invoke("azure-native:media/v20230101:getAssetEncryptionKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAssetEncryptionKeyOutput(ctx *pulumi.Context, args GetAssetEncryptionKeyOutputArgs, opts ...pulumi.InvokeOption) GetAssetEncryptionKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetAssetEncryptionKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:media/v20230101:getAssetEncryptionKey", args, GetAssetEncryptionKeyResultOutput{}, options).(GetAssetEncryptionKeyResultOutput), nil
