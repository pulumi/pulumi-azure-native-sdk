...
func LookupContentKeyPolicy(ctx *pulumi.Context, args *LookupContentKeyPolicyArgs, opts ...pulumi.InvokeOption) (*LookupContentKeyPolicyResult, error) {
	...
	err := ctx.Invoke("azure-native:media/v20230101:getContentKeyPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupContentKeyPolicyOutput(ctx *pulumi.Context, args LookupContentKeyPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupContentKeyPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContentKeyPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:media/v20230101:getContentKeyPolicy", args, LookupContentKeyPolicyResultOutput{}, options).(LookupContentKeyPolicyResultOutput), nil
