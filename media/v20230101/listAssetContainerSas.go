...
func ListAssetContainerSas(ctx *pulumi.Context, args *ListAssetContainerSasArgs, opts ...pulumi.InvokeOption) (*ListAssetContainerSasResult, error) {
	...
	err := ctx.Invoke("azure-native:media/v20230101:listAssetContainerSas", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAssetContainerSasOutput(ctx *pulumi.Context, args ListAssetContainerSasOutputArgs, opts ...pulumi.InvokeOption) ListAssetContainerSasResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAssetContainerSasResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:media/v20230101:listAssetContainerSas", args, ListAssetContainerSasResultOutput{}, options).(ListAssetContainerSasResultOutput), nil
