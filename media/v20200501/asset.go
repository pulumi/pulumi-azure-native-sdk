...
func NewAsset(ctx *pulumi.Context,
	...
	var resource Asset
	err := ctx.RegisterResource("azure-native:media/v20200501:Asset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAsset(ctx *pulumi.Context,
	...
	var resource Asset
	err := ctx.ReadResource("azure-native:media/v20200501:Asset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
