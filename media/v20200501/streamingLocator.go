...
//
// Deprecated: azure-native:media/v20200501:StreamingLocator is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.
...
func NewStreamingLocator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20200501:StreamingLocator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingLocator(ctx *pulumi.Context,
	...
	var resource StreamingLocator
	err := ctx.ReadResource("azure-native:media/v20200501:StreamingLocator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
