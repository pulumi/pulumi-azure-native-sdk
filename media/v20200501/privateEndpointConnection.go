...
//
// Deprecated: azure-native:media/v20200501:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:PrivateEndpointConnection to guarantee forwards compatibility.
...
func NewPrivateEndpointConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("azure-native:media:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:media/v20210501:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:media/v20210601:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:media/v20211101:PrivateEndpointConnection"),
		},
		{
			Type: pulumi.String("azure-native:media/v20230101:PrivateEndpointConnection"),
		},
	})
	opts = append(opts, aliases)
	var resource PrivateEndpointConnection
	err := ctx.RegisterResource("azure-native:media/v20200501:PrivateEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateEndpointConnection(ctx *pulumi.Context,
	...
	var resource PrivateEndpointConnection
	err := ctx.ReadResource("azure-native:media/v20200501:PrivateEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
