...
// The Live Output.
//
// Deprecated: azure-native:media/v20180330preview:LiveOutput is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveOutput to guarantee forwards compatibility.
...
func NewLiveOutput(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:media/v20221101:LiveOutput"),
		},
	})
	opts = append(opts, aliases)
	var resource LiveOutput
	err := ctx.RegisterResource("azure-native:media/v20180330preview:LiveOutput", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLiveOutput(ctx *pulumi.Context,
	...
	var resource LiveOutput
	err := ctx.ReadResource("azure-native:media/v20180330preview:LiveOutput", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
