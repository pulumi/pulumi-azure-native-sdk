...
//
// Deprecated: azure-native:media/v20180330preview:Transform is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Transform to guarantee forwards compatibility.
...
func NewTransform(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20180330preview:Transform", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransform(ctx *pulumi.Context,
	...
	var resource Transform
	err := ctx.ReadResource("azure-native:media/v20180330preview:Transform", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
