...
func NewLiveEvent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20220801:LiveEvent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLiveEvent(ctx *pulumi.Context,
	...
	var resource LiveEvent
	err := ctx.ReadResource("azure-native:media/v20220801:LiveEvent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
