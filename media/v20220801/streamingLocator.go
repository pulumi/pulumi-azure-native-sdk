...
func NewStreamingLocator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20220801:StreamingLocator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStreamingLocator(ctx *pulumi.Context,
	...
	var resource StreamingLocator
	err := ctx.ReadResource("azure-native:media/v20220801:StreamingLocator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
