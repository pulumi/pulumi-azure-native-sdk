...
func NewLiveOutput(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:media/v20221101:LiveOutput", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLiveOutput(ctx *pulumi.Context,
	...
	var resource LiveOutput
	err := ctx.ReadResource("azure-native:media/v20221101:LiveOutput", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
