...
func LookupStreamingEndpoint(ctx *pulumi.Context, args *LookupStreamingEndpointArgs, opts ...pulumi.InvokeOption) (*LookupStreamingEndpointResult, error) {
	...
	err := ctx.Invoke("azure-native:media/v20221101:getStreamingEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupStreamingEndpointOutput(ctx *pulumi.Context, args LookupStreamingEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupStreamingEndpointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStreamingEndpointResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:media/v20221101:getStreamingEndpoint", args, LookupStreamingEndpointResultOutput{}, options).(LookupStreamingEndpointResultOutput), nil
