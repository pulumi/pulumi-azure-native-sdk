...
func NewLabelByWorkspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:easm/v20230401preview:LabelByWorkspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLabelByWorkspace(ctx *pulumi.Context,
	...
	var resource LabelByWorkspace
	err := ctx.ReadResource("azure-native:easm/v20230401preview:LabelByWorkspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
