...
func (o LookupPowerShell72ModuleResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupPowerShell72ModuleResult] {
	return pulumix.Output[LookupPowerShell72ModuleResult]{
