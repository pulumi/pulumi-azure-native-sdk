...
func NewHybridRunbookWorkerGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:automation/v20230515preview:HybridRunbookWorkerGroup"),
		},
		{
			Type: pulumi.String("azure-native:automation/v20231101:HybridRunbookWorkerGroup"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:automation:HybridRunbookWorkerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridRunbookWorkerGroup(ctx *pulumi.Context,
	...
	var resource HybridRunbookWorkerGroup
	err := ctx.ReadResource("azure-native:automation:HybridRunbookWorkerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o HybridRunbookWorkerGroupOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *HybridRunbookWorkerGroup) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
