...
// The Azure API version of the resource.
func (o Python3PackageOutput) AzureApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Python3Package) pulumi.StringOutput { return v.AzureApiVersion }).(pulumi.StringOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o Python3PackageOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Python3Package) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
