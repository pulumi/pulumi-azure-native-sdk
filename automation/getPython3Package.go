...
func LookupPython3Package(ctx *pulumi.Context, args *LookupPython3PackageArgs, opts ...pulumi.InvokeOption) (*LookupPython3PackageResult, error) {
	...
	err := ctx.Invoke("azure-native:automation:getPython3Package", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupPython3PackageOutput(ctx *pulumi.Context, args LookupPython3PackageOutputArgs, opts ...pulumi.InvokeOption) LookupPython3PackageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPython3PackageResultOutput, error) {
			args := v.(LookupPython3PackageArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: utilities.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("azure-native:automation:getPython3Package", args, LookupPython3PackageResultOutput{}, options).(LookupPython3PackageResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupPython3PackageResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupPython3PackageResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
