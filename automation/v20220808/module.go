...
func NewModule(ctx *pulumi.Context,
	...
	var resource Module
	err := ctx.RegisterResource("azure-native:automation/v20220808:Module", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModule(ctx *pulumi.Context,
	...
	var resource Module
	err := ctx.ReadResource("azure-native:automation/v20220808:Module", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
