...
func LookupSourceControl(ctx *pulumi.Context, args *LookupSourceControlArgs, opts ...pulumi.InvokeOption) (*LookupSourceControlResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20220808:getSourceControl", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSourceControlOutput(ctx *pulumi.Context, args LookupSourceControlOutputArgs, opts ...pulumi.InvokeOption) LookupSourceControlResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSourceControlResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20220808:getSourceControl", args, LookupSourceControlResultOutput{}, options).(LookupSourceControlResultOutput), nil
