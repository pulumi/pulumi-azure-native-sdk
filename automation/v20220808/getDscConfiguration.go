...
func LookupDscConfiguration(ctx *pulumi.Context, args *LookupDscConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupDscConfigurationResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20220808:getDscConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDscConfigurationOutput(ctx *pulumi.Context, args LookupDscConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupDscConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDscConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20220808:getDscConfiguration", args, LookupDscConfigurationResultOutput{}, options).(LookupDscConfigurationResultOutput), nil
