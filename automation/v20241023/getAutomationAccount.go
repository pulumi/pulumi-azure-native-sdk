...
func LookupAutomationAccount(ctx *pulumi.Context, args *LookupAutomationAccountArgs, opts ...pulumi.InvokeOption) (*LookupAutomationAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20241023:getAutomationAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAutomationAccountOutput(ctx *pulumi.Context, args LookupAutomationAccountOutputArgs, opts ...pulumi.InvokeOption) LookupAutomationAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAutomationAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20241023:getAutomationAccount", args, LookupAutomationAccountResultOutput{}, options).(LookupAutomationAccountResultOutput), nil
