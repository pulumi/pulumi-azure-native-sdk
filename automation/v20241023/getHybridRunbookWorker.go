...
func LookupHybridRunbookWorker(ctx *pulumi.Context, args *LookupHybridRunbookWorkerArgs, opts ...pulumi.InvokeOption) (*LookupHybridRunbookWorkerResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20241023:getHybridRunbookWorker", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHybridRunbookWorkerOutput(ctx *pulumi.Context, args LookupHybridRunbookWorkerOutputArgs, opts ...pulumi.InvokeOption) LookupHybridRunbookWorkerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHybridRunbookWorkerResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20241023:getHybridRunbookWorker", args, LookupHybridRunbookWorkerResultOutput{}, options).(LookupHybridRunbookWorkerResultOutput), nil
...
// The geo-location where the resource lives
func (o LookupHybridRunbookWorkerResultOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v LookupHybridRunbookWorkerResult) string { return v.Location }).(pulumi.StringOutput)
}
...
// Resource tags.
func (o LookupHybridRunbookWorkerResultOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupHybridRunbookWorkerResult) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
