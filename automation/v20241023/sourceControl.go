...
func NewSourceControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20241023:SourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourceControl(ctx *pulumi.Context,
	...
	var resource SourceControl
	err := ctx.ReadResource("azure-native:automation/v20241023:SourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
