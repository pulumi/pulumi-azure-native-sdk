...
func LookupRunbook(ctx *pulumi.Context, args *LookupRunbookArgs, opts ...pulumi.InvokeOption) (*LookupRunbookResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20241023:getRunbook", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRunbookOutput(ctx *pulumi.Context, args LookupRunbookOutputArgs, opts ...pulumi.InvokeOption) LookupRunbookResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRunbookResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20241023:getRunbook", args, LookupRunbookResultOutput{}, options).(LookupRunbookResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupRunbookResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupRunbookResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
