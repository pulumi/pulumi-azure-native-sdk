...
func LookupRuntimeEnvironment(ctx *pulumi.Context, args *LookupRuntimeEnvironmentArgs, opts ...pulumi.InvokeOption) (*LookupRuntimeEnvironmentResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20241023:getRuntimeEnvironment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRuntimeEnvironmentOutput(ctx *pulumi.Context, args LookupRuntimeEnvironmentOutputArgs, opts ...pulumi.InvokeOption) LookupRuntimeEnvironmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRuntimeEnvironmentResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20241023:getRuntimeEnvironment", args, LookupRuntimeEnvironmentResultOutput{}, options).(LookupRuntimeEnvironmentResultOutput), nil
