...
func NewWatcher(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20241023:Watcher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWatcher(ctx *pulumi.Context,
	...
	var resource Watcher
	err := ctx.ReadResource("azure-native:automation/v20241023:Watcher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
