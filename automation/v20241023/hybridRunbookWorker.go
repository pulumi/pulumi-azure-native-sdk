...
func NewHybridRunbookWorker(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20241023:HybridRunbookWorker", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridRunbookWorker(ctx *pulumi.Context,
	...
	var resource HybridRunbookWorker
	err := ctx.ReadResource("azure-native:automation/v20241023:HybridRunbookWorker", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
