...
func NewCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20241023:Credential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCredential(ctx *pulumi.Context,
	...
	var resource Credential
	err := ctx.ReadResource("azure-native:automation/v20241023:Credential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
