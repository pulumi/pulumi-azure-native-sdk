...
func NewSoftwareUpdateConfigurationByName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20241023:SoftwareUpdateConfigurationByName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSoftwareUpdateConfigurationByName(ctx *pulumi.Context,
	...
	var resource SoftwareUpdateConfigurationByName
	err := ctx.ReadResource("azure-native:automation/v20241023:SoftwareUpdateConfigurationByName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
