...
func NewDscConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20241023:DscConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscConfiguration(ctx *pulumi.Context,
	...
	var resource DscConfiguration
	err := ctx.ReadResource("azure-native:automation/v20241023:DscConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
