...
func NewDscNodeConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20241023:DscNodeConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscNodeConfiguration(ctx *pulumi.Context,
	...
	var resource DscNodeConfiguration
	err := ctx.ReadResource("azure-native:automation/v20241023:DscNodeConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
