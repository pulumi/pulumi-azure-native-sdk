...
func LookupModule(ctx *pulumi.Context, args *LookupModuleArgs, opts ...pulumi.InvokeOption) (*LookupModuleResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20241023:getModule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupModuleOutput(ctx *pulumi.Context, args LookupModuleOutputArgs, opts ...pulumi.InvokeOption) LookupModuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupModuleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20241023:getModule", args, LookupModuleResultOutput{}, options).(LookupModuleResultOutput), nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o LookupModuleResultOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v LookupModuleResult) SystemDataResponse { return v.SystemData }).(SystemDataResponseOutput)
}
