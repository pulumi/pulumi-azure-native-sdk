...
func ListAutomationAccountDeletedRunbooks(ctx *pulumi.Context, args *ListAutomationAccountDeletedRunbooksArgs, opts ...pulumi.InvokeOption) (*ListAutomationAccountDeletedRunbooksResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20241023:listAutomationAccountDeletedRunbooks", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListAutomationAccountDeletedRunbooksOutput(ctx *pulumi.Context, args ListAutomationAccountDeletedRunbooksOutputArgs, opts ...pulumi.InvokeOption) ListAutomationAccountDeletedRunbooksResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListAutomationAccountDeletedRunbooksResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20241023:listAutomationAccountDeletedRunbooks", args, ListAutomationAccountDeletedRunbooksResultOutput{}, options).(ListAutomationAccountDeletedRunbooksResultOutput), nil
