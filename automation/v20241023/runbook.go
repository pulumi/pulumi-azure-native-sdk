...
func NewRunbook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20241023:Runbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRunbook(ctx *pulumi.Context,
	...
	var resource Runbook
	err := ctx.ReadResource("azure-native:automation/v20241023:Runbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
