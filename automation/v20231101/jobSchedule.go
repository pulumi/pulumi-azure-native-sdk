...
func NewJobSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20231101:JobSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobSchedule(ctx *pulumi.Context,
	...
	var resource JobSchedule
	err := ctx.ReadResource("azure-native:automation/v20231101:JobSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
