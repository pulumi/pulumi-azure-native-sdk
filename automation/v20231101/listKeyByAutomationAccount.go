...
func ListKeyByAutomationAccount(ctx *pulumi.Context, args *ListKeyByAutomationAccountArgs, opts ...pulumi.InvokeOption) (*ListKeyByAutomationAccountResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20231101:listKeyByAutomationAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func ListKeyByAutomationAccountOutput(ctx *pulumi.Context, args ListKeyByAutomationAccountOutputArgs, opts ...pulumi.InvokeOption) ListKeyByAutomationAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (ListKeyByAutomationAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20231101:listKeyByAutomationAccount", args, ListKeyByAutomationAccountResultOutput{}, options).(ListKeyByAutomationAccountResultOutput), nil
