...
func NewDscConfiguration(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:automation/v20230515preview:DscConfiguration"),
		},
		{
			Type: pulumi.String("azure-native:automation/v20241023:DscConfiguration"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DscConfiguration
	err := ctx.RegisterResource("azure-native:automation/v20231101:DscConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscConfiguration(ctx *pulumi.Context,
	...
	var resource DscConfiguration
	err := ctx.ReadResource("azure-native:automation/v20231101:DscConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
