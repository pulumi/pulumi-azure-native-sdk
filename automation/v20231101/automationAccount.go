...
func NewAutomationAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20231101:AutomationAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutomationAccount(ctx *pulumi.Context,
	...
	var resource AutomationAccount
	err := ctx.ReadResource("azure-native:automation/v20231101:AutomationAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
