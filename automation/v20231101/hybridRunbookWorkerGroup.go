...
func NewHybridRunbookWorkerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20231101:HybridRunbookWorkerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHybridRunbookWorkerGroup(ctx *pulumi.Context,
	...
	var resource HybridRunbookWorkerGroup
	err := ctx.ReadResource("azure-native:automation/v20231101:HybridRunbookWorkerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
