...
func NewSourceControl(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:automation/v20220808:SourceControl"),
		},
		{
			Type: pulumi.String("azure-native:automation/v20230515preview:SourceControl"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:automation/v20231101:SourceControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourceControl(ctx *pulumi.Context,
	...
	var resource SourceControl
	err := ctx.ReadResource("azure-native:automation/v20231101:SourceControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
