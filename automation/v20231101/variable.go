...
func NewVariable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20231101:Variable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVariable(ctx *pulumi.Context,
	...
	var resource Variable
	err := ctx.ReadResource("azure-native:automation/v20231101:Variable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
