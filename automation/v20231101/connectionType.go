...
func NewConnectionType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20231101:ConnectionType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionType(ctx *pulumi.Context,
	...
	var resource ConnectionType
	err := ctx.ReadResource("azure-native:automation/v20231101:ConnectionType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
