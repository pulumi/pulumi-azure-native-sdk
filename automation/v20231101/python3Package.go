...
func NewPython3Package(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20231101:Python3Package", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPython3Package(ctx *pulumi.Context,
	...
	var resource Python3Package
	err := ctx.ReadResource("azure-native:automation/v20231101:Python3Package", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
