...
func NewConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20231101:Connection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnection(ctx *pulumi.Context,
	...
	var resource Connection
	err := ctx.ReadResource("azure-native:automation/v20231101:Connection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
