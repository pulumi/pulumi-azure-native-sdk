...
//
// Deprecated: azure-native:automation/v20190601:JobSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.
func LookupJobSchedule(ctx *pulumi.Context, args *LookupJobScheduleArgs, opts ...pulumi.InvokeOption) (*LookupJobScheduleResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20190601:getJobSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
