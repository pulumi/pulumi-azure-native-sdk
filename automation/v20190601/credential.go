...
//
// Deprecated: azure-native:automation/v20190601:Credential is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Credential to guarantee forwards compatibility.
...
func NewCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20190601:Credential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCredential(ctx *pulumi.Context,
	...
	var resource Credential
	err := ctx.ReadResource("azure-native:automation/v20190601:Credential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
