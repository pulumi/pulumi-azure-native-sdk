...
//
// Deprecated: azure-native:automation/v20190601:DscNodeConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:DscNodeConfiguration to guarantee forwards compatibility.
...
func NewDscNodeConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20190601:DscNodeConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDscNodeConfiguration(ctx *pulumi.Context,
	...
	var resource DscNodeConfiguration
	err := ctx.ReadResource("azure-native:automation/v20190601:DscNodeConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
