...
//
// Deprecated: azure-native:automation/v20190601:ConnectionType is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:ConnectionType to guarantee forwards compatibility.
...
func NewConnectionType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20190601:ConnectionType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionType(ctx *pulumi.Context,
	...
	var resource ConnectionType
	err := ctx.ReadResource("azure-native:automation/v20190601:ConnectionType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
