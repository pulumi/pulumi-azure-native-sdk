...
// ContentSourceTypeInput is an input type that accepts values of the ContentSourceType enum
// A concrete instance of `ContentSourceTypeInput` can be one of the following:
//
...
// EncryptionKeySourceTypeInput is an input type that accepts values of the EncryptionKeySourceType enum
// A concrete instance of `EncryptionKeySourceTypeInput` can be one of the following:
//
...
// RunbookTypeEnumInput is an input type that accepts values of the RunbookTypeEnum enum
// A concrete instance of `RunbookTypeEnumInput` can be one of the following:
//
...
// SkuNameEnumInput is an input type that accepts values of the SkuNameEnum enum
// A concrete instance of `SkuNameEnumInput` can be one of the following:
//
//	SkuNameEnumFree
//	SkuNameEnumBasic
...
// TokenTypeInput is an input type that accepts values of the TokenType enum
// A concrete instance of `TokenTypeInput` can be one of the following:
//
