...
func NewConnection(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:automation/v20231101:Connection"),
		},
		{
			Type: pulumi.String("azure-native:automation/v20241023:Connection"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:automation/v20230515preview:Connection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnection(ctx *pulumi.Context,
	...
	var resource Connection
	err := ctx.ReadResource("azure-native:automation/v20230515preview:Connection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
