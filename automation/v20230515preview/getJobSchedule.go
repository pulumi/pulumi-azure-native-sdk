...
func LookupJobSchedule(ctx *pulumi.Context, args *LookupJobScheduleArgs, opts ...pulumi.InvokeOption) (*LookupJobScheduleResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20230515preview:getJobSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupJobScheduleOutput(ctx *pulumi.Context, args LookupJobScheduleOutputArgs, opts ...pulumi.InvokeOption) LookupJobScheduleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupJobScheduleResultOutput, error) {
			...
			return ctx.InvokeOutput("azure-native:automation/v20230515preview:getJobSchedule", args, LookupJobScheduleResultOutput{}, options).(LookupJobScheduleResultOutput), nil
