...
func NewPython2Package(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20230515preview:Python2Package", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPython2Package(ctx *pulumi.Context,
	...
	var resource Python2Package
	err := ctx.ReadResource("azure-native:automation/v20230515preview:Python2Package", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o Python2PackageOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *Python2Package) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
