...
type Runbook struct {
	...
	RuntimeEnvironment pulumi.StringPtrOutput `pulumi:"runtimeEnvironment"`
...
func NewRunbook(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:automation/v20241023:Runbook"),
		},
		{
	...
	err := ctx.RegisterResource("azure-native:automation/v20230515preview:Runbook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRunbook(ctx *pulumi.Context,
	...
	var resource Runbook
	err := ctx.ReadResource("azure-native:automation/v20230515preview:Runbook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Runtime Environment of the runbook execution.
func (o RunbookOutput) RuntimeEnvironment() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Runbook) pulumi.StringPtrOutput { return v.RuntimeEnvironment }).(pulumi.StringPtrOutput)
}
...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o RunbookOutput) SystemData() SystemDataResponseOutput {
	return o.ApplyT(func(v *Runbook) SystemDataResponseOutput { return v.SystemData }).(SystemDataResponseOutput)
}
