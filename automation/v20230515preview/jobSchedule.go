...
func NewJobSchedule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("azure-native:automation/v20231101:JobSchedule"),
		},
		{
			Type: pulumi.String("azure-native:automation/v20241023:JobSchedule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource JobSchedule
	err := ctx.RegisterResource("azure-native:automation/v20230515preview:JobSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobSchedule(ctx *pulumi.Context,
	...
	var resource JobSchedule
	err := ctx.ReadResource("azure-native:automation/v20230515preview:JobSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
