...
func NewRuntimeEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20230515preview:RuntimeEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuntimeEnvironment(ctx *pulumi.Context,
	...
	var resource RuntimeEnvironment
	err := ctx.ReadResource("azure-native:automation/v20230515preview:RuntimeEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
