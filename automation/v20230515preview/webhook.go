...
func NewWebhook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:automation/v20230515preview:Webhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebhook(ctx *pulumi.Context,
	...
	var resource Webhook
	err := ctx.ReadResource("azure-native:automation/v20230515preview:Webhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
