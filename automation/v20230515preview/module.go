...
func NewModule(ctx *pulumi.Context,
	...
	var resource Module
	err := ctx.RegisterResource("azure-native:automation/v20230515preview:Module", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModule(ctx *pulumi.Context,
	...
	var resource Module
	err := ctx.ReadResource("azure-native:automation/v20230515preview:Module", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
