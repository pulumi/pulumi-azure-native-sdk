...
// Azure Resource Manager metadata containing createdBy and modifiedBy information.
func (o WebhookOutput) SystemData() commontypesv5.SystemDataResponseOutput {
	return o.ApplyT(func(v *Webhook) commontypesv5.SystemDataResponseOutput { return v.SystemData }).(commontypesv5.SystemDataResponseOutput)
}
