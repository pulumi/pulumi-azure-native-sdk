...
//
// Deprecated: azure-native:automation/v20180630:Python2Package is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Python2Package to guarantee forwards compatibility.
func LookupPython2Package(ctx *pulumi.Context, args *LookupPython2PackageArgs, opts ...pulumi.InvokeOption) (*LookupPython2PackageResult, error) {
	...
	err := ctx.Invoke("azure-native:automation/v20180630:getPython2Package", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
